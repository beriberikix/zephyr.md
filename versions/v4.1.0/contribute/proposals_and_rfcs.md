---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/contribute/proposals_and_rfcs.html
...
the [Zephyr meetings](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Groups) in order to move it forward in cases where there is
