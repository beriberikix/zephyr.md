---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/contribute/contributor_expectations.html
...
- No fixup or merge commits are allowed, see [Contribution Workflow](guidelines.md#contribution-workflow) for
  more information.
...
- The code must follow the Zephyr [Coding Style Guidelines](style/index.md#coding-style) and [Coding Guidelines](coding_guidelines/index.md#coding-guidelines).
- The PR must pass all CI checks, as described in [Merge Criteria](../project/project_roles.md#merge-criteria).
...
- Documentation must be added and/or updated to reflect the changes in the code
  ...
  the rules in [Images](documentation/guidelines.md#doc-images). Please refer to [Documentation Guidelines](documentation/guidelines.md#doc-guidelines) for
...
The [Zephyr Dev Meeting](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Groups#zephyr-dev-meeting) performs a triage of PRs missing reviewer approval,
...
- After 2 weeks of inactivity, add the [dev-review](https://github.com/zephyrproject-rtos/zephyr/labels/dev-review) label to the PR. This
  explicitly adds the PR to the agenda for the next [Zephyr Dev Meeting](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Groups#zephyr-dev-meeting)
...
- Optionally resolve in the next [Zephyr Dev Meeting](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Groups#zephyr-dev-meeting) meeting with more
