---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/contribute/style/code.html
original_path: contribute/style/code.html
---
...
- Use [snake case](https://en.wikipedia.org/wiki/Snake_case) for code and variables.
