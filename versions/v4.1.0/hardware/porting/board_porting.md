---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/hardware/porting/board_porting.html
original_path: hardware/porting/board_porting.html
---

# Board Porting Guide

To add Zephyr support for a new [board](../../glossary.md#term-board), you at least need a *board
...
support your [SoC](../../glossary.md#term-SoC) as well.
...
- Support for reusing the SoC and board Kconfig trees outside of the Zephyr
  build system
- Support for advanced use cases with [Sysbuild (System build)](../../build/sysbuild/index.md#sysbuild)
...
model can be found in the [original issue](https://github.com/zephyrproject-rtos/zephyr/issues/51831), the
[original Pull Request](https://github.com/zephyrproject-rtos/zephyr/issues/50305) and, for a complete set of changes
introduced, the [hardware model v2 commit](https://github.com/zephyrproject-rtos/zephyr/commit/8dc3f856229ce083c956aa301c31a23e65bd8cd8).

Some non-critical features, enhancements and improvements of the new hardware
model are still in development. Check the
[hardware model v2 enhancements issue](https://github.com/zephyrproject-rtos/zephyr/issues/69546) for a complete list.
...
2. Take the SoC definition from Zephyr v3.6.0 and copy it to your downstream
   repository (ensuring that the build system can find it via a
   [zephyr module](../../develop/modules.md#modules) or `SOC_ROOT`). This will allow your board,
...
can then use the [example-application conversion Pull Request](https://github.com/zephyrproject-rtos/example-application/pull/58) as an example on
how to port a simple board. Additionally, a [conversion script](https://github.com/zephyrproject-rtos/zephyr/blob/main/scripts/utils/board_v1_to_v2.py) is available
and works reliably in many cases (though multi-core SoCs may not be handled
entirely). Finally, the [hardware model v2 commit](https://github.com/zephyrproject-rtos/zephyr/commit/8dc3f856229ce083c956aa301c31a23e65bd8cd8) contains the full conversion
...
Primarily, each [board](../../glossary.md#term-board) has one or more [SoC](../../glossary.md#term-SoC).
Each SoC can be optionally classed into an [SoC series](../../glossary.md#term-SoC-series), which in turn may optionally belong to an [SoC family](../../glossary.md#term-SoC-family).
Each SoC has one or more [CPU cluster](../../glossary.md#term-CPU-cluster), each containing one or more [CPU core](../../glossary.md#term-CPU-core) of a particular [architecture](../../glossary.md#term-architecture).

You can visualize the hierarchy in the diagram below:

[![Hardware support Hierarchy](https://docs.zephyrproject.org/4.1.0/_images/hierarchy.png)
](https://docs.zephyrproject.org/4.1.0/_images/hierarchy.png)

Hardware support Hierarchy

Below are some examples of the hierarchy described in this section, in the form
of a [board](../../glossary.md#term-board) per row with its corresponding hierarchy entries. Notice how
the [SoC series](../../glossary.md#term-SoC-series) and [SoC family](../../glossary.md#term-SoC-family) levels are not always used.

| [board name](../../glossary.md#term-board-name) | [board qualifiers](../../glossary.md#term-board-qualifiers) | [SoC](../../glossary.md#term-SoC) | [SoC Series](../../glossary.md#term-SoC-series) | [SoC family](../../glossary.md#term-SoC-family) | CPU core | [architecture](../../glossary.md#term-architecture) |
| --- | --- | --- | --- | --- | --- | --- |
| [nrf52dk](../../boards/nordic/nrf52dk/doc/index.md#nrf52dk-nrf52832) | nrf52832 | nRF52832 | nRF52 | Nordic nRF | Arm Cortex-M4 | ARMv7-M |
| [frdm\_k64f](../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) | mk64f12 | MK64F12 | Kinetis K6x | NXP Kinetis | Arm Cortex-M4 | ARMv7-M |
| [rv32m1\_vega](../../boards/openisa/rv32m1_vega/doc/index.md#rv32m1_vega) | openisa\_rv32m1/ri5cy | RV32M1 | (Not used) | (Not used) | RI5CY | RISC-V RV32 |
| [nrf5340dk](../../boards/nordic/nrf5340dk/doc/index.md#nrf5340dk-nrf5340) | nrf5340/cpuapp | nRF5340 | nRF53 | Nordic nRF | Arm Cortex-M33 | ARMv8-M |
| nrf5340/cpunet | nRF5340 | nRF53 | Nordic nRF | Arm Cortex-M33 | ARMv8-M |
| [mimx8mp\_evk](../../boards/nxp/imx8mp_evk/doc/index.md#imx8mp_evk) | mimx8ml8/a53 | i.MX8M Plus | i.MX8M | NXP i.MX | Arm Cortex-A53 | ARMv8-A |
...
in the image below, which uses the [BL5340 DVK](../../boards/ezurio/bl5340_dvk/doc/index.md#bl5340_dvk) board as reference.

[![Board terminology diagram](https://docs.zephyrproject.org/4.1.0/_images/board-terminology.svg)
](https://docs.zephyrproject.org/4.1.0/_images/board-terminology.svg)

Board terminology diagram

The diagram shows the different terms that are used to describe boards:

- The [board name](../../glossary.md#term-board-name): `bl5340_dvk`
- The optional [board revision](../../glossary.md#term-board-revision): `1.2.0`
- The [board qualifiers](../../glossary.md#term-board-qualifiers), that optionally describe the [SoC](../../glossary.md#term-SoC),
  [CPU cluster](../../glossary.md#term-CPU-cluster) and [variant](../../glossary.md#term-variant): `nrf5340/cpuapp/ns`
- The [board target](../../glossary.md#term-board-target), which uniquely identifies a combination of the above
...
Continuing with the example above, The board [BL5340 DVK](../../boards/ezurio/bl5340_dvk/doc/index.md#bl5340_dvk) is a single SoC
...
- `ns`: a variant, in this case `ns` is a common variant name is
  Zephyr denoting a non-secure build for boards supporting [Trusted Firmware-M (TF-M)](../../services/tfm/index.md#tfm).

Not all SoCs define CPU clusters or variants. For example a simple board
like the [Thingy:52](../../boards/nordic/thingy52/doc/index.md#thingy52-nrf52832) contains a single SoC with no CPU clusters and
no variants.
...
[Create your board directory](#create-your-board-directory). If you don’t know, try:

- checking [Supported Boards and Shields](../../boards/index.md#boards) for names that look relevant, and reading individual
...
CPU core support files go in `core` subdirectories under [arch](https://github.com/zephyrproject-rtos/zephyr/blob/main/arch),
e.g. [arch/x86/core](https://github.com/zephyrproject-rtos/zephyr/blob/main/arch/x86/core).

See [Install a Toolchain](../../develop/beyond-GSG.md#gs-toolchain) for information about toolchains (compiler, linker,
etc.) supported by Zephyr. If you need to support a new toolchain,
[Build and Configuration Systems](../../build/index.md#build-overview) is a good place to start learning about the build system.
...
[soc](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc). They are generally grouped by SoC family.
...
started. See [Custom Board, Devicetree and SOC Definitions](../../develop/application/index.md#custom-board-definition) for documentation on moving your
...
[dts/bindings/vendor-prefixes.txt](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/bindings/vendor-prefixes.txt) then you must use
...
1. `board.yml`: a YAML file describing the high-level meta data of the
...
2. `plank_<qualifiers>.dts`: a hardware description
   in [devicetree](../../build/dts/index.md#dt-guide) format. This declares your SoC, connectors,
   and any other hardware components such as LEDs, buttons, sensors, or
   communication peripherals (USB, Bluetooth controller, etc).
3. `Kconfig.plank`: the base software configuration for selecting SoC and
   ...
   the `Kconfig` file must be used.

The optional files are:

- `Kconfig`, `Kconfig.defconfig` software configuration in
  [Configuration System (Kconfig)](../../build/kconfig/index.md#kconfig) formats. This provides default settings for software features
  and peripheral drivers.
- `plank_defconfig` and `plank_<qualifiers>_defconfig`: software
  configuration in Kconfig `.conf` format.
- `board.cmake`: used for [Flash and debug support](#flash-and-debug-support)
- `CMakeLists.txt`: if you need to add additional source files to
  your build.
- `doc/index.rst`, `doc/plank.webp`: documentation for and a picture
  of your board. You only need this if you’re [Contributing your board](#contributing-your-board) to
  Zephyr.
- `plank_<qualifiers>.yaml`: a YAML file with miscellaneous metadata used
  by the [Test Runner (Twister)](../../develop/test/twister.md#twister-script).
...
The devicetree file `boards/<vendor>/plank/plank.dts` or
`boards/<vendor>/plank/plank_<qualifiers>.dts` describes your board
hardware in the Devicetree Source (DTS) format (as usual, change `plank` to
your board’s name). If you’re new to devicetree, see [Introduction to devicetree](../../build/dts/intro.md#devicetree-intro).
...
This means that if both `plank.dts` and `plank_soc1_foo.dts` exist,
then when building for `plank` / `plank/soc1`, then `plank.dts` is
used. When building for `plank//foo` / `plank/soc1/foo` the
`plank_soc1_foo.dts` is used.
...
[frdm\_k64fs.dts ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/nxp/frdm_k64f/frdm_k64f.dts) and
[hexiwear\_k64.dts ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/nxp/hexiwear/hexiwear_mk64f12.dts)
respectively. Both boards have NXP SoCs from the same Kinetis SoC family, the
K6X.

Common devicetree definitions for K6X are stored in [nxp\_k6x.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nxp/nxp_k6x.dtsi), which is included by both board `.dts`
files. [nxp\_k6x.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nxp/nxp_k6x.dtsi) in turn includes
[armv7-m.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/armv7-m.dtsi), which has common definitions
for Arm v7-M cores.

Since [nxp\_k6x.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nxp/nxp_k6x.dtsi) is meant to be
...
`aliases` and `chosen` to the right nodes (see [Aliases and chosen nodes](../../build/dts/intro-syntax-structure.md#dt-alias-chosen)), and
...
:   A shared Kconfig file which can be sourced both in Zephyr Kconfig and sysbuild
    ...
    The Kconfig symbols `BOARD_board` and
    `BOARD_normalized_board_target` are constructed by the build
...
:   A Kconfig fragment that is merged as-is into the final build directory
    ...
    If both the common `plank_defconfig` file and one or more board
    qualifiers specific `plank_<qualifiers>_defconfig` files exist, then
    all matching files will be used.
    This allows you to place configuration which is common for all board SoCs,
    CPU clusters, and board variants in the base `plank_defconfig` and only
...
:   A Kconfig fragment that is merged as-is into the final build directory
    `.config` whenever an application is compiled for your board revision
    `x.y.z`.
...
For `west flash` to work, see [Flash and debug support](#flash-and-debug-support) below. You can
...
- If available, configure and enable a serial output for the console
  ...
  For boards like [nRF52840 Dongle](../../boards/nordic/nrf52840dongle/doc/index.md#nrf52840dongle-nrf52840), that do not
  have a debug adapter, but a USB device controller, there is a common
  [Kconfig file ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/common/usb/Kconfig.cdc_acm_serial.defconfig)
  that must be included in the board’s Kconfig.defconfig file and
  [devicetree file ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/common/usb/cdc_acm_serial.dtsi)
...
- It is recommended to enable the MPU by default, if there is support for it
  ...
  hardware stack protection (CONFIG\_HW\_STACK\_PROTECTION=y) and, thus, allow the
  kernel to detect stack overflows when the system is running in privileged
  mode.

## Flash and debug support

Zephyr supports [Building, Flashing and Debugging](../../develop/west/build-flash-debug.md#west-build-flash-debug) via west extension commands.
...
host tools](../../develop/flash_debug/host-tools.md#flash-debug-host-tools) and integrate with west and the zephyr build
...
- See [Flash and debug runners](../../develop/west/build-flash-debug.md#west-runner) for Python APIs.
- Look for `board.cmake` files for other boards similar to your own for
  more examples.
...
See [Building for a board revision](../../develop/application/index.md#application-board-version) for basics on this feature from the user
perspective.
...
As described in the [Write your devicetree](#default-board-configuration) and
[Write Kconfig files](#board-kconfig-files) sections the board default configuration is created
...
- `<board>_<qualifiers>_<revision>_defconfig`: a specific revision
  defconfig which is only used for the board and SOC / variants identified by
  `<board>_<qualifiers>`.
- `<board>_<revision>_defconfig`: a specific revision defconfig which is
  used for the board regardless of the SOC / variants.
- `<board>_<qualifiers>_<revision>.overlay`: a specific revision dts
  overlay which is only used for the board and SOC / variants identified by
  `<board>_<qualifiers>`.
- `<board>_<revision>.overlay`: a specific revision dts overlay which is
  used for the board regardless of the SOC / variants.
...
The **BOARD\_REVISION** variable holds the revision value specified by the
user.
...
1. Make sure you’ve followed all the [General recommendations](#porting-general-recommendations).
   They are requirements for boards included with Zephyr.
2. Add documentation for your board using the template file
   [doc/templates/board.tmpl](https://github.com/zephyrproject-rtos/zephyr/blob/main/doc/templates/board.tmpl). See [Documentation Generation](../../contribute/documentation/generation.md#zephyr-doc) for
   information on how to build your documentation before submitting
   your pull request.
3. Prepare a pull request adding your board which follows the
   [Contribution Guidelines](../../contribute/guidelines.md#contribute-guidelines).
...
[Create your board directory](#create-your-board-directory).
...
feature described in [Board extensions](#extend-board).
...
description or [choices](../../build/dts/api/api.md#devicetree-chosen-nodes) can not be added in the
...
[same guidelines](#porting-general-recommendations) as regular boards. For
