---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/hardware/peripherals/eeprom/shell.html
...
For example, building the [Hello World](../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") sample for the [Native simulator - native\_sim](../../../boards/native/native_sim/doc/index.md#native-sim) with the EEPROM shell:
