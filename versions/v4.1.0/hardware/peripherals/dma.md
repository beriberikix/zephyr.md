---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/hardware/peripherals/dma.html
...
requirements vary dramatically depending on the application. See [Caching Basics](../cache/guide.md#cache-guide) for an
...
CONFIGURED -> CONFIGURED [label=dma\_stop, headport=c, tailport=e];
CONFIGURED -> CONFIGURED [label=dma\_config, headport=c, tailport=w];
