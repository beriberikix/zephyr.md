---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/hardware/arch/arm_cortex_m.html
...
| Native system timer (SysTick) |  | N [[1]](#f1) | Y | Y | Y | Y | Y | Y | Y |
| Memory protection |  |  | | | | | | | |
|  | User mode | N | Y | Y | Y | Y | Y | Y | Y |
|  | HW stack protection (MPU) | N | N | Y | Y | Y | Y | Y | Y |
|  | HW-assisted stack limit checking | N | N | N | N | N | Y [[2]](#f2) | Y | Y |
...
[zephyrproject-rtos/cmsis](https://github.com/zephyrproject-rtos/cmsis).
