...
![Emulator architecture showing tests, emulators and drivers](https://docs.zephyrproject.org/4.1.0/_images/arch.svg)
...
![Device class example, demonstrating BC1.2 charging detectors.](https://docs.zephyrproject.org/4.1.0/_images/device_class_emulator.svg)
