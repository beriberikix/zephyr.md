---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/hardware/cache/guide.html
...
caching tools, see [Cache Control Configuration](index.md#cache-config) for Zephyr Kconfig options or
[Cache API](index.md#cache-api) for the API reference. This section primarily focuses on the
