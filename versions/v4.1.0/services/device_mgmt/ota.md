---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/services/device_mgmt/ota.html
...
Bluetooth Low Energy (LE) or UDP. [MCUmgr](mcumgr.md#mcu-mgr) is used to send a signed
