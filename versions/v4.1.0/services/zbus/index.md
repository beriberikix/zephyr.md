...
[![zbus usage overview](https://docs.zephyrproject.org/4.1.0/_images/zbus_overview.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_overview.svg)
...
[![ZBus anatomy](https://docs.zephyrproject.org/4.1.0/_images/zbus_anatomy.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_anatomy.svg)
...
[![ZBus observers type](https://docs.zephyrproject.org/4.1.0/_images/zbus_type_of_observers.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_type_of_observers.svg)
...
[![ZBus observation mask.](https://docs.zephyrproject.org/4.1.0/_images/zbus_observation_mask.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_observation_mask.svg)
...
[![ZBus sensor-based application](https://docs.zephyrproject.org/4.1.0/_images/zbus_operations.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_operations.svg)
...
[![ZBus example scenario](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example_scenario.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example_scenario.svg)
...
[![ZBus publish processing detail](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example.svg)
...
[![ZBus publish processing detail](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example2.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example2.svg)
...
[![ZBus publishing process details using priority boost.](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example_HLP.svg)
](https://docs.zephyrproject.org/4.1.0/_images/zbus_publishing_process_example_HLP.svg)
