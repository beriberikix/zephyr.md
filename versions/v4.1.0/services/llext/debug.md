---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/services/llext/debug.html
original_path: services/llext/debug.html
---
...
dynamically relocated by [`llext_load()`](../../doxygen/html/group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157) at runtime, so even if the
...
1. Make sure the project is set up to display the verbose LLEXT debug output
   ([`CONFIG_LOG`](../../kconfig.md#CONFIG_LOG "CONFIG_LOG") and [`CONFIG_LLEXT_LOG_LEVEL_DBG`](../../kconfig.md#CONFIG_LLEXT_LOG_LEVEL_DBG "CONFIG_LLEXT_LOG_LEVEL_DBG")
   are set).
...
3. Start a debugging session of the main Zephyr application. This is described
   in the [Debugging](../../develop/west/build-flash-debug.md#west-debugging) section of the documentation; on
   supported boards it is as easy as running `west debug`, perhaps with some
   additional arguments.
4. Set a breakpoint just after the [`llext_load()`](../../doxygen/html/group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157) function in your code
