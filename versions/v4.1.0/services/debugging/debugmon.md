---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/services/debugging/debugmon.html
original_path: services/debugging/debugmon.html
---
...
- [`CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK`](../../kconfig.md#CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK "CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK"): enable the module. This option, by itself,
...
- [`CONFIG_SEGGER_DEBUGMON`](../../kconfig.md#CONFIG_SEGGER_DEBUGMON "CONFIG_SEGGER_DEBUGMON"): enables SEGGER debug monitor interrupt. Can be
...
`z_arm_debug_monitor` symbol. [`CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK`](../../kconfig.md#CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK "CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK") config configures this interrupt
...
The ready implementation provided with [`CONFIG_SEGGER_DEBUGMON`](../../kconfig.md#CONFIG_SEGGER_DEBUGMON "CONFIG_SEGGER_DEBUGMON") provides functionality
required to debug in the monitor mode using regular GDB commands.
Steps to configure SEGGER debug monitor:

1. Build a sample with `` CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK` `` and [`CONFIG_SEGGER_DEBUGMON`](../../kconfig.md#CONFIG_SEGGER_DEBUGMON "CONFIG_SEGGER_DEBUGMON")
   configs enabled.
...
(see [Debug Monitor](../../samples/subsys/debug/debugmon/README.md#debugmon "Configure the Debug Monitor feature on a Cortex-M processor.") sample).
