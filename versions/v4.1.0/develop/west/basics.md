---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/west/basics.html
...
West’s built-in commands allow you to work with [projects](../../glossary.md#term-west-project)
(Git repositories) under a common [workspace](../../glossary.md#term-west-workspace) directory.

West works in the following manner: the `west init` command creates the
[west workspace](../../glossary.md#term-west-workspace), and clones the [manifest repo](../../glossary.md#term-west-manifest-repository), while the `west update` command initially clones, and later updates, the
[projects](../../glossary.md#term-west-project) listed in the manifest in the workspace.

## Example workspace

If you’ve followed the [Getting Started Guide](../getting_started/index.md#getting-started), your local
[west workspace](../../glossary.md#term-west-workspace), which in this case is the folder named
`zephyrproject` as well as all its subfolders, looks like this:
