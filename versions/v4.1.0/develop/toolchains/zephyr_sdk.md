---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/toolchains/zephyr_sdk.html
...
You can change `0.17.0` to another version in the instructions below
...
1. Download and verify the [Zephyr SDK bundle](https://github.com/zephyrproject-rtos/sdk-ng/releases/tag/v0.17.0):
...
2. Download the [Zephyr SDK bundle](https://github.com/zephyrproject-rtos/sdk-ng/releases/tag/v0.17.0):
