---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/sca/eclair.html
...
- first\_analysis (default): a tiny selection of the projects coding guidelines to verify that
