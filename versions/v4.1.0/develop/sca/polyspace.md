---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/sca/polyspace.html
original_path: develop/sca/polyspace.html
---

# Polyspace support

[Polyspace®](https://mathworks.com/products/polyspace.html) is
...
[Polyspace user interface](https://mathworks.com/help/bugfinder/review-results-1.html)
or [uploaded to the web interface](https://mathworks.com/help/bugfinder/gs/run-bug-finder-on-server.html)
and reviewed there.
...
| `POLYSPACE_OPTIONS_FILE` | Command line flags can also be provided in a text file, line by line. Provide the absolute path to the file. | `-DPOLYSPACE_OPTIONS_FILE=/workdir/zephyr/myoptions.txt` |
