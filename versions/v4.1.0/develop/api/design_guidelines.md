---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/api/design_guidelines.html
...
[`gpio_callback`](../../doxygen/html/structgpio__callback.md), normally defined within a data structure
...
[`CONTAINER_OF`](../../doxygen/html/group__sys-util.md#gac5bc561d1bfd1bf68877fe577779bd2f).

### Examples

- The requirements of [`k_timer_expiry_t`](../../doxygen/html/group__timer__apis.md#ga2915762e70454d98c73c179a45cafbde) invoked when a system
  ...
  The assumption here, as with [`gpio_callback`](../../doxygen/html/structgpio__callback.md), is that the
  timer is embedded in a structure reachable from
  [`CONTAINER_OF`](../../doxygen/html/group__sys-util.md#gac5bc561d1bfd1bf68877fe577779bd2f) that can provide additional context to the
  callback.
- The requirements of [`counter_alarm_callback_t`](../../doxygen/html/group__counter__interface.md#ga36c570c3e57e635753d163400e437b77) invoked when a
  ...
  [`counter_alarm_cfg`](../../doxygen/html/structcounter__alarm__cfg.md) used to register the callback, depending
  on user needs.
