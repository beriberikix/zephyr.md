---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/develop/optimizations/tools.html
original_path: develop/optimizations/tools.html
---

# Optimization Tools

The available optimization tools let you analyse [Footprint and Memory Usage](#footprint-tools)
and [Data Structures](#data-structure-tools) using different build system targets.
...
If you are using [Sysbuild (System build)](../../build/sysbuild/index.md#sysbuild), see [Dedicated image build targets](../../build/sysbuild/index.md#sysbuild-dedicated-image-build-targets) instead.
...
[https://github.com/HBehrens/puncover](https://github.com/HBehrens/puncover). When this target is built, it will
...
[`CONFIG_STACK_USAGE`](../../kconfig.md#CONFIG_STACK_USAGE "CONFIG_STACK_USAGE") enabled.
...
obtained from [https://git.kernel.org/pub/scm/devel/pahole/pahole.git](https://git.kernel.org/pub/scm/devel/pahole/pahole.git) and is
