---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/project/project_roles.html
...
You may apply for your Contributor Badge by filling out the [Zephyr Contributor Badge form](https://forms.gle/oCw9iAPLhUsHTapc8).
...
not follow the [expectations](../contribute/reviewer_expectations.md#reviewer-expectations) and the guidelines
...
[MAINTAINERS File](#maintainers-file) in the Zephyr repository. Candidates who are neither
...
- Right to dismiss stale and unrelated reviews or reviews not following
  [expectations](../contribute/reviewer_expectations.md#reviewer-expectations) from reviewers and seek reviews
...
> [![Release Activity](https://docs.zephyrproject.org/4.1.0/_images/img_release_activity.png)
> ](https://docs.zephyrproject.org/4.1.0/_images/img_release_activity.png)

### Merge Criteria

- All [PR Requirements](../contribute/contributor_expectations.md#pr-requirements) must be met.
