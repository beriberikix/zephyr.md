---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/bluetooth-tools.html
...
### [Using a Zephyr-based Bluetooth Controller](#id6)
...
- UART: Use the [HCI UART](../../samples/bluetooth/hci_uart/README.md#bluetooth_hci_uart "Expose a Bluetooth controller to another device or CPU over UART.") sample and follow
...
- USB: Use the [HCI USB](../../samples/bluetooth/hci_usb/README.md#bluetooth_hci_usb "Turn a Zephyr board into a USB Bluetooth dongle (compatible with all operating systems).") sample and then
...
peripheral samples such as [Heart-rate Monitor (Peripheral)](../../samples/bluetooth/peripheral_hr/README.md#ble_peripheral_hr "Expose a Heart Rate (HR) GATT Service generating dummy heart-rate values.") or
[DIS Peripheral](../../samples/bluetooth/peripheral_dis/README.md#ble_peripheral_dis "Expose device information using the Device Information Service (DIS).").
