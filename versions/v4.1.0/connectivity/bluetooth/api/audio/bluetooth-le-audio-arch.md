---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/audio/bluetooth-le-audio-arch.html
...
| CCP | Call Control Server | 1.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor (in progress) - Sample Application (in progress) |
| Call Control Client | 1.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor (in progress) - Sample Application (in progress) |
...
![Common Audio Profile Procedures](https://docs.zephyrproject.org/4.1.0/_images/cap_proc.svg)
