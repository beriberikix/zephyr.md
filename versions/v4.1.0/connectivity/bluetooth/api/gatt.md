---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/gatt.html
...
Services can be registered using the [`bt_gatt_service_register()`](../../../doxygen/html/group__bt__gatt__server.md#gab4d9cfea04e44445d5dc30ad52842b64) API
...
- [ST Bluetooth LE Sensor Demo](../../../samples/bluetooth/st_ble_sensor/README.md#bluetooth_st_ble_sensor "Export vendor-specific GATT services over Bluetooth.")Export vendor-specific GATT services over Bluetooth.
