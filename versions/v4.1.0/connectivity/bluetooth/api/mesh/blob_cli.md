---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/blob_cli.html
...
[`bt_mesh_blob_cli_inputs`](../../../../doxygen/html/structbt__mesh__blob__cli__inputs.md) to determine how to perform the transfer. The BLOB Transfer Client
...
not [`BT_MESH_ADDR_UNASSIGNED`](../../../../doxygen/html/group__bt__mesh__access.md#ga6d11790af686e6d48f08c6f1cd65317c), the messages in the transfer will be sent to the group
...
[`lost_target`](../../../../doxygen/html/structbt__mesh__blob__cli__cb.md#a26a5ebe87db105900b150f71d770234d) callback.

The end of the procedure is signalled through the [`caps`](../../../../doxygen/html/structbt__mesh__blob__cli__cb.md#a58e749cadeb464299495ee74456c592c)
callback, and the resulting capabilities can be used to determine the block and chunk sizes required
for the BLOB transfer.

### BLOB transfer

The BLOB transfer is started by calling [`bt_mesh_blob_cli_send()`](../../../../doxygen/html/group__bt__mesh__blob__cli.md#ga708e4afb3d9e1d6a8fb02d8fd5ab78c2) function, which (in addition
...
cancelled. The end of the transfer is communicated to the application through the [`end`](../../../../doxygen/html/structbt__mesh__blob__cli__cb.md#a60bc49eab376b055a8c21099f86fdde7) callback. Lost Target nodes will be reported through the
[`lost_target`](../../../../doxygen/html/structbt__mesh__blob__cli__cb.md#a26a5ebe87db105900b150f71d770234d) callback.
