---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/core.html
...
The mesh stack uses the [Settings Subsystem](../../../../services/storage/settings/index.md#settings-api) for storing the
...
- [Mesh](../../../../samples/bluetooth/mesh/README.md#ble_mesh "Use basic Bluetooth Mesh functionality.")Use basic Bluetooth Mesh functionality.
