---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/shell.html
original_path: connectivity/bluetooth/api/mesh/shell.html
---

# Bluetooth Mesh Shell

The Bluetooth Mesh shell subsystem provides a set of Bluetooth Mesh shell commands for the
[Shell](../../../../services/shell/index.md#shell-api) module. It allows for testing and exploring the Bluetooth Mesh API through an
...
under `tests/bluetooth/mesh_shell`. See [Shell](../../../../services/shell/index.md#shell-api) for information on how to connect and
...
[Models](#bluetooth-mesh-shell-cfg-cli) commands.
...
| Booleans | Boolean values are denoted in the API documentation as `<val(off, on)>`. | `on`, `off`, `enabled`, `disabled`, `1`, `0` |
...
[`CONFIG_BT_MESH_PROVISIONEE`](../../../../kconfig.md#CONFIG_BT_MESH_PROVISIONEE "CONFIG_BT_MESH_PROVISIONEE") configuration option must be enabled, along with the
[`CONFIG_BT_MESH_PB_GATT`](../../../../kconfig.md#CONFIG_BT_MESH_PB_GATT "CONFIG_BT_MESH_PB_GATT") option.
...
[`CONFIG_BT_MESH_PROVISIONEE`](../../../../kconfig.md#CONFIG_BT_MESH_PROVISIONEE "CONFIG_BT_MESH_PROVISIONEE") configuration option must be enabled, along with the
[`CONFIG_BT_MESH_PB_ADV`](../../../../kconfig.md#CONFIG_BT_MESH_PB_ADV "CONFIG_BT_MESH_PB_ADV") option.
...
To allow a device to provision devices, the [`CONFIG_BT_MESH_PROVISIONER`](../../../../kconfig.md#CONFIG_BT_MESH_PROVISIONER "CONFIG_BT_MESH_PROVISIONER") and
[`CONFIG_BT_MESH_PB_ADV`](../../../../kconfig.md#CONFIG_BT_MESH_PB_ADV "CONFIG_BT_MESH_PB_ADV") configuration options must be enabled.
...
> - `AttDur`: The duration in seconds the unprovisioned device will identify itself for, if supported. See [Attention state](health_srv.md#bluetooth-mesh-models-health-srv-attention) for details.

To allow a device to provision devices over GATT, the [`CONFIG_BT_MESH_PROVISIONER`](../../../../kconfig.md#CONFIG_BT_MESH_PROVISIONER "CONFIG_BT_MESH_PROVISIONER")
and [`CONFIG_BT_MESH_PB_GATT_CLIENT`](../../../../kconfig.md#CONFIG_BT_MESH_PB_GATT_CLIENT "CONFIG_BT_MESH_PB_GATT_CLIENT") configuration options must be enabled.
...
>
> - `UUID`: If present, new 128-bit UUID value. Providing a hex-string shorter than 16 bytes will populate the N most significant bytes of the array and zero-pad the rest. If omitted, the current UUID will be printed. To enable this command, the [`CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE`](../../../../kconfig.md#CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE "CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE") option must be enabled.
...
> [`CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE`](../../../../kconfig.md#CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE "CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE") option must be enabled.
>
...
[`CONFIG_BT_MESH_GATT_PROXY`](../../../../kconfig.md#CONFIG_BT_MESH_GATT_PROXY "CONFIG_BT_MESH_GATT_PROXY") configuration option.
...
[`CONFIG_BT_MESH_PROXY_CLIENT`](../../../../kconfig.md#CONFIG_BT_MESH_PROXY_CLIENT "CONFIG_BT_MESH_PROXY_CLIENT") configuration option.
...
> [`CONFIG_BT_MESH_PROXY_SOLICITATION`](../../../../kconfig.md#CONFIG_BT_MESH_PROXY_SOLICITATION "CONFIG_BT_MESH_PROXY_SOLICITATION") configuration option.
>
...
[`CONFIG_BT_MESH_CFG_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_CFG_CLI "CONFIG_BT_MESH_CFG_CLI") configuration option. This is implemented as a separate
...
the [`CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE`](../../../../kconfig.md#CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE "CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE") option is enabled with the shell
...
>   > - `1` to `17`: The node will subscribe to Heartbeat messages for 2(period - 1) seconds.
...
[`CONFIG_BT_MESH_HEALTH_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_HEALTH_CLI "CONFIG_BT_MESH_HEALTH_CLI") configuration option. This is implemented as a separate
...
The [BLOB Transfer Client](blob_cli.md#bluetooth-mesh-blob-cli) can be added to the mesh shell by enabling the
[`CONFIG_BT_MESH_BLOB_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_BLOB_CLI "CONFIG_BT_MESH_BLOB_CLI") option, and disabling the
[`CONFIG_BT_MESH_DFU_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_DFU_CLI "CONFIG_BT_MESH_DFU_CLI") option.
...
The [BLOB Transfer Server](blob_srv.md#bluetooth-mesh-blob-srv) can be added to the mesh shell by enabling the
[`CONFIG_BT_MESH_BLOB_SRV`](../../../../kconfig.md#CONFIG_BT_MESH_BLOB_SRV "CONFIG_BT_MESH_BLOB_SRV") option. The BLOB Transfer Server model is capable of
...
[`CONFIG_BT_MESH_SHELL_BLOB_IO_FLASH`](../../../../kconfig.md#CONFIG_BT_MESH_SHELL_BLOB_IO_FLASH "CONFIG_BT_MESH_SHELL_BLOB_IO_FLASH") option. By default, the shell uses a
dummy BLOB stream. This option allows the user to specify which area in the flash to use.
See [Flash map](../../../../services/storage/flash_map/flash_map.md#flash-map-api) for information on how to obtain related parameters.
...
[`CONFIG_BT_MESH_BLOB_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_BLOB_CLI "CONFIG_BT_MESH_BLOB_CLI") and [`CONFIG_BT_MESH_DFU_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_DFU_CLI "CONFIG_BT_MESH_DFU_CLI"). The Firmware
...
[`CONFIG_BT_MESH_BLOB_SRV`](../../../../kconfig.md#CONFIG_BT_MESH_BLOB_SRV "CONFIG_BT_MESH_BLOB_SRV") and [`CONFIG_BT_MESH_DFU_SRV`](../../../../kconfig.md#CONFIG_BT_MESH_DFU_SRV "CONFIG_BT_MESH_DFU_SRV"). The Firmware
...
[`CONFIG_BT_MESH_DFD_SRV`](../../../../kconfig.md#CONFIG_BT_MESH_DFD_SRV "CONFIG_BT_MESH_DFD_SRV") configuration option. The shell commands for this model
...
> comma-separated addr,fw\_idx pairs, separated by semicolons, for example,
...
> - `TimeoutBase`: Optional additional value used to calculate timeout values in the firmware distribution process, in 10-second increments.. See [Transfer timeout](blob.md#bluetooth-mesh-blob-timeout) for information about how `timeout_base` is used to calculate the transfer timeout. Defaults to 0.
...
[`CONFIG_BT_MESH_SHELL_DFU_METADATA`](../../../../kconfig.md#CONFIG_BT_MESH_SHELL_DFU_METADATA "CONFIG_BT_MESH_SHELL_DFU_METADATA") configuration option.
...
[`CONFIG_BT_MESH_SAR_CFG_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_SAR_CFG_CLI "CONFIG_BT_MESH_SAR_CFG_CLI") configuration option. The SAR Configuration Client
...
[`CONFIG_BT_MESH_PRIV_BEACON_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_PRIV_BEACON_CLI "CONFIG_BT_MESH_PRIV_BEACON_CLI") configuration option.
...
[`CONFIG_BT_MESH_OP_AGG_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_OP_AGG_CLI "CONFIG_BT_MESH_OP_AGG_CLI") configuration option. The Opcodes Aggregator Client
...
[`CONFIG_BT_MESH_RPR_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_RPR_CLI "CONFIG_BT_MESH_RPR_CLI") configuration option. The Remote Provisioning Client model
...
>
> - `Timeout`: Scan timeout in seconds. Valid values from [`BT_MESH_RPR_EXT_SCAN_TIME_MIN`](../../../../doxygen/html/group__bt__mesh__rpr.md#ga2b7e2636da150f5c5cb4e3bdee13c745) to [`BT_MESH_RPR_EXT_SCAN_TIME_MAX`](../../../../doxygen/html/group__bt__mesh__rpr.md#ga2a5241b2e87fec227740dd4f2de3a68a).
...
> - `ADType`: List of AD types to include in the scan report. Must contain 1 to [`CONFIG_BT_MESH_RPR_AD_TYPES_MAX`](../../../../kconfig.md#CONFIG_BT_MESH_RPR_AD_TYPES_MAX "CONFIG_BT_MESH_RPR_AD_TYPES_MAX") entries.
...
[`CONFIG_BT_MESH_LARGE_COMP_DATA_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_LARGE_COMP_DATA_CLI "CONFIG_BT_MESH_LARGE_COMP_DATA_CLI") configuration option. The Large Composition Data Client
...
[`CONFIG_BT_MESH_BRG_CFG_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_BRG_CFG_CLI "CONFIG_BT_MESH_BRG_CFG_CLI") configuration option. The model provides functionality
...
### [Configuration database](#id11)

The Configuration database is an optional mesh subsystem that can be enabled through the
[`CONFIG_BT_MESH_CDB`](../../../../kconfig.md#CONFIG_BT_MESH_CDB "CONFIG_BT_MESH_CDB") configuration option. The Configuration database is only
...
through the [`CONFIG_BT_MESH_OD_PRIV_PROXY_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_OD_PRIV_PROXY_CLI "CONFIG_BT_MESH_OD_PRIV_PROXY_CLI") configuration option.
...
[`CONFIG_BT_MESH_SOL_PDU_RPL_CLI`](../../../../kconfig.md#CONFIG_BT_MESH_SOL_PDU_RPL_CLI "CONFIG_BT_MESH_SOL_PDU_RPL_CLI") configuration option.
