---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/provisioning.html
...
needs to be provisioned, call [`bt_mesh_prov_enable()`](../../../../doxygen/html/group__bt__mesh__prov.md#ga6c8dc1b09d4cde8738be83c992b860a9). The device
...
[`bt_mesh_init()`](../../../../doxygen/html/group__bt__mesh.md#ga521def6f74467a9bd3f2757c6aabd405). Additionally, a Uniform Resource Identifier (URI)
...
[`bt_mesh_prov.public_key_be`](../../../../doxygen/html/structbt__mesh__prov.md#a1261ba69e785f005d5834ac49da00778)
and [`bt_mesh_prov.private_key_be`](../../../../doxygen/html/structbt__mesh__prov.md#a1ab714e9be35242e02099884c3af45f5). The keys needs to be
provided in big-endian bytes order.

To provide the device’s public key obtained via OOB,
call [`bt_mesh_prov_remote_pub_key_set()`](../../../../doxygen/html/group__bt__mesh__prov.md#gae33b5b6e9650b49d46494b4a81b18674) on the provisioner side.
...
- **Input OOB:** The user inputs the authentication value. The available input
  actions are listed in [`bt_mesh_input_action_t`](../../../../doxygen/html/group__bt__mesh__prov.md#gaf71f3dbdef6b8c085e9a4f068e1f60c5).
- **Output OOB:** Show the user the authentication value. The available output
  actions are listed in [`bt_mesh_output_action_t`](../../../../doxygen/html/group__bt__mesh__prov.md#ga5512b81ef7eeb45b0a12ef62234c8795).

The application must provide callbacks for the supported authentication
methods in [`bt_mesh_prov`](../../../../doxygen/html/structbt__mesh__prov.md), as well as enabling the supported actions
in [`bt_mesh_prov.output_actions`](../../../../doxygen/html/structbt__mesh__prov.md#a8b88959c5eef7f47591468e9c9768b7c) and
[`bt_mesh_prov.input_actions`](../../../../doxygen/html/structbt__mesh__prov.md#af928a9419f684bcbda0563dda2c34d76).
...
[`bt_mesh_prov.input_complete`](../../../../doxygen/html/structbt__mesh__prov.md#a2717ddf38465b95452724078f780f9e5) or [`bt_mesh_prov.complete`](../../../../doxygen/html/structbt__mesh__prov.md#ad55abc2b1632455bb23fbd8b03df85ea)
...
application receives the [`bt_mesh_prov.input`](../../../../doxygen/html/structbt__mesh__prov.md#a31eff9c903ac721bbca7ab586dda9e80) callback. The user
response should be fed back to the Provisioning API through
[`bt_mesh_input_string()`](../../../../doxygen/html/group__bt__mesh__prov.md#ga2592abf429b40ef9242bce26f5bd085e) or [`bt_mesh_input_number()`](../../../../doxygen/html/group__bt__mesh__prov.md#gace8cbf2a6e9144d3118054f234de02ef). If
...
by the mesh stack, and the provisioning [`bt_mesh_prov.complete`](../../../../doxygen/html/structbt__mesh__prov.md#ad55abc2b1632455bb23fbd8b03df85ea)
