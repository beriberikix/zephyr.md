---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/blob.html
...
[`open`](../../../../doxygen/html/structbt__mesh__blob__io.md#a4666a3fafde0ee9fdd51d27732bec6bc) callback. When used with a BLOB Transfer Server, the BLOB
...
[`block_start`](../../../../doxygen/html/structbt__mesh__blob__io.md#a900f049b6a778d9e0973ee66b46dc046). Then, depending on the access mode, the BLOB
stream’s [`wr`](../../../../doxygen/html/structbt__mesh__blob__io.md#ae0b27ea814e5c939d708ae20d452ca09) or [`rd`](../../../../doxygen/html/structbt__mesh__blob__io.md#a330ec5dcc8d18b84e7fdab9ef6d75f49) callback is
called repeatedly to move data to or from the BLOB. When the model is done processing the block, it
calls [`block_end`](../../../../doxygen/html/structbt__mesh__blob__io.md#a57381249bf63924b2345ece6e12909cb). When the transfer is complete, the BLOB
stream is closed by calling [`close`](../../../../doxygen/html/structbt__mesh__blob__io.md#aac42902d0bbbef10a5e9cc35e8a3ea64).
