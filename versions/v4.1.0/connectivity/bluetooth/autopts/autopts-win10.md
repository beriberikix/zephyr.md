...
[![../../../_images/download_nrftools_windows.png](https://docs.zephyrproject.org/4.1.0/_images/download_nrftools_windows.png)
](https://docs.zephyrproject.org/4.1.0/_images/download_nrftools_windows.png)
...
[![../../../_images/device_manager.png](https://docs.zephyrproject.org/4.1.0/_images/device_manager.png)
](https://docs.zephyrproject.org/4.1.0/_images/device_manager.png)
...
[![../../../_images/download_socat.png](https://docs.zephyrproject.org/4.1.0/_images/download_socat.png)
](https://docs.zephyrproject.org/4.1.0/_images/download_socat.png)

Add path to directory of socat.exe to PATH:

[![../../../_images/add_socat_to_path.png](https://docs.zephyrproject.org/4.1.0/_images/add_socat_to_path.png)
](https://docs.zephyrproject.org/4.1.0/_images/add_socat_to_path.png)
...
[![../../../_images/autoptsserver_run.png](https://docs.zephyrproject.org/4.1.0/_images/autoptsserver_run.png)
](https://docs.zephyrproject.org/4.1.0/_images/autoptsserver_run.png)
...
[![../../../_images/autoptsclient_run.png](https://docs.zephyrproject.org/4.1.0/_images/autoptsclient_run.png)
](https://docs.zephyrproject.org/4.1.0/_images/autoptsclient_run.png)

At the first run, when Windows asks, enable connection through firewall:

[![../../../_images/allow_firewall.png](https://docs.zephyrproject.org/4.1.0/_images/allow_firewall.png)
](https://docs.zephyrproject.org/4.1.0/_images/allow_firewall.png)
