---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/networking/api/net_pkt.html
...
existing object for this: [`net_buf`](../../../doxygen/html/structnet__buf.md). (See
[Network Buffers](../../../services/net_buf/index.md#net-buf-interface) for more information). However, it mostly
...
once via [`net_pkt_alloc_with_buffer()`](../../../doxygen/html/group__net__pkt.md#ga57e2f5138acd92ad49864e3d709d9419). It is actually the most
...
[`net_pkt_alloc_buffer()`](../../../doxygen/html/group__net__pkt.md#gae31b4afd510bce346f7d00a9ec5d190d), as it will take into account the
...
[`net_pkt_ref()`](../../../doxygen/html/group__net__pkt.md#ga4e83d4f60b46db8f57798c0e96d6cd7a) or decremented with
[`net_pkt_unref()`](../../../doxygen/html/group__net__pkt.md#ga893d1660fd18ad5842224fda78466099). When the count drops to zero the buffer is
...
calling last net\_pkt\_unref. See [Network Buffers](../../../services/net_buf/index.md#net-buf-interface) for more
information.
...
[`net_pkt_skip()`](../../../doxygen/html/group__net__pkt.md#ga223a79baa1e740a53c4ed0f083d62185). For example, to go after the IP header, use:
...
updated. Note that [`net_pkt_set_data()`](../../../doxygen/html/group__net__pkt.md#ga98df84477b35e203b11029fc4ddec1cc) could be used in the RX
path as well, but it is slightly faster to use
[`net_pkt_acknowledge_data()`](../../../doxygen/html/group__net__pkt.md#gac7226cbfa2da28408f9691d375bc8f9f) as this one does not care about
contiguity at all, it just advances the cursor via
[`net_pkt_skip()`](../../../doxygen/html/group__net__pkt.md#ga223a79baa1e740a53c4ed0f083d62185) directly.
