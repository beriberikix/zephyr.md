---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/networking/api/http_server.html
...
- Static file system resources - the path at which the filesystem is mounted,
  ...
  server ([`HTTP_RESOURCE_TYPE_STATIC_FS`](../../../doxygen/html/group__http__server.md#gga23d0077fb99827b25491111bd74d00afa05a9e5c3c4c1cce4894e6250220fea6e)).
...
the same name as used for the linker section with [`HTTP_SERVICE_DEFINE`](../../../doxygen/html/group__http__service.md#ga1aa8efe3622b5c9421a6257140c5d2c5)
macro:
...
- The `headers`, `header_count` and `headers_status` fields pass request
  ...
  [`CONFIG_HTTP_SERVER_CAPTURE_HEADERS`](../../../kconfig.md#CONFIG_HTTP_SERVER_CAPTURE_HEADERS "CONFIG_HTTP_SERVER_CAPTURE_HEADERS") is enabled.
