---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/networking/api/capture.html
...
- [Network packet capture](../../../samples/net/capture/README.md#net-capture "Capture network packets and send them to a remote host via IPIP tunnel.")Capture network packets and send them to a remote host via IPIP tunnel.
