---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/networking/qemu_setup.html
...
gateway by calling the [`net_if_ipv4_set_gw()`](../../doxygen/html/group__net__if.md#ga310ccbd9b37629422ca8e32836362724) at runtime.
...
```shell
west build -b qemu_x86 -o server samples/net/sockets/echo_server
```
...
```shell
west build -b qemu_x86 -o client samples/net/sockets/echo_client
```
