...
![Overview of the network stack architecture](https://docs.zephyrproject.org/4.1.0/_images/zephyr_netstack_overview.svg)
...
![Network RX data flow](https://docs.zephyrproject.org/4.1.0/_images/zephyr_netstack_overview-rx_sequence.svg)
...
![Network TX data flow](https://docs.zephyrproject.org/4.1.0/_images/zephyr_netstack_overview-tx_sequence.svg)
