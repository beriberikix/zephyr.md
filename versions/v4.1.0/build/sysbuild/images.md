---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/sysbuild/images.html
original_path: build/sysbuild/images.html
---
...
[Modules (External projects)](../../develop/modules.md#modules) can add sysbuild images with the `sysbuild-cmake` and `sysbuild-kconfig`
options in a `module.yml` file, see [Sysbuild integration](../../develop/modules.md#sysbuild-module-integration) for details.
...
[Zephyr application has been created](../../develop/application/index.md#application):

`Kconfig.sysbuild``sysbuild.cmake`
...
[Adding dependencies among Zephyr applications](index.md#sysbuild-zephyr-application-dependencies) for details, image configuration can also be set
here, see [Image configuration](#sysbuild-images-config) for details.
...
This can then be extended by [Modules (External projects)](../../develop/modules.md#modules) like so:
...
[sysbuild using modules](../../develop/modules.md#sysbuild-module-integration) the pre-CMake hook should be used
instead, for example:
...
[share/sysbuild/cmake/modules/sysbuild\_extensions.cmake](https://github.com/zephyrproject-rtos/zephyr/blob/main/share/sysbuild/cmake/modules/sysbuild_extensions.cmake) in the
`ExternalZephyrProject_Add` function. After adding a new type, it can be used when adding a
sysbuild image, for example:

`sysbuild_extensions.cmake``sysbuild.cmake``MY_CUSTOM_TYPE_image_default.cmake`
...
[sysbuild is extended by a module](../../develop/modules.md#sysbuild-module-integration) or inside of a `sysbuild/CMakeLists.txt` file after `find_package(Sysbuild)` has been used. An example of outputting
values from all images is shown:

Module CMake`sysbuild/CMakeLists.txt`
