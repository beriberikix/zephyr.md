---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/snippets/writing.html
...
## [Sysbuild `.conf` files](#id7)

This `snippet.yml` adds `foo.conf` to the sysbuild configuration:
