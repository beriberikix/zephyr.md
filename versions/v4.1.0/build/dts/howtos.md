---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/howtos.html
...
You can build [Hello World](../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") to see the “base” devicetree for your board
without any additional changes from [overlay files](intro-input-output.md#dt-input-files).

For example, using the [QEMU Emulation for ARM Cortex-M3](../../boards/qemu/cortex_m3/doc/index.md#qemu_cortex_m3) board to build
...
device is to use [`DEVICE_DT_GET`](../../doxygen/html/group__device__model.md#ga9a65996ce21f43acb7db061e23b48ec7):
...
There are variants of [`DEVICE_DT_GET`](../../doxygen/html/group__device__model.md#ga9a65996ce21f43acb7db061e23b48ec7) such as
[`DEVICE_DT_GET_OR_NULL`](../../doxygen/html/group__device__model.md#ga6ce1dbfda6847ca6c3858712e9b41989), [`DEVICE_DT_GET_ONE`](../../doxygen/html/group__device__model.md#ga39c760429534ef9ae77f3d996987cd2b) or
[`DEVICE_DT_GET_ANY`](../../doxygen/html/group__device__model.md#gaadf3ffb63df544eb3de356ab2c5e9e3c). This idiom fetches the device pointer at
...
(This check is done for you by [`device_get_binding()`](../../doxygen/html/group__device__model.md#ga15386ca9ab38f3e30183c18f604fa835).)
...
`struct device` by combining [`device_get_binding()`](../../doxygen/html/group__device__model.md#ga15386ca9ab38f3e30183c18f604fa835) with the device
name:
...
[`uart_configure()`](../../doxygen/html/group__uart__interface.md#gaa0b75777b879af10543f7e8f463ff9a2). Similar code will work for other device types; just
...
help in such situations. Note that you can also use [`device_get_binding()`](../../doxygen/html/group__device__model.md#ga15386ca9ab38f3e30183c18f604fa835)
...
Notice the use of APIs like [`DT_INST_PROP`](../../doxygen/html/group__devicetree-inst.md#ga9dce2e631b2a94804e8f2bcc76c6eff8) and
[`DEVICE_DT_INST_DEFINE`](../../doxygen/html/group__device__model.md#gada5ba4aca9e0662ccebb2232c7256419) to access devicetree node data. These
APIs retrieve data from the devicetree for instance number `inst` of
the node with compatible determined by `DT_DRV_COMPAT`.

Finally, pass the instantiation macro to [`DT_INST_FOREACH_STATUS_OKAY`](../../doxygen/html/group__devicetree-inst.md#gaeac7ed0f4a6820a6e5d7dadb6d62d6e7):
...
[`DT_NODELABEL`](../../doxygen/html/group__devicetree-generic-id.md#gab7d23294a6bf7fd44a98b48ec47d8a79) to refer to individual nodes in the devicetree
...
Notice the use of APIs like [`DT_PROP`](../../doxygen/html/group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b) and
[`DEVICE_DT_DEFINE`](../../doxygen/html/group__device__model.md#gac49e26fbe91a14307d5ea08d41561dd1) to access devicetree node data.
...
- In particular, for bus devices, your driver’s binding should include a
  ...
  use of APIs like [`DT_BUS`](../../doxygen/html/group__devicetree-generic-bus.md#ga1082d31ac2dafdf9e085d4c23f2169dc) to obtain a node identifier for the bus
