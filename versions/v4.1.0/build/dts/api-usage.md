---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api-usage.html
...
By path
:   Use [`DT_PATH()`](../../doxygen/html/group__devicetree-generic-id.md#ga015b4819473797982e83cae497697086) along with the node’s full path in the devicetree,
    starting from the root node. This is mostly useful if you happen to know the
    exact node you’re looking for.

By node label
:   Use [`DT_NODELABEL()`](../../doxygen/html/group__devicetree-generic-id.md#gab7d23294a6bf7fd44a98b48ec47d8a79) to get a node identifier from a [node
...
By alias
:   Use [`DT_ALIAS()`](../../doxygen/html/group__devicetree-generic-id.md#gaa49e19bbc39dc0d6f16b78a5d02482c9) to get a node identifier for a property of the
    ...
    You may also use [`DT_HAS_ALIAS()`](../../doxygen/html/group__devicetree-generic-id.md#ga1f6c459577dbb195192bef33a30c5d51) to verify whether an alias
    node exists.
...
:   This is done primarily by device drivers, as instance numbers are a way to
    ...
    [`DT_INST()`](../../doxygen/html/group__devicetree-generic-id.md#gae199b930cb21ff38dab284a696093ead), but be careful doing so. See below.

By chosen node
:   Use [`DT_CHOSEN()`](../../doxygen/html/group__devicetree-generic-chosen.md#ga3412d0acecffa828984cf9e2c89889ed) to get a node identifier for `/chosen` node
    properties.

By parent/child
:   Use [`DT_PARENT()`](../../doxygen/html/group__devicetree-generic-id.md#ga3ac56d491510275ee1321446796ab63b) and [`DT_CHILD()`](../../doxygen/html/group__devicetree-generic-id.md#ga88259608f4e9083ccc2e9ca5ec2c212e) to get a node identifier
...
- `DT_INST(x, vnd_soc_i2c)` for some unknown number `x`. See the
  [`DT_INST()`](../../doxygen/html/group__devicetree-generic-id.md#gae199b930cb21ff38dab284a696093ead) documentation for details.
...
You can use [`DT_NODE_HAS_PROP()`](../../doxygen/html/group__devicetree-generic-exist.md#gacce67bf20541cd2d07d8540058964692) to check if a node has a property. For
...
You can use [`DT_PROP_LEN()`](../../doxygen/html/group__devicetree-generic-prop.md#gaa7f5afcedd1f54be79a5337e8e28a5b6) to get logical array lengths in number of
elements.
...
[`DT_REG_ADDR`](../../doxygen/html/group__devicetree-reg-prop.md#gac6d8279c32351ced4c0ac7f32270974e) or [`DT_REG_SIZE`](../../doxygen/html/group__devicetree-reg-prop.md#gad223efc6c77d008e55c3588953e85bfb):

- `DT_REG_ADDR(node_id)`: the given node’s register block address
- `DT_REG_SIZE(node_id)`: its size

Use [`DT_REG_ADDR_BY_IDX`](../../doxygen/html/group__devicetree-reg-prop.md#gac540b00bb12d0662f6aefe6ac0cff243) or [`DT_REG_SIZE_BY_IDX`](../../doxygen/html/group__devicetree-reg-prop.md#ga9a703d688e4b983689b8579e0e7d9f48) instead if the
...
[`DT_IRQ_BY_IDX`](../../doxygen/html/group__devicetree-interrupts-prop.md#ga3779b2115eac60ab32adfc8d212e973f):
...
interrupt number. You can use [`DT_IRQN`](../../doxygen/html/group__devicetree-interrupts-prop.md#ga5e00c208388736ce9b5bc0088a77cd95) as a convenient way to get a
...
You can convert a phandle to a node identifier using [`DT_PHANDLE`](../../doxygen/html/group__devicetree-generic-prop.md#ga7bd77c49472ba4547d87f00f40fd7171),
[`DT_PHANDLE_BY_IDX`](../../doxygen/html/group__devicetree-generic-prop.md#ga8ff163c240878a988d29d727671671de), or [`DT_PHANDLE_BY_NAME`](../../doxygen/html/group__devicetree-generic-prop.md#ga65c90d2d96255b8569c5b869b637c2fd), depending on the
...
general purpose APIs for this are [`DT_PHA_BY_IDX`](../../doxygen/html/group__devicetree-generic-prop.md#ga118b63fd22c20ef940ac2fa073c126ed) and [`DT_PHA`](../../doxygen/html/group__devicetree-generic-prop.md#gacef5921973a55433161fe0be3f8f628d).
There are also hardware-specific shorthands like [`DT_GPIO_CTLR_BY_IDX`](../../doxygen/html/group__devicetree-gpio.md#ga97bd46d2ab88d392a3f336f4d23184eb),
[`DT_GPIO_CTLR`](../../doxygen/html/group__devicetree-gpio.md#gafbad7d0d7f7fb9338997482c8da0e566),
[`DT_GPIO_PIN_BY_IDX`](../../doxygen/html/group__devicetree-gpio.md#ga8f7d82567056266bab1603865f8b27af), [`DT_GPIO_PIN`](../../doxygen/html/group__devicetree-gpio.md#ga4e41ec30ece058555333811a9fcee333),
[`DT_GPIO_FLAGS_BY_IDX`](../../doxygen/html/group__devicetree-gpio.md#ga672b2597b99194b8cbd42b3f3401d2b5), and [`DT_GPIO_FLAGS`](../../doxygen/html/group__devicetree-gpio.md#ga32b3383d7ed543602a7b4a031018316f).

See [`DT_PHA_HAS_CELL_AT_IDX`](../../doxygen/html/group__devicetree-generic-exist.md#gacfbd6a2cb3038e5aba1e2216d65ebc78) and [`DT_PROP_HAS_IDX`](../../doxygen/html/group__devicetree-generic-prop.md#ga479dfc704087eea7e7c5af42ae98576c) for ways to
...
- [`DT_CHOSEN`](../../doxygen/html/group__devicetree-generic-chosen.md#ga3412d0acecffa828984cf9e2c89889ed), [`DT_HAS_CHOSEN`](../../doxygen/html/group__devicetree-generic-chosen.md#ga9df6bacab5f579284f5f3c1e4856cd15): for properties
  of the special `/chosen` node
- [`DT_HAS_COMPAT_STATUS_OKAY`](../../doxygen/html/group__devicetree-generic-exist.md#ga916e11b66fdaab46e93c25241b62b52a), [`DT_NODE_HAS_COMPAT`](../../doxygen/html/group__devicetree-generic-exist.md#gad8912ba5db980713e72257472ded3ced): global- and
  node-specific tests related to the `compatible` property
- [`DT_BUS`](../../doxygen/html/group__devicetree-generic-bus.md#ga1082d31ac2dafdf9e085d4c23f2169dc): get a node’s bus controller, if there is one
- [`DT_ENUM_IDX`](../../doxygen/html/group__devicetree-generic-prop.md#ga6c1a3b93e30429c1c69a7e2d8fe2d840): for properties whose values are among a fixed list of
  choices
...
[`DT_INST`](../../doxygen/html/group__devicetree-generic-id.md#gae199b930cb21ff38dab284a696093ead).
