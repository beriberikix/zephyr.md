---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/display/solomon,ssd1309fb-spi.html
original_path: build/dts/api/bindings/display/solomon,ssd1309fb-spi.html
---

# solomon,ssd1309fb (on spi bus)
...
```text
SSD1309 128x64 dot-matrix display controller on SPI bus
```
...
may apply to the “solomon,ssd1309fb” compatible.
