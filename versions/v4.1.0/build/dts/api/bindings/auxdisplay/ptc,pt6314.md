---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/auxdisplay/ptc,pt6314.html
original_path: build/dts/api/bindings/auxdisplay/ptc,pt6314.html
---

# ptc,pt6314 (on spi bus)

Vendor: [Princeton Technology Corp.](../../bindings.md#dt-vendor-ptc)

Note

An implementation of a driver matching this compatible is available in
[drivers/auxdisplay/auxdisplay\_pt6314.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/auxdisplay/auxdisplay_pt6314.c).

## Description

```text
PTC PT6314 Dot Character VFD Controller/Driver IC
```
...
| Name | Type | Details |
| --- | --- | --- |
| `columns` | `int` | ```text Number of text columns that the display has ```  This property is **required**.  Legal values: `16`, `20`, `24` |
| `rows` | `int` | ```text Number of text rows that the display has ```  This property is **required**.  Legal values: `1`, `2` |
...
may apply to the “ptc,pt6314” compatible.
