---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/ipc/zephyr,ipc-icmsg-me-initiator.html
original_path: build/dts/api/bindings/ipc/zephyr,ipc-icmsg-me-initiator.html
---

# zephyr,ipc-icmsg-me-initiator
...
[subsys/ipc/ipc\_service/backends/ipc\_icmsg\_me\_initiator.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/ipc/ipc_service/backends/ipc_icmsg_me_initiator.c).

## Description

```text
Multiendpoint inter core messaging backend in initiator role
```
...
may apply to the “zephyr,ipc-icmsg-me-initiator” compatible.
