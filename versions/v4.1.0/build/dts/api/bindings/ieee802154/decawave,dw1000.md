---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/ieee802154/decawave,dw1000.html
original_path: build/dts/api/bindings/ieee802154/decawave,dw1000.html
---

# decawave,dw1000 (on spi bus)

Vendor: [Qorvo, Inc (formerly Decawave)](../../bindings.md#dt-vendor-decawave)

Note

An implementation of a driver matching this compatible is available in
[drivers/ieee802154/ieee802154\_dw1000.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ieee802154/ieee802154_dw1000.c).

## Description

```text
Decawave DW1000 802.15.4 UWB transceiver
```
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin. The interrupt pin IRQ of DW1000 is active high output. If connected directly the MCU pin should be configured as active high. ```  This property is **required**. |
| `reset-gpios` | `phandle-array` | ```text RESET pin. The RESET pin of DW1000 is active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
| `tx-ant-delay` | `int` | ```text Transmitter antenna delay. ``` |
| `rx-ant-delay` | `int` | ```text Receiver antenna delay. ``` |
...
may apply to the “decawave,dw1000” compatible.
