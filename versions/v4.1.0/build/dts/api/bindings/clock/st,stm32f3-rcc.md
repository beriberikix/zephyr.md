---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/st,stm32f3-rcc.html
original_path: build/dts/api/bindings/clock/st,stm32f3-rcc.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `adc12-prescaler` | `int` | ```text ADC 1 and 2 prescaler - 0: Disables the clock so the ADC can use AHB clock (synchronous mode) - Other values n: The ADC can use the PLL clock divided by n On STM32F37x, only 2/4/6/8 are allowed. ```  Legal values: `0`, `1`, `2`, `4`, `6`, `8`, `10`, `12`, `16`, `32`, `64`, `128`, `256` |
| `adc34-prescaler` | `int` | ```text ADC 3 and 4 prescaler - 0: Disables the clock so the ADC can use AHB clock (synchronous mode) - Other values n: The ADC can use the PLL clock divided by n Check RefMan for availability. ```  Legal values: `0`, `1`, `2`, `4`, `6`, `8`, `10`, `12`, `16`, `32`, `64`, `128`, `256` |
...
may apply to the “st,stm32f3-rcc” compatible.
