---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/st,stm32h7rs-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32h7rs-pll-clock.html
---

# st,stm32h7rs-pll-clock
...
| Name | Type | Details |
| --- | --- | --- |
| `div-s` | `int` | ```text PLL division factor for pllx_s_ck : valid for PLL1, 2, 3 Valid range: 1 - 8 ``` |
| `div-t` | `int` | ```text PLL division factor for pllx_t_ck : valid for PLL2 Valid range: 1 - 8 ``` |
...
may apply to the “st,stm32h7rs-pll-clock” compatible.
