---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/nordic,nrf-hsfll-global.html
original_path: build/dts/api/bindings/clock/nordic,nrf-hsfll-global.html
---
...
[drivers/clock\_control/clock\_control\_nrf2\_global\_hsfll.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_nrf2_global_hsfll.c).
...
| `supported-clock-frequencies` | `array` | ```text Supported clock frequencies in ascending order ``` |
| `clock-frequency` | `int` | ```text Optional fixed frequency specified if used in fixed frequency mode. ``` |
...
may apply to the “nordic,nrf-hsfll-global” compatible.
