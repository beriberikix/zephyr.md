---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/st,stm32n6-rcc.html
...
| `apb1-prescaler` | `int` | ```text CPU domain APB1 prescaler ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128` |
| `apb2-prescaler` | `int` | ```text CPU domain APB2 prescaler ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128` |
| `apb4-prescaler` | `int` | ```text CPU domain APB4 prescaler ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128` |
| `apb5-prescaler` | `int` | ```text CPU domain APB5 prescaler ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128` |
