---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/silabs,siwx91x-clock.html
original_path: build/dts/api/bindings/clock/silabs,siwx91x-clock.html
---
...
[drivers/clock\_control/clock\_control\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_silabs_siwx91x.c).

## Description

```text
Clocks embedded on Silabs SiWx91x chips
```
...
may apply to the “silabs,siwx91x-clock” compatible.
