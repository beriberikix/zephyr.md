---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/mediatek,mt8195_cpuclk.html
...
| Name | Type | Details |
| --- | --- | --- |
| `freqs-mhz` | `array` | ```text Available frequencies in ascending order ```  This property is **required**. |
| `cg-reg` | `int` |  |
| `pll-ctrl-reg` | `int` |  |
