---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/input/xptek,xpt2046.html
original_path: build/dts/api/bindings/input/xptek,xpt2046.html
---

# xptek,xpt2046 (on spi bus)

Vendor: [Shenzhen Xptek Technology Co., Ltd](../../bindings.md#dt-vendor-xptek)

Note

An implementation of a driver matching this compatible is available in
[drivers/input/input\_xpt2046.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_xpt2046.c).

## Description

```text
Driver for XPT2046 touch IC
```
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt GPIO. ```  This property is **required**. |
| `touchscreen-size-x` | `int` | ```text horizontal resolution of screen ```  This property is **required**. |
| `touchscreen-size-y` | `int` | ```text vertical resolution of screen ```  This property is **required**. |
| `min-x` | `int` | ```text minimum raw X value reported. ```  This property is **required**. |
| `min-y` | `int` | ```text minimum raw Y value reported. ```  This property is **required**. |
| `max-x` | `int` | ```text maximum raw X value reported. ```  This property is **required**. |
| `max-y` | `int` | ```text maximum raw Y value reported. ```  This property is **required**. |
| `z-threshold` | `int` | ```text Z value threshold to trigger a touch ```  Default value: `100` |
| `reads` | `int` | ```text How many reads per touch to average the value ```  Default value: `1` |
...
may apply to the “xptek,xpt2046” compatible.
