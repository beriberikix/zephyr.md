---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/input/focaltech,ft5336.html
original_path: build/dts/api/bindings/input/focaltech,ft5336.html
---

# focaltech,ft5336 (on i2c bus)

Vendor: [FocalTech Systems Co.,Ltd](../../bindings.md#dt-vendor-focaltech)

Note

An implementation of a driver matching this compatible is available in
[drivers/input/input\_ft5336.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_ft5336.c).

## Description

```text
FT3267/FT5XX6/FT6XX6 capacitive touch panels
```
...
| `reset-gpios` | `phandle-array` | ```text Reset GPIO. Used to reset the controller during initialization, and to wake it from hibernation mode. Active low. ``` |
...
may apply to the “focaltech,ft5336” compatible.
