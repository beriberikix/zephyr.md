---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/input/input-keymap.html
...
[subsys/input/input\_keymap.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/input/input_keymap.c).
