---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/input/ite,it8801-kbd.html
original_path: build/dts/api/bindings/input/ite,it8801-kbd.html
---
...
[drivers/input/input\_ite\_it8801\_kbd.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_ite_it8801_kbd.c).

## Description

```text
ITE IT8801 I2C-based keyboard matrix scan controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `mfdctrl` | `phandles` | ```text Switching the pin to KSO alternate function. ``` |
| `kso-mapping` | `array` |  |
...
may apply to the “ite,it8801-kbd” compatible.
