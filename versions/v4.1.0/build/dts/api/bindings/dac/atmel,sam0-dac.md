---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dac/atmel,sam0-dac.html
original_path: build/dts/api/bindings/dac/atmel,sam0-dac.html
---
...
[drivers/dac/dac\_sam0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_sam0.c).

## Description

```text
Atmel SAM0 family DAC
```
...
| `reference` | `string` | ```text Reference voltage source ```  Legal values: `'intref'`, `'vddana'`, `'vrefa'` |
...
may apply to the “atmel,sam0-dac” compatible.
