---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dac/adi,ad5676.html
original_path: build/dts/api/bindings/dac/adi,ad5676.html
---

# adi,ad5676 (on spi bus)
...
```text
Analog Devices 16-Bit 8-channel SPI DAC
```
...
may apply to the “adi,ad5676” compatible.
