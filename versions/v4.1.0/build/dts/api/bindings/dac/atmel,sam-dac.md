---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dac/atmel,sam-dac.html
original_path: build/dts/api/bindings/dac/atmel,sam-dac.html
---
...
[drivers/dac/dac\_sam.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_sam.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text Peripheral Clock to DAC Clock Ratio. Prescaler value is calculated as PRESCAL = (MCK / DACClock) - 2. Should be in range from 0 to 15. The value will be written to DACC_MR.PRESCALER bit-field. The property is applicable only to SAME70, SAMV71 series devices. ```  Default value: `15` |
...
may apply to the “atmel,sam-dac” compatible.
