---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dac/adi,ad5674.html
original_path: build/dts/api/bindings/dac/adi,ad5674.html
---

# adi,ad5674 (on spi bus)
...
```text
Analog Devices 12-Bit 16-channel SPI DAC
```
...
may apply to the “adi,ad5674” compatible.
