---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sdhc/renesas,ra-sdhc.html
original_path: build/dts/api/bindings/sdhc/renesas,ra-sdhc.html
---
...
[drivers/sdhc/sdhc\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sdhc/sdhc_renesas_ra.c).
...
| `bus-width` | `int` | Default value: `4`  Legal values: `1`, `4` |
| `sd-support` | `boolean` |  |
| `mmc-support` | `boolean` |  |
| `card-detect` | `boolean` |  |
...
| `enable-gpios` | `phandle-array` | ```text GPIO to use to enable/disable the SDHI. This GPIO is driven active when the SDHI is enabled and inactive when the SDHI is disabled ``` |
...
may apply to the “renesas,ra-sdhc” compatible.
