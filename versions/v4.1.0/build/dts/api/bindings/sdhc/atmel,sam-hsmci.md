---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sdhc/atmel,sam-hsmci.html
original_path: build/dts/api/bindings/sdhc/atmel,sam-hsmci.html
---
...
[drivers/sdhc/sam\_hsmci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sdhc/sam_hsmci.c).
...
```text
ATMEL (Microchip) SAM HSMCI SD host controller
```
...
may apply to the “atmel,sam-hsmci” compatible.
