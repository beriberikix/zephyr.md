---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pinctrl/ti,cc23x0-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/ti,cc23x0-pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_cc23x0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_cc23x0.c).
...
These property descriptions apply to “ti,cc23x0-pinctrl”
...
may apply to the “ti,cc23x0-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text CC23X0 pin's configuration (IO pin, IO function). ```  This property is **required**. |
