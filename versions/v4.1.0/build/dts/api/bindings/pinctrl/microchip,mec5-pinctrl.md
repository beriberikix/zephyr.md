---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pinctrl/microchip,mec5-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/microchip,mec5-pinctrl.html
---

# microchip,mec5-pinctrl
...
[drivers/pinctrl/pinctrl\_mchp\_mec5.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_mchp_mec5.c).
...
These property descriptions apply to “microchip,mec5-pinctrl”
...
may apply to the “microchip,mec5-pinctrl” compatible.
...
| `slew-rate` | `string` | ```text Pin speed. The default value of slew-rate is the SoC power-on-reset value. Please refer to the data sheet as a small number of pins may have a different default and some pins do not implement slew rate adjustment. ```  Legal values: `'low-speed'`, `'high-speed'` |
| `drive-strength` | `string` | ```text Pin output drive strength for PIO and PIO-24 pin types. Default is "1x" for most pins. PIO pins are 2, 4, 8, or 12 mA. PIO-24 pins are 4, 8, 16, or 24 mA. Please refer to the data sheet for each pin's PIO type and default drive strength. ```  Legal values: `'1x'`, `'2x'`, `'4x'`, `'6x'` |
