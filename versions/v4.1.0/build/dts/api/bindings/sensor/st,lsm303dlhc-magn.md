---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,lsm303dlhc-magn.html
original_path: build/dts/api/bindings/sensor/st,lsm303dlhc-magn.html
---

# st,lsm303dlhc-magn (on i2c bus)
...
[drivers/sensor/st/lsm303dlhc\_magn/lsm303dlhc\_magn.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/lsm303dlhc_magn/lsm303dlhc_magn.c).

## Description

```text
STMicroelectronics LSM303DLHC magnetometer sensor
```
...
may apply to the “st,lsm303dlhc-magn” compatible.
