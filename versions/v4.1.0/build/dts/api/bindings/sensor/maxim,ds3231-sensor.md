---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/maxim,ds3231-sensor.html
original_path: build/dts/api/bindings/sensor/maxim,ds3231-sensor.html
---
...
[drivers/sensor/maxim/ds3231/ds3231.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/maxim/ds3231/ds3231.c).

## Description

```text
Maxim DS3231 I2C temperature sensor
```
...
may apply to the “maxim,ds3231-sensor” compatible.
