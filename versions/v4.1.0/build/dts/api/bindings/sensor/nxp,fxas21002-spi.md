---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/nxp,fxas21002-spi.html
original_path: build/dts/api/bindings/sensor/nxp,fxas21002-spi.html
---

# nxp,fxas21002 (on spi bus)
...
[drivers/sensor/nxp/fxas21002/fxas21002.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/nxp/fxas21002/fxas21002.c).

## Description

```text
FXAS21002 3-axis gyroscope sensor
```
...
| `reset-gpios` | `phandle-array` | ```text RST pin This pin defaults to active low when consumed by the sensor. The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
...
may apply to the “nxp,fxas21002” compatible.
