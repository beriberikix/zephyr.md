---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/ist,tsic-xx6.html
...
| `lower-temperature-limit` | `int` | ```text Lowest temperature supported by the device in celsius degrees. ```  This property is **required**. |
| `higher-temperature-limit` | `int` | ```text Highest temperature supported by the device in celsius degrees. ```  This property is **required**. |
