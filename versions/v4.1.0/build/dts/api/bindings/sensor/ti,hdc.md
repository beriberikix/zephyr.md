---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/ti,hdc.html
original_path: build/dts/api/bindings/sensor/ti,hdc.html
---
...
[drivers/sensor/ti/ti\_hdc/ti\_hdc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ti/ti_hdc/ti_hdc.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `drdy-gpios` | `phandle-array` | ```text Data ready pin. The DRDYn pin of HDC sensor is open-drain, active low. If connected directly the MCU pin should be configured as pull-up, active low. ``` |
...
may apply to the “ti,hdc” compatible.
