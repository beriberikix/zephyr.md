---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,stm32c0-temp-cal.html
...
| `io-channels` | `phandle-array` | ```text IO channel specifiers relevant to the device. ```  This property is **required**. |
