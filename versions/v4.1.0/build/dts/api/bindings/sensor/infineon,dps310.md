---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/infineon,dps310.html
original_path: build/dts/api/bindings/sensor/infineon,dps310.html
---

# infineon,dps310 (on i2c bus)
...
[drivers/sensor/infineon/dps310/dps310.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/infineon/dps310/dps310.c).

## Description

```text
Infineon DPS310 temperature and pressure sensor
```
...
may apply to the “infineon,dps310” compatible.
