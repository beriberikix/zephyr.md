---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/bosch,bmi08x-gyro-spi.html
original_path: build/dts/api/bindings/sensor/bosch,bmi08x-gyro-spi.html
---

# bosch,bmi08x-gyro (on spi bus)
