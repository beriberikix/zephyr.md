---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/ti,tmp116.html
original_path: build/dts/api/bindings/sensor/ti,tmp116.html
---

# ti,tmp116 (on i2c bus)
...
[drivers/sensor/ti/tmp116/tmp116.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ti/tmp116/tmp116.c).

## Description

These nodes are “tmp116” bus nodes.
...
| `oversampling` | `int` | ```text Set number of sample to averaging in one readout. Default is power-up configuration (8 samples).  - 0    # TMP116_DT_OVERSAMPLING_1 - 0x20 # TMP116_DT_OVERSAMPLING_8 - 0x40 # TMP116_DT_OVERSAMPLING_32 - 0x60 # TMP116_DT_OVERSAMPLING_64 ```  Default value: `32`  Legal values: `0`, `32`, `64`, `96` |
...
may apply to the “ti,tmp116” compatible.
