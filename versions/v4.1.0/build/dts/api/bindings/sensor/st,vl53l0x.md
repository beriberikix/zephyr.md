---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,vl53l0x.html
original_path: build/dts/api/bindings/sensor/st,vl53l0x.html
---

# st,vl53l0x (on i2c bus)
...
[drivers/sensor/st/vl53l0x/vl53l0x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/vl53l0x/vl53l0x.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `xshut-gpios` | `phandle-array` | ```text Xshutdown pin, Active LOW. ``` |
...
may apply to the “st,vl53l0x” compatible.
