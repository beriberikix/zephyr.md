---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/isil,isl29035.html
original_path: build/dts/api/bindings/sensor/isil,isl29035.html
---

# isil,isl29035 (on i2c bus)

Vendor: [Intersil](../../bindings.md#dt-vendor-isil)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/renesas/isl29035/isl29035.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/renesas/isl29035/isl29035.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text The INT pin defaults to active low when produced by the sensor. The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
...
may apply to the “isil,isl29035” compatible.
