---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,iis2dh-spi.html
original_path: build/dts/api/bindings/sensor/st,iis2dh-spi.html
---

# st,iis2dh (on spi bus)
