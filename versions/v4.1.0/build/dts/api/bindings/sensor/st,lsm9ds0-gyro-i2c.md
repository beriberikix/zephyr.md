---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,lsm9ds0-gyro-i2c.html
original_path: build/dts/api/bindings/sensor/st,lsm9ds0-gyro-i2c.html
---

# st,lsm9ds0-gyro (on i2c bus)
...
[drivers/sensor/st/lsm9ds0\_gyro/lsm9ds0\_gyro.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/lsm9ds0_gyro/lsm9ds0_gyro.c).

## Description

```text
STMicroelectronics LSM9DS0-GYRO 3-axis gyro
```
...
may apply to the “st,lsm9ds0-gyro” compatible.
