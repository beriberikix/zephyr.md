---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,iis2dlpc-spi.html
original_path: build/dts/api/bindings/sensor/st,iis2dlpc-spi.html
---

# st,iis2dlpc (on spi bus)
...
[drivers/sensor/st/iis2dlpc/iis2dlpc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/iis2dlpc/iis2dlpc.c).
...
| `power-mode` | `int` | ```text Specify the sensor power mode. Default is power-up configuration.  - 0 # IIS2DLPC_DT_LP_M1 - 1 # IIS2DLPC_DT_LP_M2 - 2 # IIS2DLPC_DT_LP_M3 - 3 # IIS2DLPC_DT_LP_M4 - 4 # IIS2DLPC_DT_HP_MODE ```  Legal values: `0`, `1`, `2`, `3`, `4` |
| `tap-mode` | `int` | ```text Tap mode. Default is power-up configuration.  - 0 # IIS2DLPC_DT_SINGLE_TAP - 1 # IIS2DLPC_DT_SINGLE_DOUBLE_TAP ```  Legal values: `0`, `1` |
...
may apply to the “st,iis2dlpc” compatible.
