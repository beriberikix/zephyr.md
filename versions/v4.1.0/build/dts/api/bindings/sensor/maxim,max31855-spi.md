---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/maxim,max31855-spi.html
original_path: build/dts/api/bindings/sensor/maxim,max31855-spi.html
---

# maxim,max31855 (on spi bus)
...
[drivers/sensor/maxim/max31855/max31855.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/maxim/max31855/max31855.c).

## Description

```text
MAX31855 SPI-based cold-junction compensated thermocouple-to-digital converter.
```
...
may apply to the “maxim,max31855” compatible.
