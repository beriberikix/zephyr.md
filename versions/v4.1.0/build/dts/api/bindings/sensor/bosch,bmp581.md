---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/bosch,bmp581.html
original_path: build/dts/api/bindings/sensor/bosch,bmp581.html
---
...
[drivers/sensor/bosch/bmp581](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/bosch/bmp581).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin. The interrupt pin of BMP581 is open-drain, active low. If connected directly to the MCU, the pin should be configured as pull-up, active low. ``` |
...
may apply to the “bosch,bmp581” compatible.
