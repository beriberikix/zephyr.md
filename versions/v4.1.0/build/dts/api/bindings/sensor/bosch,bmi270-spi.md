---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/bosch,bmi270-spi.html
original_path: build/dts/api/bindings/sensor/bosch,bmi270-spi.html
---

# bosch,bmi270 (on spi bus)
...
[drivers/sensor/bosch/bmi270/bmi270.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/bosch/bmi270/bmi270.c).
...
| `irq-gpios` | `phandle-array` | ```text The INT1 and (optional) INT2 signal connections. ``` |
...
may apply to the “bosch,bmi270” compatible.
