---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/renesas,hs400x.html
original_path: build/dts/api/bindings/sensor/renesas,hs400x.html
---

# renesas,hs400x (on i2c bus)
...
[drivers/sensor/renesas/hs400x/hs400x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/renesas/hs400x/hs400x.c).

## Description

```text
Renesas HS400x humidity and temperature sensor
```
...
may apply to the “renesas,hs400x” compatible.
