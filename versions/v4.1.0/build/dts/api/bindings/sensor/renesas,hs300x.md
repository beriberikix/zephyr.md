---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/renesas,hs300x.html
original_path: build/dts/api/bindings/sensor/renesas,hs300x.html
---

# renesas,hs300x (on i2c bus)
...
[drivers/sensor/renesas/hs300x/hs300x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/renesas/hs300x/hs300x.c).

## Description

```text
Renesas HS300x humidity and temperature sensor
```
...
may apply to the “renesas,hs300x” compatible.
