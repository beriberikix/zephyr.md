---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/seeed,hm330x.html
original_path: build/dts/api/bindings/sensor/seeed,hm330x.html
---

# seeed,hm330x (on i2c bus)
...
[drivers/sensor/seeed/hm330x/hm330x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/seeed/hm330x/hm330x.c).
...
may apply to the “seeed,hm330x” compatible.
