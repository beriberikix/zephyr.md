---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/meas,ms5837.html
original_path: build/dts/api/bindings/sensor/meas,ms5837.html
---

# meas,ms5837 (on i2c bus)
...
```text
TE Connectivity MS5837 digital pressure sensor
```
...
may apply to the “meas,ms5837” compatible.
