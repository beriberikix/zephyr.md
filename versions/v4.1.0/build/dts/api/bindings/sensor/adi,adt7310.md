---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/adi,adt7310.html
original_path: build/dts/api/bindings/sensor/adi,adt7310.html
---

# adi,adt7310 (on spi bus)
...
[drivers/sensor/adi/adt7310/adt7310.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/adi/adt7310/adt7310.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text The INT signal defaults to active low open drain, so requires a pull-up on the board or in the flags cell of this entry. ``` |
...
may apply to the “adi,adt7310” compatible.
