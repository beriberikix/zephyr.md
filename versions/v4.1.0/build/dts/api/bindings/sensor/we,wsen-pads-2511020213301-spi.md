---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/we,wsen-pads-2511020213301-spi.html
original_path: build/dts/api/bindings/sensor/we,wsen-pads-2511020213301-spi.html
---

# we,wsen-pads-2511020213301 (on spi bus)
...
```text
Würth Elektronik WSEN-PADS-2511020213301 absolute pressure sensor (SPI bus)
```
