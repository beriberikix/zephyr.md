---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/litex,gpio.html
original_path: build/dts/api/bindings/gpio/litex,gpio.html
---
...
[drivers/gpio/gpio\_litex.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_litex.c).
...
These property descriptions apply to “litex,gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `port-is-output` | `boolean` | ```text Indicates if the port is an output port ``` |
...
may apply to the “litex,gpio” compatible.
