---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/zephyr,gpio-emul.html
original_path: build/dts/api/bindings/gpio/zephyr,gpio-emul.html
---
...
[drivers/gpio/gpio\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_emul.c).
...
These property descriptions apply to “zephyr,gpio-emul”
...
| Name | Type | Details |
| --- | --- | --- |
| `rising-edge` | `boolean` | ```text Enables support for rising edge interrupt detection ``` |
| `falling-edge` | `boolean` | ```text Enables support for falling edge interrupt detection ``` |
| `high-level` | `boolean` | ```text Enables support for high level interrupt detection ``` |
| `low-level` | `boolean` | ```text Enables support for low level interrupt detection ``` |
...
may apply to the “zephyr,gpio-emul” compatible.
