---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,mcp23016.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23016.html
---

# microchip,mcp23016 (on i2c bus)
...
```text
This is a representation of the Microchip MCP23016 I2C GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23016”
...
may apply to the “microchip,mcp23016” compatible.
