---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/raspberrypi,rp1-gpio.html
original_path: build/dts/api/bindings/gpio/raspberrypi,rp1-gpio.html
---
...
[drivers/gpio/gpio\_rp1.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_rp1.c).

## Description

```text
GPIO Banks on RP1 peripheral controller
```
...
These property descriptions apply to “raspberrypi,rp1-gpio”
...
may apply to the “raspberrypi,rp1-gpio” compatible.
