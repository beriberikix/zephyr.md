---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,xec-gpio-v2.html
original_path: build/dts/api/bindings/gpio/microchip,xec-gpio-v2.html
---

# microchip,xec-gpio-v2
...
[drivers/gpio/gpio\_mchp\_xec\_v2.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mchp_xec_v2.c).

## Description

```text
Microchip CEC/MEC GPIO V2 node
```
...
These property descriptions apply to “microchip,xec-gpio-v2”
...
| Name | Type | Details |
| --- | --- | --- |
| `port-id` | `int` | ```text Zero based GPIO port number ```  This property is **required**. |
| `girq-id` | `int` | ```text Aggregated GIRQ number for this bank of 32 GPIO pins. ```  This property is **required**. |
...
may apply to the “microchip,xec-gpio-v2” compatible.
