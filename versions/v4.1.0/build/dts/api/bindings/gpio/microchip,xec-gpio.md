---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,xec-gpio.html
original_path: build/dts/api/bindings/gpio/microchip,xec-gpio.html
---
...
[drivers/gpio/gpio\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mchp_xec.c).

## Description

```text
Microchip CEC/MEC GPIO node
```
...
These property descriptions apply to “microchip,xec-gpio”
...
may apply to the “microchip,xec-gpio” compatible.
