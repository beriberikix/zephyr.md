---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nordic,npm2100-gpio.html
original_path: build/dts/api/bindings/gpio/nordic,npm2100-gpio.html
---
...
[drivers/gpio/gpio\_npm2100.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_npm2100.c).

## Description

```text
nPM2100 GPIO Controller
```
...
These property descriptions apply to “nordic,npm2100-gpio”
...
may apply to the “nordic,npm2100-gpio” compatible.
