---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/ti,sn74hc595.html
original_path: build/dts/api/bindings/gpio/ti,sn74hc595.html
---

# ti,sn74hc595 (on spi bus)
...
[drivers/gpio/gpio\_sn74hc595.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_sn74hc595.c).
...
These property descriptions apply to “ti,sn74hc595”
...
| `ngpios` | `int` | ```text Number of supported gpios ```  This property is **required**.  Default value: `32`  Constant value: `8` |
...
may apply to the “ti,sn74hc595” compatible.
