---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/silabs,siwx91x-gpio.html
original_path: build/dts/api/bindings/gpio/silabs,siwx91x-gpio.html
---
...
[drivers/gpio/gpio\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_silabs_siwx91x.c).

## Description

```text
Silabs SiWx91x GPIO node
```
...
| Name | Type | Details |
| --- | --- | --- |
| `silabs,ulp` | `boolean` | ```text If this property is set, the GPIO controller uses ULP (ultra low power) pads. ``` |
...
may apply to the “silabs,siwx91x-gpio” compatible.
