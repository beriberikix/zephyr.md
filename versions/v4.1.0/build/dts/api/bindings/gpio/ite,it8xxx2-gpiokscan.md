---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/ite,it8xxx2-gpiokscan.html
original_path: build/dts/api/bindings/gpio/ite,it8xxx2-gpiokscan.html
---

# ite,it8xxx2-gpiokscan
...
[drivers/gpio/gpio\_kscan\_ite\_it8xxx2.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_kscan_ite_it8xxx2.c).

## Description

```text
This binding gives a base representation of the ITE kscan pins as gpio
```
...
These property descriptions apply to “ite,it8xxx2-gpiokscan”
...
may apply to the “ite,it8xxx2-gpiokscan” compatible.
