---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/ti,cc23x0-gpio.html
original_path: build/dts/api/bindings/gpio/ti,cc23x0-gpio.html
---
...
[drivers/gpio/gpio\_cc23x0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_cc23x0.c).

## Description

```text
TI SimpleLink CC23X0 GPIO node
```
...
These property descriptions apply to “ti,cc23x0-gpio”
...
may apply to the “ti,cc23x0-gpio” compatible.
