---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,pcal6408a.html
original_path: build/dts/api/bindings/gpio/nxp,pcal6408a.html
---

# nxp,pcal6408a (on i2c bus)
...
[drivers/gpio/gpio\_pcal64xxa.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_pcal64xxa.c).

## Description

```text
PCAL6408A 8-bit I2C-based I/O expander
```
...
These property descriptions apply to “nxp,pcal6408a”
...
may apply to the “nxp,pcal6408a” compatible.
