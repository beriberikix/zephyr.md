---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/snps,creg-gpio.html
original_path: build/dts/api/bindings/gpio/snps,creg-gpio.html
---
...
[drivers/gpio/gpio\_creg\_gpio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_creg_gpio.c).

## Description

```text
Synopsys CREG GPIO node
```
...
These property descriptions apply to “snps,creg-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `bit-per-gpio` | `int` | This property is **required**. |
| `off-val` | `int` | This property is **required**. |
| `on-val` | `int` | This property is **required**. |
...
may apply to the “snps,creg-gpio” compatible.
