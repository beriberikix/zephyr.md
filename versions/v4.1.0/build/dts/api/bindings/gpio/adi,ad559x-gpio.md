---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/adi,ad559x-gpio.html
original_path: build/dts/api/bindings/gpio/adi,ad559x-gpio.html
---
...
[drivers/gpio/gpio\_ad559x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ad559x.c).

## Description

```text
AD559x GPIO Controller
```
...
These property descriptions apply to “adi,ad559x-gpio”
...
may apply to the “adi,ad559x-gpio” compatible.
