---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/stemma-qt-connector.html
original_path: build/dts/api/bindings/gpio/stemma-qt-connector.html
---
...
may apply to the “stemma-qt-connector” compatible.
