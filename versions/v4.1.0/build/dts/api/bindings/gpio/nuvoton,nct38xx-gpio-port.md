---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nuvoton,nct38xx-gpio-port.html
original_path: build/dts/api/bindings/gpio/nuvoton,nct38xx-gpio-port.html
---

# nuvoton,nct38xx-gpio-port
...
[drivers/gpio/gpio\_nct38xx\_port.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_nct38xx_port.c).

## Description

```text
Nuvoton NCT38XX series I2C-based GPIO expander port
```
...
These property descriptions apply to “nuvoton,nct38xx-gpio-port”
...
| Name | Type | Details |
| --- | --- | --- |
| `pin-mask` | `int` | ```text Not every GPIOs are usable for different NCT38XX series. This property indicates the usable GPIO mask.  NCT3808: <0xdc> others: <0xff> ```  This property is **required**. |
| `pinmux-mask` | `int` | ```text NCT38XX series port 0 has Pin Multiplexing functionality. However, not every GPIOs have pinmux controller functionality. This property indicates the usable GPIO pinmux mask. For port 1, this property is ignored.  NCT3807 port 0: <0xf7> others: <0xff> ``` |
...
may apply to the “nuvoton,nct38xx-gpio-port” compatible.
