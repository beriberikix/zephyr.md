---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/silabs,siwx91x-gpio-uulp.html
original_path: build/dts/api/bindings/gpio/silabs,siwx91x-gpio-uulp.html
---
...
[drivers/gpio/gpio\_silabs\_siwx91x\_uulp.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_silabs_siwx91x_uulp.c).

## Description

```text
Silabs SiWx91x UULP (ultra ultra low power) GPIO port node
```
...
These property descriptions apply to “silabs,siwx91x-gpio-uulp”
...
may apply to the “silabs,siwx91x-gpio-uulp” compatible.
