---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,pca9555.html
original_path: build/dts/api/bindings/gpio/nxp,pca9555.html
---

# nxp,pca9555 (on i2c bus)
...
```text
NXP PCA9555 I2C GPIO expander node
```
...
These property descriptions apply to “nxp,pca9555”
...
may apply to the “nxp,pca9555” compatible.
