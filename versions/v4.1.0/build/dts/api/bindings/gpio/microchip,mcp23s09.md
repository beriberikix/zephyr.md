---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,mcp23s09.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23s09.html
---

# microchip,mcp23s09 (on spi bus)
...
[drivers/gpio/gpio\_mcp23sxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mcp23sxx.c).

## Description

```text
This is a representation of the Microchip MCP23S09 SPI GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23s09”
...
may apply to the “microchip,mcp23s09” compatible.
