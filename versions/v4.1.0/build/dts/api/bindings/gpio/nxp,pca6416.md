---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,pca6416.html
original_path: build/dts/api/bindings/gpio/nxp,pca6416.html
---

# nxp,pca6416 (on i2c bus)
...
[drivers/gpio/gpio\_pca6416.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_pca6416.c).

## Description

```text
Base binding for PCA6416 I2C-based GPIO expander
```
...
These property descriptions apply to “nxp,pca6416”
...
| Name | Type | Details |
| --- | --- | --- |
| `interrupt-gpios` | `phandle-array` | ```text Interrupt GPIO pin (active-low open-drain) Left blank if the pin is not connected in your application. ``` |
...
may apply to the “nxp,pca6416” compatible.
