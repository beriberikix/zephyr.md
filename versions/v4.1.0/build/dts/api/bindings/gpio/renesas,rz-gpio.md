---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/renesas,rz-gpio.html
original_path: build/dts/api/bindings/gpio/renesas,rz-gpio.html
---
...
[drivers/gpio/gpio\_renesas\_rz.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_renesas_rz.c).
...
These property descriptions apply to “renesas,rz-gpio”
...
may apply to the “renesas,rz-gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text GPIO port number ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
