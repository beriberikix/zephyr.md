---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/ti,davinci-gpio.html
original_path: build/dts/api/bindings/gpio/ti,davinci-gpio.html
---
...
[drivers/gpio/gpio\_davinci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_davinci.c).

## Description

```text
GPIO controller for Davinci and Keystone devices.
```
...
These property descriptions apply to “ti,davinci-gpio”
...
may apply to the “ti,davinci-gpio” compatible.
