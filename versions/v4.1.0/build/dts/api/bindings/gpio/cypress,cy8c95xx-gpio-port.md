---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/cypress,cy8c95xx-gpio-port.html
original_path: build/dts/api/bindings/gpio/cypress,cy8c95xx-gpio-port.html
---

# cypress,cy8c95xx-gpio-port
...
[drivers/gpio/gpio\_cy8c95xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_cy8c95xx.c).

## Description

```text
Cypress cy8c95xx GPIO port node
```
...
These property descriptions apply to “cypress,cy8c95xx-gpio-port”
...
may apply to the “cypress,cy8c95xx-gpio-port” compatible.
