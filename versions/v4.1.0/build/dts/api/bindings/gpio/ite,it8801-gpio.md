---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/ite,it8801-gpio.html
original_path: build/dts/api/bindings/gpio/ite,it8801-gpio.html
---
...
[drivers/gpio/gpio\_ite\_it8801.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ite_it8801.c).

## Description

```text
ITE IT8801 I2C-based GPIO device driver
```
...
These property descriptions apply to “ite,it8801-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `pin-mask` | `int` | ```text Not every GPIO pins are usable for IT8801. This property indicates the usable GPIO pin mask. ```  This property is **required**. |
...
may apply to the “ite,it8801-gpio” compatible.
