---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,mec5-gpio.html
original_path: build/dts/api/bindings/gpio/microchip,mec5-gpio.html
---
...
[drivers/gpio/gpio\_mchp\_mec5.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mchp_mec5.c).

## Description

```text
Microchip MEC5 GPIO node
```
...
These property descriptions apply to “microchip,mec5-gpio”
...
may apply to the “microchip,mec5-gpio” compatible.
