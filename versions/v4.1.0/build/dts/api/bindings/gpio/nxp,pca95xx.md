---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,pca95xx.html
original_path: build/dts/api/bindings/gpio/nxp,pca95xx.html
---

# nxp,pca95xx (on i2c bus)
...
[drivers/gpio/gpio\_pca95xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_pca95xx.c).

## Description

```text
PCA95xx series I2C-based GPIO expander
```
...
These property descriptions apply to “nxp,pca95xx”
...
| Name | Type | Details |
| --- | --- | --- |
| `has-pud` | `boolean` | ```text Supports pull-up/pull-down ``` |
| `has-interrupt-mask-reg` | `boolean` | ```text Has Interrupt mask register (PCAL95xx) ``` |
| `interrupt-gpios` | `phandle-array` | ```text Interrupt GPIO pin (active-low open-drain) ``` |
...
may apply to the “nxp,pca95xx” compatible.
