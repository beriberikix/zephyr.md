---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/xlnx,xps-gpio-1.00.a.html
original_path: build/dts/api/bindings/gpio/xlnx,xps-gpio-1.00.a.html
---
...
[drivers/gpio/gpio\_xlnx\_axi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_xlnx_axi.c).
...
These property descriptions apply to “xlnx,xps-gpio-1.00.a”
...
| Name | Type | Details |
| --- | --- | --- |
| `xlnx,all-inputs` | `int` | ```text 1 if all GPIOs are inputs, 0 otherwise ``` |
| `xlnx,all-outputs` | `int` | ```text 1 if all GPIOs are outputs, 0 otherwise ``` |
| `xlnx,dout-default` | `int` | ```text Default output value. If n-th bit is 1, GPIO-n default value is 1. ``` |
| `xlnx,gpio-width` | `int` | ```text Number of GPIOs supported ``` |
| `xlnx,tri-default` | `int` | ```text Default tristate register value. If n-th bit is 1, GPIO-n is an input. ``` |
| `xlnx,is-dual` | `int` | ```text 1 if controller has GPIO2 enabled, 0 otherwise ``` |
| `xlnx,all-inputs-2` | `int` | ```text 1 if all GPIO2s are inputs, 0 otherwise ``` |
| `xlnx,all-outputs-2` | `int` | ```text 1 if all GPIO2s are outputs, 0 otherwise ``` |
| `xlnx,dout-default-2` | `int` | ```text Default output value. If n-th bit is 1, GPIO2-n default value is 1. ``` |
| `xlnx,gpio2-width` | `int` | ```text Number of GPIO2s supported ``` |
| `xlnx,tri-default-2` | `int` | ```text Default tristate register value. If n-th bit is 1, GPIO2-n is an input. ``` |
...
may apply to the “xlnx,xps-gpio-1.00.a” compatible.
