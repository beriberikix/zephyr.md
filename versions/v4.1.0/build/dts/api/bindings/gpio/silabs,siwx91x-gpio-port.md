---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/silabs,siwx91x-gpio-port.html
original_path: build/dts/api/bindings/gpio/silabs,siwx91x-gpio-port.html
---
...
These property descriptions apply to “silabs,siwx91x-gpio-port”
...
| `silabs,pads` | `uint8-array` | ```text Contains the map of what pad number is used for each GPIO. 0xFF if a GPIO has no pad. 0 if the pad is directly configured using port and pin number. ```  This property is **required**. |
...
may apply to the “silabs,siwx91x-gpio-port” compatible.
