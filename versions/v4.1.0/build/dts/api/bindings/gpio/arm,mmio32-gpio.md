---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/arm,mmio32-gpio.html
original_path: build/dts/api/bindings/gpio/arm,mmio32-gpio.html
---
...
[drivers/gpio/gpio\_mmio32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mmio32.c).
...
These property descriptions apply to “arm,mmio32-gpio”
...
| `#gpio-cells` | `int` | ```text Number of items to expect in a GPIO specifier ```  This property is **required**.  Constant value: `1` |
| `direction-input` | `boolean` | ```text Marks this pin set as all input pins. ``` |
...
may apply to the “arm,mmio32-gpio” compatible.
