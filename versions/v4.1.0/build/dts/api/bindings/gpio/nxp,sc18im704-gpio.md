---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,sc18im704-gpio.html
original_path: build/dts/api/bindings/gpio/nxp,sc18im704-gpio.html
---

# nxp,sc18im704-gpio (on nxp,sc18im704 bus)
...
[drivers/gpio/gpio\_sc18im704.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_sc18im704.c).

## Description

```text
GPIO controller part for the SC18IM704 bridge
```
...
These property descriptions apply to “nxp,sc18im704-gpio”
...
may apply to the “nxp,sc18im704-gpio” compatible.
