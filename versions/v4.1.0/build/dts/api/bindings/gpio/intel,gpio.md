---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/intel,gpio.html
original_path: build/dts/api/bindings/gpio/intel,gpio.html
---
...
[drivers/gpio/gpio\_intel.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_intel.c).
...
These property descriptions apply to “intel,gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `group-index` | `int` | ```text Group number for this GPIO entry ``` |
| `ngpios` | `int` | ```text Number of pins for this GPIO entry ```  Default value: `32` |
| `pin-offset` | `int` | ```text Pin offset of this GPIO entry ``` |
...
may apply to the “intel,gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text reg properties not required if acpi enumerated ```  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
| `interrupts` | `array` | ```text interrupts properties not required if acpi enumerated ```  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
