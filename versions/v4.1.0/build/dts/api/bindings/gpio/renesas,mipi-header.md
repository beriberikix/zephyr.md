---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/renesas,mipi-header.html
original_path: build/dts/api/bindings/gpio/renesas,mipi-header.html
---
...
may apply to the “renesas,ra-gpio-mipi-header” compatible.
