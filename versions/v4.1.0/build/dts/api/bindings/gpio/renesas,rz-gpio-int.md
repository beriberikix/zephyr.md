---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/renesas,rz-gpio-int.html
original_path: build/dts/api/bindings/gpio/renesas,rz-gpio-int.html
---
...
may apply to the “renesas,rz-gpio-int” compatible.
