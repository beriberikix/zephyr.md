---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/awinic,aw9523b-gpio.html
original_path: build/dts/api/bindings/gpio/awinic,aw9523b-gpio.html
---

# awinic,aw9523b-gpio (on aw9523b bus)

Vendor: [Shanghai Awinic Technology Co., Ltd.](../../bindings.md#dt-vendor-awinic)

Note

An implementation of a driver matching this compatible is available in
[drivers/gpio/gpio\_aw9523b.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_aw9523b.c).

## Description

```text
AW9523B GPIO Controller
```
...
These property descriptions apply to “awinic,aw9523b-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Set GPIO connected to the controller INTN pin. This is used for notifying interruption. ``` |
| `reset-gpios` | `phandle-array` | ```text Set GPIO connected to the controller RSTN pin. This is used for controlling resets via GPIO. ``` |
| `port0-push-pull` | `boolean` | ```text Configure Port0 to Push-Pull mode. Port0 is worked in Open-Drain mode by default. ``` |
...
may apply to the “awinic,aw9523b-gpio” compatible.
