---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/can/atmel,sam-can.html
original_path: build/dts/api/bindings/can/atmel,sam-can.html
---
...
[drivers/can/can\_sam.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_sam.c).
...
These property descriptions apply to “atmel,sam-can”
...
| Name | Type | Details |
| --- | --- | --- |
| `divider` | `int` | ```text Clock divider for the CAN core clock ```  This property is **required**.  Legal values: `6`, `12`, `24` |
...
may apply to the “atmel,sam-can” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text 2 reg blocks needed; Register block for the MCAN configuration registers; Register block for the DMA Base Address ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
| `reg-names` | `string-array` | ```text description of reg blocks ```  This property is **required**. |
...
| `interrupt-names` | `string-array` | ```text Optional names given to each interrupt generated by a device. The interrupts themselves are defined in either "interrupts" or "interrupts-extended" properties.  For details, see "2.4 Interrupts and Interrupt Mapping" in Devicetree Specification v0.4. ```  This property is **required**. |
