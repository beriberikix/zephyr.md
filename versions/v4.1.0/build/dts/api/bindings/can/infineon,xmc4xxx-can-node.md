---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/can/infineon,xmc4xxx-can-node.html
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-div8` | `boolean` | ```text Option enables clock divide by a factor of 8. ``` |
