---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/can/renesas,ra-canfd-global.html
...
| Name | Type | Details |
| --- | --- | --- |
| `dll-min-freq` | `int` | ```text Specifies the Data Link Layer clock limit on this device: DLL clock frequency > dll-min-freq. ``` |
| `dll-max-freq` | `int` | ```text Specifies the Data Link Layer clock limit on this device: DLL clock frequency < dll-max-freq. ``` |
