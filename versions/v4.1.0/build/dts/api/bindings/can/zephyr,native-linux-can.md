---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/can/zephyr,native-linux-can.html
original_path: build/dts/api/bindings/can/zephyr,native-linux-can.html
---
...
[drivers/can/can\_native\_linux.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_native_linux.c).
...
These property descriptions apply to “zephyr,native-linux-can”
...
| Name | Type | Details |
| --- | --- | --- |
| `host-interface` | `string` | ```text Linux host interface name (e.g. zcan0, vcan0, can0, ...). This property can be overridden using the --can-if command-line option. Note that it applies for every instance of this driver. ```  This property is **required**. |
...
may apply to the “zephyr,native-linux-can” compatible.
