---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mdio/infineon,xmc4xxx-mdio.html
original_path: build/dts/api/bindings/mdio/infineon,xmc4xxx-mdio.html
---
...
[drivers/mdio/mdio\_xmc4xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_xmc4xxx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `mdi-port-ctrl` | `string` | ```text The MDIO input is connected to several port/pins via a mux. This is not handled by pinctrl because the mux is located at the peripheral and not GPIO. The possible connections are defined by an enum. ```  This property is **required**.  Legal values: `'P0_9'`, `'P2_0'`, `'P1_11'` |
...
may apply to the “infineon,xmc4xxx-mdio” compatible.
