---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mdio/nxp,imx-netc-emdio.html
original_path: build/dts/api/bindings/mdio/nxp,imx-netc-emdio.html
---
...
[drivers/mdio/mdio\_nxp\_imx\_netc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_nxp_imx_netc.c).
...
```text
NXP i.MX NETC External MDIO controller
```
...
may apply to the “nxp,imx-netc-emdio” compatible.
