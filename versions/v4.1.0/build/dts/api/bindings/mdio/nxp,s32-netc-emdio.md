---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mdio/nxp,s32-netc-emdio.html
original_path: build/dts/api/bindings/mdio/nxp,s32-netc-emdio.html
---
...
[drivers/mdio/mdio\_nxp\_s32\_netc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_nxp_s32_netc.c).
...
```text
NXP S32 NETC External MDIO controller
```
...
may apply to the “nxp,s32-netc-emdio” compatible.
