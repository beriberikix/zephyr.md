---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/nuvoton,npcx-adc.html
original_path: build/dts/api/bindings/adc/nuvoton,npcx-adc.html
---
...
[drivers/adc/adc\_npcx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_npcx.c).

## Description

```text
Nuvoton, NPCX-ADC node
```
...
These property descriptions apply to “nuvoton,npcx-adc”
...
| `threshold-count` | `int` | ```text the number of threshold detectors adc supports ```  This property is **required**. |
...
may apply to the “nuvoton,npcx-adc” compatible.
