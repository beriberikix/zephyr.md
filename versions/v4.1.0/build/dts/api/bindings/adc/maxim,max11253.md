---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/maxim,max11253.html
original_path: build/dts/api/bindings/adc/maxim,max11253.html
---

# maxim,max11253 (on spi bus)
...
[drivers/adc/adc\_max1125x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_max1125x.c).

## Description

```text
Maxim Integrated MAX11253 SPI ADC
```
...
These property descriptions apply to “maxim,max11253”
...
| `gpio0-enable` | `boolean` | ```text this option for gpio0 enable or disable ``` |
| `gpio1-enable` | `boolean` | ```text this option for gpio1 enable or disable ``` |
| `gpio0-direction` | `boolean` | ```text this option for gpio0 direction enable for input, disable for output ``` |
| `gpio1-direction` | `boolean` | ```text this option for gpio0 direction enable for input, disable for output ``` |
| `gpo0-enable` | `boolean` | ```text this option for gpo0 enable or disable ``` |
| `gpo1-enable` | `boolean` | ```text this option for gpo1 enable or disable ``` |
...
| `self-calibration` | `boolean` | ```text start self calibration during channel setup ``` |
...
may apply to the “maxim,max11253” compatible.
