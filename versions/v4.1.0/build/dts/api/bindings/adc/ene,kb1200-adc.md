---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ene,kb1200-adc.html
original_path: build/dts/api/bindings/adc/ene,kb1200-adc.html
---
...
[drivers/adc/adc\_ene\_kb1200.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ene_kb1200.c).

## Description

```text
ENE KB1200 ADC controller
```
...
These property descriptions apply to “ene,kb1200-adc”
...
may apply to the “ene,kb1200-adc” compatible.
