---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,lmp90100.html
original_path: build/dts/api/bindings/adc/ti,lmp90100.html
---

# ti,lmp90100 (on spi bus)
...
```text
Texas Instruments LMP90100 AFE binding
```
...
These property descriptions apply to “ti,lmp90100”
...
| Name | Type | Details |
| --- | --- | --- |
| `rtd-current` | `int` | ```text RTD current in microampere ``` |
...
may apply to the “ti,lmp90100” compatible.
