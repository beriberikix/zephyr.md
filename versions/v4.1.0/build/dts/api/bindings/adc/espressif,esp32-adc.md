---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/espressif,esp32-adc.html
original_path: build/dts/api/bindings/adc/espressif,esp32-adc.html
---
...
[drivers/adc/adc\_esp32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_esp32.c).
...
These property descriptions apply to “espressif,esp32-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `unit` | `int` | ```text ADC unit number. Possible values are 1,2,.. depending on chip. ```  This property is **required**. |
...
may apply to the “espressif,esp32-adc” compatible.
