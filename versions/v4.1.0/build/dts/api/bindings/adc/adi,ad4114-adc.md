---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/adi,ad4114-adc.html
original_path: build/dts/api/bindings/adc/adi,ad4114-adc.html
---

# adi,ad4114-adc (on spi bus)
...
[drivers/adc/adc\_ad4114.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ad4114.c).

## Description

```text
Binding for the ADI AD4114 ADC.
```
...
These property descriptions apply to “adi,ad4114-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `map-inputs` | `array` | ```text Array of 16 values corresponding to CHANNEL REGISTER 0 TO CHANNEL REGISTER 15. ```  This property is **required**. |
...
may apply to the “adi,ad4114-adc” compatible.
