---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,lmp90078.html
original_path: build/dts/api/bindings/adc/ti,lmp90078.html
---

# ti,lmp90078 (on spi bus)
...
```text
Texas Instruments LMP90078 AFE binding
```
...
These property descriptions apply to “ti,lmp90078”
...
may apply to the “ti,lmp90078” compatible.
