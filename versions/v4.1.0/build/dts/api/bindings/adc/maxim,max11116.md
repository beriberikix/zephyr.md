---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/maxim,max11116.html
original_path: build/dts/api/bindings/adc/maxim,max11116.html
---

# maxim,max11116 (on spi bus)
...
```text
Maxim Integrated 1 channel 8 bit 3 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11116”
...
may apply to the “maxim,max11116” compatible.
