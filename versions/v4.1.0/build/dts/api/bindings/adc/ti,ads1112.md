---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,ads1112.html
original_path: build/dts/api/bindings/adc/ti,ads1112.html
---

# ti,ads1112 (on i2c bus)
...
[drivers/adc/adc\_ads1112.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ads1112.c).

## Description

```text
Texas Instrument ADS1112 I2C ADC
```
...
These property descriptions apply to “ti,ads1112”
...
| `alert-rdy-gpios` | `phandle-array` | ```text Interrupt pin. Comparator output or conversion ready ``` |
...
may apply to the “ti,ads1112” compatible.
