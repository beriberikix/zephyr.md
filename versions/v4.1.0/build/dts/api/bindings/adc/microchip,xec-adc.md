---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/microchip,xec-adc.html
...
| `channels` | `int` | ```text Number of ADC channels supported by SoC ```  This property is **required**. |
