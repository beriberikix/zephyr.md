---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/maxim,max11103.html
original_path: build/dts/api/bindings/adc/maxim,max11103.html
---

# maxim,max11103 (on spi bus)
...
[drivers/adc/adc\_max11102\_17.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_max11102_17.c).

## Description

```text
Maxim Integrated 2 channels 12 bit 3 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11103”
...
| Name | Type | Details |
| --- | --- | --- |
| `chsel-gpios` | `phandle-array` | ```text GPIO for channel selection ``` |
...
may apply to the “maxim,max11103” compatible.
