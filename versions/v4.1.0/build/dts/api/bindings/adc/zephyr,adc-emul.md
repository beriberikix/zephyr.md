---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/zephyr,adc-emul.html
original_path: build/dts/api/bindings/adc/zephyr,adc-emul.html
---
...
[drivers/adc/adc\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_emul.c).
...
These property descriptions apply to “zephyr,adc-emul”
...
| Name | Type | Details |
| --- | --- | --- |
| `nchannels` | `int` | ```text Number of emulated ADC channels. Should be in 1-32 range. ```  This property is **required**. |
| `ref-internal-mv` | `int` | ```text Internal reference voltage in mV. If not provided or set to zero, channel setup with ADC_REF_INTERNAL will fail. ``` |
| `ref-vdd-mv` | `int` | ```text VDD reference voltage in mV. If not provided or set to zero, channel setup with ADC_REF_VDD_X will fail. ``` |
| `ref-external0-mv` | `int` | ```text External 0 reference voltage in mV. If not provided or set to zero, channel setup with ADC_REF_EXTERNAL0 will fail. ``` |
| `ref-external1-mv` | `int` | ```text External 1 reference voltage in mV. If not provided or set to zero, channel setup with ADC_REF_EXTERNAL1 will fail. ``` |
| `#io-channel-cells` | `int` | This property is **required**. |
