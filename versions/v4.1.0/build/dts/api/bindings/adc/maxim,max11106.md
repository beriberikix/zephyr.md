---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/maxim,max11106.html
original_path: build/dts/api/bindings/adc/maxim,max11106.html
---

# maxim,max11106 (on spi bus)
...
```text
Maxim Integrated 2 channels 10 bit 3 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11106”
...
may apply to the “maxim,max11106” compatible.
