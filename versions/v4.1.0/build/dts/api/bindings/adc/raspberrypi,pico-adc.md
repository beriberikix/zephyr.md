---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/raspberrypi,pico-adc.html
original_path: build/dts/api/bindings/adc/raspberrypi,pico-adc.html
---
...
[drivers/adc/adc\_rpi\_pico.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_rpi_pico.c).
...
These property descriptions apply to “raspberrypi,pico-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `vref-mv` | `int` | ```text Indicate the reference voltage of the ADC in mV. Raspberry Pi has one voltage reference. And it is usually connected to VDD. In such case, set this property to the VDD (in mV) value. ```  Default value: `3300` |
...
may apply to the “raspberrypi,pico-adc” compatible.
