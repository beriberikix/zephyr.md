---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/maxim,max11102.html
original_path: build/dts/api/bindings/adc/maxim,max11102.html
---

# maxim,max11102 (on spi bus)
...
```text
Maxim Integrated 2 channels 12 bit 2 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11102”
...
may apply to the “maxim,max11102” compatible.
