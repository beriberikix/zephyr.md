---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mfd/rohm,bd8lb600fs.html
original_path: build/dts/api/bindings/mfd/rohm,bd8lb600fs.html
---

# rohm,bd8lb600fs (on spi bus)
...
[drivers/mfd/mfd\_bd8lb600fs.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mfd/mfd_bd8lb600fs.c).

## Description

These nodes are “bd8lb600fs” bus nodes.

```text
Rohm BD8LB600FS SPI Gpio Expander MFD
```
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text GPIO for reset ```  This property is **required**. |
| `instance-count` | `int` | ```text number of daisy chained instances, defaults to no daisy chaining ```  This property is **required**.  Default value: `1`  Legal values: `1`, `2`, `3`, `4` |
...
may apply to the “rohm,bd8lb600fs” compatible.
