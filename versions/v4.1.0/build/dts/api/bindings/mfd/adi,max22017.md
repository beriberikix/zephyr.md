---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mfd/adi,max22017.html
original_path: build/dts/api/bindings/mfd/adi,max22017.html
---

# adi,max22017 (on spi bus)
...
[drivers/mfd/mfd\_max22017.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mfd/mfd_max22017.c).

## Description

```text
Analog MAX22017 DAC/GPIO chip common properties
```
...
| Name | Type | Details |
| --- | --- | --- |
| `rst-gpios` | `phandle-array` | ```text Reset pin for max22017. ``` |
| `crc-mode` | `boolean` | ```text Enables CRC over SPI. ``` |
| `int-gpios` | `phandle-array` | ```text Interrupt gpio ``` |
...
may apply to the “adi,max22017” compatible.
