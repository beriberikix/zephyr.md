---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mfd/ite,it8801-mfd.html
original_path: build/dts/api/bindings/mfd/ite,it8801-mfd.html
---
...
[drivers/mfd/mfd\_ite\_it8801.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mfd/mfd_ite_it8801.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `irq-gpios` | `phandle-array` | ```text An interrupt can be asserted on SMB_INT# pin to notify the host-side since an effective interrupt occurs. ```  This property is **required**. |
...
may apply to the “ite,it8801-mfd” compatible.
