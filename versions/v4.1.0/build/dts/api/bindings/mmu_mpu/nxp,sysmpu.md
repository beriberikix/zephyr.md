---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mmu_mpu/nxp,sysmpu.html
original_path: build/dts/api/bindings/mmu_mpu/nxp,sysmpu.html
---
...
```text
NXP System Memory Protection Unit (SYSMPU)
```
...
may apply to the “nxp,sysmpu” compatible.
