---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/fujitsu,mb85rsxx.html
original_path: build/dts/api/bindings/mtd/fujitsu,mb85rsxx.html
---

# fujitsu,mb85rsxx (on spi bus)
...
[drivers/eeprom/eeprom\_mb85rsxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/eeprom/eeprom_mb85rsxx.c).

## Description

```text
Fujitsu MB85RSXX SPI FRAM
```
...
may apply to the “fujitsu,mb85rsxx” compatible.
