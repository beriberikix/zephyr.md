---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/zephyr,mspi-emul-flash.html
original_path: build/dts/api/bindings/mtd/zephyr,mspi-emul-flash.html
---

# zephyr,mspi-emul-flash (on mspi bus)
...
[drivers/flash/flash\_mspi\_emul\_device.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/flash_mspi_emul_device.c).

## Description

```text
Zephyr MSPI flash emulator
```
...
may apply to the “zephyr,mspi-emul-flash” compatible.
