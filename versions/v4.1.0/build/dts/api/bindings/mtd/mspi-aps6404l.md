---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/mspi-aps6404l.html
original_path: build/dts/api/bindings/mtd/mspi-aps6404l.html
---

# mspi-aps6404l (on mspi bus)
...
[drivers/memc/memc\_mspi\_aps6404l.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mspi_aps6404l.c).

## Description

```text
AP Memory APS6404L pSRAM on MSPI bus
```
...
may apply to the “mspi-aps6404l” compatible.
