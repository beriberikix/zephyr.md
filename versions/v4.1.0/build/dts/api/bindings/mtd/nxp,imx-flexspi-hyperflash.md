---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/nxp,imx-flexspi-hyperflash.html
original_path: build/dts/api/bindings/mtd/nxp,imx-flexspi-hyperflash.html
---

# nxp,imx-flexspi-hyperflash (on spi bus)
...
[drivers/flash/flash\_mcux\_flexspi\_hyperflash.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/flash_mcux_flexspi_hyperflash.c).

## Description

```text
NXP FlexSPI HyperFlash
```
...
may apply to the “nxp,imx-flexspi-hyperflash” compatible.
