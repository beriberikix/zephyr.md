---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/atmel,at24.html
original_path: build/dts/api/bindings/mtd/atmel,at24.html
---
...
[drivers/eeprom/eeprom\_at2x\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/eeprom/eeprom_at2x_emul.c).
...
| `pagesize` | `int` | ```text EEPROM page size in bytes ```  This property is **required**. |
| `address-width` | `int` | ```text EEPROM address width in bits ```  This property is **required**. |
| `timeout` | `int` | ```text EEPROM write cycle timeout in milliseconds ```  This property is **required**. |
| `wp-gpios` | `phandle-array` | ```text GPIO to which the write-protect pin of the chip is connected.  The device will interpret this signal as active-low. ``` |
...
may apply to the “atmel,at24” compatible.
