---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/nxp,imx-flexspi-aps6408l.html
original_path: build/dts/api/bindings/mtd/nxp,imx-flexspi-aps6408l.html
---

# nxp,imx-flexspi-aps6408l (on spi bus)
...
[drivers/memc/memc\_mcux\_flexspi\_aps6408l.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mcux_flexspi_aps6408l.c).

## Description

```text
AP Memory APS6408L pSRAM on NXP FlexSPI bus
```
...
may apply to the “nxp,imx-flexspi-aps6408l” compatible.
