---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mtd/nxp,imx-flexspi-w956a8mbya.html
original_path: build/dts/api/bindings/mtd/nxp,imx-flexspi-w956a8mbya.html
---

# nxp,imx-flexspi-w956a8mbya (on spi bus)
...
[drivers/memc/memc\_mcux\_flexspi\_w956a8mbya.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mcux_flexspi_w956a8mbya.c).

## Description

```text
Winbond W956A8MBYA HyperRAM on NXP FlexSPI bus
```
...
may apply to the “nxp,imx-flexspi-w956a8mbya” compatible.
