---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/i2c/nuvoton,npcx-i2c-ctrl.html
...
| Name | Type | Details |
| --- | --- | --- |
| `smb-wui` | `phandle` | ```text Mapping table between Wake-Up Input (WUI) and SMB module.  For example the WUI mapping on SMB 4 module would be    smb-wui = <&wui_smb4>; ```  This property is **required**. |
