---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/i2c/microchip,xec-i2c.html
...
| Name | Type | Details |
| --- | --- | --- |
| `port-sel` | `int` | ```text soc block mapping to pin ```  This property is **required**. |
