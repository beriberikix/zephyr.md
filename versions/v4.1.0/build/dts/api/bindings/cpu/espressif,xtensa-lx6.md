---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/cpu/espressif,xtensa-lx6.html
...
| `xtal-freq` | `int` | ```text Value of the external XTAL connected to ESP32. ```  This property is **required**.  Legal values: `40000000`, `32000000`, `26000000` |
