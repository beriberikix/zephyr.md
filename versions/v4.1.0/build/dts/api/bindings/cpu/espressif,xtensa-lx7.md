---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/cpu/espressif,xtensa-lx7.html
...
| `xtal-freq` | `int` | ```text Value of the external XTAL connected to ESP32. ```  This property is **required**.  Legal values: `40000000` |
