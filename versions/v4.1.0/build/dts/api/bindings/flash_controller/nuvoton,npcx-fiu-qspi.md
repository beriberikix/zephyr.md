---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/flash_controller/nuvoton,npcx-fiu-qspi.html
original_path: build/dts/api/bindings/flash_controller/nuvoton,npcx-fiu-qspi.html
---
...
[drivers/flash/flash\_npcx\_fiu\_qspi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/flash_npcx_fiu_qspi.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `en-direct-access-2dev` | `boolean` | ```text Two external SPI devices are supported for Direct Read Access (DRA) on QSPI bus. ``` |
| `flash-dev-inv` | `boolean` | ```text Inverse the device connected to the base address. ``` |
...
may apply to the “nuvoton,npcx-fiu-qspi” compatible.
