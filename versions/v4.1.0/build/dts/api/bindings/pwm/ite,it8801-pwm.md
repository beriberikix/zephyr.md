---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pwm/ite,it8801-pwm.html
original_path: build/dts/api/bindings/pwm/ite,it8801-pwm.html
---
...
[drivers/pwm/pwm\_ite\_it8801.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_ite_it8801.c).

## Description

```text
ITE IT8801 I2C-based PWM device driver
```
...
| Name | Type | Details |
| --- | --- | --- |
| `mfdctrl` | `phandle` | ```text Switching the pin to PWM alternate function. ```  This property is **required**. |
| `channel` | `int` | ```text 1 = PWM_CHANNEL_1, 2 = PWM_CHANNEL_2, 3 = PWM_CHANNEL_3, 4 = PWM_CHANNEL_4, 7 = PWM_CHANNEL_7, 8 = PWM_CHANNEL_8, 9 = PWM_CHANNEL_9 ```  This property is **required**.  Legal values: `1`, `2`, `3`, `4`, `7`, `8`, `9` |
...
may apply to the “ite,it8801-pwm” compatible.
