---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pwm/ite,it8xxx2-pwm.html
original_path: build/dts/api/bindings/pwm/ite,it8xxx2-pwm.html
---
...
[drivers/pwm/pwm\_ite\_it8xxx2.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_ite_it8xxx2.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `channel` | `int` | ```text 0 = PWM_CHANNEL_0, 1 = PWM_CHANNEL_1, 2 = PWM_CHANNEL_2, 3 = PWM_CHANNEL_3, 4 = PWM_CHANNEL_4, 5 = PWM_CHANNEL_5, 6 = PWM_CHANNEL_6, 7 = PWM_CHANNEL_7 ```  This property is **required**.  Legal values: `0`, `1`, `2`, `3`, `4`, `5`, `6`, `7` |
| `pwmctrl` | `phandle` | ```text PWM prescaler controller ```  This property is **required**. |
| `prescaler-cx` | `int` | ```text 1 = PWM_PRESCALER_C4, 2 = PWM_PRESCALER_C6, 3 = PWM_PRESCALER_C7 ```  This property is **required**.  Legal values: `1`, `2`, `3` |
| `pwm-output-frequency` | `int` | ```text PWM output frequency for operation ``` |
