---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pwm/atmel,sam0-tc-pwm.html
original_path: build/dts/api/bindings/pwm/atmel,sam0-tc-pwm.html
---
...
[drivers/pwm/pwm\_sam0\_tc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_sam0_tc.c).

## Description

```text
Atmel SAM0 TC in PWM mode
```
...
| `channels` | `int` | ```text Number of channels this TC has ```  This property is **required**.  Legal values: `2` |
| `counter-size` | `int` | ```text Width of the TC counter in bits ```  This property is **required**.  Legal values: `8`, `16` |
...
may apply to the “atmel,sam0-tc-pwm” compatible.
