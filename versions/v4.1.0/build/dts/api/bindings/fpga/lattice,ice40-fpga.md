---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/fpga/lattice,ice40-fpga.html
...
[drivers/fpga/fpga\_ice40\_spi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/fpga/fpga_ice40_spi.c).

## Description

```text
Lattice iCE40 FPGA SPI based driver
```
