---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/usb/ambiq,usb.html
original_path: build/dts/api/bindings/usb/ambiq,usb.html
---
...
[drivers/usb/udc/udc\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/udc/udc_ambiq.c).
...
| `vddusb33-gpios` | `phandle-array` | ```text Control VDDUSB33 via GPIO pin. ``` |
| `vddusb0p9-gpios` | `phandle-array` | ```text Control VDDUSB0P9 via GPIO pin. ``` |
...
may apply to the “ambiq,usb” compatible.
