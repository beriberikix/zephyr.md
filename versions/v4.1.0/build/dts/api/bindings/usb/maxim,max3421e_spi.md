---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/usb/maxim,max3421e_spi.html
original_path: build/dts/api/bindings/usb/maxim,max3421e_spi.html
---

# maxim,max3421e\_spi (on spi bus)
...
[drivers/usb/uhc/uhc\_max3421e.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/uhc/uhc_max3421e.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin of MAX3421E, active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
| `reset-gpios` | `phandle-array` | ```text RESET pin of MAX3421E, active low. If connected directly the MCU pin should be configured as active low. ``` |
...
may apply to the “maxim,max3421e\_spi” compatible.
