---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dai/nxp,dai-micfil.html
original_path: build/dts/api/bindings/dai/nxp,dai-micfil.html
---
...
[drivers/dai/nxp/micfil/micfil.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dai/nxp/micfil/micfil.c).
...
| `fifo-depth` | `int` | ```text Depth (in words) for each channel's FIFO. ```  This property is **required**. |
...
may apply to the “nxp,dai-micfil” compatible.
