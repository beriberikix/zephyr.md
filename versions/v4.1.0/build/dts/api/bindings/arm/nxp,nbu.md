---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/arm/nxp,nbu.html
original_path: build/dts/api/bindings/arm/nxp,nbu.html
---
...
[soc/nxp/common/nxp\_nbu.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/nxp/common/nxp_nbu.c).

## Description

```text
NXP NBU interruption information
```
...
| Name | Type | Details |
| --- | --- | --- |
| `nbu-name` | `string` | ```text Name of the Narrow Band Unit interruption initialization ```  Default value: `NBU NXP` |
...
may apply to the “nxp,nbu” compatible.
