---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/lora/semtech,sx1261.html
original_path: build/dts/api/bindings/lora/semtech,sx1261.html
---

# semtech,sx1261 (on spi bus)
...
[drivers/lora](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/lora).

## Description

```text
Semtech SX1261 LoRa Modem
```
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text GPIO connected to the modem's NRESET signal.  This signal is open-drain, active-low as interpreted by the modem. ```  This property is **required**. |
| `busy-gpios` | `phandle-array` | ```text GPIO connected to the modem's BUSY signal. ```  This property is **required**. |
| `dio1-gpios` | `phandle-array` | ```text GPIO connected to DIO1. This GPIO will be used as a generic IRQ line from the chip. ```  This property is **required**. |
...
may apply to the “semtech,sx1261” compatible.
