---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/smbus/st,stm32-smbus.html
original_path: build/dts/api/bindings/smbus/st,stm32-smbus.html
---
...
[drivers/smbus/smbus\_stm32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/smbus/smbus_stm32.c).

## Description

These nodes are “smbus” bus nodes.
...
| Name | Type | Details |
| --- | --- | --- |
| `i2c` | `phandle` | ```text I2C device which maps to the same address ```  This property is **required**. |
...
may apply to the “st,stm32-smbus” compatible.
