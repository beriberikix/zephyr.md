---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/regulator/nordic,npm2100-regulator.html
original_path: build/dts/api/bindings/regulator/nordic,npm2100-regulator.html
---
...
[drivers/regulator/regulator\_npm2100.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/regulator/regulator_npm2100.c).
...
These property descriptions apply to “nordic,npm2100-regulator”
...
| Name | Type | Details |
| --- | --- | --- |
| `dvs-gpios` | `phandle-array` | ```text List of SOC GPIOs connected to PMIC GPIOs. Set_dvs_mode will drive these pins as follows:   DVS mode 1 will enable the first pin   DVS mode 2 will enable the second pin The effect of the mode change is defined by the mode-gpios fields for each of the regulator blocks. ``` |
...
may apply to the “nordic,npm2100-regulator” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `mode-gpios` | `phandle-array` | ```text Regulator mode controlled by specified regulator GPIO pin. ``` |
| `ldosw-wd-reset` | `boolean` | ```text LDOSW turned off by watchdog reset. ``` |
| `dps-timer-us` | `int` | ```text Interval between DPS refresh cycles in microseconds. ```  Legal values: `100`, `200`, `400`, `800` |
| `dps-pulse-limit` | `int` | ```text DPS coil pulse limit per refresh cycle. ``` |
