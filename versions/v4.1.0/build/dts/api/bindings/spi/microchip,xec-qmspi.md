---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/spi/microchip,xec-qmspi.html
original_path: build/dts/api/bindings/spi/microchip,xec-qmspi.html
---
...
[drivers/spi/spi\_xec\_qmspi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_xec_qmspi.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `port_sel` | `int` | ```text SPI Port 0 or 1. ```  This property is **required**. |
...
| `rxdma` | `int` | ```text Receive DMA channel ```  This property is **required**. |
| `txdma` | `int` | ```text Transmit DMA channel ```  This property is **required**. |
| `lines` | `int` | ```text QMSPI lines 1, 2, or 4 ```  This property is **required**. |
| `chip_select` | `int` | ```text Use QMSPI CS0# or CS1# ```  This property is **required**. |
| `dcsckon` | `int` | ```text Delay in system clocks from CS# assertion to first clock edge ```  This property is **required**. |
| `dckcsoff` | `int` | ```text Delay in system clocks from last clock edge to CS# de-assertion ```  This property is **required**. |
| `dldh` | `int` | ```text Delay in system clocks from CS# de-assertion to driving HOLD# and WP# ```  This property is **required**. |
| `dcsda` | `int` | ```text Delay in system clocks from CS# de-assertion to CS# assertion ```  This property is **required**. |
...
may apply to the “microchip,xec-qmspi” compatible.
