---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/spi/litex,spi.html
original_path: build/dts/api/bindings/spi/litex,spi.html
---
...
[drivers/spi/spi\_litex.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_litex.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `data-width` | `int` | ```text Maximum data width of the SPI controller in bits. ```  Default value: `8` |
| `max-cs` | `int` | ```text Maximum number of chip selects supported by the SPI controller. ```  Default value: `1` |
...
may apply to the “litex,spi” compatible.
