---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/spi/telink,b91-spi.html
original_path: build/dts/api/bindings/spi/telink,b91-spi.html
---
...
[drivers/spi/spi\_b91.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_b91.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `peripheral-id` | `string` | This property is **required**.  Legal values: `'PSPI_MODULE'`, `'HSPI_MODULE'` |
...
| `cs0-pin` | `string` | This property is **required**.  Legal values: `'0'`, `'PSPI_CSN_PC4'`, `'PSPI_CSN_PC0'`, `'PSPI_CSN_PD0'`, `'HSPI_CSN_PA1'`, `'HSPI_CSN_PB6'` |
| `cs1-pin` | `string` | Legal values: `'0'`, `'PSPI_CSN_PC4'`, `'PSPI_CSN_PC0'`, `'PSPI_CSN_PD0'`, `'HSPI_CSN_PA1'`, `'HSPI_CSN_PB6'` |
| `cs2-pin` | `string` | Legal values: `'0'`, `'PSPI_CSN_PC4'`, `'PSPI_CSN_PC0'`, `'PSPI_CSN_PD0'`, `'HSPI_CSN_PA1'`, `'HSPI_CSN_PB6'` |
...
may apply to the “telink,b91-spi” compatible.
