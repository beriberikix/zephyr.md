---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/spi/raspberrypi,pico-spi-pio.html
original_path: build/dts/api/bindings/spi/raspberrypi,pico-spi-pio.html
---
...
[drivers/spi/spi\_rpi\_pico\_pio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_rpi_pico_pio.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clk-gpios` | `phandle-array` | ```text Output pin for SPI clock ```  This property is **required**. |
| `mosi-gpios` | `phandle-array` | ```text Output pin for Master Out Slave In. ``` |
| `miso-gpios` | `phandle-array` | ```text Input pin for Master In Slave Out. ``` |
| `sio-gpios` | `phandle-array` | ```text Single I/O gpio info  GPIO input/output pin for 3-wire mode. ``` |
...
may apply to the “raspberrypi,pico-spi-pio” compatible.
