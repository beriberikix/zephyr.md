---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/spi/zephyr,spi-bitbang.html
original_path: build/dts/api/bindings/spi/zephyr,spi-bitbang.html
---
...
[drivers/spi/spi\_bitbang.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_bitbang.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clk-gpios` | `phandle-array` | ```text Clock gpio info ```  This property is **required**. |
| `mosi-gpios` | `phandle-array` | ```text MOSI gpio info. Output pin for Master Out Slave In. If this is not provided then the driver will transmit 0s ``` |
| `miso-gpios` | `phandle-array` | ```text MISO gpio info. Input pin for Master In Slave Out. If this is not provided the driver will read 0s ``` |
...
may apply to the “zephyr,spi-bitbang” compatible.
