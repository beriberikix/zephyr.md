---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/led/issi,is31fl3194.html
original_path: build/dts/api/bindings/led/issi,is31fl3194.html
---
...
[drivers/led/is31fl3194.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/led/is31fl3194.c).
...
These property descriptions apply to “issi,is31fl3194”
...
may apply to the “issi,is31fl3194” compatible.
...
| `current-limit` | `int` | ```text The current limit for the LED in mA. ```  This property is **required**.  Legal values: `10`, `20`, `30`, `40` |
| `index` | `int` | ```text Index of the LED on a controller. It can be used by drivers or applications to map a logical LED to its real position on the controller. For example, this allows to handle boards where the LEDs in an array/strip are not wired following the LED order of the controller. ``` |
