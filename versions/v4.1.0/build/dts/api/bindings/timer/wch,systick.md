---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/timer/wch,systick.html
original_path: build/dts/api/bindings/timer/wch,systick.html
---
...
[drivers/timer/wch\_systick\_ch32v00x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/wch_systick_ch32v00x.c).

## Description

```text
WCH CH32V00x Systick
```
...
may apply to the “wch,systick” compatible.
