---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/timer/ti,cc23x0-timer.html
original_path: build/dts/api/bindings/timer/ti,cc23x0-timer.html
---

# ti,cc23x0-systim-timer
...
[drivers/timer/cc23x0\_systim\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/cc23x0_systim_timer.c).

## Description

```text
TI SimpleLink CC23x0 Timer Node
```
...
may apply to the “ti,cc23x0-systim-timer” compatible.
