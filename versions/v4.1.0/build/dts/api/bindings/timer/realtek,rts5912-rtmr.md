---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/timer/realtek,rts5912-rtmr.html
original_path: build/dts/api/bindings/timer/realtek,rts5912-rtmr.html
---

# realtek,rts5912-rtmr
...
[drivers/timer/realtek\_rts5912\_rtmr.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/realtek_rts5912_rtmr.c).

## Description

```text
RTOS Timer on Realtek RTS5912 EC
```
...
may apply to the “realtek,rts5912-rtmr” compatible.
