---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/timer/st,stm32-lptim.html
...
[drivers/timer/stm32\_lptim\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/stm32_lptim_timer.c).
...
| `st,timeout` | `int` | ```text Gives the LPTIM an exact counting value (s) for timeout expiration. Valid range is [1, 256] and should be consistent with st,prescaler pre-defined setting. If not, an error is raised. ``` |
