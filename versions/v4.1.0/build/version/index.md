---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/version/index.html
...
| APP\_VERSION\_STRING | String (quoted) | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION` | “1.2.3-unstable.5” |
| APP\_VERSION\_EXTENDED\_STRING | String (quoted) | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION`   `VERSION_TWEAK` | “1.2.3-unstable.5+4” |
...
| $(APPVERSION) | String | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION` | 1.2.3-unstable.5 |
| $(APP\_VERSION\_EXTENDED\_STRING) | String | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION`,   `VERSION_TWEAK` | 1.2.3-unstable.5+4 |
...
| APP\_VERSION\_STRING | String | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION` | 1.2.3-unstable.5 |
| APP\_VERSION\_EXTENDED\_STRING | String | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `EXTRAVERSION`,   `VERSION_TWEAK` | 1.2.3-unstable.5+4 |
| APP\_VERSION\_TWEAK\_STRING | String | `VERSION_MAJOR`,   `VERSION_MINOR`,   `PATCHLEVEL`,   `VERSION_TWEAK` | 1.2.3+4 |
