---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/boards/nordic/coresight_stm/README.html
original_path: samples/boards/nordic/coresight_stm/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/coresight_stm/README.rst/..)
...
There are three sample configurations in the `sample.yaml`.

- **sample.boards.nrf.coresight\_stm.local\_uart**

  This configuration doesn’t use STM.
  Logs are printed on local console.
- **sample.boards.nrf.coresight\_stm**
...
- **sample.boards.nrf.coresight\_stm.dict**
...
**sample.boards.nrf.coresight\_stm.dict** requires host tool like `nrfutil trace`
to decode the traces.

## Building and running

To build the sample, use configuration setups from the `sample.yaml` using the `-T` option.
See the example:
...
For logging on NRF54H20 using ARM Coresight STM see [Multi-domain logging using ARM Coresight STM](../../../../services/logging/cs_stm.md#logging-cs-stm).
