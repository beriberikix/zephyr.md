---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/boards/bbc/microbit/pong/README.html
original_path: samples/boards/bbc/microbit/pong/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/bbc/microbit/pong/README.rst/..)
...
```shell
west build -b bbc_microbit samples/boards/bbc/microbit/pong
west flash
```
