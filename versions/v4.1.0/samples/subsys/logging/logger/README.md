---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/logging/logger/README.html
original_path: samples/subsys/logging/logger/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/logging/logger/README.rst/..)
...
```shell
west build -b qemu_x86 samples/subsys/logging/logger
west build -t run
```
