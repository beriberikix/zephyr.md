---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/zbus/uart_bridge/README.html
original_path: samples/subsys/zbus/uart_bridge/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/zbus/uart_bridge/README.rst/..)
...
on native\_sim as follows:

```shell
# From the root of the zephyr repository
west build -b native_sim samples/subsys/zbus/uart_bridge
west build -t run
```
...
The `decoder.py` script can be executed using the following command:
...
Exit the decoder script by pressing `CTRL+C`.
