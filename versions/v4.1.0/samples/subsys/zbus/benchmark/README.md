---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/zbus/benchmark/README.html
original_path: samples/subsys/zbus/benchmark/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/zbus/benchmark/README.rst/..)
...
- **CONFIG\_BM\_MESSAGE\_SIZE** the size of the message to be transferred (2 to 4096 bytes);
- **CONFIG\_BM\_ONE\_TO** number of consumers to send (1 up to 8 consumers);
- **CONFIG\_BM\_LISTENERS** Use y to perform the benchmark listeners;
- **CONFIG\_BM\_SUBSCRIBERS** Use y to perform the benchmark subscribers;
- **CONFIG\_BM\_MSG\_SUBSCRIBERS** Use y to perform the benchmark message subscribers.
...
There is a [Robot framework](https://robotframework.org/) script called `benchmark_256KB.robot` which runs all the input combinations as the complete benchmark.
...
| --- | --- | --- | --- | --- | --- |
| LIS/SUB/MSG\_SUB | 1,4,8 | 2,8,32,128,512 | float | int | int |
