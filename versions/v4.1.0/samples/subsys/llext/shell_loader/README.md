---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/llext/shell_loader/README.html
original_path: samples/subsys/llext/shell_loader/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/llext/shell_loader/README.rst/..)

## Overview

This example provides shell access to the [Linkable Loadable Extensions (LLEXT)](../../../../services/llext/index.md#llext) system and provides the
...
[tests/subsys/llext/no\_mem\_protection.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/tests/subsys/llext/no_mem_protection.conf).

This sample also includes the source for a very basic extension,
[samples/subsys/llext/shell\_loader/hello\_world.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/llext/shell_loader/hello_world.c), which can be
...
the extension via the [`EXPORT_SYMBOL`](../../../../doxygen/html/group__llext__symbols.md#ga0188531646d69e784eccf85bd4fb34aa) macro. Compiling with this
macro requires using the full Zephyr build system, or at least the
[LLEXT EDK](../../../../services/llext/build.md#llext-build-edk).
...
[`CONFIG_LLEXT_IMPORT_ALL_GLOBALS`](../../../../kconfig.md#CONFIG_LLEXT_IMPORT_ALL_GLOBALS "CONFIG_LLEXT_IMPORT_ALL_GLOBALS"). This is not recommended
...
(`list_symbols`), and the hello\_world function which the extension exports can be called and
run (`call_fn`).
