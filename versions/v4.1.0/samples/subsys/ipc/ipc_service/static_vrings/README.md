---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/ipc/ipc_service/static_vrings/README.html
...
```shell
# From the root of the zephyr repository
west build -b frdm_mcxn947/mcxn947/cpu0 --sysbuild samples/subsys/ipc/ipc_service/static_vrings
west debug
```
