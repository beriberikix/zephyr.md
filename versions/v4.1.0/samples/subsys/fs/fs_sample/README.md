---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/fs/fs_sample/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/fs/fs_sample/README.rst/..)
...
```shell
west build -b hifive_unmatched/fu740/s7 hifive_unmatched/fu740/u74 samples/subsys/fs/fs_sample -- -DCONF_FILE=prj_ext.conf
```
