---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/nvs/README.html
original_path: samples/subsys/nvs/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/nvs/README.rst/..)
...
This sample can be found under [samples/subsys/nvs](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/nvs) in the Zephyr tree.

The sample can be built for several platforms, the following commands build the
application for the nrf51dk/nrf51822 board.

```shell
west build -b nrf51dk/nrf51822 samples/subsys/nvs
west flash
```
