---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/usb/mass/README.html
original_path: samples/subsys/usb/mass/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/usb/mass/README.rst/..)
...
[samples/subsys/usb/mass](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/usb/mass) in the Zephyr project tree.
...
in [samples/subsys/usb/mass/boards](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/usb/mass/boards) in the Zephyr project tree.
...
```shell
west build -b reel_board samples/subsys/usb/mass -- -DEXTRA_DTC_OVERLAY_FILE="ramdisk.overlay"
```
...
```shell
west build -b reel_board samples/subsys/usb/mass -- -DEXTRA_DTC_OVERLAY_FILE="ramdisk.overlay" -DCONFIG_APP_MSC_STORAGE_RAM=y
```
...
```shell
west build -b adafruit_feather_nrf52840_sense samples/subsys/usb/mass -- -DCONFIG_APP_MSC_STORAGE_FLASH_FATFS=y
```
...
This example requires SD card support, see [Disk Access](../../../../services/storage/disk/access.md#disk-access-api), and
...
```shell
west build -b nrf52840dk/nrf52840 --shield waveshare_epaper_gdeh0154a07 samples/subsys/usb/mass -- -DCONFIG_APP_MSC_STORAGE_SDCARD=y
```
...
128 KiBy [littlefs](https://github.com/littlefs-project/littlefs) partition compatible with the one produced by the
[LittleFS filesystem](../../fs/littlefs/README.md#littlefs "Use file system API over LittleFS.") sample.
...
accomplished using the [littlefs-FUSE](https://github.com/littlefs-project/littlefs-fuse) utility.
...
Be aware that the parameters passed to **lfs** in the example
