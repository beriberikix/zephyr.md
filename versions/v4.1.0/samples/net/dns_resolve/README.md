---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/net/dns_resolve/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/dns_resolve/README.rst/..)
...
installation, the sample dnsmasq start script can be found in the [net-tools](https://github.com/zephyrproject-rtos/net-tools)
project or downloaded from [https://github.com/zephyrproject-rtos/net-tools](https://github.com/zephyrproject-rtos/net-tools).
...
See [Freedom-K64F board documentation](../../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) for more information
about this board.
