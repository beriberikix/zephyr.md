---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/net/wifi/apsta_mode/README.html
original_path: samples/net/wifi/apsta_mode/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/wifi/apsta_mode/README.rst/..)
...
In this demo, AP-STA mode is enabled using [`CONFIG_ESP32_WIFI_AP_STA_MODE`](../../../../kconfig.md#CONFIG_ESP32_WIFI_AP_STA_MODE "CONFIG_ESP32_WIFI_AP_STA_MODE").
...
[ESP32-DevKitC-WROOM](../../../../boards/espressif/esp32_devkitc_wroom/doc/index.md#esp32_devkitc_wroom) development board without any extra hardware.

To enable or disable `AP-STA` mode, modify the [`CONFIG_ESP32_WIFI_AP_STA_MODE`](../../../../kconfig.md#CONFIG_ESP32_WIFI_AP_STA_MODE "CONFIG_ESP32_WIFI_AP_STA_MODE")
...
```shell
west build -b esp32_devkitc_wroom/esp32/procpu samples/net/wifi/apsta_mode
west flash
```
