---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/net/mqtt_sn_publisher/README.html
original_path: samples/net/mqtt_sn_publisher/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/mqtt_sn_publisher/README.rst/..)
...
See the [MQTT-SN v1.2 spec](https://www.oasis-open.org/committees/download.php/66091/MQTT-SN_spec_v1.2.pdf) for more information.

The source code of this sample application can be found at:
[samples/net/mqtt\_sn\_publisher](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/mqtt_sn_publisher).
...
Open the [samples/net/mqtt\_sn\_publisher/prj.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/mqtt_sn_publisher/prj.conf) file and set the IP addresses according
to the LAN environment. CONFIG\_NET\_SAMPLE\_MQTT\_SN\_STATIC\_GATEWAY can be used to select the
...
from source - see [PAHO MQTT-SN Gateway](https://www.eclipse.org/paho/index.php?page=components/mqtt-sn-transparent-gateway/index.php) - or run an unofficial docker image, l
ike [kyberpunk/paho](https://hub.docker.com/r/kyberpunk/paho).
