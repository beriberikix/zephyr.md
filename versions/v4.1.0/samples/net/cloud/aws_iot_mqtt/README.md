---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/net/cloud/aws_iot_mqtt/README.html
original_path: samples/net/cloud/aws_iot_mqtt/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/cloud/aws_iot_mqtt/README.rst/..)
...
- Passing the AWS Device Qualification Program (DQP) test suite: [Device Qualification Program (DQP)](https://aws.amazon.com/partners/programs/dqp/)
...
Copy these files to the [samples/net/cloud/aws\_iot\_mqtt/src/creds](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/cloud/aws_iot_mqtt/src/creds)
directory. Run the [samples/net/cloud/aws\_iot\_mqtt/src/creds/convert\_keys.py](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/cloud/aws_iot_mqtt/src/creds/convert_keys.py)
...
- `CONFIG_AWS_ENDPOINT`: The AWS IoT Core broker endpoint, found in the AWS IoT Core
...
- `CONFIG_AWS_THING_NAME`: The name of the thing created in AWS IoT Core. Associated
...
Refer to the [AWS IoT Core Documentation](https://docs.aws.amazon.com/iot/index.html)
for more information.

Additionnaly, it is possible to tune the firmware to pass the AWS DQP test
suite, to do set Kconfig option `CONFIG_AWS_TEST_SUITE_DQP` to `y`.
...
[Networking with QEMU](../../../../connectivity/networking/qemu_setup.md#networking-with-qemu). for more information.
