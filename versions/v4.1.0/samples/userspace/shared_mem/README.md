---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/userspace/shared_mem/README.html
original_path: samples/userspace/shared_mem/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/userspace/shared_mem/README.rst/..)
...
The sample is dependent on the subsystem app\_memory, and it will
not run on boards that do not support the subsystem. The sample
was tested on the following boards qemu\_x86,frdm\_k64, and `96b_carbon/stm32f401xe`.

## Building and Running

This example will only cover the qemu\_x86 board, since the sample
just prints text to a console.

```shell
west build -b qemu_x86 samples/userspace/shared_mem
west build -t run
```
