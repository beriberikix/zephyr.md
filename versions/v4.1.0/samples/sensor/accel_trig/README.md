---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/sensor/accel_trig/README.html
...
`CONFIG_SAMPLE_TAP_DETECTION`.
In this example we use a x\_nucleo\_iks01a3 shield with a LIS2DW12 accelerometer.
You can build it with the following command:

```shell
west build -b nrf52dk/nrf52832 --extra-dtc-overlay x_nucleo_iks01a3.overlay --shield x_nucleo_iks01a3 samples/sensor/accel_trig
```

### Sample Output (SENSOR\_TRIG\_DATA\_READY)
...
### Sample Output (SENSOR\_TRIG\_DOUBLE\_TAP)
