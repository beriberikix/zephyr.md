---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/sensor/adt7420/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/adt7420/README.rst/..)
...
> - ADT7420: [https://www.analog.com/adt7420](https://www.analog.com/adt7420)
...
In this example below the [nRF52 DK](../../../boards/nordic/nrf52dk/doc/index.md#nrf52dk-nrf52832) board is used.

```shell
# From the root of the zephyr repository
west build -b nrf52dk/nrf52832 samples/sensor/adt7420
west flash
```
