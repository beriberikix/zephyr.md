---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/sensor/mcux_acmp/README.html
...
```shell
west build -b mimxrt1170_evk@A/mimxrt1176/cm7 samples/sensor/mcux_acmp
west flash
```
