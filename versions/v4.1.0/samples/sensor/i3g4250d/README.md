---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/sensor/i3g4250d/README.html
original_path: samples/sensor/i3g4250d/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/i3g4250d/README.rst/..)
...
SPI interface. This is the case for example for stm32f3\_disco@E
board devicetree.
...
west build -b stm32f3_disco@E samples/sensor/i3g4250d
west flash
```
