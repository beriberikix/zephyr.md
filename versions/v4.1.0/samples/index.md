---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/index.html
...
### [MCTP](modules/mctp/mctp.md)

- [MCTP Endpoint Sample](modules/mctp/mctp_endpoint/README.md#mctp_endpoint_sample "Create an MCTP endpoint over UART.")Create an MCTP endpoint over UART.
- [MCTP Host Sample](modules/mctp/mctp_host/README.md#mctp_host_sample "Create an MCTP host over UART.")Create an MCTP host over UART.
