---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/drivers/lora/receive/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/drivers/lora/receive/README.rst/..)
...
```shell
west build -b b_l072z_lrwan1 samples/drivers/lora/receive
west flash
```
