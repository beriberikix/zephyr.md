---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/drivers/mbox_data/README.html
...
```shell
# From the root of the zephyr repository
west build -b frdm_mcxn947/mcxn947/cpu0 --sysbuild samples/drivers/mbox_data/
west debug
```
