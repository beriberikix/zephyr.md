---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/psa/persistent_key/README.html
...
- The [secure storage subsystem](../../../services/storage/secure_storage/index.md#secure-storage), for the other board targets.
