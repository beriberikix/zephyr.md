---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/bluetooth/encrypted_advertising/README.html
original_path: samples/bluetooth/encrypted_advertising/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/encrypted_advertising/README.rst/..)
...
To use the [`bt_ead_encrypt()`](../../../doxygen/html/group__bt__ead.md#ga8bed2f85d63b3950fd3e19fe211a8f02) and [`bt_ead_decrypt()`](../../../doxygen/html/group__bt__ead.md#gaf4005550479008e5f32f5cf15200ea8e) functions, you must enable
the Kconfig symbol [`CONFIG_BT_EAD`](../../../kconfig.md#CONFIG_BT_EAD "CONFIG_BT_EAD").
...
- Two boards with a push button connected via a GPIO pin, see the [Button](../../basic/button/README.md#button "Handle GPIO inputs with interrupts.")
  sample for more details

## Building and Running

This sample can be found under
[samples/bluetooth/encrypted\_advertising](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/encrypted_advertising) in the Zephyr tree.
