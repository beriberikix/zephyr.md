---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/bluetooth/ccp_call_control_client/README.html
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/ccp_call_control_client/ -- -DOVERLAY_CONFIG=overlay-bt_ll_sw_split.conf
```
