---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/bluetooth/pbp_public_broadcast_sink/README.html
original_path: samples/bluetooth/pbp_public_broadcast_sink/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/pbp_public_broadcast_sink/README.rst/..)
...
[samples/bluetooth/pbp\_public\_broadcast\_sink](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/pbp_public_broadcast_sink) in the Zephyr tree.
...
west build -b nrf5340dk/nrf5340/cpuapp --sysbuild samples/bluetooth/pbp_public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340dk/nrf5340/cpuapp samples/bluetooth/pbp_public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim/nrf5340/cpuapp --sysbuild samples/bluetooth/pbp_public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/pbp_public_broadcast_sink/ -- -DEXTRA_CONF_FILE=overlay-bt_ll_sw_split.conf
```
