---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/bluetooth/hci_uart_async/README.html
original_path: samples/bluetooth/hci_uart_async/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/hci_uart_async/README.rst/..)

## Overview

Expose Bluetooth Controller support over a standard Bluetooth HCI UART interface.

This sample performs the same basic function as the HCI UART sample, but it uses the UART\_ASYNC\_API
instead of UART\_INTERRUPT\_DRIVEN API. Not all boards implement both UART APIs, so the board support
...
This sample can be found under [samples/bluetooth/hci\_uart\_async](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/hci_uart_async)
...
In order to use the HCI UART controller with QEMU or [native\_sim](../../../boards/native/native_sim/doc/index.md#native-sim) you will need
