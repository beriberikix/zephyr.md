---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/thread__analyzer_8h_source.html
...
43#ifdef CONFIG\_THREAD\_ANALYZER\_PRIV\_STACK\_USAGE

45 size\_t priv\_stack\_size;

46

48 size\_t priv\_stack\_used;
...
[ 58](group__thread__analyzer.md#ga7ac3e88ca6d905ba0efe4afe5822485c)typedef void (\*[thread\_analyzer\_cb](group__thread__analyzer.md#ga7ac3e88ca6d905ba0efe4afe5822485c))(struct [thread\_analyzer\_info](structthread__analyzer__info.md) \*info);

59

[ 70](group__thread__analyzer.md#gad95f59d773da7db0ffa16b06b155f655)void [thread\_analyzer\_run](group__thread__analyzer.md#gad95f59d773da7db0ffa16b06b155f655)([thread\_analyzer\_cb](group__thread__analyzer.md#ga7ac3e88ca6d905ba0efe4afe5822485c) cb, unsigned int cpu);

71

[ 81](group__thread__analyzer.md#ga4b7e9fb25842e55d7072c271b54e2769)void [thread\_analyzer\_print](group__thread__analyzer.md#ga4b7e9fb25842e55d7072c271b54e2769)(unsigned int cpu);
...
89#endif /\* \_\_STACK\_SIZE\_ANALYZER\_H \*/

[thread\_analyzer\_print](group__thread__analyzer.md#ga4b7e9fb25842e55d7072c271b54e2769)

void thread\_analyzer\_print(unsigned int cpu)
...
**Definition** thread\_analyzer.h:58

[thread\_analyzer\_run](group__thread__analyzer.md#gad95f59d773da7db0ffa16b06b155f655)

void thread\_analyzer\_run(thread\_analyzer\_cb cb, unsigned int cpu)
