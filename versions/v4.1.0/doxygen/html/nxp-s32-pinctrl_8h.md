---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/nxp-s32-pinctrl_8h.html
...
| #define | [NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT](#acda7ed56ba5298bc9e2dedbf41689217)   25U |
| #define | [NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK](#a45370f12eb59e87b296e0ab8ca75d9a1)   [BIT\_MASK](group__sys-util.md#ga3c12c6d36ad0aa481a3436923d21f4f8)(3) |
| #define | [NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT](#ae8b5532ac34a69b0e6af420b30b9f21c)   28U |
| #define | [NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK](#a20d83adf4f587ac553cd410ea4c1e470)   [BIT\_MASK](group__sys-util.md#ga3c12c6d36ad0aa481a3436923d21f4f8)(3) |
...
| #define | [NXP\_S32\_PINMUX\_MSCR\_SIUL2\_IDX](#a0ddbf8d6fb6e1cd40aa7883fe5509ee6)(cfg) |
| #define | [NXP\_S32\_PINMUX\_IMCR\_SIUL2\_IDX](#a1ec211308d697276bef1d69a7619bede)(cfg) |
...
| #define | [NXP\_S32\_PINMUX\_GET\_MSCR\_SIUL2\_IDX](#a10a5d08b6be11d50d535b269f62fcde8)(cfg) |
| #define | [NXP\_S32\_PINMUX\_GET\_IMCR\_SIUL2\_IDX](#ac21c656b243792b10af59199c00e1915)(cfg) |
| #define | [NXP\_S32\_PINMUX](#ab7ff4f1d2a05ec44c358ff52f13a5733)(mscr\_siul2\_idx, imcr\_siul2\_idx, mscr\_idx, mscr\_sss, imcr\_idx, imcr\_sss) |
...
## [◆ ](#a20d83adf4f587ac553cd410ea4c1e470)NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK

| #define NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK   [BIT\_MASK](group__sys-util.md#ga3c12c6d36ad0aa481a3436923d21f4f8)(3) |
| --- |

## [◆ ](#ae8b5532ac34a69b0e6af420b30b9f21c)NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT

| #define NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT   28U |
| --- |
...
## [◆ ](#a45370f12eb59e87b296e0ab8ca75d9a1)NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK

| #define NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK   [BIT\_MASK](group__sys-util.md#ga3c12c6d36ad0aa481a3436923d21f4f8)(3) |
| --- |

## [◆ ](#acda7ed56ba5298bc9e2dedbf41689217)NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT

| #define NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT   25U |
| --- |
...
## [◆ ](#ab7ff4f1d2a05ec44c358ff52f13a5733)NXP\_S32\_PINMUX

| #define NXP\_S32\_PINMUX | ( |  | *mscr\_siul2\_idx*, |
| --- | --- | --- | --- |
|  |  |  | *imcr\_siul2\_idx*, |
|  |  |  | *mscr\_idx*, |
|  |  |  | *mscr\_sss*, |
...
([NXP\_S32\_PINMUX\_MSCR\_SIUL2\_IDX](#a0ddbf8d6fb6e1cd40aa7883fe5509ee6)(mscr\_siul2\_idx) | \

NXP\_S32\_PINMUX\_IMCR\_SIUL2\_IDX(imcr\_siul2\_idx) | \

NXP\_S32\_PINMUX\_MSCR\_IDX(mscr\_idx) | \

NXP\_S32\_PINMUX\_MSCR\_SSS(mscr\_sss) | \

NXP\_S32\_PINMUX\_IMCR\_IDX(imcr\_idx) | \

NXP\_S32\_PINMUX\_IMCR\_SSS(imcr\_sss))

[NXP\_S32\_PINMUX\_MSCR\_SIUL2\_IDX](#a0ddbf8d6fb6e1cd40aa7883fe5509ee6)

#define NXP\_S32\_PINMUX\_MSCR\_SIUL2\_IDX(cfg)
...
Parameters
:   | mscr\_siul2\_idx | MSCR SIUL2 instance index |
    | --- | --- |
    | imcr\_siul2\_idx | IMCR SIUL2 instance index |
...
## [◆ ](#ac21c656b243792b10af59199c00e1915)NXP\_S32\_PINMUX\_GET\_IMCR\_SIUL2\_IDX

| #define NXP\_S32\_PINMUX\_GET\_IMCR\_SIUL2\_IDX | ( |  | *cfg* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((cfg) >> [NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT](#ae8b5532ac34a69b0e6af420b30b9f21c)) & [NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK](#a20d83adf4f587ac553cd410ea4c1e470))

[NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK](#a20d83adf4f587ac553cd410ea4c1e470)

#define NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK

**Definition** nxp-s32-pinctrl.h:34

[NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT](#ae8b5532ac34a69b0e6af420b30b9f21c)

#define NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT
...
## [◆ ](#a10a5d08b6be11d50d535b269f62fcde8)NXP\_S32\_PINMUX\_GET\_MSCR\_SIUL2\_IDX

| #define NXP\_S32\_PINMUX\_GET\_MSCR\_SIUL2\_IDX | ( |  | *cfg* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((cfg) >> [NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT](#acda7ed56ba5298bc9e2dedbf41689217)) & [NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK](#a45370f12eb59e87b296e0ab8ca75d9a1))

[NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK](#a45370f12eb59e87b296e0ab8ca75d9a1)

#define NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK

**Definition** nxp-s32-pinctrl.h:32

[NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT](#acda7ed56ba5298bc9e2dedbf41689217)

#define NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT
...
## [◆ ](#a1ec211308d697276bef1d69a7619bede)NXP\_S32\_PINMUX\_IMCR\_SIUL2\_IDX

| #define NXP\_S32\_PINMUX\_IMCR\_SIUL2\_IDX | ( |  | *cfg* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((cfg) & [NXP\_S32\_IMCR\_SIUL2\_IDX\_MASK](#a20d83adf4f587ac553cd410ea4c1e470)) << [NXP\_S32\_IMCR\_SIUL2\_IDX\_SHIFT](#ae8b5532ac34a69b0e6af420b30b9f21c))
...
## [◆ ](#a0ddbf8d6fb6e1cd40aa7883fe5509ee6)NXP\_S32\_PINMUX\_MSCR\_SIUL2\_IDX
...
(((cfg) & [NXP\_S32\_MSCR\_SIUL2\_IDX\_MASK](#a45370f12eb59e87b296e0ab8ca75d9a1)) << [NXP\_S32\_MSCR\_SIUL2\_IDX\_SHIFT](#acda7ed56ba5298bc9e2dedbf41689217))
