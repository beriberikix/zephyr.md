---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/sys_2byteorder_8h.html
...
| #define | [BSWAP\_40](#a9220598b1562f6458a1f3cdace730086)(x) |
...
| #define | [sys\_le40\_to\_cpu](#a7a60d7b88a76e722e6b7f6f790c9d6ba)(val) |
| #define | [sys\_cpu\_to\_le40](#af1b10bdf8927f7d089e9e5241b1c280f)(val) |
...
| #define | [sys\_be40\_to\_cpu](#aa0d7790b5838d6df8c5483dcdfd7882b)(val) |
| #define | [sys\_cpu\_to\_be40](#af91f379aa31af2094ed46281e1097f73)(val) |
...
| static void | [sys\_put\_be40](#ae08c9ac9238729a6a4449fa375f0f701) ([uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) val, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dst[5]) |
...
| static void | [sys\_put\_le40](#aba15200a89744a6799040d230241263d) ([uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) val, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dst[5]) |
...
| static [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | [sys\_get\_be40](#a9004452841790b59b4cdc3579b1f583d) (const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) src[5]) |
...
| static [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | [sys\_get\_le40](#a080573b0bfb1328111fd16ba9926280b) (const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) src[5]) |
...
|  | Swap buffer content. |
| static void | [sys\_le\_to\_cpu](#a1dfbe1844998a2532142661e6f83cd1c) (void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Convert buffer from little-endian to host endianness. |
| static void | [sys\_cpu\_to\_le](#a185a92952eb93c3b4171f814382e3c6c) (void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Convert buffer from host endianness to little-endian. |
| static void | [sys\_be\_to\_cpu](#a56104f3f100b7d74cc3a14d82d39e766) (void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Convert buffer from big-endian to host endianness. |
| static void | [sys\_cpu\_to\_be](#a470e5adb20ee21268358d1a758b32a14) (void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Convert buffer from host endianness to big-endian. |
| static void | [sys\_put\_le](#a73d878abef7674b2c0f78f37725c57dd) (void \*dst, const void \*src, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Put a buffer as little-endian to arbitrary location. |
| static void | [sys\_put\_be](#af6e3a1a295b4f19f10581e5b655deb26) (void \*dst, const void \*src, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Put a buffer as big-endian to arbitrary location. |
| static void | [sys\_get\_le](#aebf1dd355257a635d976fbe034ec470e) (void \*dst, const void \*src, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
|  | Get a buffer stored in little-endian format. |
| static void | [sys\_get\_be](#a0674cde757cbe634bdd100fed9aabca8) (void \*dst, const void \*src, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) length) |
...
## [◆ ](#a9220598b1562f6458a1f3cdace730086)BSWAP\_40
...
(([uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1)) ((((x) >> 32) & 0xff) | \
...
## [◆ ](#aa0d7790b5838d6df8c5483dcdfd7882b)sys\_be40\_to\_cpu

| #define sys\_be40\_to\_cpu | ( |  | *val* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#af91f379aa31af2094ed46281e1097f73)sys\_cpu\_to\_be40

| #define sys\_cpu\_to\_be40 | ( |  | *val* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#af1b10bdf8927f7d089e9e5241b1c280f)sys\_cpu\_to\_le40

| #define sys\_cpu\_to\_le40 | ( |  | *val* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

[BSWAP\_40](#a9220598b1562f6458a1f3cdace730086)(val)

[BSWAP\_40](#a9220598b1562f6458a1f3cdace730086)
...
## [◆ ](#a7a60d7b88a76e722e6b7f6f790c9d6ba)sys\_le40\_to\_cpu

| #define sys\_le40\_to\_cpu | ( |  | *val* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#a56104f3f100b7d74cc3a14d82d39e766)sys\_be\_to\_cpu()

| | void sys\_be\_to\_cpu | ( | void \* | *buf*, | | --- | --- | --- | --- | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Convert buffer from big-endian to host endianness.

Parameters
:   | buf | A valid pointer on a memory area to convert from big-endian to host endianness. |
    | --- | --- |
    | length | Size of buf memory area |

## [◆ ](#a470e5adb20ee21268358d1a758b32a14)sys\_cpu\_to\_be()

| | void sys\_cpu\_to\_be | ( | void \* | *buf*, | | --- | --- | --- | --- | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Convert buffer from host endianness to big-endian.

Parameters
:   | buf | A valid pointer on a memory area to convert from host endianness to big-endian. |
    | --- | --- |
    | length | Size of buf memory area |

## [◆ ](#a185a92952eb93c3b4171f814382e3c6c)sys\_cpu\_to\_le()

| | void sys\_cpu\_to\_le | ( | void \* | *buf*, | | --- | --- | --- | --- | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Convert buffer from host endianness to little-endian.

Parameters
:   | buf | A valid pointer on a memory area to convert from host endianness to little-endian. |
    | --- | --- |
    | length | Size of buf memory area |

## [◆ ](#a0674cde757cbe634bdd100fed9aabca8)sys\_get\_be()

| | void sys\_get\_be | ( | void \* | *dst*, | | --- | --- | --- | --- | |  |  | const void \* | *src*, | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Get a buffer stored in big-endian format.

Get a buffer, stored in big-endian format in a potentially unaligned memory location, and convert it to the host endianness.
...
## [◆ ](#a9004452841790b59b4cdc3579b1f583d)sys\_get\_be40()

| | [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) sys\_get\_be40 | ( | const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *src*[5] | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#aebf1dd355257a635d976fbe034ec470e)sys\_get\_le()

| | void sys\_get\_le | ( | void \* | *dst*, | | --- | --- | --- | --- | |  |  | const void \* | *src*, | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Get a buffer stored in little-endian format.

Get a buffer, stored in little-endian format in a potentially unaligned memory location, and convert it to the host endianness.
...
## [◆ ](#a080573b0bfb1328111fd16ba9926280b)sys\_get\_le40()

| | [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) sys\_get\_le40 | ( | const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *src*[5] | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#a1dfbe1844998a2532142661e6f83cd1c)sys\_le\_to\_cpu()

| | void sys\_le\_to\_cpu | ( | void \* | *buf*, | | --- | --- | --- | --- | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Convert buffer from little-endian to host endianness.

Parameters
:   | buf | A valid pointer on a memory area to convert from little-endian to host endianness. |
    | --- | --- |
    | length | Size of buf memory area |
...
## [◆ ](#af6e3a1a295b4f19f10581e5b655deb26)sys\_put\_be()

| | void sys\_put\_be | ( | void \* | *dst*, | | --- | --- | --- | --- | |  |  | const void \* | *src*, | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Put a buffer as big-endian to arbitrary location.

Put a buffer originally in host endianness, to a potentially unaligned memory location in big-endian format.
...
## [◆ ](#ae08c9ac9238729a6a4449fa375f0f701)sys\_put\_be40()

| | void sys\_put\_be40 | ( | [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | *val*, | | --- | --- | --- | --- | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dst*[5] ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#a73d878abef7674b2c0f78f37725c57dd)sys\_put\_le()

| | void sys\_put\_le | ( | void \* | *dst*, | | --- | --- | --- | --- | |  |  | const void \* | *src*, | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *length* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

Put a buffer as little-endian to arbitrary location.

Put a buffer originally in host endianness, to a potentially unaligned memory location in little-endian format.
...
## [◆ ](#aba15200a89744a6799040d230241263d)sys\_put\_le40()

| | void sys\_put\_le40 | ( | [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | *val*, | | --- | --- | --- | --- | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dst*[5] ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
