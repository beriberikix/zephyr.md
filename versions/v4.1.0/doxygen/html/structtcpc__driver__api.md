---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structtcpc__driver__api.html
...
| int(\* | [get\_status\_register](#a15ffc79b75022e583e9840b6b16a1d19) )(const struct [device](structdevice.md) \*dev, enum [tcpc\_status\_reg](group__usb__type__c__port__controller__api.md#gafd8253dfa6abc80d0717b17271ed8916) reg, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*status) |
...
| int(\* | [set\_snk\_ctrl](#a2aa06dc38fcf6d0d044d2094481c43c5) )(const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
| int(\* | [get\_src\_ctrl](#a4ba0050fb389cd281deedbe327eca49e) )(const struct [device](structdevice.md) \*dev) |
| int(\* | [set\_src\_ctrl](#a797e6472126c3a02b8651cbc40395526) )(const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
...
## [◆ ](#a15ffc79b75022e583e9840b6b16a1d19)get\_status\_register

| int(\* tcpc\_driver\_api::get\_status\_register) (const struct [device](structdevice.md) \*dev, enum [tcpc\_status\_reg](group__usb__type__c__port__controller__api.md#gafd8253dfa6abc80d0717b17271ed8916) reg, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*status) |
| --- |
...
## [◆ ](#a2aa06dc38fcf6d0d044d2094481c43c5)set\_snk\_ctrl

| int(\* tcpc\_driver\_api::set\_snk\_ctrl) (const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
| --- |

## [◆ ](#a797e6472126c3a02b8651cbc40395526)set\_src\_ctrl

| int(\* tcpc\_driver\_api::set\_src\_ctrl) (const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
| --- |
