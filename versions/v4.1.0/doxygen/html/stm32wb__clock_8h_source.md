---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/stm32wb__clock_8h_source.html
...
[ 42](stm32wb__clock_8h.md#af50f81a20c6e91a7a8611d1e59ca6260)#define CCIPR\_REG 0x88

43

[ 45](stm32wb__clock_8h.md#a70a10f70b4f5058508e8983ad0a4de3a)#define BDCR\_REG 0x90

46

[ 48](stm32wb__clock_8h.md#a16c4f3ac8a8c6255620516b3a32b7a70)#define CSR\_REG 0x94

49

[ 52](stm32wb__clock_8h.md#a17f3ec5f86995a2c4087f2988a9486c5)#define USART1\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 0, CCIPR\_REG)

[ 53](stm32wb__clock_8h.md#aac31ca48bf87a722f6e0519f25f764dd)#define LPUART1\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 10, CCIPR\_REG)

[ 54](stm32wb__clock_8h.md#a3fbef8f2542fc6921236bd2709acf64c)#define I2C1\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 12, CCIPR\_REG)

[ 55](stm32wb__clock_8h.md#aa12a1d2ac790880b7148d1e5660eb941)#define I2C3\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 16, CCIPR\_REG)

[ 56](stm32wb__clock_8h.md#a042804bf8a52b3dd28033f8814442bfb)#define LPTIM1\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 18, CCIPR\_REG)

[ 57](stm32wb__clock_8h.md#aa713f6ff001bfa6352747e7a66e3f98a)#define LPTIM2\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 20, CCIPR\_REG)

[ 58](stm32wb__clock_8h.md#ab8e49f6309adb53edd9ad3d051d451db)#define SAI1\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 22, CCIPR\_REG)

[ 59](stm32wb__clock_8h.md#a3f3b40e4fdebc11d7a2dd4a86e1fefc8)#define CLK48\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 26, CCIPR\_REG)

[ 60](stm32wb__clock_8h.md#a635d17ad991ded52d41a6e7b0bec5773)#define ADC\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 28, CCIPR\_REG)

[ 61](stm32wb__clock_8h.md#abfff4355a498febbcf4ebcb237930a57)#define RNG\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 30, CCIPR\_REG)

[ 63](stm32wb__clock_8h.md#a4836377699efa295c56d340e150695b0)#define RTC\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 8, BDCR\_REG)

[ 65](stm32wb__clock_8h.md#a1812acd6f7e09cbe8f6f6c4fc7fe6f13)#define RFWKP\_SEL(val) STM32\_DT\_CLOCK\_SELECT((val), 3, 14, CSR\_REG)

66

67#endif /\* ZEPHYR\_INCLUDE\_DT\_BINDINGS\_CLOCK\_STM32WB\_CLOCK\_H\_ \*/
