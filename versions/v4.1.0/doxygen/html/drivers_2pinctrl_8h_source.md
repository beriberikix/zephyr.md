---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/drivers_2pinctrl_8h_source.html
...
160 .pins = Z\_PINCTRL\_STATE\_PINS\_NAME(state\_idx, node\_id), \

161 .pin\_cnt = ARRAY\_SIZE(Z\_PINCTRL\_STATE\_PINS\_NAME(state\_idx, \

162 node\_id)), \

163 .id = Z\_PINCTRL\_STATE\_ID(state\_idx, node\_id) \
...
Device address (only available if CONFIG\_PINCTRL\_STORE\_REG is enabled).
