---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structi3c__ccc__address.html
...
:   For SET GETACCCR, the address is left-shift by 1, and bit[0] is the calculated odd parity bit.
