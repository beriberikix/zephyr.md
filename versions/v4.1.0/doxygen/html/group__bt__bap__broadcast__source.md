---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/group__bt__bap__broadcast__source.html
...
| Functions | |
| --- | --- |
| int | [bt\_bap\_broadcast\_source\_register\_cb](#gac75ad00b8f9a1cd7048677a33b17acda) (struct [bt\_bap\_broadcast\_source\_cb](structbt__bap__broadcast__source__cb.md) \*cb) |
|  | Registers callbacks for Broadcast Sources. |
| int | [bt\_bap\_broadcast\_source\_unregister\_cb](#gacc8d26c42c6b4ae6dc11af84ec4af616) (struct [bt\_bap\_broadcast\_source\_cb](structbt__bap__broadcast__source__cb.md) \*cb) |
...
## [◆ ](#gac75ad00b8f9a1cd7048677a33b17acda)bt\_bap\_broadcast\_source\_register\_cb()

| int bt\_bap\_broadcast\_source\_register\_cb | ( | struct [bt\_bap\_broadcast\_source\_cb](structbt__bap__broadcast__source__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gacc8d26c42c6b4ae6dc11af84ec4af616)bt\_bap\_broadcast\_source\_unregister\_cb()

| int bt\_bap\_broadcast\_source\_unregister\_cb | ( | struct [bt\_bap\_broadcast\_source\_cb](structbt__bap__broadcast__source__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
:   | 0 | on success |
    | --- | --- |
    | -EINVAL | if `cb` is NULL |
    | -ENOENT | if `cb` is not registered |
