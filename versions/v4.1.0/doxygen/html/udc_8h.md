---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/udc_8h.html
...
|  | Controller is initialized by [udc\_init()](group__udc__api.md#ga0670bec8b55c013fb607ba53a8634ad4 "Initialize USB device controller.") and can generate the VBUS events, if capable, but shall not be recognizable by host. |
...
| int | [udc\_init](group__udc__api.md#ga0670bec8b55c013fb607ba53a8634ad4) (const struct [device](structdevice.md) \*dev, [udc\_event\_cb\_t](#aa3ff247fd5234f65d91f84ebc38e384a) event\_cb, const void \*const event\_ctx) |
...
| static const void \* | [udc\_get\_event\_ctx](group__udc__api.md#ga2d89f013b2e1279d1ec4cbd869e0cae6) (const struct [device](structdevice.md) \*dev) |
|  | Get pointer to higher layer context. |
| static [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | [udc\_mps\_ep\_size](group__udc__api.md#ga6da3d836e868f2d09fe24854c2d76aeb) (const struct [udc\_ep\_config](structudc__ep__config.md) \*const cfg) |
