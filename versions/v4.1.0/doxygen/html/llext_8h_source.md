---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/llext_8h_source.html
...
125 unsigned int sect\_cnt;

126 [elf\_shdr\_t](group__llext__elf.md#gab3695edd628cf868dc4f0d618f86bcbd) \*sect\_hdrs;

127 bool sect\_hdrs\_on\_heap;

129};

130

[ 131](group__llext__apis.md#ga2432e14161e327d2b1adb5bde5ce6a86)static inline const [elf\_shdr\_t](group__llext__elf.md#gab3695edd628cf868dc4f0d618f86bcbd) \*[llext\_section\_headers](group__llext__apis.md#ga2432e14161e327d2b1adb5bde5ce6a86)(const struct [llext](structllext.md) \*ext)

132{

133 return ext->sect\_hdrs;

134}

135

[ 136](group__llext__apis.md#ga0b4a3969f1322bf77aaaa614be789bd9)static inline unsigned int [llext\_section\_count](group__llext__apis.md#ga0b4a3969f1322bf77aaaa614be789bd9)(const struct [llext](structllext.md) \*ext)

137{

138 return ext->sect\_cnt;

139}

140

[ 146](structllext__load__param.md)struct [llext\_load\_param](structllext__load__param.md) {

[ 148](structllext__load__param.md#a3c1683b0baafc636af18df3808d08031) bool [relocate\_local](structllext__load__param.md#a3c1683b0baafc636af18df3808d08031);

149

[ 157](structllext__load__param.md#a5e9fdb238b8a706155a873e82e35393d) bool [pre\_located](structllext__load__param.md#a5e9fdb238b8a706155a873e82e35393d);

158

[ 164](structllext__load__param.md#af3d61fa83c93361e4c5292b078d51a93) [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) (\*[section\_detached](structllext__load__param.md#af3d61fa83c93361e4c5292b078d51a93))(const [elf\_shdr\_t](group__llext__elf.md#gab3695edd628cf868dc4f0d618f86bcbd) \*shdr);

165

[ 173](structllext__load__param.md#ae8e62920c8f47e7d2bcf7b7309058fb7) bool [keep\_section\_info](structllext__load__param.md#ae8e62920c8f47e7d2bcf7b7309058fb7);

174};

175

[ 177](group__llext__apis.md#ga15f6bd18c1693009be46641ce1b008c6)#define LLEXT\_LOAD\_PARAM\_DEFAULT { .relocate\_local = true, }

178

[ 185](group__llext__apis.md#gaad89b0b44cf5c9528c3f8a0ce37a8fbe)struct [llext](structllext.md) \*[llext\_by\_name](group__llext__apis.md#gaad89b0b44cf5c9528c3f8a0ce37a8fbe)(const char \*[name](structllext.md#a505e052f55e25cf10ac0431defb774ea));

186

[ 198](group__llext__apis.md#ga0faf5a335199e63a424b122b03027c98)int [llext\_iterate](group__llext__apis.md#ga0faf5a335199e63a424b122b03027c98)(int (\*fn)(struct [llext](structllext.md) \*ext, void \*arg), void \*arg);

199

[ 215](group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157)int [llext\_load](group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157)(struct [llext\_loader](structllext__loader.md) \*loader, const char \*[name](structllext.md#a505e052f55e25cf10ac0431defb774ea), struct [llext](structllext.md) \*\*ext,

216 const struct [llext\_load\_param](structllext__load__param.md) \*ldr\_parm);

217

[ 223](group__llext__apis.md#gad3df7ed4d436846504c0047166eb929e)int [llext\_unload](group__llext__apis.md#gad3df7ed4d436846504c0047166eb929e)(struct [llext](structllext.md) \*\*ext);

224

[ 236](group__llext__apis.md#ga54f3aaed749e8c6bad6fbecb1622ab06)int [llext\_free\_inspection\_data](group__llext__apis.md#ga54f3aaed749e8c6bad6fbecb1622ab06)(struct [llext\_loader](structllext__loader.md) \*ldr, struct [llext](structllext.md) \*ext);

237

[ 239](group__llext__apis.md#ga0c27a8648deab424948eeb776a3de5ea)typedef void (\*[llext\_entry\_fn\_t](group__llext__apis.md#ga0c27a8648deab424948eeb776a3de5ea))(void \*user\_data);

240

[ 252](group__llext__apis.md#ga01c0c23dba5ff1aa9da42c7895cc7fab)int [llext\_bringup](group__llext__apis.md#ga01c0c23dba5ff1aa9da42c7895cc7fab)(struct [llext](structllext.md) \*ext);

253

[ 266](group__llext__apis.md#gae061bb6100ad394fcaca7751ff3dadba)int [llext\_teardown](group__llext__apis.md#gae061bb6100ad394fcaca7751ff3dadba)(struct [llext](structllext.md) \*ext);

267

[ 284](group__llext__apis.md#ga809f7a7976b4436dad31aa03d9ea3729)void [llext\_bootstrap](group__llext__apis.md#ga809f7a7976b4436dad31aa03d9ea3729)(struct [llext](structllext.md) \*ext, [llext\_entry\_fn\_t](group__llext__apis.md#ga0c27a8648deab424948eeb776a3de5ea) entry\_fn, void \*user\_data);

285

[ 304](group__llext__apis.md#ga201b2c853cb3ff35aaa7b891dad5464c)\_\_syscall [ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) [llext\_get\_fn\_table](group__llext__apis.md#ga201b2c853cb3ff35aaa7b891dad5464c)(struct [llext](structllext.md) \*ext, bool is\_init, void \*buf, size\_t size);

305

[ 318](group__llext__apis.md#gac0982fad15a62723a5cad3f7edd6ba3e)const void \*[llext\_find\_sym](group__llext__apis.md#gac0982fad15a62723a5cad3f7edd6ba3e)(const struct [llext\_symtable](structllext__symtable.md) \*sym\_table, const char \*sym\_name);

319

[ 332](group__llext__apis.md#gad50ad281c70093da99851723fc6af470)int [llext\_call\_fn](group__llext__apis.md#gad50ad281c70093da99851723fc6af470)(struct [llext](structllext.md) \*ext, const char \*sym\_name);

333

[ 347](group__llext__apis.md#ga64b13edf15b7c233b49c9c8edff884e6)int [llext\_add\_domain](group__llext__apis.md#ga64b13edf15b7c233b49c9c8edff884e6)(struct [llext](structllext.md) \*ext, struct [k\_mem\_domain](structk__mem__domain.md) \*domain);

348

[ 367](group__llext__apis.md#ga1f1a02ac08db72db8cd8a01fa91c95cb)int [arch\_elf\_relocate](group__llext__apis.md#ga1f1a02ac08db72db8cd8a01fa91c95cb)([elf\_rela\_t](group__llext__elf.md#gad5dd8960a2fbfc74cdcd016b5c2c7cea) \*rel, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) loc,

368 [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) sym\_base\_addr, const char \*sym\_name, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) load\_bias);

369

[ 379](group__llext__apis.md#ga396bddb41c51415faf79e11fad44cb4e)[ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) [llext\_find\_section](group__llext__apis.md#ga396bddb41c51415faf79e11fad44cb4e)(struct [llext\_loader](structllext__loader.md) \*loader, const char \*search\_name);

380

[ 394](group__llext__apis.md#ga308d3c0b60358dcfbd8d7481fa68ff90)int [llext\_get\_section\_header](group__llext__apis.md#ga308d3c0b60358dcfbd8d7481fa68ff90)(struct [llext\_loader](structllext__loader.md) \*loader, struct [llext](structllext.md) \*ext,

395 const char \*search\_name, [elf\_shdr\_t](group__llext__elf.md#gab3695edd628cf868dc4f0d618f86bcbd) \*shdr);

396

[ 407](group__llext__apis.md#gafac4da8a6157c599cfcc78fa0f32cb02)void [arch\_elf\_relocate\_local](group__llext__apis.md#gafac4da8a6157c599cfcc78fa0f32cb02)(struct [llext\_loader](structllext__loader.md) \*loader, struct [llext](structllext.md) \*ext, const [elf\_rela\_t](group__llext__elf.md#gad5dd8960a2fbfc74cdcd016b5c2c7cea) \*rel,

408 const [elf\_sym\_t](group__llext__elf.md#ga144fdcc270b75a371880da097968555e) \*sym, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*rel\_addr,

409 const struct [llext\_load\_param](structllext__load__param.md) \*ldr\_parm);

410

[ 421](group__llext__apis.md#ga88ff11fb0f37fdbb37b2de9eb990f817)void [arch\_elf\_relocate\_global](group__llext__apis.md#ga88ff11fb0f37fdbb37b2de9eb990f817)(struct [llext\_loader](structllext__loader.md) \*loader, struct [llext](structllext.md) \*ext, const [elf\_rela\_t](group__llext__elf.md#gad5dd8960a2fbfc74cdcd016b5c2c7cea) \*rel,

422 const [elf\_sym\_t](group__llext__elf.md#ga144fdcc270b75a371880da097968555e) \*sym, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*rel\_addr, const void \*link\_addr);

423

427

428#ifdef \_\_cplusplus
...
432#include <zephyr/syscalls/llext.h>

433

434#endif /\* ZEPHYR\_LLEXT\_H \*/
...
[arch\_elf\_relocate\_global](group__llext__apis.md#ga88ff11fb0f37fdbb37b2de9eb990f817)

void arch\_elf\_relocate\_global(struct llext\_loader \*loader, struct llext \*ext, const elf\_rela\_t \*rel, const elf\_sym\_t \*sym, uint8\_t \*rel\_addr, const void \*link\_addr)
...
[arch\_elf\_relocate\_local](group__llext__apis.md#gafac4da8a6157c599cfcc78fa0f32cb02)

void arch\_elf\_relocate\_local(struct llext\_loader \*loader, struct llext \*ext, const elf\_rela\_t \*rel, const elf\_sym\_t \*sym, uint8\_t \*rel\_addr, const struct llext\_load\_param \*ldr\_parm)
