---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/group__devicetree-generic-prop.html
...
| #define | [DT\_PROP\_LAST](#ga05a04871d83b31834c134a64636dcd8a)(node\_id, prop) |
...
| #define | [DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)(node\_id, prop, idx) |
...
|  | Equivalent to [DT\_ENUM\_IDX\_BY\_IDX(node\_id, prop, 0)](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2). |
| #define | [DT\_ENUM\_IDX\_BY\_IDX\_OR](#gac4892f2a54e05bd922f8c85db9c16d73)(node\_id, prop, idx, default\_idx\_value) |
|  | Like [DT\_ENUM\_IDX\_BY\_IDX()](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2), but with a fallback to a default enum index. |
| #define | [DT\_ENUM\_IDX\_OR](#gac3616e3aa1a025235032786de8d31576)(node\_id, prop, default\_idx\_value) |
|  | Equivalent to [DT\_ENUM\_IDX\_BY\_IDX\_OR(node\_id, prop, 0, default\_idx\_value)](#gac4892f2a54e05bd922f8c85db9c16d73). |
| #define | [DT\_ENUM\_HAS\_VALUE\_BY\_IDX](#ga3c8b19de88ffdb4246567bb54ef6e6a4)(node\_id, prop, idx, value) |
...
|  | Equivalent to [DT\_ENUM\_HAS\_VALUE\_BY\_IDX(node\_id, prop, 0, value)](#ga3c8b19de88ffdb4246567bb54ef6e6a4). |
...
[DT\_ENUM\_HAS\_VALUE\_BY\_IDX](#ga3c8b19de88ffdb4246567bb54ef6e6a4)(node\_id, prop, 0, value)

[DT\_ENUM\_HAS\_VALUE\_BY\_IDX](#ga3c8b19de88ffdb4246567bb54ef6e6a4)
...
## [◆ ](#ga3c8b19de88ffdb4246567bb54ef6e6a4)DT\_ENUM\_HAS\_VALUE\_BY\_IDX

| #define DT\_ENUM\_HAS\_VALUE\_BY\_IDX | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *prop*, |
|  |  |  | *idx*, |
|  |  |  | *value* ) |
...
[IS\_ENABLED](group__sys-util.md#ga111fe4e9d63758262fc6810a782cb32a)(DT\_CAT8(node\_id, \_P\_, prop, \_IDX\_, idx, \_ENUM\_VAL\_, value, \_EXISTS))
...
[DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)(node\_id, prop, 0)

[DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)
...
## [◆ ](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)DT\_ENUM\_IDX\_BY\_IDX

| #define DT\_ENUM\_IDX\_BY\_IDX | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *prop*, |
|  |  |  | *idx* ) |
...
DT\_CAT6(node\_id, \_P\_, prop, \_IDX\_, idx, \_ENUM\_IDX)
...
[DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)([DT\_NODELABEL](group__devicetree-generic-id.md#gab7d23294a6bf7fd44a98b48ec47d8a79)(some\_node), foo\_names, 0) // 0

[DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)([DT\_NODELABEL](group__devicetree-generic-id.md#gab7d23294a6bf7fd44a98b48ec47d8a79)(some\_node), foo\_names, 2) // 1
...
## [◆ ](#gac4892f2a54e05bd922f8c85db9c16d73)DT\_ENUM\_IDX\_BY\_IDX\_OR

| #define DT\_ENUM\_IDX\_BY\_IDX\_OR | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *prop*, |
|  |  |  | *idx*, |
|  |  |  | *default\_idx\_value* ) |
...
[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)([DT\_PROP\_HAS\_IDX](#ga479dfc704087eea7e7c5af42ae98576c)(node\_id, prop, idx), \

([DT\_ENUM\_IDX\_BY\_IDX](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2)(node\_id, prop, idx)), (default\_idx\_value))

[DT\_PROP\_HAS\_IDX](#ga479dfc704087eea7e7c5af42ae98576c)
...
If the value exists, this expands to its zero based index value thanks to [DT\_ENUM\_IDX\_BY\_IDX(node\_id, prop, idx)](#gae2e5f62d8f0c1eefcbb60ec7a5e84be2).
...
[DT\_ENUM\_IDX\_BY\_IDX\_OR](#gac4892f2a54e05bd922f8c85db9c16d73)(node\_id, prop, 0, default\_idx\_value)

[DT\_ENUM\_IDX\_BY\_IDX\_OR](#gac4892f2a54e05bd922f8c85db9c16d73)
...
## [◆ ](#ga05a04871d83b31834c134a64636dcd8a)DT\_PROP\_LAST

| #define DT\_PROP\_LAST | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *prop* ) |
...
[DT\_PROP\_BY\_IDX](#ga52ad691ea4cae633ca702020e939d461)(node\_id, prop, [UTIL\_DEC](group__sys-util.md#gaa7623e1e33316024217094698e4d8258)([DT\_PROP\_LEN](#gaa7f5afcedd1f54be79a5337e8e28a5b6)(node\_id, prop)))

[DT\_PROP\_BY\_IDX](#ga52ad691ea4cae633ca702020e939d461)
...
[UTIL\_DEC](group__sys-util.md#gaa7623e1e33316024217094698e4d8258)

#define UTIL\_DEC(x)

UTIL\_DEC(x) for an integer literal x from 0 to 4095 expands to an integer literal whose value is x-1.

**Definition** util\_macro.h:443
...
Returns
:   a representation of the last element of the property
