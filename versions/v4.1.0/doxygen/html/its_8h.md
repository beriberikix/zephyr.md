---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/its_8h.html
...
The functions declared in this header implement the PSA ITS API when the secure storage subsystem is enabled. They must not be called directly, and this header must not be included other than when providing a custom implementation (`CONFIG_SECURE_STORAGE_ITS_IMPLEMENTATION_CUSTOM`).
