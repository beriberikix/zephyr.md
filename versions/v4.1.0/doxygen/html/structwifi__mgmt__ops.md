---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structwifi__mgmt__ops.html
...
| int(\* | [set\_btwt](#ad2d1ab4db1947dbdb2909a675fa1d653) )(const struct [device](structdevice.md) \*dev, struct [wifi\_twt\_params](structwifi__twt__params.md) \*params) |
|  | Setup BTWT flow. |
...
| int(\* | [btm\_query](#a3437f5881a8e0a487c11dd43a6099b6d) )(const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) reason) |
|  | Send BTM query. |
| int(\* | [bss\_ext\_capab](#afb83b59f392b11fe8071ca57e3ea3928) )(const struct [device](structdevice.md) \*dev, int capab) |
|  | Judge ap whether support the capability. |
| int(\* | [legacy\_roam](#aa088223f84094614145d9d81e3acc20a) )(const struct [device](structdevice.md) \*dev) |
|  | Send legacy scan. |
...
## [◆ ](#afb83b59f392b11fe8071ca57e3ea3928)bss\_ext\_capab

| int(\* wifi\_mgmt\_ops::bss\_ext\_capab) (const struct [device](structdevice.md) \*dev, int capab) |
| --- |
...
## [◆ ](#a3437f5881a8e0a487c11dd43a6099b6d)btm\_query

| int(\* wifi\_mgmt\_ops::btm\_query) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) reason) |
| --- |
...
## [◆ ](#aa088223f84094614145d9d81e3acc20a)legacy\_roam

| int(\* wifi\_mgmt\_ops::legacy\_roam) (const struct [device](structdevice.md) \*dev) |
| --- |
...
## [◆ ](#ad2d1ab4db1947dbdb2909a675fa1d653)set\_btwt

| int(\* wifi\_mgmt\_ops::set\_btwt) (const struct [device](structdevice.md) \*dev, struct [wifi\_twt\_params](structwifi__twt__params.md) \*params) |
| --- |
