---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/p4wq_8h.html
...
| #define | [K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER](#ac6e9c4e8e6236e97fb0d8a890b13a101)(name, n\_threads, stack\_sz, dn\_handler) |
|  | Statically initialize a P4 Work Queue. |
| #define | [K\_P4WQ\_DEFINE](#af37c37fe046571f9ed99e14325d7a321)(name, n\_threads, stack\_sz) |
|  | Statically initialize a P4 Work Queue. |
| #define | [K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER](#a409785d1aeaa3e6bd874bc8db1ef08e7)(name, n\_threads, stack\_sz, flg, dn\_handler) |
...
| typedef void(\* | [k\_p4wq\_done\_handler\_t](#afa5f86d1b4679a2f07a9a7c7af71f12a)) (struct [k\_p4wq\_work](structk__p4wq__work.md) \*work) |
...
[K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER](#a409785d1aeaa3e6bd874bc8db1ef08e7)(name, n\_threads, stack\_sz, flg, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
[K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER](#a409785d1aeaa3e6bd874bc8db1ef08e7)

#define K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER(name, n\_threads, stack\_sz, flg, dn\_handler)

Statically initialize an array of P4 Work Queues.

**Definition** p4wq.h:152

Statically initialize an array of P4 Work Queues.

Same like K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER but without an optional handler which is called everytime when work is executed and not used anymore by the p4wq

## [◆ ](#a409785d1aeaa3e6bd874bc8db1ef08e7)K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER

| #define K\_P4WQ\_ARRAY\_DEFINE\_WITH\_DONE\_HANDLER | ( |  | *name*, |
| --- | --- | --- | --- |
|  |  |  | *n\_threads*, |
|  |  |  | *stack\_sz*, |
|  |  |  | *flg*, |
...
:   | name | Symbol name of the struct [k\_p4wq](structk__p4wq.md "P4 Queue.") array that will be defined |
    ...
    | flg | Flags |
    | dn\_handler | Function pointer to handler of type [k\_p4wq\_done\_handler\_t](#afa5f86d1b4679a2f07a9a7c7af71f12a) |
...
[K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER](#ac6e9c4e8e6236e97fb0d8a890b13a101)(name, n\_threads, stack\_sz, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))

[K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER](#ac6e9c4e8e6236e97fb0d8a890b13a101)

#define K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER(name, n\_threads, stack\_sz, dn\_handler)

Statically initialize a P4 Work Queue.

**Definition** p4wq.h:113

Statically initialize a P4 Work Queue.

Same like K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER but without an optional handler which is called everytime when work is executed and not used anymore by the p4wq

## [◆ ](#ac6e9c4e8e6236e97fb0d8a890b13a101)K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER

| #define K\_P4WQ\_DEFINE\_WITH\_DONE\_HANDLER | ( |  | *name*, |
| --- | --- | --- | --- |
|  |  |  | *n\_threads*, |
|  |  |  | *stack\_sz*, |
|  |  |  | *dn\_handler* ) |
...
## [◆ ](#afa5f86d1b4679a2f07a9a7c7af71f12a)k\_p4wq\_done\_handler\_t

| typedef void(\* k\_p4wq\_done\_handler\_t) (struct [k\_p4wq\_work](structk__p4wq__work.md) \*work) |
| --- |

Optional P4 Queue done callback.

Will be called after the memory structure is not used anymore by the p4wq. If it is not used it must be set to NULL.
