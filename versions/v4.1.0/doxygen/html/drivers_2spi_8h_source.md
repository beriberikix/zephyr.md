---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/drivers_2spi_8h_source.html
...
[ 638](group__spi__interface.md#ga84811e0fdd574477c8569d559f773dae)#define SPI\_DEVICE\_DT\_INST\_DEFINE(inst, ...) \

639 SPI\_DEVICE\_DT\_DEFINE(DT\_DRV\_INST(inst), \_\_VA\_ARGS\_\_)

640

[ 646](group__spi__interface.md#ga3fc669f866b03cfdad98754de69cda13)typedef int (\*[spi\_api\_io](group__spi__interface.md#ga3fc669f866b03cfdad98754de69cda13))(const struct [device](structdevice.md) \*dev,

647 const struct [spi\_config](structspi__config.md) \*config,

648 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

649 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs);

650

[ 658](group__spi__interface.md#ga1db2a410f482d0f26c49f96352aa606d)typedef void (\*[spi\_callback\_t](group__spi__interface.md#ga1db2a410f482d0f26c49f96352aa606d))(const struct [device](structdevice.md) \*dev, int result, void \*[data](structdevice.md#a27573cbd10ee145f8bb1396242b27a3e));

659

[ 665](group__spi__interface.md#ga03be7f33032ac479153616bbe26848e7)typedef int (\*[spi\_api\_io\_async](group__spi__interface.md#ga03be7f33032ac479153616bbe26848e7))(const struct [device](structdevice.md) \*dev,

666 const struct [spi\_config](structspi__config.md) \*config,

667 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

668 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs,

669 [spi\_callback\_t](group__spi__interface.md#ga1db2a410f482d0f26c49f96352aa606d) cb,

670 void \*userdata);

671

672#if defined(CONFIG\_SPI\_RTIO) || defined(DOXYGEN)

673

678typedef void (\*spi\_api\_iodev\_submit)(const struct [device](structdevice.md) \*dev,

679 struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe);

680#endif /\* CONFIG\_SPI\_RTIO \*/

681

[ 687](group__spi__interface.md#gac651ff7cd3dde7abe2525e20ef2e9e7d)typedef int (\*[spi\_api\_release](group__spi__interface.md#gac651ff7cd3dde7abe2525e20ef2e9e7d))(const struct [device](structdevice.md) \*dev,

688 const struct [spi\_config](structspi__config.md) \*config);

689

690

[ 695](structspi__driver__api.md)\_\_subsystem struct [spi\_driver\_api](structspi__driver__api.md) {

[ 696](structspi__driver__api.md#abeb852d35e4772dcec716cf63ef307bb) [spi\_api\_io](group__spi__interface.md#ga3fc669f866b03cfdad98754de69cda13) [transceive](structspi__driver__api.md#abeb852d35e4772dcec716cf63ef307bb);

697#ifdef CONFIG\_SPI\_ASYNC

698 [spi\_api\_io\_async](group__spi__interface.md#ga03be7f33032ac479153616bbe26848e7) transceive\_async;

699#endif /\* CONFIG\_SPI\_ASYNC \*/

700#ifdef CONFIG\_SPI\_RTIO

701 spi\_api\_iodev\_submit iodev\_submit;

702#endif /\* CONFIG\_SPI\_RTIO \*/

[ 703](structspi__driver__api.md#ae15944912ece9f736fd935184e8a184d) [spi\_api\_release](group__spi__interface.md#gac651ff7cd3dde7abe2525e20ef2e9e7d) [release](structspi__driver__api.md#ae15944912ece9f736fd935184e8a184d);

704};

705

[ 713](group__spi__interface.md#gae1156a4ee1b5909c321811045566d888)static inline bool [spi\_cs\_is\_gpio](group__spi__interface.md#gae1156a4ee1b5909c321811045566d888)(const struct [spi\_config](structspi__config.md) \*config)

714{

715 return config->[cs](structspi__config.md#a537dbfe323fafedaa219de1be2097dde).[gpio](structspi__cs__control.md#a8ad907e168666c2ddca77e89f9b9f47f).[port](structgpio__dt__spec.md#a5d617d47e2f568c7a4402a8f5a40ed4f) != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4);

716}

717

[ 725](group__spi__interface.md#gaa13f0da1f28cffa0da4677987db0c9c5)static inline bool [spi\_cs\_is\_gpio\_dt](group__spi__interface.md#gaa13f0da1f28cffa0da4677987db0c9c5)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec)

726{

727 return [spi\_cs\_is\_gpio](group__spi__interface.md#gae1156a4ee1b5909c321811045566d888)(&spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e));

728}

729

[ 738](group__spi__interface.md#ga37b4e5079ed18b70b0c5a260f4c36403)static inline bool [spi\_is\_ready\_dt](group__spi__interface.md#ga37b4e5079ed18b70b0c5a260f4c36403)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec)

739{

740 /\* Validate bus is ready \*/

741 if (![device\_is\_ready](group__device__model.md#gaa4944bd850e90cbd52b0489f9b12edfb)(spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a))) {
...
745 if ([spi\_cs\_is\_gpio\_dt](group__spi__interface.md#gaa13f0da1f28cffa0da4677987db0c9c5)(spec) &&

746 ![gpio\_is\_ready\_dt](group__gpio__interface.md#gaaec9ad17c08a0d527d66445fe82d8327)(&spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e).[cs](structspi__config.md#a537dbfe323fafedaa219de1be2097dde).[gpio](structspi__cs__control.md#a8ad907e168666c2ddca77e89f9b9f47f))) {
...
[ 770](group__spi__interface.md#gad51054c1ba259db5a64619788506a6f5)\_\_syscall int [spi\_transceive](group__spi__interface.md#gad51054c1ba259db5a64619788506a6f5)(const struct [device](structdevice.md) \*dev,

771 const struct [spi\_config](structspi__config.md) \*config,

772 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

773 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs);

774

775static inline int z\_impl\_spi\_transceive(const struct [device](structdevice.md) \*dev,

776 const struct [spi\_config](structspi__config.md) \*config,

777 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

778 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs)

779{

780 const struct [spi\_driver\_api](structspi__driver__api.md) \*api =

781 (const struct [spi\_driver\_api](structspi__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

782 int ret;

783

784 ret = api->transceive(dev, config, tx\_bufs, rx\_bufs);

785 [spi\_transceive\_stats](group__spi__interface.md#gad7d1058f600d6aef4fc4e2bdff5d55f3)(dev, ret, tx\_bufs, rx\_bufs);
...
[ 805](group__spi__interface.md#ga52c017066736414b31ff709ddc67c4ff)static inline int [spi\_transceive\_dt](group__spi__interface.md#ga52c017066736414b31ff709ddc67c4ff)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec,

806 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

807 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs)

808{

809 return [spi\_transceive](group__spi__interface.md#gad51054c1ba259db5a64619788506a6f5)(spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a), &spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e), tx\_bufs, rx\_bufs);

810}

811

[ 829](group__spi__interface.md#ga41f771785a4fa9ca0954125d1e97959e)static inline int [spi\_read](group__spi__interface.md#ga41f771785a4fa9ca0954125d1e97959e)(const struct [device](structdevice.md) \*dev,

830 const struct [spi\_config](structspi__config.md) \*config,

831 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs)

832{

833 return [spi\_transceive](group__spi__interface.md#gad51054c1ba259db5a64619788506a6f5)(dev, config, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), rx\_bufs);

834}

835

[ 848](group__spi__interface.md#ga7a1d7ebd37d2861b169c265cb90015bf)static inline int [spi\_read\_dt](group__spi__interface.md#ga7a1d7ebd37d2861b169c265cb90015bf)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec,

849 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs)

850{

851 return [spi\_read](group__spi__interface.md#ga41f771785a4fa9ca0954125d1e97959e)(spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a), &spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e), rx\_bufs);

852}

853

[ 870](group__spi__interface.md#ga7e7c4460670ec1c0433ba19accd97796)static inline int [spi\_write](group__spi__interface.md#ga7e7c4460670ec1c0433ba19accd97796)(const struct [device](structdevice.md) \*dev,

871 const struct [spi\_config](structspi__config.md) \*config,

872 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs)

873{

874 return [spi\_transceive](group__spi__interface.md#gad51054c1ba259db5a64619788506a6f5)(dev, config, tx\_bufs, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4));

875}

876

[ 889](group__spi__interface.md#ga292d6d1fe82f3f1ce0d9a2aa5437201b)static inline int [spi\_write\_dt](group__spi__interface.md#ga292d6d1fe82f3f1ce0d9a2aa5437201b)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec,

890 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs)

891{

892 return [spi\_write](group__spi__interface.md#ga7e7c4460670ec1c0433ba19accd97796)(spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a), &spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e), tx\_bufs);

893}

894

895#if defined(CONFIG\_SPI\_ASYNC) || defined(\_\_DOXYGEN\_\_)

896

[ 923](group__spi__interface.md#ga6114e63ca23b82f9be0ac70e372b878b)static inline int [spi\_transceive\_cb](group__spi__interface.md#ga6114e63ca23b82f9be0ac70e372b878b)(const struct [device](structdevice.md) \*dev,

924 const struct [spi\_config](structspi__config.md) \*config,

925 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

926 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs,

927 [spi\_callback\_t](group__spi__interface.md#ga1db2a410f482d0f26c49f96352aa606d) callback,

928 void \*userdata)

929{

930 const struct [spi\_driver\_api](structspi__driver__api.md) \*api =

931 (const struct [spi\_driver\_api](structspi__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

932

933 return api->transceive\_async(dev, config, tx\_bufs, rx\_bufs, callback, userdata);
...
939void z\_spi\_transfer\_signal\_cb(const struct [device](structdevice.md) \*dev, int result, void \*userdata);

941

[ 967](group__spi__interface.md#ga41b8a541257c0d45575fdc4593417edc)static inline int [spi\_transceive\_signal](group__spi__interface.md#ga41b8a541257c0d45575fdc4593417edc)(const struct [device](structdevice.md) \*dev,

968 const struct [spi\_config](structspi__config.md) \*config,

969 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

970 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs,

971 struct [k\_poll\_signal](structk__poll__signal.md) \*sig)

972{

973 const struct [spi\_driver\_api](structspi__driver__api.md) \*api =

974 (const struct [spi\_driver\_api](structspi__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

975 [spi\_callback\_t](group__spi__interface.md#ga1db2a410f482d0f26c49f96352aa606d) cb = (sig == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) ? [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) : z\_spi\_transfer\_signal\_cb;

976

977 return api->transceive\_async(dev, config, tx\_bufs, rx\_bufs, cb, sig);

978}

979

[ 1004](group__spi__interface.md#ga9a1ceadb217368232af5b688c12169c5)static inline int [spi\_read\_signal](group__spi__interface.md#ga9a1ceadb217368232af5b688c12169c5)(const struct [device](structdevice.md) \*dev,

1005 const struct [spi\_config](structspi__config.md) \*config,

1006 const struct [spi\_buf\_set](structspi__buf__set.md) \*rx\_bufs,

1007 struct [k\_poll\_signal](structk__poll__signal.md) \*sig)

1008{

1009 return [spi\_transceive\_signal](group__spi__interface.md#ga41b8a541257c0d45575fdc4593417edc)(dev, config, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), rx\_bufs, sig);

1010}

1011

[ 1035](group__spi__interface.md#gadcb19d43461ef88e31f6b382cc87fd0b)static inline int [spi\_write\_signal](group__spi__interface.md#gadcb19d43461ef88e31f6b382cc87fd0b)(const struct [device](structdevice.md) \*dev,

1036 const struct [spi\_config](structspi__config.md) \*config,

1037 const struct [spi\_buf\_set](structspi__buf__set.md) \*tx\_bufs,

1038 struct [k\_poll\_signal](structk__poll__signal.md) \*sig)

1039{

1040 return [spi\_transceive\_signal](group__spi__interface.md#ga41b8a541257c0d45575fdc4593417edc)(dev, config, tx\_bufs, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), sig);

1041}

1042

1043#endif /\* CONFIG\_POLL \*/

1044

1045#endif /\* CONFIG\_SPI\_ASYNC \*/

1046

1047

1048#if defined(CONFIG\_SPI\_RTIO) || defined(\_\_DOXYGEN\_\_)

1049

[ 1057](group__spi__interface.md#ga8b23855bdc7dab7d02b8f7daa7db651b)static inline void [spi\_iodev\_submit](group__spi__interface.md#ga8b23855bdc7dab7d02b8f7daa7db651b)(struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe)

1058{

1059 const struct [spi\_dt\_spec](structspi__dt__spec.md) \*dt\_spec = (const struct [spi\_dt\_spec](structspi__dt__spec.md) \*)iodev\_sqe->[sqe](structrtio__iodev__sqe.md#a2bd98599678909c0ddb22f879affa12b).[iodev](structrtio__sqe.md#a6c784702f011592c84feacd57915bbfc)->[data](structrtio__iodev.md#af0f3a27fe8dea2161c9a73cb838bdeec);

1060 const struct [device](structdevice.md) \*dev = dt\_spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a);

1061 const struct [spi\_driver\_api](structspi__driver__api.md) \*api = (const struct [spi\_driver\_api](structspi__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

1062

1063 api->iodev\_submit(dt\_spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a), iodev\_sqe);

1064}

1065

1066extern const struct [rtio\_iodev\_api](structrtio__iodev__api.md) [spi\_iodev\_api](group__spi__interface.md#gacd22d734b1b2729e09862065d44b8ce9);

1067

[ 1079](group__spi__interface.md#ga1e9f5fe389d53c280639f23ea134e18c)#define SPI\_DT\_IODEV\_DEFINE(name, node\_id, operation\_, delay\_) \

1080 const struct spi\_dt\_spec \_spi\_dt\_spec\_##name = \

1081 SPI\_DT\_SPEC\_GET(node\_id, operation\_, delay\_); \

1082 RTIO\_IODEV\_DEFINE(name, &spi\_iodev\_api, (void \*)&\_spi\_dt\_spec\_##name)

1083

[ 1092](group__spi__interface.md#gafea78af1fe1fa49fdc5459ab3a2d5f73)static inline bool [spi\_is\_ready\_iodev](group__spi__interface.md#gafea78af1fe1fa49fdc5459ab3a2d5f73)(const struct [rtio\_iodev](structrtio__iodev.md) \*spi\_iodev)

1093{

1094 struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec = (struct [spi\_dt\_spec](structspi__dt__spec.md) \*)spi\_iodev->[data](structrtio__iodev.md#af0f3a27fe8dea2161c9a73cb838bdeec);

1095

1096 return [spi\_is\_ready\_dt](group__spi__interface.md#ga37b4e5079ed18b70b0c5a260f4c36403)(spec);

1097}

1098

1099#endif /\* CONFIG\_SPI\_RTIO \*/

1100

[ 1121](group__spi__interface.md#ga0c4f4f0a93bb83a4f58d551a7491164e)\_\_syscall int [spi\_release](group__spi__interface.md#ga0c4f4f0a93bb83a4f58d551a7491164e)(const struct [device](structdevice.md) \*dev,

1122 const struct [spi\_config](structspi__config.md) \*[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e));

1123

1124static inline int z\_impl\_spi\_release(const struct [device](structdevice.md) \*dev,

1125 const struct [spi\_config](structspi__config.md) \*[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e))

1126{

1127 const struct [spi\_driver\_api](structspi__driver__api.md) \*api =

1128 (const struct [spi\_driver\_api](structspi__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
[ 1144](group__spi__interface.md#ga829b59767c51b20b546eee8a9cc84b69)static inline int [spi\_release\_dt](group__spi__interface.md#ga829b59767c51b20b546eee8a9cc84b69)(const struct [spi\_dt\_spec](structspi__dt__spec.md) \*spec)

1145{

1146 return [spi\_release](group__spi__interface.md#ga0c4f4f0a93bb83a4f58d551a7491164e)(spec->[bus](structspi__dt__spec.md#a37519633ae787ffaa1026e6867d7007a), &spec->[config](structspi__dt__spec.md#a88372c17ede2e9dfb0c09c49abebf87e));

1147}

1148

1149#ifdef \_\_cplusplus
...
1159#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_SPI\_H\_ \*/
