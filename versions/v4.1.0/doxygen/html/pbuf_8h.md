---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/pbuf_8h.html
...
| #define | [PBUF\_MAYBE\_CONST](group__pbuf.md#gaba4cc55b02db047bc2e0ca5c873b1222)   const |
| #define | [PBUF\_CFG\_INIT](group__pbuf.md#ga4e33dce801e591c9f319cc5682748920)(mem\_addr, size, dcache\_align, use\_handshake) |
...
| #define | [PBUF\_DEFINE](group__pbuf.md#gad167c69e7892f79060b07c6269699ae9)(name, mem\_addr, size, dcache\_align, use\_handshake, compatibility) |
|  | Statically define and initialize pbuf. |

| Functions | |
| --- | --- |
| int | [pbuf\_tx\_init](group__pbuf.md#ga05782e212932d84ba1192b4dbe1dfd42) (struct [pbuf](structpbuf.md) \*pb) |
|  | Initialize the Tx packet buffer. |
| int | [pbuf\_rx\_init](group__pbuf.md#ga9da1179f5fd3e5238244cd2f7664a928) (struct [pbuf](structpbuf.md) \*pb) |
...
| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [pbuf\_handshake\_read](group__pbuf.md#ga9fc04394d6e029aa74c26ae974787483) (struct [pbuf](structpbuf.md) \*pb) |
|  | Read handshake word from pbuf. |
| void | [pbuf\_handshake\_write](group__pbuf.md#ga97cb3608eaaa4f276d57c21150916938) (struct [pbuf](structpbuf.md) \*pb, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) value) |
|  | Write handshake word to pbuf. |
| int | [pbuf\_get\_initial\_buf](group__pbuf.md#gab31a49d00da9713170f4e63ba97191d9) (struct [pbuf](structpbuf.md) \*pb, volatile char \*\*buf, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) \*len) |
