---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/loader_8h_source.html
...
101 struct llext\_elf\_sect\_map \*sect\_map;

103};

104

106static inline int llext\_prepare(struct [llext\_loader](structllext__loader.md) \*l)

107{

108 if (l->[prepare](structllext__loader.md#a3034e439e3c55a2ed874cf2db6aba46e)) {

109 return l->[prepare](structllext__loader.md#a3034e439e3c55a2ed874cf2db6aba46e)(l);
...
115static inline int llext\_read(struct [llext\_loader](structllext__loader.md) \*l, void \*buf, size\_t len)

116{

117 return l->[read](structllext__loader.md#a29a16df55b72bc299b338036437f53e0)(l, buf, len);

118}

119

120static inline int llext\_seek(struct [llext\_loader](structllext__loader.md) \*l, size\_t pos)

121{

122 return l->[seek](structllext__loader.md#a2376c3774af219972e164b0ee8a6bb6d)(l, pos);

123}

124

125static inline void \*llext\_peek(struct [llext\_loader](structllext__loader.md) \*l, size\_t pos)

126{

127 if (l->[peek](structllext__loader.md#af5452f4b4f1099379d110c1bcd7773f6)) {

128 return l->[peek](structllext__loader.md#af5452f4b4f1099379d110c1bcd7773f6)(l, pos);

129 }

130

131 return [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4);

132}

133

134static inline void llext\_finalize(struct [llext\_loader](structllext__loader.md) \*l)

135{

136 if (l->[finalize](structllext__loader.md#a7c0ea7bce0a56ccf98e120a52e362b37)) {

137 l->[finalize](structllext__loader.md#a7c0ea7bce0a56ccf98e120a52e362b37)(l);
...
150#endif /\* ZEPHYR\_LLEXT\_LOADER\_H \*/
