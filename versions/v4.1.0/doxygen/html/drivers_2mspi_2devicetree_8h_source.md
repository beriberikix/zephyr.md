---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/drivers_2mspi_2devicetree_8h_source.html
...
215 GPIO\_DT\_SPEC\_GET\_BY\_IDX\_OR(DT\_BUS(mspi\_dev), ce\_gpios, \

216 DT\_REG\_ADDR\_RAW(mspi\_dev), {})

217

[ 227](group__mspi__devicetree.md#ga0b98f7a625324abce90933cb2395fb17)#define MSPI\_DEV\_CE\_GPIOS\_DT\_SPEC\_INST\_GET(inst) \

228 MSPI\_DEV\_CE\_GPIOS\_DT\_SPEC\_GET(DT\_DRV\_INST(inst))

229

230

[ 241](group__mspi__devicetree.md#ga1ca28d7ead69cd3a5e26198bc6815b54)#define MSPI\_CE\_GPIOS\_DT\_SPEC\_GET(node\_id) \

242{ \

243 COND\_CODE\_1(DT\_NODE\_HAS\_PROP(node\_id, ce\_gpios), \

244 (DT\_FOREACH\_PROP\_ELEM\_SEP(node\_id, ce\_gpios, GPIO\_DT\_SPEC\_GET\_BY\_IDX, (,))), \
...
[ 257](group__mspi__devicetree.md#ga5ae4bd8071da4babd0bdf9767e9542e4)#define MSPI\_CE\_GPIOS\_DT\_SPEC\_INST\_GET(inst) \

258 MSPI\_CE\_GPIOS\_DT\_SPEC\_GET(DT\_DRV\_INST(inst))

259

[ 298](group__mspi__devicetree.md#ga501b2e19e358083f2b47838cde58a676)#define MSPI\_CE\_CONTROL\_INIT(node\_id, delay\_) \

299 { \

300 .gpio = MSPI\_DEV\_CE\_GPIOS\_DT\_SPEC\_GET(node\_id), .delay = (delay\_), \

301 }

302

[ 316](group__mspi__devicetree.md#gacec91c9080052adf96aa5d36c6301d8c)#define MSPI\_CE\_CONTROL\_INIT\_INST(inst, delay\_) MSPI\_CE\_CONTROL\_INIT(DT\_DRV\_INST(inst), delay\_)

317

318#ifdef \_\_cplusplus
...
326#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_MSPI\_DEVICETREE\_H\_ \*/
