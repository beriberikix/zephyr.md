---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/log__core_8h_source.html
...
357 Z\_LOG\_MSG\_CREATE(UTIL\_NOT(IS\_ENABLED(CONFIG\_USERSPACE)), \_mode, \
...
366#define Z\_LOG\_HEXDUMP(\_level, \_data, \_length, ...) \

367 Z\_LOG\_HEXDUMP2(\_level, 0, Z\_LOG\_CURRENT\_DATA(), \_data, \_length, \_\_VA\_ARGS\_\_)

368

369#define Z\_LOG\_HEXDUMP\_INSTANCE(\_level, \_inst, \_data, \_length, ...) \

370 Z\_LOG\_HEXDUMP2(\_level, 1, Z\_LOG\_INST(\_inst), \_data, \_length, \_\_VA\_ARGS\_\_)

371

372/\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*/

373/\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\* Filtering macros \*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*/

374/\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*/

375

[ 377](log__core_8h.md#a84474b9b8e31f5ee7040f7e22021c163)#define LOG\_LEVEL\_BITS 3U

378

[ 380](log__core_8h.md#a31c9e4a93ba2527b3bce4e5461dd65dd)#define LOG\_FILTER\_SLOT\_SIZE LOG\_LEVEL\_BITS

381

[ 383](log__core_8h.md#ad7a2f00a0b9d7961f6f246b828ec8c63)#define LOG\_FILTERS\_NUM\_OF\_SLOTS (32 / LOG\_FILTER\_SLOT\_SIZE)

384

[ 386](log__core_8h.md#a6258cbdcc73befb83fb5e5b5efd29d65)#define LOG\_FILTERS\_MAX\_BACKENDS \

387 (LOG\_FILTERS\_NUM\_OF\_SLOTS - (1 + IS\_ENABLED(CONFIG\_LOG\_FRONTEND)))

388

[ 390](log__core_8h.md#ad3865db594c20dff3d20e02b954d7a51)#define LOG\_FRONTEND\_SLOT\_ID (LOG\_FILTERS\_NUM\_OF\_SLOTS - 1)

391

[ 393](log__core_8h.md#a6d1b6a2b8ac28915ac085d430a952a15)#define LOG\_FILTER\_SLOT\_MASK (BIT(LOG\_FILTER\_SLOT\_SIZE) - 1U)

394

[ 399](log__core_8h.md#a5a21fea47b27e76f7382cf4cf687b4b3)#define LOG\_FILTER\_SLOT\_SHIFT(\_id) (LOG\_FILTER\_SLOT\_SIZE \* (\_id))

400

[ 401](log__core_8h.md#a91e38e2a6e541df4bb8dbb741e393e0e)#define LOG\_FILTER\_SLOT\_GET(\_filters, \_id) \

402 ((\*(\_filters) >> LOG\_FILTER\_SLOT\_SHIFT(\_id)) & LOG\_FILTER\_SLOT\_MASK)

403

[ 404](log__core_8h.md#aa95cdf72ca0084ef4deed1cf698192d6)#define LOG\_FILTER\_SLOT\_SET(\_filters, \_id, \_filter) \

405 do { \

406 \*(\_filters) &= ~(LOG\_FILTER\_SLOT\_MASK << \

407 LOG\_FILTER\_SLOT\_SHIFT(\_id)); \

408 \*(\_filters) |= ((\_filter) & LOG\_FILTER\_SLOT\_MASK) << \

409 LOG\_FILTER\_SLOT\_SHIFT(\_id); \

410 } while (false)

411

[ 412](log__core_8h.md#a3a875fb65e4f17a0b2d5cbc493084e34)#define LOG\_FILTER\_AGGR\_SLOT\_IDX 0

413

[ 414](log__core_8h.md#a4f4120cb018e563dea7005b10d5a6dc8)#define LOG\_FILTER\_AGGR\_SLOT\_GET(\_filters) \

415 LOG\_FILTER\_SLOT\_GET(\_filters, LOG\_FILTER\_AGGR\_SLOT\_IDX)

416

[ 417](log__core_8h.md#ab0f4745bf6824181306e2f71b3c9612e)#define LOG\_FILTER\_FIRST\_BACKEND\_SLOT\_IDX 1

418

419/\* Return aggregated (highest) level for all enabled backends, e.g. if there

420 \* are 3 active backends, one backend is set to get INF logs from a module and

421 \* two other backends are set for ERR, returned level is INF.

422 \*/

423#define Z\_LOG\_RUNTIME\_FILTER(\_filter) \

424 LOG\_FILTER\_SLOT\_GET(&(\_filter), LOG\_FILTER\_AGGR\_SLOT\_IDX)

425

[ 429](log__core_8h.md#a8be8b78ac80e9dd6bc8b9d3639942d33)#define LOG\_LEVEL\_INTERNAL\_RAW\_STRING LOG\_LEVEL\_NONE

430

[ 431](log__core_8h.md#a8bddbf82fcd014a2b65b53d80312237d)[TYPE\_SECTION\_START\_EXTERN](group__iterable__section__apis.md#ga40c6ba05d5bcb848a530bdc17bbff5be)(struct [log\_source\_const\_data](structlog__source__const__data.md), log\_const);

[ 432](log__core_8h.md#a9c76801a0e4d03e64c025f7cd5695d77)[TYPE\_SECTION\_END\_EXTERN](group__iterable__section__apis.md#gaf009fe4b90f7b338c3bf85bb4cd682e5)(struct [log\_source\_const\_data](structlog__source__const__data.md), log\_const);

433

444#define Z\_LOG\_PRINTK(\_is\_raw, ...) do { \

445 if (!IS\_ENABLED(CONFIG\_LOG)) { \

446 break; \

447 } \

448 if (IS\_ENABLED(CONFIG\_LOG\_MODE\_MINIMAL)) { \

449 z\_log\_minimal\_printk(\_\_VA\_ARGS\_\_); \
...
454 z\_log\_printf\_arg\_checker(\_\_VA\_ARGS\_\_); \

455 } \

456 Z\_LOG\_MSG\_CREATE(!IS\_ENABLED(CONFIG\_USERSPACE), \_mode, \

457 Z\_LOG\_LOCAL\_DOMAIN\_ID, (const void \*)(uintptr\_t)\_is\_raw, \

458 LOG\_LEVEL\_INTERNAL\_RAW\_STRING, NULL, 0, \_\_VA\_ARGS\_\_);\

459} while (0)

460

[ 468](log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_const\_source\_id](log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)(

469 const struct [log\_source\_const\_data](structlog__source__const__data.md) \*data)

470{

471 return ((const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)data - ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)[TYPE\_SECTION\_START](group__iterable__section__apis.md#gac97b7f4fd42a2d9e11b6a585bc716a05)(log\_const))/

472 sizeof(struct [log\_source\_const\_data](structlog__source__const__data.md));

473}

474

[ 475](log__core_8h.md#aab9e9896eac3c3008df9f191e2dc46eb)[TYPE\_SECTION\_START\_EXTERN](group__iterable__section__apis.md#ga40c6ba05d5bcb848a530bdc17bbff5be)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md), log\_dynamic);

[ 476](log__core_8h.md#aa42f7911fae598d4b602b336cdf269b1)[TYPE\_SECTION\_END\_EXTERN](group__iterable__section__apis.md#gaf009fe4b90f7b338c3bf85bb4cd682e5)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md), log\_dynamic);

477

[ 482](log__core_8h.md#a86c2e55bace38c6e71b4d1d0736b1160)#define LOG\_ITEM\_DYNAMIC\_DATA(\_name) UTIL\_CAT(log\_dynamic\_, \_name)

483

[ 484](log__core_8h.md#a322351c9b30bf3328821c6358ddc6a0b)#define LOG\_INSTANCE\_DYNAMIC\_DATA(\_module\_name, \_inst) \

485 LOG\_ITEM\_DYNAMIC\_DATA(Z\_LOG\_INSTANCE\_FULL\_NAME(\_module\_name, \_inst))

486

[ 494](log__core_8h.md#ab2e628ee35c240d79a5e622fa1209008)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_dynamic\_source\_id](log__core_8h.md#ab2e628ee35c240d79a5e622fa1209008)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md) \*data)

495{

496 return (([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)data - ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)[TYPE\_SECTION\_START](group__iterable__section__apis.md#gac97b7f4fd42a2d9e11b6a585bc716a05)(log\_dynamic))/

497 sizeof(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md));

498}

499

[ 507](log__core_8h.md#a018055fae12bf8aa165e8a790196fafe)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_source\_id](log__core_8h.md#a018055fae12bf8aa165e8a790196fafe)(const void \*source)

508{

509 return [IS\_ENABLED](group__sys-util.md#ga111fe4e9d63758262fc6810a782cb32a)(CONFIG\_LOG\_RUNTIME\_FILTERING) ?

510 [log\_dynamic\_source\_id](log__core_8h.md#ab2e628ee35c240d79a5e622fa1209008)((struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md) \*)source) :

511 [log\_const\_source\_id](log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)((const struct [log\_source\_const\_data](structlog__source__const__data.md) \*)source);

512}

513

515static inline \_\_printf\_like(1, 2)

516void z\_log\_printf\_arg\_checker(const char \*fmt, ...)
...
[ 530](log__core_8h.md#ab81a1401935513819384b85948e3d09c)static inline void [log\_generic](log__core_8h.md#ab81a1401935513819384b85948e3d09c)([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level, const char \*fmt, va\_list ap)

531{

532 z\_log\_msg\_runtime\_vcreate(Z\_LOG\_LOCAL\_DOMAIN\_ID, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), level,

533 [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), 0, 0, fmt, ap);
...
540#endif /\* ZEPHYR\_INCLUDE\_LOGGING\_LOG\_CORE\_H\_ \*/
