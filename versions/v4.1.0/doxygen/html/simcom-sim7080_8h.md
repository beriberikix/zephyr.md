---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/simcom-sim7080_8h.html
...
| int | [mdm\_sim7080\_ftp\_get\_start](#a53a7c0d347cfacf0d7fadaf073fbff6c) (const char \*server, const char \*user, const char \*[passwd](structpasswd.md), const char \*file, const char \*path) |
...
:   | server | The ftp servers address. |
    ...
    | [passwd](structpasswd.md) | Password for the ftp user. |
