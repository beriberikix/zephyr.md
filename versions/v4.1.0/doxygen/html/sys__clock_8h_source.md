---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/sys__clock_8h_source.html
original_path: doxygen/html/sys__clock_8h_source.html
---
...
[Go to the documentation of this file.](sys__clock_8h.md)
...
152/\* added tick needed to account for tick in progress \*/

153#define \_TICK\_ALIGN 1

154

156

157#if defined(CONFIG\_SYS\_CLOCK\_EXISTS) && \

158 (CONFIG\_SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC == 0)

159#error "SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC must be non-zero!"
...
166 \* We default to using 64-bit intermediates in timescale conversions,

167 \* but if the HW timer cycles/sec, ticks/sec and ms/sec are all known

168 \* to be nicely related, then we can cheat with 32 bits instead.

169 \*/

174

175#ifdef CONFIG\_SYS\_CLOCK\_EXISTS

176

177#if defined(CONFIG\_TIMER\_READS\_ITS\_FREQUENCY\_AT\_RUNTIME) || \

178 (MSEC\_PER\_SEC % CONFIG\_SYS\_CLOCK\_TICKS\_PER\_SEC) || \

179 (CONFIG\_SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC % CONFIG\_SYS\_CLOCK\_TICKS\_PER\_SEC)

180#define \_NEED\_PRECISE\_TICK\_MS\_CONVERSION
...
[ 189](group__clock__apis.md#ga59d9bd47b0caa662f0e289cf3df83a82)#define SYS\_CLOCK\_HW\_CYCLES\_TO\_NS\_AVG(X, NCYCLES) \

190 (uint32\_t)(k\_cyc\_to\_ns\_floor64(X) / NCYCLES)

191

[ 199](group__clock__apis.md#ga38f64e34c3f5b179e1f65d96911823cd)[uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [sys\_clock\_tick\_get\_32](group__clock__apis.md#ga38f64e34c3f5b179e1f65d96911823cd)(void);

200

[ 208](group__clock__apis.md#ga53e768db46e328e433848c62739c82e0)[int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) [sys\_clock\_tick\_get](group__clock__apis.md#ga53e768db46e328e433848c62739c82e0)(void);

209

210#ifndef CONFIG\_SYS\_CLOCK\_EXISTS

211#define sys\_clock\_tick\_get() (0)

212#define sys\_clock\_tick\_get\_32() (0)

213#endif

214

215#ifdef CONFIG\_SYS\_CLOCK\_EXISTS

216

[ 227](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe)typedef struct { [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) [tick](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe); } [k\_timepoint\_t](structk__timepoint__t.md);

228

[ 245](group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33)[k\_timepoint\_t](structk__timepoint__t.md) [sys\_timepoint\_calc](group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33)([k\_timeout\_t](structk__timeout__t.md) timeout);

246

[ 260](group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa)[k\_timeout\_t](structk__timeout__t.md) [sys\_timepoint\_timeout](group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa)([k\_timepoint\_t](structk__timepoint__t.md) timepoint);

261

[ 272](group__clock__apis.md#gaba264a00149527cd70aea717f3b3a998)static inline int [sys\_timepoint\_cmp](group__clock__apis.md#gaba264a00149527cd70aea717f3b3a998)([k\_timepoint\_t](structk__timepoint__t.md) a, [k\_timepoint\_t](structk__timepoint__t.md) b)

273{

274 if (a.[tick](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe) == b.[tick](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe)) {

275 return 0;

276 }

277 return a.[tick](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe) < b.[tick](structk__timepoint__t.md#a33e68c86f68dad539d7c2a70e6f80fbe) ? -1 : 1;
...
283 \* When timers are configured out, timepoints can't relate to anything.

284 \* The best we can do is to preserve whether or not they are derived from

285 \* K\_NO\_WAIT. Anything else will translate back to K\_FOREVER.

286 \*/

287typedef struct { bool wait; } [k\_timepoint\_t](structk__timepoint__t.md);

288

289static inline [k\_timepoint\_t](structk__timepoint__t.md) [sys\_timepoint\_calc](group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33)([k\_timeout\_t](structk__timeout__t.md) timeout)

290{

291 [k\_timepoint\_t](structk__timepoint__t.md) timepoint;

292

293 timepoint.wait = ![K\_TIMEOUT\_EQ](group__clock__apis.md#ga9abf00b34e16ab7ad0883603b6778b1b)(timeout, Z\_TIMEOUT\_NO\_WAIT);

294 return timepoint;

295}

296

297static inline [k\_timeout\_t](structk__timeout__t.md) [sys\_timepoint\_timeout](group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa)([k\_timepoint\_t](structk__timepoint__t.md) timepoint)

298{

299 return timepoint.wait ? Z\_FOREVER : Z\_TIMEOUT\_NO\_WAIT;

300}

301

302static inline int [sys\_timepoint\_cmp](group__clock__apis.md#gaba264a00149527cd70aea717f3b3a998)([k\_timepoint\_t](structk__timepoint__t.md) a, [k\_timepoint\_t](structk__timepoint__t.md) b)

303{

304 if (a.wait == b.wait) {

305 return 0;

306 }

307 return b.wait ? -1 : 1;
...
[ 320](group__clock__apis.md#ga87d0d7a0f7bcdcc8c4909962eac12985)static inline bool [sys\_timepoint\_expired](group__clock__apis.md#ga87d0d7a0f7bcdcc8c4909962eac12985)([k\_timepoint\_t](structk__timepoint__t.md) timepoint)

321{

322 return [K\_TIMEOUT\_EQ](group__clock__apis.md#ga9abf00b34e16ab7ad0883603b6778b1b)([sys\_timepoint\_timeout](group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa)(timepoint), Z\_TIMEOUT\_NO\_WAIT);
...
331#endif /\* ZEPHYR\_INCLUDE\_SYS\_CLOCK\_H\_ \*/
