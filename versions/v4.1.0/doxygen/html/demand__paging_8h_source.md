---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/demand__paging_8h_source.html
...
220#if defined(CONFIG\_EVICTION\_TRACKING) || defined(\_\_DOXYGEN\_\_)

221

[ 235](group__mem-demand-paging-eviction.md#ga6bb19be3098cc839ae3f6e9528598867)void [k\_mem\_paging\_eviction\_add](group__mem-demand-paging-eviction.md#ga6bb19be3098cc839ae3f6e9528598867)(struct k\_mem\_page\_frame \*pf);

236

[ 250](group__mem-demand-paging-eviction.md#ga16a4df904cc7a9641d06741ed589949d)void [k\_mem\_paging\_eviction\_remove](group__mem-demand-paging-eviction.md#ga16a4df904cc7a9641d06741ed589949d)(struct k\_mem\_page\_frame \*pf);

251

[ 264](group__mem-demand-paging-eviction.md#ga228747c10bfd8816aec59fddf0e3a224)void [k\_mem\_paging\_eviction\_accessed](group__mem-demand-paging-eviction.md#ga228747c10bfd8816aec59fddf0e3a224)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) phys);

265

266#else /\* CONFIG\_EVICTION\_TRACKING || \_\_DOXYGEN\_\_ \*/

267

268static inline void [k\_mem\_paging\_eviction\_add](group__mem-demand-paging-eviction.md#ga6bb19be3098cc839ae3f6e9528598867)(struct k\_mem\_page\_frame \*pf)
...
273static inline void [k\_mem\_paging\_eviction\_remove](group__mem-demand-paging-eviction.md#ga16a4df904cc7a9641d06741ed589949d)(struct k\_mem\_page\_frame \*pf)
...
278static inline void [k\_mem\_paging\_eviction\_accessed](group__mem-demand-paging-eviction.md#ga228747c10bfd8816aec59fddf0e3a224)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) phys)

279{

280 ARG\_UNUSED(phys);

281}

282

283#endif /\* CONFIG\_EVICTION\_TRACKING || \_\_DOXYGEN\_\_ \*/

284

[ 301](group__mem-demand-paging-eviction.md#gaadbb4eb56c239f800daf995e6673ae1d)struct k\_mem\_page\_frame \*[k\_mem\_paging\_eviction\_select](group__mem-demand-paging-eviction.md#gaadbb4eb56c239f800daf995e6673ae1d)(bool \*dirty);

302

[ 310](group__mem-demand-paging-eviction.md#ga68dcfc0e5374de2c8ad7b9fe4e65c4f4)void [k\_mem\_paging\_eviction\_init](group__mem-demand-paging-eviction.md#ga68dcfc0e5374de2c8ad7b9fe4e65c4f4)(void);
...
[ 357](group__mem-demand-paging-backing-store.md#ga1192487fdc8d63c025de42162fb204cd)int [k\_mem\_paging\_backing\_store\_location\_get](group__mem-demand-paging-backing-store.md#ga1192487fdc8d63c025de42162fb204cd)(struct k\_mem\_page\_frame \*pf,

358 [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*location,

359 bool page\_fault);

360

[ 371](group__mem-demand-paging-backing-store.md#ga6ad421ad5671d9df3d96e03361f672e8)void [k\_mem\_paging\_backing\_store\_location\_free](group__mem-demand-paging-backing-store.md#ga6ad421ad5671d9df3d96e03361f672e8)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location);

372

[ 387](group__mem-demand-paging-backing-store.md#ga25debe925b369765ecd5bd7777ce32d0)int [k\_mem\_paging\_backing\_store\_location\_query](group__mem-demand-paging-backing-store.md#ga25debe925b369765ecd5bd7777ce32d0)(void \*addr, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*location);

388

[ 400](group__mem-demand-paging-backing-store.md#ga51f663e0a8c31367082e78097359af6d)void [k\_mem\_paging\_backing\_store\_page\_out](group__mem-demand-paging-backing-store.md#ga51f663e0a8c31367082e78097359af6d)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location);

401

[ 413](group__mem-demand-paging-backing-store.md#ga9becb4908cc7840ece93a2360692962d)void [k\_mem\_paging\_backing\_store\_page\_in](group__mem-demand-paging-backing-store.md#ga9becb4908cc7840ece93a2360692962d)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location);

414

[ 435](group__mem-demand-paging-backing-store.md#ga8d4bd3ea311fd873413d0477e8deb464)void [k\_mem\_paging\_backing\_store\_page\_finalize](group__mem-demand-paging-backing-store.md#ga8d4bd3ea311fd873413d0477e8deb464)(struct k\_mem\_page\_frame \*pf,

436 [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location);

437

[ 451](group__mem-demand-paging-backing-store.md#ga7ff441f23619b2678bfb72559d5bd592)void [k\_mem\_paging\_backing\_store\_init](group__mem-demand-paging-backing-store.md#ga7ff441f23619b2678bfb72559d5bd592)(void);
...
460#endif /\* ZEPHYR\_INCLUDE\_KERNEL\_MM\_DEMAND\_PAGING\_H \*/
