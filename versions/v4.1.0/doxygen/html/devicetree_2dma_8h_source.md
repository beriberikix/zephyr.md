---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/devicetree_2dma_8h_source.html
...
[ 239](group__devicetree-dmas.md#ga2843380c317657cd5f50cdacb9e93939)#define DT\_DMAS\_CELL\_BY\_NAME\_OR(node\_id, name, cell, default\_value) \

240 DT\_PHA\_BY\_NAME\_OR(node\_id, dmas, name, cell, default\_value)

241

[ 251](group__devicetree-dmas.md#ga2cc0124a66cf3b9f1c4c506b7f978d30)#define DT\_INST\_DMAS\_CELL\_BY\_NAME(inst, name, cell) \

252 DT\_DMAS\_CELL\_BY\_NAME(DT\_DRV\_INST(inst), name, cell)

253

[ 260](group__devicetree-dmas.md#gab789e18935628f40d80f3b64ca5cbe80)#define DT\_DMAS\_HAS\_IDX(node\_id, idx) \

261 IS\_ENABLED(DT\_CAT4(node\_id, \_P\_dmas\_IDX\_, idx, \_EXISTS))

262

[ 269](group__devicetree-dmas.md#gaff634d5b2a342c73f001a5ee64b70829)#define DT\_INST\_DMAS\_HAS\_IDX(inst, idx) \

270 DT\_DMAS\_HAS\_IDX(DT\_DRV\_INST(inst), idx)

271

[ 279](group__devicetree-dmas.md#ga865adb5b82c63e7f63451b96cd5a6404)#define DT\_DMAS\_HAS\_NAME(node\_id, name) \

280 DT\_PROP\_HAS\_NAME(node\_id, dmas, name)

281

[ 289](group__devicetree-dmas.md#gad60c155da3d850a61365ca7d12dc1813)#define DT\_INST\_DMAS\_HAS\_NAME(inst, name) \

290 DT\_DMAS\_HAS\_NAME(DT\_DRV\_INST(inst), name)
...
300#endif /\* ZEPHYR\_INCLUDE\_DEVICETREE\_DMAS\_H\_ \*/
