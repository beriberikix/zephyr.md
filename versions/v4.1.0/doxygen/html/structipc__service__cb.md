---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structipc__service__cb.html
...
|  | Bind was successful. |
| void(\* | [unbound](#a87aa417b0d8ff42f40460bf291bdfbae) )(void \*priv) |
...
## [◆ ](#a87aa417b0d8ff42f40460bf291bdfbae)unbound

| void(\* ipc\_service\_cb::unbound) (void \*priv) |
| --- |
...
You may want to do some cleanup, resetting, e.t.c. and after that if you want to bound again, you can register the endpoint. When the remote becomes available again and it also registers the endpoint, the binding will be reestablished and the [bound()](#a76be12bf8a7964977b5d7512dd010110) callback will be called.
