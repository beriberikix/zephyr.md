---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/usbc__ppc_8h.html
...
| Data Structures | |
| --- | --- |
| struct | [usbc\_ppc\_driver\_api](structusbc__ppc__driver__api.md) |
|  | Structure with pointers to the functions implemented by driver. [More...](structusbc__ppc__driver__api.md#details) |
