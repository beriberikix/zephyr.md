---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structbt__conn__auth__cb.html
...
For BR/EDR Secure Simple Pairing (SSP), this callback is called when receiving the BT\_HCI\_EVT\_IO\_CAPA\_REQ hci event.
