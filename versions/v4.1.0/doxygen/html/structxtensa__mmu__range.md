---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/structxtensa__mmu__range.html
...
[Internal and System API](group__internal__api.md) » [Architecture Interface](group__arch-interface.md) » [Xtensa APIs](group__xtensa__apis.md) » [Xtensa Memory Management Unit (MMU) APIs](group__xtensa__mmu__apis.md)
