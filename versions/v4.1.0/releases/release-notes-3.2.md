---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-3.2.html
...
- Sockets:
  ...
  - Fixed filling of the address structure provided in [`recvfrom()`](../doxygen/html/posix_2sys_2socket_8h.md#a1c41b0d557d19b5031e668b1997dc73a) for
    packet socket.
  - Fixed a potential deadlock in TCP [`send()`](../doxygen/html/posix_2sys_2socket_8h.md#a16485de18b1ec93572e5d74b4a04e42f) call.
...
- Bindings
  ...
  - New:
    ...
    - [`andestech,atcpit100`](../build/dts/api/bindings/counter/andestech,atcpit100.md#std-dtcompatible-andestech-atcpit100)
    ...
    - [`sifive,clint0`](../build/dts/api/bindings/interrupt-controller/sifive,clint0.md#std-dtcompatible-sifive-clint0)
  ...
  - Other changes:
    ...
    - GigaDevice SoCs:
      ...
      - Various peripheral bindings have had their SoC-specific
        ...
        - [`gd,gd32-timer`](../build/dts/api/bindings/counter/gd,gd32-timer.md#std-dtcompatible-gd-gd32-timer)
    ...
    - NXP SoCs:
      ...
      - `nxp,imx-lpi2c`: new `scl-gpios`, `sda-gpios` properties.
    - STM32 SoCs:
