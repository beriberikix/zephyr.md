---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-1.7.html
...
- Improved consistency of [Supported Boards and Shields](../boards/index.md#boards) and [Samples and Demos](../samples/index.md#samples).
