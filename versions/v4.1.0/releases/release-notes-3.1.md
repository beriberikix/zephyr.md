---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-3.1.html
...
- HCI Driver
  ...
  - Added support for a new optional `bt_hci_driver.close` API which
    closes HCI transport.
  - Implemented `bt_hci_driver.close` on stm32wb HCI driver.
- Host
...
- Bindings
  ...
  - Several new bindings were created to support [Pin Control](../hardware/pinctrl/index.md#pinctrl-guide) driver API implementations. This also affected many
    ...
    - `nxp,kinetis-pinctrl` has replaced the `nxp,kinetis-port-pins` property found in the `nxp,kinetis-pinmux` binding.
