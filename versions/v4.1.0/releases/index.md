---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/index.html
original_path: releases/index.html
---
...
All Zephyr project source code is maintained in a [GitHub repository](https://github.com/zephyrproject-rtos/zephyr). In order
to use a released version of the Zephyr project, it is recommended that you use
[West (Zephyr’s meta-tool)](../develop/west/index.md#west) to [Get Zephyr and install Python dependencies](../develop/getting_started/index.md#get-the-code) of the release you are interested in.

The technical documentation for current and past releases is available at
[https://docs.zephyrproject.org/](https://docs.zephyrproject.org/) (use the version selector to select your release
of interest).
...
A Zephyr [Long Term Support (LTS)](../project/release_process.md#release-process-lts) release is
...
For more information, see [Security Vulnerability Reporting](../security/reporting.md#reporting).

## Supported Releases

| Release | Release date | EOL |
| --- | --- | --- |
| [Zephyr 4.1.0](https://docs.zephyrproject.org/4.1.0/) | 2025-03-07 | 2025-11-14 |
| [Zephyr 4.0.0](https://docs.zephyrproject.org/4.0.0/) | 2024-11-15 | 2025-07-18 |
| [Zephyr 3.7.0 (LTS3)](https://docs.zephyrproject.org/3.7.0/) | 2024-07-26 | 2027-01-26 |

## Previous LTS

| Release | EOL |
| --- | --- |
| [Zephyr 2.7.6 (LTS2)](https://docs.zephyrproject.org/2.7.6/) | 2025-01-26 |
| [Zephyr 1.14.1 (LTS1)](https://docs.zephyrproject.org/1.14.1/) | 2022-01-01 |
...
[here](eol_releases.md#eol-releases).
