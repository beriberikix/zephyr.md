---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/migration-guide-3.7.html
...
- The [`nxp,kinetis-ethernet`](../build/dts/api/bindings/ethernet/nxp,kinetis-ethernet.md#std-dtcompatible-nxp-kinetis-ethernet) has been deprecated in favor of
  ...
  ```
- The [`nxp,kinetis-lptmr`](../build/dts/api/bindings/counter/nxp,kinetis-lptmr.md#std-dtcompatible-nxp-kinetis-lptmr) compatible string has been changed to
...
>   the [`microchip,ksz8081`](../build/dts/api/bindings/ethernet/microchip,ksz8081.md#std-dtcompatible-microchip-ksz8081) phy binding have changed to
...
- Support for manual bus-off recovery was reworked ([GitHub #69460](https://github.com/zephyrproject-rtos/zephyr/issues/69460)):
  ...
  - The Kconfig `CONFIG_CAN_AUTO_BUS_OFF_RECOVERY` was renamed (and inverted) to
    ...
    option enables support for the [`can_recover()`](../doxygen/html/group__can__interface.md#gac474e56a50685736a1c25dca277aab5e) API function and a new manual recovery mode
    (see the next bullet).
  - A new CAN controller operational mode [`CAN_MODE_MANUAL_RECOVERY`](../doxygen/html/group__can__interface.md#ga3d8675253125b2af2bd22f0b2cc60cdd) was added. Support for
    ...
    recovery mode via the [`can_get_capabilities()`](../doxygen/html/group__can__interface.md#ga4afd7776c5039dec8acb089499dc1168) API function. The application can then
    ...
    [`can_set_mode()`](../doxygen/html/group__can__interface.md#gae04c3c884b3ed26dfea4745b7dff2c5f) during application startup instead of failing when [`can_recover()`](../doxygen/html/group__can__interface.md#gac474e56a50685736a1c25dca277aab5e)
...
- The `orientation-flipped` property has been removed from the SSD16XX
  ...
  via [`display_set_orientation()`](../doxygen/html/group__display__interface.md#ga4e0a4dc2e434144874af014b8e7c4394) ([GitHub #73360](https://github.com/zephyrproject-rtos/zephyr/issues/73360))
...
- Basic power management support has been added to the `gnss-nmea-generic` driver.
  ...
  application needs to call [`pm_device_action_run()`](../doxygen/html/group__subsys__pm__device.md#ga3840d6e7832a00b93763247a5951bfde) with `PM_DEVICE_ACTION_RESUME`
...
- The `holtek,ht16k33-keyscan` driver has been converted to use the
  ...
  [`zephyr,kscan-input`](../build/dts/api/bindings/kscan/zephyr,kscan-input.md#std-dtcompatible-zephyr-kscan-input) can be used for backward compatibility. ([GitHub #69875](https://github.com/zephyrproject-rtos/zephyr/issues/69875))
...
- The static auto-generation of the multilevel interrupt controller lookup table has been
  ...
  `CONFIG_LEGACY_MULTI_LEVEL_TABLE_GENERATION` is enabled, which will eventually
...
- The model metadata pointer declaration of [`bt_mesh_model`](../doxygen/html/structbt__mesh__model.md) has been changed
  to add `const` qualifiers. The data pointer of [`bt_mesh_models_metadata_entry`](../doxygen/html/structbt__mesh__models__metadata__entry.md)
...
- The model metadata pointer declaration of [`bt_mesh_model`](../doxygen/html/structbt__mesh__model.md) has been changed
  to a single `const *` and redundant metadata pointer from [`bt_mesh_health_srv`](../doxygen/html/structbt__mesh__health__srv.md)
...
- [`bt_bap_stream_start()`](../doxygen/html/group__bt__bap.md#ga8f2dc67c35299334d21c7dee7b8664ae) no longer connects the CIS. To connect the CIS,
  the [`bt_bap_stream_connect()`](../doxygen/html/group__bt__bap.md#gaa75f2cd2c36fdaef04a62c95bec6e2e3) shall now be called before [`bt_bap_stream_start()`](../doxygen/html/group__bt__bap.md#ga8f2dc67c35299334d21c7dee7b8664ae).
...
- Renamed `stream_lang` to just `lang` to better fit with the assigned numbers document.
  ...
  - [`bt_audio_codec_cap_meta_set_lang()`](../doxygen/html/group__bt__audio__codec__cap.md#ga8182b2bed20449b8581b89677893c130)
  - [`bt_audio_codec_cap_meta_get_lang()`](../doxygen/html/group__bt__audio__codec__cap.md#gafb631b55b69b256c60b9cf3c7f418ff8)
  - [`bt_audio_codec_cfg_meta_set_lang()`](../doxygen/html/group__bt__audio__codec__cfg.md#ga54b7eadf072c397879c1dababa2a3be0)
  - [`bt_audio_codec_cfg_meta_get_lang()`](../doxygen/html/group__bt__audio__codec__cfg.md#ga55e3cbaeacf15fcb1f24a16eb28db99c)
...
- Added `fallback_to_default` parameter to [`bt_audio_codec_cfg_get_chan_allocation()`](../doxygen/html/group__bt__audio__codec__cfg.md#gae712e0f8e84aeb4ad2528da34907e29d).
...
- Added `fallback_to_default` parameter to
  [`bt_audio_codec_cap_get_supported_audio_chan_counts()`](../doxygen/html/group__bt__audio__codec__cap.md#ga63d5e083f03ec06939ee1cd0355c8c2a).
  To maintain existing behavior set the parameter to `false`. ([GitHub #72090](https://github.com/zephyrproject-rtos/zephyr/issues/72090))
- Added `fallback_to_default` parameter to
  [`bt_audio_codec_cap_get_max_codec_frames_per_sdu()`](../doxygen/html/group__bt__audio__codec__cap.md#ga194d938896ee65601bdce96d68c84885).
  To maintain existing behavior set the parameter to `false`. ([GitHub #72090](https://github.com/zephyrproject-rtos/zephyr/issues/72090))
- Added `fallback_to_default` parameter to
  [`bt_audio_codec_cfg_meta_get_pref_context()`](../doxygen/html/group__bt__audio__codec__cfg.md#gaea087663426a49bb6ff4859800aecb84).
  To maintain existing behavior set the parameter to `false`. ([GitHub #72090](https://github.com/zephyrproject-rtos/zephyr/issues/72090))
...
- The field `init_credits` in `bt_l2cap_le_endpoint` has been removed as it was no
  longer used in Zephyr 3.4.0 and later. Any references to this field should be removed. No further
  action is needed.
- [`BT_LE_ADV_PARAM`](../doxygen/html/group__bt__gap.md#ga9557269dd36b624b49e76c511c3a0cc1) now returns a `const` pointer.
  ...
  The change to [`BT_LE_ADV_PARAM`](../doxygen/html/group__bt__gap.md#ga9557269dd36b624b49e76c511c3a0cc1) also affects all of its derivatives, including but not
  limited to:

  - [`BT_LE_ADV_CONN`](../doxygen/html/group__bt__gap.md#gad490487b9e196526a13fe249a4c25448)
  - [`BT_LE_ADV_NCONN`](../doxygen/html/group__bt__gap.md#ga1610555bf59f1d691d640f245957fdce)
  - [`BT_LE_EXT_ADV_SCAN`](../doxygen/html/group__bt__gap.md#ga5dd57fc7f0e213db08655e631a2f314e)
...
- `CONFIG_BT_USE_PSA_API` was added to explicitly request use
...
- Deprecate the `CONFIG_NET_SOCKETS_POSIX_NAMES` option. It is a legacy option
...
- Virtual LAN (VLAN) implementation is changed to use the Virtual network interfaces.
  ...
  interface. For example in the [`net_eth_is_vlan_enabled()`](../doxygen/html/group__ethernet.md#gac536aa7154c4a8d194ec67efb68e275c) API, the 2nd interface parameter
...
- In LwM2M API, the callback type [`lwm2m_engine_set_data_cb_t`](../doxygen/html/group__lwm2m__api.md#ga3afac013b0cf731f9c86dc3791131585) has now an additional
...
- The [`SMF_CREATE_STATE`](../doxygen/html/group__smf.md#ga5760b98a36ed1ac55eba700cf44c7e1e) macro now always takes 5 arguments. The amount of arguments is
...
- SMF now follows a more UML-like transition flow when the transition source is a parent of the
  state called by [`smf_run_state()`](../doxygen/html/group__smf.md#ga8399cfa9e793a7f188b4ed4fec9f4f90). Exit actions up to (but not including) the Least Common
...
- Previously, calling [`smf_set_state()`](../doxygen/html/group__smf.md#ga3e5ac3e2ad105d1a01b4cf0b1a8a6fcb) with a `new_state` set to NULL would execute all
  ...
  ‘terminate’ state at the top level, and call [`smf_set_terminate()`](../doxygen/html/group__smf.md#gaae28c66f0652c99ba8e843eeaf02aaf7) from its entry action.
...
- Function `arch_start_cpu()` has been renamed to [`arch_cpu_start()`](../doxygen/html/group__arch-smp.md#ga32b7e543ce51498200c368c39c900bc8). ([GitHub #64987](https://github.com/zephyrproject-rtos/zephyr/issues/64987))
