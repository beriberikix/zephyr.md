---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-4.0.html
...
- Display
  ...
  - Added driver for SSD1327 OLED display controller ([`solomon,ssd1327fb`](../build/dts/api/bindings/display/solomon,ssd1327fb.md#std-dtcompatible-solomon-ssd1327fb)).
