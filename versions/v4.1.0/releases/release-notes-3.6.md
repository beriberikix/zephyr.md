---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-3.6.html
...
- Deprecated `CONFIG_BOOTLOADER_SRAM_SIZE`. Users of this should transition to
...
- IP:
  ...
  - It is now possible to have separate IPv4 TTL value and IPv6 hop limit value for
    ...
    [`setsockopt()`](../doxygen/html/posix_2sys_2socket_8h.md#a71c8788caef89a362e35ce5855e77077) API.
  ...
  - Added support for setting peer IP address in [`net_pkt`](../doxygen/html/structnet__pkt.md) structure
    for offloaded interfaces. This allows for [`recvfrom()`](../doxygen/html/posix_2sys_2socket_8h.md#a1c41b0d557d19b5031e668b1997dc73a) to return a
...
- Sockets:
  ...
  - Added support for object core, which allows to track networks sockets and
    their statistics.
  - Added support for [`recvmsg()`](../doxygen/html/posix_2sys_2socket_8h.md#ae074d22829eb79c596fd60d0f9f9611f).
  ...
  - Fixed DTLS handshake processing during [`poll()`](../doxygen/html/poll_8h.md#afa7e83ddea0ab5b08fcf614b89ac48ba).
  - Aligned DTLS socket [`connect()`](../doxygen/html/posix_2sys_2socket_8h.md#a90f0aa598d0f4ab4ea99ecf289a6a7fb) behavior with regular TLS (handshake
    during connect call).
  ...
  - Fixed DTLS connection timeout when monitoring socket with [`poll()`](../doxygen/html/poll_8h.md#afa7e83ddea0ab5b08fcf614b89ac48ba).
...
- TCP:
  ...
  - TCP stack now replies with RST packet in response to connection attempt on
    a closed port.
  - Fixed remote address passed in [`accept()`](../doxygen/html/posix_2sys_2socket_8h.md#a66e3de379c18201b21c889035ec54864) call.
