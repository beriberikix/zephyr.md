---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/releases/release-notes-3.4.html
...
- Introduced [Real-Time Clock (RTC)](../hardware/peripherals/rtc.md#rtc-api) API which adds experimental support for real-time clock
  ...
  [`rtc_alarm_set_callback()`](../doxygen/html/group__rtc__interface.md#ga77ccb9e6bd32e97016e01729d95074b6) are enabled with
  [`CONFIG_RTC_ALARM`](../kconfig.md#CONFIG_RTC_ALARM "CONFIG_RTC_ALARM"), the optional function
  [`rtc_update_set_callback()`](../doxygen/html/group__rtc__interface.md#gad9a48c4e7a05ee20c0edc96c348c9a45) is enabled with
