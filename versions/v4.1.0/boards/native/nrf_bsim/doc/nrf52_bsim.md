---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/native/nrf_bsim/doc/nrf52_bsim.html
...
These applications typically enable [`CONFIG_CONSOLE_SUBSYS`](../../../../kconfig.md#CONFIG_CONSOLE_SUBSYS "CONFIG_CONSOLE_SUBSYS") and [`CONFIG_CONSOLE_GETCHAR`](../../../../kconfig.md#CONFIG_CONSOLE_GETCHAR "CONFIG_CONSOLE_GETCHAR").
The UART console is disabled by default for BabbleSim boards, to enable it simply add the snippet [UART Console Snippet (uart-console)](../../../../snippets/serial-console/README.md#snippet-uart-console).
