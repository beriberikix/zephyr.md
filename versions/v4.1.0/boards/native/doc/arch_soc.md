---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/native/doc/arch_soc.html
...
![Comparison of different debugging targets](https://docs.zephyrproject.org/4.1.0/_images/Port_vs_QEMU_vs.svg)
...
![Zephyr layering in a native simulator build](https://docs.zephyrproject.org/4.1.0/_images/layering_natsim.svg)

Zephyr layering when built against an embedded target (left), and targeting a native\_simulator
based board (right)

![native_sim boards and the native simulator](https://docs.zephyrproject.org/4.1.0/_images/components_natsim.svg)
