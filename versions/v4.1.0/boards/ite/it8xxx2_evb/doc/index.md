...
| ADC | on-chip | ITE it8xxx2 ADC[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L452) | [`ite,it8xxx2-adc`](../../../../build/dts/api/bindings/adc/ite%2Cit8xxx2-adc.md#std-dtcompatible-ite-it8xxx2-adc) |
...
| ESPI | on-chip | ITE IT8XXX2 ESPI controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L418) | [`ite,it8xxx2-espi`](../../../../build/dts/api/bindings/espi/ite%2Cit8xxx2-espi.md#std-dtcompatible-ite-it8xxx2-espi) |
...
| GPIO & Headers | on-chip | This binding gives a base representation of the ITE gpio[13 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L156) | [`ite,it8xxx2-gpio`](../../../../build/dts/api/bindings/gpio/ite%2Cit8xxx2-gpio.md#std-dtcompatible-ite-it8xxx2-gpio) |
| on-chip | This binding gives a base representation of the ITE kscan pins as gpio[3 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it81xx2.dtsi?plain=1#L16) | [`ite,it8xxx2-gpiokscan`](../../../../build/dts/api/bindings/gpio/ite%2Cit8xxx2-gpiokscan.md#std-dtcompatible-ite-it8xxx2-gpiokscan) |
...
| Input | on-chip | ITE it8xxx2 keyboard matrix controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L676) | [`ite,it8xxx2-kbd`](../../../../build/dts/api/bindings/input/ite%2Cit8xxx2-kbd.md#std-dtcompatible-ite-it8xxx2-kbd) |
...
| PECI | on-chip | ITE it8xxx2 PECI[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L666) | [`ite,it8xxx2-peci`](../../../../build/dts/api/bindings/peci/ite%2Cit8xxx2-peci.md#std-dtcompatible-ite-it8xxx2-peci) |
...
| on-chip | ITE IT8XXX2 pin controller function node[16 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it81xx2.dtsi?plain=1#L62) | [`ite,it8xxx2-pinctrl-func`](../../../../build/dts/api/bindings/pinctrl/ite%2Cit8xxx2-pinctrl-func.md#std-dtcompatible-ite-it8xxx2-pinctrl-func) |
| PWM | on-chip | ITE, it8xxx2 PWM prescaler node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L550) | [`ite,it8xxx2-pwmprs`](../../../../build/dts/api/bindings/pwm/ite%2Cit8xxx2-pwmprs.md#std-dtcompatible-ite-it8xxx2-pwmprs) |
...
| SHI | on-chip | ITE, IT8XXX2 Serial Host Interface (SHI) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L443) | [`ite,it8xxx2-shi`](../../../../build/dts/api/bindings/shi/ite%2Cit8xxx2-shi.md#std-dtcompatible-ite-it8xxx2-shi) |
...
| USB Type-C | on-chip | ITE it8xxx2 USB-C Power Delivery port[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/ite/it8xxx2.dtsi?plain=1#L694) | [`ite,it8xxx2-usbpd`](../../../../build/dts/api/bindings/usb-c/ite%2Cit8xxx2-usbpd.md#std-dtcompatible-ite-it8xxx2-usbpd) |
