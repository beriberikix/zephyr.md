---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/96boards/wistrio/doc/96b_wistrio.html
original_path: boards/96boards/wistrio/doc/96b_wistrio.html
---
...
![96Boards WisTrio](https://docs.zephyrproject.org/4.1.0/_images/96b-wistrio.jpg)

96Boards WisTrio

This board is one of the [96Boards IoT Edition](https://linaro.co/ie-specification) [[5]](#id11) platforms providing LoRa
connectivity.
...
The Zephyr 96b\_wistrio board configuration supports the following hardware
features:
...
[boards/96boards/wistrio/96b\_wistrio\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/96boards/wistrio/96b_wistrio_defconfig)
...
checking the application note [AN2606](https://www.st.com/resource/en/application_note/cd00167594.pdf) [[1]](#id2) .
...
Chapter 29 of Application note [AN2606](https://www.st.com/resource/en/application_note/cd00167594.pdf) [[1]](#id2). The ROM bootloader supports flashing
via UART, and I2C protocols.

Here is an example for building and flashing the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application using [stm32flash](https://sourceforge.net/p/stm32flash/wiki/Home/) [[2]](#id5) command line utility:
...
Use the [Black Magic Debug Probe](https://github.com/blacksphere/blackmagic/wiki) [[3]](#id7) as an SWD programmer, which can
...
documented on its [Getting started page](https://github.com/blacksphere/blackmagic/wiki/Getting-Started) [[4]](#id9).
...
[https://linaro.co/ie-specification](https://linaro.co/ie-specification)
