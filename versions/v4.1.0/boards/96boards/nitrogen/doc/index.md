---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/96boards/nitrogen/doc/index.html
original_path: boards/96boards/nitrogen/doc/index.html
---
...
![96Boards Nitrogen](https://docs.zephyrproject.org/4.1.0/_images/96b_nitrogen.jpg)

96Boards Nitrogen

More information about the board can be found at the [seeed BLE Nitrogen](http://wiki.seeed.cc/BLE_Nitrogen/)
website. The [Nordic Semiconductor Infocenter](http://infocenter.nordicsemi.com/) contains the processor’s
...
The Zephyr 96b\_nitrogen board configuration supports the following hardware
features:
...
See [Nordic Semiconductor Infocenter](http://infocenter.nordicsemi.com/) for a complete list of nRF52-based
board hardware features.

The default configuration can be found in
[boards/96boards/nitrogen/96b\_nitrogen\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/96boards/nitrogen/96b_nitrogen_defconfig)
...
The 96Boards Nitrogen board can be flashed via the [CMSIS DAP](https://developer.mbed.org/handbook/CMSIS-DAP) interface,
...
To use `pyOCD`, install the [pyOCD Debug Host Tools](../../../../develop/flash_debug/host-tools.md#pyocd-debug-host-tools) and make sure they
...
As described by [pyOCD issue 259](https://github.com/mbedmicro/pyOCD/issues/259), you might get the
...
Here is an example for the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application. This
requires installing the [pyOCD Debug Host Tools](../../../../develop/flash_debug/host-tools.md#pyocd-debug-host-tools).
...
[Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application. This also requires pyOCD.
