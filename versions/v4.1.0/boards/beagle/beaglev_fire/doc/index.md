---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/beagle/beaglev_fire/doc/index.html
...
[![../../../../_images/BeagleV-Fire-Front-Annotated-768x432.webp](https://docs.zephyrproject.org/4.1.0/_images/BeagleV-Fire-Front-Annotated-768x432.webp)
](https://docs.zephyrproject.org/4.1.0/_images/BeagleV-Fire-Front-Annotated-768x432.webp)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/beagle/beaglev_fire/doc/index.rst/../..)
...
- `beaglev_fire/polarfire/u54/smp`: Uses the U54 cores with CONFIG\_SMP=y
...
![beaglev_fire](https://docs.zephyrproject.org/4.1.0/_images/board-booting.png)
...
When using the PolarFire [Hart Software Services](https://github.com/polarfire-soc/hart-software-services) along with Zephyr, you need to use the [hss-payload-generator](https://github.com/polarfire-soc/hart-software-services/tree/master/tools/hss-payload-generator) tool to generate an image that HSS can boot.
...
This will cause the board to appear as a USB mass storage device. You can then then flash the image with `dd` or other tools like [BalenaEtcher](https://www.balena.io/etcher/):
