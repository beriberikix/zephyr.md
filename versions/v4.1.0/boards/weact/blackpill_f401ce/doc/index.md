---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/weact/blackpill_f401ce/doc/index.html
original_path: boards/weact/blackpill_f401ce/doc/index.html
---
...
[![../../../../_images/Blackpill_Pinout2.jpg](https://docs.zephyrproject.org/4.1.0/_images/Blackpill_Pinout2.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/Blackpill_Pinout2.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/weact/blackpill_f401ce/doc/index.rst/../..)

## Overview

The WeAct Black Pill V3.0 Board is an extremely low cost and bare-bones
development board featuring the STM32F401CE, see [STM32F401CE website](https://www.st.com/en/microcontrollers/stm32f401ce.html) [[6]](#id12).
This is the 48-pin variant of the STM32F401x series,
see [STM32F401x reference manual](https://www.st.com/resource/en/reference_manual/dm00096844.pdf) [[7]](#id14). More info about the board available
[here](https://stm32-base.org/boards/STM32F401CEU6-WeAct-Black-Pill-V3.0.html) [[4]](#id8) and on [WeAct Github](https://github.com/WeActStudio/WeActStudio.MiniSTM32F4x1) [[3]](#id6).
...
The `blackpill_f401ce` board supports the hardware features listed below.
...
#### `blackpill_f401ce/stm32f401xe` target
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/weact/blackpill_f401ce/blackpill_f401ce.dts?plain=1#L31) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/weact/blackpill_f401ce/blackpill_f401ce.dts?plain=1#L23) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/weact/blackpill_f401ce/blackpill_f401ce.dts?plain=1#L50) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
...
![Black Pill V3.0+ Pinout](https://docs.zephyrproject.org/4.1.0/_images/Blackpill_Pinout3.jpg)
