---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/actinius/icarus/doc/index.html
original_path: boards/actinius/icarus/doc/index.html
---
...
[![../../../../_images/Icarus_pinouts.jpg](https://docs.zephyrproject.org/4.1.0/_images/Icarus_pinouts.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/Icarus_pinouts.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/actinius/icarus/doc/index.rst/../..)
...
![Icarus IoT Dev Board w/ Pinouts](https://docs.zephyrproject.org/4.1.0/_images/Icarus_pinouts1.jpg)
...
| 14 / A1 | GPIO / Analog in | nRF9160 P0.14 / AIN1 | gpio0 / adc\_1 |
| 15 / A2 | GPIO / Analog in | nRF9160 P0.15 / AIN2 | gpio0 / adc\_2 |
| 16 / A3 | GPIO / Analog in | nRF9160 P0.16 / AIN3 | gpio0 / adc\_3 |
| 17 / A4 | GPIO / Analog in | nRF9160 P0.17 / AIN4 | gpio0 / adc\_4 |
| 18 / A5 | GPIO / Analog in | nRF9160 P0.18 / AIN5 | gpio0 / adc\_5 |
| 19 / A6 | GPIO / Analog in | nRF9160 P0.19 / AIN6 | gpio0 / adc\_6 |
...
| P0.13 / AIN0 | Battery voltage measurement | adc\_0 |
| P0.06 | USB - FTDI serial RX | uart0 |
| P0.09 | USB - FTDI serial TX | uart0 |
| P0.07 | USB - FTDI serial RTS Charger enable pin (Icarus v2.0) | uart0 gpio0 (Icarus v2.0) |
| P0.25 | USB - FTDI serial CTS FLASH memory SPI CS pin (Icarus v2.0) | uart0 gpio0 (Icarus v2.0) |

### Supported Features

The actinius\_icarus board configuration supports the following
hardware features:
...
More information can be found in the [Icarus “Get Started” Guide](https://www.actinius.com/get-started) [[3]](#id7) or the
[Actinius Documentation Portal](https://docs.actinius.com) [[4]](#id9).
...
[https://www.actinius.com/icarus](https://www.actinius.com/icarus)

[[3](#id8)]

[https://www.actinius.com/get-started](https://www.actinius.com/get-started)
