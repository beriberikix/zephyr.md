---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/snps/nsim/arc_v/doc/index.html
original_path: boards/snps/nsim/arc_v/doc/index.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/snps/nsim/arc_v/doc/index.rst/../..)

## Overview

This platform can be used to run Zephyr RTOS on the widest possible range of Synopsys RISC-V processors in
simulation with [Designware ARC nSIM](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim) [[1]](#id1) or run same images on FPGA prototyping platform [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id6). The
...
files in [boards/snps/nsim/arc\_v/support/](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_v/support/) directory to understand
...
either [DesignWare ARC nSIM](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim) [[1]](#id1) or [DesignWare ARC Free nSIM](https://www.synopsys.com/cgi-bin/dwarcnsim/req1.cgi) [[2]](#id4) is required.
...
I.e. for the `nsim_arc_v/rmx100` board we can check [boards/snps/nsim/arc\_v/nsim\_arc\_v\_rmx100.yaml](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_v/nsim_arc_v_rmx100.yaml)
...
nSIM configuration is defined in [props files](#board-nsim-arc-v-prop-files).
...
it is [soc/snps/nsim/arc\_v/CMakeLists.txt](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/snps/nsim/arc_v/CMakeLists.txt).
...
[running build in verbose mode](#board-nsim-arc-v-verbose-build).
