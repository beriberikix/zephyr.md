---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/snps/nsim/arc_classic/doc/index.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/snps/nsim/arc_classic/doc/index.rst/../..)

## Overview

This platform can be used to run Zephyr RTOS on the widest possible range of ARC processors in
simulation with [Designware ARC nSIM](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim) [[1]](#id1) or run same images on FPGA prototyping platform [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7). The
...
`.props` or `.args` files in [boards/snps/nsim/arc\_classic/support/](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_classic/support/) directory to understand
...
[boards/snps/nsim/arc\_classic/support/nsim\_hs5x.props](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_classic/support/nsim_hs5x.props) and
[boards/snps/nsim/arc\_classic/support/mdb\_hs5x.args](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_classic/support/mdb_hs5x.args).
...
[boards/snps/nsim/arc\_classic/support/mdb\_hs5x\_smp.args](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_classic/support/mdb_hs5x_smp.args).
...
either [DesignWare ARC nSIM](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim) [[1]](#id1) or [DesignWare ARC Free nSIM](https://www.synopsys.com/cgi-bin/dwarcnsim/req1.cgi) [[2]](#id5) is required.

To run multi-core Zephyr RTOS applications in simulation on this board,
[DesignWare ARC nSIM](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim) [[1]](#id1) and MetaWare Debugger from [ARC MWDT](https://www.synopsys.com/dw/ipdir.php?ds=sw_metaware) [[4]](#id14) are required.

To run Zephyr RTOS applications on FPGA-based [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7) platform,
MetaWare Debugger from [ARC MWDT](https://www.synopsys.com/dw/ipdir.php?ds=sw_metaware) [[4]](#id14) is required as well as the HAPS platform itself.
...
I.e. for the `nsim/nsim_hs5x` board we can check [boards/snps/nsim/arc\_classic/nsim\_nsim\_hs5x.yaml](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/nsim/arc_classic/nsim_nsim_hs5x.yaml)
...
FPGA based HW platform [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7). To run previously built application on HAPS do:
...
- Allows to debug on [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7) platform.
...
You can use the following command to start GUI debugging when running application on [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7)
platform:
...
Currently debugging with GDB is not supported on [HAPS](https://www.synopsys.com/verification/prototyping/haps.html) [[3]](#id7) platform.
...
it is [soc/snps/nsim/arc\_classic/CMakeLists.txt](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/snps/nsim/arc_classic/CMakeLists.txt).
...
[https://www.synopsys.com/dw/ipdir.php?ds=sim\_nsim](https://www.synopsys.com/dw/ipdir.php?ds=sim_nsim)

[[2](#id6)]

[https://www.synopsys.com/cgi-bin/dwarcnsim/req1.cgi](https://www.synopsys.com/cgi-bin/dwarcnsim/req1.cgi)

[3]
([1](#id8),[2](#id9),[3](#id10),[4](#id11),[5](#id12),[6](#id13))

[https://www.synopsys.com/verification/prototyping/haps.html](https://www.synopsys.com/verification/prototyping/haps.html)

[4]
([1](#id15),[2](#id16))

[https://www.synopsys.com/dw/ipdir.php?ds=sw\_metaware](https://www.synopsys.com/dw/ipdir.php?ds=sw_metaware)
