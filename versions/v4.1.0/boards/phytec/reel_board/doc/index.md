---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/phytec/reel_board/doc/index.html
original_path: boards/phytec/reel_board/doc/index.html
---
...
[reel board](https://www.phytec.de/reelboard/) [[3]](#id15) [[1]](#id10) is a evaluation board based on the Nordic Semiconductor
...
The schematic can be found on the [reel board website](https://www.phytec.de/reelboard/) [[3]](#id15) [[1]](#id10).
...
![reel board front](https://docs.zephyrproject.org/4.1.0/_images/reel_board.jpg)

reel board front (Credit: PHYTEC)

![reel board back](https://docs.zephyrproject.org/4.1.0/_images/reel_board_descr_back.jpg)
...
| Good Display GDEH0213B72 | HINK-E0213A22 | SSD1675A / ssd16xx | reel\_board@2 |
...
[boards/phytec/reel\_board/board.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/phytec/reel_board/board.c)
...
![reel board Jumper and Testpoints](https://docs.zephyrproject.org/4.1.0/_images/reel_board_tp.jpg)
...
![reel board Debug Adapter](https://docs.zephyrproject.org/4.1.0/_images/reel_board_debug.jpg)

reel board Debug Adapter overview (Credit: PHYTEC)

#### Debug Adapter Firmware

DAPLink firmware for the adapter can be found at [DAPLink reel board Firmware](https://github.com/PHYTEC-Messtechnik-GmbH/DAPLink/tree/reel-board) [[4]](#id18) [[2]](#id13).
...
![reel board Expansion Connector](https://docs.zephyrproject.org/4.1.0/_images/reel_board_excon.jpg)
...
![reel board and link board BASE](https://docs.zephyrproject.org/4.1.0/_images/rb_lb_shield.jpg)
...
![link board BASE](https://docs.zephyrproject.org/4.1.0/_images/link_board_base.jpg)
...
Please use reel\_board@2 to build a application for the board equipped with
