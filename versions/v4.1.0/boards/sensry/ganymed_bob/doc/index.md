---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/sensry/ganymed_bob/doc/index.html
...
![Ganymed Break-Out-Board (BOB) equipped with SY120 GBM](https://docs.zephyrproject.org/4.1.0/_images/ganymed_bob_sy120_gbm.webp)

Ganymed Break-Out-Board (BOB) equipped with SY120 GBM (Credit: Sensry)

![Ganymed Break-Out-Board (BOB) equipped with SY120 GEN1](https://docs.zephyrproject.org/4.1.0/_images/ganymed_bob_sy120_gen1.webp)
