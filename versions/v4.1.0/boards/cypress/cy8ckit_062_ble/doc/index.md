---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/cypress/cy8ckit_062_ble/doc/index.html
original_path: boards/cypress/cy8ckit_062_ble/doc/index.html
---
...
[![../../../../_images/cy8ckit-062-ble.jpg](https://docs.zephyrproject.org/4.1.0/_images/cy8ckit-062-ble.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/cy8ckit-062-ble.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/cypress/cy8ckit_062_ble/doc/index.rst/../..)
...
- [PSOC 63 BLE MCU SoC Website](https://www.cypress.com/products/32-bit-arm-cortex-m4-cortex-m0-psoc-63-connectivity-line) [[1]](#id2)
- [PSOC 63 BLE MCU Datasheet](https://www.cypress.com/documentation/datasheets/psoc-6-mcu-psoc-63-ble-datasheet-programmable-system-chip-psoc) [[2]](#id4)
- [PSOC 63 BLE MCU Architecture Reference Manual](https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-psoc-63-ble-architecture-technical-reference) [[3]](#id6)
- [PSOC 63 BLE MCU Register Reference Manual](https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-cy8c63x6-cy8c63x7-cy8c63x6-cy8c63x7-registers) [[4]](#id8)
- [CY8CKIT-062-BLE Website](https://www.cypress.com/documentation/development-kitsboards/psoc-6-ble-pioneer-kit-cy8ckit-062-ble) [[5]](#id10)
- [CY8CKIT-062-BLE User Guide](https://www.cypress.com/file/390496/download) [[6]](#id12)
- [CY8CKIT-062-BLE Schematics](https://www.cypress.com/file/417021/download) [[7]](#id14)
...
[boards/cypress/cy8ckit\_062\_ble/cy8ckit\_062\_ble\_cy8c6347\_m0\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/cypress/cy8ckit_062_ble/cy8ckit_062_ble_cy8c6347_m0_defconfig) for
Cortex-M0+ and on the Kconfig
[boards/cypress/cy8ckit\_062\_ble/cy8ckit\_062\_ble\_cy8c6347\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/cypress/cy8ckit_062_ble/cy8ckit_062_ble_cy8c6347_m4_defconfig) for
Cortex-M4
...
USB-UART Bridge working as a serial console interface. SCB6 to P13\_0, P13\_1
...
A watchdog timer is enabled by default. To disable it call Cy\_WDT\_Unlock() and
Cy\_WDT\_Disable().
...
1. Build the Zephyr kernel and the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") sample application:
   ...
   ```shell
   west build -b cy8ckit_062_ble/cy8c6347/m0 samples/hello_world
   ```
...
3. To flash an image:
   ...
   You should see “Hello World! cy8ckit\_062\_ble” in your terminal.

## Running on Dual Core

1. Build the Zephyr kernel and the [Button](../../../../samples/basic/button/README.md#button "Handle GPIO inputs with interrupts.") sample application:

   ```shell
   west build -b cy8ckit_062_ble/cy8c6347/m4 samples/basic/button
   ```
2. If you have a USB-Serial adapter, you can connect SBC[UART]-6 on Arduino
...
3. To flash an image:
   ...
   west flash
   ```
4. Configure Cortex-M0+ to enable Cortex-M4:
   ...
   ```shell
   west build -b cy8ckit_062_ble/cy8c6347/m0 samples/hello_world -- -DCONFIG_SOC_PSOC6_M0_ENABLES_M4=y
   west flash
   ```

   Now you can press button SW-2 and see LED-9 blink at same time you have the
   “Hello World! cy8ckit\_062\_ble” in the your terminal.
...
1. Build the Zephyr kernel and the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") sample application for
   board revision 1.0.0:

   ```shell
   west build -b cy8ckit_062_ble@1.0.0/cy8c6347/m0 samples/hello_world
   ```
2. The differences from version 0.0.0 to 1.0.0:

| Connection | 0.0.0 | 1.0.0 |
| --- | --- | --- |
| CDC-COM RX | P5\_0 | P9\_0 |
| CDC-COM TX | P5\_1 | P9\_1 |
| R77 | X |  |
| R78 |  | X |
...
UART\_RTS with UART\_CTS from KitProg2.
...
[https://www.cypress.com/documentation/datasheets/psoc-6-mcu-psoc-63-ble-datasheet-programmable-system-chip-psoc](https://www.cypress.com/documentation/datasheets/psoc-6-mcu-psoc-63-ble-datasheet-programmable-system-chip-psoc)

[[3](#id7)]

[https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-psoc-63-ble-architecture-technical-reference](https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-psoc-63-ble-architecture-technical-reference)

[[4](#id9)]

[https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-cy8c63x6-cy8c63x7-cy8c63x6-cy8c63x7-registers](https://www.cypress.com/documentation/technical-reference-manuals/psoc-6-mcu-cy8c63x6-cy8c63x7-cy8c63x6-cy8c63x7-registers)

[[5](#id11)]

[https://www.cypress.com/documentation/development-kitsboards/psoc-6-ble-pioneer-kit-cy8ckit-062-ble](https://www.cypress.com/documentation/development-kitsboards/psoc-6-ble-pioneer-kit-cy8ckit-062-ble)

[[6](#id13)]

[https://www.cypress.com/file/390496/download](https://www.cypress.com/file/390496/download)

[[7](#id15)]

[https://www.cypress.com/file/417021/download](https://www.cypress.com/file/417021/download)
