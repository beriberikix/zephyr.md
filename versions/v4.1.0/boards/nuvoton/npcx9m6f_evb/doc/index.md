...
| Cryptographic accelerator | on-chip | NPCX Crypto SHA accelerator[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L383) | [`nuvoton,npcx-sha`](../../../../build/dts/api/bindings/crypto/nuvoton%2Cnpcx-sha.md#std-dtcompatible-nuvoton-npcx-sha) |
...
| on-chip | The SPI NOR flash devices accessed by Nuvoton Flash Interface Unit (FIU)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx9m6f.dtsi?plain=1#L32) | [`nuvoton,npcx-fiu-nor`](../../../../build/dts/api/bindings/flash_controller/nuvoton%2Cnpcx-fiu-nor.md#std-dtcompatible-nuvoton-npcx-fiu-nor) |
...
| Memory controller | on-chip | Nuvoton, NPCX Battery Backed RAM node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L85) | [`nuvoton,npcx-bbram`](../../../../build/dts/api/bindings/memory-controllers/nuvoton%2Cnpcx-bbram.md#std-dtcompatible-nuvoton-npcx-bbram) |
...
| Reset controller | on-chip | NPCX Reset Controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L406) | [`nuvoton,npcx-rst`](../../../../build/dts/api/bindings/reset/nuvoton%2Cnpcx-rst.md#std-dtcompatible-nuvoton-npcx-rst) |
...
| SHI | on-chip | Nuvoton, NPCX Serial Host Interface (SHI) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L390) | [`nuvoton,npcx-shi`](../../../../build/dts/api/bindings/shi/nuvoton%2Cnpcx-shi.md#std-dtcompatible-nuvoton-npcx-shi) |
...
| on-chip | Nuvoton, NPCX Internal Timer (ITIM) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L93) | [`nuvoton,npcx-itim-timer`](../../../../build/dts/api/bindings/timer/nuvoton%2Cnpcx-itim-timer.md#std-dtcompatible-nuvoton-npcx-itim-timer) |
