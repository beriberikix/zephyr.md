...
| Cryptographic accelerator | on-chip | NPCX Crypto SHA accelerator[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L405) | [`nuvoton,npcx-sha`](../../../../build/dts/api/bindings/crypto/nuvoton%2Cnpcx-sha.md#std-dtcompatible-nuvoton-npcx-sha) |
...
| on-chip | The target flash devices accessed by Nuvoton eSPI TAF controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L427) | [`nuvoton,npcx-espi-taf`](../../../../build/dts/api/bindings/espi/nuvoton%2Cnpcx-espi-taf.md#std-dtcompatible-nuvoton-npcx-espi-taf) |
...
| on-chip | The SPI NOR flash devices accessed by Nuvoton Flash Interface Unit (FIU)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx4m8f.dtsi?plain=1#L32) | [`nuvoton,npcx-fiu-nor`](../../../../build/dts/api/bindings/flash_controller/nuvoton%2Cnpcx-fiu-nor.md#std-dtcompatible-nuvoton-npcx-fiu-nor) |
| GPIO & Headers | on-chip | Nuvoton, NPCX-GPIO node[16 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx.dtsi?plain=1#L124) | [`nuvoton,npcx-gpio`](../../../../build/dts/api/bindings/gpio/nuvoton%2Cnpcx-gpio.md#std-dtcompatible-nuvoton-npcx-gpio) |
...
| I3C | on-chip | Nuvoton I3C controller[3 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L441) | [`nuvoton,npcx-i3c`](../../../../build/dts/api/bindings/i3c/nuvoton%2Cnpcx-i3c.md#std-dtcompatible-nuvoton-npcx-i3c) |
...
| Memory controller | on-chip | Nuvoton, NPCX Battery Backed RAM node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L87) | [`nuvoton,npcx-bbram`](../../../../build/dts/api/bindings/memory-controllers/nuvoton%2Cnpcx-bbram.md#std-dtcompatible-nuvoton-npcx-bbram) |
...
| on-chip | Nuvoton, NPCX System Configuration (Pinmux, 1.8V support and so on) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx.dtsi?plain=1#L78) | [`nuvoton,npcx-scfg`](../../../../build/dts/api/bindings/pinctrl/nuvoton%2Cnpcx-scfg.md#std-dtcompatible-nuvoton-npcx-scfg) |
...
| Reset controller | on-chip | NPCX Reset Controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L434) | [`nuvoton,npcx-rst`](../../../../build/dts/api/bindings/reset/nuvoton%2Cnpcx-rst.md#std-dtcompatible-nuvoton-npcx-rst) |
...
| SHI | on-chip | Nuvoton, NPCX Serial Host Interface (SHI) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L412) | [`nuvoton,npcx-shi-enhanced`](../../../../build/dts/api/bindings/shi/nuvoton%2Cnpcx-shi-enhanced.md#std-dtcompatible-nuvoton-npcx-shi-enhanced) |
...
| on-chip | Nuvoton, NPCX Internal Timer (ITIM) node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx4.dtsi?plain=1#L95) | [`nuvoton,npcx-itim-timer`](../../../../build/dts/api/bindings/timer/nuvoton%2Cnpcx-itim-timer.md#std-dtcompatible-nuvoton-npcx-itim-timer) |
| Watchdog | on-chip | Nuvoton, NPCX-TWD node[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx.dtsi?plain=1#L334) | [`nuvoton,npcx-watchdog`](../../../../build/dts/api/bindings/watchdog/nuvoton%2Cnpcx-watchdog.md#std-dtcompatible-nuvoton-npcx-watchdog) |
