---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/adafruit/feather_m0_basic_proto/doc/index.html
...
[![../../../../_images/adafruit_feather_m0_basic_proto.jpg](https://docs.zephyrproject.org/4.1.0/_images/adafruit_feather_m0_basic_proto.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/adafruit_feather_m0_basic_proto.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/adafruit/feather_m0_basic_proto/doc/index.rst/../..)
...
The `adafruit_feather_m0_basic_proto` board supports the hardware features listed below.
...
#### `adafruit_feather_m0_basic_proto/samd21g18a` target
...
| on-board | GPIO pins exposed on Adafruit Feather headers[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adafruit/feather_m0_basic_proto/feather_connector.dtsi?plain=1#L9) | [`adafruit-feather-header`](../../../../build/dts/api/bindings/gpio/adafruit-feather-header.md#std-dtcompatible-adafruit-feather-header) |
| I2C | on-chip | Atmel SAM0 series SERCOM I2C[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L138) | [`atmel,sam0-i2c`](../../../../build/dts/api/bindings/i2c/atmel,sam0-i2c.md#std-dtcompatible-atmel-sam0-i2c) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adafruit/feather_m0_basic_proto/adafruit_feather_m0_basic_proto.dts?plain=1#L31) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| SPI | on-chip | Atmel SAM0 SERCOM SPI controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L144) | [`atmel,sam0-spi`](../../../../build/dts/api/bindings/spi/atmel,sam0-spi.md#std-dtcompatible-atmel-sam0-spi) |
