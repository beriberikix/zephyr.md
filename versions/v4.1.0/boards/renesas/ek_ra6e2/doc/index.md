---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/renesas/ek_ra6e2/doc/index.html
...
[![../../../../_images/ek_ra6e2.webp](https://docs.zephyrproject.org/4.1.0/_images/ek_ra6e2.webp)
](https://docs.zephyrproject.org/4.1.0/_images/ek_ra6e2.webp)
...
[![RA6E2 MCU group feature](https://docs.zephyrproject.org/4.1.0/_images/ra6e2_block_diagram1.webp)
](https://docs.zephyrproject.org/4.1.0/_images/ra6e2_block_diagram1.webp)
...
| GPIO & Headers | on-chip | Renesas RA GPIO IO port[5 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/renesas/ra/ra6/ra6-cm33-common.dtsi?plain=1#L42)[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/renesas/ra/ra6/ra6-cm33-common.dtsi?plain=1#L92) | [`renesas,ra-gpio-ioport`](../../../../build/dts/api/bindings/gpio/renesas,ra-gpio-ioport.md#std-dtcompatible-renesas-ra-gpio-ioport) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/renesas/ek_ra6e2/ek_ra6e2.dts?plain=1#L176) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
