---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/shields/mikroe_wifi_bt_click/doc/index.html
...
![MikroE WIFI BLE Click](https://docs.zephyrproject.org/4.1.0/_images/wifi_click.jpg)
...
west build -b lpcxpresso55s69/lpc55s69/cpu0 --shield mikroe_wifi_bt_click_mikrobus samples/net/wifi
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b b_u585i_iot02a --shield mikroe_wifi_bt_click_arduino samples/net/wifi
west flash
```
