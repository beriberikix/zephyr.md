---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/shields/p3t1755dp_ard_i3c/doc/index.html
original_path: boards/shields/p3t1755dp_ard_i3c/doc/index.html
---
...
![P3T1755DP ARD](https://docs.zephyrproject.org/4.1.0/_images/p3t1755dp_ard1.webp)
...
- [Getting Started with the P3T1755DP-ARD Evaluation Board](https://www.nxp.com/document/guide/getting-started-with-the-p3t1755dp-ard-evaluation-board:GS-P3T1755DP-ARD)
- [P3T1755DP-ARD Evaluation Board User Manual](https://www.nxp.com/docs/en/user-manual/UM11834.pdf)

## Hardware Connection

- Shield board p3t1755dp\_ard in I3C mode
  :   J10, J11, J12 3-5, the i3c addr is 0x4800000236152a0090
      JP2, Jp3 1-2
      I3C is from J13
      The VDD from arduino is 3v3 JP1 2-3
- Shield board p3t1755dp\_ard in I2C mode
  :   J10, J11, J12 3-5, the i2c addr is 0x48
      JP2, Jp3 2-3
      The I2C is from Arduino J5 pin9(SCL\_ARD) pin10(SDA\_ARD)
      The VDD from arduino is 3v3 JP1 2-3
