...
[![../../../../_images/mec172xevb_assy6906.jpg](https://docs.zephyrproject.org/4.1.0/_images/mec172xevb_assy6906.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/mec172xevb_assy6906.jpg)
...
#### `mec172xevb_assy6906/mec172x_nsz` target
...
| on-board | PCA95xx series I2C-based GPIO expander[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/microchip/mec172xevb_assy6906/mec172xevb_assy6906.dts?plain=1#L152) | [`nxp,pca95xx`](../../../../build/dts/api/bindings/gpio/nxp,pca95xx.md#std-dtcompatible-nxp-pca95xx) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/microchip/mec172xevb_assy6906/mec172xevb_assy6906.dts?plain=1#L33) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
1. Connect the SPI Dongle ASSY 6791 to `J34` in the EVB.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/4.1.0/_images/spidongle_assy67911.jpg)
2. Connect programmer to the header J6 on the Assy6791 board, it will flash the SPI NOR chip
   ...
   ![SF100 Connected](https://docs.zephyrproject.org/4.1.0/_images/dediprog_connector.jpg)
...
4. Apply power to the board via a micro-USB cable.
   ...
   ![Power Connection](https://docs.zephyrproject.org/4.1.0/_images/jp30_power_options.jpg)
...
2. Flash your board using `west` from the second terminal window.
   ...
   ![Reset Button](https://docs.zephyrproject.org/4.1.0/_images/Reset_Button.jpg)
