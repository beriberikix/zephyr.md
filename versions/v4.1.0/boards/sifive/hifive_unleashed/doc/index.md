---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/sifive/hifive_unleashed/doc/index.html
...
[![../../../../_images/hifive_unleashed.jpg](https://docs.zephyrproject.org/4.1.0/_images/hifive_unleashed.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/hifive_unleashed.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/sifive/hifive_unleashed/doc/index.rst/../..)
...
west build -b hifive_unleashed/fu540/e51 samples/hello_world
```

```shell
# From the root of the zephyr repository
west build -b hifive_unleashed/fu540/u54 samples/hello_world
```
