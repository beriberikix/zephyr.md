---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/st/nucleo_f030r8/doc/index.html
original_path: boards/st/nucleo_f030r8/doc/index.html
---
...
[![../../../../_images/nucleo_f030r8.jpg](https://docs.zephyrproject.org/4.1.0/_images/nucleo_f030r8.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/nucleo_f030r8.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/st/nucleo_f030r8/doc/index.rst/../..)
...
More information about the board can be found at the [Nucleo F030R8 website](https://www.st.com/en/evaluation-tools/nucleo-f030r8.html) [[1]](#id2).
...
- [STM32F030 data sheet](https://www.st.com/resource/en/datasheet/stm32f030r8.pdf) [[3]](#id6)

### Supported Features

The `nucleo_f030r8` board supports the hardware features listed below.
...
#### `nucleo_f030r8/stm32f030x8@1` target
...
| on-board | GPIO pins exposed on Arduino Uno (R3) headers[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_f030r8/arduino_r3_connector.dtsi?plain=1#L8) | [`arduino-header-r3`](../../../../build/dts/api/bindings/gpio/arduino-header-r3.md#std-dtcompatible-arduino-header-r3) |
| on-board | GPIO pins exposed on ST Morpho connector[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_f030r8/st_morpho_connector.dtsi?plain=1#L10) | [`st-morpho-header`](../../../../build/dts/api/bindings/gpio/st-morpho-header.md#std-dtcompatible-st-morpho-header) |
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_f030r8/nucleo_f030r8.dts?plain=1#L33) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_f030r8/nucleo_f030r8.dts?plain=1#L25) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| Serial controller | on-chip | STM32 USART[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/f0/stm32f0.dtsi?plain=1#L173) | [`st,stm32-usart`](../../../../build/dts/api/bindings/serial/st%2Cstm32-usart.md#std-dtcompatible-st-stm32-usart) |
...
| on-chip | STM32 timers[7 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/f0/stm32f0.dtsi?plain=1#L233) | [`st,stm32-timers`](../../../../build/dts/api/bindings/timer/st%2Cstm32-timers.md#std-dtcompatible-st-stm32-timers) |
...
#### `nucleo_f030r8/stm32f030x8@2` target
...
![Nucleo F030R8 connectors](https://docs.zephyrproject.org/4.1.0/_images/nucleo_f030r8_connectors.jpg)
...
The board is configured to be flashed using west [STM32CubeProgrammer](https://www.st.com/en/development-tools/stm32cubeprog.html) [[5]](#id11) runner,
...
```shell
# From the root of the zephyr repository
west build -b nucleo_f030r8@1 samples/basic/blinky
west flash
```
...
[STM32 Nucleo-64 board User Manual](https://www.st.com/resource/en/user_manual/dm00105823.pdf) [[4]](#id8) mentions to Nucleo board variants.
...
Please see [Flashing](#nucleo-f030r8-flashing) section.

## References

[[1](#id3)]

[https://www.st.com/en/evaluation-tools/nucleo-f030r8.html](https://www.st.com/en/evaluation-tools/nucleo-f030r8.html)
...
[https://www.st.com/resource/en/datasheet/stm32f030r8.pdf](https://www.st.com/resource/en/datasheet/stm32f030r8.pdf)
