...
[![../../../../_images/sensortile_box.jpg](https://docs.zephyrproject.org/4.1.0/_images/sensortile_box.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/sensortile_box.jpg)
...
| DAC | on-chip | STM32 family DAC[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4p5.dtsi?plain=1#L358) | [`st,stm32-dac`](../../../../build/dts/api/bindings/dac/st,stm32-dac.md#std-dtcompatible-st-stm32-dac) |
| Display | on-chip | STM32 LCD-TFT display controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4r9.dtsi?plain=1#L15) | [`st,stm32-ltdc`](../../../../build/dts/api/bindings/display/st,stm32-ltdc.md#std-dtcompatible-st-stm32-ltdc) |
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L38) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
| MMC | on-chip | STM32 SDMMC Disk Access[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4p5.dtsi?plain=1#L338) | [`st,stm32-sdmmc`](../../../../build/dts/api/bindings/mmc/st,stm32-sdmmc.md#std-dtcompatible-st-stm32-sdmmc) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L212) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
| OCTOSPI | on-chip | STM32 OSPI Controller[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4p5.dtsi?plain=1#L366) | [`st,stm32-ospi`](../../../../build/dts/api/bindings/ospi/st,stm32-ospi.md#std-dtcompatible-st-stm32-ospi) |
...
| PWM | on-chip | STM32 PWM[10 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4.dtsi?plain=1#L297) | [`st,stm32-pwm`](../../../../build/dts/api/bindings/pwm/st,stm32-pwm.md#std-dtcompatible-st-stm32-pwm) |
...
| Sensors | on-board | STMicroelectronics HTS221 humidity and temperature sensor on I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L109) | [`st,hts221`](../../../../build/dts/api/compatibles/st,hts221.md#std-dtcompatible-st-hts221) |
| on-board | STMicroelectronics LPS22HH pressure and temperature sensor connected to I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L115) | [`st,lps22hh`](../../../../build/dts/api/compatibles/st,lps22hh.md#std-dtcompatible-st-lps22hh) |
| on-board | STMicroelectronics STTS751 temperature sensor connected to I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L128) | [`st,stts751`](../../../../build/dts/api/bindings/sensor/st,stts751-i2c.md#std-dtcompatible-st-stts751) |
| on-board | STMicroelectronics LIS2DW12 3-axis accelerometer accessed through SPI bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L143) | [`st,lis2dw12`](../../../../build/dts/api/compatibles/st,lis2dw12.md#std-dtcompatible-st-lis2dw12) |
| on-board | STMicroelectronics LSM6DSO 6-axis IMU (Inertial Measurement Unit) sensor accessed through SPI bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L150) | [`st,lsm6dso`](../../../../build/dts/api/compatibles/st,lsm6dso.md#std-dtcompatible-st-lsm6dso) |
| on-board | STMicroelectronics IIS3DHHC 3-axis accelerometer accessed through SPI bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L158) | [`st,iis3dhhc`](../../../../build/dts/api/bindings/sensor/st,iis3dhhc-spi.md#std-dtcompatible-st-iis3dhhc) |
| on-board | STMicroelectronics LIS2MDL magnetometer accessed through I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/sensortile_box/sensortile_box.dts?plain=1#L191) | [`st,lis2mdl`](../../../../build/dts/api/compatibles/st,lis2mdl.md#std-dtcompatible-st-lis2mdl) |
...
| SPI | on-chip | STM32 SPI controller with embedded Rx and Tx FIFOs[3 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4.dtsi?plain=1#L276) | [`st,stm32-spi-fifo`](../../../../build/dts/api/bindings/spi/st,stm32-spi-fifo.md#std-dtcompatible-st-stm32-spi-fifo) |
...
| on-chip | STM32 timers[11 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4.dtsi?plain=1#L287) | [`st,stm32-timers`](../../../../build/dts/api/bindings/timer/st,stm32-timers.md#std-dtcompatible-st-stm32-timers) |
