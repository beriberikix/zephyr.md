---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/st/b_l4s5i_iot01a/doc/index.html
...
| Bluetooth | on-board | STMicroelectronics SPI protocol V1 compatible with BlueNRG-MS devices[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L155) | [`st,hci-spi-v1`](../../../../build/dts/api/bindings/bluetooth/st,hci-spi-v1.md#std-dtcompatible-st-hci-spi-v1) |
...
| on-board | STM32 OSPI Flash controller supporting the JEDEC CFI interface[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L247) | [`st,stm32-ospi-nor`](../../../../build/dts/api/bindings/flash_controller/st,stm32-ospi-nor.md#std-dtcompatible-st-stm32-ospi-nor) |
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L40) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L177) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
| OCTOSPI | on-chip | STM32 OSPI Controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4p5.dtsi?plain=1#L366)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/l4/stm32l4p5.dtsi?plain=1#L380) | [`st,stm32-ospi`](../../../../build/dts/api/bindings/ospi/st,stm32-ospi.md#std-dtcompatible-st-stm32-ospi) |
...
| Sensors | on-board | STMicroelectronics LIS3MDL magnetometer[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L112) | [`st,lis3mdl-magn`](../../../../build/dts/api/bindings/sensor/st,lis3mdl-magn.md#std-dtcompatible-st-lis3mdl-magn) |
| on-board | STMicroelectronics HTS221 humidity and temperature sensor on I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L117) | [`st,hts221`](../../../../build/dts/api/compatibles/st,hts221.md#std-dtcompatible-st-hts221) |
| on-board | STMicroelectronics LPS22HB pressure sensor[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L122) | [`st,lps22hb-press`](../../../../build/dts/api/bindings/sensor/st,lps22hb-press.md#std-dtcompatible-st-lps22hb-press) |
| on-board | STMicroelectronics LSM6DSL 6-axis accelerometer and gyrometer accessed through I2C bus[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L127) | [`st,lsm6dsl`](../../../../build/dts/api/compatibles/st,lsm6dsl.md#std-dtcompatible-st-lsm6dsl) |
| on-board | STMicroelectronics VL53L0X Time of Flight sensor[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L133) | [`st,vl53l0x`](../../../../build/dts/api/bindings/sensor/st,vl53l0x.md#std-dtcompatible-st-vl53l0x) |
...
| Wi-Fi | on-board | es-WiFi module[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_l4s5i_iot01a/b_l4s5i_iot01a.dts?plain=1#L164) | [`inventek,eswifi`](../../../../build/dts/api/bindings/wifi/inventek,eswifi.md#std-dtcompatible-inventek-eswifi) |
