---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/particle/xenon/doc/index.html
original_path: boards/particle/xenon/doc/index.html
---
...
[![../../../../_images/particle_xenon.jpg](https://docs.zephyrproject.org/4.1.0/_images/particle_xenon.jpg)
](https://docs.zephyrproject.org/4.1.0/_images/particle_xenon.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/particle/xenon/doc/index.rst/../..)
...
- [Xenon Datasheet](https://docs.particle.io/datasheets/mesh/xenon-datasheet/)
...
The `particle_xenon` board supports the hardware features listed below.
...
#### `particle_xenon/nrf52840` target
...
| on-board | GPIO pins exposed on Particle Gen3 (Feather) headers[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/dts/mesh_feather.dtsi?plain=1#L69) | [`particle-gen3-header`](../../../../build/dts/api/bindings/gpio/particle-gen3-header.md#std-dtcompatible-particle-gen3-header) |
| on-board | GPIO pins exposed on Adafruit Feather headers[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/dts/mesh_feather.dtsi?plain=1#L98) | [`adafruit-feather-header`](../../../../build/dts/api/bindings/gpio/adafruit-feather-header.md#std-dtcompatible-adafruit-feather-header) |
...
| IIO | on-board | Description for a voltage divider, with optional ability to measure resistance of the upper leg[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/particle_xenon.dts?plain=1#L23) | [`voltage-divider`](../../../../build/dts/api/bindings/iio/afe/voltage-divider.md#std-dtcompatible-voltage-divider) |
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/dts/mesh_feather.dtsi?plain=1#L54) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
| Interrupt controller | on-chip | ARMv7-M NVIC (Nested Vectored Interrupt Controller)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/armv7-m.dtsi?plain=1#L13) | [`arm,v7m-nvic`](../../../../build/dts/api/bindings/interrupt-controller/arm%2Cv7m-nvic.md#std-dtcompatible-arm-v7m-nvic) |
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/dts/mesh_feather.dtsi?plain=1#L34) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| on-board | Output selectors on the SKY13351 GaAs SPDT FET I/C switch[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/particle/xenon/particle_xenon.dts?plain=1#L17) | [`skyworks,sky13351`](../../../../build/dts/api/bindings/misc/skyworks%2Csky13351.md#std-dtcompatible-skyworks-sky13351) |
...
Please see the [Xenon Datasheet](https://docs.particle.io/datasheets/mesh/xenon-datasheet/) for header pin assignments, which are
