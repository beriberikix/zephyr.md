---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/memory_management/virtual_memory.html
...
- [`k_mem_map()`](../../doxygen/html/group__kernel__memory__management.md#gacf5f9c43ac2c31c376fed4a19f607feb) can be used to map unused physical memory:
  ...
  - Guard pages immediately before and after the mapped virtual region are
    ...
    or overrun.
- The mapped region can be unmapped (i.e. freed) via [`k_mem_unmap()`](../../doxygen/html/group__kernel__memory__management.md#ga1867ea13671daae6a5f38929ea9fd64a):

  - Caution must be exercised to give the pass the same region size to
    both [`k_mem_map()`](../../doxygen/html/group__kernel__memory__management.md#gacf5f9c43ac2c31c376fed4a19f607feb) and [`k_mem_unmap()`](../../doxygen/html/group__kernel__memory__management.md#ga1867ea13671daae6a5f38929ea9fd64a). The unmapping
