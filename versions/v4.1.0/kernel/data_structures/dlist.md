---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/data_structures/dlist.html
...
![dlist example](https://docs.zephyrproject.org/4.1.0/_images/dlist.png)

A dlist containing three elements. Note that the list struct
appears as a fourth “element” in the list.

![single-element dlist example](https://docs.zephyrproject.org/4.1.0/_images/dlist-single.png)

An dlist containing just one element.

![dlist example](https://docs.zephyrproject.org/4.1.0/_images/dlist-empty.png)
