---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/usermode/memory_domain.html
...
- Any configuration of memory regions which need to have special caching or
  ...
  have similar capabilities. See [Memory Attributes](../../services/mem_mgmt/index.md#mem-mgmt-api) for information on
...
[`CONFIG_ARCH_MEM_DOMAIN_SUPPORTS_ISOLATED_STACKS`](../../kconfig.md#CONFIG_ARCH_MEM_DOMAIN_SUPPORTS_ISOLATED_STACKS "CONFIG_ARCH_MEM_DOMAIN_SUPPORTS_ISOLATED_STACKS").
This behavior is enabled by default if supported and can be selectively
disabled via [`CONFIG_MEM_DOMAIN_ISOLATED_STACKS`](../../kconfig.md#CONFIG_MEM_DOMAIN_ISOLATED_STACKS "CONFIG_MEM_DOMAIN_ISOLATED_STACKS") if
...
must assign themselves to a resource pool, which is a [`k_heap`](../../doxygen/html/structk__heap.md)
object. Memory is drawn from a thread’s resource pool using
`z_thread_malloc()` and freed with [`k_free()`](../../doxygen/html/group__heap__apis.md#ga79b63cc93b3358cf82d74f40e73b69d5).
...
> - [`k_stack_alloc_init()`](../../doxygen/html/group__stack__apis.md#gab97d924db1aef3f6adade156a107d45c) sets up a k\_stack with its storage
...
>   initialized at boot with [`K_STACK_DEFINE()`](../../doxygen/html/group__stack__apis.md#ga8c9ca77e5de3c9757dcd4ecb55797835), or to initialize the
>   k\_stack in supervisor mode with [`k_stack_init()`](../../doxygen/html/group__stack__apis.md#ga4400a39ef48289305cf66a092d5c6c7d).
> - `k_pipe_alloc_init()` sets up a k\_pipe object with its
...
>   initialized at boot with [`K_PIPE_DEFINE()`](../../doxygen/html/group__pipe__apis.md#gac2256aa00c59e78199be9bdefd61aa52), or to initialize the
>   k\_pipe in supervisor mode with [`k_pipe_init()`](../../doxygen/html/group__pipe__apis.md#gae2c8d97af1f7e9deb93e670859525cf3).
> - [`k_msgq_alloc_init()`](../../doxygen/html/group__msgq__apis.md#gabe7305b8f442ebdc147dbbc6e8cf92fc) sets up a k\_msgq object with its
>   storage buffer allocated out of a resource pool instead of a buffer provided
>   by the user. An alternative is to declare a k\_msgq that is automatically
>   initialized at boot with [`K_MSGQ_DEFINE()`](../../doxygen/html/group__msgq__apis.md#ga95ef93002766901511d09c8cd8f8293b), or to initialize the
>   k\_msgq in supervisor mode with [`k_msgq_init()`](../../doxygen/html/group__msgq__apis.md#ga54a5cdcaea2236c383ace433fedc0d39).
> - [`k_poll()`](../../doxygen/html/group__poll__apis.md#gac550dc93662ce164fb22a5a91d6830db) when invoked from user mode, needs to make a kernel-side
>   copy of the provided events array while waiting for an event. This copy is
>   freed when [`k_poll()`](../../doxygen/html/group__poll__apis.md#gac550dc93662ce164fb22a5a91d6830db) returns for any reason.
> - [`k_queue_alloc_prepend()`](../../doxygen/html/group__queue__apis.md#gacf3dba40125073c11075e5a134919f88) and [`k_queue_alloc_append()`](../../doxygen/html/group__queue__apis.md#ga690f3a1450e946d75f31b3e499d1d06a)
...
> - [`k_object_alloc()`](../../doxygen/html/group__usermode__apis.md#ga5bba3a354fbc63673c76c9815db40812) allows for entire kernel objects to be
>   dynamically allocated at runtime and a usable pointer to them returned to
>   the caller.

The relevant API is [`k_thread_heap_assign()`](../../doxygen/html/group__thread__apis.md#ga3f46c06833add2a2e0ddb7242f06702c) which assigns
...
![Automatic Memory Domain build flow](https://docs.zephyrproject.org/4.1.0/_images/auto_mem_domain.png)

Automatic Memory Domain build flow

Automatic memory partitions are only configured as read-write
regions. They are defined with [`K_APPMEM_PARTITION_DEFINE()`](../../doxygen/html/group__mem__domain__apis__app.md#gaba1614a7fa1a2ce2fc7cfd6ecfc02796).
Global variables are then routed to this partition using
[`K_APP_DMEM()`](../../doxygen/html/group__mem__domain__apis__app.md#gace571a7f6ee313a732976cc863b5d0e6) for initialized data and [`K_APP_BMEM()`](../../doxygen/html/group__mem__domain__apis__app.md#ga8fd691f9c9007ec80432c19f7ce84881) for
BSS.
...
[`k_mem_domain`](../../doxygen/html/structk__mem__domain.md). It must then be initialized by calling
[`k_mem_domain_init()`](../../doxygen/html/group__mem__domain__apis.md#ga8a987bc85c02925685fe87213fe26c5a).
