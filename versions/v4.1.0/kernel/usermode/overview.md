---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/usermode/overview.html
...
- Any user thread will only have access to a subset of memory:
  ...
  configured in the [Memory Protection Design](memory_domain.md#memory-domain) it belongs to. Access to any other RAM
