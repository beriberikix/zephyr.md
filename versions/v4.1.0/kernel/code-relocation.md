---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/code-relocation.html
...
The memory region and file are given to the [scripts/build/gen\_relocate\_app.py](../build/cmake/index.md#gen-relocate-app-py) script
