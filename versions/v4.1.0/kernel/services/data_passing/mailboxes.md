---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/services/data_passing/mailboxes.html
...
is sent, or send it to any thread by specifying [`K_ANY`](../../../doxygen/html/kernel_8h.md#ac627cc4c3da16be4b74f0a4ab036a603).
...
by specifying [`K_ANY`](../../../doxygen/html/kernel_8h.md#ac627cc4c3da16be4b74f0a4ab036a603).
...
A mailbox is defined using a variable of type [`k_mbox`](../../../doxygen/html/structk__mbox.md).
It must then be initialized by calling [`k_mbox_init()`](../../../doxygen/html/group__mailbox__apis.md#ga686f20c199a9e971822d8279d175d8c2).
...
by calling [`K_MBOX_DEFINE`](../../../doxygen/html/group__mailbox__apis.md#gab55cba898db47113a06641c01f3e3714).
...
A message descriptor is a structure of type [`k_mbox_msg`](../../../doxygen/html/structk__mbox__msg.md).
...
*tx\_target\_thread*
:   The address of the desired receiving thread. Set it to [`K_ANY`](../../../doxygen/html/kernel_8h.md#ac627cc4c3da16be4b74f0a4ab036a603)
...
*rx\_source\_thread*
:   The address of the desired sending thread. Set it to [`K_ANY`](../../../doxygen/html/kernel_8h.md#ac627cc4c3da16be4b74f0a4ab036a603)
...
- If the message descriptor size is non-zero and the receiving thread still
  wants to retrieve the data, the thread must call [`k_mbox_data_get()`](../../../doxygen/html/group__mailbox__apis.md#ga3d19e648e67f109609259543c9a01d6e)
...
- If the message descriptor size is non-zero and the receiving thread does *not*
  want to retrieve the data, the thread must call [`k_mbox_data_get()`](../../../doxygen/html/group__mailbox__apis.md#ga3d19e648e67f109609259543c9a01d6e)
