---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/services/timing/clocks.html
...
The kernel presents a “cycle” count via the [`k_cycle_get_32()`](../../../doxygen/html/group__clock__apis.md#ga208687de625e0036558343b4e66143d3)
and [`k_cycle_get_64()`](../../../doxygen/html/group__clock__apis.md#gae09f509d02bf75a7b45d2800d823bb3a) APIs. The intent is that this counter
...
[`sys_clock_hw_cycles_per_sec()`](../../../doxygen/html/group__timeutil__unit__apis.md#gafe3ef19636d5002350794fa01b480d16) (which on almost all
...
For example: [`k_ms_to_ticks_ceil32()`](../../../doxygen/html/group__timeutil__unit__apis.md#gac74a319bcb69cc714818413ae15af7a2) will convert a
millisecond input value to the next higher number of ticks, returning
a result truncated to 32 bits of precision; and
[`k_cyc_to_us_floor64()`](../../../doxygen/html/group__timeutil__unit__apis.md#gad3376aa7ab36b6b7f5a1f9c9977cee4a) will convert a measured cycle count
...
This is available at all times via [`k_uptime_get()`](../../../doxygen/html/group__clock__apis.md#gae3e992cd3257c23d5b26d765fcbb2b69), which
...
[`k_uptime_ticks()`](../../../doxygen/html/group__clock__apis.md#ga8f143af2ee4ad42d9f7817ef161cbd13).
...
- Kernel blocking operations like [`k_sem_take()`](../../../doxygen/html/group__semaphore__apis.md#gac71e2383c1920dddc45a561cacfef090) or
  [`k_queue_get()`](../../../doxygen/html/group__queue__apis.md#ga0a77d8556e7d253319275de034f01619) may provide a timeout after which the
...
- The kernel [`k_work_delayable`](../../../doxygen/html/structk__work__delayable.md) API provides a timeout parameter
...
of kernel timeout macros. The most common, [`K_MSEC`](../../../doxygen/html/group__clock__apis.md#ga302af954e87b10a9b731f1ad07775e9f), defines
...
- When scheduling a relative timeout from within a timeout callback (e.g. from
  within the expiry function passed to [`k_timer_init()`](../../../doxygen/html/group__timer__apis.md#ga318c846a740b901e5d56876a47ad7f61) or the work handler
  passed to [`k_work_init_delayable()`](../../../doxygen/html/group__workqueue__apis.md#ga2876c5d82fb2340a093bc4d689a55465)), “current time” is the exact time at
...
- When scheduling a timeout from application context, “current time” means the
  value returned by [`k_uptime_ticks()`](../../../doxygen/html/group__clock__apis.md#ga8f143af2ee4ad42d9f7817ef161cbd13) at the time at which the kernel
  receives the timeout value.

Other options for timeout initialization follow the unit conventions
described above: [`K_NSEC()`](../../../doxygen/html/group__clock__apis.md#gae2f3a80170afc5fbce0337cdf5a4ce4c), [`K_USEC`](../../../doxygen/html/group__clock__apis.md#ga91198e325210ec052a8308e642058c0b), [`K_TICKS`](../../../doxygen/html/group__clock__apis.md#gaeda983960bd25f1dba7a386ad720e395) and
[`K_CYC()`](../../../doxygen/html/group__clock__apis.md#gab41f59fd2b724cb1279e4f6821154b33) specify timeout values that will expire after specified
...
example: a `wait_q` struct, or a [`k_tid_t`](../../../doxygen/html/kernel_2thread_8h.md#a6379f5a1f19ffbc262a6877c4f6e3647) thread struct).
...
- The driver is expected to be able to “announce” new ticks to the
  kernel via the [`sys_clock_announce()`](../../../doxygen/html/group__clock__apis.md#gaa7d3b1bdb8d15c907aaafea3b96ac2b5) call, which passes an integer
  ...
  and real world time.
- The driver is expected to provide a [`sys_clock_set_timeout()`](../../../doxygen/html/group__clock__apis.md#ga747c1f4a99a3bc48e7ec65d7bc5e4767) call
...
- The driver is expected to provide a [`sys_clock_elapsed()`](../../../doxygen/html/group__clock__apis.md#gaa9b6d8eebc69d2808beb0580d974bb84) call which
  provides a current indication of how many ticks have elapsed (as
  compared to a real world clock) since the last call to
  [`sys_clock_announce()`](../../../doxygen/html/group__clock__apis.md#gaa7d3b1bdb8d15c907aaafea3b96ac2b5), which the kernel needs to test newly
...
- The driver can receive interrupts at a regular rate corresponding to
  the OS tick rate, calling [`sys_clock_announce()`](../../../doxygen/html/group__clock__apis.md#gaa7d3b1bdb8d15c907aaafea3b96ac2b5) with an argument of one
  each time.
- The driver can ignore calls to [`sys_clock_set_timeout()`](../../../doxygen/html/group__clock__apis.md#ga747c1f4a99a3bc48e7ec65d7bc5e4767), as every
  tick will be announced regardless of timeout status.
- The driver can return zero for every call to [`sys_clock_elapsed()`](../../../doxygen/html/group__clock__apis.md#gaa9b6d8eebc69d2808beb0580d974bb84)
...
- The [`sys_clock_announce()`](../../../doxygen/html/group__clock__apis.md#gaa7d3b1bdb8d15c907aaafea3b96ac2b5) call is expected to be globally
...
- The next timeout value passed back to the driver via
  [`sys_clock_set_timeout()`](../../../doxygen/html/group__clock__apis.md#ga747c1f4a99a3bc48e7ec65d7bc5e4767) is done identically for every CPU.
  ...
  non-zero ticks argument to [`sys_clock_announce()`](../../../doxygen/html/group__clock__apis.md#gaa7d3b1bdb8d15c907aaafea3b96ac2b5). This is probably
...
value passed to [`sys_clock_set_timeout()`](../../../doxygen/html/group__clock__apis.md#ga747c1f4a99a3bc48e7ec65d7bc5e4767) may be clamped to a
...
[`K_MSEC()`](../../../doxygen/html/group__clock__apis.md#ga302af954e87b10a9b731f1ad07775e9f) at the point where they are presented to the
kernel.
...
One complexity is [`K_FOREVER`](../../../doxygen/html/group__clock__apis.md#ga0bb4b83f0222193b21a8910311bab0ca). Subsystems that might have
...
“forever”. [`K_NO_WAIT`](../../../doxygen/html/group__clock__apis.md#ga3d9541cfe2e8395af66d186efa77362f) has the same typesafety concern too,
...
But `k_timeout_t` is opaque, and needs to be converted before
it can be inspected by an application.

Some conversions are simple. Code that needs to test for
[`K_FOREVER`](../../../doxygen/html/group__clock__apis.md#ga0bb4b83f0222193b21a8910311bab0ca) can simply use the [`K_TIMEOUT_EQ()`](../../../doxygen/html/group__clock__apis.md#ga9abf00b34e16ab7ad0883603b6778b1b)
...
internal [`sys_timepoint_calc()`](../../../doxygen/html/group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33) and [`sys_timepoint_timeout()`](../../../doxygen/html/group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa) routines
...
Note that [`sys_timepoint_calc()`](../../../doxygen/html/group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33) accepts special values [`K_FOREVER`](../../../doxygen/html/group__clock__apis.md#ga0bb4b83f0222193b21a8910311bab0ca)
and [`K_NO_WAIT`](../../../doxygen/html/group__clock__apis.md#ga3d9541cfe2e8395af66d186efa77362f), and works identically for absolute timeouts as well
as conventional ones. Conversely, [`sys_timepoint_timeout()`](../../../doxygen/html/group__clock__apis.md#ga6f6d06ef8c13e2fa54c63831fc00ecaa) may return
[`K_FOREVER`](../../../doxygen/html/group__clock__apis.md#ga0bb4b83f0222193b21a8910311bab0ca) or [`K_NO_WAIT`](../../../doxygen/html/group__clock__apis.md#ga3d9541cfe2e8395af66d186efa77362f) if those were used to create
the timepoint, the later also being returned if the timepoint is now in the
past. For simple cases, [`sys_timepoint_expired()`](../../../doxygen/html/group__clock__apis.md#ga87d0d7a0f7bcdcc8c4909962eac12985) can be used as well.
...
[`sys_timepoint_calc()`](../../../doxygen/html/group__clock__apis.md#ga509cf4599c1f162c97540743e8c21d33). But the user expects that the time is
