---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/services/other/atomic.html
...
An atomic variable is defined using a variable of type [`atomic_t`](../../../doxygen/html/atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8).

By default an atomic variable is initialized to zero. However, it can be given
a different value using [`ATOMIC_INIT`](../../../doxygen/html/group__atomic__apis.md#gaadfbba86627ee7eeb07e04f712550f73):
...
[`ATOMIC_DEFINE`](../../../doxygen/html/group__atomic__apis.md#ga249c575db9764486197709b327f7370e).
