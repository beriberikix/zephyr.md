---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/kernel/services/other/fatal.html
...
[`printf()`](../../../doxygen/html/stdio_8h.md#a6c67912b5a18e7d7ac03ca4e77425715)-like format codes or extra arguments.
...
[`k_oops()`](../../../doxygen/html/kernel_8h.md#abde5aa8ca5e64a045b25b88f91370dcd). This should be used to indicate an unrecoverable condition
...
[`k_panic()`](../../../doxygen/html/kernel_8h.md#aedd541f707b1463aaac15c7798340329). This should be used to indicate that the Zephyr kernel is
in an unrecoverable state. Implementations of
[`k_sys_fatal_error_handler()`](../../../doxygen/html/group__fatal__apis.md#ga255cc816d227f0a5c0e80e61bfba11fa) should not return if the kernel
encounters a panic condition, as the entire system needs to be reset.

Threads running in user mode are not permitted to invoke [`k_panic()`](../../../doxygen/html/kernel_8h.md#aedd541f707b1463aaac15c7798340329),
...
a handler installed with `IRQ_CONNECT()` or [`irq_connect_dynamic()`](../../../doxygen/html/group__isr__apis.md#ga4e9915b92b09df49b99bc449f0cc31a1),
...
implementation of the [`k_sys_fatal_error_handler()`](../../../doxygen/html/group__fatal__apis.md#ga255cc816d227f0a5c0e80e61bfba11fa) function. This
...
halts the system with [`k_fatal_halt()`](../../../doxygen/html/group__fatal__apis.md#gaa8c0b43a2360e5319d7910e8e0ceb951).

Applications are free to implement their own error handling policy by
overriding the implementation of [`k_sys_fatal_error_handler()`](../../../doxygen/html/group__fatal__apis.md#ga255cc816d227f0a5c0e80e61bfba11fa).
