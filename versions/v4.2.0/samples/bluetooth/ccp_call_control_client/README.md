---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/bluetooth/ccp_call_control_client/README.html
original_path: samples/bluetooth/ccp_call_control_client/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/ccp_call_control_client/README.rst/..)
...
This sample can be found under [samples/bluetooth/ccp\_call\_control\_client](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/ccp_call_control_client)
in the Zephyr tree.
...
west build -b nrf5340dk/nrf5340/cpuapp --sysbuild samples/bluetooth/ccp_call_control_client/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340dk/nrf5340/cpuapp samples/bluetooth/ccp_call_control_client/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim/nrf5340/cpuapp --sysbuild samples/bluetooth/ccp_call_control_client/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/ccp_call_control_client/ -- -DEXTRA_CONF_FILE=overlay-bt_ll_sw_split.conf
```
