---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/bluetooth/direction_finding_connectionless_rx/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/direction_finding_connectionless_rx/README.rst/..)
...
```shell
west build -b nrf52833dk/nrf52833 samples/bluetooth/direction_finding_connectionless_rx -- -DEXTRA_CONF_FILE=overlay-aod.conf
west flash
```
