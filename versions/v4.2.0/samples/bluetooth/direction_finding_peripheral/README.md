---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/bluetooth/direction_finding_peripheral/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/direction_finding_peripheral/README.rst/..)
...
- Nordic nRF SoC based board with Direction Finding support (example boards:
  [nRF52833 DK](../../../boards/nordic/nrf52833dk/doc/index.md#nrf52833dk), [nRF5340 DK](../../../boards/nordic/nrf5340dk/doc/index.md#nrf5340dk))
...
```shell
west build -b nrf52833dk/nrf52833 samples/bluetooth/direction_finding_peripheral -- -DEXTRA_CONF_FILE=overlay-aoa.conf
west flash
```
