---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/bluetooth/hci_spi/README.html
...
directory for an example overlay for the [nRF51 DK](../../../boards/nordic/nrf51dk/doc/index.md#nrf51dk) board.
