---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/bluetooth/hci_usb/README.html
...
board it runs on (e.g. [nRF52840 DK](../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk) supports both Bluetooth LE and USB).
