---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/shields/npm2100_ek/doc/index.html
original_path: samples/shields/npm2100_ek/doc/index.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/shields/npm2100_ek/doc/index.rst/..)

## Overview

This sample is provided for evaluation of the [nPM2100 EK](../../../../boards/shields/npm2100_ek/doc/index.md#npm2100-ek).
...
The sample supports the following boards: [nRF52840 DK](../../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk), [nRF5340 DK](../../../../boards/nordic/nrf5340dk/doc/index.md#nrf5340dk)

The sample also requires an nPM2100 Evaluation Kit (EK) that you need to connect to the
development kit as described in [Wiring](#wiring).
...
2. Connect the TWI interface and power supply between the chosen DK and the nPM2100 EK
