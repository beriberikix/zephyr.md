---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/drivers/drivers.html
...
- [Auxiliary digits display](auxdisplay_digits/README.md#auxdisplay_digits "Output increasing numbers to an auxiliary display.")Output increasing numbers to an auxiliary display.
...
- [Fuel Gauge](fuel_gauge/README.md#fuel_gauge "Use fuel gauge API to access fuel gauge properties and get charge information.")Use fuel gauge API to access fuel gauge properties and get charge information.
...
- [PSI5 interface](psi5/README.md#psi5 "Use the PSI5 (Peripheral Sensor Interface) driver.")Use the PSI5 (Peripheral Sensor Interface) driver.
...
- [SENT interface](sent/README.md#sent "Use the SENT (Single Edge Nibble Transmission) driver.")Use the SENT (Single Edge Nibble Transmission) driver.
...
- [Ambiq MSPI timing scan](mspi/mspi_timing_scan/README.md#mspi-timing-scan "Find the appropriate timing for a given device on a given board.")Find the appropriate timing for a given device on a given board.
...
- [Stepper](stepper/generic/README.md#stepper "Rotate a stepper motor in 4 different modes.")Rotate a stepper motor in 4 different modes.
...
- [UART ASYNC API](uart/async_api/README.md#uart_async "Demonstrate the use of the asynchronous API")Demonstrate the use of the asynchronous API
