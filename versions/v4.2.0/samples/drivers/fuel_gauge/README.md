---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/drivers/fuel_gauge/README.html
original_path: samples/drivers/fuel_gauge/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/drivers/fuel_gauge/README.rst/..)

## Overview

This sample shows how to use the Zephyr [Fuel Gauge](../../../hardware/peripherals/fuel_gauge.md#fuel-gauge-api) API driver for.
