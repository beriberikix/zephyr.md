---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/sockets/echo_service/README.html
...
The sockets/echo\_service sample application for Zephyr implements a TCP and UDP
