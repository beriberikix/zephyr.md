---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/sockets/echo_client/README.html
...
- `overlay-vlan.conf`
  ...
  See [Overview](../../common/README.md#networking-samples-common) for details.
