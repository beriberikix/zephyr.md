---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/sockets/coap_server/README.html
original_path: samples/net/sockets/coap_server/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/sockets/coap_server/README.rst/..)
...
```shell
west build -b <board to use> samples/net/sockets/coap_server
```

Use [overlay-dtls.conf ](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/sockets/coap_server/overlay-dtls.conf)
...
Use this command on the host to run the [libcoap](https://github.com/obgm/libcoap) implementation of
the ETSI test cases:
...
prj\_cc2520.conf configuration file enabling IEEE 802.15.4.
