---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/wifi/apsta_mode/README.html
...
[ESP32-DevKitC](../../../../boards/espressif/esp32_devkitc/doc/index.md#esp32_devkitc) development board without any extra hardware.
...
```shell
west build -b esp32_devkitc/esp32/procpu samples/net/wifi/apsta_mode
west flash
```
