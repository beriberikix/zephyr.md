---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/net.html
...
- [Network packet filter](pkt_filter/README.md#net-pkt-filter "Install network packet filter hooks.")Install network packet filter hooks.
