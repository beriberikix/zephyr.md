---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/zperf/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/zperf/README.rst/..)
...
- Compatible with iPerf v2.0.10 and newer. For older versions, enable
  [`CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT`](../../../kconfig.md#CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT "CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT").
