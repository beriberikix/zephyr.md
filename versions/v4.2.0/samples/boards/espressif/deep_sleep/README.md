---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/boards/espressif/deep_sleep/README.html
...
[ESP32-DevKitC](../../../../boards/espressif/esp32_devkitc/doc/index.md#esp32_devkitc) development board without any extra hardware if
...
```shell
west build -b esp32_devkitc/esp32/procpu samples/boards/espressif/deep_sleep
west flash
```
