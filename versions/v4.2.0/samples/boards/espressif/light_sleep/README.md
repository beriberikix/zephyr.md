---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/boards/espressif/light_sleep/README.html
...
```shell
west build -b esp32_devkitc/esp32/procpu samples/boards/espressif/light_sleep
west flash
```
