---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/boards/nxp/adsp/rtxxx/amp_mbox/README.html
original_path: samples/boards/nxp/adsp/rtxxx/amp_mbox/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nxp/adsp/rtxxx/amp_mbox/README.rst/..)
...
```shell
west build -b <board> -o --sysbuild samples/boards/nxp/adsp/rtxxx/amp_mbox
west flash -r jlink
```
