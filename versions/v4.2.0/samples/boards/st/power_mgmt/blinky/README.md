---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/boards/st/power_mgmt/blinky/README.html
original_path: samples/boards/st/power_mgmt/blinky/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/st/power_mgmt/blinky/README.rst/..)
...
```shell
west build -b stm32l562e_dk samples/boards/st/power_mgmt/blinky
west flash
```
...
Debugging this sample may require enabling [`CONFIG_DEBUG`](../../../../../kconfig.md#CONFIG_DEBUG "CONFIG_DEBUG") `=y`.
That will enable the [`CONFIG_STM32_ENABLE_DEBUG_SLEEP_STOP`](../../../../../kconfig.md#CONFIG_STM32_ENABLE_DEBUG_SLEEP_STOP "CONFIG_STM32_ENABLE_DEBUG_SLEEP_STOP")
