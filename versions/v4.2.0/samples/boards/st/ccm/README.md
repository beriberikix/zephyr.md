---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/boards/st/ccm/README.html
original_path: samples/boards/st/ccm/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/st/ccm/README.rst/..)
...
128	phy-connection-type = "rmii";
129	phy-handle = <&eth_phy>;
130};
131
132&mdio {
133	status = "okay";
134	pinctrl-0 = <&eth_mdio_pa2 &eth_mdc_pc1>;
135	pinctrl-names = "default";
136
137	eth_phy: ethernet-phy@0 {
138		compatible = "ethernet-phy";
139		reg = <0x00>;
140	};
141};
```
