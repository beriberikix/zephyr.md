---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/subsys/subsys.html
...
- [UUID](uuid/README.md#uuid "Manipulate UUID v4 and v5 compliant with IETF RFC 9562.")Manipulate UUID v4 and v5 compliant with IETF RFC 9562.
...
- [Fatfs filesystem fstab](fs/fatfs_fstab/README.md#fatfs-fstab "Define fatfs filesystems in the devicetree.")Define fatfs filesystems in the devicetree.
...
- [Bluetooth logging backend](logging/ble_backend/README.md#logging-ble-backend "Send log messages over Bluetooth using the Bluetooth logging backend.")Send log messages over Bluetooth using the Bluetooth logging backend.
...
## [Real Time I/O (RTIO)](rtio/rtio.md)

- [Sensor batch processing](rtio/sensor_batch_processing/README.md#sensor_batch_processing "Implement a sensor device using RTIO for asynchronous data processing.")Implement a sensor device using RTIO for asynchronous data processing.
...
- [Console over USB CDC ACM](usb/console-next/README.md#usbd-cdc-acm-console "Output "Hello World!" to the console over USB CDC ACM.")Output "Hello World!" to the console over USB CDC ACM.
...
- [USB CDC-ACM bridge](usb/cdc_acm_bridge/README.md#usb-cdc-acm-bridge "Use USB CDC-ACM driver to implement a serial port bridge.")Use USB CDC-ACM driver to implement a serial port bridge.
- [USB device testing application](usb/testusb/README.md#testusb-app "Test USB device drivers using a loopback function.")Test USB device drivers using a loopback function.
- [USB DFU](usb/dfu-next/README.md#dfu-next "Implement a basic USB DFU device")Implement a basic USB DFU device
...
- [USB MIDI2 device](usb/midi/README.md#usb-midi2-device "Implements a simple USB MIDI loopback and keyboard device.")Implements a simple USB MIDI loopback and keyboard device.
...
- [USB Video webcam](usb/uvc/README.md#uvc "Send video frames over USB.")Send video frames over USB.
...
- [WebUSB-next](usb/webusb-next/README.md#webusb-next "Receive and echo data from a web page using WebUSB API.")Receive and echo data from a web page using WebUSB API.
