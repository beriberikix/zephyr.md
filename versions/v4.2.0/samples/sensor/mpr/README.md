---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/sensor/mpr/README.html
...
In the sample below the [Arduino Due](../../../boards/arduino/due/doc/index.md#arduino_due) board is used.
