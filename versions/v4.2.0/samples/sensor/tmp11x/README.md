---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/sensor/tmp11x/README.html
original_path: samples/sensor/tmp11x/README.html
---
...
This sample application periodically takes temperature readings using the ti\_tmp11x
...
```shell
west build -b nucleo_f401re samples/sensor/tmp11x
west flash
```
