---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/sensor/mcux_lpcmp/README.html
...
Build the application for the [FRDM-MCXA153](../../../boards/nxp/frdm_mcxa153/doc/index.md#frdm_mcxa153) board, and adjust the
LPCMP positive input port voltage by changing the voltage input to J2-9.

```shell
west build -b frdm_mcxa153 samples/sensor/mcux_lpcmp
west flash
```
