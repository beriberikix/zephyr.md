---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/migration-guide-3.6.html
...
- Several Renesas RA series drivers Kconfig options have been renamed:
  ...
  - `CONFIG_CLOCK_CONTROL_RA` -> `CONFIG_CLOCK_CONTROL_RENESAS_RA`
  - `CONFIG_GPIO_RA` -> `CONFIG_GPIO_RENESAS_RA`
  - `CONFIG_PINCTRL_RA` -> `CONFIG_PINCTRL_RENESAS_RA`
  - `CONFIG_UART_RA` -> `CONFIG_UART_RENESAS_RA`
