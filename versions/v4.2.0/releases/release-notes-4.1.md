---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-4.1.html
...
- I3C
  ...
  - [`i3c_device_controller_handoff()`](../doxygen/html/group__i3c__interface.md#gaedf58fdd96f38f103f8defe221427b6f)
- Management
...
- Video
  ...
  - `video_set_stream()` driver API has replaced [`video_stream_start()`](../doxygen/html/group__video__interface.md#ga835bb485fcf906cc5b27529a0fe218d3) and
    [`video_stream_stop()`](../doxygen/html/group__video__interface.md#gaa8965272b3f2a7f6692b56ff569f190f) driver APIs.
- Other
...
- [MCTP Endpoint Sample](../samples/modules/pmci/mctp/endpoint/README.md#mctp_endpoint_sample "Create an MCTP endpoint over UART.")
- [MCTP Host Sample](../samples/modules/pmci/mctp/host/README.md#mctp_host_sample "Create an MCTP host over UART.")
