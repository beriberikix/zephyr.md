---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/migration-guide-4.1.html
...
- The [`video_stream_start()`](../doxygen/html/group__video__interface.md#ga835bb485fcf906cc5b27529a0fe218d3) and [`video_stream_stop()`](../doxygen/html/group__video__interface.md#gaa8965272b3f2a7f6692b56ff569f190f) driver APIs are now merged
...
- Following the beginnig of the deprecation process for the TinyCrypt crypto
  library, Kconfig symbol `CONFIG_BT_MESH_USES_TINYCRYPT` was
...
- Mesh key representations are not backward compatible if images are built with TinyCrypt and
  ...
  the `CONFIG_BT_MESH_USES_TINYCRYPT` Kconfig option set on an image
