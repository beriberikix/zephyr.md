---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-2.7.html
...
- Socket:
  ...
  - Fixed a bug, where [`poll()`](../doxygen/html/poll_8h.md#afa7e83ddea0ab5b08fcf614b89ac48ba) events were not signalled correctly
...
- TLS:
  ...
  - Reset mbed TLS session on timed out DTLS handshake, to allow a retry without
    closing a socket.
  - Fixed TLS/DTLS [`sendmsg()`](../doxygen/html/posix_2sys_2socket_8h.md#a8a2ad4261d3978ba299926f45d56ed74) implementation for larger payloads.
  - Fixed TLS/DTLS sockets `POLLHUP` notification.
- WebSocket:

  - Fixed [`poll()`](../doxygen/html/poll_8h.md#afa7e83ddea0ab5b08fcf614b89ac48ba) implementation for WebSocket, which did not work
...
- Devicetree bindings
  ...
  - Other new bindings in alphabetical order: [`andestech,atcgpio100`](../build/dts/api/bindings/gpio/andestech%2Catcgpio100.md#std-dtcompatible-andestech-atcgpio100),
    ...
    `espressif,esp32s2-uart`, [`ethernet-phy`](../build/dts/api/bindings/ethernet/phy/ethernet-phy.md#std-dtcompatible-ethernet-phy),
    ...
    [`nxp,imx-ccm-rev2`](../build/dts/api/bindings/clock/nxp%2Cimx-ccm-rev2.md#std-dtcompatible-nxp-imx-ccm-rev2), [`nxp,lpc-ctimer`](../build/dts/api/bindings/counter/nxp%2Clpc-ctimer.md#std-dtcompatible-nxp-lpc-ctimer),
    ...
    [`ti,hdc2080`](../build/dts/api/bindings/sensor/ti%2Chdc2080.md#std-dtcompatible-ti-hdc2080), `ti,hdc20xx`,
