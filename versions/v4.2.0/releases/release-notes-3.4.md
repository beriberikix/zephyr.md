---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-3.4.html
...
- Including updatehub in an application now requires additional Kconfig options
  ...
  > | [`CONFIG_JSON_LIBRARY`](../kconfig.md#CONFIG_JSON_LIBRARY "CONFIG_JSON_LIBRARY") |
  > | [`CONFIG_HWINFO`](../kconfig.md#CONFIG_HWINFO "CONFIG_HWINFO") |
- The sensor driver API clarified [`sensor_trigger_set()`](../doxygen/html/group__sensor__interface.md#ga7c72aca732e0641612d2f9437c2e41b7) to state that
  ...
  to use [`CONTAINER_OF`](../doxygen/html/group__sys-util.md#gac5bc561d1bfd1bf68877fe577779bd2f) to retrieve a context pointer when the trigger
...
- Converted few drivers to the [Input](../services/input/index.md#input) subsystem.
  ...
  - `ft5336`: moved from `kscan_api` to [Input](../services/input/index.md#input), renamed the Kconfig
  ...
  - `kscan_sdl`: moved from `kscan_api` to [Input](../services/input/index.md#input), renamed the Kconfig
  ...
  - Touchscreen drivers converted to use the input APIs can use the
    `zephyr,kscan-input` driver to maintain Kscan compatibility.
...
- The following network interface APIs now take additional,
  ...
  - [`net_if_ipv4_maddr_join()`](../doxygen/html/group__net__if.md#gae275a5e75817aa178d36f422573ad76a)
  - [`net_if_ipv4_maddr_leave()`](../doxygen/html/group__net__if.md#ga1408fe384736d20f36c035c10007113c)
  - [`net_if_ipv6_maddr_join()`](../doxygen/html/group__net__if.md#ga49dbc954015307222f176f4149829b76)
  - [`net_if_ipv6_maddr_leave()`](../doxygen/html/group__net__if.md#gad24d5537d52de9781a7a6a55ceedd92b)
- MCUmgr transports now need to set up the struct before registering it by
  ...
  [`smp_transport_api_t`](../doxygen/html/structsmp__transport__api__t.md). Because of these changes, the legacy
...
- Added a new flag [`dac_channel_cfg`](../doxygen/html/structdac__channel__cfg.md) `buffered` for DAC channels in
  [`dac_channel_cfg`](../doxygen/html/structdac__channel__cfg.md) to allow the configuration of the output buffer.
...
- MCUmgr fs\_mgmt group’s file access hook is now called for all fs\_mgmt group
  ...
  [`fs_mgmt_file_access`](../doxygen/html/structfs__mgmt__file__access.md) for the new structure definition.
...
- On nRF51 and nRF52-based boards, the behavior of the reset reason being
  provided to [`sys_reboot()`](../doxygen/html/reboot_8h.md#a18abe5d5b8089e8429c25bafa5e76d3d) and being set in the GPREGRET register has
...
- Deprecated `PTHREAD_BARRIER_DEFINE` in favor of the standardized
  [`pthread_barrier_init()`](../doxygen/html/pthread_8h.md#aecc6c99901aac517072970e153863296)
...
- Removed `bt_set_oob_data_flag` and replaced it with two new API calls:
  \* [`bt_le_oob_set_sc_flag()`](../doxygen/html/group__bt__conn.md#gad02f8fe587efd543c0c81cace3f63d63) for setting/clearing OOB flag in SC pairing
  \* [`bt_le_oob_set_legacy_flag()`](../doxygen/html/group__bt__conn.md#ga978770d46d7c8af854a61261c14cb892) for setting/clearing OOB flag in legacy paring
- [`SYS_INIT`](../doxygen/html/group__sys__init.md#gaf507cc0613add8113c41896bd631254f) callback no longer requires a [`device`](../doxygen/html/structdevice.md) argument.
...
- Changed [`spi_config`](../doxygen/html/structspi__config.md) `cs` ([`spi_cs_control`](../doxygen/html/structspi__cs__control.md)) from
  ...
  if CS is GPIO-based or not, must now use [`spi_cs_is_gpio()`](../doxygen/html/group__spi__interface.md#gae1156a4ee1b5909c321811045566d888) or
  [`spi_cs_is_gpio_dt()`](../doxygen/html/group__spi__interface.md#gaa13f0da1f28cffa0da4677987db0c9c5) calls.

### New APIs in this release

- Introduced [`flash_ex_op()`](../doxygen/html/group__flash__interface.md#ga5571fbed2babb0036255d7a4d5e66f6c) function. This allows to perform extra
...
- Introduced [Real-Time Clock (RTC)](../hardware/peripherals/rtc.md#rtc-api) API which adds experimental support for real-time clock
  ...
  functions [`rtc_set_time()`](../doxygen/html/group__rtc__interface.md#ga52982b434c740e86aa5f3e35e9bee4a7) and [`rtc_get_time()`](../doxygen/html/group__rtc__interface.md#ga208321104a1cdb39173317e6911aea87), the optional functions
  [`rtc_alarm_get_supported_fields()`](../doxygen/html/group__rtc__interface.md#ga62f8ece98065b9bd892908e2f0b1f9bb), [`rtc_alarm_set_time()`](../doxygen/html/group__rtc__interface.md#ga1fc9f0ec9642dfbf742ea541a20bdad5),
  [`rtc_alarm_get_time()`](../doxygen/html/group__rtc__interface.md#gacba4edcec86ccbea5cd676924840c47a), [`rtc_alarm_is_pending()`](../doxygen/html/group__rtc__interface.md#ga531c379c437a91df44a45e95063700e8) and
  [`rtc_alarm_set_callback()`](../doxygen/html/group__rtc__interface.md#ga90d7f422ca15cf679aa7ba61fb5373f0) are enabled with
  [`CONFIG_RTC_ALARM`](../kconfig.md#CONFIG_RTC_ALARM "CONFIG_RTC_ALARM"), the optional function
  [`rtc_update_set_callback()`](../doxygen/html/group__rtc__interface.md#ga0b2b2b44077dcdb73feb007f87cc47b3) is enabled with
  [`CONFIG_RTC_UPDATE`](../kconfig.md#CONFIG_RTC_UPDATE "CONFIG_RTC_UPDATE"), and lastly, the optional functions
  [`rtc_set_calibration()`](../doxygen/html/group__rtc__interface.md#ga13395c6b38e06bcda23cc0e9c299c445) and [`rtc_get_calibration()`](../doxygen/html/group__rtc__interface.md#gab29bc6bcea5eb71e03d3e6181d4bec2f) are enabled with
...
- Added [`CAN_FRAME_ESI`](../doxygen/html/group__can__interface.md#ga83f8b7af6eb45e43aaac355de3e69e52) CAN-FD Error State Indicator flag.
...
- RISC-V
  ...
  - Switched from accessing CSRs from inline assembly to using the [`csr_read()`](../doxygen/html/csr_8h.md#a1b19216c67cb23fc1c46136325b732d9) helper
    function.
...
- Introduced support for extending/replacing the signing mechanism in zephyr,
  see [West extending signing](../build/signing/index.md#west-extending-signing) for further
  details.
...
- CAN
  ...
  - The CAN statistics are now reset when calling [`can_start()`](../doxygen/html/group__can__interface.md#gae48dfa8bc5b52f233b9b1a08aac2675a).
...
- Flash
  ...
  - Introduced new flash API call [`flash_ex_op()`](../doxygen/html/group__flash__interface.md#ga5571fbed2babb0036255d7a4d5e66f6c) which calls
  ...
  - STM32F4: Now supports write protection and readout protection through
    new flash API call [`flash_ex_op()`](../doxygen/html/group__flash__interface.md#ga5571fbed2babb0036255d7a4d5e66f6c).
...
- CoAP:
  ...
  - Added [`coap_append_descriptive_block_option()`](../doxygen/html/group__coap.md#ga8b5966a29054ace04cae81d4da588e72) and
    [`coap_get_block1_option()`](../doxygen/html/group__coap.md#ga10c4a0d7e2052f3116fbf3b355fe75db) APIs to facilitate block transfer handling.
  ...
  - Fixed missing token length validation in [`coap_header_get_token()`](../doxygen/html/group__coap.md#ga6a5049accfa0cd7106a3a6593c598545).
  - Fixed missing response check in [`coap_response_received()`](../doxygen/html/group__coap.md#ga3da23a809504025a24bf03daea3e606b).
- Connection Manager:
...
- IEEE802154:
  ...
  - Deprecated `CONFIG_IEEE802154_2015` Kconfig option.
...
- IPv4:
  ...
  - Fixed [`net_ipv4_is_ll_addr()`](../doxygen/html/group__ip__4__6.md#gac000a319de7a6f95d4a63719bca3b865) helper function to correctly identify LL address.
  - Fixed possible NULL pointer dereference in IPv4 fragmentation.
- LwM2M:

  - Added new `LWM2M_RD_CLIENT_EVENT_REG_UPDATE` event.
...
- Sockets:
  ...
  - Fixed blocking [`recv()`](../doxygen/html/posix_2sys_2socket_8h.md#adee01662b0cf762a014efd87ab811276) not being interrupted on socket close.
  - Fixed blocking [`accept()`](../doxygen/html/posix_2sys_2socket_8h.md#a66e3de379c18201b21c889035ec54864) not being interrupted on socket close.
...
- Websockets:
  ...
  - Implemented proper timeout handling in [`websocket_recv_msg()`](../doxygen/html/group__websocket.md#ga0fb118f84b7631d12c1b742b75593ba6).
...
- File systems
  ...
  - With LittleFS as backend, [`fs_mount()`](../doxygen/html/group__file__system__api.md#ga46d59d84a1da3ce1d90478397826d793) return code was corrected to `EFAULT` when
...
- IPC
  ...
  - [`ipc_service_close_instance()`](../doxygen/html/group__ipc__service__api.md#ga78c837d30cfd8989efe63e0a397148a7) now only acts on bounded endpoints.
...
- POSIX API
  ...
  - Improved the locking strategy for [`eventfd_read()`](../doxygen/html/posix_2sys_2eventfd_8h.md#a32e55549cb7aea88db8a14be9ed5d092) and
    [`eventfd_write()`](../doxygen/html/posix_2sys_2eventfd_8h.md#a9c7aafe8ee787e3ba362fb6aab3e5542). This eliminated a deadlock scenario that was
