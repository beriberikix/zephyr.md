---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/migration-guide-3.7.html
...
- The `holtek,ht16k33-keyscan` driver has been converted to use the
  ...
  `zephyr,kscan-input` can be used for backward compatibility. ([GitHub #69875](https://github.com/zephyrproject-rtos/zephyr/issues/69875))
...
- The DNS resolver and mDNS/LLMNR responders are converted to use socket service API.
  ...
  `CONFIG_POSIX_MAX_FDS` are high enough. Unfortunately no exact values
