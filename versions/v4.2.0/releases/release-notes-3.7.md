---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-3.7.html
...
- POSIX API
  ...
  - In efforts to use Kconfig options that map directly to the Options and Option Groups in
    ...
    - `CONFIG_EVENTFD_MAX` ([`CONFIG_ZVFS_EVENTFD_MAX`](../kconfig.md#CONFIG_ZVFS_EVENTFD_MAX "CONFIG_ZVFS_EVENTFD_MAX"))
    - `CONFIG_FNMATCH` ([`CONFIG_POSIX_C_LIB_EXT`](../kconfig.md#CONFIG_POSIX_C_LIB_EXT "CONFIG_POSIX_C_LIB_EXT"))
    - `CONFIG_GETOPT` ([`CONFIG_POSIX_C_LIB_EXT`](../kconfig.md#CONFIG_POSIX_C_LIB_EXT "CONFIG_POSIX_C_LIB_EXT"))
    - `CONFIG_MAX_PTHREAD_COUNT` ([`CONFIG_POSIX_THREAD_THREADS_MAX`](../kconfig.md#CONFIG_POSIX_THREAD_THREADS_MAX "CONFIG_POSIX_THREAD_THREADS_MAX"))
    - `CONFIG_MAX_PTHREAD_KEY_COUNT` ([`CONFIG_POSIX_THREAD_KEYS_MAX`](../kconfig.md#CONFIG_POSIX_THREAD_KEYS_MAX "CONFIG_POSIX_THREAD_KEYS_MAX"))
    - `CONFIG_MAX_TIMER_COUNT` ([`CONFIG_POSIX_TIMER_MAX`](../kconfig.md#CONFIG_POSIX_TIMER_MAX "CONFIG_POSIX_TIMER_MAX"))
    - `CONFIG_POSIX_LIMITS_RTSIG_MAX` ([`CONFIG_POSIX_RTSIG_MAX`](../kconfig.md#CONFIG_POSIX_RTSIG_MAX "CONFIG_POSIX_RTSIG_MAX"))
    - `CONFIG_POSIX_CLOCK` ([`CONFIG_POSIX_CLOCK_SELECTION`](../kconfig.md#CONFIG_POSIX_CLOCK_SELECTION "CONFIG_POSIX_CLOCK_SELECTION"),
    ...
    - `CONFIG_POSIX_FS` ([`CONFIG_POSIX_FILE_SYSTEM`](../kconfig.md#CONFIG_POSIX_FILE_SYSTEM "CONFIG_POSIX_FILE_SYSTEM"))
    - `CONFIG_POSIX_MAX_FDS` ([`CONFIG_POSIX_OPEN_MAX`](../kconfig.md#CONFIG_POSIX_OPEN_MAX "CONFIG_POSIX_OPEN_MAX") and
      [`CONFIG_ZVFS_OPEN_MAX`](../kconfig.md#CONFIG_ZVFS_OPEN_MAX "CONFIG_ZVFS_OPEN_MAX"))
    - `CONFIG_POSIX_MAX_OPEN_FILES` ([`CONFIG_POSIX_OPEN_MAX`](../kconfig.md#CONFIG_POSIX_OPEN_MAX "CONFIG_POSIX_OPEN_MAX") and
      [`CONFIG_ZVFS_OPEN_MAX`](../kconfig.md#CONFIG_ZVFS_OPEN_MAX "CONFIG_ZVFS_OPEN_MAX"))
    - `CONFIG_POSIX_MQUEUE` ([`CONFIG_POSIX_MESSAGE_PASSING`](../kconfig.md#CONFIG_POSIX_MESSAGE_PASSING "CONFIG_POSIX_MESSAGE_PASSING"))
    - `CONFIG_POSIX_PUTMSG` ([`CONFIG_XOPEN_STREAMS`](../kconfig.md#CONFIG_XOPEN_STREAMS "CONFIG_XOPEN_STREAMS"))
    - `CONFIG_POSIX_SIGNAL` ([`CONFIG_POSIX_SIGNALS`](../kconfig.md#CONFIG_POSIX_SIGNALS "CONFIG_POSIX_SIGNALS"))
    - `CONFIG_POSIX_SYSCONF` ([`CONFIG_POSIX_SINGLE_PROCESS`](../kconfig.md#CONFIG_POSIX_SINGLE_PROCESS "CONFIG_POSIX_SINGLE_PROCESS"))
    - `CONFIG_POSIX_UNAME` ([`CONFIG_POSIX_SINGLE_PROCESS`](../kconfig.md#CONFIG_POSIX_SINGLE_PROCESS "CONFIG_POSIX_SINGLE_PROCESS"))
    - `CONFIG_PTHREAD` ([`CONFIG_POSIX_THREADS`](../kconfig.md#CONFIG_POSIX_THREADS "CONFIG_POSIX_THREADS"))
    - `CONFIG_PTHREAD_BARRIER` ([`CONFIG_POSIX_BARRIERS`](../kconfig.md#CONFIG_POSIX_BARRIERS "CONFIG_POSIX_BARRIERS"))
    - `CONFIG_PTHREAD_COND` ([`CONFIG_POSIX_THREADS`](../kconfig.md#CONFIG_POSIX_THREADS "CONFIG_POSIX_THREADS"))
    - `CONFIG_PTHREAD_IPC` ([`CONFIG_POSIX_THREADS`](../kconfig.md#CONFIG_POSIX_THREADS "CONFIG_POSIX_THREADS"))
    - `CONFIG_PTHREAD_KEY` ([`CONFIG_POSIX_THREADS`](../kconfig.md#CONFIG_POSIX_THREADS "CONFIG_POSIX_THREADS"))
    - `CONFIG_PTHREAD_MUTEX` ([`CONFIG_POSIX_THREADS`](../kconfig.md#CONFIG_POSIX_THREADS "CONFIG_POSIX_THREADS"))
    - `CONFIG_PTHREAD_RWLOCK` ([`CONFIG_POSIX_READER_WRITER_LOCKS`](../kconfig.md#CONFIG_POSIX_READER_WRITER_LOCKS "CONFIG_POSIX_READER_WRITER_LOCKS"))
    - `CONFIG_PTHREAD_SPINLOCK` ([`CONFIG_POSIX_SPIN_LOCKS`](../kconfig.md#CONFIG_POSIX_SPIN_LOCKS "CONFIG_POSIX_SPIN_LOCKS"))
    - `CONFIG_SEM_NAMELEN_MAX` ([`CONFIG_POSIX_SEM_NAMELEN_MAX`](../kconfig.md#CONFIG_POSIX_SEM_NAMELEN_MAX "CONFIG_POSIX_SEM_NAMELEN_MAX"))
    - `CONFIG_SEM_VALUE_MAX` ([`CONFIG_POSIX_SEM_VALUE_MAX`](../kconfig.md#CONFIG_POSIX_SEM_VALUE_MAX "CONFIG_POSIX_SEM_VALUE_MAX"))
    - `CONFIG_TIMER` ([`CONFIG_POSIX_TIMERS`](../kconfig.md#CONFIG_POSIX_TIMERS "CONFIG_POSIX_TIMERS"))
    - `CONFIG_TIMER_DELAYTIMER_MAX` ([`CONFIG_POSIX_DELAYTIMER_MAX`](../kconfig.md#CONFIG_POSIX_DELAYTIMER_MAX "CONFIG_POSIX_DELAYTIMER_MAX"))
...
- Added support for these boards:
  ...
  - Added support for [Arduino UNO R4 WiFi board](../boards/arduino/uno_r4/doc/index.md#arduino_uno_r4): `arduino_uno_r4_wifi`.
...
- Made these board changes:
  ...
  - nRF54H20 PDK (pre-release) converted to [nRF54H20 DK](../boards/nordic/nrf54h20dk/doc/index.md#nrf54h20dk)
  - PPR core target in [nRF54H20 DK](../boards/nordic/nrf54h20dk/doc/index.md#nrf54h20dk) runs from RAM by default. A
...
- Added support for the following shields:
  ...
  - [Raspberry Pi Pico to UNO FlexyPin Adapter](../boards/shields/rpi_pico_uno_flexypin/doc/index.md#rpi-pico-uno-flexypin) (`rpi_pico_uno_flexypin`)
