...
- Generic or vendor-independent:
  ...
  - Modified bindings:
    ...
    - The `riscv,isa` property used by RISC-V CPU bindings no longer has an
      `enum` value.
    - [`neorv32,cpu`](../build/dts/api/bindings/cpu/neorv32%2Ccpu.md#std-dtcompatible-neorv32-cpu):
...
- Analog Devices, Inc. (adi):
  ...
  - New bindings:
    ...
    - [`adi,adin1110`](../build/dts/api/bindings/ethernet/phy/adi%2Cadin1110.md#std-dtcompatible-adi-adin1110)
...
- Raspberry Pi Foundation (raspberrypi):
  ...
  - New bindings:
    ...
    - [`raspberrypi,pico-timer`](../build/dts/api/bindings/counter/raspberrypi%2Cpico-timer.md#std-dtcompatible-raspberrypi-pico-timer)
...
- Renesas Electronics Corporation (renesas):
  ...
  - New bindings:
    ...
    - [`renesas,smartbond-timer`](../build/dts/api/bindings/counter/renesas%2Csmartbond-timer.md#std-dtcompatible-renesas-smartbond-timer)
  - Modified bindings:
