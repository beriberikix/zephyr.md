---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/porting/shields.html
original_path: hardware/porting/shields.html
---
...
under [boards/shields](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/shields):
...
- **shield.yml**: This file provides metadata about the shield in YAML format.
  ...
  - `supported_features`: List of hardware features the shield supports (optional). In order to
    ...
    [dts/bindings/binding-types.txt](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/bindings/binding-types.txt) file.
...
- **<shield>.overlay**: This file provides a shield description in devicetree
  format that is merged with the board’s [devicetree](../../build/dts/index.md#dt-guide)
  before compilation.
- **Kconfig.shield**: This file defines shield Kconfig symbols that will be
  ...
  the [Write your devicetree](board_porting.md#default-board-configuration).
- **Kconfig.defconfig**: This file defines the default shield configuration. It
  is made to be consistent with the [Write your devicetree](board_porting.md#default-board-configuration). Hence,
  shield configuration should be done by keeping in mind that features
  activation is application responsibility.
- **pre\_dt\_shield.cmake**: This optional file can be used to pass additional
...
- Devicetree: A board [devicetree](../../build/dts/index.md#dt-guide) file,
  `BOARD.dts` should define an alternate nodelabel for each connector interface.
...
node](https://github.com/devicetree-org/devicetree-specification/blob/4b1dac80eaca45b4babf5299452a951008a5d864/source/devicetree-basics.rst#nexus-nodes-and-specifier-mapping) that looks like the following into the board devicetree file:
...
See [nexus node](https://github.com/devicetree-org/devicetree-specification/blob/4b1dac80eaca45b4babf5299452a951008a5d864/source/devicetree-basics.rst#nexus-nodes-and-specifier-mapping) for more information about this capability.
