---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/arch/semihost.html
...
[RISC-V Github documentation](https://github.com/riscv-non-isa/riscv-semihosting/blob/main/riscv-semihosting.adoc).

Semihosting implementation on Xtensa supports GDB File-I/O extension, which is
explained in [GDB File-I/O Remote Protocol](https://sourceware.org/gdb/current/onlinedocs/gdb.html/File_002dI_002fO-Remote-Protocol-Extension.html).
