---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/peripherals/spi.html
...
- [SPI bitbang](../../samples/drivers/spi_bitbang/README.md#spi-bitbang "Use the bitbang SPI driver for communicating with a slave.")Use the bitbang SPI driver for communicating with a slave.
- [SPIS wake up](../../samples/boards/nordic/spis_wakeup/README.md#spis-wakeup "Reduce current consumption by handling the wake line while using an SPIS.")Reduce current consumption by handling the wake line while using an SPIS.
