---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/peripherals/auxdisplay.html
...
- [Auxiliary digits display](../../samples/drivers/auxdisplay_digits/README.md#auxdisplay_digits "Output increasing numbers to an auxiliary display.")Output increasing numbers to an auxiliary display.
