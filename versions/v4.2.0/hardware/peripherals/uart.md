---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/peripherals/uart.html
...
- [UART ASYNC API](../../samples/drivers/uart/async_api/README.md#uart_async "Demonstrate the use of the asynchronous API")Demonstrate the use of the asynchronous API
- [UART circular mode](../../samples/boards/st/uart/circular_dma/README.md#uart-circular-dma "Read data from the console and echo it back using a circular DMA configuration.")Read data from the console and echo it back using a circular DMA configuration.
...
- [USB CDC-ACM bridge](../../samples/subsys/usb/cdc_acm_bridge/README.md#usb-cdc-acm-bridge "Use USB CDC-ACM driver to implement a serial port bridge.")Use USB CDC-ACM driver to implement a serial port bridge.
