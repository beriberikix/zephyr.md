---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/cache/guide.html
original_path: hardware/cache/guide.html
---
...
caching tools, see [Cache Control Configuration](config.md#cache-config) for Zephyr Kconfig options or
[Cache API](config.md#cache-api) for the API reference. This section primarily focuses on the
...
see [`CONFIG_KERNEL_COHERENCE`](../../kconfig.md#CONFIG_KERNEL_COHERENCE "CONFIG_KERNEL_COHERENCE").
...
- [`CONFIG_DCACHE`](../../kconfig.md#CONFIG_DCACHE "CONFIG_DCACHE"): DCACHE control enabled in Zephyr.
- [`CONFIG_CACHE_MANAGEMENT`](../../kconfig.md#CONFIG_CACHE_MANAGEMENT "CONFIG_CACHE_MANAGEMENT"): cache API enabled.
- Call [`sys_cache_data_disable()`](../../doxygen/html/group__cache__interface.md#ga7952019e9231e250a37a3226908102ee) to globally disable the data cache.
...
- [`CONFIG_DCACHE`](../../kconfig.md#CONFIG_DCACHE "CONFIG_DCACHE"): DCACHE control enabled in Zephyr.
- [`CONFIG_MEM_ATTR`](../../kconfig.md#CONFIG_MEM_ATTR "CONFIG_MEM_ATTR"): enable the `mem-attr` library for
  handling memory attributes in the device tree.
- Annotate your device tree according to [Memory Attributes](../../services/mem_mgmt/index.md#mem-mgmt-api).
...
[userspace](../../kernel/usermode/mpu_userspace.md#mpu-userspace), [stack protection](../../kernel/usermode/mpu_stack_objects.md#mpu-stack-objects),
or [memory domains](../../kernel/usermode/memory_domain.md#memory-domain).
...
- [`CONFIG_DCACHE`](../../kconfig.md#CONFIG_DCACHE "CONFIG_DCACHE"): DCACHE control enabled in Zephyr.
- [`CONFIG_NOCACHE_MEMORY`](../../kconfig.md#CONFIG_NOCACHE_MEMORY "CONFIG_NOCACHE_MEMORY"): enable allocation of the `nocache`
...
bytes. See [`CONFIG_DCACHE_LINE_SIZE`](../../kconfig.md#CONFIG_DCACHE_LINE_SIZE "CONFIG_DCACHE_LINE_SIZE"). Cache line sizes are
...
- [`CONFIG_DCACHE`](../../kconfig.md#CONFIG_DCACHE "CONFIG_DCACHE"): DCACHE control enabled in Zephyr.
- [`CONFIG_CACHE_MANAGEMENT`](../../kconfig.md#CONFIG_CACHE_MANAGEMENT "CONFIG_CACHE_MANAGEMENT"): cache API enabled.
- Call [`sys_cache_data_flush_range()`](../../doxygen/html/group__cache__interface.md#ga6b61424f0aa81e2893c915b096de0cdb) to flush a memory region.
- Call [`sys_cache_data_invd_range()`](../../doxygen/html/group__cache__interface.md#ga578f2f926cbf5ad196765881c8c1265e) to invalidate a memory region.
- Call [`sys_cache_data_flush_and_invd_range()`](../../doxygen/html/group__cache__interface.md#ga51d2bfa0ed0d139d1d299d14e8269eac) to flush and invalidate.

## Alignment

As mentioned in [`sys_cache_data_invd_range()`](../../doxygen/html/group__cache__interface.md#ga578f2f926cbf5ad196765881c8c1265e) and associated functions,
