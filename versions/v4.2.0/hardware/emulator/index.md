---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/emulator/index.html
...
:   - A fake driver which pretends to be actual ADC, and can be used for testing higher-level API
    ...
    - DT binding: [`zephyr,adc-emul`](../../build/dts/api/bindings/adc/zephyr,adc-emul.md#std-dtcompatible-zephyr-adc-emul)

**DMA emulator**
:   - Emulated DMA controller
    - Main Kconfig option: [`CONFIG_DMA_EMUL`](../../kconfig.md#CONFIG_DMA_EMUL "CONFIG_DMA_EMUL")
    - DT binding: [`zephyr,dma-emul`](../../build/dts/api/bindings/dma/zephyr,dma-emul.md#std-dtcompatible-zephyr-dma-emul)
...
:   - Emulate an EEPROM on a flash partition
    ...
    - DT binding: [`zephyr,emu-eeprom`](../../build/dts/api/bindings/mtd/zephyr,emu-eeprom.md#std-dtcompatible-zephyr-emu-eeprom)
...
:   - Emulate an EEPROM on RAM
    ...
    - DT binding: [`zephyr,sim-eeprom`](../../build/dts/api/bindings/mtd/zephyr,sim-eeprom.md#std-dtcompatible-zephyr-sim-eeprom)
...
:   - Emulate a flash on RAM
    ...
    - DT binding: [`zephyr,sim-flash`](../../build/dts/api/bindings/flash_controller/zephyr,sim-flash.md#std-dtcompatible-zephyr-sim-flash)
...
:   - Emulated GPIO controllers which can be driven from SW
    ...
    - DT binding: [`zephyr,gpio-emul`](../../build/dts/api/bindings/gpio/zephyr,gpio-emul.md#std-dtcompatible-zephyr-gpio-emul)
...
:   - Emulated I2C bus. See [bus emulators](bus_emulators.md#bus-emul).
    ...
    - DT binding: [`zephyr,i2c-emul-controller`](../../build/dts/api/bindings/i2c/zephyr,i2c-emul-controller.md#std-dtcompatible-zephyr-i2c-emul-controller)
...
:   - Emulated RTC peripheral. See [RTC emulated device section](../peripherals/rtc.md#rtc-api-emul-dev)
    ...
    - DT binding: [`zephyr,rtc-emul`](../../build/dts/api/bindings/rtc/zephyr,rtc-emul.md#std-dtcompatible-zephyr-rtc-emul)
...
:   - Emulated SPI bus. See [bus emulators](bus_emulators.md#bus-emul).
    ...
    - DT binding: [`zephyr,spi-emul-controller`](../../build/dts/api/bindings/spi/zephyr,spi-emul-controller.md#std-dtcompatible-zephyr-spi-emul-controller)
...
:   - Emulated MSPI bus. See [bus emulators](bus_emulators.md#bus-emul).
    ...
    - DT binding: [`zephyr,mspi-emul-controller`](../../build/dts/api/bindings/mspi/zephyr,mspi-emul-controller.md#std-dtcompatible-zephyr-mspi-emul-controller)
...
:   - Emulated UART bus. See [bus emulators](bus_emulators.md#bus-emul).
    ...
    - DT binding: [`zephyr,uart-emul`](../../build/dts/api/bindings/serial/zephyr,uart-emul.md#std-dtcompatible-zephyr-uart-emul)
