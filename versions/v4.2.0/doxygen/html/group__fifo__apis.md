---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__fifo__apis.html
...
| | #define k\_fifo\_alloc\_put | ( |  | *fifo*, | | --- | --- | --- | --- | |  |  |  | *data* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
SYS\_PORT\_TRACING\_OBJ\_FUNC\_ENTER([k\_fifo](structk__fifo.md), alloc\_put, fifo, \_data); \

int fap\_ret = [k\_queue\_alloc\_append](group__queue__apis.md#ga690f3a1450e946d75f31b3e499d1d06a)(&(fifo)->\_queue, \_data); \

SYS\_PORT\_TRACING\_OBJ\_FUNC\_EXIT([k\_fifo](structk__fifo.md), alloc\_put, fifo, \_data, fap\_ret); \
...
| | #define k\_fifo\_cancel\_wait | ( |  | *fifo* | ) |  | | --- | --- | --- | --- | --- | --- | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | #define k\_fifo\_get | ( |  | *fifo*, | | --- | --- | --- | --- | |  |  |  | *timeout* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | #define k\_fifo\_is\_empty | ( |  | *fifo* | ) |  | | --- | --- | --- | --- | --- | --- | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | #define k\_fifo\_put | ( |  | *fifo*, | | --- | --- | --- | --- | |  |  |  | *data* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
SYS\_PORT\_TRACING\_OBJ\_FUNC\_ENTER([k\_fifo](structk__fifo.md), put, fifo, \_data); \

k\_queue\_append(&(fifo)->\_queue, \_data); \

SYS\_PORT\_TRACING\_OBJ\_FUNC\_EXIT([k\_fifo](structk__fifo.md), put, fifo, \_data); \
...
| | #define k\_fifo\_put\_list | ( |  | *fifo*, | | --- | --- | --- | --- | |  |  |  | *head*, | |  |  |  | *tail* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | #define k\_fifo\_put\_slist | ( |  | *fifo*, | | --- | --- | --- | --- | |  |  |  | *list* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
