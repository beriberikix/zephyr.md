---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__mesh__health__srv.html
...
| #define | [BT\_MESH\_MODEL\_HEALTH\_SRV](#gafcab7a9c9264c52f42b5409ccad1c931)(srv, pub, ...) |
|  | Define a new health server model. |
| #define | [BT\_MESH\_HEALTH\_TEST\_INFO\_METADATA\_ID](#ga240e4632cdf7c425d4beec3c6a290306)   0x0000 |
...
`#include <[zephyr/bluetooth/mesh/health_srv.h](health__srv_8h.md)>`

**Value:**

[BT\_MESH\_MODEL\_PUB\_DEFINE](group__bt__mesh__access.md#ga8334ff2da1f0dc3ab2fc914059c33622)(\_name, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), (1 + 3 + (\_max\_faults)))
...
| #define BT\_MESH\_HEALTH\_TEST\_INFO\_METADATA\_ID   0x0000 |
| --- |
...
## [◆ ](#gafcab7a9c9264c52f42b5409ccad1c931)BT\_MESH\_MODEL\_HEALTH\_SRV
...
[BT\_MESH\_MODEL\_METADATA\_CB](group__bt__mesh__access.md#ga40204b4ccaa819a487de168bcf66c98f)([BT\_MESH\_MODEL\_ID\_HEALTH\_SRV](group__bt__mesh__access.md#ga6416216348d7186f91175ca50bb8c903), \

bt\_mesh\_health\_srv\_op, \

pub, \

srv, \

&[bt\_mesh\_health\_srv\_cb](structbt__mesh__health__srv__cb.md), \_\_VA\_ARGS\_\_)

[BT\_MESH\_MODEL\_METADATA\_CB](group__bt__mesh__access.md#ga40204b4ccaa819a487de168bcf66c98f)

#define BT\_MESH\_MODEL\_METADATA\_CB(\_id, \_op, \_pub, \_user\_data, \_cb, \_metadata)
