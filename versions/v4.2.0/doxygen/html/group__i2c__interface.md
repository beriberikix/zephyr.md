---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i2c__interface.html
...
| #define | [I2C\_DEVICE\_DT\_DEINIT\_DEFINE](#ga831cf78c11ebfceb65315995504cb7fb)(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api, ...) |
|  | Like [DEVICE\_DT\_DEINIT\_DEFINE()](group__device__model.md#gaa53f7267950569df898b0e5362e6f583 "Create a device object from a devicetree node identifier and set it up for boot time initialization.") with I2C specifics. |
| #define | [I2C\_DEVICE\_DT\_DEFINE](#ga47b9d476cc85d6f5b8081c73dd87064f)(node\_id, init\_fn, pm, data, config, level, prio, api, ...) |
|  | Like [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](#ga831cf78c11ebfceb65315995504cb7fb) but without deinit\_fn. |
| #define | [I2C\_DEVICE\_DT\_INST\_DEINIT\_DEFINE](#ga9c7a8248802760a2f9509e76377fb38a)(inst, ...) |
|  | Like [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](#ga831cf78c11ebfceb65315995504cb7fb) for an instance of a DT\_DRV\_COMPAT compatible. |
...
| static int | [i2c\_configure\_dt](#ga780c4b50a3dc89c01a98c432554c2795) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*spec, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) dev\_config) |
|  | Configure operation of a host controller. |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i2c\_is\_ready\_iodev](#ga3ddf8440c2306b5cde3013fba13a0e29) (const struct [rtio\_iodev](structrtio__iodev.md) \*i2c\_iodev) |
|  | Validate that I2C bus is ready. |
...
| struct [rtio\_sqe](structrtio__sqe.md) \* | [i2c\_rtio\_copy\_reg\_write\_byte](#gaf09d16086cbf1f0fc02463205df9fc00) (struct [rtio](structrtio.md) \*[r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2), struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) reg\_addr, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) data) |
|  | Copy the register address and data to a SQE. |
| struct [rtio\_sqe](structrtio__sqe.md) \* | [i2c\_rtio\_copy\_reg\_burst\_read](#gafa782a07d60a6f3115957e1327b41cd3) (struct [rtio](structrtio.md) \*[r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2), struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) start\_addr, void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_bytes) |
...
`#include <[zephyr/drivers/i2c.h](drivers_2i2c_8h.md)>`
...
[I2C\_DEVICE\_DT\_DEINIT\_DEFINE](#ga831cf78c11ebfceb65315995504cb7fb)(node\_id, init\_fn, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), pm, data, \

config, level, prio, api, \

\_\_VA\_ARGS\_\_)

[I2C\_DEVICE\_DT\_DEINIT\_DEFINE](#ga831cf78c11ebfceb65315995504cb7fb)

#define I2C\_DEVICE\_DT\_DEINIT\_DEFINE(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api,...)

Like DEVICE\_DT\_DEINIT\_DEFINE() with I2C specifics.

**Definition** i2c.h:666
...
## [◆ ](#ga831cf78c11ebfceb65315995504cb7fb)I2C\_DEVICE\_DT\_DEINIT\_DEFINE

| #define I2C\_DEVICE\_DT\_DEINIT\_DEFINE | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *init\_fn*, |
|  |  |  | *deinit\_fn*, |
|  |  |  | *pm*, |
...
deinit\_fn, Z\_DEVICE\_DT\_FLAGS(node\_id), pm, data,\
...
:   | node\_id | The devicetree node identifier. |
    ...
    | deinit\_fn | Name of the deinit function of the driver. Can be [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4). |
...
Like I2C\_DEVICE\_DT\_DEINIT\_DEFINE() but without deinit\_fn.

**Definition** i2c.h:698
...
## [◆ ](#ga9c7a8248802760a2f9509e76377fb38a)I2C\_DEVICE\_DT\_INST\_DEINIT\_DEFINE

| #define I2C\_DEVICE\_DT\_INST\_DEINIT\_DEFINE | ( |  | *inst*, |
| --- | --- | --- | --- |
|  |  |  | ... ) |
...
[I2C\_DEVICE\_DT\_DEINIT\_DEFINE](#ga831cf78c11ebfceb65315995504cb7fb)([DT\_DRV\_INST](group__devicetree-inst.md#ga219f413efba2f4c0151468b9a25a8dc1)(inst), \_\_VA\_ARGS\_\_)

Like [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](#ga831cf78c11ebfceb65315995504cb7fb) for an instance of a DT\_DRV\_COMPAT compatible.

Parameters
:   | inst | instance number. This is replaced by DT\_DRV\_COMPAT(inst) in the call to [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](#ga831cf78c11ebfceb65315995504cb7fb). |
    | --- | --- |
    | ... | other parameters as expected by [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](#ga831cf78c11ebfceb65315995504cb7fb). |
...
## [◆ ](#ga780c4b50a3dc89c01a98c432554c2795)i2c\_configure\_dt()

| | int i2c\_configure\_dt | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *spec*, | | --- | --- | --- | --- | |  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *dev\_config* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Returns
:   a value from [i2c\_configure()](#ga75326a6f38c011d35df9f3e72f2259e9)
...
## [◆ ](#ga3ddf8440c2306b5cde3013fba13a0e29)i2c\_is\_ready\_iodev()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) i2c\_is\_ready\_iodev | ( | const struct [rtio\_iodev](structrtio__iodev.md) \* | *i2c\_iodev* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | i2c\_iodev | I2C iodev defined with I2C\_DT\_IODEV\_DEFINE |
    | --- | --- |
...
## [◆ ](#gafa782a07d60a6f3115957e1327b41cd3)i2c\_rtio\_copy\_reg\_burst\_read()

| struct [rtio\_sqe](structrtio__sqe.md) \* i2c\_rtio\_copy\_reg\_burst\_read | ( | struct [rtio](structrtio.md) \* | *r*, |
| --- | --- | --- | --- |
|  |  | struct [rtio\_iodev](structrtio__iodev.md) \* | *iodev*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *start\_addr*, |
|  |  | void \* | *buf*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *num\_bytes* ) |
...
:   | [r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2) | RTIO context |
    | --- | --- |
    | iodev | RTIO IODev to target for the submissions |
    | start\_addr | target register address |
    | buf | Memory pool that stores the retrieved data. |
    | num\_bytes | Number of bytes to read. |
...
## [◆ ](#gaf09d16086cbf1f0fc02463205df9fc00)i2c\_rtio\_copy\_reg\_write\_byte()

| struct [rtio\_sqe](structrtio__sqe.md) \* i2c\_rtio\_copy\_reg\_write\_byte | ( | struct [rtio](structrtio.md) \* | *r*, |
| --- | --- | --- | --- |
|  |  | struct [rtio\_iodev](structrtio__iodev.md) \* | *iodev*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *reg\_addr*, |
...
:   | [r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2) | RTIO context |
    | --- | --- |
    | iodev | RTIO IODev to target for the submissions |
    | reg\_addr | target register address |
