---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/flash__map_8h_source.html
...
[ 209](group__flash__area__api.md#gaa50bb1b455a9004f9c24e4af9fd74cd7)int [flash\_area\_copy](group__flash__area__api.md#gaa50bb1b455a9004f9c24e4af9fd74cd7)(const struct [flash\_area](structflash__area.md) \*src\_fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) src\_off,

210 const struct [flash\_area](structflash__area.md) \*dst\_fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) dst\_off,

211 [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) len, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t buf\_size);

212

[ 226](group__flash__area__api.md#gacc5cbff19d23773115f3334f862814d2)int [flash\_area\_erase](group__flash__area__api.md#gacc5cbff19d23773115f3334f862814d2)(const struct [flash\_area](structflash__area.md) \*fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) [off](asm-macro-32-bit-gnu_8h.md#adbc19a384ffe3a93866980a920b08394), size\_t len);

227

[ 249](group__flash__area__api.md#gafd097d05f5bfe91695bc7793e82cabcd)int [flash\_area\_flatten](group__flash__area__api.md#gafd097d05f5bfe91695bc7793e82cabcd)(const struct [flash\_area](structflash__area.md) \*fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) [off](asm-macro-32-bit-gnu_8h.md#adbc19a384ffe3a93866980a920b08394), size\_t len);

250

[ 261](group__flash__area__api.md#ga13b7294e84544373e97b8c0274859f6e)[uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [flash\_area\_align](group__flash__area__api.md#ga13b7294e84544373e97b8c0274859f6e)(const struct [flash\_area](structflash__area.md) \*fa);

262

[ 275](group__flash__area__api.md#ga5c89e0be6c41058beb1c3f87a0c9c94f)int [flash\_area\_get\_sectors](group__flash__area__api.md#ga5c89e0be6c41058beb1c3f87a0c9c94f)(int fa\_id, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*count,

276 struct [flash\_sector](structflash__sector.md) \*sectors);

277

[ 290](group__flash__area__api.md#ga12064d388369a504b571e9776201f688)int [flash\_area\_sectors](group__flash__area__api.md#ga12064d388369a504b571e9776201f688)(const struct [flash\_area](structflash__area.md) \*fa, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*count, struct [flash\_sector](structflash__sector.md) \*sectors);

291

[ 299](group__flash__area__api.md#gab9d0b43faefa1f25805e7def82819f2c)typedef void (\*[flash\_area\_cb\_t](group__flash__area__api.md#gab9d0b43faefa1f25805e7def82819f2c))(const struct [flash\_area](structflash__area.md) \*fa,

300 void \*user\_data);

301

[ 308](group__flash__area__api.md#ga34e74955153f8576acdbff1a524f2d37)void [flash\_area\_foreach](group__flash__area__api.md#ga34e74955153f8576acdbff1a524f2d37)([flash\_area\_cb\_t](group__flash__area__api.md#gab9d0b43faefa1f25805e7def82819f2c) user\_cb, void \*user\_data);

309

[ 318](group__flash__area__api.md#ga557d5fd981b0d52d0eb483ab218c497c)int [flash\_area\_has\_driver](group__flash__area__api.md#ga557d5fd981b0d52d0eb483ab218c497c)(const struct [flash\_area](structflash__area.md) \*fa);

319

[ 327](group__flash__area__api.md#gaed7d16e272d7644f556d2edaa942b308)const struct [device](structdevice.md) \*[flash\_area\_get\_device](group__flash__area__api.md#gaed7d16e272d7644f556d2edaa942b308)(const struct [flash\_area](structflash__area.md) \*fa);

328

329#if CONFIG\_FLASH\_MAP\_LABELS

337const char \*flash\_area\_label(const struct [flash\_area](structflash__area.md) \*fa);

338#endif

339

[ 349](group__flash__area__api.md#ga1f16d59cecb25c5143c6a923b3b2f466)[uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [flash\_area\_erased\_val](group__flash__area__api.md#ga1f16d59cecb25c5143c6a923b3b2f466)(const struct [flash\_area](structflash__area.md) \*fa);

350

[ 359](group__flash__area__api.md#gabb94759e5717302724f08f90f941a945)#define FIXED\_PARTITION\_EXISTS(label) DT\_FIXED\_PARTITION\_EXISTS(DT\_NODELABEL(label))

360

[ 368](group__flash__area__api.md#ga60d5298007e2ee261b915a110389e76a)#define FIXED\_PARTITION\_ID(label) DT\_FIXED\_PARTITION\_ID(DT\_NODELABEL(label))

369

[ 377](group__flash__area__api.md#ga9229bc06458c19baf093ced063a9494b)#define FIXED\_PARTITION\_OFFSET(label) DT\_REG\_ADDR(DT\_NODELABEL(label))

378

[ 386](group__flash__area__api.md#gaf26b80f089d25283c01ed54b5a27988c)#define FIXED\_PARTITION\_NODE\_OFFSET(node) DT\_REG\_ADDR(node)

387

[ 395](group__flash__area__api.md#ga2dbc50d9f80d7f7c597c75cbd536cd50)#define FIXED\_PARTITION\_SIZE(label) DT\_REG\_SIZE(DT\_NODELABEL(label))

396

[ 404](group__flash__area__api.md#ga526459438c6de09abb727585d22b7004)#define FIXED\_PARTITION\_NODE\_SIZE(node) DT\_REG\_SIZE(node)

405

[ 413](group__flash__area__api.md#gacca3f32100a4e46cb7da21ea8bf0782c)#define FLASH\_AREA\_DEVICE(label) \

414 DEVICE\_DT\_GET(DT\_MTD\_FROM\_FIXED\_PARTITION(DT\_NODE\_BY\_FIXED\_PARTITION\_LABEL(label)))

415

[ 423](group__flash__area__api.md#ga3c92b6797feb183da38b8b57e77f2d17)#define FIXED\_PARTITION\_DEVICE(label) \

424 DEVICE\_DT\_GET(DT\_MTD\_FROM\_FIXED\_PARTITION(DT\_NODELABEL(label)))

425

[ 433](group__flash__area__api.md#gad64fb220f82870acce62661bfa94991a)#define FIXED\_PARTITION\_NODE\_DEVICE(node) \

434 DEVICE\_DT\_GET(DT\_MTD\_FROM\_FIXED\_PARTITION(node))

435

[ 443](group__flash__area__api.md#ga5682b688b50fd2cac3c6c8045e64107e)#define FIXED\_PARTITION(label) FIXED\_PARTITION\_1(DT\_NODELABEL(label))

444

[ 452](group__flash__area__api.md#gab51fb05a2cd0666b892d90ccbc9de342)#define FIXED\_PARTITION\_BY\_NODE(node) FIXED\_PARTITION\_1(node)

453

455#define FIXED\_PARTITION\_1(node) FIXED\_PARTITION\_0(DT\_DEP\_ORD(node))

456#define FIXED\_PARTITION\_0(ord) \

457 ((const struct flash\_area \*)&DT\_CAT(global\_fixed\_partition\_ORD\_, ord))

458

459#define DECLARE\_PARTITION(node) DECLARE\_PARTITION\_0(DT\_DEP\_ORD(node))

460#define DECLARE\_PARTITION\_0(ord) \

461 extern const struct flash\_area DT\_CAT(global\_fixed\_partition\_ORD\_, ord);

462#define FOR\_EACH\_PARTITION\_TABLE(table) DT\_FOREACH\_CHILD(table, DECLARE\_PARTITION)

463

464/\* Generate declarations \*/

465[DT\_FOREACH\_STATUS\_OKAY](group__devicetree-generic-foreach.md#ga52b34316d269cc8d8ef2244d3ca460b8)(fixed\_partitions, FOR\_EACH\_PARTITION\_TABLE)

466

467#undef DECLARE\_PARTITION

468#undef DECLARE\_PARTITION\_0

469#undef FOR\_EACH\_PARTITION\_TABLE
...
480#endif /\* ZEPHYR\_INCLUDE\_STORAGE\_FLASH\_MAP\_H\_ \*/
...
[flash\_area\_copy](group__flash__area__api.md#gaa50bb1b455a9004f9c24e4af9fd74cd7)

int flash\_area\_copy(const struct flash\_area \*src\_fa, off\_t src\_off, const struct flash\_area \*dst\_fa, off\_t dst\_off, off\_t len, uint8\_t \*buf, size\_t buf\_size)
