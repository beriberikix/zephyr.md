---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structhttp__client__ctx.html
...
| --- | --- |
|  | [IF\_ENABLED](#afc21ace1fba336e739eb4181e9b8d55e) (CONFIG\_HTTP\_SERVER\_COMPRESSION,([bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) accept\_encoding\_next:1)) |
...
| const struct http\_service\_desc \* | [service](#aea8cfd5353abc7b6bd50acde9d2c8c23) |
...
| struct http\_header\_capture\_ctx | [header\_capture\_ctx](#af278d2f02f617d49c54639a29317b758) |
...
## [◆ ](#afc21ace1fba336e739eb4181e9b8d55e)IF\_ENABLED()

| http\_client\_ctx::IF\_ENABLED | ( | CONFIG\_HTTP\_SERVER\_COMPRESSION | , |
| --- | --- | --- | --- |
|  |  | ([bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) accept\_encoding\_next:1) | ) |
...
## [◆ ](#af278d2f02f617d49c54639a29317b758)header\_capture\_ctx

| struct http\_header\_capture\_ctx http\_client\_ctx::header\_capture\_ctx |
| --- |
...
## [◆ ](#aea8cfd5353abc7b6bd50acde9d2c8c23)service

| const struct http\_service\_desc\* http\_client\_ctx::service |
| --- |
