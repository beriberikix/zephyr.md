---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/rtio_2rtio_8h.html
original_path: doxygen/html/rtio_2rtio_8h.html
---
...
`#include <[zephyr/sys/mpsc_lockfree.h](mpsc__lockfree_8h_source.md)>`  
`#include <zephyr/syscalls/rtio.h>`

[Go to the source code of this file.](rtio_2rtio_8h_source.md)
...
| #define | [RTIO\_IODEV\_I2C\_STOP](group__rtio.md#gaf923e862d2c6a3fbce5eb96781cf86d8)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
|  | Equivalent to the I2C\_MSG\_STOP flag. |
| #define | [RTIO\_IODEV\_I2C\_RESTART](group__rtio.md#gadba1c5eddeecc431000bd92054f55c3a)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(2) |
|  | Equivalent to the I2C\_MSG\_RESTART flag. |
| #define | [RTIO\_IODEV\_I2C\_10\_BITS](group__rtio.md#gaa0c3b047c7205d12775d8d38907119b9)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(3) |
|  | Equivalent to the I2C\_MSG\_ADDR\_10\_BITS. |
| #define | [RTIO\_IODEV\_I3C\_STOP](group__rtio.md#ga671a479885f4d9abbdad677ddfbc47df)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
|  | Equivalent to the I3C\_MSG\_STOP flag. |
| #define | [RTIO\_IODEV\_I3C\_RESTART](group__rtio.md#ga9d30e1b8f22da07a25fd379c27dc2afe)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(2) |
|  | Equivalent to the I3C\_MSG\_RESTART flag. |
| #define | [RTIO\_IODEV\_I3C\_HDR](group__rtio.md#ga857a1b2a766faa1438b4b07d73ca05ed)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(3) |
|  | Equivalent to the I3C\_MSG\_HDR. |
| #define | [RTIO\_IODEV\_I3C\_NBCH](group__rtio.md#ga258aae8fdda81c71d08dc3e26feb843d)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(4) |
|  | Equivalent to the I3C\_MSG\_NBCH. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_MODE\_MASK](group__rtio.md#ga5e278e6ec0c31de2246c0fa9a96425c8)   [GENMASK](group__sys-util.md#ga58530d20924859d16358c7400c37738d)(15, 8) |
|  | I3C HDR Mode Mask. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_MODE\_SET](group__rtio.md#gae2b6caf5fa82cc7dc07508dccfeb423b)([flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9)) |
|  | I3C HDR Mode Mask. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_MODE\_GET](group__rtio.md#ga902a66ba8772f7a2395069e6725776da)([flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9)) |
|  | I3C HDR Mode Mask. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_CMD\_CODE\_MASK](group__rtio.md#ga0642bb5c69d01ea0fe148da9b8475328)   [GENMASK](group__sys-util.md#ga58530d20924859d16358c7400c37738d)(22, 16) |
|  | I3C HDR 7b Command Code. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_CMD\_CODE\_SET](group__rtio.md#ga4d0b165eb8f4a7cc63c35e9f9438ee5a)([flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9)) |
|  | I3C HDR 7b Command Code. |
| #define | [RTIO\_IODEV\_I3C\_HDR\_CMD\_CODE\_GET](group__rtio.md#ga881fcb3d955aece099266ef5b57e767b)([flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9)) |
|  | I3C HDR 7b Command Code. |
...
| #define | [RTIO\_OP\_DELAY](group__rtio.md#gae8da4da54f32963190f52c7533d4c951)   ([RTIO\_OP\_TXRX](group__rtio.md#ga9f0e70f5a28be65a8ed67c0257a72692)+1) |
|  | An operation that takes a specified amount of time (asynchronously) before completing. |
| #define | [RTIO\_OP\_I2C\_RECOVER](group__rtio.md#ga3b4f9b1ee1612290323161ecc16e0859)   ([RTIO\_OP\_DELAY](group__rtio.md#gae8da4da54f32963190f52c7533d4c951)+1) |
|  | An operation to recover I2C buses. |
| #define | [RTIO\_OP\_I2C\_CONFIGURE](group__rtio.md#gad987be3acfe406b11419c7e8cd068cf5)   ([RTIO\_OP\_I2C\_RECOVER](group__rtio.md#ga3b4f9b1ee1612290323161ecc16e0859)+1) |
|  | An operation to configure I2C buses. |
| #define | [RTIO\_OP\_I3C\_RECOVER](group__rtio.md#gac69023c6902570e7511edd044d6d9d94)   ([RTIO\_OP\_I2C\_CONFIGURE](group__rtio.md#gad987be3acfe406b11419c7e8cd068cf5)+1) |
|  | An operation to recover I3C buses. |
| #define | [RTIO\_OP\_I3C\_CONFIGURE](group__rtio.md#gaa77874941380a8215ec57b30d993d437)   ([RTIO\_OP\_I3C\_RECOVER](group__rtio.md#gac69023c6902570e7511edd044d6d9d94)+1) |
|  | An operation to configure I3C buses. |
| #define | [RTIO\_OP\_I3C\_CCC](group__rtio.md#ga691ea387929db1224d6343fd91dfd2c5)   ([RTIO\_OP\_I3C\_CONFIGURE](group__rtio.md#gaa77874941380a8215ec57b30d993d437)+1) |
|  | An operation to sends I3C CCC. |
| #define | [RTIO\_OP\_AWAIT](group__rtio.md#gad74290935595b83040676b426cd07161)   ([RTIO\_OP\_I3C\_CCC](group__rtio.md#ga691ea387929db1224d6343fd91dfd2c5)+1) |
...
| typedef void(\* | [rtio\_signaled\_t](group__rtio.md#gab254ffa4d10bfb670bacd1c47c1f8711)) (struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe, void \*userdata) |
...
| static void | [rtio\_sqe\_prep\_callback\_no\_cqe](group__rtio.md#gae87be354087d038953dae07c7f9cd3b0) (struct [rtio\_sqe](structrtio__sqe.md) \*sqe, [rtio\_callback\_t](group__rtio.md#gad1dbd690e6cf88d7c788436dd04d1a00) callback, void \*arg0, void \*userdata) |
|  | Prepare a callback op submission that does not create a CQE. |
| static void | [rtio\_sqe\_prep\_transceive](group__rtio.md#gab9b605dcbb01d21c88f9ae70588ea3b5) (struct [rtio\_sqe](structrtio__sqe.md) \*sqe, const struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [int8\_t](stdint_8h.md#accbd6432732c88ad6adc5365800433b6) prio, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*tx\_buf, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*rx\_buf, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) buf\_len, void \*userdata) |
|  | Prepare a transceive op submission. |
| static void | [rtio\_sqe\_prep\_await](group__rtio.md#gafd97c145b8525895494a31a87610f65d) (struct [rtio\_sqe](structrtio__sqe.md) \*sqe, const struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [int8\_t](stdint_8h.md#accbd6432732c88ad6adc5365800433b6) prio, void \*userdata) |
| static void | [rtio\_sqe\_prep\_delay](group__rtio.md#ga2169a7a776a5300b25f599144de4de0b) (struct [rtio\_sqe](structrtio__sqe.md) \*sqe, [k\_timeout\_t](structk__timeout__t.md) timeout, void \*userdata) |
...
| void | [rtio\_sqe\_signal](group__rtio.md#gae63ffc626a3e99406d36aa47f10b49e1) (struct [rtio\_sqe](structrtio__sqe.md) \*sqe) |
|  | Signal an AWAIT SQE. |
| static void | [rtio\_iodev\_sqe\_await\_signal](group__rtio.md#ga7d2e5673582f32b630e2294dfbf0fe44) (struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe, [rtio\_signaled\_t](group__rtio.md#gab254ffa4d10bfb670bacd1c47c1f8711) callback, void \*userdata) |
