---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structhttp__response.html
...
| [http\_response\_cb\_t](group__http__client.md#ga6141c94f7da92b71713079063f3426be) | [cb](#a1936119331645bb421d4a5dc0d3fffb5) |
...
| char | [http\_status](#a6bf553c9399385afeb921f6abef9a875) [HTTP\_STATUS\_STR\_SIZE] |
...
| struct [http\_content\_range](structhttp__content__range.md) | [content\_range](#a1f88915f82406ae3592dec32b7430851) |
...
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [cr\_present](#ade896effa407ccdc5c9a7ef3720e66e2): 1 |
...
| [http\_response\_cb\_t](group__http__client.md#ga6141c94f7da92b71713079063f3426be) http\_response::cb |
| --- |
...
## [◆ ](#a1f88915f82406ae3592dec32b7430851)content\_range

| struct [http\_content\_range](structhttp__content__range.md) http\_response::content\_range |
| --- |

HTTP Content-Range response field value.

Consist of range\_start, range\_end and total\_size. Total is set to 0 if not supplied.

## [◆ ](#ade896effa407ccdc5c9a7ef3720e66e2)cr\_present

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) http\_response::cr\_present |
| --- |
...
## [◆ ](#a6bf553c9399385afeb921f6abef9a875)http\_status

| char http\_response::http\_status[HTTP\_STATUS\_STR\_SIZE] |
| --- |
