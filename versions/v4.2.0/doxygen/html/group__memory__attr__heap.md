---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__memory__attr__heap.html
...
`#include <[zephyr/mem_mgmt/mem_attr_heap.h](mem__attr__heap_8h.md)>`
...
:   | ptr | a valid pointer to the allocated memory. |
    | --- | --- |
    | [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) | if no memory is available with that attribute and size. |
