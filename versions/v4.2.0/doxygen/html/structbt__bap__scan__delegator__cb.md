---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__bap__scan__delegator__cb.html
...
| int(\* | [bis\_sync\_req](#a9702317028e29e8bb2c19a48749816e8) )(struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state, const [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) bis\_sync\_req[[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)(CONFIG\_BT\_AUDIO,(CONFIG\_BT\_BAP\_BASS\_MAX\_SUBGROUPS),(0))]) |
...
| int(\* | [add\_source](#a1ca1642de4bcf3f6552d09761168b1fc) )(struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state) |
|  | Add Source operation callback. |
| int(\* | [modify\_source](#af862ad2d51d60e57cc50e20c256fde35) )(struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state) |
|  | Modify Source operation callback. |
| int(\* | [remove\_source](#a8da03993be622b5d25e8bd462dfd16c5) )(struct bt\_conn \*conn, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) src\_id) |
...
## [◆ ](#a1ca1642de4bcf3f6552d09761168b1fc)add\_source

| int(\* bt\_bap\_scan\_delegator\_cb::add\_source) (struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state) |
| --- |

Add Source operation callback.

These callbacks notify the application when a request comes in to add a source. The application can return 0 to accept or any other value to reject the request.

Parameters
:   | conn | Pointer to the connection that initiated the request, or NULL if locally triggered. |
    | --- | --- |
    | recv\_state | Pointer to the requested receive state to be added. |

Returns
:   0 in case of accept, or other value to reject.

## [◆ ](#a9702317028e29e8bb2c19a48749816e8)bis\_sync\_req

| int(\* bt\_bap\_scan\_delegator\_cb::bis\_sync\_req) (struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state, const [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) bis\_sync\_req[[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)(CONFIG\_BT\_AUDIO,(CONFIG\_BT\_BAP\_BASS\_MAX\_SUBGROUPS),(0))]) |
| --- |
...
:   | [in] | conn | Pointer to the connection of the Broadcast Assistant requesting the sync. |
    ...
    | [in] | [bis\_sync\_req](#a9702317028e29e8bb2c19a48749816e8) | Array of bitfields of which BIS indexes that is requested to sync for each subgroup by the Broadcast Assistant. A value of 0 indicates a request to terminate the BIG sync. |
...
## [◆ ](#af862ad2d51d60e57cc50e20c256fde35)modify\_source

| int(\* bt\_bap\_scan\_delegator\_cb::modify\_source) (struct bt\_conn \*conn, const struct [bt\_bap\_scan\_delegator\_recv\_state](structbt__bap__scan__delegator__recv__state.md) \*recv\_state) |
| --- |

Modify Source operation callback.

These callbacks notify the application when a request comes in to modify a source. The application can return 0 to accept or any other value to reject the request.

Parameters
:   | conn | Pointer to the connection that initiated the request, or NULL if locally triggered. |
    | --- | --- |
    | recv\_state | Pointer to the requested receive state to be modified. |
...
## [◆ ](#a8da03993be622b5d25e8bd462dfd16c5)remove\_source

| int(\* bt\_bap\_scan\_delegator\_cb::remove\_source) (struct bt\_conn \*conn, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) src\_id) |
| --- |

Remove Source operation callback.

These callbacks notify the application when a request comes in to remove a source. The application can return 0 to accept or any other value to reject the request.

Parameters
:   | conn | Pointer to the connection that initiated the request, or NULL if locally triggered. |
    | --- | --- |
    | src\_id | The Source ID that is requested to be removed. |
