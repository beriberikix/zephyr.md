---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/uart__async__to__irq_8h_source.html
...
[ 116](uart__async__to__irq_8h.md#aae442237aa3432348c256807df3ffa1c)int [uart\_async\_to\_irq\_init](uart__async__to__irq_8h.md#aae442237aa3432348c256807df3ffa1c)(const struct [device](structdevice.md) \*dev);
...
[ 126](uart__async__to__irq_8h.md#a42a81b74f16109ad516628f99bc44503)int [uart\_async\_to\_irq\_rx\_enable](uart__async__to__irq_8h.md#a42a81b74f16109ad516628f99bc44503)(const struct [device](structdevice.md) \*dev);
...
[ 136](uart__async__to__irq_8h.md#a4638b8d0a01c9cd388e5d0dafc9b4d8c)int [uart\_async\_to\_irq\_rx\_disable](uart__async__to__irq_8h.md#a4638b8d0a01c9cd388e5d0dafc9b4d8c)(const struct [device](structdevice.md) \*dev);
...
143struct uart\_async\_to\_irq\_config {

145 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*tx\_buf;
...
151 struct [uart\_async\_rx\_config](structuart__async__rx__config.md) async\_rx;

152

154 const struct uart\_async\_to\_irq\_async\_api \*api;

155

157 [uart\_async\_to\_irq\_trampoline](uart__async__to__irq_8h.md#a6f9f2a997d3c8b76d3615f1de85b8a92) trampoline;

158

160 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) baudrate;

161

163 [LOG\_INSTANCE\_PTR\_DECLARE](log__instance_8h.md#a224e4a75dca6d1b363ef49e96730dcfd)(log);

164};

165

167struct uart\_async\_to\_irq\_async\_api {

168 int (\*callback\_set)(const struct device \*dev,

169 [uart\_callback\_t](group__uart__async.md#ga00b7c98a4da3ea3675d0a40c5dacb136) callback,

170 void \*user\_data);

171

172 int (\*tx)(const struct device \*dev, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t len,

173 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) timeout);

174 int (\*tx\_abort)(const struct device \*dev);

175

176 int (\*rx\_enable)(const struct device \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t len,

177 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) timeout);

178 int (\*rx\_buf\_rsp)(const struct device \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t len);

179 int (\*rx\_disable)(const struct device \*dev);

180};

181

183struct uart\_async\_to\_irq\_rx\_data {

185 struct uart\_async\_rx async\_rx;

186

188 struct k\_sem sem;

189

191 [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8) pending\_buf\_req;

192};

193

195struct uart\_async\_to\_irq\_tx\_data {

197 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf;
...
204struct uart\_async\_to\_irq\_data {

206 [uart\_irq\_callback\_user\_data\_t](group__uart__interrupt.md#gad7a26b1a1d6212d7d39c05c8ad4ec926) callback;
...
212 [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8) irq\_req;

213

215 struct uart\_async\_to\_irq\_rx\_data rx;

216

218 struct uart\_async\_to\_irq\_tx\_data tx;

219

221 struct k\_spinlock lock;

222

224 [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8) [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9);

225};

226

228int z\_uart\_async\_to\_irq\_fifo\_fill(const struct [device](structdevice.md) \*dev,

229 const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf,

230 int len);

231

233int z\_uart\_async\_to\_irq\_fifo\_read(const struct [device](structdevice.md) \*dev,

234 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf,

235 const int len);

236

238void z\_uart\_async\_to\_irq\_irq\_tx\_enable(const struct [device](structdevice.md) \*dev);

239

241void z\_uart\_async\_to\_irq\_irq\_tx\_disable(const struct [device](structdevice.md) \*dev);

242

244int z\_uart\_async\_to\_irq\_irq\_tx\_ready(const struct [device](structdevice.md) \*dev);

245

247void z\_uart\_async\_to\_irq\_irq\_rx\_enable(const struct [device](structdevice.md) \*dev);

248

250void z\_uart\_async\_to\_irq\_irq\_rx\_disable(const struct [device](structdevice.md) \*dev);

251

253int z\_uart\_async\_to\_irq\_irq\_tx\_complete(const struct [device](structdevice.md) \*dev);

254

256int z\_uart\_async\_to\_irq\_irq\_rx\_ready(const struct [device](structdevice.md) \*dev);

257

259void z\_uart\_async\_to\_irq\_irq\_err\_enable(const struct [device](structdevice.md) \*dev);

260

262void z\_uart\_async\_to\_irq\_irq\_err\_disable(const struct [device](structdevice.md) \*dev);

263

265int z\_uart\_async\_to\_irq\_irq\_is\_pending(const struct [device](structdevice.md) \*dev);

266

268int z\_uart\_async\_to\_irq\_irq\_update(const struct [device](structdevice.md) \*dev);

269

271void z\_uart\_async\_to\_irq\_irq\_callback\_set(const struct [device](structdevice.md) \*dev,

272 [uart\_irq\_callback\_user\_data\_t](group__uart__interrupt.md#gad7a26b1a1d6212d7d39c05c8ad4ec926) cb,
...
283#endif /\* ZEPHYR\_DRIVERS\_SERIAL\_UART\_ASYNC\_TO\_IRQ\_H\_ \*/
...
**Definition** log\_instance.h:133
...
[uart\_async\_to\_irq\_init](uart__async__to__irq_8h.md#aae442237aa3432348c256807df3ffa1c)

int uart\_async\_to\_irq\_init(const struct device \*dev)
