---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__user__mutex__apis.html
...
[Kernel APIs](group__kernel__apis.md) » [User Mode APIs](group__usermode__apis.md)
...
`#include <[zephyr/sys/mutex.h](mutex_8h.md)>`
