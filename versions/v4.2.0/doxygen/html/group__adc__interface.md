---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__adc__interface.html
...
| #define | [ADC\_DT\_SPEC\_GET\_BY\_NAME](#ga058dbc619b7bbf624cd48518b429bb58)(node\_id, name) |
|  | Get ADC io-channel information from devicetree by name. |
| #define | [ADC\_DT\_SPEC\_INST\_GET\_BY\_NAME](#ga48139728bd2cec25208ef37d9bbcc34f)(inst, name) |
|  | Get ADC io-channel information from a DT\_DRV\_COMPAT devicetree instance by name. |
...
| int | [adc\_gain\_invert\_64](#ga252581edcc0c516108260169d797c02f) (enum [adc\_gain](#ga306f882323c66b263d3797124ca5f3a0) gain, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) \*value) |
|  | Invert the application of gain to a measurement value. |
...
| static int | [adc\_raw\_to\_microvolts](#ga443772e29554fb289032c3b0b7d2fe8d) ([int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) ref\_mv, enum [adc\_gain](#ga306f882323c66b263d3797124ca5f3a0) gain, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) resolution, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*valp) |
|  | Convert a raw ADC value to microvolts. |
| static int | [adc\_raw\_to\_x\_dt\_chan](#ga21f68d7f81524dc7c83289f74b86d62b) ([adc\_raw\_to\_x\_fn](#ga37d3183c11465aef0890484ffd1f5144) conv\_func, const struct [adc\_dt\_spec](structadc__dt__spec.md) \*spec, const struct [adc\_channel\_cfg](structadc__channel__cfg.md) \*channel\_cfg, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*valp) |
...
| static int | [adc\_raw\_to\_microvolts\_dt](#ga47faafc73cea1828a5bc2af9d857f1b2) (const struct [adc\_dt\_spec](structadc__dt__spec.md) \*spec, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*valp) |
|  | Convert a raw ADC value to microvolts using information stored in a struct [adc\_dt\_spec](structadc__dt__spec.md "Container for ADC channel information specified in devicetree."). |
...
`#include <[zephyr/drivers/adc.h](drivers_2adc_8h.md)>`
...
IF\_ENABLED([UTIL\_OR](group__sys-util.md#ga50cfdf948906976562c3f0625c84c2b2)([DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node\_id, zephyr\_differential), \

[UTIL\_AND](group__sys-util.md#ga26179b776b4a03143e8be1612ef6d853)(CONFIG\_ADC\_CONFIGURABLE\_INPUTS, \

[DT\_NODE\_HAS\_PROP](group__devicetree-generic-exist.md#gacce67bf20541cd2d07d8540058964692)(node\_id, zephyr\_input\_negative))), \
...
[IF\_ENABLED](group__sys-util.md#gae67ffe50e848951dbde309ed569ea925)(CONFIG\_ADC\_CONFIGURABLE\_VBIAS\_PIN, \

(.vbias\_pins = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, zephyr\_vbias\_pins, 0),)) \
...
## [◆ ](#ga058dbc619b7bbf624cd48518b429bb58)ADC\_DT\_SPEC\_GET\_BY\_NAME

| #define ADC\_DT\_SPEC\_GET\_BY\_NAME | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *name* ) |
...
ADC\_DT\_SPEC\_STRUCT([DT\_IO\_CHANNELS\_CTLR\_BY\_NAME](group__devicetree-io-channels.md#ga1d6422230eb139beec9ac0f25ca2eab3)(node\_id, name), \

[DT\_IO\_CHANNELS\_INPUT\_BY\_NAME](group__devicetree-io-channels.md#ga6870a8215f61f87c3cb8f137a7bbbcc3)(node\_id, name))

[DT\_IO\_CHANNELS\_CTLR\_BY\_NAME](group__devicetree-io-channels.md#ga1d6422230eb139beec9ac0f25ca2eab3)
...
[DT\_IO\_CHANNELS\_INPUT\_BY\_NAME](group__devicetree-io-channels.md#ga6870a8215f61f87c3cb8f137a7bbbcc3)
...
This returns a static initializer for an `[adc_dt_spec](structadc__dt__spec.md "Container for ADC channel information specified in devicetree.")` structure given a devicetree node and a channel name. The node must have the "io-channels" property defined.
...
[ADC\_DT\_SPEC\_GET\_BY\_NAME](#ga058dbc619b7bbf624cd48518b429bb58)([DT\_PATH](group__devicetree-generic-id.md#ga015b4819473797982e83cae497697086)(zephyr\_user), a0);

static const struct [adc\_dt\_spec](structadc__dt__spec.md) adc\_chan1 =

[ADC\_DT\_SPEC\_GET\_BY\_NAME](#ga058dbc619b7bbf624cd48518b429bb58)([DT\_PATH](group__devicetree-generic-id.md#ga015b4819473797982e83cae497697086)(zephyr\_user), a1);
...
[ADC\_DT\_SPEC\_GET\_BY\_NAME](#ga058dbc619b7bbf624cd48518b429bb58)

#define ADC\_DT\_SPEC\_GET\_BY\_NAME(node\_id, name)
...
## [◆ ](#ga48139728bd2cec25208ef37d9bbcc34f)ADC\_DT\_SPEC\_INST\_GET\_BY\_NAME

| #define ADC\_DT\_SPEC\_INST\_GET\_BY\_NAME | ( |  | *inst*, |
| --- | --- | --- | --- |
|  |  |  | *name* ) |
...
[ADC\_DT\_SPEC\_GET\_BY\_NAME](#ga058dbc619b7bbf624cd48518b429bb58)([DT\_DRV\_INST](group__devicetree-inst.md#ga219f413efba2f4c0151468b9a25a8dc1)(inst), name)
...
## [◆ ](#ga37d3183c11465aef0890484ffd1f5144)adc\_raw\_to\_x\_fn

| typedef int(\* adc\_raw\_to\_x\_fn) ([int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) ref\_mv, enum [adc\_gain](#ga306f882323c66b263d3797124ca5f3a0) gain, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) resolution, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*valp) |
| --- |
...
This function performs the necessary conversion to transform a raw ADC measurement to a physical voltage.
...
:   | ref\_mv | the reference voltage used for the measurement, in millivolts. This may be from [adc\_ref\_internal()](#gad11845f5621d0b0d03da4b6484d79aa4) or a known external reference. |
    ...
    | valp | pointer to the raw measurement value on input, and the corresponding output value on successful conversion. If conversion fails the stored value is left unchanged. |
...
## [◆ ](#ga252581edcc0c516108260169d797c02f)adc\_gain\_invert\_64()

| int adc\_gain\_invert\_64 | ( | enum [adc\_gain](#ga306f882323c66b263d3797124ca5f3a0) | *gain*, |
| --- | --- | --- | --- |
...
## [◆ ](#ga443772e29554fb289032c3b0b7d2fe8d)adc\_raw\_to\_microvolts()

| | int adc\_raw\_to\_microvolts | ( | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) | *ref\_mv*, | | --- | --- | --- | --- | |  |  | enum [adc\_gain](#ga306f882323c66b263d3797124ca5f3a0) | *gain*, | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *resolution*, | |  |  | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \* | *valp* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
See also
:   [adc\_raw\_to\_x\_fn](#ga37d3183c11465aef0890484ffd1f5144)

## [◆ ](#ga47faafc73cea1828a5bc2af9d857f1b2)adc\_raw\_to\_microvolts\_dt()

| | int adc\_raw\_to\_microvolts\_dt | ( | const struct [adc\_dt\_spec](structadc__dt__spec.md) \* | *spec*, | | --- | --- | --- | --- | |  |  | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \* | *valp* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Returns
:   A value from [adc\_raw\_to\_microvolts()](#ga443772e29554fb289032c3b0b7d2fe8d) or -ENOTSUP if information from Devicetree is not valid.

See also
:   [adc\_raw\_to\_microvolts()](#ga443772e29554fb289032c3b0b7d2fe8d)
...
## [◆ ](#ga21f68d7f81524dc7c83289f74b86d62b)adc\_raw\_to\_x\_dt\_chan()

| | int adc\_raw\_to\_x\_dt\_chan | ( | [adc\_raw\_to\_x\_fn](#ga37d3183c11465aef0890484ffd1f5144) | *conv\_func*, | | --- | --- | --- | --- | |  |  | const struct [adc\_dt\_spec](structadc__dt__spec.md) \* | *spec*, | |  |  | const struct [adc\_channel\_cfg](structadc__channel__cfg.md) \* | *channel\_cfg*, | |  |  | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \* | *valp* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | [in] | conv\_func | Function that converts to the final output unit. |
    | --- | --- | --- |
    | [in] | spec | ADC specification from Devicetree. |
    | [in] | channel\_cfg | Channel configuration used for sampling. This can be either the configuration from *spec*, or an alternate sampling configuration based on *spec*, for example a different gain value. |
    | [in,out] | valp | Pointer to the raw measurement value on input, and the corresponding output value on successful conversion. If conversion fails the stored value is left unchanged. |

Returns
:   A value from [adc\_raw\_to\_x\_fn](#ga37d3183c11465aef0890484ffd1f5144) or -ENOTSUP if information from Devicetree is not valid.
