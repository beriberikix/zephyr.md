---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/nrf-pinctrl_8h.html
...
|  | CAN RX. |
| #define | [NRF\_FUN\_TWIS\_SCL](#a991d00b1a2fafff3f5f1a107d1c92b28)   48U |
|  | TWIS SCL. |
| #define | [NRF\_FUN\_TWIS\_SDA](#ae680ea89fa8da33f4bee9f3d30ea3c66)   49U |
|  | TWIS SDA. |
| #define | [NRF\_FUN\_EXMIF\_RWDS](#ad95c35e659797da017ae8bfd9f436968)   50U |
|  | EXMIF RWDS. |
| #define | [NRF\_FUN\_GRTC\_CLKOUT\_FAST](#a06ece4c8604d693297d063bbc236c084)   55U |
|  | GRTC fast clock output. |
| #define | [NRF\_FUN\_GRTC\_CLKOUT\_32K](#a7c0fb8d0cd3a5557b3ac9ee7c7ebeffa)   56U |
|  | GRTC slow clock output. |
| #define | [NRF\_FUN\_TDM\_SCK\_M](#aa65eb5cf16a9f5963fb7feb0d6dfe4d7)   71U |
|  | TDM SCK in master mode. |
| #define | [NRF\_FUN\_TDM\_SCK\_S](#a1c8af5882b6779bcd652f82a8c18670d)   72U |
|  | TDM SCK in slave mode. |
| #define | [NRF\_FUN\_TDM\_FSYNC\_M](#a821a1d39a3d2272b75089b1aacb26d84)   73U |
|  | TDM LRCK in master mode. |
| #define | [NRF\_FUN\_TDM\_FSYNC\_S](#a37860ffd62afc5eaf6822f6aeb5e1bbd)   74U |
|  | TDM LRCK in slave mode. |
| #define | [NRF\_FUN\_TDM\_SDIN](#adb1ccccd147874be2ce018dcdb5a88d3)   75U |
|  | TDM SDIN. |
| #define | [NRF\_FUN\_TDM\_SDOUT](#af4c5c8cda1519cf93d4fb1e37d145606)   76U |
|  | TDM SDOUT. |
| #define | [NRF\_FUN\_TDM\_MCK](#a849b917fb8c2b9e748a3ec486ecf8bf3)   77U |
|  | TDM MCK. |
...
## [◆ ](#ad95c35e659797da017ae8bfd9f436968)NRF\_FUN\_EXMIF\_RWDS

| #define NRF\_FUN\_EXMIF\_RWDS   50U |
| --- |

EXMIF RWDS.

## [◆ ](#a7c0fb8d0cd3a5557b3ac9ee7c7ebeffa)NRF\_FUN\_GRTC\_CLKOUT\_32K

| #define NRF\_FUN\_GRTC\_CLKOUT\_32K   56U |
| --- |

GRTC slow clock output.

## [◆ ](#a06ece4c8604d693297d063bbc236c084)NRF\_FUN\_GRTC\_CLKOUT\_FAST

| #define NRF\_FUN\_GRTC\_CLKOUT\_FAST   55U |
| --- |
...
## [◆ ](#a821a1d39a3d2272b75089b1aacb26d84)NRF\_FUN\_TDM\_FSYNC\_M

| #define NRF\_FUN\_TDM\_FSYNC\_M   73U |
| --- |

TDM LRCK in master mode.

## [◆ ](#a37860ffd62afc5eaf6822f6aeb5e1bbd)NRF\_FUN\_TDM\_FSYNC\_S

| #define NRF\_FUN\_TDM\_FSYNC\_S   74U |
| --- |

TDM LRCK in slave mode.

## [◆ ](#a849b917fb8c2b9e748a3ec486ecf8bf3)NRF\_FUN\_TDM\_MCK

| #define NRF\_FUN\_TDM\_MCK   77U |
| --- |

TDM MCK.

## [◆ ](#aa65eb5cf16a9f5963fb7feb0d6dfe4d7)NRF\_FUN\_TDM\_SCK\_M

| #define NRF\_FUN\_TDM\_SCK\_M   71U |
| --- |

TDM SCK in master mode.

## [◆ ](#a1c8af5882b6779bcd652f82a8c18670d)NRF\_FUN\_TDM\_SCK\_S

| #define NRF\_FUN\_TDM\_SCK\_S   72U |
| --- |

TDM SCK in slave mode.

## [◆ ](#adb1ccccd147874be2ce018dcdb5a88d3)NRF\_FUN\_TDM\_SDIN

| #define NRF\_FUN\_TDM\_SDIN   75U |
| --- |

TDM SDIN.

## [◆ ](#af4c5c8cda1519cf93d4fb1e37d145606)NRF\_FUN\_TDM\_SDOUT

| #define NRF\_FUN\_TDM\_SDOUT   76U |
| --- |
...
## [◆ ](#a991d00b1a2fafff3f5f1a107d1c92b28)NRF\_FUN\_TWIS\_SCL

| #define NRF\_FUN\_TWIS\_SCL   48U |
| --- |

TWIS SCL.

## [◆ ](#ae680ea89fa8da33f4bee9f3d30ea3c66)NRF\_FUN\_TWIS\_SDA

| #define NRF\_FUN\_TWIS\_SDA   49U |
| --- |
