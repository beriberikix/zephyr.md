---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__iso.html
...
| #define | [BT\_ISO\_DATA\_PATH\_VS\_ID\_MIN](#ga9f26e30d05e571d3fc33dec8ae693e45)   0x01 |
|  | The minimum value for vendor specific data path ID. |
| #define | [BT\_ISO\_DATA\_PATH\_VS\_ID\_MAX](#gae5e1f7c86165b26fc6d93bc922676f9a)   0xFE |
|  | The maximum value for vendor specific data path ID. |
| #define | [BT\_ISO\_CONTROLLER\_DELAY\_MIN](#ga29bf2b36a4ab4e1325f626bbcf52a9a6)   0x000000 |
|  | Minimum controller delay in microseconds (0 s). |
| #define | [BT\_ISO\_CONTROLLER\_DELAY\_MAX](#gae6ba7c8ea447112bcd7798d0351a9a91)   0x3D0900 |
...
| enum | [bt\_iso\_chan\_type](#gafcbd720c67c6a6e5f1cae1395e1e06f0) {     [BT\_ISO\_CHAN\_TYPE\_NONE](#ggafcbd720c67c6a6e5f1cae1395e1e06f0a58579ee03e3769501536826248758f17) , [BT\_ISO\_CHAN\_TYPE\_CENTRAL](#ggafcbd720c67c6a6e5f1cae1395e1e06f0a46a0148a474b297d38d67fb18bdb410a) , [BT\_ISO\_CHAN\_TYPE\_PERIPHERAL](#ggafcbd720c67c6a6e5f1cae1395e1e06f0aa8b51a9ebacbaaac90956d7a9a816edb) , [BT\_ISO\_CHAN\_TYPE\_BROADCASTER](#ggafcbd720c67c6a6e5f1cae1395e1e06f0a63fb0b72a274afd24ff6b0d04d28910b) ,     [BT\_ISO\_CHAN\_TYPE\_SYNC\_RECEIVER](#ggafcbd720c67c6a6e5f1cae1395e1e06f0a725ae4b23a26a8569f5abb6a1e8134c2)   } |
...
| int | [bt\_iso\_setup\_data\_path](#gaa74c762451cfb5d04ffcd8d396a75447) (const struct [bt\_iso\_chan](structbt__iso__chan.md) \*chan, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dir, const struct [bt\_iso\_chan\_path](structbt__iso__chan__path.md) \*path) |
|  | Sets up the ISO data path for a ISO channel. |
| int | [bt\_iso\_remove\_data\_path](#ga53be464e005392676830feeddd8cdc22) (const struct [bt\_iso\_chan](structbt__iso__chan.md) \*chan, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dir) |
...
`#include <[zephyr/bluetooth/iso.h](iso_8h.md)>`
...
## [◆ ](#gae6ba7c8ea447112bcd7798d0351a9a91)BT\_ISO\_CONTROLLER\_DELAY\_MAX

| #define BT\_ISO\_CONTROLLER\_DELAY\_MAX   0x3D0900 |
| --- |
...
## [◆ ](#ga29bf2b36a4ab4e1325f626bbcf52a9a6)BT\_ISO\_CONTROLLER\_DELAY\_MIN

| #define BT\_ISO\_CONTROLLER\_DELAY\_MIN   0x000000 |
| --- |
...
## [◆ ](#gae5e1f7c86165b26fc6d93bc922676f9a)BT\_ISO\_DATA\_PATH\_VS\_ID\_MAX

| #define BT\_ISO\_DATA\_PATH\_VS\_ID\_MAX   0xFE |
| --- |
...
## [◆ ](#ga9f26e30d05e571d3fc33dec8ae693e45)BT\_ISO\_DATA\_PATH\_VS\_ID\_MIN

| #define BT\_ISO\_DATA\_PATH\_VS\_ID\_MIN   0x01 |
| --- |
...
| BT\_ISO\_CHAN\_TYPE\_CENTRAL | Connected as central. |
| BT\_ISO\_CHAN\_TYPE\_PERIPHERAL | Connected as peripheral. |
...
## [◆ ](#ga53be464e005392676830feeddd8cdc22)bt\_iso\_remove\_data\_path()

| int bt\_iso\_remove\_data\_path | ( | const struct [bt\_iso\_chan](structbt__iso__chan.md) \* | *chan*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dir* ) |

`#include <[zephyr/bluetooth/iso.h](iso_8h.md)>`

Removes the ISO data path for a ISO channel.

Removes the ISO data path configured by [bt\_iso\_setup\_data\_path()](#gaa74c762451cfb5d04ffcd8d396a75447) for the provided `dir`.

The data paths of CIS for Peripherals are deleted by the controller, and thus it is not necessary (or possible) to remove data paths of CIS after they have disconnected for a Peripheral, as per Bluetooth Core specification 6.0, Vol 4, Part E, Section 7.7.5. The data paths for CIS for a Central remain valid, even after a disconnection, and thus a Central device should call [bt\_iso\_remove\_data\_path()](#ga53be464e005392676830feeddd8cdc22) on disconnect if it no longer wants to use that CIS. All data paths created by a Central are removed when the CIG is removed with [bt\_iso\_cig\_terminate()](#gad4b6a7286593ff099117113b6ca996f8).
...
All data paths associated with an ISO Broadcaster BIG are removed when the BIG is terminated by [bt\_iso\_big\_terminate()](#gab9c06a86bf5cc023f5f9bd16c5d3265b), and thus it is not necessary (or possible) to remove data paths of ISO channels associated with a BIG for a Broadcaster, as per Bluetooth Core specification 6.0, Vol 4, Part E, Section 7.8.105

Parameters
:   | chan | The channel to setup the ISO data path for |
    | --- | --- |
    | dir | The direction to setup, either [BT\_HCI\_DATAPATH\_DIR\_CTLR\_TO\_HOST](hci__types_8h.md#af8d89c712a3d27f9b6f92a31bea2a8c3 "BT_HCI_DATAPATH_DIR_CTLR_TO_HOST") or [BT\_HCI\_DATAPATH\_DIR\_HOST\_TO\_CTLR](hci__types_8h.md#a0f74c19fabbcb3088e1a819d33a05a1c "BT_HCI_DATAPATH_DIR_HOST_TO_CTLR"). For ISO broadcast channels this can only be [BT\_HCI\_DATAPATH\_DIR\_HOST\_TO\_CTLR](hci__types_8h.md#a0f74c19fabbcb3088e1a819d33a05a1c "BT_HCI_DATAPATH_DIR_HOST_TO_CTLR"), and for ISO sync receiver channels this can only be [BT\_HCI\_DATAPATH\_DIR\_CTLR\_TO\_HOST](hci__types_8h.md#af8d89c712a3d27f9b6f92a31bea2a8c3 "BT_HCI_DATAPATH_DIR_CTLR_TO_HOST"). |

Return values
:   | 0 | Success |
    | --- | --- |
    | -EINVAL | Invalid parameters |
    | -ENOBUFS | No HCI command buffer could be allocated |
    | -EIO | The controller rejected the request or response contains invalid data |
    | -ENODEV | `chan` is not associated with a CIS or BIS handle |
    | -EACCES | The controller rejected the request as disallowed |
    | -ENOEXEC | Unexpected error occurred |
...
## [◆ ](#gaa74c762451cfb5d04ffcd8d396a75447)bt\_iso\_setup\_data\_path()

| int bt\_iso\_setup\_data\_path | ( | const struct [bt\_iso\_chan](structbt__iso__chan.md) \* | *chan*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dir*, |
|  |  | const struct [bt\_iso\_chan\_path](structbt__iso__chan__path.md) \* | *path* ) |

`#include <[zephyr/bluetooth/iso.h](iso_8h.md)>`

Sets up the ISO data path for a ISO channel.

The channel must be associated with a BIS or CIS handle first which it is when the [bt\_iso\_chan\_ops.connected()](structbt__iso__chan__ops.md#a6b0e51770158da7b728e1084a8e44504 "Channel connected callback.") callback is called.
