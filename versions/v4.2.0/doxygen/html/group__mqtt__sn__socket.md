---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mqtt__sn__socket.html
...
| int | [mqtt\_sn\_add\_gw](#gadd38840ebc78217a692748afb704b42b) (struct [mqtt\_sn\_client](structmqtt__sn__client.md) \*client, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) gw\_id, struct [mqtt\_sn\_data](structmqtt__sn__data.md) gw\_addr) |
|  | Manually add a Gateway, bypasing the normal search process. |
| int | [mqtt\_sn\_search](#gafdf80b1de5d1b069b2f75b2bd688416f) (struct [mqtt\_sn\_client](structmqtt__sn__client.md) \*client, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) radius) |
...
`#include <[zephyr/net/mqtt_sn.h](mqtt__sn_8h.md)>`
...
| MQTT\_SN\_EVT\_ADVERTISE | Received a ADVERTISE. |
| MQTT\_SN\_EVT\_GWINFO | Received a GWINFO. |
| MQTT\_SN\_EVT\_SEARCHGW | Received a SEARCHGW. |
...
## [◆ ](#gadd38840ebc78217a692748afb704b42b)mqtt\_sn\_add\_gw()

| int mqtt\_sn\_add\_gw | ( | struct [mqtt\_sn\_client](structmqtt__sn__client.md) \* | *client*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *gw\_id*, |
|  |  | struct [mqtt\_sn\_data](structmqtt__sn__data.md) | *gw\_addr* ) |
...
:   | client | The MQTT-SN client to connect. |
    | --- | --- |
    | gw\_id | Single byte Gateway Identifier |
    | gw\_addr | Address data structure to be used by the transport layer. |
...
## [◆ ](#gafdf80b1de5d1b069b2f75b2bd688416f)mqtt\_sn\_search()

| int mqtt\_sn\_search | ( | struct [mqtt\_sn\_client](structmqtt__sn__client.md) \* | *client*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *radius* ) |
...
:   | client | The MQTT-SN client to connect. |
    | --- | --- |
    | radius | Broadcast radius for the search message. |
