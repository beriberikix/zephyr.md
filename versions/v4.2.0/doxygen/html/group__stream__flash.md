---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__stream__flash.html
...
`#include <[zephyr/storage/stream_flash.h](stream__flash_8h.md)>`
...
:   | ctx | context to be initialized |
    ...
    | size | Number of bytes available for performing buffered write. |
    | cb | Callback to be invoked on completed flash write operations. Callback is supported when CONFIG\_STREAM\_FLASH\_POST\_WRITE\_CALLBACK is enabled. |
