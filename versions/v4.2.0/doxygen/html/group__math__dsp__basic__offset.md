---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__math__dsp__basic__offset.html
...
[Utilities](group__utilities.md) » [DSP (Digital Signal Processing)](group__math__dsp.md) » [Basic Math Functions](group__math__dsp__basic.md)
...
`#include <[zephyr/dsp/basicmath_f16.h](basicmath__f16_8h.md)>`
...
`#include <[zephyr/dsp/basicmath.h](basicmath_8h.md)>`
