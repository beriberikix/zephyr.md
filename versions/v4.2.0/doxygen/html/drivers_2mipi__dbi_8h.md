---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/drivers_2mipi__dbi_8h.html
...
| #define | [MIPI\_DBI\_TE\_MODE\_DT](group__mipi__dbi__interface.md#ga0e60d22a8172d1a0b017707eccdc6c7e)(node\_id, edge\_prop) |
|  | Get the MIPI DBI TE mode from devicetree. |
| #define | [MIPI\_DBI\_TE\_MODE\_DT\_INST](group__mipi__dbi__interface.md#gaec5f771a41fa75072b9e79ce125876a7)(inst, edge\_prop) |
...
| static int | [mipi\_dbi\_reset](group__mipi__dbi__interface.md#ga1c1a117ae5db5f7508f302d48dc72013) (const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) delay\_ms) |
...
| static int | [mipi\_dbi\_configure\_te](group__mipi__dbi__interface.md#gab74f96d99f9702f29b51cc2fe0b48d95) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) edge, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) delay\_us) |
...
3. 8 write clocks per byte. Command/data selected via GPIO pin The current driver interface does not support type C with 16 write clocks (option 2).
