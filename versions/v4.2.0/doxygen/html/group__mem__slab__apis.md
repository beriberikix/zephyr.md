---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mem__slab__apis.html
...
| Macros | |
| --- | --- |
| #define | [K\_MEM\_SLAB\_DEFINE\_IN\_SECT](#ga6b6751464262505c1117dea1bea56a08)(name, in\_section, slab\_block\_size, slab\_num\_blocks, slab\_align) |
...
| #define | [K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC](#ga7f0750f940b9a9f94b5c52373d4161f1)(name, in\_section, slab\_block\_size, slab\_num\_blocks, slab\_align) |
...
[K\_MEM\_SLAB\_DEFINE\_IN\_SECT](#ga6b6751464262505c1117dea1bea56a08)(name, \_\_noinit\_named(k\_mem\_slab\_buf\_##name), slab\_block\_size, \

slab\_num\_blocks, slab\_align)

[K\_MEM\_SLAB\_DEFINE\_IN\_SECT](#ga6b6751464262505c1117dea1bea56a08)

#define K\_MEM\_SLAB\_DEFINE\_IN\_SECT(name, in\_section, slab\_block\_size, slab\_num\_blocks, slab\_align)

Statically define and initialize a memory slab in a user-provided memory section with public (non-sta...

**Definition** kernel.h:5484
...
## [◆ ](#ga6b6751464262505c1117dea1bea56a08)K\_MEM\_SLAB\_DEFINE\_IN\_SECT

| #define K\_MEM\_SLAB\_DEFINE\_IN\_SECT | ( |  | *name*, |
| --- | --- | --- | --- |
|  |  |  | *in\_section*, |
|  |  |  | *slab\_block\_size*, |
|  |  |  | *slab\_num\_blocks*, |
...
BUILD\_ASSERT(((slab\_block\_size) % (slab\_align)) == 0, \

"slab\_block\_size must be a multiple of slab\_align"); \

BUILD\_ASSERT((((slab\_align) & ((slab\_align) - 1)) == 0), \

"slab\_align must be a power of 2"); \

char in\_section \_\_aligned([WB\_UP](group__sys-util.md#ga8b16b3a76faa15ea544e4b0edb3e62c7)( \

slab\_align)) \_k\_mem\_slab\_buf\_##name[(slab\_num\_blocks) \* [WB\_UP](group__sys-util.md#ga8b16b3a76faa15ea544e4b0edb3e62c7)(slab\_block\_size)]; \

STRUCT\_SECTION\_ITERABLE(k\_mem\_slab, name) = Z\_MEM\_SLAB\_INITIALIZER( \

name, \_k\_mem\_slab\_buf\_##name, [WB\_UP](group__sys-util.md#ga8b16b3a76faa15ea544e4b0edb3e62c7)(slab\_block\_size), slab\_num\_blocks)
...
Note
:   This macro cannot be used together with a static keyword. If such a use-case is desired, use [K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC](#ga7f0750f940b9a9f94b5c52373d4161f1) instead.

Parameters
:   | name | Name of the memory slab. |
    | --- | --- |
    | in\_section | Section attribute specifier such as Z\_GENERIC\_SECTION. |
    | slab\_block\_size | Size of each memory block (in bytes). |
    | slab\_num\_blocks | Number memory blocks. |
    | slab\_align | Alignment of the memory slab's buffer (power of 2). |

## [◆ ](#ga7f0750f940b9a9f94b5c52373d4161f1)K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC

| #define K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC | ( |  | *name*, |
| --- | --- | --- | --- |
|  |  |  | *in\_section*, |
|  |  |  | *slab\_block\_size*, |
|  |  |  | *slab\_num\_blocks*, |
...
static char in\_section \_\_aligned([WB\_UP](group__sys-util.md#ga8b16b3a76faa15ea544e4b0edb3e62c7)( \

slab\_align)) \_k\_mem\_slab\_buf\_##name[(slab\_num\_blocks) \* [WB\_UP](group__sys-util.md#ga8b16b3a76faa15ea544e4b0edb3e62c7)(slab\_block\_size)]; \

static [STRUCT\_SECTION\_ITERABLE](group__iterable__section__apis.md#ga9104f42cbe4a67a931bed7f7cc8f600f)(k\_mem\_slab, name) = Z\_MEM\_SLAB\_INITIALIZER( \
...
[K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC](#ga7f0750f940b9a9f94b5c52373d4161f1)(name, \_\_noinit\_named(k\_mem\_slab\_buf\_##name), \

slab\_block\_size, slab\_num\_blocks, slab\_align)

[K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC](#ga7f0750f940b9a9f94b5c52373d4161f1)

#define K\_MEM\_SLAB\_DEFINE\_IN\_SECT\_STATIC(name, in\_section, slab\_block\_size, slab\_num\_blocks, slab\_align)

Statically define and initialize a memory slab in a user-provided memory section with private (static...

**Definition** kernel.h:5537
...
| | int k\_mem\_slab\_alloc | ( | struct k\_mem\_slab \* | *slab*, | | --- | --- | --- | --- | |  |  | void \*\* | *mem*, | |  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
