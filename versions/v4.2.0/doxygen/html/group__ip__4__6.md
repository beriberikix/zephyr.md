---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__ip__4__6.html
...
| #define | [SOCKADDR\_ALIGN](#ga929a6597b2a4669e42cb416a84fd568f)   (4) |
| #define | [IN6ADDR\_ANY\_INIT](#ga1de876a356ee05a2e9427b741f99f49c) |
|  | IPv6 address initializer. |
| #define | [IN6ADDR\_LOOPBACK\_INIT](#ga5562c81af19ee5988ddc5a5c6153cf37) |
|  | IPv6 loopback address initializer. |
| #define | [INADDR\_ANY](#ga5d1940045dc2e7de552f3d4ff13a74ab)   0 |
|  | IPv4 any address. |
| #define | [INADDR\_BROADCAST](#ga4a725f61ded23ce8a7dff8e82ed51986)   0xffffffff |
|  | IPv4 broadcast address. |
| #define | [INADDR\_ANY\_INIT](#ga915fcf49ce8c1e235e64fc83b57ec5b1)   { { { [INADDR\_ANY](#ga5d1940045dc2e7de552f3d4ff13a74ab) } } } |
|  | IPv4 address initializer. |
| #define | [INADDR\_LOOPBACK\_INIT](#ga554163cb2fa86ef4307dd1fff2aad2eb)   { { { 127, 0, 0, 1 } } } |
|  | IPv6 loopback address initializer. |
...
| #define | [NET\_MAX\_PRIORITIES](#ga5b32bdfc249437709bb25bd95ec7d6d7)   8 |
...
|  | IP Maximum Transfer Unit. [More...](#ga7a207761e4879c140f48f93978cb2f0b) |
...
| static void | [net\_ipv6\_addr\_prefix\_mask](#ga4e91a4298604a916731bf591acc7b326) (const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*inaddr, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*outaddr, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) prefix\_len) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [net\_ipv4\_is\_private\_addr](#ga6f19cb74de130d70668599c05a5ed66b) (const struct [in\_addr](structin__addr.md) \*addr) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [net\_ipv6\_is\_private\_addr](#gad35da6e137d62231052dda63c68b7eff) (const struct [in6\_addr](structin6__addr.md) \*addr) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [net\_ipv6\_is\_addr\_mcast\_group](#ga611a4adb332715d983375899dcf101d0) (const struct [in6\_addr](structin6__addr.md) \*addr, const struct [in6\_addr](structin6__addr.md) \*[group](structgroup.md)) |
...
| int | [net\_ipv6\_addr\_generate\_iid](#ga876301e06196f2e543bf2ef8d41449be) (struct [net\_if](structnet__if.md) \*iface, const struct [in6\_addr](structin6__addr.md) \*prefix, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*network\_id, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) network\_id\_len, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dad\_counter, struct [in6\_addr](structin6__addr.md) \*addr, struct [net\_linkaddr](structnet__linkaddr.md) \*lladdr) |
...
| static struct [sockaddr](structsockaddr.md) \* | [net\_sad](#gaeb003b18ca8a377e842248c4938db266) (const struct sockaddr\_storage \*addr) |
...
| static struct sockaddr\_in6\_ptr \* | [net\_sin6\_ptr](#gae86d2cd402142190e1ea1c120a57939f) (const struct sockaddr\_ptr \*addr) |
|  | Get sockaddr\_in6\_ptr from sockaddr\_ptr. |
| static struct sockaddr\_in\_ptr \* | [net\_sin\_ptr](#ga4b948e84590081a8aed2a63496e57ae2) (const struct sockaddr\_ptr \*addr) |
|  | Get sockaddr\_in\_ptr from sockaddr\_ptr. |
| static struct sockaddr\_ll\_ptr \* | [net\_sll\_ptr](#gad5cf206e18769a15f9fc917e416db6ee) (const struct sockaddr\_ptr \*addr) |
|  | Get sockaddr\_ll\_ptr from sockaddr\_ptr. |
| static struct sockaddr\_can\_ptr \* | [net\_can\_ptr](#gac2fb590a35961c04807dd985f462c5fb) (const struct sockaddr\_ptr \*addr) |
...
| int | [net\_mask\_len\_to\_netmask](#gac2b9014f655ff4784f93fe5cd79ddc79) ([sa\_family\_t](#ga2d9e094abb99ebd0874373edf1c45eda) family, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) mask\_len, struct [sockaddr](structsockaddr.md) \*mask) |
|  | Create netmask from mask length. |
| int | [net\_netmask\_to\_mask\_len](#ga112a97c0d54e281ea95747b07d93e646) ([sa\_family\_t](#ga2d9e094abb99ebd0874373edf1c45eda) family, struct [sockaddr](structsockaddr.md) \*mask, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*mask\_len) |
...
| const char \* | [net\_ipaddr\_parse\_mask](#ga77208ab2861d88a99837a86992a29286) (const char \*str, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) str\_len, struct [sockaddr](structsockaddr.md) \*addr, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*mask\_len) |
...
| int | [net\_port\_set\_default](#gaa2354e12d310c0647a98c873c7b7e5ad) (struct [sockaddr](structsockaddr.md) \*addr, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) default\_port) |
...
| static int | [net\_ipv6\_pe\_add\_filter](#ga14f9607f6c18869e7755ab497ff62147) (struct [in6\_addr](structin6__addr.md) \*addr, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) is\_denylist) |
|  | Add IPv6 prefix as a privacy extension filter. |
| static int | [net\_ipv6\_pe\_del\_filter](#ga76e7787a18dbf0b3575d46f81603f65a) (struct [in6\_addr](structin6__addr.md) \*addr) |
...
`#include <[zephyr/net/net_ip.h](net__ip_8h.md)>`
...
(([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)(cmsg) + ALIGN\_D(sizeof(struct [cmsghdr](structcmsghdr.md))))
...
(struct [cmsghdr](structcmsghdr.md) \*)(([msghdr](structmsghdr.md))->msg\_control) : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
(ALIGN\_D(sizeof(struct [cmsghdr](structcmsghdr.md))) + length)
...
(((cmsg) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) ? [CMSG\_FIRSTHDR](#ga39567a31d167fc53336d2ab4a2cd78a4)([msghdr](structmsghdr.md)) : \

((([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)(cmsg) + ALIGN\_H((cmsg)->cmsg\_len) + \

ALIGN\_D([sizeof](retained__mem_8h.md#a8c945f5e523f7f88fe4d09bfe304240e)(struct [cmsghdr](structcmsghdr.md))) > \
...
(ALIGN\_D(sizeof(struct [cmsghdr](structcmsghdr.md))) + ALIGN\_H(length))
...
## [◆ ](#ga1de876a356ee05a2e9427b741f99f49c)IN6ADDR\_ANY\_INIT
...
## [◆ ](#ga5562c81af19ee5988ddc5a5c6153cf37)IN6ADDR\_LOOPBACK\_INIT
...
## [◆ ](#ga5d1940045dc2e7de552f3d4ff13a74ab)INADDR\_ANY

| #define INADDR\_ANY   0 |
| --- |
...
## [◆ ](#ga915fcf49ce8c1e235e64fc83b57ec5b1)INADDR\_ANY\_INIT

| #define INADDR\_ANY\_INIT   { { { [INADDR\_ANY](#ga5d1940045dc2e7de552f3d4ff13a74ab) } } } |
| --- |
...
## [◆ ](#ga4a725f61ded23ce8a7dff8e82ed51986)INADDR\_BROADCAST
...
## [◆ ](#ga554163cb2fa86ef4307dd1fff2aad2eb)INADDR\_LOOPBACK\_INIT

| #define INADDR\_LOOPBACK\_INIT   { { { 127, 0, 0, 1 } } } |
| --- |
...
## [◆ ](#ga929a6597b2a4669e42cb416a84fd568f)SOCKADDR\_ALIGN

| #define SOCKADDR\_ALIGN   (4) |
| --- |
...
| Enumerator | |
| --- | --- |
| IPPROTO\_IP | IP protocol (pseudo-val for [setsockopt()](posix_2sys_2socket_8h.md#a71c8788caef89a362e35ce5855e77077). |
| IPPROTO\_ICMP | ICMP protocol. |
| IPPROTO\_IGMP | IGMP protocol. |
| IPPROTO\_ETH\_P\_ALL | Every packet.  from linux if\_ether.h |
...
| IPPROTO\_TLS\_1\_3 | TLS 1.3 protocol. |
...
| | struct sockaddr\_can\_ptr \* net\_can\_ptr | ( | const struct sockaddr\_ptr \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga77208ab2861d88a99837a86992a29286)net\_ipaddr\_parse\_mask()

| const char \* net\_ipaddr\_parse\_mask | ( | const char \* | *str*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *str\_len*, |
|  |  | struct [sockaddr](structsockaddr.md) \* | *addr*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *mask\_len* ) |

`#include <[zephyr/net/net_ip.h](net__ip_8h.md)>`

Parse a string that contains either IPv4 or IPv6 address and optional mask len, and store the information in user supplied sockaddr struct.

There can be multiple IP addresses separated by comma or space. The function returns the pointer to the next IP address in the string.

Syntax of the IP address string: 192.0.2.1/24 192.0.2.42 2001:db8::1/64 2001:db8::2 2001:db::42/128 2001:db8::1/64,192.0.2.1,2001:db8::2,192.0.2.2/24 2001:db8::1/64 192.0.2.1 2001:db8::2 192.0.2.2/24 Note that the str\_len parameter is used to restrict the amount of characters that are checked.
...
:   | str | String that contains the IP address. |
    ...
    | str\_len | Length of the string to be parsed. |
    | addr | Pointer to user supplied struct sockaddr. |
    | mask\_len | Pointer to mask\_len which is returned to the caller. |

Returns
:   NULL if there was an error while parsing. "" if we could parse the IP address and there is nothing more to parse. All other values point to next character after the "," or " " in the string.
...
## [◆ ](#ga6f19cb74de130d70668599c05a5ed66b)net\_ipv4\_is\_private\_addr()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) net\_ipv4\_is\_private\_addr | ( | const struct [in\_addr](structin__addr.md) \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
See [https://en.wikipedia.org/wiki/Reserved\_IP\_addresses](https://en.wikipedia.org/wiki/Reserved_IP_addresses) for details.
...
## [◆ ](#ga876301e06196f2e543bf2ef8d41449be)net\_ipv6\_addr\_generate\_iid()

| int net\_ipv6\_addr\_generate\_iid | ( | struct [net\_if](structnet__if.md) \* | *iface*, |
| --- | --- | --- | --- |
|  |  | const struct [in6\_addr](structin6__addr.md) \* | *prefix*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *network\_id*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *network\_id\_len*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dad\_counter*, |
...
Interface identifier is either generated from EUI-64 (MAC) defined in RFC 4291 or from randomized value defined in RFC 7217.

Parameters
:   | iface | Network interface |
    | --- | --- |
    | prefix | IPv6 prefix, can be left out in which case fe80::/64 is used |
    | network\_id | Network identifier (for example SSID in WLAN), this is optional can be set to NULL |
    | network\_id\_len | Network identifier length, if set to 0 then the network id is ignored. |
    | dad\_counter | Duplicate Address Detection counter value, can be set to 0 if it is not known. |
    | addr | IPv6 address |
    | lladdr | Link local address |
...
## [◆ ](#ga4e91a4298604a916731bf591acc7b326)net\_ipv6\_addr\_prefix\_mask()

| | void net\_ipv6\_addr\_prefix\_mask | ( | const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *inaddr*, | | --- | --- | --- | --- | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *outaddr*, | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *prefix\_len* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | inaddr | Unicast IPv6 address. |
    ...
    | prefix\_len | Prefix length (max length is 128). |
...
:   | addr | IPv6 address. |
    | --- | --- |
    | [group](structgroup.md "Group structure.") | Group id IPv6 address, the values must be in network byte order |
...
## [◆ ](#gad35da6e137d62231052dda63c68b7eff)net\_ipv6\_is\_private\_addr()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) net\_ipv6\_is\_private\_addr | ( | const struct [in6\_addr](structin6__addr.md) \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga14f9607f6c18869e7755ab497ff62147)net\_ipv6\_pe\_add\_filter()

| | int net\_ipv6\_pe\_add\_filter | ( | struct [in6\_addr](structin6__addr.md) \* | *addr*, | | --- | --- | --- | --- | |  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *is\_denylist* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | addr | IPv6 prefix |
    | --- | --- |
    | is\_denylist | Tells if this filter is for allowing or denying listing. |

Returns
:   0 if ok, <0 if error

## [◆ ](#ga76e7787a18dbf0b3575d46f81603f65a)net\_ipv6\_pe\_del\_filter()

| | int net\_ipv6\_pe\_del\_filter | ( | struct [in6\_addr](structin6__addr.md) \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gac2b9014f655ff4784f93fe5cd79ddc79)net\_mask\_len\_to\_netmask()

| int net\_mask\_len\_to\_netmask | ( | [sa\_family\_t](#ga2d9e094abb99ebd0874373edf1c45eda) | *family*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *mask\_len*, |
|  |  | struct [sockaddr](structsockaddr.md) \* | *mask* ) |
...
:   | family | IP address family (AF\_INET or AF\_INET6) |
    | --- | --- |
    | mask\_len | Netmask length (in IPv4) or prefix length (in IPv6) |
    | mask | Pointer to struct [sockaddr\_in](structsockaddr__in.md "Socket address struct for IPv4.") if family is AF\_INET or pointer to struct [sockaddr\_in6](structsockaddr__in6.md "Socket address struct for IPv6.") if family is AF\_INET6 |

Returns
:   0 if ok, < 0 if error

## [◆ ](#ga112a97c0d54e281ea95747b07d93e646)net\_netmask\_to\_mask\_len()

| int net\_netmask\_to\_mask\_len | ( | [sa\_family\_t](#ga2d9e094abb99ebd0874373edf1c45eda) | *family*, |
| --- | --- | --- | --- |
|  |  | struct [sockaddr](structsockaddr.md) \* | *mask*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *mask\_len* ) |
...
## [◆ ](#gaa2354e12d310c0647a98c873c7b7e5ad)net\_port\_set\_default()

| int net\_port\_set\_default | ( | struct [sockaddr](structsockaddr.md) \* | *addr*, |
| --- | --- | --- | --- |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *default\_port* ) |
...
:   | addr | Pointer to user supplied struct sockaddr. |
    | --- | --- |
    | default\_port | Default port number to set. |
...
## [◆ ](#gaeb003b18ca8a377e842248c4938db266)net\_sad()

| | struct [sockaddr](structsockaddr.md) \* net\_sad | ( | const struct sockaddr\_storage \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | addr | Socket storage address |
    | --- | --- |

Returns
:   Pointer to socket address (struct sockaddr)
...
| | struct sockaddr\_in6\_ptr \* net\_sin6\_ptr | ( | const struct sockaddr\_ptr \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | struct sockaddr\_in\_ptr \* net\_sin\_ptr | ( | const struct sockaddr\_ptr \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | struct sockaddr\_ll\_ptr \* net\_sll\_ptr | ( | const struct sockaddr\_ptr \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
