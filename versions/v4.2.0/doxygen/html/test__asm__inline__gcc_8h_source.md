---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/test__asm__inline__gcc_8h_source.html
...
43#elif defined(CONFIG\_RISCV)

44#define timestamp\_serialize()

45#elif defined(CONFIG\_SPARC)

46#define timestamp\_serialize()

47#elif defined(CONFIG\_MIPS)

48#define timestamp\_serialize()

49#elif defined(CONFIG\_RX)
