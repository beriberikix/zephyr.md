---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/gic_8h.html
...
| #define | [GICD\_IGROUPRnE](#a708bbd9e06c140f7af1fa82da8895862)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1000) |
| #define | [GICD\_ISENABLERn](#a310ab6442912860cc32c4728323aa77d)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x100) |
| #define | [GICD\_ISENABLERnE](#ac025a607c04580cacf0c8acbdd11adbf)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1200) |
| #define | [GICD\_ICENABLERn](#a5c3d3ec71773c06de84fae6e9a4e0a09)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x180) |
| #define | [GICD\_ICENABLERnE](#ac727aed76e6b88a9ae7f5fcc8eeadc6b)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1400) |
| #define | [GICD\_ISPENDRn](#a6f6edc1558ef636d46f09b68b7abe025)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x200) |
| #define | [GICD\_ISPENDRnE](#abaa3fdc6750ad8a11b6ae13ad23d4455)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1600) |
| #define | [GICD\_ICPENDRn](#aeb43e488b1b2f321aa04973b92f55fde)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x280) |
| #define | [GICD\_ICPENDRnE](#a9d07d68d06a19deab790f8e9d908b1ed)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1800) |
| #define | [GICD\_ISACTIVERn](#a166410e3d61c7b967df532db8b541bf6)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x300) |
| #define | [GICD\_ISACTIVERnE](#a5128486fe91db8fd38cf5d5c07dcf2b1)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1A00) |
| #define | [GICD\_IPRIORITYRn](#ac55442a1b5748b8fcc46a9630ecf1645)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x400) |
| #define | [GICD\_IPRIORITYRnE](#ab0596892abd30aeb2cb0f3bcb70b388a)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x2000) |
...
| #define | [GICD\_ICFGRnE](#a255b5836278cef9e538b11118a854944)   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x3000) |
...
| #define | [GICD\_TYPER\_ESPI\_MASK](#a2b22db96d30050d2d33e7a116d778bbd)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(8) |
...
| void | [arm\_gic\_irq\_set\_pending](#aa9e67bf28cee4b9382ebdc641874d2f8) ([unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int irq) |
...
(((intid) >= [GIC\_SGI\_INT\_BASE](#a87acbf5e0124561ba231e95cca1bbc7a)) && ((intid) < [GIC\_PPI\_INT\_BASE](#a63bca268593477e8c0b6bc58aa3ee85c)))

[GIC\_PPI\_INT\_BASE](#a63bca268593477e8c0b6bc58aa3ee85c)

#define GIC\_PPI\_INT\_BASE

**Definition** gic.h:280

[GIC\_SGI\_INT\_BASE](#a87acbf5e0124561ba231e95cca1bbc7a)

#define GIC\_SGI\_INT\_BASE

**Definition** gic.h:279
...
(((intid) >= [GIC\_SPI\_INT\_BASE](#ad9e9ba1264c9e57922cc0b8ad2e4dfba)) && ((intid) <= [GIC\_SPI\_MAX\_INTID](#a1deeb13c2ac681cb120c06b18dee2b91)))

[GIC\_SPI\_MAX\_INTID](#a1deeb13c2ac681cb120c06b18dee2b91)

#define GIC\_SPI\_MAX\_INTID

**Definition** gic.h:286

[GIC\_SPI\_INT\_BASE](#ad9e9ba1264c9e57922cc0b8ad2e4dfba)

#define GIC\_SPI\_INT\_BASE

**Definition** gic.h:284
...
## [◆ ](#ac727aed76e6b88a9ae7f5fcc8eeadc6b)GICD\_ICENABLERnE

| #define GICD\_ICENABLERnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1400) |
| --- |
...
## [◆ ](#a255b5836278cef9e538b11118a854944)GICD\_ICFGRnE

| #define GICD\_ICFGRnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x3000) |
| --- |
...
## [◆ ](#a9d07d68d06a19deab790f8e9d908b1ed)GICD\_ICPENDRnE

| #define GICD\_ICPENDRnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1800) |
| --- |
...
## [◆ ](#a708bbd9e06c140f7af1fa82da8895862)GICD\_IGROUPRnE

| #define GICD\_IGROUPRnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1000) |
| --- |
...
## [◆ ](#ab0596892abd30aeb2cb0f3bcb70b388a)GICD\_IPRIORITYRnE

| #define GICD\_IPRIORITYRnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x2000) |
| --- |
...
## [◆ ](#a5128486fe91db8fd38cf5d5c07dcf2b1)GICD\_ISACTIVERnE

| #define GICD\_ISACTIVERnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1A00) |
| --- |
...
## [◆ ](#ac025a607c04580cacf0c8acbdd11adbf)GICD\_ISENABLERnE

| #define GICD\_ISENABLERnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1200) |
| --- |
...
## [◆ ](#abaa3fdc6750ad8a11b6ae13ad23d4455)GICD\_ISPENDRnE

| #define GICD\_ISPENDRnE   ([GIC\_DIST\_BASE](#adb371115c787d786755ca23eedc6a651) + 0x1600) |
| --- |
...
## [◆ ](#a2b22db96d30050d2d33e7a116d778bbd)GICD\_TYPER\_ESPI\_MASK

| #define GICD\_TYPER\_ESPI\_MASK   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(8) |
| --- |
...
## [◆ ](#aa9e67bf28cee4b9382ebdc641874d2f8)arm\_gic\_irq\_set\_pending()

| void arm\_gic\_irq\_set\_pending | ( | [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int | *irq* | ) |  |
| --- | --- | --- | --- | --- | --- |
