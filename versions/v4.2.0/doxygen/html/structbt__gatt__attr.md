---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__gatt__attr.html
...
You can define a new Attribute Type for your application specific use by generating a new UUID for it.
