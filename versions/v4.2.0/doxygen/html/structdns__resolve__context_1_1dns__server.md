---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structdns__resolve__context_1_1dns__server.html
...
| int | [if\_index](#a6b544dc78ee42cd51d2a9404bf69ca06) |
|  | Network interface index if the DNS resolving should be done via this interface. |
| enum [dns\_server\_source](group__dns__resolve.md#gaeda02f82b12e9b7b4dea9fd66be123a7) | [source](#a5d6003855511e8754372a9189c3bfbec) |
...
## [◆ ](#a6b544dc78ee42cd51d2a9404bf69ca06)if\_index

| int dns\_resolve\_context::dns\_server::if\_index |
| --- |
...
## [◆ ](#a5d6003855511e8754372a9189c3bfbec)source

| enum [dns\_server\_source](group__dns__resolve.md#gaeda02f82b12e9b7b4dea9fd66be123a7) dns\_resolve\_context::dns\_server::source |
| --- |
