---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/avrcp_8h.html
...
| struct | [bt\_avrcp\_get\_cap\_rsp](structbt__avrcp__get__cap__rsp.md) |
| struct | [bt\_avrcp\_cb](structbt__avrcp__cb.md) |

| Macros | |
| --- | --- |
| #define | [BT\_AVRCP\_COMPANY\_ID\_SIZE](#ae4e7573280179717124104858629122a)   (3) |
| #define | [BT\_AVRCP\_COMPANY\_ID\_BLUETOOTH\_SIG](#ae7a97b11a8954a2a25cc401ced566fd2)   (0x001958) |
| #define | [BT\_AVRCP\_PASSTHROUGH\_GET\_STATE](#a7eee1ffa11a5152a0dd014ac15979605)(payload) |
| #define | [BT\_AVRCP\_PASSTHROUGH\_GET\_OPID](#a8c8e1596f92e32781690c0a76196c4c8)(payload) |

| Enumerations | |
| --- | --- |
| enum | [bt\_avrcp\_cap\_t](#ac311dc7b5f99162b954271529eeb84ea) { [BT\_AVRCP\_CAP\_COMPANY\_ID](#ac311dc7b5f99162b954271529eeb84eaa89fecce56afb09791a2253a7ad840430) = 0x2 , [BT\_AVRCP\_CAP\_EVENTS\_SUPPORTED](#ac311dc7b5f99162b954271529eeb84eaa2a7b326aded772c09cf01387145d2802) = 0x3 } |
|  | AVRCP Capability ID. [More...](#ac311dc7b5f99162b954271529eeb84ea) |
| enum | [bt\_avrcp\_evt\_t](#af55aae17f67a1361279ae208b17e4a75) {     [BT\_AVRCP\_EVT\_PLAYBACK\_STATUS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75a892f2928d634b675426f2fe597a45f6d) = 0x01 , [BT\_AVRCP\_EVT\_TRACK\_CHANGED](#af55aae17f67a1361279ae208b17e4a75a25f8e3e08b5988e833eb0d47452d12a9) = 0x02 , [BT\_AVRCP\_EVT\_TRACK\_REACHED\_END](#af55aae17f67a1361279ae208b17e4a75a412a9b7cbb891bc50fb77c1e6de9faaf) = 0x03 , [BT\_AVRCP\_EVT\_TRACK\_REACHED\_START](#af55aae17f67a1361279ae208b17e4a75af4f9e221522cd57461920d22e7a290b9) = 0x04 ,     [BT\_AVRCP\_EVT\_PLAYBACK\_POS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75afc4ef6f8a80a9067ad9dfd30bf2a6958) = 0x05 , [BT\_AVRCP\_EVT\_BATT\_STATUS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75a9ff1d99bc0c83399961ef23d4a75f9b6) = 0x06 , [BT\_AVRCP\_EVT\_SYSTEM\_STATUS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75ae6237555b0051b2395e0bf2287e954c1) = 0x07 , [BT\_AVRCP\_EVT\_PLAYER\_APP\_SETTING\_CHANGED](#af55aae17f67a1361279ae208b17e4a75ab2b2287a0db9be97af8c20298bebba2d) = 0x08 ,     [BT\_AVRCP\_EVT\_NOW\_PLAYING\_CONTENT\_CHANGED](#af55aae17f67a1361279ae208b17e4a75ac0b720defdd8716d757e0c8a7e57db83) = 0x09 , [BT\_AVRCP\_EVT\_AVAILABLE\_PLAYERS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75abd82dd6ba6d5d76cf22a8c703c76c6e0) = 0x0a , [BT\_AVRCP\_EVT\_ADDRESSED\_PLAYER\_CHANGED](#af55aae17f67a1361279ae208b17e4a75ab6fdeacb536067660f754b3c586e073a) = 0x0b , [BT\_AVRCP\_EVT\_UIDS\_CHANGED](#af55aae17f67a1361279ae208b17e4a75a8ac593400cda085fbdff36e403bd2a91) = 0x0c ,     [BT\_AVRCP\_EVT\_VOLUME\_CHANGED](#af55aae17f67a1361279ae208b17e4a75a8d526498fdcb1380e8e3944da2a5ef85) = 0x0d   } |
|  | AVRCP Notification Events. [More...](#af55aae17f67a1361279ae208b17e4a75) |
...
|  | Register callback. |
| int | [bt\_avrcp\_get\_cap](#adb21554b69948d5994de8344f44c1179) (struct bt\_avrcp \*avrcp, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) tid, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) cap\_id) |
|  | Get AVRCP Capabilities. |
| int | [bt\_avrcp\_get\_unit\_info](#a7d9faee722b04fb3133b1cf863e5f1c9) (struct bt\_avrcp \*avrcp, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) tid) |
|  | Get AVRCP Unit Info. |
| int | [bt\_avrcp\_get\_subunit\_info](#a495525e5d5b9b743bc6eb13e4881b0f3) (struct bt\_avrcp \*avrcp, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) tid) |
|  | Get AVRCP Subunit Info. |
| int | [bt\_avrcp\_passthrough](#abfe2bc60019a560ea90455d0df613392) (struct bt\_avrcp \*avrcp, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) tid, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) opid, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90), const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*payload, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) len) |
...
## [◆ ](#ae7a97b11a8954a2a25cc401ced566fd2)BT\_AVRCP\_COMPANY\_ID\_BLUETOOTH\_SIG

| #define BT\_AVRCP\_COMPANY\_ID\_BLUETOOTH\_SIG   (0x001958) |
| --- |

## [◆ ](#ae4e7573280179717124104858629122a)BT\_AVRCP\_COMPANY\_ID\_SIZE

| #define BT\_AVRCP\_COMPANY\_ID\_SIZE   (3) |
| --- |

## [◆ ](#a8c8e1596f92e32781690c0a76196c4c8)BT\_AVRCP\_PASSTHROUGH\_GET\_OPID

| #define BT\_AVRCP\_PASSTHROUGH\_GET\_OPID | ( |  | *payload* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(([bt\_avrcp\_opid\_t](#a3c997d96028343a0a5a4948dabe19b84))([FIELD\_GET](silabs-pinctrl-siwx91x_8h.md#aa49a456f06f7bdbedfcf3517e461947e)([GENMASK](group__sys-util.md#ga58530d20924859d16358c7400c37738d)(6, 0), ((payload)->byte0))))

[bt\_avrcp\_opid\_t](#a3c997d96028343a0a5a4948dabe19b84)
...
## [◆ ](#a7eee1ffa11a5152a0dd014ac15979605)BT\_AVRCP\_PASSTHROUGH\_GET\_STATE

| #define BT\_AVRCP\_PASSTHROUGH\_GET\_STATE | ( |  | *payload* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(([bt\_avrcp\_button\_state\_t](#a15f9f868b056f17ea12d96530b7da881))([FIELD\_GET](silabs-pinctrl-siwx91x_8h.md#aa49a456f06f7bdbedfcf3517e461947e)([BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(7), ((payload)->byte0))))

[bt\_avrcp\_button\_state\_t](#a15f9f868b056f17ea12d96530b7da881)
...
## [◆ ](#ac311dc7b5f99162b954271529eeb84ea)bt\_avrcp\_cap\_t

| enum [bt\_avrcp\_cap\_t](#ac311dc7b5f99162b954271529eeb84ea) |
| --- |
...
## [◆ ](#af55aae17f67a1361279ae208b17e4a75)bt\_avrcp\_evt\_t

| enum [bt\_avrcp\_evt\_t](#af55aae17f67a1361279ae208b17e4a75) |
| --- |
...
## [◆ ](#adb21554b69948d5994de8344f44c1179)bt\_avrcp\_get\_cap()

| int bt\_avrcp\_get\_cap | ( | struct bt\_avrcp \* | *avrcp*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *tid*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *cap\_id* ) |
...
:   | avrcp | The AVRCP instance. |
    ...
    | cap\_id | Specific capability requested, see [bt\_avrcp\_cap\_t](#ac311dc7b5f99162b954271529eeb84ea). |

Returns
:   0 in case of success or error code in case of error.

## [◆ ](#a495525e5d5b9b743bc6eb13e4881b0f3)bt\_avrcp\_get\_subunit\_info()
...
## [◆ ](#a7d9faee722b04fb3133b1cf863e5f1c9)bt\_avrcp\_get\_unit\_info()
...
## [◆ ](#abfe2bc60019a560ea90455d0df613392)bt\_avrcp\_passthrough()

| int bt\_avrcp\_passthrough | ( | struct bt\_avrcp \* | *avrcp*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *tid*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *opid*, |
...
:   | avrcp | The AVRCP instance. |
    | --- | --- |
    | tid | The transaction label of the response, valid from 0 to 15. |
    | opid | The user operation id, see [bt\_avrcp\_opid\_t](#a3c997d96028343a0a5a4948dabe19b84). |
    | [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90) | The button state, see [bt\_avrcp\_button\_state\_t](#a15f9f868b056f17ea12d96530b7da881). |
