---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__net__pkt.html
...
| Functions | |
| --- | --- |
| struct [net\_buf](structnet__buf.md) \* | [net\_pkt\_get\_reserve\_data](#ga6f697a97dd09e24663cbddc332ec5f7c) (struct [net\_buf\_pool](structnet__buf__pool.md) \*pool, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) min\_len, [k\_timeout\_t](structk__timeout__t.md) timeout) |
...
| int | [net\_pkt\_alloc\_buffer\_with\_reserve](#ga0a292103ba0eacd62a15447e2765a485) (struct [net\_pkt](structnet__pkt.md) \*pkt, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) size, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) reserve, enum [net\_ip\_protocol](group__ip__4__6.md#gaf06819bf427cc58be1229b27b373ca31) proto, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Allocate buffer for a [net\_pkt](structnet__pkt.md "Network packet.") and reserve some space in the first [net\_buf](structnet__buf.md "Network buffer representation."). |
...
| static void | [net\_pkt\_cursor\_backup](#gabd352b66cdeaff2fb45361a0fae62876) (struct [net\_pkt](structnet__pkt.md) \*pkt, struct net\_pkt\_cursor \*backup) |
|  | Backup [net\_pkt](structnet__pkt.md "Network packet.") cursor. |
| static void | [net\_pkt\_cursor\_restore](#gad5ab788f01b4bb3640755e8c4a2c612e) (struct [net\_pkt](structnet__pkt.md) \*pkt, struct net\_pkt\_cursor \*backup) |
...
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_pkt\_get\_len](#ga9401d109ba978087139436c8a79c9bb0) (struct [net\_pkt](structnet__pkt.md) \*pkt) |
...
| void \* | [net\_pkt\_get\_data](#gaa00da4276fd4a01faf80a92796f78e70) (struct [net\_pkt](structnet__pkt.md) \*pkt, struct net\_pkt\_data\_access \*access) |
|  | Get data from a network packet in a contiguous way. |
| int | [net\_pkt\_set\_data](#ga98df84477b35e203b11029fc4ddec1cc) (struct [net\_pkt](structnet__pkt.md) \*pkt, struct net\_pkt\_data\_access \*access) |
|  | Set contiguous data into a network packet. |
| static int | [net\_pkt\_acknowledge\_data](#gac7226cbfa2da28408f9691d375bc8f9f) (struct [net\_pkt](structnet__pkt.md) \*pkt, struct net\_pkt\_data\_access \*access) |
...
NET\_PKT\_ALLOC\_STATS\_DEFINE(pkt\_alloc\_stats\_##name, name)
...
| | int net\_pkt\_acknowledge\_data | ( | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, | | --- | --- | --- | --- | |  |  | struct net\_pkt\_data\_access \* | *access* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga0a292103ba0eacd62a15447e2765a485)net\_pkt\_alloc\_buffer\_with\_reserve()

| int net\_pkt\_alloc\_buffer\_with\_reserve | ( | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *size*, |
...
:   | pkt | The network packet requiring buffer to be allocated. |
    | --- | --- |
    | size | The size of buffer being requested. |
    | reserve | The L2 header size to reserve. This can be 0, in which case the L2 header is placed into a separate [net\_buf](structnet__buf.md "Network buffer representation."). |
    | proto | The IP protocol type (can be 0 for none). |
    | timeout | Maximum time to wait for an allocation. |
...
| | void net\_pkt\_cursor\_backup | ( | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, | | --- | --- | --- | --- | |  |  | struct net\_pkt\_cursor \* | *backup* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | void net\_pkt\_cursor\_restore | ( | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, | | --- | --- | --- | --- | |  |  | struct net\_pkt\_cursor \* | *backup* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- |
|  |  | struct net\_pkt\_data\_access \* | *access* ) |
...
:   | pkt | The network packet from where to get the data. |
    | --- | --- |
    | access | A pointer to a valid net\_pkt\_data\_access describing the data to get in a contiguous way. |
...
## [◆ ](#ga9401d109ba978087139436c8a79c9bb0)net\_pkt\_get\_len()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_pkt\_get\_len | ( | struct [net\_pkt](structnet__pkt.md) \* | *pkt* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Returns
:   Total amount of bytes stored in a packet.

## [◆ ](#ga6f697a97dd09e24663cbddc332ec5f7c)net\_pkt\_get\_reserve\_data()

| struct [net\_buf](structnet__buf.md) \* net\_pkt\_get\_reserve\_data | ( | struct [net\_buf\_pool](structnet__buf__pool.md) \* | *pool*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *min\_len*, |
|  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) |
...
Parameters
:   | pool | The [net\_buf](structnet__buf.md "Network buffer representation.") pool to use. |
    | --- | --- |
    | min\_len | Minimum length of the requested fragment. |
    | timeout | Affects the action taken should the net buf pool be empty. If K\_NO\_WAIT, then return immediately. If K\_FOREVER, then wait as long as necessary. Otherwise, wait up to the specified time. |
...
[net\_pkt](structnet__pkt.md "Network packet.")'s cursor should be properly initialized. Note that [net\_pkt](structnet__pkt.md "Network packet.")'s cursor is reset by this function. This functions works in similar way as [net\_buf\_pull()](group__net__buf.md#gaef433d92734dd8691c292abdb823ba0e "Remove data from the beginning of the buffer."), but it can handle multiple [net\_buf](structnet__buf.md "Network buffer representation.") fragments.
...
:   | pkt | The network packet from where to read |
    | --- | --- |
    | data | The destination [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) where to copy the data |
...
:   | pkt | The network packet to where the data should be set. |
    | --- | --- |
    | access | A pointer to a valid net\_pkt\_data\_access describing the data to set. |
...
:   | pkt | The network packet from where to read |
    | --- | --- |
    | data | The [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) value in host byte order to write |
...
:   | pkt | The network packet from where to read |
    | --- | --- |
    | data | The [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) value in host byte order to write |
...
:   | pkt | The network packet from where to read |
    | --- | --- |
    | data | The [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) value to write |
