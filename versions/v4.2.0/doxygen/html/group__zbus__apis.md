---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__zbus__apis.html
...
| struct | [zbus\_observer\_node](structzbus__observer__node.md) |
|  | Structure used to register runtime obeservers. [More...](structzbus__observer__node.md#details) |
...
| #define | [ZBUS\_CHAN\_ID\_INVALID](#ga1f1e0798856c54dd641c1a322789400b)   [UINT32\_MAX](stdint_8h.md#ab5eb23180f7cc12b7d6c04a8ec067fdd) |
...
| #define | [ZBUS\_CHAN\_DEFINE\_WITH\_ID](#ga7c49cba434b90d417859b37722843e5f)(\_name, \_id, \_type, \_validator, \_user\_data, \_observers, \_init\_val) |
...
| const struct [zbus\_channel](structzbus__channel.md) \* | [zbus\_chan\_from\_id](#gacef06cf9818ab91be97d45ab5f58a4a3) ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel\_id) |
...
| int | [zbus\_chan\_add\_obs\_with\_node](#ga6f2b8db3a13546e3d0fd095ff9cd37ba) (const struct [zbus\_channel](structzbus__channel.md) \*chan, const struct [zbus\_observer](structzbus__observer.md) \*obs, struct [zbus\_observer\_node](structzbus__observer__node.md) \*node, [k\_timeout\_t](structk__timeout__t.md) timeout) |
...
`#include <[zephyr/zbus/zbus.h](zbus_8h.md)>`
...
static \_type \_ZBUS\_MESSAGE\_NAME(\_name) = \_init\_val; \

\_ZBUS\_CHAN\_DEFINE(\_name, [ZBUS\_CHAN\_ID\_INVALID](#ga1f1e0798856c54dd641c1a322789400b), \_type, \_validator, \_user\_data); \
...
[ZBUS\_CHAN\_ID\_INVALID](#ga1f1e0798856c54dd641c1a322789400b)

#define ZBUS\_CHAN\_ID\_INVALID

This macro indicates the channel does not have a unique ID.

**Definition** zbus.h:372
...
## [◆ ](#ga7c49cba434b90d417859b37722843e5f)ZBUS\_CHAN\_DEFINE\_WITH\_ID

| #define ZBUS\_CHAN\_DEFINE\_WITH\_ID | ( |  | *\_name*, |
| --- | --- | --- | --- |
|  |  |  | *\_id*, |
|  |  |  | *\_type*, |
|  |  |  | *\_validator*, |
...
\_ZBUS\_CHAN\_DEFINE(\_name, \_id, \_type, \_validator, \_user\_data); \
...
:   | \_name | The channel's name. |
    | --- | --- |
    | \_id | The channel's unique numeric identifier. |
    | \_type | The Message type. It must be a struct or union. |
    | \_validator | The validator function. |
    | \_user\_data | A pointer to the user data. |
...
## [◆ ](#ga1f1e0798856c54dd641c1a322789400b)ZBUS\_CHAN\_ID\_INVALID

| #define ZBUS\_CHAN\_ID\_INVALID   [UINT32\_MAX](stdint_8h.md#ab5eb23180f7cc12b7d6c04a8ec067fdd) |
| --- |
...
This routine adds an observer to the channel in runtime. This function is only supported if the CONFIG\_ZBUS\_RUNTIME\_OBSERVERS\_NODE\_ALLOC\_DYNAMIC or CONFIG\_ZBUS\_RUNTIME\_OBSERVERS\_NODE\_ALLOC\_STATIC is enabled.
...
:   | 0 | Observer added to the channel. |
    ...
    | -EEXIST | The observer is already present in the channel's observers list. |
    | -EALREADY | The observer is already present in the channel's runtime observers list. |
    | -ENOMEM | No memory available for a new runtime observer node. |

## [◆ ](#ga6f2b8db3a13546e3d0fd095ff9cd37ba)zbus\_chan\_add\_obs\_with\_node()

| int zbus\_chan\_add\_obs\_with\_node | ( | const struct [zbus\_channel](structzbus__channel.md) \* | *chan*, |
| --- | --- | --- | --- |
|  |  | const struct [zbus\_observer](structzbus__observer.md) \* | *obs*, |
|  |  | struct [zbus\_observer\_node](structzbus__observer__node.md) \* | *node*, |
|  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) |
...
This routine adds an observer to the channel by providing an allocated node. This function is only supported if the CONFIG\_ZBUS\_RUNTIME\_OBSERVERS\_NODE\_ALLOC\_NONE is enabled.

Parameters
:   | chan | The channel's reference. |
    | --- | --- |
    | obs | The observer's reference to be added. |
    | node | Persistent structure to link the channel to the observer |
    | timeout | Waiting period to add an observer, or one of the special values K\_NO\_WAIT and K\_FOREVER. |
...
:   | 0 | Observer added to the channel. |
    ...
    | -EBUSY | The node is already in use. |
...
## [◆ ](#gacef06cf9818ab91be97d45ab5f58a4a3)zbus\_chan\_from\_id()

| const struct [zbus\_channel](structzbus__channel.md) \* zbus\_chan\_from\_id | ( | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *channel\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | channel\_id | Unique channel ID from [ZBUS\_CHAN\_DEFINE\_WITH\_ID](#ga7c49cba434b90d417859b37722843e5f) |
    | --- | --- |

Return values
:   | [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) | If channel with ID *channel\_id* does not exist. |
    | --- | --- |
    | chan | Channel pointer with ID *channel\_id* otherwise. |
