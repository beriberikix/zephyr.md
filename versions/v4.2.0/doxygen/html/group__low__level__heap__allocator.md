---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__low__level__heap__allocator.html
...
| Functions | |
| --- | --- |
| int | [sys\_heap\_runtime\_stats\_get](#ga02231fb88b51b83f9adc0724fb2338b6) (struct [sys\_heap](structsys__heap.md) \*heap, struct [sys\_memory\_stats](structsys__memory__stats.md) \*stats) |
|  | Get the runtime statistics of a [sys\_heap](structsys__heap.md). |
| int | [sys\_heap\_runtime\_stats\_reset\_max](#ga22af4668b2190974443a5aded4798b2c) (struct [sys\_heap](structsys__heap.md) \*heap) |
...
| void \* | [sys\_heap\_noalign\_alloc](#ga04b26b30634dac3e362ba093994b890b) (struct [sys\_heap](structsys__heap.md) \*heap, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) align, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) bytes) |
|  | Allocate memory from a [sys\_heap](structsys__heap.md). |
...
| void \* | [sys\_heap\_realloc](#ga15c48d5c3002ad7943a45d6693699b04) (struct [sys\_heap](structsys__heap.md) \*heap, void \*ptr, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) bytes) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_heap\_validate](#ga81de9cc56f9fb88ae12ea70cc85d1db1) (struct [sys\_heap](structsys__heap.md) \*heap) |
...
| int | [sys\_heap\_array\_save](#gabb384fcc481e46051938b7b83efa1770) (struct [sys\_heap](structsys__heap.md) \*heap) |
|  | Save the heap pointer. |
| int | [sys\_heap\_array\_get](#ga4b528274c83766c28748ffa7b4b9631b) (struct [sys\_heap](structsys__heap.md) \*\*\*heap) |
...
`#include <[zephyr/sys/sys_heap.h](sys__heap_8h.md)>`
...
## [◆ ](#ga4b528274c83766c28748ffa7b4b9631b)sys\_heap\_array\_get()

| int sys\_heap\_array\_get | ( | struct [sys\_heap](structsys__heap.md) \*\*\* | *heap* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Returns
:   -EINVAL if null pointer, otherwise number of saved pointers

## [◆ ](#gabb384fcc481e46051938b7b83efa1770)sys\_heap\_array\_save()

| int sys\_heap\_array\_save | ( | struct [sys\_heap](structsys__heap.md) \* | *heap* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Returns
:   -EINVAL if null pointer or array is full, otherwise 0
...
## [◆ ](#ga04b26b30634dac3e362ba093994b890b)sys\_heap\_noalign\_alloc()

| void \* sys\_heap\_noalign\_alloc | ( | struct [sys\_heap](structsys__heap.md) \* | *heap*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *align*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *bytes* ) |
...
This is a wrapper for [sys\_heap\_alloc()](#ga6b8bdf02c9be5576fddbe711904a3aad) whose purpose is to provide the same function signature as [sys\_heap\_aligned\_alloc()](#ga92a973158860c6863e1aba8516311076).

Parameters
:   | heap | Heap from which to allocate |
    | --- | --- |
    | align | Ignored placeholder |
    | bytes | Number of bytes requested |
...
## [◆ ](#ga15c48d5c3002ad7943a45d6693699b04)sys\_heap\_realloc()

| void \* sys\_heap\_realloc | ( | struct [sys\_heap](structsys__heap.md) \* | *heap*, |
| --- | --- | --- | --- |
|  |  | void \* | *ptr*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *bytes* ) |
...
## [◆ ](#ga02231fb88b51b83f9adc0724fb2338b6)sys\_heap\_runtime\_stats\_get()

| int sys\_heap\_runtime\_stats\_get | ( | struct [sys\_heap](structsys__heap.md) \* | *heap*, |
| --- | --- | --- | --- |
...
Parameters
:   | heap | Pointer to specified [sys\_heap](structsys__heap.md) |
    | --- | --- |
...
## [◆ ](#ga22af4668b2190974443a5aded4798b2c)sys\_heap\_runtime\_stats\_reset\_max()

| int sys\_heap\_runtime\_stats\_reset\_max | ( | struct [sys\_heap](structsys__heap.md) \* | *heap* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | heap | Pointer to [sys\_heap](structsys__heap.md) |
    | --- | --- |

Returns
:   -EINVAL if null pointer was passed, otherwise 0
...
## [◆ ](#ga81de9cc56f9fb88ae12ea70cc85d1db1)sys\_heap\_validate()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_heap\_validate | ( | struct [sys\_heap](structsys__heap.md) \* | *heap* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
