---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structwifi__credentials__header.html
...
`#include <[zephyr/net/wifi_credentials.h](wifi__credentials_8h_source.md)>`
...
| char | [anon\_id](#acbbd421fda51f23d2243dd9573b05d71) [16] |
|  | Anonymous identifier (Limited to 16 bytes due to settings subsystem overflow). |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [aid\_length](#a2c39cdc6f7023560de61fb353a178369) |
|  | Length of the Anonymous identifier. |
| char | [key\_passwd](#a99ccc993d609632f42650aabe9fc861b) [16] |
|  | Password/PSK (Limited to 16 bytes due to settings subsystem overflow). |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [key\_passwd\_length](#a605b62d473586f3d8312aa1c80731ee6) |
...
## [◆ ](#a2c39cdc6f7023560de61fb353a178369)aid\_length

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) wifi\_credentials\_header::aid\_length |
| --- |

Length of the Anonymous identifier.

## [◆ ](#acbbd421fda51f23d2243dd9573b05d71)anon\_id

| char wifi\_credentials\_header::anon\_id[16] |
| --- |
...
## [◆ ](#a99ccc993d609632f42650aabe9fc861b)key\_passwd

| char wifi\_credentials\_header::key\_passwd[16] |
| --- |

Password/PSK (Limited to 16 bytes due to settings subsystem overflow).

## [◆ ](#a605b62d473586f3d8312aa1c80731ee6)key\_passwd\_length

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) wifi\_credentials\_header::key\_passwd\_length |
| --- |
