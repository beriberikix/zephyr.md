---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i3c__devicetree.html
...
| --- | --- |
|  | |
| #define | [I3C\_SUPPORTS\_SETAASA](#ga24fbe85a8cb5ffc049288b1b82e1c15b)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
|  | Device supports SETAASA CCC. |
| #define | [I3C\_V1P0\_SUPPORT](#ga91bb0d3b4b86524d5f7a6a0429a123da)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
...
`#include <[zephyr/drivers/i3c/devicetree.h](drivers_2i3c_2devicetree_8h.md)>`
...
.init\_dynamic\_addr = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, assigned\_address, 0), \

.flags = [FIELD\_PREP](silabs-pinctrl-siwx91x_8h.md#aa03c8b31bf67a097dd9f8153a04ef86b)([I3C\_SUPPORTS\_SETAASA](#ga24fbe85a8cb5ffc049288b1b82e1c15b), [DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node\_id, supports\_setaasa)) | \

FIELD\_PREP([I3C\_V1P0\_SUPPORT](#ga91bb0d3b4b86524d5f7a6a0429a123da), [DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node\_id, v1p0\_support)), \
...
[I3C\_SUPPORTS\_SETAASA](#ga24fbe85a8cb5ffc049288b1b82e1c15b)

#define I3C\_SUPPORTS\_SETAASA

Device supports SETAASA CCC.

**Definition** devicetree.h:62

[I3C\_V1P0\_SUPPORT](#ga91bb0d3b4b86524d5f7a6a0429a123da)

#define I3C\_V1P0\_SUPPORT

Device supports I3C v1.0.

**Definition** devicetree.h:64
...
:   | node\_id | The devicetree node identifier. |
    ...
    | pm | PM device resources reference ([NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) if device does not use PM). |
...
This helper macro expands to a static initializer for a [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.") by reading the relevant bus and device data from the devicetree.
...
## [◆ ](#ga24fbe85a8cb5ffc049288b1b82e1c15b)I3C\_SUPPORTS\_SETAASA

| #define I3C\_SUPPORTS\_SETAASA   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| --- |
...
## [◆ ](#ga91bb0d3b4b86524d5f7a6a0429a123da)I3C\_V1P0\_SUPPORT

| #define I3C\_V1P0\_SUPPORT   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
| --- |
