---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__gatt__exchange__params.html
...
Used with [bt\_gatt\_exchange\_mtu](group__bt__gatt__client.md#ga0f41da23c6559a8254b04295aff8198d "bt_gatt_exchange_mtu") function to initiate an MTU exchange. The response is handled in the callback `func`, which is called upon completion from the 'config BT\_RECV\_CONTEXT' context.
