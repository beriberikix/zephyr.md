---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__pbuf.html
...
| #define | [PBUF\_CFG\_INIT](#ga4e33dce801e591c9f319cc5682748920)(mem\_addr, size, dcache\_align, use\_handshake) |
...
| #define | [PBUF\_DEFINE](#gad167c69e7892f79060b07c6269699ae9)(name, mem\_addr, size, dcache\_align, use\_handshake, compatibility) |
...
| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [pbuf\_handshake\_read](#ga9fc04394d6e029aa74c26ae974787483) (struct [pbuf](structpbuf.md) \*pb) |
|  | Read handshake word from pbuf. |
| void | [pbuf\_handshake\_write](#ga97cb3608eaaa4f276d57c21150916938) (struct [pbuf](structpbuf.md) \*pb, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) value) |
|  | Write handshake word to pbuf. |
| int | [pbuf\_get\_initial\_buf](#gab31a49d00da9713170f4e63ba97191d9) (struct [pbuf](structpbuf.md) \*pb, volatile char \*\*buf, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) \*len) |
...
## [◆ ](#ga4e33dce801e591c9f319cc5682748920)PBUF\_CFG\_INIT
...
`#include <[zephyr/ipc/pbuf.h](pbuf_8h.md)>`
...
.handshake\_loc = use\_handshake ? ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*)(([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)(mem\_addr) + \

\_PBUF\_IDX\_SIZE) : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), \

.wr\_idx\_loc = ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*)(([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)(mem\_addr) + [MAX](group__sys-util.md#gafa99ec4acc4ecb2dc3c2d05da15d0e3f)(dcache\_align, \

(use\_handshake ? 2 : 1) \* \_PBUF\_IDX\_SIZE)), \
...
[MAX](group__sys-util.md#gafa99ec4acc4ecb2dc3c2d05da15d0e3f)(dcache\_align, (use\_handshake ? 2 : 1) \* \

\_PBUF\_IDX\_SIZE) + \_PBUF\_IDX\_SIZE), \

.len = ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f))(([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f))(size) - [MAX](group__sys-util.md#gafa99ec4acc4ecb2dc3c2d05da15d0e3f)(dcache\_align, \

(use\_handshake ? 2 : 1) \* \_PBUF\_IDX\_SIZE) - \_PBUF\_IDX\_SIZE), \
...
:   | mem\_addr | Memory address for pbuf. |
    ...
    | use\_handshake | Add handshake word inside shared memory that can be access with [pbuf\_handshake\_read](#ga9fc04394d6e029aa74c26ae974787483) and [pbuf\_handshake\_write](#ga97cb3608eaaa4f276d57c21150916938). |

## [◆ ](#gad167c69e7892f79060b07c6269699ae9)PBUF\_DEFINE
...
BUILD\_ASSERT(!(compatibility) || (dcache\_align) >= 8, \
...
PBUF\_CFG\_INIT(mem\_addr, size, dcache\_align, use\_handshake); \
...
## [◆ ](#gab31a49d00da9713170f4e63ba97191d9)pbuf\_get\_initial\_buf()

| int pbuf\_get\_initial\_buf | ( | struct [pbuf](structpbuf.md) \* | *pb*, |
| --- | --- | --- | --- |
|  |  | volatile char \*\* | *buf*, |
...
## [◆ ](#ga9fc04394d6e029aa74c26ae974787483)pbuf\_handshake\_read()

| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) pbuf\_handshake\_read | ( | struct [pbuf](structpbuf.md) \* | *pb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
The pb must be defined with "PBUF\_DEFINE" with "use\_handshake" set.
...
Return values
:   | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | The handshake word value. |
    | --- | --- |

## [◆ ](#ga97cb3608eaaa4f276d57c21150916938)pbuf\_handshake\_write()

| void pbuf\_handshake\_write | ( | struct [pbuf](structpbuf.md) \* | *pb*, |
| --- | --- | --- | --- |
