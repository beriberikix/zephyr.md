---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structllext__loader.html
...
| Data Fields | |
| --- | --- |
| int(\* | [prepare](#a3034e439e3c55a2ed874cf2db6aba46e) )(struct [llext\_loader](structllext__loader.md) \*ldr) |
...
| void(\* | [finalize](#a7c0ea7bce0a56ccf98e120a52e362b37) )(struct [llext\_loader](structllext__loader.md) \*ldr) |
|  | Optional function to clean after the extension has been loaded or error occurred. |
| enum [llext\_storage\_type](group__llext__loader__apis.md#ga8e04f364aef19cf45843cc97cc702f24) | [storage](#a1b82b69501e174b6a0f24ef356abbf16) |
...
## [◆ ](#a7c0ea7bce0a56ccf98e120a52e362b37)finalize

| void(\* llext\_loader::finalize) (struct [llext\_loader](structllext__loader.md) \*ldr) |
| --- |
...
Returns
:   a pointer into the buffer or [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) if not supported

## [◆ ](#a3034e439e3c55a2ed874cf2db6aba46e)prepare

| int(\* llext\_loader::prepare) (struct [llext\_loader](structllext__loader.md) \*ldr) |
| --- |
...
## [◆ ](#a1b82b69501e174b6a0f24ef356abbf16)storage

| enum [llext\_storage\_type](group__llext__loader__apis.md#ga8e04f364aef19cf45843cc97cc702f24) llext\_loader::storage |
| --- |
