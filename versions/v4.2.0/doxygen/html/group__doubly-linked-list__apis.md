---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__doubly-linked-list__apis.html
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_dlist\_is\_head](#gafc47ac9ba916c585cf527deb9df4ada2) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | check if a node is the list's head |
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_dlist\_is\_tail](#ga336288dfb1d6293567743018171090a4) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | check if a node is the list's tail |
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_dlist\_is\_empty](#gaa44b9aa0cf3910e5f2884c3cd6b0b01e) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
|  | check if the list is empty |
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_dlist\_has\_multiple\_nodes](#ga397bae1a777af7b008e9d24fe7dd6608) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
|  | check if more than one node present |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
|  | get a reference to the head item in the list |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_head\_not\_empty](#ga6be5281719ce432fe1b34be64bbdfcfb) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
|  | get a reference to the head item in the list |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_next\_no\_check](#ga12be5af77a8941913d8ba0e4cbd97122) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | get a reference to the next item in the list, node is not NULL |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | get a reference to the next item in the list |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_prev\_no\_check](#ga569062ce6e6d6280c9e77f88fa6a45cb) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | get a reference to the previous item in the list, node is not NULL |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_prev](#gababe826faee8b081dbe09cfad4556a4e) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list, const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
|  | get a reference to the previous item in the list |
| static [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | [sys\_dlist\_peek\_tail](#gae8b78bea092edc49afeb2d481e36dc86) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
...
| static void | [sys\_dlist\_dequeue](#gadf588e086301e31d70c4fc8de4b9d499) ([sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \*node) |
...
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [sys\_dlist\_len](#ga6797f138ad66cfb5ee7918bb12869eac) (const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \*list) |
...
`#include <[zephyr/sys/dlist.h](dlist_8h.md)>`

**Value:**

(((\_\_dn) != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) ? [CONTAINER\_OF](group__sys-util.md#gac5bc561d1bfd1bf68877fe577779bd2f)(\_\_dn, \_\_typeof\_\_(\*(\_\_cn)), \_\_n) : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
(\_\_cn) != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4); \
...
(\_\_cn) != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4); (\_\_cn) = (\_\_cns), \
...
for (\_\_dn = [sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568)(\_\_dl); \_\_dn != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4); \

\_\_dn = [sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0)(\_\_dl, \_\_dn))

[sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568)

static sys\_dnode\_t \* sys\_dlist\_peek\_head(const sys\_dlist\_t \*list)

get a reference to the head item in the list

**Definition** dlist.h:302

[sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0)

static sys\_dnode\_t \* sys\_dlist\_peek\_next(const sys\_dlist\_t \*list, const sys\_dnode\_t \*node)
...
for ((\_\_dn) = [sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568)(\_\_dl), \

(\_\_dns) = [sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0)((\_\_dl), (\_\_dn)); \

(\_\_dn) != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4); (\_\_dn) = (\_\_dns), \
...
for (\_\_dn = \_\_dn ? [sys\_dlist\_peek\_next\_no\_check](#ga12be5af77a8941913d8ba0e4cbd97122)(\_\_dl, \_\_dn) \

: [sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568)(\_\_dl); \

\_\_dn != [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4); \

\_\_dn = [sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0)(\_\_dl, \_\_dn))

[sys\_dlist\_peek\_next\_no\_check](#ga12be5af77a8941913d8ba0e4cbd97122)

static sys\_dnode\_t \* sys\_dlist\_peek\_next\_no\_check(const sys\_dlist\_t \*list, const sys\_dnode\_t \*node)
...
[SYS\_DLIST\_CONTAINER](#ga33a8bf65e8095e3b4dcee0b005b79170)([sys\_dlist\_peek\_head](#ga07567e9c1baeb92577daf39134b83568)(\_\_dl), \_\_cn, \_\_n)
...
SYS\_DLIST\_CONTAINER([sys\_dlist\_peek\_next](#ga6aa98dd8c6365fa74956ee182b71b2d0)((\_\_dl), &((\_\_cn)->\_\_n)), \

\_\_cn, \_\_n) : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
## [◆ ](#gadf588e086301e31d70c4fc8de4b9d499)sys\_dlist\_dequeue()

| | void sys\_dlist\_dequeue | ( | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Like :c:func:[sys\_dlist\_remove()](#ga06f88befada25820fba01d2019970e4e), this routine removes a specific node from a list. However, unlike :c:func:[sys\_dlist\_remove()](#ga06f88befada25820fba01d2019970e4e), this routine does not re-initialize the removed node. One significant implication of this difference is that the function :c:func[sys\_dnode\_is\_linked()](#gac725da0c7e65c126a96a9405af84ca41) will not work on a dequeued node.
...
## [◆ ](#ga397bae1a777af7b008e9d24fe7dd6608)sys\_dlist\_has\_multiple\_nodes()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_dlist\_has\_multiple\_nodes | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaa44b9aa0cf3910e5f2884c3cd6b0b01e)sys\_dlist\_is\_empty()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_dlist\_is\_empty | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gafc47ac9ba916c585cf527deb9df4ada2)sys\_dlist\_is\_head()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_dlist\_is\_head | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga336288dfb1d6293567743018171090a4)sys\_dlist\_is\_tail()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_dlist\_is\_tail | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga6797f138ad66cfb5ee7918bb12869eac)sys\_dlist\_len()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) sys\_dlist\_len | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga07567e9c1baeb92577daf39134b83568)sys\_dlist\_peek\_head()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_head | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga6be5281719ce432fe1b34be64bbdfcfb)sys\_dlist\_peek\_head\_not\_empty()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_head\_not\_empty | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga6aa98dd8c6365fa74956ee182b71b2d0)sys\_dlist\_peek\_next()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_next | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga12be5af77a8941913d8ba0e4cbd97122)sys\_dlist\_peek\_next\_no\_check()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_next\_no\_check | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Faster than [sys\_dlist\_peek\_next()](#ga6aa98dd8c6365fa74956ee182b71b2d0) if node is known not to be NULL.
...
## [◆ ](#gababe826faee8b081dbe09cfad4556a4e)sys\_dlist\_peek\_prev()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_prev | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga569062ce6e6d6280c9e77f88fa6a45cb)sys\_dlist\_peek\_prev\_no\_check()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_prev\_no\_check | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* | *node* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Faster than [sys\_dlist\_peek\_prev()](#gababe826faee8b081dbe09cfad4556a4e) if node is known not to be NULL.
...
## [◆ ](#gae8b78bea092edc49afeb2d481e36dc86)sys\_dlist\_peek\_tail()

| | [sys\_dnode\_t](#ga57fdb936802a617d16c00ab08cd2ad98) \* sys\_dlist\_peek\_tail | ( | const [sys\_dlist\_t](#gaa03f9557215b486fee1039dd4c07e683) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
