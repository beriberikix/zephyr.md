---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/posix_2arch_8h.html
...
`#include <[zephyr/arch/posix/exception.h](posix_2exception_8h_source.md)>`  
...
This header contains the POSIX arch specific kernel interface. It is included by the kernel interface architecture-abstraction header (include/zephyr/arch/cpu.h).
