---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/policy_8h.html
...
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_state\_is\_available](group__subsys__pm__sys__policy.md#ga1c8634f68224aa64f05a373dfad5cb09) (enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90), [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) substate\_id) |
|  | Check if a power state is available. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_state\_any\_active](group__subsys__pm__sys__policy.md#ga0c4fee04c7434e2ba741be8d5b1036c6) (void) |
|  | Check if any power state can be used. |
| void | [pm\_policy\_event\_register](group__subsys__pm__sys__policy.md#ga4e66c09a5c8694e48b7be6b61667aeca) (struct [pm\_policy\_event](structpm__policy__event.md) \*evt, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) uptime\_ticks) |
|  | Register an event. |
| void | [pm\_policy\_event\_update](group__subsys__pm__sys__policy.md#ga059074d867befbe9c6b7afc170ee09b3) (struct [pm\_policy\_event](structpm__policy__event.md) \*evt, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) uptime\_ticks) |
|  | Update an event. |
...
|  | Unregister an event. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_device\_is\_disabling\_state](group__subsys__pm__sys__policy.md#ga4cfc3c450387663b6e1bf9bb966baad8) (const struct [device](structdevice.md) \*dev, enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90), [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) substate\_id) |
|  | Check if a state will disable a device. |
| [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) | [pm\_policy\_next\_event\_ticks](group__subsys__pm__sys__policy.md#gae2680fcc323e161362e4a5aa5339ac12) (void) |
|  | Returns the ticks until the next event. |
| void | [pm\_policy\_device\_power\_lock\_get](group__subsys__pm__sys__policy.md#ga708b7d2f8cb5f09738e3c6e5937c475e) (const struct [device](structdevice.md) \*dev) |
|  | Increase power state locks. |
| void | [pm\_policy\_device\_power\_lock\_put](group__subsys__pm__sys__policy.md#gafb90036c42bce2cc44466427b2907a81) (const struct [device](structdevice.md) \*dev) |
