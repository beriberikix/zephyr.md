---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/stm32__flash__api__extensions_8h_source.html
...
67#if defined(CONFIG\_FLASH\_EX\_OP\_ENABLED)

68enum stm32\_qspi\_ex\_ops {

69 /\*

70 \* QSPI generic read command.

71 \*

72 \* Transmit the custom command and read the result to the user-provided

73 \* buffer.

74 \*/

75 FLASH\_STM32\_QSPI\_EX\_OP\_GENERIC\_READ,

76 /\*

77 \* QSPI generic write command.

78 \*

79 \* Transmit the custom command and then write data taken from the

80 \* user-provided buffer.

81 \*/

82 FLASH\_STM32\_QSPI\_EX\_OP\_GENERIC\_WRITE,

83};

84#endif /\* CONFIG\_FLASH\_EX\_OP\_ENABLED \*/

85

86#if defined(CONFIG\_FLASH\_STM32\_WRITE\_PROTECT)

87struct flash\_stm32\_ex\_op\_sector\_wp\_in {

88 [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) enable\_mask;

89 [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) disable\_mask;

90};

91

92struct flash\_stm32\_ex\_op\_sector\_wp\_out {

93 [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) protected\_mask;

94};

95#endif /\* CONFIG\_FLASH\_STM32\_WRITE\_PROTECT \*/

96

97#if defined(CONFIG\_FLASH\_STM32\_READOUT\_PROTECTION)

98struct flash\_stm32\_ex\_op\_rdp {
...
102#endif /\* CONFIG\_FLASH\_STM32\_READOUT\_PROTECTION \*/

103

104#endif /\* \_\_ZEPHYR\_INCLUDE\_DRIVERS\_FLASH\_STM32\_FLASH\_API\_EXTENSIONS\_H\_\_ \*/
