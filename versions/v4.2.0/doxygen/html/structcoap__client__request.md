---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structcoap__client__request.html
...
`#include <[zephyr/net/coap_client.h](coap__client_8h_source.md)>`
...
| const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | [payload](#aca43b59a62328be1d87901ab3e30f399) |
...
| const struct [coap\_client\_option](structcoap__client__option.md) \* | [options](#a8c8b28facf0e0bbe267dc9b1aeb7772a) |
...
## [◆ ](#a8c8b28facf0e0bbe267dc9b1aeb7772a)options

| const struct [coap\_client\_option](structcoap__client__option.md)\* coap\_client\_request::options |
| --- |
...
## [◆ ](#aca43b59a62328be1d87901ab3e30f399)payload

| const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d)\* coap\_client\_request::payload |
| --- |
