---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__dai__interface.html
...
|  | Gets timestamp. |
| static int | [dai\_config\_update](#ga82a6fef76b66474f365b260e333385e5) (const struct [device](structdevice.md) \*dev, const void \*bespoke\_cfg, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) size) |
...
`#include <[zephyr/drivers/dai.h](dai_8h.md)>`
...
| DAI\_IMX\_MICFIL | i.MX PDM MICFIL |
...
## [◆ ](#ga82a6fef76b66474f365b260e333385e5)dai\_config\_update()

| | int dai\_config\_update | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | const void \* | *bespoke\_cfg*, | |  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *size* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | dev | Pointer to the device structure for the driver instance. |
    | --- | --- |
    | bespoke\_cfg | Pointer to the buffer containing bespoke configuration parameters. |
    | size | Size of the bespoke\_cfg buffer in bytes. |
