---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__net__stats.html
...
| struct | [net\_stats\_pkt\_filter](structnet__stats__pkt__filter.md) |
|  | Network packet filter statistics. [More...](structnet__stats__pkt__filter.md#details) |
...
| #define | [NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4](#ga3c3413463adef85973626716e19e05d6)(iface, dev\_id, sfx) |
| #define | [NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6](#ga94763ab89bb97f832f43e4d09d34edd7)(iface, dev\_id, sfx) |
| #define | [NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL](#gac53b62a898db85f469eed307b3852247)(iface, dev\_id, sfx) |
| #define | [NET\_STATS\_PROMETHEUS\_PKT\_FILTER](#ga347ee5863fd3501b5e3f7f04c8457bda)(iface, dev\_id, sfx) |
...
`#include <[zephyr/net/net_stats.h](net__stats_8h.md)>`
...
IF\_ENABLED(CONFIG\_NET\_STATISTICS\_PKT\_FILTER, \

([NET\_STATS\_PROMETHEUS\_PKT\_FILTER](#ga347ee5863fd3501b5e3f7f04c8457bda)(iface, dev\_id, sfx))) \
...
## [◆ ](#ga347ee5863fd3501b5e3f7f04c8457bda)NET\_STATS\_PROMETHEUS\_PKT\_FILTER

| #define NET\_STATS\_PROMETHEUS\_PKT\_FILTER | ( |  | *iface*, |
| --- | --- | --- | --- |
|  |  |  | *dev\_id*, |
|  |  |  | *sfx* ) |
...
[NET\_STATS\_GET\_INSTANCE](#gabb15df6c3c85b85756ef5d2d51d0afb2)(dev\_id, sfx, pkt\_filter\_rx\_drop),\

"packet\_count", \

[NET\_STATS\_GET\_COLLECTOR\_NAME](#gab58d7d437d4fa9836a826ee59e2d081d)(dev\_id, sfx), \

[NET\_STATS\_GET\_VAR](#gab66b3c8d32d2f02add08c332460d5cd6)(dev\_id, sfx, pkt\_filter\_rx\_drop), \

&(iface)->stats.pkt\_filter.rx.drop); \

NET\_STATS\_PROMETHEUS\_COUNTER\_DEFINE( \

"Packet filter TX drop", \

[NET\_STATS\_GET\_INSTANCE](#gabb15df6c3c85b85756ef5d2d51d0afb2)(dev\_id, sfx, pkt\_filter\_tx\_drop),\

"packet\_count", \

[NET\_STATS\_GET\_COLLECTOR\_NAME](#gab58d7d437d4fa9836a826ee59e2d081d)(dev\_id, sfx), \

[NET\_STATS\_GET\_VAR](#gab66b3c8d32d2f02add08c332460d5cd6)(dev\_id, sfx, pkt\_filter\_tx\_drop), \

&(iface)->stats.pkt\_filter.tx.drop); \

IF\_ENABLED(CONFIG\_NET\_PKT\_FILTER\_IPV4\_HOOK, \

([NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4](#ga3c3413463adef85973626716e19e05d6)(iface, dev\_id, sfx))) \

IF\_ENABLED(CONFIG\_NET\_PKT\_FILTER\_IPV6\_HOOK, \

([NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6](#ga94763ab89bb97f832f43e4d09d34edd7)(iface, dev\_id, sfx))) \

IF\_ENABLED(CONFIG\_NET\_PKT\_FILTER\_LOCAL\_IN\_HOOK, \

([NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL](#gac53b62a898db85f469eed307b3852247)(iface, dev\_id, sfx)))

[NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4](#ga3c3413463adef85973626716e19e05d6)

#define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4(iface, dev\_id, sfx)

**Definition** net\_stats.h:1417

[NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6](#ga94763ab89bb97f832f43e4d09d34edd7)

#define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6(iface, dev\_id, sfx)

**Definition** net\_stats.h:1426

[NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL](#gac53b62a898db85f469eed307b3852247)

#define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL(iface, dev\_id, sfx)

**Definition** net\_stats.h:1435

## [◆ ](#ga3c3413463adef85973626716e19e05d6)NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4

| #define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV4 | ( |  | *iface*, |
| --- | --- | --- | --- |
|  |  |  | *dev\_id*, |
|  |  |  | *sfx* ) |
...
[NET\_STATS\_GET\_INSTANCE](#gabb15df6c3c85b85756ef5d2d51d0afb2)(dev\_id, sfx, pkt\_filter\_rx\_ipv4\_drop), \

"packet\_count", \

[NET\_STATS\_GET\_COLLECTOR\_NAME](#gab58d7d437d4fa9836a826ee59e2d081d)(dev\_id, sfx), \

[NET\_STATS\_GET\_VAR](#gab66b3c8d32d2f02add08c332460d5cd6)(dev\_id, sfx, pkt\_filter\_rx\_ipv4\_drop),\

&(iface)->stats.pkt\_filter.rx.ipv4\_drop);

## [◆ ](#ga94763ab89bb97f832f43e4d09d34edd7)NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6

| #define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_IPV6 | ( |  | *iface*, |
| --- | --- | --- | --- |
|  |  |  | *dev\_id*, |
|  |  |  | *sfx* ) |
...
[NET\_STATS\_GET\_INSTANCE](#gabb15df6c3c85b85756ef5d2d51d0afb2)(dev\_id, sfx, pkt\_filter\_rx\_ipv6\_drop), \

"packet\_count", \

[NET\_STATS\_GET\_COLLECTOR\_NAME](#gab58d7d437d4fa9836a826ee59e2d081d)(dev\_id, sfx), \

[NET\_STATS\_GET\_VAR](#gab66b3c8d32d2f02add08c332460d5cd6)(dev\_id, sfx, pkt\_filter\_rx\_ipv6\_drop),\

&(iface)->stats.pkt\_filter.rx.ipv6\_drop);

## [◆ ](#gac53b62a898db85f469eed307b3852247)NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL

| #define NET\_STATS\_PROMETHEUS\_PKT\_FILTER\_LOCAL | ( |  | *iface*, |
| --- | --- | --- | --- |
|  |  |  | *dev\_id*, |
|  |  |  | *sfx* ) |
...
[NET\_STATS\_GET\_INSTANCE](#gabb15df6c3c85b85756ef5d2d51d0afb2)(dev\_id, sfx, pkt\_filter\_rx\_local\_drop), \

"packet\_count", \

[NET\_STATS\_GET\_COLLECTOR\_NAME](#gab58d7d437d4fa9836a826ee59e2d081d)(dev\_id, sfx), \

[NET\_STATS\_GET\_VAR](#gab66b3c8d32d2f02add08c332460d5cd6)(dev\_id, sfx, pkt\_filter\_rx\_local\_drop),\

&(iface)->stats.pkt\_filter.rx.local\_drop);
