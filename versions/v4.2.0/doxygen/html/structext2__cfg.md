---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structext2__cfg.html
...
`#include <[zephyr/fs/ext2.h](ext2_8h_source.md)>`
...
:   | [block\_size](#a3eb5587725f3fee4dd8ea86a7077e662) | Requested size of block. |
    ...
    | [uuid](structuuid.md "Binary representation of a UUID.") | UUID for created file system. Used when set\_uuid is true. |
