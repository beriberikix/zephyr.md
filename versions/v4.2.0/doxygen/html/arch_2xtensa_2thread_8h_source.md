---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/arch_2xtensa_2thread_8h_source.html
...
46 /\* Stashed PS value used to restore PS when restoring from

47 \* context switching or returning from non-nested interrupts.

48 \*/

49 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) return\_ps;
...
53typedef struct \_thread\_arch \_thread\_arch\_t;
...
57#endif /\* ZEPHYR\_INCLUDE\_ARCH\_XTENSA\_THREAD\_H\_ \*/
