---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__arch-interface.html
...
For all macros and inline function prototypes described herein, <[arch/cpu.h](arch_2cpu_8h.md)> must eventually pull in full definitions for all of them (the actual macro defines and inline function bodies)
