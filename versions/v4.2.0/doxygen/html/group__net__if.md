---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__net__if.html
...
| static int | [net\_if\_oper\_state\_change\_time](#gabae216ba527bdfcd945ef19fb48e56be) (struct [net\_if](structnet__if.md) \*iface, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) \*change\_time) |
|  | Get an operational state change time of an interface. |
| enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896) | [net\_if\_try\_send\_data](#ga5d01d7fa6c7511d68933ad4cec032d8a) (struct [net\_if](structnet__if.md) \*iface, struct [net\_pkt](structnet__pkt.md) \*pkt, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Try sending a packet through a net iface. |
| static enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896) | [net\_if\_send\_data](#ga84a58403183b88c64fda59d5d2d903fc) (struct [net\_if](structnet__if.md) \*iface, struct [net\_pkt](structnet__pkt.md) \*pkt) |
...
| void | [net\_if\_try\_queue\_tx](#ga3617cd1f712b8a85fdd7f1425254ae5d) (struct [net\_if](structnet__if.md) \*iface, struct [net\_pkt](structnet__pkt.md) \*pkt, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Try enqueuing a packet to the net interface TX queue. |
| static void | [net\_if\_queue\_tx](#ga2ac749d465ef7f0f64f294a30310457e) (struct [net\_if](structnet__if.md) \*iface, struct [net\_pkt](structnet__pkt.md) \*pkt) |
...
| static struct [net\_if](structnet__if.md) \* | [net\_if\_ipv6\_select\_src\_iface\_addr](#gae05071bf94ac7abea118fedd79deeeee) (const struct [in6\_addr](structin6__addr.md) \*dst, const struct [in6\_addr](structin6__addr.md) \*\*src\_addr) |
|  | Get a network interface that should be used when sending IPv6 network data to destination. |
...
| static struct [net\_if](structnet__if.md) \* | [net\_if\_ipv4\_select\_src\_iface\_addr](#ga08dd64f024cb8713c4ca77e532eb471c) (const struct [in\_addr](structin__addr.md) \*dst, const struct [in\_addr](structin__addr.md) \*\*src\_addr) |
|  | Get a network interface that should be used when sending IPv4 network data to destination. |
...
`#include <[zephyr/net/net_if.h](net__if_8h.md)>`
...
## [◆ ](#ga08dd64f024cb8713c4ca77e532eb471c)net\_if\_ipv4\_select\_src\_iface\_addr()

| | struct [net\_if](structnet__if.md) \* net\_if\_ipv4\_select\_src\_iface\_addr | ( | const struct [in\_addr](structin__addr.md) \* | *dst*, | | --- | --- | --- | --- | |  |  | const struct [in\_addr](structin__addr.md) \*\* | *src\_addr* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Also return the source IPv4 address from that network interface.

Parameters
:   | dst | IPv4 destination address |
    | --- | --- |
    | src\_addr | IPv4 source address. This can be set to NULL if the source address is not needed. |
...
## [◆ ](#gae05071bf94ac7abea118fedd79deeeee)net\_if\_ipv6\_select\_src\_iface\_addr()

| | struct [net\_if](structnet__if.md) \* net\_if\_ipv6\_select\_src\_iface\_addr | ( | const struct [in6\_addr](structin6__addr.md) \* | *dst*, | | --- | --- | --- | --- | |  |  | const struct [in6\_addr](structin6__addr.md) \*\* | *src\_addr* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Also return the source IPv6 address from that network interface.

Parameters
:   | dst | IPv6 destination address |
    | --- | --- |
    | src\_addr | IPv6 source address. This can be set to NULL if the source address is not needed. |
...
## [◆ ](#gabae216ba527bdfcd945ef19fb48e56be)net\_if\_oper\_state\_change\_time()

| | int net\_if\_oper\_state\_change\_time | ( | struct [net\_if](structnet__if.md) \* | *iface*, | | --- | --- | --- | --- | |  |  | [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) \* | *change\_time* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | iface | Pointer to network interface |
    | --- | --- |
    | change\_time | Pointer to store the change time. Time the operational state of an interface was last changed, in milliseconds since boot. If the interface operational state has not been changed yet, then the value is 0. |

Returns
:   0 if ok, -EINVAL if operational state change time could not be retrieved (for example if iface or change\_time is NULL).
...
## [◆ ](#ga2ac749d465ef7f0f64f294a30310457e)net\_if\_queue\_tx()

| | void net\_if\_queue\_tx | ( | struct [net\_if](structnet__if.md) \* | *iface*, | | --- | --- | --- | --- | |  |  | struct [net\_pkt](structnet__pkt.md) \* | *pkt* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This is equivalent to net\_if\_try\_queue\_tx with an infinite timeout
...
## [◆ ](#ga84a58403183b88c64fda59d5d2d903fc)net\_if\_send\_data()

| | enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896) net\_if\_send\_data | ( | struct [net\_if](structnet__if.md) \* | *iface*, | | --- | --- | --- | --- | |  |  | struct [net\_pkt](structnet__pkt.md) \* | *pkt* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga3617cd1f712b8a85fdd7f1425254ae5d)net\_if\_try\_queue\_tx()

| void net\_if\_try\_queue\_tx | ( | struct [net\_if](structnet__if.md) \* | *iface*, |
| --- | --- | --- | --- |
|  |  | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, |
...
:   | iface | Pointer to a network interface structure |
    | --- | --- |
    | pkt | Pointer to a net packet to queue |
    | timeout | Timeout for the enqueuing attempt |

## [◆ ](#ga5d01d7fa6c7511d68933ad4cec032d8a)net\_if\_try\_send\_data()

| enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896) net\_if\_try\_send\_data | ( | struct [net\_if](structnet__if.md) \* | *iface*, |
| --- | --- | --- | --- |
|  |  | struct [net\_pkt](structnet__pkt.md) \* | *pkt*, |
|  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) |
...
:   | iface | Pointer to a network interface structure |
    | --- | --- |
    | pkt | Pointer to a net packet to send |
    | timeout | timeout for attempting to send |
