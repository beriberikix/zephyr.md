---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structudc__api.html
...
`#include <[zephyr/drivers/usb/udc.h](udc_8h_source.md)>`
...
| void(\* | [lock](#a1e3d733665cd609381e02929907c9837) )(const struct [device](structdevice.md) \*dev) |
| void(\* | [unlock](#a2be8523215fd255112bb03d9cd54c26b) )(const struct [device](structdevice.md) \*dev) |
...
## [◆ ](#a1e3d733665cd609381e02929907c9837)lock

| void(\* udc\_api::lock) (const struct [device](structdevice.md) \*dev) |
| --- |
...
## [◆ ](#a2be8523215fd255112bb03d9cd54c26b)unlock

| void(\* udc\_api::unlock) (const struct [device](structdevice.md) \*dev) |
| --- |
