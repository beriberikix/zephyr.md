---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/hci_8h.html
...
| struct [net\_buf](structnet__buf.md) \* | [bt\_hci\_cmd\_alloc](#a974e6e9262601e73537cbdcba7a7c93c) ([k\_timeout\_t](structk__timeout__t.md) timeout) |
...
| struct bt\_conn \* | [bt\_hci\_conn\_lookup\_handle](#a73ba00112117da9ce60c850fa4cb4722) ([uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) handle) |
...
| struct bt\_le\_ext\_adv \* | [bt\_hci\_adv\_lookup\_handle](#a8bf5e3e8b55633350a4cb34c928bce4d) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) handle) |
...
| struct bt\_le\_per\_adv\_sync \* | [bt\_hci\_per\_adv\_sync\_lookup\_handle](#a425f0cee74f061bb7f11e73da3ac627d) ([uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) handle) |
...
## [◆ ](#a8bf5e3e8b55633350a4cb34c928bce4d)bt\_hci\_adv\_lookup\_handle()

| struct bt\_le\_ext\_adv \* bt\_hci\_adv\_lookup\_handle | ( | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *handle* | ) |  |
| --- | --- | --- | --- | --- | --- |

Get advertising set given an advertising handle.

Parameters
:   | handle | The advertising handle |
    | --- | --- |

Returns
:   The corresponding advertising set on success, NULL if it does not exist.

## [◆ ](#a974e6e9262601e73537cbdcba7a7c93c)bt\_hci\_cmd\_alloc()

| struct [net\_buf](structnet__buf.md) \* bt\_hci\_cmd\_alloc | ( | [k\_timeout\_t](structk__timeout__t.md) | *timeout* | ) |  |
| --- | --- | --- | --- | --- | --- |

Allocate an HCI command buffer.

This function allocates a new buffer for an HCI command. Upon successful return the buffer is ready to have the command parameters encoded into it. Sufficient headroom gets automatically reserved in the buffer, allowing the actual command and H:4 headers to be encoded later, as part of calling [bt\_hci\_cmd\_send()](#af2eed9d93da45185aad9c2edc0001a54) or [bt\_hci\_cmd\_send\_sync()](#a8d306b5b56afdece1cadbbf0eecfe5a7).

Parameters
:   | timeout | Timeout for the allocation. |
    | --- | --- |

Returns
:   Newly allocated buffer or NULL if allocation failed.
...
:   Use [bt\_hci\_cmd\_alloc()](#a974e6e9262601e73537cbdcba7a7c93c) instead.
...
This function is used for sending a HCI command asynchronously. It can either be called for a buffer created using [bt\_hci\_cmd\_alloc()](#a974e6e9262601e73537cbdcba7a7c93c), or if the command has no parameters a NULL can be passed instead. The sending of the command will happen asynchronously, i.e. upon successful return from this function the caller only knows that it was queued successfully.
...
This function is used for sending a HCI command synchronously. It can either be called for a buffer created using [bt\_hci\_cmd\_alloc()](#a974e6e9262601e73537cbdcba7a7c93c), or if the command has no parameters a NULL can be passed instead.
...
## [◆ ](#a73ba00112117da9ce60c850fa4cb4722)bt\_hci\_conn\_lookup\_handle()

| struct bt\_conn \* bt\_hci\_conn\_lookup\_handle | ( | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *handle* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Returns
:   The corresponding connection object on success. NULL if it does not exist.
...
## [◆ ](#a425f0cee74f061bb7f11e73da3ac627d)bt\_hci\_per\_adv\_sync\_lookup\_handle()

| struct bt\_le\_per\_adv\_sync \* bt\_hci\_per\_adv\_sync\_lookup\_handle | ( | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *handle* | ) |  |
| --- | --- | --- | --- | --- | --- |

Get periodic advertising sync given an periodic advertising sync handle.

Parameters
:   | handle | The periodic sync set handle |
    | --- | --- |

Return values
:   | The | corresponding periodic advertising sync set object on success, NULL if it does not exist. |
    | --- | --- |
