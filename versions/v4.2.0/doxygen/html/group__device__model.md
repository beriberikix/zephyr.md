---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__device__model.html
...
| struct | [device\_ops](structdevice__ops.md) |
|  | Device operations. [More...](structdevice__ops.md#details) |
...
| #define | [DEVICE\_DEINIT\_DEFINE](#ga61d851f960a701c9d47d6167b35ac99c)(dev\_id, name, init\_fn, deinit\_fn, pm, data, config, level, prio, api) |
...
| #define | [DEVICE\_DT\_DEINIT\_DEFINE](#gaa53f7267950569df898b0e5362e6f583)(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api, ...) |
...
|  | Create a device object from a devicetree node identifier and set it up for boot time initialization. |
| #define | [DEVICE\_DT\_INST\_DEINIT\_DEFINE](#ga85eecc663e60efa947a59844bcb0bb54)(inst, ...) |
|  | Like [DEVICE\_DT\_DEINIT\_DEFINE()](#gaa53f7267950569df898b0e5362e6f583), but uses an instance of a DT\_DRV\_COMPAT compatible instead of a node identifier. |
...
| typedef [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [device\_flags\_t](#gae3daac2d0f7f881d15e47fa15009f15b) |
|  | Device flags. |
...
|  | Initialize a device. |
| int | [device\_deinit](#ga73c949c90a7434a7ad31dc9047166417) (const struct [device](structdevice.md) \*dev) |
|  | De-initialize a device. |

| Device flags | |
| --- | --- |
| #define | [DEVICE\_FLAG\_INIT\_DEFERRED](#ga9541cb57fcd27619621668e4034d034d)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
...
`#include <[zephyr/device.h](device_8h.md)>`
...
[DEVICE\_DEINIT\_DEFINE](#ga61d851f960a701c9d47d6167b35ac99c)(dev\_id, name, init\_fn, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), pm, data, config, \

level, prio, api)

[DEVICE\_DEINIT\_DEFINE](#ga61d851f960a701c9d47d6167b35ac99c)

#define DEVICE\_DEINIT\_DEFINE(dev\_id, name, init\_fn, deinit\_fn, pm, data, config, level, prio, api)
...
## [◆ ](#ga61d851f960a701c9d47d6167b35ac99c)DEVICE\_DEINIT\_DEFINE

| #define DEVICE\_DEINIT\_DEFINE | ( |  | *dev\_id*, |
| --- | --- | --- | --- |
|  |  |  | *name*, |
|  |  |  | *init\_fn*, |
|  |  |  | *deinit\_fn*, |
...
Z\_DEVICE\_DEFINE([DT\_INVALID\_NODE](group__devicetree-generic-id.md#ga710cc4455dd7e738f43f750153163855), dev\_id, name, init\_fn, deinit\_fn, 0U, \
...
This macro defines a [device](structdevice.md "device") that is automatically configured by the kernel during system initialization. This macro should only be used when the device is not being allocated from a devicetree node. If you are allocating a device from a devicetree node, use [DEVICE\_DT\_DEINIT\_DEFINE()](#gaa53f7267950569df898b0e5362e6f583) or [DEVICE\_DT\_INST\_DEINIT\_DEFINE()](#ga85eecc663e60efa947a59844bcb0bb54) instead.

Note: deinit\_fn will only be used if CONFIG\_DEVICE\_DEINIT\_SUPPORT is enabled.
...
:   | dev\_id | A unique token which is used in the name of the global device structure as a C identifier. |
    ...
    | deinit\_fn | Pointer to the device's de-initialization function. Can be [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4). It must release any acquired resources (e.g. pins, bus, clock...) and leave the device in its reset state. |
...
[DEVICE\_DT\_DEINIT\_DEFINE](#gaa53f7267950569df898b0e5362e6f583)(node\_id, init\_fn, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), pm, data, config, \

level, prio, api, \_\_VA\_ARGS\_\_)

[DEVICE\_DT\_DEINIT\_DEFINE](#gaa53f7267950569df898b0e5362e6f583)

#define DEVICE\_DT\_DEINIT\_DEFINE(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api,...)
...
## [◆ ](#gaa53f7267950569df898b0e5362e6f583)DEVICE\_DT\_DEINIT\_DEFINE

| #define DEVICE\_DT\_DEINIT\_DEFINE | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *init\_fn*, |
|  |  |  | *deinit\_fn*, |
|  |  |  | *pm*, |
...
[DEVICE\_DT\_NAME](#gad864d7a50ee45285dacd68be1e5a49ce)(node\_id), init\_fn, deinit\_fn, \

Z\_DEVICE\_DT\_FLAGS(node\_id), pm, data, config, level, \
...
## [◆ ](#ga85eecc663e60efa947a59844bcb0bb54)DEVICE\_DT\_INST\_DEINIT\_DEFINE

| #define DEVICE\_DT\_INST\_DEINIT\_DEFINE | ( |  | *inst*, |
| --- | --- | --- | --- |
|  |  |  | ... ) |
...
[DEVICE\_DT\_DEINIT\_DEFINE](#gaa53f7267950569df898b0e5362e6f583)([DT\_DRV\_INST](group__devicetree-inst.md#ga219f413efba2f4c0151468b9a25a8dc1)(inst), \_\_VA\_ARGS\_\_)
...
## [◆ ](#ga9541cb57fcd27619621668e4034d034d)DEVICE\_FLAG\_INIT\_DEFERRED

| #define DEVICE\_FLAG\_INIT\_DEFERRED   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| --- |
...
## [◆ ](#gae3daac2d0f7f881d15e47fa15009f15b)device\_flags\_t
...
## [◆ ](#ga73c949c90a7434a7ad31dc9047166417)device\_deinit()

| int device\_deinit | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Note: this will be available if CONFIG\_DEVICE\_DEINIT\_SUPPORT is enabled.

Warning
:   It is the responsibility of the caller to ensure that the device is ready to be de-initialized.

Parameters
:   | dev | device to be de-initialized. |
    | --- | --- |

Return values
:   | 0 | If successful |
    | --- | --- |
    | -EPERM | If device has not been initialized. |
    | -ENOTSUP | If device does not support de-initialization, or if the feature is not enabled (see CONFIG\_DEVICE\_DEINIT\_SUPPORT) |
    | -errno | For any other errors. |
...
Return values
:   | -EALREADY | Device is already initialized. |
    | --- | --- |
