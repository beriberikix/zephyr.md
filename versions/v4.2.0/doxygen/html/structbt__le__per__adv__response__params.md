---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__le__per__adv__response__params.html
...
This struct contains the parameters used when sending a response to a periodic advertising request (see [bt\_le\_per\_adv\_set\_response\_data](group__bt__gap.md#gaae6b8583f7d5457f20b03dccd146425e "bt_le_per_adv_set_response_data") function). The response is sent in the specified subevent and response slot, and includes event and subevent counters to track the request the response corresponds to.
