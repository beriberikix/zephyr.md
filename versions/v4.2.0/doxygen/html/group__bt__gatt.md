---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__gatt.html
...
| enum | [bt\_gatt\_attr\_write\_flag](#ga830d437c8d0757f53af1de6aa3031906) { [BT\_GATT\_WRITE\_FLAG\_PREPARE](#gga830d437c8d0757f53af1de6aa3031906a019cf6118a0cfacbfad20c1cc5838383) = BIT(0) , [BT\_GATT\_WRITE\_FLAG\_CMD](#gga830d437c8d0757f53af1de6aa3031906a770df41b7d433e8ce349b19e4657ba78) = BIT(1) , [BT\_GATT\_WRITE\_FLAG\_EXECUTE](#gga830d437c8d0757f53af1de6aa3031906ad4e8f43c03da10c15685bd1a0109708b) = BIT(2) } |
|  | GATT attribute write flags. [More...](#ga830d437c8d0757f53af1de6aa3031906) |

## Detailed Description

Generic Attribute Profile (GATT).

The GATT layer manages the service database by providing APIs for service registration and attribute declaration. For more information, see [GATT Client APIs](group__bt__gatt__client.md "GATT Client APIs") and [GATT Server APIs](group__bt__gatt__server.md "GATT Server APIs").
...
If `flags` contains [BT\_GATT\_WRITE\_FLAG\_PREPARE](#gga830d437c8d0757f53af1de6aa3031906a019cf6118a0cfacbfad20c1cc5838383), then the method shall not perform a write, but instead only check if the write is authorized and return an error code if not.
...
:   | conn | The connection that is requesting to write |
    ...
    | [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9) | Flags of type [bt\_gatt\_attr\_write\_flag](#ga830d437c8d0757f53af1de6aa3031906) |
...
## [◆ ](#ga830d437c8d0757f53af1de6aa3031906)bt\_gatt\_attr\_write\_flag
...
| BT\_GATT\_WRITE\_FLAG\_EXECUTE | Attribute write execute flag.  If set, indicates that write operation is a execute, which indicates the end of a long write, and will come after 1 or more [BT\_GATT\_WRITE\_FLAG\_PREPARE](#gga830d437c8d0757f53af1de6aa3031906a019cf6118a0cfacbfad20c1cc5838383). |
...
| BT\_GATT\_PERM\_PREPARE\_WRITE | Attribute prepare write permission.  If set, allows prepare writes with use of [BT\_GATT\_WRITE\_FLAG\_PREPARE](#gga830d437c8d0757f53af1de6aa3031906a019cf6118a0cfacbfad20c1cc5838383) passed to write callback. |
