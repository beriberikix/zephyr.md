---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/log__frontend__stmesp_8h_source.html
...
[ 110](log__frontend__stmesp_8h.md#ae583dd282c17ad3330955b98206b401a)#define LOG\_FRONTEND\_STMESP\_LOG0(\_source, ...) \

111 do { \

112 static const char \_str[] \_\_in\_section(\_log\_stmesp\_str, static, \_) \

113 \_\_used \_\_noasan \_\_aligned(sizeof(uint32\_t)) = GET\_ARG\_N(1, \_\_VA\_ARGS\_\_); \

114 static const char \*\_str\_ptr \_\_in\_section(\_log\_stmesp\_ptr, static, \_) \

115 \_\_used \_\_noasan = \_str; \

116 uint32\_t \_idx = \

117 ((uintptr\_t)&\_str\_ptr - (uintptr\_t)TYPE\_SECTION\_START(log\_stmesp\_ptr)) / \

118 sizeof(void \*); \

119 log\_frontend\_stmesp\_log0(\_source, \_idx); \

120 } while (0)

121

[ 127](log__frontend__stmesp_8h.md#ae82104c26a3426e5c1ab45ba1149204a)#define LOG\_FRONTEND\_STMESP\_LOG1(\_source, ...) \

128 do { \

129 static const char \_str[] \_\_in\_section(\_log\_stmesp\_str, static, \_) \

130 \_\_used \_\_noasan \_\_aligned(sizeof(uint32\_t)) = GET\_ARG\_N(1, \_\_VA\_ARGS\_\_); \

131 static const char \*\_str\_ptr \_\_in\_section(\_log\_stmesp\_ptr, static, \_) \

132 \_\_used \_\_noasan = \_str; \

133 uint32\_t \_idx = \

134 ((uintptr\_t)&\_str\_ptr - (uintptr\_t)TYPE\_SECTION\_START(log\_stmesp\_ptr)) / \

135 sizeof(void \*); \

136 log\_frontend\_stmesp\_log1(\_source, \_idx, (uintptr\_t)(GET\_ARG\_N(2, \_\_VA\_ARGS\_\_))); \
...
143#endif /\* ZEPHYR\_INCLUDE\_LOGGING\_LOG\_FRONTEND\_STMESP\_H\_ \*/
