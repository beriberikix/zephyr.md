---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structhid__device__ops.html
...
`#include <[zephyr/usb/class/usbd_hid.h](usbd__hid_8h_source.md)>`
...
| void(\* | [input\_report\_done](#ace79e5ef79606daf22b8f39794e9d19e) )(const struct [device](structdevice.md) \*dev, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*const report) |
...
## [◆ ](#ace79e5ef79606daf22b8f39794e9d19e)input\_report\_done

| void(\* hid\_device\_ops::input\_report\_done) (const struct [device](structdevice.md) \*dev, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*const report) |
| --- |
