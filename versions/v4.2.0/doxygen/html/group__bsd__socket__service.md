---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bsd__socket__service.html
...
| Macros | |
| --- | --- |
| #define | [NET\_SOCKET\_SERVICE\_SYNC\_DEFINE](#ga424f319f9ccc675f8eeca23cb2c91bc4)(name, cb, count) |
|  | Statically define a network socket service. |
| #define | [NET\_SOCKET\_SERVICE\_SYNC\_DEFINE\_STATIC](#gadee4c786ebf89706a6b0151244b55cc3)(name, cb, count) |
|  | Statically define a network socket service in a private (static) scope. |

| Typedefs | |
| --- | --- |
| typedef void(\* | [net\_socket\_service\_handler\_t](#ga5d9495470c1ade51791df56c59cfb1f5)) (struct [net\_socket\_service\_event](structnet__socket__service__event.md) \*pev) |
...
## [◆ ](#ga424f319f9ccc675f8eeca23cb2c91bc4)NET\_SOCKET\_SERVICE\_SYNC\_DEFINE
...
`#include <[zephyr/net/socket_service.h](socket__service_8h.md)>`

**Value:**

\_\_z\_net\_socket\_service\_define(name, cb, count)
...
## [◆ ](#gadee4c786ebf89706a6b0151244b55cc3)NET\_SOCKET\_SERVICE\_SYNC\_DEFINE\_STATIC
...
\_\_z\_net\_socket\_service\_define(name, cb, count, static)
...
## [◆ ](#ga5d9495470c1ade51791df56c59cfb1f5)net\_socket\_service\_handler\_t

| typedef void(\* net\_socket\_service\_handler\_t) (struct [net\_socket\_service\_event](structnet__socket__service__event.md) \*pev) |
| --- |
...
Parameters
:   | pev | the socket service event that provided the handler. |
    | --- | --- |
