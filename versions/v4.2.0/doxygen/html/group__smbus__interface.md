---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__smbus__interface.html
...
| Functions | |
| --- | --- |
| static void | [smbus\_xfer\_stats](#ga0a63b800c14f5831730372b9bad41864) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) sent, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [recv](posix_2sys_2socket_8h.md#adee01662b0cf762a014efd87ab811276)) |
...
`#include <[zephyr/drivers/smbus.h](smbus_8h.md)>`
...
[NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), Z\_DEVICE\_DT\_FLAGS(node\_id), [pm\_device](structpm__device.md), \
