---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__gpio__interface.html
...
|  | [MAX32-specific GPIO Flags](group__gpio__interface__max32.md) |
|  | MAX32-specific GPIO Flags. |
|  | [nPM13xx-specific GPIO Flags](group__gpio__interface__npm13xx.md) |
|  | nPM13xx-specific GPIO Flags |
|  | [nPM2100-specific GPIO Flags](group__gpio__interface__npm2100.md) |
...
| #define | [GPIO\_INT\_WAKEUP](#ga644109ce84c8feffe1226b9b50122a96)   (1 << 6) |
...
| --- | --- |
| #define | [GPIO\_INPUT](#ga7be6a0cc9aa65da1d4ee5751b4085853)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(16) |
|  | Enables pin as input. |
| #define | [GPIO\_OUTPUT](#ga0db9fe8a278e6ab7c5c6f14fe58e5eb1)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(17) |
...
| #define | [GPIO\_INT\_DISABLE](#ga91657faac28f9b213105dd61a419dd5a)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(21) |
...
| #define | [STM32\_GPIO\_WKUP](#ga9a05f736e9ee915f591a65a7f6d382d3)   (1 << 8) |
|  | STM32 GPIO specific flags. |
| #define | [STM32\_GPIO\_LOW\_SPEED](#gaa8d19f48bfea73193ff35c06a6894df6)   (0x0 << STM32\_GPIO\_SPEED\_SHIFT) |
|  | Configure the GPIO pin output speed to be low. |
| #define | [STM32\_GPIO\_MEDIUM\_SPEED](#gaee4f9eb7cb958d4a55d13029658bdff3)   (0x1 << STM32\_GPIO\_SPEED\_SHIFT) |
|  | Configure the GPIO pin output speed to be medium. |
| #define | [STM32\_GPIO\_HIGH\_SPEED](#gac91d2b48bc764131896ebb3b0436dac1)   (0x2 << STM32\_GPIO\_SPEED\_SHIFT) |
|  | Configure the GPIO pin output speed to be high. |
| #define | [STM32\_GPIO\_VERY\_HIGH\_SPEED](#gaeff690b8406b0ed24f97bbe8ab4bf31e)   (0x3 << STM32\_GPIO\_SPEED\_SHIFT) |
...
`#include <[zephyr/dt-bindings/gpio/gpio.h](dt-bindings_2gpio_2gpio_8h.md)>`
...
`#include <[zephyr/drivers/gpio.h](drivers_2gpio_8h.md)>`
...
[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)([DT\_PROP\_HAS\_IDX](group__devicetree-generic-prop.md#ga479dfc704087eea7e7c5af42ae98576c)(node\_id, prop, idx), \
...
If the devicetree node identifier 'node\_id' refers to a node with a property 'prop', and the index `idx` is valid for that property, this expands to [GPIO\_DT\_SPEC\_GET\_BY\_IDX(node\_id, prop, idx)](#gacb1077b77aecf8f1a9c7636ea583c4cf). The `default_value` parameter is not expanded in this case.
...
| #define GPIO\_INPUT   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(16) |
| --- |
...
| #define GPIO\_INT\_DISABLE   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(21) |
| --- |
...
## [◆ ](#ga644109ce84c8feffe1226b9b50122a96)GPIO\_INT\_WAKEUP

| #define GPIO\_INT\_WAKEUP   (1 << 6) |
| --- |
...
| #define GPIO\_OUTPUT   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(17) |
| --- |
...
## [◆ ](#gac91d2b48bc764131896ebb3b0436dac1)STM32\_GPIO\_HIGH\_SPEED

| #define STM32\_GPIO\_HIGH\_SPEED   (0x2 << STM32\_GPIO\_SPEED\_SHIFT) |
| --- |

`#include <[zephyr/dt-bindings/gpio/stm32-gpio.h](stm32-gpio_8h.md)>`

Configure the GPIO pin output speed to be high.

## [◆ ](#gaa8d19f48bfea73193ff35c06a6894df6)STM32\_GPIO\_LOW\_SPEED

| #define STM32\_GPIO\_LOW\_SPEED   (0x0 << STM32\_GPIO\_SPEED\_SHIFT) |
| --- |
...
## [◆ ](#gaee4f9eb7cb958d4a55d13029658bdff3)STM32\_GPIO\_MEDIUM\_SPEED

| #define STM32\_GPIO\_MEDIUM\_SPEED   (0x1 << STM32\_GPIO\_SPEED\_SHIFT) |
| --- |
...
## [◆ ](#gaeff690b8406b0ed24f97bbe8ab4bf31e)STM32\_GPIO\_VERY\_HIGH\_SPEED

| #define STM32\_GPIO\_VERY\_HIGH\_SPEED   (0x3 << STM32\_GPIO\_SPEED\_SHIFT) |
| --- |
...
## [◆ ](#ga9a05f736e9ee915f591a65a7f6d382d3)STM32\_GPIO\_WKUP

| #define STM32\_GPIO\_WKUP   (1 << 8) |
| --- |
...
The driver flags are encoded in the 8 upper bits of [gpio\_dt\_flags\_t](#gad435719dccdc37c05852960a7218fbd2) as follows:

- Bit 8: Configure a GPIO pin to power on the system after Poweroff.
- Bit 10..9: Configure the output speed of a GPIO pin. Configures a GPIO pin to power on the system after Poweroff. This flag is reserved to GPIO pins that are associated with wake-up pins in STM32 PWR devicetree node, through the property "wkup-gpios".
...
| | int gpio\_pin\_interrupt\_configure | ( | const struct [device](structdevice.md) \* | *port*, | | --- | --- | --- | --- | |  |  | [gpio\_pin\_t](#ga38179eb7a46a743c12cfac28f347fb34) | *pin*, | |  |  | [gpio\_flags\_t](#ga5f5cb5e7dae6d58e072bb450af029d2e) | *flags* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int gpio\_pin\_interrupt\_configure\_dt | ( | const struct [gpio\_dt\_spec](structgpio__dt__spec.md) \* | *spec*, | | --- | --- | --- | --- | |  |  | [gpio\_flags\_t](#ga5f5cb5e7dae6d58e072bb450af029d2e) | *flags* ) | | inlinestaticisr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
