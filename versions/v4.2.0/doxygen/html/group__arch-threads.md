---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__arch-threads.html
...
| Macros | |
| --- | --- |
| #define | [ARCH\_KERNEL\_STACK\_RESERVED](#ga75b8e6cce01f5a34e9f3d649e561c3af)   Z\_ARM64\_STACK\_GUARD\_SIZE |
...
| int | [arch\_swap](#ga05c03d97386bc973a403102f4c048444) ([unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int key) |
|  | Cooperatively context switch. |
| static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) void | [arch\_thread\_return\_value\_set](#ga61b6981d7dd768fa01922c6c6ab9780f) (struct [k\_thread](structk__thread.md) \*thread, [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int value) |
...
## [◆ ](#ga75b8e6cce01f5a34e9f3d649e561c3af)ARCH\_KERNEL\_STACK\_RESERVED

| #define ARCH\_KERNEL\_STACK\_RESERVED   Z\_ARM64\_STACK\_GUARD\_SIZE |
| --- |

`#include <[zephyr/arch/arm64/thread_stack.h](arch_2arm64_2thread__stack_8h.md)>`

MPU guard size for kernel-only stacks.

If MPU stack guards are used to catch stack overflows, specify the amount of space reserved in kernel stack objects. If guard sizes are context dependent, this should be in the minimum guard size, with remaining space carved out if needed.
...
## [◆ ](#ga05c03d97386bc973a403102f4c048444)arch\_swap()

| int arch\_swap | ( | [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int | *key* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Must be called with interrupts locked with the provided key. This is the older-style context switching method, which is incompatible with SMP. New arch ports, either SMP or UP, are encouraged to implement [arch\_switch()](#gab411d82ce5b60f062171f5a19e33e025) instead.

Parameters
:   | key | Interrupt locking key |
    | --- | --- |

Returns
:   If woken from blocking on some kernel object, the result of that blocking operation.
...
## [◆ ](#ga61b6981d7dd768fa01922c6c6ab9780f)arch\_thread\_return\_value\_set()

| | [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) void arch\_thread\_return\_value\_set | ( | struct [k\_thread](structk__thread.md) \* | *thread*, | | --- | --- | --- | --- | |  |  | [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int | *value* ) | | static |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
It is assumed that the specified *thread* is pending.

Parameters
:   | thread | Pointer to thread object |
    | --- | --- |
    | value | value to set as return value |
