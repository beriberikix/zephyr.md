---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mcumgr__callback__api__fs__mgmt.html
...
`#include <[zephyr/mgmt/mcumgr/grp/fs_mgmt/fs_mgmt_callbacks.h](fs__mgmt__callbacks_8h.md)>`

The type of operation that is being requested for a given file access callback.

| Enumerator | |
| --- | --- |
| FS\_MGMT\_FILE\_ACCESS\_READ | Access to read file (file download). |
| FS\_MGMT\_FILE\_ACCESS\_WRITE | Access to write file (file upload). |
