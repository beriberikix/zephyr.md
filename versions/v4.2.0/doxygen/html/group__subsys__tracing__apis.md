---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__subsys__tracing__apis.html
...
|  | FIFO Tracing APIs. |
|  | [GPIO Tracing APIs](group__subsys__tracing__apis__gpio.md) |
|  | GPIO Tracing APIs. |
...
|  | Mutex Tracing APIs. |
|  | [Named tracing APIs](group__subsys__tracing__apis__named.md) |
|  | Named Tracing APIs. |
|  | [Network Core Tracing APIs](group__subsys__tracing__apis__net.md) |
|  | Network Core Tracing APIs. |
|  | [Network Socket Tracing APIs](group__subsys__tracing__apis__socket.md) |
...
| Macros | |
| --- | --- |
| #define | [sys\_trace\_sys\_init\_enter](#ga9b5a02fc57b86d38f857597c7a2553f6)(entry, level) |
|  | Called when entering an init function. |
| #define | [sys\_trace\_sys\_init\_exit](#gacd56f9b376b4639cbe21e12055ca74c7)(entry, level, result) |
...
| void | [sys\_trace\_idle\_exit](#gac7b7973acf38a440e88242aca52e424c) (void) |
...
## [◆ ](#ga9b5a02fc57b86d38f857597c7a2553f6)sys\_trace\_sys\_init\_enter

| #define sys\_trace\_sys\_init\_enter | ( |  | *entry*, |
| --- | --- | --- | --- |
|  |  |  | *level* ) |
...
## [◆ ](#gacd56f9b376b4639cbe21e12055ca74c7)sys\_trace\_sys\_init\_exit

| #define sys\_trace\_sys\_init\_exit | ( |  | *entry*, |
| --- | --- | --- | --- |
|  |  |  | *level*, |
|  |  |  | *result* ) |
...
## [◆ ](#gac7b7973acf38a440e88242aca52e424c)sys\_trace\_idle\_exit()
