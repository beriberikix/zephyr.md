---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/fixed-partitions_8h.html
...
| #define | [DT\_FIXED\_SUBPARTITION\_EXISTS](group__devicetree-fixed-partition.md#ga14a8091e4a46de4314c5bbacc0451726)(node\_id) |
|  | Test if fixed-subpartitions compatible node exists. |
| #define | [DT\_MEM\_FROM\_FIXED\_SUBPARTITION](group__devicetree-fixed-partition.md#ga1bff6b50b50e9c926a7779d9ee2aaba3)(node\_id) |
|  | Get the node identifier of the flash memory for a subpartition. |
| #define | [DT\_MTD\_FROM\_FIXED\_SUBPARTITION](group__devicetree-fixed-partition.md#ga9e6ffb2c5a623d9e49333302f8e1a834)(node\_id) |
|  | Get the node identifier of the flash controller for a subpartition. |
| #define | [DT\_FIXED\_SUBPARTITION\_ADDR](group__devicetree-fixed-partition.md#gac3fb38b3219320d67f24f02518eb29c1)(node\_id) |
