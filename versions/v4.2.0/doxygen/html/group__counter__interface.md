---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__counter__interface.html
...
| typedef int(\* | [counter\_api\_reset](#gaa88f8ff5bcfe4cae02d88c0fe3a5a0d7)) (const struct [device](structdevice.md) \*dev) |
...
| int | [counter\_reset](#ga225705f1f6f3bef127de8ef84dcfba4e) (const struct [device](structdevice.md) \*dev) |
...
`#include <[zephyr/drivers/counter.h](drivers_2counter_8h.md)>`
...
## [◆ ](#gaa88f8ff5bcfe4cae02d88c0fe3a5a0d7)counter\_api\_reset

| typedef int(\* counter\_api\_reset) (const struct [device](structdevice.md) \*dev) |
| --- |
...
## [◆ ](#ga225705f1f6f3bef127de8ef84dcfba4e)counter\_reset()

| int counter\_reset | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
:   | 0 | If successful. |
    | --- | --- |
    | -errno | Negative error code on failure resetting the counter value. |
...
:   | 0 | if successful. |
    | --- | --- |
    | -ENOSYS | if function or flags are not supported. |
