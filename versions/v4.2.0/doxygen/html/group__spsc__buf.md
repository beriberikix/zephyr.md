---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__spsc__buf.html
...
`#include <[zephyr/sys/spsc_pbuf.h](spsc__pbuf_8h.md)>`
...
:   | struct | spsc\_pbuf\* Pointer to the created buffer. The pointer points to the same address as buf. |
    | --- | --- |
    | [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) | Invalid buffer alignment. |
