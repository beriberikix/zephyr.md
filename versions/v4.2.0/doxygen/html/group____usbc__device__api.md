---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group____usbc__device__api.html
...
`#include <[zephyr/usb_c/usbc.h](usbc_8h.md)>`
...
| MSG\_DISCARDED | Power Delivery discarded the message being transmitted. |
...
:   | pointer | to dpm data that was set with usbc\_set\_dpm\_data |
    | --- | --- |
    | [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) | if dpm data was not set |
