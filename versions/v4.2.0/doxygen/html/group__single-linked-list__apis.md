---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__single-linked-list__apis.html
...
|  | Initialize a list. |
| static [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | [sys\_slist\_peek\_head](#ga651a886700f4c043d4ecb561f2643b50) (const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \*list) |
|  | Peek the first node from the list. |
| static [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | [sys\_slist\_peek\_tail](#ga5490f1ee321747430011aaeeafba9d61) (const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \*list) |
|  | Peek the last node from the list. |
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_slist\_is\_empty](#gaefa93f17fb5412b376360bf06d3e8a78) (const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \*list) |
|  | Test if the given list is empty. |
| static [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | [sys\_slist\_peek\_next\_no\_check](#ga20d9679582c62f658c0bef0bdd3dd69a) (const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \*node) |
|  | Peek the next node from current node, node is not NULL. |
| static [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | [sys\_slist\_peek\_next](#gaafe204e39ec4468c8b83e96894d71877) (const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \*node) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_slist\_find](#ga26a42a8958a3c7c24f18a7ac959d8619) (const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \*list, const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \*node, [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \*\*prev) |
|  | Find if a node is already linked in a singly linked list. |
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [sys\_slist\_len](#gaac9635e7ae7ab0edc521973e4b457fb5) (const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \*list) |
...
`#include <[zephyr/sys/slist.h](slist_8h.md)>`
...
## [◆ ](#ga26a42a8958a3c7c24f18a7ac959d8619)sys\_slist\_find()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_slist\_find | ( | const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \* | *list*, | | --- | --- | --- | --- | |  |  | const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | *node*, | |  |  | [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \*\* | *prev* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaefa93f17fb5412b376360bf06d3e8a78)sys\_slist\_is\_empty()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_slist\_is\_empty | ( | const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaac9635e7ae7ab0edc521973e4b457fb5)sys\_slist\_len()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) sys\_slist\_len | ( | const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga651a886700f4c043d4ecb561f2643b50)sys\_slist\_peek\_head()

| | [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* sys\_slist\_peek\_head | ( | const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaafe204e39ec4468c8b83e96894d71877)sys\_slist\_peek\_next()

| | [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* sys\_slist\_peek\_next | ( | const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga20d9679582c62f658c0bef0bdd3dd69a)sys\_slist\_peek\_next\_no\_check()

| | [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* sys\_slist\_peek\_next\_no\_check | ( | const [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Faster then [sys\_slist\_peek\_next()](#gaafe204e39ec4468c8b83e96894d71877) if node is known not to be NULL.
...
## [◆ ](#ga5490f1ee321747430011aaeeafba9d61)sys\_slist\_peek\_tail()

| | [sys\_snode\_t](#ga69bf43aad81e3ee2d55250c59b857493) \* sys\_slist\_peek\_tail | ( | const [sys\_slist\_t](#ga44658c336b634c03938a251cdc8134f8) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
