---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__fuel__gauge__interface.html
...
| int | [fuel\_gauge\_get\_props](#gaf8a1fed5f6af9c25a12130c481411603) (const struct [device](structdevice.md) \*dev, const [fuel\_gauge\_prop\_t](#ga633eb1cb8dd64123252634b833b2f806) \*props, union [fuel\_gauge\_prop\_val](unionfuel__gauge__prop__val.md) \*vals, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) len) |
...
| int | [fuel\_gauge\_set\_props](#gac8efb10ccb6f510dc92618e218c1df9b) (const struct [device](structdevice.md) \*dev, const [fuel\_gauge\_prop\_t](#ga633eb1cb8dd64123252634b833b2f806) \*props, const union [fuel\_gauge\_prop\_val](unionfuel__gauge__prop__val.md) \*vals, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) len) |
|  | Set a battery fuel-gauge property. |
...
`#include <[zephyr/drivers/fuel_gauge.h](fuel__gauge_8h.md)>`
...
| FUEL\_GAUGE\_CURRENT\_DIRECTION | Battery current direction (flags). |
| FUEL\_GAUGE\_STATE\_OF\_CHARGE\_ALARM | Remaining state of charge alarm (percent, 0-100). |
| FUEL\_GAUGE\_LOW\_VOLTAGE\_ALARM | Low Cell Voltage Alarm (uV). |
...
## [◆ ](#gaf8a1fed5f6af9c25a12130c481411603)fuel\_gauge\_get\_props()

| int fuel\_gauge\_get\_props | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | const [fuel\_gauge\_prop\_t](#ga633eb1cb8dd64123252634b833b2f806) \* | *props*, |
...
## [◆ ](#gac8efb10ccb6f510dc92618e218c1df9b)fuel\_gauge\_set\_props()

| int fuel\_gauge\_set\_props | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | const [fuel\_gauge\_prop\_t](#ga633eb1cb8dd64123252634b833b2f806) \* | *props*, |
|  |  | const union [fuel\_gauge\_prop\_val](unionfuel__gauge__prop__val.md) \* | *vals*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *len* ) |
