---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__usb__hid__definitions.html
...
| #define | [HID\_USAGE\_SENSORS](#gab5d07369bed290a78a119d54240db567)   0x20 |
...
| #define | [HID\_USAGE\_SENSOR\_TYPE\_COLLECTION](#ga85a9547841ea4a2e4b56ba2a58e9d0ee)   0x001 |
|  | HID Sensors Collection Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_TYPE\_ENVIRONMENTAL\_TEMPERATURE](#ga00b6e4c7d3eb1576c9f3eb7bae076bab)   0x033 |
|  | HID Sensors Environmental Temperature Type Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_EVENT\_SENSOR\_STATE](#ga062651fd2ce433819e1d61d0488e4b7f)   0x201 |
|  | HID Sensors Event Sensor State Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_PROPERTY\_FRIENDLY\_NAME](#gaf5d0cd096b1a0591002a6438a977710c)   0x301 |
|  | HID Sensors Friendly Name Property Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_DATA\_ENVIRONMENTAL\_TEMPERATURE](#ga2108b2634377a0f8860b2f7de50f21e8)   0x434 |
|  | HID Sensors Enviromental Temperature Data Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_PROPERTY\_TIMESTAMP](#ga0f907ba7b85ff784dde9a14b38ed6fbb)   0x529 |
|  | HID Sensors Timestamp Property Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_UNDEFINED](#gaa5a61c460035086e103a4fa97b89efb6)   0x800 |
|  | HID Sensors Sensor State Undefined Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_READY](#gae37e00681768e24a1995a6766bd5ba77)   0x801 |
|  | HID Sensors Sensor State Ready Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NOT\_AVAILABLE](#ga5c897b459ec0f68d0825b6f454a49355)   0x802 |
|  | HID Sensors Sensor State Not Available Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NO\_DATA](#ga6948d4190e58386e184b0376b6c67584)   0x803 |
|  | HID Sensors Sensor State No Data Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_INITIALIZING](#ga347b9f96fc87f3e7f6540961e240ef5e)   0x804 |
|  | HID Sensors Sensor State Initializing Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ACCESS\_DENIED](#gacd020e8f8e80bf1592b750542684d915)   0x805 |
|  | HID Sensors Sensor State Access Denied Usage ID. |
| #define | [HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ERROR](#gaabb092d4a50f1f60298079d3e5a82242)   0x806 |
...
`#include <[zephyr/usb/class/hid.h](hid_8h.md)>`
...
## [◆ ](#ga85a9547841ea4a2e4b56ba2a58e9d0ee)HID\_USAGE\_SENSOR\_TYPE\_COLLECTION

| #define HID\_USAGE\_SENSOR\_TYPE\_COLLECTION   0x001 |
| --- |
...
## [◆ ](#gab5d07369bed290a78a119d54240db567)HID\_USAGE\_SENSORS

| #define HID\_USAGE\_SENSORS   0x20 |
| --- |
...
## [◆ ](#ga2108b2634377a0f8860b2f7de50f21e8)HID\_USAGE\_SENSORS\_DATA\_ENVIRONMENTAL\_TEMPERATURE

| #define HID\_USAGE\_SENSORS\_DATA\_ENVIRONMENTAL\_TEMPERATURE   0x434 |
| --- |
...
## [◆ ](#ga062651fd2ce433819e1d61d0488e4b7f)HID\_USAGE\_SENSORS\_EVENT\_SENSOR\_STATE

| #define HID\_USAGE\_SENSORS\_EVENT\_SENSOR\_STATE   0x201 |
| --- |
...
## [◆ ](#gaf5d0cd096b1a0591002a6438a977710c)HID\_USAGE\_SENSORS\_PROPERTY\_FRIENDLY\_NAME

| #define HID\_USAGE\_SENSORS\_PROPERTY\_FRIENDLY\_NAME   0x301 |
| --- |
...
## [◆ ](#ga0f907ba7b85ff784dde9a14b38ed6fbb)HID\_USAGE\_SENSORS\_PROPERTY\_TIMESTAMP

| #define HID\_USAGE\_SENSORS\_PROPERTY\_TIMESTAMP   0x529 |
| --- |
...
## [◆ ](#gacd020e8f8e80bf1592b750542684d915)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ACCESS\_DENIED

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ACCESS\_DENIED   0x805 |
| --- |
...
## [◆ ](#gaabb092d4a50f1f60298079d3e5a82242)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ERROR

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_ERROR   0x806 |
| --- |
...
## [◆ ](#ga347b9f96fc87f3e7f6540961e240ef5e)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_INITIALIZING

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_INITIALIZING   0x804 |
| --- |
...
## [◆ ](#ga6948d4190e58386e184b0376b6c67584)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NO\_DATA

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NO\_DATA   0x803 |
| --- |
...
## [◆ ](#ga5c897b459ec0f68d0825b6f454a49355)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NOT\_AVAILABLE

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_NOT\_AVAILABLE   0x802 |
| --- |
...
## [◆ ](#gae37e00681768e24a1995a6766bd5ba77)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_READY

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_READY   0x801 |
| --- |
...
## [◆ ](#gaa5a61c460035086e103a4fa97b89efb6)HID\_USAGE\_SENSORS\_SENSOR\_STATE\_UNDEFINED

| #define HID\_USAGE\_SENSORS\_SENSOR\_STATE\_UNDEFINED   0x800 |
| --- |
...
## [◆ ](#ga00b6e4c7d3eb1576c9f3eb7bae076bab)HID\_USAGE\_SENSORS\_TYPE\_ENVIRONMENTAL\_TEMPERATURE

| #define HID\_USAGE\_SENSORS\_TYPE\_ENVIRONMENTAL\_TEMPERATURE   0x033 |
| --- |
