---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structuac2__ops.html
...
[Connectivity](group__connectivity.md) » [USB](group__usb.md) » [USB Audio Class 2 device API](group__uac2__device.md)

USB Audio 2 application event handlers.
[More...](#details)

`#include <[zephyr/usb/class/usbd_uac2.h](usbd__uac2_8h_source.md)>`
...
| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f)(\* | [get\_sample\_rate](#ad8a5599b97edbecc653da41a970f378d) )(const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) clock\_id, void \*user\_data) |
|  | Get active sample rate. |
| int(\* | [set\_sample\_rate](#ab658d1468ba300f882dfb61e3e73ed1b) )(const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) clock\_id, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) rate, void \*user\_data) |
...
This function releases buffer provided in [usbd\_uac2\_send](group__uac2__device.md#gae899d75d786f5b1df86db48de88d1254 "usbd_uac2_send") when the class no longer needs it. This callback is mandatory to register if calling [usbd\_uac2\_send](group__uac2__device.md#gae899d75d786f5b1df86db48de88d1254 "usbd_uac2_send").

Parameters
:   | dev | USB Audio 2 device |
    | --- | --- |
    | terminal | Output Terminal ID linked to AudioStreaming interface |
    | buf | Buffer previously provided via [usbd\_uac2\_send](group__uac2__device.md#gae899d75d786f5b1df86db48de88d1254 "usbd_uac2_send") |
...
This function releases buffer obtained in [get\_recv\_buf](#ab41274aadc39d39cbcbfe0047a56f24b) after USB has written data to the buffer and/or no longer needs it. This callback is mandatory to register for devices receiving USB audio from the USB host.
...
USB stack calls this function to obtain receive buffer address for AudioStreaming interface. The buffer is owned by USB stack until [data\_recv\_cb](#abb973db8018d09ba34f508c4e8aff573) callback is called. The buffer must be sufficiently aligned and otherwise suitable for use by UDC driver. This callback is mandatory to register for devices receiving USB audio from the USB host.
...
## [◆ ](#ad8a5599b97edbecc653da41a970f378d)get\_sample\_rate

| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f)(\* uac2\_ops::get\_sample\_rate) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) clock\_id, void \*user\_data) |
| --- |
...
:   | dev | USB Audio 2 device |
    | --- | --- |
    | clock\_id | Clock Source ID whose sample rate should be returned |
    | user\_data | Opaque user data pointer |

Returns
:   Active sample rate in Hz

## [◆ ](#ab658d1468ba300f882dfb61e3e73ed1b)set\_sample\_rate

| int(\* uac2\_ops::set\_sample\_rate) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) clock\_id, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) rate, void \*user\_data) |
| --- |
...
:   | dev | USB Audio 2 device |
    | --- | --- |
    | clock\_id | Clock Source ID whose sample rate should be set |
