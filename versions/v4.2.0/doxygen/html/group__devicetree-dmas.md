---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__devicetree-dmas.html
...
| #define | [DT\_DMAS\_CELL\_BY\_NAME\_OR](#ga2843380c317657cd5f50cdacb9e93939)(node\_id, name, cell, default\_value) |
|  | Like [DT\_DMAS\_CELL\_BY\_NAME()](#ga1b80ae7fee6bcc9aa2ad03435e70dd14), but with a fallback to `default_value`. |
...
`#include <[zephyr/devicetree/dma.h](devicetree_2dma_8h.md)>`
...
## [◆ ](#ga2843380c317657cd5f50cdacb9e93939)DT\_DMAS\_CELL\_BY\_NAME\_OR

| #define DT\_DMAS\_CELL\_BY\_NAME\_OR | ( |  | *node\_id*, |
| --- | --- | --- | --- |
|  |  |  | *name*, |
|  |  |  | *cell*, |
|  |  |  | *default\_value* ) |
...
[DT\_PHA\_BY\_NAME\_OR](group__devicetree-generic-prop.md#ga79cda6ca70cc1e27b034ad096d4f4401)(node\_id, dmas, name, cell, default\_value)
...
If the value exists, this expands to [DT\_DMAS\_CELL\_BY\_NAME(node\_id,
name, cell)](#ga1b80ae7fee6bcc9aa2ad03435e70dd14). The `default_value` parameter is not expanded in this case.
