---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__conn__auth__info__cb.html
...
| void(\* | [br\_bond\_deleted](#afcb8dae77f7b4df3ed0741de65f7f5d0) )(const [bt\_addr\_t](structbt__addr__t.md) \*peer) |
...
## [◆ ](#afcb8dae77f7b4df3ed0741de65f7f5d0)br\_bond\_deleted

| void(\* bt\_conn\_auth\_info\_cb::br\_bond\_deleted) (const [bt\_addr\_t](structbt__addr__t.md) \*peer) |
| --- |

Notify that bond of classic has been deleted.

This callback notifies the application that the bond information of classic for the remote peer has been deleted
