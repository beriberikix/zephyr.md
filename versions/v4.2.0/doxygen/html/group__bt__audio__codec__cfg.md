---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__audio__codec__cfg.html
...
| int | [bt\_audio\_codec\_cfg\_meta\_get\_assisted\_listening\_stream](#ga22ae14fce65b757e31f391c4bdcae328) (const struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \*codec\_cfg) |
|  | Extract assisted listening stream. |
| int | [bt\_audio\_codec\_cfg\_meta\_set\_assisted\_listening\_stream](#ga67d83559cbe6cfab235f2e588cbc398c) (struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \*codec\_cfg, enum [bt\_audio\_assisted\_listening\_stream](group__bt__audio.md#ga207fbf0fbca9b24cba02c7f1d184e7f5) val) |
|  | Set the assisted listening stream value of a codec configuration metadata. |
| int | [bt\_audio\_codec\_cfg\_meta\_get\_broadcast\_name](#ga5d80babcd6f381014e1fae98a755e1d3) (const struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \*codec\_cfg, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*\*broadcast\_name) |
|  | Extract broadcast name. |
| int | [bt\_audio\_codec\_cfg\_meta\_set\_broadcast\_name](#ga4f5cbacebedc8d7df02d1c47b140bf3c) (struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \*codec\_cfg, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*broadcast\_name, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) broadcast\_name\_len) |
...
`#include <[zephyr/bluetooth/audio/audio.h](bluetooth_2audio_2audio_8h.md)>`
...
Return values
:   | duration | The assigned numbers frame duration ([bt\_audio\_codec\_cfg\_frame\_dur](group__bt__audio.md#ga83701b5eadfcbc9b84dc0b1a85ebeb74 "bt_audio_codec_cfg_frame_dur")). |
    | --- | --- |
    | -EINVAL | Arguments are invalid. |
...
Return values
:   | frequency | The assigned numbers frequency ([bt\_audio\_codec\_cfg\_freq](group__bt__audio.md#ga8e99fb678cc011bb8c9f6e1858bae0d7 "bt_audio_codec_cfg_freq")). |
    | --- | --- |
    | -EINVAL | Arguments are invalid. |
...
Return values
:   | frame\_blocks\_per\_sdu | The count of codec frame blocks in each SDU. |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENODATA | Data not found |
    | -EBADMSG | The found value has invalid size or value |
...
Return values
:   | frequency | A [bt\_audio\_codec\_cfg\_frame\_dur](group__bt__audio.md#ga83701b5eadfcbc9b84dc0b1a85ebeb74 "bt_audio_codec_cfg_frame_dur") value |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENODATA | Data not found |
    | -EBADMSG | The found value has invalid size or value |
...
Return values
:   | frequency | A [bt\_audio\_codec\_cfg\_freq](group__bt__audio.md#ga8e99fb678cc011bb8c9f6e1858bae0d7 "bt_audio_codec_cfg_freq") value |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENODATA | Data not found |
    | -EBADMSG | The found value has invalid size or value |
...
Return values
:   | frame\_length | Frame length in octets |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENODATA | Data not found |
    | -EBADMSG | The found value has invalid size or value |
...
## [◆ ](#ga22ae14fce65b757e31f391c4bdcae328)bt\_audio\_codec\_cfg\_meta\_get\_assisted\_listening\_stream()

| int bt\_audio\_codec\_cfg\_meta\_get\_assisted\_listening\_stream | ( | const struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \* | *codec\_cfg* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga5d80babcd6f381014e1fae98a755e1d3)bt\_audio\_codec\_cfg\_meta\_get\_broadcast\_name()

| int bt\_audio\_codec\_cfg\_meta\_get\_broadcast\_name | ( | const struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \* | *codec\_cfg*, |
| --- | --- | --- | --- |
...
Return values
:   | parental\_rating | The parental rating if positive or 0 |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENODATA | Data not found |
    | -EBADMSG | The found value has invalid size |
...
## [◆ ](#ga67d83559cbe6cfab235f2e588cbc398c)bt\_audio\_codec\_cfg\_meta\_set\_assisted\_listening\_stream()

| int bt\_audio\_codec\_cfg\_meta\_set\_assisted\_listening\_stream | ( | struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \* | *codec\_cfg*, |
| --- | --- | --- | --- |
...
Return values
:   | data\_len | The `codec_cfg.data_len` on success |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENOMEM | The new value could not be set or added due to lack of memory |
...
## [◆ ](#ga4f5cbacebedc8d7df02d1c47b140bf3c)bt\_audio\_codec\_cfg\_meta\_set\_broadcast\_name()

| int bt\_audio\_codec\_cfg\_meta\_set\_broadcast\_name | ( | struct [bt\_audio\_codec\_cfg](structbt__audio__codec__cfg.md) \* | *codec\_cfg*, |
| --- | --- | --- | --- |
|  |  | const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *broadcast\_name*, |
...
Return values
:   | meta\_len | The `codec_cfg.meta_len` on success |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
    | -ENOMEM | The new value could not be set or added due to lack of memory |
...
Return values
:   | meta\_len | The of `codec_cfg.meta_len` success |
    | --- | --- |
    | -EINVAL | Arguments are invalid |
