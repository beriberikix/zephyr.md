---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mdf__interface__axp192.html
...
`#include <[zephyr/drivers/mfd/axp192.h](drivers_2mfd_2axp192_8h.md)>`

Request a GPIO pin to be configured to a specific function.

GPIO0..5 of AXP192 feature various functions (see [axp192\_gpio\_func](drivers_2mfd_2axp192_8h.md#ac92e5fa77591e02e49570d1a1c38e249 "axp192_gpio_func") for details). A GPIO can only be used by one driver instance. Subsequential calls on the same GPIO will overwrite according function.
