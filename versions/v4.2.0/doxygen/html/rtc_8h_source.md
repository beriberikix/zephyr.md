---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/rtc_8h_source.html
...
[ 371](group__rtc__interface.md#ga90d7f422ca15cf679aa7ba61fb5373f0)static inline int [rtc\_alarm\_set\_callback](group__rtc__interface.md#ga90d7f422ca15cf679aa7ba61fb5373f0)(const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) id,

372 [rtc\_alarm\_callback](group__rtc__interface.md#ga8fc3b6037a95e97b686875beff9a581d) callback, void \*user\_data)

373{

374 if ([DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->alarm\_set\_callback == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {
...
378 return [DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->alarm\_set\_callback(dev, id, callback, user\_data);

379}

380

381#endif /\* CONFIG\_RTC\_ALARM \*/

385

390#if defined(CONFIG\_RTC\_UPDATE) || defined(\_\_DOXYGEN\_\_)

391

[ 411](group__rtc__interface.md#ga0b2b2b44077dcdb73feb007f87cc47b3)static inline int [rtc\_update\_set\_callback](group__rtc__interface.md#ga0b2b2b44077dcdb73feb007f87cc47b3)(const struct [device](structdevice.md) \*dev,

412 [rtc\_update\_callback](group__rtc__interface.md#ga99e4869ee85507befc7e7cf129b45b07) callback, void \*user\_data)

413{

414 if ([DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->update\_set\_callback == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {

415 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

416 }

417

418 return [DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->update\_set\_callback(dev, callback, user\_data);

419}

420

421#endif /\* CONFIG\_RTC\_UPDATE \*/

425

430#if defined(CONFIG\_RTC\_CALIBRATION) || defined(\_\_DOXYGEN\_\_)

431

[ 450](group__rtc__interface.md#ga13395c6b38e06bcda23cc0e9c299c445)\_\_syscall int [rtc\_set\_calibration](group__rtc__interface.md#ga13395c6b38e06bcda23cc0e9c299c445)(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) calibration);

451

452static inline int z\_impl\_rtc\_set\_calibration(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) calibration)

453{

454 if ([DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->set\_calibration == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {
...
458 return [DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->set\_calibration(dev, calibration);

459}

460

[ 471](group__rtc__interface.md#gab29bc6bcea5eb71e03d3e6181d4bec2f)\_\_syscall int [rtc\_get\_calibration](group__rtc__interface.md#gab29bc6bcea5eb71e03d3e6181d4bec2f)(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*calibration);

472

473static inline int z\_impl\_rtc\_get\_calibration(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*calibration)

474{

475 if ([DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->get\_calibration == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {

476 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

477 }

478

479 return [DEVICE\_API\_GET](device_8h.md#a9907e8ee5e7be8c3b5d52b13bd33970a)(rtc, dev)->get\_calibration(dev, calibration);

480}

481

482#endif /\* CONFIG\_RTC\_CALIBRATION \*/

486

491

495struct [tm](structtm.md);

496

[ 501](group__rtc__interface.md#gac2bb774a4b512f76c35a0a6723a7c807)static inline struct [tm](structtm.md) \*[rtc\_time\_to\_tm](group__rtc__interface.md#gac2bb774a4b512f76c35a0a6723a7c807)(struct [rtc\_time](structrtc__time.md) \*timeptr)

502{

503 return (struct [tm](structtm.md) \*)timeptr;

504}

505

[ 513](group__rtc__interface.md#gacca437e504026d800aa481b870291fda)static inline [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) [rtc\_calibration\_from\_frequency](group__rtc__interface.md#gacca437e504026d800aa481b870291fda)([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) frequency)

514{

515 \_\_ASSERT\_NO\_MSG(frequency > 0);

516

517 return ([int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2))((1000000000000000000LL / frequency) - 1000000000);
...
532#include <zephyr/syscalls/rtc.h>

533

534#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_RTC\_H\_ \*/
...
[rtc\_update\_set\_callback](group__rtc__interface.md#ga0b2b2b44077dcdb73feb007f87cc47b3)

static int rtc\_update\_set\_callback(const struct device \*dev, rtc\_update\_callback callback, void \*user\_data)

API for setting update callback.

**Definition** rtc.h:411
...
[rtc\_alarm\_set\_callback](group__rtc__interface.md#ga90d7f422ca15cf679aa7ba61fb5373f0)

static int rtc\_alarm\_set\_callback(const struct device \*dev, uint16\_t id, rtc\_alarm\_callback callback, void \*user\_data)

API for setting alarm callback.

**Definition** rtc.h:371
