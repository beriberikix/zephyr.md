---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__mesh__stat.html
...
`#include <[zephyr/bluetooth/mesh/statistic.h](statistic_8h.md)>`

Get mesh frame handling statistic.

Parameters
:   | st | Bluetooh Mesh statistic. |
    | --- | --- |
