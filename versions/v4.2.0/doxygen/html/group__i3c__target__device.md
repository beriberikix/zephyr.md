---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i3c__target__device.html
...
| Functions | |
| --- | --- |
| static int | [i3c\_target\_controller\_handoff](#ga09be7f73861bede0071fd8ade344d092) (const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) [accept](posix_2sys_2socket_8h.md#a66e3de379c18201b21c889035ec54864)) |
...
## [◆ ](#ga09be7f73861bede0071fd8ade344d092)i3c\_target\_controller\_handoff()

| | int i3c\_target\_controller\_handoff | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *accept* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

`#include <[zephyr/drivers/i3c/target_device.h](target__device_8h.md)>`

Accept or Decline Controller Handoffs.

This sets the target to ACK or NACK handoffs from the active controller from the CCC GETACCCR.

Parameters
:   | dev | Pointer to the device structure for an I3C controller driver configured in target mode. |
    | --- | --- |
    | [accept](posix_2sys_2socket_8h.md#a66e3de379c18201b21c889035ec54864) | True to ACK controller handoffs, False to NACK |
