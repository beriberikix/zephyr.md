---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/usb__ch9_8h.html
...
| #define | [USB\_SFS\_TEST\_MODE\_J](#a48567c219ecb9e0b3c0d7a1685d68cec)   0x01 |
|  | USB Test Mode Selectors defined in spec. |
| #define | [USB\_SFS\_TEST\_MODE\_K](#a2693cbe71751c0990568c01c5137f34e)   0x02 |
| #define | [USB\_SFS\_TEST\_MODE\_SE0\_NAK](#a2e36154ec5720097fda6e8fb67ab8c5f)   0x03 |
| #define | [USB\_SFS\_TEST\_MODE\_PACKET](#a400245449e029997eab958d1963e27fa)   0x04 |
| #define | [USB\_SFS\_TEST\_MODE\_FORCE\_ENABLE](#a5b4e7459b82b9d22da12e9b5dd8b5ba0)   0x05 |
...
| #define | [USB\_MPS\_EP\_SIZE](#ae028a023a157a29a0e83dee304c6267a)(mps) |
|  | Get endpoint size field from Max Packet Size value. |
| #define | [USB\_MPS\_ADDITIONAL\_TRANSACTIONS](#ad82d2bcde8045078531a607ddf5231b2)(mps) |
|  | Get number of additional transactions per microframe from Max Packet Size value. |
| #define | [USB\_MPS\_TO\_TPL](#a10ea5b5c35aff863958c83ee1e4c9de5)(mps) |
|  | Calculate total payload length from Max Packet Size value. |
| #define | [USB\_TPL\_TO\_MPS](#a4aa386328cee14a25e8e9b4183ca1353)(tpl) |
|  | Calculate Max Packet Size value from total payload length. |
| #define | [USB\_TPL\_ROUND\_UP](#af0d975aa6569cdd395e0d08d6c866a02)(tpl) |
|  | Round up total payload length to next valid value. |
| #define | [USB\_TPL\_IS\_VALID](#a9a9dc75d25540bbf34543df09a9ecd4e)(tpl) |
...
[CLAMP](group__sys-util.md#gad6e7d4f6ba5a77f9ee3c04026f1c2b67)(([ilog2](group__math__ilog2.md#ga2696c6303d4c53b65a3a7f7ff771d5eb)((us) / 1000U) + 1U), 1U, 16U)

[ilog2](group__math__ilog2.md#ga2696c6303d4c53b65a3a7f7ff771d5eb)
...
[CLAMP](group__sys-util.md#gad6e7d4f6ba5a77f9ee3c04026f1c2b67)(([ilog2](group__math__ilog2.md#ga2696c6303d4c53b65a3a7f7ff771d5eb)((us) / 125U) + 1U), 1U, 16U)
...
## [◆ ](#ad82d2bcde8045078531a607ddf5231b2)USB\_MPS\_ADDITIONAL\_TRANSACTIONS

| #define USB\_MPS\_ADDITIONAL\_TRANSACTIONS | ( |  | *mps* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ae028a023a157a29a0e83dee304c6267a)USB\_MPS\_EP\_SIZE
...
((mps) & [BIT\_MASK](group__sys-util.md#ga3c12c6d36ad0aa481a3436923d21f4f8)(11))
...
## [◆ ](#a10ea5b5c35aff863958c83ee1e4c9de5)USB\_MPS\_TO\_TPL

| #define USB\_MPS\_TO\_TPL | ( |  | *mps* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

((1 + [USB\_MPS\_ADDITIONAL\_TRANSACTIONS](#ad82d2bcde8045078531a607ddf5231b2)(mps)) \* [USB\_MPS\_EP\_SIZE](#ae028a023a157a29a0e83dee304c6267a)(mps))

[USB\_MPS\_ADDITIONAL\_TRANSACTIONS](#ad82d2bcde8045078531a607ddf5231b2)

#define USB\_MPS\_ADDITIONAL\_TRANSACTIONS(mps)

Get number of additional transactions per microframe from Max Packet Size value.

**Definition** usb\_ch9.h:367

[USB\_MPS\_EP\_SIZE](#ae028a023a157a29a0e83dee304c6267a)

#define USB\_MPS\_EP\_SIZE(mps)

Get endpoint size field from Max Packet Size value.

**Definition** usb\_ch9.h:364
...
## [◆ ](#a5b4e7459b82b9d22da12e9b5dd8b5ba0)USB\_SFS\_TEST\_MODE\_FORCE\_ENABLE

| #define USB\_SFS\_TEST\_MODE\_FORCE\_ENABLE   0x05 |
| --- |

## [◆ ](#a48567c219ecb9e0b3c0d7a1685d68cec)USB\_SFS\_TEST\_MODE\_J

| #define USB\_SFS\_TEST\_MODE\_J   0x01 |
| --- |
...
## [◆ ](#a2693cbe71751c0990568c01c5137f34e)USB\_SFS\_TEST\_MODE\_K

| #define USB\_SFS\_TEST\_MODE\_K   0x02 |
| --- |

## [◆ ](#a400245449e029997eab958d1963e27fa)USB\_SFS\_TEST\_MODE\_PACKET

| #define USB\_SFS\_TEST\_MODE\_PACKET   0x04 |
| --- |

## [◆ ](#a2e36154ec5720097fda6e8fb67ab8c5f)USB\_SFS\_TEST\_MODE\_SE0\_NAK

| #define USB\_SFS\_TEST\_MODE\_SE0\_NAK   0x03 |
| --- |
...
## [◆ ](#a9a9dc75d25540bbf34543df09a9ecd4e)USB\_TPL\_IS\_VALID

| #define USB\_TPL\_IS\_VALID | ( |  | *tpl* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((tpl) > 3072) ? [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) : \
...
## [◆ ](#af0d975aa6569cdd395e0d08d6c866a02)USB\_TPL\_ROUND\_UP

| #define USB\_TPL\_ROUND\_UP | ( |  | *tpl* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((tpl) > 2048) ? [ROUND\_UP](group__sys-util.md#gaada5610108b15d85c65d863b0c646ef3)(tpl, 3) : \

((tpl) > 1024) ? [ROUND\_UP](group__sys-util.md#gaada5610108b15d85c65d863b0c646ef3)(tpl, 2) : \
...
## [◆ ](#a4aa386328cee14a25e8e9b4183ca1353)USB\_TPL\_TO\_MPS

| #define USB\_TPL\_TO\_MPS | ( |  | *tpl* | ) |  |
| --- | --- | --- | --- | --- | --- |
