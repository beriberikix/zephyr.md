---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structi3c__device__desc.html
...
| const struct [device](structdevice.md) \* | [bus](#aaa1a96e29bf98028ad6ee4c1aae79809) |
|  | I3C bus to which this target device is attached. |
| const struct [device](structdevice.md) \* | [dev](#af0466893f56f9aebdaa7677a9a0076ed) |
|  | Device driver instance of the I3C device. |
| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | [pid](#a153ff108d8cf523d60aad3534d06f88e) |
|  | Device Provisioned ID. |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [static\_addr](#a078901f1dc853dabf6503407d78735c0) |
...
| const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [flags](#a5cc5f0ffdd173478275a6b5f651d86a3) |
|  | Device Flags. |
...
Fields [bus](#aaa1a96e29bf98028ad6ee4c1aae79809), [pid](#a153ff108d8cf523d60aad3534d06f88e) and [static\_addr](#a078901f1dc853dabf6503407d78735c0) must be initialized by the module that implements the target device behavior prior to passing the object reference to I3C controller device APIs. [static\_addr](#a078901f1dc853dabf6503407d78735c0) can be zero if target device does not have static address.
...
## [◆ ](#aaa1a96e29bf98028ad6ee4c1aae79809)bus

| const struct [device](structdevice.md)\* i3c\_device\_desc::bus |
| --- |
...
## [◆ ](#af0466893f56f9aebdaa7677a9a0076ed)dev

| const struct [device](structdevice.md)\* i3c\_device\_desc::dev |
| --- |
...
## [◆ ](#a5cc5f0ffdd173478275a6b5f651d86a3)flags

| const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) i3c\_device\_desc::flags |
| --- |

Device Flags.

BIT[0]: This shall be used as an optimization for bus initializtion if the device supports SETAASA. BIT[1]: This shall be used to indicate if the device is a I3C v1.0 device
...
## [◆ ](#a153ff108d8cf523d60aad3534d06f88e)pid

| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) i3c\_device\_desc::pid |
| --- |

Device Provisioned ID.

## [◆ ](#a078901f1dc853dabf6503407d78735c0)static\_addr

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) i3c\_device\_desc::static\_addr |
| --- |
