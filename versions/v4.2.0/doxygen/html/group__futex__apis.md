---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__futex__apis.html
...
:   | futex | Address of the futex. |
    ...
    | timeout | Waiting period on the futex, or one of the special values K\_NO\_WAIT or K\_FOREVER. |
