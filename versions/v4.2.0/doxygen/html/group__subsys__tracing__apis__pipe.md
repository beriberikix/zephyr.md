---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__subsys__tracing__apis__pipe.html
...
| Macros | |
| --- | --- |
| #define | [sys\_port\_trace\_k\_pipe\_init](#ga8b22ee35dfa2c4be5cf9772fe92dd731)(pipe, buffer, size) |
|  | Trace initialization of Pipe. |
| #define | [sys\_port\_trace\_k\_pipe\_reset\_enter](#ga9168b8fbacac753adc76b5fa341ba5f3)(pipe) |
|  | Trace Pipe reset entry. |
| #define | [sys\_port\_trace\_k\_pipe\_reset\_exit](#gad880e5655d35441e83bada3e950924cc)(pipe) |
|  | Trace Pipe reset exit. |
| #define | [sys\_port\_trace\_k\_pipe\_close\_enter](#gad9913c3eaa2711e501f4d3a071ee2304)(pipe) |
|  | Trace Pipe close entry. |
| #define | [sys\_port\_trace\_k\_pipe\_close\_exit](#ga42029311eeb46b06d8a4cdd3ca12b2fe)(pipe) |
|  | Trace Pipe close exit. |
| #define | [sys\_port\_trace\_k\_pipe\_write\_enter](#gae1d79d1472bfb3905f107159b297d50b)(pipe, data, len, timeout) |
|  | Trace Pipe write attempt entry. |
| #define | [sys\_port\_trace\_k\_pipe\_write\_blocking](#ga566b7428e665bf086beaac4884bee3b6)(pipe, timeout) |
|  | Trace Pipe write attempt blocking. |
| #define | [sys\_port\_trace\_k\_pipe\_write\_exit](#gacb4b01b7c27ac7ad875f054038832d3a)(pipe, ret) |
|  | Trace Pipe write attempt outcome. |
| #define | [sys\_port\_trace\_k\_pipe\_read\_enter](#ga35d3ebbc09e2690a9b01707663c9f4cc)(pipe, data, len, timeout) |
|  | Trace Pipe read attempt entry. |
| #define | [sys\_port\_trace\_k\_pipe\_read\_blocking](#ga94f7c8eb46b23be75eb9341ec52bfeb1)(pipe, timeout) |
|  | Trace Pipe read attempt blocking. |
| #define | [sys\_port\_trace\_k\_pipe\_read\_exit](#gaa43afb60d07428049dd13c12a7fcab88)(pipe, ret) |
...
## [◆ ](#gad9913c3eaa2711e501f4d3a071ee2304)sys\_port\_trace\_k\_pipe\_close\_enter

| #define sys\_port\_trace\_k\_pipe\_close\_enter | ( |  | *pipe* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga42029311eeb46b06d8a4cdd3ca12b2fe)sys\_port\_trace\_k\_pipe\_close\_exit

| #define sys\_port\_trace\_k\_pipe\_close\_exit | ( |  | *pipe* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga8b22ee35dfa2c4be5cf9772fe92dd731)sys\_port\_trace\_k\_pipe\_init
...
## [◆ ](#ga94f7c8eb46b23be75eb9341ec52bfeb1)sys\_port\_trace\_k\_pipe\_read\_blocking

| #define sys\_port\_trace\_k\_pipe\_read\_blocking | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *timeout* ) |
...
## [◆ ](#ga35d3ebbc09e2690a9b01707663c9f4cc)sys\_port\_trace\_k\_pipe\_read\_enter

| #define sys\_port\_trace\_k\_pipe\_read\_enter | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *data*, |
|  |  |  | *len*, |
|  |  |  | *timeout* ) |
...
## [◆ ](#gaa43afb60d07428049dd13c12a7fcab88)sys\_port\_trace\_k\_pipe\_read\_exit

| #define sys\_port\_trace\_k\_pipe\_read\_exit | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *ret* ) |
...
## [◆ ](#ga9168b8fbacac753adc76b5fa341ba5f3)sys\_port\_trace\_k\_pipe\_reset\_enter

| #define sys\_port\_trace\_k\_pipe\_reset\_enter | ( |  | *pipe* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gad880e5655d35441e83bada3e950924cc)sys\_port\_trace\_k\_pipe\_reset\_exit

| #define sys\_port\_trace\_k\_pipe\_reset\_exit | ( |  | *pipe* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga566b7428e665bf086beaac4884bee3b6)sys\_port\_trace\_k\_pipe\_write\_blocking

| #define sys\_port\_trace\_k\_pipe\_write\_blocking | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *timeout* ) |
...
## [◆ ](#gae1d79d1472bfb3905f107159b297d50b)sys\_port\_trace\_k\_pipe\_write\_enter

| #define sys\_port\_trace\_k\_pipe\_write\_enter | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *data*, |
|  |  |  | *len*, |
|  |  |  | *timeout* ) |
...
## [◆ ](#gacb4b01b7c27ac7ad875f054038832d3a)sys\_port\_trace\_k\_pipe\_write\_exit

| #define sys\_port\_trace\_k\_pipe\_write\_exit | ( |  | *pipe*, |
| --- | --- | --- | --- |
|  |  |  | *ret* ) |
