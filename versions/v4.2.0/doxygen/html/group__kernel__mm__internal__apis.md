---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__kernel__mm__internal__apis.html
...
| #define | [IS\_SRAM\_ADDRESS\_LOWER](#gaeda081ed25c90237b2ca88bc5ae0f254)([ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)) |
| #define | [IS\_SRAM\_ADDRESS\_UPPER](#ga38152dff07d0cc76efc4b9eed96e8037)([ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)) |
| #define | [IS\_SRAM\_ADDRESS](#gae0d6fc45cca5dc25d77294b4efb14c80)([ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)) |
...
## [◆ ](#gae0d6fc45cca5dc25d77294b4efb14c80)IS\_SRAM\_ADDRESS

| #define IS\_SRAM\_ADDRESS | ( |  | *[ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)* | ) |  |
| --- | --- | --- | --- | --- | --- |

`#include <[zephyr/kernel/internal/mm.h](kernel_2internal_2mm_8h.md)>`

**Value:**

([IS\_SRAM\_ADDRESS\_LOWER](#gaeda081ed25c90237b2ca88bc5ae0f254)([ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)) && \

IS\_SRAM\_ADDRESS\_UPPER([ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)))
...
[IS\_SRAM\_ADDRESS\_LOWER](#gaeda081ed25c90237b2ca88bc5ae0f254)

#define IS\_SRAM\_ADDRESS\_LOWER(ADDR)

**Definition** mm.h:50

## [◆ ](#gaeda081ed25c90237b2ca88bc5ae0f254)IS\_SRAM\_ADDRESS\_LOWER

| #define IS\_SRAM\_ADDRESS\_LOWER | ( |  | *[ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga38152dff07d0cc76efc4b9eed96e8037)IS\_SRAM\_ADDRESS\_UPPER

| #define IS\_SRAM\_ADDRESS\_UPPER | ( |  | *[ADDR](asm-macro-32-bit-mwdt_8h.md#a74d94870ad16a58f150bf43374bcc908)* | ) |  |
| --- | --- | --- | --- | --- | --- |
