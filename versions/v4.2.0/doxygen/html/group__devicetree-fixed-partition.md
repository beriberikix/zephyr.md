---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__devicetree-fixed-partition.html
...
| #define | [DT\_FIXED\_SUBPARTITION\_EXISTS](#ga14a8091e4a46de4314c5bbacc0451726)(node\_id) |
|  | Test if fixed-subpartitions compatible node exists. |
| #define | [DT\_MEM\_FROM\_FIXED\_SUBPARTITION](#ga1bff6b50b50e9c926a7779d9ee2aaba3)(node\_id) |
|  | Get the node identifier of the flash memory for a subpartition. |
| #define | [DT\_MTD\_FROM\_FIXED\_SUBPARTITION](#ga9e6ffb2c5a623d9e49333302f8e1a834)(node\_id) |
|  | Get the node identifier of the flash controller for a subpartition. |
| #define | [DT\_FIXED\_SUBPARTITION\_ADDR](#gac3fb38b3219320d67f24f02518eb29c1)(node\_id) |
...
`#include <[zephyr/devicetree/fixed-partitions.h](fixed-partitions_8h.md)>`
...
## [◆ ](#gac3fb38b3219320d67f24f02518eb29c1)DT\_FIXED\_SUBPARTITION\_ADDR

| #define DT\_FIXED\_SUBPARTITION\_ADDR | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
([DT\_REG\_ADDR](group__devicetree-reg-prop.md#gac6d8279c32351ced4c0ac7f32270974e)([DT\_MEM\_FROM\_FIXED\_SUBPARTITION](#ga1bff6b50b50e9c926a7779d9ee2aaba3)(node\_id)) + [DT\_REG\_ADDR](group__devicetree-reg-prop.md#gac6d8279c32351ced4c0ac7f32270974e)(node\_id))

[DT\_MEM\_FROM\_FIXED\_SUBPARTITION](#ga1bff6b50b50e9c926a7779d9ee2aaba3)

#define DT\_MEM\_FROM\_FIXED\_SUBPARTITION(node\_id)

Get the node identifier of the flash memory for a subpartition.

**Definition** fixed-partitions.h:151
...
This macro can only be used with subpartitions of internal memory addressable by the CPU. Otherwise, it may produce a compile-time error, such as: '\_\_REG\_IDX\_0\_VAL\_ADDRESS' undeclared.

Parameters
:   | node\_id | node identifier for a fixed-subpartitions child node |
    | --- | --- |

Returns
:   the subpartition's offset plus the base address of the flash node containing it.

## [◆ ](#ga14a8091e4a46de4314c5bbacc0451726)DT\_FIXED\_SUBPARTITION\_EXISTS

| #define DT\_FIXED\_SUBPARTITION\_EXISTS | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[DT\_NODE\_HAS\_COMPAT](group__devicetree-generic-exist.md#gad8912ba5db980713e72257472ded3ced)([DT\_PARENT](group__devicetree-generic-id.md#ga3ac56d491510275ee1321446796ab63b)(node\_id), fixed\_subpartitions)
...
Returns
:   1 if node exists and is fixed-subpartitions compatible, 0 otherwise.
...
## [◆ ](#ga1bff6b50b50e9c926a7779d9ee2aaba3)DT\_MEM\_FROM\_FIXED\_SUBPARTITION
...
[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)([DT\_NODE\_HAS\_COMPAT](group__devicetree-generic-exist.md#gad8912ba5db980713e72257472ded3ced)([DT\_GPARENT](group__devicetree-generic-id.md#gaa4eccf276a426cbbc6e440d72b692753)([DT\_PARENT](group__devicetree-generic-id.md#ga3ac56d491510275ee1321446796ab63b)(node\_id)), soc\_nv\_flash), \

([DT\_GPARENT](group__devicetree-generic-id.md#gaa4eccf276a426cbbc6e440d72b692753)([DT\_PARENT](group__devicetree-generic-id.md#ga3ac56d491510275ee1321446796ab63b)(node\_id))), ([DT\_INVALID\_NODE](group__devicetree-generic-id.md#ga710cc4455dd7e738f43f750153163855)))
...
Returns
:   the node identifier of the internal memory that contains the fixed-subpartitions node, or [DT\_INVALID\_NODE](group__devicetree-generic-id.md#ga710cc4455dd7e738f43f750153163855 "DT_INVALID_NODE") if it doesn't exist.
...
## [◆ ](#ga9e6ffb2c5a623d9e49333302f8e1a834)DT\_MTD\_FROM\_FIXED\_SUBPARTITION

| #define DT\_MTD\_FROM\_FIXED\_SUBPARTITION | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[COND\_CODE\_1](group__sys-util.md#ga358bc3e7669c860a98839a51cd526b20)([DT\_NODE\_EXISTS](group__devicetree-generic-exist.md#ga9d5cf40051d042b853f6b0088fd4500a)([DT\_MEM\_FROM\_FIXED\_SUBPARTITION](#ga1bff6b50b50e9c926a7779d9ee2aaba3)(node\_id)), \

([DT\_PARENT](group__devicetree-generic-id.md#ga3ac56d491510275ee1321446796ab63b)([DT\_MEM\_FROM\_FIXED\_SUBPARTITION](#ga1bff6b50b50e9c926a7779d9ee2aaba3)(node\_id))), ([DT\_GPARENT](group__devicetree-generic-id.md#gaa4eccf276a426cbbc6e440d72b692753)(node\_id)))
...
Returns
:   the node identifier of the memory technology device that contains the fixed-subpartitions node.
