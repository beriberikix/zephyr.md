---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structrtio__sqe.html
...
|  | Op Flags. |
| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [iodev\_flags](#a8bebe5d55aa8549d749466e444fadf91) |
|  | Op iodev flags. |
...
| struct { |  |
| [k\_timeout\_t](structk__timeout__t.md)   [timeout](#a544c75ee10281e10e83f51df5b157d62) |  |
|  | Delay timeout. [More...](#a544c75ee10281e10e83f51df5b157d62) |
| struct \_timeout   [to](#a582d4a8022d237f894034a5a92511587) |  |
|  | Timeout struct. [More...](#a582d4a8022d237f894034a5a92511587) |
| }   [delay](#a9a93700154d745bc1bacc764bbfbe696) |
|  | OP\_DELAY. [More...](#a9a93700154d745bc1bacc764bbfbe696) |
...
| struct { |  |
| int   [type](#aa09a0c93a6e8cfc73278a87942e4af33) |  |
| void \*   [config](#ac07a16c50a067acc90bd4ab08aae4184) |  |
| }   [i3c\_config](#a7f568fc04ec3bd70577d85f03d671d0b) |
|  | OP\_I3C\_CONFIGURE. [More...](#a7f568fc04ec3bd70577d85f03d671d0b) |
| void \*   [ccc\_payload](#a8d78973983abca8b97cfc5bcdc2dd2f1) |  |
|  | OP\_I3C\_CCC. [More...](#a8d78973983abca8b97cfc5bcdc2dd2f1) |
| struct { |  |
| [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8)   [ok](#a45d8aad94aa1dac80c90cf7c0266bcd8) |  |
| [rtio\_signaled\_t](group__rtio.md#gab254ffa4d10bfb670bacd1c47c1f8711)   [callback](#a597587210c0a574d95c7c84ae9002267) |  |
| void \*   [userdata](#a0ed519ee0b5867ff73bdaf37f983c971) |  |
| }   [await](#a7ed5828c28fd59a34f5aa7262e4ddd20) |
|  | OP\_AWAIT. [More...](#a7ed5828c28fd59a34f5aa7262e4ddd20) |
| }; |  |
...
## [◆ ](#a7ed5828c28fd59a34f5aa7262e4ddd20)[struct]

| struct { ... } rtio\_sqe::await |
| --- |
...
## [◆ ](#a597587210c0a574d95c7c84ae9002267)callback [1/3]

| [rtio\_signaled\_t](group__rtio.md#gab254ffa4d10bfb670bacd1c47c1f8711) rtio\_sqe::callback |
| --- |

## [◆ ](#add4f73af249b5b548ddf8f5b8d84af2b)[struct] [2/3]
...
## [◆ ](#af8c31c33e9fedebe55cac73595d0f696)callback [3/3]

| [rtio\_callback\_t](group__rtio.md#gad1dbd690e6cf88d7c788436dd04d1a00) rtio\_sqe::callback |
| --- |

## [◆ ](#a8d78973983abca8b97cfc5bcdc2dd2f1)ccc\_payload

| void\* rtio\_sqe::ccc\_payload |
| --- |

OP\_I3C\_CCC.

## [◆ ](#ac07a16c50a067acc90bd4ab08aae4184)config

| void\* rtio\_sqe::config |
| --- |

## [◆ ](#a9a93700154d745bc1bacc764bbfbe696)[struct]

| struct { ... } rtio\_sqe::delay |
| --- |
...
## [◆ ](#a7f568fc04ec3bd70577d85f03d671d0b)[struct]

| struct { ... } rtio\_sqe::i3c\_config |
| --- |
...
## [◆ ](#a8bebe5d55aa8549d749466e444fadf91)iodev\_flags

| [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) rtio\_sqe::iodev\_flags |
| --- |

Op iodev flags.

## [◆ ](#a45d8aad94aa1dac80c90cf7c0266bcd8)ok

| [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8) rtio\_sqe::ok |
| --- |
...
## [◆ ](#a544c75ee10281e10e83f51df5b157d62)timeout

| [k\_timeout\_t](structk__timeout__t.md) rtio\_sqe::timeout |
| --- |
...
## [◆ ](#a582d4a8022d237f894034a5a92511587)to

| struct \_timeout rtio\_sqe::to |
| --- |
...
## [◆ ](#aa09a0c93a6e8cfc73278a87942e4af33)type
