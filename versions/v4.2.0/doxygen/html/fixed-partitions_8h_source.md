---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/fixed-partitions_8h_source.html
...
[ 142](group__devicetree-fixed-partition.md#ga14a8091e4a46de4314c5bbacc0451726)#define DT\_FIXED\_SUBPARTITION\_EXISTS(node\_id) \

143 DT\_NODE\_HAS\_COMPAT(DT\_PARENT(node\_id), fixed\_subpartitions)

144

[ 151](group__devicetree-fixed-partition.md#ga1bff6b50b50e9c926a7779d9ee2aaba3)#define DT\_MEM\_FROM\_FIXED\_SUBPARTITION(node\_id) \

152 COND\_CODE\_1(DT\_NODE\_HAS\_COMPAT(DT\_GPARENT(DT\_PARENT(node\_id)), soc\_nv\_flash), \

153 (DT\_GPARENT(DT\_PARENT(node\_id))), (DT\_INVALID\_NODE))

154

[ 161](group__devicetree-fixed-partition.md#ga9e6ffb2c5a623d9e49333302f8e1a834)#define DT\_MTD\_FROM\_FIXED\_SUBPARTITION(node\_id) \

162 COND\_CODE\_1(DT\_NODE\_EXISTS(DT\_MEM\_FROM\_FIXED\_SUBPARTITION(node\_id)), \

163 (DT\_PARENT(DT\_MEM\_FROM\_FIXED\_SUBPARTITION(node\_id))), (DT\_GPARENT(node\_id)))

164

[ 209](group__devicetree-fixed-partition.md#gac3fb38b3219320d67f24f02518eb29c1)#define DT\_FIXED\_SUBPARTITION\_ADDR(node\_id) \

210 (DT\_REG\_ADDR(DT\_MEM\_FROM\_FIXED\_SUBPARTITION(node\_id)) + DT\_REG\_ADDR(node\_id))
...
220#endif /\* ZEPHYR\_INCLUDE\_DEVICETREE\_FIXED\_PARTITION\_H\_ \*/
