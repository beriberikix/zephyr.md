---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__nvs__high__level__api.html
...
| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [nvs\_sector\_max\_data\_size](#ga7ce6065cf3ac68544f51d26cabd983b2) (struct [nvs\_fs](structnvs__fs.md) \*fs) |
|  | Tell how many contiguous free space remains in the currently active NVS sector. |
| int | [nvs\_sector\_use\_next](#ga52db47389e9aa2b0de77497f0e60ed5b) (struct [nvs\_fs](structnvs__fs.md) \*fs) |
...
`#include <[zephyr/fs/nvs.h](nvs_8h.md)>`
...
## [◆ ](#ga7ce6065cf3ac68544f51d26cabd983b2)nvs\_sector\_max\_data\_size()

| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) nvs\_sector\_max\_data\_size | ( | struct [nvs\_fs](structnvs__fs.md) \* | *fs* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga52db47389e9aa2b0de77497f0e60ed5b)nvs\_sector\_use\_next()

| int nvs\_sector\_use\_next | ( | struct [nvs\_fs](structnvs__fs.md) \* | *fs* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Returns
:   0 on success. On error, returns negative value of [errno.h](errno_8h.md "System error numbers.") defined error codes.
