---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structi3c__config__target.html
...
| Data Fields | |
| --- | --- |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [enabled](#a25b0837f2363f880936391d9baed1d1e) |
|  | If the hardware is currently acting as a target device on the bus. |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [dynamic\_addr](#aac5e8a92468df108ce964bb6a9a7ae9c) |
...
This can also be used to configure the controller if it is to act as a target on the bus.
...
## [◆ ](#aac5e8a92468df108ce964bb6a9a7ae9c)dynamic\_addr

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) i3c\_config\_target::dynamic\_addr |
| --- |

I3C target dynamic address.

Currently assigned dynamic address. 0 if no address assigned.

Note
:   Only writeable if the hardware acts as a primary controller

## [◆ ](#a25b0837f2363f880936391d9baed1d1e)enabled

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) i3c\_config\_target::enabled |
| --- |
...
Used used when operating as a secondary controller or as a target device.
