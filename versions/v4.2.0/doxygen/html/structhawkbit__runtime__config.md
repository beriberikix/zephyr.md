---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structhawkbit__runtime__config.html
...
[Third-party](group__third__party.md) » [hawkBit Firmware Over-the-Air](group__hawkbit.md) » [hawkBit configuration API](group__hawkbit__config.md)

hawkBit configuration structure.
[More...](#details)

`#include <[zephyr/mgmt/hawkbit/config.h](config_8h_source.md)>`
...
| char \* | [server\_domain](#a3efc42d340461934b96a55ec6d5b91d2) |
|  | Server domain name. |
...
## [◆ ](#a3efc42d340461934b96a55ec6d5b91d2)server\_domain

| char\* hawkbit\_runtime\_config::server\_domain |
| --- |
...
- zephyr/mgmt/hawkbit/[config.h](config_8h_source.md)
