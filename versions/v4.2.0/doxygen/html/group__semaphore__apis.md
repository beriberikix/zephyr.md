---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__semaphore__apis.html
...
| Functions | |
| --- | --- |
| int | [k\_sem\_init](#gadcd0e6cfba3392fb887222eafe4c1845) (struct [k\_sem](structk__sem.md) \*sem, [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int initial\_count, [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int limit) |
|  | Initialize a semaphore. |
| int | [k\_sem\_take](#gac71e2383c1920dddc45a561cacfef090) (struct [k\_sem](structk__sem.md) \*sem, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Take a semaphore. |
| void | [k\_sem\_give](#gab9be3cf1988af2cd6afdace52d497c84) (struct [k\_sem](structk__sem.md) \*sem) |
|  | Give a semaphore. |
| void | [k\_sem\_reset](#ga1bd12d8d8c1b9c6be9b665d0fefe5562) (struct [k\_sem](structk__sem.md) \*sem) |
|  | Resets a semaphore's count to zero. |
| [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int | [k\_sem\_count\_get](#ga58843b581e170a1811fc38eecbfd01f3) (struct [k\_sem](structk__sem.md) \*sem) |
...
[STRUCT\_SECTION\_ITERABLE](group__iterable__section__apis.md#ga9104f42cbe4a67a931bed7f7cc8f600f)([k\_sem](structk__sem.md), name) = \

Z\_SEM\_INITIALIZER(name, initial\_count, count\_limit); \

BUILD\_ASSERT(((count\_limit) != 0) && \

(((initial\_count) < (count\_limit)) || ((initial\_count) == (count\_limit))) && \
...
extern struct [k\_sem](structk__sem.md) <name>;
...
| [unsigned](lib_2libc_2minimal_2include_2sys_2types_8h.md#a4089fb16419d359081465355db05f846) int k\_sem\_count\_get | ( | struct [k\_sem](structk__sem.md) \* | *sem* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| | void k\_sem\_give | ( | struct [k\_sem](structk__sem.md) \* | *sem* | ) |  | | --- | --- | --- | --- | --- | --- | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| int k\_sem\_init | ( | struct [k\_sem](structk__sem.md) \* | *sem*, |
| --- | --- | --- | --- |
...
| void k\_sem\_reset | ( | struct [k\_sem](structk__sem.md) \* | *sem* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| | int k\_sem\_take | ( | struct [k\_sem](structk__sem.md) \* | *sem*, | | --- | --- | --- | --- | |  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
