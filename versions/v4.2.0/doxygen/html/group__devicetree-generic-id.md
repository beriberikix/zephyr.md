---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__devicetree-generic-id.html
...
| #define | [DT\_HAS\_ALIAS](#ga1f6c459577dbb195192bef33a30c5d51)(alias\_name) |
|  | Test if the devicetree has a given alias. |
| #define | [DT\_NODE\_HASH](#ga067821c9b49437ac9333fd2a0443f1fc)(node\_id) |
...
| #define | [DT\_NODE\_FULL\_NAME\_UNQUOTED](#ga8832fb6fa0e0555884621d210440fdcd)(node\_id) |
|  | Get the node's full name, including the unit-address, as an unquoted sequence of tokens. |
| #define | [DT\_NODE\_FULL\_NAME\_TOKEN](#gad24b51e728175e7d347407f2131a3850)(node\_id) |
|  | Get the node's full name, including the unit-address, as a token. |
| #define | [DT\_NODE\_FULL\_NAME\_UPPER\_TOKEN](#gab966ae50efe46cc3a54f086f508edb3b)(node\_id) |
|  | Like [DT\_NODE\_FULL\_NAME\_TOKEN()](#gad24b51e728175e7d347407f2131a3850), but uppercased. |
...
## [◆ ](#ga1f6c459577dbb195192bef33a30c5d51)DT\_HAS\_ALIAS

| #define DT\_HAS\_ALIAS | ( |  | *alias\_name* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[DT\_NODE\_EXISTS](group__devicetree-generic-exist.md#ga9d5cf40051d042b853f6b0088fd4500a)([DT\_ALIAS](#gaa49e19bbc39dc0d6f16b78a5d02482c9)(alias\_name))
...
Parameters
:   | alias\_name | lowercase-and-underscores devicetree alias name |
    | --- | --- |
...
## [◆ ](#gad24b51e728175e7d347407f2131a3850)DT\_NODE\_FULL\_NAME\_TOKEN

| #define DT\_NODE\_FULL\_NAME\_TOKEN | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
DT\_CAT(node\_id, \_FULL\_NAME\_TOKEN)
...
[DT\_NODE\_FULL\_NAME\_TOKEN](#gad24b51e728175e7d347407f2131a3850)([DT\_NODELABEL](#gab7d23294a6bf7fd44a98b48ec47d8a79)(node)) // my\_node\_12345678

[DT\_NODE\_FULL\_NAME\_TOKEN](#gad24b51e728175e7d347407f2131a3850)

#define DT\_NODE\_FULL\_NAME\_TOKEN(node\_id)

Get the node's full name, including the unit-address, as a token.

**Definition** devicetree.h:593
...
## [◆ ](#ga8832fb6fa0e0555884621d210440fdcd)DT\_NODE\_FULL\_NAME\_UNQUOTED

| #define DT\_NODE\_FULL\_NAME\_UNQUOTED | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
DT\_CAT(node\_id, \_FULL\_NAME\_UNQUOTED)
...
[DT\_NODE\_FULL\_NAME\_UNQUOTED](#ga8832fb6fa0e0555884621d210440fdcd)([DT\_NODELABEL](#gab7d23294a6bf7fd44a98b48ec47d8a79)(node)) // my-node@12345678

[DT\_NODE\_FULL\_NAME\_UNQUOTED](#ga8832fb6fa0e0555884621d210440fdcd)

#define DT\_NODE\_FULL\_NAME\_UNQUOTED(node\_id)

Get the node's full name, including the unit-address, as an unquoted sequence of tokens.

**Definition** devicetree.h:565
...
## [◆ ](#gab966ae50efe46cc3a54f086f508edb3b)DT\_NODE\_FULL\_NAME\_UPPER\_TOKEN
...
DT\_CAT(node\_id, \_FULL\_NAME\_UPPER\_TOKEN)
...
[DT\_NODE\_FULL\_NAME\_UPPER\_TOKEN](#gab966ae50efe46cc3a54f086f508edb3b)([DT\_NODELABEL](#gab7d23294a6bf7fd44a98b48ec47d8a79)(node)) // MY\_NODE\_12345678

[DT\_NODE\_FULL\_NAME\_UPPER\_TOKEN](#gab966ae50efe46cc3a54f086f508edb3b)
...
## [◆ ](#ga067821c9b49437ac9333fd2a0443f1fc)DT\_NODE\_HASH

| #define DT\_NODE\_HASH | ( |  | *node\_id* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
DT\_CAT(node\_id, \_HASH)

Get the hash associated with a DT node.

Get the hash for the specified node\_id. The hash is calculated on the full devicetree path of the node.
...
Returns
:   hash value as a preprocessor token
...
[IS\_EQ](group__sys-util.md#gaa35a6894bca38a8ffb558c2c22a1eee1)([DT\_DEP\_ORD](group__devicetree-dep-ord.md#ga5b96dccfd349dd0ddba1812aa942c1bd)(node\_id1), [DT\_DEP\_ORD](group__devicetree-dep-ord.md#ga5b96dccfd349dd0ddba1812aa942c1bd)(node\_id2))
...
[IS\_EQ](group__sys-util.md#gaa35a6894bca38a8ffb558c2c22a1eee1)

#define IS\_EQ(a, b)

Like a == b, but does evaluation and short-circuiting at C preprocessor time.

**Definition** util\_macro.h:322
