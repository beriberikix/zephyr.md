---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__subsys__pm__sys__policy.html
...
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_state\_is\_available](#ga1c8634f68224aa64f05a373dfad5cb09) (enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90), [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) substate\_id) |
|  | Check if a power state is available. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_state\_any\_active](#ga0c4fee04c7434e2ba741be8d5b1036c6) (void) |
|  | Check if any power state can be used. |
| void | [pm\_policy\_event\_register](#ga4e66c09a5c8694e48b7be6b61667aeca) (struct [pm\_policy\_event](structpm__policy__event.md) \*evt, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) uptime\_ticks) |
|  | Register an event. |
| void | [pm\_policy\_event\_update](#ga059074d867befbe9c6b7afc170ee09b3) (struct [pm\_policy\_event](structpm__policy__event.md) \*evt, [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) uptime\_ticks) |
|  | Update an event. |
...
|  | Unregister an event. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_policy\_device\_is\_disabling\_state](#ga4cfc3c450387663b6e1bf9bb966baad8) (const struct [device](structdevice.md) \*dev, enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90), [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) substate\_id) |
|  | Check if a state will disable a device. |
| [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) | [pm\_policy\_next\_event\_ticks](#gae2680fcc323e161362e4a5aa5339ac12) (void) |
...
`#include <[zephyr/pm/policy.h](policy_8h.md)>`
...
## [◆ ](#ga4cfc3c450387663b6e1bf9bb966baad8)pm\_policy\_device\_is\_disabling\_state()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) pm\_policy\_device\_is\_disabling\_state | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) | *state*, |
...
:   | dev | Device reference. |
    | --- | --- |
    | [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90) | The state to check on whether it disables the device. |
    | substate\_id | The substate to check on whether it disables the device. |

Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | if the state disables the device |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | if the state does not disable the device |
...
## [◆ ](#ga4e66c09a5c8694e48b7be6b61667aeca)pm\_policy\_event\_register()

| void pm\_policy\_event\_register | ( | struct [pm\_policy\_event](structpm__policy__event.md) \* | *evt*, |
| --- | --- | --- | --- |
|  |  | [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) | *uptime\_ticks* ) |
...
CPU is woken up before the time passed in cycle to minimize event handling latency. Once woken up, the CPU will be kept awake until the event has been handled, which is signaled by [pm\_policy\_event\_unregister()](#ga9448e31e1bd1a8b02defe6d1427197ff) or moving event into the future using [pm\_policy\_event\_update()](#ga059074d867befbe9c6b7afc170ee09b3).

Parameters
:   | evt | Event. |
    | --- | --- |
    | uptime\_ticks | When the event will occur, in uptime ticks. |
...
See also
:   [pm\_policy\_event\_register](#ga4e66c09a5c8694e48b7be6b61667aeca)

## [◆ ](#ga059074d867befbe9c6b7afc170ee09b3)pm\_policy\_event\_update()
...
## [◆ ](#gae2680fcc323e161362e4a5aa5339ac12)pm\_policy\_next\_event\_ticks()

| [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) pm\_policy\_next\_event\_ticks | ( | void |  | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga0c4fee04c7434e2ba741be8d5b1036c6)pm\_policy\_state\_any\_active()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) pm\_policy\_state\_any\_active | ( | void |  | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | if any power state is active. |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | if all power states are unavailable. |

## [◆ ](#ga1c8634f68224aa64f05a373dfad5cb09)pm\_policy\_state\_is\_available()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) pm\_policy\_state\_is\_available | ( | enum [pm\_state](group__subsys__pm__states.md#ga20e2f5ea9027a3653e5b9cc5aa1e21d5) | *state*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *substate\_id* ) |
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | if power state is active. |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | if power state is not active. |
