---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/net_2ppp_8h_source.html
...
381#define LCP\_NUM\_MY\_OPTIONS 2

382#else

[ 383](group__ppp.md#gaa584f3427a21343ab692b5ec3a9573ec)#define LCP\_NUM\_MY\_OPTIONS 1

384#endif

385

[ 387](structipcp__options.md)struct [ipcp\_options](structipcp__options.md) {

[ 389](structipcp__options.md#a2d4a41b74c4a319551c003210c1e6f3d) struct [in\_addr](structin__addr.md) [address](structipcp__options.md#a2d4a41b74c4a319551c003210c1e6f3d);

390

[ 392](structipcp__options.md#a5c2b153ee9103393159a7090357df5a1) struct [in\_addr](structin__addr.md) [dns1\_address](structipcp__options.md#a5c2b153ee9103393159a7090357df5a1);

393

[ 395](structipcp__options.md#a4e9825d9c161fa318cb538ebc231dd44) struct [in\_addr](structin__addr.md) [dns2\_address](structipcp__options.md#a4e9825d9c161fa318cb538ebc231dd44);

396};

397

[ 399](structipv6cp__options.md)struct [ipv6cp\_options](structipv6cp__options.md) {

[ 401](structipv6cp__options.md#a4962f03fcf645257306ceeb95116ddce) [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [iid](structipv6cp__options.md#a4962f03fcf645257306ceeb95116ddce)[[PPP\_INTERFACE\_IDENTIFIER\_LEN](group__ppp.md#gaad7380b3a502f4b649348b733124f21a)];

402};

403

[ 405](structppp__context.md)struct [ppp\_context](structppp__context.md) {

[ 409](structppp__context.md#a6b327cafe07a0807163589471a9bdae8) [atomic\_t](atomic__types_8h.md#a124f07c3a788e53c3a40e4e1c06d8af8) [flags](structppp__context.md#a6b327cafe07a0807163589471a9bdae8);

410

[ 412](structppp__context.md#a5671d7ba465c424004f0460e5ed0d3ba) struct [k\_work\_delayable](structk__work__delayable.md) [startup](structppp__context.md#a5671d7ba465c424004f0460e5ed0d3ba);

413

415 struct {

[ 417](structppp__context.md#ac555024228a1e1d830c915a098428bc5) struct [ppp\_fsm](structppp__fsm.md) [fsm](structppp__context.md#ac555024228a1e1d830c915a098428bc5);

418

[ 420](structppp__context.md#a37f609192ee6b739d7018d5a07ce179f) struct [lcp\_options](structlcp__options.md) [my\_options](structppp__context.md#a37f609192ee6b739d7018d5a07ce179f);

421

[ 423](structppp__context.md#a80fffd30b145b0842e36299ac78d5da8) struct [lcp\_options](structlcp__options.md) [peer\_options](structppp__context.md#a80fffd30b145b0842e36299ac78d5da8);

424

[ 426](structppp__context.md#a4d91bf9e6e36415b13be02ccf03d3e40) [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [magic](structppp__context.md#a4d91bf9e6e36415b13be02ccf03d3e40);

427

[ 429](structppp__context.md#aec24ddc41138484c2e7608481d78f155) struct ppp\_my\_option\_data [my\_options\_data](structppp__context.md#aec24ddc41138484c2e7608481d78f155)[[LCP\_NUM\_MY\_OPTIONS](group__ppp.md#gaa584f3427a21343ab692b5ec3a9573ec)];

[ 430](structppp__context.md#a7705aedba900cf1de66b02ad488b7161) } [lcp](structppp__context.md#a7705aedba900cf1de66b02ad488b7161);

431

432#if defined(CONFIG\_NET\_IPV4)

434 struct {

436 struct [ppp\_fsm](structppp__fsm.md) fsm;

437

439 struct [ipcp\_options](structipcp__options.md) my\_options;

440

442 struct [ipcp\_options](structipcp__options.md) peer\_options;

443

445 struct ppp\_my\_option\_data my\_options\_data[IPCP\_NUM\_MY\_OPTIONS];
...
449#if defined(CONFIG\_NET\_IPV6)

451 struct {

453 struct ppp\_fsm fsm;

454

456 struct ipv6cp\_options my\_options;

457

459 struct ipv6cp\_options peer\_options;

460

462 struct ppp\_my\_option\_data my\_options\_data[IPV6CP\_NUM\_MY\_OPTIONS];
...
466#if defined(CONFIG\_NET\_L2\_PPP\_PAP)

468 struct {

470 struct ppp\_fsm fsm;
...
474#if defined(CONFIG\_NET\_SHELL)

476 struct {

478 struct {

481 [net\_ppp\_lcp\_echo\_reply\_cb\_t](group__ppp.md#ga15afa05abc0446201c912c75644306bf) cb;
...
487 size\_t user\_data\_len;

488 } echo\_reply;

489

491 struct k\_sem wait\_echo\_reply;

492

494 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) echo\_req\_data;

495

497 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) echo\_reply\_data;
...
[ 502](structppp__context.md#a3b0bfb9c3ceece34565b282efa74390e) struct [net\_if](structnet__if.md) \*[iface](structppp__context.md#a3b0bfb9c3ceece34565b282efa74390e);

503

[ 505](structppp__context.md#a141cb0b4f4b99313de63a5bff2b7cafc) struct [net\_mgmt\_event\_callback](structnet__mgmt__event__callback.md) [mgmt\_evt\_cb](structppp__context.md#a141cb0b4f4b99313de63a5bff2b7cafc);

506

[ 508](structppp__context.md#a6afb964ef87696fdadb5cb0c714bd841) enum [ppp\_phase](group__ppp.md#ga284e237a6323f2daffc444a73a4b8b6b) [phase](structppp__context.md#a6afb964ef87696fdadb5cb0c714bd841);

509

[ 511](structppp__context.md#a1afa42c99b098407f8bba11e50178c84) struct [k\_sem](structk__sem.md) [wait\_ppp\_link\_terminated](structppp__context.md#a1afa42c99b098407f8bba11e50178c84);

512

[ 514](structppp__context.md#ae784688e2d78f7427c6672583e326d94) struct [k\_sem](structk__sem.md) [wait\_ppp\_link\_down](structppp__context.md#ae784688e2d78f7427c6672583e326d94);

515

[ 517](structppp__context.md#a1c6674bad19047abcc3097bf5ff5f31d) enum [net\_l2\_flags](group__net__l2.md#gac7db0cc6c56d371a5803873074ec2516) [ppp\_l2\_flags](structppp__context.md#a1c6674bad19047abcc3097bf5ff5f31d);

518

[ 520](structppp__context.md#a2e04c6e411fe5b07d9d2cda1a61db57f) int [network\_protos\_open](structppp__context.md#a2e04c6e411fe5b07d9d2cda1a61db57f);

521

[ 523](structppp__context.md#a9dd6e156897c53d488344bbbe05d4ae1) int [network\_protos\_up](structppp__context.md#a9dd6e156897c53d488344bbbe05d4ae1);

524

[ 526](structppp__context.md#a3d97c93b183ca455daf0e3bc2b9c25e1) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_ready\_to\_serve](structppp__context.md#a3d97c93b183ca455daf0e3bc2b9c25e1) : 1;

527

[ 529](structppp__context.md#a7f103857c7412a6ee9471b6c67baea71) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_enabled](structppp__context.md#a7f103857c7412a6ee9471b6c67baea71) : 1;

530

[ 532](structppp__context.md#acdee16f229cb6aa0672630de1d3ee39b) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_enable\_done](structppp__context.md#acdee16f229cb6aa0672630de1d3ee39b) : 1;

533

[ 535](structppp__context.md#a861216f943c5af5d5db58f10ba4263ac) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_ipcp\_up](structppp__context.md#a861216f943c5af5d5db58f10ba4263ac) : 1;

536

[ 538](structppp__context.md#a7ef9ac6bb1f86ea417032fe93fc7e8a0) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_ipcp\_open](structppp__context.md#a7ef9ac6bb1f86ea417032fe93fc7e8a0) : 1;

539

[ 541](structppp__context.md#a7b4ee6988626cb69c012a0b58c27bef5) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_ipv6cp\_up](structppp__context.md#a7b4ee6988626cb69c012a0b58c27bef5) : 1;

542

[ 544](structppp__context.md#ab139c8d6f1d16c702cb9ca92a7f82178) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_ipv6cp\_open](structppp__context.md#ab139c8d6f1d16c702cb9ca92a7f82178) : 1;

545

[ 547](structppp__context.md#a52227a05ce8a63f3a4f7535e60fdf979) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_pap\_up](structppp__context.md#a52227a05ce8a63f3a4f7535e60fdf979) : 1;

548

[ 550](structppp__context.md#a80c2c3248c47fac7fce8d463cfbc0c9f) [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [is\_pap\_open](structppp__context.md#a80c2c3248c47fac7fce8d463cfbc0c9f) : 1;

551};

552

[ 558](group__ppp.md#gaabf883cfefc9910b9b9d8931e68b320c)void [net\_ppp\_init](group__ppp.md#gaabf883cfefc9910b9b9d8931e68b320c)(struct [net\_if](structnet__if.md) \*iface);

559

560/\* Management API for PPP \*/

561

563

564#define PPP\_L2\_CTX\_TYPE struct ppp\_context

565

566#define NET\_PPP\_LAYER NET\_MGMT\_LAYER\_L2

567#define NET\_PPP\_CODE NET\_MGMT\_LAYER\_CODE\_PPP

568#define NET\_PPP\_BASE (NET\_MGMT\_IFACE\_BIT | \

569 NET\_MGMT\_LAYER(NET\_PPP\_LAYER) | \

570 NET\_MGMT\_LAYER\_CODE(NET\_PPP\_CODE))

571#define NET\_PPP\_EVENT (NET\_PPP\_BASE | NET\_MGMT\_EVENT\_BIT)

572

573enum {

574 NET\_EVENT\_PPP\_CMD\_CARRIER\_ON\_VAL,

575 NET\_EVENT\_PPP\_CMD\_CARRIER\_OFF\_VAL,

576 NET\_EVENT\_PPP\_CMD\_PHASE\_RUNNING\_VAL,

577 NET\_EVENT\_PPP\_CMD\_PHASE\_DEAD\_VAL,

578

579 NET\_EVENT\_PPP\_CMD\_MAX

580};

581

582BUILD\_ASSERT(NET\_EVENT\_PPP\_CMD\_MAX <= NET\_MGMT\_MAX\_COMMANDS,

583 "Number of events in net\_event\_ppp\_cmd exceeds the limit");

584

585enum net\_event\_ppp\_cmd {

586 [NET\_MGMT\_CMD](group__wifi__mgmt.md#ggac2638308cbb0d268831f1618cf8e1fa8ae731884669e9ee832e36b8280e9c58c6)(NET\_EVENT\_PPP\_CMD\_CARRIER\_ON),

587 [NET\_MGMT\_CMD](group__wifi__mgmt.md#ggac2638308cbb0d268831f1618cf8e1fa8ae731884669e9ee832e36b8280e9c58c6)(NET\_EVENT\_PPP\_CMD\_CARRIER\_OFF),

588 [NET\_MGMT\_CMD](group__wifi__mgmt.md#ggac2638308cbb0d268831f1618cf8e1fa8ae731884669e9ee832e36b8280e9c58c6)(NET\_EVENT\_PPP\_CMD\_PHASE\_RUNNING),

589 [NET\_MGMT\_CMD](group__wifi__mgmt.md#ggac2638308cbb0d268831f1618cf8e1fa8ae731884669e9ee832e36b8280e9c58c6)(NET\_EVENT\_PPP\_CMD\_PHASE\_DEAD),

590};

591

592struct [net\_if](structnet__if.md);

593

595

[ 597](group__ppp.md#ga17c4e8cc92e0e9261d0b2dcc704b2f93)#define NET\_EVENT\_PPP\_CARRIER\_ON \

598 (NET\_PPP\_EVENT | NET\_EVENT\_PPP\_CMD\_CARRIER\_ON)

599

[ 601](group__ppp.md#ga2b3c11bbdc7b36d4381811b210340e45)#define NET\_EVENT\_PPP\_CARRIER\_OFF \

602 (NET\_PPP\_EVENT | NET\_EVENT\_PPP\_CMD\_CARRIER\_OFF)

603

[ 605](group__ppp.md#ga4853534532ac4875321785a70c5a1b19)#define NET\_EVENT\_PPP\_PHASE\_RUNNING \

606 (NET\_PPP\_EVENT | NET\_EVENT\_PPP\_CMD\_PHASE\_RUNNING)

607

[ 609](group__ppp.md#ga7aa5d07daa3f8bb45cf1bd0c30c6fc7a)#define NET\_EVENT\_PPP\_PHASE\_DEAD \

610 (NET\_PPP\_EVENT | NET\_EVENT\_PPP\_CMD\_PHASE\_DEAD)

611

617#if defined(CONFIG\_NET\_L2\_PPP\_MGMT)

618void [ppp\_mgmt\_raise\_carrier\_on\_event](group__ppp.md#ga1436cf5cfcb6752e41c9e06a0ee30030)(struct [net\_if](structnet__if.md) \*iface);

619#else

[ 620](group__ppp.md#ga1436cf5cfcb6752e41c9e06a0ee30030)static inline void [ppp\_mgmt\_raise\_carrier\_on\_event](group__ppp.md#ga1436cf5cfcb6752e41c9e06a0ee30030)(struct [net\_if](structnet__if.md) \*iface)
...
632void [ppp\_mgmt\_raise\_carrier\_off\_event](group__ppp.md#gad96b2c77cf6a066d55d78c5d63cb9bd0)(struct [net\_if](structnet__if.md) \*iface);

633#else

[ 634](group__ppp.md#gad96b2c77cf6a066d55d78c5d63cb9bd0)static inline void [ppp\_mgmt\_raise\_carrier\_off\_event](group__ppp.md#gad96b2c77cf6a066d55d78c5d63cb9bd0)(struct [net\_if](structnet__if.md) \*iface)
...
646void [ppp\_mgmt\_raise\_phase\_running\_event](group__ppp.md#ga74e94e9fcae30bc386c5e3d951ed5882)(struct [net\_if](structnet__if.md) \*iface);

647#else

[ 648](group__ppp.md#ga74e94e9fcae30bc386c5e3d951ed5882)static inline void [ppp\_mgmt\_raise\_phase\_running\_event](group__ppp.md#ga74e94e9fcae30bc386c5e3d951ed5882)(struct [net\_if](structnet__if.md) \*iface)
...
659#if defined(CONFIG\_NET\_L2\_PPP\_MGMT)

660void [ppp\_mgmt\_raise\_phase\_dead\_event](group__ppp.md#gad7f41d9012098ed1a04f897e252cc32d)(struct [net\_if](structnet__if.md) \*iface);

661#else

[ 662](group__ppp.md#gad7f41d9012098ed1a04f897e252cc32d)static inline void [ppp\_mgmt\_raise\_phase\_dead\_event](group__ppp.md#gad7f41d9012098ed1a04f897e252cc32d)(struct [net\_if](structnet__if.md) \*iface)

663{

664 ARG\_UNUSED(iface);
...
678#if defined(CONFIG\_NET\_L2\_PPP)

679int [net\_ppp\_ping](group__ppp.md#ga9893a7c93b3d23b96b4d83aa1204c500)(int idx, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) timeout);

680#else

[ 681](group__ppp.md#ga9893a7c93b3d23b96b4d83aa1204c500)static inline int [net\_ppp\_ping](group__ppp.md#ga9893a7c93b3d23b96b4d83aa1204c500)(int idx, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) timeout)

682{

683 ARG\_UNUSED(idx);

684 ARG\_UNUSED(timeout);

685

686 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);
...
698#if defined(CONFIG\_NET\_L2\_PPP) && defined(CONFIG\_NET\_SHELL)

699struct [ppp\_context](structppp__context.md) \*[net\_ppp\_context\_get](group__ppp.md#ga4f6104cff735f9829762b6552a7346bf)(int idx);

700#else

[ 701](group__ppp.md#ga4f6104cff735f9829762b6552a7346bf)static inline struct [ppp\_context](structppp__context.md) \*[net\_ppp\_context\_get](group__ppp.md#ga4f6104cff735f9829762b6552a7346bf)(int idx)
...
705 return [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4);
...
717#endif /\* ZEPHYR\_INCLUDE\_NET\_PPP\_H\_ \*/
...
**Definition** ppp.h:681

[LCP\_NUM\_MY\_OPTIONS](group__ppp.md#gaa584f3427a21343ab692b5ec3a9573ec)

#define LCP\_NUM\_MY\_OPTIONS
...
[ppp\_context::my\_options\_data](structppp__context.md#aec24ddc41138484c2e7608481d78f155)

struct ppp\_my\_option\_data my\_options\_data[1]
