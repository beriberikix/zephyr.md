---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/gap_8h.html
...
|  | Maximum data time. |
| #define | [BT\_GAP\_SID\_MIN](group__bt__gap__defines.md#gacf05b7660d2ae85f64e2a220abf8e57d)   0x00 |
...
| #define | [BT\_GAP\_ADV\_INTERVAL\_TO\_US](group__bt__gap__defines.md#ga6e10b5311c785ad7eea10743987c0f27)(\_interval) |
|  | Convert periodic advertising interval (N \* 0.625 ms) to microseconds. |
| #define | [BT\_GAP\_ADV\_INTERVAL\_TO\_MS](group__bt__gap__defines.md#ga7261e64328e433d333d88d3a4cad21de)(\_interval) |
|  | Convert periodic advertising interval (N \* 0.625 ms) to milliseconds. |
| #define | [BT\_GAP\_ISO\_INTERVAL\_TO\_US](group__bt__gap__defines.md#ga4feca4664259c43121c2ff481d9ee611)(\_interval) |
|  | Convert isochronous interval (N \* 1.25 ms) to microseconds. |
| #define | [BT\_GAP\_ISO\_INTERVAL\_TO\_MS](group__bt__gap__defines.md#ga46c1e49ca3285ed9fc1b4ac593a25cd3)(\_interval) |
|  | Convert isochronous interval (N \* 1.25 ms) to milliseconds. |
| #define | [BT\_GAP\_PER\_ADV\_INTERVAL\_TO\_US](group__bt__gap__defines.md#ga63587ef565ccde477b9c6f03faf778a5)(\_interval) |
|  | Convert periodic advertising interval (N \* 1.25 ms) to microseconds \*. |
| #define | [BT\_GAP\_PER\_ADV\_INTERVAL\_TO\_MS](group__bt__gap__defines.md#gac240015012694df3557679d99da6c1a9)(\_interval) |
|  | Convert periodic advertising interval (N \* 1.25 ms) to milliseconds. |
| #define | [BT\_GAP\_US\_TO\_ADV\_INTERVAL](group__bt__gap__defines.md#gac79626389f62bb7b3e5b5f6d3a5eaf2b)(\_interval) |
|  | Convert microseconds to advertising interval units (0.625 ms). |
| #define | [BT\_GAP\_MS\_TO\_ADV\_INTERVAL](group__bt__gap__defines.md#gaef9c34f229f1b8b06d3e6cd44a1014ef)(\_interval) |
|  | Convert milliseconds to advertising interval units (0.625 ms). |
| #define | [BT\_GAP\_US\_TO\_PER\_ADV\_INTERVAL](group__bt__gap__defines.md#ga5a9da01507b4356c2ad6f8309257f2ce)(\_interval) |
|  | Convert microseconds to periodic advertising interval units (1.25 ms). |
| #define | [BT\_GAP\_MS\_TO\_PER\_ADV\_INTERVAL](group__bt__gap__defines.md#ga15ec0bc7c9bab797d6c5595269a33ea4)(\_interval) |
|  | Convert milliseconds to periodic advertising interval units (1.25 ms). |
| #define | [BT\_GAP\_MS\_TO\_PER\_ADV\_SYNC\_TIMEOUT](group__bt__gap__defines.md#ga242a6a4e3dd138073c01bc600c9642eb)(\_timeout) |
|  | Convert milliseconds to periodic advertising sync timeout units (10 ms). |
| #define | [BT\_GAP\_US\_TO\_PER\_ADV\_SYNC\_TIMEOUT](group__bt__gap__defines.md#gaf33284a372b21e24c53deb5e3a6a91aa)(\_timeout) |
|  | Convert microseconds to periodic advertising sync timeout units (10 ms). |
| #define | [BT\_GAP\_US\_TO\_SCAN\_INTERVAL](group__bt__gap__defines.md#gab65e489c4a799774f6511c6ce5b65ea2)(\_interval) |
|  | Convert microseconds to scan interval units (0.625 ms). |
| #define | [BT\_GAP\_MS\_TO\_SCAN\_INTERVAL](group__bt__gap__defines.md#gad18c4a9774014081833905fc9e03fb15)(\_interval) |
|  | Convert milliseconds to scan interval units (0.625 ms). |
| #define | [BT\_GAP\_US\_TO\_SCAN\_WINDOW](group__bt__gap__defines.md#gaac5d0ec82d9730b793960c0470ac6342)(\_window) |
|  | Convert microseconds to scan window units (0.625 ms). |
| #define | [BT\_GAP\_MS\_TO\_SCAN\_WINDOW](group__bt__gap__defines.md#ga5204f7e42b4e33eb8ae4ae71b82a4c88)(\_window) |
|  | Convert milliseconds to scan window units (0.625 ms). |
| #define | [BT\_GAP\_US\_TO\_CONN\_INTERVAL](group__bt__gap__defines.md#gab12ba919a5a389b4c342d142d3a9ce6e)(\_interval) |
|  | Convert microseconds to connection interval units (1.25 ms). |
| #define | [BT\_GAP\_MS\_TO\_CONN\_INTERVAL](group__bt__gap__defines.md#ga75985e2c444da7b2426cc746c9781c8c)(\_interval) |
|  | Convert milliseconds to connection interval units (1.25 ms). |
| #define | [BT\_GAP\_MS\_TO\_CONN\_TIMEOUT](group__bt__gap__defines.md#ga24f79cacceeea262987f3cdaf2ef6bc3)(\_timeout) |
|  | Convert milliseconds to connection supervision timeout units (10 ms). |
| #define | [BT\_GAP\_US\_TO\_CONN\_TIMEOUT](group__bt__gap__defines.md#ga317a60f9edb371fef180130282805539)(\_timeout) |
|  | Convert microseconds to connection supervision timeout units (10 ms). |
| #define | [BT\_GAP\_US\_TO\_CONN\_EVENT\_LEN](group__bt__gap__defines.md#ga8905e22b1864021b77367c228b8bff48)(\_event\_len) |
|  | Convert milliseconds to connection event length units (0.625). |
| #define | [BT\_GAP\_MS\_TO\_CONN\_EVENT\_LEN](group__bt__gap__defines.md#gaa3703cccd343dbb6418fdeb47a718eb5)(\_event\_len) |
|  | Convert milliseconds to connection event length units (0.625). |
...
| Enumerations | |
| --- | --- |
| enum | [bt\_gap\_le\_phy](group__bt__gap__defines.md#ga691d9793fd21c41b2c192d65cc2bf6c4) {     [BT\_GAP\_LE\_PHY\_NONE](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4aaf7e1b40f6464a603e5116db269cacab) = 0 , [BT\_GAP\_LE\_PHY\_1M](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4a53eff400720a20fe1a91da4834bad752) = BIT(0) , [BT\_GAP\_LE\_PHY\_2M](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4a662049cc8293959194bcb481e1dd50a8) = BIT(1) , [BT\_GAP\_LE\_PHY\_CODED](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4a97d042e48448fdf6a9e35e5d38cb14c3) = BIT(2) ,     [BT\_GAP\_LE\_PHY\_CODED\_S8](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4a47ca63851d4380aad42a0a37a17f020d) = BIT(3) , [BT\_GAP\_LE\_PHY\_CODED\_S2](group__bt__gap__defines.md#gga691d9793fd21c41b2c192d65cc2bf6c4a23fc74a635a05d082b0033b3f152592b) = BIT(4)   } |
|  | LE PHY types. [More...](group__bt__gap__defines.md#ga691d9793fd21c41b2c192d65cc2bf6c4) |
| enum | [bt\_gap\_adv\_type](group__bt__gap__defines.md#ga07833ed1f79708d5f6a5d0c2e01d4dca) {     [BT\_GAP\_ADV\_TYPE\_ADV\_IND](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaaf4d48e46c1da164e876e4ded28470c82) = 0x00 , [BT\_GAP\_ADV\_TYPE\_ADV\_DIRECT\_IND](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaa05b182a44fea67f52015cbfb4d775be8) = 0x01 , [BT\_GAP\_ADV\_TYPE\_ADV\_SCAN\_IND](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaae48316c135886d9f6d20f7bdba0858c1) = 0x02 , [BT\_GAP\_ADV\_TYPE\_ADV\_NONCONN\_IND](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaabb587b376bd6511881d6b70ceaa2af56) = 0x03 ,     [BT\_GAP\_ADV\_TYPE\_SCAN\_RSP](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaa5387de0177d3a9da9fd0c44ca30c7018) = 0x04 , [BT\_GAP\_ADV\_TYPE\_EXT\_ADV](group__bt__gap__defines.md#gga07833ed1f79708d5f6a5d0c2e01d4dcaa09292ffe2f0b76b8761fcaad6fbf9ba8) = 0x05   } |
|  | Advertising PDU types. [More...](group__bt__gap__defines.md#ga07833ed1f79708d5f6a5d0c2e01d4dca) |
| enum | [bt\_gap\_adv\_prop](group__bt__gap__defines.md#ga8ac9dd875bc7480929b5166193c621d0) {     [BT\_GAP\_ADV\_PROP\_CONNECTABLE](group__bt__gap__defines.md#gga8ac9dd875bc7480929b5166193c621d0af843db0752f3360ccb1a02c456ca9e5e) = BIT(0) , [BT\_GAP\_ADV\_PROP\_SCANNABLE](group__bt__gap__defines.md#gga8ac9dd875bc7480929b5166193c621d0a6c5ea1b8392783568b568c74f9f17571) = BIT(1) , [BT\_GAP\_ADV\_PROP\_DIRECTED](group__bt__gap__defines.md#gga8ac9dd875bc7480929b5166193c621d0a4595d3a3ea30bd4cd51ba4f1c4ab7de9) = BIT(2) , [BT\_GAP\_ADV\_PROP\_SCAN\_RESPONSE](group__bt__gap__defines.md#gga8ac9dd875bc7480929b5166193c621d0a55258ac9a7b355db87aeec5d443718f7) = BIT(3) ,     [BT\_GAP\_ADV\_PROP\_EXT\_ADV](group__bt__gap__defines.md#gga8ac9dd875bc7480929b5166193c621d0aeda2301e9eb191e742375e54bb765684) = BIT(4)   } |
|  | Advertising PDU properties. [More...](group__bt__gap__defines.md#ga8ac9dd875bc7480929b5166193c621d0) |
| enum | [bt\_gap\_cte](group__bt__gap__defines.md#gab7418dd67b5c7fb9b0f9cfd5a55fe272) { [BT\_GAP\_CTE\_AOA](group__bt__gap__defines.md#ggab7418dd67b5c7fb9b0f9cfd5a55fe272a8a82746ee64ffbcc62e79fdd8e0e30a0) = 0x00 , [BT\_GAP\_CTE\_AOD\_1US](group__bt__gap__defines.md#ggab7418dd67b5c7fb9b0f9cfd5a55fe272aa8587383f9ea245e8c279fdd63417a19) = 0x01 , [BT\_GAP\_CTE\_AOD\_2US](group__bt__gap__defines.md#ggab7418dd67b5c7fb9b0f9cfd5a55fe272a2385af24a5a82f4d799674443b92e966) = 0x02 , [BT\_GAP\_CTE\_NONE](group__bt__gap__defines.md#ggab7418dd67b5c7fb9b0f9cfd5a55fe272aec9324d8e0997e1ace59895e168087e8) = 0xFF } |
|  | Constant Tone Extension (CTE) types. [More...](group__bt__gap__defines.md#gab7418dd67b5c7fb9b0f9cfd5a55fe272) |
| enum | [bt\_gap\_sca](group__bt__gap__defines.md#ga3cd6d431193b05414020ca5686f4c0e4) {     [BT\_GAP\_SCA\_UNKNOWN](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4ace5a2d3f9fcb1a8913203ee6f437b910) = 0 , [BT\_GAP\_SCA\_251\_500](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4a96900858c146259fc41af27b4cb62247) = 0 , [BT\_GAP\_SCA\_151\_250](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4ab19b506bc13aad6af3dba925153f4e7d) = 1 , [BT\_GAP\_SCA\_101\_150](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4a7f41d38c1a2125bd7c4d1765c8fbee73) = 2 ,     [BT\_GAP\_SCA\_76\_100](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4aa4011892d3409238f668c87626587bfd) = 3 , [BT\_GAP\_SCA\_51\_75](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4a999a15d6ed8c860af7323af1b4d86fe9) = 4 , [BT\_GAP\_SCA\_31\_50](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4a5fa53f708753d67bd6ec4f54b164b005) = 5 , [BT\_GAP\_SCA\_21\_30](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4a164fe8b7df50d8e393373153a1f70d1d) = 6 ,     [BT\_GAP\_SCA\_0\_20](group__bt__gap__defines.md#gga3cd6d431193b05414020ca5686f4c0e4ab8fd607ccdc30216fd90d4c6f568b9f6) = 7   } |
|  | Peripheral sleep clock accuracy (SCA) in ppm (parts per million). [More...](group__bt__gap__defines.md#ga3cd6d431193b05414020ca5686f4c0e4) |
