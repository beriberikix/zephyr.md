---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/arc_2arch_8h.html
...
`#include <[zephyr/arch/arc/v2/error.h](include_2zephyr_2arch_2arc_2v2_2error_8h_source.md)>`
...
| Typedefs | |
| --- | --- |
| typedef [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [k\_mem\_partition\_attr\_t](group__xtensa__mpu__apis.md#ga58f790e348e5e1c4a3962a134cfb505f) |
...
This header contains the ARC specific kernel interface. It is included by the kernel interface architecture-abstraction header (include/zephyr/arch/cpu.h).
