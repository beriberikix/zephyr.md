---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__http__service.html
...
| #define | [HTTP\_SERVICE\_DEFINE\_EMPTY](#ga8cfc7d2be962a1b0f44e389856097ac1)(\_name, \_host, \_port, \_concurrent, \_backlog, \_detail, \_res\_fallback) |
|  | Define an HTTP service without static resources. |
| #define | [HTTPS\_SERVICE\_DEFINE\_EMPTY](#ga4ec55524f40ac76a0abdcac3818dfa80)(\_name, \_host, \_port, \_concurrent, \_backlog, \_detail, \_res\_fallback, \_sec\_tag\_list, \_sec\_tag\_list\_size) |
|  | Define an HTTPS service without static resources. |
| #define | [HTTP\_SERVICE\_DEFINE](#ga1aa8efe3622b5c9421a6257140c5d2c5)(\_name, \_host, \_port, \_concurrent, \_backlog, \_detail, \_res\_fallback) |
|  | Define an HTTP service with static resources. |
| #define | [HTTPS\_SERVICE\_DEFINE](#gad8468a96fd46ad7d8aaf48667d7ef092)(\_name, \_host, \_port, \_concurrent, \_backlog, \_detail, \_res\_fallback, \_sec\_tag\_list, \_sec\_tag\_list\_size) |
...
`#include <[zephyr/net/http/service.h](service_8h.md)>`
...
Note
:   This macro requires that `_service` is defined with [HTTP\_SERVICE\_DEFINE](#ga1aa8efe3622b5c9421a6257140c5d2c5).
...
## [◆ ](#ga1aa8efe3622b5c9421a6257140c5d2c5)HTTP\_SERVICE\_DEFINE
...
:   |  | \_name | Name of the service. |
    ...
    |  | \_concurrent | Maximum number of concurrent clients. (max. CONFIG\_HTTP\_SERVER\_MAX\_CLIENTS) |
    |  | \_backlog | Maximum number of queued connections. (min. 1) |
    |  | \_detail | User-defined detail associated with the service. |
    |  | \_res\_fallback | Fallback resource to be served if no other resource matches path |

## [◆ ](#ga8cfc7d2be962a1b0f44e389856097ac1)HTTP\_SERVICE\_DEFINE\_EMPTY
...
\_res\_fallback, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
Note
:   This macro is suitable for a `_service` defined with either [HTTP\_SERVICE\_DEFINE](#ga1aa8efe3622b5c9421a6257140c5d2c5) or [HTTP\_SERVICE\_DEFINE\_EMPTY](#ga8cfc7d2be962a1b0f44e389856097ac1).
...
## [◆ ](#gad8468a96fd46ad7d8aaf48667d7ef092)HTTPS\_SERVICE\_DEFINE
...
## [◆ ](#ga4ec55524f40ac76a0abdcac3818dfa80)HTTPS\_SERVICE\_DEFINE\_EMPTY
