---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/kernel__arch__interface_8h_source.html
...
[ 644](group__arch-coredump.md#gad53d55d1e9bf8c15137e204bc05d2732)[uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) [arch\_coredump\_stack\_ptr\_get](group__arch-coredump.md#gad53d55d1e9bf8c15137e204bc05d2732)(const struct [k\_thread](structk__thread.md) \*thread);

645

646#if defined(CONFIG\_USERSPACE) || defined(\_\_DOXYGEN\_\_)

647

[ 655](group__arch-coredump.md#ga31bcb446604666c8f4d05ccfcbc00441)void [arch\_coredump\_priv\_stack\_dump](group__arch-coredump.md#ga31bcb446604666c8f4d05ccfcbc00441)(struct [k\_thread](structk__thread.md) \*thread);

656

657#endif /\* CONFIG\_USERSPACE || \_\_DOXYGEN\_\_ \*/
...
[ 677](group__arch-tls.md#ga7f159caca46063b04cf03a54b39255fc)size\_t [arch\_tls\_stack\_setup](group__arch-tls.md#ga7f159caca46063b04cf03a54b39255fc)(struct [k\_thread](structk__thread.md) \*new\_thread, char \*stack\_ptr);

678

680

681/\* Include arch-specific inline function implementation \*/

682#include <kernel\_arch\_func.h>

683

684#ifdef \_\_cplusplus
...
688#endif /\* \_ASMLANGUAGE \*/

689

690#endif /\* ZEPHYR\_KERNEL\_INCLUDE\_KERNEL\_ARCH\_INTERFACE\_H\_ \*/
...
[arch\_coredump\_stack\_ptr\_get](group__arch-coredump.md#gad53d55d1e9bf8c15137e204bc05d2732)

uintptr\_t arch\_coredump\_stack\_ptr\_get(const struct k\_thread \*thread)
