---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__icmp.html
...
| int | [net\_icmp\_send\_echo\_request\_no\_wait](#ga6464792ecaff412a4eee3fa3952993e4) (struct [net\_icmp\_ctx](structnet__icmp__ctx.md) \*ctx, struct [net\_if](structnet__if.md) \*iface, struct [sockaddr](structsockaddr.md) \*dst, struct [net\_icmp\_ping\_params](structnet__icmp__ping__params.md) \*params, void \*user\_data) |
...
`#include <[zephyr/net/icmp.h](icmp_8h.md)>`
...
## [◆ ](#ga6464792ecaff412a4eee3fa3952993e4)net\_icmp\_send\_echo\_request\_no\_wait()

| int net\_icmp\_send\_echo\_request\_no\_wait | ( | struct [net\_icmp\_ctx](structnet__icmp__ctx.md) \* | *ctx*, |
| --- | --- | --- | --- |
|  |  | struct [net\_if](structnet__if.md) \* | *iface*, |
|  |  | struct [sockaddr](structsockaddr.md) \* | *dst*, |
|  |  | struct [net\_icmp\_ping\_params](structnet__icmp__ping__params.md) \* | *params*, |
...
This function can be used to send ICMP Echo-Request from a system workqueue handler which should not have any sleeps or waits. This variant will do the [net\_buf](structnet__buf.md "Network buffer representation.") allocations with K\_NO\_WAIT. This will avoid a warning message in the log about the timeout.
