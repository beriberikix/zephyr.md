---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/devicetree__regions_8h_source.html
...
215#define \_SECTION\_DECLARE(node\_id) \

216 LINKER\_DT\_NODE\_REGION\_NAME\_TOKEN(node\_id) (NOLOAD) : \

217 { \

218 \_DT\_SECTION\_START(node\_id) = .; \

219 KEEP(\*(LINKER\_DT\_NODE\_REGION\_NAME\_TOKEN(node\_id))) \

220 KEEP(\*(LINKER\_DT\_NODE\_REGION\_NAME\_TOKEN(node\_id).\*)) \

221 \_DT\_SECTION\_END(node\_id) = .; \

222 } > LINKER\_DT\_NODE\_REGION\_NAME\_TOKEN(node\_id) \

223 \_DT\_SECTION\_SIZE(node\_id) = \_DT\_SECTION\_END(node\_id) - \_DT\_SECTION\_START(node\_id); \

224 \_DT\_SECTION\_LOAD(node\_id) = LOADADDR(LINKER\_DT\_NODE\_REGION\_NAME\_TOKEN(node\_id));
...
[ 237](devicetree__regions_8h.md#a1b743e1c6c735c87d4fbd2094819c573)#define LINKER\_DT\_REGIONS() \

238 DT\_FOREACH\_STATUS\_OKAY(\_DT\_COMPATIBLE, \_REGION\_DECLARE)

239

[ 244](devicetree__regions_8h.md#a171f1425c840f60dd94722ff046e0e81)#define LINKER\_DT\_SECTIONS() \

245 DT\_FOREACH\_STATUS\_OKAY(\_DT\_COMPATIBLE, \_SECTION\_DECLARE)

246

247#endif /\* ZEPHYR\_INCLUDE\_LINKER\_DEVICETREE\_REGIONS\_H\_ \*/
