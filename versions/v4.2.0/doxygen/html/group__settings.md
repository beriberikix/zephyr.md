---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__settings.html
...
| #define | [SETTINGS\_FULL\_NAME\_LEN](#gaec4d6fb4a186afb90c74574bab8db855)   (([SETTINGS\_MAX\_NAME\_LEN](#gad96357290d7289dd1d7917abd575c4f7)) + ([SETTINGS\_EXTRA\_LEN](#ga9f10069ed74c368aef366d659d3a917d)) + 1) |
| #define | [SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO](#ga2ab4b85d30c5f6c19e505fdd8cc8f437)(\_hname, \_tree, \_get, \_set, \_commit, \_export, \_cprio) |
...
| int | [settings\_register\_with\_cprio](#gadf612631e30119ff688f83f16ad5aa89) (struct [settings\_handler](structsettings__handler.md) \*cf, int cprio) |
...
| [ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) | [settings\_load\_one](#ga6ada8f687dcd3f3374a766ca173fdf27) (const char \*name, void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) buf\_len) |
|  | Load one serialized item from registered persistence sources. |
| [ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) | [settings\_get\_val\_len](#gacadb36d1cd5f6c7c6cbaf46e0e81ac7c) (const char \*key) |
...
`#include <[zephyr/settings/settings.h](settings_8h.md)>`

## [◆ ](#gaec4d6fb4a186afb90c74574bab8db855)SETTINGS\_FULL\_NAME\_LEN

| #define SETTINGS\_FULL\_NAME\_LEN   (([SETTINGS\_MAX\_NAME\_LEN](#gad96357290d7289dd1d7917abd575c4f7)) + ([SETTINGS\_EXTRA\_LEN](#ga9f10069ed74c368aef366d659d3a917d)) + 1) |
| --- |
...
[SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO](#ga2ab4b85d30c5f6c19e505fdd8cc8f437)(\_hname, \_tree, \_get, \_set, \

\_commit, \_export, 0)

[SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO](#ga2ab4b85d30c5f6c19e505fdd8cc8f437)

#define SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO(\_hname, \_tree, \_get, \_set, \_commit, \_export, \_cprio)

Define a static handler for settings items.

**Definition** settings.h:214

## [◆ ](#ga2ab4b85d30c5f6c19e505fdd8cc8f437)SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO

| #define SETTINGS\_STATIC\_HANDLER\_DEFINE\_WITH\_CPRIO | ( |  | *\_hname*, |
| --- | --- | --- | --- |
|  |  |  | *\_tree*, |
|  |  |  | *\_get*, |
|  |  |  | *\_set*, |
...
:   | \_hname | handler name |
    ...
    | \_cprio | commit priority (lower value is higher priority) |
...
## [◆ ](#gacadb36d1cd5f6c7c6cbaf46e0e81ac7c)settings\_get\_val\_len()

| [ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) settings\_get\_val\_len | ( | const char \* | *key* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | [in] | key | Name/key of the settings item. |
    | --- | --- | --- |

Returns
:   length of value if item exists, 0 if not and negative value on failure.
...
## [◆ ](#ga6ada8f687dcd3f3374a766ca173fdf27)settings\_load\_one()

| [ssize\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a5c5d83d87790efd59ea916c2b99f9118) settings\_load\_one | ( | const char \* | *name*, |
| --- | --- | --- | --- |
|  |  | void \* | *buf*, |
...
Parameters
:   | [in] | name | Name/key of the settings item. |
    | --- | --- | --- |
    | [out] | buf | Pointer to the buffer where the data is going to be loaded |
    | [in] | buf\_len | Length of the allocated buffer. |
...
## [◆ ](#gadf612631e30119ff688f83f16ad5aa89)settings\_register\_with\_cprio()

| int settings\_register\_with\_cprio | ( | struct [settings\_handler](structsettings__handler.md) \* | *cf*, |
| --- | --- | --- | --- |
|  |  | int | *cprio* ) |
...
:   | cf | Structure containing registration info. |
    | --- | --- |
    | cprio | Commit priority (lower value is higher priority). |
