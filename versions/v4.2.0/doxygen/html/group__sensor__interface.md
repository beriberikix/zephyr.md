---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__sensor__interface.html
...
|  | [Battery APIs](group__battery__apis.md) |
|  | Battery API. |
...
| #define | [SENSOR\_CHANNEL\_IS\_ACCEL](#ga8bec69db645c9f4d58b396f4d025d0d8)(chan) |
|  | checks if a given channel is an Accelerometer |
| #define | [SENSOR\_CHANNEL\_IS\_GYRO](#gafac19bf89f1cca6f9a208676588184ae)(chan) |
|  | checks if a given channel is a Gyroscope |
...
| static [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) | [sensor\_ms2\_to\_mg](#ga9e0fb14f84dca02497ce5bff10b51ab8) (const struct [sensor\_value](structsensor__value.md) \*ms2) |
...
| static [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) | [sensor\_value\_to\_deci](#gabbcb8ad4b9484cba77ae65e2d3ba7457) (const struct [sensor\_value](structsensor__value.md) \*val) |
|  | Helper function for converting struct [sensor\_value](structsensor__value.md "Representation of a sensor readout value.") to integer deci units. |
| static [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) | [sensor\_value\_to\_centi](#gae812fb481bfe3a8053f0fc23f8617434) (const struct [sensor\_value](structsensor__value.md) \*val) |
|  | Helper function for converting struct [sensor\_value](structsensor__value.md "Representation of a sensor readout value.") to integer centi units. |
...
`#include <[zephyr/drivers/sensor.h](sensor_8h.md)>`
...
## [◆ ](#ga8bec69db645c9f4d58b396f4d025d0d8)SENSOR\_CHANNEL\_IS\_ACCEL

| #define SENSOR\_CHANNEL\_IS\_ACCEL | ( |  | *chan* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
((chan) == [SENSOR\_CHAN\_ACCEL\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a16c05784ae15a4952ea708c2f11a2ae9) || (chan) == [SENSOR\_CHAN\_ACCEL\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934afa9238082f000350530ca77b2f513d4c) || \

(chan) == [SENSOR\_CHAN\_ACCEL\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a61c145468f01916c1a547fb38a1be9a8) || (chan) == [SENSOR\_CHAN\_ACCEL\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a78e06bb48cfe06e42829816ad4cb5a0f))

[SENSOR\_CHAN\_ACCEL\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a61c145468f01916c1a547fb38a1be9a8)
...
[SENSOR\_CHAN\_ACCEL\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a78e06bb48cfe06e42829816ad4cb5a0f)
...
[SENSOR\_CHAN\_ACCEL\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934afa9238082f000350530ca77b2f513d4c)
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | if `chan` is any of [SENSOR\_CHAN\_ACCEL\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a16c05784ae15a4952ea708c2f11a2ae9), [SENSOR\_CHAN\_ACCEL\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934afa9238082f000350530ca77b2f513d4c), or [SENSOR\_CHAN\_ACCEL\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a61c145468f01916c1a547fb38a1be9a8), or [SENSOR\_CHAN\_ACCEL\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a78e06bb48cfe06e42829816ad4cb5a0f) |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | otherwise |

## [◆ ](#gafac19bf89f1cca6f9a208676588184ae)SENSOR\_CHANNEL\_IS\_GYRO

| #define SENSOR\_CHANNEL\_IS\_GYRO | ( |  | *chan* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
((chan) == [SENSOR\_CHAN\_GYRO\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a1d36b89ab3761e9bc86effc839f8db0e) || (chan) == [SENSOR\_CHAN\_GYRO\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934ac5709b77f0eb69972ccc055f927e5015) || \

(chan) == [SENSOR\_CHAN\_GYRO\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a4a9533172105fd2e55d96e0122a48847) || (chan) == [SENSOR\_CHAN\_GYRO\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a9b6b9d13cd8d82449823d65779a87a39))

[SENSOR\_CHAN\_GYRO\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a4a9533172105fd2e55d96e0122a48847)
...
[SENSOR\_CHAN\_GYRO\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a9b6b9d13cd8d82449823d65779a87a39)
...
[SENSOR\_CHAN\_GYRO\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934ac5709b77f0eb69972ccc055f927e5015)
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | if `chan` is any of [SENSOR\_CHAN\_GYRO\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a1d36b89ab3761e9bc86effc839f8db0e), [SENSOR\_CHAN\_GYRO\_X](#ggaaa1b502bc029b10d7b23b0a25ef4e934ac5709b77f0eb69972ccc055f927e5015), or [SENSOR\_CHAN\_GYRO\_Y](#ggaaa1b502bc029b10d7b23b0a25ef4e934a4a9533172105fd2e55d96e0122a48847), or [SENSOR\_CHAN\_GYRO\_Z](#ggaaa1b502bc029b10d7b23b0a25ef4e934a9b6b9d13cd8d82449823d65779a87a39) |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | otherwise |
...
[sensor\_stream](#gac77fc83844935f61a2bf9ab2c38987b6)(&imu\_stream, &[rtio](structrtio.md), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), &handle);
...
| SENSOR\_CHAN\_FREQUENCY | Frequency, in Hz. |
| SENSOR\_CHAN\_GAUGE\_VOLTAGE | Voltage, in volts. |
| SENSOR\_CHAN\_GAUGE\_AVG\_CURRENT | Average current, in amps (negative=discharging). |
| SENSOR\_CHAN\_GAUGE\_STDBY\_CURRENT | Standby current, in amps (negative=discharging). |
| SENSOR\_CHAN\_GAUGE\_MAX\_LOAD\_CURRENT | Max load current, in amps (negative=discharging). |
...
| SENSOR\_CHAN\_GAME\_ROTATION\_VECTOR | Game Rotation Vector (unit quaternion components X/Y/Z/W). |
| SENSOR\_CHAN\_GRAVITY\_VECTOR | Gravity Vector (X/Y/Z components in m/s^2). |
| SENSOR\_CHAN\_GBIAS\_XYZ | Gyroscope bias (X/Y/Z components in radians/s). |
...
| SENSOR\_TRIG\_TILT | Trigger fires when a tilt is detected. |
...
## [◆ ](#ga9e0fb14f84dca02497ce5bff10b51ab8)sensor\_ms2\_to\_mg()

| | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) sensor\_ms2\_to\_mg | ( | const struct [sensor\_value](structsensor__value.md) \* | *ms2* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int sensor\_trigger\_set | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | const struct [sensor\_trigger](structsensor__trigger.md) \* | *trig*, | |  |  | [sensor\_trigger\_handler\_t](#ga890c1fb6d6974aea22a2d08829a75902) | *handler* ) | | inlinestaticsupervisor |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gae812fb481bfe3a8053f0fc23f8617434)sensor\_value\_to\_centi()

| | [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) sensor\_value\_to\_centi | ( | const struct [sensor\_value](structsensor__value.md) \* | *val* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gabbcb8ad4b9484cba77ae65e2d3ba7457)sensor\_value\_to\_deci()

| | [int64\_t](stdint_8h.md#ac714c0d2c1a4adb10e73cab29623314b) sensor\_value\_to\_deci | ( | const struct [sensor\_value](structsensor__value.md) \* | *val* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
