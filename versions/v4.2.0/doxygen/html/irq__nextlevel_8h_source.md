---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/irq__nextlevel_8h_source.html
...
[ 130](irq__nextlevel_8h.md#a7e0e5fe59eae08878a8f243dd9301633)static inline unsigned int [irq\_line\_is\_enabled\_next\_level](irq__nextlevel_8h.md#a7e0e5fe59eae08878a8f243dd9301633)(const struct [device](structdevice.md) \*dev,

131 unsigned int irq)

132{

133 const struct irq\_next\_level\_api \*api =

134 (const struct irq\_next\_level\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

135

136 return api->intr\_get\_line\_state(dev, irq);

137}

138

139#endif /\* CONFIG\_MULTI\_LEVEL\_INTERRUPTS \*/
...
144#endif /\* ZEPHYR\_INCLUDE\_IRQ\_NEXTLEVEL\_H\_ \*/
...
**Definition** irq\_nextlevel.h:130
