---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/a2dp_8h.html
...
|  | MPEG2,4 IE length. |
| #define | [BT\_A2DP\_MAX\_IE\_LENGTH](#a8c365793c40e8425d9e002208bc7863f)   (8U) |
...
| int | [bt\_a2dp\_register\_ep](#ab1cd7028a41bfdc34ce8cc60aed239de) (struct [bt\_a2dp\_ep](structbt__a2dp__ep.md) \*ep, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) media\_type, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) sep\_type) |
|  | Endpoint Registration. |
| int | [bt\_a2dp\_register\_cb](#a4af29d7c162743c00534868ba945b7ec) (struct [bt\_a2dp\_cb](structbt__a2dp__cb.md) \*cb) |
|  | register callback. |
| struct bt\_conn \* | [bt\_a2dp\_get\_conn](#a09470ceb08b66661d63c951736f34a5d) (struct bt\_a2dp \*a2dp) |
...
| int | [bt\_a2dp\_stream\_abort](#a7999e06ef74be78ec2744bb24ff72912) (struct [bt\_a2dp\_stream](structbt__a2dp__stream.md) \*stream) |
|  | abort a2dp streamer. |
...
.codec\_cap = \_capability, .stream = [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), \
...
## [◆ ](#a8c365793c40e8425d9e002208bc7863f)BT\_A2DP\_MAX\_IE\_LENGTH

| #define BT\_A2DP\_MAX\_IE\_LENGTH   (8U) |
| --- |
...
.len = [BT\_A2DP\_SBC\_IE\_LENGTH](#af83aa927ac312cfc8577056afffeae56), \

.codec\_ie = {\_freq\_cfg | \_ch\_mode\_cfg, \

\_blk\_len\_cfg | \_subband\_cfg | \_alloc\_mthd\_cfg, \_min\_bitpool\_cfg, \

\_max\_bitpool\_cfg}, \

}; \

struct bt\_a2dp\_codec\_cfg \_name = { \

.codec\_config = &bt\_a2dp\_codec\_ie##\_name, \
...
.codec\_ie = {\_freq\_cfg | [A2DP\_SBC\_CH\_MODE\_JOINT](a2dp__codec__sbc_8h.md#afcf64fa599e4d820dccdf40990f5ba39), \

[A2DP\_SBC\_BLK\_LEN\_16](a2dp__codec__sbc_8h.md#a1cb9425713c325442652fb406557e52a) | [A2DP\_SBC\_SUBBAND\_8](a2dp__codec__sbc_8h.md#a6b4bd1ef891c14c4f863c9623dcb63f7) | \
...
.codec\_ie = {\_freq | \_ch\_mode, \_blk\_len | \_subband | \_alloc\_mthd, \_min\_bitpool, \

\_max\_bitpool}}; \

static struct bt\_a2dp\_ep \_name = \

BT\_A2DP\_SINK\_EP\_INIT([BT\_A2DP\_SBC](#afdb0a28b03d1e11f0595dd3f0b3cb4d6abd097d204d4136c5205afe7dfe3dfe00), (&bt\_a2dp\_ep\_cap\_ie##\_name))
...
.codec\_ie = {[A2DP\_SBC\_SAMP\_FREQ\_44100](a2dp__codec__sbc_8h.md#a57d7b85560b36603651fae6c055c32c6) | [A2DP\_SBC\_SAMP\_FREQ\_48000](a2dp__codec__sbc_8h.md#a0ebafbef2cddd4b6c7c7990ca77db0f9) | \

[A2DP\_SBC\_CH\_MODE\_MONO](a2dp__codec__sbc_8h.md#aa9b58737fa1561b684a20980ea0b6feb) | [A2DP\_SBC\_CH\_MODE\_STREO](a2dp__codec__sbc_8h.md#acc5be684b75804f72a28d025fc5cc9bb) | \
...
BT\_A2DP\_SOURCE\_EP\_INIT([BT\_A2DP\_SBC](#afdb0a28b03d1e11f0595dd3f0b3cb4d6abd097d204d4136c5205afe7dfe3dfe00), &bt\_a2dp\_ep\_cap\_ie##\_name)
...
## [◆ ](#a09470ceb08b66661d63c951736f34a5d)bt\_a2dp\_get\_conn()
...
Returns
:   Connection object associated with the A2DP context. The caller gets a new reference to the connection object which must be released with [bt\_conn\_unref()](group__bt__conn.md#ga4b18c6b22a9f02be0d7d078b2ce51ff6 "Decrement a connection's reference count.") once done using the object.
...
## [◆ ](#ab1cd7028a41bfdc34ce8cc60aed239de)bt\_a2dp\_register\_ep()
...
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *sep\_type* ) |
...
:   | ep | Pointer to [bt\_a2dp\_ep](structbt__a2dp__ep.md "Stream End Point.") structure. |
    | --- | --- |
    | media\_type | Media type that the Endpoint is, [bt\_avdtp\_media\_type](avdtp_8h.md#a6e9f13217ede2687e206b6a8cbd9137f "Stream End Point Media Type."). |
    | sep\_type | Stream endpoint type, [bt\_avdtp\_sep\_type](avdtp_8h.md#a28b828df32df5a40e8487dc4dee78757 "Stream End Point Type."). |

Returns
:   0 in case of success and error code in case of error.

## [◆ ](#a7999e06ef74be78ec2744bb24ff72912)bt\_a2dp\_stream\_abort()

| int bt\_a2dp\_stream\_abort | ( | struct [bt\_a2dp\_stream](structbt__a2dp__stream.md) \* | *stream* | ) |  |
| --- | --- | --- | --- | --- | --- |

abort a2dp streamer.

This function sends the AVDTP\_ABORT command. After abort, the stream becomes invalid.
...
This function sends the AVDTP\_CLOSE command and release the l2cap channel. After release, the stream becomes invalid.
