---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mcumgr__callback__api.html
...
| Topics | |
| --- | --- |
|  | [MCUmgr enum\_mgmt callback API](group__mcumgr__callback__api__enum__mgmt.md) |
|  | MCUmgr enum\_mgmt callback API. |
...
| enum | [enum\_mgmt\_group\_events](#ga7ddc4c031948a2fee56fcbdb7d675a1d) { [MGMT\_EVT\_OP\_ENUM\_MGMT\_DETAILS](#gga7ddc4c031948a2fee56fcbdb7d675a1da749daeaef01327a881f91671b9222abf) = MGMT\_DEF\_EVT\_OP\_ID(MGMT\_EVT\_GRP\_ENUM, 0) , [MGMT\_EVT\_OP\_ENUM\_MGMT\_ALL](#gga7ddc4c031948a2fee56fcbdb7d675a1da5f19a62b627e602db48748c91ce2354b) = MGMT\_DEF\_EVT\_OP\_ALL(MGMT\_EVT\_GRP\_ENUM) } |
|  | MGMT event opcodes for enumeration management group. [More...](#ga7ddc4c031948a2fee56fcbdb7d675a1d) |
...
`#include <[zephyr/mgmt/mcumgr/mgmt/callbacks.h](callbacks_8h.md)>`
...
## [◆ ](#ga7ddc4c031948a2fee56fcbdb7d675a1d)enum\_mgmt\_group\_events

| enum [enum\_mgmt\_group\_events](#ga7ddc4c031948a2fee56fcbdb7d675a1d) |
| --- |
...
| Enumerator | |
| --- | --- |
| MGMT\_EVT\_OP\_ENUM\_MGMT\_DETAILS | Callback when fetching details on supported command groups. |
| MGMT\_EVT\_OP\_ENUM\_MGMT\_ALL | Used to enable all enum\_mgmt\_group events. |
...
| MGMT\_EVT\_OP\_FS\_MGMT\_FILE\_ACCESS\_DONE | Callback when a file upload/download is finished, data is [fs\_mgmt\_file\_access()](structfs__mgmt__file__access.md "Structure provided in the MGMT_EVT_OP_FS_MGMT_FILE_ACCESS notification callback: This callback functi..."). |
...
| MGMT\_EVT\_OP\_IMG\_MGMT\_DFU\_CONFIRMED | Callback when an image has been confirmed.  data is [img\_mgmt\_image\_confirmed()](structimg__mgmt__image__confirmed.md "Structure provided in the MGMT_EVT_OP_IMG_MGMT_DFU_CONFIRMED notification callback: This callback fun..."). |
| MGMT\_EVT\_OP\_IMG\_MGMT\_DFU\_CHUNK\_WRITE\_COMPLETE | Callback when an image write command has finished writing to flash. |
| MGMT\_EVT\_OP\_IMG\_MGMT\_IMAGE\_SLOT\_STATE | Callback when an image slot's state is encoded for a response, data is [img\_mgmt\_state\_slot\_encode()](structimg__mgmt__state__slot__encode.md "Structure provided in the MGMT_EVT_OP_IMG_MGMT_IMAGE_SLOT_STATE notification callback: This callback ..."). |
| MGMT\_EVT\_OP\_IMG\_MGMT\_SLOT\_INFO\_IMAGE | Callback when a slot list command outputs fields for an image, data is [img\_mgmt\_slot\_info\_image()](structimg__mgmt__slot__info__image.md "Structure provided in the MGMT_EVT_OP_IMG_MGMT_SLOT_INFO_IMAGE notification callback: This callback f..."). |
| MGMT\_EVT\_OP\_IMG\_MGMT\_SLOT\_INFO\_SLOT | Callback when a slot list command outputs fields for a slot of an image, data is [img\_mgmt\_slot\_info\_slot()](structimg__mgmt__slot__info__slot.md "Structure provided in the MGMT_EVT_OP_IMG_MGMT_SLOT_INFO_SLOT notification callback: This callback fu..."). |
...
| MGMT\_EVT\_OP\_OS\_MGMT\_BOOTLOADER\_INFO | Callback when a bootloader info command has been received, data is [os\_mgmt\_bootloader\_info\_data()](structos__mgmt__bootloader__info__data.md "Structure provided in the MGMT_EVT_OP_OS_MGMT_BOOTLOADER_INFO notification callback: This callback fu..."). |
