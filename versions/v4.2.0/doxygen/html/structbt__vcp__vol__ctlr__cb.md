---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structbt__vcp__vol__ctlr__cb.html
...
`#include <[zephyr/bluetooth/audio/vcp.h](vcp_8h_source.md)>`
...
|  | Callback function for [bt\_vcp\_vol\_ctlr\_discover()](group__bt__vcp.md#gac18d43a0785155c1131249f95554f2de "Discover Volume Control Service and included services."). |
| void(\* | [vol\_down](#ac986e0c5cb49395fe8581f5b1dae1a88) )(struct bt\_vcp\_vol\_ctlr \*vol\_ctlr, int err) |
|  | Callback function for [bt\_vcp\_vol\_ctlr\_vol\_down()](group__bt__vcp.md#ga03e073e29920f4a530d2f8851b4b8df4 "Turn the volume down one step on a remote Volume Renderer."). |
| void(\* | [vol\_up](#ae1beaa5d0a61c630fa90b4a5236ce743) )(struct bt\_vcp\_vol\_ctlr \*vol\_ctlr, int err) |
|  | Callback function for [bt\_vcp\_vol\_ctlr\_vol\_up()](group__bt__vcp.md#ga908eb20727e1d68ed569badfd13ff896 "Turn the volume up one step on a remote Volume Renderer."). |
| void(\* | [mute](#aa2cd77992831eef7e59d3e4a01a0e542) )(struct bt\_vcp\_vol\_ctlr \*vol\_ctlr, int err) |
|  | Callback function for [bt\_vcp\_vol\_ctlr\_mute()](group__bt__vcp.md#ga106b7f826adec665b4f0ac3d5e82b867 "Mute a remote Volume Renderer."). |
| void(\* | [unmute](#a6a217e0d8cbcc56e5128d5b7acdaac6d) )(struct bt\_vcp\_vol\_ctlr \*vol\_ctlr, int err) |
|  | Callback function for [bt\_vcp\_vol\_ctlr\_unmute()](group__bt__vcp.md#ga4e95c3fb071cb94fbe75f88e96d34b36 "Unmute a remote Volume Renderer."). |
...
These can be registered for usage with [bt\_vcp\_vol\_ctlr\_cb\_register()](group__bt__vcp.md#ga7861d0c3426870c015106e8e170004a3 "Registers the callbacks used by the Volume Controller.").
