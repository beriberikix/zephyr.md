---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__gatt__server.html
...
| struct | [bt\_gatt\_ccc\_managed\_user\_data](structbt__gatt__ccc__managed__user__data.md) |
|  | Internal representation of CCC value. [More...](structbt__gatt__ccc__managed__user__data.md#details) |
...
| #define | [BT\_GATT\_CCC\_INITIALIZER](#gab422808c5af1a1da27e15fd458d96bb8)   [BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT](#gae3a23386bfe38e0127b74e0f4b5e5667) \_\_DEPRECATED\_MACRO |
|  | Macro to keep old name for deprecation period. |
| #define | [BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT](#gae3a23386bfe38e0127b74e0f4b5e5667)(\_changed, \_write, \_match) |
...
| #define | [BT\_GATT\_CCC\_WITH\_WRITE\_CB](#ga9a6fa72eb2b6e9438ad677365c998428)(\_changed, \_write, \_perm) |
...
| Enumerations | |
| --- | --- |
| enum | [bt\_gatt\_iter](#gab38994257f53473e62e01eff8f236ee1) { [BT\_GATT\_ITER\_STOP](#ggab38994257f53473e62e01eff8f236ee1aa3f2a25e27c7065a2c7bb2a9ff09542e) = 0 , [BT\_GATT\_ITER\_CONTINUE](#ggab38994257f53473e62e01eff8f236ee1aea569feffa4815d3443e12be78c684f5) } |
|  | to be used as return values for [bt\_gatt\_attr\_func\_t](#ga60284611c90729b289fe806524ba9209) and [bt\_gatt\_read\_func\_t](group__bt__gatt__client.md#ga1ca94b4f2b6c456b6134e05127993569 "bt_gatt_read_func_t") type callbacks. [More...](#gab38994257f53473e62e01eff8f236ee1) |
...
| struct [bt\_gatt\_attr](structbt__gatt__attr.md) \* | [bt\_gatt\_find\_by\_uuid](#gad2f3272b1dc42378104b492ec7caf6b0) (const struct [bt\_gatt\_attr](structbt__gatt__attr.md) \*attr, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) attr\_count, const struct [bt\_uuid](structbt__uuid.md) \*[uuid](structuuid.md)) |
...
|  | Notify attribute value change. |
| static int | [bt\_gatt\_notify\_uuid](#ga24bae284dbc71cd4075649c4bc348b7c) (struct bt\_conn \*conn, const struct [bt\_uuid](structbt__uuid.md) \*[uuid](structuuid.md), const struct [bt\_gatt\_attr](structbt__gatt__attr.md) \*attr, const void \*data, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) len) |
...
[BT\_GATT\_CCC\_MANAGED](#gad8b296ecfd1139680f21da7904b9f585)(((struct [bt\_gatt\_ccc\_managed\_user\_data](structbt__gatt__ccc__managed__user__data.md)[]){ \

BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT(\_changed, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))}), \
...
## [◆ ](#gab422808c5af1a1da27e15fd458d96bb8)BT\_GATT\_CCC\_INITIALIZER

| #define BT\_GATT\_CCC\_INITIALIZER   [BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT](#gae3a23386bfe38e0127b74e0f4b5e5667) \_\_DEPRECATED\_MACRO |
| --- |
...
Parameters
:   | \_ccc | A new [bt\_gatt\_ccc\_managed\_user\_data](structbt__gatt__ccc__managed__user__data.md "bt_gatt_ccc_managed_user_data") object with the same lifetime as the results of the call to BT\_GATT\_CCC\_MANAGED. See the documentation of [bt\_gatt\_ccc\_managed\_user\_data](structbt__gatt__ccc__managed__user__data.md "bt_gatt_ccc_managed_user_data") on how to initialize it. |
    | --- | --- |
    | \_perm | CCC access permissions, a bitmap of [bt\_gatt\_perm](group__bt__gatt.md#ga96e57500d2340a45badb23701cc43833 "bt_gatt_perm") values. |

## [◆ ](#gae3a23386bfe38e0127b74e0f4b5e5667)BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT

| #define BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT | ( |  | *\_changed*, |
| --- | --- | --- | --- |
|  |  |  | *\_write*, |
|  |  |  | *\_match* ) |
...
## [◆ ](#ga9a6fa72eb2b6e9438ad677365c998428)BT\_GATT\_CCC\_WITH\_WRITE\_CB

| #define BT\_GATT\_CCC\_WITH\_WRITE\_CB | ( |  | *\_changed*, |
| --- | --- | --- | --- |
|  |  |  | *\_write*, |
|  |  |  | *\_perm* ) |
...
BT\_GATT\_CCC\_MANAGED\_USER\_DATA\_INIT(\_changed, \_write, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))}), \
...
Returns
:   [BT\_GATT\_ITER\_CONTINUE](#ggab38994257f53473e62e01eff8f236ee1aea569feffa4815d3443e12be78c684f5) if should continue to the next attribute.
:   [BT\_GATT\_ITER\_STOP](#ggab38994257f53473e62e01eff8f236ee1aa3f2a25e27c7065a2c7bb2a9ff09542e) to stop.
...
## [◆ ](#gab38994257f53473e62e01eff8f236ee1)bt\_gatt\_iter

| enum [bt\_gatt\_iter](#gab38994257f53473e62e01eff8f236ee1) |
| --- |
...
Note
:   Only use this with attributes which user\_data is a [bt\_gatt\_include](structbt__gatt__include.md "Include Attribute Value."). The function returns EINVAL if `attr` or `attr->user_data` is NULL.
...
Note
:   The user\_data of the attribute must be of type [bt\_gatt\_chrc](structbt__gatt__chrc.md "bt_gatt_chrc") and the [uuid](structuuid.md "Binary representation of a UUID.") shall be BT\_UUID\_GATT\_CHRC.
...
:   | attr | Pointer to an attribute that serves as the starting point for the search of a match for the UUID. Passing NULL will search the entire range. |
    ...
    | [uuid](structuuid.md "Binary representation of a UUID.") | UUID to match. |
...
Parameters
:   | start\_handle | Starting attribute handle. |
    | --- | --- |
    | end\_handle | Ending attribute handle. |
...
Parameters
:   | start\_handle | Start attribute handle. |
    | --- | --- |
    | end\_handle | End attribute handle. Often set to start\_handle + attr\_count or BT\_ATT\_LAST\_ATTRIBUTE\_HANDLE. |
    | [uuid](structuuid.md "Binary representation of a UUID.") | UUID to match, passing NULL skips UUID matching. |
...
:   | conn | Connection object. |
    | --- | --- |
    | [uuid](structuuid.md "Binary representation of a UUID.") | The UUID. If the server contains multiple services with the same UUID, then the first occurrence, starting from the attr given, is used. |
