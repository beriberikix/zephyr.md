---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__flagged-single-linked-list__apis.html
...
| #define | [SYS\_SFLIST\_FLAGS\_MASK](#ga46e57329036b76ab03267d2e9258d5c2)   (([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808))(\_\_alignof\_\_([sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7)) - 1)) |
...
|  | Initialize a list. |
| static [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [sys\_sfnode\_flags\_get](#gac37d689834e258c4f113204f574c1c9c) (const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \*node) |
|  | Fetch flags value for a particular sfnode. |
| static [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | [sys\_sflist\_peek\_head](#gaa21d0f39228534840c81ac518c82541c) (const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \*list) |
|  | Peek the first node from the list. |
| static [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | [sys\_sflist\_peek\_tail](#ga89f8bbced2992a84bae32db74e544788) (const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \*list) |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [sys\_sflist\_is\_empty](#ga039ad5d35670e5d18acb38a174258a7e) (const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \*list) |
|  | Test if the given list is empty. |
| static [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | [sys\_sflist\_peek\_next\_no\_check](#ga45c613fd20a67fb120d94a915ce68618) (const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \*node) |
|  | Peek the next node from current node, node is not NULL. |
| static [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | [sys\_sflist\_peek\_next](#gaa9013d3a0b241dc63d038f49f822c0f8) (const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \*node) |
...
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [sys\_sflist\_len](#ga46a75676d66c97f0f8be694342b3c660) (const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \*list) |
...
`#include <[zephyr/sys/sflist.h](sflist_8h.md)>`
...
| #define SYS\_SFLIST\_FLAGS\_MASK   (([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808))(\_\_alignof\_\_([sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7)) - 1)) |
| --- |
...
{[NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)}
...
## [◆ ](#ga039ad5d35670e5d18acb38a174258a7e)sys\_sflist\_is\_empty()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) sys\_sflist\_is\_empty | ( | const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga46a75676d66c97f0f8be694342b3c660)sys\_sflist\_len()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) sys\_sflist\_len | ( | const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaa21d0f39228534840c81ac518c82541c)sys\_sflist\_peek\_head()

| | [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* sys\_sflist\_peek\_head | ( | const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaa9013d3a0b241dc63d038f49f822c0f8)sys\_sflist\_peek\_next()

| | [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* sys\_sflist\_peek\_next | ( | const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga45c613fd20a67fb120d94a915ce68618)sys\_sflist\_peek\_next\_no\_check()

| | [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* sys\_sflist\_peek\_next\_no\_check | ( | const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Faster then [sys\_sflist\_peek\_next()](#gaa9013d3a0b241dc63d038f49f822c0f8) if node is known not to be NULL.
...
## [◆ ](#ga89f8bbced2992a84bae32db74e544788)sys\_sflist\_peek\_tail()

| | [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* sys\_sflist\_peek\_tail | ( | const [sys\_sflist\_t](#ga9e7f835170787303732c805dc7375f66) \* | *list* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gac37d689834e258c4f113204f574c1c9c)sys\_sfnode\_flags\_get()

| | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) sys\_sfnode\_flags\_get | ( | const [sys\_sfnode\_t](#ga02dabbe35036cbc11fbbefa99a129cc7) \* | *node* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | node | A pointer to the node to set the flags on |
    | --- | --- |
    | [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9) | The flags value to set |
