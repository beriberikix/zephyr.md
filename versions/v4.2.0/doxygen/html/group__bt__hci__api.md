---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__hci__api.html
...
`#include <[zephyr/drivers/bluetooth.h](drivers_2bluetooth_8h.md)>`
...
:   | dev | HCI device |
    | --- | --- |
    | [recv](posix_2sys_2socket_8h.md#adee01662b0cf762a014efd87ab811276) | This is callback through which the HCI driver provides the host with data from the controller. The callback is expected to be called from thread context. |
