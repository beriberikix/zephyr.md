---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__modem__pipe.html
...
| Functions | |
| --- | --- |
| int | [modem\_pipe\_open](#ga7521ac0aeda8027c47741237e8312bf0) (struct modem\_pipe \*pipe, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Open pipe. |
...
|  | Clear callback. |
| int | [modem\_pipe\_close](#ga4f5d30e87bb252c4e38ce2e3b10e78c5) (struct modem\_pipe \*pipe, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Close pipe. |
...
`#include <[zephyr/modem/pipe.h](pipe_8h.md)>`
...
## [◆ ](#ga4f5d30e87bb252c4e38ce2e3b10e78c5)modem\_pipe\_close()
...
## [◆ ](#ga7521ac0aeda8027c47741237e8312bf0)modem\_pipe\_open()
