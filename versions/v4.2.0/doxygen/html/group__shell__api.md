---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__shell__api.html
...
| struct | [shell\_cmd\_help](structshell__cmd__help.md) |
|  | Shell structured help descriptor. [More...](structshell__cmd__help.md#details) |
...
| Macros | |
| --- | --- |
| #define | [SHELL\_HELP](#gacf66d1ef4c3ae7d18a5f0668c667ed77)(\_description, \_usage) |
...
| #define | [SHELL\_SUBCMD\_SET\_END](#ga4f7a3432f76541eb226a426507e10174)   {0} |
...
| const struct [device](structdevice.md) \* | [shell\_device\_get\_binding](#ga7fb40045dc0a27c175e37a6c9cd84b53) (const char \*name) |
|  | Get a [device](structdevice.md "device") reference from its [device::name](structdevice.md#a1e74e8d3b0b1a981c67e1d0284ccac3d "device::name") field or label. |
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [shell\_help\_is\_structured](#ga061bf2530269ebf20d8e006dace5e33b) (const char \*help) |
...
`#include <[zephyr/shell/shell.h](shell_2shell_8h.md)>`
...
:   | [in] | syntax | Command syntax (for example: history). |
    ...
    | [in] | help | Pointer to a command help string. Use [SHELL\_HELP](#gacf66d1ef4c3ae7d18a5f0668c667ed77) for structured help. |
...
[SHELL\_CMD\_ARG](#gad762c496a2ced65069b6d1d02a4d925c)([GET\_ARG\_N](group__sys-util.md#gabbe04a4d59a495b2b86196304b937ec6)(1, \_\_DEBRACKET \_data), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), [GET\_ARG\_N](group__sys-util.md#gabbe04a4d59a495b2b86196304b937ec6)(3, \_\_DEBRACKET \_data), \
...
.help = (\_expr) ? (const char \*)\_help : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), \

.subcmd = (const union [shell\_cmd\_entry](unionshell__cmd__entry.md) \*)((\_expr) ? \

\_subcmd : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)), \

.handler = ([shell\_cmd\_handler](#ga331e7d19b9b0755486596f5ffc598338))((\_expr) ? \_handler : [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)), \
...
## [◆ ](#gacf66d1ef4c3ae7d18a5f0668c667ed77)SHELL\_HELP

| #define SHELL\_HELP | ( |  | *\_description*, |
| --- | --- | --- | --- |
|  |  |  | *\_usage* ) |
...
((const char \*)&(const struct [shell\_cmd\_help](structshell__cmd__help.md)){ \

.magic = SHELL\_STRUCTURED\_HELP\_MAGIC, \
...
#define MY\_CMD\_HELP SHELL\_HELP("Do stuff", "<device> <arg1> [<arg2>]")

[SHELL\_CMD\_REGISTER](#ga06060b98eb505300a3dcc8f922a8e7ab)(my\_cmd, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), MY\_CMD\_HELP, &my\_cmd\_handler, 1, 1);
...
**Definition** shell.h:387

Parameters
:   | [in] | \_description | Command description. This can be a multi-line string. First line should be one sentence describing the command. Additional lines might be used to provide additional details. |
    | --- | --- | --- |
    | [in] | \_usage | Command usage string. This can be a multi-line string. First line should always be indicating the command syntax (*without* the command name). Additional lines may be used to provide additional details, e.g. explain the meaning of each argument, allowed values, etc. |
...
[SHELL\_CMD\_REGISTER](#ga06060b98eb505300a3dcc8f922a8e7ab)(dictionary, &sub\_dict\_cmds, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4), [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4));
...
| #define SHELL\_SUBCMD\_SET\_END   {0} |
| --- |
...
## [◆ ](#ga7fb40045dc0a27c175e37a6c9cd84b53)shell\_device\_get\_binding()

| const struct [device](structdevice.md) \* shell\_device\_get\_binding | ( | const char \* | *name* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga061bf2530269ebf20d8e006dace5e33b)shell\_help\_is\_structured()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) shell\_help\_is\_structured | ( | const char \* | *help* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | help | Pointer to help string or structured help. |
    | --- | --- |

Returns
:   true if help is structured, false otherwise.
