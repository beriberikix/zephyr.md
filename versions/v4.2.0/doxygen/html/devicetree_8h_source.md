---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/devicetree_8h_source.html
...
693 IS\_EQ(DT\_DEP\_ORD(node\_id1), DT\_DEP\_ORD(node\_id2))
...
1055 IS\_ENABLED(DT\_CAT6(node\_id, \_P\_, prop, \_ENUM\_VAL\_, value, \_EXISTS))
...
4821 UTIL\_NOT(IS\_EMPTY( \

4822 DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS(DT\_ANY\_INST\_HAS\_PROP\_STATUS\_OKAY\_, prop)))

4823

[ 4868](group__devicetree-inst.md#ga4b22771199048b3db1d43955f3743ab9)#define DT\_ALL\_INST\_HAS\_PROP\_STATUS\_OKAY(prop) \

4869 IS\_EMPTY(DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS(DT\_ALL\_INST\_HAS\_PROP\_STATUS\_OKAY\_, prop))

4870

[ 4915](group__devicetree-inst.md#ga052727464d4f04768eaa71b7522c9a61)#define DT\_ANY\_COMPAT\_HAS\_PROP\_STATUS\_OKAY(compat, prop) \

4916 (DT\_COMPAT\_FOREACH\_STATUS\_OKAY\_VARGS(compat, DT\_COMPAT\_NODE\_HAS\_PROP\_AND\_OR, prop) 0)

4917

[ 4965](group__devicetree-inst.md#gab3d2f48ad95c4e2af76eed5e34735b18)#define DT\_ANY\_INST\_HAS\_BOOL\_STATUS\_OKAY(prop) \

4966 UTIL\_NOT(IS\_EMPTY( \

4967 DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS(DT\_ANY\_INST\_HAS\_BOOL\_STATUS\_OKAY\_, prop)))

4968

[ 5014](group__devicetree-inst.md#ga85abb155219c1ff13429356c0b4a6c25)#define DT\_ALL\_INST\_HAS\_BOOL\_STATUS\_OKAY(prop) \

5015 IS\_EMPTY(DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS(DT\_ALL\_INST\_HAS\_BOOL\_STATUS\_OKAY\_, prop))

5016

[ 5082](group__devicetree-inst.md#gaeac7ed0f4a6820a6e5d7dadb6d62d6e7)#define DT\_INST\_FOREACH\_STATUS\_OKAY(fn) \

5083 COND\_CODE\_1(DT\_HAS\_COMPAT\_STATUS\_OKAY(DT\_DRV\_COMPAT), \

5084 (UTIL\_CAT(DT\_FOREACH\_OKAY\_INST\_, \

5085 DT\_DRV\_COMPAT)(fn)), \

5086 ())

5087

[ 5100](group__devicetree-inst.md#ga1b9fd4b9c37a23e52e69ea23f7aedb38)#define DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS(fn, ...) \

5101 COND\_CODE\_1(DT\_HAS\_COMPAT\_STATUS\_OKAY(DT\_DRV\_COMPAT), \

5102 (UTIL\_CAT(DT\_FOREACH\_OKAY\_INST\_VARGS\_, \

5103 DT\_DRV\_COMPAT)(fn, \_\_VA\_ARGS\_\_)), \

5104 ())

5105

[ 5115](group__devicetree-inst.md#gafd15350971dee495f955f2fcc7edd82c)#define DT\_INST\_FOREACH\_NODELABEL(inst, fn) \

5116 DT\_FOREACH\_NODELABEL(DT\_DRV\_INST(inst), fn)

5117

[ 5129](group__devicetree-inst.md#ga3cf2a5bc8bad5ef8d47feb56c8215ca6)#define DT\_INST\_FOREACH\_NODELABEL\_VARGS(inst, fn, ...) \

5130 DT\_FOREACH\_NODELABEL\_VARGS(DT\_DRV\_INST(inst), fn, \_\_VA\_ARGS\_\_)

5131

[ 5142](group__devicetree-inst.md#gaf163f2f85b3893ca46c87f0fcbe65255)#define DT\_INST\_FOREACH\_PROP\_ELEM(inst, prop, fn) \

5143 DT\_FOREACH\_PROP\_ELEM(DT\_DRV\_INST(inst), prop, fn)

5144

[ 5157](group__devicetree-inst.md#ga08de2f0ba1a6ec395f198e06c5f52373)#define DT\_INST\_FOREACH\_PROP\_ELEM\_SEP(inst, prop, fn, sep) \

5158 DT\_FOREACH\_PROP\_ELEM\_SEP(DT\_DRV\_INST(inst), prop, fn, sep)

5159

[ 5174](group__devicetree-inst.md#ga31b9022f7add3d77417b78ed67d544e3)#define DT\_INST\_FOREACH\_PROP\_ELEM\_VARGS(inst, prop, fn, ...) \

5175 DT\_FOREACH\_PROP\_ELEM\_VARGS(DT\_DRV\_INST(inst), prop, fn, \_\_VA\_ARGS\_\_)

5176

[ 5194](group__devicetree-inst.md#ga41b9dfd3519809bfc3c1c500780d6a2d)#define DT\_INST\_FOREACH\_PROP\_ELEM\_SEP\_VARGS(inst, prop, fn, sep, ...) \

5195 DT\_FOREACH\_PROP\_ELEM\_SEP\_VARGS(DT\_DRV\_INST(inst), prop, fn, sep, \

5196 \_\_VA\_ARGS\_\_)

5197

[ 5204](group__devicetree-inst.md#gaa03419e2d9c887a81e16e96b5947bccb)#define DT\_INST\_NODE\_HAS\_PROP(inst, prop) \

5205 DT\_NODE\_HAS\_PROP(DT\_DRV\_INST(inst), prop)

5206

[ 5213](group__devicetree-inst.md#gaf88c7dc0e935ad7097e317e54c362ba0)#define DT\_INST\_NODE\_HAS\_COMPAT(inst, compat) \

5214 DT\_NODE\_HAS\_COMPAT(DT\_DRV\_INST(inst), compat)

5215

[ 5226](group__devicetree-inst.md#gae054b89701ec9fae577320fb7b9cae1e)#define DT\_INST\_PHA\_HAS\_CELL\_AT\_IDX(inst, pha, idx, cell) \

5227 DT\_PHA\_HAS\_CELL\_AT\_IDX(DT\_DRV\_INST(inst), pha, idx, cell)

5228

[ 5238](group__devicetree-inst.md#gab8083dae430aeb93a967bbf98aa9eefc)#define DT\_INST\_PHA\_HAS\_CELL(inst, pha, cell) \

5239 DT\_INST\_PHA\_HAS\_CELL\_AT\_IDX(inst, pha, 0, cell)

5240

[ 5248](group__devicetree-inst.md#gabb45132ef78818512c02bdf1f5a38068)#define DT\_INST\_IRQ\_HAS\_IDX(inst, idx) DT\_IRQ\_HAS\_IDX(DT\_DRV\_INST(inst), idx)

5249

[ 5258](group__devicetree-inst.md#gab176ff07912cea915c811406e8f5e386)#define DT\_INST\_IRQ\_HAS\_CELL\_AT\_IDX(inst, idx, cell) \

5259 DT\_IRQ\_HAS\_CELL\_AT\_IDX(DT\_DRV\_INST(inst), idx, cell)

5260

[ 5268](group__devicetree-inst.md#gabec43df3451bd917120b283d76c57054)#define DT\_INST\_IRQ\_HAS\_CELL(inst, cell) \

5269 DT\_INST\_IRQ\_HAS\_CELL\_AT\_IDX(inst, 0, cell)

5270

[ 5277](group__devicetree-inst.md#gaa038ffc9b4f5c897a4a9e6d0e9836ffd)#define DT\_INST\_IRQ\_HAS\_NAME(inst, name) \

5278 DT\_IRQ\_HAS\_NAME(DT\_DRV\_INST(inst), name)
...
5297#define DT\_ANY\_INST\_HAS\_PROP\_STATUS\_OKAY\_(idx, prop) \

5298 IF\_ENABLED(DT\_INST\_NODE\_HAS\_PROP(idx, prop), (1,))

5299

5312#define DT\_ANY\_INST\_HAS\_BOOL\_STATUS\_OKAY\_(idx, prop) \

5313 IF\_ENABLED(DT\_INST\_PROP(idx, prop), (1,))

5314

5326#define DT\_ALL\_INST\_HAS\_PROP\_STATUS\_OKAY\_(idx, prop) \

5327 IF\_DISABLED(DT\_INST\_NODE\_HAS\_PROP(idx, prop), (1,))

5328

5341#define DT\_ALL\_INST\_HAS\_BOOL\_STATUS\_OKAY\_(idx, prop) \

5342 IF\_DISABLED(DT\_INST\_PROP(idx, prop), (1,))

5343

5344#define DT\_PATH\_INTERNAL(...) \

5345 UTIL\_CAT(DT\_ROOT, MACRO\_MAP\_CAT(DT\_S\_PREFIX, \_\_VA\_ARGS\_\_))

5351#define DT\_S\_PREFIX(name) \_S\_##name

5352

5367#define DT\_CAT(a1, a2) a1 ## a2

5369#define DT\_CAT3(a1, a2, a3) a1 ## a2 ## a3

5371#define DT\_CAT4(a1, a2, a3, a4) a1 ## a2 ## a3 ## a4

5373#define DT\_CAT5(a1, a2, a3, a4, a5) a1 ## a2 ## a3 ## a4 ## a5

5375#define DT\_CAT6(a1, a2, a3, a4, a5, a6) a1 ## a2 ## a3 ## a4 ## a5 ## a6

5377#define DT\_CAT7(a1, a2, a3, a4, a5, a6, a7) \

5378 a1 ## a2 ## a3 ## a4 ## a5 ## a6 ## a7

5380#define DT\_CAT8(a1, a2, a3, a4, a5, a6, a7, a8) \

5381 a1 ## a2 ## a3 ## a4 ## a5 ## a6 ## a7 ## a8

5382/\*

5383 \* If you need to define a bigger DT\_CATN(), do so here. Don't leave

5384 \* any "holes" of undefined macros, please.

5385 \*/

5386

5388#define DT\_DASH(...) MACRO\_MAP\_CAT(DT\_DASH\_PREFIX, \_\_VA\_ARGS\_\_)

5390#define DT\_DASH\_PREFIX(name) \_##name

5392#define DT\_NODE\_HAS\_STATUS\_INTERNAL(node\_id, status) \

5393 IS\_ENABLED(DT\_CAT3(node\_id, \_STATUS\_, status))

5394

5398#define DT\_COMPAT\_NODE\_HAS\_PROP\_AND\_OR(inst, compat, prop) \

5399 DT\_NODE\_HAS\_PROP(DT\_INST(inst, compat), prop) ||

5400

5405#if defined(\_LINKER) || defined(\_ASMLANGUAGE)

5406#define DT\_U32\_C(\_v) (\_v)

5407#else

5408#define DT\_U32\_C(\_v) UINT32\_C(\_v)

5409#endif

5410

5415#if defined(\_LINKER) || defined(\_ASMLANGUAGE)

5416#define DT\_U64\_C(\_v) (\_v)

5417#else

5418#define DT\_U64\_C(\_v) UINT64\_C(\_v)

5419#endif

5420

5421/\* Helpers for DT\_NODELABEL\_STRING\_ARRAY. We define our own stringify

5422 \* in order to avoid adding a dependency on toolchain.h..

5423 \*/

5424#define DT\_NODELABEL\_STRING\_ARRAY\_ENTRY\_INTERNAL(nodelabel) DT\_STRINGIFY\_INTERNAL(nodelabel),

5425#define DT\_STRINGIFY\_INTERNAL(arg) DT\_STRINGIFY\_INTERNAL\_HELPER(arg)

5426#define DT\_STRINGIFY\_INTERNAL\_HELPER(arg) #arg

5427

5429

5430/\* have these last so they have access to all previously defined macros \*/

5431#include <[zephyr/devicetree/io-channels.h](io-channels_8h.md)>

5432#include <[zephyr/devicetree/clocks.h](clocks_8h.md)>

5433#include <[zephyr/devicetree/gpio.h](devicetree_2gpio_8h.md)>

5434#include <[zephyr/devicetree/spi.h](devicetree_2spi_8h.md)>

5435#include <[zephyr/devicetree/dma.h](devicetree_2dma_8h.md)>

5436#include <[zephyr/devicetree/pwms.h](pwms_8h.md)>

5437#include <[zephyr/devicetree/fixed-partitions.h](fixed-partitions_8h.md)>

5438#include <[zephyr/devicetree/ordinals.h](ordinals_8h.md)>

5439#include <[zephyr/devicetree/pinctrl.h](devicetree_2pinctrl_8h.md)>

5440#include <[zephyr/devicetree/can.h](devicetree_2can_8h.md)>

5441#include <[zephyr/devicetree/reset.h](devicetree_2reset_8h.md)>

5442#include <[zephyr/devicetree/mbox.h](devicetree_2mbox_8h.md)>

5443#include <[zephyr/devicetree/port-endpoint.h](port-endpoint_8h.md)>

5444#include <[zephyr/devicetree/display.h](devicetree_2display_8h.md)>

5445

5446#endif /\* ZEPHYR\_INCLUDE\_DEVICETREE\_H\_ \*/
