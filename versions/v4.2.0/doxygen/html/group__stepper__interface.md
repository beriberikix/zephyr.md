---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__stepper__interface.html
...
| #define | [VALID\_MICRO\_STEP\_RES](#ga3196866d26d23c04313d802f2d8c61c1)(res) |
...
| enum | [stepper\_event](#gab1534238fbf8d2270ea4f69d3a558b5f) {     [STEPPER\_EVENT\_STEPS\_COMPLETED](#ggab1534238fbf8d2270ea4f69d3a558b5fa7b52130939a6bc32f66d860f256ab8c4) = 0 , [STEPPER\_EVENT\_STALL\_DETECTED](#ggab1534238fbf8d2270ea4f69d3a558b5fa99db863b18d3e004a06de3f7d1abe445) = 1 , [STEPPER\_EVENT\_LEFT\_END\_STOP\_DETECTED](#ggab1534238fbf8d2270ea4f69d3a558b5fa3815a2913aef2f234c36936294685fc0) = 2 , [STEPPER\_EVENT\_RIGHT\_END\_STOP\_DETECTED](#ggab1534238fbf8d2270ea4f69d3a558b5fa3d2b06294740a8f7d84c0a81b011b8e3) = 3 ,     [STEPPER\_EVENT\_STOPPED](#ggab1534238fbf8d2270ea4f69d3a558b5faf9c22bc201660b258c54473e929e665c) = 4 , [STEPPER\_EVENT\_FAULT\_DETECTED](#ggab1534238fbf8d2270ea4f69d3a558b5faa1811857d120f56e0e7646457fc9e7d4) = 5   } |
|  | Stepper Events. [More...](#gab1534238fbf8d2270ea4f69d3a558b5f) |

| Functions | |
| --- | --- |
| int | [stepper\_enable](#ga3395b5f8b401d8175067edfb25c2e0e8) (const struct [device](structdevice.md) \*dev) |
|  | Enable stepper driver. |
| int | [stepper\_disable](#gab892a6b8d8fb34db0e682dd8f7de4218) (const struct [device](structdevice.md) \*dev) |
...
| int | [stepper\_stop](#gaa049d39fe611a86904e7a60fc7005abd) (const struct [device](structdevice.md) \*dev) |
|  | Stop the stepper. |
...
`#include <[zephyr/drivers/stepper.h](stepper_8h.md)>`
...
## [◆ ](#ga3196866d26d23c04313d802f2d8c61c1)VALID\_MICRO\_STEP\_RES
...
((res) == [STEPPER\_MICRO\_STEP\_1](#ggad8d053f92eb3a194652b4600af531e30a4c72780b13eb7f5ee5c433420a0eede9) || (res) == [STEPPER\_MICRO\_STEP\_2](#ggad8d053f92eb3a194652b4600af531e30a6f42ccb9a398946ce4eeac20c364f990) || \

(res) == [STEPPER\_MICRO\_STEP\_4](#ggad8d053f92eb3a194652b4600af531e30a4c5dd8c5054a1a66e65cceba719ca5e0) || (res) == [STEPPER\_MICRO\_STEP\_8](#ggad8d053f92eb3a194652b4600af531e30aae2b109417f88201514bedd0e2c71155) || \

(res) == [STEPPER\_MICRO\_STEP\_16](#ggad8d053f92eb3a194652b4600af531e30ac04236cc36c1201539f3fcc4aef1f1d8) || (res) == [STEPPER\_MICRO\_STEP\_32](#ggad8d053f92eb3a194652b4600af531e30af733d75d60220ae98bb08ee3a4c49d14) || \

(res) == [STEPPER\_MICRO\_STEP\_64](#ggad8d053f92eb3a194652b4600af531e30a25ea7a12d2ec3751e941f446b9637370) || (res) == [STEPPER\_MICRO\_STEP\_128](#ggad8d053f92eb3a194652b4600af531e30afc6d0ffc96256600c74b00057ec55e43) || \

(res) == [STEPPER\_MICRO\_STEP\_256](#ggad8d053f92eb3a194652b4600af531e30a7ff93a287c10971ac50644de2ae0161f))

[STEPPER\_MICRO\_STEP\_64](#ggad8d053f92eb3a194652b4600af531e30a25ea7a12d2ec3751e941f446b9637370)
...
[STEPPER\_MICRO\_STEP\_4](#ggad8d053f92eb3a194652b4600af531e30a4c5dd8c5054a1a66e65cceba719ca5e0)
...
[STEPPER\_MICRO\_STEP\_1](#ggad8d053f92eb3a194652b4600af531e30a4c72780b13eb7f5ee5c433420a0eede9)
...
[STEPPER\_MICRO\_STEP\_2](#ggad8d053f92eb3a194652b4600af531e30a6f42ccb9a398946ce4eeac20c364f990)
...
[STEPPER\_MICRO\_STEP\_256](#ggad8d053f92eb3a194652b4600af531e30a7ff93a287c10971ac50644de2ae0161f)
...
[STEPPER\_MICRO\_STEP\_8](#ggad8d053f92eb3a194652b4600af531e30aae2b109417f88201514bedd0e2c71155)
...
[STEPPER\_MICRO\_STEP\_16](#ggad8d053f92eb3a194652b4600af531e30ac04236cc36c1201539f3fcc4aef1f1d8)
...
[STEPPER\_MICRO\_STEP\_32](#ggad8d053f92eb3a194652b4600af531e30af733d75d60220ae98bb08ee3a4c49d14)
...
[STEPPER\_MICRO\_STEP\_128](#ggad8d053f92eb3a194652b4600af531e30afc6d0ffc96256600c74b00057ec55e43)
...
| STEPPER\_EVENT\_STOPPED | Stepper has stopped. |
| STEPPER\_EVENT\_FAULT\_DETECTED | Fault with the stepper controller detected. |
...
## [◆ ](#gab892a6b8d8fb34db0e682dd8f7de4218)stepper\_disable()

| int stepper\_disable | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Disabling the driver shall switch off the power stage and de-energize the coils. Disabling the stepper does not implicitly stop the stepper. If the motor shall not move after re-enabling the stepper than consider calling [stepper\_stop()](#gaa049d39fe611a86904e7a60fc7005abd) before.
...
## [◆ ](#ga3395b5f8b401d8175067edfb25c2e0e8)stepper\_enable()
...
The stepper shall be set into motion and run continuously until stalled or stopped using some other command, for instance, [stepper\_stop()](#gaa049d39fe611a86904e7a60fc7005abd). This function is non-blocking.
...
## [◆ ](#gaa049d39fe611a86904e7a60fc7005abd)stepper\_stop()

| int stepper\_stop | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
