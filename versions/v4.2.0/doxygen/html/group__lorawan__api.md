---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__lorawan__api.html
...
| typedef void(\* | [lorawan\_link\_check\_ans\_cb\_t](#gaf9fad3b2bb93ab43751098f4b8dd31f9)) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) demod\_margin, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) nb\_gateways) |
|  | Defines the link check answer handler function signature. |
| typedef int(\* | [transport\_descriptor\_cb](#gade697fcc14a384420afc8817f72af410)) ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) descriptor) |
...
| enum | [lorawan\_dl\_flags](#gab28a9f22482069b2246892e4ee31660d) { [LORAWAN\_DATA\_PENDING](#ggab28a9f22482069b2246892e4ee31660da01aee480c4308ac7abb6bf909478cce2) = BIT(0) , [LORAWAN\_TIME\_UPDATED](#ggab28a9f22482069b2246892e4ee31660dad272f787e193c2397e1b670ced4ba1b8) = BIT(1) } |
|  | LoRaWAN downlink flags. [More...](#gab28a9f22482069b2246892e4ee31660d) |
...
| void | [lorawan\_register\_link\_check\_ans\_callback](#ga7b620841f521b9addc8d1ee823ee45fd) ([lorawan\_link\_check\_ans\_cb\_t](#gaf9fad3b2bb93ab43751098f4b8dd31f9) cb) |
...
| int | [lorawan\_request\_device\_time](#ga980f1650e9cceba19da453d4937273cb) ([bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) force\_request) |
|  | Request for time according to DeviceTimeReq MAC cmd. |
| int | [lorawan\_device\_time\_get](#ga88c22a7e83437688039c05f9c7c1e7d4) ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*gps\_time) |
|  | Retrieve the current time from LoRaWAN stack updated by DeviceTimeAns on MAC layer. |
| int | [lorawan\_request\_link\_check](#gaed19bb9c528f8f21104201fd0816e3a9) ([bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) force\_request) |
...
`#include <[zephyr/lorawan/lorawan.h](lorawan_8h.md)>`
...
## [◆ ](#gaf9fad3b2bb93ab43751098f4b8dd31f9)lorawan\_link\_check\_ans\_cb\_t

| typedef void(\* lorawan\_link\_check\_ans\_cb\_t) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) demod\_margin, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) nb\_gateways) |
| --- |
...
Parameters
:   | demod\_margin | The demodulation margin in db. |
    | --- | --- |
    | nb\_gateways | The number of gateways the device is connected to. |

## [◆ ](#gade697fcc14a384420afc8817f72af410)transport\_descriptor\_cb

| typedef int(\* transport\_descriptor\_cb) ([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) descriptor) |
| --- |
...
Returns
:   0 if successful. This represents, in the case that the descriptor is the firmware version, that the end-device is able to receive binary firmware. Otherwise, a negative error code ([errno.h](errno_8h.md "System error numbers.")) indicating the reason for failure. Any negative error code will result in setting the Wrong Descriptor status bit mask when sending FragSessionSetupAns to the Network Server.
...
## [◆ ](#gab28a9f22482069b2246892e4ee31660d)lorawan\_dl\_flags

| enum [lorawan\_dl\_flags](#gab28a9f22482069b2246892e4ee31660d) |
| --- |
...
## [◆ ](#ga88c22a7e83437688039c05f9c7c1e7d4)lorawan\_device\_time\_get()

| int lorawan\_device\_time\_get | ( | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *gps\_time* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | gps\_time | Synchronized time in GPS epoch format truncated to 32-bit. |
    | --- | --- |

Returns
:   0 if successful, -EAGAIN if the clock is not yet synchronized.
...
## [◆ ](#ga7b620841f521b9addc8d1ee823ee45fd)lorawan\_register\_link\_check\_ans\_callback()

| void lorawan\_register\_link\_check\_ans\_callback | ( | [lorawan\_link\_check\_ans\_cb\_t](#gaf9fad3b2bb93ab43751098f4b8dd31f9) | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga980f1650e9cceba19da453d4937273cb)lorawan\_request\_device\_time()

| int lorawan\_request\_device\_time | ( | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *force\_request* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | force\_request | Immediately send an empty message to execute the request |
    | --- | --- |

Returns
:   0 if successful, negative errno otherwise

## [◆ ](#gaed19bb9c528f8f21104201fd0816e3a9)lorawan\_request\_link\_check()

| int lorawan\_request\_link\_check | ( | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *force\_request* | ) |  |
| --- | --- | --- | --- | --- | --- |
