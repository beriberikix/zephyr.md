---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/i3c_8h.html
...
`#include <[zephyr/drivers/i3c/error_types.h](error__types_8h_source.md)>`  
...
`#include <[zephyr/drivers/i3c/hdr_ddr.h](hdr__ddr_8h_source.md)>`  
...
| #define | [I3C\_BUS\_FOR\_EACH\_I3CDEV](group__i3c__interface.md#ga42cb4edf6a099d586df14456fd98c873)(bus, desc) |
|  | iterate over all I3C devices present on the bus |
| #define | [I3C\_BUS\_FOR\_EACH\_I2CDEV](group__i3c__interface.md#ga450ba9021d1080f890c32624f20ba2b8)(bus, desc) |
|  | iterate over all I2C devices present on the bus |
| #define | [I3C\_DT\_IODEV\_DEFINE](group__i3c__interface.md#gabec5796b92d4582761bc3de456f1df27)(name, node\_id) |
...
| #define | [I3C\_BCR\_DEVICE\_ROLE\_MASK](group__i3c__interface.md#ga25721c9963040c84b7f5bbb48bb87b44)   [GENMASK](group__sys-util.md#ga58530d20924859d16358c7400c37738d)(7U, 6U) |
...
|  | I2C Device Index 2. |
| #define | [I3C\_LVR\_I2C\_DEV\_IDX\_MASK](group__i3c__interface.md#ga50fa249b36b91d56e49004548a1c7520)   [GENMASK](group__sys-util.md#ga58530d20924859d16358c7400c37738d)(7U, 5U) |
...
| struct [i3c\_device\_desc](structi3c__device__desc.md) \* | [i3c\_dev\_list\_i3c\_addr\_find](group__i3c__interface.md#ga0e83c5a26b18acfbe7d532825a8fd54c) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) addr) |
|  | Find a I3C target device descriptor by dynamic address. |
| struct [i3c\_device\_desc](structi3c__device__desc.md) \* | [i3c\_dev\_list\_i3c\_static\_addr\_find](group__i3c__interface.md#gaecbb16ce8edcd9ad7a7afcfb1251aa76) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) addr) |
|  | Find a I3C target device descriptor by static address. |
| struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* | [i3c\_dev\_list\_i2c\_addr\_find](group__i3c__interface.md#gafac78dca571ff7daa34fca0cfa7cc3b1) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) addr) |
...
| static int | [i3c\_configure\_controller](group__i3c__interface.md#gaeca24930774ecc2dcbf2240d48ae19c5) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_controller](structi3c__config__controller.md) \*config) |
|  | Get the controller device configuration for an I3C device. |
| static int | [i3c\_configure\_target](group__i3c__interface.md#ga7dfa33c7bdbe7e6607af61fe04bcb985) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_target](structi3c__config__target.md) \*config) |
...
| static int | [i3c\_config\_get\_controller](group__i3c__interface.md#ga96cd903b4a676c5943c43cc7b27af867) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_controller](structi3c__config__controller.md) \*config) |
|  | Get the controller device configuration for an I3C device. |
| static int | [i3c\_config\_get\_target](group__i3c__interface.md#ga8ef11af673e94646806e093504cfb01f) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_target](structi3c__config__target.md) \*config) |
|  | Get the target device configuration for an I3C device. |
...
| static int | [i3c\_ibi\_hj\_response](group__i3c__ibi.md#gac8c77e43fc7c06701437e799739507ee) (const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) ack) |
...
| static int | [i3c\_device\_is\_controller\_capable](group__i3c__ibi.md#ga537c1e2dafe3df1a5758e535beb323ea) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target) |
...
| int | [i3c\_device\_adv\_info\_get](group__i3c__interface.md#ga4e4a7e9408bd2f43602367bc9fe4f81e) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target) |
|  | Get advanced information from device and update device descriptor. |
| static int | [i3c\_device\_info\_get](group__i3c__interface.md#ga39a760d8ba759f9443689fc954eb3d4b) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target) |
|  | Get all information from device and update device descriptor. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i3c\_bus\_has\_sec\_controller](group__i3c__interface.md#ga149d70b1c2e02e19782aa21a94b13684) (const struct [device](structdevice.md) \*dev) |
|  | Check if the bus has a secondary controller. |
| int | [i3c\_bus\_rstdaa\_all](group__i3c__interface.md#ga14ec397e1c82b79302f7eff6022660ae) (const struct [device](structdevice.md) \*dev) |
|  | Reset all devices on the bus and clear their dynamic addresses. |
| int | [i3c\_bus\_setdasa](group__i3c__interface.md#ga2ae8b79140ddceebd071e0891a0ac824) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dynamic\_addr) |
|  | Assign a dynamic address to a device using its static address. |
| int | [i3c\_bus\_setnewda](group__i3c__interface.md#ga55ba4babddb31ed83ad3fab5adce2f18) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dynamic\_addr) |
|  | Assign a new dynamic address to a device. |
| int | [i3c\_bus\_setaasa](group__i3c__interface.md#gab6735824952836a1ac06745b21e2b534) (const struct [device](structdevice.md) \*dev) |
|  | Assign static addresses as dynamic addresses for all devices on the bus. |
| int | [i3c\_bus\_getbcr](group__i3c__interface.md#gac8c0ec6eb11030183be10fb541e1e561) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Bus Characteristics Register (BCR) of a device. |
| int | [i3c\_bus\_getdcr](group__i3c__interface.md#gaab2801ccc00e9891269709ecc34f4f7c) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Device Characteristics Register (DCR) of a device. |
| int | [i3c\_bus\_getpid](group__i3c__interface.md#ga129bab2c352fd08b62c352d916c7307c) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Provisional ID (PID) of a device. |
| int | [i3c\_bus\_getmrl](group__i3c__interface.md#ga5483ce25f70cae032ed5935483102c0f) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Maximum Read Length (MRL) of a device. |
| int | [i3c\_bus\_getmwl](group__i3c__interface.md#ga8d4da712075ee05896bcd7dde49cd827) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Maximum Write Length (MWL) of a device. |
| int | [i3c\_bus\_setmrl](group__i3c__interface.md#ga6fbb9bec228b7dc310c5724c3530bebd) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mrl, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) ibi\_len) |
|  | Set the Maximum Read Length (MRL) for a device. |
| int | [i3c\_bus\_setmwl](group__i3c__interface.md#ga8002de8239c4a0d1178fba27092a1254) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mwl) |
|  | Set the Maximum Write Length (MWL) for a device. |
| int | [i3c\_bus\_setmrl\_all](group__i3c__interface.md#ga28278e90417b01d7cb18a301f906f6ae) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mrl, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) ibi\_len, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) has\_ibi\_size) |
|  | Set the Maximum Read Length (MRL) for all devices on the bus. |
| int | [i3c\_bus\_setmwl\_all](group__i3c__interface.md#gad3a4bf3cfc1b150c19ff1186cc8e3e2a) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mwl) |
|  | Set the Maximum Write Length (MWL) for all devices on the bus. |
| int | [i3c\_bus\_getacccr](group__i3c__interface.md#ga8d4356b56d8414e62b5a9931ffc7ab8b) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Active Controller's Dynamic Address (ACCCR). |
| int | [i3c\_bus\_deftgts](group__i3c__interface.md#ga554e0c4fa3e6855f431521ae42313216) (const struct [device](structdevice.md) \*dev) |
|  | Send the CCC DEFTGTS. |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [i3c\_odd\_parity](group__i3c__interface.md#gaaf7736a8895de826f7fac1a9ecf0d7ea) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) p) |
|  | Calculate odd parity. |
| int | [i3c\_device\_controller\_handoff](group__i3c__interface.md#gaedf58fdd96f38f103f8defe221427b6f) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) requested) |
|  | Perform Controller Handoff. |
| void | [i3c\_sec\_handoffed](group__i3c__interface.md#ga221ab7abe735ddee881c002b934ee138) (struct [k\_work](structk__work.md) \*work) |
|  | Call back for when Controllership is Handoffed to itself. |
| struct [i3c\_device\_desc](structi3c__device__desc.md) \* | [i3c\_device\_desc\_alloc](group__i3c__interface.md#gab8e12d10528686040707f4aae502df98) (void) |
|  | Allocate memory for a i3c device descriptor. |
| void | [i3c\_device\_desc\_free](group__i3c__interface.md#ga25bfef54bb7bdc387ce0997ed0120739) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Free memory from a i3c device descriptor. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i3c\_device\_desc\_in\_pool](group__i3c__interface.md#gaf2c8afec987322be8dfd4fb053fac61b) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Report if the i3c device descriptor was from a mem slab. |
| struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* | [i3c\_i2c\_device\_desc\_alloc](group__i3c__interface.md#ga16b9ba6480ac807ff8b9268d6cffa577) (void) |
|  | Allocate memory for a i3c i2c device descriptor. |
| void | [i3c\_i2c\_device\_desc\_free](group__i3c__interface.md#ga61ead89539fe3556f5e6e30eae5e71a3) (struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \*desc) |
|  | Free memory from a i3c i2c device descriptor. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i3c\_i2c\_device\_desc\_in\_pool](group__i3c__interface.md#gabfebceaa3e6f6f255352b8dcc3e7f9b1) (struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \*desc) |
|  | Report if the i3c i2c device descriptor was from a mem slab. |
| void | [i3c\_iodev\_submit\_fallback](group__i3c__interface.md#ga909d531941cd81850f4a05c51646690d) (const struct [device](structdevice.md) \*dev, struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe) |
|  | Fallback submit implementation. |
| static void | [i3c\_iodev\_submit](group__i3c__interface.md#ga3b612267e71202094fb4adab64ffd61c) (struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*iodev\_sqe) |
|  | Submit request(s) to an I3C device with RTIO. |
| struct [rtio\_sqe](structrtio__sqe.md) \* | [i3c\_rtio\_copy](group__i3c__interface.md#gab46a231442a7bf60e7e28ca2f52d25fc) (struct [rtio](structrtio.md) \*[r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2), struct [rtio\_iodev](structrtio__iodev.md) \*iodev, const struct [i3c\_msg](structi3c__msg.md) \*msgs, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) num\_msgs) |
|  | Copy the i3c\_msgs into a set of RTIO requests. |

| Variables | |
| --- | --- |
| const struct [rtio\_iodev\_api](structrtio__iodev__api.md) | [i3c\_iodev\_api](group__i3c__interface.md#gace1f8f10af2d87bb5a17441645030833) |
