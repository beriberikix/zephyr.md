---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/drivers_2i2c_8h.html
...
| #define | [I2C\_DEVICE\_DT\_DEINIT\_DEFINE](group__i2c__interface.md#ga831cf78c11ebfceb65315995504cb7fb)(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api, ...) |
...
|  | Like [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](group__i2c__interface.md#ga831cf78c11ebfceb65315995504cb7fb "Like DEVICE_DT_DEINIT_DEFINE() with I2C specifics.") but without deinit\_fn. |
| #define | [I2C\_DEVICE\_DT\_INST\_DEINIT\_DEFINE](group__i2c__interface.md#ga9c7a8248802760a2f9509e76377fb38a)(inst, ...) |
|  | Like [I2C\_DEVICE\_DT\_DEINIT\_DEFINE()](group__i2c__interface.md#ga831cf78c11ebfceb65315995504cb7fb "Like DEVICE_DT_DEINIT_DEFINE() with I2C specifics.") for an instance of a DT\_DRV\_COMPAT compatible. |
| #define | [I2C\_DEVICE\_DT\_INST\_DEFINE](group__i2c__interface.md#gabfd94bccb99bd1a958cd8d7902b2072a)(inst, ...) |
|  | Like [I2C\_DEVICE\_DT\_DEFINE()](group__i2c__interface.md#ga47b9d476cc85d6f5b8081c73dd87064f "Like I2C_DEVICE_DT_DEINIT_DEFINE() but without deinit_fn.") for an instance of a DT\_DRV\_COMPAT compatible. |
...
| static int | [i2c\_configure\_dt](group__i2c__interface.md#ga780c4b50a3dc89c01a98c432554c2795) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*spec, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) dev\_config) |
|  | Configure operation of a host controller. |
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i2c\_is\_ready\_iodev](group__i2c__interface.md#ga3ddf8440c2306b5cde3013fba13a0e29) (const struct [rtio\_iodev](structrtio__iodev.md) \*i2c\_iodev) |
|  | Validate that I2C bus is ready. |
...
| struct [rtio\_sqe](structrtio__sqe.md) \* | [i2c\_rtio\_copy\_reg\_write\_byte](group__i2c__interface.md#gaf09d16086cbf1f0fc02463205df9fc00) (struct [rtio](structrtio.md) \*[r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2), struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) reg\_addr, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) data) |
|  | Copy the register address and data to a SQE. |
| struct [rtio\_sqe](structrtio__sqe.md) \* | [i2c\_rtio\_copy\_reg\_burst\_read](group__i2c__interface.md#gafa782a07d60a6f3115957e1327b41cd3) (struct [rtio](structrtio.md) \*[r](asm-macro-32-bit-gnu_8h.md#af16d2973cfd145a2ebdbf9528d5d9ae2), struct [rtio\_iodev](structrtio__iodev.md) \*iodev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) start\_addr, void \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_bytes) |
