---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__mesh__access.html
...
| #define | [BT\_MESH\_MODEL\_OP\_END](#gaf2c164506c601214c85d451747176827)   { 0, 0, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) } |
...
| #define | [BT\_MESH\_MODELS\_METADATA\_NONE](#ga56b518123ab47cb3ae4a249f471ae556)   [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) |
|  | Helper to define an empty Models metadata array. |
| #define | [BT\_MESH\_MODELS\_METADATA\_END](#gaab5fe51071f6e54debd9136ac6a70a49)   { 0, 0, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) } |
...
`#include <[zephyr/bluetooth/mesh/access.h](access_8h.md)>`
...
[BT\_MESH\_MODEL\_CB](#gac062c101b7310020e11a527de9c40d3a)(\_id, \_op, \_pub, \_user\_data, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
| #define BT\_MESH\_MODEL\_OP\_END   { 0, 0, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) } |
| --- |
...
[BT\_MESH\_MODEL\_VND\_CB](#gabe79d914990ba2721f5bb7081910e512)(\_company, \_id, \_op, \_pub, \_user\_data, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4))
...
| #define BT\_MESH\_MODELS\_METADATA\_END   { 0, 0, [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) } |
| --- |
...
| #define BT\_MESH\_MODELS\_METADATA\_NONE   [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) |
| --- |
...
(([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d))((count) | (((int\_ms / 10) - 1) << 3)))
...
This function triggers the [bt\_mesh\_model\_cb::pending\_store](structbt__mesh__model__cb.md#ae28f875dffc7f5f2ce99abe590369f43 "bt_mesh_model_cb::pending_store") callback for the corresponding model after delay defined by `CONFIG_BT_MESH_STORE_TIMEOUT`.
...
If `CONFIG_BT_MESH_COMP_PAGE_1` is enabled, it is not allowed to call this function before the [bt\_mesh\_model\_cb::init](structbt__mesh__model__cb.md#a1688a2c6d7b3b17ba49a0975b6f4f68e "bt_mesh_model_cb::init") callback is called for both models, except if it is called as part of the final callback.
