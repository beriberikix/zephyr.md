---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__log__backend.html
...
|  | [MQTT log backend API](group__log__backend__mqtt.md) |
...
`#include <[zephyr/logging/log_backend.h](log__backend_8h.md)>`
