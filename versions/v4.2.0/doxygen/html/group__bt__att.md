---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__att.html
...
`#include <[zephyr/bluetooth/att.h](att_8h.md)>`
...
:   | conn | The connection to send the request on |
    | --- | --- |
    | num\_channels | The number of Enhanced ATT bearers to request. Must be in the range 1 - `CONFIG_BT_EATT_MAX`, inclusive. |
