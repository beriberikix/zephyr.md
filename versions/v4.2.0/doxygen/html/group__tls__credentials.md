---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__tls__credentials.html
...
`#include <[zephyr/net/tls_credentials.h](tls__credentials_8h.md)>`
...
| TLS\_CREDENTIAL\_PUBLIC\_CERTIFICATE | A public client or server certificate.  Use this to register your own certificate. Should be registered together with a corresponding private key. Used with certificate-based ciphersuites. |
| TLS\_CREDENTIAL\_SERVER\_CERTIFICATE | **[Deprecated](deprecated.md#_deprecated000026)**  Use TLS\_CREDENTIAL\_PUBLIC\_CERTIFICATE instead. |
