---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__websocket.html
...
|  | Websocket option codes. [More...](#ga207402575311103c75906143724e8c35) |
...
|  | Close websocket. |
| int | [websocket\_register](#gabc2556e62f001f8109bf6ae9f50f3952) (int http\_sock, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*recv\_buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) recv\_buf\_len) |
|  | Register a socket as websocket. |
| int | [websocket\_unregister](#gaa3131d2599c8c69ab95c55c2e38e28e0) (int ws\_sock) |
...
`#include <[zephyr/net/websocket.h](websocket_8h.md)>`
...
| Enumerator | |
| --- | --- |
| WEBSOCKET\_OPCODE\_CONTINUE | Message continues. |
| WEBSOCKET\_OPCODE\_DATA\_TEXT | Textual data. |
| WEBSOCKET\_OPCODE\_DATA\_BINARY | Binary data. |
| WEBSOCKET\_OPCODE\_CLOSE | Closing connection. |
| WEBSOCKET\_OPCODE\_PING | Ping message. |
| WEBSOCKET\_OPCODE\_PONG | Pong message. |
...
## [◆ ](#gabc2556e62f001f8109bf6ae9f50f3952)websocket\_register()

| int websocket\_register | ( | int | *http\_sock*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *recv\_buf*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *recv\_buf\_len* ) |
...
Parameters
:   | http\_sock | Underlying socket connection socket. |
    | --- | --- |
    | recv\_buf | Temporary receive buffer for websocket parsing. This must point to a memory area that is valid for the duration of the whole websocket session. |
    | recv\_buf\_len | Length of the temporary receive buffer. |
...
## [◆ ](#gaa3131d2599c8c69ab95c55c2e38e28e0)websocket\_unregister()
...
Parameters
:   | ws\_sock | Websocket connection socket. |
    | --- | --- |
