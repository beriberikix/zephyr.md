---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__subsys__tracing__macros.html
...
`#include <[zephyr/tracing/tracing_macros.h](tracing__macros_8h.md)>`
...
Parameters
:   | obj\_type | The type of object associated with the call ([k\_thread](structk__thread.md "Thread Structure."), [k\_sem](structk__sem.md "Semaphore structure."), [k\_mutex](structk__mutex.md "Mutex Structure.") etc.) |
    | --- | --- |
    | func | Name of the function responsible for the call. This does not need to exactly match the name of the function but should rather match what the user called in case of system calls etc. That is, we can often omit the z\_vrfy/z\_impl part of the name. |
    | obj | Object |
    | ... | Additional parameters relevant to the tracing call |
...
**Definition** tracing\_macros.h:222

Field added to kernel objects so they are tracked.

Parameters
:   | type | Type of object being tracked ([k\_thread](structk__thread.md "Thread Structure."), [k\_sem](structk__sem.md "Semaphore structure."), etc.) |
    | --- | --- |
