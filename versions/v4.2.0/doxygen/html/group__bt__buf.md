---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__buf.html
...
| #define | [BT\_BUF\_ACL\_RX\_COUNT\_MAX](#ga9a196035ab78158867ce301c698c08e1)   65535 |
| #define | [BT\_BUF\_ACL\_RX\_COUNT\_EXTRA](#ga2a43657d82801ab838928fd544d93f1f)   0 |
| #define | [BT\_BUF\_ACL\_RX\_COUNT](#ga1f2226f2fb0a4ea2b215e1c5572ecbf6)   0 |
...
| Typedefs | |
| --- | --- |
| typedef void(\* | [bt\_buf\_rx\_freed\_cb\_t](#gaf5c7be1db66cc51c588938fe0b332040)) (enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) type\_mask) |
|  | A callback to notify about freed buffer in the incoming data pool. |

| Enumerations | |
| --- | --- |
| enum | [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) {     [BT\_BUF\_TYPE\_NONE](#ggafe1539a89ba3389d52d010a071620d7ba370190256608b003d85a149fa8039a8d) = 0 , [BT\_BUF\_CMD](#ggafe1539a89ba3389d52d010a071620d7baead9b640992dd72bd90ebd5d1fa3aaf1) = BIT(0) , [BT\_BUF\_EVT](#ggafe1539a89ba3389d52d010a071620d7ba350a2419b238423e479203a61d45a6e5) = BIT(1) , [BT\_BUF\_ACL\_OUT](#ggafe1539a89ba3389d52d010a071620d7ba4332d09d0ae276cf48aa550cf2ab4091) = BIT(2) ,     [BT\_BUF\_ACL\_IN](#ggafe1539a89ba3389d52d010a071620d7baff31d58d06bf1d330f570bf8f1600c13) = BIT(3) , [BT\_BUF\_ISO\_OUT](#ggafe1539a89ba3389d52d010a071620d7ba4137aa547b58a7dbf69ef9c29127fa7e) = BIT(4) , [BT\_BUF\_ISO\_IN](#ggafe1539a89ba3389d52d010a071620d7badd49c17ef6b2f452c9172fce6f96fb9e) = BIT(5)   } |
|  | Possible types of buffers passed around the Bluetooth stack in a form of bitmask. [More...](#gafe1539a89ba3389d52d010a071620d7b) |
| enum | [bt\_buf\_dir](#gaba424dbbb447b1826cbbe715a228744c) { [BT\_BUF\_IN](#ggaba424dbbb447b1826cbbe715a228744cac877edada534dc90a2ad7a8fcb9ffc77) , [BT\_BUF\_OUT](#ggaba424dbbb447b1826cbbe715a228744ca14de2807d9e45293b6d219b9ca28bc05) } |
|  | Direction of HCI packets. [More...](#gaba424dbbb447b1826cbbe715a228744c) |

| Functions | |
| --- | --- |
| static [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [bt\_buf\_type\_to\_h4](#gae355c6555a1d514332b2d594bcaf416c) (enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) type) |
|  | Convert from [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) to H:4 type. |
| static enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) | [bt\_buf\_type\_from\_h4](#ga01c7d236ef77e4ba334401c628f582a9) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) h4\_type, enum [bt\_buf\_dir](#gaba424dbbb447b1826cbbe715a228744c) dir) |
|  | Convert from H:4 type to [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b). |
...
| void | [bt\_buf\_rx\_freed\_cb\_set](#gaf946b1bf3706fe74c6d0c9faaaf478f5) ([bt\_buf\_rx\_freed\_cb\_t](#gaf5c7be1db66cc51c588938fe0b332040) cb) |
...
## [◆ ](#ga1f2226f2fb0a4ea2b215e1c5572ecbf6)BT\_BUF\_ACL\_RX\_COUNT

| #define BT\_BUF\_ACL\_RX\_COUNT   0 |
| --- |

`#include <[zephyr/bluetooth/buf.h](buf_8h.md)>`

## [◆ ](#ga2a43657d82801ab838928fd544d93f1f)BT\_BUF\_ACL\_RX\_COUNT\_EXTRA

| #define BT\_BUF\_ACL\_RX\_COUNT\_EXTRA   0 |
| --- |

`#include <[zephyr/bluetooth/buf.h](buf_8h.md)>`

## [◆ ](#ga9a196035ab78158867ce301c698c08e1)BT\_BUF\_ACL\_RX\_COUNT\_MAX

| #define BT\_BUF\_ACL\_RX\_COUNT\_MAX   65535 |
| --- |
...
(CONFIG\_BT\_BUF\_EVT\_RX\_COUNT + \

MAX([BT\_BUF\_ACL\_RX\_COUNT](#ga1f2226f2fb0a4ea2b215e1c5572ecbf6), [BT\_BUF\_ISO\_RX\_COUNT](#gac45f7915fff9516d9d156a42794e8221)))

[BT\_BUF\_ACL\_RX\_COUNT](#ga1f2226f2fb0a4ea2b215e1c5572ecbf6)
...
**Definition** buf.h:133

[BT\_BUF\_ISO\_RX\_SIZE](#gae5db5f9f282f9675fe620842e0c50337)

#define BT\_BUF\_ISO\_RX\_SIZE

**Definition** buf.h:139
...
**Definition** buf.h:110

Helper to include reserved HCI data in buffer calculations.

## Typedef Documentation

## [◆ ](#gaf5c7be1db66cc51c588938fe0b332040)bt\_buf\_rx\_freed\_cb\_t

| typedef void(\* bt\_buf\_rx\_freed\_cb\_t) (enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) type\_mask) |
| --- |
...
This callback is called when a buffer of a given type is freed and can be requested through the [bt\_buf\_get\_rx](#ga4013cce9637f5aa2742d1f1aaa00e7ee) function. However, this callback is called from the context of the buffer freeing operation and must not attempt to allocate a new buffer from the same pool.
...
Parameters
:   | type\_mask | A bit mask of buffer types that have been freed. |
    | --- | --- |

## Enumeration Type Documentation

## [◆ ](#gaba424dbbb447b1826cbbe715a228744c)bt\_buf\_dir

| enum [bt\_buf\_dir](#gaba424dbbb447b1826cbbe715a228744c) |
| --- |
...
Only used for mapping H:4 to BT\_BUF\_\* values.

| Enumerator | |
| --- | --- |
| BT\_BUF\_IN | Packet from the controller to the host. |
| BT\_BUF\_OUT | Packet from the host to the controller. |
...
| Enumerator | |
| --- | --- |
| BT\_BUF\_TYPE\_NONE | Unknown/invalid packet type, used for error checking. |
...
Parameters
:   | type | Type of buffer. BT\_BUF\_CMD or BT\_BUF\_ACL\_OUT. |
    | --- | --- |
    | timeout | Non-negative waiting period to obtain a buffer or one of the special values K\_NO\_WAIT and K\_FOREVER. |
...
## [◆ ](#gaf946b1bf3706fe74c6d0c9faaaf478f5)bt\_buf\_rx\_freed\_cb\_set()

| void bt\_buf\_rx\_freed\_cb\_set | ( | [bt\_buf\_rx\_freed\_cb\_t](#gaf5c7be1db66cc51c588938fe0b332040) | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga01c7d236ef77e4ba334401c628f582a9)bt\_buf\_type\_from\_h4()

| | enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) bt\_buf\_type\_from\_h4 | ( | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *h4\_type*, | | --- | --- | --- | --- | |  |  | enum [bt\_buf\_dir](#gaba424dbbb447b1826cbbe715a228744c) | *dir* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | h4\_type | The H:4 type to convert |
    | --- | --- |
    | dir | The direction of the packet |

Returns
:   The [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b)

## [◆ ](#gae355c6555a1d514332b2d594bcaf416c)bt\_buf\_type\_to\_h4()

| | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) bt\_buf\_type\_to\_h4 | ( | enum [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) | *type* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | type | The [bt\_buf\_type](#gafe1539a89ba3389d52d010a071620d7b) to convert |
    | --- | --- |
