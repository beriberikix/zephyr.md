---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structwdt__timeout__cfg.html
...
`#include <[zephyr/drivers/watchdog.h](watchdog_8h_source.md)>`
...
|  | Timeout callback (can be [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)). |
...
This field is only available if `CONFIG_WDT_MULTISTAGE` is enabled (watchdogs with staged timeouts functionality). Value must be [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) for single stage timeout.
