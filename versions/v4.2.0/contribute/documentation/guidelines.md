---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/documentation/guidelines.html
...
Zephyr Project content is written using the [reStructuredText](http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html) [[2]](#id8) markup
...
[Zephyr documentation](https://docs.zephyrproject.org) [[4]](#id13) website.

You can read details about [reStructuredText](http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html) [[2]](#id8)
and about [Sphinx extensions](http://www.sphinx-doc.org/en/stable/contents.html) [[1]](#id6) from their respective websites.
...
Refer to the Zephyr [Coding Style Guidelines](../style/index.md#coding-style) for additional requirements.
...
exhaustive list, refer to the [reStructuredText Quick Reference](http://docutils.sourceforge.io/docs/user/rst/quickref.html) [[5]](#id15),
[reStructuredText Interpreted Text Roles](https://docutils.sourceforge.io/docs/ref/rst/roles.html) [[6]](#id17) as well as the [additional roles provided by Sphinx](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html) [[7]](#id19).
...
meanings and allow style output formatting. (You can refer to the [Sphinx Inline Markup](http://sphinx-doc.org/markup/inline.html#inline-markup) [[3]](#id11)
...
Other languages are of course supported (see [languages supported by Pygments](http://pygments.org/languages/) [[8]](#id21)), and in particular,
...
[Graphviz](https://graphviz.org) [[9]](#id23) is a tool for creating diagrams specified in a simple text language. As it’s important
...
Please refer to the [Graphviz documentation](https://graphviz.org/documentation) [[10]](#id25) for more information on how to create diagrams using
...
very file can be done using the [`zephyr_file`](#role-zephyr_file) role.
...
:   This role is used to reference a file in the Zephyr tree. For example:
    ...
    You can reference specific lines or line ranges in a file by appending `#Lline_number` or
    `#Lstart_line-Lend_line` to the file path:
    ...
    > See [doc/contribute/documentation/guidelines.rst#L3](https://github.com/zephyrproject-rtos/zephyr/blob/main/doc/contribute/documentation/guidelines.rst?plain=1#L3) for the main heading of
    > this document.
...
:   This role is used to reference a module in the Zephyr tree. For example:
    ...
    > Check out [hal\_stm32:CMakeLists.txt](https://github.com/zephyrproject-rtos/hal_stm32/blob/1e753266ddfb4b07a8a0b1ec566e9637ea45d5ef/CMakeLists.txt) for more information.

    Similar to [`zephyr_file`](#role-zephyr_file), you can reference specific lines or line ranges in a file.
...
:   This role is used to create links to regex searches for Kconfig options. It generates a link to
    ...
    > Check out [`CONFIG_SECURE_STORAGE_ITS_(STORE|TRANSFORM)_.*_CUSTOM`](../../kconfig.md#!CONFIG_SECURE_STORAGE_ITS_(STORE|TRANSFORM)_.*_CUSTOM) for
    > the various customization possibilities.
    ...
    > Check out the [ITS Kconfig options](../../kconfig.md#!CONFIG_SECURE_STORAGE_ITS_.*)
    > for more information.
...
:   This directive is used to show supported hardware features for all the targets of the board
    ...
    The directive must be used in a document that also contains a [`zephyr:board`](#directive-zephyr-board) directive,
...
:   This directive is used to show the supported runners for the board documented in the current
    ...
    Similar to [`zephyr:board-supported-hw`](#directive-zephyr-board-supported-hw), this directive requires hardware features
...
- **Complex Images**: For charts, diagrams, or other complex visuals, provide a summary in the alt
  ...
  tools like [Graphviz](#graphviz-diagrams) can also improve accessibility.

### Headings and Structure

Use [headings](#headings) to structure your document logically. This allows users of assistive
...
- Use the `list-table` directive when possible for better responsiveness and accessibility.
...
[Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/WAI/standards-guidelines/wcag/) [[11]](#id27)
