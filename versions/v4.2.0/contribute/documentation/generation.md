---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/documentation/generation.html
original_path: contribute/documentation/generation.html
---
...
You can read details about [reStructuredText](http://sphinx-doc.org/rest.html), and [Sphinx](http://sphinx-doc.org/) from
their respective websites.

The project’s documentation contains the following items:

- ReStructuredText source files used to generate documentation found at the
  [https://docs.zephyrproject.org](https://docs.zephyrproject.org) website. Most of the reStructuredText sources
  are found in the `/doc` directory, but others are stored within the
  code source tree near their specific component (such as `/samples` and
  `/boards`)
- Doxygen-generated material used to create all API-specific documents
  also found at [https://docs.zephyrproject.org](https://docs.zephyrproject.org)
...
described in [Getting Started Guide](../../develop/getting_started/index.md#getting-started). Then install additional tools
...
the instructions in [Windows Python Path](https://docs.python.org/3/using/windows.html#finding-the-python-executable) to add those if needed.
...
[Get Zephyr and install Python dependencies](../../develop/getting_started/index.md#install-py-requirements) step you took in the getting started
guide.
...
On Unix platforms a convenience [doc/Makefile](https://github.com/zephyrproject-rtos/zephyr/blob/main/doc/Makefile) can be used to
...
Invoking **make** with the following target will build the documentation
...
This option can also be used with the **make** wrapper:
...
tag file exported at [zephyr.tag](https://docs.zephyrproject.org/4.2.0/doxygen/html/zephyr.tag)
...
For additional information refer to [Doxygen External Documentation](https://www.doxygen.nl/manual/external.html).
