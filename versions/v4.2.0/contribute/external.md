---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/external.html
...
2. Use the [New External Source Code Issue](https://github.com/zephyrproject-rtos/zephyr/issues/new?assignees=&labels=RFC&template=007_ext-source.yml) to open an issue
...
![../_images/ext-src-flowchart.svg](https://docs.zephyrproject.org/4.2.0/_images/ext-src-flowchart.svg)
