---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/index.html
original_path: contribute/index.html
---
...
[Contribution Guidelines](guidelines.md#contribute-guidelines)
...
[Contributor Expectations](contributor_expectations.md#contributor-expectations)
:   This document is another mandatory read that describes the expected behavior of *all*
    contributors to the project.

[Reviewer Expectations](reviewer_expectations.md#reviewer-expectations)
:   This document is another mandatory read that describes the expected behavior when revieweing
    contributions to the project.

[Coding Guidelines](coding_guidelines/index.md#coding-guidelines)
...
[Coding Style Guidelines](style/index.md#coding-style)
:   Code contributions are expected to follow a set of style guidelines to ensure consistency and
    readability across the code base.

[Proposals and RFCs](proposals_and_rfcs.md#rfcs)
:   Learn when and how to submit RFCs (Request for Comments) for new features and changes to the
    project.

[Modifying Contributions made by other developers](modifying_contributions.md#modifying-contributions)
...
[Documentation Guidelines](documentation/guidelines.md#doc-guidelines)
...
[Documentation Generation](documentation/generation.md#zephyr-doc)
...
[Contributing External Components](external.md#external-contributions)
...
[Contributing External Tooling](external.md#external-tooling)
...
[Binary Blobs](bin_blobs.md#bin-blobs)
:   As some functionality might only be made available with the help of executable code distributed
    in binary form, this page describes the process and guidelines for [contributing binary
    blobs](bin_blobs.md#blobs-process) to the project.

## Need help along the way?

If you have questions related to the contribution process, the Zephyr community is here to help.
You may join our [Discord](https://chat.zephyrproject.org) channel or use the [Developer Mailing List](https://lists.zephyrproject.org/g/devel).
