---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/bin_blobs.html
...
defined in [Binary Blobs](#bin-blobs).
...
can be integrated. The standard [PR escalation procedures](contributor_expectations.md#pr-technical-escalation)
shall apply for any technical disagreements.

Subsequent updates to binary blobs follow the [module update procedure](../develop/modules.md#modules-changes).
