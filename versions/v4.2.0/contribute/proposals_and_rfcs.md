---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/proposals_and_rfcs.html
...
label](../project/dev_env_and_tools.md#gh-labels) that documents the proposal thoroughly. You are encouraged
to use the [RFC form](https://github.com/zephyrproject-rtos/zephyr/issues/new?template=003_rfc-proposal.yml) to make sure the proposal follows a template which
