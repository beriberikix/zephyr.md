---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/contribute/guidelines.html
...
The Zephyr Project follows the [Community Best Practice](https://www.linuxfoundation.org/blog/copyright-notices-in-open-source-software-projects/) for Copyright Notices from the Linux
Foundation.
...
- The person proposing a treewide change must create an [RFC issue](https://github.com/zephyrproject-rtos/zephyr/issues/new?assignees=&labels=RFC&template=003_rfc-proposal.yml)
