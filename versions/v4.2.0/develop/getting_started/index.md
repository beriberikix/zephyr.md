---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/getting_started/index.html
...
These instructions rely on Windows’ official package manager, [winget](https://learn.microsoft.com/en-us/windows/package-manager/).
...
1. In modern Windows versions, winget is already pre-installed by default.
   You can verify that this is the case by typing `winget` in a terminal
   window. If that fails, you can then [install winget](https://aka.ms/getwinget).
2. Open a Command Prompt (`cmd.exe`) or PowerShell terminal window.
...
the [nRF5340 DK](../../boards/nordic/nrf5340dk/doc/index.md#nrf5340dk) the board must be provided as:
