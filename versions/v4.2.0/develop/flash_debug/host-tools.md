---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/flash_debug/host-tools.html
...
see [Black Magic Probe](probes.md#black-magic-probe).
...
> - [Arduino Nano 33 IOT](../../boards/arduino/nano_33_iot/doc/index.md#arduino_nano_33_iot) (Arduino bootloader)
> - [Arduino Nano 33 BLE (Sense)](../../boards/arduino/nano_33_ble/doc/index.md#arduino_nano_33_ble) (Arduino legacy bootloader)
...
Renesas provides [Renesas Flash Programmer](https://www.renesas.com/en/software-tool/renesas-flash-programmer-programming-gui) as an official programming tool for Renesas boards
...
STMicroelectronics provides [STM32CubeCLT](https://www.st.com/en/development-tools/stm32cubeclt.html) as an official all-in-one toolset compatible with
...
The easiest way to get the ST-LINK GDB Server is to install [STM32CubeCLT](https://www.st.com/en/development-tools/stm32cubeclt.html) from STMicroelectronics’ website.
...
The [STM32CubeProgrammer](https://www.st.com/en/development-tools/stm32cubeprog.html) version contained in the [STM32CubeCLT](https://www.st.com/en/development-tools/stm32cubeclt.html) installation can also be used to flash
applications. To do so, the dedicated [STM32CubeProgrammer runner](#runner-stm32cubeprogrammer) should
...
For more about the UF2 format and its tooling, see [USB Flashing Format (UF2)](https://github.com/microsoft/uf2).
