---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/env_vars.html
...
Zephyr supports multiple locations for your `zephyrrc` file,
...
1. `$XDG_CONFIG_HOME/zephyr/zephyrrc`
2. `$HOME/.config/zephyr/zephyrrc`
3. `$HOME/.zephyrrc`
...
other things, this script sources your `zephyrrc` (the first one it
