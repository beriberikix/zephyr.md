---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/west/sign.html
...
but on [west config](config.md#west-config), similar to
...
`silabs_commander` require [Simplicity Commander](https://www.silabs.com/developer-tools/simplicity-studio/simplicity-commander?tab=downloads) to be install on the host. The provisionning of the
key on the device is described in [UG574 SiWx917 SoC Manufacturing Utility User Guide](https://www.silabs.com/documents/public/user-guides/ug574-siwx917-soc-manufacturing-utility-user-guide.pdf).
