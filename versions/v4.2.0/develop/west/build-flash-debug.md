---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/west/build-flash-debug.html
...
## [Out of tree runners](#id46)

[Zephyr modules](../modules.md#modules) can have external runners discovered by adding python
files in their [module.yml](../modules.md#modules-runners). Create an external runner class by
...
[deprecation process](../api/api_lifecycle.md#breaking-api-changes).
...
*class* runners.core.RunnerCaps(*commands: set[str] = <factory>*, *dev\_id: bool = False*, *mult\_dev\_ids: bool = False*, *flash\_addr: bool = False*, *erase: bool = False*, *reset: bool = False*, *extload: bool = False*, *tool\_opt: bool = False*, *file: bool = False*, *hide\_load\_files: bool = False*, *rtt: bool = False*)
:   This class represents a runner class’s capabilities.
    ...
    - mult\_dev\_ids: whether the runner supports multiple device identifiers
...
*class* runners.core.RunnerConfig(*build\_dir: str*, *board\_dir: str*, *elf\_file: str | None*, *exe\_file: str | None*, *hex\_file: str | None*, *bin\_file: str | None*, *uf2\_file: str | None*, *mot\_file: str | None*, *file: str | None*, *file\_type: [FileType](#runners.core.FileType) | None = FileType.OTHER*, *gdb: str | None = None*, *openocd: str | None = None*, *openocd\_search: list[str] = []*, *rtt\_address: int | None = None*)
...
:   Abstract superclass for binary runners (flashers, debuggers).
    ...
    *static* require(*program: str*, *path: str | None = None*) → str
    ...
    run\_telnet\_client(*host: str*, *port: int*, *active\_sock=None*) → None
    :   Run a telnet client for user interaction.

    *static* sram\_address\_from\_build\_conf(*build\_conf: [BuildConfiguration](#runners.core.BuildConfiguration)*)
    :   return CONFIG\_SRAM\_BASE\_ADDRESS.
