---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/toolchains/zephyr_sdk.html
...
You can change `0.17.2` to another version in the instructions below
...
1. Download and verify the [Zephyr SDK bundle](https://github.com/zephyrproject-rtos/sdk-ng/releases/tag/v0.17.2):
...
1. Download and verify the [Zephyr SDK bundle](https://github.com/zephyrproject-rtos/sdk-ng/releases/tag/v0.17.2):
   ...
   ```
   cd ~
   curl -L -O https://github.com/zephyrproject-rtos/sdk-ng/releases/download/v0.17.2/zephyr-sdk-0.17.2_macos-x86_64.tar.xz
   curl -L https://github.com/zephyrproject-rtos/sdk-ng/releases/download/v0.17.2/sha256.sum | shasum --check --ignore-missing
   ```
...
2. Extract the Zephyr SDK bundle archive:
   ...
   ```
   tar xvf zephyr-sdk-0.17.2_macos-x86_64.tar.xz
   ```
...
2. Download the [Zephyr SDK bundle](https://github.com/zephyrproject-rtos/sdk-ng/releases/tag/v0.17.2):

   ```
   cd %HOMEPATH%
   wget https://github.com/zephyrproject-rtos/sdk-ng/releases/download/v0.17.2/zephyr-sdk-0.17.2_windows-x86_64.7z
   ```
3. Extract the Zephyr SDK bundle archive:

   ```
   7z x zephyr-sdk-0.17.2_windows-x86_64.7z
   ```
