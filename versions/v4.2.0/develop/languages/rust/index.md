---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/languages/rust/index.html
...
2. Enable Rust support, via `CONFIG_RUST` in the `prj.conf`. The easiest way
   ...
   in [modules/lang/rust/samples ](https://github.com/zephyrproject-rtos/zephyr-lang-rust/blob/dd73abc242e995784da62352fe8c70d9a6c7ac2e/samples).
3. Configure the application’s `CMakeLists.txt` file to support Rust. Again this is easiest
...
5. Build as you would any other Zephyr application. Only a few targets currently support Rust
   ...
   [modules/lang/rust/etc/platforms.txt ](https://github.com/zephyrproject-rtos/zephyr-lang-rust/blob/dd73abc242e995784da62352fe8c70d9a6c7ac2e/etc/platforms.txt) file).
