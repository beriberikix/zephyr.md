---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/test/pytest.html
...
![../../_images/twister_and_pytest.svg](https://docs.zephyrproject.org/4.2.0/_images/twister_and_pytest.svg)
...
:   Helper class that provides methods used to interact with shell application.
    ...
    get\_filtered\_output(*command\_lines: list[str]*) → list[str]
    :   Filter out prompts and log messages

        Take the output of exec\_command, which can contain log messages and command prompts,
        ...
        Parameters:
        :   **command\_lines** – List of strings i.e. the output of exec\_command.
