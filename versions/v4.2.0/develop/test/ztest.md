---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/test/ztest.html
...
Using Ztest to create a test suite is as easy as calling the [`ZTEST_SUITE`](../../doxygen/html/group__ztest__test.md#gaef8892743e2d47c983efcb61beeedeb3). The macro
accepts the following arguments:

- `suite_name` - The name of the suite. This name must be unique within a single binary.
- [`ztest_suite_predicate_t`](../../doxygen/html/group__ztest__test.md#gad5323aa82773dac33cf0930e9524420c) - An optional predicate function to allow choosing when the
  test will run. The predicate will get a pointer to the global state passed in through
  [`ztest_run_all()`](../../doxygen/html/group__ztest__test.md#gac6b1f8b820cd682094b7aaeebdaa106e) and should return a boolean to decide if the suite should run.
- [`ztest_suite_setup_t`](../../doxygen/html/group__ztest__test.md#ga0063907dd70b9eb817ea472162693ee4) - An optional setup function which returns a test fixture. This
  will be called and run once per test suite run.
- [`ztest_suite_before_t`](../../doxygen/html/group__ztest__test.md#gac8a204832c267fed047e7707b65be74d) - An optional before function which will run before every single
  test in this suite.
- [`ztest_suite_after_t`](../../doxygen/html/group__ztest__test.md#ga0f9eeb8ddae455c1e7cc7a388a7b013c) - An optional after function which will run after every single
  test in this suite.
- [`ztest_suite_teardown_t`](../../doxygen/html/group__ztest__test.md#ga7769b894fdac5283ac949ce8fceea0dd) - An optional teardown function which will run at the end of
...
- [`ZTEST`](../../doxygen/html/group__ztest__test.md#gac25858f76ea667d07de422a3b489cb15) `(suite_name, test_name)` - Which can be used to add a test by `test_name` to a
  given suite by `suite_name`.
- [`ZTEST_P`](../../doxygen/html/group__ztest__test.md#gab80e25231b291b2c2b32e6049a52d34c) `(suite_name, test_name)` - Add a parameterized test to a given suite by specifying
  the `suite_name` and `test_name`. You can then access the passed parameter within
  the body of the test using the `data` pointer.
- [`ZTEST_USER`](../../doxygen/html/group__ztest__test.md#ga7121acc7ee00646cacefa773ff9631c8) `(suite_name, test_name)` - Which behaves the same as [`ZTEST`](../../doxygen/html/group__ztest__test.md#gac25858f76ea667d07de422a3b489cb15), only
  ...
  thread.
- [`ZTEST_F`](../../doxygen/html/group__ztest__test.md#gacd3ab522e0e5c8a270e86b0cb6bd81b2) `(suite_name, test_name)` - Which behaves the same as [`ZTEST`](../../doxygen/html/group__ztest__test.md#gac25858f76ea667d07de422a3b489cb15), only
  that the test function will already include a variable named `fixture` with the type
  `<suite_name>_fixture`.
- [`ZTEST_USER_F`](../../doxygen/html/group__ztest__test.md#ga12ccce144e577cac6ba763982ad14def) `(suite_name, test_name)` - Which combines the fixture feature of
  [`ZTEST_F`](../../doxygen/html/group__ztest__test.md#gacd3ab522e0e5c8a270e86b0cb6bd81b2) with the userspace threading for the test.
...
[`ZTEST_USER`](../../doxygen/html/group__ztest__test.md#ga7121acc7ee00646cacefa773ff9631c8) or [`ZTEST_USER_F`](../../doxygen/html/group__ztest__test.md#ga12ccce144e577cac6ba763982ad14def), requires that memory to be declared userspace
accessible. This is because the fixture memory is owned and initialized by kernel space. The Ztest
framework provides the [`ZTEST_DMEM`](../../doxygen/html/group__ztest__test.md#ga2c7d0aa85e7f320d582395c5ded90133) and [`ZTEST_BMEM`](../../doxygen/html/group__ztest__test.md#gac3de5965061b1164a8033712c9094e23) macros for use of such
...
While the Ztest framework provides a default [`test_main()`](../../doxygen/html/ztest_8h.md#a8a4533f287d99bb2d7c24c0e29c9a449) function, it’s possible that some
...
using the `predicate` to control when it would run. In that case, the [`test_main()`](../../doxygen/html/ztest_8h.md#a8a4533f287d99bb2d7c24c0e29c9a449)
...
report a skip using [`ztest_test_skip()`](../../doxygen/html/group__ztest__test.md#gada3b1fcfa71db1bf7787c03ff45256d5) or `Z_TEST_SKIP_IFDEF`. If the test runs,
...
The stress test environment is setup and executed using [`ZTRESS_EXECUTE`](../../doxygen/html/group__ztest__ztress.md#ga6acc3a50e0eff7360873006482f5c8e9) which
accepts a variable number of arguments. Each argument is a context that is
specified by [`ZTRESS_TIMER`](../../doxygen/html/group__ztest__ztress.md#gabab05b8db44a7024ce23cb34bf999e42) or [`ZTRESS_THREAD`](../../doxygen/html/group__ztest__ztress.md#gaed561641541e8ced6866f2f1227f21c0) macros. Contexts
...
Execution can be prematurely completed by specifying a test timeout ([`ztress_set_timeout()`](../../doxygen/html/group__ztest__ztress.md#ga5b3069bb2aa35ddc64c46c18d2e30091))
or an explicit abort ([`ztress_abort()`](../../doxygen/html/group__ztest__ztress.md#ga57f171e230fba462b3dea6b2d3cf71f6)).
...
may be executed multiple times. Enable [`CONFIG_ZTEST_REPEAT`](../../kconfig.md#CONFIG_ZTEST_REPEAT "CONFIG_ZTEST_REPEAT") to
...
be changed by the [`CONFIG_ZTEST_SUITE_REPEAT_COUNT`](../../kconfig.md#CONFIG_ZTEST_SUITE_REPEAT_COUNT "CONFIG_ZTEST_SUITE_REPEAT_COUNT") and
[`CONFIG_ZTEST_TEST_REPEAT_COUNT`](../../kconfig.md#CONFIG_ZTEST_TEST_REPEAT_COUNT "CONFIG_ZTEST_TEST_REPEAT_COUNT") Kconfig options.
