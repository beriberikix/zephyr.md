---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/bindings-upstream.html
...
- If your binding is describing an abstract class of hardware with Zephyr
  ...
  the vendor prefix. See [The Zephyr Project (zephyr)](api/bindings.md#dt-vendor-zephyr) for examples.
