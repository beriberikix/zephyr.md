---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/silabs,letimer-pwm.html
original_path: build/dts/api/bindings/pwm/silabs,letimer-pwm.html
---
...
[drivers/pwm/pwm\_silabs\_letimer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_silabs_letimer.c).

## Description

```text
Silicon Labs LETIMER (Low Energy Timer) PWM (Pulse Width Modulation)
...
may apply to the “silabs,letimer-pwm” compatible.
