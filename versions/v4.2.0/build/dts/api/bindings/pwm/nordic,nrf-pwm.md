---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/nordic,nrf-pwm.html
...
| `idleout-supported` | `boolean` | ```text Indicates if the PWM instance has the IDLEOUT register. ``` |
