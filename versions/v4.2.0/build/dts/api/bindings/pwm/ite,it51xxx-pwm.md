---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/ite,it51xxx-pwm.html
original_path: build/dts/api/bindings/pwm/ite,it51xxx-pwm.html
---
...
[drivers/pwm/pwm\_ite\_it51xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_ite_it51xxx.c).

## Description

```text
ITE, it51xxx Pulse Width Modulator (PWM) node
```
...
may apply to the “ite,it51xxx-pwm” compatible.
