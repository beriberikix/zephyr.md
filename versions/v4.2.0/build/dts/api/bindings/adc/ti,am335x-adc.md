---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/ti,am335x-adc.html
original_path: build/dts/api/bindings/adc/ti,am335x-adc.html
---
...
[drivers/adc/adc\_ti\_am335x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ti_am335x.c).
...
These property descriptions apply to “ti,am335x-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `ti,vrefp` | `int` | ```text Reference Voltage (in mV) ```  This property is **required**. |
| `ti,fifo` | `int` | ```text FIFO for storing conversions ```  This property is **required**.  Legal values: `0`, `1` |
...
may apply to the “ti,am335x-adc” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `ti,open-delay` | `int` | ```text Delay before acquisition period ``` |
| `zephyr,resolution` | `int` | ```text ADC resolution to be used for the channel. ```  Default value: `12` |
