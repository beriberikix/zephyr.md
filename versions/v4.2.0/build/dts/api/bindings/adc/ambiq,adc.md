---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/ambiq,adc.html
...
| `dma-mode` | `boolean` | ```text Enables DMA over ADC. ``` |
| `dma-buffer-location` | `string` | ```text Define the DMA buffer location section ``` |
| `dma-buffer-size` | `int` | ```text Define the DMA buffer size in (4-byte) words ``` |
