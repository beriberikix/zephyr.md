---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/wch,adc.html
original_path: build/dts/api/bindings/adc/wch,adc.html
---
...
[drivers/adc/adc\_ch32v00x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ch32v00x.c).
...
These property descriptions apply to “wch,adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `vref-mv` | `int` | ```text Reference voltage in mV. This is typically VDD. ```  Default value: `3300` |
...
may apply to the “wch,adc” compatible.
