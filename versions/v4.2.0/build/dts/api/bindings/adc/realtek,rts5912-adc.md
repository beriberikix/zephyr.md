---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/realtek,rts5912-adc.html
original_path: build/dts/api/bindings/adc/realtek,rts5912-adc.html
---
...
[drivers/adc/adc\_realtek\_rts5912.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_realtek_rts5912.c).
...
These property descriptions apply to “realtek,rts5912-adc”
...
| `vref-mv` | `int` | ```text The reference voltage of the ADC in mV. ```  Default value: `3300` |
...
may apply to the “realtek,rts5912-adc” compatible.
