---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/adi,ad405x-adc-base.html
original_path: build/dts/api/bindings/adc/adi,ad405x-adc-base.html
---

# adi,ad4050-adc (on spi bus)
...
[drivers/adc/adc\_ad405x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ad405x.c).

## Description

```text
ADL4050 ADC Controller
```
...
These property descriptions apply to “adi,ad4050-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `gp1-gpios` | `phandle-array` | ```text The GP1 signal defaults to DEV_RDY as produced by the adc. The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
| `gp0-gpios` | `phandle-array` | ```text The GP0 signal defaults to Disabled as produced by the adc. The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
| `conversion-gpios` | `phandle-array` | ```text The CONV signal. ```  This property is **required**. |
| `#io-channel-cells` | `int` | This property is **required**.  Constant value: `1` |
| `double-input-range` | `boolean` | ```text Default ADC input range is 0V to Vref. This option increases the range from 0V to 2 x Vref. Note that this requires VDD >= 2 x Vref. ``` |
...
may apply to the “adi,ad4050-adc” compatible.
