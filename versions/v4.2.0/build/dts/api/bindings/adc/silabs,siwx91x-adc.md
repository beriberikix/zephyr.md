---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/silabs,siwx91x-adc.html
original_path: build/dts/api/bindings/adc/silabs,siwx91x-adc.html
---
...
[drivers/adc/adc\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_silabs_siwx91x.c).

## Description

```text
Silicon Labs siwx91x ADC
```
...
These property descriptions apply to “silabs,siwx91x-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `silabs,adc-ref-voltage` | `int` | ```text ADC reference volatge in mv. This voltage is common for all the channels. Valid range: 1800 - 3600 ```  This property is **required**. |
| `silabs,adc-sampling-rate` | `int` | ```text ADC sampling rate in Hz (1-2500000 Hz). ```  This property is **required**.  Default value: `100000` |
| `#io-channel-cells` | `int` | ```text ADC channels should be declared in a sequential manner. Since the hardware allows any pin to be mapped to any channel, enforcing sequential channel declarations does not restrict or limit any functional capability. ```  This property is **required**.  Constant value: `1` |
...
may apply to the “silabs,siwx91x-adc” compatible.
