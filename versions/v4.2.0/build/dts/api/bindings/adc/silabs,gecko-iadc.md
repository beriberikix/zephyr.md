---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/silabs,gecko-iadc.html
...
```text
Silicon Labs Series 2 IADC (Incremental Analog to Digital Converter)
