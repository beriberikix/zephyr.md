---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/adi,ad4130-adc.html
original_path: build/dts/api/bindings/adc/adi,ad4130-adc.html
---

# adi,ad4130-adc (on spi bus)
...
[drivers/adc/adc\_ad4130.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ad4130.c).
...
These property descriptions apply to “adi,ad4130-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `bipolar` | `boolean` | ```text Bipolar configuration for AD4130 ``` |
| `internal-reference-value` | `int` | ```text Internal reference value selection: - AD4130_INTREF_2_5V - AD4130_INTREF_1_25V The default value is set to 0 to provide a higher full-scale range for ADC measurements, which is suitable for a wider variety of general-purpose applications. ```  Legal values: `0`, `1` |
| `adc-mode` | `int` | ```text ADC operating mode for AD4130 - 0 AD4130_CONTINUOUS - 1 AD4130_SINGLE - 2 AD4130_STANDBY - 3 AD4130_POWER_DOWN - 4 AD4130_IDLE The default is set to 0 because the continuous conversion mode is enabled for control setup upon power-up or after reset. ```  Legal values: `0`, `1`, `2`, `3`, `4` |
| `clock-type` | `int` | ```text Clock selection: - AD4130_INT_76_8_KHZ_OUT_OFF - AD4130_INT_76_8_KHZ_OUT_ON - AD4130_EXT_76_8KHZ - AD4130_EXT_153_6_KHZ_DIV_2 The default value is 0, which selects the internal clock without enabling the clock output. ```  Legal values: `0`, `1`, `2`, `3` |
...
may apply to the “adi,ad4130-adc” compatible.
