---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mfd/ambiq,iom.html
original_path: build/dts/api/bindings/mfd/ambiq,iom.html
---
...
```text
Ambiq SPI/I2C controller common properties
```
...
| Name | Type | Details |
| --- | --- | --- |
| `dma-mode` | `boolean` | ```text Enables DMA over SPI/I2C. ``` |
...
may apply to the “ambiq,iom” compatible.
