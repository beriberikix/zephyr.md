---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/stepper/ti/ti,drv84xx.html
original_path: build/dts/api/bindings/stepper/ti/ti,drv84xx.html
---
...
[drivers/stepper/ti/drv84xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/stepper/ti/drv84xx.c).
...
| `m0-gpios` | `phandle-array` | ```text Microstep configuration pin 0. ``` |
| `m1-gpios` | `phandle-array` | ```text Microstep configuration pin 1. ``` |
