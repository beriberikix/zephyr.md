---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/power/st,stm32-pwr.html
original_path: build/dts/api/bindings/power/st,stm32-pwr.html
---
...
[soc/st/stm32/common/stm32\_wkup\_pins.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/st/stm32/common/stm32_wkup_pins.c).
...
These property descriptions apply to “st,stm32-pwr”
...
may apply to the “st,stm32-pwr” compatible.
...
| `wkup-gpios` | `phandle-array` | ```text Specifies the GPIOs, if any, that are associated with the wake-up pin.  For example, for GPIO PB2 associated with wakeup source 1 on wake-up event 1 on STM32U5 SoCs: wkup-gpios = <&gpiob 2 STM32_PWR_WKUP_EVT_SRC_1>, <...>; ``` |
