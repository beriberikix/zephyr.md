---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mtd/renesas,ra-nv-data-flash.html
original_path: build/dts/api/bindings/mtd/renesas,ra-nv-data-flash.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `programming-enable` | `boolean` | ```text Enable data flash programming configuration ``` |
| `erase-value-undefined` | `boolean` | ```text Areas of flash that are in an erased state will read back undefined values. ``` |
...
may apply to the “renesas,ra-nv-data-flash” compatible.
