---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mtd/mspi-is25xX0xx.html
original_path: build/dts/api/bindings/mtd/mspi-is25xX0xx.html
---

# mspi-is25xX0xx (on mspi bus)
...
[drivers/flash/flash\_mspi\_is25xX0xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/flash_mspi_is25xX0xx.c).

## Description

```text
ISSI IS25(W/L)X0(32/64) on MSPI bus
```
...
may apply to the “mspi-is25xX0xx” compatible.
