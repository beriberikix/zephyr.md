---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/bluetooth/infineon,cyw43xxx-bt-hci.html
...
| `fw-download-speed` | `int` | ```text HCI UART baudrate for FW download operation. If not defined bus/current-speed will be used as default. ``` |
