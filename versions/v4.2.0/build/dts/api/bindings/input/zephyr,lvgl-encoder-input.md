---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/input/zephyr,lvgl-encoder-input.html
...
| `display` | `phandle` | ```text Phandle of the display device to pass input commands to. Used in multi-display setup. ``` |
