---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i3c/snps,designware-i3c.html
original_path: build/dts/api/bindings/i3c/snps,designware-i3c.html
---
...
[drivers/i3c/i3c\_dw.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i3c/i3c_dw.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `od-thigh-max-ns` | `int` | ```text Maximum high clock pulse length (ns) in Open-Drain mode. The default is value from Section 6.2 of the I3C Specifiction. ```  Default value: `41` |
| `od-tlow-min-ns` | `int` | ```text Minimum low clock pulse length (ns) in Open-Drain mode. The default is value from Section 6.2 of the I3C Specifiction. ```  Default value: `200` |
...
| `primary-controller-da` | `int` | ```text This is the self assigned dynamic address of the I3C controller. This is the address is used to communicate with itself after a handoff by a secondary controller. This is only used if the controller is a primary controller. ``` |
...
may apply to the “snps,designware-i3c” compatible.
