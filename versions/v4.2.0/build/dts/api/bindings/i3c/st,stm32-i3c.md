---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i3c/st,stm32-i3c.html
original_path: build/dts/api/bindings/i3c/st,stm32-i3c.html
---
...
[drivers/i3c/i3c\_stm32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i3c/i3c_stm32.c).
...
may apply to the “st,stm32-i3c” compatible.
...
| `dmas` | `phandle-array` | ```text Optional DMA channel specifier, required for DMA transactions. ``` |
| `dma-names` | `string-array` | ```text DMA channel name. If DMA should be used, expected value is "rx" "tx" "tc" "rs".  For example    dma-names = "rx", "tx", "tc", "rs"; ``` |
