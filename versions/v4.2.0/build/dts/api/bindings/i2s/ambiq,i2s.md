---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2s/ambiq,i2s.html
original_path: build/dts/api/bindings/i2s/ambiq,i2s.html
---
...
[drivers/i2s/i2s\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2s/i2s_ambiq.c).
...
| `i2s-buffer-location` | `string` | ```text Define I2S DMA buffer location section ``` |
| `i2s-buffer-size` | `int` | ```text Define I2S DMA buffer size in (4-byte) words ``` |
...
may apply to the “ambiq,i2s” compatible.
