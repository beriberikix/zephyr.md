---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/can/microchip,mcp251xfd.html
...
[drivers/can/can\_mcp251xfd.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_mcp251xfd.c).
...
| `xstby-enable` | `boolean` | ```text Enables standby pin control on GPIO0. ``` |
