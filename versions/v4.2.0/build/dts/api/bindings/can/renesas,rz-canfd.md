---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/can/renesas,rz-canfd.html
original_path: build/dts/api/bindings/can/renesas,rz-canfd.html
---
...
[drivers/can/can\_renesas\_rz\_canfd.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_renesas_rz_canfd.c).

## Description

```text
Renesas RZ CANFD controller
```
...
These property descriptions apply to “renesas,rz-canfd”
...
| `rx-max-filters` | `int` | ```text To determine the maximum rx filters can be added on this CAN device. Valid range: 1 - 128 ```  This property is **required**. |
...
may apply to the “renesas,rz-canfd” compatible.
