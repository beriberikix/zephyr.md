---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/can/renesas,rz-canfd-global.html
original_path: build/dts/api/bindings/can/renesas,rz-canfd-global.html
---
...
```text
Renesas RZ CANFD controller global
```
...
may apply to the “renesas,rz-canfd-global” compatible.
