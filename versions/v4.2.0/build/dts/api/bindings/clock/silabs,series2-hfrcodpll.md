---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/silabs,series2-hfrcodpll.html
...
```text
Silicon Labs Series 2 HFRCODPLL (High-Frequency RC Oscillator with Digital Phase-Locked Loop)
