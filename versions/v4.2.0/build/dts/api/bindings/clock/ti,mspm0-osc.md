---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/ti,mspm0-osc.html
original_path: build/dts/api/bindings/clock/ti,mspm0-osc.html
---
...
| `ti,xtal-startup-delay-us` | `int` | ```text Crystal Oscillator startup delay in micro seconds. ``` |
| `ti,low-cap` | `boolean` | ```text Specifies if capacitance is less than 3pF to reduce power consumption. ``` |
...
may apply to the “ti,mspm0-osc” compatible.
