---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/silabs,series2-lfrco.html
...
```text
Silicon Labs Series 2 LFRCO (Low-Frequency RC Oscillator)
