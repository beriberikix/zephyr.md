---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/bflb,bclk.html
original_path: build/dts/api/bindings/clock/bflb,bclk.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `divider` | `int` | ```text Divide root clock by this 8-bits value ```  This property is **required**. |
...
may apply to the “bflb,bclk” compatible.
