---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/nordic,nrf-auxpll.html
...
| `nordic,frequency` | `int` | ```text Value used to set the fractional PLL divider ratio (can be set between divider ratios 4 to 5). Valid values shown in dt-bindings/clock/nrf-auxpll.h. ```  This property is **required**. |
