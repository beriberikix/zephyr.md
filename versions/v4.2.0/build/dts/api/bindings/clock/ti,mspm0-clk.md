---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/ti,mspm0-clk.html
original_path: build/dts/api/bindings/clock/ti,mspm0-clk.html
---
...
| `clock-frequency` | `int` | ```text Output clock frequency in Hz. ``` |
| `clk-div` | `int` | ```text Clock divider selction value. Valid range [2 ... 16]. ``` |
...
may apply to the “ti,mspm0-clk” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `clocks` | `phandle-array` | ```text Clock reference source ``` |
