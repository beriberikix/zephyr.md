---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/renesas,rx-cgc-pll.html
original_path: build/dts/api/bindings/clock/renesas,rx-cgc-pll.html
---
...
[drivers/clock\_control/clock\_control\_renesas\_rx\_pll\_cgc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_renesas_rx_pll_cgc.c).

## Description

```text
Renesas RX Clock Generation Circuit PLL Clock
```
...
| `mul` | `int` | This property is **required**. |
...
may apply to the “renesas,rx-cgc-pll” compatible.
