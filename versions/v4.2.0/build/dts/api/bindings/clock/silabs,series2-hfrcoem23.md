---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/silabs,series2-hfrcoem23.html
...
```text
Silicon Labs Series 2 HFRCOEM23 (High-Frequency RC Oscillator for Energy Mode 2 and 3)
