---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/nordic,nrf-hsfll-local.html
original_path: build/dts/api/bindings/clock/nordic,nrf-hsfll-local.html
---
...
[drivers/clock\_control/clock\_control\_nrf\_hsfll\_local.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_nrf_hsfll_local.c).
...
| `nordic,ficrs` | `phandle-array` | ```text FICR entries, e.g. <&ficr OFFSET>. Available offsets (or FICR entries) are available at <zephyr/dt-bindings/misc/nordic-nrf-ficr-*.h>. ``` |
...
may apply to the “nordic,nrf-hsfll-local” compatible.
