---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/nordic,nrf-lfclk.html
original_path: build/dts/api/bindings/clock/nordic,nrf-lfclk.html
---
...
[drivers/clock\_control/clock\_control\_nrf\_lfclk.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_nrf_lfclk.c).
...
| `lfrc-accuracy-ppm` | `int` | ```text Clock accuracy in parts per million if LFRC clock source is used. ``` |
| `lflprc-accuracy-ppm` | `int` | ```text Clock accuracy in parts per million if LFLPRC clock source is used. ``` |
| `lfrc-startup-time-us` | `int` | ```text Clock startup time in microseconds if LFRC clock source is used. ``` |
| `lflprc-startup-time-us` | `int` | ```text Clock startup time in microseconds if LFLPRC clock source is used. ``` |
...
may apply to the “nordic,nrf-lfclk” compatible.
