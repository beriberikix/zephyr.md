---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/nordic,nrf-fll16m.html
...
[drivers/clock\_control/clock\_control\_nrf\_fll16m.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_nrf_fll16m.c).
...
| `open-loop-accuracy-ppm` | `int` | ```text Clock accuracy in parts per million ```  This property is **required**. |
| `open-loop-startup-time-us` | `int` | ```text Clock startup time if open-loop clock source is used. ```  This property is **required**. |
