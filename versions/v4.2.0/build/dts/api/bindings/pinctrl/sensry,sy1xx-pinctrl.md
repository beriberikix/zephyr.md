---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/sensry,sy1xx-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/sensry,sy1xx-pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_sy1xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_sy1xx.c).

## Description

```text
Sensry SY1xx Pin Controller
...
These property descriptions apply to “sensry,sy1xx-pinctrl”
...
may apply to the “sensry,sy1xx-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text Pin mux selection. See the SOC level pinctrl header for a defined list of these options. ```  This property is **required**. |
| `slew-rate` | `int` | ```text Selects the output drive strength. Choices represent approximate capacitive load. The default corresponds to the reset value of the register field. - 0.. 2pF, Weakest drive - 1.. 4pF, Low drive - 2.. 8pF, Medium drive - 3.. 16pF, Strongest drive ```  Legal values: `0`, `1`, `2`, `3` |
