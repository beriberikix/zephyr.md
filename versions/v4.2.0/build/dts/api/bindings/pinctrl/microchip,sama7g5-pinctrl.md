---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/microchip,sama7g5-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/microchip,sama7g5-pinctrl.html
---
...
These property descriptions apply to “microchip,sama7g5-pinctrl”
...
may apply to the “microchip,sama7g5-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text An array of pins sharing the same group properties. The pins should be defined using pre-defined macros used by the SoC series. ```  This property is **required**. |
