---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/wch,afio.html
original_path: build/dts/api/bindings/pinctrl/wch,afio.html
---
...
[drivers/pinctrl/pinctrl\_wch\_afio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_wch_afio.c).
...
These property descriptions apply to “wch,afio”
...
may apply to the “wch,afio” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `slew-rate` | `string` | Default value: `max-speed-2mhz`  Legal values: `'max-speed-10mhz'`, `'max-speed-2mhz'`, `'max-speed-30mhz'` |
