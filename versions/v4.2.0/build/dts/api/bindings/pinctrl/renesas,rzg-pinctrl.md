---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/renesas,rzg-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/renesas,rzg-pinctrl.html
---
...
These property descriptions apply to “renesas,rzg-pinctrl”
...
may apply to the “renesas,rzg-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text Pinmux configuration node. Values are constructed from GPIO port number, pin number, and alternate function configuration number using the RZG_PINMUX() helper macro in pinctrl-rzg(2)-common.h. ``` |
| `pins` | `array` | ```text Special Purpose pins configuration node. Values are define in pinctrl-rzg(2)-common.h. Ex: BSP_IO_XSPI_IO0,BSP_IO_I3C_SCL,... ``` |
