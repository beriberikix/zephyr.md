---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/wch,00x-afio.html
original_path: build/dts/api/bindings/pinctrl/wch,00x-afio.html
---
...
[drivers/pinctrl/pinctrl\_wch\_00x\_afio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_wch_00x_afio.c).

## Description

```text
WCH CH32V00x Alternate Function (AFIO)
```
...
These property descriptions apply to “wch,00x-afio”
...
may apply to the “wch,00x-afio” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `slew-rate` | `string` | Default value: `max-speed-30mhz`  Legal values: `'max-speed-30mhz'` |
