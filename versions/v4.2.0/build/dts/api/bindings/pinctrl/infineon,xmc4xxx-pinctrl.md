---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/infineon,xmc4xxx-pinctrl.html
...
[drivers/pinctrl/pinctrl\_xmc4xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_xmc4xxx.c).

## Description

```text
Infineon XMC4XXX Pin Controller
