---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/silabs,siwx91x-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/silabs,siwx91x-pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_silabs_siwx91x.c).

## Description

```text
Silabs SiWx91x Pin Controller
...
These property descriptions apply to “silabs,siwx91x-pinctrl”
...
may apply to the “silabs,siwx91x-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text An array of pins sharing the same group properties. The pins should be defined using the <peripheral>_<signal>_<pin> macros available from the SoC DeviceTree files. ```  This property is **required**. |
