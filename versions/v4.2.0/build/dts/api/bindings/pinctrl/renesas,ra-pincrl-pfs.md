---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/renesas,ra-pincrl-pfs.html
original_path: build/dts/api/bindings/pinctrl/renesas,ra-pincrl-pfs.html
---
...
These property descriptions apply to “renesas,ra-pinctrl-pfs”
...
may apply to the “renesas,ra-pinctrl-pfs” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `psels` | `array` | ```text An array of pins sharing the same group properties. Each element of the array is an integer constructed from the pin number and the alternative function of the pin. ```  This property is **required**. |
| `drive-strength` | `string` | ```text The drive strength of a pin. The default value is low, as this is the power on reset value. ```  Default value: `low`  Legal values: `'low'`, `'medium'`, `'highspeed-high'`, `'high'` |
| `renesas,analog-enable` | `boolean` | ```text enable analog input ``` |
