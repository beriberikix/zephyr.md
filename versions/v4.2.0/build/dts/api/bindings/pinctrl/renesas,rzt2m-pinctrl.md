---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/renesas,rzt2m-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/renesas,rzt2m-pinctrl.html
---
...
[drivers/pinctrl/renesas/rz/pinctrl\_rzt2m.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/renesas/rz/pinctrl_rzt2m.c).

## Description

```text
Renesas RZ/T2M Pin Controller
...
These property descriptions apply to “renesas,rzt2m-pinctrl”
...
may apply to the “renesas,rzt2m-pinctrl” compatible.
...
| `drive-strength` | `string` | ```text The drive strength of a pin, relative to full-driver strength. The default value is "low", which is the reset value. ```  Default value: `low`  Legal values: `'low'`, `'middle'`, `'high'`, `'ultrahigh'` |
