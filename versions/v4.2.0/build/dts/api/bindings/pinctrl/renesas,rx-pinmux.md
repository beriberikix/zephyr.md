---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/renesas,rx-pinmux.html
original_path: build/dts/api/bindings/pinctrl/renesas,rx-pinmux.html
---
...
```text
Rensas RX Pinmux (Multi Function Pin Controller, MPC)
```
...
These property descriptions apply to “renesas,rx-pinmux”
...
| Name | Type | Details |
| --- | --- | --- |
| `#pinmux-cells` | `int` | ```text number of items in a pinmux specifier ```  This property is **required**.  Constant value: `2` |
...
may apply to the “renesas,rx-pinmux” compatible.
