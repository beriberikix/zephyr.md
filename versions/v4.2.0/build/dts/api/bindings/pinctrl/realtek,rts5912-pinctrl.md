---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/realtek,rts5912-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/realtek,rts5912-pinctrl.html
---

# realtek,rts5912-pinctrl
...
[drivers/pinctrl/pinctrl\_realtek\_rts5912.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_realtek_rts5912.c).

## Description

```text
Realtek RTS5912 Pin Controller
```
...
These property descriptions apply to “realtek,rts5912-pinctrl”
...
may apply to the “realtek,rts5912-pinctrl” compatible.
...
| `drive-strength` | `string` | ```text "low" — 4mA/8mA drive strength "high" — 8mA/12mA drive strength ```  Legal values: `'low'`, `'high'` |
| `slew-rate` | `string` | ```text "fast" — Fast Frequency Slew Rate "slow" — Slow Frequency Slew Rate ```  Legal values: `'fast'`, `'low'` |
| `bias-pull-up` | `boolean` | ```text enable pull-up resistor ``` |
| `bias-pull-down` | `boolean` | ```text enable pull-down resistor ``` |
| `drive-push-pull` | `boolean` | ```text drive actively high and low ``` |
| `drive-open-drain` | `boolean` | ```text drive with open drain (hardware AND) ``` |
