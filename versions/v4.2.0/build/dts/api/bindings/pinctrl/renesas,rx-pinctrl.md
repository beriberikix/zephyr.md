---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/renesas,rx-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/renesas,rx-pinctrl.html
---
...
These property descriptions apply to “renesas,rx-pinctrl”
...
may apply to the “renesas,rx-pinctrl” compatible.
...
| `drive-strength` | `string` | ```text The drive strength of a pin. The default value is normal, as this is the power on reset value. ```  Default value: `normal`  Legal values: `'normal'`, `'high'` |
