---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/reset/microchip,mpfs-reset.html
original_path: build/dts/api/bindings/reset/microchip,mpfs-reset.html
---
...
[drivers/reset/reset\_mchp\_mss.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/reset/reset_mchp_mss.c).

## Description

```text
Microchip MPFS Reset Controller (SOFT_RESET_CR, SUBBLK_CLOCK_CR)
```
...
may apply to the “microchip,mpfs-reset” compatible.
