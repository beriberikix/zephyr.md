---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/meas,ms5837-02ba.html
original_path: build/dts/api/bindings/sensor/meas,ms5837-02ba.html
---

# meas,ms5837-02ba (on i2c bus)
...
```text
TE Connectivity MS5837-02BA digital pressure sensor
```
...
may apply to the “meas,ms5837-02ba” compatible.
