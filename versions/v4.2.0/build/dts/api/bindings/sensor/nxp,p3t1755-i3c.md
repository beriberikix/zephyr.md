---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/nxp,p3t1755-i3c.html
original_path: build/dts/api/bindings/sensor/nxp,p3t1755-i3c.html
---

# nxp,p3t1755 (on i3c bus)
...
[drivers/sensor/nxp/p3t1755/p3t1755.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/nxp/p3t1755/p3t1755.c).

## Description

```text
NXP P3T1755 digital temperature sensor connected to I3C bus.
```
...
| `oneshot-mode` | `boolean` | ```text Oneshot sampling mode, this reduces power consumption. By default the sensor is in a continuous conversion state. ``` |
...
may apply to the “nxp,p3t1755” compatible.
