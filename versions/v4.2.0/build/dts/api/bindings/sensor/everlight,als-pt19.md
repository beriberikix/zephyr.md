---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/everlight,als-pt19.html
original_path: build/dts/api/bindings/sensor/everlight,als-pt19.html
---

# everlight,als-pt19

Vendor: [Everlight Electronics Co. Ltd.](../../bindings.md#dt-vendor-everlight)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/everlight/als\_pt19/als\_pt19.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/everlight/als_pt19/als_pt19.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `load-resistor` | `int` | ```text Load resistor value in ohms ```  This property is **required**. |
...
may apply to the “everlight,als-pt19” compatible.
