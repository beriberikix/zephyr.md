---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/pni,rm3100.html
original_path: build/dts/api/bindings/sensor/pni,rm3100.html
---

# pni,rm3100 (on i2c bus)

Vendor: [PNI Sensor Corporation](../../bindings.md#dt-vendor-pni)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/pni/rm3100/rm3100.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/pni/rm3100/rm3100.c).
...
| `odr` | `int` | ```text The output data rate (ODR) of the sensor in Hz. Default is power-on setting. ```  Default value: `150`  Legal values: `146`, `147`, `148`, `149`, `150`, `151`, `152`, `153`, `154`, `155`, `156`, `157`, `158`, `159` |
...
may apply to the “pni,rm3100” compatible.
