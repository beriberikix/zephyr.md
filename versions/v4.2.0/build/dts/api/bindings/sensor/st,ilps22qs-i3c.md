---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/st,ilps22qs-i3c.html
original_path: build/dts/api/bindings/sensor/st,ilps22qs-i3c.html
---
...
[drivers/sensor/st/lps2xdf/lps2xdf.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/lps2xdf/lps2xdf.c).
...
| `fs` | `int` | ```text Specify the full-scale mode. The default is the power-on reset value.  - 0 # ILPS22QS_DT_FS_MODE_1_1260 - 1 # ILPS22QS_DT_FS_MODE_2_4060 ```  Legal values: `0`, `1` |
...
may apply to the “st,ilps22qs” compatible.
