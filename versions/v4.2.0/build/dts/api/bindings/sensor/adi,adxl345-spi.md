---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/adi,adxl345-spi.html
original_path: build/dts/api/bindings/sensor/adi,adxl345-spi.html
---

# adi,adxl345 (on spi bus)
...
[drivers/sensor/adi/adxl345/adxl345.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/adi/adxl345/adxl345.c).

## Description

```text
ADXL345 3-axis accelerometer with SPI connection
```
...
| `odr` | `int` | ```text Accelerometer sampling frequency (ODR). Default is power on reset value. ```  Default value: `10`  Legal values: `7`, `8`, `9`, `10`, `11`, `12` |
| `fifo-watermark` | `int` | ```text Specify the FIFO watermark level in frame count. Valid range: 1 - 31 ``` |
| `int2-gpios` | `phandle-array` | ```text The INT2 signal defaults to active high as produced by the sensor.  The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
...
may apply to the “adi,adxl345” compatible.
