---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/st,lsm6dso-i2c.html
original_path: build/dts/api/bindings/sensor/st,lsm6dso-i2c.html
---
...
[drivers/sensor/st/lsm6dso/lsm6dso.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/st/lsm6dso/lsm6dso.c).
...
| `tap-mode` | `int` | ```text Tap mode. Default is power-up configuration.  - 0 # LSM6DSO_DT_SINGLE_TAP - 1 # LSM6DSO_DT_SINGLE_DOUBLE_TAP ```  Legal values: `0`, `1` |
...
may apply to the “st,lsm6dso” compatible.
