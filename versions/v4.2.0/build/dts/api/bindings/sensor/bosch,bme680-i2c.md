---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/bosch,bme680-i2c.html
original_path: build/dts/api/bindings/sensor/bosch,bme680-i2c.html
---
...
```text
Bosch BME680 Environmental Sensor (I2C)
