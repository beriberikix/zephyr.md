---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/bosch,bme680-spi.html
original_path: build/dts/api/bindings/sensor/bosch,bme680-spi.html
---

# bosch,bme680 (on spi bus)
...
[drivers/sensor/bosch/bme680](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/bosch/bme680).

## Description

```text
Bosch BME680 Environmental Sensor (SPI)
...
may apply to the “bosch,bme680” compatible.
