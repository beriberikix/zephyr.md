---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/adi,adxl366-spi.html
original_path: build/dts/api/bindings/sensor/adi,adxl366-spi.html
---

# adi,adxl366 (on spi bus)
...
```text
ADXL366 3-axis nanopower accelerometer, accessed through SPI bus
```
