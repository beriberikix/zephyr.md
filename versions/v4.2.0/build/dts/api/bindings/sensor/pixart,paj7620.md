---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/pixart,paj7620.html
original_path: build/dts/api/bindings/sensor/pixart,paj7620.html
---

# pixart,paj7620 (on i2c bus)
...
[drivers/sensor/pixart/paj7620/paj7620.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/pixart/paj7620/paj7620.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text INT pin This pin defaults to active low when produced by the sensor. The property value should ensure the flags properly describe the signal that is presented to the driver. ``` |
...
may apply to the “pixart,paj7620” compatible.
