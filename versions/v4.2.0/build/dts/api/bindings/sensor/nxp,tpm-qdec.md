---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/nxp,tpm-qdec.html
original_path: build/dts/api/bindings/sensor/nxp,tpm-qdec.html
---
...
[drivers/sensor/nxp/qdec\_tpm/qdec\_nxp\_tpm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/nxp/qdec_tpm/qdec_nxp_tpm.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `micro-ticks-per-rev` | `int` | ```text This is a number that is used to determine how many revolutions * 1000000 were done based on the current counter's value. ```  This property is **required**. |
...
may apply to the “nxp,tpm-qdec” compatible.
