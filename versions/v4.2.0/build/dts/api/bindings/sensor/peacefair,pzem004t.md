---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/peacefair,pzem004t.html
original_path: build/dts/api/bindings/sensor/peacefair,pzem004t.html
---

# peacefair,pzem004t

Vendor: [Ningbo Peacefair Electronic Technology Co., Ltd](../../bindings.md#dt-vendor-peacefair)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/pzem004t/pzem004t.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/pzem004t/pzem004t.c).

## Description

```text
Peacefair PZEM004T energy meter sensor
```
...
may apply to the “peacefair,pzem004t” compatible.
