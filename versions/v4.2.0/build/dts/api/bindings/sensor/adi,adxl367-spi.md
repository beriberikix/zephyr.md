---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/adi,adxl367-spi.html
original_path: build/dts/api/bindings/sensor/adi,adxl367-spi.html
---

# adi,adxl367 (on spi bus)
...
```text
ADXL367 3-axis nanopower accelerometer, accessed through SPI bus
```
