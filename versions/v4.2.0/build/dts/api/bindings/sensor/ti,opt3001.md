---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/ti,opt3001.html
original_path: build/dts/api/bindings/sensor/ti,opt3001.html
---

# ti,opt3001 (on i2c bus)
...
[drivers/sensor/ti/opt3001/opt3001.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ti/opt3001/opt3001.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin on the opt3001 where the default polarity is active low. ``` |
...
may apply to the “ti,opt3001” compatible.
