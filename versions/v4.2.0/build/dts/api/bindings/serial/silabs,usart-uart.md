---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/silabs,usart-uart.html
original_path: build/dts/api/bindings/serial/silabs,usart-uart.html
---
...
[drivers/serial/uart\_silabs\_usart.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_silabs_usart.c).
...
```text
Silicon Labs Series 2 USART (Universal Synchronous/Asynchronous Receiver/Transmitter)
...
may apply to the “silabs,usart-uart” compatible.
