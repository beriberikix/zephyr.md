---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/espressif,esp32-uart.html
original_path: build/dts/api/bindings/serial/espressif,esp32-uart.html
---
...
[drivers/serial/uart\_esp32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_esp32.c).
...
| `hw-rs485-hd-mode` | `boolean` | ```text Enable the hardware RS485 half duplex mode. Overrides hw-flow-control if both are set. Using this mode, the pin assigned to DTR is asserted during transmission. ``` |
...
may apply to the “espressif,esp32-uart” compatible.
