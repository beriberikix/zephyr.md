---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/wch,usart.html
original_path: build/dts/api/bindings/serial/wch,usart.html
---

# wch,usart

Vendor: [WinChipHead](../../bindings.md#dt-vendor-wch)

Note

An implementation of a driver matching this compatible is available in
[drivers/serial/uart\_wch\_usart.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_wch_usart.c).
...
may apply to the “wch,usart” compatible.
