---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rz-sci-b-uart.html
original_path: build/dts/api/bindings/serial/renesas,rz-sci-b-uart.html
---
...
[drivers/serial/uart\_renesas\_rz\_sci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_rz_sci.c).
...
```text
Renesas RZ SCI-B UART controller
```
...
may apply to the “renesas,rz-sci-b-uart” compatible.
