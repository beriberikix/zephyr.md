---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/adi,max32-uart.html
...
| `dmas` | `phandle-array` | ```text DMA configuration used by asynchronous UART. Consists of a DMA instance, channel number and a matching DMA slot.  For example dmas for TX, RX on UART2    dmas = <&dma0 1 MAX32_DMA_SLOT_UART2_TX>, <&dma0 2 MAX32_DMA_SLOT_UART2_RX>; ``` |
