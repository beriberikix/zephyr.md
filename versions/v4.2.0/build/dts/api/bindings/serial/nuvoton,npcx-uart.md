---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/nuvoton,npcx-uart.html
original_path: build/dts/api/bindings/serial/nuvoton,npcx-uart.html
---
...
[drivers/serial/uart\_npcx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_npcx.c).
...
| `uart-rx` | `phandle` | ```text Mapping table between Wake-Up Input (WUI) and uart rx START signal.  For example the WUI mapping on NPCX7 UART1 would be    uart-rx = <&wui_cr_sin1>; ```  This property is **required**. |
...
may apply to the “nuvoton,npcx-uart” compatible.
