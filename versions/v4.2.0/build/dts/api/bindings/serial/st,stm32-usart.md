---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/st,stm32-usart.html
original_path: build/dts/api/bindings/serial/st,stm32-usart.html
---
...
may apply to the “st,stm32-usart” compatible.
