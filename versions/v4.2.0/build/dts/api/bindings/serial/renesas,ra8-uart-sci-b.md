---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,ra8-uart-sci-b.html
original_path: build/dts/api/bindings/serial/renesas,ra8-uart-sci-b.html
---
...
[drivers/serial/uart\_renesas\_ra8\_sci\_b.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_ra8_sci_b.c).
...
```text
Renesas RA SCI_B UART controller
```
...
may apply to the “renesas,ra8-uart-sci-b” compatible.
