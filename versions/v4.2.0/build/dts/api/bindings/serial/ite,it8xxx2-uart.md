---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/ite,it8xxx2-uart.html
original_path: build/dts/api/bindings/serial/ite,it8xxx2-uart.html
---
...
[drivers/serial/uart\_ite\_it8xxx2.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_ite_it8xxx2.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `port-num` | `int` | ```text Ordinal identifying the port ```  This property is **required**. |
| `gpios` | `phandle-array` | This property is **required**. |
| `uart-dev` | `phandle` | ```text Get the handle of the UART device ```  This property is **required**. |
...
may apply to the “ite,it8xxx2-uart” compatible.
