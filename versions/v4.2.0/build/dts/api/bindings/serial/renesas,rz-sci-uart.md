---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rz-sci-uart.html
original_path: build/dts/api/bindings/serial/renesas,rz-sci-uart.html
---
...
```text
Renesas RZ SCI UART controller
```
...
may apply to the “renesas,rz-sci-uart” compatible.
