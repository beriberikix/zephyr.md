---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/nxp,lpuart.html
original_path: build/dts/api/bindings/serial/nxp,lpuart.html
---
...
[drivers/serial/uart\_mcux\_lpuart.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_mcux_lpuart.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `nxp,loopback` | `boolean` | ```text Enable loopback mode on LPUART peripheral. When present, RX pin is disconnected, and transmitter output is internally connected to the receiver input. ``` |
...
| `nxp,rs485-mode` | `boolean` | ```text Set to enable RTS signal, which can be used to enable the driver of an external RS-485 transceiver. Note hw-flow-control should be set to false. ``` |
| `nxp,rs485-de-active-low` | `boolean` | ```text RTS polarity at RS485 mode. ``` |
...
may apply to the “nxp,lpuart” compatible.
