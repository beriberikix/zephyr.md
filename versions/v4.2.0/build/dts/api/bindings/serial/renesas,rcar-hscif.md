---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rcar-hscif.html
original_path: build/dts/api/bindings/serial/renesas,rcar-hscif.html
---
...
[drivers/serial/uart\_rcar.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_rcar.c).
...
```text
Renesas R-Car HSCIF controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `current-speed` | `int` | ```text Initial baud rate setting for UART ```  This property is **required**. |
...
may apply to the “renesas,rcar-hscif” compatible.
