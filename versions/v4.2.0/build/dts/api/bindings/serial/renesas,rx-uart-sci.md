---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rx-uart-sci.html
original_path: build/dts/api/bindings/serial/renesas,rx-uart-sci.html
---
...
[drivers/serial/uart\_renesas\_rx\_sci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_rx_sci.c).
...
```text
Renesas RX SCI UART controller
```
...
may apply to the “renesas,rx-uart-sci” compatible.
