---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/ns16550.html
original_path: build/dts/api/bindings/serial/ns16550.html
---
...
[drivers/serial/uart\_ns16550.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_ns16550.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `reg-shift` | `int` | ```text quantity to shift the register offsets by ```  This property is **required**. |
| `pcp` | `int` | ```text custom clock (PRV_CLOCK_PARAMS, if supported) ``` |
| `dlf` | `int` | ```text divisor latch fraction (DLF, if supported) ``` |
| `io-mapped` | `boolean` | ```text specify registers are IO mapped or memory mapped ``` |
...
may apply to the “ns16550” compatible.
