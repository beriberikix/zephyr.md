---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/lowrisc,opentitan-uart.html
original_path: build/dts/api/bindings/serial/lowrisc,opentitan-uart.html
---

# lowrisc,opentitan-uart

Vendor: [lowRISC Community Interest Company](../../bindings.md#dt-vendor-lowrisc)

Note

An implementation of a driver matching this compatible is available in
[drivers/serial/uart\_opentitan.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_opentitan.c).
...
may apply to the “lowrisc,opentitan-uart” compatible.
