---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/ambiq,uart.html
...
[drivers/serial/uart\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_ambiq.c).
...
| `clk-src` | `int` | ```text Set the UART clock source, apollo510 only 0x0 - HFRC 0x1 - SYSPLL ``` |
