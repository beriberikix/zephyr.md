---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/bflb,uart.html
original_path: build/dts/api/bindings/serial/bflb,uart.html
---

# bflb,uart

Vendor: [Bouffalo Lab (Nanjing) Co., Ltd.](../../bindings.md#dt-vendor-bflb)

Note

An implementation of a driver matching this compatible is available in
[drivers/serial/uart\_bflb.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_bflb.c).
...
may apply to the “bflb,uart” compatible.
