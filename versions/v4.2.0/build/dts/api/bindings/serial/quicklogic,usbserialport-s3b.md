---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/quicklogic,usbserialport-s3b.html
original_path: build/dts/api/bindings/serial/quicklogic,usbserialport-s3b.html
---
...
[drivers/serial/uart\_ql\_usbserialport\_s3b.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_ql_usbserialport_s3b.c).
...
```text
QuickLogic USBserialport_S3B serial interface
```
...
may apply to the “quicklogic,usbserialport-s3b” compatible.
