---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,ra-sci-uart.html
original_path: build/dts/api/bindings/serial/renesas,ra-sci-uart.html
---
...
[drivers/serial/uart\_renesas\_ra\_sci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_ra_sci.c).
...
```text
Renesas RA SCI UART controller
```
...
may apply to the “renesas,ra-sci-uart” compatible.
