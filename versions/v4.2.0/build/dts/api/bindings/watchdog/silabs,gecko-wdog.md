---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/watchdog/silabs,gecko-wdog.html
...
```text
Silicon Labs Series 1-2 WDOG (Watchdog)

Watchdog timer for Silicon Labs Series 1-2 SoCs.
```
