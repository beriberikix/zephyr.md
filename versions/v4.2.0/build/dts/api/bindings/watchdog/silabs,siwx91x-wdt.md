---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/watchdog/silabs,siwx91x-wdt.html
original_path: build/dts/api/bindings/watchdog/silabs,siwx91x-wdt.html
---
...
[drivers/watchdog/wdt\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/watchdog/wdt_silabs_siwx91x.c).

## Description

```text
Silabs SiWx91x Watchdog
```
...
may apply to the “silabs,siwx91x-wdt” compatible.
