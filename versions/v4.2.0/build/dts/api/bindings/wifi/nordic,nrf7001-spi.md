---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/wifi/nordic,nrf7001-spi.html
original_path: build/dts/api/bindings/wifi/nordic,nrf7001-spi.html
---

# nordic,nrf7001-spi (on spi bus)
...
```text
nRF7002 Wi-Fi chip with SPI interface.
```
...
| `iovdd-power-up-delay-ms` | `int` | ```text Duration to wait after enabling IOVDD before attempting communications. Default value of 1 comes from the nRF7002 DK/EK switch (TCK106AG): ~600us ```  Default value: `1` |
...
may apply to the “nordic,nrf7001-spi” compatible.
