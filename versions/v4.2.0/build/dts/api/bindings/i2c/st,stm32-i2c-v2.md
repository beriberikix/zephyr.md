---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/st,stm32-i2c-v2.html
...
| `dmas` | `phandle-array` | ```text Optional DMA channels used by the I2C peripheral. If specified, these channels can be used to handle RX and TX transactions over DMA. ``` |
| `dma-names` | `string-array` | ```text Names of the optional DMA channels. Expected values are "tx" for the TX channel and "rx" for the RX channel. ``` |
