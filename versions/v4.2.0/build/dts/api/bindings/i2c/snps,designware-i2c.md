---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/snps,designware-i2c.html
...
| Name | Type | Details |
| --- | --- | --- |
| `lcnt-offset` | `int` | ```text A fixed offset to apply to the SCL lcnt setting. ``` |
| `hcnt-offset` | `int` | ```text A fixed offset to apply to the SCL hcnt setting. ``` |
| `sda-timeout-value` | `int` | ```text Describe the SDA stuck at low timeout value, unit in ms ```  Default value: `30` |
| `scl-timeout-value` | `int` | ```text Describe the SCL stuck at low timeout value, unit in ms ```  Default value: `30` |
