---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/renesas,rx-i2c.html
original_path: build/dts/api/bindings/i2c/renesas,rx-i2c.html
---
...
[drivers/i2c/i2c\_renesas\_rx\_riic.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_renesas_rx_riic.c).
...
```text
Renesas RX I2C Master controller
```
...
may apply to the “renesas,rx-i2c” compatible.
