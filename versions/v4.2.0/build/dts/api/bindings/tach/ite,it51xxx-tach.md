---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/tach/ite,it51xxx-tach.html
original_path: build/dts/api/bindings/tach/ite,it51xxx-tach.html
---
...
[drivers/sensor/ite/ite\_tach\_it51xxx/tach\_ite\_it51xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ite/ite_tach_it51xxx/tach_ite_it51xxx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `input-pin` | `int` | ```text 0 = TACH_INPUT_PIN_A, 1 = TACH_INPUT_PIN_B ```  This property is **required**.  Legal values: `0`, `1` |
...
may apply to the “ite,it51xxx-tach” compatible.
