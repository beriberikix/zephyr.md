---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/tach/realtek,rts5912-tach.html
original_path: build/dts/api/bindings/tach/realtek,rts5912-tach.html
---
...
[drivers/sensor/realtek/rts5912/rts5912.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/realtek/rts5912/rts5912.c).
...
```text
Realtek rts5912 tachometer controller
```
...
may apply to the “realtek,rts5912-tach” compatible.
