---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/rtc/nxp,pcf2123.html
original_path: build/dts/api/bindings/rtc/nxp,pcf2123.html
---

# nxp,pcf2123 (on spi bus)
...
[drivers/rtc/rtc\_pcf2123.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/rtc/rtc_pcf2123.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clkout-frequency` | `int` | ```text Frequency of the CLKOUT signal in Hertz (Hz). Default is 32768 Hz. ```  Default value: `32768`  Legal values: `32768`, `16384`, `8192`, `4096`, `2048`, `1024`, `1` |
| `int1-gpios` | `phandle-array` | ```text GPIO connected to the PCF2123 INT output, interrupts are unused if none is provided. ``` |
...
may apply to the “nxp,pcf2123” compatible.
