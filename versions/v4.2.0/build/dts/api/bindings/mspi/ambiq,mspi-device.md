---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mspi/ambiq,mspi-device.html
...
| `ambiq,timing-config` | `array` | ```text Array of tuples to configure the timing parameters default = <   .ui8WriteLatency   = 0,   .ui8TurnAround     = 0,   .bTxNeg            = false,   .bRxNeg            = false,   .bRxCap            = false,   .ui32TxDQSDelay    = 0,   .ui32RxDQSDelay    = 0, > ```  Default value: `[0, 0, 0, 0, 0, 0, 0]` |
