---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mspi/ambiq,mspi-controller.html
...
| `ambiq,rbx` | `boolean` | ```text Define the Ambiq MSPI controller read boundary crossing feature enable. ``` |
| `ambiq,wbx` | `boolean` | ```text Define the Ambiq MSPI controller write boundary crossing feature enable. ``` |
| `ambiq,apmemory` | `boolean` | ```text Define the Ambiq MSPI controller APMemory specific support enable. ``` |
| `ambiq,hyperbus` | `boolean` | ```text Define the Ambiq MSPI controller HyperBus specific support enable. ``` |
| `ambiq,clkond4` | `boolean` | ```text Define the Ambiq MSPI controller clock on D4 feature enable. ``` |
