---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/dma/intel,adsp-gpdma.html
...
```text
Intel ADSP Designware based General Purpose DMA Controller
```
