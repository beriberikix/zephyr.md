---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/dma/silabs,ldma.html
original_path: build/dts/api/bindings/dma/silabs,ldma.html
---
...
[drivers/dma/dma\_silabs\_ldma.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_silabs_ldma.c).
...
```text
Silicon Labs Series 2 LDMA (Linked Direct Memory Access)
...
may apply to the “silabs,ldma” compatible.
