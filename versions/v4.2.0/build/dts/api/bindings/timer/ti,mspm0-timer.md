---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/ti,mspm0-timer.html
original_path: build/dts/api/bindings/timer/ti,mspm0-timer.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `ti,clk-prescaler` | `int` | ```text TIMCLK clock source prescaler value. Valid range [0 ... 255]. ```  This property is **required**. |
| `ti,clk-div` | `int` | ```text Clock divider selction value. ```  This property is **required**.  Default value: `1`  Legal values: `1`, `2`, `3`, `4`, `5`, `6`, `7`, `8` |
...
may apply to the “ti,mspm0-timer” compatible.
