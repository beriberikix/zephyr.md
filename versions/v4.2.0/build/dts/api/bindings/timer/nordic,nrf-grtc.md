---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/nordic,nrf-grtc.html
...
| Name | Type | Details |
| --- | --- | --- |
| `clkout-fast-frequency-hz` | `int` | ```text Fast output clock frequency. ``` |
| `clkout-32k` | `boolean` | ```text 32768 Hz output clock frequency enable. ``` |
| `cc-num` | `int` | ```text Number of capture/compare channels ```  This property is **required**. |
| `clock-frequency` | `int` | ```text Clock frequency information for tick increment operations, this default value comes from the nRF54L15 datasheet. ```  Default value: `1000000` |
