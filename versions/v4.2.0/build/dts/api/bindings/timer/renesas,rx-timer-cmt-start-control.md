---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/renesas,rx-timer-cmt-start-control.html
original_path: build/dts/api/bindings/timer/renesas,rx-timer-cmt-start-control.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Clock frequency information for Timer operation This value need to be set at PCLKB/8 ```  This property is **required**. |
...
may apply to the “renesas,rx-timer-cmt-start-control” compatible.
