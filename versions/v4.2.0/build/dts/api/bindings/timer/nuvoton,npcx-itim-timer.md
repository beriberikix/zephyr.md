---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/nuvoton,npcx-itim-timer.html
...
```text
Nuvoton NPCX Internal Timer (ITIM)
```
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text The frequency in Hz for this timer's clock source. This value is used to set SYS_CLOCK_HW_CYCLES_PER_SEC. ```  This property is **required**. |
