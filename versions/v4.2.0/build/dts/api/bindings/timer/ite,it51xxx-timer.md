---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/ite,it51xxx-timer.html
original_path: build/dts/api/bindings/timer/ite,it51xxx-timer.html
---
...
[drivers/timer/ite\_it51xxx\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/ite_it51xxx_timer.c).

## Description

```text
ITE it51xxx external timer
```
...
may apply to the “ite,it51xxx-timer” compatible.
