---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/silabs,gecko-burtc.html
...
```text
Silicon Labs Series 2 BURTC (Backup Real Time Counter)
