---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/cpu/openhwgroup,cva6.html
original_path: build/dts/api/bindings/cpu/openhwgroup,cva6.html
---

# openhwgroup,cva6

Vendor: [OpenHW Group](../../bindings.md#dt-vendor-openhwgroup)

## Description

```text
OpenHW Group CVA6 CPU
```
...
| Name | Type | Details |
| --- | --- | --- |
| `timebase-frequency` | `int` | ```text Clock speed at which the core-local machine timer operates. ```  This property is **required**. |
...
may apply to the “openhwgroup,cva6” compatible.
