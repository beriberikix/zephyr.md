---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/cpu/renesas,rx.html
original_path: build/dts/api/bindings/cpu/renesas,rx.html
---
...
may apply to the “renesas,rx” compatible.
