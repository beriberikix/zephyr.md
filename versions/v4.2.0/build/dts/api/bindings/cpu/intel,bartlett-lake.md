---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/cpu/intel,bartlett-lake.html
original_path: build/dts/api/bindings/cpu/intel,bartlett-lake.html
---
...
may apply to the “intel,bartlett-lake” compatible.
