---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/cpu/arm,cortex-r8.html
original_path: build/dts/api/bindings/cpu/arm,cortex-r8.html
---
...
may apply to the “arm,cortex-r8” compatible.
