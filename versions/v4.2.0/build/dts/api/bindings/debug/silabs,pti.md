---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/debug/silabs,pti.html
original_path: build/dts/api/bindings/debug/silabs,pti.html
---
...
[drivers/debug/debug\_silabs\_pti.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/debug/debug_silabs_pti.c).

## Description

```text
Silicon Labs Packet Trace Interface
```
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Clock frequency for PTI signal in Hz. ``` |
| `mode` | `string` | ```text Packet Trace mode. ```  Legal values: `'disabled'`, `'spi'`, `'uart'`, `'uart-onewire'` |
...
may apply to the “silabs,pti” compatible.
