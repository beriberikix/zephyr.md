---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/misc/renesas,rx-sci.html
original_path: build/dts/api/bindings/misc/renesas,rx-sci.html
---
...
may apply to the “renesas,rx-sci” compatible.
