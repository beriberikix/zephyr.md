---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/microchip,mcp23008.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23008.html
---

# microchip,mcp23008 (on i2c bus)
...
```text
Microchip MCP23008 I2C GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23008”
...
may apply to the “microchip,mcp23008” compatible.
