---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/microchip,mcp23s17.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23s17.html
---

# microchip,mcp23s17 (on spi bus)
...
```text
Microchip MCP23S17 SPI GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23s17”
...
may apply to the “microchip,mcp23s17” compatible.
