---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/silabs,gecko-gpio-port.html
original_path: build/dts/api/bindings/gpio/silabs,gecko-gpio-port.html
---
...
[drivers/gpio/gpio\_gecko.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_gecko.c).

## Description

```text
Silicon Labs Series 0-2 GPIO (General Purpose Input/Output) Port
...
These property descriptions apply to “silabs,gecko-gpio-port”
...
may apply to the “silabs,gecko-gpio-port” compatible.
