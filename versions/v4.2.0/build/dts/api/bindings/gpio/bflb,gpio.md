---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/bflb,gpio.html
original_path: build/dts/api/bindings/gpio/bflb,gpio.html
---
...
These property descriptions apply to “bflb,gpio”
...
| `#bflb,pin-cells` | `int` | ```text Number of items to expect in a bflb,pins specifier ```  This property is **required**.  Constant value: `2` |
...
may apply to the “bflb,gpio” compatible.
