---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/arduino-nano-header.html
original_path: build/dts/api/bindings/gpio/arduino-nano-header.html
---
...
may apply to the “arduino-nano-header” compatible.
