---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/microchip,mcp23017.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23017.html
---

# microchip,mcp23017 (on i2c bus)
...
```text
Microchip MCP23017 I2C GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23017”
...
may apply to the “microchip,mcp23017” compatible.
