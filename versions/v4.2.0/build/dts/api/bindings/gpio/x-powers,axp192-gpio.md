---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/x-powers,axp192-gpio.html
original_path: build/dts/api/bindings/gpio/x-powers,axp192-gpio.html
---

# x-powers,axp192-gpio (on axp192 bus)
...
[drivers/gpio/gpio\_axp192.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_axp192.c).

## Description

```text
AXP192 GPIO Controller
AX192 features 5 native GPIOs. In addition the EXTEN pin can be configured to be used as an IO as well.
Pin-Mapping is as follows [0] GPIO0 [1] GPIO1 [2] GPIO2 [3] GPIO3 [4] GPIO4 [5] EXTEN
```
...
These property descriptions apply to “x-powers,axp192-gpio”
...
| `ngpios` | `int` | ```text Number of GPIOs available on axp192. ```  This property is **required**.  Default value: `32`  Constant value: `6` |
...
may apply to the “x-powers,axp192-gpio” compatible.
