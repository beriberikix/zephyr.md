---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/nxp,lcd-pmod.html
original_path: build/dts/api/bindings/gpio/nxp,lcd-pmod.html
---
...
may apply to the “nxp,lcd-pmod” compatible.
