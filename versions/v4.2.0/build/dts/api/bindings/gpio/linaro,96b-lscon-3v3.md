---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/linaro,96b-lscon-3v3.html
...
```text
GPIO Pin exposed on the 96Boards 3.3v low-speed header
```
