---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/infineon,cat1-gpio.html
original_path: build/dts/api/bindings/gpio/infineon,cat1-gpio.html
---
...
[drivers/gpio/gpio\_ifx\_cat1.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ifx_cat1.c).

## Description

```text
Infineon CAT1 GPIO Port
```
...
These property descriptions apply to “infineon,cat1-gpio”
...
may apply to the “infineon,cat1-gpio” compatible.
