---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/silabs,gecko-gpio.html
...
```text
Silicon Labs Series 0-2 GPIO (General Purpose Input/Output) Peripheral
