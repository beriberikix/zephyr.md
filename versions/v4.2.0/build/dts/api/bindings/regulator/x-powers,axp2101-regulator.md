---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/regulator/x-powers,axp2101-regulator.html
original_path: build/dts/api/bindings/regulator/x-powers,axp2101-regulator.html
---

# x-powers,axp2101-regulator (on axp2101 bus)
...
These property descriptions apply to “x-powers,axp2101-regulator”
...
may apply to the “x-powers,axp2101-regulator” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `regulator-initial-mode` | `int` | ```text Initial operating mode. AXP2101 supports 2 different power modes: AXP2101_DCDC_MODE_AUTO: Auto (0, default) AXP2101_DCDC_MODE_PWM:  PWM ```  Legal values: `0`, `1` |
