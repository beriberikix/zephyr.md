---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mdio/espressif,esp32-mdio.html
original_path: build/dts/api/bindings/mdio/espressif,esp32-mdio.html
---
...
[drivers/mdio/mdio\_esp32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_esp32.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `ref-clk-output-gpios` | `phandle-array` | ```text GPIO to output RMII Clock. ``` |
...
may apply to the “espressif,esp32-mdio” compatible.
