---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/usb/zephyr,hid-device.html
...
| Name | Type | Details |
| --- | --- | --- |
| `label` | `string` | ```text The string defined by the label property is also used for the USB device interface string descriptor. ```  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
