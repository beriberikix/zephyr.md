---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sdhc/xlnx,sdhc.html
original_path: build/dts/api/bindings/sdhc/xlnx,sdhc.html
---
...
[drivers/sdhc/xlnx\_sdhc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sdhc/xlnx_sdhc.c).
...
```text
Xilinx SD/EMMC host controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `broken-cd` | `boolean` | ```text There is no card detection available; polling must be used. ``` |
...
may apply to the “xlnx,versal-8.9a” compatible.
