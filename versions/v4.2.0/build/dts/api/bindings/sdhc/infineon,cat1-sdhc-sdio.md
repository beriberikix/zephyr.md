---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sdhc/infineon,cat1-sdhc-sdio.html
original_path: build/dts/api/bindings/sdhc/infineon,cat1-sdhc-sdio.html
---
...
[drivers/sdhc/ifx\_cat1\_sdio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sdhc/ifx_cat1_sdio.c).
...
```text
Infineon CAT1 SDHC/SDIO controller
```
...
may apply to the “infineon,cat1-sdhc-sdio” compatible.
