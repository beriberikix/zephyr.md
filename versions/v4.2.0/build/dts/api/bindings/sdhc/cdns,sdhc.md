---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sdhc/cdns,sdhc.html
...
| `power-delay-ms` | `int` | ```text delay required to switch on the SDHC ```  This property is **required**.  Default value: `500` |
