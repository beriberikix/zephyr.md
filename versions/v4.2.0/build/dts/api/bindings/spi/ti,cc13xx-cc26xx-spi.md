---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/spi/ti,cc13xx-cc26xx-spi.html
original_path: build/dts/api/bindings/spi/ti,cc13xx-cc26xx-spi.html
---
...
[drivers/spi/spi\_cc13xx\_cc26xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_cc13xx_cc26xx.c).
...
```text
TI SimpleLink CC13xx / CC26xx SPI controller
```
