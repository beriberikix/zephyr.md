---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/spi/microchip,xec-qmspi.html
...
| Name | Type | Details |
| --- | --- | --- |
| `port-sel` | `int` | ```text SPI Port 0 or 1. ```  This property is **required**. |
...
| `chip-select` | `int` | ```text Use QMSPI CS0# or CS1# ```  This property is **required**. |
