---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/display/solomon,ssd1306fb-spi.html
original_path: build/dts/api/bindings/display/solomon,ssd1306fb-spi.html
---

# solomon,ssd1306fb (on spi bus)
...
```text
Solomon SSD1306 display controller on SPI bus
...
may apply to the “solomon,ssd1306fb” compatible.
