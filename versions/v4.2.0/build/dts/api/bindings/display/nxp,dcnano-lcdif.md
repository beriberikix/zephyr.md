---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/display/nxp,dcnano-lcdif.html
...
| `version` | `string` | ```text The version of the ip ```  Legal values: `'DCnano'`, `'DC8000'` |
