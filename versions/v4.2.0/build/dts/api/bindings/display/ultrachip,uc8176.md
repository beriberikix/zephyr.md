---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/display/ultrachip,uc8176.html
original_path: build/dts/api/bindings/display/ultrachip,uc8176.html
---

# ultrachip,uc8176 (on mipi-dbi bus)
...
```text
Ultrachip UC81xx EPD display controller common properties
