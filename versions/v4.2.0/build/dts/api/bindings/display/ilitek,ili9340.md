---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/display/ilitek,ili9340.html
original_path: build/dts/api/bindings/display/ilitek,ili9340.html
---

# ilitek,ili9340 (on mipi-dbi bus)
...
```text
Ilitek ILI9340 320x240 display controller
...
| `disctrl` | `uint8-array` | ```text Display function control (DISCTRL) register value. Note that changing default SS bit value (0) may interfere with display rotation. ```  Default value: `[10, 130, 39]` |
| `pwctrl1` | `uint8-array` | ```text Power control 1 (PWCTRL1) register values. ```  Default value: `[38, 0]` |
...
may apply to the “ilitek,ili9340” compatible.
