---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/microchip,lan9250.html
original_path: build/dts/api/bindings/ethernet/microchip,lan9250.html
---

# microchip,lan9250 (on spi bus)
...
[drivers/ethernet/eth\_lan9250.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_lan9250.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text The interrupt pin of LAN9250 is active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
...
may apply to the “microchip,lan9250” compatible.
