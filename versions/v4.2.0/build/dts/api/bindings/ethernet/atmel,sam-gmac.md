---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/atmel,sam-gmac.html
original_path: build/dts/api/bindings/ethernet/atmel,sam-gmac.html
---
...
[drivers/ethernet/eth\_sam\_gmac.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_sam_gmac.c).
...
| `phy-connection-type` | `string` | ```text Specifies the interface connection type between ethernet MAC and PHY. ```  Default value: `rmii`  Legal values: `'mii'`, `'rmii'`, `'gmii'`, `'rgmii'`, `'internal'` |
...
may apply to the “atmel,sam-gmac” compatible.
