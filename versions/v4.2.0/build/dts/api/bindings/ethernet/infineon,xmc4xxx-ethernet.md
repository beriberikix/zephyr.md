---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/infineon,xmc4xxx-ethernet.html
...
| `rxd3-port-ctrl` | `string` | ```text Receive bit 3 (rxd3) signal GPIO connection. Only used for MII interface. ```  Legal values: `'P5_9'`, `'P6_3'` |
