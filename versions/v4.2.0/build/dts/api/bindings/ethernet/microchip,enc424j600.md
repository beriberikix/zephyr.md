---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/microchip,enc424j600.html
original_path: build/dts/api/bindings/ethernet/microchip,enc424j600.html
---

# microchip,enc424j600 (on spi bus)
...
[drivers/ethernet/eth\_enc424j600.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_enc424j600.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin. The interrupt pin of ENC424J600 is active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
...
may apply to the “microchip,enc424j600” compatible.
