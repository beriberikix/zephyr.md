---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/nxp,imx-netc-psi.html
original_path: build/dts/api/bindings/ethernet/nxp,imx-netc-psi.html
---
...
[drivers/ethernet/nxp\_imx\_netc/eth\_nxp\_imx\_netc\_psi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/nxp_imx_netc/eth_nxp_imx_netc_psi.c).

## Description

```text
NXP i.MX NETC Physical Station Interface (PSI)
```
...
| Name | Type | Details |
| --- | --- | --- |
| `mac-index` | `int` | ```text The MAC index of this PSI. ```  This property is **required**. |
| `si-index` | `int` | ```text The SI index of this PSI. ```  This property is **required**. |
...
may apply to the “nxp,imx-netc-psi” compatible.
