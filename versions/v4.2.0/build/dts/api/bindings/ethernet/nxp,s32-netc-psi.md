---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/nxp,s32-netc-psi.html
...
[drivers/ethernet/eth\_nxp\_s32\_netc\_psi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_nxp_s32_netc_psi.c).
...
may apply to the “nxp,s32-netc-psi” compatible.
...
| `mboxes` | `phandle-array` | ```text Mailbox / IPM channel specifiers relevant to the device. ```  This property is **required**. |
| `mbox-names` | `string-array` | ```text Optional names given to the mbox specifiers in the "mboxes" property. ```  This property is **required**. |
