---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/ethernet/wiznet,w5500.html
original_path: build/dts/api/bindings/ethernet/wiznet,w5500.html
---

# wiznet,w5500 (on spi bus)

Vendor: [WIZnet Co., Ltd.](../../bindings.md#dt-vendor-wiznet)

Note

An implementation of a driver matching this compatible is available in
[drivers/ethernet/eth\_w5500.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_w5500.c).

## Description

```text
W5500 standalone 10/100BASE-T Ethernet controller with SPI interface
```
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Interrupt pin. The interrupt pin of W5500 is active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
| `reset-gpios` | `phandle-array` | ```text Reset pin. The reset pin of W5500 is active low. If connected directly the MCU pin should be configured as active low. ``` |
...
may apply to the “wiznet,w5500” compatible.
