---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/video/st,stm32-dcmipp.html
original_path: build/dts/api/bindings/video/st,stm32-dcmipp.html
---
...
[drivers/video/video\_stm32\_dcmipp.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/video/video_stm32_dcmipp.c).
...
These property descriptions apply to “st,stm32-dcmipp”
...
may apply to the “st,stm32-dcmipp” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `bus-type` | `int` | ```text Data bus type. ```  This property is **required**.  Legal values: `1`, `2`, `3`, `4`, `5`, `6` |
