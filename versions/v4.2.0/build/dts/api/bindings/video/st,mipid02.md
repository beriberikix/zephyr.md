---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/video/st,mipid02.html
original_path: build/dts/api/bindings/video/st,mipid02.html
---

# st,mipid02 (on i2c bus)
...
[drivers/video/video\_st\_mipid02.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/video/video_st_mipid02.c).

## Description

```text
MIPID02 CSI to DVP interface bridge
```
...
These property descriptions apply to “st,mipid02”
...
may apply to the “st,mipid02” compatible.
