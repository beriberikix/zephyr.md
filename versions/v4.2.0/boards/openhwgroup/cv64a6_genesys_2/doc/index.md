...
| --- | --- | --- | --- |
| CPU | on-chip | OpenHW Group CVA6 CPU[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/openhwgroup/cv64a6.dtsi?plain=1#L19) | [`openhwgroup,cva6`](../../../../build/dts/api/bindings/cpu/openhwgroup%2Ccva6.md#std-dtcompatible-openhwgroup-cva6) |
...
| on-chip | RISC-V CPU interrupt controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/riscv/openhwgroup/cv64a6.dtsi?plain=1#L30) | [`riscv,cpu-intc`](../../../../build/dts/api/bindings/interrupt-controller/riscv%2Ccpu-intc.md#std-dtcompatible-riscv-cpu-intc) |
