---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/arduino/nano_33_iot/doc/index.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/arduino/nano_33_iot/doc/index.rst/../..)
...
| ARM architecture | on-chip | Atmel SAM0 multi-protocol (UART, SPI, I2C) SERCOM unit[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L120) | [`atmel,sam0-sercom`](../../../../build/dts/api/bindings/arm/atmel,sam0-sercom.md#std-dtcompatible-atmel-sam0-sercom) |
...
| on-board | GPIO pins exposed on Arduino Nano headers[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arduino/nano_33_iot/arduino_nano_connector.dtsi?plain=1#L9) | [`arduino-nano-header`](../../../../build/dts/api/bindings/gpio/arduino-nano-header.md#std-dtcompatible-arduino-nano-header) |
| I2C | on-chip | Atmel SAM0 series SERCOM I2C[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L144) | [`atmel,sam0-i2c`](../../../../build/dts/api/bindings/i2c/atmel,sam0-i2c.md#std-dtcompatible-atmel-sam0-i2c) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arduino/nano_33_iot/arduino_nano_33_iot.dts?plain=1#L25) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
| on-board | Group of PWM-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arduino/nano_33_iot/arduino_nano_33_iot.dts?plain=1#L33) | [`pwm-leds`](../../../../build/dts/api/bindings/led/pwm-leds.md#std-dtcompatible-pwm-leds) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arduino/nano_33_iot/arduino_nano_33_iot.dts?plain=1#L152) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
...
| PWM | on-chip | Atmel SAM0 TCC in PWM mode[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd21.dtsi?plain=1#L77) | [`atmel,sam0-tcc-pwm`](../../../../build/dts/api/bindings/pwm/atmel,sam0-tcc-pwm.md#std-dtcompatible-atmel-sam0-tcc-pwm) |
...
| Serial controller | on-chip | Atmel SAM0 SERCOM UART driver[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L138) | [`atmel,sam0-uart`](../../../../build/dts/api/bindings/serial/atmel,sam0-uart.md#std-dtcompatible-atmel-sam0-uart) |
| SPI | on-chip | Atmel SAM0 SERCOM SPI controller[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samd2x.dtsi?plain=1#L126) | [`atmel,sam0-spi`](../../../../build/dts/api/bindings/spi/atmel,sam0-spi.md#std-dtcompatible-atmel-sam0-spi) |
...
| Wi-Fi | on-board | ESP8266/ESP32 WiFi modem (AT Commands)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arduino/nano_33_iot/arduino_nano_33_iot.dts?plain=1#L103) | [`espressif,esp-at`](../../../../build/dts/api/bindings/wifi/espressif,esp-at.md#std-dtcompatible-espressif-esp-at) |
...
The `arduino_nano_33_iot` board supports the runners and associated west commands listed below.
