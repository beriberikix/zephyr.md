---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/others/stm32_min_dev/doc/index.html
...
[![../../../../_images/stm32_min_dev.jpg](https://docs.zephyrproject.org/4.2.0/_images/stm32_min_dev.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/stm32_min_dev.jpg)
...
![Pinout for STM32 Minimum Development Blue Pill Board](https://docs.zephyrproject.org/4.2.0/_images/stm32_min_dev_pinout_blue.jpg)
...
#### `stm32_min_dev@black/stm32f103xb` target
...
#### `stm32_min_dev@blue/stm32f103xb` target
...
The `stm32_min_dev` board supports the runners and associated west commands listed below.
