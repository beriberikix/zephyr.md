---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/adafruit/feather_m0_basic_proto/doc/index.html
...
The `adafruit_feather_m0_basic_proto` board supports the runners and associated west commands listed below.
