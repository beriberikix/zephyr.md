---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/adafruit/feather_esp32s2/doc/adafruit_feather_esp32s2_tft_reverse.html
original_path: boards/adafruit/feather_esp32s2/doc/adafruit_feather_esp32s2_tft_reverse.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/adafruit/feather_esp32s2/doc/adafruit_feather_esp32s2_tft_reverse.rst/../..)
...
The `adafruit_feather_esp32s2_tft_reverse` board supports the hardware features listed below.
...
#### `adafruit_feather_esp32s2_tft_reverse/esp32s2` target
...
| Display | on-board | Sitronix ST7789V display controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adafruit/feather_esp32s2/adafruit_feather_esp32s2_tft_reverse.dts?plain=1#L69) | [`sitronix,st7789v`](../../../../build/dts/api/bindings/display/sitronix,st7789v.md#std-dtcompatible-sitronix-st7789v) |
...
| Fuel gauge | on-board | Maxim MAX17048 Fuel Gauge with ModelGauge[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adafruit/feather_esp32s2/adafruit_feather_esp32s2_tft_reverse.dts?plain=1#L118) | [`maxim,max17048`](../../../../build/dts/api/bindings/fuel-gauge/maxim,max17048.md#std-dtcompatible-maxim-max17048) |
...
The [Adafruit ESP32-S2 Reverse TFT Feather](https://www.adafruit.com/product/5345) [[1]](#id2) User Guide has detailed information about the board
including pinouts and the schematic.

- [Adafruit ESP32-S2 Reverse TFT Feather Pinouts](https://learn.adafruit.com/esp32-s2-reverse-tft-feather/pinouts) [[4]](#id8)
- [Adafruit ESP32-S2 Reverse TFT Feather Schematic](https://learn.adafruit.com/esp32-s2-reverse-tft-feather/downloads) [[5]](#id10)

## Programming and Debugging

The `adafruit_feather_esp32s2_tft_reverse` board supports the runners and associated west commands listed below.
...
```shell
west build -b adafruit_feather_esp32s2_tft_reverse --sysbuild samples/hello_world
```
...
west build -b adafruit_feather_esp32s2_tft_reverse samples/hello_world
```
...
```shell
# From the root of the zephyr repository
west build -b adafruit_feather_esp32s2_tft_reverse samples/basic/blinky
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b adafruit_feather_esp32s2_tft_reverse samples/drivers/led/led_strip
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b adafruit_feather_esp32s2_tft_reverse samples/subsys/display/lvgl
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b adafruit_feather_esp32s2_tft_reverse samples/drivers/fuel_gauge
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b adafruit_feather_esp32s2_tft_reverse samples/net/wifi/shell
west flash
```
...
[https://www.adafruit.com/product/5345](https://www.adafruit.com/product/5345)
...
[https://learn.adafruit.com/esp32-s2-reverse-tft-feather/pinouts](https://learn.adafruit.com/esp32-s2-reverse-tft-feather/pinouts)

[[5](#id11)]

[https://learn.adafruit.com/esp32-s2-reverse-tft-feather/downloads](https://learn.adafruit.com/esp32-s2-reverse-tft-feather/downloads)
