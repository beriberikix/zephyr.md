---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/google/quincy/doc/index.html
...
The `google_quincy` board supports the runners and associated west commands listed below.
