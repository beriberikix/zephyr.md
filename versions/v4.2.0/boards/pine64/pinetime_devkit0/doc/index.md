---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/pine64/pinetime_devkit0/doc/index.html
...
[![../../../../_images/pinetime_devkit0.jpg](https://docs.zephyrproject.org/4.2.0/_images/pinetime_devkit0.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/pinetime_devkit0.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/pine64/pinetime_devkit0/doc/index.rst/../..)
...
The [PineTime schematics](http://files.pine64.org/doc/PineTime/PineTime%20Schematic-V1.0a-20191103.pdf) [[1]](#id3) are available on the pine64 website. Below
...
The `pinetime_devkit0` board supports the runners and associated west commands listed below.
...
More infos to be found in the [Wiki Reprogramming the PineTime](https://wiki.pine64.org/index.php/Reprogramming_the_PineTime) [[2]](#id5) page.
...
![PineTime SWD location](https://docs.zephyrproject.org/4.2.0/_images/PineTime_SWD_location.jpg)
