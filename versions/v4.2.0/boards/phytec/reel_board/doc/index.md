---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/phytec/reel_board/doc/index.html
...
![reel board front](https://docs.zephyrproject.org/4.2.0/_images/reel_board.jpg)

reel board front (Credit: PHYTEC)

![reel board back](https://docs.zephyrproject.org/4.2.0/_images/reel_board_descr_back.jpg)
...
![reel board Jumper and Testpoints](https://docs.zephyrproject.org/4.2.0/_images/reel_board_tp.jpg)
...
![reel board Debug Adapter](https://docs.zephyrproject.org/4.2.0/_images/reel_board_debug.jpg)

reel board Debug Adapter overview (Credit: PHYTEC)

#### Debug Adapter Firmware

DAPLink firmware for the adapter can be found at [DAPLink reel board Firmware](https://github.com/phytec/DAPLink/tree/reel-board) [[4]](#id18) [[2]](#id13).
...
![reel board Expansion Connector](https://docs.zephyrproject.org/4.2.0/_images/reel_board_excon.jpg)
...
![reel board and link board BASE](https://docs.zephyrproject.org/4.2.0/_images/rb_lb_shield.jpg)
...
![link board BASE](https://docs.zephyrproject.org/4.2.0/_images/link_board_base.jpg)
...
[https://github.com/phytec/DAPLink/tree/reel-board](https://github.com/phytec/DAPLink/tree/reel-board)
