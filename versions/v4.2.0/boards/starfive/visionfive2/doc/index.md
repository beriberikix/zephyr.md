---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/starfive/visionfive2/doc/index.html
original_path: boards/starfive/visionfive2/doc/index.html
---
...
[![../../../../_images/visionfive2.webp](https://docs.zephyrproject.org/4.2.0/_images/visionfive2.webp)
](https://docs.zephyrproject.org/4.2.0/_images/visionfive2.webp)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/starfive/visionfive2/doc/index.rst/../..)
...
The `visionfive2` board supports the runners and associated west commands listed below.
...
as usual (see [Building an Application](../../../../develop/application/index.md#build-an-application)) using the corresponding board name:

```shell
west build -b visionfive2
```

[spl\_tool](https://github.com/starfive-tech/Tools/tree/master/spl_tool/)
...
git clone the vf2-loader tool from [https://github.com/orangecms/vf2-loader.git](https://github.com/orangecms/vf2-loader.git) and
xmodem tool from [https://github.com/orangecms/xmodem.rs.git](https://github.com/orangecms/xmodem.rs.git) side by side.

VisionFive2 uses uart for flashing. Refer to
[VisionFive2 Recovery Quick Start Guide](https://doc-en.rvspace.org/VisionFive2/Quick_Start_Guide/VisionFive2_SDK_QSG/recovering_bootloader%20-%20vf2.html)
