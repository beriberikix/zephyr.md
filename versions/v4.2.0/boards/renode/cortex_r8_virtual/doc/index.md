---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/renode/cortex_r8_virtual/doc/index.html
...
The `cortex_r8_virtual` board supports the runners and associated west commands listed below.
