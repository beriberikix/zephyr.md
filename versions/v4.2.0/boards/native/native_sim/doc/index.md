---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/native/native_sim/doc/index.html
original_path: boards/native/native_sim/doc/index.html
---
...
:   Two optional native UART drivers are available:
    ...
    **PTY driver (UART\_NATIVE\_PTY)**
    :   With this driver, Zephyr UART devices can be created. These
        ...
        pseudo-tty. For more information refer to the section [PTY UART](#pty-uart).
...
:   This driver is an alternative to the [TAP based ethernet driver](#nsim-per-ethe). Instead of using a virtual network in the Linux side, this
...
:   A display driver is provided that creates a window on the host machine to
    ...
    the [SDL2](https://www.libsdl.org) development library on the host machine. For
    [64bit native\_sim](#native-sim32-64) builds you need to have the 64bit version installed.
...
:   The flash simulator can also be used in the native targets. In this you have the option to keep
    ...
    [Host (FUSE) filesystem access](#host-fuse-filesystem-access) section.
...
[`CONFIG_SERIAL`](../../../../kconfig.md#CONFIG_SERIAL "CONFIG_SERIAL") is set.
By default one ready UART of this type is setup in DTS, but any number can be enabled as desired.

Normally these UARTs are connected to new pseudoterminals PTYs, i.e. `/dev/pts<nbr>`,
...
[`CONFIG_UART_NATIVE_PTY_0_ON_STDINOUT`](../../../../kconfig.md#CONFIG_UART_NATIVE_PTY_0_ON_STDINOUT "CONFIG_UART_NATIVE_PTY_0_ON_STDINOUT") instead of the default
[`CONFIG_UART_NATIVE_PTY_0_ON_OWN_PTY`](../../../../kconfig.md#CONFIG_UART_NATIVE_PTY_0_ON_OWN_PTY "CONFIG_UART_NATIVE_PTY_0_ON_OWN_PTY").
For interactive use with the [Shell](../../../../services/shell/index.md#shell-api), it is recommended to choose the PTY option.
...
:   A console backend which by default is configured to
    redirect any [`printk()`](../../../../doxygen/html/printk_8h.md#a768a7dff8592b69f327a08f96b00fa54) write to the native host application’s
    `stdout`.
...
## [Host (FUSE) filesystem access](#id12)

When building Zephyr with a filesystem, the device partitions can be exposed through the host file
system by enabling [`CONFIG_FUSE_FS_ACCESS`](../../../../kconfig.md#CONFIG_FUSE_FS_ACCESS "CONFIG_FUSE_FS_ACCESS"). This option enables a FUSE
...
| Bluetooth | [Userchan](#nsim-bt-host-cont) | [`CONFIG_BT_USERCHAN`](../../../../kconfig.md#CONFIG_BT_USERCHAN "CONFIG_BT_USERCHAN") | Host and pico libC |
...
| Entropy | [Native simulator entropy](#nsim-per-entr) | [`CONFIG_FAKE_ENTROPY_NATIVE_SIM`](../../../../kconfig.md#CONFIG_FAKE_ENTROPY_NATIVE_SIM "CONFIG_FAKE_ENTROPY_NATIVE_SIM") | All |
| EEPROM | EEPROM simulator | [`CONFIG_EEPROM_SIMULATOR`](../../../../kconfig.md#CONFIG_EEPROM_SIMULATOR "CONFIG_EEPROM_SIMULATOR") | All |
| EEPROM | EEPROM emulator | [`CONFIG_EEPROM_EMULATOR`](../../../../kconfig.md#CONFIG_EEPROM_EMULATOR "CONFIG_EEPROM_EMULATOR") | All |
| Ethernet | [Eth native\_tap](#nsim-per-ethe) | [`CONFIG_ETH_NATIVE_TAP`](../../../../kconfig.md#CONFIG_ETH_NATIVE_TAP "CONFIG_ETH_NATIVE_TAP") | All |
...
| FUSE | [Host based filesystem access](#native-fuse-flash) | [`CONFIG_FUSE_FS_ACCESS`](../../../../kconfig.md#CONFIG_FUSE_FS_ACCESS "CONFIG_FUSE_FS_ACCESS") | All |
...
| Offloaded sockets | [Offloaded sockets driver](#nsim-per-offloaded-sockets) | [`CONFIG_NET_NATIVE_OFFLOADED_SOCKETS`](../../../../kconfig.md#CONFIG_NET_NATIVE_OFFLOADED_SOCKETS "CONFIG_NET_NATIVE_OFFLOADED_SOCKETS") | All |
| RTC | RTC emul | [`CONFIG_RTC_EMUL`](../../../../kconfig.md#CONFIG_RTC_EMUL "CONFIG_RTC_EMUL") | All |
| Serial | [UART native PTY](#native-ptty-uart) | [`CONFIG_UART_NATIVE_PTY`](../../../../kconfig.md#CONFIG_UART_NATIVE_PTY "CONFIG_UART_NATIVE_PTY") | All |
...
| System tick | Native\_sim timer | [`CONFIG_NATIVE_SIM_TIMER`](../../../../kconfig.md#CONFIG_NATIVE_SIM_TIMER "CONFIG_NATIVE_SIM_TIMER") | All |
