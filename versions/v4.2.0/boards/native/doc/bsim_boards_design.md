---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/native/doc/bsim_boards_design.html
...
### [Different types of tests and how the bsim boards relate to them](#id6)
...
### [Relationship between Zephyr, the native simulator, the nRF HW models and BabbleSim](#id8)

As shown in the figure below, when you build your embedded application targeting one of Zephyr’s
nrf\_bsim targets, you are using the [native simulator](https://github.com/BabbleSim/native_simulator/blob/main/docs/README.md), which is being built together with and
...
![nrf_bsim boards and the native simulator](https://docs.zephyrproject.org/4.2.0/_images/components_bsim.svg)

Relationship between Zephyr, the native simulator, the nRF HW models and BabbleSim.

When you target a multi MCU SOC like the [nrf5340bsim](../nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim-multi-mcu-build), you can
use [sysbuild](../../../build/sysbuild/index.md#sysbuild) to build an executable, where, for each MCU, its application, Zephyr
...
### [Layering: Zephyr’s arch, soc and board layers](#id9)
...
![Zephyr layering in native & bsim builds](https://docs.zephyrproject.org/4.2.0/_images/layering_natsim.svg)

Overall architecture in a Zephyr application in an embedded target vs a bsim
target

### [Important limitations and unsupported features](#id10)
...
### [Threading and overall scheduling of CPU and HW models](#id11)
...
### [Time and the time\_machine](#id12)
...
### [Use of babblesim components: tracing, random number generation, logging activity](#id13)
...
![Communication between a Zephyr device and other simulated devices](https://docs.zephyrproject.org/4.2.0/_images/Zephyr_and_bsim.svg)
...
### [posix\_print and nsi\_print backends](#id15)
...
### [Command line argument parsing](#id17)
