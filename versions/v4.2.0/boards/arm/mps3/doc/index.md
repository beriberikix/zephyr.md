---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/arm/mps3/doc/index.html
original_path: boards/arm/mps3/doc/index.html
---
...
![ARM MPS3](https://docs.zephyrproject.org/4.2.0/_images/mps3.jpg)
...
MPS3 Corstone-300 (AN547)MPS3 Corstone-300 (AN552)MPS3 Corstone-300 (FVP)MPS3 Corstone-310 (AN555)MPS3 Corstone-310 (FVP)
...
FPGA Usage:
:   - Follow [Programming and Debugging](#programming-and-debugging) for build and flash instructions.
...
See the [MPS3 FPGA Website](https://developer.arm.com/tools-and-software/development-boards/fpga-prototyping-boards/mps3) for a complete list of MPS3 AN547 board hardware
features.

The default configuration can be found in
:   - For AN547: [boards/arm/mps3/mps3\_corstone300\_an547\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps3/mps3_corstone300_an547_defconfig).
    - For AN552: [boards/arm/mps3/mps3\_corstone300\_an552\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps3/mps3_corstone300_an552_defconfig).
    - For FVP : [boards/arm/mps3/mps3\_corstone300\_fvp\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps3/mps3_corstone300_fvp_defconfig).
    - For AN555: [boards/arm/mps3/mps3\_corstone310\_an555\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps3/mps3_corstone310_an555_defconfig).
...
the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application with AN547.
...
:   - [MPS3 AN547 Technical Reference Manual (TRM)](https://developer.arm.com/-/media/Arm%20Developer%20Community/PDF/DAI0547B_SSE300_PLUS_U55_FPGA_for_mps3.pdf)
    - [MPS3 AN552 Technical Reference Manual (TRM)](https://developer.arm.com/documentation/dai0552/latest)
    - [MPS3 AN555 Technical Reference Manual (TRM)](https://developer.arm.com/documentation/107642/latest)
    - [MPS3 FPGA Prototyping Board Technical Reference Manual (TRM)](https://developer.arm.com/documentation/100765/latest)
    - [Cortex M55 Generic User Guide](https://developer.arm.com/documentation/101051/latest)
    - [Cortex M85 Generic User Guide](https://developer.arm.com/documentation/101924/latest)
    - [Corelink SSE-300 Example Subsystem](https://developer.arm.com/documentation/101772/latest)
    - [Corelink SSE-310 Example Subsystem](https://developer.arm.com/documentation/102778/latest)
