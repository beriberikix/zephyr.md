---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/ti/msp_exp432p401r_launchxl/doc/index.html
...
#### `msp_exp432p401r_launchxl/msp432p401r` target
...
| SRAM | on-chip | Generic on-chip SRAM[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/ti/msp432p4xx.dtsi?plain=1#L16) | [`mmio-sram`](../../../../build/dts/api/bindings/sram/mmio-sram.md#std-dtcompatible-mmio-sram) |
...
The `msp_exp432p401r_launchxl` board supports the runners and associated west commands listed below.
