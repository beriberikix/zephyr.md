---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/toradex/verdin_imx8mm/doc/index.html
original_path: boards/toradex/verdin_imx8mm/doc/index.html
---
...
[![../../../../_images/verdin_imx8mm_m4.webp](https://docs.zephyrproject.org/4.2.0/_images/verdin_imx8mm_m4.webp)
](https://docs.zephyrproject.org/4.2.0/_images/verdin_imx8mm_m4.webp)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/toradex/verdin_imx8mm/doc/index.rst/../..)
...
[Toradex website](https://developer.toradex.com/hardware/verdin-som-family/modules/verdin-imx8m-mini/).
...
[boards/toradex/verdin\_imx8mm/verdin\_imx8mm\_mimx8mm6\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/verdin_imx8mm/verdin_imx8mm_mimx8mm6_m4_defconfig).
...
`zephyr,shell-uart` in the [boards/toradex/verdin\_imx8mm/verdin\_imx8mm\_mimx8mm6\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/verdin_imx8mm/verdin_imx8mm_mimx8mm6_m4.dts) file.

| Board Name | SoC Name | Usage |
| --- | --- | --- |
| UART\_1 | UART2 | General purpose UART |
| UART\_2 | UART3 | General purpose UART |
| UART\_3 | UART1 | Cortex-A53 debug UART |
| UART\_4 | UART4 | Cortex-M4 debug UART |

GPIO:

All the GPIO banks are enabled in the [dts/arm/nxp/nxp\_imx8m\_m4.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nxp/nxp_imx8m_m4.dtsi).

LED:

There is no LED in the module itself, this is dependent on the carrier board that
is being used with the module. The device tree is configured to use the GPIO3\_IO1,
which can be connected to the LED of the Verdin Development Board or changed in the
[boards/toradex/verdin\_imx8mm/verdin\_imx8mm\_mimx8mm6\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/verdin_imx8mm/verdin_imx8mm_mimx8mm6_m4.dts) if needed.
...
configuration is done in the file [boards/toradex/verdin\_imx8mm/verdin\_imx8mm\_mimx8mm6\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/verdin_imx8mm/verdin_imx8mm_mimx8mm6_m4.dts)
...
If you are using [TorizonCore](https://developer.toradex.com/torizon/) OS, then you should use partition 1:
...
you are using [TorizonCore](https://developer.toradex.com/torizon/), then this file is located at
