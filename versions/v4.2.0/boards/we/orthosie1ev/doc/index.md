---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/we/orthosie1ev/doc/index.html
...
[![../../../../_images/we_orthosie1ev.webp](https://docs.zephyrproject.org/4.2.0/_images/we_orthosie1ev.webp)
](https://docs.zephyrproject.org/4.2.0/_images/we_orthosie1ev.webp)
...
The `we_orthosie1ev` board supports the runners and associated west commands listed below.
...
```shell
west build -b we_orthosie1ev --sysbuild samples/hello_world
```
...
west build -b we_orthosie1ev samples/hello_world
```
...
```shell
# From the root of the zephyr repository
west build -b we_orthosie1ev samples/hello_world -- -DOPENOCD=<path/to/bin/openocd> -DOPENOCD_DEFAULT_PATH=<path/to/openocd/share/openocd/scripts>
west flash
```
