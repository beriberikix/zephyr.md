---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/snps/em_starterkit/doc/index.html
original_path: boards/snps/em_starterkit/doc/index.html
---
...
[![../../../../_images/em_starterkit.jpg](https://docs.zephyrproject.org/4.2.0/_images/em_starterkit.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/em_starterkit.jpg)
...
SoC:
:   emsk\_em9d, emsk\_em7d, emsk\_em11d

[
Browse board sources
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/snps/em_starterkit/doc/index.rst/../..)
...
Documentation for this board can be found at [embARC website](https://www.embarc.org) [[1]](#id2).

See also this URL for details about the board:
[Designware ARC EM Starter Kit website](https://www.synopsys.com/dw/ipdir.php?ds=arc_em_starter_kit) [[2]](#id6) .
...
[boards/snps/em\_starterkit/](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/snps/em_starterkit/).
...
is found in [soc/snps/emsk/Kconfig.defconfig.em9d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/snps/emsk/Kconfig.defconfig.em9d).
...
is found in [soc/snps/emsk/Kconfig.defconfig.em7d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/snps/emsk/Kconfig.defconfig.em7d) and EM11D is
found in [soc/snps/emsk/Kconfig.defconfig.em11d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/snps/emsk/Kconfig.defconfig.em11d).
...
[embARC website](https://www.embarc.org) [[1]](#id2), which also includes some free sample software.
...
- Terminal emulator software for use with the USB-UART. Suggestion:
  [Putty Website](http://www.putty.org) [[4]](#id10).
- (optional) A collection of Pmods.
  See [Digilent Pmod Modules](http://store.digilentinc.com/pmod-modules) [[3]](#id8) or develop your custom interfaces to attach
...
- If you want to know more about how to use this board, you can take a look
  at the [ARC EM Starter Kit User Guide](https://www.synopsys.com/dw/ipdir.php?ds=arc_em_starter_kit) [[2]](#id6).
...
[embARC website](https://www.embarc.org) [[1]](#id2), which includes instructions for how to place an
...
[https://www.synopsys.com/dw/ipdir.php?ds=arc\_em\_starter\_kit](https://www.synopsys.com/dw/ipdir.php?ds=arc_em_starter_kit)
