---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/snps/hsdk/doc/index.html
...
[![../../../../_images/hsdk.jpg](https://docs.zephyrproject.org/4.2.0/_images/hsdk.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/hsdk.jpg)
...
![Pinout Diagram of the Pmod](https://docs.zephyrproject.org/4.2.0/_images/pinout_diagram_of_the_pmod.jpg)
...
![mikrobus header](https://docs.zephyrproject.org/4.2.0/_images/mikrobus_header.jpg)
...
![arduino shield interface](https://docs.zephyrproject.org/4.2.0/_images/arduino_shield_interface.jpg)
...
The `hsdk` board supports the runners and associated west commands listed below.
