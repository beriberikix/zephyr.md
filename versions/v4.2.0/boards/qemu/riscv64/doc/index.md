---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/qemu/riscv64/doc/index.html
...
The `qemu_riscv64` board supports the runners and associated west commands listed below.
