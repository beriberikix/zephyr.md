---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/weact/stm32f446_core/doc/index.html
original_path: boards/weact/stm32f446_core/doc/index.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/weact/stm32f446_core/doc/index.rst/../..)

## Overview

The WeAct STM32F446 Core Board is an extremely low cost and bare-bones
development board featuring the STM32F446RE, see [STM32F446RE website](https://www.st.com/en/microcontrollers-microprocessors/stm32f446re.html) [[4]](#id8).
This is the 64-pin variant of the STM32F446x series,
see [STM32F446x reference manual](https://www.st.com/resource/en/reference_manual/rm0390-stm32f446xx-advanced-armbased-32bit-mcus-stmicroelectronics.pdf) [[5]](#id10). More info about the board available
...
#### `weact_stm32f446_core/stm32f446xx` target
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/weact/stm32f446_core/weact_stm32f446_core.dts?plain=1#L32) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/weact/stm32f446_core/weact_stm32f446_core.dts?plain=1#L23) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| on-chip | STM32 timers[8 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/f4/stm32f4.dtsi?plain=1#L325) | [`st,stm32-timers`](../../../../build/dts/api/bindings/timer/st%2Cstm32-timers.md#std-dtcompatible-st-stm32-timers) |
...
- UART\_1 TX/RX : PA9/PA10 (also available on USB-C for console)
...
- USER\_PB : PC13 (Active Low)
- USER\_LED : PB2 (Active High)
- USB\_DM/USB\_DP : PA11/PA12
...
[https://www.st.com/en/microcontrollers-microprocessors/stm32f446re.html](https://www.st.com/en/microcontrollers-microprocessors/stm32f446re.html)
