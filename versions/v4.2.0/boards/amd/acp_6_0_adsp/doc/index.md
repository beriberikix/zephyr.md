---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/amd/acp_6_0_adsp/doc/index.html
...
The `acp_6_0_adsp` board supports the runners and associated west commands listed below.
