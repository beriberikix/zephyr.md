---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/data_structures/ring_buffers.html
...
byte mode. [`ring_buf_put_claim()`](../../doxygen/html/group__ring__buffer__apis.md#ga0381d9c6413d78b9226d32532ef523eb) takes a byte size value from the
...
[`ring_buf_put_finish()`](../../doxygen/html/group__ring__buffer__apis.md#gaf910aa666eac329813a55db732a21bd8) can be used to signal the buffer that the
transfer is complete, passing the number of bytes actually
transferred. At this point a new transfer can be initiated.
Similarly, [`ring_buf_get_claim()`](../../doxygen/html/group__ring__buffer__apis.md#gad7cd6e1fe8e47ab7f6d9c42b87581f19) returns a pointer to internal ring
buffer data from which the user can read without making a verbatim
copy, and [`ring_buf_get_finish()`](../../doxygen/html/group__ring__buffer__apis.md#ga8ea8ad9949bffd0d6f9b0785e18a6378) signals the buffer with how many
...
using either [`ring_buf_space_get()`](../../doxygen/html/group__ring__buffer__apis.md#ga5eee438bd5bf08eb3a2da4cf2289903c) or [`ring_buf_item_space_get()`](../../doxygen/html/group__ring__buffer__apis.md#ga39c203f8e599098ce0d308e88d07d084)
which returns the number of free bytes or free 32-bit item words respectively,
or by testing the [`ring_buf_is_empty()`](../../doxygen/html/group__ring__buffer__apis.md#gac1a8c9e4cc9c3485573082371a4d9574) predicate.
...
[`ring_buf_put_claim()`](../../doxygen/html/group__ring__buffer__apis.md#ga0381d9c6413d78b9226d32532ef523eb), [`ring_buf_put_finish()`](../../doxygen/html/group__ring__buffer__apis.md#gaf910aa666eac329813a55db732a21bd8),
[`ring_buf_get_claim()`](../../doxygen/html/group__ring__buffer__apis.md#gad7cd6e1fe8e47ab7f6d9c42b87581f19), [`ring_buf_get_finish()`](../../doxygen/html/group__ring__buffer__apis.md#ga8ea8ad9949bffd0d6f9b0785e18a6378),
...
1. allocating the buffer ([`ring_buf_put_claim()`](../../doxygen/html/group__ring__buffer__apis.md#ga0381d9c6413d78b9226d32532ef523eb)) when
...
3. indicating the amount of data written to the provided buffer
   ([`ring_buf_put_finish()`](../../doxygen/html/group__ring__buffer__apis.md#gaf910aa666eac329813a55db732a21bd8)). The amount
...
1. retrieving source location with valid data written to a ring buffer
   (see [`ring_buf_get_claim()`](../../doxygen/html/group__ring__buffer__apis.md#gad7cd6e1fe8e47ab7f6d9c42b87581f19)).
2. processing data
3. freeing processed data (see [`ring_buf_get_finish()`](../../doxygen/html/group__ring__buffer__apis.md#ga8ea8ad9949bffd0d6f9b0785e18a6378)).
...
(i.e. it has no data array), a size of 0 and data pointer of [`NULL`](../../doxygen/html/iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)
can be specified.
