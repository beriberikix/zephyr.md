---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/services/threads/workqueue.html
...
- Direct submission of delayable work items to the queue with
  [`K_NO_WAIT`](../../../doxygen/html/group__clock__apis.md#ga3d9541cfe2e8395af66d186efa77362f) rather than always going through the timeout API,
...
Using the return values of [`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b) or
[`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0), or measurements of remaining time until
...
A work item may be **queued** ([`K_WORK_QUEUED`](../../../doxygen/html/group__workqueue__apis.md#ggae539da4c3f3d31b039bc49b9e76744ebaa7f8855bc9931bff79062ce53b06eb85)) by submitting it to a
...
A delayable work item may be **scheduled** ([`K_WORK_DELAYED`](../../../doxygen/html/group__workqueue__apis.md#ggae539da4c3f3d31b039bc49b9e76744ebab4bf9e74435077b2bbfe1de1f4e80aed)) to a
workqueue; see [Delayable Work](#delayable-work).

A work item will be **running** ([`K_WORK_RUNNING`](../../../doxygen/html/group__workqueue__apis.md#ggae539da4c3f3d31b039bc49b9e76744ebac6bee9a104cf6ee3853579f5eb15c165)) when it is running
on a work queue, and may also be **canceling** ([`K_WORK_CANCELING`](../../../doxygen/html/group__workqueue__apis.md#ggae539da4c3f3d31b039bc49b9e76744eba9fdc4327489bcdcca3de0ee9eed6b732))
...
- running on a queue;
- marked canceling (because a thread used [`k_work_cancel_sync()`](../../../doxygen/html/group__workqueue__apis.md#gab2b05cfe3af08f7d32c3946fa1c808f9) to
...
([`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0)) or **busy** ([`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b)).
...
address of the enclosing data structure with [`CONTAINER_OF`](../../../doxygen/html/group__sys-util.md#gac5bc561d1bfd1bf68877fe577779bd2f), and
...
[`k_work_delayable`](../../../doxygen/html/structk__work__delayable.md). To get access to an object that contains the
...
The [`k_work_poll_submit()`](../../../doxygen/html/group__workqueue__apis.md#gad9f222e46d72c4f98739395a0c8bb4ea) interface schedules a triggered work
...
In contrast to [`k_poll()`](../../../doxygen/html/group__poll__apis.md#gac550dc93662ce164fb22a5a91d6830db), the triggered work does not require
...
A workqueue is defined using a variable of type [`k_work_q`](../../../doxygen/html/structk__work__q.md).
The workqueue is initialized by defining the stack area used by its
thread, initializing the [`k_work_q`](../../../doxygen/html/structk__work__q.md), either zeroing its
memory or calling [`k_work_queue_init()`](../../../doxygen/html/group__workqueue__apis.md#gada77d818ea9e4d07c14a960872ed5492), and then calling
[`k_work_queue_start()`](../../../doxygen/html/group__workqueue__apis.md#gadfc56554f9bfe7b52309d79660188593). The stack area must be defined using
[`K_THREAD_STACK_DEFINE`](../../../doxygen/html/group__thread__stack__api.md#gac5368ce24fdeab3863b5c8dee2ebd955) to ensure it is properly set up in
memory.
...
[`k_work_queue_start()`](../../../doxygen/html/group__workqueue__apis.md#gadfc56554f9bfe7b52309d79660188593) for details.

The following API can be used to interact with a workqueue:

- [`k_work_queue_drain()`](../../../doxygen/html/group__workqueue__apis.md#ga0fefe3e0225ac99b47b250849f6cd863) can be used to block the caller until the
...
- [`k_work_queue_unplug()`](../../../doxygen/html/group__workqueue__apis.md#gaa0463bb79af3ec470f7d3be02052139f) removes any previous block on submission to
  the queue due to a previous drain operation.

### Submitting a Work Item

A work item is defined using a variable of type [`k_work`](../../../doxygen/html/structk__work.md). It must
be initialized by calling [`k_work_init()`](../../../doxygen/html/group__workqueue__apis.md#gaf20080884a2893d39cd8e862b34a2a30), unless it is defined using
[`K_WORK_DEFINE`](../../../doxygen/html/group__workqueue__apis.md#gaf8e003eefa5dd66ba883688f9d39c333) in which case initialization is performed at
compile-time.

An initialized work item can be submitted to the system workqueue by
calling [`k_work_submit()`](../../../doxygen/html/group__workqueue__apis.md#gace61b59575093d7442f39ccb7be686d7), or to a specified workqueue by
calling [`k_work_submit_to_queue()`](../../../doxygen/html/group__workqueue__apis.md#ga5353e76f73db070614f50d06d292d05c).
...
- [`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b) returns a snapshot of flags indicating work item
  ...
  infrastructure.
- [`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0) is a helper that indicates `true` if and only
  if the work is scheduled, queued, or running.
- [`k_work_flush()`](../../../doxygen/html/group__workqueue__apis.md#gabd1cda459bab538fb2d6dfd84a73b253) may be invoked from threads to block until the work
  item has completed. It returns immediately if the work is not pending.
- [`k_work_cancel()`](../../../doxygen/html/group__workqueue__apis.md#ga389fe2a8fb20f9bd593cf8d990727078) attempts to prevent the work item from being
  executed. This may or may not be successful. This is safe to invoke
  from ISRs.
- [`k_work_cancel_sync()`](../../../doxygen/html/group__workqueue__apis.md#gab2b05cfe3af08f7d32c3946fa1c808f9) may be invoked from threads to block until
  ...
  can be used after [`k_work_cancel()`](../../../doxygen/html/group__workqueue__apis.md#ga389fe2a8fb20f9bd593cf8d990727078) is invoked (from an ISR)` to
...
[`k_work_delayable`](../../../doxygen/html/structk__work__delayable.md). It must be initialized by calling
[`k_work_init_delayable()`](../../../doxygen/html/group__workqueue__apis.md#ga2876c5d82fb2340a093bc4d689a55465).
...
- [`k_work_schedule()`](../../../doxygen/html/group__workqueue__apis.md#ga5c113ea2bc8e8e5cd7a5c8bc5ec595d3) (or [`k_work_schedule_for_queue()`](../../../doxygen/html/group__workqueue__apis.md#ga17f863c9f6ff2fb41dc0f3b7de4fdf23))
...
- [`k_work_reschedule()`](../../../doxygen/html/group__workqueue__apis.md#gaacaab408fb7c848d466ad1f069dfa648) (or [`k_work_reschedule_for_queue()`](../../../doxygen/html/group__workqueue__apis.md#gabf5db091eac19b19a4e12c0cb381f0a8))
...
[`K_NO_WAIT`](../../../doxygen/html/group__clock__apis.md#ga3d9541cfe2e8395af66d186efa77362f) is specified as the delay the behavior is as if the item
was immediately submitted directly to the target queue, without waiting for a
minimal timeout (unless [`k_work_schedule()`](../../../doxygen/html/group__workqueue__apis.md#ga5c113ea2bc8e8e5cd7a5c8bc5ec595d3) is used and a previous
delay has not completed).

Both also have variants that allow
control of the queue used for submission.

The helper function [`k_work_delayable_from_work()`](../../../doxygen/html/group__workqueue__apis.md#gabcb822a03ce7ea9ee1ed046afe31ffca) can be used to get
a pointer to the containing [`k_work_delayable`](../../../doxygen/html/structk__work__delayable.md) from a pointer to
[`k_work`](../../../doxygen/html/structk__work.md) that is passed to a work handler function.

The following additional API can be used to check the status of or synchronize
with the work item:

- [`k_work_delayable_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#ga1b76969667844f0981d348c9c671bc9f) is the analog to [`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b)
  for delayable work.
- [`k_work_delayable_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga66e598dbc73f653cbfec03c21168df2e) is the analog to
  [`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0) for delayable work.
- [`k_work_flush_delayable()`](../../../doxygen/html/group__workqueue__apis.md#gad47d54e513030304be2600d75b1a965f) is the analog to [`k_work_flush()`](../../../doxygen/html/group__workqueue__apis.md#gabd1cda459bab538fb2d6dfd84a73b253)
  for delayable work.
- [`k_work_cancel_delayable()`](../../../doxygen/html/group__workqueue__apis.md#ga92355914ee178d4c3e848a1946bed3e4) is the analog to
  [`k_work_cancel()`](../../../doxygen/html/group__workqueue__apis.md#ga389fe2a8fb20f9bd593cf8d990727078) for delayable work; similarly with
  [`k_work_cancel_delayable_sync()`](../../../doxygen/html/group__workqueue__apis.md#ga7e7ec237648556fc16bfda8d35f7cd86).

### Synchronizing with Work Items

While the state of both regular and delayable work items can be determined
from any context using [`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b) and
[`k_work_delayable_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#ga1b76969667844f0981d348c9c671bc9f) some use cases require synchronizing
with work items after they’ve been submitted. [`k_work_flush()`](../../../doxygen/html/group__workqueue__apis.md#gabd1cda459bab538fb2d6dfd84a73b253),
[`k_work_cancel_sync()`](../../../doxygen/html/group__workqueue__apis.md#gab2b05cfe3af08f7d32c3946fa1c808f9), and [`k_work_cancel_delayable_sync()`](../../../doxygen/html/group__workqueue__apis.md#ga7e7ec237648556fc16bfda8d35f7cd86)
can be invoked from thread context to wait until the requested state has been
reached.

These APIs must be provided with a [`k_work_sync`](../../../doxygen/html/structk__work__sync.md) object that has no
...
example when it’s put into a [`k_queue`](../../../doxygen/html/structk__queue.md) by some thread and processed
...
locks ([`k_spinlock`](../../../doxygen/html/structk__spinlock.md)) or thread-aware locks ([`k_sem`](../../../doxygen/html/structk__sem.md),
[`k_mutex`](../../../doxygen/html/structk__mutex.md) , …) may be used to ensure data races don’t occur.
...
- Submitting a work item ([`k_work_submit_to_queue()`](../../../doxygen/html/group__workqueue__apis.md#ga5353e76f73db070614f50d06d292d05c)) can fail if the
...
- Asynchronous cancellation ([`k_work_cancel()`](../../../doxygen/html/group__workqueue__apis.md#ga389fe2a8fb20f9bd593cf8d990727078) or
  [`k_work_cancel_delayable()`](../../../doxygen/html/group__workqueue__apis.md#ga92355914ee178d4c3e848a1946bed3e4)) can complete while the work item is still
...
state with [`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0) or [`k_work_busy_get()`](../../../doxygen/html/group__workqueue__apis.md#gaba8a8734768d768b433f9d8490e7df7b), or
checking for a non-zero delay from
[`k_work_delayable_remaining_get()`](../../../doxygen/html/group__workqueue__apis.md#gabce78598a014f3ed87730fe6a9fe61b4). Those checks are fragile: a “busy”
...
A rare case where you could safely use [`k_work_is_pending()`](../../../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0) is as a
check to avoid invoking [`k_work_flush()`](../../../doxygen/html/group__workqueue__apis.md#gabd1cda459bab538fb2d6dfd84a73b253) or
[`k_work_cancel_sync()`](../../../doxygen/html/group__workqueue__apis.md#gab2b05cfe3af08f7d32c3946fa1c808f9), if you are *certain* that nothing else might
