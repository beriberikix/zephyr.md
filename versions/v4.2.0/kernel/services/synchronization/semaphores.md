---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/services/synchronization/semaphores.html
...
A semaphore is defined using a variable of type [`k_sem`](../../../doxygen/html/structk__sem.md).
