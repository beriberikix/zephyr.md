---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/drivers/index.html
...
[![Device Driver Model](https://docs.zephyrproject.org/4.2.0/_images/device_driver_model.svg)
](https://docs.zephyrproject.org/4.2.0/_images/device_driver_model.svg)
...
[`DEVICE_DEFINE()`](../../doxygen/html/group__device__model.md#gac12521f4d900e8947aac45c1b228366d)
:   Create device object and related data structures including setting it
    up for boot-time initialization.

[`DEVICE_NAME_GET()`](../../doxygen/html/group__device__model.md#ga430eb7530aeb3cff5708b55f9b571eb9)
:   Converts a device identifier to the global identifier for a device
    object.

[`DEVICE_GET()`](../../doxygen/html/group__device__model.md#gaf9403e7eb573a30d2dfaed357f4ef3f4)
:   Obtain a pointer to a device object by name.

[`DEVICE_DECLARE()`](../../doxygen/html/group__device__model.md#ga4e763eae14dcd41d599c485410ac2983)
:   Declare a device object. Use this when you need a forward reference
    to a device that has not yet been defined.

[`DEVICE_API()`](../../doxygen/html/device_8h.md#aa0cdc799fc0b9c80eb29f989eec86707)
...
use [`DEVICE_API_IS()`](../../doxygen/html/device_8h.md#a48c6030c2e7d1d05ace7c708dda11949) to verify the API’s type.
...
of these APIs, and populate an instance of subsystem\_driver\_api structure using
the [`DEVICE_API()`](../../doxygen/html/device_8h.md#aa0cdc799fc0b9c80eb29f989eec86707) wrapper:
...
the use of kernel services. [`DEVICE_DEFINE()`](../../doxygen/html/group__device__model.md#gac12521f4d900e8947aac45c1b228366d) and related APIs
...
still in pre-kernel states by using the [`k_is_pre_kernel()`](../../doxygen/html/group__isr__apis.md#gae74e5de996276df767b96d4b50fa47ea)
function.
...
the device is initialized when the application calls [`device_init()`](../../doxygen/html/group__device__model.md#gaeea4f9c9f14ab12d224378ab90231c09).
...
[`SYS_INIT`](../../doxygen/html/group__sys__init.md#gaf507cc0613add8113c41896bd631254f) can be used. This macro does not take any config or runtime
...
Device drivers declared with [`DEVICE_DEFINE`](../../doxygen/html/group__device__model.md#gac12521f4d900e8947aac45c1b228366d) (or any variations of it)
and [`SYS_INIT`](../../doxygen/html/group__sys__init.md#gaf507cc0613add8113c41896bd631254f) are processed at boot time and the corresponding
...
[`device_map()`](../../doxygen/html/group__device-mmio.md#ga6b4a9841a5176104e1b63f7475d3d2a2).
...
is the case with PCI-E. In this case the [`device_map()`](../../doxygen/html/group__device-mmio.md#ga6b4a9841a5176104e1b63f7475d3d2a2) function
...
[Device Model](../../doxygen/html/group__device__model.md)
