---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/timeutil.html
...
`CLOCK_MONOTONIC_RAW`. [`k_uptime_get()`](../doxygen/html/group__clock__apis.md#gae3e992cd3257c23d5b26d765fcbb2b69) provides a millisecond
...
- [comparing, adding, and subtracting representations](#timeutil-manip)
...
`timeutil_timegm()` and [`timeutil_timegm64()`](../doxygen/html/group__timeutil__repr__apis.md#gac4d2957df896a77eb317e10318adf481).

To convert between `struct timespec` and `k_timeout_t` durations,
use [`timespec_to_timeout()`](../doxygen/html/group__timeutil__repr__apis.md#gac4262e7e4ebc2af52d21a18744d50169) and [`timespec_from_timeout()`](../doxygen/html/group__timeutil__repr__apis.md#gab9b5ccdfd7abeaf7a05ebf273cb4d022).
...
- [`timeutil_sync_config`](../doxygen/html/structtimeutil__sync__config.md) records the nominal rates of a reference
  time scale/source (e.g. TAI) and a local time source
  (e.g. [`k_uptime_ticks()`](../doxygen/html/group__clock__apis.md#ga8f143af2ee4ad42d9f7817ef161cbd13)).
- [`timeutil_sync_instant`](../doxygen/html/structtimeutil__sync__instant.md) records the representation of a single
  instant in both the reference and local time scales.
- [`timeutil_sync_state`](../doxygen/html/structtimeutil__sync__state.md) provides storage for an initial instant, a
  recently received second observation, and a skew that can adjust for
  relative errors in the actual rate of each time scale.
- [`timeutil_sync_ref_from_local()`](../doxygen/html/group__timeutil__sync__apis.md#ga75361d2bfd219f1e8107d635eb4ecc16) and
  [`timeutil_sync_local_from_ref()`](../doxygen/html/group__timeutil__sync__apis.md#gad8ef92e5dc72bd26d765567134044400) convert instants in one time scale
  to another taking into account skew that can be estimated from the two
  instances stored in the state structure by
  [`timeutil_sync_estimate_skew()`](../doxygen/html/group__timeutil__sync__apis.md#gac4c25a1ed054a8a06c87d4df9c25ffc6).

[Time Synchronization APIs](../doxygen/html/group__timeutil__sync__apis.md)

### `timespec` Manipulation

Checking the validity of a `timespec` can be done with [`timespec_is_valid()`](../doxygen/html/group__timeutil__timespec__apis.md#ga2426889e703021e8b6f8a0ccab885bb6).
...
It is possible to compare two `timespec` objects for equality using [`timespec_equal()`](../doxygen/html/group__timeutil__timespec__apis.md#gaedc15d71f9eee8e243c070a3e07d919f).
...
[`timespec_add()`](../doxygen/html/group__timeutil__timespec__apis.md#ga81026756e417d086b4f53306d04c8d10), [`timespec_sub()`](../doxygen/html/group__timeutil__timespec__apis.md#gae0511602aea1fecc0b204e28ae91e7d0), and [`timespec_negate()`](../doxygen/html/group__timeutil__timespec__apis.md#ga38216267ef6ca24e2b05d77104f5837a),
respectively. Like [`timespec_normalize()`](../doxygen/html/group__timeutil__timespec__apis.md#ga4a0d4891eb6aef6543b1992566729f6c), these functions will output
...
The API around [`timeutil_sync_state_update()`](../doxygen/html/group__timeutil__sync__apis.md#gaa6926a23d1c4fbb61584e957d157bd62) supports the first step
