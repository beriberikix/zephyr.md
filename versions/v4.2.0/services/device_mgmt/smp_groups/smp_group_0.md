---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/device_mgmt/smp_groups/smp_group_0.html
...
error response. For details on this functionality, see [MCUmgr Callbacks](../mcumgr_callbacks.md#mcumgr-callbacks).
...
attempt has responded with “rc” equal to [`MGMT_ERR_EBUSY`](../../../doxygen/html/group__mcumgr__mgmt__api.md#ggac5d8757a7ca945c77f405764b85ad5c5a7a0a4726f516645ac8b19efb25f79be1) then the
...
| --- | --- |
| “boot\_mode” | Specifies boot mode for image or application mode/selection, requires [`CONFIG_MCUMGR_GRP_OS_RESET_BOOT_MODE`](../../../kconfig.md#CONFIG_MCUMGR_GRP_OS_RESET_BOOT_MODE "CONFIG_MCUMGR_GRP_OS_RESET_BOOT_MODE") to be enabled. |
