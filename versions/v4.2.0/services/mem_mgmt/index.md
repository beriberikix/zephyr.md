---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/mem_mgmt/index.html
...
[Memory map and MPU considerations](../../hardware/arch/arm_cortex_m.md#arm-cortex-m-mpu-considerations) in the [Arm Cortex-M Developer Guide](../../hardware/arch/arm_cortex_m.md#arm-cortex-m-developer-guide)
for more details about MPU usage. Also see [Caching Basics](../../hardware/cache/guide.md#cache-guide) for details on how
...
[`CONFIG_ARM_MPU`](../../kconfig.md#CONFIG_ARM_MPU "CONFIG_ARM_MPU"), [`CONFIG_RISCV_PMP`](../../kconfig.md#CONFIG_RISCV_PMP "CONFIG_RISCV_PMP"), etc.
...
[`mem_attr_heap_pool_init()`](../../doxygen/html/group__memory__attr__heap.md#ga85301dfc19493a84e89f965ed793d576).
