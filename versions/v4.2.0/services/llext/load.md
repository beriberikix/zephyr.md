---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/llext/load.html
...
needed by the [`llext_load()`](../../doxygen/html/group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157) function. Several loaders are already provided:

> - An implementation over a buffer containing an ELF in addressable memory in
>   memory is available as [`llext_buf_loader`](../../doxygen/html/structllext__buf__loader.md). To use this kind of
>   loader, it is helpful to use one of the [`LLEXT_TEMPORARY_BUF_LOADER`](../../doxygen/html/group__llext__loader__apis.md#ga8485b4dfecbd2eff3e21b5958d5e8699),
>   [`LLEXT_PERSISTENT_BUF_LOADER`](../../doxygen/html/group__llext__loader__apis.md#ga2c2214bcf1506f1209476619e42114b3), or [`LLEXT_WRITABLE_BUF_LOADER`](../../doxygen/html/group__llext__loader__apis.md#gac726727897e02bca0bf5d32f4c66be55)
...
>   as the [`llext_fs_loader`](../../doxygen/html/structllext__fs__loader.md). The path to the file must be provided
>   when creating the loader with the [`LLEXT_FS_LOADER`](../../doxygen/html/group__llext__loader__apis.md#ga25a394fb7f7f93cfe3ab92d8ed4a6bff) macro.
...
may want to refer to [`llext_get_section_info()`](../../doxygen/html/group__llext__inspect__apis.md#ga23121962662f057da004ac1c527716e3) and other LLEXT
inspection APIs.
...
- Use a debugger to inspect the memory and registers to try to understand what
  is happening. See [Debugging extensions](debug.md#llext-debug) for more details.
