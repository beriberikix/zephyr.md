---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/llext/config.html
...
[`CONFIG_LLEXT_HEAP_DYNAMIC`](../../kconfig.md#CONFIG_LLEXT_HEAP_DYNAMIC "CONFIG_LLEXT_HEAP_DYNAMIC")
...
>
> Application must call [`llext_heap_init()`](../../doxygen/html/group__llext__apis.md#ga1fa344ade4911a259e7b8ded51241d13) in order to assign a
...
> it should call [`llext_heap_uninit()`](../../doxygen/html/group__llext__apis.md#gab20e01c13bdb344978a0fb9b5bd8531d) which releases control of
...
> before it can be used again in a call to [`llext_load()`](../../doxygen/html/group__llext__apis.md#ga0a4c3db30bc3ec7aa8a9b0e076af7157).
>
> Note
>
