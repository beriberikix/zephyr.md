---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/storage/secure_storage/index.html
original_path: services/storage/secure_storage/index.html
---
...
available [Kconfig options](../../../kconfig.md#!CONFIG_SECURE_STORAGE_.*).
They are defined in the various Kconfig files found under [subsys/secure\_storage/](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/secure_storage/).
...
Have a look at the [ITS transform and store Kconfig options](../../../kconfig.md#!CONFIG_SECURE_STORAGE_ITS_(STORE|TRANSFORM)_.*_CUSTOM) to see the different customization
possibilities.
