---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/storage/settings/index.html
...
:   This gets called when loading only one item from persistent storage using
    [`settings_load_one()`](../../../doxygen/html/group__settings.md#ga6ada8f687dcd3f3374a766ca173fdf27).

**csi\_get\_val\_len**
:   This gets called when getting a value’s length from persistent storage using
    [`settings_get_val_len()`](../../../doxygen/html/group__settings.md#gacadb36d1cd5f6c7c6cbaf46e0e81ac7c).
...
([`CONFIG_SETTINGS_ZMS_MAX_COLLISIONS_BITS`](../../../kconfig.md#CONFIG_SETTINGS_ZMS_MAX_COLLISIONS_BITS "CONFIG_SETTINGS_ZMS_MAX_COLLISIONS_BITS")).
...
Alternatively, a call to [`settings_load_one()`](../../../doxygen/html/group__settings.md#ga6ada8f687dcd3f3374a766ca173fdf27) will load only one
...
a call to [`settings_get_val_len()`](../../../doxygen/html/group__settings.md#gacadb36d1cd5f6c7c6cbaf46e0e81ac7c) can be performed.
This is used for example by applications that allocates dynamically the data
buffer and needs to get the data size before reading it by settings\_load\_one().
