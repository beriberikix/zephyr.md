---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/portability/posix/option_groups/index.html
...
### POSIX\_C\_LANG\_SUPPORT\_R

Enable this option group with [`CONFIG_POSIX_C_LANG_SUPPORT_R`](../../../../kconfig.md#CONFIG_POSIX_C_LANG_SUPPORT_R "CONFIG_POSIX_C_LANG_SUPPORT_R").
...
### POSIX\_FILE\_SYSTEM\_R

Enable this option with [`CONFIG_POSIX_FILE_SYSTEM_R`](../../../../kconfig.md#CONFIG_POSIX_FILE_SYSTEM_R "CONFIG_POSIX_FILE_SYSTEM_R").
...
The `XSI_REALTIME` option group indicates that the [\_POSIX\_FSYNC](#posix-option-fsync),
[\_POSIX\_MEMLOCK](#posix-option-memlock),
[\_POSIX\_MEMLOCK\_RANGE](#posix-option-memlock-range),
[\_POSIX\_MESSAGE\_PASSING](#posix-option-message-passing),
[\_POSIX\_PRIORITY\_SCHEDULING](#posix-option-priority-scheduling),
[\_POSIX\_SHARED\_MEMORY\_OBJECTS](#posix-option-shared-memory-objects), and
[\_POSIX\_SYNCHRONIZED\_IO](#posix-option-synchronized-io) options are enabled.

Enable this option group with [`CONFIG_XSI_REALTIME`](../../../../kconfig.md#CONFIG_XSI_REALTIME "CONFIG_XSI_REALTIME").

When this option group is enabled, the `_XOPEN_REALTIME` feature test macro will be defined to a
value other than -1.

### XSI\_SINGLE\_PROCESS

Enable this option group with [`CONFIG_XSI_SINGLE_PROCESS`](../../../../kconfig.md#CONFIG_XSI_SINGLE_PROCESS "CONFIG_XSI_SINGLE_PROCESS").
