---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/bluetooth/api/mesh/blob_srv.html
...
![BLOB Transfer Server model interaction](https://docs.zephyrproject.org/4.2.0/_images/blob_srv.svg)
