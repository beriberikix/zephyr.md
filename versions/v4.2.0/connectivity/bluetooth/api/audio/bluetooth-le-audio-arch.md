---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/bluetooth/api/audio/bluetooth-le-audio-arch.html
original_path: connectivity/bluetooth/api/audio/bluetooth-le-audio-arch.html
---

# LE Audio Stack

digraph bluetooth\_audio\_arch {
...
applicable (e.g. [`bt_bap_unicast_client_discover()`](../../../../doxygen/html/group__bt__bap__unicast__client.md#gacef9c88f66762e8de19303d20dafa0bb) and [`bt_vcp_vol_rend_set_vol()`](../../../../doxygen/html/group__bt__vcp.md#ga61279baeba11152625cd3a87c5d973c9)).
...
subgraph tmap\_layer {
cluster=true;
label="TMAP";
TMAS;
}
subgraph gmap\_layer {
cluster=true;
label="GMAP";
GMAS;
}
...
subgraph transition\_and\_coordination\_control\_layer {
cluster=true;
...
subgraph stream\_control\_layer {
cluster=true;
...
subgraph content\_control\_layer {
cluster=true;
...
subgraph rendering\_and\_capture\_control\_layer {
cluster=true;
label="Rendering and Capture Control";
style=dashed;
subgraph micp\_layer {
cluster=true;
label="MICP";
style=solid;
MICS;
MICP\_AICS [style=dashed];
}
subgraph vcp\_layer {
cluster=true;
label="VCP";
...
cluster=true;
label="PBP";
PBP\_H [label="pbp.h"]; // Make it possible to treat PBP like the others
}
subgraph tmap\_layer {
cluster=true;
label="TMAP";
TMAP\_H [label="tmap.h"];
}
subgraph gmap\_layer {
cluster=true;
label="GMAP";
GMAP\_H [label="gmap.h"];
GMAP\_PRESET\_H [label="gmap\_lc3\_preset.h"];
}
subgraph gaf\_layer {
cluster=true;
label="Generic Audio Framework";
AUDIO\_H [label="audio.h"];
LC3\_H [label="lc3.h"];
subgraph transition\_and\_coordination\_control\_layer {
cluster=true;
label="Transition and Coordination Control";
...
label="BAP";
style=solid;
PACS\_H [label="pacs.h"];
BAP\_H [label="bap.h"];
BAP\_PRESET\_H [label="bap\_lc3\_preset.h"];
}
}
subgraph content\_control\_layer {
cluster=true;
...
label="MICP";
style=solid;
MICP\_H [label="micp.h"];
AICS\_H [label="aics.h"];
}
subgraph vcp\_layer {
cluster=true;
label="VCP";
...
| --- | --- | --- | --- | --- | --- |
| VCP | Volume Renderer | 1.0.0 | 2.6 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| Volume Controller | 1.0.0 | 2.6 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| MICP | Microphone Device | 1.0.0 | 2.7 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| Microphone Controller | 1.0.0 | 2.7 | - Feature complete - Shell Module - BSIM test | - Sample Application |
...
| CCP | Call Control Server | 1.0.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor (in progress) - Sample Application (in progress) |
| Call Control Client | 1.0.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor (in progress) - Sample Application (in progress) |
| MCP | Media Control Server | 1.0.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor - Support for multiple instances and connections - Sample Application |
| Media Control Client | 1.0.0 | 3.0 | - Feature complete - Shell Module - BSIM test | - API refactor - Sample Application |
...
| CAP | Acceptor | 1.0.1 | 3.2 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Initiator | 1.0.1 | 3.3 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Commander |  |  | - WIP | - Feature complete - Shell Module - BSIM test - Sample Application |
| HAP | Hearing Aid | 1.0.0 | 3.1 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Hearing Aid Unicast Client | 1.0.0 | 3.1 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Hearing Aid Remote Controller |  |  | - WIP | - Feature complete - Shell Module - BSIM test - Sample Application |
| TMAP | Call Gateway | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Call Terminal | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Unicast Media Sender | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Unicast Media Receiver | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Broadcast Media Sender | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Broadcast Media Receiver | 1.0.0 | 3.4 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| PBP | Public Broadcast Source | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Public Broadcast Sink | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test - Sample Application |  |
| Public Broadcast Assistant |  |  |  | - Feature complete - Shell Module - BSIM test - Sample Application |
| GMAP | Unicast Game Gateway | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| Unicast Game Terminal | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| Broadcast Game Sender | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test | - Sample Application |
| Broadcast Game Receiver | 1.0.0 | 3.5 | - Feature complete - Shell Module - BSIM test | - Sample Application |
...
![Common Audio Profile Procedures](https://docs.zephyrproject.org/4.2.0/_images/cap_proc.svg)

Common Audio Profile Procedures

The API reference for CAP can be found in [Common Audio Profile](cap.md#bluetooth-cap).
...
be found at
[https://www.bluetooth.com/bluetooth-resources/developing-auracast-receivers-with-an-assistant-application-for-legacy-smartphones/](https://www.bluetooth.com/bluetooth-resources/developing-auracast-receivers-with-an-assistant-application-for-legacy-smartphones/).
...
([https://www.bluetooth.com/specifications/assigned-numbers/](https://www.bluetooth.com/specifications/assigned-numbers/)), and the values for other codecs such
...
but by using functions such as [`bt_pacs_conn_set_available_contexts_for_conn()`](../../../../doxygen/html/group__bt__pacs.md#ga12f283d2daf72302a01cefb4a4a8fc70),
it is possible to set specific values for specific clients.

The API reference for stream control can be found in
[Bluetooth Audio](audio.md#bluetooth-audio).
...
[Bluetooth Volume Control](volume.md#bluetooth-volume).

The API reference for Microphone Control can be found in
[Bluetooth Microphone Control](microphone.md#bluetooth-microphone).
...
[Bluetooth Media Control](media.md#bluetooth-media).
...
The API reference for media control can be found in
[Bluetooth Coordinated Sets](coordinated_sets.md#bluetooth-coordinated-sets).
...
[subsys/bluetooth/audio/audio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/bluetooth/audio/audio.c), where all LE Audio services must use the
...
The Basic Audio Profile (BAP) has a requirement that both sides shall support a minimum ATT\_MTU of
...
If a ASCS device supports values larger than the minimum ATT\_MTU of 64 octets, then it shall support
Read long Characteristic Value by setting [`CONFIG_BT_ATT_PREPARE_COUNT`](../../../../kconfig.md#CONFIG_BT_ATT_PREPARE_COUNT "CONFIG_BT_ATT_PREPARE_COUNT") to a
non-zero value.
...
Find it here at [https://discordapp.com/channels/720317445772017664/1207326649591271434](https://discordapp.com/channels/720317445772017664/1207326649591271434) or simply
...
Discord channel found at [https://discordapp.com/channels/720317445772017664/869172014018097162](https://discordapp.com/channels/720317445772017664/869172014018097162).
...
joining the Bluetooth-sig group at [https://lists.zephyrproject.org/g/Bluetooth-sig](https://lists.zephyrproject.org/g/Bluetooth-sig).

## Github project

LE Audio in Zephyr has its own Github project available at
[https://github.com/orgs/zephyrproject-rtos/projects/26](https://github.com/orgs/zephyrproject-rtos/projects/26).
...
- Generic Audio (GA) errata [https://bluetooth.atlassian.net/wiki/spaces/GA/pages/1634402349/GAWG+Errata+Lists](https://bluetooth.atlassian.net/wiki/spaces/GA/pages/1634402349/GAWG+Errata+Lists)
- Hearing Aid (HA) errata [https://bluetooth.atlassian.net/wiki/spaces/HA/pages/1634140216/HA+WG+Errata+List](https://bluetooth.atlassian.net/wiki/spaces/HA/pages/1634140216/HA+WG+Errata+List)
- Audio, Telephony and Automotive (ATA) errata [https://bluetooth.atlassian.net/wiki/spaces/ATA/pages/1668481034/ATA+Errata+Lists](https://bluetooth.atlassian.net/wiki/spaces/ATA/pages/1668481034/ATA+Errata+Lists)
...
- Generic Audio (GA) [https://www.bluetooth.org/groups/group.aspx?gId=665](https://www.bluetooth.org/groups/group.aspx?gId=665)
- Hearing Aid (HA) [https://www.bluetooth.org/groups/group.aspx?gId=605](https://www.bluetooth.org/groups/group.aspx?gId=605)
- Audio, Telephony, and Automotive (ATA) [https://www.bluetooth.org/groups/group.aspx?gId=659](https://www.bluetooth.org/groups/group.aspx?gId=659)
...
There is a free ebook on LE Audio at [https://www.bluetooth.com/bluetooth-resources/le-audio-book/](https://www.bluetooth.com/bluetooth-resources/le-audio-book/).
...
These can be found at [https://www.bluetooth.com/bluetooth-resources/?tags=le-audio&keyword](https://www.bluetooth.com/bluetooth-resources/?tags=le-audio&keyword).
