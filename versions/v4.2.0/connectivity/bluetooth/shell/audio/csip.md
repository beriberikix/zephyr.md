---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/bluetooth/shell/audio/csip.html
original_path: connectivity/bluetooth/shell/audio/csip.html
---
...
`BT_MAX_CONN` shall be at least 3.
...
set members, make sure that `BT_MAX_PAIRED` is correctly configured.
...
initialized by calling `csip_set_coordinator init`, which will start a discovery
...
[`CONFIG_BT_CSIP_SET_COORDINATOR_LOG_LEVEL_DBG`](../../../../kconfig.md#CONFIG_BT_CSIP_SET_COORDINATOR_LOG_LEVEL_DBG "CONFIG_BT_CSIP_SET_COORDINATOR_LOG_LEVEL_DBG") to properly use
the set coordinator.
