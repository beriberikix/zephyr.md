---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/native_sim_setup.html
...
## [Setting interface name and IPv4 parameters from command line](#id7)

By default the Ethernet interface name used by native\_sim is determined by
[`CONFIG_ETH_NATIVE_TAP_DRV_NAME`](../../kconfig.md#CONFIG_ETH_NATIVE_TAP_DRV_NAME "CONFIG_ETH_NATIVE_TAP_DRV_NAME"), but is also possible
...
Note that the configuration [`CONFIG_NET_CONFIG_MY_IPV4_ADDR`](../../kconfig.md#CONFIG_NET_CONFIG_MY_IPV4_ADDR "CONFIG_NET_CONFIG_MY_IPV4_ADDR")
