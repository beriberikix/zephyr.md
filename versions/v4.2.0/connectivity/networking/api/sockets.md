---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/sockets.html
...
| --- | --- | --- | --- |
| AF\_INET   AF\_INET6 | SOCK\_DGRAM | IPPROTO\_UDP | Enabled if [`CONFIG_NET_UDP`](../../../kconfig.md#CONFIG_NET_UDP "CONFIG_NET_UDP") is set.   Allows to send and receive UDP datagrams. |
| IPPROTO\_DTLS\_1\_x | Enabled if [`CONFIG_NET_SOCKETS_ENABLE_DTLS`](../../../kconfig.md#CONFIG_NET_SOCKETS_ENABLE_DTLS "CONFIG_NET_SOCKETS_ENABLE_DTLS") is set.   Allows to send and receive DTLS datagrams. |
| SOCK\_STREAM | IPPROTO\_TCP | Enabled if [`CONFIG_NET_TCP`](../../../kconfig.md#CONFIG_NET_TCP "CONFIG_NET_TCP") is set.   Allows to send and receive TCP data stream. |
| IPPROTO\_TLS\_1\_x | Enabled if [`CONFIG_NET_SOCKETS_SOCKOPT_TLS`](../../../kconfig.md#CONFIG_NET_SOCKETS_SOCKOPT_TLS "CONFIG_NET_SOCKETS_SOCKOPT_TLS") is set.   Allows to send and receive TLS data stream. |
| SOCK\_RAW | IPPROTO\_IP   <proto> | Enabled if [`CONFIG_NET_SOCKETS_INET_RAW`](../../../kconfig.md#CONFIG_NET_SOCKETS_INET_RAW "CONFIG_NET_SOCKETS_INET_RAW") is set.   Allows to send and receive IPv4/IPv6 datagrams.   Packets are filtered by L4 protocol specified. IPPROTO\_IP is a wildcard protocol to receive all IP datagrams. |
| AF\_PACKET | SOCK\_DGRAM | ETH\_P\_ALL   <proto> | Enabled if [`CONFIG_NET_SOCKETS_PACKET_DGRAM`](../../../kconfig.md#CONFIG_NET_SOCKETS_PACKET_DGRAM "CONFIG_NET_SOCKETS_PACKET_DGRAM") is set.   Allows to send and receive packets without L2 header.   Packets are filtered by L3 protocol specified. ETH\_P\_ALL is a wildcard protocol to receive all packets. |
| SOCK\_RAW | ETH\_P\_ALL | Enabled if [`CONFIG_NET_SOCKETS_PACKET`](../../../kconfig.md#CONFIG_NET_SOCKETS_PACKET "CONFIG_NET_SOCKETS_PACKET") is set.   Allows to send and receive packets with L2 header included. |
| AF\_CAN | SOCK\_RAW | CAN\_RAW | Enabled if [`CONFIG_NET_SOCKETS_CAN`](../../../kconfig.md#CONFIG_NET_SOCKETS_CAN "CONFIG_NET_SOCKETS_CAN") is set.   Allows to send and receive CAN packets. |
