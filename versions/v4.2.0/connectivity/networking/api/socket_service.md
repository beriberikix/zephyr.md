---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/socket_service.html
original_path: connectivity/networking/api/socket_service.html
---
...
See [Echo server (service)](../../../samples/net/sockets/echo_service/README.md#sockets-service-echo "Implements a simple IPv4/IPv6 TCP echo server using BSD sockets and socket service API.") sample application to learn how
...
Socket service API is enabled using [`CONFIG_NET_SOCKETS_SERVICE`](../../../kconfig.md#CONFIG_NET_SOCKETS_SERVICE "CONFIG_NET_SOCKETS_SERVICE")
config option and implements the following operations:

- [`NET_SOCKET_SERVICE_SYNC_DEFINE`](../../../doxygen/html/group__bsd__socket__service.md#ga424f319f9ccc675f8eeca23cb2c91bc4)
...
- [`NET_SOCKET_SERVICE_SYNC_DEFINE_STATIC`](../../../doxygen/html/group__bsd__socket__service.md#gadee4c786ebf89706a6b0151244b55cc3)

  Define a network socket service with static scope. This socket service can only
  be used within one C source file.
- [`net_socket_service_register()`](../../../doxygen/html/group__bsd__socket__service.md#gaa72bb82aa413b711e61eda092504b091)

  Register pollable sockets for this service. User must create the sockets
  before this call.
- [`net_socket_service_unregister()`](../../../doxygen/html/group__bsd__socket__service.md#gae2d4eea01c9ea4e6a48315681e05afd6)

  Remove pollable sockets for this service. User can close the sockets after
  this call.
- [`net_socket_service_handler_t`](../../../doxygen/html/group__bsd__socket__service.md#ga5d9495470c1ade51791df56c59cfb1f5)

  User specified callback which is called when data is received on the
  listening socket.

## [Application Overview](#id3)
...
[`net_socket_service_register()`](../../../doxygen/html/group__bsd__socket__service.md#gaa72bb82aa413b711e61eda092504b091) for the accepted socket.
...
code at [samples/net/sockets/echo\_service/src/main.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/sockets/echo_service/src/main.c).
