---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/net_shell.html
...
| net filter | View network packet filter rules. Only available if [`CONFIG_NET_PKT_FILTER`](../../../kconfig.md#CONFIG_NET_PKT_FILTER "CONFIG_NET_PKT_FILTER") is set. |
