---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/zperf.html
...
enable [`CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT`](../../../kconfig.md#CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT "CONFIG_NET_ZPERF_LEGACY_HEADER_COMPAT").
...
## [Session Management](#id3)

If [`CONFIG_ZPERF_SESSION_PER_THREAD`](../../../kconfig.md#CONFIG_ZPERF_SESSION_PER_THREAD "CONFIG_ZPERF_SESSION_PER_THREAD") option is set, then
...
| zperf shell command | Description |
| --- | --- |
...
## [Custom Data Upload](#id4)

zperf supports more advanced data upload profiling by setting a custom data
source through `zperf_upload_params.data_loader`. This enables the
