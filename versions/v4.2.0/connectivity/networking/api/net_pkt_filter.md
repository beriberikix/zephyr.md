---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/net_pkt_filter.html
...
A rule is represented by a [`npf_rule`](../../../doxygen/html/structnpf__rule.md) object. It can be inserted to,
appended to or removed from a rule list contained in a
[`npf_rule_list`](../../../doxygen/html/structnpf__rule__list.md) object using [`npf_insert_rule()`](../../../doxygen/html/group__net__pkt__filter.md#ga3b2a85558b6756e76760d9a40c780e28),
[`npf_append_rule()`](../../../doxygen/html/group__net__pkt__filter.md#gadfa956e4af3c45460846fc22f863e697), and [`npf_remove_rule()`](../../../doxygen/html/group__net__pkt__filter.md#ga4d7426db901debff35e1de5805e06c71).
...
Rule conditions are represented by a [`npf_test`](../../../doxygen/html/structnpf__test.md). This structure
...
[`NPF_RULE()`](../../../doxygen/html/group__net__pkt__filter.md#ga2f45093d5ad164d5c51a8996f7f04d32) to create a rule instance to tie them.
...
- [Network packet filter](../../../samples/net/pkt_filter/README.md#net-pkt-filter "Install network packet filter hooks.")Install network packet filter hooks.
