---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/usb/device/usb_device.html
...
[New USB device support APIs](../device_next/api/index.md#usb-device-next-api), will become the default in Zephyr v4.2.0.
...
See [HCI USB](../../../samples/bluetooth/hci_usb/README.md#bluetooth_hci_usb "Turn a Zephyr board into a USB Bluetooth dongle (compatible with all operating systems).") sample for reference.
...
- `zephyr,bt-c2h-uart` used in Bluetooth,
  for example see [HCI UART](../../../samples/bluetooth/hci_uart/README.md#bluetooth_hci_uart "Expose a Bluetooth controller to another device or CPU over UART.")
- `zephyr,ot-uart` used in OpenThread,
  for example see [OpenThread co-processor](../../../samples/net/openthread/coprocessor/README.md#openthread-coprocessor "Build a Thread border-router using OpenThread's co-processor designs.")
...
the [`device_get_binding()`](../../../doxygen/html/group__device__model.md#ga15386ca9ab38f3e30183c18f604fa835). Note that there is no HID device API as such,
instead the interface is provided by [`hid_ops`](../../../doxygen/html/structhid__ops.md).
...
and the report descriptor must be registered using [`usb_hid_register_device()`](../../../doxygen/html/group__usb__hid__device__api.md#ga8b08b633472ceb1323f09ef81176520f).
...
for [`hid_ops`](../../../doxygen/html/structhid__ops.md) is to provide `int_in_ready` callback.
...
See [USB HID mouse](../../../samples/subsys/usb/hid-mouse/README.md#usb-hid-mouse "Implement a basic HID mouse device.") sample for reference.
...
[`CONFIG_MASS_STORAGE_DISK_NAME`](../../../kconfig.md#CONFIG_MASS_STORAGE_DISK_NAME "CONFIG_MASS_STORAGE_DISK_NAME") and should be the same as the
...
using [`usb_bos_register_cap()`](../../../doxygen/html/group____usb__device__core__api.md#ga1bf8ec88cf752e98234d9f8bb57f976a). Registered descriptors are added to the root
...
## [Interface number and endpoint address assignment](#id14)
...
## [Testing over USBIP in native\_sim](#id15)
...
## [USB Vendor and Product identifiers](#id16)
...
Each USB [sample](../../../samples/subsys/usb/usb.md#usb) has its own unique Product ID.
...
| [USB device testing application](../../../samples/subsys/usb/testusb/README.md#testusb-app "Test USB device drivers using a loopback function.") | 0x0009 |
| [WebUSB](../../../samples/subsys/usb/webusb/README.md#webusb "Receive and echo data from a web page using WebUSB API.") | 0x000A |
| [HCI USB](../../../samples/bluetooth/hci_usb/README.md#bluetooth_hci_usb "Turn a Zephyr board into a USB Bluetooth dongle (compatible with all operating systems).") | 0x000B |
| Reserved (previously: bluetooth\_hci\_usb\_h4) | 0x000C |
...
| [USB Audio asynchronous implicit feedback sample](../../../samples/subsys/usb/uac2_implicit_feedback/README.md#uac2-implicit-feedback "USB Audio 2 implicit feedback sample playing stereo and recording mono audio on I2S interface.") | 0x000F |
| [USB Video webcam](../../../samples/subsys/usb/uvc/README.md#uvc "Send video frames over USB.") | 0x0011 |
