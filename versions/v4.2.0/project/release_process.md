---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/project/release_process.html
...
[![Release Cycle](https://docs.zephyrproject.org/4.2.0/_images/release_cycle.svg)
](https://docs.zephyrproject.org/4.2.0/_images/release_cycle.svg)
...
cosmetic changes, tests, bug and doc fixes are allowed (See [table](#release-milestones) below).
...
[![Releases](https://docs.zephyrproject.org/4.2.0/_images/release_flow.png)
](https://docs.zephyrproject.org/4.2.0/_images/release_flow.png)
...
[here](../releases/index.md#supported-releases).

[![Long Term Support Release](https://docs.zephyrproject.org/4.2.0/_images/lts.svg)
](https://docs.zephyrproject.org/4.2.0/_images/lts.svg)
...
3. Tag and push the version, using an annotated tag:
   ...
   ```
4. Verify that the tag has been signed correctly, `git show` for the
...
5. Push the tag:
   ...
   ```
6. Send an email to the mailing lists (`announce` and `devel`)
...
5. Push the tag:
   ...
   ```
6. Find the new `v1.11.0` tag at the top of the releases page and
...
7. Send an email to the mailing lists (`announce` and `devel`) with a link
   to the release
