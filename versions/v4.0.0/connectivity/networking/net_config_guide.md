---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/net_config_guide.html
original_path: connectivity/networking/net_config_guide.html
---
...
## [Network Buffer Configuration Options](#id2)

The network buffer configuration options control how much data we
are able to either send or receive at the same time.

[`CONFIG_NET_PKT_RX_COUNT`](../../kconfig.md#CONFIG_NET_PKT_RX_COUNT "CONFIG_NET_PKT_RX_COUNT")
:   Maximum amount of network packets we can receive at the same time.

[`CONFIG_NET_PKT_TX_COUNT`](../../kconfig.md#CONFIG_NET_PKT_TX_COUNT "CONFIG_NET_PKT_TX_COUNT")
:   Maximum amount of network packet sends pending at the same time.

[`CONFIG_NET_BUF_RX_COUNT`](../../kconfig.md#CONFIG_NET_BUF_RX_COUNT "CONFIG_NET_BUF_RX_COUNT")
:   How many network buffers are allocated for receiving data.
    Each net\_buf contains a small header and either a fixed or variable
    length data buffer. The [`CONFIG_NET_BUF_DATA_SIZE`](../../kconfig.md#CONFIG_NET_BUF_DATA_SIZE "CONFIG_NET_BUF_DATA_SIZE")
    is used when [`CONFIG_NET_BUF_FIXED_DATA_SIZE`](../../kconfig.md#CONFIG_NET_BUF_FIXED_DATA_SIZE "CONFIG_NET_BUF_FIXED_DATA_SIZE") is set.
    This is the default setting. The default size of the buffer is 128 bytes.

    The [`CONFIG_NET_BUF_VARIABLE_DATA_SIZE`](../../kconfig.md#CONFIG_NET_BUF_VARIABLE_DATA_SIZE "CONFIG_NET_BUF_VARIABLE_DATA_SIZE") is an experimental
    setting. There each net\_buf data portion is allocated from a memory pool and
    can be the amount of data we have received from the network.
    When data is received from the network, it is placed into net\_buf data portion.
    Depending on device resources and desired network usage, user can tweak
    the size of the fixed buffer by setting [`CONFIG_NET_BUF_DATA_SIZE`](../../kconfig.md#CONFIG_NET_BUF_DATA_SIZE "CONFIG_NET_BUF_DATA_SIZE"), and
    the size of the data pool size by setting [`CONFIG_NET_PKT_BUF_RX_DATA_POOL_SIZE`](../../kconfig.md#CONFIG_NET_PKT_BUF_RX_DATA_POOL_SIZE "CONFIG_NET_PKT_BUF_RX_DATA_POOL_SIZE")
    and [`CONFIG_NET_PKT_BUF_TX_DATA_POOL_SIZE`](../../kconfig.md#CONFIG_NET_PKT_BUF_TX_DATA_POOL_SIZE "CONFIG_NET_PKT_BUF_TX_DATA_POOL_SIZE") if variable size buffers are used.
    ...
    there is some overhead involved for each net\_buf. For these reasons the default
    ...
    If one wants to receive two full frames, then the net\_pkt RX count should be set to 2,
    and net\_buf RX count to (1500 / 128) \* 2 which is 24.
...
[`CONFIG_NET_BUF_TX_COUNT`](../../kconfig.md#CONFIG_NET_BUF_TX_COUNT "CONFIG_NET_BUF_TX_COUNT")
...
## [Connection Options](#id3)

[`CONFIG_NET_MAX_CONN`](../../kconfig.md#CONFIG_NET_MAX_CONN "CONFIG_NET_MAX_CONN")
...
[`CONFIG_NET_MAX_CONTEXTS`](../../kconfig.md#CONFIG_NET_MAX_CONTEXTS "CONFIG_NET_MAX_CONTEXTS")
...
[`CONFIG_NET_SOCKETPAIR_BUFFER_SIZE`](../../kconfig.md#CONFIG_NET_SOCKETPAIR_BUFFER_SIZE "CONFIG_NET_SOCKETPAIR_BUFFER_SIZE")
...
[`CONFIG_NET_SOCKETS_TLS_MAX_CONTEXTS`](../../kconfig.md#CONFIG_NET_SOCKETS_TLS_MAX_CONTEXTS "CONFIG_NET_SOCKETS_TLS_MAX_CONTEXTS")
:   Maximum number of TLS/DTLS contexts. Each TLS/DTLS connection needs one context.

[`CONFIG_NET_SOCKETS_TLS_MAX_CREDENTIALS`](../../kconfig.md#CONFIG_NET_SOCKETS_TLS_MAX_CREDENTIALS "CONFIG_NET_SOCKETS_TLS_MAX_CREDENTIALS")
:   This variable sets maximum number of TLS/DTLS credentials that can be
    used with a specific socket.

[`CONFIG_NET_SOCKETS_TLS_MAX_CIPHERSUITES`](../../kconfig.md#CONFIG_NET_SOCKETS_TLS_MAX_CIPHERSUITES "CONFIG_NET_SOCKETS_TLS_MAX_CIPHERSUITES")
...
[`CONFIG_NET_SOCKETS_TLS_MAX_APP_PROTOCOLS`](../../kconfig.md#CONFIG_NET_SOCKETS_TLS_MAX_APP_PROTOCOLS "CONFIG_NET_SOCKETS_TLS_MAX_APP_PROTOCOLS")
...
[`CONFIG_NET_SOCKETS_TLS_MAX_CLIENT_SESSION_COUNT`](../../kconfig.md#CONFIG_NET_SOCKETS_TLS_MAX_CLIENT_SESSION_COUNT "CONFIG_NET_SOCKETS_TLS_MAX_CLIENT_SESSION_COUNT")
:   This variable specifies maximum number of stored TLS/DTLS sessions,
    used for TLS/DTLS session resumption.

[`CONFIG_TLS_MAX_CREDENTIALS_NUMBER`](../../kconfig.md#CONFIG_TLS_MAX_CREDENTIALS_NUMBER "CONFIG_TLS_MAX_CREDENTIALS_NUMBER")
...
[`CONFIG_NET_IF_MAX_IPV4_COUNT`](../../kconfig.md#CONFIG_NET_IF_MAX_IPV4_COUNT "CONFIG_NET_IF_MAX_IPV4_COUNT")
...
[`CONFIG_NET_IF_MAX_IPV6_COUNT`](../../kconfig.md#CONFIG_NET_IF_MAX_IPV6_COUNT "CONFIG_NET_IF_MAX_IPV6_COUNT")
:   Maximum number of IPv6 network interfaces in the system.
    This is similar setting as the IPv4 count option but for IPv6.

## [TCP Options](#id7)

[`CONFIG_NET_TCP_TIME_WAIT_DELAY`](../../kconfig.md#CONFIG_NET_TCP_TIME_WAIT_DELAY "CONFIG_NET_TCP_TIME_WAIT_DELAY")
:   How long to wait in TCP *TIME\_WAIT* state (in milliseconds).
    ...
    [RFC 793](https://www.rfc-editor.org/rfc/rfc793) (TCP) suggests
    to keep an old, closed connection in a special *TIME\_WAIT* state for
    ...
    *This is an engineering choice, and may be changed if experience indicates
    ...
    by default. Value of 0 disables *TIME\_WAIT* state completely.

[`CONFIG_NET_TCP_RETRY_COUNT`](../../kconfig.md#CONFIG_NET_TCP_RETRY_COUNT "CONFIG_NET_TCP_RETRY_COUNT")
:   Maximum number of TCP segment retransmissions.
    ...
    \[\sum\_{n=0}^{\mathtt{NET\\_TCP\\_RETRY\\_COUNT}} \bigg(1 \ll n\bigg)\times
    ...
    [RFC 1122](https://www.rfc-editor.org/rfc/rfc1122) (1:40 minutes).
...
[`CONFIG_NET_TCP_MAX_SEND_WINDOW_SIZE`](../../kconfig.md#CONFIG_NET_TCP_MAX_SEND_WINDOW_SIZE "CONFIG_NET_TCP_MAX_SEND_WINDOW_SIZE")
:   Maximum sending window size to use.
    ...
    TCP connections could easily exhaust net\_buf pool for the queued TX data.

[`CONFIG_NET_TCP_MAX_RECV_WINDOW_SIZE`](../../kconfig.md#CONFIG_NET_TCP_MAX_RECV_WINDOW_SIZE "CONFIG_NET_TCP_MAX_RECV_WINDOW_SIZE")
...
[`CONFIG_NET_TCP_RECV_QUEUE_TIMEOUT`](../../kconfig.md#CONFIG_NET_TCP_RECV_QUEUE_TIMEOUT "CONFIG_NET_TCP_RECV_QUEUE_TIMEOUT")
...
[`CONFIG_NET_TC_TX_COUNT`](../../kconfig.md#CONFIG_NET_TC_TX_COUNT "CONFIG_NET_TC_TX_COUNT") option is set to 0 if userspace is
...
option [`CONFIG_NET_TC_RX_COUNT`](../../kconfig.md#CONFIG_NET_TC_RX_COUNT "CONFIG_NET_TC_RX_COUNT") could be set to 0.

## [Stack Size Options](#id9)
...
are setup in the system if the [`CONFIG_NET_MGMT`](../../kconfig.md#CONFIG_NET_MGMT "CONFIG_NET_MGMT") and
[`CONFIG_NET_MGMT_EVENT`](../../kconfig.md#CONFIG_NET_MGMT_EVENT "CONFIG_NET_MGMT_EVENT") options are enabled.
If the options are enabled, the user is able to register a callback function
that the net\_mgmt thread is calling for each network management event.
By default the net\_mgmt event thread stack size is rather small.
...
The net\_mgmt event thread stack size is controlled by
[`CONFIG_NET_MGMT_EVENT_QUEUE_SIZE`](../../kconfig.md#CONFIG_NET_MGMT_EVENT_QUEUE_SIZE "CONFIG_NET_MGMT_EVENT_QUEUE_SIZE") option. It is recommended
