---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/api/ptp.html
...
- [PTP](../../../samples/net/ptp/README.md#ptp "Enable PTP support and monitor messages and events via logging.")Enable PTP support and monitor messages and events via logging.
