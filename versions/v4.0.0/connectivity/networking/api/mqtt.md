---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/api/mqtt.html
...
- [MQTT publisher](../../../samples/net/mqtt_publisher/README.md#mqtt-publisher "Send MQTT PUBLISH messages to an MQTT server.")Send MQTT PUBLISH messages to an MQTT server.
