---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/api/tftp.html
...
- [TFTP client](../../../samples/net/tftp_client/README.md#tftp-client "Use the TFTP client library to get/put files from/to a TFTP server.")Use the TFTP client library to get/put files from/to a TFTP server.
