---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/api/wifi.html
...
in PEM format are committed to the repo at [samples/net/wifi/test\_certs](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/wifi/test_certs) and the during the
