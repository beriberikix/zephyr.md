---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/networking/eth_bridge_native_sim_setup.html
original_path: connectivity/networking/eth_bridge_native_sim_setup.html
---

# Ethernet bridge with native\_sim board
...
[`CONFIG_NET_ETHERNET_BRIDGE`](../../kconfig.md#CONFIG_NET_ETHERNET_BRIDGE "CONFIG_NET_ETHERNET_BRIDGE") Kconfig option. In this setup, the net-tools
configuration creates two host network interfaces `zeth0` and `zeth1` and connects them
to Zephyr’s [native\_sim](../../boards/native/native_sim/doc/index.md#native-sim) application.
...
[Echo server (advanced)](../../samples/net/sockets/echo_server/README.md#sockets-echo-server "Implement a UDP/TCP server that sends received packets back to the sender.") sample application.
...
This will create and run [Echo server (advanced)](../../samples/net/sockets/echo_server/README.md#sockets-echo-server "Implement a UDP/TCP server that sends received packets back to the sender.") with bridging enabled but
