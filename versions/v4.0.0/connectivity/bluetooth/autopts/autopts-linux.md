---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/autopts/autopts-linux.html
...
[![../../../_images/download_nrftools_linux.png](https://docs.zephyrproject.org/4.0.0/_images/download_nrftools_linux.png)
](https://docs.zephyrproject.org/4.0.0/_images/download_nrftools_linux.png)
...
[![../../../_images/virtualbox_nat_1.png](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_nat_1.png)
](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_nat_1.png)
...
[![../../../_images/virtualbox_nat_2.png](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_nat_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_nat_2.png)
...
[![../../../_images/vmware_static_ip_1.png](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_1.png)
](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_1.png)

Open virtual machine network settings. Add custom adapter:

[![../../../_images/vmware_static_ip_2.png](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_2.png)

If you type ‘ifconfig’ in terminal, you should be able to find your host IP:

[![../../../_images/vmware_static_ip_3.png](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_3.png)
](https://docs.zephyrproject.org/4.0.0/_images/vmware_static_ip_3.png)
...
[![../../../_images/virtualbox_static_ip_1.png](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_static_ip_1.png)
](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_static_ip_1.png)

Open virtual machine network settings. On adapter 1 you will have created by default NAT.
Add adapter 2:

[![../../../_images/virtualbox_static_ip_2.png](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_static_ip_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/virtualbox_static_ip_2.png)
...
[![../../../_images/windows_static_ip.png](https://docs.zephyrproject.org/4.0.0/_images/windows_static_ip.png)
](https://docs.zephyrproject.org/4.0.0/_images/windows_static_ip.png)
...
[![../../../_images/usb-devices_output.png](https://docs.zephyrproject.org/4.0.0/_images/usb-devices_output.png)
](https://docs.zephyrproject.org/4.0.0/_images/usb-devices_output.png)
...
[![../../../_images/autoptsserver_run_2.png](https://docs.zephyrproject.org/4.0.0/_images/autoptsserver_run_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/autoptsserver_run_2.png)
...
[![../../../_images/autoptsclient_run_2.png](https://docs.zephyrproject.org/4.0.0/_images/autoptsclient_run_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/autoptsclient_run_2.png)

At the first run, when Windows asks, enable connection through firewall:

[![../../../_images/allow_firewall_2.png](https://docs.zephyrproject.org/4.0.0/_images/allow_firewall_2.png)
](https://docs.zephyrproject.org/4.0.0/_images/allow_firewall_2.png)
...
[![../../../_images/autoptsserver_typical_error.png](https://docs.zephyrproject.org/4.0.0/_images/autoptsserver_typical_error.png)
](https://docs.zephyrproject.org/4.0.0/_images/autoptsserver_typical_error.png)
...
[![../../../_images/pts_automation_window.png](https://docs.zephyrproject.org/4.0.0/_images/pts_automation_window.png)
](https://docs.zephyrproject.org/4.0.0/_images/pts_automation_window.png)
