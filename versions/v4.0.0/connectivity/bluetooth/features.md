---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/features.html
original_path: connectivity/bluetooth/features.html
---
...
- Bluetooth v5.3 compliant
  ...
  - Support for [all combinations](bluetooth-dev.md#bluetooth-hw-setup) of Host and
    Controller builds:
...
- [Bluetooth-SIG qualifiable](bluetooth-qual.md#bluetooth-qual)

  - Conformance tests run regularly on all layers (Controller and Host, except
    BT Classic) on Nordic Semiconductor hardware.
- [Bluetooth Low Energy Controller](bluetooth-ctlr-arch.md#bluetooth-ctlr-arch) (LE Link Layer)
...
- [Bluetooth Host](bluetooth-le-host.md#bluetooth-le-host)
  ...
  - Isochronous channels
  - [LE Audio](api/audio/bluetooth-le-audio-arch.md#bluetooth-le-audio-arch)
