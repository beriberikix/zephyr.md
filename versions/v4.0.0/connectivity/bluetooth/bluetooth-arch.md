---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/bluetooth-arch.html
...
- **Controller-only build**: When built as a BLE Controller, Zephyr includes
  ...
  - [HCI UART](../../samples/bluetooth/hci_uart/README.md#bluetooth_hci_uart "Expose a Bluetooth controller to another device or CPU over UART.")
  ...
  - [HCI SPI](../../samples/bluetooth/hci_spi/README.md#bluetooth_hci_spi "Expose a Bluetooth controller to another device or CPU over SPI.")
...
![BLE Combined build on a single chip](https://docs.zephyrproject.org/4.0.0/_images/ble_cfg_single.png)
...
![BLE dual-chip configuration builds](https://docs.zephyrproject.org/4.0.0/_images/ble_cfg_dual.png)
...
[HCI UART](../../samples/bluetooth/hci_uart/README.md#bluetooth_hci_uart "Expose a Bluetooth controller to another device or CPU over UART."), or the
[HCI SPI](../../samples/bluetooth/hci_spi/README.md#bluetooth_hci_spi "Expose a Bluetooth controller to another device or CPU over SPI.") app to provide an interface to
the BLE Controller.
...
:   [The host stack](bluetooth-le-host.md#bluetooth-le-host). This is where the HCI command and
...
:   [Bluetooth LE Controller](bluetooth-ctlr-arch.md#bluetooth-ctlr-arch) implementation.
    Implements the controller-side of HCI, the Link Layer as well as access to the
    radio transceiver.

`include/bluetooth/`
:   [Public API](api/index.md#bluetooth-api) header files. These are the header files
...
`samples/bluetooth/`
:   [Sample Bluetooth code](../../samples/bluetooth/bluetooth.md#bluetooth). This is a good reference to
