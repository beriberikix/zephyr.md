...
![Bluetooth Host protocol & profile layers](https://docs.zephyrproject.org/4.0.0/_images/ble_host_layers.png)
...
![ATT timeout](https://docs.zephyrproject.org/4.0.0/_images/att_timeout.svg)
