---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/api/audio/shell/bap_broadcast_assistant.html
original_path: connectivity/bluetooth/api/audio/shell/bap_broadcast_assistant.html
---
...
[`CONFIG_BT_BAP_BROADCAST_ASSISTANT_LOG_LEVEL_DBG`](../../../../../kconfig.md#CONFIG_BT_BAP_BROADCAST_ASSISTANT_LOG_LEVEL_DBG "CONFIG_BT_BAP_BROADCAST_ASSISTANT_LOG_LEVEL_DBG") enabled for
...
the connected device calling `bap_broadcast_assistant discover`, which
...
#### Adding a source to the receive state with add\_src:
...
#### Adding a source to the receive state with add\_broadcast\_id (recommended):
