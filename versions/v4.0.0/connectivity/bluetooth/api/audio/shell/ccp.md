---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/api/audio/shell/ccp.html
original_path: connectivity/bluetooth/api/audio/shell/ccp.html
---
...
It is necessary to have [`CONFIG_BT_TBS_CLIENT_LOG_LEVEL_DBG`](../../../../../kconfig.md#CONFIG_BT_TBS_CLIENT_LOG_LEVEL_DBG "CONFIG_BT_TBS_CLIENT_LOG_LEVEL_DBG")
...
discover TBS on the connected device calling `tbs_client discover`, which
...
Since a server may have multiple TBS instances, most of the tbs\_client commands
...
It is necessary to have [`CONFIG_BT_TBS_LOG_LEVEL_DBG`](../../../../../kconfig.md#CONFIG_BT_TBS_LOG_LEVEL_DBG "CONFIG_BT_TBS_LOG_LEVEL_DBG") enabled
...
or the TBS server may initiate a call to remote device, without a TBS\_CLIENT client.
The TBS implementation is capable of fully controlling any call.
Omitting an index for commands where a `<instance_index>` can be supplied, defaults to the
GTBS bearer.
