---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/api/mesh/brg_cfg.html
...
the [`CONFIG_BT_MESH_RELAY_BUF_COUNT`](../../../../kconfig.md#CONFIG_BT_MESH_RELAY_BUF_COUNT "CONFIG_BT_MESH_RELAY_BUF_COUNT") option should be increased accordingly.

However, if the [`CONFIG_BT_MESH_RELAY`](../../../../kconfig.md#CONFIG_BT_MESH_RELAY "CONFIG_BT_MESH_RELAY") feature is disabled, the messages will be
allocated from the advertising buffer instead. In this case, increase the
[`CONFIG_BT_MESH_ADV_BUF_COUNT`](../../../../kconfig.md#CONFIG_BT_MESH_ADV_BUF_COUNT "CONFIG_BT_MESH_ADV_BUF_COUNT") option to allow for sufficient buffer space.
