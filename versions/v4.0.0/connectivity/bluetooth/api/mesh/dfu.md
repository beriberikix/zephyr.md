---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/bluetooth/api/mesh/dfu.html
...
![Graphic overview of the DFU roles mesh nodes can have during the process of image distribution](https://docs.zephyrproject.org/4.0.0/_images/dfu_roles_mesh.svg)
...
:   The firmware metadata is used by the Target node to determine whether it should accept an
    ...
    ([`bt_mesh_dfu_metadata`](../../../../doxygen/html/structbt__mesh__dfu__metadata.md)) together with a set of related functions that can be used by
...
re-provisioned. The complete list of available options is defined in [`bt_mesh_dfu_effect`](../../../../doxygen/html/group__bt__mesh__dfu.md#gae7d7ef4ed1e65e5f8e1641a9c00bb7e8):

[`BT_MESH_DFU_EFFECT_NONE`](../../../../doxygen/html/group__bt__mesh__dfu.md#ggae7d7ef4ed1e65e5f8e1641a9c00bb7e8af8fba9033b663ce141c099b48128b22e)
...
[`BT_MESH_DFU_EFFECT_COMP_CHANGE_NO_RPR`](../../../../doxygen/html/group__bt__mesh__dfu.md#ggae7d7ef4ed1e65e5f8e1641a9c00bb7e8a399d11f493d538d6d11a6aee927015dc)
...
[`BT_MESH_DFU_EFFECT_COMP_CHANGE`](../../../../doxygen/html/group__bt__mesh__dfu.md#ggae7d7ef4ed1e65e5f8e1641a9c00bb7e8a049447eb32bcc0b1b18d5ae908de30b8)
...
[`BT_MESH_DFU_EFFECT_UNPROV`](../../../../doxygen/html/group__bt__mesh__dfu.md#ggae7d7ef4ed1e65e5f8e1641a9c00bb7e8a11e843036db6bcae565c07ace00c9211)
...
Update Server model calls the [`bt_mesh_dfu_srv_cb.check`](../../../../doxygen/html/structbt__mesh__dfu__srv__cb.md#afbde918804e66160ffa176c206540027) callback, the application can
then process the metadata and provide the effect value. If the effect is
[`BT_MESH_DFU_EFFECT_COMP_CHANGE`](../../../../doxygen/html/group__bt__mesh__dfu.md#ggae7d7ef4ed1e65e5f8e1641a9c00bb7e8a049447eb32bcc0b1b18d5ae908de30b8), the application must call functions
[`bt_mesh_comp_change_prepare()`](../../../../doxygen/html/group__bt__mesh__access.md#ga8575f680e77d86d6c85cac27985b9f3c) and [`bt_mesh_models_metadata_change_prepare()`](../../../../doxygen/html/group__bt__mesh__access.md#ga26ac86bdd32d27e0091735d98670687a) to
...
![Overview of DFU stages and procedures](https://docs.zephyrproject.org/4.0.0/_images/dfu_stages_procedures_mesh.svg)
