---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/usb/device/api/usb_dc.html
...
and is being replaced by [USB device controller (UDC) driver API](../../device_next/api/udc.md#udc-api).
