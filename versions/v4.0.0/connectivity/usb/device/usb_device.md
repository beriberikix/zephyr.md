---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/connectivity/usb/device/usb_device.html
...
[New USB device support APIs](../device_next/api/index.md#usb-device-next-api), will become the default in Zephyr v4.1.0.
...
| [HCI H4 over USB](../../../samples/bluetooth/hci_usb_h4/README.md#bluetooth_hci_usb_h4 "Turn a Zephyr board into a USB H4 Bluetooth dongle (Linux/BlueZ only).") | 0x000C |
