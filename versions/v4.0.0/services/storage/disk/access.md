---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/storage/disk/access.html
...
- [`DISK_IOCTL_CTRL_INIT`](../../../doxygen/html/group__disk__driver__interface.md#ga9def34b23915a3ce6c9a8a746d3d1372): Initialize the disk. Must be called before
  additional I/O operations can be run on the disk device. Equivalent to
  calling the legacy function [`disk_access_init()`](../../../doxygen/html/group__disk__access__interface.md#gaba3fead8c0ce65945b440bf824fd4144).
- [`DISK_IOCTL_CTRL_DEINIT`](../../../doxygen/html/group__disk__driver__interface.md#gaf13b377592baace863070fee450bd5be): De-initialize the disk. Once this IOCTL
  is issued, the [`DISK_IOCTL_CTRL_INIT`](../../../doxygen/html/group__disk__driver__interface.md#ga9def34b23915a3ce6c9a8a746d3d1372) must be issued before
...
[`DISK_IOCTL_CTRL_DEINIT`](../../../doxygen/html/group__disk__driver__interface.md#gaf13b377592baace863070fee450bd5be) IOCTL. This is an unsafe operation which
...
de-initialize the disk and can instead call [`fs_unmount()`](../../../doxygen/html/group__file__system__api.md#gabc20c3ce66340c4c207aba3c88448fbf)
...
[include/zephyr/fs/fs.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/fs/fs.h) such as [`fs_open()`](../../../doxygen/html/group__file__system__api.md#ga9c90031ba3e5a10da8e00e81d53ef63b),
[`fs_read()`](../../../doxygen/html/group__file__system__api.md#gaba7e07127777187eedcd6976d352ab76), and [`fs_write()`](../../../doxygen/html/group__file__system__api.md#ga9e0dccc0d4235ff8bc4a745bc697e808).
...
[Disk Driver Interface](../../../doxygen/html/group__disk__driver__interface.md)
