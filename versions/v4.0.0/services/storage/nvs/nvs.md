---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/storage/nvs/nvs.html
...
- [Non-Volatile Storage (NVS)](../../../samples/subsys/nvs/README.md#nvs "Store and retrieve data from flash using the NVS API.")Store and retrieve data from flash using the NVS API.
