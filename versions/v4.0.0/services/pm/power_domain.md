---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/pm/power_domain.html
original_path: services/pm/power_domain.html
---
...
option [`CONFIG_PM_DEVICE_POWER_DOMAIN`](../../kconfig.md#CONFIG_PM_DEVICE_POWER_DOMAIN "CONFIG_PM_DEVICE_POWER_DOMAIN") has to be set.
...
[`PM_DEVICE_ACTION_TURN_ON`](../../doxygen/html/group__subsys__pm__device.md#ggaee5546eacb9be7caa9d59ab63926cc4cac7690e0ffd27742acf58fdbdb7b89544) or
[`PM_DEVICE_ACTION_TURN_OFF`](../../doxygen/html/group__subsys__pm__device.md#ggaee5546eacb9be7caa9d59ab63926cc4ca2bcd7dee3a85b27157bbc465bacf521e) respectively. This
...
domain [label="gpio\_domain"]
action -> devA [label="pm\_device\_get()"]
devA:se -> domain:n [label="pm\_device\_get()"]
domain -> devB [label="action\_cb(PM\_DEVICE\_ACTION\_TURN\_ON)"]
domain:sw -> devA:sw [label="action\_cb(PM\_DEVICE\_ACTION\_TURN\_ON)"]
}

Power domain work flow
...
[Power domain work flow](#pm-domain-work-flow) as example, the following code defines a
