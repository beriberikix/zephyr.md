---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/portability/posix/implementation/index.html
original_path: services/portability/posix/implementation/index.html
---
...
build time. See [System Calls](../../../../kernel/usermode/syscalls.md#syscalls) for more information.
...
- POSIX API calls should be provided as regular callable C functions; if a Zephyr
  [System Call](../../../../kernel/usermode/syscalls.md#syscalls) is needed as part of the implementation, the declaration and the
