---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/resource_management/index.html
...
use [`onoff_sync_service`](../../doxygen/html/structonoff__sync__service.md) and its supporting API rather than
[`onoff_manager`](../../doxygen/html/structonoff__manager.md), with only a small reduction in functionality
