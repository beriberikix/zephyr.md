---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/services/tfm/integration.html
original_path: services/tfm/integration.html
---
...
the [`CONFIG_BUILD_WITH_TFM`](../../kconfig.md#CONFIG_BUILD_WITH_TFM "CONFIG_BUILD_WITH_TFM") flag is set to `y`.
...
processing environment. [`CONFIG_TFM_BOARD`](../../kconfig.md#CONFIG_TFM_BOARD "CONFIG_TFM_BOARD") must also be set via
[modules/trusted-firmware-m/Kconfig.tfm](https://github.com/zephyrproject-rtos/zephyr/blob/main/modules/trusted-firmware-m/Kconfig.tfm)
...
- [`CONFIG_TRUSTED_EXECUTION_NONSECURE`](../../kconfig.md#CONFIG_TRUSTED_EXECUTION_NONSECURE "CONFIG_TRUSTED_EXECUTION_NONSECURE") `y`
- [`CONFIG_ARM_TRUSTZONE_M`](../../kconfig.md#CONFIG_ARM_TRUSTZONE_M "CONFIG_ARM_TRUSTZONE_M") `y`

Comparing the [boards/arm/mps2/mps2\_an521\_cpu0.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps2/mps2_an521_cpu0.dts) and
[boards/arm/mps2/mps2\_an521\_cpu0\_ns.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mps2/mps2_an521_cpu0_ns.dts) files,
...
[`CONFIG_TFM_BOARD`](../../kconfig.md#CONFIG_TFM_BOARD "CONFIG_TFM_BOARD").
