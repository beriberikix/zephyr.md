---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/sensor/fdc2x1x/README.html
original_path: samples/sensor/fdc2x1x/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/fdc2x1x/README.rst/..)
...
For detailed description refer to the [FDC2X1X datasheet](https://www.ti.com/lit/gpn/fdc2114)
at pages 4-5.
...
In this example the [nRF9160 DK](../../../boards/nordic/nrf9160dk/doc/index.md#nrf9160dk-nrf9160) board is used. The devicetree
overlay of this board provides example settings for evaluation, which
you can use as a reference for other platforms.

```shell
west build -b nrf9160dk/nrf9160 samples/sensor/fdc2x1x
west flash
```
...
:   [https://www.ti.com/product/FDC2114](https://www.ti.com/product/FDC2114)
