---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/sensor/lps22hh_i3c/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/lps22hh_i3c/README.rst/..)
...
STEVALMKI192-V1 connected to the I3C header on [MIMXRT685-EVK](../../../boards/nxp/mimxrt685_evk/doc/index.md#mimxrt685_evk).
...
### Building on mimxrt685\_evk board

```shell
west build -b mimxrt685_evk/mimxrt685s/cm33 samples/sensor/lps22hh_i3c
```
...
On the board [MIMXRT685-EVK](../../../boards/nxp/mimxrt685_evk/doc/index.md#mimxrt685_evk), the I3C pins are exposed on the J18
header, where:
