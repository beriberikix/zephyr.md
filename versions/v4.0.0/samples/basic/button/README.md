---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/basic/button/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/basic/button/README.rst/..)
...
If you are looking into an implementation of button events with
debouncing, check out [Input](../../../services/input/index.md#input) and [Input dump](../../subsys/input/input_dump/README.md#input-dump "Print all input events.")
instead.

## Requirements

The board hardware must have a push button connected via a GPIO pin. These are
called “User buttons” on many of Zephyr’s [Supported Boards and Shields](../../../boards/index.md#boards).
