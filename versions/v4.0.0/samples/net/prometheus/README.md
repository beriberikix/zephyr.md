---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/net/prometheus/README.html
original_path: samples/net/prometheus/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/prometheus/README.rst/..)
...
See [Prometheus client library documentation](https://prometheus.io/docs/instrumenting/clientlibs/).
...
[Prometheus API](../../../doxygen/html/group__prometheus.md)
