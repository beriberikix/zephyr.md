---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/net/mqtt_sn_publisher/README.html
...
Open the `prj.conf` file and set the IP addresses according
to the LAN environment.

You will also need to start an MQTT-SN gateway. With Paho, you can either
build it from source - see [PAHO MQTT-SN Gateway](https://www.eclipse.org/paho/index.php?page=components/mqtt-sn-transparent-gateway/index.php) - or run an unofficial
docker image, like [kyberpunk/paho](https://hub.docker.com/r/kyberpunk/paho).
