---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/net/net.html
...
- [OpenThread co-processor](openthread/coprocessor/README.md#coprocessor "Build a Thread border-router using OpenThread's co-processor designs.")Build a Thread border-router using OpenThread's co-processor designs.
