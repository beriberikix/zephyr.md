---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/net/tftp_client/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/tftp_client/README.rst/..)
