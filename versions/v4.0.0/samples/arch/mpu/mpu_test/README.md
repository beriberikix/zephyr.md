---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/arch/mpu/mpu_test/README.html
original_path: samples/arch/mpu/mpu_test/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/arch/mpu/mpu_test/README.rst/..)
...
```shell
west build -b v2m_beetle samples/arch/mpu/mpu_test
west flash
```
...
```shell
west build -b v2m_beetle samples/arch/mpu/mpu_test -- -DCONF_FILE=prj_single.conf
west build -t run
```
