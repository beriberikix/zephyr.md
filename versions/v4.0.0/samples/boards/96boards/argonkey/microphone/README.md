---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/boards/96boards/argonkey/microphone/README.html
original_path: samples/boards/96boards/argonkey/microphone/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/96boards/argonkey/microphone/README.rst/..)
...
```shell
west build -b 96b_argonkey samples/boards/96boards/argonkey/microphone
west build -t run
```
...
See pcm and pdm configuration in file [samples/boards/96boards/argonkey/microphone/src/main.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/96boards/argonkey/microphone/src/main.c).
...
following macro, off by default, in [samples/boards/96boards/argonkey/microphone/src/main.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/96boards/argonkey/microphone/src/main.c):
