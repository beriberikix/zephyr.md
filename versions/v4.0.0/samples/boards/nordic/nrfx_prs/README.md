---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/boards/nordic/nrfx_prs/README.html
original_path: samples/boards/nordic/nrfx_prs/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/nrfx_prs/README.rst/..)
...
[samples/boards/nordic/nrfx\_prs/boards](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nordic/nrfx_prs/boards) directory to check which pins
...
The code can be found in [samples/boards/nordic/nrfx\_prs](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nordic/nrfx_prs).

To build and flash the application:

```shell
west build -b nrf9160dk/nrf9160 samples/boards/nordic/nrfx_prs
west flash
```
