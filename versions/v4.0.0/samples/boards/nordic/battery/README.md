---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/boards/nordic/battery/README.html
original_path: samples/boards/nordic/battery/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/battery/README.rst/..)
...
The code can be found in [samples/boards/nordic/battery](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nordic/battery).

```shell
west build -b thingy52/nrf52832 samples/boards/nordic/battery
west flash
```
