---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/boards/nordic/nrf53_sync_rtc/README.html
original_path: samples/boards/nordic/nrf53_sync_rtc/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/nrf53_sync_rtc/README.rst/..)
...
west build -b nrf5340dk/nrf5340/cpuapp --sysbuild samples/boards/nordic/nrf53_sync_rtc
west flash --hex-file build/nrf53_sync_rtc/zephyr/zephyr.hex
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim/nrf5340/cpuapp --sysbuild samples/boards/nordic/nrf53_sync_rtc
```
