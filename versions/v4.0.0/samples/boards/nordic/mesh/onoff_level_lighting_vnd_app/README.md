---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/boards/nordic/mesh/onoff_level_lighting_vnd_app/README.html
original_path: samples/boards/nordic/mesh/onoff_level_lighting_vnd_app/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/mesh/onoff_level_lighting_vnd_app/README.rst/..)
...
This sample can be found under [samples/boards/nordic/mesh/onoff\_level\_lighting\_vnd\_app](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nordic/mesh/onoff_level_lighting_vnd_app) in the
Zephyr tree.

The following commands build the application.

```shell
west build -b nrf52840dk/nrf52840 samples/boards/nordic/mesh/onoff_level_lighting_vnd_app
west flash
```
...
See [Bluetooth](../../../../bluetooth/bluetooth.md#bluetooth) samples for details.
