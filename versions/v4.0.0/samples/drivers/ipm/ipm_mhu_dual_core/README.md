---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/drivers/ipm/ipm_mhu_dual_core/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/drivers/ipm/ipm_mhu_dual_core/README.rst/..)
...
```shell
west build -b v2m_musca_b1/musca_b1 samples/drivers/ipm/ipm_mhu_dual_core
west build -t run
```
...
```shell
west build -b v2m_musca_b1/musca_b1/ns samples/drivers/ipm/ipm_mhu_dual_core
west build -t run
```
