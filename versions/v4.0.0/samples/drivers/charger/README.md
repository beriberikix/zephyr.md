---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/drivers/charger/README.html
original_path: samples/drivers/charger/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/drivers/charger/README.rst/..)

## Overview

This sample demonstrates how to use the [Chargers](../../../hardware/peripherals/charger.md#charger-api) API.
