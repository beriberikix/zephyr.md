---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/usb_c/sink/README.html
original_path: samples/subsys/usb_c/sink/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/usb_c/sink/README.rst/..)
...
negotiates with the charger to provide [5V@100mA](mailto:5V%40100mA) and displays all
...
The sample has been tested on [B-G474E-DPOW1 Discovery](../../../../boards/st/b_g474e_dpow1/doc/index.md#b_g474e_dpow1) and
[STM32G081B Evaluation](../../../../boards/st/stm32g081b_eval/doc/index.md#stm32g081b_eval). Overlay files for the two boards
are provided.
...
```shell
west build -b b_g474e_dpow1 samples/subsys/usb_c/sink
west flash
```
