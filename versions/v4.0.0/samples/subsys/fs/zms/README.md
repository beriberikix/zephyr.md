---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/fs/zms/README.html
...
> of data.
>
> Each DELETE\_ITERATION period, we delete all set of data and verify that it has been deleted.
