---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/llext/shell_loader/README.html
...
You may need to disable memory protection for the sample to work (e.g. CONFIG\_ARM\_MPU=n).
...
A hello world C file can be found in tests/subsys/llext/hello\_world/hello\_world.c
...
In this sample there are 3 absolute (R\_ARM\_ABS32) relocations, 2 of which are meant to hold addresses into the .rodata sections where the strings are located. A third is an address of where the printk function (symbol) can be found. At load time llext replaces the values in the .text section with real memory addresses so that printk works as expected with the strings included in the hello world sample.
