---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/llext/edk/README.html
original_path: samples/subsys/llext/edk/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/llext/edk/README.rst/..)
...
based on [Zbus](../../../../services/zbus/index.md#zbus), which extensions use to communicate with each other.
...
the [`CONFIG_LLEXT_EDK_USERSPACE_ONLY`](../../../../kconfig.md#CONFIG_LLEXT_EDK_USERSPACE_ONLY "CONFIG_LLEXT_EDK_USERSPACE_ONLY") option disabled.
...
The [`ZEPHYR_SDK_INSTALL_DIR`](../../../../develop/env_vars.md#envvar-ZEPHYR_SDK_INSTALL_DIR) environment variable is used by the
