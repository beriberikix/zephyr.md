---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/usb/dfu/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/usb/dfu/README.rst/..)
...
Build and sign a second application image e.g. [Hello World](../../../hello_world/README.md#hello_world "Print "Hello World" to the console."),
