---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/usb/hid-mouse/README.html
original_path: samples/subsys/usb/hid-mouse/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/usb/hid-mouse/README.rst/..)
...
This sample can be found under [samples/subsys/usb/hid-mouse](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/usb/hid-mouse) in the
Zephyr project tree.

## Requirements

This project requires an USB device driver and uses the [Input](../../../../services/input/index.md#input) API.
There must be a [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) group of buttons or keys defined at
...
(see the [Ubuntu evtest man page](http://manpages.ubuntu.com/manpages/trusty/man1/evtest.1.html) for more information about this tool):
