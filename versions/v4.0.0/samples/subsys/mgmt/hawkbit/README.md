---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/subsys/mgmt/hawkbit/README.html
original_path: samples/subsys/mgmt/hawkbit/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/mgmt/hawkbit/README.rst/..)
...
access the sample source code for this hawkbit\_polling.
...
source code for this mode hawkbit\_manual

## Caveats

- The Zephyr port of hawkBit is configured to run on a
  [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) MCU by default. The application should
...
- The MCUboot bootloader is required for hawkBit to function properly.
  ...
  can be found in [MCUboot](../../../../services/device_mgmt/dfu.md#mcuboot).
...
Build MCUboot by following the instructions in the [MCUboot](../../../../services/device_mgmt/dfu.md#mcuboot) documentation
page.
...
hawkBit can be built for the [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) as follows:
...
Upload the `zephyr.signed.confirmed.bin` file to image slot-0
of your board.
...
This time you need the file `zephyr.signed.bin` from the build directory.
...
- Convert the server.pem file to self\_sign.der and place the der file in
  hawkbit/src directory

`hawkBit https` can be built for the [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) as follows:
