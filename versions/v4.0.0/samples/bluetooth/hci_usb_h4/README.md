---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/bluetooth/hci_usb_h4/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/hci_usb_h4/README.rst/..)

## Overview

Make a USB H4 Bluetooth dongle out of Zephyr. Requires USB device support from
the board it runs on (e.g. [nRF52840 DK](../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk-nrf52840) supports both Bluetooth LE and
USB).
