---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/bluetooth/iso_connected_benchmark/README.html
original_path: samples/bluetooth/iso_connected_benchmark/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/iso_connected_benchmark/README.rst/..)
...
- A remote board running the same sample as the reversed role that supports
  setting CONFIG\_BT\_CTLR\_PERIPHERAL\_ISO=y

## Building and running

This sample can be found under
[samples/bluetooth/iso\_connected\_benchmark](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/iso_connected_benchmark) in the Zephyr tree.
...
1. Connect to both boards with a terminal emulator (for example, PuTTY or
   minicom).
2. Reset both boards.
3. In one of the terminal emulators, type “c” to start the application on the
   connected board in the central role.
4. In the other terminal emulator, type “p” to start the application in the
   peripheral role.
5. Optionally modify the central ISO settings using the console.
6. Observe that the central and the peripheral connects.
7. Observe the receive statistics on the devices (the connected ISO channels may
