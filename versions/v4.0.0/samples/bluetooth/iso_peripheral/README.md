---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/bluetooth/iso_peripheral/README.html
original_path: samples/bluetooth/iso_peripheral/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/iso_peripheral/README.rst/..)
...
It is recommended to run this sample together with the [ISO (Central)](../iso_central/README.md#ble_central_iso "Transfer isochronous data to a peer device using an isochronous channel as a central.") sample.
...
This sample can be found under [samples/bluetooth/iso\_peripheral](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/iso_peripheral) in the Zephyr tree.
