---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/bluetooth/cap_acceptor/README.html
original_path: samples/bluetooth/cap_acceptor/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/cap_acceptor/README.rst/..)
...
This sample can be found under [samples/bluetooth/cap\_acceptor](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/cap_acceptor) in the Zephyr tree.
...
west build -b nrf5340dk/nrf5340/cpuapp --sysbuild samples/bluetooth/cap_acceptor/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340dk/nrf5340/cpuapp samples/bluetooth/cap_acceptor/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim/nrf5340/cpuapp --sysbuild samples/bluetooth/cap_acceptor/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/cap_acceptor/ -- -DEXTRA_CONF_FILE=overlay-bt_ll_sw_split.conf
```
