---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/bluetooth/iso_broadcast_benchmark/README.html
original_path: samples/bluetooth/iso_broadcast_benchmark/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/iso_broadcast_benchmark/README.rst/..)
...
- A remote board running the same sample as the reversed role that supports
  setting CONFIG\_BT\_CTLR\_SYNC\_ISO

## Building and running

This sample can be found under
[samples/bluetooth/iso\_broadcast\_benchmark](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/iso_broadcast_benchmark) in the Zephyr tree.
...
1. Connect to both boards with a terminal emulator (for example, PuTTY or
   minicom).
2. Reset both boards.
3. In one of the terminal emulators, type “r” to start the application on the
   connected board in the receiver role.
4. In the other terminal emulator, type “b” to start the application in the
   broadcaster role.
5. Optionally modify the broadcasting settings.
6. Observe that the receiver synchronizes to the broadcaster.
7. Observe the receive statistics on the receiver(s).
