---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/modules/tflite-micro/hello_world/README.html
original_path: samples/modules/tflite-micro/hello_world/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/modules/tflite-micro/hello_world/README.rst/..)
...
[the TensorFlow Hello World sample for Zephyr](https://github.com/tensorflow/tflite-micro/tree/main/tensorflow/lite/micro/examples/hello_world).
...
the [`PATH`](../../../../develop/env_vars.md#envvar-PATH) variable, then building and testing can be done with following
commands.
...
Kconfig option is only set for Arm Cortex-M cores, i.e. option CPU\_CORTEX\_M is set.
