---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/samples/tfm_integration/psa_crypto/README.html
original_path: samples/tfm_integration/psa_crypto/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/tfm_integration/psa_crypto/README.rst/..)
...
of the RTOS vendor requirements for a [PSA Certified Level 1](https://www.psacertified.org/security-certification/psa-certified-level-1/) product, such
...
1. Build Zephyr with a non-secure configuration
   ...
   make
   ```
2. Copy application binary files (mcuboot.bin and tfm\_sign.bin) to
