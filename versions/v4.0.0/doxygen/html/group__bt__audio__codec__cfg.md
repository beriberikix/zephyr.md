---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__bt__audio__codec__cfg.html
...
:   | 0 | if the flag was found |
    | --- | --- |
    | -EINVAL | if arguments are invalid |
    | -ENODATA | if the flag was not found |
...
Return values
:   | length | The data\_len of `codec_cap` on success |
    | --- | --- |
    | -EINVAL | if arguments are invalid |
...
Return values
:   | length | The data\_len of `codec_cfg` on success |
    | --- | --- |
    | -EINVAL | if arguments are invalid |
    | -ENOMEM | if the new value could not set or added due to memory |
