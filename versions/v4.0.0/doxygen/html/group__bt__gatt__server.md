---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__bt__gatt__server.html
...
| Enumerations | |
| --- | --- |
| enum | { [BT\_GATT\_ITER\_STOP](#ggab94ce0108483b70392b31a621aa0712aaa3f2a25e27c7065a2c7bb2a9ff09542e) = 0 , [BT\_GATT\_ITER\_CONTINUE](#ggab94ce0108483b70392b31a621aa0712aaea569feffa4815d3443e12be78c684f5) } |
...
{[BT\_GATT\_CCC\_INITIALIZER](#ga59fd77199435e461e03a80c7121bb869)(\_changed, NULL, NULL)}), \_perm)
...
[bt\_gatt\_attr\_read\_cep](#ga5893166f1b24f437a94ccf1fc57c7917), NULL, (void \*)\_value)
...
[bt\_gatt\_attr\_read\_chrc](#gad58b526a06334530c13292d14a11257c), NULL, \
...
[bt\_gatt\_attr\_read\_cpf](#ga5ae96590a0aaa5c4c3863a4a14d80fdd), NULL, (void \*)\_value)
...
[bt\_gatt\_attr\_read\_included](#ga4313a63decac2c8b7c4a1764df3d53ea), NULL, \_service\_incl)
...
[bt\_gatt\_attr\_read\_service](#gacae81c0f272bad7e6ac93c0d13b678c6), NULL, (void \*)\_service)
...
Returns
:   [BT\_GATT\_ITER\_CONTINUE](#ggab94ce0108483b70392b31a621aa0712aaea569feffa4815d3443e12be78c684f5) if should continue to the next attribute.
:   [BT\_GATT\_ITER\_STOP](#ggab94ce0108483b70392b31a621aa0712aaa3f2a25e27c7065a2c7bb2a9ff09542e) to stop.
...
## [◆ ](#gab94ce0108483b70392b31a621aa0712a)anonymous enum
...
Note
:   Only use this with attributes which user\_data is a [bt\_gatt\_chrc](structbt__gatt__chrc.md "Characteristic Attribute Value.").
...
Note
:   The user\_data of the attribute must of type [bt\_gatt\_chrc](structbt__gatt__chrc.md "bt_gatt_chrc").
...
:   | conn | Connection object. |
    ...
    | len | Buffer length. |
    | offset | Start offset. |
    | [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9) | Write flags. |
...
Returns
:   The string representation of the GATT error code. If
...
Parameters
:   | conn | Target client. Notifying all connected clients by passing NULL is not yet supported, please use [bt\_gatt\_notify](#ga74ee552864c563aa5bc939f37395c14a) instead. |
    | --- | --- |
...
Register GATT service. Applications can make use of macros such as [BT\_GATT\_PRIMARY\_SERVICE](#gaacada0ff1029af959b6fcd6703d4a0bf), [BT\_GATT\_CHARACTERISTIC](#ga9e739546dbd906d3b3c4f1ed5ad9f41e), [BT\_GATT\_DESCRIPTOR](#ga83207fc083454327004f7d3c3e5b3840), etc.
...
then all services that should have bond configuration loaded, i.e. CCC values, must be registered before calling [settings\_load](group__settings.md#ga89c6d618df81f197cc5c1a2018b00648 "settings_load").
