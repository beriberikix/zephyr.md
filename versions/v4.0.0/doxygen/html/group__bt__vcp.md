---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__bt__vcp.html
original_path: doxygen/html/group__bt__vcp.html
---
...
```
CONFIG_BT_VCP_VOL_CTLR_VOCS
```

or

```
CONFIG_BT_VCP_VOL_CTLR_AICS
```
