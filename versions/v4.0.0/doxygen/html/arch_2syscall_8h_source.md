---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/arch_2syscall_8h_source.html
...
12#if defined(CONFIG\_X86\_64)

13#include <[zephyr/arch/x86/intel64/syscall.h](arch_2x86_2intel64_2syscall_8h.md)>

14#elif defined(CONFIG\_X86)

15#include <[zephyr/arch/x86/ia32/syscall.h](arch_2x86_2ia32_2syscall_8h.md)>
...
21#include <[zephyr/arch/arc/syscall.h](arch_2arc_2syscall_8h.md)>

22#elif defined(CONFIG\_RISCV)

23#include <[zephyr/arch/riscv/syscall.h](arch_2riscv_2syscall_8h.md)>

24#elif defined(CONFIG\_XTENSA)

25#include <[zephyr/arch/xtensa/syscall.h](arch_2xtensa_2syscall_8h.md)>

26#endif

27

28#endif /\* ZEPHYR\_INCLUDE\_ARCH\_SYSCALL\_H\_ \*/
