---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/socket__select_8h_source.html
...
53 .tv\_sec = (timeout == NULL) ? 0 : timeout->tv\_sec,

54 .tv\_nsec = (long)((timeout == NULL) ? 0 : timeout->tv\_usec \* [NSEC\_PER\_USEC](group__clock__apis.md#ga2180f263d149841a7c1fde663edb84c5))};

55

56 return [zvfs\_select](fdtable_8h.md#a8ced1fc0adbdf35b71ec486a8ec68665)(nfds, readfds, writefds, exceptfds, (timeout == NULL) ? NULL : &to,
...
125#ifdef CONFIG\_NET\_SOCKETS\_POSIX\_NAMES

126

127#define fd\_set zsock\_fd\_set

128#define FD\_SETSIZE ZSOCK\_FD\_SETSIZE

129

130static inline int [select](select_8h.md#a7ffa34f8c9a12e7fd43f5ef65bf889fa)(int nfds, [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*readfds,

131 [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*writefds, [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*exceptfds,

132 struct [timeval](structtimeval.md) \*timeout)

133{

134 return [zsock\_select](group__bsd__sockets.md#ga1a065da89061bcb10b10663a9ffbdd10)(nfds, readfds, writefds, exceptfds, timeout);

135}

136

137static inline void [FD\_ZERO](select_8h.md#a3f88268fa19b2068723de10d848e8a42)([zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*set)

138{

139 [ZSOCK\_FD\_ZERO](group__bsd__sockets.md#gaa4855f07c1329a150f371044e4384490)(set);

140}

141

142static inline int [FD\_ISSET](select_8h.md#ac38fe1ff5db5e46e778f13ad5accdf98)(int fd, [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*set)

143{

144 return [ZSOCK\_FD\_ISSET](group__bsd__sockets.md#gab92b08adccc22a85e7a1c06bf11a88bc)(fd, set);

145}

146

147static inline void [FD\_CLR](select_8h.md#a0835759308c63ca23a1760980eea21d7)(int fd, [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*set)

148{

149 [ZSOCK\_FD\_CLR](group__bsd__sockets.md#ga7023ec00d24af41a7cbf5f376fb44487)(fd, set);

150}

151

152static inline void [FD\_SET](select_8h.md#a8c14b5b455292781fbcc2e34a47923d6)(int fd, [zsock\_fd\_set](group__bsd__sockets.md#ga1cdeeddce9000b9fd29b638c422f48f8) \*set)

153{

154 [ZSOCK\_FD\_SET](group__bsd__sockets.md#ga5d07f52910f6d881295ec659716767f1)(fd, set);

155}

156

157#endif /\* CONFIG\_NET\_SOCKETS\_POSIX\_NAMES \*/
...
169#endif /\* ZEPHYR\_INCLUDE\_NET\_SOCKET\_SELECT\_H\_ \*/
