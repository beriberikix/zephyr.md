---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__can__interface.html
...
| static int | [can\_get\_min\_bitrate](#gaef00151aad8c47fef798d53140ea7296) (const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*min\_bitrate) |
|  | Get minimum supported bitrate. |
...
| static int | [can\_get\_max\_bitrate](#gad3f929b2170f27b1cbe37a1caccb2e37) (const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*max\_bitrate) |
|  | Get maximum supported bitrate. |
...
| #define | [CAN\_MAX\_STD\_ID](#ga7987c1d4089742f87a7ac611add1a286)   [CAN\_STD\_ID\_MASK](#ga4cd8ce34887b90baeeaa6a4aa048b398) \_\_DEPRECATED\_MACRO |
...
| #define | [CAN\_MAX\_EXT\_ID](#ga0f3572940065f8f6d54099e7a4175f8f)   [CAN\_EXT\_ID\_MASK](#ga15ee71e8abcf51008925585049125986) \_\_DEPRECATED\_MACRO |
...
Defines a device which implements the CAN API. May generate a custom [device\_state](structdevice__state.md "Runtime device dynamic structure (in RAM) per driver instance.") container struct and init\_fn wrapper when needed depending on
...
| #define CAN\_MAX\_EXT\_ID   [CAN\_EXT\_ID\_MASK](#ga15ee71e8abcf51008925585049125986) \_\_DEPRECATED\_MACRO |
| --- |
...
:   Use [CAN\_EXT\_ID\_MASK](#ga15ee71e8abcf51008925585049125986) instead.

## [◆ ](#ga7987c1d4089742f87a7ac611add1a286)CAN\_MAX\_STD\_ID

| #define CAN\_MAX\_STD\_ID   [CAN\_STD\_ID\_MASK](#ga4cd8ce34887b90baeeaa6a4aa048b398) \_\_DEPRECATED\_MACRO |
| --- |
...
:   Use [CAN\_STD\_ID\_MASK](#ga4cd8ce34887b90baeeaa6a4aa048b398) instead.
...
## [◆ ](#gad3f929b2170f27b1cbe37a1caccb2e37)can\_get\_max\_bitrate()

| | int can\_get\_max\_bitrate | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *max\_bitrate* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   Use *[can\_get\_bitrate\_max()](#ga1e6dc8026e4d922bce4d398d9f32a457)* instead.
...
## [◆ ](#gaef00151aad8c47fef798d53140ea7296)can\_get\_min\_bitrate()

| | int can\_get\_min\_bitrate | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *min\_bitrate* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   Use *[can\_get\_bitrate\_min()](#ga343456749eec6144a91bacae0d94b114)* instead.
...
:   |  | dev | Pointer to the device structure for the driver instance. |
    | --- | --- | --- |
    | [out] | min\_bitrate | Minimum supported bitrate in bits/s. A value of 0 means the lower limit is unspecified. |
