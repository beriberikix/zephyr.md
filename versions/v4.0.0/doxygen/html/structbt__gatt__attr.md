---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/structbt__gatt__attr.html
...
The Attribute Type determines the interface that can be expected from the [read()](#a074abc719494ca35997a452f526e7ecc) and [write()](#a1ecd78536067f4bded506e0daccefd35) methods and the possible permission configurations.
