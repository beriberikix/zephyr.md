---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__bt__conn.html
...
The caller gets a new reference to the connection object which must be released with [bt\_conn\_unref()](#ga4b18c6b22a9f02be0d7d078b2ce51ff6) once done using the object. If

```
CONFIG_BT_CONN_CHECK_NULL_BEFORE_CREATE
```

is enabled, this function will return -EINVAL if dereferenced `conn` is not NULL.
...
Get current bonding flag. The initial value of this flag depends on

```
CONFIG_BT_BONDABLE
```

Kconfig setting. The Bonding flag can be updated using [bt\_set\_bondable()](#ga014db594b17a3b5d7d954e64ad8de759).
