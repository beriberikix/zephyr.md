---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/stm32__clock__control_8h.html
...
| #define | [STM32\_CLOCK\_REG\_GET](#aaeece46c7eb50e1f095cc33f9f9c3475)(clock) |
|  | Clock source binding accessors. |
| #define | [STM32\_CLOCK\_SHIFT\_GET](#a311bbc17ae04bf6fb648040255ed9af4)(clock) |
|  | Obtain position field from clock configuration. |
| #define | [STM32\_CLOCK\_MASK\_GET](#ad3decf332c88ed6dd0f3deb22fdf559e)(clock) |
|  | Obtain mask field from clock configuration. |
| #define | [STM32\_CLOCK\_VAL\_GET](#ae4e06e6122c64ab7c4ccfadb4957a029)(clock) |
|  | Obtain value field from clock configuration. |
| #define | [STM32\_MCO\_CFGR\_REG\_GET](#aa10147ff5e9b937abef1f11b15d92901)(mco\_cfgr) |
|  | Obtain register field from MCO configuration. |
| #define | [STM32\_MCO\_CFGR\_SHIFT\_GET](#a018b775433cbe5f53f4161d359d04bb5)(mco\_cfgr) |
|  | Obtain position field from MCO configuration. |
| #define | [STM32\_MCO\_CFGR\_MASK\_GET](#a22fcdb2be5108145090b65a2d90d4146)(mco\_cfgr) |
|  | Obtain mask field from MCO configuration. |
| #define | [STM32\_MCO\_CFGR\_VAL\_GET](#a3503338c38db5b0939879395a97e0ac0)(mco\_cfgr) |
...
## [◆ ](#ad3decf332c88ed6dd0f3deb22fdf559e)STM32\_CLOCK\_MASK\_GET

| #define STM32\_CLOCK\_MASK\_GET | ( |  | *clock* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((clock) >> [STM32\_CLOCK\_MASK\_SHIFT](stm32c0__clock_8h.md#abfdb31d824fc5c6cf809a1dcff022b5d)) & [STM32\_CLOCK\_MASK\_MASK](stm32c0__clock_8h.md#a63ecbd205c0dd6cb3eab7bcbfdce38b9))
...
## [◆ ](#aaeece46c7eb50e1f095cc33f9f9c3475)STM32\_CLOCK\_REG\_GET

| #define STM32\_CLOCK\_REG\_GET | ( |  | *clock* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((clock) >> [STM32\_CLOCK\_REG\_SHIFT](stm32c0__clock_8h.md#a2e73bdb1691751ffd616a5c4e2762423)) & [STM32\_CLOCK\_REG\_MASK](stm32c0__clock_8h.md#a33d66849c63db64784317260b06ceb24))
...
## [◆ ](#a311bbc17ae04bf6fb648040255ed9af4)STM32\_CLOCK\_SHIFT\_GET

| #define STM32\_CLOCK\_SHIFT\_GET | ( |  | *clock* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((clock) >> [STM32\_CLOCK\_SHIFT\_SHIFT](stm32c0__clock_8h.md#a147846b77bd51e42c85bea5aca50ad4f)) & [STM32\_CLOCK\_SHIFT\_MASK](stm32c0__clock_8h.md#af3001a7541ea4df9e4948fd559352f60))
...
## [◆ ](#ae4e06e6122c64ab7c4ccfadb4957a029)STM32\_CLOCK\_VAL\_GET

| #define STM32\_CLOCK\_VAL\_GET | ( |  | *clock* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((clock) >> [STM32\_CLOCK\_VAL\_SHIFT](stm32c0__clock_8h.md#adf2ca8c7f707b82b7ec4820dfc32929a)) & [STM32\_CLOCK\_VAL\_MASK](stm32c0__clock_8h.md#a6b4f80c7dbd047ca1ebac0b233ad1d1b))
...
**Definition** stm32\_clock\_control.h:440
...
**Definition** stm32\_clock\_control.h:445
...
## [◆ ](#a22fcdb2be5108145090b65a2d90d4146)STM32\_MCO\_CFGR\_MASK\_GET

| #define STM32\_MCO\_CFGR\_MASK\_GET | ( |  | *mco\_cfgr* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((mco\_cfgr) >> [STM32\_MCO\_CFGR\_MASK\_SHIFT](stm32__common__clocks_8h.md#abe5f0de675895eb047ad7d8ba15b444b)) & [STM32\_MCO\_CFGR\_MASK\_MASK](stm32__common__clocks_8h.md#af4128292c207270d5abfe104ebf723da))

[STM32\_MCO\_CFGR\_MASK\_SHIFT](stm32__common__clocks_8h.md#abe5f0de675895eb047ad7d8ba15b444b)

#define STM32\_MCO\_CFGR\_MASK\_SHIFT

**Definition** stm32\_common\_clocks.h:24

[STM32\_MCO\_CFGR\_MASK\_MASK](stm32__common__clocks_8h.md#af4128292c207270d5abfe104ebf723da)
...
Parameters
:   | mco\_cfgr | MCO configuration bit field value. |
    | --- | --- |

## [◆ ](#aa10147ff5e9b937abef1f11b15d92901)STM32\_MCO\_CFGR\_REG\_GET

| #define STM32\_MCO\_CFGR\_REG\_GET | ( |  | *mco\_cfgr* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((mco\_cfgr) >> [STM32\_MCO\_CFGR\_REG\_SHIFT](stm32__common__clocks_8h.md#ab5cb026c26c0059a2920288ea0305170)) & [STM32\_MCO\_CFGR\_REG\_MASK](stm32__common__clocks_8h.md#ae14130ea70f0df4747f357dc863ea456))

[STM32\_MCO\_CFGR\_REG\_SHIFT](stm32__common__clocks_8h.md#ab5cb026c26c0059a2920288ea0305170)

#define STM32\_MCO\_CFGR\_REG\_SHIFT

**Definition** stm32\_common\_clocks.h:20

[STM32\_MCO\_CFGR\_REG\_MASK](stm32__common__clocks_8h.md#ae14130ea70f0df4747f357dc863ea456)
...
## [◆ ](#a018b775433cbe5f53f4161d359d04bb5)STM32\_MCO\_CFGR\_SHIFT\_GET

| #define STM32\_MCO\_CFGR\_SHIFT\_GET | ( |  | *mco\_cfgr* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((mco\_cfgr) >> [STM32\_MCO\_CFGR\_SHIFT\_SHIFT](stm32__common__clocks_8h.md#a90ef8b401020d2d31233ab5e0aef3953)) & [STM32\_MCO\_CFGR\_SHIFT\_MASK](stm32__common__clocks_8h.md#ace1dd95ce384cbd71a7cf71e23b450b6))

[STM32\_MCO\_CFGR\_SHIFT\_SHIFT](stm32__common__clocks_8h.md#a90ef8b401020d2d31233ab5e0aef3953)

#define STM32\_MCO\_CFGR\_SHIFT\_SHIFT

**Definition** stm32\_common\_clocks.h:22

[STM32\_MCO\_CFGR\_SHIFT\_MASK](stm32__common__clocks_8h.md#ace1dd95ce384cbd71a7cf71e23b450b6)
...
## [◆ ](#a3503338c38db5b0939879395a97e0ac0)STM32\_MCO\_CFGR\_VAL\_GET

| #define STM32\_MCO\_CFGR\_VAL\_GET | ( |  | *mco\_cfgr* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

(((mco\_cfgr) >> [STM32\_MCO\_CFGR\_VAL\_SHIFT](stm32__common__clocks_8h.md#a1c2cadfeafe266885df8e3b6ca22aa1c)) & [STM32\_MCO\_CFGR\_VAL\_MASK](stm32__common__clocks_8h.md#aa0fd0438f4f39510b942f085443da629))

[STM32\_MCO\_CFGR\_VAL\_SHIFT](stm32__common__clocks_8h.md#a1c2cadfeafe266885df8e3b6ca22aa1c)

#define STM32\_MCO\_CFGR\_VAL\_SHIFT

**Definition** stm32\_common\_clocks.h:26

[STM32\_MCO\_CFGR\_VAL\_MASK](stm32__common__clocks_8h.md#aa0fd0438f4f39510b942f085443da629)
