---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/kernel__arch__interface_8h_source.html
...
155static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) void

156arch\_thread\_return\_value\_set(struct [k\_thread](structk__thread.md) \*thread, unsigned int value);

157#endif /\* CONFIG\_USE\_SWITCH \*/
...
211#if defined(CONFIG\_USERSPACE) && defined(CONFIG\_ARCH\_HAS\_THREAD\_PRIV\_STACK\_SPACE\_GET)

235int arch\_thread\_priv\_stack\_space\_get(const struct [k\_thread](structk__thread.md) \*thread, size\_t \*stack\_size,

236 size\_t \*unused\_ptr);

237#endif /\* CONFIG\_USERSPACE && CONFIG\_ARCH\_HAS\_THREAD\_PRIV\_STACK\_SPACE\_GET \*/

238

240

[ 247](group__arch-pm.md#gada83bf3beb5004a39a1f9c8c7ce35348)FUNC\_NORETURN void [arch\_system\_halt](group__arch-pm.md#gada83bf3beb5004a39a1f9c8c7ce35348)(unsigned int reason);
...
[ 266](group__arch-irq.md#gaee3fe4c82d94c4d307ea3e1169eb9573)static inline bool [arch\_is\_in\_isr](group__arch-irq.md#gaee3fe4c82d94c4d307ea3e1169eb9573)(void);
...
[ 312](group__arch-mmu.md#ga627bee468e54bb2d5ebe6ac53bb7fc94)void [arch\_mem\_map](group__arch-mmu.md#ga627bee468e54bb2d5ebe6ac53bb7fc94)(void \*virt, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) phys, size\_t size, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9));

313

[ 340](group__arch-mmu.md#ga8783e1d292510477b3816b6686d7d8cd)void [arch\_mem\_unmap](group__arch-mmu.md#ga8783e1d292510477b3816b6686d7d8cd)(void \*addr, size\_t size);

341

[ 363](group__arch-mmu.md#gaa31a233dab4ad575a9a969de10965200)int [arch\_page\_phys\_get](group__arch-mmu.md#gaa31a233dab4ad575a9a969de10965200)(void \*virt, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*phys);

364

[ 375](group__arch-mmu.md#ga229fa5699ad47951235af494f3d2a06a)void [arch\_reserved\_pages\_update](group__arch-mmu.md#ga229fa5699ad47951235af494f3d2a06a)(void);

376

[ 396](group__arch-mmu.md#ga4c13ffab5b5a5f8c93971c4d3b51bd8f)void [arch\_mem\_page\_out](group__arch-mmu.md#ga4c13ffab5b5a5f8c93971c4d3b51bd8f)(void \*addr, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location);

397

[ 415](group__arch-mmu.md#ga3c446aea862e37d479a809582322b3ae)void [arch\_mem\_page\_in](group__arch-mmu.md#ga3c446aea862e37d479a809582322b3ae)(void \*addr, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) phys);

416

[ 431](group__arch-mmu.md#gae4e82c3100b08bdfdcd9361d316735a1)void [arch\_mem\_scratch](group__arch-mmu.md#gae4e82c3100b08bdfdcd9361d316735a1)([uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) phys);

432

[ 436](group__arch-mmu.md#ga65e10c80055d7e695add000f2ccfbb0b)enum [arch\_page\_location](group__arch-mmu.md#ga65e10c80055d7e695add000f2ccfbb0b) {

[ 438](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0bacf9e624eac380ea2bfa37632c4d17a3a) [ARCH\_PAGE\_LOCATION\_PAGED\_OUT](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0bacf9e624eac380ea2bfa37632c4d17a3a),

439

[ 441](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0bae378a008f497ae10ab50cab06f8c36db) [ARCH\_PAGE\_LOCATION\_PAGED\_IN](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0bae378a008f497ae10ab50cab06f8c36db),

442

[ 444](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0ba7ff70acdf02345b5fa4c42ed2b2adde9) [ARCH\_PAGE\_LOCATION\_BAD](group__arch-mmu.md#gga65e10c80055d7e695add000f2ccfbb0ba7ff70acdf02345b5fa4c42ed2b2adde9)

445};

446

[ 474](group__arch-mmu.md#ga74b3ce1173b91a8f82c25ef89f9fbbc0)enum [arch\_page\_location](group__arch-mmu.md#ga65e10c80055d7e695add000f2ccfbb0b) [arch\_page\_location\_get](group__arch-mmu.md#ga74b3ce1173b91a8f82c25ef89f9fbbc0)(void \*addr, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*location);
...
[ 559](group__arch-mmu.md#gae4db701524d0614d0104706dc2a03a6c)[uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) [arch\_page\_info\_get](group__arch-mmu.md#gae4db701524d0614d0104706dc2a03a6c)(void \*addr, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*location,

560 bool clear\_accessed);
...
[ 586](group__arch-misc.md#ga6860efc93b8ba35911cfb0afbe372623)int [arch\_printk\_char\_out](group__arch-misc.md#ga6860efc93b8ba35911cfb0afbe372623)(int c);

587

588#ifdef CONFIG\_ARCH\_HAS\_THREAD\_NAME\_HOOK

601int arch\_thread\_name\_set(struct [k\_thread](structk__thread.md) \*thread, const char \*str);

602#endif /\* CONFIG\_ARCH\_HAS\_THREAD\_NAME\_HOOK \*/

603

[ 610](group__arch-misc.md#ga62cc65268b396d2683e47c09c9b62af5)static inline void [arch\_kernel\_init](group__arch-misc.md#ga62cc65268b396d2683e47c09c9b62af5)(void);

611

[ 613](group__arch-misc.md#gabb087b9e158824121212d65646ae4154)static inline void [arch\_nop](group__arch-misc.md#gabb087b9e158824121212d65646ae4154)(void);
...
[ 630](group__arch-coredump.md#gae997cb3dc249bec6d5166145f37d9292)void [arch\_coredump\_info\_dump](group__arch-coredump.md#gae997cb3dc249bec6d5166145f37d9292)(const struct [arch\_esf](structarch__esf.md) \*esf);

631

[ 635](group__arch-coredump.md#ga1d9b0c011a03434272ff9bec120f273d)[uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) [arch\_coredump\_tgt\_code\_get](group__arch-coredump.md#ga1d9b0c011a03434272ff9bec120f273d)(void);

636

637#if defined(CONFIG\_USERSPACE) || defined(\_\_DOXYGEN\_\_)

638

[ 646](group__arch-coredump.md#ga31bcb446604666c8f4d05ccfcbc00441)void [arch\_coredump\_priv\_stack\_dump](group__arch-coredump.md#ga31bcb446604666c8f4d05ccfcbc00441)(struct [k\_thread](structk__thread.md) \*thread);

647

648#endif /\* CONFIG\_USERSPACE || \_\_DOXYGEN\_\_ \*/
...
[ 668](group__arch-tls.md#ga7f159caca46063b04cf03a54b39255fc)size\_t [arch\_tls\_stack\_setup](group__arch-tls.md#ga7f159caca46063b04cf03a54b39255fc)(struct [k\_thread](structk__thread.md) \*new\_thread, char \*stack\_ptr);

669

671

672/\* Include arch-specific inline function implementation \*/

673#include <kernel\_arch\_func.h>

674

675#ifdef \_\_cplusplus
...
679#endif /\* \_ASMLANGUAGE \*/

680

681#endif /\* ZEPHYR\_KERNEL\_INCLUDE\_KERNEL\_ARCH\_INTERFACE\_H\_ \*/
...
**Definition** kernel\_arch\_interface.h:436
...
**Definition** kernel\_arch\_interface.h:444
...
**Definition** kernel\_arch\_interface.h:438
...
**Definition** kernel\_arch\_interface.h:441
