---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/dlist_8h_source.html
...
304 return [sys\_dlist\_is\_empty](group__doubly-linked-list__apis.md#gaaa314b62d8d271071d5603075a961766)(list) ? NULL : list->head;
...
352 return (node != NULL) ? [sys\_dlist\_peek\_next\_no\_check](group__doubly-linked-list__apis.md#ga84863ceb4ef678a9d3500d0e876e6afb)(list, node) : NULL;
...
387 return (node != NULL) ? [sys\_dlist\_peek\_prev\_no\_check](group__doubly-linked-list__apis.md#ga806259b974b7ea6e42feaeab3987f140)(list, node) : NULL;
...
400 return [sys\_dlist\_is\_empty](group__doubly-linked-list__apis.md#gaaa314b62d8d271071d5603075a961766)(list) ? NULL : list->tail;
...
[ 504](group__doubly-linked-list__apis.md#ga06f88befada25820fba01d2019970e4e)static inline void [sys\_dlist\_remove](group__doubly-linked-list__apis.md#ga06f88befada25820fba01d2019970e4e)([sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*node)

505{

506 [sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*const prev = node->prev;

507 [sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*const next = node->next;
...
511 [sys\_dnode\_init](group__doubly-linked-list__apis.md#gadf15b39af330221921d24505280e7a32)(node);
...
[ 524](group__doubly-linked-list__apis.md#ga3032394541494771f980e7642ecbc287)static inline [sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*[sys\_dlist\_get](group__doubly-linked-list__apis.md#ga3032394541494771f980e7642ecbc287)([sys\_dlist\_t](group__doubly-linked-list__apis.md#gaa03f9557215b486fee1039dd4c07e683) \*list)

525{

526 [sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*node = NULL;

527

528 if (![sys\_dlist\_is\_empty](group__doubly-linked-list__apis.md#gaaa314b62d8d271071d5603075a961766)(list)) {

529 node = list->head;

530 [sys\_dlist\_remove](group__doubly-linked-list__apis.md#ga06f88befada25820fba01d2019970e4e)(node);
...
[ 543](group__doubly-linked-list__apis.md#ga9418e906cc333b6a57b092487592c563)static inline size\_t [sys\_dlist\_len](group__doubly-linked-list__apis.md#ga9418e906cc333b6a57b092487592c563)([sys\_dlist\_t](group__doubly-linked-list__apis.md#gaa03f9557215b486fee1039dd4c07e683) \*list)

544{

545 size\_t len = 0;

546 [sys\_dnode\_t](group__doubly-linked-list__apis.md#ga57fdb936802a617d16c00ab08cd2ad98) \*node = NULL;

547

548 [SYS\_DLIST\_FOR\_EACH\_NODE](group__doubly-linked-list__apis.md#ga3788b5bbd11acc885e7378800a8cf974)(list, node) {
...
560#endif /\* ZEPHYR\_INCLUDE\_SYS\_DLIST\_H\_ \*/
