---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/gpio__utils_8h_source.html
...
[ 24](gpio__utils_8h.md#a696fbe0e6868902fbec77afc06f55e0a)#define GPIO\_PORT\_PIN\_MASK\_FROM\_NGPIOS(ngpios) \

25 ((gpio\_port\_pins\_t)(((uint64\_t)1 << (ngpios)) - 1U))

26

[ 35](gpio__utils_8h.md#a570c8e724c799b1bb0edeafa249d9730)#define GPIO\_PORT\_PIN\_MASK\_FROM\_DT\_NODE(node\_id) \

36 GPIO\_DT\_PORT\_PIN\_MASK\_NGPIOS\_EXC(node\_id, DT\_PROP(node\_id, ngpios))

37

[ 46](gpio__utils_8h.md#a34528b682ca57bfc77cef745ed235e04)#define GPIO\_PORT\_PIN\_MASK\_FROM\_DT\_INST(inst) \

47 GPIO\_PORT\_PIN\_MASK\_FROM\_DT\_NODE(DT\_DRV\_INST(inst))

48

[ 58](gpio__utils_8h.md#ac9d36599625b79bd2ebb9f3603a2a122)static inline int [gpio\_manage\_callback](gpio__utils_8h.md#ac9d36599625b79bd2ebb9f3603a2a122)([sys\_slist\_t](group__single-linked-list__apis.md#ga44658c336b634c03938a251cdc8134f8) \*callbacks,

59 struct [gpio\_callback](structgpio__callback.md) \*callback,

60 bool set)

61{

62 \_\_ASSERT(callback, "No callback!");

63 \_\_ASSERT(callback->[handler](structgpio__callback.md#af89dc41cbd610d81ac03cae7ab764ceb), "No callback handler!");

64

65 if (![sys\_slist\_is\_empty](group__single-linked-list__apis.md#ga7d729bbb7bba57c5784ad0d2c341670a)(callbacks)) {

66 if (![sys\_slist\_find\_and\_remove](group__single-linked-list__apis.md#ga296560229ffdfd0054c9c7b0602825a6)(callbacks, &callback->[node](structgpio__callback.md#ab60e7093072964bd818d536c746211e4))) {
...
72 return -[EINVAL](group__system__errno.md#ga2d1678d5a7cc8ce499643f3b8957def4);
...
76 [sys\_slist\_prepend](group__single-linked-list__apis.md#gac962e3ec8440e4adb2ba6682dbf186ff)(callbacks, &callback->[node](structgpio__callback.md#ab60e7093072964bd818d536c746211e4));
...
[ 89](gpio__utils_8h.md#ac7193ccc60e2f1c62569f80cd9973702)static inline void [gpio\_fire\_callbacks](gpio__utils_8h.md#ac7193ccc60e2f1c62569f80cd9973702)([sys\_slist\_t](group__single-linked-list__apis.md#ga44658c336b634c03938a251cdc8134f8) \*list,

90 const struct [device](structdevice.md) \*port,

91 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) pins)

92{

93 struct [gpio\_callback](structgpio__callback.md) \*cb, \*tmp;

94

95 [SYS\_SLIST\_FOR\_EACH\_CONTAINER\_SAFE](group__single-linked-list__apis.md#gacf3aaf32a6a3389229b548588c6d655e)(list, cb, tmp, [node](structgpio__callback.md#ab60e7093072964bd818d536c746211e4)) {

96 if (cb->[pin\_mask](structgpio__callback.md#ace5c2b83f1d51f73877a1f2c54ba8c67) & pins) {

97 \_\_ASSERT(cb->[handler](structgpio__callback.md#af89dc41cbd610d81ac03cae7ab764ceb), "No callback handler!");

98 cb->[handler](structgpio__callback.md#af89dc41cbd610d81ac03cae7ab764ceb)(port, cb, cb->[pin\_mask](structgpio__callback.md#ace5c2b83f1d51f73877a1f2c54ba8c67) & pins);
...
107#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_GPIO\_GPIO\_UTILS\_H\_ \*/
