---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/shell__websocket_8h_source.html
...
[ 65](shell__websocket_8h.md#acc516f1459d0def39779eb8e15c29d80)extern int [shell\_websocket\_setup](shell__websocket_8h.md#acc516f1459d0def39779eb8e15c29d80)(int ws\_socket, void \*user\_data);

[ 66](shell__websocket_8h.md#a773f4275294a28b9a25364c5a7d50cab)extern int [shell\_websocket\_enable](shell__websocket_8h.md#a773f4275294a28b9a25364c5a7d50cab)(const struct [shell](structshell.md) \*sh);
...
125 \_sec\_tag\_list\_size); \

126 DEFINE\_WEBSOCKET\_SERVICE(\_service); \

127

128

129#else /\* CONFIG\_NET\_SOCKETS\_SOCKOPT\_TLS \*/

130/\* TLS not possible so define only normal HTTP service \*/

[ 131](shell__websocket_8h.md#a726a23776948ff246176c1ac2c88daa6)#define WEBSOCKET\_CONSOLE\_DEFINE(\_service, \_sec\_tag\_list, \_sec\_tag\_list\_size) \

132 static uint16\_t SHELL\_WS\_PORT\_NAME(\_service) = \

133 CONFIG\_SHELL\_WEBSOCKET\_PORT; \

134 HTTP\_SERVICE\_DEFINE(\_service, \

135 CONFIG\_SHELL\_WEBSOCKET\_IP\_ADDR, \

136 &SHELL\_WS\_PORT\_NAME(\_service), \

137 SHELL\_WEBSOCKET\_SERVICE\_COUNT, \

138 SHELL\_WEBSOCKET\_SERVICE\_COUNT, \

139 NULL); \

140 DEFINE\_WEBSOCKET\_SERVICE(\_service)

141

142#endif /\* CONFIG\_NET\_SOCKETS\_SOCKOPT\_TLS \*/

143

[ 144](shell__websocket_8h.md#a134a7de93ded994b49fd781fb289e876)#define WEBSOCKET\_CONSOLE\_ENABLE(\_service) \

145 (void)shell\_websocket\_enable(&GET\_WS\_SHELL\_NAME(\_service))
...
151#endif /\* ZEPHYR\_INCLUDE\_SHELL\_WEBSOCKET\_H\_ \*/
...
[shell\_websocket\_setup](shell__websocket_8h.md#acc516f1459d0def39779eb8e15c29d80)
