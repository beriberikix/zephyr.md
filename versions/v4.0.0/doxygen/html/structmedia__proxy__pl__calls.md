---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/structmedia__proxy__pl__calls.html
...
Write a search to the media player. (For the formatting of a search, see the Media Control Service spec and the [mcs.h](mcs_8h.md "Bluetooth Media Control Service (MCS) APIs.") file.)
