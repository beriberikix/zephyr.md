---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/arcv2__irq__unit_8h_source.html
...
94static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)
...
115static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)
...
138static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)
...
168static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)
...
186static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)
...
209void z\_arc\_v2\_irq\_unit\_trigger\_set(int irq, unsigned int trigger)

210{

211 unsigned int key = [arch\_irq\_lock](arch_2arc_2v2_2irq_8h.md#a1496f4f860a99f42e1aee15ce5c9b3e2)();

212

213 z\_arc\_v2\_aux\_reg\_write(\_ARC\_V2\_IRQ\_SELECT, irq);

214 z\_arc\_v2\_aux\_reg\_write(\_ARC\_V2\_IRQ\_TRIGGER, trigger);

215

216 [arch\_irq\_unlock](arch_2arc_2v2_2irq_8h.md#a203e02b994beba0d006dad9f6d797c27)(key);

217}

218

229static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)

230unsigned int z\_arc\_v2\_irq\_unit\_trigger\_get(int irq)

231{

232 unsigned int ret;

233 unsigned int key = [arch\_irq\_lock](arch_2arc_2v2_2irq_8h.md#a1496f4f860a99f42e1aee15ce5c9b3e2)();

234

235 z\_arc\_v2\_aux\_reg\_write(\_ARC\_V2\_IRQ\_SELECT, irq);

236 ret = z\_arc\_v2\_aux\_reg\_read(\_ARC\_V2\_IRQ\_TRIGGER);

237

238 [arch\_irq\_unlock](arch_2arc_2v2_2irq_8h.md#a203e02b994beba0d006dad9f6d797c27)(key);
...
249static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a)

250void z\_arc\_v2\_irq\_unit\_int\_eoi(int irq)

251{

252 unsigned int key = [arch\_irq\_lock](arch_2arc_2v2_2irq_8h.md#a1496f4f860a99f42e1aee15ce5c9b3e2)();

253

254 z\_arc\_v2\_aux\_reg\_write(\_ARC\_V2\_IRQ\_SELECT, irq);

255 z\_arc\_v2\_aux\_reg\_write(\_ARC\_V2\_IRQ\_PULSE\_CANCEL, 1);

256

257 [arch\_irq\_unlock](arch_2arc_2v2_2irq_8h.md#a203e02b994beba0d006dad9f6d797c27)(key);
...
266#endif /\* ZEPHYR\_INCLUDE\_ARCH\_ARC\_V2\_ARCV2\_IRQ\_UNIT\_H\_ \*/
