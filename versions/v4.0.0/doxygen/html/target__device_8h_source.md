---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/target__device_8h_source.html
...
[ 220](structi3c__target__callbacks.md#a15a1bacdd10c0d6803fbd24f1a1a3323) int (\*[stop\_cb](structi3c__target__callbacks.md#a15a1bacdd10c0d6803fbd24f1a1a3323))(struct [i3c\_target\_config](structi3c__target__config.md) \*config);

221};

222

[ 223](structi3c__target__driver__api.md)\_\_subsystem struct [i3c\_target\_driver\_api](structi3c__target__driver__api.md) {

[ 224](structi3c__target__driver__api.md#ae4cfbf1bfa1549086d120e3ea49c3d38) int (\*[driver\_register](structi3c__target__driver__api.md#ae4cfbf1bfa1549086d120e3ea49c3d38))(const struct [device](structdevice.md) \*dev);

[ 225](structi3c__target__driver__api.md#a23fe52e8c1f700b6c39cabec667a80b8) int (\*[driver\_unregister](structi3c__target__driver__api.md#a23fe52e8c1f700b6c39cabec667a80b8))(const struct [device](structdevice.md) \*dev);

226};

227

[ 252](group__i3c__target__device.md#gafb5ebdfd5536ee265a3719beb8ae81dc)static inline int [i3c\_target\_tx\_write](group__i3c__target__device.md#gafb5ebdfd5536ee265a3719beb8ae81dc)(const struct [device](structdevice.md) \*dev,

253 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) len, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) hdr\_mode)

254{

255 const struct i3c\_driver\_api \*api =

256 (const struct i3c\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

257

258 if (api->target\_tx\_write == NULL) {
...
262 return api->target\_tx\_write(dev, buf, len, hdr\_mode);

263}

264

[ 288](group__i3c__target__device.md#gaf13d2b84a91e17d5ec49a41e9c553d42)static inline int [i3c\_target\_register](group__i3c__target__device.md#gaf13d2b84a91e17d5ec49a41e9c553d42)(const struct [device](structdevice.md) \*dev,

289 struct [i3c\_target\_config](structi3c__target__config.md) \*cfg)

290{

291 const struct i3c\_driver\_api \*api =

292 (const struct i3c\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

293

294 if (api->target\_register == NULL) {
...
298 return api->target\_register(dev, cfg);

299}

300

[ 317](group__i3c__target__device.md#ga3dc0e6451fb13fa063c5ec3e18fe22e4)static inline int [i3c\_target\_unregister](group__i3c__target__device.md#ga3dc0e6451fb13fa063c5ec3e18fe22e4)(const struct [device](structdevice.md) \*dev,

318 struct [i3c\_target\_config](structi3c__target__config.md) \*cfg)

319{

320 const struct i3c\_driver\_api \*api =

321 (const struct i3c\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

322

323 if (api->target\_unregister == NULL) {
...
327 return api->target\_unregister(dev, cfg);

328}

329

330#ifdef \_\_cplusplus
...
338#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_I3C\_TARGET\_DEVICE\_H\_ \*/
...
**Definition** target\_device.h:317
...
**Definition** target\_device.h:288
...
**Definition** target\_device.h:252
...
**Definition** target\_device.h:220
...
**Definition** target\_device.h:223
...
**Definition** target\_device.h:225
...
**Definition** target\_device.h:224
