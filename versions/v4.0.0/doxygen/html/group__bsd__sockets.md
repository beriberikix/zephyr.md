---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__bsd__sockets.html
...
|  | POSIX wrapper for [zsock\_poll](#ga518361903c9fac3766164d38243872e3). |
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/bind.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/bind.html) for normative description. This function is also exposed as [bind()](#ga0de5e0b54a93dc6462078539b0a4a0b9) if @kconfig{CONFIG\_POSIX\_API} is defined.
...
Close a network socket. This function is also exposed as [close()](#ga3c78073ab26ad78a7a1f715ba3580086) if @kconfig{CONFIG\_POSIX\_API} is defined (in which case it may conflict with generic POSIX [close()](#ga3c78073ab26ad78a7a1f715ba3580086) function).
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html) for normative description. This function is also exposed as [FD\_CLR()](select_8h.md#a0835759308c63ca23a1760980eea21d7) if
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html) for normative description. This function is also exposed as [FD\_ISSET()](select_8h.md#ac38fe1ff5db5e46e778f13ad5accdf98) if
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html) for normative description. This function is also exposed as [FD\_SET()](select_8h.md#a8c14b5b455292781fbcc2e34a47923d6) if
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/select.html) for normative description. This function is also exposed as [FD\_ZERO()](select_8h.md#a3f88268fa19b2068723de10d848e8a42) if
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/gethostname.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/gethostname.html) for normative description. This function is also exposed as [gethostname()](#ga14fe74115e6133e1be596c327047b0ca) if @kconfig{CONFIG\_POSIX\_API} is defined.
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/recv.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/recv.html) for normative description. This function is also exposed as [recv()](#gae11da452beee536eac85d5f26e5cdd40) if @kconfig{CONFIG\_POSIX\_API} is defined.
...
See POSIX.1-2017 article [http://pubs.opengroup.org/onlinepubs/9699919799/functions/send.html](http://pubs.opengroup.org/onlinepubs/9699919799/functions/send.html) for normative description. This function is also exposed as [send()](#gad32c12370c1d09a96775091bbbf3c44d) if @kconfig{CONFIG\_POSIX\_API} is defined.
