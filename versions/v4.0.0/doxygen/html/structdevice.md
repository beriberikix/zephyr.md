---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/structdevice.html
...
This encodes a sequence of sets of device handles that have some relationship to this node. The individual sets are extracted with dedicated API, such as [device\_required\_handles\_get()](group__device__model.md#ga2157bbfc2deecfae6514f58221663618 "Get the device handles for devicetree dependencies of this device."). Only available if
