---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__dma__interface.html
...
| | void dma\_release\_channel | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *channel* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int dma\_request\_channel | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | void \* | *filter\_param* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
