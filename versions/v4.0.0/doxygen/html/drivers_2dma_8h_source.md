---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/drivers_2dma_8h_source.html
...
355\_\_subsystem struct dma\_driver\_api {

356 dma\_api\_config config;

357 dma\_api\_reload reload;

358 dma\_api\_start start;

359 dma\_api\_stop stop;

360 dma\_api\_suspend suspend;

361 dma\_api\_resume resume;

362 dma\_api\_get\_status get\_status;

363 dma\_api\_get\_attribute get\_attribute;

364 dma\_api\_chan\_filter chan\_filter;

365};

369

[ 381](group__dma__interface.md#ga6df1a6b89f271a0eae01c17b748bd2df)static inline int [dma\_config](group__dma__interface.md#ga6df1a6b89f271a0eae01c17b748bd2df)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel,

382 struct [dma\_config](structdma__config.md) \*config)

383{

384 const struct dma\_driver\_api \*api =

385 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
403#ifdef CONFIG\_DMA\_64BIT

404static inline int [dma\_reload](group__dma__interface.md#ga55bd5d550349c11c63ef47c2ed861f36)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel,

405 [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) src, [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) dst, size\_t size)

406#else

[ 407](group__dma__interface.md#ga55bd5d550349c11c63ef47c2ed861f36)static inline int [dma\_reload](group__dma__interface.md#ga55bd5d550349c11c63ef47c2ed861f36)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel,

408 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) src, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) dst, size\_t size)

409#endif

410{

411 const struct dma\_driver\_api \*api =

412 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
418 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

419}

420

[ 440](group__dma__interface.md#gac2ddafd17680f59e4e8fe5f6e2eaba48)\_\_syscall int [dma\_start](group__dma__interface.md#gac2ddafd17680f59e4e8fe5f6e2eaba48)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel);

441

442static inline int z\_impl\_dma\_start(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel)

443{

444 const struct dma\_driver\_api \*api =

445 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
[ 468](group__dma__interface.md#ga305cc72d0804028b77aa82dd07c926ad)\_\_syscall int [dma\_stop](group__dma__interface.md#ga305cc72d0804028b77aa82dd07c926ad)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel);

469

470static inline int z\_impl\_dma\_stop(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel)

471{

472 const struct dma\_driver\_api \*api =

473 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
[ 495](group__dma__interface.md#ga6779850f6082259f5bef29b1282effdb)\_\_syscall int [dma\_suspend](group__dma__interface.md#ga6779850f6082259f5bef29b1282effdb)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel);

496

497static inline int z\_impl\_dma\_suspend(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel)

498{

499 const struct dma\_driver\_api \*api = (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
[ 523](group__dma__interface.md#ga89a3d056803d7f2dd1c8b6e535ef4f1d)\_\_syscall int [dma\_resume](group__dma__interface.md#ga89a3d056803d7f2dd1c8b6e535ef4f1d)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel);

524

525static inline int z\_impl\_dma\_resume(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel)

526{

527 const struct dma\_driver\_api \*api = (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);
...
[ 549](group__dma__interface.md#ga91cc55f781744069f1f9f29249bdee8d)\_\_syscall int [dma\_request\_channel](group__dma__interface.md#ga91cc55f781744069f1f9f29249bdee8d)(const struct [device](structdevice.md) \*dev,

550 void \*filter\_param);

551

552static inline int z\_impl\_dma\_request\_channel(const struct [device](structdevice.md) \*dev,

553 void \*filter\_param)

554{

555 int i = 0;

556 int channel = -[EINVAL](group__system__errno.md#ga2d1678d5a7cc8ce499643f3b8957def4);

557 const struct dma\_driver\_api \*api =

558 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

559 /\* dma\_context shall be the first one in dev data \*/

560 struct [dma\_context](structdma__context.md) \*dma\_ctx = (struct [dma\_context](structdma__context.md) \*)dev->[data](structdevice.md#a27573cbd10ee145f8bb1396242b27a3e);

561

562 if (dma\_ctx->magic != [DMA\_MAGIC](group__dma__interface.md#gae28ba5114dc2e9ecb89ccf9b623e938f)) {
...
566 for (i = 0; i < dma\_ctx->dma\_channels; i++) {

567 if (![atomic\_test\_and\_set\_bit](group__atomic__apis.md#ga7ff45e13aa5f8be5d7a550e49f5c720b)(dma\_ctx->atomic, i)) {

568 if (api->chan\_filter &&

569 !api->chan\_filter(dev, i, filter\_param)) {

570 [atomic\_clear\_bit](group__atomic__apis.md#ga1c1693d524c49d11fd32b323a39d718e)(dma\_ctx->atomic, i);
...
[ 592](group__dma__interface.md#gab02df5277d79a04a65132365e7b5d3de)\_\_syscall void [dma\_release\_channel](group__dma__interface.md#gab02df5277d79a04a65132365e7b5d3de)(const struct [device](structdevice.md) \*dev,

593 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel);

594

595static inline void z\_impl\_dma\_release\_channel(const struct [device](structdevice.md) \*dev,

596 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel)

597{

598 struct [dma\_context](structdma__context.md) \*dma\_ctx = (struct [dma\_context](structdma__context.md) \*)dev->[data](structdevice.md#a27573cbd10ee145f8bb1396242b27a3e);

599

600 if (dma\_ctx->magic != [DMA\_MAGIC](group__dma__interface.md#gae28ba5114dc2e9ecb89ccf9b623e938f)) {
...
604 if ((int)channel < dma\_ctx->[dma\_channels](structdma__context.md#ac6685cf14ca69c7b77160e5031c0a800)) {

605 [atomic\_clear\_bit](group__atomic__apis.md#ga1c1693d524c49d11fd32b323a39d718e)(dma\_ctx->atomic, channel);
...
[ 622](group__dma__interface.md#ga729d8f1163458d447d0a4b20cb9e4659)\_\_syscall int [dma\_chan\_filter](group__dma__interface.md#ga729d8f1163458d447d0a4b20cb9e4659)(const struct [device](structdevice.md) \*dev,

623 int channel, void \*filter\_param);

624

625static inline int z\_impl\_dma\_chan\_filter(const struct [device](structdevice.md) \*dev,

626 int channel, void \*filter\_param)

627{

628 const struct dma\_driver\_api \*api =

629 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

630

631 if (api->chan\_filter) {

632 return api->chan\_filter(dev, channel, filter\_param);

633 }

634

635 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

636}

637

[ 654](group__dma__interface.md#ga2cae500f1f9ed42ad338a40ec8655544)static inline int [dma\_get\_status](group__dma__interface.md#ga2cae500f1f9ed42ad338a40ec8655544)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) channel,

655 struct [dma\_status](structdma__status.md) \*[stat](structstat.md))

656{

657 const struct dma\_driver\_api \*api =

658 (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

659

660 if (api->get\_status) {

661 return api->get\_status(dev, channel, [stat](structstat.md));
...
[ 684](group__dma__interface.md#ga641f3fa492bfb17cf9f0a0361d429257)static inline int [dma\_get\_attribute](group__dma__interface.md#ga641f3fa492bfb17cf9f0a0361d429257)(const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) type, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*value)

685{

686 const struct dma\_driver\_api \*api = (const struct dma\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

687

688 if (api->get\_attribute) {

689 return api->get\_attribute(dev, type, value);

690 }

691

692 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

693}

694

[ 708](group__dma__interface.md#gadd1724a843bba4ccc1c65c9fb9d3d921)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [dma\_width\_index](group__dma__interface.md#gadd1724a843bba4ccc1c65c9fb9d3d921)([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) size)
...
716 if (![is\_power\_of\_two](group__sys-util.md#gadfe7046eb6c39bb3c84c18d8ac7a230e)(size)) {
...
721 return [find\_msb\_set](ffs_8h.md#a088db7d02e8f1fc559cbe1ec048494e8)(size);

722}

723

[ 737](group__dma__interface.md#gaac27f2ee664671884087ee3d2a2863ce)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [dma\_burst\_index](group__dma__interface.md#gaac27f2ee664671884087ee3d2a2863ce)([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) burst)
...
750 return [find\_msb\_set](ffs_8h.md#a088db7d02e8f1fc559cbe1ec048494e8)(burst);

751}

752

[ 762](group__dma__interface.md#ga542e1a0fa0d851a51e4c8abf9a820e0c)#define DMA\_BUF\_ADDR\_ALIGNMENT(node) DT\_PROP(node, dma\_buf\_addr\_alignment)

763

[ 773](group__dma__interface.md#ga76dfdfecc732319908f381883c630a2b)#define DMA\_BUF\_SIZE\_ALIGNMENT(node) DT\_PROP(node, dma\_buf\_size\_alignment)

774

[ 781](group__dma__interface.md#ga083e8b0a863b0833c55158053d286f15)#define DMA\_COPY\_ALIGNMENT(node) DT\_PROP(node, dma\_copy\_alignment)
...
793#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_DMA\_H\_ \*/
