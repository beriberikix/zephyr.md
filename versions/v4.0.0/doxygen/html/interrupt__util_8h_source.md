---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/interrupt__util_8h_source.html
...
92 [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) mpidr = [GET\_MPIDR](arm_2cortex__a__r_2cpu_8h.md#a958d9c5f047f5dc318ecf4b171a68949)();

93 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) aff0 = [MPIDR\_AFFLVL](arm_2cortex__a__r_2cpu_8h.md#a35278aa57b0b98cd0cb541cfea58b177)(mpidr, 0);
...
112#include <[zephyr/arch/arch\_interface.h](arch__interface_8h.md)>
...
144 int cpu\_id = [arch\_curr\_cpu](arc_2arch__inlines_8h.md#a3e8a7515c0c3b8de5a037ce5997c73b0)()->id;
...
169#if defined(CONFIG\_NUCLEI\_ECLIC) || defined(CONFIG\_NRFX\_CLIC)
