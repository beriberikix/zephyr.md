---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/input_8h_source.html
...
[ 127](structinput__callback.md#a1f50a902f5f1ce10ee9131fcd1e7865d) void (\*[callback](structinput__callback.md#a1f50a902f5f1ce10ee9131fcd1e7865d))(struct [input\_event](structinput__event.md) \*evt, void \*[user\_data](structinput__callback.md#a353255145aabf43c92faab719b8f524c));

[ 129](structinput__callback.md#a353255145aabf43c92faab719b8f524c) void \*[user\_data](structinput__callback.md#a353255145aabf43c92faab719b8f524c);

130};

131

[ 139](group__input__interface.md#gad3e7310625b14db2e6930f66dfd879a7)#define INPUT\_CALLBACK\_DEFINE\_NAMED(\_dev, \_callback, \_user\_data, name) \

140 static const STRUCT\_SECTION\_ITERABLE(input\_callback, \

141 \_input\_callback\_\_##name) = { \

142 .dev = \_dev, \

143 .callback = \_callback, \

144 .user\_data = \_user\_data, \

145 }

146

[ 158](group__input__interface.md#gac986cdf392f9aa0a771c8e4e92c479a3)#define INPUT\_CALLBACK\_DEFINE(\_dev, \_callback, \_user\_data) \

159 INPUT\_CALLBACK\_DEFINE\_NAMED(\_dev, \_callback, \_user\_data, \_callback)
...
167#endif /\* ZEPHYR\_INCLUDE\_INPUT\_H\_ \*/
...
[input\_callback::callback](structinput__callback.md#a1f50a902f5f1ce10ee9131fcd1e7865d)

void(\* callback)(struct input\_event \*evt, void \*user\_data)

The callback function.

**Definition** input.h:127

[input\_callback::user\_data](structinput__callback.md#a353255145aabf43c92faab719b8f524c)
