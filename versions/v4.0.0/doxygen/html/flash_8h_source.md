---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/flash_8h_source.html
...
183 const struct [flash\_pages\_layout](structflash__pages__layout.md) \*\*[layout](bindesc_8h.md#af8174bbae9567135fe17f1e55621f641),
...
[ 614](group__flash__interface.md#ga847407358a20d3d5918d8ef11657ce2b)\_\_syscall int [flash\_copy](group__flash__interface.md#ga847407358a20d3d5918d8ef11657ce2b)(const struct [device](structdevice.md) \*src\_dev, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) src\_offset,

615 const struct [device](structdevice.md) \*dst\_dev, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) dst\_offset, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) size, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf,

616 size\_t buf\_size);

617/\*

618 \* Extended operation interface provides flexible way for supporting flash

619 \* controller features. Code space is divided equally into Zephyr codes

620 \* (MSb == 0) and vendor codes (MSb == 1). This way we can easily add extended

621 \* operations to the drivers without cluttering the API or problems with API

622 \* incompatibility. Extended operation can be promoted from vendor codes to

623 \* Zephyr codes if the feature is available in most flash controllers and

624 \* can be represented in the same way.

625 \*

626 \* It's not forbidden to have operation in Zephyr codes and vendor codes for

627 \* the same functionality. In this case, vendor operation could provide more

628 \* specific access when abstraction in Zephyr counterpart is insufficient.

629 \*/

[ 630](group__flash__interface.md#ga67418b2d5cbbec83463dce3d426162e3)#define FLASH\_EX\_OP\_VENDOR\_BASE 0x8000

[ 631](group__flash__interface.md#gafc0aa899b7ea452d048d8ee67d2e6f06)#define FLASH\_EX\_OP\_IS\_VENDOR(c) ((c) & FLASH\_EX\_OP\_VENDOR\_BASE)

632

[ 636](group__flash__interface.md#gae401e7b13d22a0f405e8d2ca0ef33c51)enum [flash\_ex\_op\_types](group__flash__interface.md#gae401e7b13d22a0f405e8d2ca0ef33c51) {

637 /\*

638 \* Reset flash device.

639 \*/

[ 640](group__flash__interface.md#ggae401e7b13d22a0f405e8d2ca0ef33c51a296527e7d6b431780b9f4d813010bbdd) [FLASH\_EX\_OP\_RESET](group__flash__interface.md#ggae401e7b13d22a0f405e8d2ca0ef33c51a296527e7d6b431780b9f4d813010bbdd) = 0,

641};

642

643static inline int z\_impl\_flash\_ex\_op(const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) code,

644 const [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) in, void \*out)

645{

646#if defined(CONFIG\_FLASH\_EX\_OP\_ENABLED)

647 const struct [flash\_driver\_api](structflash__driver__api.md) \*api =

648 (const struct [flash\_driver\_api](structflash__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

649

650 if (api->ex\_op == NULL) {

651 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

652 }

653

654 return api->ex\_op(dev, code, in, out);

655#else

656 ARG\_UNUSED(dev);

657 ARG\_UNUSED(code);
...
661 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

662#endif /\* CONFIG\_FLASH\_EX\_OP\_ENABLED \*/
...
675#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_FLASH\_H\_ \*/
