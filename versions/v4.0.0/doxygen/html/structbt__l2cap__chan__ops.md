---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/structbt__l2cap__chan__ops.html
...
Note
:   This callback is mandatory, unless

    ```
    CONFIG_BT_L2CAP_SEG_RECV
    ```

    is enabled and seg\_recv is supplied.
