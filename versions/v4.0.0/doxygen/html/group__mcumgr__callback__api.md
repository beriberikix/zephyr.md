---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__mcumgr__callback__api.html
...
| MGMT\_EVT\_OP\_IMG\_MGMT\_IMAGE\_SLOT\_STATE | Callback when an image slot's state is encoded for a response. |
| MGMT\_EVT\_OP\_IMG\_MGMT\_SLOT\_INFO\_IMAGE | Callback when an slot list command outputs fields for an image. |
| MGMT\_EVT\_OP\_IMG\_MGMT\_SLOT\_INFO\_SLOT | Callback when an slot list command outputs fields for a slot of an image. |
