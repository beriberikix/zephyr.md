---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__trinamic__stepper__interface.html
...
[Device Driver APIs](group__io__interfaces.md) » [Stepper Controller Interface](group__stepper__interface.md)
...
| Functions | |
| --- | --- |
| int | [tmc5041\_stepper\_set\_ramp](#ga34391082dc1b89d3b22f19fc253a4eb5) (const struct [device](structdevice.md) \*dev, const struct [tmc\_ramp\_generator\_data](structtmc__ramp__generator__data.md) \*ramp\_data) |
...
.iholdrun = (TMC5041\_IRUN([DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node, irun)) | \

TMC5041\_IHOLD([DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node, ihold)) | \

TMC5041\_IHOLDDELAY([DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node, iholddelay))), \
...
## [◆ ](#ga34391082dc1b89d3b22f19fc253a4eb5)tmc5041\_stepper\_set\_ramp()

| int tmc5041\_stepper\_set\_ramp | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
