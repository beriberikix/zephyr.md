---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/drivers_2pwm_8h_source.html
...
714 if (api->configure\_capture == NULL) {
...
750 if (api->enable\_capture == NULL) {
...
781 if (api->disable\_capture == NULL) {
