---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/group__zms__high__level__api.html
...
Returns
:   0 on success. On error, returns negative value of error codes defined in [errno.h](errno_8h.md "System error numbers.").
