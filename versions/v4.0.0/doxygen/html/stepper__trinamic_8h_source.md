---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/doxygen/html/stepper__trinamic_8h_source.html
...
147 .iholdrun = (TMC5041\_IRUN(DT\_PROP(node, irun)) | \

148 TMC5041\_IHOLD(DT\_PROP(node, ihold)) | \

149 TMC5041\_IHOLDDELAY(DT\_PROP(node, iholddelay))), \

150 }

151

[ 162](group__trinamic__stepper__interface.md#ga34391082dc1b89d3b22f19fc253a4eb5)int [tmc5041\_stepper\_set\_ramp](group__trinamic__stepper__interface.md#ga34391082dc1b89d3b22f19fc253a4eb5)(const struct [device](structdevice.md) \*dev,
...
173#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_STEPPER\_STEPPER\_TRINAMIC\_H\_ \*/

[tmc5041\_stepper\_set\_ramp](group__trinamic__stepper__interface.md#ga34391082dc1b89d3b22f19fc253a4eb5)

int tmc5041\_stepper\_set\_ramp(const struct device \*dev, const struct tmc\_ramp\_generator\_data \*ramp\_data)
