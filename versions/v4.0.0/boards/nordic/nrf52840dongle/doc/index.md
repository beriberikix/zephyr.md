---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/nordic/nrf52840dongle/doc/index.html
...
![nRF52840 Dongle](https://docs.zephyrproject.org/4.0.0/_images/nrf52840dongle_nrf52840.jpg)
...
SDK. With this option, you’ll use Nordic’s [nrfutil](https://github.com/NordicSemiconductor/pc-nrfutil) [[5]](#id11) program to create
...
1. Reset the board into the Nordic bootloader by pressing the RESET button.
   ...
   ![Location of RESET button and direction of push](https://docs.zephyrproject.org/4.0.0/_images/nRF52840_dongle_press_reset.svg)
...
Install [nrfutil](https://github.com/NordicSemiconductor/pc-nrfutil) [[5]](#id11) and [mcumgr](https://github.com/apache/mynewt-mcumgr-cli) [[7]](#id16) first, and make sure MCUboot’s `imgtool` is
