---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/ite/it82xx2_evb/doc/index.html
...
![IT82202 EVB](https://docs.zephyrproject.org/4.0.0/_images/it82xx2_evb_and_debug_card.jpg)
...
[boards/ite/it82xx2\_evb/it82xx2\_evb\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/ite/it82xx2_evb/it82xx2_evb_defconfig) Kconfig file.
...
4. Connect the USB to UART wire to J33 on the evolution motherboard.
   ...
   ![it82xx2_evb wiring](https://docs.zephyrproject.org/4.0.0/_images/it82xx2_evb_wiring.jpg)
...
1. Open the winflash tool and make sure the order you open the switch is right.
   ...
   > ![../../../../_images/WinFlashTool_P2.jpg](https://docs.zephyrproject.org/4.0.0/_images/WinFlashTool_P2.jpg)
   >
   > ![../../../../_images/WinFlashTool_P4.jpg](https://docs.zephyrproject.org/4.0.0/_images/WinFlashTool_P4.jpg)
2. Using the winflash tool flash `zephyr.bin` into your ITE board.
   ...
   > ![../../../../_images/WinFlashTool_P3.jpg](https://docs.zephyrproject.org/4.0.0/_images/WinFlashTool_P3.jpg)
3. At this point, you have flashed your image into ITE board and
   ...
   > ![../../../../_images/WinFlashTool_P1.jpg](https://docs.zephyrproject.org/4.0.0/_images/WinFlashTool_P1.jpg)
