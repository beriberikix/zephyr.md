---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/renesas/fpb_ra6e2/doc/index.html
...
![RA6E2 Fast Prototyping Board](https://docs.zephyrproject.org/4.0.0/_images/fpb_ra6e2.webp)
...
[![RA6E2 MCU group feature](https://docs.zephyrproject.org/4.0.0/_images/ra6e2_block_diagram1.webp)
](https://docs.zephyrproject.org/4.0.0/_images/ra6e2_block_diagram1.webp)

RA6E2 Block diagram (Credit: Renesas Electronics Corporation)

Detailed hardware feature for the FPB-RA6E2 MCU can be found at [FPB-RA6E2 - User’s Manual](https://www.renesas.com/us/en/document/mat/fpb-ra6e2-v1-users-manual)
