---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/intel/adsp/doc/intel_adsp_generic.html
original_path: boards/intel/adsp/doc/intel_adsp_generic.html
---
...
[UP Xtreme i11-0001 series](https://up-shop.org/up-xtreme-i11-boards-0001-series.html) ([Intel ADSP CAVS 2.5](intel_adsp_cavs25.md#intel-adsp-cavs25)) board as an example.
...
[soc/intel/intel\_adsp/tools/remote-fw-service.py](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/intel/intel_adsp/tools/remote-fw-service.py) will receive
the binary sent over the network by West and invoke
[soc/intel/intel\_adsp/tools/cavstool.py](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/intel/intel_adsp/tools/cavstool.py) (referred to as the
...
it sends requests using the [soc/intel/intel\_adsp/tools/cavstool\_client.py](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/intel/intel_adsp/tools/cavstool_client.py)
