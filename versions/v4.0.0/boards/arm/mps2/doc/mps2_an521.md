---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/arm/mps2/doc/mps2_an521.html
...
![ARM MPS2+ AN521](https://docs.zephyrproject.org/4.0.0/_images/mps2_an521.jpg)
...
Here is an example for the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application built as
