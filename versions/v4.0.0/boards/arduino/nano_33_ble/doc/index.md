---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/arduino/nano_33_ble/doc/index.html
...
![Arduino Nano 33 BLE (Sense variant)](https://docs.zephyrproject.org/4.0.0/_images/arduino_nano_33_ble_sense.jpg)
...
On Windows you need to use the `bossac.exe` from the [Arduino IDE](https://www.arduino.cc/en/Main/Software) [[7]](#id13)
...
![Nano 33 BLE SWD connecting](https://docs.zephyrproject.org/4.0.0/_images/nano_33_ble_swd.jpg)
...
[Lauterbach TRACE32 GDB Front-End Debugger for Nano 33 BLE](https://docs.arduino.cc/tutorials/nano-33-ble-sense/trace-32) [[5]](#id9)
...
The TRACE32 is [TRACE32 as GDB Front-End](https://www2.lauterbach.com/pdf/frontend_gdb.pdf) [[6]](#id11) version.
