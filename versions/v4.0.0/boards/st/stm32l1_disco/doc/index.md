---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/st/stm32l1_disco/doc/index.html
...
More information about the board can be found at the [STM32LDISCOVERY website](https://www.st.com/en/evaluation-tools/32l152cdiscovery.html) [[1]](#id3).
...
More information about STM32L151x can be found in the [STM32L1x reference manual](https://www.st.com/resource/en/reference_manual/cd00240193.pdf) [[2]](#id5).

### Supported Features

The Zephyr stm32l1\_disco and stm32l152c\_disco board configurations support
...
The configuration of stm32l1\_disco can be found in
[boards/st/stm32l1\_disco/stm32l1\_disco\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/stm32l1_disco/stm32l1_disco_defconfig)

Configuration of stm32l152c\_disco can be found in
[boards/st/stm32l1\_disco/stm32l152c\_disco\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/stm32l1_disco/stm32l152c_disco_defconfig)
...
For more details please refer to [STM32L1DISCOVERY board User Manual](https://www.st.com/resource/en/user_manual/dm00027954.pdf) [[3]](#id7).
...
The board is configured to be flashed using west [STM32CubeProgrammer](https://www.st.com/en/development-tools/stm32cubeprog.html) [[4]](#id9) runner,
