---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/st/stm32l4r9i_disco/doc/index.html
...
[![../../../../_images/stm32l4r9i_disco.jpg](https://docs.zephyrproject.org/4.0.0/_images/stm32l4r9i_disco.jpg)
](https://docs.zephyrproject.org/4.0.0/_images/stm32l4r9i_disco.jpg)
...
The current Zephyr stm32l4r9i\_disco board configuration supports the following hardware features:
...
| GPIO | on-chip | gpio |
| FLASH | on-chip | on-chip flash memory; external OctoSPI memory |
...
> [boards/st/stm32l4r9i\_disco/stm32l4r9i\_disco\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/stm32l4r9i_disco/stm32l4r9i_disco_defconfig)
