---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/native/doc/bsim_boards_design.html
...
![nrf_bsim boards and the native simulator](https://docs.zephyrproject.org/4.0.0/_images/components_bsim.svg)
...
![Zephyr layering in native & bsim builds](https://docs.zephyrproject.org/4.0.0/_images/layering_natsim.svg)
...
![Communication between a Zephyr device and other simulated devices](https://docs.zephyrproject.org/4.0.0/_images/Zephyr_and_bsim.svg)
