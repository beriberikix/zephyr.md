---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/96boards/carbon/doc/stm32f401xe.html
...
![96Boards Carbon](https://docs.zephyrproject.org/4.0.0/_images/96b_carbon.jpg)
...
3. Build and flash the `samples/bluetooth/peripheral_hr` application for
   ...
   west flash
   ```
4. Refer to the instructions in [Heart-rate Monitor (Peripheral)](../../../../samples/bluetooth/peripheral_hr/README.md#ble_peripheral_hr "Expose a Heart Rate (HR) GATT Service generating dummy heart-rate values.") for how
