---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/microchip/mec172xevb_assy6906/doc/index.html
...
[![../../../../_images/mec172xevb_assy6906.jpg](https://docs.zephyrproject.org/4.0.0/_images/mec172xevb_assy6906.jpg)
](https://docs.zephyrproject.org/4.0.0/_images/mec172xevb_assy6906.jpg)
...
1. Connect the SPI Dongle ASSY 6791 to `J34` in the EVB.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/4.0.0/_images/spidongle_assy67911.jpg)
2. Connect programmer to the header J6 on the Assy6791 board, it will flash the SPI NOR chip
   ...
   ![SF100 Connected](https://docs.zephyrproject.org/4.0.0/_images/dediprog_connector.jpg)
...
4. Apply power to the board via a micro-USB cable.
   ...
   ![Power Connection](https://docs.zephyrproject.org/4.0.0/_images/jp30_power_options.jpg)
...
2. Flash your board using `west` from the second terminal window.
   ...
   ![Reset Button](https://docs.zephyrproject.org/4.0.0/_images/Reset_Button.jpg)
