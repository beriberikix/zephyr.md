---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/altr/max10/doc/index.html
original_path: boards/altr/max10/doc/index.html
---
...
[![../../../../_images/altera_max10.jpg](https://docs.zephyrproject.org/4.0.0/_images/altera_max10.jpg)
](https://docs.zephyrproject.org/4.0.0/_images/altera_max10.jpg)
...
- Switch 2 (CONFIG\_SEL) should be in the OFF (up) position so that the first
  boot image is CFM0
- Switch 3 (VTAP\_BYPASS) needs to be in the ON (down) position or the flashing
  scripts won’t work
- Switch 4 (HSMC\_BYPASSN) should be OFF (up)

![Altera's MAX* 10 Switches](https://docs.zephyrproject.org/4.0.0/_images/Altera_MAX10_switches.jpg)
...
[Altera Lite Distribution](https://www.intel.com/content/www/us/en/collections/products/fpga/software/downloads.html) of Quartus may be obtained without
charge.
...
in the [soc/altr/zephyr\_nios2f/cpu](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/altr/zephyr_nios2f/cpu) directory.

Flash this CPU using the `nios2-configure-sof` SDK tool with the FPGA
configuration file
[soc/altr/zephyr\_nios2f/cpu/ghrd\_10m50da.sof](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/altr/zephyr_nios2f/cpu/ghrd_10m50da.sof):
...
Enable `jtag_uart` node in `altera_max10.dts` or overlay file:
...
west build -b altera_max10 samples/hello_world
west flash
```
...
directly into RAM and then boot it from the \_\_start symbol.
...
reset vector, instead it will boot from the \_\_start symbol:
...
- [CPU Documentation](https://www.altera.com/en_US/pdfs/literature/hb/nios2/n2cpu-nii5v1gen2.pdf)
- [Nios II Processor Booting Methods in MAX 10 FPGA Devices](https://www.altera.com/en_US/pdfs/literature/an/an730.pdf)
...
- [MAX 10 FPGA Configuration User Guide](https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/hb/max-10/ug_m10_config.pdf)
- [MAX 10 FPGA Development Kit User Guide](https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/ug-max10m50-fpga-dev-kit.pdf)
- [Nios II Command-Line Tools](https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/hb/nios2/edh_ed51004.pdf)
