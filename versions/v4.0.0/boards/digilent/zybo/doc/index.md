---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/boards/digilent/zybo/doc/index.html
...
![Digilent Zybo](https://docs.zephyrproject.org/4.0.0/_images/zybo-0.jpg)
...
Here is an example for running the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application via JTAG.
...
Another option is to load and run the [Hello World](../../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") application via U-Boot. Copy
