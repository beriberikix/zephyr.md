---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/safety/safety_requirements.html
original_path: safety/safety_requirements.html
---
...
the implementation, following the [route 3s](https://docs.zephyrproject.org/latest/safety/safety_overview.html#general-safety-scope)
...
[Requirement repository](https://github.com/zephyrproject-rtos/reqmgmt)
...
The tool used to manage requirements, [strictDoc](https://strictdoc.readthedocs.io/en/stable/), is
...
- Adhere to the [Contribution Guidelines](../contribute/guidelines.md#contribute-guidelines) of the Zephyr Project.
...
- Use of a recognized Requirements Syntax is recommended.
  ...
  - [EARS](https://alistairmavin.com/ears/) is a good reference. Particularly if you are
