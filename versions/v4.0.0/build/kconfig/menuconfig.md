---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/kconfig/menuconfig.html
...
2. To run the terminal-based `menuconfig` interface, use either of these
   ...
   ![menuconfig interface](https://docs.zephyrproject.org/4.0.0/_images/menuconfig.png)

   ![guiconfig interface](https://docs.zephyrproject.org/4.0.0/_images/guiconfig.png)
...
4. Pressing `Q` in the `menuconfig` interface will bring up the
   ...
   ![Save and Quit Dialog](https://docs.zephyrproject.org/4.0.0/_images/menuconfig-quit.png)
...
![menuconfig jump-to dialog](https://docs.zephyrproject.org/4.0.0/_images/menuconfig-jump-to.png)

![guiconfig jump-to dialog](https://docs.zephyrproject.org/4.0.0/_images/guiconfig-jump-to.png)
