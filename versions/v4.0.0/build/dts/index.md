---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/index.html
original_path: build/dts/index.html
---
...
- to describe hardware to the [Device Driver Model](../../kernel/drivers/index.md#device-model-api)
...
For the platform-independent details, see the [Devicetree specification](https://www.devicetree.org/).
