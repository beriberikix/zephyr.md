---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/microchip,mpfs-gpio.html
original_path: build/dts/api/bindings/gpio/microchip,mpfs-gpio.html
---
...
[drivers/gpio/gpio\_mchp\_mss.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mchp_mss.c).

## Description

```text
Microchip PolarFire SoC GPIO node
```
...
These property descriptions apply to “microchip,mpfs-gpio”
...
may apply to the “microchip,mpfs-gpio” compatible.
