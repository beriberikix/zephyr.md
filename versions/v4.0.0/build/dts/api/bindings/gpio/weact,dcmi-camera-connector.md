---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/weact,dcmi-camera-connector.html
original_path: build/dts/api/bindings/gpio/weact,dcmi-camera-connector.html
---

# weact,dcmi-camera-connector

Vendor: [WeAct Studio](../../bindings.md#dt-vendor-weact)
...
may apply to the “weact,dcmi-camera-connector” compatible.
