---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/ambiq,gpio-bank.html
original_path: build/dts/api/bindings/gpio/ambiq,gpio-bank.html
---
...
[drivers/gpio/gpio\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ambiq.c).

## Description

```text
Ambiq GPIO bank node
```
...
These property descriptions apply to “ambiq,gpio-bank”
...
may apply to the “ambiq,gpio-bank” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text This property indicates the register address offset of each GPIO child node under the "ambiq,gpio" parent node. The register address of pin described in gpio-cells can be obtained by: base address + child address offset + (pin << 2). ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
