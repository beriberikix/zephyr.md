---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nordic,npm1300-gpio.html
original_path: build/dts/api/bindings/gpio/nordic,npm1300-gpio.html
---
...
[drivers/gpio/gpio\_npm1300.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_npm1300.c).

## Description

```text
nPM1300 GPIO Controller
```
...
These property descriptions apply to “nordic,npm1300-gpio”
...
may apply to the “nordic,npm1300-gpio” compatible.
