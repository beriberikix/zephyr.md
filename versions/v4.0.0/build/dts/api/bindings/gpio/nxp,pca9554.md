---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,pca9554.html
original_path: build/dts/api/bindings/gpio/nxp,pca9554.html
---

# nxp,pca9554 (on i2c bus)
...
```text
NXP PCA9554 I2C GPIO expander node
```
...
These property descriptions apply to “nxp,pca9554”
...
may apply to the “nxp,pca9554” compatible.
