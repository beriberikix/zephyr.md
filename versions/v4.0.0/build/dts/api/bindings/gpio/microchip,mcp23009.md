---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/microchip,mcp23009.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23009.html
---

# microchip,mcp23009 (on i2c bus)
...
[drivers/gpio/gpio\_mcp230xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_mcp230xx.c).

## Description

```text
This is a representation of the Microchip MCP23009 I2C GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23009”
...
may apply to the “microchip,mcp23009” compatible.
