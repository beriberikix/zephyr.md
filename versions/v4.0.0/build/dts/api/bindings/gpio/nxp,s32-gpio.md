---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,s32-gpio.html
original_path: build/dts/api/bindings/gpio/nxp,s32-gpio.html
---
...
[drivers/gpio/gpio\_nxp\_s32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_nxp_s32.c).
...
These property descriptions apply to “nxp,s32-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `nxp,wkpu` | `phandle` | ```text NXP WKPU controller associated to this GPIO port. ``` |
| `nxp,wkpu-interrupts` | `array` | ```text Map between WKPU external interrupt sources and pins of this GPIO port, as in a tuple `<gpio-pin wkpu-interrupt-source>`. ``` |
...
may apply to the “nxp,s32-gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text register space ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
| `reg-names` | `string-array` | ```text name of each register space ```  This property is **required**. |
| `interrupts` | `array` | ```text For GPIO ports that have pins can be used for processing external interrupt signal, this is a list of GPIO pins and respective external interrupt lines (<gpio-pin eirq-line>). ```  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
