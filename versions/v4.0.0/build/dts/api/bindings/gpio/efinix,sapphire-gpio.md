---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/efinix,sapphire-gpio.html
original_path: build/dts/api/bindings/gpio/efinix,sapphire-gpio.html
---

# efinix,sapphire-gpio

Vendor: [Efinix Inc](../../bindings.md#dt-vendor-efinix)

Note

An implementation of a driver matching this compatible is available in
[drivers/gpio/gpio\_efinix\_sapphire.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_efinix_sapphire.c).
...
These property descriptions apply to “efinix,sapphire-gpio”
...
may apply to the “efinix,sapphire-gpio” compatible.
