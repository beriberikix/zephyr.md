---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/microchip,mcp23018.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23018.html
---

# microchip,mcp23018 (on i2c bus)
...
```text
This is a representation of the Microchip MCP23018 I2C GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23018”
...
may apply to the “microchip,mcp23018” compatible.
