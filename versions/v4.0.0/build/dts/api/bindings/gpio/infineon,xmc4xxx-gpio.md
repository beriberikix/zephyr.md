---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/infineon,xmc4xxx-gpio.html
original_path: build/dts/api/bindings/gpio/infineon,xmc4xxx-gpio.html
---

# infineon,xmc4xxx-gpio
...
[drivers/gpio/gpio\_xmc4xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_xmc4xxx.c).

## Description

```text
INFINEON XMC4XXX GPIO PORT node
```
...
These property descriptions apply to “infineon,xmc4xxx-gpio”
...
may apply to the “infineon,xmc4xxx-gpio” compatible.
