---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,lpc11u6x-gpio.html
original_path: build/dts/api/bindings/gpio/nxp,lpc11u6x-gpio.html
---
...
[drivers/gpio/gpio\_lpc11u6x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_lpc11u6x.c).

## Description

```text
NXP LPC11U6X GPIO node
```
...
These property descriptions apply to “nxp,lpc11u6x-gpio”
...
| `base` | `int` | ```text index of the first GPIO for this port. ``` |
| `iocon` | `phandle` | ```text a phandle reference to the devicetree node that contains the pinmux controller associated with the GPIO controller. ```  This property is **required**. |
...
may apply to the “nxp,lpc11u6x-gpio” compatible.
