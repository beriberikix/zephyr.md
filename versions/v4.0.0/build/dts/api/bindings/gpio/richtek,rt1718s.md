---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/richtek,rt1718s.html
original_path: build/dts/api/bindings/gpio/richtek,rt1718s.html
---

# richtek,rt1718s (on i2c bus)
...
[drivers/gpio/gpio\_rt1718s.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_rt1718s.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `irq-gpios` | `phandle-array` | ```text Interrupt GPIO pin connected from the chip(IRQB) ``` |
...
may apply to the “richtek,rt1718s” compatible.
