---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/openisa,rv32m1-gpio.html
original_path: build/dts/api/bindings/gpio/openisa,rv32m1-gpio.html
---
...
[drivers/gpio/gpio\_rv32m1.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_rv32m1.c).
...
These property descriptions apply to “openisa,rv32m1-gpio”
...
| `openisa,rv32m1-port` | `phandle` | ```text A phandle reference to the device tree node that contains the pinmux port associated with this GPIO controller. ```  This property is **required**. |
...
may apply to the “openisa,rv32m1-gpio” compatible.
