---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/gaisler,grgpio.html
original_path: build/dts/api/bindings/gpio/gaisler,grgpio.html
---
...
[drivers/gpio/gpio\_grgpio2.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_grgpio2.c).

## Description

```text
Gaisler GRLIB GRGPIO - General Purpose I/O Port
```
...
These property descriptions apply to “gaisler,grgpio”
...
may apply to the “gaisler,grgpio” compatible.
