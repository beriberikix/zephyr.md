---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nuvoton,nct38xx-gpio-port.html
...
| Name | Type | Details |
| --- | --- | --- |
| `pin_mask` | `int` | ```text Not every GPIOs are usable for different NCT38XX series. This property indicates the usable GPIO mask.  NCT3808: <0xdc> others: <0xff> ```  This property is **required**. |
| `pinmux_mask` | `int` | ```text NCT38XX series port 0 has Pin Multiplexing functionality. However, not every GPIOs have pinmux controller functionality. This property indicates the usable GPIO pinmux mask. For port 1, this property is ignored.  NCT3807 port 0: <0xf7> others: <0xff> ``` |
