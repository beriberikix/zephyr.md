---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nuvoton,numicro-gpio.html
original_path: build/dts/api/bindings/gpio/nuvoton,numicro-gpio.html
---
...
[drivers/gpio/gpio\_numicro.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_numicro.c).

## Description

```text
Nuvoton NuMicro GPIO node
```
...
These property descriptions apply to “nuvoton,numicro-gpio”
...
may apply to the “nuvoton,numicro-gpio” compatible.
