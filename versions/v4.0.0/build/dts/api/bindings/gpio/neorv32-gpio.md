---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/neorv32-gpio.html
original_path: build/dts/api/bindings/gpio/neorv32-gpio.html
---
...
[drivers/gpio/gpio\_neorv32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_neorv32.c).
...
These property descriptions apply to “neorv32-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `syscon` | `phandle` | ```text phandle to syscon (NEORV32 SYSINFO) node. ```  This property is **required**. |
...
may apply to the “neorv32-gpio” compatible.
