---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/snps,creg-gpio.html
...
| Name | Type | Details |
| --- | --- | --- |
| `bit_per_gpio` | `int` | This property is **required**. |
| `off_val` | `int` | This property is **required**. |
| `on_val` | `int` | This property is **required**. |
