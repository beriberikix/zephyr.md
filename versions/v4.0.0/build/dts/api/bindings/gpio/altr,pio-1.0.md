---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/altr,pio-1.0.html
original_path: build/dts/api/bindings/gpio/altr,pio-1.0.html
---

# altr,pio-1.0

Vendor: [Altera Corp.](../../bindings.md#dt-vendor-altr)

Note

An implementation of a driver matching this compatible is available in
[drivers/gpio/gpio\_altera\_pio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_altera_pio.c).
...
These property descriptions apply to “altr,pio-1.0”
...
| Name | Type | Details |
| --- | --- | --- |
| `direction` | `string` | ```text Direction can be set to bidir, input, inout or output. It cannot be configure when during the runtime and should be set according to the synthesized FPGA design. ```  Default value: `output`  Legal values: `'bidir'`, `'input'`, `'inout'`, `'output'` |
| `outset` | `boolean` | ```text Enable outset register to specify which bit of the output port to set. ``` |
| `outclear` | `boolean` | ```text Enable outclear register to specify which output bit to clear. ``` |
...
may apply to the “altr,pio-1.0” compatible.
