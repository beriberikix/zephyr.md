---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/cypress,psoc6-gpio.html
original_path: build/dts/api/bindings/gpio/cypress,psoc6-gpio.html
---
...
[drivers/gpio/gpio\_psoc6.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_psoc6.c).

## Description

```text
Cypress GPIO PORT node
```
...
These property descriptions apply to “cypress,psoc6-gpio”
...
| `#cypress,pin-cells` | `int` | ```text Number of items to expect in a cypress,pins specifier ```  This property is **required**.  Constant value: `2` |
...
may apply to the “cypress,psoc6-gpio” compatible.
