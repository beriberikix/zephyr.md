---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,pca9539.html
original_path: build/dts/api/bindings/gpio/nxp,pca9539.html
---

# nxp,pca9539 (on i2c bus)
...
```text
NXP PCA9539 I2C GPIO expander node
```
...
These property descriptions apply to “nxp,pca9539”
...
may apply to the “nxp,pca9539” compatible.
