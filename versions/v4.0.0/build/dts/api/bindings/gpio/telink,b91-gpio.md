---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/telink,b91-gpio.html
original_path: build/dts/api/bindings/gpio/telink,b91-gpio.html
---
...
[drivers/gpio/gpio\_b91.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_b91.c).

## Description

```text
Telink B91 GPIO node
```
...
These property descriptions apply to “telink,b91-gpio”
...
may apply to the “telink,b91-gpio” compatible.
