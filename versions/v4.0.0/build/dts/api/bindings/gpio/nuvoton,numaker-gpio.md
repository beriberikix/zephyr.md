---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nuvoton,numaker-gpio.html
original_path: build/dts/api/bindings/gpio/nuvoton,numaker-gpio.html
---
...
[drivers/gpio/gpio\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_numaker.c).

## Description

```text
Nuvoton, Numaker-GPIO node
```
...
These property descriptions apply to “nuvoton,numaker-gpio”
...
may apply to the “nuvoton,numaker-gpio” compatible.
