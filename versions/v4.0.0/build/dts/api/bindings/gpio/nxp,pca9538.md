---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,pca9538.html
original_path: build/dts/api/bindings/gpio/nxp,pca9538.html
---

# nxp,pca9538 (on i2c bus)
...
```text
NXP PCA9538 I2C GPIO expander node
```
...
These property descriptions apply to “nxp,pca9538”
...
may apply to the “nxp,pca9538” compatible.
