---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/ti,cc13xx-cc26xx-gpio.html
original_path: build/dts/api/bindings/gpio/ti,cc13xx-cc26xx-gpio.html
---
...
[drivers/gpio/gpio\_cc13xx\_cc26xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_cc13xx_cc26xx.c).

## Description

```text
TI SimpleLink CC13xx / CC26xx GPIO node
```
...
These property descriptions apply to “ti,cc13xx-cc26xx-gpio”
...
may apply to the “ti,cc13xx-cc26xx-gpio” compatible.
