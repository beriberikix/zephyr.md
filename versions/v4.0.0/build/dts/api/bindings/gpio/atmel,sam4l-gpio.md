---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/atmel,sam4l-gpio.html
original_path: build/dts/api/bindings/gpio/atmel,sam4l-gpio.html
---
...
[drivers/gpio/gpio\_sam4l.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_sam4l.c).

## Description

```text
SAM4L GPIO PORT node
```
...
These property descriptions apply to “atmel,sam4l-gpio”
...
| `#atmel,pin-cells` | `int` | ```text Number of items to expect in a atmel,pins specifier ```  This property is **required**.  Constant value: `2` |
...
may apply to the “atmel,sam4l-gpio” compatible.
...
- atmel,pin cells: pin, peripheral
