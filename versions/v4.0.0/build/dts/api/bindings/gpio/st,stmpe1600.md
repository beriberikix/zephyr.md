---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/st,stmpe1600.html
original_path: build/dts/api/bindings/gpio/st,stmpe1600.html
---

# st,stmpe1600 (on i2c bus)
...
[drivers/gpio/gpio\_stmpe1600.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_stmpe1600.c).

## Description

```text
STMPE1600 I2C-based GPIO expander
```
...
These property descriptions apply to “st,stmpe1600”
...
may apply to the “st,stmpe1600” compatible.
