---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/renesas,ra-gpio-ioport.html
...
| `vbatts_pins` | `array` | ```text Array of vbatt pin on port ``` |
