---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/nxp,pcf857x.html
original_path: build/dts/api/bindings/gpio/nxp,pcf857x.html
---

# nxp,pcf857x (on i2c bus)
...
[drivers/gpio/gpio\_pcf857x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_pcf857x.c).

## Description

```text
PCF857x 8/16-bit I2C-based I/O expander
```
...
These property descriptions apply to “nxp,pcf857x”
...
may apply to the “nxp,pcf857x” compatible.
