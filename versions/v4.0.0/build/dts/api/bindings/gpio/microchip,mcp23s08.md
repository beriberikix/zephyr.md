---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/microchip,mcp23s08.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23s08.html
---

# microchip,mcp23s08 (on spi bus)
...
```text
This is a representation of the Microchip MCP23S08 SPI GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23s08”
...
may apply to the “microchip,mcp23s08” compatible.
