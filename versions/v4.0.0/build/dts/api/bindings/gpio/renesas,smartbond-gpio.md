---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/renesas,smartbond-gpio.html
original_path: build/dts/api/bindings/gpio/renesas,smartbond-gpio.html
---

# renesas,smartbond-gpio
...
[drivers/gpio/gpio\_smartbond.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_smartbond.c).

## Description

```text
Renesas SmartBond(tm) GPIO node
```
...
These property descriptions apply to “renesas,smartbond-gpio”
...
may apply to the “renesas,smartbond-gpio” compatible.
