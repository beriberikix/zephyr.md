---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/ti,lmp90xxx-gpio.html
original_path: build/dts/api/bindings/gpio/ti,lmp90xxx-gpio.html
---

# ti,lmp90xxx-gpio (on lmp90xxx bus)
...
[drivers/gpio/gpio\_lmp90xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_lmp90xxx.c).

## Description

```text
TI LMP90xxx GPIO controller binding
```
...
These property descriptions apply to “ti,lmp90xxx-gpio”
...
may apply to the “ti,lmp90xxx-gpio” compatible.
