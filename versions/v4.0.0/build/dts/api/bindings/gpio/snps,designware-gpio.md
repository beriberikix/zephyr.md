---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/snps,designware-gpio.html
original_path: build/dts/api/bindings/gpio/snps,designware-gpio.html
---
...
[drivers/gpio/gpio\_dw.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_dw.c).

## Description

```text
Synopsys DesignWare GPIO node
```
...
These property descriptions apply to “snps,designware-gpio”
...
may apply to the “snps,designware-gpio” compatible.
