---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/ti,ads114s0x-gpio.html
original_path: build/dts/api/bindings/gpio/ti,ads114s0x-gpio.html
---

# ti,ads114s0x-gpio (on ads114s0x bus)
...
[drivers/gpio/gpio\_ads114s0x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ads114s0x.c).

## Description

```text
TI ADS114S0x GPIO controller binding
```
...
These property descriptions apply to “ti,ads114s0x-gpio”
...
may apply to the “ti,ads114s0x-gpio” compatible.
