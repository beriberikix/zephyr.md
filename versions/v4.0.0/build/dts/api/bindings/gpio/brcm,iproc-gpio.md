---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/brcm,iproc-gpio.html
original_path: build/dts/api/bindings/gpio/brcm,iproc-gpio.html
---
...
[drivers/gpio/gpio\_iproc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_iproc.c).
...
These property descriptions apply to “brcm,iproc-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `ngpios` | `int` | ```text Total number of in-use slots in GPIO controller ```  This property is **required**.  Default value: `32` |
...
may apply to the “brcm,iproc-gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text Define the base and range of the I/O address space that contains SoC GPIO/PINCONF controller registers ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
