---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/ti,stellaris-gpio.html
original_path: build/dts/api/bindings/gpio/ti,stellaris-gpio.html
---
...
[drivers/gpio/gpio\_stellaris.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_stellaris.c).

## Description

```text
TI Stellaris GPIO node
```
...
These property descriptions apply to “ti,stellaris-gpio”
...
may apply to the “ti,stellaris-gpio” compatible.
