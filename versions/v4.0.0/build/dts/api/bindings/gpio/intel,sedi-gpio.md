---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/gpio/intel,sedi-gpio.html
original_path: build/dts/api/bindings/gpio/intel,sedi-gpio.html
---
...
[drivers/gpio/gpio\_sedi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_sedi.c).
...
These property descriptions apply to “intel,sedi-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `peripheral-id` | `int` | ```text Peripheral Instance ID ```  This property is **required**. |
...
may apply to the “intel,sedi-gpio” compatible.
