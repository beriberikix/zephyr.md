---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mfd/adi,ad559x-spi.html
original_path: build/dts/api/bindings/mfd/adi,ad559x-spi.html
---

# adi,ad559x (on spi bus)
...
[drivers/mfd/mfd\_ad559x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mfd/mfd_ad559x.c).

## Description

```text
Analog AD559X ADC/DAC/GPIO chip via SPI bus
```
...
may apply to the “adi,ad559x” compatible.
