---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/zephyr,dma-emul.html
original_path: build/dts/api/bindings/dma/zephyr,dma-emul.html
---
...
[drivers/dma/dma\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_emul.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `stack-size` | `int` | ```text Stack size (in bytes) for the instance-specific work_q thread. ```  This property is **required**. |
| `priority` | `int` | ```text Priority for the instance-specific work_q thread. ``` |
...
may apply to the “zephyr,dma-emul” compatible.
