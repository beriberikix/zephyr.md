---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/altr,msgdma.html
original_path: build/dts/api/bindings/dma/altr,msgdma.html
---
...
[drivers/dma/dma\_nios2\_msgdma.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_nios2_msgdma.c).
...
```text
Altera mSGDMA (Modular Scatter-Gather DMA)
```
...
may apply to the “altr,msgdma” compatible.
