---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/raspberrypi,pico-dma.html
original_path: build/dts/api/bindings/dma/raspberrypi,pico-dma.html
---
...
[drivers/dma/dma\_rpi\_pico.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_rpi_pico.c).
...
| `irq0-channels` | `uint8-array` | ```text Channels list that uses the irq0 ```  Default value: `[0, 2, 4, 6, 8, 10]` |
...
may apply to the “raspberrypi,pico-dma” compatible.
