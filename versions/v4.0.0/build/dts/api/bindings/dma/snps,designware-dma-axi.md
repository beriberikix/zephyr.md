---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/snps,designware-dma-axi.html
original_path: build/dts/api/bindings/dma/snps,designware-dma-axi.html
---
...
[drivers/dma/dma\_dw\_axi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_dw_axi.c).
...
```text
Synopsys Designware axi DMA Controller node
```
...
may apply to the “snps,designware-dma-axi” compatible.
