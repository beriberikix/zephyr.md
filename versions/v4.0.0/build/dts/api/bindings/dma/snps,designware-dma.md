---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/snps,designware-dma.html
original_path: build/dts/api/bindings/dma/snps,designware-dma.html
---
...
[drivers/dma/dma\_dw.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_dw.c).
...
```text
Synopsys Designware DMA Controller node
```
...
may apply to the “snps,designware-dma” compatible.
