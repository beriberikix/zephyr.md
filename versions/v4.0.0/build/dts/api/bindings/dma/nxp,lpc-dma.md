---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/nxp,lpc-dma.html
original_path: build/dts/api/bindings/dma/nxp,lpc-dma.html
---
...
[drivers/dma/dma\_mcux\_lpc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_mcux_lpc.c).
...
| `nxp,dma-num-of-otrigs` | `int` | ```text Number of Inputmux connections a DMA channel can receive from ``` |
| `nxp,dma-otrig-base-address` | `int` | ```text Address used when listening to Inputmux DMA signals ``` |
| `nxp,dma-itrig-base-address` | `int` | ```text DMA Channel Selection Address used for receiving signals ``` |
...
may apply to the “nxp,lpc-dma” compatible.
