---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/arm,dma-pl330.html
original_path: build/dts/api/bindings/dma/arm,dma-pl330.html
---
...
[drivers/dma](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma).
...
| Name | Type | Details |
| --- | --- | --- |
| `microcode` | `array` | ```text microcode's physical memory address ```  This property is **required**. |
...
may apply to the “arm,dma-pl330” compatible.
