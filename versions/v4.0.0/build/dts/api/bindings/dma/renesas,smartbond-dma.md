---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/renesas,smartbond-dma.html
original_path: build/dts/api/bindings/dma/renesas,smartbond-dma.html
---

# renesas,smartbond-dma
...
[drivers/dma/dma\_smartbond.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_smartbond.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `block-count` | `int` | ```text Number of block counts supported ```  This property is **required**.  Constant value: `1` |
...
may apply to the “renesas,smartbond-dma” compatible.
