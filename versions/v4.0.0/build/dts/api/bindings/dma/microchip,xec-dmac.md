---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/microchip,xec-dmac.html
original_path: build/dts/api/bindings/dma/microchip,xec-dmac.html
---
...
[drivers/dma/dma\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_mchp_xec.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `pcrs` | `array` | ```text PCR register index and bit position ```  This property is **required**. |
| `girqs` | `array` | ```text Encoded interrupt information ```  This property is **required**. |
| `aggregated-girq` | `phandle` | ```text If DMA driver uses aggregated interrupt mode provide the handle to the GIRQ. ``` |
...
| `girq-cells` | `int` | Constant value: `2` |
...
may apply to the “microchip,xec-dmac” compatible.
