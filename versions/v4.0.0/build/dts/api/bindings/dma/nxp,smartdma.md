---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/nxp,smartdma.html
original_path: build/dts/api/bindings/dma/nxp,smartdma.html
---
...
[drivers/dma/dma\_mcux\_smartdma.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_mcux_smartdma.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `program-mem` | `int` | ```text Program memory to load SMARTDMA routines into. Must be set to a RAM region that the SMARTDMA can access on the chip. ```  This property is **required**. |
...
may apply to the “nxp,smartdma” compatible.
