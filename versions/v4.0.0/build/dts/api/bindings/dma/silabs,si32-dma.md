---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dma/silabs,si32-dma.html
original_path: build/dts/api/bindings/dma/silabs,si32-dma.html
---
...
[drivers/dma/dma\_si32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dma/dma_si32.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `dma-channels` | `int` | ```text Limiting the number of enabled channels saves RAM. ```  This property is **required**. |
...
may apply to the “silabs,si32-dma” compatible.
...
- dma cells: channel, high-prio, rpower
