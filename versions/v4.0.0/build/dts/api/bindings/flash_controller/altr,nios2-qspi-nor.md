---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/flash_controller/altr,nios2-qspi-nor.html
original_path: build/dts/api/bindings/flash_controller/altr,nios2-qspi-nor.html
---

# altr,nios2-qspi-nor (on qspi bus)
...
[drivers/flash/soc\_flash\_nios2\_qspi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/soc_flash_nios2_qspi.c).

## Description

```text
Altera NIOS2 QSPI Flash controller supporting the JEDEC CFI interface
```
...
may apply to the “altr,nios2-qspi-nor” compatible.
