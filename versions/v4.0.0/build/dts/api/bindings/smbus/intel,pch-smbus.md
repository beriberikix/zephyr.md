---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/smbus/intel,pch-smbus.html
original_path: build/dts/api/bindings/smbus/intel,pch-smbus.html
---
...
[drivers/smbus/intel\_pch\_smbus.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/smbus/intel_pch_smbus.c).
...
```text
Intel Platform Controller Hub SMBus node
```
...
may apply to the “intel,pch-smbus” compatible.
