---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/bluetooth/st,hci-spi-v1.html
original_path: build/dts/api/bindings/bluetooth/st,hci-spi-v1.html
---

# st,hci-spi-v1 (on spi bus)
...
may apply to the “st,hci-spi-v1” compatible.
