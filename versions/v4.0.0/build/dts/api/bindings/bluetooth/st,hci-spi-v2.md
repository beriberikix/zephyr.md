---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/bluetooth/st,hci-spi-v2.html
original_path: build/dts/api/bindings/bluetooth/st,hci-spi-v2.html
---

# st,hci-spi-v2 (on spi bus)
...
[drivers/bluetooth/hci/hci\_spi\_st.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/bluetooth/hci/hci_spi_st.c).

## Description

```text
STMicroelectronics SPI protocol V2 compatible with BlueNRG-1 and successor devices
```
...
may apply to the “st,hci-spi-v2” compatible.
