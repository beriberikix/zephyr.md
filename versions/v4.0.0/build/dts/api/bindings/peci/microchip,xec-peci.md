---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/peci/microchip,xec-peci.html
original_path: build/dts/api/bindings/peci/microchip,xec-peci.html
---
...
[drivers/peci/peci\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/peci/peci_mchp_xec.c).

## Description

These nodes are “peci” bus nodes.

```text
Microchip XEC PECI controller
```
...
may apply to the “microchip,xec-peci” compatible.
