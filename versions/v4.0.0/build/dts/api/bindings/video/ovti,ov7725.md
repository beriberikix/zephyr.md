---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/video/ovti,ov7725.html
original_path: build/dts/api/bindings/video/ovti,ov7725.html
---

# ovti,ov7725 (on i2c bus)
...
[drivers/video/ov7725.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/video/ov7725.c).

## Description

```text
OV7725 CMOS video sensor
```
...
These property descriptions apply to “ovti,ov7725”
...
may apply to the “ovti,ov7725” compatible.
