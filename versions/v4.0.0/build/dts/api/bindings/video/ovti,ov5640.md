---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/video/ovti,ov5640.html
original_path: build/dts/api/bindings/video/ovti,ov5640.html
---

# ovti,ov5640 (on i2c bus)

Vendor: [OmniVision Technologies Co., Ltd.](../../bindings.md#dt-vendor-ovti)

Note

An implementation of a driver matching this compatible is available in
[drivers/video/ov5640.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/video/ov5640.c).
...
These property descriptions apply to “ovti,ov5640”
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text The RESETB pin is asserted to cause a hard reset. The sensor receives this as an active-low signal. ``` |
| `powerdown-gpios` | `phandle-array` | ```text The PWDN pin is asserted to disable the sensor. The sensor receives this as an active-high signal. ``` |
...
may apply to the “ovti,ov5640” compatible.
