---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/maxim,max11110.html
original_path: build/dts/api/bindings/adc/maxim,max11110.html
---

# maxim,max11110 (on spi bus)
...
```text
Maxim Integrated 1 channel 10 bit 2 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11110”
...
may apply to the “maxim,max11110” compatible.
