---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/nxp,kinetis-adc12.html
original_path: build/dts/api/bindings/adc/nxp,kinetis-adc12.html
---
...
[drivers/adc/adc\_mcux\_adc12.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_mcux_adc12.c).
...
These property descriptions apply to “nxp,kinetis-adc12”
...
| Name | Type | Details |
| --- | --- | --- |
| `clk-source` | `int` | ```text converter clock source ```  This property is **required**. |
| `clk-divider` | `int` | ```text clock divider for the converter ```  This property is **required**. |
| `alternate-voltage-reference` | `boolean` | ```text use alternate voltage reference source ``` |
| `sample-time` | `int` | ```text sample time in clock cycles ```  This property is **required**. |
| `vref-mv` | `int` | ```text Indicates the reference voltage of the ADC in mV. ```  This property is **required**. |
...
may apply to the “nxp,kinetis-adc12” compatible.
