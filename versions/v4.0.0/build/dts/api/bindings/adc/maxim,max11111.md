---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/maxim,max11111.html
original_path: build/dts/api/bindings/adc/maxim,max11111.html
---

# maxim,max11111 (on spi bus)
...
```text
Maxim Integrated 2 channels 8 bit 3 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11111”
...
may apply to the “maxim,max11111” compatible.
