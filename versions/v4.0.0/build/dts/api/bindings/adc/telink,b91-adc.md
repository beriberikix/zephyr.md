---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/telink,b91-adc.html
original_path: build/dts/api/bindings/adc/telink,b91-adc.html
---
...
[drivers/adc/adc\_b91.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_b91.c).
...
These property descriptions apply to “telink,b91-adc”
...
| `sample-freq` | `int` | ```text This property selects the ADC source frequency: 23 kHz, 48 kHz, or 96 kHz. ```  This property is **required**.  Legal values: `23000`, `48000`, `96000` |
| `vref-internal-mv` | `int` | ```text This property selects the internal reference voltage source (in millivolts). The external reference source is not supported. ```  This property is **required**.  Legal values: `900`, `1200` |
...
may apply to the “telink,b91-adc” compatible.
