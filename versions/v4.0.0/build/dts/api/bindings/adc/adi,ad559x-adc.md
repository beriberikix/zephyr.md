---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/adi,ad559x-adc.html
original_path: build/dts/api/bindings/adc/adi,ad559x-adc.html
---
...
[drivers/adc/adc\_ad559x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ad559x.c).

## Description

```text
AD559x ADC Controller
```
...
These property descriptions apply to “adi,ad559x-adc”
...
may apply to the “adi,ad559x-adc” compatible.
