---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/maxim,max11105.html
original_path: build/dts/api/bindings/adc/maxim,max11105.html
---

# maxim,max11105 (on spi bus)
...
```text
Maxim Integrated 1 channel 12 bit 2 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11105”
...
may apply to the “maxim,max11105” compatible.
