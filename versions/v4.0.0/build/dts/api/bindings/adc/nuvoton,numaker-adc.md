---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/nuvoton,numaker-adc.html
original_path: build/dts/api/bindings/adc/nuvoton,numaker-adc.html
---
...
[drivers/adc/adc\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_numaker.c).

## Description

```text
Nuvoton, NuMaker ADC controller
```
...
These property descriptions apply to “nuvoton,numaker-adc”
...
| `channels` | `int` | ```text Number of channels ```  This property is **required**. |
...
may apply to the “nuvoton,numaker-adc” compatible.
