---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/atmel,sam-afec.html
original_path: build/dts/api/bindings/adc/atmel,sam-afec.html
---
...
[drivers/adc/adc\_sam\_afec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_sam_afec.c).

## Description

```text
Atmel SAM family AFEC
```
...
These property descriptions apply to “atmel,sam-afec”
...
may apply to the “atmel,sam-afec” compatible.
