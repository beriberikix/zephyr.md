---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/silabs,gecko-adc.html
original_path: build/dts/api/bindings/adc/silabs,gecko-adc.html
---
...
[drivers/adc/adc\_gecko.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_gecko.c).

## Description

```text
Silicon Labs Gecko Series 1 ADC
```
...
These property descriptions apply to “silabs,gecko-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `frequency` | `int` | This property is **required**. |
...
may apply to the “silabs,gecko-adc” compatible.
