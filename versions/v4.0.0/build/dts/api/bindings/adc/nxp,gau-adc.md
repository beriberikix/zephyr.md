---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/nxp,gau-adc.html
original_path: build/dts/api/bindings/adc/nxp,gau-adc.html
---
...
[drivers/adc/adc\_mcux\_gau\_adc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_mcux_gau_adc.c).
...
These property descriptions apply to “nxp,gau-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `nxp,clock-divider` | `int` | ```text Clock divider from 1 to 32. Default is 1 which is reset value. ```  Default value: `1` |
| `nxp,power-mode` | `string` | ```text Current bias. Default is "full-bias" because it is the reset value. ```  Default value: `full-bias`  Legal values: `'full-bias'`, `'half-bias'` |
| `nxp,input-buffer` | `boolean` | ```text Enable use of the input buffer ``` |
| `nxp,calibration-voltage` | `string` | ```text Use external calibration voltage. Default is "internal" because it is the reset value. ```  Default value: `internal`  Legal values: `'internal'`, `'external'` |
...
may apply to the “nxp,gau-adc” compatible.
