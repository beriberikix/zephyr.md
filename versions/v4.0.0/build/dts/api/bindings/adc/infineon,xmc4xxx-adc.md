---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/infineon,xmc4xxx-adc.html
original_path: build/dts/api/bindings/adc/infineon,xmc4xxx-adc.html
---
...
[drivers/adc/adc\_xmc4xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_xmc4xxx.c).
...
These property descriptions apply to “infineon,xmc4xxx-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `vref-internal-mv` | `int` | ```text This property sets the internal reference voltage (in millivolts). ```  This property is **required**. |
...
may apply to the “infineon,xmc4xxx-adc” compatible.
