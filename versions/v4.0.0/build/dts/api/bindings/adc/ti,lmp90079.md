---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/ti,lmp90079.html
original_path: build/dts/api/bindings/adc/ti,lmp90079.html
---

# ti,lmp90079 (on spi bus)
...
```text
Texas Instruments LMP90079 AFE binding
```
...
These property descriptions apply to “ti,lmp90079”
...
may apply to the “ti,lmp90079” compatible.
