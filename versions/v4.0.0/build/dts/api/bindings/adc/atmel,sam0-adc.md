---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/atmel,sam0-adc.html
original_path: build/dts/api/bindings/adc/atmel,sam0-adc.html
---
...
[drivers/adc/adc\_sam0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_sam0.c).

## Description

```text
Atmel SAM0 family ADC
```
...
These property descriptions apply to “atmel,sam0-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `gclk` | `int` | ```text generic clock generator source ```  This property is **required**. |
| `prescaler` | `int` | ```text clock prescaler divisor applied to the generic clock ```  This property is **required**. |
| `#io-channel-cells` | `int` | This property is **required**.  Constant value: `1` |
| `calib-offset` | `int` | ```text bit position offset in NVM SW Calib for start of ADC0 BIASCOMP field. This property is expected to be set on SAM{D,E}5x family of SoCs. For ADC0 this should be 0, and for ADC1 this should be 14. ```  Legal values: `0`, `14` |
...
may apply to the “atmel,sam0-adc” compatible.
