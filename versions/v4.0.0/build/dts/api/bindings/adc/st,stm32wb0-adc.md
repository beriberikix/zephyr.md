---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/st,stm32wb0-adc.html
original_path: build/dts/api/bindings/adc/st,stm32wb0-adc.html
---
...
[drivers/adc/adc\_stm32wb0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_stm32wb0.c).

## Description

```text
STM32WB0 series Analog-to-Digital Converter
```
...
These property descriptions apply to “st,stm32wb0-adc”
...
| `io-booster` | `boolean` | ```text When set, the I/O Booster block is enabled during ADC usage. Otherwise, the I/O Booster block is always disabled. This property MUST be set if VBAT voltage may reach a value below 2.7V to guarantee that the ADC behavior remains correct. ``` |
...
may apply to the “st,stm32wb0-adc” compatible.
