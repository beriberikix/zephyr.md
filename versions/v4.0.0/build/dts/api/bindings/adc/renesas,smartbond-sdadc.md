---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/renesas,smartbond-sdadc.html
original_path: build/dts/api/bindings/adc/renesas,smartbond-sdadc.html
---

# renesas,smartbond-sdadc
...
[drivers/adc/adc\_smartbond\_sdadc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_smartbond_sdadc.c).

## Description

```text
Renesas SmartBond(tm) ADC node
```
...
These property descriptions apply to “renesas,smartbond-sdadc”
...
| `clock-freq` | `int` | ```text SDADC clock frequency selector; ```  Legal values: `0`, `1`, `2`, `3` |
...
may apply to the “renesas,smartbond-sdadc” compatible.
