---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/microchip,xec-adc.html
original_path: build/dts/api/bindings/adc/microchip,xec-adc.html
---
...
[drivers/adc/adc\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_mchp_xec.c).
...
These property descriptions apply to “microchip,xec-adc”
...
| `pcrs` | `array` | ```text ADC PCR register index and bit position ```  This property is **required**. |
| `clktime` | `int` | ```text ADC clock high & low time count value <1:255> ```  This property is **required**. |
...
may apply to the “microchip,xec-adc” compatible.
