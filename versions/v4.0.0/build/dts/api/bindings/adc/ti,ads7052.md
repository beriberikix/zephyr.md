---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/ti,ads7052.html
original_path: build/dts/api/bindings/adc/ti,ads7052.html
---

# ti,ads7052 (on spi bus)
...
[drivers/adc/adc\_ads7052.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ads7052.c).

## Description

```text
Texas Instrument Single Channel SPI ADC
```
...
These property descriptions apply to “ti,ads7052”
...
may apply to the “ti,ads7052” compatible.
