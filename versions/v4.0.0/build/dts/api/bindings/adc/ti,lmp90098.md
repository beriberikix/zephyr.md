---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/ti,lmp90098.html
original_path: build/dts/api/bindings/adc/ti,lmp90098.html
---

# ti,lmp90098 (on spi bus)
...
```text
Texas Instruments LMP90098 AFE binding
```
...
These property descriptions apply to “ti,lmp90098”
...
may apply to the “ti,lmp90098” compatible.
