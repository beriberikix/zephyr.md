---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/maxim,max11115.html
original_path: build/dts/api/bindings/adc/maxim,max11115.html
---

# maxim,max11115 (on spi bus)
...
```text
Maxim Integrated 1 channel 8 bit 2 Msps SPI ADC
```
...
These property descriptions apply to “maxim,max11115”
...
may apply to the “maxim,max11115” compatible.
