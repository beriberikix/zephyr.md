---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/gd,gd32-adc.html
original_path: build/dts/api/bindings/adc/gd,gd32-adc.html
---
...
[drivers/adc/adc\_gd32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_gd32.c).
...
These property descriptions apply to “gd,gd32-adc”
...
| `rcu-clock-source` | `int` | ```text Some GD32 ADC have additional clock source, like IRC14M or IRC28M. This property used to select the clock and related prescaler, valid values defined at 'dts-bindings/adc/gd32xxx.h' headers. ``` |
| `channels` | `int` | ```text Number of external channels ```  This property is **required**. |
...
may apply to the “gd,gd32-adc” compatible.
