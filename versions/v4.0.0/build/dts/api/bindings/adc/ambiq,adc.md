---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/ambiq,adc.html
original_path: build/dts/api/bindings/adc/ambiq,adc.html
---
...
[drivers/adc/adc\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ambiq.c).
...
These property descriptions apply to “ambiq,adc”
...
| `internal-vref-mv` | `int` | ```text Indicates the reference voltage of the ADC in mV. ```  This property is **required**. |
...
| `ambiq,pwrcfg` | `phandle-array` | ```text Power configuration ``` |
...
may apply to the “ambiq,adc” compatible.
