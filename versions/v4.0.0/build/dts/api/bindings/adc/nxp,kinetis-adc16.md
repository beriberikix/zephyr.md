---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/nxp,kinetis-adc16.html
original_path: build/dts/api/bindings/adc/nxp,kinetis-adc16.html
---
...
[drivers/adc/adc\_mcux\_adc16.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_mcux_adc16.c).
...
These property descriptions apply to “nxp,kinetis-adc16”
...
| Name | Type | Details |
| --- | --- | --- |
| `channel-mux-b` | `boolean` | ```text Use alternate set (b instead of a) of ADC channels ``` |
| `periodic-trigger` | `boolean` | ```text if periodic trigger enabled ``` |
| `#io-channel-cells` | `int` | This property is **required**.  Constant value: `1` |
| `clk-source` | `int` | ```text use alternate clock reference source ``` |
| `long-sample` | `int` | ```text long sample mode ```  Legal values: `0`, `1`, `2`, `3`, `4` |
| `continuous-convert` | `boolean` | ```text If use continuous convert ``` |
| `high-speed` | `boolean` | ```text If use high speed ``` |
| `hw-trigger-src` | `int` | ```text hardware trigger source (See ADCxTRGSEL field in user manual for more details) ``` |
...
may apply to the “nxp,kinetis-adc16” compatible.
