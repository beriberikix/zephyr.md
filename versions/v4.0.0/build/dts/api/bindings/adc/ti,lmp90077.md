---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/adc/ti,lmp90077.html
original_path: build/dts/api/bindings/adc/ti,lmp90077.html
---

# ti,lmp90077 (on spi bus)
...
```text
Texas Instruments LMP90077 AFE binding
```
...
These property descriptions apply to “ti,lmp90077”
...
may apply to the “ti,lmp90077” compatible.
