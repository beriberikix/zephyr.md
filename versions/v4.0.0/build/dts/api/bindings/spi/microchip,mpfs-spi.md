---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/microchip,mpfs-spi.html
original_path: build/dts/api/bindings/spi/microchip,mpfs-spi.html
---
...
[drivers/spi/spi\_mchp\_mss.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_mchp_mss.c).
...
```text
Microchip Polarfire SOC SPI IP node
```
...
may apply to the “microchip,mpfs-spi” compatible.
