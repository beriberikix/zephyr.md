---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/opencores,spi-simple.html
original_path: build/dts/api/bindings/spi/opencores,spi-simple.html
---

# opencores,spi-simple

Vendor: [OpenCores.org](../../bindings.md#dt-vendor-opencores)

Note

An implementation of a driver matching this compatible is available in
[drivers/spi/spi\_oc\_simple.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_oc_simple.c).
...
may apply to the “opencores,spi-simple” compatible.
