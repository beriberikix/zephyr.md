---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/zephyr,spi-emul-controller.html
original_path: build/dts/api/bindings/spi/zephyr,spi-emul-controller.html
---
...
[drivers/spi/spi\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_emul.c).
...
```text
Zephyr SPI Emulation controller
```
...
may apply to the “zephyr,spi-emul-controller” compatible.
