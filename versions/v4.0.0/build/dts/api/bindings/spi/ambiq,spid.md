---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/ambiq,spid.html
original_path: build/dts/api/bindings/spi/ambiq,spid.html
---
...
[drivers/spi/spi\_ambiq\_spid.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_ambiq_spid.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text GPIO that interrupts the SPI controller to require operation ```  This property is **required**. |
...
may apply to the “ambiq,spid” compatible.
