---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/nxp,flexio-spi.html
original_path: build/dts/api/bindings/spi/nxp,flexio-spi.html
---
...
[drivers/spi/spi\_mcux\_flexio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_mcux_flexio.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `sdo-pin` | `int` | ```text Pin select for data output. ```  This property is **required**. |
| `sdi-pin` | `int` | ```text Pin select for data input. ```  This property is **required**. |
| `sck-pin` | `int` | ```text Pin select for clock. ```  This property is **required**. |
...
may apply to the “nxp,flexio-spi” compatible.
