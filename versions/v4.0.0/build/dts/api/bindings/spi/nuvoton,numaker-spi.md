---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/nuvoton,numaker-spi.html
original_path: build/dts/api/bindings/spi/nuvoton,numaker-spi.html
---
...
[drivers/spi/spi\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_numaker.c).
...
```text
Nuvoton, NuMaker SPI controller
```
...
may apply to the “nuvoton,numaker-spi” compatible.
