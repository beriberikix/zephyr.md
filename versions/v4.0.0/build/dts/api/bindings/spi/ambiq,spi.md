---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/spi/ambiq,spi.html
original_path: build/dts/api/bindings/spi/ambiq,spi.html
---
...
[drivers/spi/spi\_ambiq\_spic.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_ambiq_spic.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Clock frequency the SPI peripheral is being driven at, in Hz. ```  This property is **required**. |
...
may apply to the “ambiq,spi” compatible.
