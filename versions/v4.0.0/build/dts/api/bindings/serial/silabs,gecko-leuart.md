---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/silabs,gecko-leuart.html
original_path: build/dts/api/bindings/serial/silabs,gecko-leuart.html
---
...
[drivers/serial/leuart\_gecko.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/leuart_gecko.c).
...
| `location-rx` | `array` | ```text RX pin configuration defined as <location port pin> ```  This property is **required**. |
| `location-tx` | `array` | ```text TX pin configuration defined as <location port pin> ```  This property is **required**. |
...
may apply to the “silabs,gecko-leuart” compatible.
