---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/ti,cc13xx-cc26xx-uart.html
original_path: build/dts/api/bindings/serial/ti,cc13xx-cc26xx-uart.html
---
...
[drivers/serial/uart\_cc13xx\_cc26xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_cc13xx_cc26xx.c).
...
```text
TI SimpleLink CC13xx / CC26xx UART node
```
...
may apply to the “ti,cc13xx-cc26xx-uart” compatible.
