---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/xen,hvc-consoleio.html
original_path: build/dts/api/bindings/serial/xen,hvc-consoleio.html
---

# xen,hvc-consoleio

Vendor: [Xen Hypervisor](../../bindings.md#dt-vendor-xen)

Note

An implementation of a driver matching this compatible is available in
[drivers/serial/uart\_hvc\_xen\_consoleio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_hvc_xen_consoleio.c).
...
```text
Xen Dom0/Dom0less Platform HVC ConsoleIO
```
...
may apply to the “xen,hvc-consoleio” compatible.
