---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/brcm,bcm2711-aux-uart.html
original_path: build/dts/api/bindings/serial/brcm,bcm2711-aux-uart.html
---
...
[drivers/serial/uart\_bcm2711.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_bcm2711.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Clock frequency information for UART operation ```  This property is **required**. |
...
may apply to the “brcm,bcm2711-aux-uart” compatible.
