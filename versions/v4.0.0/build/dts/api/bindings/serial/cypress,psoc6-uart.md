---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/cypress,psoc6-uart.html
original_path: build/dts/api/bindings/serial/cypress,psoc6-uart.html
---
...
[drivers/serial/uart\_psoc6.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_psoc6.c).
...
| `pinctrl-0` | `phandles` | ```text Port pin configuration for RX & TX signals.  We expect that the phandles will reference pinctrl nodes.  These nodes will have a nodelabel that matches the Cypress SoC HAL defines and be of the form p<port>_<pin>_<periph><inst>_<signal>.  For example the UART on PSOC 63 Pioneer Kit would be    pinctrl-0 = <&p5_0_uart5_rx &p5_1_uart5_tx>; ```  This property is **required**. |
...
may apply to the “cypress,psoc6-uart” compatible.
