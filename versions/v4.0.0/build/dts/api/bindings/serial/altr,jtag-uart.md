---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/altr,jtag-uart.html
original_path: build/dts/api/bindings/serial/altr,jtag-uart.html
---
...
[drivers/serial/uart\_altera\_jtag.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_altera_jtag.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `write-fifo-depth` | `int` | ```text Buffer size of transmit fifo. This used to implement irq_tx_complete. Must be same as Write FIFO: Buffer depth (bytes) in platform designer. ```  Default value: `64` |
...
may apply to the “altr,jtag-uart” compatible.
