---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/renesas,ra-uart-sci.html
original_path: build/dts/api/bindings/serial/renesas,ra-uart-sci.html
---
...
[drivers/serial/uart\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_ra.c).
...
```text
Renesas RA Series SCI based UART controller
```
...
may apply to the “renesas,ra-uart-sci” compatible.
