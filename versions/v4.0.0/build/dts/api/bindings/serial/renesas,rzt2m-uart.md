---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/serial/renesas,rzt2m-uart.html
original_path: build/dts/api/bindings/serial/renesas,rzt2m-uart.html
---
...
[drivers/serial/uart\_rzt2m.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_rzt2m.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `current-speed` | `int` | ```text Initial baud rate setting for UART. Only a fixed set of baud rates is currently supported. ```  This property is **required**.  Legal values: `9600`, `115200` |
...
may apply to the “renesas,rzt2m-uart” compatible.
