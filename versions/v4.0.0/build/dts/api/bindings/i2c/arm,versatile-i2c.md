---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/arm,versatile-i2c.html
original_path: build/dts/api/bindings/i2c/arm,versatile-i2c.html
---
...
[drivers/i2c/i2c\_sbcon.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_sbcon.c).
...
```text
ARM SBCon two-wire serial bus interface
```
...
may apply to the “arm,versatile-i2c” compatible.
