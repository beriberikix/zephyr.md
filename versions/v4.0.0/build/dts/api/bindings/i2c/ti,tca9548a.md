---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/ti,tca9548a.html
original_path: build/dts/api/bindings/i2c/ti,tca9548a.html
---

# ti,tca9548a (on i2c bus)
...
```text
Texas Instruments TCA9548A binding
```
...
These property descriptions apply to “ti,tca9548a”
...
may apply to the “ti,tca9548a” compatible.
