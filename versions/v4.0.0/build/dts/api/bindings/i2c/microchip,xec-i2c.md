---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/microchip,xec-i2c.html
original_path: build/dts/api/bindings/i2c/microchip,xec-i2c.html
---
...
[drivers/i2c/i2c\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_mchp_xec.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `port_sel` | `int` | ```text soc block mapping to pin ```  This property is **required**. |
| `girq` | `int` | ```text GIRQ for this device ```  This property is **required**. |
| `girq-bit` | `int` | ```text Bit position in GIRQ for this device ```  This property is **required**. |
| `pcrs` | `array` | ```text PCR sleep register index and bit position ```  This property is **required**. |
...
| `sda-gpios` | `phandle-array` | ```text The SDA pin for the selected port. Pin choice for port is determined by chip and package. ```  This property is **required**. |
| `scl-gpios` | `phandle-array` | ```text The SCL pin for the selected port. Pin choice for port is determined by chip and package. ```  This property is **required**. |
