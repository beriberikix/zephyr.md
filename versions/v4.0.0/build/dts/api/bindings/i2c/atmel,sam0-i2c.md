---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/atmel,sam0-i2c.html
original_path: build/dts/api/bindings/i2c/atmel,sam0-i2c.html
---
...
[drivers/i2c/i2c\_sam0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_sam0.c).
...
```text
Atmel SAM0 series SERCOM I2C node
```
...
may apply to the “atmel,sam0-i2c” compatible.
