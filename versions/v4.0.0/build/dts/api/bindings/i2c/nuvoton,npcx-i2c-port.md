---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/nuvoton,npcx-i2c-port.html
...
```text
Nuvoton, NPCX-I2C port pads node
```
...
| Name | Type | Details |
| --- | --- | --- |
| `port` | `int` | ```text index of i2c port ```  This property is **required**. |
