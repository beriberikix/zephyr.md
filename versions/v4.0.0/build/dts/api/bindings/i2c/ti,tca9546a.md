---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/ti,tca9546a.html
original_path: build/dts/api/bindings/i2c/ti,tca9546a.html
---

# ti,tca9546a (on i2c bus)
...
[drivers/i2c/i2c\_tca954x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_tca954x.c).

## Description

```text
Texas Instruments TCA9546A binding
```
...
These property descriptions apply to “ti,tca9546a”
...
may apply to the “ti,tca9546a” compatible.
