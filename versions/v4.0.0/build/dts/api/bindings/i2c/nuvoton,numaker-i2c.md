---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/nuvoton,numaker-i2c.html
original_path: build/dts/api/bindings/i2c/nuvoton,numaker-i2c.html
---
...
[drivers/i2c/i2c\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_numaker.c).
...
```text
Nuvoton, NuMaker I2C controller
```
...
may apply to the “nuvoton,numaker-i2c” compatible.
