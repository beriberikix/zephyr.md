---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/microchip,mpfs-i2c.html
original_path: build/dts/api/bindings/i2c/microchip,mpfs-i2c.html
---
...
[drivers/i2c/i2c\_mchp\_mss.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_mchp_mss.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Desired I2C bus clock frequency in Hz. As only Standard and Fast modes are supported, possible values are 100000 and 400000. ```  Legal values: `100000`, `400000` |
...
may apply to the “microchip,mpfs-i2c” compatible.
