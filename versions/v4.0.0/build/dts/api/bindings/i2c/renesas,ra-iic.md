---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/renesas,ra-iic.html
original_path: build/dts/api/bindings/i2c/renesas,ra-iic.html
---
...
[drivers/i2c/i2c\_renesas\_ra\_iic.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_renesas_ra_iic.c).
...
```text
Renesas RA I2C Master controller
```
...
| `rise-time-ns` | `int` | Default value: `120` |
| `fall-time-ns` | `int` | Default value: `120` |
| `duty-cycle-percent` | `int` | Default value: `50` |
| `interrupt-priority-level` | `int` | Default value: `12` |
...
may apply to the “renesas,ra-iic” compatible.
