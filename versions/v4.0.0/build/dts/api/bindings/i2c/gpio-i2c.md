---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2c/gpio-i2c.html
original_path: build/dts/api/bindings/i2c/gpio-i2c.html
---
...
[drivers/i2c/i2c\_gpio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_gpio.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `scl-gpios` | `phandle-array` | ```text GPIO to which the SCL pin of the I2C bus is connected. ```  This property is **required**. |
| `sda-gpios` | `phandle-array` | ```text GPIO to which the SDA pin of the I2C bus is connected. ```  This property is **required**. |
...
may apply to the “gpio-i2c” compatible.
