---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/st,hts221-spi.html
original_path: build/dts/api/bindings/sensor/st,hts221-spi.html
---

# st,hts221 (on spi bus)
