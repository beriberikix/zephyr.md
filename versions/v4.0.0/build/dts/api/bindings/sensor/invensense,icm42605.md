---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/invensense,icm42605.html
original_path: build/dts/api/bindings/sensor/invensense,icm42605.html
---

# invensense,icm42605 (on spi bus)
...
[drivers/sensor/tdk/icm42605/icm42605.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/tdk/icm42605/icm42605.c).

## Description

```text
ICM-42605 motion tracking device
```
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text The INT signal default configuration is active-high.  The property value should ensure the flags properly describe the signal that is presented to the driver. ```  This property is **required**. |
| `accel-hz` | `int` | ```text Default frequency of accelerometer. (Unit - Hz) Maps to ACCEL_ODR field in ACCEL_CONFIG0 setting ```  Default value: `12`  Legal values: `1`, `3`, `6`, `12`, `25`, `50`, `100`, `200`, `500`, `1000`, `2000`, `4000`, `8000` |
| `gyro-hz` | `int` | ```text Default frequency of gyroscope. (Unit - Hz) Maps to GYRO_ODR field in GYRO_CONFIG0 setting ```  Default value: `12`  Legal values: `12`, `25`, `50`, `100`, `200`, `500`, `1000`, `2000`, `4000`, `8000` |
| `accel-fs` | `int` | ```text Default full scale of accelerometer. (Unit - g) Maps to ACCEL_FS_SEL field in ACCEL_CONFIG0 setting ```  Default value: `16`  Legal values: `16`, `8`, `4`, `2` |
| `gyro-fs` | `int` | ```text Default full scale of gyroscope. (Unit - DPS) Maps to GYRO_FS_SEL field in GYRO_CONFIG0 setting ```  Default value: `2000`  Legal values: `2000`, `1000`, `500`, `250`, `125`, `62.5`, `31.25`, `15.625` |
...
may apply to the “invensense,icm42605” compatible.
