---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/bosch,bmp390-spi.html
original_path: build/dts/api/bindings/sensor/bosch,bmp390-spi.html
---

# bosch,bmp390 (on spi bus)
