---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/st,lis2mdl-spi.html
original_path: build/dts/api/bindings/sensor/st,lis2mdl-spi.html
---

# st,lis2mdl (on spi bus)
