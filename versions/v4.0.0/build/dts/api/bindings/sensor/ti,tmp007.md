---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/ti,tmp007.html
original_path: build/dts/api/bindings/sensor/ti,tmp007.html
---

# ti,tmp007 (on i2c bus)
...
[drivers/sensor/ti/tmp007/tmp007.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ti/tmp007/tmp007.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | ```text Identifies the ALERT signal, which is active-low open drain when produced by the sensor. ``` |
...
may apply to the “ti,tmp007” compatible.
