---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/st,lps22df-spi.html
original_path: build/dts/api/bindings/sensor/st,lps22df-spi.html
---

# st,lps22df (on spi bus)
