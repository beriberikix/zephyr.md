---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/atmel,sam-tc-qdec.html
original_path: build/dts/api/bindings/sensor/atmel,sam-tc-qdec.html
---
...
[drivers/sensor/qdec\_sam/qdec\_sam.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/qdec_sam/qdec_sam.c).

## Description

```text
Atmel SAM Timer Counter (TC) QDEC mode
```
...
may apply to the “atmel,sam-tc-qdec” compatible.
