---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/st,iis2mdc-spi.html
original_path: build/dts/api/bindings/sensor/st,iis2mdc-spi.html
---

# st,iis2mdc (on spi bus)
