---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/nxp,fxls8974-i2c.html
original_path: build/dts/api/bindings/sensor/nxp,fxls8974-i2c.html
---

# nxp,fxls8974 (on i2c bus)
...
[drivers/sensor/nxp/fxls8974/fxls8974.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/nxp/fxls8974/fxls8974.c).

## Description

```text
FXLS8974 3-axis accelerometer sensor
```
...
| `range` | `int` | ```text Range in g. Default value is 2 because it is the most sensitive setting. 16g (7.81 mg/LSB), 8g (3.91 mg/LSB), 4g (1.95 mg/LSB), 2g (0.98 mg/LSB). ```  Default value: `2`  Legal values: `16`, `8`, `4`, `2` |
...
may apply to the “nxp,fxls8974” compatible.
