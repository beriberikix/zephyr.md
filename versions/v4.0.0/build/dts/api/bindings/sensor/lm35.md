---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/lm35.html
original_path: build/dts/api/bindings/sensor/lm35.html
---
...
[drivers/sensor/lm35/lm35.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/lm35/lm35.c).

## Description

```text
LM35 Digital Temperature Sensor
```
...
| Name | Type | Details |
| --- | --- | --- |
| `resolution` | `int` | ```text ADC resolution to be used for the channel. Defaults to 12 bits as it's the most common for adc based drivers. ```  Default value: `12` |
...
may apply to the “lm35” compatible.
