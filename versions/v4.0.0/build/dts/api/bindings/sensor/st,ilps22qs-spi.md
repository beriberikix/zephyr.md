---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/st,ilps22qs-spi.html
original_path: build/dts/api/bindings/sensor/st,ilps22qs-spi.html
---

# st,ilps22qs (on spi bus)
