---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/invensense,icm42670-spi.html
original_path: build/dts/api/bindings/sensor/invensense,icm42670-spi.html
---

# invensense,icm42670 (on spi bus)
...
[drivers/sensor/tdk/icm42670/icm42670.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/tdk/icm42670/icm42670.c).

## Description

```text
ICM-42670 motion tracking device
```
...
| `accel-hz` | `int` | ```text Default frequency of accelerometer. (Unit - Hz) Maps to ACCEL_ODR field in ACCEL_CONFIG0 setting Power-on reset value is 800. ```  This property is **required**.  Legal values: `1`, `3`, `6`, `12`, `25`, `50`, `100`, `200`, `400`, `800`, `1600` |
| `gyro-hz` | `int` | ```text Default frequency of gyroscope. (Unit - Hz) Maps to GYRO_ODR field in GYRO_CONFIG0 setting Power-on reset value is 800. ```  This property is **required**.  Legal values: `12`, `25`, `50`, `100`, `200`, `400`, `800`, `1600` |
...
may apply to the “invensense,icm42670” compatible.
