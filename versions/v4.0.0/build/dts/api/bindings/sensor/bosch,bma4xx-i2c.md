---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/bosch,bma4xx-i2c.html
original_path: build/dts/api/bindings/sensor/bosch,bma4xx-i2c.html
---

# bosch,bma4xx (on i2c bus)
...
[drivers/sensor/bosch/bma4xx/bma4xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/bosch/bma4xx/bma4xx.c).
...
| `int1-gpios` | `phandle-array` | ```text Identifies pin for the INT1 signal on the sensor.  The sensor INT2,3,4 signals are not supported by the driver. ``` |
...
may apply to the “bosch,bma4xx” compatible.
