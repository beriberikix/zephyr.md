---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/microchip,mcp970x.html
original_path: build/dts/api/bindings/sensor/microchip,mcp970x.html
---
...
[drivers/sensor/microchip/mcp970x/mcp970x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/microchip/mcp970x/mcp970x.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `family` | `string` | ```text Family            Temperature Coefficient   MCP9700/9700A -   10.0mV   MCP9701/9701A -   19.5mV ```  This property is **required**.  Legal values: `'MCP9700/9700A'`, `'MCP9701/9701A'` |
...
may apply to the “microchip,mcp970x” compatible.
