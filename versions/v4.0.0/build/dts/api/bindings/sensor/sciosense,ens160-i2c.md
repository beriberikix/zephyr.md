---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/sensor/sciosense,ens160-i2c.html
original_path: build/dts/api/bindings/sensor/sciosense,ens160-i2c.html
---

# sciosense,ens160 (on i2c bus)

Vendor: [Sciosense B.V.](../../bindings.md#dt-vendor-sciosense)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/ens160/ens160.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ens160/ens160.c).
...
| `int-gpios` | `phandle-array` | ```text The interrupt pin of ENS160. ``` |
...
may apply to the “sciosense,ens160” compatible.
