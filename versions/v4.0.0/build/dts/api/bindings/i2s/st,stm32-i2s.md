---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2s/st,stm32-i2s.html
original_path: build/dts/api/bindings/i2s/st,stm32-i2s.html
---
...
[drivers/i2s/i2s\_ll\_stm32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2s/i2s_ll_stm32.c).
...
| `mck-enabled` | `boolean` | ```text Master Clock Output function. An mck pin must be listed within pinctrl-0 when enabling this property. ``` |
...
may apply to the “st,stm32-i2s” compatible.
