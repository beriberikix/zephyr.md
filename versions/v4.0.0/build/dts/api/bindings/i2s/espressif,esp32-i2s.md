---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i2s/espressif,esp32-i2s.html
original_path: build/dts/api/bindings/i2s/espressif,esp32-i2s.html
---
...
[drivers/i2s/i2s\_esp32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2s/i2s_esp32.c).
...
| `unit` | `int` | ```text I2S unit number. Possible values are 0,1,.. depending on chip. ```  This property is **required**. |
...
may apply to the “espressif,esp32-i2s” compatible.
...
| `interrupt-parent` | `phandle` | ```text phandle to interrupt controller node ```  This property is **required**. |
