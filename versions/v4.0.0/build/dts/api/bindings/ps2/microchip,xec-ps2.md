---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ps2/microchip,xec-ps2.html
original_path: build/dts/api/bindings/ps2/microchip,xec-ps2.html
---
...
[drivers/ps2/ps2\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ps2/ps2_mchp_xec.c).

## Description

These nodes are “ps2” bus nodes.

```text
Microchip XEC PS/2 controller
```
...
| `wakerx-gpios` | `phandle-array` | ```text GPIO configured as PS2 DAT wake source ``` |
...
may apply to the “microchip,xec-ps2” compatible.
