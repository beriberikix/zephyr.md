---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/i3c/cdns,i3c.html
original_path: build/dts/api/bindings/i3c/cdns,i3c.html
---
...
[drivers/i3c/i3c\_cdns.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i3c/i3c_cdns.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `input-clock-frequency` | `int` | ```text The controller input clock frequency ```  This property is **required**. |
| `ibid-thr` | `int` | ```text IBI Data Fifo Threashold Value ```  Default value: `1` |
...
may apply to the “cdns,i3c” compatible.
