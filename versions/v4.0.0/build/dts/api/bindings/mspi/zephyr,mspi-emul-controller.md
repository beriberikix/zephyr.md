---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mspi/zephyr,mspi-emul-controller.html
original_path: build/dts/api/bindings/mspi/zephyr,mspi-emul-controller.html
---
...
[drivers/mspi/mspi\_emul.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mspi/mspi_emul.c).
...
```text
Zephyr MSPI Emulation controller
```
...
may apply to the “zephyr,mspi-emul-controller” compatible.
