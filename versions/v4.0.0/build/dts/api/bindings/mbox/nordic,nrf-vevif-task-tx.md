---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mbox/nordic,nrf-vevif-task-tx.html
original_path: build/dts/api/bindings/mbox/nordic,nrf-vevif-task-tx.html
---
...
[drivers/mbox/mbox\_nrf\_vevif\_task\_tx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mbox/mbox_nrf_vevif_task_tx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `nordic,tasks` | `int` | ```text Number of tasks supported by the VEVIF instance. ```  This property is **required**. |
| `nordic,tasks-mask` | `int` | ```text Mask of tasks supported by the VEVIF instance. ```  This property is **required**. |
...
may apply to the “nordic,nrf-vevif-task-tx” compatible.
