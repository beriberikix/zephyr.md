---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mbox/nordic,nrf-vevif-event-tx.html
original_path: build/dts/api/bindings/mbox/nordic,nrf-vevif-event-tx.html
---
...
[drivers/mbox/mbox\_nrf\_vevif\_event\_tx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mbox/mbox_nrf_vevif_event_tx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `nordic,events` | `int` | ```text Number of events supported by the VEVIF instance. ```  This property is **required**. |
| `nordic,events-mask` | `int` | ```text Mask of events supported by the VEVIF instance. ```  This property is **required**. |
...
may apply to the “nordic,nrf-vevif-event-tx” compatible.
