---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/led_strip/worldsemi,ws2812-i2s.html
original_path: build/dts/api/bindings/led_strip/worldsemi,ws2812-i2s.html
---
...
[drivers/led\_strip/ws2812\_i2s.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/led_strip/ws2812_i2s.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `i2s-dev` | `phandle` | ```text Pointer to the I2S instance. ```  This property is **required**. |
| `out-active-low` | `boolean` | ```text True if the output pin is active low. ``` |
| `nibble-one` | `int` | ```text 4-bit value to shift out for a 1 pulse. ```  Default value: `14` |
| `nibble-zero` | `int` | ```text 4-bit value to shift out for a 0 pulse. ```  Default value: `8` |
| `lrck-period` | `int` | ```text LRCK (left/right clock) period in microseconds. ```  Default value: `10` |
| `extra-wait-time` | `int` | ```text Extra microseconds to wait for the driver to flush its I2S queue. ```  Default value: `300` |
...
may apply to the “worldsemi,ws2812-i2s” compatible.
