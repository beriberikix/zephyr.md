---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/led_strip/worldsemi,ws2812-spi.html
original_path: build/dts/api/bindings/led_strip/worldsemi,ws2812-spi.html
---
...
[drivers/led\_strip/ws2812\_spi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/led_strip/ws2812_spi.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `spi-one-frame` | `int` | ```text 8-bit SPI frame to shift out for a 1 pulse. ```  This property is **required**. |
| `spi-zero-frame` | `int` | ```text 8-bit SPI frame to shift out for a 0 pulse. ```  This property is **required**. |
...
may apply to the “worldsemi,ws2812-spi” compatible.
