---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/led_strip/greeled,lpd8803.html
original_path: build/dts/api/bindings/led_strip/greeled,lpd8803.html
---

# greeled,lpd8803 (on spi bus)

Vendor: [GreeLed Electronic Ltd.](../../bindings.md#dt-vendor-greeled)

Note

An implementation of a driver matching this compatible is available in
[drivers/led\_strip/lpd880x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/led_strip/lpd880x.c).

## Description

```text
GreeLed LPD8803 SPI LED strip
```
...
may apply to the “greeled,lpd8803” compatible.
