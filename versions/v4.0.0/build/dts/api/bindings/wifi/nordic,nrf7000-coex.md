---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/wifi/nordic,nrf7000-coex.html
original_path: build/dts/api/bindings/wifi/nordic,nrf7000-coex.html
---
...
```text
This is a representation of the nRF7000 Wi-Fi chip with COEX interface.
```
...
may apply to the “nordic,nrf7000-coex” compatible.
