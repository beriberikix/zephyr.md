---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/wifi/nordic,nrf7002-coex.html
original_path: build/dts/api/bindings/wifi/nordic,nrf7002-coex.html
---
...
```text
This is a representation of the nRF7002 Wi-Fi chip with COEX interface.
```
...
may apply to the “nordic,nrf7002-coex” compatible.
