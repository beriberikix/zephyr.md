---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/wifi/nordic,nrf7001-spi.html
...
```text
This is a representation of the nRF7002 Wi-Fi chip with SPI interface.
```
