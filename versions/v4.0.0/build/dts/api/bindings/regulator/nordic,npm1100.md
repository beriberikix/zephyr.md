---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/regulator/nordic,npm1100.html
original_path: build/dts/api/bindings/regulator/nordic,npm1100.html
---
...
[drivers/regulator/regulator\_npm1100.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/regulator/regulator_npm1100.c).
...
These property descriptions apply to “nordic,npm1100”
...
| Name | Type | Details |
| --- | --- | --- |
| `nordic,iset-gpios` | `phandle-array` | ```text ISET control pin. ``` |
...
may apply to the “nordic,npm1100” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `nordic,mode-gpios` | `phandle-array` | ```text MODE control pin. ``` |
