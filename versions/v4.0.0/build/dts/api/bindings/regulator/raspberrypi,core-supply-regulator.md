---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/regulator/raspberrypi,core-supply-regulator.html
original_path: build/dts/api/bindings/regulator/raspberrypi,core-supply-regulator.html
---
...
[drivers/regulator/regulator\_rpi\_pico.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/regulator/regulator_rpi_pico.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `raspberrypi,brown-out-detection` | `boolean` | ```text Enable brown-out detection ``` |
| `raspberrypi,brown-out-threshold` | `int` | ```text Reset if the core voltage drops below this threshold for a particular time (determined by the 'brown-out detection assertion delay'). ```  Default value: `860000`  Legal values: `473000`, `516000`, `559000`, `602000`, `645000`, `688000`, `731000`, `774000`, `817000`, `860000`, `903000`, `946000`, `989000`, `1032000`, `1075000`, `1118000` |
...
may apply to the “raspberrypi,core-supply-regulator” compatible.
