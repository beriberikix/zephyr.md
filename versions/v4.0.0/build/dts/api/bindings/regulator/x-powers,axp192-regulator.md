---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/regulator/x-powers,axp192-regulator.html
original_path: build/dts/api/bindings/regulator/x-powers,axp192-regulator.html
---
...
[drivers/regulator/regulator\_axp192.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/regulator/regulator_axp192.c).
...
These property descriptions apply to “x-powers,axp192-regulator”
...
may apply to the “x-powers,axp192-regulator” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `regulator-initial-mode` | `int` | ```text Initial operating mode. AXP192 supports 2 different power modes: AXP192_DCDC_MODE_AUTO: Auto (0, default) AXP192_DCDC_MODE_PWM:  PWM ```  Legal values: `0`, `1` |
