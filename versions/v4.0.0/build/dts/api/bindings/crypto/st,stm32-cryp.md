---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/crypto/st,stm32-cryp.html
original_path: build/dts/api/bindings/crypto/st,stm32-cryp.html
---
...
[drivers/crypto/crypto\_stm32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/crypto/crypto_stm32.c).

## Description

```text
STM32 Cryptographic Accelerator
```
...
may apply to the “st,stm32-cryp” compatible.
