---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/arm/nxp,imx-epit.html
original_path: build/dts/api/bindings/arm/nxp,imx-epit.html
---
...
[drivers/counter/counter\_imx\_epit.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/counter/counter_imx_epit.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text Set the EPIT prescaler between 0 and 4095 ```  This property is **required**. |
...
may apply to the “nxp,imx-epit” compatible.
