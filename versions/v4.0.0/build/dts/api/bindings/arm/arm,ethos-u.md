---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/arm/arm,ethos-u.html
original_path: build/dts/api/bindings/arm/arm,ethos-u.html
---
...
[drivers/misc/ethos\_u/ethos\_u.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/misc/ethos_u/ethos_u.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `secure-enable` | `boolean` | ```text Configure Ethos-U NPU to operate in secure- or non-secure mode ``` |
| `privilege-enable` | `boolean` | ```text Configure Ethos-U NPU to operate in privileged- or non-privileged mode ``` |
...
may apply to the “arm,ethos-u” compatible.
