---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/display/renesas,smartbond-display.html
original_path: build/dts/api/bindings/display/renesas,smartbond-display.html
---
...
[drivers/display/display\_renesas\_lcdc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/display/display_renesas_lcdc.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `disp-gpios` | `phandle-array` | ```text Display ON/OFF port control. ``` |
...
may apply to the “renesas,smartbond-display” compatible.
