---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/display/nxp,dcnano-lcdif.html
original_path: build/dts/api/bindings/display/nxp,dcnano-lcdif.html
---
...
[drivers/display/display\_mcux\_dcnano\_lcdif.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/display/display_mcux_dcnano_lcdif.c).
...
| `data-bus-width` | `string` | ```text LCD data bus width. The default is set to the reset value of 24-bit ```  Default value: `24-bit`  Legal values: `'16-bit-config1'`, `'16-bit-config2'`, `'16-bit-config3'`, `'18-bit-config1'`, `'18-bit-config2'`, `'24-bit'` |
...
may apply to the “nxp,dcnano-lcdif” compatible.
