---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/display/orisetech,otm8009a.html
original_path: build/dts/api/bindings/display/orisetech,otm8009a.html
---

# orisetech,otm8009a (on mipi-dsi bus)

Vendor: [Orise Technology](../../bindings.md#dt-vendor-orisetech)

Note

An implementation of a driver matching this compatible is available in
[drivers/display/display\_otm8009a.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/display/display_otm8009a.c).

## Description

```text
Orise Tech OTM8009A Panel
```
...
may apply to the “orisetech,otm8009a” compatible.
