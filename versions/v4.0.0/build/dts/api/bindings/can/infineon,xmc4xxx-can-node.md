---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/infineon,xmc4xxx-can-node.html
...
[drivers/can/can\_xmc4xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_xmc4xxx.c).
