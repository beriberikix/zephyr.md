---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/zephyr,can-loopback.html
original_path: build/dts/api/bindings/can/zephyr,can-loopback.html
---
...
[drivers/can/can\_loopback.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_loopback.c).

## Description

```text
Zephyr emulated CAN loopback controller
```
...
These property descriptions apply to “zephyr,can-loopback”
...
may apply to the “zephyr,can-loopback” compatible.
