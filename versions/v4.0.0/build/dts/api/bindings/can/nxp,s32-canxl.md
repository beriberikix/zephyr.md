---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/nxp,s32-canxl.html
original_path: build/dts/api/bindings/can/nxp,s32-canxl.html
---
...
[drivers/can/can\_nxp\_s32\_canxl.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_nxp_s32_canxl.c).

## Description

```text
NXP S32 CANXL controller
```
...
These property descriptions apply to “nxp,s32-canxl”
...
may apply to the “nxp,s32-canxl” compatible.
