---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/nordic,nrf-can.html
original_path: build/dts/api/bindings/can/nordic,nrf-can.html
---
...
[drivers/can/can\_nrf.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_nrf.c).

## Description

```text
Nordic CAN (Controller Area Network)
```
...
These property descriptions apply to “nordic,nrf-can”
...
may apply to the “nordic,nrf-can” compatible.
