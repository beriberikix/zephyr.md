---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/kvaser,pcican.html
original_path: build/dts/api/bindings/can/kvaser,pcican.html
---

# kvaser,pcican

Vendor: [Kvaser](../../bindings.md#dt-vendor-kvaser)

Note

An implementation of a driver matching this compatible is available in
[drivers/can/can\_kvaser\_pci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_kvaser_pci.c).
