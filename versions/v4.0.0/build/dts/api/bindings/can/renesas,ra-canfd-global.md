---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/renesas,ra-canfd-global.html
original_path: build/dts/api/bindings/can/renesas,ra-canfd-global.html
---
...
```text
Renesas RA CANFD controller global
```
...
may apply to the “renesas,ra-canfd-global” compatible.
