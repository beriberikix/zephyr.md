---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/microchip,mcp2515.html
original_path: build/dts/api/bindings/can/microchip,mcp2515.html
---

# microchip,mcp2515 (on spi bus)
...
[drivers/can/can\_mcp2515.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_mcp2515.c).
...
These property descriptions apply to “microchip,mcp2515”
...
| Name | Type | Details |
| --- | --- | --- |
| `osc-freq` | `int` | ```text Frequency of the external oscillator ```  This property is **required**. |
| `int-gpios` | `phandle-array` | ```text Interrupt pin.  This pin signals active low when produced by the controller. The property value should ensure the flags properly describe the signal that is presented to the driver. ```  This property is **required**. |
...
may apply to the “microchip,mcp2515” compatible.
