---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/espressif,esp32-twai.html
original_path: build/dts/api/bindings/can/espressif,esp32-twai.html
---
...
[drivers/can/can\_esp32\_twai.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_esp32_twai.c).
...
These property descriptions apply to “espressif,esp32-twai”
...
| `clkout-divider` | `int` | ```text Clock divider for the CLKOUT signal. If not set, the CLKOUT signal is turned off.  Valid values are 1 or any even number from 2 to 14 for ESP32 and 2 to 490 for newer Espressif MCUs like ESP32-C3. ``` |
...
may apply to the “espressif,esp32-twai” compatible.
