---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/can/renesas,ra-canfd.html
original_path: build/dts/api/bindings/can/renesas,ra-canfd.html
---
...
[drivers/can/can\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/can/can_renesas_ra.c).

## Description

```text
Renesas RA CANFD controller
```
...
These property descriptions apply to “renesas,ra-canfd”
...
| `rx-max-filters` | `int` | ```text To determine the maximum rx filters can be added on this CAN device. Valid range: 0 - 16 ``` |
...
may apply to the “renesas,ra-canfd” compatible.
