---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/timer/atmel,sam0-tc32.html
original_path: build/dts/api/bindings/timer/atmel,sam0-tc32.html
---
...
[drivers/counter/counter\_sam0\_tc32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/counter/counter_sam0_tc32.c).

## Description

```text
Atmel SAM0 basic timer counter (TC) operating in 32-bit wide mode
```
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text Timer prescaler ```  Legal values: `1`, `2`, `4`, `8`, `16`, `64`, `256`, `1024` |
...
may apply to the “atmel,sam0-tc32” compatible.
