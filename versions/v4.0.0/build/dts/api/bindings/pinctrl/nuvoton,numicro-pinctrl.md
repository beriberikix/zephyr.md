---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pinctrl/nuvoton,numicro-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/nuvoton,numicro-pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_numicro.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_numicro.c).
...
These property descriptions apply to “nuvoton,numicro-pinctrl”
...
may apply to the “nuvoton,numicro-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text Pin mux selections for this group. See the SoC level pinctrl dtsi file for a defined list of these options. ```  This property is **required**. |
| `slew-rate` | `string` | ```text Pin output slew rate. Sets the HSRENx register. If not set, defaults to the reset value (normal). ```  Default value: `normal`  Legal values: `'normal'`, `'high'`, `'fast'` |
| `input-debounce` | `boolean` | ```text enable the input debounce function ``` |
