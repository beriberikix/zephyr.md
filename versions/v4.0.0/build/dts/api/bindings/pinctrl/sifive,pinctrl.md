---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pinctrl/sifive,pinctrl.html
original_path: build/dts/api/bindings/pinctrl/sifive,pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_sifive.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_sifive.c).
...
These property descriptions apply to “sifive,pinctrl”
...
may apply to the “sifive,pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text SiFive FE310 pin's configuration (pin, IO function). ```  This property is **required**. |
