---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pinctrl/silabs,si32-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/silabs,si32-pinctrl.html
---
...
These property descriptions apply to “silabs,si32-pinctrl”
...
may apply to the “silabs,si32-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text Pin mux selections for this group. ```  This property is **required**. |
