---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pinctrl/ti,cc13xx-cc26xx-pinctrl.html
...
[drivers/pinctrl/pinctrl\_cc13xx\_cc26xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_cc13xx_cc26xx.c).
...
| `drive-strength` | `int` | ```text The drive strength controls the minimum output driver strength of an I/O pin configured as an output.   2: min 2 mA (SoC default)   4: min 4 mA   8: min 8 mA for double drive strength IOs, min 4 mA for normal IOs ```  Default value: `2`  Legal values: `2`, `4`, `8` |
