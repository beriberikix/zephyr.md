---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pinctrl/xlnx,pinctrl-zynqmp.html
original_path: build/dts/api/bindings/pinctrl/xlnx,pinctrl-zynqmp.html
---
...
[drivers/pinctrl/pinctrl\_xlnx\_zynqmp.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_xlnx_zynqmp.c).
...
These property descriptions apply to “xlnx,pinctrl-zynqmp”
...
may apply to the “xlnx,pinctrl-zynqmp” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text Pin assignments for the selected group ```  This property is **required**. |
