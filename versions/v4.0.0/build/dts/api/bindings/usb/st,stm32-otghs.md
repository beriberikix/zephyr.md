---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/usb/st,stm32-otghs.html
original_path: build/dts/api/bindings/usb/st,stm32-otghs.html
---
...
| `ram-size` | `int` | ```text Size of USB dedicated RAM. STM32 SOC's reference manual defines a shared FIFO size. ```  This property is **required**. |
...
may apply to the “st,stm32-otghs” compatible.
