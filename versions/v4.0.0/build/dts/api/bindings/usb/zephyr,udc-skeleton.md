---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/usb/zephyr,udc-skeleton.html
original_path: build/dts/api/bindings/usb/zephyr,udc-skeleton.html
---
...
[drivers/usb/udc/udc\_skeleton.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/udc/udc_skeleton.c).
...
```text
Skeleton for USB device controller driver
```
...
may apply to the “zephyr,udc-skeleton” compatible.
