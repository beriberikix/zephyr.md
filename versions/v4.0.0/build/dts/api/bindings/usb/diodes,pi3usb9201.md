---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/usb/diodes,pi3usb9201.html
original_path: build/dts/api/bindings/usb/diodes,pi3usb9201.html
---

# diodes,pi3usb9201 (on i2c bus)

Vendor: [Diodes Incorporated](../../bindings.md#dt-vendor-diodes)

Note

An implementation of a driver matching this compatible is available in
[drivers/usb/bc12/bc12\_pi3usb9201.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/bc12/bc12_pi3usb9201.c).

## Description

```text
Diodes PI3USB9201, Dual-Role USB Charging-Type Detector
```
...
| Name | Type | Details |
| --- | --- | --- |
| `intb-gpios` | `phandle-array` | ```text GPIO input connected to the active low interrupt INTB pin on the PI3USB9201. ```  This property is **required**. |
...
may apply to the “diodes,pi3usb9201” compatible.
