---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/usb/st,stm32-usb.html
original_path: build/dts/api/bindings/usb/st,stm32-usb.html
---
...
[drivers/usb/udc/udc\_stm32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/udc/udc_stm32.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `ram-size` | `int` | ```text Size of USB dedicated RAM. STM32 SOC's reference manual defines USB packet SRAM size. ```  This property is **required**. |
| `disconnect-gpios` | `phandle-array` | ```text Some boards use a USB DISCONNECT pin to enable the pull-up resistor on USB Data Positive signal. ``` |
