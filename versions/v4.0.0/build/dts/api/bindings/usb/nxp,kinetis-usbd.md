---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/usb/nxp,kinetis-usbd.html
original_path: build/dts/api/bindings/usb/nxp,kinetis-usbd.html
---
...
[drivers/usb/udc/udc\_kinetis.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/udc/udc_kinetis.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `no-voltage-regulator` | `boolean` | ```text Indicates that USB voltage regulator is not present. ``` |
...
may apply to the “nxp,kinetis-usbd” compatible.
