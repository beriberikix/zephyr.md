---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/tcpc/nuvoton,numaker-tcpc.html
...
| `vbus-divide` | `string` | ```text VBUS measurement divider ```  This property is **required**.  Legal values: `'no-divide'`, `'divide-10'`, `'divide-20'` |
