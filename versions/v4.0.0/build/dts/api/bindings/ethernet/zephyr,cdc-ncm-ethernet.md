---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ethernet/zephyr,cdc-ncm-ethernet.html
original_path: build/dts/api/bindings/ethernet/zephyr,cdc-ncm-ethernet.html
---

# zephyr,cdc-ncm-ethernet
...
[subsys/usb/device\_next/class/usbd\_cdc\_ncm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/usb/device_next/class/usbd_cdc_ncm.c).

## Description

```text
USB CDC NCM virtual Ethernet controller
```
...
may apply to the “zephyr,cdc-ncm-ethernet” compatible.
