---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ethernet/nxp,enet-ptp-clock.html
original_path: build/dts/api/bindings/ethernet/nxp,enet-ptp-clock.html
---
...
[drivers/ptp\_clock/ptp\_clock\_nxp\_enet.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ptp_clock/ptp_clock_nxp_enet.c).

## Description

```text
NXP ENET PTP (Precision Time Protocol) Clock
```
...
may apply to the “nxp,enet-ptp-clock” compatible.
