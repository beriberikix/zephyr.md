---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ethernet/nxp,enet-qos.html
original_path: build/dts/api/bindings/ethernet/nxp,enet-qos.html
---
...
[drivers/ethernet/eth\_nxp\_enet\_qos/eth\_nxp\_enet\_qos.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ethernet/eth_nxp_enet_qos/eth_nxp_enet_qos.c).

## Description

```text
NXP ENET QOS IP Module
```
...
may apply to the “nxp,enet-qos” compatible.
