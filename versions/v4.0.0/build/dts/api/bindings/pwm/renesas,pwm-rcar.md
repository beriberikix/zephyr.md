---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/renesas,pwm-rcar.html
original_path: build/dts/api/bindings/pwm/renesas,pwm-rcar.html
---
...
[drivers/pwm/pwm\_rcar.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_rcar.c).

## Description

```text
Renesas R-Car PWM controller
```
...
may apply to the “renesas,pwm-rcar” compatible.
