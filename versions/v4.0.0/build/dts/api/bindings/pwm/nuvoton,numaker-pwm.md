---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nuvoton,numaker-pwm.html
original_path: build/dts/api/bindings/pwm/nuvoton,numaker-pwm.html
---
...
[drivers/pwm/pwm\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_numaker.c).

## Description

```text
Nuvoton, NuMaker PWM controller
```
...
| `prescaler` | `int` | ```text Set the PWM prescale 0 ~ 4095 ```  This property is **required**. |
...
may apply to the “nuvoton,numaker-pwm” compatible.
