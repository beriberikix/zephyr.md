---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nxp,ctimer-pwm.html
original_path: build/dts/api/bindings/pwm/nxp,ctimer-pwm.html
---
...
[drivers/pwm/pwm\_mcux\_ctimer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_mcux_ctimer.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text prescaling value ```  Default value: `1` |
| `clk-source` | `int` | ```text clock to use ```  This property is **required**. |
...
| `mode` | `int` | ```text timer mode ```  This property is **required**. |
| `input` | `int` | ```text input channel ```  This property is **required**. |
| `prescale` | `int` | ```text prescale value ```  This property is **required**. |
...
may apply to the “nxp,ctimer-pwm” compatible.
