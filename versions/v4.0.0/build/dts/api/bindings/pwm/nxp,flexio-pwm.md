---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nxp,flexio-pwm.html
original_path: build/dts/api/bindings/pwm/nxp,flexio-pwm.html
---
...
[drivers/pwm/pwm\_nxp\_flexio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_nxp_flexio.c).
...
These property descriptions apply to “nxp,flexio-pwm”
...
may apply to the “nxp,flexio-pwm” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pin-id` | `int` | ```text pin-id should be populated with number 'n' specified in the FXIO_D<n> data pin of your board's schematic. ```  This property is **required**. |
| `prescaler` | `int` | ```text The clock divider for internal counter prescaler. - 1: Divide by 1 - 16: Divide by 16 - 256: Divide by 256 ```  Legal values: `1`, `16`, `256` |
