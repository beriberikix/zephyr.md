---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/microchip,xec-pwm.html
original_path: build/dts/api/bindings/pwm/microchip,xec-pwm.html
---
...
[drivers/pwm/pwm\_mchp\_xec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_mchp_xec.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `pcrs` | `array` | ```text PWM PCR register index and bit position ```  This property is **required**. |
...
may apply to the “microchip,xec-pwm” compatible.
