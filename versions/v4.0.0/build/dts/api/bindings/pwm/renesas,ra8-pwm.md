---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/renesas,ra8-pwm.html
original_path: build/dts/api/bindings/pwm/renesas,ra8-pwm.html
---
...
[drivers/pwm/pwm\_renesas\_ra8.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_renesas_ra8.c).

## Description

```text
Renesas RA8 Pulse Width Modulation
```
...
may apply to the “renesas,ra8-pwm” compatible.
