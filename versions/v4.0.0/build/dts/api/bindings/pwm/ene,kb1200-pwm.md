---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/ene,kb1200-pwm.html
original_path: build/dts/api/bindings/pwm/ene,kb1200-pwm.html
---
...
[drivers/pwm/pwm\_ene\_kb1200.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_ene_kb1200.c).

## Description

```text
ENE, Pulse Width Modulator (PWM) node
```
...
may apply to the “ene,kb1200-pwm” compatible.
