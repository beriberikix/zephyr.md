---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nxp,kinetis-tpm.html
original_path: build/dts/api/bindings/pwm/nxp,kinetis-tpm.html
---
...
[drivers/pwm/pwm\_mcux\_tpm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_mcux_tpm.c).

## Description

```text
MCUX Timer/PWM Module (TPM)
```
...
may apply to the “nxp,kinetis-tpm” compatible.
