---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nxp,qtmr-pwm.html
original_path: build/dts/api/bindings/pwm/nxp,qtmr-pwm.html
---
...
[drivers/pwm/pwm\_mcux\_qtmr.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_mcux_qtmr.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text prescale factor from the qtmr clock. ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128` |
...
may apply to the “nxp,qtmr-pwm” compatible.
