---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/sifive,pwm0.html
original_path: build/dts/api/bindings/pwm/sifive,pwm0.html
---
...
[drivers/pwm/pwm\_sifive.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_sifive.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `sifive,compare-width` | `int` | ```text Width of the PWM comparator in bits ```  This property is **required**. |
...
may apply to the “sifive,pwm0” compatible.
