---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/atmel,sam0-tcc-pwm.html
original_path: build/dts/api/bindings/pwm/atmel,sam0-tcc-pwm.html
---
...
[drivers/pwm/pwm\_sam0\_tcc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_sam0_tcc.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `channels` | `int` | ```text Number of channels this TCC has ```  This property is **required**.  Legal values: `2`, `3`, `4`, `6` |
| `counter-size` | `int` | ```text Width of the TCC counter in bits ```  This property is **required**.  Legal values: `16`, `24` |
| `prescaler` | `int` | ```text PWM prescaler ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `64`, `256`, `1024` |
...
may apply to the “atmel,sam0-tcc-pwm” compatible.
