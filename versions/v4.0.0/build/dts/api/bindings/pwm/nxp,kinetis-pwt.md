---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/nxp,kinetis-pwt.html
original_path: build/dts/api/bindings/pwm/nxp,kinetis-pwt.html
---
...
[drivers/pwm/pwm\_mcux\_pwt.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_mcux_pwt.c).

## Description

```text
Kinetis PWT PWM Capture
```
...
may apply to the “nxp,kinetis-pwt” compatible.
