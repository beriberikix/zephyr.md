---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/openisa,rv32m1-tpm.html
original_path: build/dts/api/bindings/pwm/openisa,rv32m1-tpm.html
---
...
[drivers/pwm/pwm\_rv32m1\_tpm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_rv32m1_tpm.c).

## Description

```text
OpenISA Timer/PWM Module (TPM)
```
...
may apply to the “openisa,rv32m1-tpm” compatible.
