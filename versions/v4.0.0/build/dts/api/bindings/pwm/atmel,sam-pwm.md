---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/pwm/atmel,sam-pwm.html
original_path: build/dts/api/bindings/pwm/atmel,sam-pwm.html
---
...
[drivers/pwm/pwm\_sam.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_sam.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `prescaler` | `int` | ```text Clock prescaler at the input of the PWM (0 to 10) ```  This property is **required**. |
| `divider` | `int` | ```text Clock divider at the input of the PWM (1 to 255) ```  This property is **required**. |
...
may apply to the “atmel,sam-pwm” compatible.
