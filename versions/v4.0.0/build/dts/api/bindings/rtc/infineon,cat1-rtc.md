---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/rtc/infineon,cat1-rtc.html
original_path: build/dts/api/bindings/rtc/infineon,cat1-rtc.html
---
...
[drivers/rtc/rtc\_ifx\_cat1.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/rtc/rtc_ifx_cat1.c).

## Description

```text
Infineon CAT1 family RTC device
```
...
may apply to the “infineon,cat1-rtc” compatible.
