---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/rtc/atmel,sam-rtc.html
original_path: build/dts/api/bindings/rtc/atmel,sam-rtc.html
---
...
[drivers/rtc/rtc\_sam.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/rtc/rtc_sam.c).

## Description

```text
Atmel SAM family RTC device
```
...
may apply to the “atmel,sam-rtc” compatible.
