---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/rtc/atmel,sam0-rtc.html
...
[drivers/timer/sam0\_rtc\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/sam0_rtc_timer.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-generator` | `int` | ```text clock generator index ```  This property is **required**. |
