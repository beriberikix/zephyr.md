---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/rtc/nuvoton,numaker-rtc.html
original_path: build/dts/api/bindings/rtc/nuvoton,numaker-rtc.html
---
...
[drivers/rtc/rtc\_numaker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/rtc/rtc_numaker.c).

## Description

```text
Nuvoton, NuMaker RTC controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `oscillator` | `string` | ```text Specify RTC oscillator source ```  Legal values: `'lxt'`, `'lirc'`, `'lirc32k'` |
...
may apply to the “nuvoton,numaker-rtc” compatible.
