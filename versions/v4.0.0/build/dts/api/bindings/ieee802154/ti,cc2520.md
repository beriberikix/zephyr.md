---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ieee802154/ti,cc2520.html
original_path: build/dts/api/bindings/ieee802154/ti,cc2520.html
---

# ti,cc2520 (on spi bus)
...
[drivers/ieee802154/ieee802154\_cc2520.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ieee802154/ieee802154_cc2520.c).

## Description

```text
Texas Instruments CC2520 802.15.4 wireless transceiver
```
...
| Name | Type | Details |
| --- | --- | --- |
| `vreg-en-gpios` | `phandle-array` | This property is **required**. |
| `reset-gpios` | `phandle-array` | This property is **required**. |
| `fifo-gpios` | `phandle-array` | This property is **required**. |
| `cca-gpios` | `phandle-array` | This property is **required**. |
| `sfd-gpios` | `phandle-array` | This property is **required**. |
| `fifop-gpios` | `phandle-array` | This property is **required**. |
...
may apply to the “ti,cc2520” compatible.
