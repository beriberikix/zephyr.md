---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ieee802154/ti,cc1200.html
original_path: build/dts/api/bindings/ieee802154/ti,cc1200.html
---

# ti,cc1200 (on spi bus)
...
[drivers/ieee802154/ieee802154\_cc1200.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ieee802154/ieee802154_cc1200.c).

## Description

```text
Texas Instruments CC1200 802.15.4 wireless transceiver
```
...
| Name | Type | Details |
| --- | --- | --- |
| `int-gpios` | `phandle-array` | This property is **required**. |
...
may apply to the “ti,cc1200” compatible.
