---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/ieee802154/nxp,mcr20a.html
original_path: build/dts/api/bindings/ieee802154/nxp,mcr20a.html
---

# nxp,mcr20a (on spi bus)
...
[drivers/ieee802154/ieee802154\_mcr20a.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/ieee802154/ieee802154_mcr20a.c).

## Description

```text
NXP MCR20A 802.15.4 wireless transceiver
```
...
| Name | Type | Details |
| --- | --- | --- |
| `irqb-gpios` | `phandle-array` | ```text Interrupt pin. The interrupt pin of MCR20A is open-drain, active low. If connected directly the MCU pin should be configured as pull-up, active low. ```  This property is **required**. |
| `reset-gpios` | `phandle-array` | ```text RESET pin. The RESET pin of MCR20A is active low. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
...
may apply to the “nxp,mcr20a” compatible.
