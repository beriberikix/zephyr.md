---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/ambiq,clkctrl.html
original_path: build/dts/api/bindings/clock/ambiq,clkctrl.html
---
...
[drivers/clock\_control/clock\_control\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_ambiq.c).

## Description

```text
Ambiq Apollo Series SoC Clock Controller
```
...
may apply to the “ambiq,clkctrl” compatible.
