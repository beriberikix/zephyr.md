---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/raspberrypi,pico-xosc.html
original_path: build/dts/api/bindings/clock/raspberrypi,pico-xosc.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `startup-delay-multiplier` | `int` | ```text Startup delay multiplier ``` |
...
may apply to the “raspberrypi,pico-xosc” compatible.
