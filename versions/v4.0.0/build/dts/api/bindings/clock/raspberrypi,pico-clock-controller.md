---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/raspberrypi,pico-clock-controller.html
original_path: build/dts/api/bindings/clock/raspberrypi,pico-clock-controller.html
---
...
[drivers/clock\_control/clock\_control\_rpi\_pico.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_rpi_pico.c).

## Description

```text
Raspberry Pi Pico clock controller node
```
...
may apply to the “raspberrypi,pico-clock-controller” compatible.
