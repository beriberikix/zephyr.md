---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/nxp,lpc11u6x-syscon.html
original_path: build/dts/api/bindings/clock/nxp,lpc11u6x-syscon.html
---
...
[drivers/clock\_control/clock\_control\_lpc11u6x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_lpc11u6x.c).

## Description

```text
LPC11U6X clock controller node
```
...
may apply to the “nxp,lpc11u6x-syscon” compatible.
