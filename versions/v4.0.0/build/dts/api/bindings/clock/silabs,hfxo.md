---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/silabs,hfxo.html
...
| `mode` | `string` | ```text Mode of operation. Defaults to "xtal", expecting a crystal oscillator on XI and XO pins. May be set to "extclk" or "extclkpkdet" to use an external sinusoidal clock on the XI pin with or without use of peak detector. ```  Default value: `xtal`  Legal values: `'xtal'`, `'extclk'`, `'extclkpkdet'` |
