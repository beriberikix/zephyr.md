---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/atmel,sam-pmc.html
original_path: build/dts/api/bindings/clock/atmel,sam-pmc.html
---
...
[drivers/clock\_control/clock\_control\_sam\_pmc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_sam_pmc.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `#clock-cells` | `int` | ```text from common clock binding; shall be set to 2. The first entry is the type of the clock (core, system, peripheral or generated) and the second entry it's the peripheral identification index as provided by the datasheet. ```  This property is **required**.  Constant value: `2` |
...
may apply to the “atmel,sam-pmc” compatible.
