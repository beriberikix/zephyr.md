---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/st,stm32u0-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32u0-pll-clock.html
---
...
| `div-m` | `int` | ```text Division factor M of the PLL input clock divider Valid range: 1 - 8 ```  This property is **required**. |
| `mul-n` | `int` | ```text PLL frequency multiplication factor N Valid range: 4 - 127 ```  This property is **required**. |
| `div-p` | `int` | ```text PLL VCO division factor P Valid range: 2 - 32 ``` |
| `div-q` | `int` | ```text PLL VCO division factor Q Valid range: 2 - 8 ``` |
| `div-r` | `int` | ```text PLL VCO division factor R Valid range: 2 - 8 ```  This property is **required**. |
...
may apply to the “st,stm32u0-pll-clock” compatible.
