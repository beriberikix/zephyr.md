---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/clock/pwm-clock.html
original_path: build/dts/api/bindings/clock/pwm-clock.html
---
...
[drivers/clock\_control/clock\_control\_pwm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_pwm.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `pwms` | `phandle-array` | This property is **required**. |
| `clock-frequency` | `int` | ```text Exact output frequency, in case the PWM period is not exact but was rounded to nanoseconds. This property is optional. ``` |
| `pwm-on-delay` | `int` | ```text Optional blocking delay in micro seconds to make sure that the PWM clock has started after returning from clock_control_on(). ``` |
...
may apply to the “pwm-clock” compatible.
