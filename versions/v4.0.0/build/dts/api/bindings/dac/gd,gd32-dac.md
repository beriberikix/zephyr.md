---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/gd,gd32-dac.html
original_path: build/dts/api/bindings/dac/gd,gd32-dac.html
---
...
[drivers/dac/dac\_gd32.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_gd32.c).

## Description

```text
GigaDevice GD32 series DAC module
```
...
| `num-channels` | `int` | ```text Number of DAC output channels ```  This property is **required**. |
| `reset-val` | `int` | ```text Reset value of DAC output. Defaults to 0, the SoC default. ``` |
...
may apply to the “gd,gd32-dac” compatible.
