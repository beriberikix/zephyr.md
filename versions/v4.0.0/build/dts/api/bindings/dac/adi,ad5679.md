---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5679.html
original_path: build/dts/api/bindings/dac/adi,ad5679.html
---

# adi,ad5679 (on spi bus)
...
[drivers/dac/dac\_ad56xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_ad56xx.c).

## Description

```text
Analog Devices 16-Bit 16-channel SPI DAC
```
...
may apply to the “adi,ad5679” compatible.
