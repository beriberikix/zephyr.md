---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5689.html
original_path: build/dts/api/bindings/dac/adi,ad5689.html
---

# adi,ad5689 (on spi bus)
...
```text
Analog Devices 16-Bit 2-channel SPI DAC
```
...
may apply to the “adi,ad5689” compatible.
