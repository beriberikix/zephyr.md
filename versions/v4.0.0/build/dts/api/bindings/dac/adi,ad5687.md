---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5687.html
original_path: build/dts/api/bindings/dac/adi,ad5687.html
---

# adi,ad5687 (on spi bus)
...
```text
Analog Devices 12-Bit 2-channel SPI DAC
```
...
may apply to the “adi,ad5687” compatible.
