---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5648.html
original_path: build/dts/api/bindings/dac/adi,ad5648.html
---

# adi,ad5648 (on spi bus)
...
```text
Analog Devices 14-Bit 8-channel SPI DAC
```
...
may apply to the “adi,ad5648” compatible.
