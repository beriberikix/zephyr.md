---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5672.html
original_path: build/dts/api/bindings/dac/adi,ad5672.html
---

# adi,ad5672 (on spi bus)
...
```text
Analog Devices 12-Bit 8-channel SPI DAC
```
...
may apply to the “adi,ad5672” compatible.
