---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/dac/adi,ad5684.html
original_path: build/dts/api/bindings/dac/adi,ad5684.html
---

# adi,ad5684 (on spi bus)
...
```text
Analog Devices 12-Bit 4-channel SPI DAC
```
...
may apply to the “adi,ad5684” compatible.
