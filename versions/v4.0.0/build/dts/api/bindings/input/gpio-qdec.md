---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/input/gpio-qdec.html
...
[drivers/input/input\_gpio\_qdec.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_gpio_qdec.c).
