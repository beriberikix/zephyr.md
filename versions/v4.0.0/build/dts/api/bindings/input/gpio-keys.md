---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/input/gpio-keys.html
...
[drivers/input/input\_gpio\_keys.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_gpio_keys.c).
...
| `no-disconnect` | `boolean` | ```text Do not try to disconnect the pin on suspend. Can be used if the GPIO controller does not support the GPIO_DISCONNECTED flag. ``` |
