---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mtd/nxp,imx-flexspi-aps6404l.html
original_path: build/dts/api/bindings/mtd/nxp,imx-flexspi-aps6404l.html
---

# nxp,imx-flexspi-aps6404l (on spi bus)
...
[drivers/memc/memc\_mcux\_flexspi\_aps6404l.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mcux_flexspi_aps6404l.c).

## Description

```text
AP Memory APS6404L pSRAM on NXP FlexSPI bus
```
...
may apply to the “nxp,imx-flexspi-aps6404l” compatible.
