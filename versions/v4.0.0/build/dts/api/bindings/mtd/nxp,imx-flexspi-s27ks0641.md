---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/mtd/nxp,imx-flexspi-s27ks0641.html
original_path: build/dts/api/bindings/mtd/nxp,imx-flexspi-s27ks0641.html
---

# nxp,imx-flexspi-s27ks0641 (on spi bus)
...
[drivers/memc/memc\_mcux\_flexspi\_s27ks0641.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mcux_flexspi_s27ks0641.c).

## Description

```text
Cypress S27KS0641 HyperRAM on NXP FlexSPI bus
```
...
may apply to the “nxp,imx-flexspi-s27ks0641” compatible.
