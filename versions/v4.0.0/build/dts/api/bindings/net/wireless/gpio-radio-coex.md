---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/net/wireless/gpio-radio-coex.html
original_path: build/dts/api/bindings/net/wireless/gpio-radio-coex.html
---
...
[subsys/bluetooth/controller/coex/coex\_ticker.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/subsys/bluetooth/controller/coex/coex_ticker.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `grant-gpios` | `phandle-array` | ```text GPIO input from the external transceiver ```  This property is **required**. |
| `grant-delay-us` | `int` | ```text Delay after assertion for the external transceiver operation ```  This property is **required**. |
...
may apply to the “gpio-radio-coex” compatible.
