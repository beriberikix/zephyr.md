---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/led/ti,lp5036.html
original_path: build/dts/api/bindings/led/ti,lp5036.html
---

# ti,lp5036 (on i2c bus)
...
```text
Texas Instruments LP5036 I2C LED controller node
```
...
These property descriptions apply to “ti,lp5036”
...
may apply to the “ti,lp5036” compatible.
