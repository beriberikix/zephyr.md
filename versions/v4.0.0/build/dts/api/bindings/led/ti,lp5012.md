---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/build/dts/api/bindings/led/ti,lp5012.html
original_path: build/dts/api/bindings/led/ti,lp5012.html
---

# ti,lp5012 (on i2c bus)
...
```text
Texas Instruments LP5012 I2C LED controller node
```
...
These property descriptions apply to “ti,lp5012”
...
may apply to the “ti,lp5012” compatible.
