...
3. Click Add environment ‣ From file and select
   ...
   [![MinGW toolchain with environment script](https://docs.zephyrproject.org/4.0.0/_images/clion_toolchain_mingw.webp)
   ](https://docs.zephyrproject.org/4.0.0/_images/clion_toolchain_mingw.webp)
...
4. Back in the CMake profile settings dialog, specify your board in the CMake options
   ...
   [![CMake profile](https://docs.zephyrproject.org/4.0.0/_images/clion_cmakeprofile.webp)
   ](https://docs.zephyrproject.org/4.0.0/_images/clion_cmakeprofile.webp)
...
2. Configure the settings:
   ...
   > | TCP/IP port | Auto |
   >
   > [![Embedded GDB server configuration](https://docs.zephyrproject.org/4.0.0/_images/clion_gdbserverconfig.webp)
   > ](https://docs.zephyrproject.org/4.0.0/_images/clion_gdbserverconfig.webp)
3. Click Next to set the Segger J-Link parameters.

   > [![Segger J-Link parameters](https://docs.zephyrproject.org/4.0.0/_images/clion_segger_settings.webp)
   > ](https://docs.zephyrproject.org/4.0.0/_images/clion_segger_settings.webp)
...
3. When a breakpoint is hit, CLion opens the Debug tool window.
   ...
   > [![Viewing Zephyr tasks during a debug session](https://docs.zephyrproject.org/4.0.0/_images/clion_debug_threads.webp)
   > ](https://docs.zephyrproject.org/4.0.0/_images/clion_debug_threads.webp)
