...
3. Open your already existing project by going to
   ...
   ![Create new CMake project](https://docs.zephyrproject.org/4.0.0/_images/stm32cube_new_cmake.webp)
...
8. Go to the C/C++ Build page and set the Generator
   ...
   ![Properties dialog for project](https://docs.zephyrproject.org/4.0.0/_images/stm32cube_project_properties.webp)
...
9. Go to the C/C++ General ‣ Preprocessor Include page.
   ...
   ![Properties dialog for preprocessor options](https://docs.zephyrproject.org/4.0.0/_images/stm32cube_preprocessor_include.webp)
   ...
   ![Add include file dialog](https://docs.zephyrproject.org/4.0.0/_images/stm32cube_add_include.webp)

   Once the include file has been added, your properties page should look
   similar to the following:

   ![Properties page after adding autoconf.h file](https://docs.zephyrproject.org/4.0.0/_images/stm32cube_autoconf_h.webp)
