---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/beyond-GSG.html
...
“board”[[2]](#board-misnomer). We’ll use the Phytec [reel\_board](../boards/phytec/reel_board/doc/index.md#reel-board) here, but you can change the `reel_board` build target
to another value if you have a different board. See [Supported Boards and Shields](../boards/index.md#boards) or run
...
documented in [Samples and Demos](../samples/index.md#samples).
...
[Supported Boards and Shields](../boards/index.md#boards) for additional details.
...
board-specific documentation ([Supported Boards and Shields](../boards/index.md#boards)) for further information if
needed.
...
For example, you can build and run the [Hello World](../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") sample using
...
on Linux. See [Native simulator - native\_sim](../boards/native/native_sim/doc/index.md#native-sim) for more information. On 64-bit host operating systems, you
need to install a 32-bit C library, or build targeting [native\_sim/native/64](../boards/native/native_sim/doc/index.md#native-sim32-64).
