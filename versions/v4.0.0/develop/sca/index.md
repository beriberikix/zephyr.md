---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/sca/index.html
...
Support for an SCA tool is implemented in a `sca.cmake` file.
The `sca.cmake` must be placed under `SCA_ROOT/cmake/sca/tool/sca.cmake`.
