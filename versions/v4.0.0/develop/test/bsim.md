---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/test/bsim.html
...
[bsim boards](../../boards/native/doc/bsim_boards_design.md#bsim-boards)
can be used to simulate a network of BLE and 15.4 devices.
When we build Zephyr targeting a [bsim board](../../boards/native/doc/bsim_boards_design.md#bsim-boards) we produce a Linux
...
In the [nrf52\_bsim](../../boards/native/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim), [nrf5340bsim](../../boards/native/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim),
and [nrf54l15bsim](../../boards/native/nrf_bsim/doc/nrf54l15bsim.md#nrf54l15bsim) boards documentation
...
The [bsim boards](../../boards/native/doc/bsim_boards_design.md#bsim-boards) can be used without radio activity, and in that case, it is not
necessary to connect them to a physical layer simulation. Thanks to this, these target boards can
be used just like [native\_sim](../../boards/native/native_sim/doc/index.md#native-sim) with [twister](twister.md#twister-script),
...
These tests are kept in the `tests/bsim/` folder. The `compile.sh` and `run_parallel.sh`
...
- Self checking embedded application/tests: In which some of the simulated devices applications are
  ...
  applications tests use the [bs\_tests](../../boards/native/doc/bsim_boards_design.md#bsim-boards-bs-tests) system to report the pass or
...
found in the [bsim boards tests section](../../boards/native/doc/bsim_boards_design.md#bsim-boards-tests).

## Test coverage and BabbleSim

As the [nrf52\_bsim](../../boards/native/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) and [nrf5340bsim](../../boards/native/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim), and
[nrf54l15bsim](../../boards/native/nrf_bsim/doc/nrf54l15bsim.md#nrf54l15bsim) boards are based on the POSIX architecture, you can easily collect
...
See the [NRF52 simulated board (BabbleSim)](../../boards/native/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) page for setting up the simulator.
...
See the [Bluetooth sample test ](https://github.com/zephyrproject-rtos/zephyr/blob/main/tests/bsim/bluetooth/host/misc/sample_test/README.rst) for conventions that apply to test
code.
