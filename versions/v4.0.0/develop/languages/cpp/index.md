---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/languages/cpp/index.html
...
incompatibilities](https://en.wikipedia.org/wiki/Compatibility_of_C_and_C%2B%2B). C is not just a C++ subset. Standard levels (e.g.:
...
headers organization](https://github.com/zephyrproject-rtos/zephyr/issues/41543) that is typical in real-world projects. So, header
...
[c15f029a7108](https://github.com/zephyrproject-rtos/zephyr/commit/c15f029a7108) and
