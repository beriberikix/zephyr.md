---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/west/west-apis.html
...
:   Abstract superclass for a west command.
    ...
    Added in version 0.6.0: The *requires\_installation* parameter (removed in v0.13.0).

    Added in version 0.7.0: The *requires\_workspace* parameter.
    ...
    Added in version 1.0.0: The *verbosity* parameter.
    ...
    abstractmethod do\_add\_parser(*parser\_adder*) → ArgumentParser
    ...
    abstractmethod do\_run(*args: Namespace*, *unknown: list[str]*)
...
class west.commands.Verbosity(*\*values*)
...
class west.configuration.ConfigFile(*\*values*)
...
west.configuration.read\_config(*configfile: [ConfigFile](#west.configuration.ConfigFile) | None = None*, *config: ConfigParser = <configparser.ConfigParser object>*, *topdir: str | PathLike | None = None*) → None
...
class west.manifest.Manifest(*\*, source\_data: str | dict | None = None, topdir: str | ~os.PathLike | None = None, config: ~west.configuration.Configuration | None = None, importer: ~typing.Callable[[~west.manifest.Project, str], str | list[str] | None] | None = None, import\_flags: ~west.manifest.ImportFlag = <ImportFlag.DEFAULT: 0>, internal\_import\_ctx: ~west.manifest.\_import\_ctx | None = None*)
:   The parsed contents of a west manifest file.

    \_\_init\_\_(*\*, source\_data: str | dict | None = None, topdir: str | ~os.PathLike | None = None, config: ~west.configuration.Configuration | None = None, importer: ~typing.Callable[[~west.manifest.Project, str], str | list[str] | None] | None = None, import\_flags: ~west.manifest.ImportFlag = <ImportFlag.DEFAULT: 0>, internal\_import\_ctx: ~west.manifest.\_import\_ctx | None = None*)
    ...
    Added in version 0.13.0: The *config* argument.

    Added in version 0.13.0: The *abspath*, *posixpath*, *relative\_path*, *yaml\_path*, *repo\_path*,
    *repo\_posixpath*, and *userdata* attributes.

    static from\_topdir(*topdir: str | ~os.PathLike | None = None, config: ~west.configuration.Configuration | None = None, importer: ~typing.Callable[[~west.manifest.Project, str], str | list[str] | None] | None = None, import\_flags: ~west.manifest.ImportFlag = <ImportFlag.DEFAULT: 0>*) → [Manifest](#west.manifest.Manifest)
    ...
    static from\_file(*source\_file: str | ~os.PathLike | None = None, importer: ~typing.Callable[[~west.manifest.Project, str], str | list[str] | None] | None = None, import\_flags: ~west.manifest.ImportFlag = <ImportFlag.DEFAULT: 0>*) → [Manifest](#west.manifest.Manifest)
    ...
    static from\_data(*source\_data: str | dict, importer: ~typing.Callable[[~west.manifest.Project, str], str | list[str] | None] | None = None, import\_flags: ~west.manifest.ImportFlag = <ImportFlag.DEFAULT: 0>*) → [Manifest](#west.manifest.Manifest)
    ...
    get\_projects(*project\_ids: Iterable[str | PathLike]*, *allow\_paths: bool = True*, *only\_cloned: bool = False*) → list[[Project](#west.manifest.Project)]
...
class west.manifest.ImportFlag(*\*values*)
...
:   Represents a project defined in a west manifest.
    ...
    Added in version 0.7.0: The *remote\_name* and *name\_and\_path* attributes.
    ...
    Added in version 0.9.0: The *group\_filter* and *submodules* attributes.

    Added in version 0.12.0: The *userdata* attribute.

    Added in version 1.2.0: The *description* attribute.
