---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/develop/west/alias.html
original_path: develop/west/alias.html
---
...
[shlex.split()](https://docs.python.org/3/library/shlex.html#shlex.split) internally to split the value). This enables adding argument
...
To list aliases, use `west help some_alias`.
