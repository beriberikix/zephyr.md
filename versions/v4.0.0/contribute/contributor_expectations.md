---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/contribute/contributor_expectations.html
...
- Reviewers shall not close a PR due to technical or structural disagreement.
  ...
  [PR Technical Escalation](#pr-technical-escalation) path shall be used for any potential resolution
