---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/releases/release-notes-3.0.html
...
- Following functions in UART Asynchronous API are using microseconds to represent
  ...
  \* [`uart_tx()`](../doxygen/html/group__uart__async.md#gaf99f32ce2e2d9beb32a2f2e5a26320dc)
  \* [`uart_rx_enable()`](../doxygen/html/group__uart__async.md#ga902e18c2a727ed2988e1b6caa6a444b8)
...
- The existing [`crc16()`](../doxygen/html/group__crc.md#ga204a779aa0c1a152763ea8edc6fc3a8c) and [`crc16_ansi()`](../doxygen/html/group__crc.md#gaac3ac50c029b656f5cc070e6c742601a) functions have been
  modified. The former has a new signature. The latter now properly calculates the
  CRC-16-ANSI checksum. A new function, [`crc16_reflect()`](../doxygen/html/group__crc.md#gaccbcb5b80cf8deaac252474ecc6d9914), has been
...
- Removed `CAN_BUS_UNKNOWN` and changed the signature of
  [`can_get_state()`](../doxygen/html/group__can__interface.md#gab98c121578c8349d9dfb41d60f356857) to return an error code instead.
...
- [`USBD_CFG_DATA_DEFINE`](../doxygen/html/usb__device_8h.md#a99b3c84f3988ccf277e41b3c52c4a51a) is deprecated in favor of utilizing
  [`USBD_DEFINE_CFG_DATA`](../doxygen/html/usb__device_8h.md#a5db8e2eb30dd2afc51dbb9e08fbc07c6)
- `SYS_DEVICE_DEFINE` is deprecated in favor of utilizing
  [`SYS_INIT`](../doxygen/html/group__sys__init.md#gaf507cc0613add8113c41896bd631254f).
- `device_usable_check()` is deprecated in favor of utilizing
  [`device_is_ready()`](../doxygen/html/group__device__model.md#gaa4944bd850e90cbd52b0489f9b12edfb).
...
- `can_configure()` is deprecated in favor of utilizing
  [`can_set_bitrate()`](../doxygen/html/group__can__interface.md#ga0685ebfacfb79d33131167ac3aaa6f9b) and [`can_set_mode()`](../doxygen/html/group__can__interface.md#gae04c3c884b3ed26dfea4745b7dff2c5f).
- `can_attach_workq()` is deprecated in favor of utilizing
  [`can_add_rx_filter_msgq()`](../doxygen/html/group__can__interface.md#gaaac20a068b7f32d2f38d1601d588b35c) and [`k_work_poll_submit()`](../doxygen/html/group__workqueue__apis.md#gad9f222e46d72c4f98739395a0c8bb4ea).
- `can_attach_isr()` is deprecated and replaced by
  [`can_add_rx_filter()`](../doxygen/html/group__can__interface.md#gae9dd69a13b960f773ab07bb0bb13b5e9).
- `CAN_DEFINE_MSGQ` is deprecated and replaced by
  [`CAN_MSGQ_DEFINE`](../doxygen/html/group__can__interface.md#ga7af0acdfbdad07fc3eba4cbd29bc090b).
- `can_attach_msgq()` is deprecated and replaced by
  [`can_add_rx_filter_msgq()`](../doxygen/html/group__can__interface.md#gaaac20a068b7f32d2f38d1601d588b35c).
- `can_detach()` is deprecated and replaced by
  [`can_remove_rx_filter()`](../doxygen/html/group__can__interface.md#ga822aa3142ea01582d5cfb8b478fb2847).
- `can_register_state_change_isr()` is deprecated and replaced by
  [`can_set_state_change_callback()`](../doxygen/html/group__can__interface.md#gad322da0dad328abb50de23bef6882d8e).
- `can_write()` is deprecated in favor of utilizing [`can_send()`](../doxygen/html/group__can__interface.md#ga446ee31913699de3c80be05d837b5fd5).
...
- Serial
  ...
  - Added new APIs to support datum wider than 8-bit.
    ...
    - Following functions, mirroring similar functions for 8-bit datum,
      ...
      - [`uart_tx_u16()`](../doxygen/html/group__uart__async.md#gab0ea611cd072fa459a6f1780ce62c9e3) to send a given number of datum from buffer.
      - [`uart_rx_enable_u16()`](../doxygen/html/group__uart__async.md#ga12d91846133351a85fa471fa90f2a0fd) to start receiving data.
      - [`uart_rx_buf_rsp_u16()`](../doxygen/html/group__uart__async.md#ga778bcfc30be853c8d320f295b34c17c0) to set buffer for receiving data
        in response to `UART_RX_BUF_REQUEST` event.
      - [`uart_poll_in_u16()`](../doxygen/html/group__uart__polling.md#gaad39c1358019bfdcb919da7982743553) to poll for input.
      - [`uart_poll_out_u16()`](../doxygen/html/group__uart__polling.md#ga8faa3f58b9098c97e288e9c5f3367fd9) to output datum in polling mode.
      - [`uart_fifo_fill_u16()`](../doxygen/html/group__uart__interrupt.md#gaa89f58818d8428ad6a11abf692c54c0d) to fill FIFO with data.
      - [`uart_fifo_read_u16()`](../doxygen/html/group__uart__interrupt.md#ga4a3c25dad2290f1f40e4b847e3b83f64) to read data from FIFO.
- Devicetree

  - Added new Devicetree helpers:

    - [`DT_INST_ENUM_IDX`](../doxygen/html/group__devicetree-inst.md#ga866d6c28eb7a72ba9831c7ee1ecb98d2)
    - [`DT_INST_ENUM_IDX_OR`](../doxygen/html/group__devicetree-inst.md#gafbf64148f9171ffd322f7689297e0da8)
    - [`DT_INST_PARENT`](../doxygen/html/group__devicetree-inst.md#ga176760ce1a019020b5465eebd4f44ff5)
...
- CAN
  ...
  - Added [`can_get_max_filters()`](../doxygen/html/group__can__interface.md#ga526c08539094486f07dc52aad8ed0dcc) for retrieving the maximum number of RX
...
- CAN
  ...
  - Added `CAN_STATE_ERROR_WARNING` CAN controller state.
  ...
  - Rework transmission error handling the NXP FlexCAN driver to automatically
    ...
    to fail early in [`can_send()`](../doxygen/html/group__can__interface.md#ga446ee31913699de3c80be05d837b5fd5) if in `CAN_STATE_BUS_OFF`.
...
- LwM2M:
  ...
  - Added a parameter to forcefully close the LwM2M session to
    [`lwm2m_rd_client_stop()`](../doxygen/html/group__lwm2m__api.md#gafd87e5d975c4d88973ac3e95e4d156ac) function.
  ...
  - Added [`lwm2m_update_device_service_period()`](../doxygen/html/group__lwm2m__api.md#gab45cebf6f0b6b70974367ca453d16aeb) API function.
...
- MQTT:
  ...
  - Fixed incomplete [`zsock_sendmsg()`](../doxygen/html/group__bsd__sockets.md#gadb708a068afed401e1354aac885c787e) writes handling.
  - Fixed [`zsock_setsockopt()`](../doxygen/html/group__bsd__sockets.md#gad123f59d8c86bf187054c80ff743b4eb) error handling in SOCKS5 transport.
- OpenThread:
...
- Socket:
  ...
  - Fixed [`zsock_sendmsg()`](../doxygen/html/group__bsd__sockets.md#gadb708a068afed401e1354aac885c787e) when payload size exceeded network MTU.
  - Added socket processing priority.
  - Fixed possible crash in [`zsock_getaddrinfo()`](../doxygen/html/group__bsd__sockets.md#gaf59c97c9bd07f188e3f06b2372ac1856) when DNS callback is
    delayed.
- Telnet:
...
- Power management
  ...
  - Power management resources are now manually allocated by devices using
    [`PM_DEVICE_DEFINE`](../doxygen/html/group__subsys__pm__device.md#gae85fb5a7c31863a3663cef8dd7229c6c), [`PM_DEVICE_DT_DEFINE`](../doxygen/html/group__subsys__pm__device.md#gaa2bd2c490fee99a6fc2b23605e799ef0) or
    [`PM_DEVICE_DT_INST_DEFINE`](../doxygen/html/group__subsys__pm__device.md#ga5b201836d9c19a1c87cdde93631a4b0c). Device instantiation macros take now
    a reference to the allocated resources. The reference can be obtained using
    [`PM_DEVICE_GET`](../doxygen/html/group__subsys__pm__device.md#gaa94d19d0590659b7aba83566de9bd0c5), [`PM_DEVICE_DT_GET`](../doxygen/html/group__subsys__pm__device.md#gad244d742bc6b9874bfb90a2c3c87c4e8) or
    [`PM_DEVICE_DT_INST_GET`](../doxygen/html/group__subsys__pm__device.md#ga52892f2c34f6ccc9598002625baf12ce). Thanks to this change, devices not
  ...
  - [`pm_device_runtime_enable()`](../doxygen/html/group__subsys__pm__device__runtime.md#gaabcd2cc694c9e201dd87bf42f02b454c) suspends the target device if not already
    suspended. This change makes sure device state is always kept in a
    consistent state.
  - Improved PM states Devicetree macros naming
  - Added a new API call [`pm_state_cpu_get_all()`](../doxygen/html/group__subsys__pm__states.md#ga682f75eb5324455ce95a5c7d4c2d6242) to obtain information
  ...
  - Added a new action `PM_DEVICE_ACTION_TURN_ON`. This action
    is used by power domains to notify devices when it becomes active.
  - Added new API (`pm_device_state_lock()`,
    `pm_device_state_unlock()` and
    `pm_device_state_is_locked()`) to lock a device pm
  ...
  - `pm_device_state_set()` is deprecated in favor of utilizing
    [`pm_device_action_run()`](../doxygen/html/group__subsys__pm__device.md#ga3840d6e7832a00b93763247a5951bfde).
