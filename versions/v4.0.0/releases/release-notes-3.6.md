---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/releases/release-notes-3.6.html
original_path: releases/release-notes-3.6.html
---
...
- New [GNSS subsystem](../hardware/peripherals/gnss.md#gnss-api) added, enabling geo-awareness in Zephyr applications.
- New API and drivers introduced for interfacing with [keyboard matrices](../services/input/gpio-kbd.md#gpio-kbd).
...
- Major updates to the documentation of the [native simulator](../boards/native/native_sim/doc/index.md#native-sim), clarifying
...
v3.5.0 to Zephyr v3.6.0 can be found in the separate [migration guide](migration-guide-3.6.md#migration-3-6).
...
- CVE-2023-5779 [Zephyr project bug tracker GHSA-7cmj-963q-jj47](https://github.com/zephyrproject-rtos/zephyr/security/advisories/GHSA-7cmj-963q-jj47)
- CVE-2023-6249 [Zephyr project bug tracker GHSA-32f5-3p9h-2rqc](https://github.com/zephyrproject-rtos/zephyr/security/advisories/GHSA-32f5-3p9h-2rqc)
- CVE-2023-6749 [Zephyr project bug tracker GHSA-757h-rw37-66hw](https://github.com/zephyrproject-rtos/zephyr/security/advisories/GHSA-757h-rw37-66hw)
- CVE-2023-6881 [Zephyr project bug tracker GHSA-mh67-4h3q-p437](https://github.com/zephyrproject-rtos/zephyr/security/advisories/GHSA-mh67-4h3q-p437)
- CVE-2023-7060: Under embargo until 2024-03-14
- CVE-2024-1638 [Zephyr project bug tracker GHSA-p6f3-f63q-5mc2](https://github.com/zephyrproject-rtos/zephyr/security/advisories/GHSA-p6f3-f63q-5mc2)
...
- ARC
  ...
  - Fixed unstable work of application built with MetaWare toolchain for hardware
    platforms (garbage in .device\_states section).
- ARM

  - MPU regions are now always cleared before initialization.
  - Standardized on `arch_secondary_cpu_init()` to provide consistency
    across all architectures.
  - Renamed `z_arm_prep_c()` as `z_prep_c()` to provide
  ...
  - Added support for custom interrupt controllers using
    [`CONFIG_ARM_CUSTOM_INTERRUPT_CONTROLLER`](../kconfig.md#CONFIG_ARM_CUSTOM_INTERRUPT_CONTROLLER "CONFIG_ARM_CUSTOM_INTERRUPT_CONTROLLER").
  - MMU and MPU initialization moved to `z_prep_c()` for Cortex-A and
...
- Audio
  ...
  - Changed `bt_bap_scan_delegator_subgroup` to [`bt_bap_bass_subgroup`](../doxygen/html/structbt__bap__bass__subgroup.md) and
    made it independent of [`CONFIG_BT_BAP_SCAN_DELEGATOR`](../kconfig.md#CONFIG_BT_BAP_SCAN_DELEGATOR "CONFIG_BT_BAP_SCAN_DELEGATOR").
  - Modified [`bt_bap_stream_send()`](../doxygen/html/group__bt__bap.md#ga63b69967aa92224a2bd9cf79eb41773e) to no longer take a timestamp as parameter,
    and added [`bt_bap_stream_send_ts()`](../doxygen/html/group__bt__bap.md#gaa0e012446238c916abc84d6c0de89bf3) that does.
  - Modified [`bt_cap_stream_send()`](../doxygen/html/group__bt__cap.md#ga2d8b15543105078b793462b762e27741) to no longer take a timestamp as parameter,
    and added [`bt_cap_stream_send_ts()`](../doxygen/html/group__bt__cap.md#ga23618d1ab7690c4d3a567228c857c89e) that does.
  - Assigned number values have been moved from `include/zephyr/bluetooth/audio/lc3.h` to
    `include/zephyr/bluetooth/audio/audio.h` and the `LC3` infix have been removed.
  ...
  - Added [`bt_csip_set_member_unregister()`](../doxygen/html/group__bt__csip.md#ga9ee48e36fb33ee27e689d32f08f071a1) to unregister a CSIS instance.
  ...
  - Refactored the `bt_bap_base` to be an abstract struct with new helper functions,
    so that Zephyr supports all BASEs regardless of the size.
- Host

  - Added `recycled()` callback to [`bt_conn_cb`](../doxygen/html/structbt__conn__cb.md), which notifies listeners when a
  ...
  - Modified [`bt_iso_chan_send()`](../doxygen/html/group__bt__iso.md#ga0dbb89a133011a833be7d18161471c6a) to no longer take a timestamp as parameter,
    and added [`bt_iso_chan_send_ts()`](../doxygen/html/group__bt__iso.md#gab75b817770e3b685920587afde39d6cd) that does.
- Mesh

  - Added the delayable messages functionality to apply random delays for
    the transmitted responses on the Access layer.
    The functionality is enabled by the [`CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG`](../kconfig.md#CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG "CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG")
    Kconfig option.
...
- Made these changes in other SoC series:
  ...
  - Nordic SoCs now imply [`CONFIG_XIP`](../kconfig.md#CONFIG_XIP "CONFIG_XIP") instead of selecting it. This allows for
...
- Made these changes for native/POSIX boards:
  ...
  - The [simulated nrf5340 targets](../boards/native/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim) now include the IPC and MUTEX peripherals,
  ...
  - The nrf\*\_bsim simulated targets now include models of the UART peripheral. It is now possible
    to connect a [nrf52\_bsim](../boards/native/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) UART to another, or a UART in loopback, utilizing
...
- Added functionality for Link Time Optimization.
  ...
  - [`CONFIG_ISR_TABLES_LOCAL_DECLARATION`](../kconfig.md#CONFIG_ISR_TABLES_LOCAL_DECLARATION "CONFIG_ISR_TABLES_LOCAL_DECLARATION"):
    LTO compatible interrupt tables parser
  - [`CONFIG_LTO`](../kconfig.md#CONFIG_LTO "CONFIG_LTO"): Enable Link Time Optimization

  Currently the LTO compatible interrupt tables parser is only supported by ARM architectures and
  GCC compiler/linker.
  See pull request [GitHub #66392](https://github.com/zephyrproject-rtos/zephyr/issues/66392) for details.
...
- Added [`CONFIG_ROM_END_OFFSET`](../kconfig.md#CONFIG_ROM_END_OFFSET "CONFIG_ROM_END_OFFSET") option which allows reducing the size of an image.
...
- Deprecated [`CONFIG_BOOTLOADER_SRAM_SIZE`](../kconfig.md#CONFIG_BOOTLOADER_SRAM_SIZE "CONFIG_BOOTLOADER_SRAM_SIZE"). Users of this should transition to
...
- Added support for sysbuild setting a signing script (`SIGNING_SCRIPT`). See
  [Extending signing externally](../build/signing/index.md#west-extending-signing) for details.
- Added support for `FILE_SUFFIX` in the build system which allows for adding suffixes to
  ...
  [File Suffixes](../develop/application/index.md#application-file-suffixes) and [Sysbuild file suffix support](../build/sysbuild/index.md#sysbuild-file-suffixes) for details.
...
- Audio
  ...
  - Added a driver `drivers/audio/dmic_mcux.c` for NXP DMIC peripheral. This peripheral is
...
- CAN
  ...
  - Added system call [`can_get_mode()`](../doxygen/html/group__can__interface.md#gabd201b5b1fca54048985a8a24dd51e55) for getting the current operation mode of a CAN
    controller.
  - Add system call [`can_get_transceiver()`](../doxygen/html/group__can__interface.md#gae012d26711c2a7ce1419d21c38cae63a) for getting the CAN transceiver associated with
    a CAN controller.
...
- Entropy
  ...
  - The “native\_posix” entropy driver now accepts a new command line option `seed-random`.
...
- Ethernet
  ...
  - The “native\_posix” ethernet driver now supports being built with embedded C libraries.
  ...
  - Fixed s32\_gmac driver. Link up/down handling fixes.
  - Fixed phy\_mii driver. The invalid phy id was incorrectly checked.
  - Fixed sam\_gmac driver. PTP clock adjustment was wrong for negative values.
  ...
  - Added a driver `drivers/ethernet/eth_nxp_enet.c` for NXP ENET which is a rework of
    the old driver `drivers/ethernet/eth_mcux.c`. The old driver became
...
- Flash
  ...
  - `spi_nor` driver now sleeps between polls in `spi_nor_wait_until_ready`. If this is not
    ...
    [`CONFIG_SPI_NOR_SLEEP_WHILE_WAITING_UNTIL_READY`](../kconfig.md#CONFIG_SPI_NOR_SLEEP_WHILE_WAITING_UNTIL_READY "CONFIG_SPI_NOR_SLEEP_WHILE_WAITING_UNTIL_READY") can be disabled.
  ...
  - `nordic_qspi_nor` driver now supports user-configurable QSPI timeout with
    [`CONFIG_NORDIC_QSPI_NOR_TIMEOUT_MS`](../kconfig.md#CONFIG_NORDIC_QSPI_NOR_TIMEOUT_MS "CONFIG_NORDIC_QSPI_NOR_TIMEOUT_MS").
- GNSS
  ...
  - Added GNSS device driver API and subsystem for parsing and publishing location,
    ...
    [`CONFIG_GNSS`](../kconfig.md#CONFIG_GNSS "CONFIG_GNSS") and [`CONFIG_GNSS_SATELLITES`](../kconfig.md#CONFIG_GNSS_SATELLITES "CONFIG_GNSS_SATELLITES").
    The GNSS subsystem and device drivers are based on the [Modem modules](../services/modem/index.md#modem) subsystem,
  ...
  - Added GNSS-specific, safe, string-to-integer parsing utilities, enabled by
    [`CONFIG_GNSS_PARSE`](../kconfig.md#CONFIG_GNSS_PARSE "CONFIG_GNSS_PARSE").
  - Added NMEA0183 parsing utilities, enabled by
    [`CONFIG_GNSS_NMEA0183`](../kconfig.md#CONFIG_GNSS_NMEA0183 "CONFIG_GNSS_NMEA0183").
...
- GPIO
  ...
  - Renamed `CONFIG_GPIO_RA` to [`CONFIG_GPIO_RENESAS_RA`](../kconfig.md#CONFIG_GPIO_RENESAS_RA "CONFIG_GPIO_RENESAS_RA").
  - Added a new GPIO driver (`drivers/gpio/gpio_mcux_rgpio.c`). This
    driver is used for i.MX93 and i.MX8ULP.
- I2C

  - [`i2c_get_config()`](../doxygen/html/group__i2c__interface.md#ga6858e0f1a942b22964105135c334baed) is now supported on the STM32 driver.
- I2S
...
- I3C
  ...
  - Added the ability to specify a start address when searching for a free I3C
    ...
    [`i3c_addr_slots_next_free_find()`](../doxygen/html/group__i3c__addresses.md#gad7eddb7aebf337a31f336ccf3f78cad1).
  - Added a field named `num_xfer` in [`i3c_msg`](../doxygen/html/structi3c__msg.md) and
    `i3c_ccc_taget_payload` as an output to indicate the actual
...
- Input
  ...
  - Added support for keyboard matrix drivers, including a new
    ...
    See [GPIO Keyboard Matrix](../services/input/gpio-kbd.md#gpio-kbd) for more details.
  - Added a pair of input codes to HID codes translation functions. See
    [`input_to_hid_code()`](../doxygen/html/group__input__interface.md#ga094b3ccfc2e111c4b2a000e9c2fe133c) and [`input_to_hid_modifier()`](../doxygen/html/group__input__interface.md#ga86ac2267d08e91bcc09c5b091042cfde).
...
- MIPI-DBI
  ...
  - Introduced a new [MIPI DBI driver class](../hardware/peripherals/mipi_dbi.md#mipi-dbi-api).
- Pin control

  - Renesas R-Car pinctrl driver now supports Gen4 SoCs.
  - Renamed `CONFIG_PINCTRL_RA` to [`CONFIG_PINCTRL_RENESAS_RA`](../kconfig.md#CONFIG_PINCTRL_RENESAS_RA "CONFIG_PINCTRL_RENESAS_RA").
  ...
  - On STM32 devices, pins assigned to JTAG/SW port can now be put to analog state when
    [`CONFIG_PM`](../kconfig.md#CONFIG_PM "CONFIG_PM") enabled and [`CONFIG_DEBUG`](../kconfig.md#CONFIG_DEBUG "CONFIG_DEBUG") disabled.
- PWM
...
- Regulators
  ...
  - Added new API functions
    ...
    - [`regulator_set_active_discharge()`](../doxygen/html/group__regulator__interface.md#ga8fb061502d0e94c4fe7a18c5a84d4af3)
    - [`regulator_get_active_discharge()`](../doxygen/html/group__regulator__interface.md#ga58d9e06c6da52a9733b3979d72915ab3)
    - [`regulator_list_current_limit()`](../doxygen/html/group__regulator__interface.md#gaf12002954c6fc0ab9689f4dd2ec39518)
...
- Sensor
  ...
  - Fixed ST drivers Kconfig dependency to the HAL\_ST module.
  ...
  - Added new self-documenting macros for setting ST sensor devicetree
    properties (e.g., LSM6DSV16X\_DT\_ODR\_AT\_60Hz). ([GitHub #65410](https://github.com/zephyrproject-rtos/zephyr/issues/65410))
- Serial
...
- Wi-Fi
  ...
  - Fixed esp\_at driver. Allow building without IPv4 support. Passive Receive mode fixes. Depend on UART runtime configuration.
...
- CoAP:
  ...
  - Changed [`coap_remove_observer()`](../doxygen/html/group__coap.md#ga33c351ac06b5ae9217cd53d8cf330fbd) API function return type to bool.
  ...
  - Fixed NULL pointer dereference in [`coap_packet_remove_option()`](../doxygen/html/group__coap.md#gaca300a216781d360d2cd64e8e9f1ae8f).
  - Added CoAP observer/service network events using the Network Event subsystem.
  - Changed [`coap_pending_init()`](../doxygen/html/group__coap.md#ga868f792abf555f01c28caa5413d9e84c) API function to take
    [`coap_transmission_parameters`](../doxygen/html/structcoap__transmission__parameters.md) instead of retry count.
  - Added new API functions:

    - [`coap_get_transmission_parameters()`](../doxygen/html/group__coap.md#ga1bd7be0a5390f0599e7bec0cbd79daf8)
    - [`coap_set_transmission_parameters()`](../doxygen/html/group__coap.md#gaf361fd233f1aa650650108ae1e205ede)
    - [`coap_handle_request_len()`](../doxygen/html/group__coap.md#ga864a95bd0d095070200494c630f7e147)
    - [`coap_well_known_core_get_len()`](../doxygen/html/group__coap.md#ga49d63f12b593d7509690a504b05da730)
    - [`coap_uri_path_match()`](../doxygen/html/group__coap.md#ga8b621232b740d8e8e1771fba24897121)
    - [`coap_packet_is_request()`](../doxygen/html/group__coap.md#ga323644931c927b8988aafd89dacb993c)
    - [`coap_find_observer()`](../doxygen/html/group__coap.md#gaf9c1a55aee52588df2694ea947db5db4)
    - [`coap_find_observer_by_token()`](../doxygen/html/group__coap.md#gadeaa59fd7b6eab454d5930289b4e08f7)
    - [`coap_pendings_count()`](../doxygen/html/group__coap.md#gad9db2ced9b882265c16e3039f893ca03)
    - [`coap_header_set_code()`](../doxygen/html/group__coap.md#gafdaecca5ad26bab4fb7c9ee3477318f8)
- Connection Manager:
...
- DNS:
  ...
  - Added [`CONFIG_DNS_RESOLVER_AUTO_INIT`](../kconfig.md#CONFIG_DNS_RESOLVER_AUTO_INIT "CONFIG_DNS_RESOLVER_AUTO_INIT") which allows to disable
...
- IP:
  ...
  - Fixed net\_context not being set on IP fragmented packets, preventing send
  ...
  - It is now possible to have separate IPv4 TTL value and IPv6 hop limit value for
    ...
    [`setsockopt()`](../doxygen/html/group__bsd__sockets.md#ga9e476c4da1bb69b721e4aaa384114328) API.
  ...
  - Added support for setting peer IP address in [`net_pkt`](../doxygen/html/structnet__pkt.md) structure
    for offloaded interfaces. This allows for [`recvfrom()`](../doxygen/html/group__bsd__sockets.md#ga2aa207302b058bbb5b88533c752218a2) to return a
    valid address in offloaded case.
- LwM2M:

  - Added [`CONFIG_LWM2M_UPDATE_PERIOD`](../kconfig.md#CONFIG_LWM2M_UPDATE_PERIOD "CONFIG_LWM2M_UPDATE_PERIOD") which configures the LwM2M
...
- Misc:
  ...
  - Added support for compile time network event handlers using the macro
    [`NET_MGMT_REGISTER_EVENT_HANDLER`](../doxygen/html/group__net__mgmt.md#ga3a6ca8a72ab12afd4f9b0461253eaa12).
  - Added the [`CONFIG_NET_MGMT_EVENT_WORKER`](../kconfig.md#CONFIG_NET_MGMT_EVENT_WORKER "CONFIG_NET_MGMT_EVENT_WORKER") choice to
  ...
  - Added support for binding to a specific network interface at the net\_context
    level.
  - Added IGMPv3 support.
  - Added a new network event, `NET_EVENT_HOSTNAME_CHANGED`, triggered upon
    hostname change.
  - Refactored net\_context option getters/setters to reduce code duplication.
  ...
  - Added a detailed [network configuration](../connectivity/networking/net_config_guide.md#network-configuration-guide)
    guide to the documentation.
  - Added [`CONFIG_NET_HOSTNAME_DYNAMIC`](../kconfig.md#CONFIG_NET_HOSTNAME_DYNAMIC "CONFIG_NET_HOSTNAME_DYNAMIC") option, which allows to
    enable setting hostname at runtime.
- MQTT-SN:

  - Added [`mqtt_sn_get_topic_name()`](../doxygen/html/group__mqtt__sn__socket.md#gade962a4da5311a403893ba24714dc332) API function.
...
- Sockets:
  ...
  - Added support for v4-mapping-to-v6, which allows IPv4 and IPv6 to share the
    same port space.
  - Added support for [`IPV6_V6ONLY`](../doxygen/html/group__bsd__sockets.md#ga48fb8bf5da186346125c2750265b0c65) socket option.
  - Added support for [`SO_ERROR`](../doxygen/html/group__bsd__sockets.md#ga040d4fd00495232970a03425bc00e77a) socket option.
  - Fixed [`select()`](../doxygen/html/select_8h.md#a7ffa34f8c9a12e7fd43f5ef65bf889fa) not setting `writefds` in case of errors.
  - Added support for object core, which allows to track networks sockets and
    their statistics.
  - Added support for [`recvmsg()`](../doxygen/html/group__bsd__sockets.md#ga6145592f431b7ba7b4ae1869b22cb359).
  - Added support for [`IP_PKTINFO`](../doxygen/html/group__bsd__sockets.md#gabb449c8b8ec93bdb600a03ca443e9a56) and [`IPV6_RECVPKTINFO`](../doxygen/html/group__bsd__sockets.md#ga543986d3b828a4a5b2d4aabbc61eea49)
    socket options.
  - Added support for [`IP_TTL`](../doxygen/html/group__bsd__sockets.md#ga4e304dc3f19993aee2a94bb63ee5f2fa) socket option.
  - Added support for IPv4 multicast [`IP_ADD_MEMBERSHIP`](../doxygen/html/group__bsd__sockets.md#ga924b1653500b7d3bf1bcef96a1a28431) and
    [`IP_DROP_MEMBERSHIP`](../doxygen/html/group__bsd__sockets.md#gad9e530e8ee1d2a001717d40d3aa26618) socket options.
  - Added support for IPv6 multicast [`IPV6_ADD_MEMBERSHIP`](../doxygen/html/group__bsd__sockets.md#gae00bbae5a549824fed6ec3c646ce6c47) and
    [`IPV6_DROP_MEMBERSHIP`](../doxygen/html/group__bsd__sockets.md#ga6afe2eca1346e32c42d6358cbfeaebfe) socket options.
  - Improved doxygen documentation of BSD socket API.
  - Fixed POLLERR error reporting in TLS sockets.
  - Fixed DTLS handshake processing during [`poll()`](../doxygen/html/group__bsd__sockets.md#gae2d9b8390c125624595e2b400a08ea29).
  - Aligned DTLS socket [`connect()`](../doxygen/html/group__bsd__sockets.md#gadfa930dd3c38f6c287d64e1680dbf386) behavior with regular TLS (handshake
    during connect call).
  ...
  - Added support for [`SO_DOMAIN`](../doxygen/html/group__bsd__sockets.md#gaf320236b2f835cdbee921bb51638ff04) socket option.
  - Fixed DTLS connection timeout when monitoring socket with [`poll()`](../doxygen/html/group__bsd__sockets.md#gae2d9b8390c125624595e2b400a08ea29).
...
- TCP:
  ...
  - TCP stack now replies with RST packet in response to connection attempt on
    a closed port.
  - Fixed remote address passed in [`accept()`](../doxygen/html/group__bsd__sockets.md#ga33e6ea428ff537ed7a4763ce91b7d9bb) call.
  - Fixed reference counting during active handshake to prevent TCP context
    being released prematurely.
  - Fixed compilation with [`CONFIG_NET_TCP_CONGESTION_AVOIDANCE`](../kconfig.md#CONFIG_NET_TCP_CONGESTION_AVOIDANCE "CONFIG_NET_TCP_CONGESTION_AVOIDANCE")
    disabled.
  ...
  - Fixed a bug where TCP state machine could get stuck in LAST\_ACK state
    during passive connection close.
  - Fixed a bug where TCP state machine could get stuck in FIN\_WAIT\_1 state
...
- Device support:
  ...
  - Added support for SetFeature(TEST\_MODE).
...
>   the macro [`SPI_CONFIG_DT`](../doxygen/html/group__spi__interface.md#ga822af066ee0829aee405c034bb967463) in order to set SPI mode in a Devicetree file.
...
- Management
  ...
  - Fixed an issue whereby messages that were too large to be sent over the UDP transport would
    wrongly return [`MGMT_ERR_EINVAL`](../doxygen/html/group__mcumgr__mgmt__api.md#ggac5d8757a7ca945c77f405764b85ad5c5a267572964d0db5483ca33e29c5f22fa7) instead of [`MGMT_ERR_EMSGSIZE`](../doxygen/html/group__mcumgr__mgmt__api.md#ggac5d8757a7ca945c77f405764b85ad5c5a16c3e20b3bb42218548fb15d3db144fd).
  ...
  - Added support for custom payload MCUmgr handlers. This can be enabled with
    [`CONFIG_MCUMGR_MGMT_CUSTOM_PAYLOAD`](../kconfig.md#CONFIG_MCUMGR_MGMT_CUSTOM_PAYLOAD "CONFIG_MCUMGR_MGMT_CUSTOM_PAYLOAD").
  ...
  - Added support for image slot size checking to ensure an update can be utilised by MCUboot.
    ...
    [`CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_SYSBUILD`](../kconfig.md#CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_SYSBUILD "CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_SYSBUILD") or by use of bootloader information
    sharing from MCUboot by enabling
    [`CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_BOOTLOADER_INFO`](../kconfig.md#CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_BOOTLOADER_INFO "CONFIG_MCUMGR_GRP_IMG_TOO_LARGE_BOOTLOADER_INFO").
- Logging
  ...
  - Extended logging frontend API to optionally implement dedicated functions for optimized messages.
    Optional API is enabled by [`CONFIG_LOG_FRONTEND_OPT_API`](../kconfig.md#CONFIG_LOG_FRONTEND_OPT_API "CONFIG_LOG_FRONTEND_OPT_API").
  ...
  - Fixed userspace issue for [`printk()`](../doxygen/html/printk_8h.md#a768a7dff8592b69f327a08f96b00fa54) when [`CONFIG_LOG_PRINTK`](../kconfig.md#CONFIG_LOG_PRINTK "CONFIG_LOG_PRINTK") is enabled.
  ...
  - Removed remaining references to v2 logging. Renamed `log2_generic()` to [`log_generic()`](../doxygen/html/log__core_8h.md#ab81a1401935513819384b85948e3d09c).
- Modem modules
  ...
  - Added `TRANSMIT_IDLE` event to the `modem_pipe` module which notifies the user of the pipe
    ...
    [`modem_pipe_transmit()`](../doxygen/html/group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6).
    The event greatly increases the efficiency of transmitting large quantities of data if used to
    dynamically manage the delay between calls to [`modem_pipe_transmit()`](../doxygen/html/group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6).
  ...
  - Extended all modem modules to utilize the `TRANSMIT_IDLE` event to dynamically manage the delay
    between calls to [`modem_pipe_transmit()`](../doxygen/html/group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6). This addition reduced the utilization of the
    ...
    relentless, continuous calls to [`modem_pipe_transmit()`](../doxygen/html/group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6)).
  - Improved `modem_pipe` event dispatching. The `modem_pipe` module now invokes the
    `RECEIVE_READY` event every time the pipe is attached using [`modem_pipe_attach()`](../doxygen/html/group__modem__pipe.md#ga68674becf672b1009d629813c041b868)
...
- Picolibc
  ...
  - Updated to version 1.8.6. This removes the `_POSIX_C_SOURCE` definition from the build
    system, so applications will need to add this if they use APIs outside of the Zephyr
    requirements.
  - Added new [`printf()`](../doxygen/html/stdio_8h.md#a6c67912b5a18e7d7ac03ca4e77425715) modes, [`CONFIG_PICOLIBC_IO_LONG_LONG`](../kconfig.md#CONFIG_PICOLIBC_IO_LONG_LONG "CONFIG_PICOLIBC_IO_LONG_LONG") and
    [`CONFIG_PICOLIBC_IO_MINIMAL`](../kconfig.md#CONFIG_PICOLIBC_IO_MINIMAL "CONFIG_PICOLIBC_IO_MINIMAL"). These provide applications with finer grained
  ...
  - Added [`CONFIG_PICOLIBC_ASSERT_VERBOSE`](../kconfig.md#CONFIG_PICOLIBC_ASSERT_VERBOSE "CONFIG_PICOLIBC_ASSERT_VERBOSE"). This option, which is false by default,
    controls whether the [`assert()`](../doxygen/html/assert_8h.md#ac88d9686b15e03eb62e2a66109845f86) function displays verbose information, including the file
  ...
  - [`CONFIG_THREAD_LOCAL_STORAGE`](../kconfig.md#CONFIG_THREAD_LOCAL_STORAGE "CONFIG_THREAD_LOCAL_STORAGE") can now be disabled while using Picolibc. This is
...
- Power management
  ...
  - [`pm_device_runtime_put_async()`](../doxygen/html/group__subsys__pm__device__runtime.md#ga9e90089b0ab78f365905418646e196c6) got a parameter to specify a minimum delay to
  ...
  - Optimizations in device runtime power management. [`pm_device_runtime_get()`](../doxygen/html/group__subsys__pm__device__runtime.md#ga530d4be65757fb2276ab6f631953e045) and
    [`pm_device_runtime_put()`](../doxygen/html/group__subsys__pm__device__runtime.md#ga98daba53a992fb6bd2c2b31cb445844f) no longer wait for a pending operation to be concluded if it is still
  ...
  - The Kconfig options below were added to customize the initialization priority of different
    ...
    - [`CONFIG_POWER_DOMAIN_GPIO_INIT_PRIORITY`](../kconfig.md#CONFIG_POWER_DOMAIN_GPIO_INIT_PRIORITY "CONFIG_POWER_DOMAIN_GPIO_INIT_PRIORITY")
    - [`CONFIG_POWER_DOMAIN_GPIO_MONITOR_INIT_PRIORITY`](../kconfig.md#CONFIG_POWER_DOMAIN_GPIO_MONITOR_INIT_PRIORITY "CONFIG_POWER_DOMAIN_GPIO_MONITOR_INIT_PRIORITY")
    - [`CONFIG_POWER_DOMAIN_INTEL_ADSP_INIT_PRIORITY`](../kconfig.md#CONFIG_POWER_DOMAIN_INTEL_ADSP_INIT_PRIORITY "CONFIG_POWER_DOMAIN_INTEL_ADSP_INIT_PRIORITY")
- Crypto

  - Mbed TLS updated to 3.5.2. Full release notes can be found in:
    [https://github.com/Mbed-TLS/mbedtls/releases/tag/v3.5.2](https://github.com/Mbed-TLS/mbedtls/releases/tag/v3.5.2)
- Retention

  - Fixed issue whereby [`CONFIG_RETENTION_BUFFER_SIZE`](../kconfig.md#CONFIG_RETENTION_BUFFER_SIZE "CONFIG_RETENTION_BUFFER_SIZE") values over 256 would cause
...
- POSIX API
  ...
  - Added support to allocate and free stacks up to 8 MB with pthread\_attr\_t.
...
> - Added LoRaWAN remote multicast support with [`CONFIG_LORAWAN_REMOTE_MULTICAST`](../kconfig.md#CONFIG_LORAWAN_REMOTE_MULTICAST "CONFIG_LORAWAN_REMOTE_MULTICAST")
...
- ZBus
  ...
  - Replaced mutexes with semaphores to lock channels and implement the Highest Locker Protocol (HLP)
    ...
    making the VDED delivery process faster and more consistent. ([GitHub #63183](https://github.com/zephyrproject-rtos/zephyr/issues/63183))
  - Fixed documentation for `zbus_chan_add()` and `zbus_chan_rm()` adding the timeout
    argument. ([GitHub #65544](https://github.com/zephyrproject-rtos/zephyr/issues/65544))
  - Fixed warning when mixing C and C++ files using zbus. ([GitHub #65222](https://github.com/zephyrproject-rtos/zephyr/issues/65222))
  - `ZBUS_CHANNEL_DEFINE` macro is now compatible with C++. ([GitHub #65196](https://github.com/zephyrproject-rtos/zephyr/issues/65196))
  - Fixed parameter order of net buf pool fixed definition. ([GitHub #65039](https://github.com/zephyrproject-rtos/zephyr/issues/65039))
  - Refactored the benchmark sample, adding message subscribers. ([GitHub #64524](https://github.com/zephyrproject-rtos/zephyr/issues/64524))
  - Renamed `CONFIG_ZBUS_MSG_SUBSCRIBER_NET_BUF_DYNAMIC` and
    ...
    [`CONFIG_ZBUS_MSG_SUBSCRIBER_BUF_ALLOC_STATIC`](../kconfig.md#CONFIG_ZBUS_MSG_SUBSCRIBER_BUF_ALLOC_STATIC "CONFIG_ZBUS_MSG_SUBSCRIBER_BUF_ALLOC_STATIC"). ([GitHub #65632](https://github.com/zephyrproject-rtos/zephyr/issues/65632))
...
> - Fixed issue with single slot encrypted image listing support in boot\_serial.
> - Fixed issue with allowing MBEDTLS Kconfig selection when tinycrypt is used.
> - Fixed missing response if echo command was disabled in boot\_serial.
...
> - Updated zcbor to version 0.8.1 and re-generated boot\_serial files.
...
> - Added [`CONFIG_MCUBOOT_IMGTOOL_OVERWRITE_ONLY`](../kconfig.md#CONFIG_MCUBOOT_IMGTOOL_OVERWRITE_ONLY "CONFIG_MCUBOOT_IMGTOOL_OVERWRITE_ONLY") which passes the –overwrite-only option
...
[https://github.com/zephyrproject-rtos/zcbor/blob/0.8.0/RELEASE\_NOTES.md](https://github.com/zephyrproject-rtos/zcbor/blob/0.8.0/RELEASE_NOTES.md) and
[https://github.com/zephyrproject-rtos/zcbor/blob/0.8.1/RELEASE\_NOTES.md](https://github.com/zephyrproject-rtos/zcbor/blob/0.8.1/RELEASE_NOTES.md)
...
[https://github.com/zephyrproject-rtos/lvgl/blob/zephyr/docs/CHANGELOG.md](https://github.com/zephyrproject-rtos/lvgl/blob/zephyr/docs/CHANGELOG.md)
...
- [native\_sim](../boards/native/native_sim/doc/index.md#native-sim) has replaced [native\_posix](../boards/native/native_posix/doc/index.md#native-posix) as the default
  test platform.
  [native\_posix](../boards/native/native_posix/doc/index.md#native-posix) remains supported and used in testing but will be deprecated
  in a future release.
- Bluetooth split stacks tests, where the BT host and controller are run in separate MCUs, are
  now run in CI based on the [nrf5340\_bsim](../boards/native/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim) targets.
...
- Runtime UART tests have been added to CI based on the [nrf52\_bsim](../boards/native/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) target.
...
- Fixed an issue in [SMP server](../samples/subsys/mgmt/mcumgr/smp_svr/README.md#smp-svr "Implement a Simple Management Protocol (SMP) server.") sample whereby if USB was already initialised,
  application would fail to boot properly.
- Added an LVGL sample [LVGL line chart with accelerometer data](../samples/modules/lvgl/accelerometer_chart/README.md#lvgl-accelerometer-chart "Display acceleration data on a real-time chart using LVGL.") showcasing displaying of live
  sensor data in a chart widget.
- Added ESP32-S3 IPM support in [IPM on ESP32](../samples/drivers/ipm/ipm_esp32/README.md#ipm-esp32 "Implement inter-processor mailbox (IPM) between ESP32 APP and PRO CPUs.").
- Added ESP32 memory-mapped flash access sample in [Memory-Mapped Flash](../samples/boards/espressif/flash_memory_mapped/README.md#esp32-flash-memory-mapped "Write data into scratch area and read it using flash API and memory-mapped pointer.").
