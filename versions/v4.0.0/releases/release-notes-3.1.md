---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/releases/release-notes-3.1.html
...
- LoRaWAN: The message type parameter in [`lorawan_send()`](../doxygen/html/group__lorawan__api.md#ga23758c3225e3ebf62bbe91b7589b67d7) was changed
...
- Kconfig preprocessor function `dt_nodelabel_has_compat` was redefined, for
  ...
  like [`DT_NODE_HAS_COMPAT()`](../doxygen/html/group__devicetree-generic-exist.md#gad8912ba5db980713e72257472ded3ced). Now the function does not take into account
...
- CAN
  ...
  - Allow calling the following CAN API functions from userspace:
    ...
    - [`can_set_mode()`](../doxygen/html/group__can__interface.md#gae04c3c884b3ed26dfea4745b7dff2c5f)
    - [`can_calc_timing()`](../doxygen/html/group__can__interface.md#gac27fe64142603f0d32d422594356b2d7)
    - [`can_calc_timing_data()`](../doxygen/html/group__can__interface.md#ga358cd73ed59c2099f4b2c6ceb397ca11)
    - [`can_set_bitrate()`](../doxygen/html/group__can__interface.md#ga0685ebfacfb79d33131167ac3aaa6f9b)
    - [`can_get_max_filters()`](../doxygen/html/group__can__interface.md#ga526c08539094486f07dc52aad8ed0dcc)
  - Changed [`can_set_bitrate()`](../doxygen/html/group__can__interface.md#ga0685ebfacfb79d33131167ac3aaa6f9b) to use a sample point of 75.0% for bitrates over 800 kbit/s,
    80.0% for bitrates over 500 kbit/s, and 87.5% for all other bitrates.
  - Split CAN classic and CAN-FD APIs:

    - [`can_set_timing()`](../doxygen/html/group__can__interface.md#ga1b134af5d6286ea0fee130b6da5217da) split into [`can_set_timing()`](../doxygen/html/group__can__interface.md#ga1b134af5d6286ea0fee130b6da5217da) and
      [`can_set_timing_data()`](../doxygen/html/group__can__interface.md#ga606cf9fda4c66a0f4abf74e1d357eac2).
    - [`can_set_bitrate()`](../doxygen/html/group__can__interface.md#ga0685ebfacfb79d33131167ac3aaa6f9b) split into [`can_set_bitrate()`](../doxygen/html/group__can__interface.md#ga0685ebfacfb79d33131167ac3aaa6f9b) and
      [`can_set_bitrate_data()`](../doxygen/html/group__can__interface.md#ga0afd2c446fc5e685370641a1678f87b7).
  - Converted the `enum can_mode` into a `can_mode_t` bitfield and renamed the CAN mode
    definitions:

    - `CAN_NORMAL_MODE` renamed to [`CAN_MODE_NORMAL`](../doxygen/html/group__can__interface.md#ga89cd5ea2e9d70a51bc12b100be28ca3d).
    - `CAN_SILENT_MODE` renamed to [`CAN_MODE_LISTENONLY`](../doxygen/html/group__can__interface.md#ga117d04b9118a1b3f839c557ef6b596cb).
    - `CAN_LOOPBACK_MODE` renamed to [`CAN_MODE_LOOPBACK`](../doxygen/html/group__can__interface.md#ga891031afc77974a041accb3d0ceb21bb).
...
- `nvs_init()` is deprecated in favor of utilizing [`nvs_mount()`](../doxygen/html/group__nvs__high__level__api.md#gab932ea2d6e933825c2378bef8c30b065).
...
- SPI
  ...
  - Deprecated the `gpio_dev`, `gpio_pin`, and `gpio_dt_flags` members in
    struct [`spi_cs_control`](../doxygen/html/structspi__cs__control.md) in favor of a new struct
    [`gpio_dt_spec`](../doxygen/html/structgpio__dt__spec.md) member named `gpio`.
- PWM
...
- Utilities
  ...
  - `UTIL_LISTIFY` has been deprecated. Use [`LISTIFY`](../doxygen/html/group__sys-util.md#ga81cbc0233cf73048d65b76f716653af6) instead.
- Mesh

  - The following functions related to the Bluetooth Mesh Health Client model:

    - `bt_mesh_health_fault_get()` replace with [`bt_mesh_health_cli_fault_get()`](../doxygen/html/group__bt__mesh__health__cli.md#ga2951f45aaaee75f4c77c4381b1ddd617)
    - `bt_mesh_health_fault_clear()` replace with [`bt_mesh_health_cli_fault_clear()`](../doxygen/html/group__bt__mesh__health__cli.md#ga77cc4e97193cca60d79a8076f3761ef5)
    - `bt_mesh_health_fault_clear_unack()` replace with [`bt_mesh_health_cli_fault_clear_unack()`](../doxygen/html/group__bt__mesh__health__cli.md#gafb0a46136f82f1aff4273704f1c47ac4)
    - `bt_mesh_health_fault_test()` replace with [`bt_mesh_health_cli_fault_test()`](../doxygen/html/group__bt__mesh__health__cli.md#ga00cef275cdf90876f1381ffaff04b25c)
    - `bt_mesh_health_fault_test_unack()` replace with [`bt_mesh_health_cli_fault_test_unack()`](../doxygen/html/group__bt__mesh__health__cli.md#ga8e58519ef78946e88258b335c350d754)
    - `bt_mesh_health_period_get()` replace with [`bt_mesh_health_cli_period_get()`](../doxygen/html/group__bt__mesh__health__cli.md#ga1e8e25681b9fcbc6584a29336924a78a)
    - `bt_mesh_health_period_set()` replace with [`bt_mesh_health_cli_period_set()`](../doxygen/html/group__bt__mesh__health__cli.md#ga2ef46f0b5059a959d5b06d6e49c4f552)
    - `bt_mesh_health_period_set_unack()` replace with [`bt_mesh_health_cli_period_set_unack()`](../doxygen/html/group__bt__mesh__health__cli.md#ga536c631d87daaca017af078d49094fc1)
    - `bt_mesh_health_attention_get()` replace with [`bt_mesh_health_cli_attention_get()`](../doxygen/html/group__bt__mesh__health__cli.md#gad6f322f506b8577c56bb0613f7dcbd93)
    - `bt_mesh_health_attention_set()` replace with [`bt_mesh_health_cli_attention_set()`](../doxygen/html/group__bt__mesh__health__cli.md#ga1b910d0849ce4c33d6de4bf1ff47ece8)
    - `bt_mesh_health_attention_set_unack()` replace with [`bt_mesh_health_cli_attention_set_unack()`](../doxygen/html/group__bt__mesh__health__cli.md#ga3a528688e340edf49b4bd62317284834)
  - The following function related to the Bluetooth Mesh Health Server model:

    - `bt_mesh_fault_update()` replace with [`bt_mesh_health_srv_fault_update()`](../doxygen/html/group__bt__mesh__health__srv.md#gad04789eb167b61d5ff19827c560ceb6e)
...
- Util
  ...
  - Added [`IN_RANGE`](../doxygen/html/group__sys-util.md#gaea00fb0c11b73f77da8884374e2121b4) for checking if a value is in the range of two
    other values.
- SDHC API
...
- CAN
  ...
  - Added support for getting the minimum/maximum supported CAN timing parameters:
    ...
    - [`can_get_timing_min()`](../doxygen/html/group__can__interface.md#ga5a57627de4764f0bd3b4bafe07f56e6f)
    - [`can_get_timing_max()`](../doxygen/html/group__can__interface.md#gabe385d0f003b1e990c78ef7a2a3f9616)
    - [`can_get_timing_data_min()`](../doxygen/html/group__can__interface.md#ga6399ef0cefdab3da738136f8a5c59c2f)
    - [`can_get_timing_data_max()`](../doxygen/html/group__can__interface.md#ga47a2f6d6b42121b390aa92160c833b80)
  - Added support for enabling/disabling CAN-FD mode at runtime using [`CAN_MODE_FD`](../doxygen/html/group__can__interface.md#gabb4d99736d8386a5ab62a5e44374d13a).
...
- HCI Driver
  ...
  - Added support for a new optional [`bt_hci_driver.close`](../doxygen/html/structbt__hci__driver.md#ae76bda7ebee44966554ba7b58da30e87) API which
    closes HCI transport.
  - Implemented [`bt_hci_driver.close`](../doxygen/html/structbt__hci__driver.md#ae76bda7ebee44966554ba7b58da30e87) on stm32wb HCI driver.
- Host

  - The [`bt_l2cap_chan_state`](../doxygen/html/group__bt__l2cap.md#ga642436bdf29f79495763b10231c6b25b) values `BT_L2CAP_CONNECT` and
  ...
  - The callbacks `pairing_complete()`, `pairing_failed()`, and
    ...
    newly created informational-only callback struct [`bt_conn_auth_info_cb`](../doxygen/html/structbt__conn__auth__info__cb.md).
  - [`bt_conn_index()`](../doxygen/html/group__bt__conn.md#gad4aed76b80cc815f748ad0e84ae3d87c) now takes a `const struct bt_conn*` argument.
  - The [`bt_gatt_subscribe_params`](../doxygen/html/structbt__gatt__subscribe__params.md) structure’s `write` callback
    function has been deprecated. Use the new `subscribe` callback
    instead.
  - [`bt_disable()`](../doxygen/html/group__bt__gap.md#ga0a58e5a050170e84a80f8d5bb3516ec7) was added to enable the caller to disable the Bluetooth stack.
  - Added new Kconfig options to select ISO Central and Peripheral role support
    separately
  - Added a new [`bt_get_appearance()`](../doxygen/html/group__bt__gap.md#ga35b76ea7ce79721e47ca4164e08b2dfb) API call
  - Implemented support for dynamic appearance, including a new
    [`bt_set_appearance()`](../doxygen/html/group__bt__gap.md#gaf0729453790aab1bd3d52c623be3b35a) API call
  ...
  - Changed the scheduling of auto-initiated HCI commands so that they execute
    synchronously
  - Added a new [`bt_is_ready()`](../doxygen/html/group__bt__gap.md#gaa8bf6854e7ad1fe7e0805737576e5d1a) API call to find out if Bluetooth is
    currently enabled and initialized
  - Added support for automatic MTU exchange right after a connection is
    established
  - Created a new [`bt_conn_auth_info_cb`](../doxygen/html/structbt__conn__auth__info__cb.md) to group the
    security-related callbacks under a single struct
  - Optimized the memory usage of the Object Transfer Service
  - Added a new [`bt_hci_le_rand()`](../doxygen/html/hci_8h.md#a50f4a8808c26a7b4e288e650b2325883) API call to obtain a random number
    from the LE Controller
  - Added a new public API to connect EATT channels, [`bt_eatt_connect()`](../doxygen/html/group__bt__att.md#ga748194cbbd54a3336d3c788f08e3de99)
...
- ADC
  ...
  - STM32: Added support for `adc_reference.ADC_REF_INTERNAL`.
  - Added the [`adc_dt_spec`](../doxygen/html/structadc__dt__spec.md) structure and associated helper macros,
    e.g. [`ADC_DT_SPEC_GET`](../doxygen/html/group__adc__interface.md#gad05df3d329ba785c094ea4c32e2913b7), to facilitate getting configuration of
...
- I2C
  ...
  - Added arbitrary I2C clock speed support with [`I2C_SPEED_DT`](../doxygen/html/group__i2c__interface.md#gad38207f2e64b6ef3c08b17c8ccb3a836)
...
- PWM
  ...
  - Added [`pwm_dt_spec`](../doxygen/html/structpwm__dt__spec.md) and associated helpers, e.g.
    [`PWM_DT_SPEC_GET`](../doxygen/html/group__pwm__interface.md#ga59a79f0b77c5b71252bde126f333a84b) or [`pwm_set_dt()`](../doxygen/html/group__pwm__interface.md#ga225ce58ceb3de3d76df3e03439d655b9). This addition makes it
  ...
  - Aligned nRF PWM drivers (pwm\_nrfx and pwm\_nrf5\_sw) with the updated PWM API.
    ...
    by the drivers, so either the [`PWM_POLARITY_INVERTED`](../doxygen/html/group__pwm__interface.md#ga930c0ab50f81aeb571af9747947d7fae) or
    [`PWM_POLARITY_NORMAL`](../doxygen/html/group__pwm__interface.md#ga2c706bbada711f383d7b42f09dace861) flag must be provided in each call.
- Reset
...
- CoAP:
  ...
  - Changed [`coap_pending`](../doxygen/html/structcoap__pending.md) allocation criteria. This now uses a data
...
- LwM2M:
  ...
  - Fixed a bug which could cause a socket descriptor leak, in case
    [`lwm2m_rd_client_start()`](../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79) was called immediately after
    [`lwm2m_rd_client_stop()`](../doxygen/html/group__lwm2m__api.md#gafd87e5d975c4d88973ac3e95e4d156ac).
  - Added error reporting from [`lwm2m_rd_client_start()`](../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79) and
    [`lwm2m_rd_client_stop()`](../doxygen/html/group__lwm2m__api.md#gafd87e5d975c4d88973ac3e95e4d156ac).
- Misc:

  - Added [`net_if_set_default()`](../doxygen/html/group__net__if.md#ga0a1f27ec893e1af3c97f130be4616589) function which allows to set a default
  ...
  - Added [`net_pkt_rx_clone()`](../doxygen/html/group__net__pkt.md#ga66aec729118e4d927c921b872df82dda) which allows to allocated packet from
...
- Sockets:
  ...
  - Added support for [`SO_SNDBUF`](../doxygen/html/group__bsd__sockets.md#gaf618cbb85161ff3196d3bcdf7565ba64) and [`SO_RCVBUF`](../doxygen/html/group__bsd__sockets.md#ga0db12e960ac303030400d9fd95391b52) socket
    options.
...
- TLS:
  ...
  - Added [`TLS_SESSION_CACHE`](../doxygen/html/group__secure__sockets__options.md#ga16943eab0c13effcbdef684cc613ee04) and [`TLS_SESSION_CACHE_PURGE`](../doxygen/html/group__secure__sockets__options.md#ga627be83cd8ae54e7d4f747a654ac1e25)
    socket options which allow to control session caching on a socket.
  - Fixed [`TLS_CIPHERSUITE_LIST`](../doxygen/html/group__secure__sockets__options.md#gaf62ff88a51178604287ab31a645adf05) socket option, which did not set the
...
- API
  ...
  - New macros for creating tokens in C from strings in the devicetree:
    [`DT_STRING_UPPER_TOKEN_OR`](../doxygen/html/group__devicetree-generic-prop.md#gab79f5274c82d025d805ec94d2935c9b9), [`DT_INST_STRING_TOKEN`](../doxygen/html/group__devicetree-inst.md#ga8e8c72187ce0d47fd24e4585f3d48484),
...
- Power management
  ...
  - Added [`CONFIG_PM_DEVICE_POWER_DOMAIN_DYNAMIC`](../kconfig.md#CONFIG_PM_DEVICE_POWER_DOMAIN_DYNAMIC "CONFIG_PM_DEVICE_POWER_DOMAIN_DYNAMIC").
    ...
    - [`pm_device_power_domain_add()`](../doxygen/html/group__subsys__pm__device.md#gaa10a3f1ce71409cb591db416a1611377)
    - [`pm_device_power_domain_remove()`](../doxygen/html/group__subsys__pm__device.md#ga1d7ab9b0b497e016b9b22d2506cd23f9)
  - The default policy was renamed from `PM_POLICY_RESIDENCY` to
    `PM_POLICY_DEFAULT`, and `PM_POLICY_APP` was renamed to
    `PM_POLICY_CUSTOM`.
  - The following functions were renamed:

    - `pm_power_state_next_get()` is now [`pm_state_next_get()`](../doxygen/html/group__subsys__pm__sys.md#ga3861a1a0009b96d15de00059257848dd)
    - `pm_power_state_force()` is now [`pm_state_force()`](../doxygen/html/group__subsys__pm__sys.md#ga075be307983f4efdcc93252a31a4258a)
  ...
  - The state constraint APIs were moved (and renamed) to the policy
    ...
    - `pm_constraint_get()` is now [`pm_policy_state_lock_is_active()`](../doxygen/html/group__subsys__pm__sys__policy.md#ga39f14c8509dee55ed084b4111584b766)
    - `pm_constraint_set()` is now [`pm_policy_state_lock_get()`](../doxygen/html/group__subsys__pm__sys__policy.md#gabbb379f8572f164addafe93ad3468f3d)
    - `pm_constraint_release()` is now [`pm_policy_state_lock_put()`](../doxygen/html/group__subsys__pm__sys__policy.md#ga12f4d121aa8be0eb66381713b481a8b1)
  - Added a new API to set maximum latency requirements. The `DEFAULT` policy
    ...
    - [`pm_policy_latency_request_add()`](../doxygen/html/group__subsys__pm__sys__policy.md#ga848627f6d143ece582711a16cab5442a)
    - [`pm_policy_latency_request_update()`](../doxygen/html/group__subsys__pm__sys__policy.md#ga6483bd320881d697de27493b4f2d92d1)
    - [`pm_policy_latency_request_remove()`](../doxygen/html/group__subsys__pm__sys__policy.md#gaadcb851b1bfb312ea0960918dc9f869e)
  - The API to set a device initial state was changed to be usable independently of
    ...
    - `pm_device_runtime_init_suspended()` is now [`pm_device_init_suspended()`](../doxygen/html/group__subsys__pm__device.md#ga4c366f49e326a8b8e01d90cb2ee424ba)
    - `pm_device_runtime_init_off()` is now [`pm_device_init_off()`](../doxygen/html/group__subsys__pm__device.md#gafb12ecf4679dd449e2faad0ede2c75fd)
- IPC
...
- Shell
  ...
  - Added API for creating subcommands from multiple files using memory section approach:
    ...
    - [`SHELL_SUBCMD_SET_CREATE`](../doxygen/html/group__shell__api.md#ga1e314886b70ee2e7e0763cd945a1a988) for creating a subcommand set.
    - [`SHELL_SUBCMD_COND_ADD`](../doxygen/html/group__shell__api.md#gab1b643efbaee748be0256e904642e310) and [`SHELL_SUBCMD_ADD`](../doxygen/html/group__shell__api.md#ga85b0afcacd3831bf5c724590765e035f) for adding subcommands
      to the set.
