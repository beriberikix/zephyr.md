---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/releases/release-notes-2.6.html
...
- The [`wait_for_usb_dfu()`](../doxygen/html/usb__dfu_8h.md#a892959f521c403e4ec295c252e75e5dc) function now accepts a `k_timeout_t` argument instead of
  using the `CONFIG_USB_DFU_WAIT_DELAY_MS` macro.
- Added disconnect reason to the `disconnected()` callback of [`bt_iso_chan_ops`](../doxygen/html/structbt__iso__chan__ops.md).
- Align error handling of :c:func:bt\_l2cap\_chan\_send and
  [`bt_iso_chan_send()`](../doxygen/html/group__bt__iso.md#ga0dbb89a133011a833be7d18161471c6a) so when an error occur the buffer is not unref.
...
- `DT_CLOCKS_LABEL_BY_IDX`, `DT_CLOCKS_LABEL_BY_NAME`,
  ...
  [`DT_CLOCKS_CTLR`](../doxygen/html/group__devicetree-clocks.md#ga69795ece1f4a46e2c26a8e2dbb452f23) and variants.
- `DT_PWMS_LABEL_BY_IDX`, `DT_PWMS_LABEL_BY_NAME`,
  ...
  [`DT_PWMS_CTLR`](../doxygen/html/group__devicetree-pwms.md#gaff7a0b201d97a1d1bb1893b556d5a194) and variants.
- `DT_IO_CHANNELS_LABEL_BY_IDX`,
  ...
  [`DT_IO_CHANNELS_CTLR`](../doxygen/html/group__devicetree-io-channels.md#gaef1d0ee74798d9e60f5c5fa0c0f8db48) and variants.
- `DT_DMAS_LABEL_BY_IDX`,
  ...
  [`DT_DMAS_CTLR`](../doxygen/html/group__devicetree-dmas.md#ga09a22a0e5133dc7514680c16373f6ad3) and variants.
...
- The following functions, macros, and structures related to the kernel
  ...
  - `k_work_pending()` replace with [`k_work_is_pending()`](../doxygen/html/group__workqueue__apis.md#ga0d1d2e1d2ba2e89a560a1bdc5365d9e0)
  - `k_work_q_start()` replace with [`k_work_queue_start()`](../doxygen/html/group__workqueue__apis.md#gadfc56554f9bfe7b52309d79660188593)
  - `k_delayed_work` replace with [`k_work_delayable`](../doxygen/html/structk__work__delayable.md)
  ...
  - `k_delayed_work_submit_to_queue()` replace with
    [`k_work_schedule_for_queue()`](../doxygen/html/group__workqueue__apis.md#ga17f863c9f6ff2fb41dc0f3b7de4fdf23) or
    [`k_work_reschedule_for_queue()`](../doxygen/html/group__workqueue__apis.md#gabf5db091eac19b19a4e12c0cb381f0a8)
  - `k_delayed_work_submit()` replace with [`k_work_schedule()`](../doxygen/html/group__workqueue__apis.md#ga5c113ea2bc8e8e5cd7a5c8bc5ec595d3)
    or [`k_work_reschedule()`](../doxygen/html/group__workqueue__apis.md#gaacaab408fb7c848d466ad1f069dfa648)
  - `k_delayed_work_pending()` replace with
    [`k_work_delayable_is_pending()`](../doxygen/html/group__workqueue__apis.md#ga66e598dbc73f653cbfec03c21168df2e)
  - `k_delayed_work_cancel()` replace with
    [`k_work_cancel_delayable()`](../doxygen/html/group__workqueue__apis.md#ga92355914ee178d4c3e848a1946bed3e4)
  - `k_delayed_work_remaining_get()` replace with
    [`k_work_delayable_remaining_get()`](../doxygen/html/group__workqueue__apis.md#gabce78598a014f3ed87730fe6a9fe61b4)
  - `k_delayed_work_expires_ticks()` replace with
    [`k_work_delayable_expires_get()`](../doxygen/html/group__workqueue__apis.md#ga1772c37bc62b86180d5cf48fe3037624)
  - `k_delayed_work_remaining_ticks()` replace with
    [`k_work_delayable_remaining_get()`](../doxygen/html/group__workqueue__apis.md#gabce78598a014f3ed87730fe6a9fe61b4)
  - `K_DELAYED_WORK_DEFINE` replace with
    [`K_WORK_DELAYABLE_DEFINE`](../doxygen/html/group__workqueue__apis.md#ga893b281f3d2bc0088650536899e17903)
...
- Added [`k_mem_unmap()`](../doxygen/html/group__kernel__memory__management.md#ga1867ea13671daae6a5f38929ea9fd64a) so anonymous memory mapped via [`k_mem_map()`](../doxygen/html/group__kernel__memory__management.md#gacf5f9c43ac2c31c376fed4a19f607feb)
...
- GPIO
  ...
  - [`gpio_dt_spec`](../doxygen/html/structgpio__dt__spec.md): a new structure which makes it more convenient to
    access GPIO configuration in the [devicetree](../build/dts/index.md#dt-guide).
  - New macros for initializing `gpio_dt_spec` values:
    [`GPIO_DT_SPEC_GET_BY_IDX`](../doxygen/html/group__gpio__interface.md#gacb1077b77aecf8f1a9c7636ea583c4cf), [`GPIO_DT_SPEC_GET_BY_IDX_OR`](../doxygen/html/group__gpio__interface.md#ga3db4fa464e191016287f4c4d7eb9a983),
    [`GPIO_DT_SPEC_GET`](../doxygen/html/group__gpio__interface.md#ga2fa6bb5880f46984f9fc29c70f7d503e), [`GPIO_DT_SPEC_GET_OR`](../doxygen/html/group__gpio__interface.md#ga26b2205aa82819df1d80a22761352e71),
    [`GPIO_DT_SPEC_INST_GET_BY_IDX`](../doxygen/html/group__gpio__interface.md#gabbdbef450f14fd0af73667e2728ad084),
    [`GPIO_DT_SPEC_INST_GET_BY_IDX_OR`](../doxygen/html/group__gpio__interface.md#gaf07edf6bc88af18e9976c76f6c3c3bf1),
    [`GPIO_DT_SPEC_INST_GET`](../doxygen/html/group__gpio__interface.md#ga168f5c6e39a0111191f606a9a0826e89), and [`GPIO_DT_SPEC_INST_GET_OR`](../doxygen/html/group__gpio__interface.md#gae6b4a354c3cf0e042a390aac4bc37c69)
  - New helper functions for using `gpio_dt_spec` values:
    [`gpio_pin_configure_dt()`](../doxygen/html/group__gpio__interface.md#ga423db4f985098ddcaa504ec430e91913), [`gpio_pin_interrupt_configure_dt()`](../doxygen/html/group__gpio__interface.md#ga24f0b4ad30e6a8c81f51a2813478c793)
  - Remove support for `GPIO_INT_*` flags in [`gpio_pin_configure()`](../doxygen/html/group__gpio__interface.md#gaed4a2051d76db7eead8ed1719ce2ba33).
    The feature has been deprecated in the Zephyr 2.2 release. The interrupt
    flags are now accepted by [`gpio_pin_interrupt_configure()`](../doxygen/html/group__gpio__interface.md#ga9618f254365381063439a0e9c5e787cb)
    function only.
...
- Management
  ...
  - MCUmgr
    ...
    - Fixed an issue with the file system management failing to
      open files due to missing initializations of `fs_file_t`
      structures.
