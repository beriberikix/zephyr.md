---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/kernel/data_structures/mpsc_pbuf.html
original_path: kernel/data_structures/mpsc_pbuf.html
---

# Multi Producer Single Consumer Packet Buffer

A *Multi Producer Single Consumer Packet Buffer (MPSC\_PBUF)* is a circular
...
[`MPSC_PBUF_HDR`](../../doxygen/html/group__mpsc__packet.md#ga643932633f40ecdcfb9120662221d828) and remaining bits in the first word can be application
...
Packet header details can be found in [include/zephyr/sys/mpsc\_packet.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/sys/mpsc_packet.h).
API functions can be found in [include/zephyr/sys/mpsc\_pbuf.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/sys/mpsc_pbuf.h). Headers
