---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/kernel/usermode/syscalls.html
original_path: kernel/usermode/syscalls.html
---
...
- A **C prototype** prefixed with `__syscall` for the API. It
  ...
  manually, instead it gets created by the [scripts/build/gen\_syscalls.py](../../build/cmake/index.md#gen-syscalls-py) script.
...
The `__syscall` attribute is very special. To the C compiler, it
simply expands to ‘static inline’. However to the post-build
[scripts/build/parse\_syscalls.py](../../build/cmake/index.md#parse-syscalls-py) script, it indicates that this API is a system call.
The [scripts/build/parse\_syscalls.py](../../build/cmake/index.md#parse-syscalls-py) script does some parsing of the function prototype,
...
turn on [`CONFIG_EMIT_ALL_SYSCALLS`](../../kconfig.md#CONFIG_EMIT_ALL_SYSCALLS "CONFIG_EMIT_ALL_SYSCALLS").
...
the definition of macros `__ZEPHYR_SUPERVISOR__` or
`__ZEPHYR_USER__`, typically these will be added to the compiler
flags in the build system for the related files.

- If [`CONFIG_USERSPACE`](../../kconfig.md#CONFIG_USERSPACE "CONFIG_USERSPACE") is not enabled, all APIs just directly call
...
- If `__ZEPHYR_SUPERVISOR__` is defined, then it is assumed that
  ...
  allowed to do.
- If `__ZEPHYR_USER__` is defined, then it is assumed that all the
  code runs in user mode and system calls are unconditionally made.

### Implementation Details

Declaring an API with `__syscall` causes some code to be generated in
C and header files by the [scripts/build/gen\_syscalls.py](../../build/cmake/index.md#gen-syscalls-py) script, all of which can be found in
...
- An entry for the system call is created in the dispatch table
  ...
  - This table only contains syscalls where their corresponding
    ...
    [`CONFIG_EMIT_ALL_SYSCALLS`](../../kconfig.md#CONFIG_EMIT_ALL_SYSCALLS "CONFIG_EMIT_ALL_SYSCALLS") is enabled:
...
example of [`k_sem_init()`](../../doxygen/html/group__semaphore__apis.md#gadcd0e6cfba3392fb887222eafe4c1845), this API is declared in
...
Inside this header is the body of [`k_sem_init()`](../../doxygen/html/group__semaphore__apis.md#gadcd0e6cfba3392fb887222eafe4c1845):
...
`_arch_syscall_invoke0()` through `_arch_syscall_invoke6()`. These
...
[![System Call execution flow](https://docs.zephyrproject.org/4.0.0/_images/syscall_flow.png)
](https://docs.zephyrproject.org/4.0.0/_images/syscall_flow.png)
...
made simpler by some macros in [include/zephyr/internal/syscall\_handler.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/internal/syscall_handler.h).
...
- [`K_SYSCALL_OBJ()`](../../doxygen/html/group__syscall__apis.md#gaf1139c2c6044c5bb6da2bf901b5804c4) Checks a memory address to assert that it is
...
- [`K_SYSCALL_OBJ_INIT()`](../../doxygen/html/group__syscall__apis.md#ga54db53f239955f325e8b7e18f06589ca) is the same as
  [`K_SYSCALL_OBJ()`](../../doxygen/html/group__syscall__apis.md#gaf1139c2c6044c5bb6da2bf901b5804c4), except that the provided object may be
  uninitialized. This is useful for verifiers of object init functions.
- [`K_SYSCALL_OBJ_NEVER_INIT()`](../../doxygen/html/group__syscall__apis.md#ga652457773cc6d45c2058183d374affe6) is the same as
  [`K_SYSCALL_OBJ()`](../../doxygen/html/group__syscall__apis.md#gaf1139c2c6044c5bb6da2bf901b5804c4), except that the provided object must be
...
- [`K_SYSCALL_MEMORY_READ()`](../../doxygen/html/group__syscall__apis.md#ga964d979b84494266ffc360318732b537) validates a memory buffer of a particular
  size. The calling thread must have read permissions on the entire buffer.
- [`K_SYSCALL_MEMORY_WRITE()`](../../doxygen/html/group__syscall__apis.md#ga5f6dfb5b3b2b6e75e164f42e127cea1a) is the same as
  [`K_SYSCALL_MEMORY_READ()`](../../doxygen/html/group__syscall__apis.md#ga964d979b84494266ffc360318732b537) but the calling thread must additionally
  have write permissions.
- [`K_SYSCALL_MEMORY_ARRAY_READ()`](../../doxygen/html/group__syscall__apis.md#ga48a8ccdd4ff43b6fb3caa77956466dd1) validates an array whose total size
  ...
  on the total size.
- [`K_SYSCALL_MEMORY_ARRAY_WRITE()`](../../doxygen/html/group__syscall__apis.md#ga6a1465208770d52a5c06de72ffda4421) is the same as
  [`K_SYSCALL_MEMORY_ARRAY_READ()`](../../doxygen/html/group__syscall__apis.md#ga48a8ccdd4ff43b6fb3caa77956466dd1) but the calling thread must
  additionally have write permissions.
- [`K_SYSCALL_VERIFY_MSG()`](../../doxygen/html/group__syscall__apis.md#gac1a9c494aa091d9e67e2bf4fb1113f53) does a runtime check of some boolean
  expression which must evaluate to true otherwise the check will fail.
  A variant [`K_SYSCALL_VERIFY`](../../doxygen/html/group__syscall__apis.md#ga2b79503cd448a698e8a4ccb46a012b48) exists which does not take
...
- [`K_SYSCALL_DRIVER_OP()`](../../doxygen/html/group__syscall__apis.md#ga5113d697b1ec8615afa66771aeb91a4e) checks at runtime if a driver
  ...
  `K_SYSCALL_DRIVER_GPIO()` macro.
- [`K_SYSCALL_SPECIFIC_DRIVER()`](../../doxygen/html/group__syscall__apis.md#ga1f5b938fc90bb11e2f8a200fe3b59730) is a runtime check to verify that
...
[`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181) can be used to induce a kernel oops which will kill the
...
[`k_usermode_to_copy()`](../../doxygen/html/group__syscall__apis.md#gaf454b8b7e076a9b9acd698b1ec2a6b79) and [`k_usermode_from_copy()`](../../doxygen/html/group__syscall__apis.md#ga931b212610371c3a288a16c158318501) APIs exist for
this purpose.
...
the implementation function, and then used [`k_usermode_to_copy()`](../../doxygen/html/group__syscall__apis.md#gaf454b8b7e076a9b9acd698b1ec2a6b79) to fill
...
memory from the caller’s resource pool via `z_thread_malloc()`. This
...
simply invoke [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181) which kills the calling thread. The current
conventions are as follows:

1. For system calls that are defined but not compiled, invocations of these
   missing system calls are routed to `handler_no_syscall()` which
   invokes [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181).
2. Any invalid access to memory found by the set of `K_SYSCALL_MEMORY` APIs,
   [`k_usermode_from_copy()`](../../doxygen/html/group__syscall__apis.md#ga931b212610371c3a288a16c158318501), [`k_usermode_to_copy()`](../../doxygen/html/group__syscall__apis.md#gaf454b8b7e076a9b9acd698b1ec2a6b79)
   should trigger a [`K_OOPS`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181). This happens when the caller doesn’t have
   appropriate permissions on the memory buffer or some size calculation
   overflowed.
3. Most system calls take kernel object pointers as an argument, checked either
   with one of the `K_SYSCALL_OBJ` functions, `K_SYSCALL_DRIVER_nnnnn`, or
   manually using [`k_object_validate()`](../../doxygen/html/group__syscall__apis.md#ga63f436a6ce6ea661f336b5e9e37b9a49). These can fail for a variety
   ...
   invoke [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181).
4. Any error resulting from a failed memory heap allocation, often from
   invoking `z_thread_malloc()`, should propagate `-ENOMEM` to the
   caller.
5. General parameter checks should be done in the implementation function,
   in most cases using `CHECKIF()`.

   - The behavior of `CHECKIF()` depends on the kernel configuration, but if
     user mode is enabled, [`CONFIG_RUNTIME_ERROR_CHECKS`](../../kconfig.md#CONFIG_RUNTIME_ERROR_CHECKS "CONFIG_RUNTIME_ERROR_CHECKS") is enforced,
     which guarantees that these checks will be made and a return value
     propagated.
6. It is totally forbidden for any kind of kernel mode callback function to
   ...
   must enforce that these are NULL and should invoke [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181) if
   not.
7. Some parameter checks are enforced only from user mode. These should be
...
- [`k_thread_join()`](../../doxygen/html/group__thread__apis.md#ga40a733561eb1f64dcaae0e01b167d233) and [`k_thread_abort()`](../../doxygen/html/group__thread__apis.md#ga1f44bb0307bea7a97227764ecd7bf963) are no-ops if
...
- [`k_thread_create()`](../../doxygen/html/group__thread__apis.md#gad5b0bff3102f1656089f5875d999a367) invokes [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181) for parameter
  checks, due to a great deal of existing code ignoring the return value.
  This will also be addressed by #23030.
- [`k_thread_abort()`](../../doxygen/html/group__thread__apis.md#ga1f44bb0307bea7a97227764ecd7bf963) invokes [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181) if an essential
  thread is aborted, as the function has no return value.
- Various system calls related to logging invoke [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181)
...
- [`CONFIG_EMIT_ALL_SYSCALLS`](../../kconfig.md#CONFIG_EMIT_ALL_SYSCALLS "CONFIG_EMIT_ALL_SYSCALLS")

## APIs

Helper macros for creating system call verification functions are provided in
[include/zephyr/internal/syscall\_handler.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/internal/syscall_handler.h):

- [`K_SYSCALL_OBJ()`](../../doxygen/html/group__syscall__apis.md#gaf1139c2c6044c5bb6da2bf901b5804c4)
- [`K_SYSCALL_OBJ_INIT()`](../../doxygen/html/group__syscall__apis.md#ga54db53f239955f325e8b7e18f06589ca)
- [`K_SYSCALL_OBJ_NEVER_INIT()`](../../doxygen/html/group__syscall__apis.md#ga652457773cc6d45c2058183d374affe6)
- [`K_OOPS()`](../../doxygen/html/group__syscall__apis.md#gadffbde0c37a4c192d8ce860943ef6181)
- [`K_SYSCALL_MEMORY_READ()`](../../doxygen/html/group__syscall__apis.md#ga964d979b84494266ffc360318732b537)
- [`K_SYSCALL_MEMORY_WRITE()`](../../doxygen/html/group__syscall__apis.md#ga5f6dfb5b3b2b6e75e164f42e127cea1a)
- [`K_SYSCALL_MEMORY_ARRAY_READ()`](../../doxygen/html/group__syscall__apis.md#ga48a8ccdd4ff43b6fb3caa77956466dd1)
- [`K_SYSCALL_MEMORY_ARRAY_WRITE()`](../../doxygen/html/group__syscall__apis.md#ga6a1465208770d52a5c06de72ffda4421)
- [`K_SYSCALL_VERIFY_MSG()`](../../doxygen/html/group__syscall__apis.md#gac1a9c494aa091d9e67e2bf4fb1113f53)
- [`K_SYSCALL_VERIFY`](../../doxygen/html/group__syscall__apis.md#ga2b79503cd448a698e8a4ccb46a012b48)

Functions for invoking system calls are defined in
[include/zephyr/syscall.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/include/zephyr/syscall.h):
