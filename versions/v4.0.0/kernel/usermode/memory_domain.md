---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/kernel/usermode/memory_domain.html
...
> - [`k_pipe_alloc_init()`](../../doxygen/html/group__pipe__apis.md#ga32a902a5d12ca54b17c2b58783214613) sets up a k\_pipe object with its
...
>   k\_pipe in supervisor mode with [`k_pipe_init()`](../../doxygen/html/group__pipe__apis.md#gae9e807fb63bb7186b87015664f2c762d).
...
![Automatic Memory Domain build flow](https://docs.zephyrproject.org/4.0.0/_images/auto_mem_domain.png)
