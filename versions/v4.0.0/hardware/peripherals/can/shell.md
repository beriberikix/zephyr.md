---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/hardware/peripherals/can/shell.html
original_path: hardware/peripherals/can/shell.html
---
...
The CAN shell provides a `can` command with a set of subcommands for the [shell](../../../services/shell/index.md#shell-api)
module. It allows for testing and exploring the [CAN Controller](controller.md#can-api) driver API through an interactive
...
In order to enable the CAN shell, the following [Kconfig](../../../build/kconfig/index.md#kconfig) options must be enabled:

- [`CONFIG_SHELL`](../../../kconfig.md#CONFIG_SHELL "CONFIG_SHELL")
- [`CONFIG_CAN`](../../../kconfig.md#CONFIG_CAN "CONFIG_CAN")
- [`CONFIG_CAN_SHELL`](../../../kconfig.md#CONFIG_CAN_SHELL "CONFIG_CAN_SHELL")

The following [Kconfig](../../../build/kconfig/index.md#kconfig) options enable additional subcommands and features of the
`can` command:

- [`CONFIG_CAN_FD_MODE`](../../../kconfig.md#CONFIG_CAN_FD_MODE "CONFIG_CAN_FD_MODE") enables CAN FD specific subcommands (e.g. for setting the
  timing for the CAN FD data phase).
- [`CONFIG_CAN_RX_TIMESTAMP`](../../../kconfig.md#CONFIG_CAN_RX_TIMESTAMP "CONFIG_CAN_RX_TIMESTAMP") enables printing of timestamps for received CAN frames.
- [`CONFIG_CAN_STATS`](../../../kconfig.md#CONFIG_CAN_STATS "CONFIG_CAN_STATS") enables printing of various statistics for the CAN controller
  in the `can show` subcommand. This depends on [`CONFIG_STATS`](../../../kconfig.md#CONFIG_STATS "CONFIG_STATS") being enabled as
  well.
- [`CONFIG_CAN_MANUAL_RECOVERY_MODE`](../../../kconfig.md#CONFIG_CAN_MANUAL_RECOVERY_MODE "CONFIG_CAN_MANUAL_RECOVERY_MODE") enables the `can recover` subcommand.

For example, building the [Hello World](../../../samples/hello_world/README.md#hello_world "Print "Hello World" to the console.") sample for the [FRDM-K64F](../../../boards/nxp/frdm_k64f/doc/index.md#frdm_k64f) with the CAN shell and
...
list` shell command when [`CONFIG_DEVICE_SHELL`](../../../kconfig.md#CONFIG_DEVICE_SHELL "CONFIG_DEVICE_SHELL") is enabled. The examples below
...
The statistics are only printed if [`CONFIG_CAN_STATS`](../../../kconfig.md#CONFIG_CAN_STATS "CONFIG_CAN_STATS") is enabled.
...
`sample-point-data` [Devicetree](../../../build/dts/index.md#devicetree) properties.
...
If [`CONFIG_CAN_FD_MODE`](../../../kconfig.md#CONFIG_CAN_FD_MODE "CONFIG_CAN_FD_MODE") is enabled, the data phase bitrate can be configured using
...
If [`CONFIG_CAN_RX_TIMESTAMP`](../../../kconfig.md#CONFIG_CAN_RX_TIMESTAMP "CONFIG_CAN_RX_TIMESTAMP") is enabled, each line will be prepended with a
...
The `recover` subcommand is only available if [`CONFIG_CAN_MANUAL_RECOVERY_MODE`](../../../kconfig.md#CONFIG_CAN_MANUAL_RECOVERY_MODE "CONFIG_CAN_MANUAL_RECOVERY_MODE")
is enabled.
