---
version: v4.0.0
source_url: https://docs.zephyrproject.org/4.0.0/hardware/pinctrl/index.html
...
![../../_images/hw-cent-control.svg](https://docs.zephyrproject.org/4.0.0/_images/hw-cent-control.svg)
...
![../../_images/hw-dist-control.svg](https://docs.zephyrproject.org/4.0.0/_images/hw-dist-control.svg)
...
| --- | --- | --- |
| `default` | [`PINCTRL_STATE_DEFAULT`](../../doxygen/html/group__pinctrl__interface.md#ga9bc564353cb9b1a7238c9fe8796023e6) | State of the pins when the device is in operational state |
| `sleep` | [`PINCTRL_STATE_SLEEP`](../../doxygen/html/group__pinctrl__interface.md#ga2ea5ac271930e0e2e9f77952b2dbea1b) | State of the pins when the device is in low power or sleep modes |
...
[`PINCTRL_STATE_PRIV_START`](../../doxygen/html/group__pinctrl__interface.md#ga25989d7b48b2d7aa4f8ca6a30d9c9077)
...
[`pinctrl_dev_config`](../../doxygen/html/structpinctrl__dev__config.md) will be stored in RAM instead of ROM (not states
or pin configurations, though). The user can then use
[`pinctrl_update_states()`](../../doxygen/html/group__pinctrl__interface__dynamic.md#ga647115208cbed7534a98c56d93a517b8) to update the states stored in
[`pinctrl_dev_config`](../../doxygen/html/structpinctrl__dev__config.md) with a new set. This effectively means that the
...
[`pinctrl_configure_pins()`](../../doxygen/html/group__pinctrl__interface.md#ga3397507e30eb10e814b793615f80455b). This function receives an array of pin
...
[`PINCTRL_DT_DEFINE`](../../doxygen/html/group__pinctrl__interface.md#gace422fcd4b28e6e6e6fdbbc64b99468f) or [`PINCTRL_DT_INST_DEFINE`](../../doxygen/html/group__pinctrl__interface.md#ga8e984a57fd3c7a04cc921131ce79ac28) macros
should be used for this purpose. Second, a reference to
the device instance [`pinctrl_dev_config`](../../doxygen/html/structpinctrl__dev__config.md) needs to be stored, since it
is required to later use the API. This can be achieved using the
[`PINCTRL_DT_DEV_CONFIG_GET`](../../doxygen/html/group__pinctrl__interface.md#ga502c3b6faec140188dd5d614f4777918) and
[`PINCTRL_DT_INST_DEV_CONFIG_GET`](../../doxygen/html/group__pinctrl__interface.md#ga32748ffc5be4710707c7f1d9380cf93c) macros.
...
The way an instance of [`pinctrl_dev_config`](../../doxygen/html/structpinctrl__dev__config.md) is named for a
...
using [`pinctrl_apply_state()`](../../doxygen/html/group__pinctrl__interface.md#ga16a9391222345d00dbc5c39c45f429f9). It is also possible to use the lower level
function [`pinctrl_apply_state_direct()`](../../doxygen/html/group__pinctrl__interface.md#ga3549075e60ccdb743b269d590600d41b) to skip state lookup if it is
cached in advance (e.g. at init time). Since state lookup time is expected to be
fast, it is recommended to use [`pinctrl_apply_state()`](../../doxygen/html/group__pinctrl__interface.md#ga16a9391222345d00dbc5c39c45f429f9).
...
- [Master Clock Output (MCO)](../../samples/boards/st/mco/README.md#stm32_mco "Output an internal clock for external use by the application.")Output an internal clock for external use by the application.
