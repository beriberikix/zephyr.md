---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/ubx_bmd345eval_nrf52840/doc/index.html
original_path: boards/arm/ubx_bmd345eval_nrf52840/doc/index.html
---
...
![BMD 345 EVAL](https://docs.zephyrproject.org/3.6.0/_images/bmd-345-eval_features.jpg)

BMD-345-EVAL (Credit: ublox AG)

More information about the BMD-345-EVAL and BMD-345 module can be
found at the [u-blox website](https://www.u-blox.com/en/product/bmd-34-series-open-cpu) [[1]](#id2).
...
| --- | --- | --- | --- | --- | --- |
| P1.05 | TX\_EN | Low | Low | High | Low |
| P1.06 | RX\_EN | Low | Low | Low | High |
| P1.04 | MODE | Low | High | Low | Low |
| P1.02 | A\_SEL | Low | Low | Low | Low |
...
See the [u-blox website](https://www.u-blox.com/en/product/bmd-34-series-open-cpu) [[1]](#id2) for a complete list of BMD-345-EVAL
hardware features.
...
![BMD-345-EVAL pin-out](https://docs.zephyrproject.org/3.6.0/_images/bmd-345-eval_pin_out.jpg)
...
Replace `<tty_device>` with the port where the BMD-345-EVAL
...
west build -b ubx_bmd345eval_nrf52840 samples/hello_world
west flash
```
...
in
[boards/arm/ubx\_bmd340eval\_nrf52840/ubx\_bmd345eval\_nrf52840.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/ubx_bmd340eval_nrf52840/ubx_bmd345eval_nrf52840.dts).
...
open the data sheet for the BMD-345 at the [u-blox website](https://www.u-blox.com/en/product/bmd-34-series-open-cpu) [[1]](#id2), Section 2
