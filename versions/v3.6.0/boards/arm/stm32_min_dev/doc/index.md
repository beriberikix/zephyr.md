---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/stm32_min_dev/doc/index.html
original_path: boards/arm/stm32_min_dev/doc/index.html
---
...
```shell
# From the root of the zephyr repository
west build -b stm32_min_dev_blue samples/hello_world
west debug
```
