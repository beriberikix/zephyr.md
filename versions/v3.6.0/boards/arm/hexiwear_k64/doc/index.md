---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/hexiwear_k64/doc/index.html
original_path: boards/arm/hexiwear_k64/doc/index.html
---
...
![Hexiwear](https://docs.zephyrproject.org/3.6.0/_images/hexiwear_k64.jpg)
...
The hexiwear\_k64 board configuration supports the following hardware features:
...
west build -b hexiwear_k64 samples/hello_world -- -DBOARD_FLASH_RUNNER=pyocd -DBOARD_DEBUG_RUNNER=pyocd
```
...
```shell
# From the root of the zephyr repository
west build -b hexiwear_k64 samples/bluetooth/peripheral_hr
west flash
```
