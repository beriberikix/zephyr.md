---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/actinius_icarus_som_dk/doc/index.html
original_path: boards/arm/actinius_icarus_som_dk/doc/index.html
---
...
[![Icarus SoM DK](https://docs.zephyrproject.org/3.6.0/_images/icarus-som-dk.jpg)](https://docs.zephyrproject.org/3.6.0/_images/icarus-som-dk.jpg)

Icarus SoM Development Kit (nRF9160)

The Icarus SoM DK is a single board development kit for
evaluation and development on the Icarus SoM ([Icarus SoM Docs](https://docs.actinius.com/icarus-som/introduction) [[4]](#id12)).
...
[![Icarus SoM DK Block Diagram](https://docs.zephyrproject.org/3.6.0/_images/icarus-som-dk-block-diagram.jpg)](https://docs.zephyrproject.org/3.6.0/_images/icarus-som-dk-block-diagram.jpg)

Icarus SoM DK Block Diagram

## Hardware

The detailed information about the on-board hardware can be found at the [Icarus SoM Product Website](https://www.actinius.com/icarus-som) [[2]](#id6)
and the [Icarus SoM DK Product Website](https://www.actinius.com/icarus-som-dk) [[3]](#id9).
...
More information can be found in the [Icarus SoM Product Website](https://www.actinius.com/icarus-som) [[2]](#id6),
the [Icarus SoM DK Product Website](https://www.actinius.com/icarus-som-dk) [[3]](#id9) or the [Actinius Documentation Portal](https://docs.actinius.com) [[5]](#id14).
