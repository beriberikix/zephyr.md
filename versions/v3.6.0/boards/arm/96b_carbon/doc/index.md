---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/96b_carbon/doc/index.html
original_path: boards/arm/96b_carbon/doc/index.html
---
...
applications, see [Providing Bluetooth to 96b\_carbon](../../96b_carbon_nrf51/doc/index.md#b-carbon-nrf51-bluetooth).
...
![96Boards Carbon](https://docs.zephyrproject.org/3.6.0/_images/96b_carbon.jpg)
...
The Zephyr 96b\_carbon board configuration supports the following hardware
features:
...
west build -b 96b_carbon samples/hello_world
west flash
```
...
1. Flash the nRF51 with the hci\_spi sample application as described in
   [Providing Bluetooth to 96b\_carbon](../../96b_carbon_nrf51/doc/index.md#b-carbon-nrf51-bluetooth).
...
3. Build and flash the `samples/bluetooth/ipsp` application for
   ...
   ```shell
   # From the root of the zephyr repository
   west build -b 96b_carbon samples/bluetooth/ipsp
   west flash
   ```
4. Refer to the instructions in [Bluetooth: IPSP Sample](../../../../samples/bluetooth/ipsp/README.md#bluetooth-ipsp-sample) for how
...
The 96b\_carbon can be debugged by installing a 100 mil (0.1 inch) header
