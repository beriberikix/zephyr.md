---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/atsamr34_xpro/doc/index.html
original_path: boards/arm/atsamr34_xpro/doc/index.html
---
...
![ATSAMR34-XPRO](https://docs.zephyrproject.org/3.6.0/_images/atsamr34-xpro.jpg)
...
The atsamr34\_xpro board configuration supports the following hardware
features:
...
![ATSAMR34-XPRO-pinout](https://docs.zephyrproject.org/3.6.0/_images/atsamr34-xpro-pinout.jpg)
...
1. Build the Zephyr kernel and the `hello_world` sample application:
   ...
   ```shell
   west build -b atsamr34_xpro samples/hello_world
   ```
...
4. To flash an image:
   ...
   You should see “Hello World! atsamr34\_xpro” in your terminal.
