---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/ubx_evkninab3_nrf52840/doc/index.html
original_path: boards/arm/ubx_evkninab3_nrf52840/doc/index.html
---
...
can be found at the [u-blox website](https://www.u-blox.com/en/product/nina-b3-series-open-cpu) [[1]](#id2).
...
The ubx\_evkninab3\_nrf52840 board configuration supports the following
hardware features:
...
See the [u-blox website](https://www.u-blox.com/en/product/nina-b3-series-open-cpu) [[1]](#id2) for a complete list of EVK-NINA-B30x
hardware features.
...
Replace `<tty_device>` with the port where the EVK-NINA-B30x
...
west build -b ubx_evkninab3_nrf52840 samples/hello_world
west flash
```
...
[boards/arm/ubx\_evkninab3\_nrf52840/ubx\_ninab3\_nrf52840.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/ubx_evkninab3_nrf52840/ubx_ninab3_nrf52840.dts).
...
open the data sheet for the NINA-B3 at [u-blox website](https://www.u-blox.com/en/product/nina-b3-series-open-cpu) [[1]](#id2), Section 3 ‘Pin definition’.
...
[https://www.u-blox.com/en/product/nina-b3-series-open-cpu](https://www.u-blox.com/en/product/nina-b3-series-open-cpu)
