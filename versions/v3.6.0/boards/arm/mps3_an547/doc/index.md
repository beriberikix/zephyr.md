---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/mps3_an547/doc/index.html
original_path: boards/arm/mps3_an547/doc/index.html
---
...
The mps3\_an547 board configuration is used by Zephyr applications that run
...
![ARM MPS3 AN547](https://docs.zephyrproject.org/3.6.0/_images/mps3_an547.jpg)
...
| BOARD | Description |
| --- | --- |
| mps3\_an547 | For building Secure (or Secure-only) firmware |
| mps3\_an547\_ns | For building Non-Secure firmware |
...
The mps3\_an547 board configuration supports the following hardware features:
...
For more details refer to [MPS3 AN547 Technical Reference Manual (TRM)](https://developer.arm.com/-/media/Arm%20Developer%20Community/PDF/DAI0547B_SSE300_PLUS_U55_FPGA_for_mps3.pdf).
...
west build -b mps3_an547 samples/hello_world
```
