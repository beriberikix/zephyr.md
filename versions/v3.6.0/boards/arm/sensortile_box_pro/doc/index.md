---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/sensortile_box_pro/doc/index.html
original_path: boards/arm/sensortile_box_pro/doc/index.html
---
...
![SensorTile.box PRO](https://docs.zephyrproject.org/3.6.0/_images/sensortile_box_pro.jpg)

More information about the board can be found at the [SensorTile.box PRO website](https://www.st.com/en/evaluation-tools/steval-mkboxpro.html) [[1]](#id4).
...
- [STM32U585 on www.st.com](https://www.st.com/en/microcontrollers-microprocessors/stm32u575-585.html) [[2]](#id6)
- [STM32U585 reference manual](https://www.st.com/resource/en/reference_manual/rm0456-stm32u575585-armbased-32bit-mcus-stmicroelectronics.pdf) [[3]](#id8)

### Motion and environmental sensors

> - **LSM6DSV16X** 6-axis inertial measurement unit
>   ([lsm6dsv16x datasheet](https://www.st.com/en/mems-and-sensors/lsm6dsv16x.html) [[4]](#id10))
> - **LIS2MDL** 3-axis magnetometer
>   ([lis2mdl datasheet](https://www.st.com/en/mems-and-sensors/lis2mdl.html) [[5]](#id12))
> - **LPS22DF** Altimeter / pressure sensor
>   ([lps22df datasheet](https://www.st.com/en/mems-and-sensors/lps22df.html) [[6]](#id14))
> - **LIS2DU12** 3-axis accelerometer
>   ([lis2du12 datasheet](https://www.st.com/en/mems-and-sensors/lis2du12.html) [[7]](#id16))
> - **HTS221** Humidity sensor
>   ([hts221 datasheet](https://www.st.com/en/mems-and-sensors/hts221.html) [[8]](#id18))
> - **STTS22H** Digital temperature sensor
>   ([stts22hh datasheet](https://www.st.com/en/mems-and-sensors/stts22h.html) [[9]](#id20))
> - **MP23db01HP** Microphone / audio sensor
>   ([mp23db01hp datasheet](https://www.st.com/en/mems-and-sensors/mp23db01hp.html) [[10]](#id22))
...
- through UART4 which is available on SWD connector (JP2). In this case a JTAG adapter
  ...
  - switch the console lines from cdc\_acm to uart4
    (`boards/arm/sensortile_box_pro/sensortile_box_pro.dts`)
  - comment out the USB configuration macros
    (`boards/arm/sensortile_box_pro/sensortile_box_pro_defconfig`)

boards/arm/sensortile\_box\_pro/sensortile\_box\_pro.dts
...
boards/arm/sensortile\_box\_pro/sensortile\_box\_pro\_defconfig
...
1. Using DFU software tools
   ...
   the application note [AN2606](http://www.st.com/content/ccc/resource/technical/document/application_note/b9/9b/16/3a/12/1e/40/0c/CD00167594.pdf/files/CD00167594.pdf/jcr:content/translations/en.CD00167594.pdf) [[11]](#id24) (STM32U585xx section).
...
at the [DFU-UTIL website](http://dfu-util.sourceforge.net/) [[12]](#id26)
...
([ST SensorTile.box Pro on-board sensors test](../../../../samples/boards/sensortile_box_pro/sensors-on-board/README.md#sensortile-box-pro-sample-sensors)) that reads sensors data and outputs
...
[https://www.st.com/en/mems-and-sensors/hts221.html](https://www.st.com/en/mems-and-sensors/hts221.html)
