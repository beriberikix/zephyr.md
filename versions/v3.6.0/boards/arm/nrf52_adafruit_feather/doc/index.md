---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/nrf52_adafruit_feather/doc/index.html
original_path: boards/arm/nrf52_adafruit_feather/doc/index.html
---
...
[Adafruit Feather nRF52 Bluefruit Learning Guide](https://learn.adafruit.com/bluefruit-nrf52-feather-learning-guide/introduction) [[1]](#id3). The [Nordic Semiconductor Infocenter](https://infocenter.nordicsemi.com) [[4]](#id10)
...
The [Adafruit Feather nRF52 Bluefruit Learning Guide](https://learn.adafruit.com/bluefruit-nrf52-feather-learning-guide/introduction) [[1]](#id3) has detailed
information about the board including [pinouts](https://cdn-learn.adafruit.com/assets/assets/000/046/210/original/Feather_NRF52_Pinout_v1.2.pdf?1504807075) [[3]](#id8) and the [schematic](https://learn.adafruit.com/assets/39913) [[2]](#id6).
...
- [Adafruit Feather nRF52 Pro with myNewt Bootloader](https://www.adafruit.com/product/3574) [[6]](#id14)
  :   This board version is the recommended one to use. It has the SWD header
      ...
      default.
- [Adafruit Feather nRF52 Bluefruit LE](https://www.adafruit.com/product/3406) [[5]](#id12)
  :   This board is identical to the board above, but the SWD header is not
      ...
      with this version a 2\*5pin 0.5” SWD header (e.g. [Adafruit SWD connector](https://www.adafruit.com/product/752) [[7]](#id16))
...
[boards/arm/nrf52\_adafruit\_feather/board.h](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/nrf52_adafruit_feather/board.h).
