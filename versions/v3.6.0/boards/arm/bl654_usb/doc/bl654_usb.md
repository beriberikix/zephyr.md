---
version: v3.6.0
source_url: https://docs.zephyrproject.org/3.6.0/boards/arm/bl654_usb/doc/bl654_usb.html
...
![BL654 USB adapter](https://docs.zephyrproject.org/3.6.0/_images/bl654_usb.jpg)

BL654 USB Adapter

![451-00004 Box Contents](https://docs.zephyrproject.org/3.6.0/_images/bl654_usb_pcb.jpg)
...
1. With the adapter plugged in, reset the board into the bootloader by pressing
   ...
   ![Location of RESET button](https://docs.zephyrproject.org/3.6.0/_images/bl654_usb_reset.jpg)
