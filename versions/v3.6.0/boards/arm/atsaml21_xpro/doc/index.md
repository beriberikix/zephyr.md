---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/atsaml21_xpro/doc/index.html
original_path: boards/arm/atsaml21_xpro/doc/index.html
---
...
The atsaml21\_xpro board configuration supports the following hardware
features:
...
1. Build the Zephyr kernel and the `hello_world` sample application:
   ...
   ```shell
   west build -b atsaml21_xpro samples/hello_world
   ```
...
4. To flash an image:
   ...
   You should see “Hello World! atsaml21\_xpro” in your terminal.
