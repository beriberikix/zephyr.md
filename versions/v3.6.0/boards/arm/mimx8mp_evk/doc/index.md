---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/mimx8mp_evk/doc/index.html
original_path: boards/arm/mimx8mp_evk/doc/index.html
---
...
![MIMX8MP EVK](https://docs.zephyrproject.org/3.6.0/_images/I.MX8MPLUS-PLUS-EVK-TOP.jpg)
...
The Zephyr mimx8mp\_evk board configuration supports the following hardware
features:
...
[boards/arm/mimx8mp\_evk/mimx8mp\_evk\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/mimx8mp_evk/mimx8mp_evk_defconfig).
...
| --- | --- | --- |
| UART4 RXD | UART4\_TXD | UART Console |
| UART4 TXD | UART4\_RXD | UART Console |
...
The i.MX8M Plus SoC has four UARTs. UART\_4 is configured for the console and
...
configuration is done based on board name (mimx8mp\_evk\_itcm for ITCM and
mimx8mp\_evk\_ddr for DDR).
