---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/bl654_sensor_board/doc/bl654_sensor_board.html
original_path: boards/arm/bl654_sensor_board/doc/bl654_sensor_board.html
---
...
![BL654 Sensor Board front and back](https://docs.zephyrproject.org/3.6.0/_images/bl654_sensor_board.jpg)

BL654 Sensor Board front and back

![BL654 Sensor Board connected to USB-SWD Programmer (UART and SWD access)](https://docs.zephyrproject.org/3.6.0/_images/bl654_sensor_board_usb_swd_programmer.jpg)

BL654 Sensor Board connected to USB-SWD Programmer (UART and SWD access)

More information about the BL654 module can be found on the [BL654 website](https://connectivity.lairdtech.com/wireless-modules/bluetooth-modules/bluetooth-5-modules/bl654-series) [[2]](#id5),
more information about the USB-SWD Programmer can be found on the
[USB-SWD Programmer website](https://www.lairdconnect.com/usb-swd-programmer) [[4]](#id10).
...
See the [BL654 website](https://connectivity.lairdtech.com/wireless-modules/bluetooth-modules/bluetooth-5-modules/bl654-series) [[2]](#id5) for a complete list of BL654 module hardware features.
...
[pyOCD website](https://github.com/pyocd/pyOCD) [[3]](#id8) to find details about the software and how to install it.
...
[boards/arm/bl654\_sensor\_board/bl654\_sensor\_board.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/bl654_sensor_board/bl654_sensor_board.dts).
...
[https://www.lairdconnect.com/usb-swd-programmer](https://www.lairdconnect.com/usb-swd-programmer)
