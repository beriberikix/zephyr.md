---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/v2m_musca_s1/doc/index.html
...
![ARM V2M Musca-S1](https://docs.zephyrproject.org/3.6.0/_images/v2m_musca_s1.jpg)
...
To upload the [Hello World](../../../../samples/hello_world/README.md#hello-world) application to the board, no extra steps are
...
![The Musca-S1 with the USB connected and powered-on](https://docs.zephyrproject.org/3.6.0/_images/v2m_musca_s1_powered.jpg)
