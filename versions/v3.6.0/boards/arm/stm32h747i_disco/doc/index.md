---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/stm32h747i_disco/doc/index.html
original_path: boards/arm/stm32h747i_disco/doc/index.html
---
...
```shell
# From the root of the zephyr repository
west build -b stm32h747i_disco_m7 samples/hello_world
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b stm32h747i_disco_m4 samples/basic/blinky
west flash
```
