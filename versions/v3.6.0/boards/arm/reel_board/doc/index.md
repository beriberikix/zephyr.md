---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/reel_board/doc/index.html
original_path: boards/arm/reel_board/doc/index.html
---
...
[reel board](https://www.phytec.de/reelboard/) [[1]](#id10) is a evaluation board based on the Nordic Semiconductor
...
Cortex®-M4F SoC with an integrated 2.4 GHz transceiver supporting Bluetooth® Low Energy and IEEE® 802.15.4.

The schematic can be found on the [reel board website](https://www.phytec.de/reelboard/) [[1]](#id10).
...
![reel board front](https://docs.zephyrproject.org/3.6.0/_images/reel_board.jpg)

reel board front (Credit: PHYTEC)

![reel board back](https://docs.zephyrproject.org/3.6.0/_images/reel_board_descr_back.jpg)
...
| --- | --- | --- | --- |
| Good Display GDEH0213B1 | HINK-E0213 | SSD1673 / ssd16xx | reel\_board |
| Good Display GDEH0213B72 | HINK-E0213A22 | SSD1675A / ssd16xx | reel\_board\_v2 |
...
[boards/arm/reel\_board/board.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/reel_board/board.c)

### Supported Features

The reel\_board board configuration supports the following
hardware features:
...
| P0.06 | UART0\_TX | UART Console over USB |
| P0.07 | Button | user button (S5) |
| P0.08 | UART0\_RX | UART Console over USB |
...
| P0.17 | EPD SPI3\_CS | SPI |
| P0.18 | CPU Reset | Reset (S4) |
| P0.19 | EPD SPI3\_CLK | SPI |
| P0.20 | EPD SPI3\_MOSI | SPI |
| P0.21 | SPI3\_MISO | SPI (not connected) |
...
![reel board Jumper and Testpoints](https://docs.zephyrproject.org/3.6.0/_images/reel_board_tp.jpg)
...
| J16 | closed solder jumper | testpoint EPD SPI\_CS |
| J17 | closed solder jumper | testpoint EPD SPI\_CLK |
| J18 | closed solder jumper | testpoint EPD SPI\_MOSI |
...
| TP12 | testpoint | testpoint nRF52840 supply voltage VDD\_nRF |
...
![reel board Debug Adapter](https://docs.zephyrproject.org/3.6.0/_images/reel_board_debug.jpg)

reel board Debug Adapter overview (Credit: PHYTEC)

#### Debug Adapter Firmware

DAPLink firmware for the adapter can be found at [DAPLink reel board Firmware](https://github.com/PHYTEC-Messtechnik-GmbH/DAPLink/tree/reel-board) [[2]](#id13).
...
![reel board Expansion Connector](https://docs.zephyrproject.org/3.6.0/_images/reel_board_excon.jpg)
...
![reel board and link board BASE](https://docs.zephyrproject.org/3.6.0/_images/rb_lb_shield.jpg)
...
![link board BASE](https://docs.zephyrproject.org/3.6.0/_images/link_board_base.jpg)
...
Please use reel\_board\_v2 to build a application for the board equipped with
the GDEH0213B72, see [Display](#reel-board-display).
...
[https://github.com/PHYTEC-Messtechnik-GmbH/DAPLink/tree/reel-board](https://github.com/PHYTEC-Messtechnik-GmbH/DAPLink/tree/reel-board)
