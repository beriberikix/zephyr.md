---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/nrf9131ek_nrf9131/doc/index.html
original_path: boards/arm/nrf9131ek_nrf9131/doc/index.html
---
...
The nrf9131ek\_nrf9131 board configuration provides support for the Nordic Semiconductor nRF9131 ARM
...
![nRF9131 EK](https://docs.zephyrproject.org/3.6.0/_images/nrf9131ek_nrf9131.webp)

nRF9131 EK (Credit: Nordic Semiconductor)

The [Nordic Semiconductor Infocenter](https://infocenter.nordicsemi.com) [[2]](#id4)
...
The nrf9131ek\_nrf9131 board configuration supports the following
hardware features:
...
nrf9131ek\_nrf9131 supports the Armv8m Security Extension, and by default boots
in the Secure state.
...
and [Run an Application](../../../../develop/application/index.md#application-run)), using `-DBOARD=nrf9131ek_nrf9131`.
...
west build -b nrf9131ek_nrf9131 samples/hello_world
west flash
```
...
[boards/arm/nrf9131ek\_nrf9131/nrf9131ek\_nrf9131\_common.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/nrf9131ek_nrf9131/nrf9131ek_nrf9131_common.dtsi).
