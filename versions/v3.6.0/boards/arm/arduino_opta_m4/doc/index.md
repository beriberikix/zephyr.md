---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/arduino_opta_m4/doc/index.html
original_path: boards/arm/arduino_opta_m4/doc/index.html
---
...
![ARDUINO-OPTA](https://docs.zephyrproject.org/3.6.0/_images/arduino_opta.jpeg)
...
The current Zephyr arduino\_opta\_m4 board configuration supports the following hardware features:
...
> - CPU2 (Cortex-M4) boot address is set to 0x08180000 (OB: BOOT\_CM4\_ADD0)
...
west build -b arduino_opta_m4 samples/basic/blinky
west flash
```
