---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/mps2_an521/doc/index.html
original_path: boards/arm/mps2_an521/doc/index.html
---
...
The mps2\_an521 board configuration is used by Zephyr applications that run
...
![ARM MPS2+ AN521](https://docs.zephyrproject.org/3.6.0/_images/mps2_an521.jpg)
...
| BOARD | Description |
| --- | --- |
| mps2\_an521 | For building Secure (or Secure-only) firmware on CPU0 |
| mps2\_an521\_ns | For building Non-Secure firmware for CPU0 |
| mps2\_an521\_remote | For building firmware on CPU1 |
...
| --- | --- | --- | --- | --- |
| mps2\_an521 | 0 | 4MB (0) | 4MB (0) | S |
| mps2\_an521\_ns | 0 | 512KB (1MB) | 512KB (1MB) | NS |
| mps2\_an521\_remote | 1 | 468KB (3628KB) | 512KB (1.5MB) | NS |
...
The mps2\_an521 board provides the following user push buttons:
...
The mps2\_an521 board configuration supports the following hardware features:
...
Applications built for the mps2\_an521 board by default
...
and [Run an Application](../../../../develop/application/index.md#application-run)), using `-DBOARD=mps2_an521` for
...
Build the Zephyr app in the usual way (see [Building an Application](../../../../develop/application/index.md#build-an-application)
and [Run an Application](../../../../develop/application/index.md#application-run)), using `-DBOARD=mps2_an521_remote` for
