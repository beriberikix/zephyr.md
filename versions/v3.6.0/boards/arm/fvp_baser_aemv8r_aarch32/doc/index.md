---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/fvp_baser_aemv8r_aarch32/doc/index.html
original_path: boards/arm/fvp_baser_aemv8r_aarch32/doc/index.html
---
...
This board configuration uses Armv8-R AEM FVP [[1]](#id6) to emulate a generic
Armv8-R [[2]](#id7) 32-bit hardware platform.
...
page [[3]](#id8) for more details about FVP.

To Run the Fixed Virtual Platform simulation tool you must download “Armv8-R AEM
FVP” from Arm developer [[1]](#id6) (This might require the user to register) and
...
to the official Armv8-R AEM FVP memory map document [[4]](#id9).
...
Arm Architecture Reference Manual Supplement - Armv8, for Armv8-R AArch32 architecture profile
