---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/xiao_ble/doc/index.html
original_path: boards/arm/xiao_ble/doc/index.html
---
...
![XIAO BLE](https://docs.zephyrproject.org/3.6.0/_images/xiao_ble.jpg)
...
The xiao\_ble board configuration supports the following hardware features:
...
The [XIAO BLE wiki](https://wiki.seeedstudio.com/XIAO_BLE/) [[1]](#id1) has detailed information about the board including
[pinouts](https://wiki.seeedstudio.com/XIAO_BLE/#hardware-overview) [[2]](#id3) and the [schematic](https://wiki.seeedstudio.com/XIAO_BLE/#resources) [[3]](#id5).
...
The XIAO BLE ships with the [Adafruit nRF52 Bootloader](https://github.com/adafruit/Adafruit_nRF52_Bootloader) [[5]](#id9) which supports flashing
using [UF2](https://github.com/microsoft/uf2) [[6]](#id11). Doing so allows easy flashing of new images, but does not support
...
applications you need to use [Seeeduino XIAO Expansion Board](https://wiki.seeedstudio.com/Seeeduino-XIAO-Expansion-Board/) [[4]](#id7) or solder an SWD
...
```shell
# From the root of the zephyr repository
west build -b xiao_ble_sense samples/hello_world -- -DCONFIG_BOOT_DELAY=5000
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b xiao_ble_sense samples/basic/blinky
west flash
```

You can build and flash the examples to make sure Zephyr is running correctly on
your board. The LED definitions can be found in
[boards/arm/xiao\_ble/xiao\_ble\_common.dtsi](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/xiao_ble/xiao_ble_common.dtsi).
...
```shell
# From the root of the zephyr repository
west build -b xiao_ble_sense samples/subsys/shell/shell_module
west flash
```
