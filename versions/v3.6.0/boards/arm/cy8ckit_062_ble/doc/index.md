---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/cy8ckit_062_ble/doc/index.html
original_path: boards/arm/cy8ckit_062_ble/doc/index.html
---
...
![CY8CKIT_062_BLE](https://docs.zephyrproject.org/3.6.0/_images/cy8ckit-062-ble.jpg)
...
[boards/arm/cy8ckit\_062\_ble/cy8ckit\_062\_ble\_m0\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/cy8ckit_062_ble/cy8ckit_062_ble_m0_defconfig) for
Cortex-M0+ and on the Kconfig
[boards/arm/cy8ckit\_062\_ble/cy8ckit\_062\_ble\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/cy8ckit_062_ble/cy8ckit_062_ble_m4_defconfig) for
Cortex-M4
...
1. Build the Zephyr kernel and the [Hello World](../../../../samples/hello_world/README.md#hello-world) sample application:
   ...
   ```shell
   west build -b cy8ckit_062_ble_m0 samples/hello_world
   ```
...
3. To flash an image:
   ...
   You should see “Hello World! cy8ckit\_062\_ble\_m0” in your terminal.
...
1. Build the Zephyr kernel and the [Button](../../../../samples/basic/button/README.md#button "Handle GPIO inputs with interrupts.") sample application:
   ...
   ```shell
   west build -b cy8ckit_062_ble_m4 samples/basic/button
   ```
...
4. Configure Cortex-M0+ to enable Cortex-M4:
   ...
   ```shell
   west build -b cy8ckit_062_ble_m0 samples/hello_world -- -DCONFIG_SOC_PSOC6_M0_ENABLES_M4=y
   west flash
   ```

   Now you can press button SW-2 and see LED-9 blink at same time you have the
   “Hello World! cy8ckit\_062\_ble\_m0” in the your terminal.
...
1. Build the Zephyr kernel and the [Hello World](../../../../samples/hello_world/README.md#hello-world) sample application for
   ...
   ```shell
   west build -b cy8ckit_062_ble_m0@1.0.0 samples/hello_world
   ```
