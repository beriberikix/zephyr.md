---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/arty/doc/index.html
original_path: boards/arm/arty/doc/index.html
---
...
The [Digilent Arty](https://store.digilentinc.com/arty) is a line of FPGA-based development boards aimed for makers
...
DesignStart FPGA](https://www.arm.com/resources/designstart/designstart-fpga) Xilinx edition reference designs from ARM. Zephyr supports
...
- [Technical Resources for DesignStart FPGA](https://developer.arm.com/ip-products/designstart/fpga)
- [Technical Resources for DesignStart FPGA on Xilinx](https://developer.arm.com/ip-products/designstart/fpga/fpga-xilinx)
- [ARM DesignStart FPGA Xilinx FAQs](https://developer.arm.com/ip-products/designstart/fpga/fpga-xilinx-faqs)
...
`boards/arm/arty/arty_a7_arm_designstart_m1_defconfig`.
...
to use the dedicated [ARM V2C-DAPLink for DesignStart FPGA](../../../shields/v2c_daplink/doc/index.md#v2c-daplink-shield).
...
from [Technical Resources for DesignStart FPGA on Xilinx](https://developer.arm.com/ip-products/designstart/fpga/fpga-xilinx)).

Another option for configuring the FPGA with the reference design bitstream is
to use the [OpenOCD Debug Host Tools](../../../../develop/flash_debug/host-tools.md#openocd-debug-host-tools):
...
west build -b arty_a7_arm_designstart_m1 samples/hello_world
west flash
```
...
[`CONFIG_BUILD_OUTPUT_BIN`](../../../../kconfig.md#CONFIG_BUILD_OUTPUT_BIN "CONFIG_BUILD_OUTPUT_BIN") is enabled and the [SiFive elf2hex](https://github.com/sifive/elf2hex) package
is available, the build system will automatically generate a Verilog memory hex
dump `zephyr.mem` file suitable for initialising the block RAM using
