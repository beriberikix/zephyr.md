---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/rcar_h3ulcb/doc/rcar_h3ulcb.html
original_path: boards/arm/rcar_h3ulcb/doc/rcar_h3ulcb.html
---
...
![R-Car starter kit](https://docs.zephyrproject.org/3.6.0/_images/rcar_h3ulcb_starter_kit.jpg)
...
![R-Car starter kit features](https://docs.zephyrproject.org/3.6.0/_images/rcar_h3ulcb_features.jpg)
...
The Zephyr console output is assigned to SCIF1 (commonly used on Kingfisher daughter board) with settings 115200 8N1 without hardware flow control by default.
...
Applications for the `rcar_h3ulcb_cr7` board configuration can be built in the usual way (see [Building an Application](../../../../develop/application/index.md#build-an-application) for more details).
