---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/cc3235sf_launchxl/doc/index.html
original_path: boards/arm/cc3235sf_launchxl/doc/index.html
---
...
See the [TI CC3235 Product Page](http://www.ti.com/product/cc3235SF) for details.
...
[CC3235SF LaunchPad Dev Kit Hardware User’s Guide](http://www.ti.com/lit/pdf/swru539).
...
Complete details of the CC3235SF SoC can be found in the [CC3235 TRM](http://www.ti.com/lit/pdf/swru543).
...
the file [boards/arm/cc3235sf\_launchxl/pinmux.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/cc3235sf_launchxl/pinmux.c).
...
[boards/arm/cc3235sf\_launchxl/cc3235sf\_launchxl\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/cc3235sf_launchxl/cc3235sf_launchxl_defconfig).

## Programming and Debugging

TI officially supports development on the CC3235SF using the TI
[CC32xx SDK](http://www.ti.com/tool/download/SIMPLELINK-CC32xx-SDK/2.40.01.01) on Windows and Linux using TI tools: Code Composer
Studio for debugging and [UniFlash](http://processors.wiki.ti.com/index.php/Category:CCS_UniFlash) for flashing.

For Windows developers, see the [CC32xx Quick Start Guide](http://dev.ti.com/tirex/content/simplelink_cc32xx_sdk_2_40_01_01/docs/simplelink_mcu_sdk/Quick_Start_Guide.html) for
...
3. Update the service pack, and place the board in “Development Mode”.
   ...
   in the [CC32xx Quick Start Guide](http://dev.ti.com/tirex/content/simplelink_cc32xx_sdk_2_40_01_01/docs/simplelink_mcu_sdk/Quick_Start_Guide.html), except for steps 5 and 6 in
...
6. Install OpenOCD
   ...
   [boards/arm/cc3220sf\_launchxl/board.cmake](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/cc3220sf_launchxl/board.cmake) to point the build
...
7. Ensure CONFIG\_XIP=y (default) is set.
   ...
   [CC3235 TRM](http://www.ti.com/lit/pdf/swru543) for details on the secure flash boot process.
...
to enable Wi-Fi.
See [samples/net/wifi/boards/cc3235sf\_launchxl.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/wifi/boards/cc3235sf_launchxl.conf).
...
See [Wi-Fi shell](../../../../samples/net/wifi/README.md#wifi-shell "Test Wi-Fi functionality using the Wi-Fi shell module.")
