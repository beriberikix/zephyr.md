---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/inventek_eswifi/doc/index.html
...
![ISMART4343C-EVB](https://docs.zephyrproject.org/3.6.0/_images/ismart4343c-evb.jpg)
...
![ISMART4343C-EVB Wiring](https://docs.zephyrproject.org/3.6.0/_images/ismart4343c-evb-wiring.jpg)
...
| --- | --- | --- |
| ATMEL sam\_v71\_xult | Ethernet | 2 , 3 |
...
The reference sample for WIFI is [Wi-Fi shell](../../../../samples/net/wifi/README.md#wifi-shell "Test Wi-Fi functionality using the Wi-Fi shell module."). It allows you to use WIFI
