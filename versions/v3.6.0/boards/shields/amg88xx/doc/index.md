---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/amg88xx/doc/index.html
original_path: boards/shields/amg88xx/doc/index.html
---
...
[IR Thermophile Array Sensor - Grid-EYE](https://industry.panasonic.eu/products/components/sensors/ir-thermophile-array-sensor-grid-eye) [[1]](#id4).
...
> [![Panasonic Grid-EYE Evaluation Shield](https://docs.zephyrproject.org/3.6.0/_images/AMG88XX_panasonic_grid_eye_evaluation_shield.png)](https://docs.zephyrproject.org/3.6.0/_images/AMG88XX_panasonic_grid_eye_evaluation_shield.png)
...
> [![Adafruit AMG8833 8x8 Thermal Camera Sensor](https://docs.zephyrproject.org/3.6.0/_images/AMG8833_adafruit_ir_thermal_camera_sensor.png)](https://docs.zephyrproject.org/3.6.0/_images/AMG8833_adafruit_ir_thermal_camera_sensor.png)
...
> [![Panasonic Grid-EYE Evaluation Kit (deprecated)](https://docs.zephyrproject.org/3.6.0/_images/AMG88XX_panasonic_grid_eye_evaluation_kit.png)](https://docs.zephyrproject.org/3.6.0/_images/AMG88XX_panasonic_grid_eye_evaluation_kit.png)
...
evaluation boards ([Panasonic Wireless Connectivity Development Hub](https://pideu.panasonic.de/development-hub/) [[3]](#id9)).
...
For the [Adafruit AMG8833 8x8 Thermal Camera Sensor](https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/overview) [[4]](#id11) breakout board you can
use the `amg88xx_grid_eye_eval_shield` shield designation as well.

The wiring has to be done according to
[Adafruit AMG8833 8x8 Thermal Camera Sensor Pinouts](https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/pinouts) [[5]](#id14) and the pin assignment
...
[https://industry.panasonic.eu/products/components/sensors/ir-thermophile-array-sensor-grid-eye](https://industry.panasonic.eu/products/components/sensors/ir-thermophile-array-sensor-grid-eye)

[2]
([1](#id7),[2](#id8))

[https://industry.panasonic.eu/products/components/sensors/ir-thermophile-array-sensor-grid-eye/grid-eye-evaluation-kit](https://industry.panasonic.eu/products/components/sensors/ir-thermophile-array-sensor-grid-eye/grid-eye-evaluation-kit)
...
[https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/overview](https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/overview)

[[5](#id15)]

[https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/pinouts](https://learn.adafruit.com/adafruit-amg8833-8x8-thermal-camera-sensor/pinouts)
