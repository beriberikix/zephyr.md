---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/mikroe_wifi_bt_click/doc/index.html
original_path: boards/shields/mikroe_wifi_bt_click/doc/index.html
---
...
![MikroE WIFI BLE Click](https://docs.zephyrproject.org/3.6.0/_images/wifi_click.jpg)

### Pins Assignment of the Shield

| Shield Connector Pin | Function |
| --- | --- |
| RST# | Reset pin, in most of the boards it should be disconnected because its tied to GND |
...
This shield should be loaded with the [ESP32 AT Bin](https://docs.espressif.com/projects/esp-at/en/latest/esp32/AT_Binary_Lists/ESP32_AT_binaries.html) [[1]](#id1) software which is
...
the [ESP-Tool](https://github.com/espressif/esptool) [[2]](#id3), extract the folder, navigate inside the binaries location
...
west build -b lpcxpresso55s69_cpu0 samples/net/wifi -- -DSHIELD=mikroe_wifi_bt_click_mikrobus
west flash
```

And this example for the b\_u585i\_iot02a development kit, using the Arduino connector for the UART pins:

```shell
# From the root of the zephyr repository
west build -b b_u585i_iot02a samples/net/wifi -- -DSHIELD=mikroe_wifi_bt_click_arduino
west flash
```
...
[https://docs.espressif.com/projects/esp-at/en/latest/esp32/AT\_Binary\_Lists/ESP32\_AT\_binaries.html](https://docs.espressif.com/projects/esp-at/en/latest/esp32/AT_Binary_Lists/ESP32_AT_binaries.html)
