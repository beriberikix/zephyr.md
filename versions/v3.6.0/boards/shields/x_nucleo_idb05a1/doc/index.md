---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/x_nucleo_idb05a1/doc/index.html
original_path: boards/shields/x_nucleo_idb05a1/doc/index.html
---
...
![X-NUCLEO-IDB05A1](https://docs.zephyrproject.org/3.6.0/_images/x-nucleo-idb05a1.jpg)
...
see cs-gpios in x\_nucleo\_idb05a1.overlay
...
You could check Figure 3 in [X-NUCLEO-IDB05A1 databrief](https://www.st.com/resource/en/data_brief/x-nucleo-idb05a1.pdf) [[2]](#id3) for more details.

The stm32mp157c\_dk2 board is known to need those CS/IRQ pin modifications
(see boards/stm32mp157c\_dk2.overlay)
whereas nucleo\_l476rg doesn’t need hardware modifications.
...
:   - [X-NUCLEO-IDB05A1 databrief](https://www.st.com/resource/en/data_brief/x-nucleo-idb05a1.pdf) [[2]](#id3)
...
> west build -b your_board_name your_app -- -DSHIELD=x_nucleo_idb05a1
> ```
...
[https://www.st.com/en/ecosystems/x-nucleo-idb05a1.html](https://www.st.com/en/ecosystems/x-nucleo-idb05a1.html)

[2]
([1](#id4),[2](#id5))

[https://www.st.com/resource/en/data\_brief/x-nucleo-idb05a1.pdf](https://www.st.com/resource/en/data_brief/x-nucleo-idb05a1.pdf)
