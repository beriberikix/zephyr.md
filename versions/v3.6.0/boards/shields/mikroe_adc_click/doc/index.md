---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/mikroe_adc_click/doc/index.html
...
![MikroElektronika ADC Click](https://docs.zephyrproject.org/3.6.0/_images/adc-click.jpg)
...
west build -b lpcxpresso55s16 <my_app> -- -DSHIELD=mikroe_adc_click
```
