---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/esp32_ethernet_kit/doc/index.html
original_path: boards/xtensa/esp32_ethernet_kit/doc/index.html
---
...
![ESP32-Ethernet-Kit V1.2](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-v1.2-overview.jpg)
...
![ESP32-Ethernet-Kit V1.2](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-v1.2.jpg)
...
![ESP32-Ethernet-Kit block diagram](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-v1.1-block-diagram.jpg)
...
![ESP32-Ethernet-Kit V1.2](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-a-v1.2-layout.jpg)
...
![ESP32-Ethernet-Kit - PoE board (B)](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-b-v1.0-layout.jpg)
...
![RMII Clock from IP101GRI PHY](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-rmii-clk-from-phy.jpg)
...
![RMII Clock from ESP Internal APLL](https://docs.zephyrproject.org/3.6.0/_images/esp32-ethernet-kit-rmii-clk-to-phy.jpg)
...
west build -b esp32_ethernet_kit samples/hello_world
```
...
```shell
# From the root of the zephyr repository
west build -b esp32_ethernet_kit samples/hello_world -- -DOPENOCD=<path/to/bin/openocd> -DOPENOCD_DEFAULT_PATH=<path/to/openocd/share/openocd/scripts>
west flash
```
