---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/heltec_wireless_stick_lite_v3/doc/index.html
original_path: boards/xtensa/heltec_wireless_stick_lite_v3/doc/index.html
---
...
[![HelTec Wireless Stick Lite (V3)](https://docs.zephyrproject.org/3.6.0/_images/heltec_wireless_stick_lite_v3.webp)](https://docs.zephyrproject.org/3.6.0/_images/heltec_wireless_stick_lite_v3.webp)
...
[![HelTec Wireless Stick Lite (V3) Pinout](https://docs.zephyrproject.org/3.6.0/_images/heltec_wireless_stick_lite_v3_pinout.webp)](https://docs.zephyrproject.org/3.6.0/_images/heltec_wireless_stick_lite_v3_pinout.webp)
...
west build -b heltec_wireless_stick_lite_v3 samples/hello_world
```
...
```shell
# From the root of the zephyr repository
west build -b heltec_wireless_stick_lite_v3 samples/hello_world -- -DOPENOCD=<path/to/bin/openocd> -DOPENOCD_DEFAULT_PATH=<path/to/openocd/share/openocd/scripts>
west flash
```
