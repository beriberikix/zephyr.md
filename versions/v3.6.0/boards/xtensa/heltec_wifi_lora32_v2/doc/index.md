---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/heltec_wifi_lora32_v2/doc/index.html
original_path: boards/xtensa/heltec_wifi_lora32_v2/doc/index.html
---
...
```shell
# From the root of the zephyr repository
west build -b heltec_wifi_lora32_v2 samples/subsys/display/lvgl -- -DSHIELD=ssd1306_128x64
west flash
```
