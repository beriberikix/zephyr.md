---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/esp_wrover_kit/doc/index.html
original_path: boards/xtensa/esp_wrover_kit/doc/index.html
---
...
![ESP-WROVER-KIT](https://docs.zephyrproject.org/3.6.0/_images/esp-wrover-kit-block-diagram.jpg)
...
![esp wrover front](https://docs.zephyrproject.org/3.6.0/_images/esp-wrover-kit-v4.1-layout-front.jpg)

ESP-WROVER-KIT board layout - front

![esp wrover back](https://docs.zephyrproject.org/3.6.0/_images/esp-wrover-kit-v4.1-layout-back.jpg)
...
[ESP-WROVER-32 V3 Getting Started Guide](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/hw-reference/esp32/get-started-wrover-kit.html) for details.

Here is an example for building the [Hello World](../../../../samples/hello_world/README.md#hello-world) application.

```shell
# From the root of the zephyr repository
west build -b esp_wrover_kit samples/hello_world -- -DOPENOCD=<path/to/bin/openocd> -DOPENOCD_DEFAULT_PATH=<path/to/openocd/share/openocd/scripts>
west flash
```
