---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/yd_esp32/doc/index.html
original_path: boards/xtensa/yd_esp32/doc/index.html
---
...
![YD-ESP32](https://docs.zephyrproject.org/3.6.0/_images/yd_esp32.png)
...
west build -b yd_esp32 samples/hello_world
```
...
Here is an example of how to test it using the [WS2812 LED strip](../../../../samples/drivers/led_ws2812/README.md#led-ws2812 "Control an LED strip using a WS2812 (or compatible) driver chip.") application.

```shell
# From the root of the zephyr repository
west build -b yd_esp32 samples/drivers/led_ws2812
west flash
```
