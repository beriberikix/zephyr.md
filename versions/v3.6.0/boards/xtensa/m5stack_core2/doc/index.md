---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/m5stack_core2/doc/index.html
original_path: boards/xtensa/m5stack_core2/doc/index.html
---
...
| 6-axis IMU  MPU6886 | The [MPU-6886](https://m5stack.oss-cn-shenzhen.aliyuncs.com/resource/docs/datasheet/core/MPU-6886-000193%2Bv1.1_GHIC_en.pdf) is a 6-axis motion tracker (6DOF IMU) device that  combines a 3-axis gyroscope and a 3-axis accelerometer.  For details please refer to [M5Stack-Core2 base shield](../../../shields/m5stack_core2_ext/doc/index.md#m5stack-core2-ext) | todo |
...
west build -b m5stack_core2 samples/hello_world
```
