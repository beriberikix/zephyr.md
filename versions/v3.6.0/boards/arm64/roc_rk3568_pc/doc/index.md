---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm64/roc_rk3568_pc/doc/index.html
original_path: boards/arm64/roc_rk3568_pc/doc/index.html
---
...
The Zephyr roc\_rk3568\_pc board configuration supports the following hardware
features:
...
roc\_rk3568\_pc\_smp support, use this configuration to run Zephyr smp applications and subsys tests,
for example, with the [Basic Synchronization](../../../../samples/synchronization/README.md#synchronization "Manipulate basic kernel synchronization primitives.") sample:

```shell
# From the root of the zephyr repository
west build -b roc_rk3568_pc_smp samples/synchronization
west build -t run
```
