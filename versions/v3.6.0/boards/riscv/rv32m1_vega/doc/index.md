---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/riscv/rv32m1_vega/doc/index.html
original_path: boards/riscv/rv32m1_vega/doc/index.html
---
...
![RV32M1-VEGA](https://docs.zephyrproject.org/3.6.0/_images/rv32m1_vega.jpg)
...
configuration name, and ZERO\_RISCY with the `rv32m1_vega_zero_riscy` board
configuration name.
...
source code, i.e.
[boards/riscv/rv32m1\_vega/rv32m1\_vega\_ri5cy.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/riscv/rv32m1_vega/rv32m1_vega_ri5cy.dts) for RI5CY and
[boards/riscv/rv32m1\_vega/rv32m1\_vega\_zero\_riscy.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/riscv/rv32m1_vega/rv32m1_vega_zero_riscy.dts) for
ZERO-RISCY.
...
1. Connect the J-Link debugger through the adapter board to the
   ...
   ![RV32M1-VEGA](https://docs.zephyrproject.org/3.6.0/_images/rv32m1_vega_jtag.jpg)
...
>
> ![Reset button is pressed](https://docs.zephyrproject.org/3.6.0/_images/ri5cy_boot.jpg)
>
...
Now let’s compile the [Hello World](../../../../samples/hello_world/README.md#hello-world) application. (You can try
others as well; see [Samples and Demos](../../../../samples/index.md#samples-and-demos) for more.)
