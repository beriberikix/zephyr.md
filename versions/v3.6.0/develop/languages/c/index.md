---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/develop/languages/c/index.html
...
example, the [`cbprintf()`](../../../services/formatted_output.md#c.cbprintf "cbprintf") component, used as the default formatted output
...
`malloc()` and `free()`) and these functions are implemented by the
...
[`k_malloc()`](../../../kernel/memory_management/heap.md#c.k_malloc "k_malloc") in order to take advantage of the advanced features
that they offer.
