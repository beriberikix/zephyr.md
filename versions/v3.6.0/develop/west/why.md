---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/develop/west/why.html
original_path: develop/west/why.html
---
...
During the development of west, a set of [Design Constraints](#west-design-constraints) were
...
Google’s [repo](https://gerrit.googlesource.com/git-repo/).
...
See [Basics](basics.md#west-basics) for information on how west workspaces manage multiple
git repositories.
...
See [Zephyr issue #6205](https://github.com/zephyrproject-rtos/zephyr/issues/6205) and for more details and discussion.
