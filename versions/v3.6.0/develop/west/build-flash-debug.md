---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/develop/west/build-flash-debug.html
...
### [Sysbuild (multi-domain builds)](#id8)
...
#### [Forcing CMake to Run Again](#id10)
...
#### [Setting Source and Build Directories](#id12)
...
#### [Setting the Build System Target](#id13)
...
build and run the [Hello World](../../samples/hello_world/README.md#hello-world) sample for the emulated [qemu\_x86](../../boards/x86/qemu_x86/doc/index.md#qemu-x86) board in one command:
...
#### [Permanent CMake Arguments](#id17)
...
#### [Build a single domain](#id20)

In a multi-domain build with [Hello World](../../samples/hello_world/README.md#hello-world) and [MCUboot](https://mcuboot.com/), you can use
...
### [Runner-Specific Overrides](#id27)
...
For example, in a multi-domain build with [Hello World](../../samples/hello_world/README.md#hello-world) and
...
## [Debugging: `west debug`, `west debugserver`](#id29)
...
### [Runner-Specific Overrides](#id33)
...
*class* runners.core.RunnerCaps(*commands: ~typing.Set[str] = <factory>*, *dev\_id: bool = False*, *flash\_addr: bool = False*, *erase: bool = False*, *reset: bool = False*, *tool\_opt: bool = False*, *file: bool = False*)
...
*class* runners.core.RunnerConfig(*build\_dir: str*, *board\_dir: str*, *elf\_file: str | None*, *exe\_file: str | None*, *hex\_file: str | None*, *bin\_file: str | None*, *uf2\_file: str | None*, *file: str | None*, *file\_type: [FileType](#runners.core.FileType) | None = FileType.OTHER*, *gdb: str | None = None*, *openocd: str | None = None*, *openocd\_search: List[str] = []*)
...
:   Abstract superclass for binary runners (flashers, debuggers).
    ...
    **Note**: this class’s API has changed relatively rarely since it
    ...
    ‘flash’). Boards (like ‘nrf52dk\_nrf52832’) declare which runner(s)
    ...
    *abstract classmethod* do\_add\_parser(*parser*)
    :   Hook for adding runner-specific options.

    *abstract classmethod* do\_create(*cfg: [RunnerConfig](#runners.core.RunnerConfig)*, *args: Namespace*) → [ZephyrBinaryRunner](#runners.core.ZephyrBinaryRunner)
    :   Hook for instance creation from command line arguments.

    *abstract* do\_run(*command: str*, *\*\*kwargs*)
