---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/develop/flash_debug/nordic_segger.html
original_path: develop/flash_debug/nordic_segger.html
---
...
1. Download the appropriate package from the [J-Link Software and documentation pack](https://www.segger.com/jlink-software.html) [[9]](#id19) website
2. Depending on your platform, install the package or run the installer
3. When connecting a J-Link-enabled board such as an nRF5x DK, PDK or dongle, a
...
To install them, visit [nRF5x Command-Line Tools](https://www.nordicsemi.com/Software-and-Tools/Development-Tools/nRF-Command-Line-Tools) [[1]](#id3) and select your operating
system.
...
Where: `<board>` is the board name you used in the BOARD directive when building (for example nrf52dk\_nrf52832)
...
To work around this disable the Mass Storage Device on your board as described in [Disabling the Mass Storage Device functionality](#nordic-segger-msd).
...
Recent versions of [ModemManager send AT commands to TTY-like devices](https://bugs.freedesktop.org/show_bug.cgi?id=85007) [[7]](#id15); this
...
You can also [blacklist Segger devices by editing udev rules](http://www.at91.com/linux4sam/bin/view/Linux4SAM/SoftwareTools#Device_or_resource_busy_dev_ttyA) [[8]](#id17) so ModemManager
...
Further information from Segger can be found in the [Segger SAM3U Wiki](https://wiki.segger.com/index.php?title=J-Link-OB_SAM3U) [[2]](#id5).

## RTT Console

Segger’s J-Link supports [Real-Time Tracing (RTT)](https://www.segger.com/jlink-rtt.html) [[3]](#id7), a technology that allows a terminal
...
a purpose different than logging (such as HCI traffic in the hci\_uart application).
...
A Python RTT viewer tool can be found in the [pyrtt-viewer](https://github.com/thomasstenersen/pyrtt-viewer) [[4]](#id9) GitHub repository.

## Segger Ozone

Segger J-Link is compatible with [Segger Ozone](https://www.segger.com/ozone.html) [[5]](#id11), a visual debugger that can be obtained here:

- [Segger Ozone Download](https://www.segger.com/downloads/jlink#Ozone) [[6]](#id13)
...
[https://www.nordicsemi.com/Software-and-Tools/Development-Tools/nRF-Command-Line-Tools](https://www.nordicsemi.com/Software-and-Tools/Development-Tools/nRF-Command-Line-Tools)

[[2](#id6)]

[https://wiki.segger.com/index.php?title=J-Link-OB\_SAM3U](https://wiki.segger.com/index.php?title=J-Link-OB_SAM3U)

[[3](#id8)]

[https://www.segger.com/jlink-rtt.html](https://www.segger.com/jlink-rtt.html)

[[4](#id10)]

[https://github.com/thomasstenersen/pyrtt-viewer](https://github.com/thomasstenersen/pyrtt-viewer)

[[5](#id12)]

[https://www.segger.com/ozone.html](https://www.segger.com/ozone.html)
...
[https://bugs.freedesktop.org/show\_bug.cgi?id=85007](https://bugs.freedesktop.org/show_bug.cgi?id=85007)

[[8](#id18)]

[http://www.at91.com/linux4sam/bin/view/Linux4SAM/SoftwareTools#Device\_or\_resource\_busy\_dev\_ttyA](http://www.at91.com/linux4sam/bin/view/Linux4SAM/SoftwareTools#Device_or_resource_busy_dev_ttyA)
