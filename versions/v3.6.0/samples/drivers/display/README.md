---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/display/README.html
...
Below is an example on how to build for a [nRF52840 DK](../../../boards/arm/nrf52840dk_nrf52840/doc/index.md#nrf52840dk-nrf52840) board with a
[Adafruit 2.8” TFT Touch Shield v2](../../../boards/shields/adafruit_2_8_tft_touch_v2/doc/index.md#adafruit-2-8-tft-touch-v2).

```shell
west build -b nrf52840dk_nrf52840 samples/drivers/display -- -DSHIELD=adafruit_2_8_tft_touch_v2
```

For testing purpose without the need of any hardware, the [native\_sim](../../../boards/posix/native_sim/doc/index.md#native-sim)
...
- [WAVESHARE e-Paper Raw Panel Shield](../../../boards/shields/waveshare_epaper/doc/index.md#waveshare-e-paper-raw-panel-shield)
