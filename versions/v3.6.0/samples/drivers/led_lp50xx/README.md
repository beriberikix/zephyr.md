---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/led_lp50xx/README.html
original_path: samples/drivers/led_lp50xx/README.html
---
...
[`led_write_channels()`](../../../hardware/peripherals/led.md#c.led_write_channels "led_write_channels") syscall) and then to each LED one by one (using the
[`led_set_brightness()`](../../../hardware/peripherals/led.md#c.led_set_brightness "led_set_brightness") and [`led_set_color()`](../../../hardware/peripherals/led.md#c.led_set_color "led_set_color") syscalls).
...
As an example this sample provides a DTS overlay for the [NXP LPCXpresso11U68](../../../boards/arm/lpcxpresso11u68/doc/index.md#lpcxpresso11u68)
