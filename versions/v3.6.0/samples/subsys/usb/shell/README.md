---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/usb/shell/README.html
...
```shell
west build -b nrf52840dk_nrf52840 samples/subsys/usb/shell -- -DSHIELD=sparkfun_max3421e -DCONFIG_UHC_DRIVER=y -DCONFIG_USB_HOST_STACK=y
west flash
```
...
the platform has already defined or not zephyr\_uhc0 or zephyr\_udc0 nodelabels.

```shell
west build -b nrf52840dk_nrf52840 samples/subsys/usb/shell -- -DEXTRA_CONF_FILE=virtual.conf -DDTC_OVERLAY_FILE=virtual.overlay
west flash
```
