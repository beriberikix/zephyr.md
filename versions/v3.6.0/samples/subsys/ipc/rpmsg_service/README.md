---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/ipc/rpmsg_service/README.html
...
west build -b nrf5340dk_nrf5340_cpuapp samples/subsys/ipc/rpmsg_service
west debug
```
...
```shell
# From the root of the zephyr repository
west build -b mps2_an521 samples/subsys/ipc/rpmsg_service
west debug
```
...
```shell
# From the root of the zephyr repository
west build -b v2m_musca_b1 samples/subsys/ipc/rpmsg_service
west debug
```
...
## Building the application for bl5340\_dvk\_cpuapp

```shell
# From the root of the zephyr repository
west build -b bl5340_dvk_cpuapp samples/subsys/ipc/rpmsg_service
west debug
```

```shell
# From the root of the zephyr repository
west build -b bl5340_dvk_cpunet samples/subsys/ipc/rpmsg_service
west debug
```
