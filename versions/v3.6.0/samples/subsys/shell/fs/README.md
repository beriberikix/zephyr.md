---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/shell/fs/README.html
...
You can build this sample for [native\_sim](../../../../boards/posix/native_sim/doc/index.md#native-sim) with:
...
Check the [native\_sim UART documentation](../../../../boards/posix/native_sim/doc/index.md#native-ptty-uart) for information on how to connect
to the UART.

#### With FUSE access in the host filesystem

If you enable the [host FUSE filsystem access](../../../../boards/posix/native_sim/doc/index.md#native-fuse-flash)
...
[the native\_sim documentation](../../../../boards/posix/native_sim/doc/index.md#native-fuse-flash).
...
For the [native sim board](../../../../boards/posix/native_sim/doc/index.md#native-sim) the flash partitions can be accessed from the host
Linux system.
