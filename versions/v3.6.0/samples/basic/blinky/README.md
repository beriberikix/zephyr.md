---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/basic/blinky/README.html
...
1. Get a pin specification from the [devicetree](../../../build/dts/index.md#dt-guide) as a
   [`gpio_dt_spec`](../../../hardware/peripherals/gpio.md#c.gpio_dt_spec "gpio_dt_spec")
...
`gpio0`. The pin flags [`GPIO_ACTIVE_HIGH`](../../../hardware/peripherals/gpio.md#c.GPIO_ACTIVE_HIGH "GPIO_ACTIVE_HIGH") mean the LED is on when
