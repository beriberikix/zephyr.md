---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/tfm_integration/tfm_ipc/README.html
...
1. Build Zephyr with a non-secure configuration (`-DBOARD=mps2_an521_ns`).
