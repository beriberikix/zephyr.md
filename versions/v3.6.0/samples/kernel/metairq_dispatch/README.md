---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/kernel/metairq_dispatch/README.html
original_path: samples/kernel/metairq_dispatch/README.html
---
...
native\_sim platforms. In that emulation environment, threads will
not be preempted except at specific instrumentation points (e.g. in
k\_busy\_wait()) where they will voluntarily release the CPU.

## Building and Running

This application can be built and executed on frdm\_k64f as follows:

```shell
west build -b frdm_k64f samples/kernel/metairq_dispatch
west flash
```

To build for another board, change “frdm\_k64f” above to that board’s name.

### Sample Output

Sample output shown below is from frdm\_k64f. The numbers will
