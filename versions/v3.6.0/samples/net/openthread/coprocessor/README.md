---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/net/openthread/coprocessor/README.html
...
```shell
west build -b nrf52840dk_nrf52840 samples/net/openthread/coprocessor -- -DDTC_OVERLAY_FILE=usb.overlay -DEXTRA_CONF_FILE=overlay-usb-nrf-br.conf
west flash
```

Example building for the nrf52840dk\_nrf52840 for RCP:
