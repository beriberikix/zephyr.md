---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/net/sockets/echo_server/README.html
...
Example building for the nrf52840dk\_nrf52840 with OpenThread support:
...
Example building for the atsamr21\_xpro with RF2XX driver support:

```shell
west build -b [atsamr21_xpro | sam4e_xpro | sam_v71_xult] samples/net/sockets/echo_server -- -DEXTRA_CONF_FILE=overlay-802154.conf
west flash
```
