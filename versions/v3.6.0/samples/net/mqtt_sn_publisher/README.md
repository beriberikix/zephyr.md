---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/net/mqtt_sn_publisher/README.html
...
```shell
west build -b native_sim_64 samples/net/mqtt_sn_publisher
west build -t run
```
