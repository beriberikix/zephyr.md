---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/modules/canopennode/README.html
...
CANopen is an internationally standardized ([EN 50325-4](https://can-cia.org/groups/international-standardization/), [CiA 301](https://can-cia.org/groups/specifications/))
...
The [NXP TWR-KE18F](../../../boards/arm/twr_ke18f/doc/index.md#twr-ke18f) board is equipped with an onboard CAN
...
The [NXP FRDM-K64F](../../../boards/arm/frdm_k64f/doc/index.md#frdm-k64f) board does not come with an onboard CAN
...
The [ST STM32F072B Discovery](../../../boards/arm/stm32f072b_disco/doc/index.md#stm32f072b-disco-board) board does not come with an onboard CAN
...
The [ST STM32F3 Discovery](../../../boards/arm/stm32f3_disco/doc/index.md#stm32f3-disco-board) board does not come with an onboard CAN
...
1. Build the CANopenNode sample with MCUboot support:
   ...
   ```shell
   west build -b frdm_k64f --sysbuild samples/modules/canopennode -- -Dcanopennode_CONF_FILE=prj_img_mgmt.conf
   ```
