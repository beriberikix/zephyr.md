---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/nrf/nrfx_prs/README.html
original_path: samples/boards/nrf/nrfx_prs/README.html
---
...
[samples/boards/nrf/nrfx\_prs/boards](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nrf/nrfx_prs/boards) directory to check which pins
...
(nrf9160dk\_nrf9160) and nRF5340 DK (nrf5340dk\_nrf5340\_cpuapp) boards.

## Building and Running

The code can be found in [samples/boards/nrf/nrfx\_prs](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nrf/nrfx_prs).

To build and flash the application:

```shell
west build -b nrf9160dk_nrf9160 samples/boards/nrf/nrfx_prs
west flash
```
