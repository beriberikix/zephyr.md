---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/nrf/mesh/onoff-app/README.html
original_path: samples/boards/nrf/mesh/onoff-app/README.html
---
...
likely also run on the nrf52dk\_nrf52832 board.

## Building and Running

This sample can be found under [samples/boards/nrf/mesh/onoff-app](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nrf/mesh/onoff-app) in the
Zephyr tree.

The following commands build the application.

```shell
west build -b nrf52840dk_nrf52840 samples/boards/nrf/mesh/onoff-app
west flash
```
...
See [bluetooth samples section](../../../../bluetooth/bluetooth.md#bluetooth-samples) for details.
