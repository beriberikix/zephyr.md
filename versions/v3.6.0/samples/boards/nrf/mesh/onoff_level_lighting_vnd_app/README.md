---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/nrf/mesh/onoff_level_lighting_vnd_app/README.html
...
This sample can be found under [samples/boards/nrf/mesh/onoff\_level\_lighting\_vnd\_app](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nrf/mesh/onoff_level_lighting_vnd_app) in the
Zephyr tree.

The following commands build the application.

```shell
west build -b nrf52840dk_nrf52840 samples/boards/nrf/mesh/onoff_level_lighting_vnd_app
west flash
```
