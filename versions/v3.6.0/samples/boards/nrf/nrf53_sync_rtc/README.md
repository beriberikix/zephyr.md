---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/nrf/nrf53_sync_rtc/README.html
original_path: samples/boards/nrf/nrf53_sync_rtc/README.html
---
...
west build -b nrf5340dk_nrf5340_cpuapp --sysbuild samples/boards/nrf/nrf53_sync_rtc
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim_nrf5340_cpuapp --sysbuild samples/boards/nrf/nrf53_sync_rtc
```
