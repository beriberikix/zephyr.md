---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/stm32/power_mgmt/serial_wakeup/README.html
original_path: samples/boards/stm32/power_mgmt/serial_wakeup/README.html
---
...
```shell
west build -b nucleo_wb55rg samples/boards/stm32/power_mgmt/serial_wakeup
west flash
```
