---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/up_squared/gpio_counter/README.html
original_path: samples/boards/up_squared/gpio_counter/README.html
---
...
- [UP Squared](../../../../boards/x86/up_squared/doc/index.md#up-squared) board documentation
...
west build -b up_squared samples/boards/up_squared/gpio_counter
```

Prepare the boot device (USB storage drive) as described for the [UP Squared](../../../../boards/x86/up_squared/doc/index.md#up-squared)
...
Replace `<tty_device>` with the port where the UP Squared board
