---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/bbc_microbit/pong/README.html
original_path: samples/boards/bbc_microbit/pong/README.html
---
...
```shell
west build -b bbc_microbit samples/boards/bbc_microbit/pong
west flash
```
