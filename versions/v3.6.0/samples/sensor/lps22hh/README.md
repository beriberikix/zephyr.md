---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/lps22hh/README.html
...
```shell
west build -b nrf52dk_nrf52832 samples/sensor/lps22hh -- -DSHIELD=x_nucleo_iks01a3
```
