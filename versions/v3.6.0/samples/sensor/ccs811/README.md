---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/ccs811/README.html
...
### Building and Running on thingy52\_nrf52832

```shell
west build -b thingy52_nrf52832 samples/sensor/ccs811
west flash
```
...
(thingy52\_nrf52832) that includes this sensor (and others).
