---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/mpr/README.html
...
In the sample below the [Arduino Due](../../../boards/arm/arduino_due/doc/index.md#arduino-due) board is used.
