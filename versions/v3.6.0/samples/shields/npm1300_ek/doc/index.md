---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/shields/npm1300_ek/doc/index.html
...
```shell
west build -b nrf52dk_nrf52832 samples/shields/npm1300_ek
```
