---
version: v3.6.0
source_url: https://docs.zephyrproject.org/3.6.0/samples/shields/x_nucleo_iks02a1/microphone/README.html
...
[![audio_import](https://docs.zephyrproject.org/3.6.0/_images/audio_import.png)](https://docs.zephyrproject.org/3.6.0/_images/audio_import.png)

After the file is imported you can analyze and play the 1sec audio file:

[![audio_file](https://docs.zephyrproject.org/3.6.0/_images/audio_file.png)](https://docs.zephyrproject.org/3.6.0/_images/audio_file.png)
