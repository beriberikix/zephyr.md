---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/shields/npm6001_ek/doc/index.html
...
![nRF52840DK + nPM6001-EK wiring example](https://docs.zephyrproject.org/3.6.0/_images/nrf52840dk_wiring.jpg)
...
```shell
west build -b nrf52840dk_nrf52840 samples/shields/npm6001_ek
```
