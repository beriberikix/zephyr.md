---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/bluetooth/public_broadcast_sink/README.html
original_path: samples/bluetooth/public_broadcast_sink/README.html
---
...
[samples/bluetooth/public\_broadcast\_sink](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/public_broadcast_sink) in the Zephyr tree.
...
west build -b nrf5340dk_nrf5340_cpuapp --sysbuild samples/bluetooth/public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340dk_nrf5340_cpuapp samples/bluetooth/public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim_nrf5340_cpuapp --sysbuild samples/bluetooth/public_broadcast_sink/
```
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/public_broadcast_sink/ -- -DOVERLAY_CONFIG=overlay-bt_ll_sw_split.conf
```
