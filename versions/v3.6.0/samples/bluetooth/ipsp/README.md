---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/bluetooth/ipsp/README.html
original_path: samples/bluetooth/ipsp/README.html
---
...
This sample can be found under [samples/bluetooth/ipsp](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/ipsp) in the
Zephyr tree.
Sample can be built and executed for the nRF52840 DK NRF52840 as follows:

```shell
west build -b nrf52840dk_nrf52840 samples/bluetooth/ipsp
west flash
```
...
```shell
west build -b nrf52840dk_nrf52840 samples/bluetooth/ipsp -- -DCONF_FILE=prj_dbg.conf
west flash
```
...
option [`CONFIG_NET_L2_BT_ZEP1656`](../../../kconfig.md#CONFIG_NET_L2_BT_ZEP1656 "CONFIG_NET_L2_BT_ZEP1656")
must be selected. For more information, see [Zephyr issue #3111](https://github.com/zephyrproject-rtos/zephyr/issues/3111).

```shell
west build -b nrf52840dk_nrf52840 samples/bluetooth/ipsp -- -DCONF_FILE="prj_zep1656.conf"
west flash
```
...
(CONFIG\_BT\_6LOWPAN=y) then proceed to enable it with with the following commands
(as root):
