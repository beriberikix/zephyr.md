---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/contribute/guidelines.html
...
`--device-testing` options. Please consult with the [Twister](../develop/test/twister.md#twister-script) documentation for more details.
...
[Coding Style](#id1) standards together with the `.clang-format` configuration file
...
A more complete alternative to this is using check\_compliance.py script from
ci-tools repo.
...
15. If the CI run fails, you will need to make changes to your code in order
...
You should have set your [Name and email](#git-name-and-email)
...
[Contribution Tools](#contribution-tools) section. The CI results must be green indicating “All
