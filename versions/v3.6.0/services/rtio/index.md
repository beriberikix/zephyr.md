---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/rtio/index.html
...
[![Submissions and Completion Ring Queues](https://docs.zephyrproject.org/3.6.0/_images/rings.png)](https://docs.zephyrproject.org/3.6.0/_images/rings.png)
...
:   RTIO.
    ...
    static inline void rtio\_iodev\_cancel\_all(struct [rtio\_iodev](#c.rtio_iodev) \*iodev)
...
:   RTIO Multiple Producer Single Consumer (MPSC) Queue API.
    ...
    static inline void rtio\_mpsc\_init(struct [rtio\_mpsc](#c.rtio_mpsc) \*q)
    :   Initialize queue.

        Parameters:
        :   - **q** – Queue to initialize or reset

    ALWAYS\_INLINE static void rtio\_mpsc\_push(struct [rtio\_mpsc](#c.rtio_mpsc) \*q, struct [rtio\_mpsc\_node](#c.rtio_mpsc_node) \*n)
    :   Push a node.
    ...
    static inline struct [rtio\_mpsc\_node](#c.rtio_mpsc_node) \*rtio\_mpsc\_pop(struct [rtio\_mpsc](#c.rtio_mpsc) \*q)
    ...
    struct rtio\_mpsc\_node
    :   *#include <rtio\_mpsc.h>*
...
:   RTIO Single Producer Single Consumer (SPSC) Queue API.
    ...
    RTIO\_SPSC\_INITIALIZER(sz, buf)
    ...
    RTIO\_SPSC\_DEFINE(name, type, sz)
    ...
    rtio\_spsc\_size(spsc)
    :   Size of the SPSC queue.

        Parameters:
        :   - **spsc** – SPSC reference

    rtio\_spsc\_reset(spsc)
