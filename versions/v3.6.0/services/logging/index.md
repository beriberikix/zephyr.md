---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/logging/index.html
...
- `LOG_INST_HEXDUMP_X` for dumping data associated with the particular
  instance, e.g. `LOG_HEXDUMP_INST_DBG`
...
![../../_images/multidomain.png](https://docs.zephyrproject.org/3.6.0/_images/multidomain.png)
...
![../../_images/domain_ids.png](https://docs.zephyrproject.org/3.6.0/_images/domain_ids.png)
