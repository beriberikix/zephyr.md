---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/pm/device_runtime.html
...
initially set to a [`PM_DEVICE_STATE_SUSPENDED`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_SUSPENDED "PM_DEVICE_STATE_SUSPENDED") indicating it is
not used. On the first device request, it will be resumed and so put into the
[`PM_DEVICE_STATE_ACTIVE`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_ACTIVE "PM_DEVICE_STATE_ACTIVE") state. The device will remain in this
...
[`PM_DEVICE_STATE_SUSPENDED`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_SUSPENDED "PM_DEVICE_STATE_SUSPENDED") state, whereas if it is performed
asynchronously, it will be put into the
[`PM_DEVICE_STATE_SUSPENDING`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_SUSPENDING "PM_DEVICE_STATE_SUSPENDING") state first and then into the
[`PM_DEVICE_STATE_SUSPENDED`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_SUSPENDED "PM_DEVICE_STATE_SUSPENDED") state when the action is run.
...
in response to [`pm_device_runtime_get()`](api/index.md#c.pm_device_runtime_get "pm_device_runtime_get") and [`pm_device_runtime_put()`](api/index.md#c.pm_device_runtime_put "pm_device_runtime_put")
...
or [`pm_device_runtime_enable()`](api/index.md#c.pm_device_runtime_enable "pm_device_runtime_enable")).
...
The [`pm_device_runtime_get()`](api/index.md#c.pm_device_runtime_get "pm_device_runtime_get") function can be used by a device driver to
...
[`pm_device_runtime_put()`](api/index.md#c.pm_device_runtime_put "pm_device_runtime_put") function can be used to indicate that the device
...
![../../_images/devr-sync-ops.svg](https://docs.zephyrproject.org/3.6.0/_images/devr-sync-ops.svg)
...
[`pm_device_runtime_put_async()`](api/index.md#c.pm_device_runtime_put_async "pm_device_runtime_put_async") function. This function will schedule
...
![../../_images/devr-async-ops.svg](https://docs.zephyrproject.org/3.6.0/_images/devr-async-ops.svg)
...
[`pm_device_runtime_enable()`](api/index.md#c.pm_device_runtime_enable "pm_device_runtime_enable") at initialization time. Note that this
function will suspend the device if its state is
[`PM_DEVICE_STATE_ACTIVE`](api/index.md#c.pm_device_state.PM_DEVICE_STATE_ACTIVE "PM_DEVICE_STATE_ACTIVE"). In case the device is physically
suspended, the init function should call
[`pm_device_init_suspended()`](api/index.md#c.pm_device_init_suspended "pm_device_init_suspended") before calling
[`pm_device_runtime_enable()`](api/index.md#c.pm_device_runtime_enable "pm_device_runtime_enable").
...
devicetree node. If enabled, [`pm_device_runtime_enable()`](api/index.md#c.pm_device_runtime_enable "pm_device_runtime_enable") is called immediately
