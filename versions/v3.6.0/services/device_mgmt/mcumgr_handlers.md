---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/device_mgmt/mcumgr_handlers.html
...
[`mcumgr_group_t`](mcumgr.md#c.mcumgr_group_t "mcumgr_group_t") contains the management groups available in Zephyr with their
...
responses that return a [`mcumgr_err_t`](mcumgr.md#c.mcumgr_err_t "mcumgr_err_t") - there should always be an OK error code with the
...
[`MGMT_GROUP_ID_PERUSER`](mcumgr.md#c.mcumgr_group_t.MGMT_GROUP_ID_PERUSER "MGMT_GROUP_ID_PERUSER"), which is the start group ID for user-defined groups, note that
...
[`MGMT_EVT_GRP_USER_CUSTOM_START`](mcumgr_callbacks.md#c.mgmt_cb_groups.MGMT_EVT_GRP_USER_CUSTOM_START "MGMT_EVT_GRP_USER_CUSTOM_START"), which is the start event ID for user-defined groups,
