---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/shell/index.html
...
### [Connecting to Segger RTT via TCP (on macOS, for example)](#id5)
...
![Command tree with static commands.](https://docs.zephyrproject.org/3.6.0/_images/static_cmd.PNG)
...
![Dictionary commands example.](https://docs.zephyrproject.org/3.6.0/_images/dict_cmd.png)
...
![Command tree with static and dynamic commands.](https://docs.zephyrproject.org/3.6.0/_images/dynamic_cmd.PNG)
...
![Command tree with static commands.](https://docs.zephyrproject.org/3.6.0/_images/execution.png)
...
![Tab Feature usage example](https://docs.zephyrproject.org/3.6.0/_images/tab_prompt.png)

## [History Feature](#id13)
...
[`CONFIG_GETOPT`](../../kconfig.md#CONFIG_GETOPT "CONFIG_GETOPT") set to `y` and [`CONFIG_GETOPT_LONG`](../../kconfig.md#CONFIG_GETOPT_LONG "CONFIG_GETOPT_LONG")
set to `y`.
...
## [Shell Logger Backend Feature](#id18)
...
## [RTT Backend Channel Selection](#id19)
...
enabled using [`CONFIG_LOG_BACKEND_RTT`](../../kconfig.md#CONFIG_LOG_BACKEND_RTT "CONFIG_LOG_BACKEND_RTT") set to `y`, because it
defaults to `n` when the Shell RTT backend is also enabled using
[`CONFIG_SHELL_BACKEND_RTT`](../../kconfig.md#CONFIG_SHELL_BACKEND_RTT "CONFIG_SHELL_BACKEND_RTT") being set to `y`.
...
:   Shell API.
    ...
    void shell\_fprintf(const struct [shell](#c.shell) \*sh, enum shell\_vt100\_color color, const char \*fmt, ...)
    ...
    :   vprintf-like function which sends formatted data stream to the shell.
        ...
        This function can be used from the command handler or from threads, but not from an interrupt context. It is similar to [shell\_fprintf()](#group__shell__api_1gaa02f857bd560e8d7a1ce7c54a418dcaa) but takes a va\_list instead of variable arguments.
