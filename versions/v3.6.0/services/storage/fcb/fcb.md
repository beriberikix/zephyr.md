---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/storage/fcb/fcb.html
...
:   Defines
    ...
    :   *#include <fcb.h>*
        ...
        The following data structure describes the FCB itself. First part should be filled in by the user before calling [fcb\_init](#group__fcb__api_1ga318d35b6f023bb4079aaf76c01a59b96). The second part is used by FCB for its internal bookkeeping.
...
:   Flash Circular Buffer APIs.
    ...
    :   FCB Walk callback function type.
        ...
        Type of function which is expected to be called while walking over fcb entries thanks to a [fcb\_walk](#group__fcb__api_1ga2e22f120b3f1d729f8e861f0c0e448fb) call.
        ...
        Param arg:
        :   **[inout]** callback context, transferred from [fcb\_walk](#group__fcb__api_1ga2e22f120b3f1d729f8e861f0c0e448fb).
    ...
    int fcb\_init(int f\_area\_id, struct [fcb](#c.fcb_init) \*fcb)
    :   Initialize FCB instance.

        Parameters:
        :   - **f\_area\_id** – **[in]** ID of flash area where fcb storage resides.
            - **fcb** – FCB instance structure.

        Returns:
        :   0 on success, non-zero on failure.

    int fcb\_append(struct [fcb](#c.fcb_append) \*fcb, uint16\_t len, struct [fcb\_entry](#c.fcb_entry) \*loc)
    :   Appends an entry to circular buffer.

        When writing the contents for the entry, use loc->fe\_sector and loc->fe\_data\_off with [flash\_area\_write()](../flash_map/flash_map.md#group__flash__area__api_1gaa56052f8d6bf4f6966752bc21f5cceb8) to fcb [flash\_area](../flash_map/flash_map.md#structflash__area). When you’re finished, call [fcb\_append\_finish()](#group__fcb__api_1ga2d8581e0784546fd73e4cd2f8baeebd9) with loc as argument.
    ...
    int fcb\_append\_finish(struct [fcb](#c.fcb_append_finish) \*fcb, struct [fcb\_entry](#c.fcb_entry) \*append\_loc)
    ...
    int fcb\_walk(struct [fcb](#c.fcb_walk) \*fcb, struct [flash\_sector](../flash_map/flash_map.md#c.flash_sector "flash_sector") \*sector, [fcb\_walk\_cb](#c.fcb_walk_cb) cb, void \*cb\_arg)
    ...
    int fcb\_getnext(struct [fcb](#c.fcb_getnext) \*fcb, struct [fcb\_entry](#c.fcb_entry) \*loc)
    ...
    int fcb\_rotate(struct [fcb](#c.fcb_rotate) \*fcb)
    :   Rotate fcb sectors.
    ...
    int fcb\_append\_to\_scratch(struct [fcb](#c.fcb_append_to_scratch) \*fcb)
    ...
    int fcb\_free\_sector\_cnt(struct [fcb](#c.fcb_free_sector_cnt) \*fcb)
    ...
    int fcb\_is\_empty(struct [fcb](#c.fcb_is_empty) \*fcb)
    ...
    int fcb\_offset\_last\_n(struct [fcb](#c.fcb_offset_last_n) \*fcb, uint8\_t entries, struct [fcb\_entry](#c.fcb_entry) \*last\_n\_entry)
    ...
    int fcb\_clear(struct [fcb](#c.fcb_clear) \*fcb)
