---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/debugging/coredump.html
...
This was done on [X86 Emulation (QEMU)](../../boards/x86/qemu_x86/doc/index.md#qemu-x86) where a null pointer was dereferenced.
...
:   Coredump APIs.
    ...
    void coredump(unsigned int reason, const z\_arch\_esf\_t \*esf, struct [k\_thread](../../kernel/services/threads/index.md#c.k_thread "k_thread") \*thread)
    :   Perform coredump.
    ...
    int coredump\_query(enum [coredump\_query\_id](#c.coredump_query_id) query\_id, void \*arg)
    ...
    int coredump\_cmd(enum [coredump\_cmd\_id](#c.coredump_cmd_id) query\_id, void \*arg)
