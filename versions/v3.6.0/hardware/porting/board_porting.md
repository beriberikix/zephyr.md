---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/porting/board_porting.html
...
| --- | --- | --- | --- | --- | --- |
| [nrf52dk\_nrf52832](../../boards/arm/nrf52dk_nrf52832/doc/index.md#nrf52dk-nrf52832) | nRF52832 | nRF52 | Nordic nRF5 | Arm Cortex-M4 | Arm |
| [frdm\_k64f](../../boards/arm/frdm_k64f/doc/index.md#frdm-k64f) | MK64F12 | Kinetis K6x | NXP Kinetis | Arm Cortex-M4 | Arm |
| [stm32h747i\_disco](../../boards/arm/stm32h747i_disco/doc/index.md#stm32h747i-disco-board) | STM32H747XI | STM32H7 | STMicro STM32 | Arm Cortex-M7 | Arm |
| [rv32m1\_vega\_ri5cy](../../boards/riscv/rv32m1_vega/doc/index.md#rv32m1-vega) | RV32M1 | (Not used) | (Not used) | RI5CY | RISC-V |
...
1. `plank.dts`: a hardware description in [devicetree](../../build/dts/index.md#dt-guide) format. This declares your SoC, connectors, and any
   other hardware components such as LEDs, buttons, sensors, or communication
   peripherals (USB, BLE controller, etc).
2. `Kconfig.board`, `Kconfig.defconfig`, `plank_defconfig`:
   software configuration in [Configuration System (Kconfig)](../../build/kconfig/index.md#kconfig) formats. This provides default
...
[frdm\_k64fs.dts ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/frdm_k64f/frdm_k64f.dts) and
[hexiwear\_k64.dts ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/hexiwear_k64/hexiwear_k64.dts)
...
`Kconfig.board`
:   Included by [boards/Kconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/Kconfig) to include your board
...
- The optional Kconfig settings specified in the file
  `plank_<revision>.conf` will be merged into the board’s default Kconfig
  configuration.
- The optional devicetree overlay `plank_<revision>.overlay` will be added
  to the common `plank.dts` devicetree file
- The `revision.cmake` file controls how the Zephyr build system matches
...
### board\_check\_revision() details
...
- `FORMAT MAJOR.MINOR.PATCH`: matches exactly three digits. The command line
  ...
  ambiguity, so only `<board>_1_0_0.conf` and
  `<board>_1_0_0.overlay` are allowed.
