---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/peripherals/edac/ibecc.html
original_path: hardware/peripherals/edac/ibecc.html
---
...
- OPERATION\_MODE = 0x0 sets functional mode to protect requests based on
  address range
- OPERATION\_MODE = 0x1 sets functional mode to all requests not be protected and
  to ignore range checks
- OPERATION\_MODE = 0x2 sets functional mode to protect all requests and ignore
  range checks
...
- [`CONFIG_EDAC_IBECC`](../../../kconfig.md#CONFIG_EDAC_IBECC "CONFIG_EDAC_IBECC")
