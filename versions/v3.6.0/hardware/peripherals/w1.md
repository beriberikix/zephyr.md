---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/peripherals/w1.html
...
![1-Wire bus topology](https://docs.zephyrproject.org/3.6.0/_images/1-Wire_bus_topology.drawio.svg)
...
:   1-Wire network layer
    ...
    W1\_ROM\_INIT\_ZERO
    :   Intitialize all [w1\_rom](#structw1__rom) struct members to zero.
