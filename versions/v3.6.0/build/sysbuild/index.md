---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/sysbuild/index.html
...
[![Sysbuild architectural overview](https://docs.zephyrproject.org/3.6.0/_images/sysbuild.svg)](https://docs.zephyrproject.org/3.6.0/_images/sysbuild.svg)
...
The following example shows how to build [Hello World](../../samples/hello_world/README.md#hello-world) with MCUboot enabled,
...
```shell
cmake -Bbuild -GNinja -DBOARD=reel_board -DAPP_DIR=samples/hello_world -DSB_CONFIG_BOOTLOADER_MCUBOOT=y -DCONFIG_DEBUG_OPTIMIZATIONS=y -Dmcuboot_DEBUG_OPTIMIZATIONS=y share/sysbuild
ninja -Cbuild
```
...
When using [Trusted Firmware](../../services/tfm/build.md#tfm-build-system), this includes build
...
- A specific core on a physical board with a multi-core SoC, such as
  [nRF5340 DK](../../boards/arm/nrf5340dk_nrf5340/doc/index.md#nrf5340dk-nrf5340).
- A specific SoC on a physical board with multiple SoCs, such as
  [nRF9160 DK](../../boards/arm/nrf9160dk_nrf9160/doc/index.md#nrf9160dk-nrf9160) and [nRF9160 DK - nRF52840](../../boards/arm/nrf9160dk_nrf52840/doc/index.md#nrf9160dk-nrf52840).
...
File suffix support through the makevar:FILE\_SUFFIX is supported in sysbuild
