---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/cmake/index.html
...
[![Zephyr's build configuration phase](https://docs.zephyrproject.org/3.6.0/_images/build-config-phase.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-config-phase.svg)
...
:   `*.dts` (*devicetree source*) and `*.dtsi` (*devicetree source
    ...
    `build/zephyr/include/generated/devicetree_generated.h` header with
    preprocessor macros.
...
[![Zephyr's build stage I](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-1.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-1.svg)
...
[![Zephyr's build stage II](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-2.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-2.svg)
...
[![Zephyr's build stage III](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-3.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-3.svg)
...
[![Zephyr's build stage IV](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-4.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-4.svg)
...
[![Zephyr's intermediate binary post-process I](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-1.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-1.svg)
...
[![Zephyr's intermediate binary post-process II](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-2.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-2.svg)
...
[![Zephyr's intermediate binary post-process III](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-3.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-3.svg)
...
[![Zephyr's intermediate binary post-process IV](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-4.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-postprocess-4.svg)
...
[![Zephyr's build final stage](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-5.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-5.svg)
...
[![Zephyr's build final stage post-process](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-6.svg)](https://docs.zephyrproject.org/3.6.0/_images/build-build-phase-6.svg)
