---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/usb/snps,designware-usb.html
original_path: build/dts/api/bindings/usb/snps,designware-usb.html
---
...
```text
Synopsys Designware USB Controller node
```
...
may apply to the “snps,designware-usb” compatible.
