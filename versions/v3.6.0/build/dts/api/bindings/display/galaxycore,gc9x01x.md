---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/display/galaxycore,gc9x01x.html
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text RESET pin of the GC9X01X. If connected directly the MCU pin should be configured as active low. ```  This property is **required**. |
| `cmd-data-gpios` | `phandle-array` | ```text Data/Command pin of the GC9X01X is to be configured high(1) for data, low(0) for command. ```  This property is **required**. |
