---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pwm/microchip,xec-pwmbbled.html
...
| `clock-select` | `string` | ```text Clock source selection: 32 KHz is available in deep sleep. - PWM_BBLED_CLK_AHB: Clock source is the PLL based AHB clock - PWM_BBLED_CLK_SLOW: Clock source is the PLL based PCR slow clock - PWM_BBLED_CLK_32K: Clock source is the 32KHz domain ```  This property is **required**.  Legal values: `'PWM_BBLED_CLK_32K'`, `'PWM_BBLED_CLK_SLOW'`, `'PWM_BBLED_CLK_48M'` |
