---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pwm/nordic,nrf-pwm.html
original_path: build/dts/api/bindings/pwm/nordic,nrf-pwm.html
---
...
| `center-aligned` | `boolean` | ```text Set this to use center-aligned (up and down) counter mode. ``` |
