---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/atmel,sam-tc-qdec.html
...
```text
Atmel SAM Timer Counter (TC) QDEC node
```
