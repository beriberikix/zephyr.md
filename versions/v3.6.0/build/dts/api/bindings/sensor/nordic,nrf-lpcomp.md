---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/nordic,nrf-lpcomp.html
original_path: build/dts/api/bindings/sensor/nordic,nrf-lpcomp.html
---
...
```text
Nordic nRF family LPCOMP (Low-power Comparator)
```
