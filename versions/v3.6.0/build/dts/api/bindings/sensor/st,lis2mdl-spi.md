---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/st,lis2mdl-spi.html
...
| `spi-full-duplex` | `boolean` | ```text Enable SPI 4wires mode with separated MISO and MOSI lines ``` |
