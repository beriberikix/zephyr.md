---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/invensense,icm42688.html
...
| `accel-hz` | `int` | ```text Default frequency of accelerometer. (Unit - Hz) Maps to ACCEL_ODR field in ACCEL_CONFIG0 setting Power-on reset value is 1000. ```  Default value: `1000`  Legal values: `1`, `3`, `6`, `12`, `25`, `50`, `100`, `200`, `500`, `1000`, `2000`, `4000`, `8000`, `16000`, `32000` |
| `gyro-hz` | `int` | ```text Default frequency of gyroscope. (Unit - Hz) Maps to GYRO_ODR field in GYRO_CONFIG0 setting Power-on reset value is 1000. ```  Default value: `1000`  Legal values: `1`, `3`, `6`, `12`, `25`, `50`, `100`, `200`, `500`, `1000`, `2000`, `4000`, `8000`, `16000`, `32000` |
| `accel-fs` | `int` | ```text Default full scale of accelerometer. (Unit - g) Maps to ACCEL_FS_SEL field in ACCEL_CONFIG0 setting Power-on reset value is 16 ```  Default value: `16`  Legal values: `16`, `8`, `4`, `2` |
| `gyro-fs` | `int` | ```text Default full scale of gyroscope. (Unit - DPS) Maps to GYRO_FS_SEL field in GYRO_CONFIG0 setting Power-on reset value is 2000 ```  Default value: `2000`  Legal values: `2000`, `1000`, `500`, `250`, `125`, `63`, `31`, `16` |
