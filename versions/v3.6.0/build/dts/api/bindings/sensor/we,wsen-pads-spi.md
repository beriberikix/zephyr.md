---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/we,wsen-pads-spi.html
original_path: build/dts/api/bindings/sensor/we,wsen-pads-spi.html
---
...
| `drdy-gpios` | `phandle-array` | ```text Data-ready interrupt pin. Interrupt is active high by default. ``` |
| `odr` | `int` | ```text Sensor output data rate expressed in samples per second. Data rates supported by the chip are 0 (power down), 1, 10, 25, 50, 75, 100 and 200. ```  This property is **required**.  Legal values: `0`, `1`, `10`, `25`, `50`, `75`, `100`, `200` |
...
may apply to the “we,wsen-pads” compatible.
