---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/serial/nxp,imx-uart.html
original_path: build/dts/api/bindings/serial/nxp,imx-uart.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `modem-mode` | `int` | ```text Set the UART Port to modem mode 0 (dce) 64 (dte) ```  This property is **required**. |
| `rdc` | `int` | ```text Set the RDC permission for this peripheral ```  This property is **required**. |
...
may apply to the “nxp,imx-uart” compatible.
