---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/can/zephyr,native-linux-can.html
...
| Name | Type | Details |
| --- | --- | --- |
| `host-interface` | `string` | ```text Linux host interface name (e.g. zcan0, vcan0, can0, ...) ```  This property is **required**. |
