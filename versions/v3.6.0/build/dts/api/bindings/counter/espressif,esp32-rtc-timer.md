---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/counter/espressif,esp32-rtc-timer.html
original_path: build/dts/api/bindings/counter/espressif,esp32-rtc-timer.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `slow-clk-freq` | `int` | ```text The slow clock input frequency for the RTC Timer. ```  This property is **required**. |
...
may apply to the “espressif,esp32-rtc-timer” compatible.
