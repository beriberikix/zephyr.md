---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/efinix,vexriscv-sapphire.html
original_path: build/dts/api/bindings/cpu/efinix,vexriscv-sapphire.html
---
...
```text
VexRiscv core with the configuration as used in the Efinix Sapphire SoC
```
...
may apply to the “efinix,vexriscv-sapphire” compatible.
