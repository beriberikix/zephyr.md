---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/andes,andescore-v5.html
original_path: build/dts/api/bindings/cpu/andes,andescore-v5.html
---
...
```text
Andes Technology RISC-V core from the AndesCore v5 series
```
...
may apply to the “andestech,andescore-v5” compatible.
