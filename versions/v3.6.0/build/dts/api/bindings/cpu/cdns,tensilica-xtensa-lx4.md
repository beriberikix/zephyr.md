---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/cdns,tensilica-xtensa-lx4.html
original_path: build/dts/api/bindings/cpu/cdns,tensilica-xtensa-lx4.html
---
...
```text
Cadence Tensilica Xtensa LX4 CPU
```
...
may apply to the “cdns,tensilica-xtensa-lx4” compatible.
