---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/intel,niosv.html
original_path: build/dts/api/bindings/cpu/intel,niosv.html
---
...
```text
INTEL FPGA NIOSV Softcore Processor
```
...
may apply to the “intel,niosv” compatible.
