---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/microchip,mcp230xx.html
original_path: build/dts/api/bindings/gpio/microchip,mcp230xx.html
---
...
These property descriptions apply to “microchip,mcp230xx”
...
| `ngpios` | `int` | ```text Number of gpios supported by the chip. ```  This property is **required**.  Default value: `32`  Legal values: `8`, `16` |
...
may apply to the “microchip,mcp230xx” compatible.
