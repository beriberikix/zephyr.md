---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/rohm,bd8lb600fs.html
original_path: build/dts/api/bindings/gpio/rohm,bd8lb600fs.html
---
...
These property descriptions apply to “rohm,bd8lb600fs”
...
| `ngpios` | `int` | ```text Number of pins for the expander. This must be a multiple of 8. The number of pins also defines how many devices are daisy chained. Set to 8 for one instance without daisy chaining. ```  This property is **required**.  Default value: `32` |
