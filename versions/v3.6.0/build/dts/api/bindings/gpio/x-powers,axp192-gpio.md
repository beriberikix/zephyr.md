---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/x-powers,axp192-gpio.html
...
| `ngpios` | `int` | ```text Number of GPIOs available on axp192. ```  This property is **required**.  Default value: `32`  Constant value: `5` |
