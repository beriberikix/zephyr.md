---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/arm,mps2-fpgaio-gpio.html
original_path: build/dts/api/bindings/gpio/arm,mps2-fpgaio-gpio.html
---
...
```text
GPIO controller on ARM MPS2 FPGA
```
...
These property descriptions apply to “arm,mps2-fpgaio-gpio”
...
may apply to the “arm,mps2-fpgaio-gpio” compatible.
