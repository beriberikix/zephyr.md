---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/arm/atmel,sam0-sercom.html
original_path: build/dts/api/bindings/arm/atmel,sam0-sercom.html
---
...
```text
Atmel SAM0 multi-protocol (UART, SPI, I2C) SERCOM unit
```
...
may apply to the “atmel,sam0-sercom” compatible.
