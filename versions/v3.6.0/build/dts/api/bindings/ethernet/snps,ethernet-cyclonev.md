---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/snps,ethernet-cyclonev.html
original_path: build/dts/api/bindings/ethernet/snps,ethernet-cyclonev.html
---
...
```text
Ethernet driver for Cyclone V SoC
```
...
| Name | Type | Details |
| --- | --- | --- |
| `emac-index` | `int` | This property is **required**. |
...
may apply to the “snps,ethernet-cyclonev” compatible.
