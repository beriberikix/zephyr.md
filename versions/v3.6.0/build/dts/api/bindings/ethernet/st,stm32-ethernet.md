---
version: v3.6.0
source_url: https://docs.zephyrproject.org/3.6.0/build/dts/api/bindings/ethernet/st,stm32-ethernet.html
original_path: build/dts/api/bindings/ethernet/st,stm32-ethernet.html
---
...
may apply to the “st,stm32-ethernet” compatible.
