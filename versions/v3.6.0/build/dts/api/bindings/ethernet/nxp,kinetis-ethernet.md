---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/nxp,kinetis-ethernet.html
original_path: build/dts/api/bindings/ethernet/nxp,kinetis-ethernet.html
---
...
These property descriptions apply to “nxp,kinetis-ethernet”
...
| Name | Type | Details |
| --- | --- | --- |
| `phy-addr` | `int` | ```text Address of the phy controller ```  This property is **required**. |
| `reset-gpios` | `phandle-array` | ```text GPIO to reset PHY. Reset signal is assumed active low. ``` |
| `int-gpios` | `phandle-array` | ```text interrupt GPIO for PHY. Will be pulled high before reset is asserted. ``` |
...
may apply to the “nxp,kinetis-ethernet” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `speed` | `int` | ```text The speed of fixed link ```  This property is **required**.  Legal values: `100`, `10` |
| `full-duplex` | `boolean` | ```text The fixed link operates in full duplex mode ``` |
