---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32f105-pll2-clock.html
original_path: build/dts/api/bindings/clock/st,stm32f105-pll2-clock.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `mul` | `int` | ```text PLL multiplication factor for output clock ```  This property is **required**.  Legal values: `8`, `9`, `10`, `11`, `12`, `13`, `14`, `16`, `20` |
...
may apply to the “st,stm32f105-pll2-clock” compatible.
