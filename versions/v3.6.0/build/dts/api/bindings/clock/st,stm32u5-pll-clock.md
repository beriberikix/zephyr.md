---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32u5-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32u5-pll-clock.html
---
...
| `div-m` | `int` | ```text Prescaler for PLLx input clock Valid range: 1 - 16 ```  This property is **required**. |
| `mul-n` | `int` | ```text PLLx multiplication factor for VCO Valid range: 4 - 512 ```  This property is **required**. |
| `div-p` | `int` | ```text PLLx DIVP division factor Valid range: 1 - 128 ``` |
| `div-q` | `int` | ```text PLLx DIVQ division factor Valid range: 1 - 128 ``` |
| `div-r` | `int` | ```text PLLx DIVR division factor On PLL1, only division by 1 and even division values are allowed. No restrictions for PLL2 and PLL3 Valid range: 1 - 128 ```  This property is **required**. |
| `fracn` | `int` | ```text PLLx FRACN value Valid range: 0 - 8191 ``` |
