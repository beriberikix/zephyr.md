---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pinctrl/st,stm32-pinctrl.html
...
| Name | Type | Details |
| --- | --- | --- |
| `remap-pa11` | `boolean` | ```text Remaps the PA11 pin to operate as PA9 pin. Use of this property is restricted to STM32G0 SoCs. ``` |
| `remap-pa12` | `boolean` | ```text Remaps the PA12 pin to operate as PA10 pin. Use of this property is restricted to STM32G0 SoCs. ``` |
