---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pinctrl/snps,emsdp-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/snps,emsdp-pinctrl.html
---
...
These property descriptions apply to “snps,emsdp-pinctrl”
...
may apply to the “snps,emsdp-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text EMSDP pin's configuration (pin, IO function). ```  This property is **required**. |
