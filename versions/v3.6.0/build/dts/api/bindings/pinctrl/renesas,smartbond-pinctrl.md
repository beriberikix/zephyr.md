---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pinctrl/renesas,smartbond-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/renesas,smartbond-pinctrl.html
---
...
These property descriptions apply to “renesas,smartbond-pinctrl”
...
may apply to the “renesas,smartbond-pinctrl” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `pinmux` | `array` | ```text An array of pins sharing the same group properties. The pins should be defined using the SMARTBOND_PINMUX utility macro that encodes the port, pin and function. ```  This property is **required**. |
