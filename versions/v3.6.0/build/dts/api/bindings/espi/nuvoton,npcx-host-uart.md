---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/espi/nuvoton,npcx-host-uart.html
original_path: build/dts/api/bindings/espi/nuvoton,npcx-host-uart.html
---
...
```text
Nuvoton, NPCX-Host UART IO node
```
...
may apply to the “nuvoton,npcx-host-uart” compatible.
