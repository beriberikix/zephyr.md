---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/i2c/nxp,imx-lpi2c.html
original_path: build/dts/api/bindings/i2c/nxp,imx-lpi2c.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `bus-idle-timeout` | `int` | ```text Bus idle timeout in nanoseconds ``` |
...
may apply to the “nxp,imx-lpi2c” compatible.
