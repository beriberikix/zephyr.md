---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/i2c/silabs,gecko-i2c.html
original_path: build/dts/api/bindings/i2c/silabs,gecko-i2c.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `location-sda` | `array` | ```text SDA pin configuration defined as <location port pin> ```  This property is **required**. |
| `location-scl` | `array` | ```text SCL pin configuration defined as <location port pin> ```  This property is **required**. |
...
may apply to the “silabs,gecko-i2c” compatible.
