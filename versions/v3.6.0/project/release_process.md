---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/project/release_process.html
original_path: project/release_process.html
---
...
[![Release Cycle](https://docs.zephyrproject.org/3.6.0/_images/release_cycle.svg)](https://docs.zephyrproject.org/3.6.0/_images/release_cycle.svg)
...
[Official GitHub Wiki](https://github.com/zephyrproject-rtos/zephyr/wiki/Release-Management).
Information on previous releases can be found [here](../releases/index.md#zephyr-release-notes).
...
| Timeline | Checkpoint | Description | Owner |
| --- | --- | --- | --- |
...
| T-3W | Feature Freeze (RC1) | No new features, ONLY stabilization and cosmetic changes, bug and doc fixes are allowed. | Release Engineering |
| T-2W | 2nd Release Candidate | No new features, ONLY stabilization and cosmetic changes, bug and doc fixes are allowed. | Release Manager |
| T-1W | Hard Freeze (RC3) | Only blocker bug fixes, documentation and changes to release notes are allowed. Release notes need to be complete by this checkpoint. Release Criteria is met. | Release Manager |
...
- Tagging:
  ...
  - v[Major].[Minor].99 - A tag applied to main branch to signify that work on
    ...
    VERSION\_MAJOR/VERSION\_MINOR/PATCHLEVEL macros as defined for a
...
[![Releases](https://docs.zephyrproject.org/3.6.0/_images/release_flow.png)](https://docs.zephyrproject.org/3.6.0/_images/release_flow.png)
...
[![Long Term Support Release](https://docs.zephyrproject.org/3.6.0/_images/lts.svg)](https://docs.zephyrproject.org/3.6.0/_images/lts.svg)
...
Release CandidateFinal Release
...
1. Update the version variables in the [VERSION](https://github.com/zephyrproject-rtos/zephyr/blob/main/VERSION) file
   ...
   EXTRAVERSION = rc1
   ```
2. Post a PR with the updated [VERSION](https://github.com/zephyrproject-rtos/zephyr/blob/main/VERSION) file using
...
3. Tag and push the version, using an annotated tag:
   ...
   ```
4. Send an email to the mailing lists (`announce` and `devel`)
...
3. Tag and push the version, using two annotated tags:
   ...
   ```
4. Find the new `v1.11.0` tag at the top of the releases page and
...
5. Send an email to the mailing lists (`announce` and `devel`) with a link
   to the release
