---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/project/documentation.html
original_path: project/documentation.html
---
...
using custom \_doxygen\_ tags that reference requirements maintained somewhere
...
[Ztest framework](../develop/test/ztest.md#test-framework). Test documentation should only be done
