---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/project/dev_env_and_tools.html
...
![Pull request classes](https://docs.zephyrproject.org/3.6.0/_images/pull_request_classes.png)
...
[feature](proposals.md#feature-tracking).
...
Changes/Updates/Additions to existing [features](proposals.md#feature-tracking).

- *Feature request*

A request for a new [feature](proposals.md#feature-tracking).

- *Feature*

A [planned feature](proposals.md#feature-tracking) with a milestone.
...
The issue is to be discussed in the following [dev-review](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Group-Meetings#zephyr-dev-meeting) if time
permits.

- *TSC*

TSC stands for Technical Steering Committee. The issue is to be discussed in the
following [TSC meeting](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Group-Meetings#technical-steering-committee-tsc) if time permits.

- *Breaking API Change*

The issue or PR describes a breaking change to a stable API. See additional information
in [Introducing breaking API changes](../develop/api/api_lifecycle.md#breaking-api-changes).
