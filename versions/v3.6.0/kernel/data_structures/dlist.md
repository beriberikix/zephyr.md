---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/data_structures/dlist.html
...
![dlist example](https://docs.zephyrproject.org/3.6.0/_images/dlist.png)

A dlist containing three elements. Note that the list struct
appears as a fourth “element” in the list.

![single-element dlist example](https://docs.zephyrproject.org/3.6.0/_images/dlist-single.png)

An dlist containing just one element.

![dlist example](https://docs.zephyrproject.org/3.6.0/_images/dlist-empty.png)

An empty dlist.

## Doubly-linked List API Reference

*group* doubly-linked-list\_apis
