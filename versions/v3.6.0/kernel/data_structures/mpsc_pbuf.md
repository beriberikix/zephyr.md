---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/data_structures/mpsc_pbuf.html
...
`MPSC_PBUF_HDR` and remaining bits in the first word can be application
