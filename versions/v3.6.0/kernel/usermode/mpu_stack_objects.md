---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/usermode/mpu_stack_objects.html
original_path: kernel/usermode/mpu_stack_objects.html
---
...
Thread stacks are declared statically with [`K_THREAD_STACK_DEFINE()`](../services/threads/index.md#c.K_THREAD_STACK_DEFINE "K_THREAD_STACK_DEFINE").
...
will have [`CONFIG_MPU_REQUIRES_POWER_OF_TWO_ALIGNMENT`](../../kconfig.md#CONFIG_MPU_REQUIRES_POWER_OF_TWO_ALIGNMENT "CONFIG_MPU_REQUIRES_POWER_OF_TWO_ALIGNMENT") defined.
