---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/services/timing/clocks.html
...
:   System Clock APIs.
    ...
    :   Set system clock timeout.
        ...
        Informs the system clock driver that the next needed call to [sys\_clock\_announce()](#group__clock__apis_1gaa7d3b1bdb8d15c907aaafea3b96ac2b5) will not be until the specified number of ticks from the the current time have elapsed. Note that spurious calls to [sys\_clock\_announce()](#group__clock__apis_1gaa7d3b1bdb8d15c907aaafea3b96ac2b5)
    ...
    :   Hardware cycle counter.
        ...
        [arch\_k\_cycle\_get\_32()](../../../hardware/porting/arch.md#group__arch-timing_1ga9ee9f897ec750957de45bf8d43349d5e)) to implement the cycle counter, though the user-facing API is owned by the architecture, not the driver. The rate must match CONFIG\_SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC.
