---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-2.4.html
...
- The `<sys/util.h>` header has been promoted to a documented API with
  ...
  reference.
- The [`wdt_feed()`](../hardware/peripherals/watchdog.md#c.wdt_feed "wdt_feed") function will now return `-EAGAIN` if
...
- `<drivers/uart.h>` has seen its callbacks normalized.
  [`uart_callback_t`](../hardware/peripherals/uart.md#c.uart_callback_t "uart_callback_t") and [`uart_irq_callback_user_data_t`](../hardware/peripherals/uart.md#c.uart_irq_callback_user_data_t "uart_irq_callback_user_data_t")
  had their signature changed to add a struct device pointer as first parameter.
  `uart_irq_callback_t` has been removed. [`uart_callback_set()`](../hardware/peripherals/uart.md#c.uart_callback_set "uart_callback_set"),
  [`uart_irq_callback_user_data_set()`](../hardware/peripherals/uart.md#c.uart_irq_callback_user_data_set "uart_irq_callback_user_data_set") and [`uart_irq_callback_set()`](../hardware/peripherals/uart.md#c.uart_irq_callback_set "uart_irq_callback_set")
...
- `<drivers/ipm.h>` has seen its callback normalized.
  [`ipm_callback_t`](../hardware/peripherals/ipm.md#c.ipm_callback_t "ipm_callback_t") had its signature changed to add a struct device
  pointer as first parameter. [`ipm_register_callback()`](../hardware/peripherals/ipm.md#c.ipm_register_callback "ipm_register_callback") user code have
...
- The [`fs_open()`](../services/file_system/index.md#c.fs_open "fs_open") function now accepts open flags that are passed as
  a third parameter.
...
- `<include/bluetooth/gatt.h>` callback [`bt_gatt_attr_func_t()`](../connectivity/bluetooth/api/gatt.md#c.bt_gatt_attr_func_t "bt_gatt_attr_func_t") used by
  [`bt_gatt_foreach_attr()`](../connectivity/bluetooth/api/gatt.md#c.bt_gatt_foreach_attr "bt_gatt_foreach_attr") and [`bt_gatt_foreach_attr_type()`](../connectivity/bluetooth/api/gatt.md#c.bt_gatt_foreach_attr_type "bt_gatt_foreach_attr_type") has
