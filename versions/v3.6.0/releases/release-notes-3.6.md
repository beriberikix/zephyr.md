---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-3.6.html
...
- Major updates to the documentation of the [native simulator](../boards/posix/native_sim/doc/index.md#native-sim), clarifying
...
- Audio
  ...
  - Changed `bt_bap_scan_delegator_subgroup` to [`bt_bap_bass_subgroup`](../connectivity/bluetooth/api/bap.md#c.bt_bap_bass_subgroup "bt_bap_bass_subgroup") and
    made it independent of [`CONFIG_BT_BAP_SCAN_DELEGATOR`](../kconfig.md#CONFIG_BT_BAP_SCAN_DELEGATOR "CONFIG_BT_BAP_SCAN_DELEGATOR").
  - Modified [`bt_bap_stream_send()`](../connectivity/bluetooth/api/bap.md#c.bt_bap_stream_send "bt_bap_stream_send") to no longer take a timestamp as parameter,
    and added [`bt_bap_stream_send_ts()`](../connectivity/bluetooth/api/bap.md#c.bt_bap_stream_send_ts "bt_bap_stream_send_ts") that does.
  - Modified [`bt_cap_stream_send()`](../connectivity/bluetooth/api/cap.md#c.bt_cap_stream_send "bt_cap_stream_send") to no longer take a timestamp as parameter,
    and added [`bt_cap_stream_send_ts()`](../connectivity/bluetooth/api/cap.md#c.bt_cap_stream_send_ts "bt_cap_stream_send_ts") that does.
  ...
  - Added [`bt_csip_set_member_unregister()`](../connectivity/bluetooth/api/coordinated_sets.md#c.bt_csip_set_member_unregister "bt_csip_set_member_unregister") to unregister a CSIS instance.
...
- Host
  ...
  - Added `recycled()` callback to [`bt_conn_cb`](../connectivity/bluetooth/api/connection_mgmt.md#c.bt_conn_cb "bt_conn_cb"), which notifies listeners when a
  ...
  - Modified `bt_iso_chan_send()` to no longer take a timestamp as parameter,
    and added `bt_iso_chan_send_ts()` that does.
- Mesh
...
- Made these changes for native/POSIX boards:
  ...
  - The [simulated nrf5340 targets](../boards/posix/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim) now include the IPC and MUTEX peripherals,
  ...
  - The nrf\*\_bsim simulated targets now include models of the UART peripheral. It is now possible
    to connect a [nrf52\_bsim](../boards/posix/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) UART to another, or a UART in loopback, utilizing
...
- Added support for sysbuild setting a signing script (`SIGNING_SCRIPT`). See
  [Extending signing externally](../develop/west/sign.md#west-extending-signing) for details.
...
- CAN
  ...
  - Added system call [`can_get_mode()`](../hardware/peripherals/can/controller.md#c.can_get_mode "can_get_mode") for getting the current operation mode of a CAN
    controller.
  - Add system call [`can_get_transceiver()`](../hardware/peripherals/can/controller.md#c.can_get_transceiver "can_get_transceiver") for getting the CAN transceiver associated with
    a CAN controller.
...
- I2C
  ...
  - [`i2c_get_config()`](../hardware/peripherals/i2c.md#c.i2c_get_config "i2c_get_config") is now supported on the STM32 driver.
- I2S
...
- I3C
  ...
  - Added the ability to specify a start address when searching for a free I3C
    ...
    [`i3c_addr_slots_next_free_find()`](../hardware/peripherals/i3c.md#c.i3c_addr_slots_next_free_find "i3c_addr_slots_next_free_find").
  - Added a field named `num_xfer` in `i3c_msg` and
...
- Regulators
  ...
  - Added new API functions
    ...
    - [`regulator_set_active_discharge()`](../hardware/peripherals/regulators.md#c.regulator_set_active_discharge "regulator_set_active_discharge")
    - [`regulator_get_active_discharge()`](../hardware/peripherals/regulators.md#c.regulator_get_active_discharge "regulator_get_active_discharge")
...
- CoAP:
  ...
  - Changed [`coap_remove_observer()`](../connectivity/networking/api/coap.md#c.coap_remove_observer "coap_remove_observer") API function return type to bool.
  ...
  - Fixed NULL pointer dereference in [`coap_packet_remove_option()`](../connectivity/networking/api/coap.md#c.coap_packet_remove_option "coap_packet_remove_option").
  - Added CoAP observer/service network events using the Network Event subsystem.
  - Changed [`coap_pending_init()`](../connectivity/networking/api/coap.md#c.coap_pending_init "coap_pending_init") API function to take
    [`coap_transmission_parameters`](../connectivity/networking/api/coap.md#c.coap_transmission_parameters "coap_transmission_parameters") instead of retry count.
  - Added new API functions:

    - [`coap_get_transmission_parameters()`](../connectivity/networking/api/coap.md#c.coap_get_transmission_parameters "coap_get_transmission_parameters")
    - [`coap_set_transmission_parameters()`](../connectivity/networking/api/coap.md#c.coap_set_transmission_parameters "coap_set_transmission_parameters")
    - [`coap_handle_request_len()`](../connectivity/networking/api/coap.md#c.coap_handle_request_len "coap_handle_request_len")
    - [`coap_well_known_core_get_len()`](../connectivity/networking/api/coap.md#c.coap_well_known_core_get_len "coap_well_known_core_get_len")
    - [`coap_uri_path_match()`](../connectivity/networking/api/coap.md#c.coap_uri_path_match "coap_uri_path_match")
    - [`coap_packet_is_request()`](../connectivity/networking/api/coap.md#c.coap_packet_is_request "coap_packet_is_request")
    - [`coap_find_observer()`](../connectivity/networking/api/coap.md#c.coap_find_observer "coap_find_observer")
    - [`coap_find_observer_by_token()`](../connectivity/networking/api/coap.md#c.coap_find_observer_by_token "coap_find_observer_by_token")
    - [`coap_pendings_count()`](../connectivity/networking/api/coap.md#c.coap_pendings_count "coap_pendings_count")
    - [`coap_header_set_code()`](../connectivity/networking/api/coap.md#c.coap_header_set_code "coap_header_set_code")
- Connection Manager:
...
- IP:
  ...
  - It is now possible to have separate IPv4 TTL value and IPv6 hop limit value for
    ...
    [`setsockopt()`](../connectivity/networking/api/sockets.md#c.setsockopt "setsockopt") API.
  ...
  - Added support for setting peer IP address in [`net_pkt`](../connectivity/networking/api/net_pkt.md#c.net_pkt "net_pkt") structure
    for offloaded interfaces. This allows for [`recvfrom()`](../connectivity/networking/api/sockets.md#c.recvfrom "recvfrom") to return a
...
- Misc:
  ...
  - Added support for compile time network event handlers using the macro
    [`NET_MGMT_REGISTER_EVENT_HANDLER`](../connectivity/networking/api/net_mgmt.md#c.NET_MGMT_REGISTER_EVENT_HANDLER "NET_MGMT_REGISTER_EVENT_HANDLER").
...
- MQTT-SN:
  ...
  - Added [`mqtt_sn_get_topic_name()`](../connectivity/networking/api/mqtt_sn.md#c.mqtt_sn_get_topic_name "mqtt_sn_get_topic_name") API function.
...
- Sockets:
  ...
  - Added support for v4-mapping-to-v6, which allows IPv4 and IPv6 to share the
    same port space.
  - Added support for [`IPV6_V6ONLY`](../connectivity/networking/api/sockets.md#c.IPV6_V6ONLY "IPV6_V6ONLY") socket option.
  - Added support for [`SO_ERROR`](../connectivity/networking/api/sockets.md#c.SO_ERROR "SO_ERROR") socket option.
  - Fixed [`select()`](../connectivity/networking/api/sockets.md#c.select "select") not setting `writefds` in case of errors.
  - Added support for object core, which allows to track networks sockets and
    their statistics.
  - Added support for [`recvmsg()`](../connectivity/networking/api/sockets.md#c.recvmsg "recvmsg").
  - Added support for [`IP_PKTINFO`](../connectivity/networking/api/sockets.md#c.IP_PKTINFO "IP_PKTINFO") and [`IPV6_RECVPKTINFO`](../connectivity/networking/api/sockets.md#c.IPV6_RECVPKTINFO "IPV6_RECVPKTINFO")
    socket options.
  - Added support for [`IP_TTL`](../connectivity/networking/api/sockets.md#c.IP_TTL "IP_TTL") socket option.
  - Added support for IPv4 multicast [`IP_ADD_MEMBERSHIP`](../connectivity/networking/api/sockets.md#c.IP_ADD_MEMBERSHIP "IP_ADD_MEMBERSHIP") and
    [`IP_DROP_MEMBERSHIP`](../connectivity/networking/api/sockets.md#c.IP_DROP_MEMBERSHIP "IP_DROP_MEMBERSHIP") socket options.
  - Added support for IPv6 multicast [`IPV6_ADD_MEMBERSHIP`](../connectivity/networking/api/sockets.md#c.IPV6_ADD_MEMBERSHIP "IPV6_ADD_MEMBERSHIP") and
    [`IPV6_DROP_MEMBERSHIP`](../connectivity/networking/api/sockets.md#c.IPV6_DROP_MEMBERSHIP "IPV6_DROP_MEMBERSHIP") socket options.
  - Improved doxygen documentation of BSD socket API.
  - Fixed POLLERR error reporting in TLS sockets.
  - Fixed DTLS handshake processing during [`poll()`](../connectivity/networking/api/sockets.md#c.poll "poll").
  - Aligned DTLS socket [`connect()`](../connectivity/networking/api/sockets.md#c.connect "connect") behavior with regular TLS (handshake
    during connect call).
  ...
  - Added support for [`SO_DOMAIN`](../connectivity/networking/api/sockets.md#c.SO_DOMAIN "SO_DOMAIN") socket option.
  - Fixed DTLS connection timeout when monitoring socket with [`poll()`](../connectivity/networking/api/sockets.md#c.poll "poll").
...
- TCP:
  ...
  - TCP stack now replies with RST packet in response to connection attempt on
    a closed port.
  - Fixed remote address passed in [`accept()`](../connectivity/networking/api/sockets.md#c.accept "accept") call.
...
>   the macro [`SPI_CONFIG_DT`](../hardware/peripherals/spi.md#c.SPI_CONFIG_DT "SPI_CONFIG_DT") in order to set SPI mode in a Devicetree file.
...
- Management
  ...
  - Fixed an issue whereby messages that were too large to be sent over the UDP transport would
    wrongly return [`MGMT_ERR_EINVAL`](../services/device_mgmt/mcumgr.md#c.mcumgr_err_t.MGMT_ERR_EINVAL "MGMT_ERR_EINVAL") instead of [`MGMT_ERR_EMSGSIZE`](../services/device_mgmt/mcumgr.md#c.mcumgr_err_t.MGMT_ERR_EMSGSIZE "MGMT_ERR_EMSGSIZE").
...
- Logging
  ...
  - Fixed userspace issue for `printk()` when [`CONFIG_LOG_PRINTK`](../kconfig.md#CONFIG_LOG_PRINTK "CONFIG_LOG_PRINTK") is enabled.
...
- Modem modules
  ...
  - Added `TRANSMIT_IDLE` event to the `modem_pipe` module which notifies the user of the pipe
    ...
    [`modem_pipe_transmit()`](../services/modem/index.md#c.modem_pipe_transmit "modem_pipe_transmit").
    The event greatly increases the efficiency of transmitting large quantities of data if used to
    dynamically manage the delay between calls to [`modem_pipe_transmit()`](../services/modem/index.md#c.modem_pipe_transmit "modem_pipe_transmit").
  ...
  - Extended all modem modules to utilize the `TRANSMIT_IDLE` event to dynamically manage the delay
    between calls to [`modem_pipe_transmit()`](../services/modem/index.md#c.modem_pipe_transmit "modem_pipe_transmit"). This addition reduced the utilization of the
    ...
    relentless, continuous calls to [`modem_pipe_transmit()`](../services/modem/index.md#c.modem_pipe_transmit "modem_pipe_transmit")).
  - Improved `modem_pipe` event dispatching. The `modem_pipe` module now invokes the
    `RECEIVE_READY` event every time the pipe is attached using [`modem_pipe_attach()`](../services/modem/index.md#c.modem_pipe_attach "modem_pipe_attach")
...
- Picolibc
  ...
  - Updated to version 1.8.6. This removes the `_POSIX_C_SOURCE` definition from the build
    ...
    requirements.
  - Added new `printf()` modes, [`CONFIG_PICOLIBC_IO_LONG_LONG`](../kconfig.md#CONFIG_PICOLIBC_IO_LONG_LONG "CONFIG_PICOLIBC_IO_LONG_LONG") and
  ...
  - Added [`CONFIG_PICOLIBC_ASSERT_VERBOSE`](../kconfig.md#CONFIG_PICOLIBC_ASSERT_VERBOSE "CONFIG_PICOLIBC_ASSERT_VERBOSE"). This option, which is false by default,
    controls whether the `assert()` function displays verbose information, including the file
...
- Power management
  ...
  - [`pm_device_runtime_put_async()`](../services/pm/api/index.md#c.pm_device_runtime_put_async "pm_device_runtime_put_async") got a parameter to specify a minimum delay to
  ...
  - Optimizations in device runtime power management. [`pm_device_runtime_get()`](../services/pm/api/index.md#c.pm_device_runtime_get "pm_device_runtime_get") and
    [`pm_device_runtime_put()`](../services/pm/api/index.md#c.pm_device_runtime_put "pm_device_runtime_put") no longer wait for a pending operation to be concluded if it is still
...
- [native\_sim](../boards/posix/native_sim/doc/index.md#native-sim) has replaced [native\_posix](../boards/posix/native_posix/doc/index.md#native-posix) as the default
  test platform.
  [native\_posix](../boards/posix/native_posix/doc/index.md#native-posix) remains supported and used in testing but will be deprecated
  in a future release.
- Bluetooth split stacks tests, where the BT host and controller are run in separate MCUs, are
  now run in CI based on the [nrf5340\_bsim](../boards/posix/nrf_bsim/doc/nrf5340bsim.md#nrf5340bsim) targets.
...
- Runtime UART tests have been added to CI based on the [nrf52\_bsim](../boards/posix/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim) target.
...
- Added ESP32 memory-mapped flash access sample in [ESP32 Flash Memory-Mapped](../samples/boards/esp32/flash_memory_mapped/README.md#esp32-flash-memory-mapped "Write data into scratch area and read it using flash API and memory-mapped pointer.").
