---
version: v3.6.0
source_url: https://docs.zephyrproject.org/3.6.0/releases/release-notes-3.3.html
...
- Emulator creation APIs have changed to better match
  [`DEVICE_DT_DEFINE`](../kernel/drivers/index.md#c.DEVICE_DT_DEFINE "DEVICE_DT_DEFINE"). It also includes a new backend API pointer to
...
- [xtools toolchain variant](../develop/toolchains/crosstool_ng.md#toolchain-xtools) is now deprecated. When using a
...
- C++ library Kconfig options have been renamed to improve consistency. See
  ...
  | --- | --- |
  | [`CONFIG_CPLUSPLUS`](../kconfig.md#CONFIG_CPLUSPLUS "CONFIG_CPLUSPLUS") | [`CONFIG_CPP`](../kconfig.md#CONFIG_CPP "CONFIG_CPP") |
  | [`CONFIG_EXCEPTIONS`](../kconfig.md#CONFIG_EXCEPTIONS "CONFIG_EXCEPTIONS") | [`CONFIG_CPP_EXCEPTIONS`](../kconfig.md#CONFIG_CPP_EXCEPTIONS "CONFIG_CPP_EXCEPTIONS") |
  | [`CONFIG_RTTI`](../kconfig.md#CONFIG_RTTI "CONFIG_RTTI") | [`CONFIG_CPP_RTTI`](../kconfig.md#CONFIG_CPP_RTTI "CONFIG_CPP_RTTI") |
  | [`CONFIG_LIB_CPLUSPLUS`](../kconfig.md#CONFIG_LIB_CPLUSPLUS "CONFIG_LIB_CPLUSPLUS") | [`CONFIG_LIBCPP_IMPLEMENTATION`](../kconfig.md#CONFIG_LIBCPP_IMPLEMENTATION "CONFIG_LIBCPP_IMPLEMENTATION") |
- MCUmgr subsystem, specifically the SMP transport API, is dropping zephyr\_
  ...
  is now replaced with [`smp_transport`](../services/device_mgmt/smp_transport.md#c.smp_transport "smp_transport"), and the later one is used,
  ...
  | --- | --- |
  | `zephyr_smp_transport_init()` | [`smp_transport_init()`](../services/device_mgmt/smp_transport.md#c.smp_transport_init "smp_transport_init") |
  ...
  | Deprecated | Drop in replacement |
  | --- | --- |
  | `zephyr_smp_transport_out_fn()` | [`smp_transport_out_fn()`](../services/device_mgmt/smp_transport.md#c.smp_transport_out_fn "smp_transport_out_fn") |
  | `zephyr_smp_transport_get_mtu_fn()` | [`smp_transport_get_mtu_fn()`](../services/device_mgmt/smp_transport.md#c.smp_transport_get_mtu_fn "smp_transport_get_mtu_fn") |
  | `zephyr_smp_transport_ud_copy_fn()` | [`smp_transport_ud_copy_fn()`](../services/device_mgmt/smp_transport.md#c.smp_transport_ud_copy_fn "smp_transport_ud_copy_fn") |
  | `zephyr_smp_transport_ud_free_fn()` | [`smp_transport_ud_free_fn()`](../services/device_mgmt/smp_transport.md#c.smp_transport_ud_free_fn "smp_transport_ud_free_fn") |

  NOTE: Only functions are marked as `__deprecated`, type definitions are not.
- STM32 Ethernet Mac address Kconfig related symbols ([`CONFIG_ETH_STM32_HAL_RANDOM_MAC`](../kconfig.md#CONFIG_ETH_STM32_HAL_RANDOM_MAC "CONFIG_ETH_STM32_HAL_RANDOM_MAC"),
  [`CONFIG_ETH_STM32_HAL_MAC4`](../kconfig.md#CONFIG_ETH_STM32_HAL_MAC4 "CONFIG_ETH_STM32_HAL_MAC4"), …) have been deprecated in favor
...
- STM32 RTC source clock should now be configured using devicetree.
  Related Kconfig [`CONFIG_COUNTER_RTC_STM32_CLOCK_LSI`](../kconfig.md#CONFIG_COUNTER_RTC_STM32_CLOCK_LSI "CONFIG_COUNTER_RTC_STM32_CLOCK_LSI") and
  [`CONFIG_COUNTER_RTC_STM32_CLOCK_LSE`](../kconfig.md#CONFIG_COUNTER_RTC_STM32_CLOCK_LSE "CONFIG_COUNTER_RTC_STM32_CLOCK_LSE") options are now
  deprecated.
...
- File backend for settings APIs and Kconfig options were deprecated:
  ...
  [`CONFIG_SETTINGS_FS`](../kconfig.md#CONFIG_SETTINGS_FS "CONFIG_SETTINGS_FS") in favor of [`CONFIG_SETTINGS_FILE`](../kconfig.md#CONFIG_SETTINGS_FILE "CONFIG_SETTINGS_FILE")

  [`CONFIG_SETTINGS_FS_DIR`](../kconfig.md#CONFIG_SETTINGS_FS_DIR "CONFIG_SETTINGS_FS_DIR") in favor of creating all parent
  directories from [`CONFIG_SETTINGS_FILE_PATH`](../kconfig.md#CONFIG_SETTINGS_FILE_PATH "CONFIG_SETTINGS_FILE_PATH")

  [`CONFIG_SETTINGS_FS_FILE`](../kconfig.md#CONFIG_SETTINGS_FS_FILE "CONFIG_SETTINGS_FS_FILE") in favor of [`CONFIG_SETTINGS_FILE_PATH`](../kconfig.md#CONFIG_SETTINGS_FILE_PATH "CONFIG_SETTINGS_FILE_PATH")

  [`CONFIG_SETTINGS_FS_MAX_LINES`](../kconfig.md#CONFIG_SETTINGS_FS_MAX_LINES "CONFIG_SETTINGS_FS_MAX_LINES") in favor of [`CONFIG_SETTINGS_FILE_MAX_LINES`](../kconfig.md#CONFIG_SETTINGS_FILE_MAX_LINES "CONFIG_SETTINGS_FILE_MAX_LINES")
- PCIe APIs [`pcie_probe()`](../hardware/peripherals/pcie.md#c.pcie_probe "pcie_probe") and [`pcie_bdf_lookup()`](../hardware/peripherals/pcie.md#c.pcie_bdf_lookup "pcie_bdf_lookup") have been
...
- POSIX API
  ...
  >   standard `PTHREAD_COND_INITIALIZER` and `PTHREAD_MUTEX_INITIALIZER`.
...
- SPI DT [`spi_is_ready()`](../hardware/peripherals/spi.md#c.spi_is_ready "spi_is_ready") function has been deprecated in favor of [`spi_is_ready_dt()`](../hardware/peripherals/spi.md#c.spi_is_ready_dt "spi_is_ready_dt").
...
- [`net_pkt_get_frag()`](../connectivity/networking/api/net_pkt.md#c.net_pkt_get_frag "net_pkt_get_frag"), [`net_pkt_get_reserve_tx_data()`](../connectivity/networking/api/net_pkt.md#c.net_pkt_get_reserve_tx_data "net_pkt_get_reserve_tx_data") and
  [`net_pkt_get_reserve_rx_data()`](../connectivity/networking/api/net_pkt.md#c.net_pkt_get_reserve_rx_data "net_pkt_get_reserve_rx_data") functions are now requiring to specify
...
- RISC-V
  ...
  - Converted [`CONFIG_MP_NUM_CPUS`](../kconfig.md#CONFIG_MP_NUM_CPUS "CONFIG_MP_NUM_CPUS") to
  ...
  - Added support for hardware register stacking/unstacking during ISRs and
    exceptions.
  - Added support for overriding [`arch_irq_lock()`](../hardware/porting/arch.md#c.arch_irq_lock "arch_irq_lock"),
    [`arch_irq_unlock()`](../hardware/porting/arch.md#c.arch_irq_unlock "arch_irq_unlock") and [`arch_irq_unlocked()`](../hardware/porting/arch.md#c.arch_irq_unlocked "arch_irq_unlocked").
...
- Host
  ...
  - Added the local advertising address to [`bt_le_ext_adv_get_info()`](../connectivity/bluetooth/api/gap.md#c.bt_le_ext_adv_get_info "bt_le_ext_adv_get_info").
  - Improved the implementation of [`bt_disable()`](../connectivity/bluetooth/api/gap.md#c.bt_disable "bt_disable") to handle additional
    edge cases.
  - Removed all Bluetooth-specific logging macros and functionality, switching
    instead to the OS-wide ones.
  - Added a new [`bt_le_per_adv_sync_lookup_index()`](../connectivity/bluetooth/api/gap.md#c.bt_le_per_adv_sync_lookup_index "bt_le_per_adv_sync_lookup_index") function.
...
- ADC
  ...
  - Fixed a problem in [`ADC_CHANNEL_CFG_DT`](../hardware/peripherals/adc.md#c.ADC_CHANNEL_CFG_DT "ADC_CHANNEL_CFG_DT") that forced users to add
...
- DFU
  ...
  - Removed `BOOT_TRAILER_IMG_STATUS_OFFS` in favor a two new functions;
    [`boot_get_area_trailer_status_offset()`](../services/device_mgmt/dfu.md#c.boot_get_area_trailer_status_offset "boot_get_area_trailer_status_offset") and [`boot_get_trailer_status_offset()`](../services/device_mgmt/dfu.md#c.boot_get_trailer_status_offset "boot_get_trailer_status_offset")
- Disk
...
- I3C
  ...
  - Added a new target device API [`i3c_target_tx_write()`](../hardware/peripherals/i3c.md#c.i3c_target_tx_write "i3c_target_tx_write") to
    explicit write to TX FIFO.
  - GETMRL and GETMWL are both optional in [`i3c_device_basic_info_get()`](../hardware/peripherals/i3c.md#c.i3c_device_basic_info_get "i3c_device_basic_info_get") as
...
- PCIE
  ...
  - Added new API [`pcie_scan()`](../hardware/peripherals/pcie.md#c.pcie_scan "pcie_scan") to scan for devices.
    ...
    - This iterates through the buses and devices which are expected to
      ...
      `pci_init()` and [`pcie_bdf_lookup()`](../hardware/peripherals/pcie.md#c.pcie_bdf_lookup "pcie_bdf_lookup") have been updated to
      use this new API.
    - [`pcie_scan()`](../hardware/peripherals/pcie.md#c.pcie_scan "pcie_scan") also introduces a callback mechanism for when
...
- Sensor
  ...
  - Refactored all drivers to use [`SENSOR_DEVICE_DT_INST_DEFINE`](../hardware/peripherals/sensor.md#c.SENSOR_DEVICE_DT_INST_DEFINE "SENSOR_DEVICE_DT_INST_DEFINE") to
...
- USB
  ...
  - STM32: Now supports [`usb_dc_detach()`](../connectivity/usb/device/api/usb_dc.md#c.usb_dc_detach "usb_dc_detach") and [`usb_dc_wakeup_request()`](../connectivity/usb/device/api/usb_dc.md#c.usb_dc_wakeup_request "usb_dc_wakeup_request").
...
- HTTP:
  ...
  - Used [`zsock_poll()`](../connectivity/networking/api/sockets.md#c.zsock_poll "zsock_poll") for HTTP timeout instead of a delayed work.
- ICMPv4:
...
- IEEE802154:
  ...
  - Decoupled IEEE802154 parameters from [`net_pkt`](../connectivity/networking/api/net_pkt.md#c.net_pkt "net_pkt") into
...
- LwM2M:
  ...
  - Renamed `LWM2M_RD_CLIENT_EVENT_REG_UPDATE_FAILURE` to
    [`LWM2M_RD_CLIENT_EVENT_REG_TIMEOUT`](../connectivity/networking/api/lwm2m.md#c.lwm2m_rd_client_event.LWM2M_RD_CLIENT_EVENT_REG_TIMEOUT "LWM2M_RD_CLIENT_EVENT_REG_TIMEOUT"). This event is now used in case
  ...
  - Deprecated [`CONFIG_LWM2M_RD_CLIENT_SUPPORT`](../kconfig.md#CONFIG_LWM2M_RD_CLIENT_SUPPORT "CONFIG_LWM2M_RD_CLIENT_SUPPORT"), as it’s now
  ...
  - Deprecated string based LwM2M APIs. LwM2M APIs now use
    [`lwm2m_obj_path`](../connectivity/networking/api/lwm2m.md#c.lwm2m_obj_path "lwm2m_obj_path") to represent object/resource paths.
...
- Misc:
  ...
  - Fixed cloning of LL address for [`net_pkt`](../connectivity/networking/api/net_pkt.md#c.net_pkt "net_pkt").
...
- OpenThread:
  ...
  - Deprecated [`openthread_set_state_changed_cb()`](../connectivity/networking/api/thread.md#c.openthread_set_state_changed_cb "openthread_set_state_changed_cb") in favour of more
    generic [`openthread_state_changed_cb_register()`](../connectivity/networking/api/thread.md#c.openthread_state_changed_cb_register "openthread_state_changed_cb_register").
...
- [`DT_FOREACH_PROP_ELEM_SEP_VARGS`](../build/dts/api/api.md#c.DT_FOREACH_PROP_ELEM_SEP_VARGS "DT_FOREACH_PROP_ELEM_SEP_VARGS")
- [`DT_FOREACH_PROP_ELEM_SEP`](../build/dts/api/api.md#c.DT_FOREACH_PROP_ELEM_SEP "DT_FOREACH_PROP_ELEM_SEP")
- [`DT_INST_FOREACH_PROP_ELEM_SEP_VARGS`](../build/dts/api/api.md#c.DT_INST_FOREACH_PROP_ELEM_SEP_VARGS "DT_INST_FOREACH_PROP_ELEM_SEP_VARGS")
- [`DT_INST_FOREACH_PROP_ELEM_SEP`](../build/dts/api/api.md#c.DT_INST_FOREACH_PROP_ELEM_SEP "DT_INST_FOREACH_PROP_ELEM_SEP")
- [`DT_INST_GPARENT`](../build/dts/api/api.md#c.DT_INST_GPARENT "DT_INST_GPARENT")
...
- [`DT_GPIO_HOG_FLAGS_BY_IDX`](../build/dts/api/api.md#c.DT_GPIO_HOG_FLAGS_BY_IDX "DT_GPIO_HOG_FLAGS_BY_IDX")
- [`DT_GPIO_HOG_PIN_BY_IDX`](../build/dts/api/api.md#c.DT_GPIO_HOG_PIN_BY_IDX "DT_GPIO_HOG_PIN_BY_IDX")
- [`DT_NUM_GPIO_HOGS`](../build/dts/api/api.md#c.DT_NUM_GPIO_HOGS "DT_NUM_GPIO_HOGS")
...
>
>   - [`atmel,samc2x-gclk`](../build/dts/api/bindings/clock/atmel,samc2x-gclk.md#std-dtcompatible-atmel-samc2x-gclk)
>   - [`atmel,samc2x-mclk`](../build/dts/api/bindings/clock/atmel,samc2x-mclk.md#std-dtcompatible-atmel-samc2x-mclk)
...
>   - [`invensense,icp10125`](../build/dts/api/bindings/sensor/invensense,icp10125.md#std-dtcompatible-invensense-icp10125)
> - ITE Tech. Inc. (ite):
>
...
>
>   - [`lowrisc,machine-timer`](../build/dts/api/bindings/timer/lowrisc,machine-timer.md#std-dtcompatible-lowrisc-machine-timer)
...
>
>   - [`nxp,css-v2`](../build/dts/api/bindings/rng/nxp,css-v2.md#std-dtcompatible-nxp-css-v2)
...
>   - [`raspberrypi,pico-temp`](../build/dts/api/bindings/sensor/raspberrrypi,pico-temp.md#std-dtcompatible-raspberrypi-pico-temp)
...
> - NXP Semiconductors (nxp):
>
>   - [`nxp,kinetis-lpuart`](../build/dts/api/bindings/serial/nxp,kinetis-lpuart.md#std-dtcompatible-nxp-kinetis-lpuart):
>
...
>
>     > - property `peripheral-id` is no longer required
>   - [`silabs,gecko-spi-usart`](../build/dts/api/bindings/spi/silabs,gecko-spi-usart.md#std-dtcompatible-silabs-gecko-spi-usart):
>
>     > - new property: `pinctrl-0`
>     > - new property: `pinctrl-1`
>     > - new property: `pinctrl-2`
...
- C++ Library
  ...
  - [`CONFIG_CPLUSPLUS`](../kconfig.md#CONFIG_CPLUSPLUS "CONFIG_CPLUSPLUS") has been renamed to
    [`CONFIG_CPP`](../kconfig.md#CONFIG_CPP "CONFIG_CPP").
  - [`CONFIG_EXCEPTIONS`](../kconfig.md#CONFIG_EXCEPTIONS "CONFIG_EXCEPTIONS") has been renamed to
    [`CONFIG_CPP_EXCEPTIONS`](../kconfig.md#CONFIG_CPP_EXCEPTIONS "CONFIG_CPP_EXCEPTIONS").
  - [`CONFIG_RTTI`](../kconfig.md#CONFIG_RTTI "CONFIG_RTTI") has been renamed to
    [`CONFIG_CPP_RTTI`](../kconfig.md#CONFIG_CPP_RTTI "CONFIG_CPP_RTTI").
  - [`CONFIG_LIB_CPLUSPLUS`](../kconfig.md#CONFIG_LIB_CPLUSPLUS "CONFIG_LIB_CPLUSPLUS") is deprecated. A toolchain-specific
  ...
  - Introduced [`CONFIG_CPP_MAIN`](../kconfig.md#CONFIG_CPP_MAIN "CONFIG_CPP_MAIN") to support defining `main()`
...
- File systems
  ...
  - Added the option to disable CRC checking in [Flash Circular Buffer (FCB)](../services/storage/fcb/fcb.md#fcb-api) by enabling the
    ...
    and setting the FCB\_FLAGS\_CRC\_DISABLED flag in the [`fcb`](../services/storage/fcb/fcb.md#c.fcb "fcb") struct.
- IPC

  - Added `ipc_rpmsg_deinit()`, [`ipc_service_close_instance()`](../services/ipc/ipc_service/ipc_service.md#c.ipc_service_close_instance "ipc_service_close_instance") and
    `ipc_static_vrings_deinit()` functions
...
- Management
  ...
  - UpdateHub:
    ...
    - The UpdateHub User API was moved as a Zephyr public API and the userspace
      now is available. This added `updatehub_confirm()` and
      `updatehub_reboot()` functions.
- LwM2M
...
- POSIX API
  ...
  - Harmonized posix type definitions across the minimal libc, newlib and picolibc.
    ...
    - Defined `PTHREAD_KEY_INITIALIZER`, `PTHREAD_COND_INITIALIZER`,
      `PTHREAD_MUTEX_INITIALIZER` to align with POSIX 1003.1.
  ...
  - Moved / renamed header files to align with POSIX specifications.
    ...
    - Move `O_ACCMODE`, `O_RDONLY`, `O_WRONLY`,
      `O_WRONLY`, to `fcntl.h`.
...
- Settings
  ...
  - Replaced all `k_panic()` invocations within settings backend
...
- Zbus
  ...
  - Added the [Zephyr bus (zbus)](../services/zbus/index.md#zbus) to Zephyr.
    ...
    - Added zbus channels APIs:
      ...
      - [`zbus_chan_pub()`](../services/zbus/index.md#c.zbus_chan_pub "zbus_chan_pub")
      - [`zbus_chan_read()`](../services/zbus/index.md#c.zbus_chan_read "zbus_chan_read")
      - [`zbus_chan_notify()`](../services/zbus/index.md#c.zbus_chan_notify "zbus_chan_notify")
      - [`zbus_chan_claim()`](../services/zbus/index.md#c.zbus_chan_claim "zbus_chan_claim")
      - [`zbus_chan_finish()`](../services/zbus/index.md#c.zbus_chan_finish "zbus_chan_finish")
      - [`zbus_chan_name()`](../services/zbus/index.md#c.zbus_chan_name "zbus_chan_name")
      - [`zbus_chan_msg()`](../services/zbus/index.md#c.zbus_chan_msg "zbus_chan_msg")
      - [`zbus_chan_const_msg()`](../services/zbus/index.md#c.zbus_chan_const_msg "zbus_chan_const_msg")
      - [`zbus_chan_msg_size()`](../services/zbus/index.md#c.zbus_chan_msg_size "zbus_chan_msg_size")
      - [`zbus_chan_user_data()`](../services/zbus/index.md#c.zbus_chan_user_data "zbus_chan_user_data")
      - [`zbus_chan_add_obs()`](../services/zbus/index.md#c.zbus_chan_add_obs "zbus_chan_add_obs")
      - [`zbus_chan_rm_obs()`](../services/zbus/index.md#c.zbus_chan_rm_obs "zbus_chan_rm_obs")
      - `zbus_runtime_obs_pool()`
      - [`zbus_obs_set_enable()`](../services/zbus/index.md#c.zbus_obs_set_enable "zbus_obs_set_enable")
      - [`zbus_obs_name()`](../services/zbus/index.md#c.zbus_obs_name "zbus_obs_name")
      - [`zbus_sub_wait()`](../services/zbus/index.md#c.zbus_sub_wait "zbus_sub_wait")
      - [`zbus_iterate_over_channels()`](../services/zbus/index.md#c.zbus_iterate_over_channels "zbus_iterate_over_channels")
      - [`zbus_iterate_over_observers()`](../services/zbus/index.md#c.zbus_iterate_over_observers "zbus_iterate_over_observers")
...
- Flash Map API drops `fa_device_id` from [`flash_area`](../services/storage/flash_map/flash_map.md#c.flash_area "flash_area"), as it
...
- In the zcbor codebase, the `ARRAY_SIZE` macro has been renamed to
  `ZCBOR_ARRAY_SIZE` to not collide with Zephyr’s [`ARRAY_SIZE`](../kernel/util/index.md#c.ARRAY_SIZE "ARRAY_SIZE") macro.
...
- [GitHub #50665](https://github.com/zephyrproject-rtos/zephyr/issues/50665) - MEC15xx/MEC1501: UART and and special purpose pins missing pinctrl configuration
