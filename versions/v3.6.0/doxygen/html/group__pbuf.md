---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__pbuf.html
...
| Functions | |
| --- | --- |
| int | [pbuf\_init](#ga651cf4ad3dc69e5dc1a0cea9f06a084e) (struct [pbuf](structpbuf.md) \*pb) |
...
BUILD\_ASSERT((size) > 0 && [IS\_PTR\_ALIGNED\_BYTES](common_8h.md#accd51a2e6e0aacde1d3c7ad7497e40ec)(size, \_PBUF\_IDX\_SIZE), \

"Incorrect size."); \

BUILD\_ASSERT([IS\_PTR\_ALIGNED\_BYTES](common_8h.md#accd51a2e6e0aacde1d3c7ad7497e40ec)(mem\_addr, [MAX](group__sys-util.md#gafa99ec4acc4ecb2dc3c2d05da15d0e3f)(dcache\_align, \_PBUF\_IDX\_SIZE)), \
...
static const struct [pbuf\_cfg](structpbuf__cfg.md) cfg\_##name = \
...
[IS\_PTR\_ALIGNED\_BYTES](common_8h.md#accd51a2e6e0aacde1d3c7ad7497e40ec)
...
## [◆ ](#ga651cf4ad3dc69e5dc1a0cea9f06a084e)pbuf\_init()

| int pbuf\_init | ( | struct [pbuf](structpbuf.md) \* | *pb* | ) |  |
| --- | --- | --- | --- | --- | --- |
