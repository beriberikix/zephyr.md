---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/multi__heap_8h.html
...
| Typedefs | |
| --- | --- |
| typedef void \*(\* | [sys\_multi\_heap\_fn\_t](#a2d8ac07e590ef36ba6f35ae88235564e)) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, void \*cfg, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) align, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) size) |
|  | Multi-heap choice function. |

| Functions | |
| --- | --- |
| void | [sys\_multi\_heap\_init](#a50ded513b50c7aed7d89386bb8f425cc) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*heap, [sys\_multi\_heap\_fn\_t](#a2d8ac07e590ef36ba6f35ae88235564e) choice\_fn) |
|  | Initialize multi-heap. |
| void | [sys\_multi\_heap\_add\_heap](#acd6b92e8090a56e1eb59a18166d659d1) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, struct [sys\_heap](structsys__heap.md) \*heap, void \*user\_data) |
|  | Add [sys\_heap](structsys__heap.md) to multi heap. |
| void \* | [sys\_multi\_heap\_alloc](#a050d7499b982ed62f85d5fc15f79548b) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, void \*cfg, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) bytes) |
|  | Allocate memory from multi heap. |
| void \* | [sys\_multi\_heap\_aligned\_alloc](#a9f958dbfa86e12236b8e356375b8d04c) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, void \*cfg, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) align, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) bytes) |
|  | Allocate aligned memory from multi heap. |
| const struct [sys\_multi\_heap\_rec](structsys__multi__heap__rec.md) \* | [sys\_multi\_heap\_get\_heap](#ad98b78be5c0ed50e1e0715a15c289b3a) (const struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, void \*addr) |
|  | Get a specific heap for provided address. |
| void | [sys\_multi\_heap\_free](#ac6f913a3bbf247807ba80408a242db73) (struct [sys\_multi\_heap](structsys__multi__heap.md) \*mheap, void \*block) |
...
## [◆ ](#a2d8ac07e590ef36ba6f35ae88235564e)sys\_multi\_heap\_fn\_t
...
This is a user-provided functions whose responsibility is selecting a specific [sys\_heap](structsys__heap.md) backend based on the opaque cfg value, which is specified by the user as an argument to [sys\_multi\_heap\_alloc()](#a050d7499b982ed62f85d5fc15f79548b), and performing the allocation on behalf of the caller. The callback is free to choose any registered heap backend to perform the allocation, and may choose to pad the user-provided values as needed, and to use an aligned allocation where required by the specified configuration.
...
## [◆ ](#acd6b92e8090a56e1eb59a18166d659d1)sys\_multi\_heap\_add\_heap()
...
## [◆ ](#a9f958dbfa86e12236b8e356375b8d04c)sys\_multi\_heap\_aligned\_alloc()
...
Just as for [sys\_multi\_heap\_alloc()](#a050d7499b982ed62f85d5fc15f79548b), allocates a block of memory of the specified size in bytes. Takes an additional parameter specifying a power of two alignment, in bytes.

Parameters
:   | mheap | Multi heap pointer |
    | --- | --- |
    | cfg | Opaque configuration parameter, as for [sys\_multi\_heap\_fn\_t](#a2d8ac07e590ef36ba6f35ae88235564e) |
...
## [◆ ](#a050d7499b982ed62f85d5fc15f79548b)sys\_multi\_heap\_alloc()
...
Just as for [sys\_heap\_alloc()](sys__heap_8h.md#a6b8bdf02c9be5576fddbe711904a3aad "Allocate memory from a sys_heap."), allocates a block of memory of the specified size in bytes. Takes an opaque configuration pointer passed to the multi heap choice function, which is used by integration code to choose a heap backend.
...
## [◆ ](#ac6f913a3bbf247807ba80408a242db73)sys\_multi\_heap\_free()
...
Returns the specified block, which must be the return value of a previously successful [sys\_multi\_heap\_alloc()](#a050d7499b982ed62f85d5fc15f79548b) or [sys\_multi\_heap\_aligned\_alloc()](#a9f958dbfa86e12236b8e356375b8d04c) call, to the heap backend from which it was allocated.
...
## [◆ ](#ad98b78be5c0ed50e1e0715a15c289b3a)sys\_multi\_heap\_get\_heap()
...
## [◆ ](#a50ded513b50c7aed7d89386bb8f425cc)sys\_multi\_heap\_init()

| void sys\_multi\_heap\_init | ( | struct [sys\_multi\_heap](structsys__multi__heap.md) \* | *heap*, |
| --- | --- | --- | --- |
|  |  | [sys\_multi\_heap\_fn\_t](#a2d8ac07e590ef36ba6f35ae88235564e) | *choice\_fn* ) |
...
:   | heap | A [sys\_multi\_heap](structsys__multi__heap.md) to initialize |
    | --- | --- |
    | choice\_fn | A [sys\_multi\_heap\_fn\_t](#a2d8ac07e590ef36ba6f35ae88235564e) callback used to select heaps at allocation time |
