---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__shell__api.html
...
| void | [shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa) (const struct [shell](structshell.md) \*sh, enum [shell\_vt100\_color](shell__types_8h.md#a6dcf569be711db32286fb1ef2dcf36d2) color, const char \*fmt,...) |
...
static const struct [shell](structshell.md) \_name; \

static struct [shell\_ctx](structshell__ctx.md) [UTIL\_CAT](util__internal_8h.md#a7e7766e792d1638bfbbc9d0f328d3d0d)(\_name, \_ctx); \
...
Z\_SHELL\_LOG\_BACKEND\_DEFINE(\_name, \_name##\_out\_buffer, \

[CONFIG\_SHELL\_PRINTF\_BUFF\_SIZE](shell_2shell_8h.md#af54e892edba822e46ca70cb6eca48146), \

\_log\_queue\_size, \_log\_timeout); \

Z\_SHELL\_HISTORY\_DEFINE(\_name##\_history, [CONFIG\_SHELL\_HISTORY\_BUFFER](shell_2shell_8h.md#ab194ada3483ec28f093fd9521b19265e)); \

Z\_SHELL\_FPRINTF\_DEFINE(\_name##\_fprintf, &\_name, \_name##\_out\_buffer, \

[CONFIG\_SHELL\_PRINTF\_BUFF\_SIZE](shell_2shell_8h.md#af54e892edba822e46ca70cb6eca48146), \

true, z\_shell\_print\_stream); \

LOG\_INSTANCE\_REGISTER([shell](structshell.md), \_name, CONFIG\_SHELL\_LOG\_LEVEL); \

Z\_SHELL\_STATS\_DEFINE(\_name); \

static [K\_KERNEL\_STACK\_DEFINE](group__thread__stack__api.md#ga9e05e3cb5aa5b72d6f19e2f327313271)(\_name##\_stack, CONFIG\_SHELL\_STACK\_SIZE); \

static struct [k\_thread](structk__thread.md) \_name##\_thread; \

static const [STRUCT\_SECTION\_ITERABLE](group__iterable__section__apis.md#ga9104f42cbe4a67a931bed7f7cc8f600f)([shell](structshell.md), \_name) = { \

.default\_prompt = \_prompt, \

.iface = \_transport\_iface, \

.ctx = &[UTIL\_CAT](util__internal_8h.md#a7e7766e792d1638bfbbc9d0f328d3d0d)(\_name, \_ctx), \

.history = [IS\_ENABLED](group__sys-util.md#ga111fe4e9d63758262fc6810a782cb32a)(CONFIG\_SHELL\_HISTORY) ? \

&\_name##\_history : NULL, \

.shell\_flag = \_shell\_flag, \

.fprintf\_ctx = &\_name##\_fprintf, \

.stats = Z\_SHELL\_STATS\_PTR(\_name), \

.log\_backend = Z\_SHELL\_LOG\_BACKEND\_PTR(\_name), \

LOG\_INSTANCE\_PTR\_INIT(log, [shell](structshell.md), \_name) \
...
[CONFIG\_SHELL\_HISTORY\_BUFFER](shell_2shell_8h.md#ab194ada3483ec28f093fd9521b19265e)

#define CONFIG\_SHELL\_HISTORY\_BUFFER
...
[shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa)(\_sh, [SHELL\_ERROR](#ga7664f5e184e9b41ac92e033f7b8d885d), \_ft "\n", ##\_\_VA\_ARGS\_\_)

[SHELL\_ERROR](#ga7664f5e184e9b41ac92e033f7b8d885d)
...
[shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa)
...
.syntax = (\_expr) ? (const char \*)[STRINGIFY](common_8h.md#a4689212d5a549893cabb9d7782eecfb6)(\_syntax) : "", \
...
[shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa)(\_sh, [SHELL\_INFO](#gaac0ea96fbb5885432dca93174c9ad4e6), \_ft "\n", ##\_\_VA\_ARGS\_\_)

[SHELL\_INFO](#gaac0ea96fbb5885432dca93174c9ad4e6)
...
[shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa)(\_sh, [SHELL\_NORMAL](#ga4c3a7db0c2bdbf36bbf72302a04bb44d), \_ft "\n", ##\_\_VA\_ARGS\_\_)

[SHELL\_NORMAL](#ga4c3a7db0c2bdbf36bbf72302a04bb44d)

#define SHELL\_NORMAL

Terminal default text color for shell\_fprintf function.

**Definition** shell.h:968
...
[shell\_fprintf](#gaa02f857bd560e8d7a1ce7c54a418dcaa)(\_sh, [SHELL\_WARNING](#ga118dd6829e092423a85e2b6de07f8dd3), \_ft "\n", ##\_\_VA\_ARGS\_\_)

[SHELL\_WARNING](#ga118dd6829e092423a85e2b6de07f8dd3)

#define SHELL\_WARNING
...
## [◆ ](#gaa02f857bd560e8d7a1ce7c54a418dcaa)shell\_fprintf()

| void shell\_fprintf | ( | const struct [shell](structshell.md) \* | *sh*, |
| --- | --- | --- | --- |
...
This function can be used from the command handler or from threads, but not from an interrupt context. It is similar to [shell\_fprintf()](#gaa02f857bd560e8d7a1ce7c54a418dcaa) but takes a va\_list instead of variable arguments.
