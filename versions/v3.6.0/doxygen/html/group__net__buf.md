---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__net__buf.html
...
| struct | [net\_buf\_data\_cb](structnet__buf__data__cb.md) |
| struct | [net\_buf\_data\_alloc](structnet__buf__data__alloc.md) |
| struct | [net\_buf\_pool](structnet__buf__pool.md) |
|  | Network buffer pool representation. [More...](structnet__buf__pool.md#details) |
| struct | [net\_buf\_pool\_fixed](structnet__buf__pool__fixed.md) |
...
|  | Remove and convert 64 bits from the beginning of the buffer. |
| static [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | [net\_buf\_simple\_tail](#ga8d623415477ed880ceb1fb8861832309) (struct [net\_buf\_simple](structnet__buf__simple.md) \*buf) |
|  | Get the tail pointer for a buffer. |
| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_simple\_headroom](#gacfdef39367c6de8a1b4479c3647cca76) (struct [net\_buf\_simple](structnet__buf__simple.md) \*buf) |
|  | Check buffer headroom. |
| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_simple\_tailroom](#ga59b2e4d1c5c5743ba20eba3bf35ac39e) (struct [net\_buf\_simple](structnet__buf__simple.md) \*buf) |
|  | Check buffer tailroom. |
| [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | [net\_buf\_simple\_max\_len](#ga7deeb4a89b90a3784e582abcb81d5126) (struct [net\_buf\_simple](structnet__buf__simple.md) \*buf) |
...
| static void | [net\_buf\_simple\_save](#ga5b891f335480830a71a5ee2d71f1a3db) (struct [net\_buf\_simple](structnet__buf__simple.md) \*buf, struct [net\_buf\_simple\_state](structnet__buf__simple__state.md) \*[state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90)) |
...
| int | [net\_buf\_id](#gad89e43832ff01c4b333a3d6fd34d0517) (struct [net\_buf](structnet__buf.md) \*buf) |
...
|  | Remove and convert 64 bits from the beginning of the buffer. |
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_tailroom](#ga605f725e051ddf153ad7f7d50340d812) (struct [net\_buf](structnet__buf.md) \*buf) |
|  | Check buffer tailroom. |
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_headroom](#ga0962940eddb100072e075088629b5bb5) (struct [net\_buf](structnet__buf.md) \*buf) |
|  | Check buffer headroom. |
| static [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | [net\_buf\_max\_len](#gaab5b7f481c8e31a3b6439cbc7bbe31e8) (struct [net\_buf](structnet__buf.md) \*buf) |
...
| static [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | [net\_buf\_tail](#gac8271c56f28b68cc58ee9e7a062eebe0) (struct [net\_buf](structnet__buf.md) \*buf) |
|  | Get the tail pointer for a buffer. |
...
| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_linearize](#gaf99e2d191233b285cef18aa43c828a86) (void \*dst, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) dst\_len, struct [net\_buf](structnet__buf.md) \*src, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) offset, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) len) |
...
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [net\_buf\_frags\_len](#gaea38d8a418b739fa335e30ed91d9943d) (struct [net\_buf](structnet__buf.md) \*buf) |
...
static const struct [net\_buf\_pool\_fixed](structnet__buf__pool__fixed.md) net\_buf\_fixed\_##\_name = { \

.data\_pool = ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*)net\_buf\_data\_##\_name, \

}; \

static const struct [net\_buf\_data\_alloc](structnet__buf__data__alloc.md) net\_buf\_fixed\_alloc\_##\_name = { \
...
static const struct [net\_buf\_data\_alloc](structnet__buf__data__alloc.md) net\_buf\_data\_alloc\_##\_name = { \

.cb = &net\_buf\_var\_cb, \

.alloc\_data = &net\_buf\_mem\_pool\_##\_name, \

.[max\_alloc\_size](structnet__buf__data__alloc.md#a7eadcd00a72ab69bd5c84f2adba10197) = 0, \
...
:   | pool | Which pool to allocate the buffer from. |
    | --- | --- |
    | timeout | Affects the action taken should the pool be empty. If K\_NO\_WAIT, then return immediately. If K\_FOREVER, then wait as long as necessary. Otherwise, wait until the specified timeout. Note that some types of data allocators do not support blocking (such as the HEAP type). In this case it's still possible for [net\_buf\_alloc()](#ga534366f3b5c7f41a28372c12149ca005) to fail (return NULL) even if it was given K\_FOREVER. |
...
## [◆ ](#gaea38d8a418b739fa335e30ed91d9943d)net\_buf\_frags\_len()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_buf\_frags\_len | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga0962940eddb100072e075088629b5bb5)net\_buf\_headroom()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_buf\_headroom | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gad89e43832ff01c4b333a3d6fd34d0517)net\_buf\_id()

| int net\_buf\_id | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaf99e2d191233b285cef18aa43c828a86)net\_buf\_linearize()
...
|  |  | struct [net\_buf](structnet__buf.md) \* | *src*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *offset*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *len* ) |
...
## [◆ ](#gaab5b7f481c8e31a3b6439cbc7bbe31e8)net\_buf\_max\_len()

| | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) net\_buf\_max\_len | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gacfdef39367c6de8a1b4479c3647cca76)net\_buf\_simple\_headroom()

| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_buf\_simple\_headroom | ( | struct [net\_buf\_simple](structnet__buf__simple.md) \* | *buf* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga7deeb4a89b90a3784e582abcb81d5126)net\_buf\_simple\_max\_len()

| [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) net\_buf\_simple\_max\_len | ( | struct [net\_buf\_simple](structnet__buf__simple.md) \* | *buf* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Restores the parsing state of a buffer from a state previously stored by [net\_buf\_simple\_save()](#ga5b891f335480830a71a5ee2d71f1a3db).
...
## [◆ ](#ga5b891f335480830a71a5ee2d71f1a3db)net\_buf\_simple\_save()

| | void net\_buf\_simple\_save | ( | struct [net\_buf\_simple](structnet__buf__simple.md) \* | *buf*, | | --- | --- | --- | --- | |  |  | struct [net\_buf\_simple\_state](structnet__buf__simple__state.md) \* | *state* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga8d623415477ed880ceb1fb8861832309)net\_buf\_simple\_tail()

| | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* net\_buf\_simple\_tail | ( | struct [net\_buf\_simple](structnet__buf__simple.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga59b2e4d1c5c5743ba20eba3bf35ac39e)net\_buf\_simple\_tailroom()

| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_buf\_simple\_tailroom | ( | struct [net\_buf\_simple](structnet__buf__simple.md) \* | *buf* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gac8271c56f28b68cc58ee9e7a062eebe0)net\_buf\_tail()

| | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* net\_buf\_tail | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga605f725e051ddf153ad7f7d50340d812)net\_buf\_tailroom()

| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) net\_buf\_tailroom | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
