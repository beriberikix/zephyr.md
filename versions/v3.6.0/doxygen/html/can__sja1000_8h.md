---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/can__sja1000_8h.html
...
| #define | [CAN\_SJA1000\_DT\_CONFIG\_GET](#a228272175f5a62fb68329d08923428be)(node\_id, \_custom, \_read\_reg, \_write\_reg, \_ocr, \_cdr) |
...
| #define | [CAN\_SJA1000\_DT\_CONFIG\_INST\_GET](#a33e08af5d929d15016ae40601619edac)(inst, \_custom, \_read\_reg, \_write\_reg, \_ocr, \_cdr) |
...
| int | [can\_sja1000\_recover](#abef8951b7f1ad74bc2e6557701258617) (const struct [device](structdevice.md) \*dev, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | SJA1000 callback API upon recovering the CAN bus See *[can\_recover()](group__can__interface.md#gac474e56a50685736a1c25dca277aab5e "Recover from bus-off state.")* for argument description. |
...
## [◆ ](#a228272175f5a62fb68329d08923428be)CAN\_SJA1000\_DT\_CONFIG\_GET
...
.common = CAN\_DT\_DRIVER\_CONFIG\_GET(node\_id, 1000000), \

.read\_reg = \_read\_reg, \

.write\_reg = \_write\_reg, \

.sjw = [DT\_PROP](group__devicetree-generic-prop.md#ga8e1fd9ebacd85d2013df027d041d506b)(node\_id, sjw), \

.phase\_seg1 = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, phase\_seg1, 0), \

.phase\_seg2 = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, phase\_seg2, 0), \
...
## [◆ ](#a33e08af5d929d15016ae40601619edac)CAN\_SJA1000\_DT\_CONFIG\_INST\_GET
...
[CAN\_SJA1000\_DT\_CONFIG\_GET](#a228272175f5a62fb68329d08923428be)([DT\_DRV\_INST](group__devicetree-inst.md#ga219f413efba2f4c0151468b9a25a8dc1)(inst), \_custom, \_read\_reg, \_write\_reg, \_ocr, \_cdr)

[CAN\_SJA1000\_DT\_CONFIG\_GET](#a228272175f5a62fb68329d08923428be)

#define CAN\_SJA1000\_DT\_CONFIG\_GET(node\_id, \_custom, \_read\_reg, \_write\_reg, \_ocr, \_cdr)

Static initializer for can\_sja1000\_config struct.

**Definition** can\_sja1000.h:126
...
## [◆ ](#abef8951b7f1ad74bc2e6557701258617)can\_sja1000\_recover()

| int can\_sja1000\_recover | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
