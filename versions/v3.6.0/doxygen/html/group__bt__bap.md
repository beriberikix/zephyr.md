---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__bap.html
...
| void | [bt\_bap\_broadcast\_assistant\_register\_cb](#gafe741eb3ba1054ed81de71aafd5c03d8) (struct [bt\_bap\_broadcast\_assistant\_cb](structbt__bap__broadcast__assistant__cb.md) \*cb) |
...
## [◆ ](#gafe741eb3ba1054ed81de71aafd5c03d8)bt\_bap\_broadcast\_assistant\_register\_cb()

| void bt\_bap\_broadcast\_assistant\_register\_cb | ( | struct [bt\_bap\_broadcast\_assistant\_cb](structbt__bap__broadcast__assistant__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
For the unicast server, this will put a [BT\_AUDIO\_DIR\_SINK](group__bt__audio.md#gga5bd899fb5e4d844058184913866e462fa2adba49daa32ac7b040c3294f047ceb8 "BT_AUDIO_DIR_SINK") stream into the streaming state if the CIS is connected (initialized by the unicast client). If the CIS is not connected yet, the stream will go into the streaming state as soon as the CIS is connected. [BT\_AUDIO\_DIR\_SOURCE](group__bt__audio.md#gga5bd899fb5e4d844058184913866e462fa868695a31ebf95402a4bae2469f3aa6c "BT_AUDIO_DIR_SOURCE") streams will go into the streaming state when the unicast client sends the Receiver Start Ready operation, which will trigger the [bt\_bap\_unicast\_server\_cb::start()](structbt__bap__unicast__server__cb.md#a48fb3021507a708a0847a1ebec6075ba "bt_bap_unicast_server_cb::start()") callback.
