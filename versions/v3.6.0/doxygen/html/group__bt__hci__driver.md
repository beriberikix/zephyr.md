---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__hci__driver.html
...
| Macros | |
| --- | --- |
| #define | [IS\_BT\_QUIRK\_NO\_AUTO\_DLE](#ga011e658a6ae4f947412b294cf423178f)(bt\_dev) |
| #define | [BT\_HCI\_EVT\_FLAG\_RECV\_PRIO](#gaa7a28bc6e6a79128d3a95c3ccd3b1866)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| #define | [BT\_HCI\_EVT\_FLAG\_RECV](#ga61e4e2d22dec695f53f5aed6ce809859)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
...
| Functions | |
| --- | --- |
| static [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [bt\_hci\_evt\_get\_flags](#ga1f1b10f6d84f4a5cf4b895b6685874ef) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) evt) |
|  | Get HCI event flags. |
| int | [bt\_recv](#gaca80bc9dacc4fa44416bd545bd185ef7) (struct [net\_buf](structnet__buf.md) \*buf) |
|  | Receive data from the controller/HCI driver. |
| int | [bt\_recv\_prio](#ga19c61df1660d6049ae6b03afe3554fee) (struct [net\_buf](structnet__buf.md) \*buf) |
|  | Receive high priority data from the controller/HCI driver. |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [bt\_read\_static\_addr](#ga502a6580da2e06f24f021c7bc4bff50f) (struct [bt\_hci\_vs\_static\_addr](structbt__hci__vs__static__addr.md) addrs[], [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) size) |
...
## [◆ ](#ga61e4e2d22dec695f53f5aed6ce809859)BT\_HCI\_EVT\_FLAG\_RECV

| #define BT\_HCI\_EVT\_FLAG\_RECV   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
| --- |

`#include <[hci_driver.h](hci__driver_8h.md)>`

## [◆ ](#gaa7a28bc6e6a79128d3a95c3ccd3b1866)BT\_HCI\_EVT\_FLAG\_RECV\_PRIO

| #define BT\_HCI\_EVT\_FLAG\_RECV\_PRIO   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| --- |

`#include <[hci_driver.h](hci__driver_8h.md)>`

## [◆ ](#ga011e658a6ae4f947412b294cf423178f)IS\_BT\_QUIRK\_NO\_AUTO\_DLE

| #define IS\_BT\_QUIRK\_NO\_AUTO\_DLE | ( |  | *bt\_dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
((bt\_dev)->drv->quirks & [BT\_QUIRK\_NO\_AUTO\_DLE](#gga8f5a83b514f6d2da7548c38f7c3c166ea7b8e6d2f5604015c92c623193b9fe1e4))

[BT\_QUIRK\_NO\_AUTO\_DLE](#gga8f5a83b514f6d2da7548c38f7c3c166ea7b8e6d2f5604015c92c623193b9fe1e4)
...
## [◆ ](#ga1f1b10f6d84f4a5cf4b895b6685874ef)bt\_hci\_evt\_get\_flags()

| | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) bt\_hci\_evt\_get\_flags | ( | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *evt* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
When `CONFIG_BT_RECV_BLOCKING` is enabled the flags BT\_HCI\_EVT\_FLAG\_RECV and BT\_HCI\_EVT\_FLAG\_RECV\_PRIO indicates if the event should be given to bt\_recv or bt\_recv\_prio.
...
## [◆ ](#ga502a6580da2e06f24f021c7bc4bff50f)bt\_read\_static\_addr()

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) bt\_read\_static\_addr | ( | struct [bt\_hci\_vs\_static\_addr](structbt__hci__vs__static__addr.md) | *addrs*[], |
| --- | --- | --- | --- |
...
When `CONFIG_BT_RECV_BLOCKING` is defined then this API should not be used for so-called high priority HCI events, which should instead be delivered to the host stack through [bt\_recv\_prio()](#ga19c61df1660d6049ae6b03afe3554fee).
...
## [◆ ](#ga19c61df1660d6049ae6b03afe3554fee)bt\_recv\_prio()

| int bt\_recv\_prio | ( | struct [net\_buf](structnet__buf.md) \* | *buf* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This is the same as [bt\_recv()](#gaca80bc9dacc4fa44416bd545bd185ef7), except that it should be used for so-called high priority HCI events. There's a separate [bt\_hci\_evt\_get\_flags()](#ga1f1b10f6d84f4a5cf4b895b6685874ef) helper that can be used to identify which events have the BT\_HCI\_EVT\_FLAG\_RECV\_PRIO flag set.

As with [bt\_recv()](#gaca80bc9dacc4fa44416bd545bd185ef7), the buffer needs to have its type set with the help of [bt\_buf\_set\_type()](group__bt__buf.md#gaec645aec3d6fb845f214c07f2a864fec "Set the buffer type.") before calling this API. The only exception is so called high priority HCI events which should be delivered to the host stack through [bt\_recv\_prio()](#ga19c61df1660d6049ae6b03afe3554fee) instead.
