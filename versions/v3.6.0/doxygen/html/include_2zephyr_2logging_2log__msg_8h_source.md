---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/include_2zephyr_2logging_2log__msg_8h_source.html
original_path: doxygen/html/include_2zephyr_2logging_2log__msg_8h_source.html
---
...
[Go to the documentation of this file.](include_2zephyr_2logging_2log__msg_8h.md)
...
[ 30](include_2zephyr_2logging_2log__msg_8h.md#aac56158f6f644d26a5aa11cfe67d6ed6)#define LOG\_MSG\_DEBUG 0

[ 31](include_2zephyr_2logging_2log__msg_8h.md#ad5fae12ef133c7e7a2622c46dd22fb1c)#define LOG\_MSG\_DBG(...) IF\_ENABLED(LOG\_MSG\_DEBUG, (printk(\_\_VA\_ARGS\_\_)))

32

33#ifdef CONFIG\_LOG\_TIMESTAMP\_64BIT

34typedef [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) [log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8);

35#else

[ 36](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8)typedef [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8);
...
75#if (INTPTR\_MAX > INT32\_MAX) && !CONFIG\_LOG\_TIMESTAMP\_64BIT

76 [log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8) [timestamp](structlog__msg__hdr.md#a48ba27c6897377fafda1a980422fb2f4);
...
[ 80](structlog__msg__hdr.md#a48ba27c6897377fafda1a980422fb2f4) [log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8) [timestamp](structlog__msg__hdr.md#a48ba27c6897377fafda1a980422fb2f4);
...
502#if defined(CONFIG\_LOG\_ALWAYS\_RUNTIME) || \

503 (!defined(CONFIG\_LOG) && \

504 (!TOOLCHAIN\_HAS\_PRAGMA\_DIAG || !TOOLCHAIN\_HAS\_C\_AUTO\_TYPE))

505#define Z\_LOG\_MSG\_CREATE2(\_try\_0cpy, \_mode, \_cstr\_cnt, \_domain\_id, \_source,\

506 \_level, \_data, \_dlen, ...) \

507do {\

508 Z\_LOG\_MSG\_STR\_VAR(\_fmt, ##\_\_VA\_ARGS\_\_) \

509 z\_log\_msg\_runtime\_create(\_domain\_id, (void \*)\_source, \

510 \_level, (uint8\_t \*)\_data, \_dlen,\

511 Z\_LOG\_MSG\_CBPRINTF\_FLAGS(\_cstr\_cnt) | \

512 (IS\_ENABLED(CONFIG\_LOG\_USE\_TAGGED\_ARGUMENTS) ? \

513 CBPRINTF\_PACKAGE\_ARGS\_ARE\_TAGGED : 0), \

514 Z\_LOG\_FMT\_RUNTIME\_ARGS(\_fmt, ##\_\_VA\_ARGS\_\_));\

515 \_mode = Z\_LOG\_MSG\_MODE\_RUNTIME; \

516} while (false)

517#else /\* CONFIG\_LOG\_ALWAYS\_RUNTIME \*/

518#define Z\_LOG\_MSG\_CREATE3(\_try\_0cpy, \_mode, \_cstr\_cnt, \_domain\_id, \_source,\

519 \_level, \_data, \_dlen, ...) \

520do { \

521 Z\_LOG\_MSG\_STR\_VAR(\_fmt, ##\_\_VA\_ARGS\_\_); \

522 bool has\_rw\_str = CBPRINTF\_MUST\_RUNTIME\_PACKAGE( \

523 Z\_LOG\_MSG\_CBPRINTF\_FLAGS(\_cstr\_cnt), \

524 \_\_VA\_ARGS\_\_); \

525 if (IS\_ENABLED(CONFIG\_LOG\_SPEED) && \_try\_0cpy && ((\_dlen) == 0) && !has\_rw\_str) {\

526 LOG\_MSG\_DBG("create zero-copy message\n");\

527 Z\_LOG\_MSG\_SIMPLE\_CREATE(\_cstr\_cnt, \_domain\_id, \_source, \

528 \_level, Z\_LOG\_FMT\_ARGS(\_fmt, ##\_\_VA\_ARGS\_\_)); \

529 \_mode = Z\_LOG\_MSG\_MODE\_ZERO\_COPY; \

530 } else { \

531 IF\_ENABLED(UTIL\_AND(IS\_ENABLED(CONFIG\_LOG\_SIMPLE\_MSG\_OPTIMIZE), \

532 UTIL\_AND(UTIL\_NOT(\_domain\_id), UTIL\_NOT(\_cstr\_cnt))), \

533 ( \

534 bool can\_simple = LOG\_MSG\_SIMPLE\_CHECK(\_\_VA\_ARGS\_\_); \

535 if (can\_simple && ((\_dlen) == 0) && !k\_is\_user\_context()) { \

536 LOG\_MSG\_DBG("create fast message\n");\

537 Z\_LOG\_MSG\_SIMPLE\_ARGS\_CREATE(\_domain\_id, \_source, \_level, \

538 Z\_LOG\_FMT\_ARGS(\_fmt, ##\_\_VA\_ARGS\_\_)); \

539 \_mode = Z\_LOG\_MSG\_MODE\_SIMPLE; \
...
544 LOG\_MSG\_DBG("create on stack message\n");\

545 Z\_LOG\_MSG\_STACK\_CREATE(\_cstr\_cnt, \_domain\_id, \_source, \_level, \_data, \

546 \_dlen, Z\_LOG\_FMT\_ARGS(\_fmt, ##\_\_VA\_ARGS\_\_)); \

547 \_mode = Z\_LOG\_MSG\_MODE\_FROM\_STACK; \
...
552#if defined(\_\_cplusplus)

553#define Z\_AUTO\_TYPE auto

554#else

555#define Z\_AUTO\_TYPE \_\_auto\_type

556#endif

557

558/\* Macro for getting name of a local variable with the exception of the first argument

559 \* which is a formatted string in log message.

560 \*/

561#define Z\_LOG\_LOCAL\_ARG\_NAME(idx, arg) COND\_CODE\_0(idx, (arg), (\_v##idx))

562

563/\* Create local variable from input variable (expect for the first (fmt) argument). \*/

564#define Z\_LOG\_LOCAL\_ARG\_CREATE(idx, arg) \

565 COND\_CODE\_0(idx, (), (Z\_AUTO\_TYPE Z\_LOG\_LOCAL\_ARG\_NAME(idx, arg) = (arg) + 0))

566

567/\* First level of processing creates stack variables to be passed for further processing.

568 \* This is done to prevent multiple evaluations of input arguments (in case argument

569 \* evaluation has side effects, e.g. it is a non-pure function call).

570 \*/

571#define Z\_LOG\_MSG\_CREATE2(\_try\_0cpy, \_mode, \_cstr\_cnt, \_domain\_id, \_source, \

572 \_level, \_data, \_dlen, ...) \

573do { \

574 \_Pragma("GCC diagnostic push") \

575 \_Pragma("GCC diagnostic ignored \"-Wpointer-arith\"") \

576 FOR\_EACH\_IDX(Z\_LOG\_LOCAL\_ARG\_CREATE, (;), \_\_VA\_ARGS\_\_); \

577 \_Pragma("GCC diagnostic pop") \

578 Z\_LOG\_MSG\_CREATE3(\_try\_0cpy, \_mode, \_cstr\_cnt, \_domain\_id, \_source,\

579 \_level, \_data, \_dlen, \

580 FOR\_EACH\_IDX(Z\_LOG\_LOCAL\_ARG\_NAME, (,), \_\_VA\_ARGS\_\_)); \

581} while (false)

582#endif /\* CONFIG\_LOG\_ALWAYS\_RUNTIME ||

583 \* (!LOG && (!TOOLCHAIN\_HAS\_PRAGMA\_DIAG || !TOOLCHAIN\_HAS\_C\_AUTO\_TYPE))
...
587#define Z\_LOG\_MSG\_CREATE(\_try\_0cpy, \_mode, \_domain\_id, \_source,\

588 \_level, \_data, \_dlen, ...) \

589 Z\_LOG\_MSG\_CREATE2(\_try\_0cpy, \_mode, UTIL\_CAT(Z\_LOG\_FUNC\_PREFIX\_, \_level), \

590 \_domain\_id, \_source, \_level, \_data, \_dlen, \

591 Z\_LOG\_STR(\_level, \_\_VA\_ARGS\_\_))

592

599struct [log\_msg](structlog__msg.md) \*z\_log\_msg\_alloc([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) wlen);

600

614void z\_log\_msg\_finalize(struct [log\_msg](structlog__msg.md) \*msg, const void \*source,

615 const struct [log\_msg\_desc](structlog__msg__desc.md) desc, const void \*[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e));

616

623\_\_syscall void z\_log\_msg\_simple\_create\_0(const void \*source, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) level,

624 const char \*fmt);

625

633\_\_syscall void z\_log\_msg\_simple\_create\_1(const void \*source, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) level,

634 const char \*fmt, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) arg);

635

644\_\_syscall void z\_log\_msg\_simple\_create\_2(const void \*source, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) level,

645 const char \*fmt, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) arg0, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) arg1);

646

657\_\_syscall void z\_log\_msg\_static\_create(const void \*source,

658 const struct [log\_msg\_desc](structlog__msg__desc.md) desc,

659 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*package, const void \*[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e));

660

682void z\_log\_msg\_runtime\_vcreate([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) domain\_id, const void \*source,

683 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level, const void \*[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e),

684 size\_t dlen, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) package\_flags,
...
709static inline void z\_log\_msg\_runtime\_create([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) domain\_id,

710 const void \*source,

711 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level, const void \*[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e),

712 size\_t dlen, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) package\_flags,
...
717 va\_start(ap, fmt);

718 z\_log\_msg\_runtime\_vcreate(domain\_id, source, level,

719 [data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e), dlen, package\_flags, fmt, ap);
...
723static inline bool z\_log\_item\_is\_msg(const union [log\_msg\_generic](unionlog__msg__generic.md) \*msg)

724{

725 return msg->[generic](unionlog__msg__generic.md#ad1d622e11a94fb14cbb4bd13871751d5).[type](structlog__msg__generic__hdr.md#abf94410d7d163a5cda5615e7fe9fbaf2) == Z\_LOG\_MSG\_LOG;

726}

727

[ 734](group__log__msg.md#gac26779a741754cfb0f79f1cd78ece856)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_msg\_get\_total\_wlen](group__log__msg.md#gac26779a741754cfb0f79f1cd78ece856)(const struct [log\_msg\_desc](structlog__msg__desc.md) desc)

735{

736 return Z\_LOG\_MSG\_ALIGNED\_WLEN(desc.[package\_len](structlog__msg__desc.md#a3b9fb3a9e612ec8642e5e595d6478ac3), desc.[data\_len](structlog__msg__desc.md#aff700ad436ba87af141268e8f7aa5f6f));

737}

738

[ 745](group__log__msg.md#gaaf2e1b6af3957a1d23898ec8ad94e7f7)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_msg\_generic\_get\_wlen](group__log__msg.md#gaaf2e1b6af3957a1d23898ec8ad94e7f7)(const union [mpsc\_pbuf\_generic](unionmpsc__pbuf__generic.md) \*item)

746{

747 const union [log\_msg\_generic](unionlog__msg__generic.md) \*generic\_msg = (const union [log\_msg\_generic](unionlog__msg__generic.md) \*)item;

748

749 if (z\_log\_item\_is\_msg(generic\_msg)) {

750 const struct [log\_msg](structlog__msg.md) \*msg = (const struct [log\_msg](structlog__msg.md) \*)generic\_msg;

751

752 return [log\_msg\_get\_total\_wlen](group__log__msg.md#gac26779a741754cfb0f79f1cd78ece856)(msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895));
...
[ 764](group__log__msg.md#gaa4f92e19f94212a8a580d19b587fcbb1)static inline [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [log\_msg\_get\_domain](group__log__msg.md#gaa4f92e19f94212a8a580d19b587fcbb1)(struct [log\_msg](structlog__msg.md) \*msg)

765{

766 return msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895).[domain](structlog__msg__desc.md#a2636fe29ddba79450689b90beff3c3c7);

767}

768

[ 775](group__log__msg.md#ga952503e8252dc60f5920e473b76cfb47)static inline [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) [log\_msg\_get\_level](group__log__msg.md#ga952503e8252dc60f5920e473b76cfb47)(struct [log\_msg](structlog__msg.md) \*msg)

776{

777 return msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895).[level](structlog__msg__desc.md#a8cc3ca0930b892a6a9b7b73d20f8628e);

778}

779

[ 786](group__log__msg.md#ga2e65669fe7fb9cbb357bdcab0eda02df)static inline const void \*[log\_msg\_get\_source](group__log__msg.md#ga2e65669fe7fb9cbb357bdcab0eda02df)(struct [log\_msg](structlog__msg.md) \*msg)

787{

788 return msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[source](structlog__msg__hdr.md#aab20cd4267d37793299a2ed3a5e75236);

789}

790

[ 797](group__log__msg.md#gae0541cad3c66df189a5c6e454459b3b0)static inline [log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8) [log\_msg\_get\_timestamp](group__log__msg.md#gae0541cad3c66df189a5c6e454459b3b0)(struct [log\_msg](structlog__msg.md) \*msg)

798{

799 return msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[timestamp](structlog__msg__hdr.md#a48ba27c6897377fafda1a980422fb2f4);

800}

801

[ 808](group__log__msg.md#ga9750b8652b310e5292f1e510e5bf0ef5)static inline void \*[log\_msg\_get\_tid](group__log__msg.md#ga9750b8652b310e5292f1e510e5bf0ef5)(struct [log\_msg](structlog__msg.md) \*msg)

809{

810#if defined(CONFIG\_LOG\_THREAD\_ID\_PREFIX)

811 return msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).tid;
...
[ 826](group__log__msg.md#gaed59653e68c2076a3add6abb52471a9e)static inline [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*[log\_msg\_get\_data](group__log__msg.md#gaed59653e68c2076a3add6abb52471a9e)(struct [log\_msg](structlog__msg.md) \*msg, size\_t \*len)

827{

828 \*len = msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895).[data\_len](structlog__msg__desc.md#aff700ad436ba87af141268e8f7aa5f6f);

829

830 return msg->[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e) + msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895).[package\_len](structlog__msg__desc.md#a3b9fb3a9e612ec8642e5e595d6478ac3);

831}

832

[ 841](group__log__msg.md#gad433f993ebc12644f9e3476c3d542c58)static inline [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*[log\_msg\_get\_package](group__log__msg.md#gad433f993ebc12644f9e3476c3d542c58)(struct [log\_msg](structlog__msg.md) \*msg, size\_t \*len)

842{

843 \*len = msg->[hdr](structlog__msg.md#a5831ce7bc8d973714a7ca37455890d2a).[desc](structlog__msg__hdr.md#a2bb4a6020e4a29cc758b7325b8e8c895).[package\_len](structlog__msg__desc.md#a3b9fb3a9e612ec8642e5e595d6478ac3);

844

845 return msg->[data](structlog__msg.md#a2336290d5ac4b87cbd998d81cc49ab7e);
...
852#include <[syscalls/log\_msg.h](subsys_2testsuite_2ztest_2include_2zephyr_2syscalls_2log__msg_8h.md)>
...
858#endif /\* ZEPHYR\_INCLUDE\_LOGGING\_LOG\_MSG\_H\_ \*/
...
[log\_msg.h](subsys_2testsuite_2ztest_2include_2zephyr_2syscalls_2log__msg_8h.md)
