---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/common_8h_source.html
original_path: doxygen/html/common_8h_source.html
---
...
[ 25](common_8h.md#abbaccfbed35b945162c27ef6d3748e77)#define EXTERN\_C extern
...
[ 36](common_8h.md#a39314fd705c5a9ed45b671ca36f883fd)#define ZRESTRICT restrict
...
[ 56](common_8h.md#ab9df20a7e00611b6bdfb246b35a761fc) #define REQUIRES(sym) \_\_asm\_\_ (".set " # sym "\_Requires, " # sym "\n\t");
...
[ 129](common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) #define ALWAYS\_INLINE inline \_\_attribute\_\_((always\_inline))
...
[ 134](common_8h.md#a4689212d5a549893cabb9d7782eecfb6)#define STRINGIFY(s) Z\_STRINGIFY(s)
...
[ 198](common_8h.md#accd51a2e6e0aacde1d3c7ad7497e40ec)#define IS\_PTR\_ALIGNED\_BYTES(ptr, bytes) ((((uintptr\_t)ptr) % bytes) == 0)

199

200/\* Check if a pointer is aligned enough for a particular data type. \*/

[ 201](common_8h.md#ab13eb1fd10a663089d43679e8c172f71)#define IS\_PTR\_ALIGNED(ptr, type) IS\_PTR\_ALIGNED\_BYTES(ptr, \_\_alignof(type))

202

[ 210](common_8h.md#ad9b02fb67670e2aed5766db629cd4bfa)#define LINKER\_KEEP(symbol) \
