---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/gecko-pinctrl_8h_source.html
...
[ 29](gecko-pinctrl_8h.md#a87d929d0a1bc9808a854ce582a0c8251)#define GECKO\_FUN\_MSK 0xFFFU
...
[ 78](gecko-pinctrl_8h.md#ac1af8b10c541907308332856fa9affe7)#define GECKO\_PSEL(fun, port, pin) \

79 (((GECKO\_PORT\_##port & GECKO\_PORT\_MSK) << GECKO\_PORT\_POS) | \

80 ((GECKO\_PIN(##pin##) & GECKO\_PIN\_MSK) << GECKO\_PIN\_POS) | \

81 ((GECKO\_FUN\_##fun & GECKO\_FUN\_MSK) << GECKO\_FUN\_POS))

82

[ 89](gecko-pinctrl_8h.md#a0c4e8fbbb218ce88bd4059bda8170e6d)#define GECKO\_LOC(fun, loc) \

90 (((GECKO\_LOCATION(##loc##) & GECKO\_LOC\_MSK) << GECKO\_LOC\_POS) | \

91 ((GECKO\_FUN\_##fun##\_LOC & GECKO\_FUN\_MSK) << GECKO\_FUN\_POS))

92

93#endif /\* ZEPHYR\_INCLUDE\_DT\_BINDINGS\_PINCTRL\_GECKO\_PINCTRL\_H\_ \*/
