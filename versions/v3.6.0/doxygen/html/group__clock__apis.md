---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__clock__apis.html
...
| static [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) | [sys\_clock\_timeout\_end\_calc](#ga2bc4243022dba41becfd37a47aabe837) ([k\_timeout\_t](structk__timeout__t.md) timeout) |
...
`#include <[sys_clock.h](include_2zephyr_2sys__clock_8h.md)>`
...
| | void sys\_clock\_announce | ( | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) | *ticks* | ) |  | | --- | --- | --- | --- | --- | --- | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
See also
:   [arch\_k\_cycle\_get\_32()](group__arch-timing.md#ga9ee9f897ec750957de45bf8d43349d5e "Obtain the current cycle count, in units specified by CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC.")) to implement the cycle counter, though the user-facing API is owned by the architecture, not the driver. The rate must match CONFIG\_SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC.
...
| | void sys\_clock\_disable | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) sys\_clock\_elapsed | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | void sys\_clock\_idle\_exit | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| | void sys\_clock\_set\_timeout | ( | [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) | *ticks*, | | --- | --- | --- | --- | |  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *idle* ) | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga2bc4243022dba41becfd37a47aabe837)sys\_clock\_timeout\_end\_calc()

| | [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) sys\_clock\_timeout\_end\_calc | ( | [k\_timeout\_t](structk__timeout__t.md) | *timeout* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
This is deprecated. Consider [sys\_timepoint\_calc()](#ga509cf4599c1f162c97540743e8c21d33) instead.
