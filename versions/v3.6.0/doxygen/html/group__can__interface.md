---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__can__interface.html
...
| int | [can\_get\_max\_bitrate](#ga90fef54f61ac2a6244ef4ab36bde6e9b) (const struct [device](structdevice.md) \*dev, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*max\_bitrate) |
...
| int | [can\_calc\_prescaler](#ga7ee7a3296995c09c7f35f54029ed26cd) (const struct [device](structdevice.md) \*dev, struct [can\_timing](structcan__timing.md) \*timing, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) bitrate) |
...
| --- | --- |
| static int | [can\_add\_rx\_filter](#ga0cf4baa2c4216d8515554d180ceb774a) (const struct [device](structdevice.md) \*dev, [can\_rx\_callback\_t](#gaab9525fafab78c0da0a78a2dae39bd6f) callback, void \*user\_data, const struct [can\_filter](structcan__filter.md) \*filter) |
...
| #define | [CAN\_MAX\_STD\_ID](#ga7987c1d4089742f87a7ac611add1a286)   [CAN\_STD\_ID\_MASK](#ga4cd8ce34887b90baeeaa6a4aa048b398) |
...
| #define | [CAN\_MAX\_EXT\_ID](#ga0f3572940065f8f6d54099e7a4175f8f)   [CAN\_EXT\_ID\_MASK](#ga15ee71e8abcf51008925585049125986) |
...
## [◆ ](#ga0f3572940065f8f6d54099e7a4175f8f)CAN\_MAX\_EXT\_ID

| #define CAN\_MAX\_EXT\_ID   [CAN\_EXT\_ID\_MASK](#ga15ee71e8abcf51008925585049125986) |
| --- |
...
## [◆ ](#ga7987c1d4089742f87a7ac611add1a286)CAN\_MAX\_STD\_ID

| #define CAN\_MAX\_STD\_ID   [CAN\_STD\_ID\_MASK](#ga4cd8ce34887b90baeeaa6a4aa048b398) |
| --- |
...
## [◆ ](#ga0cf4baa2c4216d8515554d180ceb774a)can\_add\_rx\_filter()

| | int can\_add\_rx\_filter | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [can\_rx\_callback\_t](#gaab9525fafab78c0da0a78a2dae39bd6f) | *callback*, | |  |  | void \* | *user\_data*, | |  |  | const struct [can\_filter](structcan__filter.md) \* | *filter* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Wrapper function for *[can\_add\_rx\_filter()](#ga0cf4baa2c4216d8515554d180ceb774a)* which puts received CAN frames matching the filter in a message queue instead of calling a callback.
...
Warning
:   Message queue overruns are silently ignored and overrun frames discarded. Custom error handling can be implemented by using *[can\_add\_rx\_filter()](#ga0cf4baa2c4216d8515554d180ceb774a)* and *[k\_msgq\_put()](group__msgq__apis.md#ga54e96aaaea5462a1f963b7fd5ca82bfe "Send a message to a message queue.")* directly.
...
## [◆ ](#ga7ee7a3296995c09c7f35f54029ed26cd)can\_calc\_prescaler()

| int can\_calc\_prescaler | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | struct [can\_timing](structcan__timing.md) \* | *timing*, |
...
:   | dev | Pointer to the device structure for the driver instance. |
    | --- | --- |
    | timing | Result is written into the [can\_timing](structcan__timing.md "CAN bus timing structure.") struct provided. |
...
## [◆ ](#ga90fef54f61ac2a6244ef4ab36bde6e9b)can\_get\_max\_bitrate()

| int can\_get\_max\_bitrate | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *max\_bitrate* ) |
...
:   |  | dev | Pointer to the device structure for the driver instance. |
    | --- | --- | --- |
    | [out] | max\_bitrate | Maximum supported bitrate in bits/s |
...
This routine removes a CAN RX filter based on the filter ID returned by *[can\_add\_rx\_filter()](#ga0cf4baa2c4216d8515554d180ceb774a)* or *[can\_add\_rx\_filter\_msgq()](#gaaac20a068b7f32d2f38d1601d588b35c)*.
...
Bring the CAN controller out of [CAN\_STATE\_STOPPED](#ggac7ec472c26c564dd7067c49f67c8d2f7a644e7a441f2e607b93528d3128508cc8). This will reset the RX/TX error counters, enable the CAN controller to participate in CAN communication, and enable the CAN tranceiver, if supported.
