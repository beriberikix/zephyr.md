---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/pthread_8h.html
...
| #define | [PTHREAD\_STACK\_MIN](#a8b3dc1c5c1a165d6143b1dce950e8266)   Z\_KERNEL\_STACK\_SIZE\_ADJUST(0) |
...
| #define | [PTHREAD\_BARRIER\_DEFINE](#af63f456fc30f008794402605b4e5ac9c)(name, count) |
...
|  | POSIX threading compatibility API. |
| static int | [pthread\_mutexattr\_init](#a5eb25214d1409ff80e25559875a6b009) (pthread\_mutexattr\_t \*m) |
|  | POSIX threading compatibility API. |
| static int | [pthread\_mutexattr\_destroy](#a6422431160421ef5e69da9e98fd19580) (pthread\_mutexattr\_t \*m) |
|  | POSIX threading compatibility API. |
...
|  | Compare thread IDs. |
| static int | [pthread\_rwlockattr\_destroy](#ac4d2dcfe790eee1dbd83a1db7fdce3dc) ([pthread\_rwlockattr\_t](posix__types_8h.md#a4e92e3fbb4be682babbb6796af90b50f) \*attr) |
|  | Destroy the read-write lock attributes object. |
| static int | [pthread\_rwlockattr\_init](#a78db2cd33976f604cf85662fffa28307) ([pthread\_rwlockattr\_t](posix__types_8h.md#a4e92e3fbb4be682babbb6796af90b50f) \*attr) |
...
## [◆ ](#af63f456fc30f008794402605b4e5ac9c)PTHREAD\_BARRIER\_DEFINE

| #define PTHREAD\_BARRIER\_DEFINE | ( |  | *name*, |
| --- | --- | --- | --- |
|  |  |  | *count* ) |

**Value:**

[pthread\_barrier\_t](posix__types_8h.md#aeb637552f63e4c249e7aaeb2905f3db2) name = -1 \_\_DEPRECATED\_MACRO
...
:   | name | Symbol name of the barrier |
    | --- | --- |
    | count | Thread count, same as the "count" argument to [pthread\_barrier\_init()](#aecc6c99901aac517072970e153863296) |

**[Deprecated](deprecated.md#_deprecated000065)**
:   Use [pthread\_barrier\_init](#aecc6c99901aac517072970e153863296) instead.
...
| #define PTHREAD\_STACK\_MIN   Z\_KERNEL\_STACK\_SIZE\_ADJUST(0) |
| --- |
...
## [◆ ](#a6422431160421ef5e69da9e98fd19580)pthread\_mutexattr\_destroy()

| | int pthread\_mutexattr\_destroy | ( | pthread\_mutexattr\_t \* | *m* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#a5eb25214d1409ff80e25559875a6b009)pthread\_mutexattr\_init()

| | int pthread\_mutexattr\_init | ( | pthread\_mutexattr\_t \* | *m* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ac4d2dcfe790eee1dbd83a1db7fdce3dc)pthread\_rwlockattr\_destroy()

| | int pthread\_rwlockattr\_destroy | ( | [pthread\_rwlockattr\_t](posix__types_8h.md#a4e92e3fbb4be682babbb6796af90b50f) \* | *attr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#a78db2cd33976f604cf85662fffa28307)pthread\_rwlockattr\_init()

| | int pthread\_rwlockattr\_init | ( | [pthread\_rwlockattr\_t](posix__types_8h.md#a4e92e3fbb4be682babbb6796af90b50f) \* | *attr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
