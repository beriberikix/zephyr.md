---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__sensor__emulator__backend.html
...
## [◆ ](#ga66aa2b47e79047a749b331265a66e215)emul\_sensor\_backend\_get\_attribute\_metadata()
...
:   | [in] | target | Pointer to emulator instance to operate on |
    ...
    | [out] | increment | The value that the attribute increses by for every LSB |
...
## [◆ ](#ga7662fbe6ebe090cacc4b1436975beeef)emul\_sensor\_backend\_get\_sample\_range()
...
## [◆ ](#ga4011dd5d98c2ef63cdaccddd306c9d67)emul\_sensor\_backend\_set\_attribute()

| | int emul\_sensor\_backend\_set\_attribute | ( | const struct [emul](structemul.md) \* | *target*, | | --- | --- | --- | --- | |  |  | enum [sensor\_channel](group__sensor__interface.md#gaaa1b502bc029b10d7b23b0a25ef4e934) | *ch*, | |  |  | enum [sensor\_attribute](group__sensor__interface.md#ga0dcb6842bc969492bd1c9eb49708940b) | *attribute*, | |  |  | const void \* | *value* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga53ecc5c20890546ee15b5ccf10945172)emul\_sensor\_backend\_set\_channel()

| | int emul\_sensor\_backend\_set\_channel | ( | const struct [emul](structemul.md) \* | *target*, | | --- | --- | --- | --- | |  |  | enum [sensor\_channel](group__sensor__interface.md#gaaa1b502bc029b10d7b23b0a25ef4e934) | *ch*, | |  |  | const [q31\_t](group__math__dsp.md#gadc89a3547f5324b7b3b95adec3806bc0) \* | *value*, | |  |  | [int8\_t](stdint_8h.md#accbd6432732c88ad6adc5365800433b6) | *shift* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
