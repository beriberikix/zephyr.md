---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__subsys__pm__device__runtime.html
...
| int pm\_device\_runtime\_disable | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| int pm\_device\_runtime\_enable | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| int pm\_device\_runtime\_get | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) pm\_device\_runtime\_is\_enabled | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| int pm\_device\_runtime\_put | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| int pm\_device\_runtime\_put\_async | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
