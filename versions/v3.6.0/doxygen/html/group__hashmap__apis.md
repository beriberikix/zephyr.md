---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__hashmap__apis.html
...
:   | map | Hashmap to insert into |
    ...
    | old\_value | Location to store the value previously associated with `key` or NULL |
