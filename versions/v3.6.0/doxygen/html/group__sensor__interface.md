---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__sensor__interface.html
...
| Macros | |
| --- | --- |
| #define | [SENSOR\_DECODE\_CONTEXT\_INIT](#gac537a3a64a2a67e1ae2bb70ada147b00)(decoder\_, buffer\_, channel\_, channel\_index\_) |
...
| typedef int(\* | [sensor\_submit\_t](#gab8e7a28e19d596ddcbefeb34d84a2b3c)) (const struct [device](structdevice.md) \*sensor, struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*sqe) |
...
| int | [sensor\_natively\_supported\_channel\_size\_info](#ga5d905ca03326972f3e08c92939c2a558) (enum [sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934) channel, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) \*base\_size, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) \*frame\_size) |
...
| int | [sensor\_reconfigure\_read\_iodev](#ga949ab4cb1f0572d63eb439d34dad61cc) (struct [rtio\_iodev](structrtio__iodev.md) \*iodev, const struct [device](structdevice.md) \*sensor, const enum [sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934) \*channels, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_channels) |
...
| static int | [sensor\_read](#ga385feca2a8b65cb6a24443a5d903ca8b) (struct [rtio\_iodev](structrtio__iodev.md) \*iodev, struct [rtio](structrtio.md) \*ctx, void \*userdata) |
...
(chan) == [SENSOR\_CHAN\_MAGN\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a5d1f48466f6f600503af18427fa3da32))
...
## [◆ ](#gac537a3a64a2a67e1ae2bb70ada147b00)SENSOR\_DECODE\_CONTEXT\_INIT
...
static enum [sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934) \_CONCAT(\_\_channel\_array\_, name)[] = {\_\_VA\_ARGS\_\_}; \
...
[sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934)
...
[SENSOR\_CHAN\_ACCEL\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a16c05784ae15a4952ea708c2f11a2ae9), [SENSOR\_CHAN\_GYRO\_XYZ](#ggaaa1b502bc029b10d7b23b0a25ef4e934a1d36b89ab3761e9bc86effc839f8db0e));

int main(void) {

[sensor\_read](#ga385feca2a8b65cb6a24443a5d903ca8b)(&icm42688\_accelgyro, &[rtio](structrtio.md));
...
[sensor\_read](#ga385feca2a8b65cb6a24443a5d903ca8b)
...
:   | [in] | result | The result code of the read (0 being success) |
    ...
    | [in] | userdata | The optional userdata passed to [sensor\_read()](#ga385feca2a8b65cb6a24443a5d903ca8b) |
...
## [◆ ](#gab8e7a28e19d596ddcbefeb34d84a2b3c)sensor\_submit\_t

| typedef int(\* sensor\_submit\_t) (const struct [device](structdevice.md) \*sensor, struct [rtio\_iodev\_sqe](structrtio__iodev__sqe.md) \*sqe) |
| --- |
...
## [◆ ](#ga5d905ca03326972f3e08c92939c2a558)sensor\_natively\_supported\_channel\_size\_info()

| int sensor\_natively\_supported\_channel\_size\_info | ( | enum [sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934) | *channel*, |
| --- | --- | --- | --- |
...
This function can be called in a blocking manner after [sensor\_read()](#ga385feca2a8b65cb6a24443a5d903ca8b) or in a standalone thread dedicated to processing. It will wait for a cqe from the RTIO context, once received, it will decode the userdata and call the `cb`. Once the `cb` returns, the buffer will be released back into `ctx's` mempool if available.
...
## [◆ ](#ga385feca2a8b65cb6a24443a5d903ca8b)sensor\_read()

| | int sensor\_read | ( | struct [rtio\_iodev](structrtio__iodev.md) \* | *iodev*, | | --- | --- | --- | --- | |  |  | struct [rtio](structrtio.md) \* | *ctx*, | |  |  | void \* | *userdata* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga949ab4cb1f0572d63eb439d34dad61cc)sensor\_reconfigure\_read\_iodev()
...
|  |  | const enum [sensor\_channel](#gaaa1b502bc029b10d7b23b0a25ef4e934) \* | *channels*, |
