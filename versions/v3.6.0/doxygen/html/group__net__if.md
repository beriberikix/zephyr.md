---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__net__if.html
...
| Functions | |
| --- | --- |
| static void | [net\_if\_lock](#gaaa649aca4e48d74ae2f7cff3769e9781) (struct [net\_if](structnet__if.md) \*iface) |
| static void | [net\_if\_unlock](#ga20e166991c20ddeca8023b57ed8957ad) (struct [net\_if](structnet__if.md) \*iface) |
...
| static void | [net\_if\_tx\_lock](#gafb64d93ba8f6b047bb61a6fd4994b711) (struct [net\_if](structnet__if.md) \*iface) |
| static void | [net\_if\_tx\_unlock](#ga7deaa758536baa81045219c6f5c79217) (struct [net\_if](structnet__if.md) \*iface) |
...
| struct [net\_if\_ipv6\_prefix](structnet__if__ipv6__prefix.md) \* | [net\_if\_ipv6\_prefix\_get](#ga57ee087a53b59381ecb739a62e0e17d0) (struct [net\_if](structnet__if.md) \*iface, struct [in6\_addr](structin6__addr.md) \*addr) |
...
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [net\_if\_ipv6\_get\_hop\_limit](#ga54b200a4c4f09678298bf1b8f5da2ea6) (struct [net\_if](structnet__if.md) \*iface) |
|  | Get IPv6 hop limit specified for a given interface. |
| void | [net\_if\_ipv6\_set\_hop\_limit](#ga37b1d83f3ef7ab5996a86e7f7f3d9c72) (struct [net\_if](structnet__if.md) \*iface, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) hop\_limit) |
|  | Set the default IPv6 hop limit of a given interface. |
| static void | [net\_ipv6\_set\_hop\_limit](#ga33e3bf9530e394fe0b40b1b29e413138) (struct [net\_if](structnet__if.md) \*iface, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) hop\_limit) |
| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [net\_if\_ipv6\_get\_mcast\_hop\_limit](#ga95505542ecf92642a0b6f68f9dda5bf6) (struct [net\_if](structnet__if.md) \*iface) |
|  | Get IPv6 multicast hop limit specified for a given interface. |
| void | [net\_if\_ipv6\_set\_mcast\_hop\_limit](#ga3792cb18e34693b3c49f6dbccda3cf61) (struct [net\_if](structnet__if.md) \*iface, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) hop\_limit) |
...
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [net\_if\_need\_calc\_rx\_checksum](#ga7743d516edec5b80215553699712a98b) (struct [net\_if](structnet__if.md) \*iface) |
|  | Check if received network packet checksum calculation can be avoided or not. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [net\_if\_need\_calc\_tx\_checksum](#ga230228c3249838b8b847ecc1b4ee11aa) (struct [net\_if](structnet__if.md) \*iface) |
...
Parameters
:   | iface | A pointer to a struct [net\_if](structnet__if.md "Network Interface structure.") to which the the [net\_pkt](structnet__pkt.md "Network packet.") was sent to. |
    | --- | --- |
...
The prototype is compatible with [socket()](group__bsd__sockets.md#ga00c0ed5f8528aac995d803af4b827a9c "POSIX wrapper for zsock_socket.") function.
...
## [◆ ](#ga54b200a4c4f09678298bf1b8f5da2ea6)net\_if\_ipv6\_get\_hop\_limit()

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) net\_if\_ipv6\_get\_hop\_limit | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga95505542ecf92642a0b6f68f9dda5bf6)net\_if\_ipv6\_get\_mcast\_hop\_limit()

| [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) net\_if\_ipv6\_get\_mcast\_hop\_limit | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga57ee087a53b59381ecb739a62e0e17d0)net\_if\_ipv6\_prefix\_get()
...
## [◆ ](#ga37b1d83f3ef7ab5996a86e7f7f3d9c72)net\_if\_ipv6\_set\_hop\_limit()

| void net\_if\_ipv6\_set\_hop\_limit | ( | struct [net\_if](structnet__if.md) \* | *iface*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *hop\_limit* ) |
...
## [◆ ](#ga3792cb18e34693b3c49f6dbccda3cf61)net\_if\_ipv6\_set\_mcast\_hop\_limit()

| void net\_if\_ipv6\_set\_mcast\_hop\_limit | ( | struct [net\_if](structnet__if.md) \* | *iface*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *hop\_limit* ) |
...
## [◆ ](#gaaa649aca4e48d74ae2f7cff3769e9781)net\_if\_lock()

| | void net\_if\_lock | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga7743d516edec5b80215553699712a98b)net\_if\_need\_calc\_rx\_checksum()
...
## [◆ ](#ga230228c3249838b8b847ecc1b4ee11aa)net\_if\_need\_calc\_tx\_checksum()
...
## [◆ ](#gafb64d93ba8f6b047bb61a6fd4994b711)net\_if\_tx\_lock()

| | void net\_if\_tx\_lock | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |

`#include <[net_if.h](net__if_8h.md)>`

## [◆ ](#ga7deaa758536baa81045219c6f5c79217)net\_if\_tx\_unlock()

| | void net\_if\_tx\_unlock | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |

`#include <[net_if.h](net__if_8h.md)>`

## [◆ ](#ga20e166991c20ddeca8023b57ed8957ad)net\_if\_unlock()

| | void net\_if\_unlock | ( | struct [net\_if](structnet__if.md) \* | *iface* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga33e3bf9530e394fe0b40b1b29e413138)net\_ipv6\_set\_hop\_limit()

| | void net\_ipv6\_set\_hop\_limit | ( | struct [net\_if](structnet__if.md) \* | *iface*, | | --- | --- | --- | --- | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *hop\_limit* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
