---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/usb/device/usb_device.html
...
The device stack and [USB device controller driver API](api/usb_dc.md#usb-dc-api) have some limitations, such as not being
...
Samples [USB CDC-ACM](../../../samples/subsys/usb/cdc_acm/README.md#usb-cdc-acm "Use USB CDC-ACM driver to implement a serial port echo.") and [USB HID and CDC ACM](../../../samples/subsys/usb/hid-cdc/README.md#usb-hid-cdc "Expose multiple USB HID and CDC ACM instances.") have similar overlay files.
...
using [`usb_bos_register_cap()`](api/usb_device_bos.md#c.usb_bos_register_cap "usb_bos_register_cap"). Registered descriptors are added to the root
...
the [native\_sim](../../../boards/posix/native_sim/doc/index.md#native-sim) configuration.
...
| [USB HID and CDC ACM](../../../samples/subsys/usb/hid-cdc/README.md#usb-hid-cdc "Expose multiple USB HID and CDC ACM instances.") | 0x0003 |
