---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/usbnet_setup.html
original_path: connectivity/networking/usbnet_setup.html
---
...
The [Echo server (advanced)](../../samples/net/sockets/echo_server/README.md#sockets-echo-server "Implement a UDP/TCP server that sends received packets back to the sender.") application from the Zephyr source
...
### [Setting IPv4 address and routing](#id3)
...
### [Setting IPv6 address and routing](#id4)
