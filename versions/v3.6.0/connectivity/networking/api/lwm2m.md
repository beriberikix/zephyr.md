---
version: v3.6.0
source_url: https://docs.zephyrproject.org/3.6.0/connectivity/networking/api/lwm2m.html
...
![LwM2M engine state machine](https://docs.zephyrproject.org/3.6.0/_images/lwm2m_engine_state_machine.svg)
...
![LwM2M seconds to update early](https://docs.zephyrproject.org/3.6.0/_images/lwm2m_lifetime_seconds_early.png)
...
![LwM2M update time when both values are set](https://docs.zephyrproject.org/3.6.0/_images/lwm2m_lifetime_both.png)
