---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/api/wifi.html
...
:   Wi-Fi Management API.
    ...
    WIFI\_LISTEN\_INTERVAL\_MIN

    WIFI\_LISTEN\_INTERVAL\_MAX
    ...
    WIFI\_MGMT\_SCAN\_SSID\_FILT\_MAX

    WIFI\_MGMT\_SCAN\_CHAN\_MAX\_MANUAL

    WIFI\_MGMT\_BAND\_STR\_SIZE\_MAX
    ...
    NET\_REQUEST\_WIFI\_PS\_TIMEOUT
    ...
    WIFI\_MAX\_TWT\_FLOWS

    WIFI\_MAX\_TWT\_INTERVAL\_US

    WIFI\_MAX\_TWT\_WAKE\_INTERVAL\_US

    WIFI\_MAX\_TWT\_WAKE\_AHEAD\_DURATION\_US
    ...
    :   IEEE 802.11 security types.
        ...
        *Values:*
        ...
        enumerator \_\_WIFI\_SECURITY\_TYPE\_AFTER\_LAST

        enumerator WIFI\_SECURITY\_TYPE\_MAX = [\_\_WIFI\_SECURITY\_TYPE\_AFTER\_LAST](#c.wifi_security_type.__WIFI_SECURITY_TYPE_AFTER_LAST) - 1

        enumerator WIFI\_SECURITY\_TYPE\_UNKNOWN
    ...
    :   IEEE 802.11w - Management frame protection.
        ...
        *Values:*
        ...
        enumerator \_\_WIFI\_MFP\_AFTER\_LAST

        enumerator WIFI\_MFP\_MAX = [\_\_WIFI\_MFP\_AFTER\_LAST](#c.wifi_mfp_options.__WIFI_MFP_AFTER_LAST) - 1

        enumerator WIFI\_MFP\_UNKNOWN
    ...
    :   Wi-Fi interface states.
        ...
        *Values:*
        ...
        enumerator \_\_WIFI\_STATE\_AFTER\_LAST

        enumerator WIFI\_STATE\_MAX = [\_\_WIFI\_STATE\_AFTER\_LAST](#c.wifi_iface_state.__WIFI_STATE_AFTER_LAST) - 1

        enumerator WIFI\_STATE\_UNKNOWN
    ...
    :   Wi-Fi interface modes.
        ...
        *Values:*
        ...
        enumerator \_\_WIFI\_MODE\_AFTER\_LAST

        enumerator WIFI\_MODE\_MAX = [\_\_WIFI\_MODE\_AFTER\_LAST](#c.wifi_iface_mode.__WIFI_MODE_AFTER_LAST) - 1

        enumerator WIFI\_MODE\_UNKNOWN
    ...
    :   Wi-Fi link operating modes.
        ...
        *Values:*
        ...
        enumerator \_\_WIFI\_LINK\_MODE\_AFTER\_LAST

        enumerator WIFI\_LINK\_MODE\_MAX = [\_\_WIFI\_LINK\_MODE\_AFTER\_LAST](#c.wifi_link_mode.__WIFI_LINK_MODE_AFTER_LAST) - 1

        enumerator WIFI\_LINK\_MODE\_UNKNOWN
    ...
    :   Wi-Fi management commands.
        ...
        *Values:*
        ...
        enumerator NET\_REQUEST\_WIFI\_CMD\_PS\_MODE
        :   Set power save mode.
        ...
        enumerator NET\_REQUEST\_WIFI\_CMD\_PS\_TIMEOUT
        ...
        enumerator NET\_REQUEST\_WIFI\_CMD\_MAX
    ...
    :   Wi-Fi disconnect reason codes.
        ...
        *Values:*
        ...
        enumerator WIFI\_REASON\_DISCONN\_UNSPECIFIED = 0
        :   Unspecified reason.
    ...
    :   *#include <wifi\_mgmt.h>*
        ...
        struct [wifi\_band\_channel](#c.wifi_band_channel) band\_chan[1]
    ...
    :   *#include <wifi\_mgmt.h>*
        ...
        struct [wifi\_twt\_flow\_info](#c.wifi_twt_flow_info) twt\_flows[8]
        :   TWT flow details.
    ...
    union wifi\_mgmt\_events
    :   *#include <wifi\_mgmt.h>*

        Public Members

        struct [wifi\_scan\_result](#c.wifi_scan_result) scan\_result

        struct [wifi\_status](#c.wifi_status) connect\_status

        struct [wifi\_iface\_status](#c.wifi_iface_status) iface\_status

        struct [wifi\_twt\_params](#c.wifi_twt_params) twt\_params

        struct [wifi\_ap\_sta\_info](#c.wifi_ap_sta_info) ap\_sta\_info
