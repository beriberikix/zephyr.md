---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/bluetooth-arch.html
original_path: connectivity/bluetooth/bluetooth-arch.html
---
...
The [Bluetooth Specification](https://www.bluetooth.com/specifications/bluetooth-core-specification) describes the format in which a Host must
...
- **Controller-only build**: When built as a BLE Controller, Zephyr includes
  ...
  - [hci\_uart](../../samples/bluetooth/hci_uart/README.md#bluetooth-hci-uart-sample)
  - [hci\_usb](../../samples/bluetooth/hci_usb/README.md#bluetooth-hci-usb-sample)
  - [hci\_spi](../../samples/bluetooth/hci_spi/README.md#bluetooth-hci-spi-sample)
  ...
  - [`CONFIG_BT`](../../kconfig.md#CONFIG_BT "CONFIG_BT") `=y`
  - [`CONFIG_BT_HCI`](../../kconfig.md#CONFIG_BT_HCI "CONFIG_BT_HCI") `=y`
  - [`CONFIG_BT_HCI_RAW`](../../kconfig.md#CONFIG_BT_HCI_RAW "CONFIG_BT_HCI_RAW") `=y`
  - [`CONFIG_BT_CTLR`](../../kconfig.md#CONFIG_BT_CTLR "CONFIG_BT_CTLR") `=y`
  - [`CONFIG_BT_LL_SW_SPLIT`](../../kconfig.md#CONFIG_BT_LL_SW_SPLIT "CONFIG_BT_LL_SW_SPLIT") `=y` (if using the open source Link Layer)
- **Host-only build**: A Zephyr OS Host build will contain the Application and
  ...
  - [`CONFIG_BT`](../../kconfig.md#CONFIG_BT "CONFIG_BT") `=y`
  - [`CONFIG_BT_HCI`](../../kconfig.md#CONFIG_BT_HCI "CONFIG_BT_HCI") `=y`
  - [`CONFIG_BT_CTLR`](../../kconfig.md#CONFIG_BT_CTLR "CONFIG_BT_CTLR") `=n`
...
![BLE Combined build on a single chip](https://docs.zephyrproject.org/3.6.0/_images/ble_cfg_single.png)
...
![BLE dual-chip configuration builds](https://docs.zephyrproject.org/3.6.0/_images/ble_cfg_dual.png)
...
[hci\_uart](../../samples/bluetooth/hci_uart/README.md#bluetooth-hci-uart-sample), or the
[hci\_spi](../../samples/bluetooth/hci_spi/README.md#bluetooth-hci-spi-sample) app to provide an interface to
the BLE Controller.
...
![Bluetooth Host protocol & profile layers](https://docs.zephyrproject.org/3.6.0/_images/ble_host_layers.png)
...
[`bt_gatt_service_register()`](api/gatt.md#c.bt_gatt_service_register "bt_gatt_service_register") API the application will typically
start connectable advertising using the [`bt_le_adv_start()`](api/gap.md#c.bt_le_adv_start "bt_le_adv_start") API.
...
use the [`bt_le_scan_start()`](api/gap.md#c.bt_le_scan_start "bt_le_scan_start") API, wait for an appropriate device
to be found (using the scan callback), stop scanning using
[`bt_le_scan_stop()`](api/gap.md#c.bt_le_scan_stop "bt_le_scan_stop") and then connect to the device using
[`bt_conn_le_create()`](api/connection_mgmt.md#c.bt_conn_le_create "bt_conn_le_create"). If the central wants to keep
automatically reconnecting to the peripheral it should use the
[`bt_le_set_auto_conn()`](api/connection_mgmt.md#c.bt_le_set_auto_conn "bt_le_set_auto_conn") API.
...
An observer role device will use the [`bt_le_scan_start()`](api/gap.md#c.bt_le_scan_start "bt_le_scan_start") API to
...
A broadcaster role device will use the [`bt_le_adv_start()`](api/gap.md#c.bt_le_adv_start "bt_le_adv_start") API to
...
the device are registered using the [`bt_conn_auth_cb_register()`](api/connection_mgmt.md#c.bt_conn_auth_cb_register "bt_conn_auth_cb_register")
API. The [`bt_conn_auth_cb`](api/connection_mgmt.md#c.bt_conn_auth_cb "bt_conn_auth_cb") struct that’s passed to this API has
...
> [`BT_SECURITY_L1`](api/connection_mgmt.md#c.bt_security_t.BT_SECURITY_L1 "BT_SECURITY_L1")
> :   No encryption and no authentication.
>
> [`BT_SECURITY_L2`](api/connection_mgmt.md#c.bt_security_t.BT_SECURITY_L2 "BT_SECURITY_L2")
> :   Encryption but no authentication (no MITM protection).
>
> [`BT_SECURITY_L3`](api/connection_mgmt.md#c.bt_security_t.BT_SECURITY_L3 "BT_SECURITY_L3")
> :   Encryption and authentication using the legacy pairing method
>     from Bluetooth 4.0 and 4.1.
>
> [`BT_SECURITY_L4`](api/connection_mgmt.md#c.bt_security_t.BT_SECURITY_L4 "BT_SECURITY_L4")
...
[Bluetooth Audio Architecture](bluetooth-audio-arch.md#bluetooth-audio-arch).
