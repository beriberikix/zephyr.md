---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/bap.html
original_path: connectivity/bluetooth/api/bap.html
---
...
[Bluetooth: Broadcast Audio Assistant](../../../samples/bluetooth/broadcast_audio_assistant/README.md#bluetooth_broadcast_audio_assistant "Use LE Audio Broadcast Assistant functionality")
...
:   Bluetooth Basic Audio Profile (BAP).
    ...
    :   Start Audio Stream.
        ...
        For the unicast server, this will put a [BT\_AUDIO\_DIR\_SINK](audio.md#group__bt__audio_1gga5bd899fb5e4d844058184913866e462fa2adba49daa32ac7b040c3294f047ceb8) stream into the streaming state if the CIS is connected (initialized by the unicast client). If the CIS is not connected yet, the stream will go into the streaming state as soon as the CIS is connected. [BT\_AUDIO\_DIR\_SOURCE](audio.md#group__bt__audio_1gga5bd899fb5e4d844058184913866e462fa868695a31ebf95402a4bae2469f3aa6c) streams will go into the streaming state when the unicast client sends the Receiver Start Ready operation, which will trigger the [bt\_bap\_unicast\_server\_cb::start()](#structbt__bap__unicast__server__cb_1a48fb3021507a708a0847a1ebec6075ba) callback.
    ...
    :   Add a receive state source locally.
        ...
        If  [`CONFIG_BT_BAP_BROADCAST_SINK`](../../../kconfig.md#CONFIG_BT_BAP_BROADCAST_SINK "CONFIG_BT_BAP_BROADCAST_SINK") is enabled, any Broadcast Sink sources are autonomously modifed.
    ...
    void bt\_bap\_broadcast\_assistant\_register\_cb(struct [bt\_bap\_broadcast\_assistant\_cb](#c.bt_bap_broadcast_assistant_cb) \*cb)
...
*group* bt\_bap\_unicast\_client
:   Functions
    ...
    :   Add streams to a unicast group as a unicast client.
        ...
        :   - **unicast\_group** – Pointer to the unicast group
            ...
            - **num\_param** – Number of paramers in `params`.
...
*group* bt\_bap\_unicast\_server
:   Typedefs
...
*group* bt\_bap\_broadcast\_sink
:   BAP Broadcast Sink APIs.
    ...
    :   Sync to a broadcaster’s audio.
        ...
        :   - **sink** – Pointer to the sink object from the base\_recv callback.
            ...
            - **broadcast\_code** – The 16-octet broadcast code. Shall be supplied if the broadcast is encrypted (see [bt\_bap\_broadcast\_sink\_cb::syncable](#structbt__bap__broadcast__sink__cb_1ac2c8389a8e68e5b4afe735f623dc36ec)). If the value is a string or a the value is less than 16 octets, the remaining octets shall be 0.
...
*group* bt\_bap\_broadcast\_source
