---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/mesh/blob_srv.html
...
![BLOB Transfer Server model interaction](https://docs.zephyrproject.org/3.6.0/_images/blob_srv.svg)
