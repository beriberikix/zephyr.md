---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/autopts/autopts-linux.html
...
- Testing Zephyr Host Stack on [native\_sim](../../../boards/posix/native_sim/doc/index.md#native-sim)
- Testing Zephyr combined (controller + host) build on Real hardware (such as nRF52)

For running with QEMU or [native\_sim](../../../boards/posix/native_sim/doc/index.md#native-sim), see [Running on QEMU or native\_sim](../bluetooth-tools.md#bluetooth-qemu-native).
...
[![../../../_images/download_nrftools_linux.png](https://docs.zephyrproject.org/3.6.0/_images/download_nrftools_linux.png)](https://docs.zephyrproject.org/3.6.0/_images/download_nrftools_linux.png)
...
[![../../../_images/vmware_static_ip_1.png](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_1.png)](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_1.png)

Open virtual machine network settings. Add custom adapter:

[![../../../_images/vmware_static_ip_2.png](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_2.png)](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_2.png)

If you type ‘ifconfig’ in terminal, you should be able to find your host IP:

[![../../../_images/vmware_static_ip_3.png](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_3.png)](https://docs.zephyrproject.org/3.6.0/_images/vmware_static_ip_3.png)
...
[![../../../_images/virtualbox_static_ip_1.png](https://docs.zephyrproject.org/3.6.0/_images/virtualbox_static_ip_1.png)](https://docs.zephyrproject.org/3.6.0/_images/virtualbox_static_ip_1.png)

Open virtual machine network settings. On adapter 1 you will have created by default NAT.
Add adapter 2:

[![../../../_images/virtualbox_static_ip_2.png](https://docs.zephyrproject.org/3.6.0/_images/virtualbox_static_ip_2.png)](https://docs.zephyrproject.org/3.6.0/_images/virtualbox_static_ip_2.png)
...
[![../../../_images/windows_static_ip.png](https://docs.zephyrproject.org/3.6.0/_images/windows_static_ip.png)](https://docs.zephyrproject.org/3.6.0/_images/windows_static_ip.png)
...
[![../../../_images/install_python1.png](https://docs.zephyrproject.org/3.6.0/_images/install_python1.png)](https://docs.zephyrproject.org/3.6.0/_images/install_python1.png)
[![../../../_images/install_python2.png](https://docs.zephyrproject.org/3.6.0/_images/install_python2.png)](https://docs.zephyrproject.org/3.6.0/_images/install_python2.png)
...
[![../../../_images/install_git.png](https://docs.zephyrproject.org/3.6.0/_images/install_git.png)](https://docs.zephyrproject.org/3.6.0/_images/install_git.png)
...
[![../../../_images/install_pts_drivers.png](https://docs.zephyrproject.org/3.6.0/_images/install_pts_drivers.png)](https://docs.zephyrproject.org/3.6.0/_images/install_pts_drivers.png)
...
[![../../../_images/usb-devices_output.png](https://docs.zephyrproject.org/3.6.0/_images/usb-devices_output.png)](https://docs.zephyrproject.org/3.6.0/_images/usb-devices_output.png)
...
[![../../../_images/devices_1.png](https://docs.zephyrproject.org/3.6.0/_images/devices_1.png)](https://docs.zephyrproject.org/3.6.0/_images/devices_1.png)
[![../../../_images/devices_2.png](https://docs.zephyrproject.org/3.6.0/_images/devices_2.png)](https://docs.zephyrproject.org/3.6.0/_images/devices_2.png)
...
[![../../../_images/autoptsserver_run_2.png](https://docs.zephyrproject.org/3.6.0/_images/autoptsserver_run_2.png)](https://docs.zephyrproject.org/3.6.0/_images/autoptsserver_run_2.png)
...
[![../../../_images/autoptsclient_run_2.png](https://docs.zephyrproject.org/3.6.0/_images/autoptsclient_run_2.png)](https://docs.zephyrproject.org/3.6.0/_images/autoptsclient_run_2.png)

At the first run, when Windows asks, enable connection through firewall:

[![../../../_images/allow_firewall_2.png](https://docs.zephyrproject.org/3.6.0/_images/allow_firewall_2.png)](https://docs.zephyrproject.org/3.6.0/_images/allow_firewall_2.png)
...
[![../../../_images/autoptsserver_typical_error.png](https://docs.zephyrproject.org/3.6.0/_images/autoptsserver_typical_error.png)](https://docs.zephyrproject.org/3.6.0/_images/autoptsserver_typical_error.png)
