---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/security/security-overview.html
original_path: security/security-overview.html
---
...
![../_images/security-process-steps.png](https://docs.zephyrproject.org/3.6.0/_images/security-process-steps.png)
...
“OPTIONAL” are to be interpreted as described in [[RFC2119]](security-citations.md#rfc2119).
...
the developers (see: [Secure Coding](secure-coding.md#secure-code)).

Static code analyses are run on the Zephyr code tree on a regular basis,
see [Static Code Analysis](../contribute/guidelines.md#static-analysis).
...
![../_images/security-zephyr-system-architecture.png](https://docs.zephyrproject.org/3.6.0/_images/security-zephyr-system-architecture.png)
...
[Zephyr subsystem documentation](../services/index.md#os-services) for
...
[Secure Coding](secure-coding.md#secure-code) section. In [[SALT75]](security-citations.md#salt75), the following, widely
...
- **Economy of mechanism** specifies that the underlying design of a
  ...
  modular code [[PAUL09]](security-citations.md#paul09) and abstracted APIs.
...
- **Fail-safe defaults** defines that access is restricted by default
  ...
  by Default” paradigm [[MS12]](security-citations.md#ms12).
- **Separation of privilege** is the principle that two conditions or
  ...
  [[PAUL09]](security-citations.md#paul09).
...
- **Least common mechanism** specifies that mechanisms common to more
  ...
  required. The example given in [[SALT75]](security-citations.md#salt75) is a function that should
...
- **Complementary Security/Defense in Depth:** do not rely on a single
  ...
  the platform, or are not trusted, a defense in depth [[MS12]](security-citations.md#ms12)
...
- **Less commonly used services off by default**: to reduce the
  ...
  threshold of 80% is given in [[MS12]](security-citations.md#ms12)). For the Zephyr project,
...
in the [Secure Design](#secure-design) section.
...
- **Code Reviews** ensure the functional correctness of the code base
  ...
  security reviews as laid out in the [Secure Design](#secure-design) section.
  Refer to the [Project and Governance](../project/index.md#development-model) documentation for more information.
...
[Secure Coding](secure-coding.md#secure-code) outlined in the Zephyr project documentation
...
- **Security Issue Management** encompasses the evaluation of potential
  ...
  [Security Issue Management](reporting.md#reporting).
...
Please see [Security Vulnerability Reporting](reporting.md#reporting) for information on reporting security
vulnerabilities.
...
(adapted from [[OWASP]](security-citations.md#owasp)):

1. Definition of assets
2. Application decomposition and creation of appropriate data flow
   diagrams (DFDs)
3. Threat identification and categorization using the [[STRIDE09]](security-citations.md#stride09) and
   [[CVSS]](security-citations.md#cvss) approaches
...
as Common Criteria [[CCITSE12]](security-citations.md#ccitse12) require evidence that the evaluation
...
(compare [[MICR16]](security-citations.md#micr16)) are:
...
In all three cases, the certification scheme (e.g., FIPS 140-2 [[NIST02]](security-citations.md#nist02)
or Common Criteria [[CCITSE12]](security-citations.md#ccitse12)), the scope of the certification
...
include [[GHS10]](security-citations.md#ghs10)
