---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/introduction/index.html
...
:   A command-line CMake build environment runs on popular developer OS
    systems. A native port ([native\_sim](../boards/posix/native_sim/doc/index.md#native-sim)) lets you build and run Zephyr as a native
...
**Native port**
:   [Native sim](../boards/posix/native_sim/doc/index.md#native-sim) allows running Zephyr as a Linux application with support
