---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/usb__ch9_8h_source.html
...
[ 287](usb__ch9_8h.md#a8c4dd61ae766f50c9398c9753b4156b5)#define USB\_CONTROL\_EP\_MPS 64U

288

[ 290](usb__ch9_8h.md#afb744cb324e47124f93424a47d874b2a)#define USB\_EP\_DIR\_MASK (uint8\_t)BIT(7)

291

[ 293](usb__ch9_8h.md#aae8411e95f26738326bc25a0161dde99)#define USB\_EP\_DIR\_IN (uint8\_t)BIT(7)

294

[ 296](usb__ch9_8h.md#a0510b0a04d9cef144e4d9793310abccf)#define USB\_EP\_DIR\_OUT 0U
...
[ 304](usb__ch9_8h.md#a4fd2505dba51e8f198276a032d3f0523)#define USB\_EP\_GET\_IDX(ep) ((ep) & ~USB\_EP\_DIR\_MASK)

305

[ 307](usb__ch9_8h.md#aa974862712344d5d806d521a87549284)#define USB\_EP\_GET\_DIR(ep) ((ep) & USB\_EP\_DIR\_MASK)

308

[ 310](usb__ch9_8h.md#aa5963d81b4b5bee364fb0078229c71cf)#define USB\_EP\_GET\_ADDR(idx, dir) ((idx) | ((dir) & USB\_EP\_DIR\_MASK))

311

[ 313](usb__ch9_8h.md#a495d790dfb00609ce029631f40d0a422)#define USB\_EP\_DIR\_IS\_IN(ep) (USB\_EP\_GET\_DIR(ep) == USB\_EP\_DIR\_IN)

314

[ 316](usb__ch9_8h.md#a1734aa980e0f135ddc7873bb1a60c1a1)#define USB\_EP\_DIR\_IS\_OUT(ep) (USB\_EP\_GET\_DIR(ep) == USB\_EP\_DIR\_OUT)

317

[ 319](usb__ch9_8h.md#a9af36e318a50a982ebf826ef1d9e384e)#define USB\_CONTROL\_EP\_OUT (USB\_EP\_DIR\_OUT | 0U)

320

[ 322](usb__ch9_8h.md#ad907649f48bf773b010ce8fa36639b99)#define USB\_CONTROL\_EP\_IN (USB\_EP\_DIR\_IN | 0U)

323

[ 325](usb__ch9_8h.md#a619c400cb86d083c38d59366bf18ee0c)#define USB\_EP\_TRANSFER\_TYPE\_MASK 0x3U

326

[ 328](usb__ch9_8h.md#a1cecaf205acbc73308396af4f540c012)#define USB\_EP\_TYPE\_CONTROL 0U

329

[ 331](usb__ch9_8h.md#ad128f0d04114e8a5d40a943bb58eb7d2)#define USB\_EP\_TYPE\_ISO 1U

332

[ 334](usb__ch9_8h.md#a89eb27133e7e106c3637039f6f49d187)#define USB\_EP\_TYPE\_BULK 2U

335

[ 337](usb__ch9_8h.md#a904b4eef8e7bcab363757e19832617ee)#define USB\_EP\_TYPE\_INTERRUPT 3U

338

[ 340](usb__ch9_8h.md#a3530fe35c97b660a43bcbd573015a14a)#define USB\_FS\_INT\_EP\_INTERVAL(us) CLAMP(((us) / 1000U), 1U, 255U)

341

[ 343](usb__ch9_8h.md#aac29193abaef01df1c81566a9029c92f)#define USB\_HS\_INT\_EP\_INTERVAL(us) CLAMP((ilog2((us) / 125U) + 1U), 1U, 16U)

344

[ 346](usb__ch9_8h.md#a00508417f5da453f39a8aac96cbba673)#define USB\_FS\_ISO\_EP\_INTERVAL(us) CLAMP(((us) / 1000U), 1U, 16U)

347

[ 349](usb__ch9_8h.md#ae4facc67e3acfcc97d6e9529968ea7ca)#define USB\_HS\_ISO\_EP\_INTERVAL(us) CLAMP((ilog2((us) / 125U) + 1U), 1U, 16U)
...
355#endif /\* ZEPHYR\_INCLUDE\_USB\_CH9\_H\_ \*/
