---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/regulator_8h_source.html
...
[ 343](group__regulator__parent__interface.md#ga980feabe8415a9643eb66c8566d700bf)static inline int [regulator\_parent\_dvs\_state\_set](group__regulator__parent__interface.md#ga980feabe8415a9643eb66c8566d700bf)(const struct [device](structdevice.md) \*dev,

344 [regulator\_dvs\_state\_t](group__regulator__interface.md#ga9a15a21a532e497713724f42052b1dbd) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90))

345{

346 const struct regulator\_parent\_driver\_api \*api =

347 (const struct regulator\_parent\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

348

349 if (api->dvs\_state\_set == NULL) {
...
353 return api->dvs\_state\_set(dev, [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90));

354}

355

[ 370](group__regulator__parent__interface.md#gaa65d0a8d792256818a2ba06ad67a4f02)static inline int [regulator\_parent\_ship\_mode](group__regulator__parent__interface.md#gaa65d0a8d792256818a2ba06ad67a4f02)(const struct [device](structdevice.md) \*dev)

371{

372 const struct regulator\_parent\_driver\_api \*api =

373 (const struct regulator\_parent\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

374

375 if (api->ship\_mode == NULL) {
...
[ 398](group__regulator__interface.md#ga06e3109b9607521fe07686c6d601e460)int [regulator\_enable](group__regulator__interface.md#ga06e3109b9607521fe07686c6d601e460)(const struct [device](structdevice.md) \*dev);

399

[ 408](group__regulator__interface.md#ga28744a6cabadfe5a22bc96792c8ad124)bool [regulator\_is\_enabled](group__regulator__interface.md#ga28744a6cabadfe5a22bc96792c8ad124)(const struct [device](structdevice.md) \*dev);

409

[ 426](group__regulator__interface.md#gaac417fbf6e30bbbfbd5ea5029a8ef298)int [regulator\_disable](group__regulator__interface.md#gaac417fbf6e30bbbfbd5ea5029a8ef298)(const struct [device](structdevice.md) \*dev);

427

[ 439](group__regulator__interface.md#ga96bf136ff2deca774931ca27300b03a6)static inline unsigned int [regulator\_count\_voltages](group__regulator__interface.md#ga96bf136ff2deca774931ca27300b03a6)(const struct [device](structdevice.md) \*dev)

440{

441 const struct regulator\_driver\_api \*api =

442 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

443

444 if (api->count\_voltages == NULL) {
...
448 return api->count\_voltages(dev);

449}

450

[ 466](group__regulator__interface.md#ga62d9ea1d7dc2987101cf31b324ca7c51)static inline int [regulator\_list\_voltage](group__regulator__interface.md#ga62d9ea1d7dc2987101cf31b324ca7c51)(const struct [device](structdevice.md) \*dev,

467 unsigned int idx, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*volt\_uv)

468{

469 const struct regulator\_driver\_api \*api =

470 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

471

472 if (api->list\_voltage == NULL) {

473 return -[EINVAL](group__system__errno.md#ga2d1678d5a7cc8ce499643f3b8957def4);

474 }

475

476 return api->list\_voltage(dev, idx, volt\_uv);

477}

478

[ 489](group__regulator__interface.md#ga31b42ddfe94fee47158632f355ad864c)bool [regulator\_is\_supported\_voltage](group__regulator__interface.md#ga31b42ddfe94fee47158632f355ad864c)(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) min\_uv,

490 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) max\_uv);

491

[ 510](group__regulator__interface.md#ga2c2b345da9029013edbf59fd8c565d85)int [regulator\_set\_voltage](group__regulator__interface.md#ga2c2b345da9029013edbf59fd8c565d85)(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) min\_uv,

511 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) max\_uv);

512

[ 523](group__regulator__interface.md#gaa0114ee43a137ee98f98f5bce93d8579)static inline int [regulator\_get\_voltage](group__regulator__interface.md#gaa0114ee43a137ee98f98f5bce93d8579)(const struct [device](structdevice.md) \*dev,

524 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*volt\_uv)

525{

526 const struct regulator\_driver\_api \*api =

527 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

528

529 if (api->get\_voltage == NULL) {
...
533 return api->get\_voltage(dev, volt\_uv);

534}

535

[ 547](group__regulator__interface.md#ga27de51302b5222f860457c5b8bd494d6)static inline unsigned int [regulator\_count\_current\_limits](group__regulator__interface.md#ga27de51302b5222f860457c5b8bd494d6)(const struct [device](structdevice.md) \*dev)

548{

549 const struct regulator\_driver\_api \*api =

550 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

551

552 if (api->count\_current\_limits == NULL) {
...
556 return api->count\_current\_limits(dev);

557}

558

[ 574](group__regulator__interface.md#gaf12002954c6fc0ab9689f4dd2ec39518)static inline int [regulator\_list\_current\_limit](group__regulator__interface.md#gaf12002954c6fc0ab9689f4dd2ec39518)(const struct [device](structdevice.md) \*dev,

575 unsigned int idx, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*current\_ua)

576{

577 const struct regulator\_driver\_api \*api =

578 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

579

580 if (api->list\_current\_limit == NULL) {

581 return -[EINVAL](group__system__errno.md#ga2d1678d5a7cc8ce499643f3b8957def4);

582 }

583

584 return api->list\_current\_limit(dev, idx, current\_ua);

585}

586

[ 604](group__regulator__interface.md#ga2ccf66175b37754e2c21f341ecb2acbd)int [regulator\_set\_current\_limit](group__regulator__interface.md#ga2ccf66175b37754e2c21f341ecb2acbd)(const struct [device](structdevice.md) \*dev, [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) min\_ua,

605 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) max\_ua);

606

[ 617](group__regulator__interface.md#ga88c3ddeed962b5368713ad8fef0e7d7a)static inline int [regulator\_get\_current\_limit](group__regulator__interface.md#ga88c3ddeed962b5368713ad8fef0e7d7a)(const struct [device](structdevice.md) \*dev,

618 [int32\_t](stdint_8h.md#a0c18914b3041c2f583aba76f418399c2) \*curr\_ua)

619{

620 const struct regulator\_driver\_api \*api =

621 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

622

623 if (api->get\_current\_limit == NULL) {

624 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

625 }

626

627 return api->get\_current\_limit(dev, curr\_ua);

628}

629

[ 646](group__regulator__interface.md#ga1877bac62c2b81ee37deb86bfae302af)int [regulator\_set\_mode](group__regulator__interface.md#ga1877bac62c2b81ee37deb86bfae302af)(const struct [device](structdevice.md) \*dev, [regulator\_mode\_t](group__regulator__interface.md#ga1971bd21b504979a0cecab16048a0d03) mode);

647

[ 658](group__regulator__interface.md#ga9bc0fc7ba4bd2ed2548bff25cf4badfe)static inline int [regulator\_get\_mode](group__regulator__interface.md#ga9bc0fc7ba4bd2ed2548bff25cf4badfe)(const struct [device](structdevice.md) \*dev,

659 [regulator\_mode\_t](group__regulator__interface.md#ga1971bd21b504979a0cecab16048a0d03) \*mode)

660{

661 const struct regulator\_driver\_api \*api =

662 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

663

664 if (api->get\_mode == NULL) {

665 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

666 }

667

668 return api->get\_mode(dev, mode);

669}

670

[ 681](group__regulator__interface.md#ga8fb061502d0e94c4fe7a18c5a84d4af3)static inline int [regulator\_set\_active\_discharge](group__regulator__interface.md#ga8fb061502d0e94c4fe7a18c5a84d4af3)(const struct [device](structdevice.md) \*dev,

682 bool active\_discharge)

683{

684 const struct regulator\_driver\_api \*api =

685 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

686

687 if (api->set\_active\_discharge == NULL) {

688 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

689 }

690

691 return api->set\_active\_discharge(dev, active\_discharge);

692}

693

[ 704](group__regulator__interface.md#ga58d9e06c6da52a9733b3979d72915ab3)static inline int [regulator\_get\_active\_discharge](group__regulator__interface.md#ga58d9e06c6da52a9733b3979d72915ab3)(const struct [device](structdevice.md) \*dev,

705 bool \*active\_discharge)

706{

707 const struct regulator\_driver\_api \*api =

708 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

709

710 if (api->get\_active\_discharge == NULL) {

711 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

712 }

713

714 return api->get\_active\_discharge(dev, active\_discharge);

715}

716

[ 727](group__regulator__interface.md#ga9133662844a20eaf703d6d075347c62f)static inline int [regulator\_get\_error\_flags](group__regulator__interface.md#ga9133662844a20eaf703d6d075347c62f)(const struct [device](structdevice.md) \*dev,

728 [regulator\_error\_flags\_t](group__regulator__interface.md#ga31dae130509d28ee41602ab16ab31a90) \*[flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9))

729{

730 const struct regulator\_driver\_api \*api =

731 (const struct regulator\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

732

733 if (api->get\_error\_flags == NULL) {
...
737 return api->get\_error\_flags(dev, [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9));
...
746#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_REGULATOR\_H\_ \*/
