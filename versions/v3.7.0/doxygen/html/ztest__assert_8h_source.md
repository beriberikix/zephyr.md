---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/ztest__assert_8h_source.html
...
[ 399](group__ztest__assert.md#ga382017945a8c409e885cad8d0909b197)#define zassert\_str\_equal(s1, s2, ...) \

400 zassert(strcmp(s1, s2) == 0, #s1 " not equal to " #s2, ##\_\_VA\_ARGS\_\_)
...
[ 423](group__ztest__assume.md#ga6f5778ed8c1205126f7dcafb6eb26905)#define zassume\_true(cond, ...) zassume(cond, #cond " is false", ##\_\_VA\_ARGS\_\_)

424

[ 433](group__ztest__assume.md#ga5acf4256e5af3afaed06da7400dc3ad5)#define zassume\_false(cond, ...) zassume(!(cond), #cond " is true", ##\_\_VA\_ARGS\_\_)

434

[ 443](group__ztest__assume.md#ga9c6d1c701dd2d50027bf5e24b7567ae4)#define zassume\_ok(cond, ...) zassume(!(cond), #cond " is non-zero", ##\_\_VA\_ARGS\_\_)

444

[ 453](group__ztest__assume.md#ga539831d2f42cc991a8295b388ec12846)#define zassume\_not\_ok(cond, ...) zassume(!!(cond), #cond " is zero", ##\_\_VA\_ARGS\_\_)

454

[ 463](group__ztest__assume.md#ga3c5b1814deb5974e8ba0af961b516fa0)#define zassume\_is\_null(ptr, ...) zassume((ptr) == NULL, #ptr " is not NULL", ##\_\_VA\_ARGS\_\_)

464

[ 473](group__ztest__assume.md#ga24f4144edf5cef493c88872c7d56900e)#define zassume\_not\_null(ptr, ...) zassume((ptr) != NULL, #ptr " is NULL", ##\_\_VA\_ARGS\_\_)

474

[ 485](group__ztest__assume.md#ga88c2a3153568a6f621b88dd6ceeb48d6)#define zassume\_equal(a, b, ...) zassume((a) == (b), #a " not equal to " #b, ##\_\_VA\_ARGS\_\_)

486

[ 497](group__ztest__assume.md#ga0d90bb874c3135ffee870a4b61607853)#define zassume\_not\_equal(a, b, ...) zassume((a) != (b), #a " equal to " #b, ##\_\_VA\_ARGS\_\_)

498

[ 509](group__ztest__assume.md#ga78d6fbbf5eb13b32a5164053811b6cca)#define zassume\_equal\_ptr(a, b, ...) \

510 zassume((void \*)(a) == (void \*)(b), #a " not equal to " #b, ##\_\_VA\_ARGS\_\_)

511

[ 522](group__ztest__assume.md#gad808c91e07e6c27b2e28ec7e04e03854)#define zassume\_within(a, b, d, ...) \
...
[ 537](group__ztest__assume.md#gacff02eeba8dd334b3727dbe2036617e3)#define zassume\_between\_inclusive(a, l, u, ...) \
...
[ 552](group__ztest__assume.md#ga62be45256399530167745e71226e4a37)#define zassume\_mem\_equal(...) zassume\_mem\_equal\_\_(\_\_VA\_ARGS\_\_)

553

[ 567](group__ztest__assume.md#gaaed6045f194ead4ffe1dd72a6fa5175d)#define zassume\_mem\_equal\_\_(buf, exp, size, ...) \

568 zassume(memcmp(buf, exp, size) == 0, #buf " not equal to " #exp, ##\_\_VA\_ARGS\_\_)

569

[ 577](group__ztest__assume.md#ga33a9cd37d321f1a421a1328e67b04788)#define zassume\_str\_equal(s1, s2, ...) \

578 zassume(strcmp(s1, s2) == 0, #s1 " not equal to " #s2, ##\_\_VA\_ARGS\_\_)
...
[ 599](group__ztest__expect.md#gaef66b2764b6086dfbe8cbc933a8cfdc3)#define zexpect\_true(cond, ...) zexpect(cond, #cond " is false", ##\_\_VA\_ARGS\_\_)

600

[ 607](group__ztest__expect.md#ga619bd320e39799414383a228dc2d8299)#define zexpect\_false(cond, ...) zexpect(!(cond), #cond " is true", ##\_\_VA\_ARGS\_\_)

608

[ 616](group__ztest__expect.md#gaab325ee22058252c6a1c3243f3226657)#define zexpect\_ok(cond, ...) zexpect(!(cond), #cond " is non-zero", ##\_\_VA\_ARGS\_\_)

617

[ 625](group__ztest__expect.md#gabde5406775f05d5fcd135eb926969004)#define zexpect\_not\_ok(cond, ...) zexpect(!!(cond), #cond " is zero", ##\_\_VA\_ARGS\_\_)

626

[ 633](group__ztest__expect.md#ga10b2c904f1c68b816eae2ad53e2b9f90)#define zexpect\_is\_null(ptr, ...) zexpect((ptr) == NULL, #ptr " is not NULL", ##\_\_VA\_ARGS\_\_)

634

[ 641](group__ztest__expect.md#gaa51053fe2a07c6417db7952d7a594798)#define zexpect\_not\_null(ptr, ...) zexpect((ptr) != NULL, #ptr " is NULL", ##\_\_VA\_ARGS\_\_)

642

[ 650](group__ztest__expect.md#ga5ba65dbf95c204ed60694c5757db247f)#define zexpect\_equal(a, b, ...) zexpect((a) == (b), #a " not equal to " #b, ##\_\_VA\_ARGS\_\_)

651

[ 662](group__ztest__expect.md#ga31d83ab89828a03aebe0d0dc003f5232)#define zexpect\_not\_equal(a, b, ...) zexpect((a) != (b), #a " equal to " #b, ##\_\_VA\_ARGS\_\_)

663

[ 673](group__ztest__expect.md#gabf791d13c5781fc2215289d6dd925b3e)#define zexpect\_equal\_ptr(a, b, ...) \

674 zexpect((void \*)(a) == (void \*)(b), #a " not equal to " #b, ##\_\_VA\_ARGS\_\_)

675

[ 685](group__ztest__expect.md#ga907afb07269bbc444a3d8ffee46839b5)#define zexpect\_within(a, b, delta, ...) \

686 zexpect(((a) >= ((b) - (delta))) && ((a) <= ((b) + (delta))), \

687 #a " not within " #b " +/- " #delta, ##\_\_VA\_ARGS\_\_)

688

[ 698](group__ztest__expect.md#gac37ebea6a9c71e3666a4911ceea5c913)#define zexpect\_between\_inclusive(a, lower, upper, ...) \

699 zexpect(((a) >= (lower)) && ((a) <= (upper)), \

700 #a " not between " #lower " and " #upper " inclusive", ##\_\_VA\_ARGS\_\_)

701

[ 711](group__ztest__expect.md#gaee52264e5f92a606a2a85f5fbb0a85fb)#define zexpect\_mem\_equal(buf, exp, size, ...) \

712 zexpect(memcmp(buf, exp, size) == 0, #buf " not equal to " #exp, ##\_\_VA\_ARGS\_\_)

713

[ 722](group__ztest__expect.md#gacd5ef284610ca2027fc2e892243dfd38)#define zexpect\_str\_equal(s1, s2, ...) \

723 zexpect(strcmp(s1, s2) == 0, #s1 " not equal to " #s2, ##\_\_VA\_ARGS\_\_)

724

728

729#ifdef \_\_cplusplus
...
733#endif /\* ZEPHYR\_TESTSUITE\_ZTEST\_ASSERT\_H\_ \*/
