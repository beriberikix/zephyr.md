---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/structbt__micp__mic__dev__cb.html
...
These can be registered for usage with [bt\_micp\_mic\_dev\_register()](group__bt__gatt__micp.md#ga5dee6c7a1115bffbea39ba0575f369fc "Initialize the Microphone Control Profile Microphone Device.").
...
Called when the value is read with [bt\_micp\_mic\_dev\_mute\_get()](group__bt__gatt__micp.md#ga263bf5cf51e4ef8d7e6986f0d8358da3 "Read the mute state on the Microphone Device."), or if the value is changed by either the Microphone Device or a Microphone Controller.
