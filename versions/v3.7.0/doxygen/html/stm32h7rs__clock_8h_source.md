---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/stm32h7rs__clock_8h_source.html
...
[ 79](stm32h7rs__clock_8h.md#a91fa38e1c3f4afa5d23b2bbc885c2bb9)#define STM32\_CLOCK(val, mask, shift, reg) \
...
96/\* TODO to be completed \*/

97

[ 99](stm32h7rs__clock_8h.md#a0de89c03e0cd384de7f594aa5c5e82de)#define FMC\_SEL(val) STM32\_CLOCK(val, 3, 0, D1CCIPR\_REG)

[ 100](stm32h7rs__clock_8h.md#a42688c1d17e09ab58029feedd7491c0b)#define SDMMC\_SEL(val) STM32\_CLOCK(val, 1, 2, D1CCIPR\_REG)

[ 101](stm32h7rs__clock_8h.md#a15df14366d6921bac34208b0c1af0ebb)#define XSPI1\_SEL(val) STM32\_CLOCK(val, 3, 4, D1CCIPR\_REG)

[ 102](stm32h7rs__clock_8h.md#a58f2e1e8be7e4e9b50783f03afc687ff)#define XSPI2\_SEL(val) STM32\_CLOCK(val, 3, 6, D1CCIPR\_REG)

[ 103](stm32h7rs__clock_8h.md#a635d17ad991ded52d41a6e7b0bec5773)#define ADC\_SEL(val) STM32\_CLOCK(val, 3, 24, D1CCIPR\_REG)

[ 104](stm32h7rs__clock_8h.md#adc32e4d489d72766d6df1783eedf7628)#define CKPER\_SEL(val) STM32\_CLOCK(val, 3, 28, D1CCIPR\_REG)

105

[ 107](stm32h7rs__clock_8h.md#af81b9ee44136b6468393f807e70bbbf0)#define USART234578\_SEL(val) STM32\_CLOCK(val, 7, 0, D2CCIPR\_REG)

[ 108](stm32h7rs__clock_8h.md#ad760ef96e4fd9ca527e7d9c746d1c9f3)#define SPI23\_SEL(val) STM32\_CLOCK(val, 7, 4, D2CCIPR\_REG)

[ 109](stm32h7rs__clock_8h.md#a490889daf5612d2f0f08b3cab473ef10)#define I2C23\_SEL(val) STM32\_CLOCK(val, 3, 8, D2CCIPR\_REG)

[ 110](stm32h7rs__clock_8h.md#a3fbef8f2542fc6921236bd2709acf64c)#define I2C1\_SEL(val) STM32\_CLOCK(val, 3, 12, D2CCIPR\_REG)

[ 111](stm32h7rs__clock_8h.md#a576dca08c22370326fefc540bf056b81)#define I3C1\_SEL(val) STM32\_CLOCK(val, 3, 12, D2CCIPR\_REG)

[ 112](stm32h7rs__clock_8h.md#a042804bf8a52b3dd28033f8814442bfb)#define LPTIM1\_SEL(val) STM32\_CLOCK(val, 7, 16, D2CCIPR\_REG)

[ 113](stm32h7rs__clock_8h.md#ac1df6369669b4b3febd0525426e76499)#define FDCAN\_SEL(val) STM32\_CLOCK(val, 3, 22, D2CCIPR\_REG)

114

[ 116](stm32h7rs__clock_8h.md#a17f3ec5f86995a2c4087f2988a9486c5)#define USART1\_SEL(val) STM32\_CLOCK(val, 7, 0, D3CCIPR\_REG)

[ 117](stm32h7rs__clock_8h.md#a6919b0ea063667adb88c7c2d79877426)#define SPI45\_SEL(val) STM32\_CLOCK(val, 7, 4, D3CCIPR\_REG)

[ 118](stm32h7rs__clock_8h.md#a5199102173e9dbe957230f356e14d910)#define SPI1\_SEL(val) STM32\_CLOCK(val, 7, 8, D3CCIPR\_REG)

[ 119](stm32h7rs__clock_8h.md#ab8e49f6309adb53edd9ad3d051d451db)#define SAI1\_SEL(val) STM32\_CLOCK(val, 7, 16, D3CCIPR\_REG)

[ 120](stm32h7rs__clock_8h.md#a4fb9a6b79339e822f0ae426e8bba7486)#define SAI2\_SEL(val) STM32\_CLOCK(val, 7, 20, D3CCIPR\_REG)

121

[ 123](stm32h7rs__clock_8h.md#aac31ca48bf87a722f6e0519f25f764dd)#define LPUART1\_SEL(val) STM32\_CLOCK(val, 7, 0, D4CCIPR\_REG)

[ 124](stm32h7rs__clock_8h.md#ab43d49ec71267eb1d8002909cc3360bf)#define SPI6\_SEL(val) STM32\_CLOCK(val, 7, 4, D4CCIPR\_REG)

[ 125](stm32h7rs__clock_8h.md#a07706332b9bea6a82d90e93b9ea70293)#define LPTIM23\_SEL(val) STM32\_CLOCK(val, 7, 8, D4CCIPR\_REG)

[ 126](stm32h7rs__clock_8h.md#ad44ca291fceaacfa1794f08034143dc8)#define LPTIM45\_SEL(val) STM32\_CLOCK(val, 7, 12, D4CCIPR\_REG)

127

[ 129](stm32h7rs__clock_8h.md#a4836377699efa295c56d340e150695b0)#define RTC\_SEL(val) STM32\_CLOCK(val, 3, 8, BDCR\_REG)

130

131#endif /\* ZEPHYR\_INCLUDE\_DT\_BINDINGS\_CLOCK\_STM32H7RS\_CLOCK\_H\_ \*/
