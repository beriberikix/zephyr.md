---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/pipe_8h_source.html
...
66 struct modem\_pipe\_api \*api;
...
80void modem\_pipe\_init(struct modem\_pipe \*pipe, void \*data, struct modem\_pipe\_api \*api);

81

85

[ 98](group__modem__pipe.md#gad53acf3b0641bcc1779d85d5af6fb412)int [modem\_pipe\_open](group__modem__pipe.md#gad53acf3b0641bcc1779d85d5af6fb412)(struct modem\_pipe \*pipe);

99

[ 111](group__modem__pipe.md#ga0a7312eadaa76b433fe8a319d8c9ec74)int [modem\_pipe\_open\_async](group__modem__pipe.md#ga0a7312eadaa76b433fe8a319d8c9ec74)(struct modem\_pipe \*pipe);

112

[ 123](group__modem__pipe.md#ga68674becf672b1009d629813c041b868)void [modem\_pipe\_attach](group__modem__pipe.md#ga68674becf672b1009d629813c041b868)(struct modem\_pipe \*pipe, [modem\_pipe\_api\_callback](group__modem__pipe.md#gaf64941177c179cb9086a5736d1ea56f1) callback, void \*user\_data);

124

[ 138](group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6)int [modem\_pipe\_transmit](group__modem__pipe.md#ga72311fcb03f138d57e230af60340c9f6)(struct modem\_pipe \*pipe, const [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t size);

139

[ 153](group__modem__pipe.md#gab030b4040725ad4dab2399840ef73fde)int [modem\_pipe\_receive](group__modem__pipe.md#gab030b4040725ad4dab2399840ef73fde)(struct modem\_pipe \*pipe, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, size\_t size);

154

[ 160](group__modem__pipe.md#gad1a9fa3dba49a86c187328b7ee022293)void [modem\_pipe\_release](group__modem__pipe.md#gad1a9fa3dba49a86c187328b7ee022293)(struct modem\_pipe \*pipe);

161

[ 174](group__modem__pipe.md#ga43d885be0f284cc580e66572b4bab065)int [modem\_pipe\_close](group__modem__pipe.md#ga43d885be0f284cc580e66572b4bab065)(struct modem\_pipe \*pipe);

175

[ 187](group__modem__pipe.md#ga9814c9a1a5da33b2787ac058a6a037f5)int [modem\_pipe\_close\_async](group__modem__pipe.md#ga9814c9a1a5da33b2787ac058a6a037f5)(struct modem\_pipe \*pipe);

188

192

200void modem\_pipe\_notify\_opened(struct modem\_pipe \*pipe);

201

209void modem\_pipe\_notify\_closed(struct modem\_pipe \*pipe);

210

218void modem\_pipe\_notify\_receive\_ready(struct modem\_pipe \*pipe);

219

227void modem\_pipe\_notify\_transmit\_idle(struct modem\_pipe \*pipe);
...
241#endif /\* ZEPHYR\_MODEM\_PIPE\_ \*/
