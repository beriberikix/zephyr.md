---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/usbc__ppc_8h_source.html
...
83 if (api->[is\_dead\_battery\_mode](structusbc__ppc__driver__api.md#a832320573b2adab1d748e5e761690733) == NULL) {
...
106 if (api->[exit\_dead\_battery\_mode](structusbc__ppc__driver__api.md#a4ba2f654765130d5562f56243967bf58) == NULL) {
...
126 if (api->[is\_vbus\_source](structusbc__ppc__driver__api.md#aab74a38a9c055efdfd0198143f12c9ff) == NULL) {
...
146 if (api->[is\_vbus\_sink](structusbc__ppc__driver__api.md#a93b91d21d4d2edda1d457f4144800f37) == NULL) {
...
166 if (api->[set\_snk\_ctrl](structusbc__ppc__driver__api.md#af4a66a11b66d48818123434c59553f0d) == NULL) {
...
186 if (api->[set\_src\_ctrl](structusbc__ppc__driver__api.md#a20ddefaee68808414f4075cc513a8660) == NULL) {
...
206 if (api->[set\_vbus\_discharge](structusbc__ppc__driver__api.md#a1c2c21070ee18b7b5df09a6b6ed618b6) == NULL) {
...
226 if (api->[is\_vbus\_present](structusbc__ppc__driver__api.md#a8bf73dee9ba920f1b426038f62d5c9db) == NULL) {
...
247 if (api->[set\_event\_handler](structusbc__ppc__driver__api.md#a8f82ae3af5452d9cd0852bf15fcab573) == NULL) {
...
266 if (api->[dump\_regs](structusbc__ppc__driver__api.md#adce51ae345d5fc417f3767476af36276) == NULL) {
