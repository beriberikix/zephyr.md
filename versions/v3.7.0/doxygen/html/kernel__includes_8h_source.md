---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/kernel__includes_8h_source.html
...
29#include <[zephyr/sys/sflist.h](sflist_8h.md)>

30#include <[zephyr/sys/util.h](util_8h.md)>

31#include <[zephyr/kernel/obj\_core.h](obj__core_8h.md)>

32#include <[zephyr/kernel\_structs.h](kernel__structs_8h.md)>

33#include <[zephyr/kernel\_version.h](kernel__version_8h.md)>

34#include <[zephyr/syscall.h](syscall_8h.md)>

35#include <[zephyr/sys/printk.h](printk_8h.md)>

36#include <[zephyr/arch/cpu.h](cpu_8h.md)>

37#include <[zephyr/sys/rb.h](rb_8h.md)>

38#include <[zephyr/sys\_clock.h](sys__clock_8h.md)>

39#include <[zephyr/spinlock.h](spinlock_8h.md)>

40#include <[zephyr/fatal.h](fatal_8h.md)>

41#include <[zephyr/irq.h](irq_8h.md)>

42#include <[zephyr/kernel/thread\_stack.h](kernel_2thread__stack_8h.md)>

43#include <[zephyr/app\_memory/mem\_domain.h](mem__domain_8h.md)>

44#include <[zephyr/sys/kobject.h](kobject_8h.md)>

45#include <[zephyr/kernel/thread.h](kernel_2thread_8h.md)>

46/\* FIXME This needs to be removed. Exposes some private APIs to SOF \*/

47#include <[zephyr/kernel/internal/smp.h](kernel_2internal_2smp_8h.md)>

48

49#endif /\* ZEPHYR\_INCLUDE\_KERNEL\_INCLUDES\_H\_ \*/
