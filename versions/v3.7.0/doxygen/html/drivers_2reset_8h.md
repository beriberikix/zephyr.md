---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/drivers_2reset_8h.html
...
| #define | [RESET\_DT\_SPEC\_GET\_BY\_IDX\_OR](group__reset__controller__interface.md#ga594221ce06a743b591ef285856981793)(node\_id, idx, default\_value) |
|  | Like [RESET\_DT\_SPEC\_GET\_BY\_IDX()](group__reset__controller__interface.md#ga9f2e9e2e14a6ec9d2848979c77ecad9b "Static initializer for a reset_dt_spec."), with a fallback to a default value. |
...
| #define | [RESET\_DT\_SPEC\_GET\_OR](group__reset__controller__interface.md#ga66fa2c042d282b34939bc762240d3705)(node\_id, default\_value) |
|  | Equivalent to [RESET\_DT\_SPEC\_GET\_BY\_IDX\_OR(node\_id, 0, default\_value)](group__reset__controller__interface.md#ga594221ce06a743b591ef285856981793 "Like RESET_DT_SPEC_GET_BY_IDX(), with a fallback to a default value."). |
...
| #define | [RESET\_DT\_SPEC\_INST\_GET\_BY\_IDX\_OR](group__reset__controller__interface.md#ga7d14fdead7518b4070ec7123130311b2)(inst, idx, default\_value) |
...
| #define | [RESET\_DT\_SPEC\_INST\_GET\_OR](group__reset__controller__interface.md#gadcb4cd7adabb84a479485da421d39c6c)(inst, default\_value) |
|  | Equivalent to [RESET\_DT\_SPEC\_INST\_GET\_BY\_IDX\_OR(node\_id, 0, default\_value)](group__reset__controller__interface.md#ga7d14fdead7518b4070ec7123130311b2 "Static initializer for a reset_dt_spec from a DT_DRV_COMPAT instance's 'resets' property at an index,..."). |
