---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/os__mgmt_8h_source.html
...
88 \* processed, note that if all\_format\_specified is specified, the corresponding bits here
