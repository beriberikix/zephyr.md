---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/pm_2device_8h_source.html
...
638static inline int [pm\_device\_state\_get](group__subsys__pm__device.md#gaffcf0aea5df10657235d4ed1f8c74d5a)(const struct [device](structdevice.md) \*dev,

639 enum [pm\_device\_state](group__subsys__pm__device.md#ga561c0789071e3c3963f21f4c4a1bb2c6) \*[state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90))
...
643 \*[state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90) = [PM\_DEVICE\_STATE\_ACTIVE](group__subsys__pm__device.md#gga561c0789071e3c3963f21f4c4a1bb2c6a54b207e01b4dfc5e1ff56149817120c7);
...
648static inline void [pm\_device\_init\_suspended](group__subsys__pm__device.md#ga4c366f49e326a8b8e01d90cb2ee424ba)(const struct [device](structdevice.md) \*dev)
...
652static inline void [pm\_device\_init\_off](group__subsys__pm__device.md#gafb12ecf4679dd449e2faad0ede2c75fd)(const struct [device](structdevice.md) \*dev)
...
656static inline void [pm\_device\_busy\_set](group__subsys__pm__device.md#ga7ea002352f3d1c90aecff1d54c255a06)(const struct [device](structdevice.md) \*dev)
...
660static inline void [pm\_device\_busy\_clear](group__subsys__pm__device.md#ga8b527314f0c61b85602876b4f5a52275)(const struct [device](structdevice.md) \*dev)
...
664static inline bool [pm\_device\_is\_any\_busy](group__subsys__pm__device.md#gae59a1fbcd2399717076fbfcee1e5e411)(void) { return false; }

665static inline bool [pm\_device\_is\_busy](group__subsys__pm__device.md#ga8ff7c3197d5ded860878302d00ac709c)(const struct [device](structdevice.md) \*dev)
...
670static inline bool [pm\_device\_wakeup\_enable](group__subsys__pm__device.md#ga74fde62f71393fb9863916b3a2e5c460)(const struct [device](structdevice.md) \*dev,
...
674 ARG\_UNUSED(enable);

675 return false;

676}

677static inline bool [pm\_device\_wakeup\_is\_enabled](group__subsys__pm__device.md#ga0716c6158804ac48022280d8d237f8c1)(const struct [device](structdevice.md) \*dev)
...
682static inline bool [pm\_device\_wakeup\_is\_capable](group__subsys__pm__device.md#gac818aafb748b57d70909808b45d89379)(const struct [device](structdevice.md) \*dev)
...
687static inline bool [pm\_device\_on\_power\_domain](group__subsys__pm__device.md#ga32eb5e210d2f0ba533b0185a94c8744e)(const struct [device](structdevice.md) \*dev)
...
693static inline int [pm\_device\_power\_domain\_add](group__subsys__pm__device.md#gaa10a3f1ce71409cb591db416a1611377)(const struct [device](structdevice.md) \*dev,

694 const struct [device](structdevice.md) \*domain)

695{

696 ARG\_UNUSED(dev);

697 ARG\_UNUSED(domain);
...
701static inline int [pm\_device\_power\_domain\_remove](group__subsys__pm__device.md#ga1d7ab9b0b497e016b9b22d2506cd23f9)(const struct [device](structdevice.md) \*dev,

702 const struct [device](structdevice.md) \*domain)

703{

704 ARG\_UNUSED(dev);

705 ARG\_UNUSED(domain);

706 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

707}

708

709static inline bool [pm\_device\_is\_powered](group__subsys__pm__device.md#ga9e926dffd7eafc567499ce1ea537486b)(const struct [device](structdevice.md) \*dev)
...
715static inline int [pm\_device\_driver\_init](group__subsys__pm__device.md#gad563094c2d4ad066bc4ce30586e13fb3)(const struct [device](structdevice.md) \*dev, [pm\_device\_action\_cb\_t](group__subsys__pm__device.md#ga81d4ee32f5bbb1b343234b9b3afc0179) [action\_cb](structpm__device__base.md#abd3a07f0e7c54cb0bee7f835be79dac6))
...
720 rc = [action\_cb](structpm__device__base.md#abd3a07f0e7c54cb0bee7f835be79dac6)(dev, [PM\_DEVICE\_ACTION\_TURN\_ON](group__subsys__pm__device.md#ggaee5546eacb9be7caa9d59ab63926cc4cac7690e0ffd27742acf58fdbdb7b89544));

721 if (rc == 0) {

722 rc = [action\_cb](structpm__device__base.md#abd3a07f0e7c54cb0bee7f835be79dac6)(dev, [PM\_DEVICE\_ACTION\_RESUME](group__subsys__pm__device.md#ggaee5546eacb9be7caa9d59ab63926cc4ca757c6ab81eeac0d6afae479d6a0ac564));
...
727#endif /\* CONFIG\_PM\_DEVICE \*/

728

730

731#ifdef \_\_cplusplus
