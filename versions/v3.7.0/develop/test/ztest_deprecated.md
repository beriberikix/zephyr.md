---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/develop/test/ztest_deprecated.html
...
- Do not use `#if`
  ...
  ```c
          ...
          ...
  ```
- Do not add comments on lines with a call to [`ztest_unit_test()`](ztest.md#c.ztest_unit_test "ztest_unit_test"):
