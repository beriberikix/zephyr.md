---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/develop/test/twister.html
...
![Twister and a Test applications' project.](https://docs.zephyrproject.org/3.7.0/_images/twister_test_project.svg)
...
2. Each test scenario identifier shall start with a section followed by a
...
3. All test scenario identifiers within a `testcase.yaml` file need to be unique. For
...
![../../_images/fixtures.svg](https://docs.zephyrproject.org/3.7.0/_images/fixtures.svg)
...
- Option to specify your own list of default platforms overriding what
  upstream defines.
- Ability to override build\_on\_all options used in some test scenarios.
