...
3. Click Add environment ‣ From file and select
   ...
   [![MinGW toolchain with environment script](../../_images/clion_toolchain_mingw.webp)](../../_images/clion_toolchain_mingw.webp)
...
4. Back in the CMake profile settings dialog, specify your board in the CMake options
   ...
   [![CMake profile](../../_images/clion_cmakeprofile.webp)](../../_images/clion_cmakeprofile.webp)
...
2. Configure the settings:
   ...
   > | TCP/IP port | Auto |
   >
   > [![Embedded GDB server configuration](../../_images/clion_gdbserverconfig.webp)](../../_images/clion_gdbserverconfig.webp)
3. Click Next to set the Segger J-Link parameters.

   > [![Segger J-Link parameters](../../_images/clion_segger_settings.webp)](../../_images/clion_segger_settings.webp)
...
3. When a breakpoint is hit, CLion opens the Debug tool window.
   ...
   > [![Viewing Zephyr tasks during a debug session](../../_images/clion_debug_threads.webp)](../../_images/clion_debug_threads.webp)
