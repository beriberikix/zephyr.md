---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/device_mgmt/smp_groups/smp_group_3.html
...
with the event [`MGMT_EVT_OP_SETTINGS_MGMT_ACCESS`](../mcumgr_callbacks.md#c.settings_mgmt_group_events.MGMT_EVT_OP_SETTINGS_MGMT_ACCESS "MGMT_EVT_OP_SETTINGS_MGMT_ACCESS"), whereby the supplied callback data
