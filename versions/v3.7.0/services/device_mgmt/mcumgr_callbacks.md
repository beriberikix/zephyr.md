---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/device_mgmt/mcumgr_callbacks.html
...
>       data is `fs_mgmt_file_access`. Instead of returning true to allow
...
>       data is `img_mgmt_upload_check`. Instead of returning true to
...
:   MCUmgr callback API.
    ...
    :   MGMT event opcodes for base SMP command processing.
        ...
        *Values:*
        ...
        :   Callback when a status is updated, data is [mgmt\_evt\_op\_cmd\_arg()](#structmgmt__evt__op__cmd__arg).
