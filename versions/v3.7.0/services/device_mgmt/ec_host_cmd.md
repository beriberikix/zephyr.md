---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/device_mgmt/ec_host_cmd.html
...
*group* EC Host Command Interface
:   EC Host Command Interface.
    ...
    **Version**
    ...
    enum ec\_host\_cmd\_state
    :   *Values:*

        enumerator EC\_HOST\_CMD\_STATE\_DISABLED = 0

        enumerator EC\_HOST\_CMD\_STATE\_RECEIVING

        enumerator EC\_HOST\_CMD\_STATE\_PROCESSING

        enumerator EC\_HOST\_CMD\_STATE\_SENDING
