---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/device_mgmt/mcumgr_handlers.html
...
[`MGMT_GROUP_ID_PERUSER`](mcumgr.md#c.mcumgr_group_t.MGMT_GROUP_ID_PERUSER "MGMT_GROUP_ID_PERUSER"), which is the start group ID for user-defined groups, note
