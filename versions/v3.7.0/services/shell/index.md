...
![Command tree with static commands.](https://docs.zephyrproject.org/3.7.0/_images/static_cmd.PNG)
...
![Dictionary commands example.](https://docs.zephyrproject.org/3.7.0/_images/dict_cmd.png)
...
![Command tree with static and dynamic commands.](https://docs.zephyrproject.org/3.7.0/_images/dynamic_cmd.PNG)
...
![Command tree with static commands.](https://docs.zephyrproject.org/3.7.0/_images/execution.png)
...
![Tab Feature usage example](https://docs.zephyrproject.org/3.7.0/_images/tab_prompt.png)
...
![Wildcard usage example](https://docs.zephyrproject.org/3.7.0/_images/wildcard.png)
