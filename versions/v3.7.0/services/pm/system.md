---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/pm/system.html
...
The set of power states is defined by [`pm_state`](api/index.md#c.pm_state "pm_state"). In general, lower power states
...
lose context. See [`pm_policy_state_lock_get()`](api/index.md#c.pm_policy_state_lock_get "pm_policy_state_lock_get").
