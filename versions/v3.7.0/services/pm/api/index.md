---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/pm/api/index.html
...
:   System Power Management States.
    ...
    :   *#include <state.h>*
        ...
        enum [pm\_state](#c.pm_state) state
        :   Power management state.

            See also

            [pm\_state](#group__subsys__pm__states_1ga20e2f5ea9027a3653e5b9cc5aa1e21d5)
...
:   System Power Management Policy API.
    ...
    void pm\_policy\_device\_power\_lock\_get(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev)
    :   Increase power state locks.
        ...
        [pm\_policy\_device\_power\_lock\_put()](#group__subsys__pm__sys__policy_1gafb90036c42bce2cc44466427b2907a81)
    ...
    void pm\_policy\_device\_power\_lock\_put(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev)
    :   Decrease power state locks.
        ...
        [pm\_policy\_device\_power\_lock\_get()](#group__subsys__pm__sys__policy_1ga708b7d2f8cb5f09738e3c6e5937c475e)
...
:   Device Runtime Power Management API.
    ...
    int pm\_device\_runtime\_usage(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev)
