---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/pm/device.html
...
[`pm_device_state`](api/index.md#c.pm_device_state "pm_device_state"). This method is used to track power states of
...
[`pm_policy_device_power_lock_get()`](api/index.md#c.pm_policy_device_power_lock_get "pm_policy_device_power_lock_get") and release with
[`pm_policy_device_power_lock_put()`](api/index.md#c.pm_policy_device_power_lock_put "pm_policy_device_power_lock_put"). For example:
