---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/zbus/index.html
...
:   Zbus API.
    ...
    :   Publish to a channel.
        ...
        :   - **0** – Channel published.
            ...
            - **-EFAULT** – A parameter is incorrect, the notification could not be sent to one or more observer, or the function context is invalid (inside an ISR). The function only returns this value when the  [`CONFIG_ZBUS_ASSERT_MOCK`](../../kconfig.md#CONFIG_ZBUS_ASSERT_MOCK "CONFIG_ZBUS_ASSERT_MOCK") is enabled.
    ...
    static inline void zbus\_chan\_set\_msg\_sub\_pool(const struct [zbus\_channel](#c.zbus_channel) \*chan, struct [net\_buf\_pool](../../connectivity/networking/api/net_buf.md#c.net_buf_pool "net_buf_pool") \*pool)
    :   Set the channel’s msg subscriber `[net_buf](../../connectivity/networking/api/net_buf.md#structnet__buf)` pool.

        Parameters:
        :   - **chan** – The channel’s reference.
            - **pool** – The reference to the `[net_buf](../../connectivity/networking/api/net_buf.md#structnet__buf)` memory pool.
    ...
    :   *#include <zbus.h>*
        ...
        struct [net\_buf\_pool](../../connectivity/networking/api/net_buf.md#c.net_buf_pool "net_buf_pool") \*msg\_subscriber\_pool
