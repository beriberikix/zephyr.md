---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/tracing/index.html
...
[![SEGGER SystemView](https://docs.zephyrproject.org/3.7.0/_images/segger_systemview.png)](https://docs.zephyrproject.org/3.7.0/_images/segger_systemview.png)
...
:   Tracing APIs.
    ...
    sys\_trace\_sys\_init\_enter(entry, level)
    :   Called when entering an init function.

    sys\_trace\_sys\_init\_exit(entry, level, result)
...
*group* Conditional Variable Tracing APIs
...
*group* Message Queue Tracing APIs
...
:   Heap Tracing APIs.
    ...
    sys\_port\_trace\_k\_heap\_realloc\_enter(h, ptr, bytes, timeout)
    ...
    sys\_port\_trace\_k\_heap\_realloc\_exit(h, ptr, bytes, timeout, ret)
    ...
    sys\_port\_trace\_k\_heap\_sys\_k\_realloc\_enter(heap, ptr)
    ...
    sys\_port\_trace\_k\_heap\_sys\_k\_realloc\_exit(heap, ptr, ret)
...
*group* Memory Slab Tracing APIs
