---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/crypto/psa_crypto.html
original_path: services/crypto/psa_crypto.html
---
...
:   Some environments allow applications to be multithreaded, while
    ...
    details, refer to [Concurrent calls](https://arm-software.github.io/psa-api/crypto/1.2/overview/conventions.html#concurrent-calls)
    ...
    [Stability of parameters](https://arm-software.github.io/psa-api/crypto/1.2/overview/conventions.html#stability-of-parameters).
...
- [PSA Crypto](https://arm-software.github.io/psa-api/crypto/)
