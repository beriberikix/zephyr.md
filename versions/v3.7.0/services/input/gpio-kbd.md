---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/services/input/gpio-kbd.html
...
[![../../_images/no-diodes.svg](https://docs.zephyrproject.org/3.7.0/_images/no-diodes.svg)](https://docs.zephyrproject.org/3.7.0/_images/no-diodes.svg)
...
[![../../_images/diodes-rc.svg](https://docs.zephyrproject.org/3.7.0/_images/diodes-rc.svg)](https://docs.zephyrproject.org/3.7.0/_images/diodes-rc.svg)
...
[![../../_images/diodes-cr.svg](https://docs.zephyrproject.org/3.7.0/_images/diodes-cr.svg)](https://docs.zephyrproject.org/3.7.0/_images/diodes-cr.svg)
...
[![../../_images/no-sw4.svg](https://docs.zephyrproject.org/3.7.0/_images/no-sw4.svg)](https://docs.zephyrproject.org/3.7.0/_images/no-sw4.svg)
...
:   Keyboard Matrix API.
    ...
    :   Enables or disables a specific row, column combination in the actual key mask.
        ...
        This allows enabling or disabling specific row, column combination in the actual key mask in runtime. It can be useful if some of the keys are not present in some configuration, and the specific configuration is determined in runtime. Requires  [`CONFIG_INPUT_KBD_ACTUAL_KEY_MASK_DYNAMIC`](../../kconfig.md#CONFIG_INPUT_KBD_ACTUAL_KEY_MASK_DYNAMIC "CONFIG_INPUT_KBD_ACTUAL_KEY_MASK_DYNAMIC") to be enabled.
