---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/release-notes-3.6.html
...
- Audio
  ...
  - Changed `bt_bap_scan_delegator_subgroup` to [`bt_bap_bass_subgroup`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_bass_subgroup "bt_bap_bass_subgroup") and
    made it independent of [`CONFIG_BT_BAP_SCAN_DELEGATOR`](../kconfig.md#CONFIG_BT_BAP_SCAN_DELEGATOR "CONFIG_BT_BAP_SCAN_DELEGATOR").
  - Modified [`bt_bap_stream_send()`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_stream_send "bt_bap_stream_send") to no longer take a timestamp as parameter,
    and added [`bt_bap_stream_send_ts()`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_stream_send_ts "bt_bap_stream_send_ts") that does.
  - Modified [`bt_cap_stream_send()`](../connectivity/bluetooth/api/audio/cap.md#c.bt_cap_stream_send "bt_cap_stream_send") to no longer take a timestamp as parameter,
    and added [`bt_cap_stream_send_ts()`](../connectivity/bluetooth/api/audio/cap.md#c.bt_cap_stream_send_ts "bt_cap_stream_send_ts") that does.
  ...
  - Added [`bt_csip_set_member_unregister()`](../connectivity/bluetooth/api/audio/coordinated_sets.md#c.bt_csip_set_member_unregister "bt_csip_set_member_unregister") to unregister a CSIS instance.
