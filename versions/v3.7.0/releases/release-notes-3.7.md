---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/release-notes-3.7.html
...
>   deprecated:
>
>   > - [`BT_LE_ADV_CONN_NAME`](../connectivity/bluetooth/api/gap.md#c.BT_LE_ADV_CONN_NAME "BT_LE_ADV_CONN_NAME")
>   > - [`BT_LE_ADV_CONN_NAME_AD`](../connectivity/bluetooth/api/gap.md#c.BT_LE_ADV_CONN_NAME_AD "BT_LE_ADV_CONN_NAME_AD")
>   > - [`BT_LE_ADV_NCONN_NAME`](../connectivity/bluetooth/api/gap.md#c.BT_LE_ADV_NCONN_NAME "BT_LE_ADV_NCONN_NAME")
>   > - [`BT_LE_EXT_ADV_CONN_NAME`](../connectivity/bluetooth/api/gap.md#c.BT_LE_EXT_ADV_CONN_NAME "BT_LE_EXT_ADV_CONN_NAME")
>   > - [`BT_LE_EXT_ADV_SCAN_NAME`](../connectivity/bluetooth/api/gap.md#c.BT_LE_EXT_ADV_SCAN_NAME "BT_LE_EXT_ADV_SCAN_NAME")
>   > - [`BT_LE_EXT_ADV_NCONN_NAME`](../connectivity/bluetooth/api/gap.md#c.BT_LE_EXT_ADV_NCONN_NAME "BT_LE_EXT_ADV_NCONN_NAME")
...
- CAN
  ...
  - Deprecated the [`can_calc_prescaler()`](../hardware/peripherals/can/controller.md#c.can_calc_prescaler "can_calc_prescaler") API function, as it allows for bitrate
  ...
  - Deprecated the [`can_get_min_bitrate()`](../hardware/peripherals/can/controller.md#c.can_get_min_bitrate "can_get_min_bitrate") and [`can_get_max_bitrate()`](../hardware/peripherals/can/controller.md#c.can_get_max_bitrate "can_get_max_bitrate") API functions in
    favor of [`can_get_bitrate_min()`](../hardware/peripherals/can/controller.md#c.can_get_bitrate_min "can_get_bitrate_min") and [`can_get_bitrate_max()`](../hardware/peripherals/can/controller.md#c.can_get_bitrate_max "can_get_bitrate_max").
  - Deprecated the [`CAN_MAX_STD_ID`](../hardware/peripherals/can/controller.md#c.CAN_MAX_STD_ID "CAN_MAX_STD_ID") and [`CAN_MAX_EXT_ID`](../hardware/peripherals/can/controller.md#c.CAN_MAX_EXT_ID "CAN_MAX_EXT_ID") macros in favor of
    [`CAN_STD_ID_MASK`](../hardware/peripherals/can/controller.md#c.CAN_STD_ID_MASK "CAN_STD_ID_MASK") and [`CAN_EXT_ID_MASK`](../hardware/peripherals/can/controller.md#c.CAN_EXT_ID_MASK "CAN_EXT_ID_MASK").
- PM

  - Deprecated [`CONFIG_PM_DEVICE_RUNTIME_EXCLUSIVE`](../kconfig.md#CONFIG_PM_DEVICE_RUNTIME_EXCLUSIVE "CONFIG_PM_DEVICE_RUNTIME_EXCLUSIVE"). Similar behavior can be achieved
...
- RISC-V
  ...
  - Implemented stack unwinding
    ...
    - Symbol names can be enabled by selecting [`CONFIG_EXCEPTION_STACK_TRACE_SYMTAB`](../kconfig.md#CONFIG_EXCEPTION_STACK_TRACE_SYMTAB "CONFIG_EXCEPTION_STACK_TRACE_SYMTAB")
- Xtensa
  ...
  - Fixed an issue where [`arch_user_string_nlen()`](../hardware/porting/arch.md#c.arch_user_string_nlen "arch_user_string_nlen") accessing unmapped memory resulted
    in an unrecoverable exception.

## Kernel

> - Added [`k_uptime_seconds()`](../kernel/services/timing/clocks.md#c.k_uptime_seconds "k_uptime_seconds") function to simplify `k_uptime_get() / 1000` usage.
> - Added [`k_realloc()`](../kernel/memory_management/heap.md#c.k_realloc "k_realloc"), that uses kernel heap to implement traditional `realloc()`
>   semantics.
...
>   initialized later in time by using [`device_init()`](../kernel/drivers/index.md#c.device_init "device_init").
> - The declaration of statically allocated thread stacks has been updated to utilize
>   [`K_THREAD_STACK_LEN`](../kernel/services/threads/index.md#c.K_THREAD_STACK_LEN "K_THREAD_STACK_LEN") for both single thread stack declaration and array thread
...
> - Fix an edge case deadlock in [`k_thread_abort()`](../kernel/services/threads/index.md#c.k_thread_abort "k_thread_abort") (and join)
...
- Audio
  ...
  - Removed `err` from [`bt_bap_broadcast_assistant_cb.recv_state_removed`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_broadcast_assistant_cb.recv_state_removed "bt_bap_broadcast_assistant_cb.recv_state_removed") as it was
    redundant.
...
- Host
  ...
  - Improve [`bt_foreach_bond()`](../connectivity/bluetooth/api/gap.md#c.bt_foreach_bond "bt_foreach_bond") to support Bluetooth Classic key traversal.
- HCI Drivers
...
- Added support for these boards:
  ...
  - Added support for [Ambiq Apollo3 Blue board](../boards/ambiq/apollo3_evb/doc/index.md#apollo3-evb): `apollo3_evb`.
  - Added support for [Ambiq Apollo3 Blue Plus board](../boards/ambiq/apollo3p_evb/doc/index.md#apollo3p-evb): `apollo3p_evb`.
  - Added support for [Raspberry Pi 5 board](../boards/raspberrypi/rpi_5/doc/index.md#rpi-5): `rpi_5`.
  - Added support for [Seeed Studio XIAO RP2040 board](../boards/seeed/xiao_rp2040/doc/index.md#xiao-rp2040): `xiao_rp2040`.
  - Added support for [Mikroe RA4M1 Clicker board](../boards/mikroe/clicker_ra4m1/doc/index.md#mikroe-clicker-ra4m1): `mikroe_clicker_ra4m1`.
  - Added support for [Arduino UNO R4 WiFi board](../boards/arduino/uno_r4/doc/index.md#arduino-uno-r4): `arduino_uno_r4_wifi`.
  - Added support for [Renesas EK-RA8M1 board](../boards/renesas/ek_ra8m1/doc/index.md#ek-ra8m1): `ek_ra8m1`.
  - Added support for [ST Nucleo H533RE](../boards/st/nucleo_h533re/doc/index.md#nucleo-h533re-board): `nucleo_h533re`.
  - Added support for [ST STM32C0116-DK Discovery Kit](../boards/st/stm32c0116_dk/doc/index.md#stm32c0116-dk-board): `stm32c0116_dk`.
  - Added support for [ST STM32H745I Discovery](../boards/st/stm32h745i_disco/doc/index.md#stm32h745i-disco-board): `stm32h745i_disco`.
  - Added support for [ST STM32H7S78-DK Discovery](../boards/st/stm32h7s78_dk/doc/index.md#stm32h7s78-dk-board): `stm32h7s78_dk`.
  - Added support for [ST STM32L152CDISCOVERY board](../boards/st/stm32l1_disco/doc/index.md#stm32l1-disco-board): `stm32l152c_disco`.
  - Added support for [ST STEVAL STWINBX1 Development kit](../boards/st/steval_stwinbx1/doc/index.md#steval-stwinbx1-board): `steval_stwinbx1`.
  - Added support for NXP boards: `frdm_mcxn947`, `ke17z512`, `rd_rw612_bga`, `frdm_rw612`, `frdm_ke15z`, `frdm_ke17z`
  - Added support for [Synopsys ARC-V RMX1xx nSIM-based simulation platform](../boards/snps/nsim/arc_v/doc/index.md#nsim-arc-v): `nsim_arc_v/rmx100`.
  - Added support for [Analog Devices MAX32690EVKIT](../boards/adi/max32690evkit/doc/index.md#max32690-evkit): `max32690evkit`.
  - Added support for [Analog Devices MAX32680EVKIT](../boards/adi/max32680evkit/doc/index.md#max32680-evkit): `max32680evkit`.
  - Added support for [Analog Devices MAX32672EVKIT](../boards/adi/max32672evkit/doc/index.md#max32672-evkit): `max32672evkit`.
  - Added support for [Analog Devices MAX32672FTHR](../boards/adi/max32672fthr/doc/index.md#max32672-fthr): `max32672fthr`.
  - Added support for [Analog Devices MAX32670EVKIT](../boards/adi/max32670evkit/doc/index.md#max32670-evkit): `max32670evkit`.
  - Added support for [Analog Devices MAX32655EVKIT](../boards/adi/max32655evkit/doc/index.md#max32655-evkit): `max32655evkit`.
  - Added support for [Analog Devices MAX32655FTHR](../boards/adi/max32655fthr/doc/index.md#max32655-fthr): `max32655fthr`.
  - Added support for [Analog Devices AD-APARD32690-SL](../boards/adi/apard32690/doc/index.md#ad-apard32690-sl): `ad_apard32690_sl`.
  - Added support for [Infineon Technologies CYW920829M2EVK-02](../boards/infineon/cyw920829m2evk_02/doc/index.md#cyw920829m2evk-02): `cyw920829m2evk_02`.
  - Added support for [Nuvoton Numaker M2L31KI board](../boards/nuvoton/numaker_m2l31ki/doc/index.md#nuvoton-m2l31ki): `numaker_m2l31ki`.
  - Added support for [Espressif ESP32-S2 DevKit-C](../boards/espressif/esp32s2_devkitc/doc/index.md#esp32s2-devkitc): `esp32s2_devkitc`.
  - Added support for [Espressif ESP32-S3 DevKit-C](../boards/espressif/esp32s3_devkitc/doc/index.md#esp32s3-devkitc): `esp32s3_devkitc`.
  - Added support for [Espressif ESP32-C6 DevKit-C](../boards/espressif/esp32c6_devkitc/doc/index.md#esp32c6-devkitc): `esp32c6_devkitc`.
  - Added support for [Waveshare ESP32-S3-Touch-LCD-1.28](../boards/waveshare/esp32s3_touch_lcd_1_28/doc/index.md#esp32s3-touch-lcd-1-28): `esp32s3_touch_lcd_1_28`.
  - Added support for [M5Stack ATOM Lite](../boards/m5stack/m5stack_atom_lite/doc/index.md#m5stack-atom-lite): `m5stack_atom_lite`.
  - Added support for [CTHINGS.CO Connectivity Card nRF52840](../boards/ct/ctcc/doc/index.md#ctcc-nrf52840): `ctcc_nrf52840`.
- Made these board changes:

  - On [ST STM32H7B3I Discovery Kit](../boards/st/stm32h7b3i_dk/doc/index.md#stm32h7b3i-dk-board): `stm32h7b3i_dk_board`,
  ...
  - Refactored [BeagleConnect Freedom](../boards/beagle/beagleconnect_freedom/doc/index.md#beagleconnect-freedom) external antenna switch handling.
...
- Added support for the following shields:
  ...
  - [RK043FN02H-CT Parallel Display](../boards/shields/rk043fn02h_ct/doc/index.md#rk043fn02h-ct) (`rk043fn02h_ct`)
  - [RK043FN66HS-CTG Parallel Display](../boards/shields/rk043fn66hs_ctg/doc/index.md#rk043fn66hs-ctg) (`rk043fn66hs_ctg`)
...
- ADC
  ...
  - Sample changes
    ...
    - Added a new sample called adc\_sequence that shows more of the runtime
      [`adc_sequence`](../hardware/peripherals/adc.md#c.adc_sequence "adc_sequence") features.
  - New ADC Drivers
  ...
  - ADI AD559x changes
    ...
    - Added configuration of internal reference voltage value to ad559x to support
      calls of [`adc_raw_to_millivolts()`](../hardware/peripherals/adc.md#c.adc_raw_to_millivolts "adc_raw_to_millivolts").
  ...
  - Other driver changes
    ...
    - Fixed issue with [`adc_raw_to_millivolts()`](../hardware/peripherals/adc.md#c.adc_raw_to_millivolts "adc_raw_to_millivolts") returning half the actual voltage with
...
- CAN
  ...
  - Extended support for automatic sample point location to also cover [`can_calc_timing()`](../hardware/peripherals/can/controller.md#c.can_calc_timing "can_calc_timing") and
  ...
  - Added devicetree macros [`DT_CAN_TRANSCEIVER_MIN_BITRATE`](../build/dts/api/api.md#c.DT_CAN_TRANSCEIVER_MIN_BITRATE "DT_CAN_TRANSCEIVER_MIN_BITRATE") and
    [`DT_INST_CAN_TRANSCEIVER_MIN_BITRATE`](../build/dts/api/api.md#c.DT_INST_CAN_TRANSCEIVER_MIN_BITRATE "DT_INST_CAN_TRANSCEIVER_MIN_BITRATE") for getting the minimum supported bitrate of a CAN
    transceiver.
  ...
  - Added [`can_get_bitrate_min()`](../hardware/peripherals/can/controller.md#c.can_get_bitrate_min "can_get_bitrate_min") and [`can_get_bitrate_max()`](../hardware/peripherals/can/controller.md#c.can_get_bitrate_max "can_get_bitrate_max") for retrieving the minimum
    ...
    [`can_get_max_bitrate()`](../hardware/peripherals/can/controller.md#c.can_get_max_bitrate "can_get_max_bitrate") API function.
...
- Disk
  ...
  - Added support for [`DISK_IOCTL_CTRL_INIT`](../services/storage/disk/access.md#c.DISK_IOCTL_CTRL_INIT "DISK_IOCTL_CTRL_INIT") and
    [`DISK_IOCTL_CTRL_DEINIT`](../services/storage/disk/access.md#c.DISK_IOCTL_CTRL_DEINIT "DISK_IOCTL_CTRL_DEINIT") macros, which allow for initializing
...
- Display
  ...
  - Added support for [`display_read()`](../hardware/peripherals/display/index.md#c.display_read "display_read") API to ILI9XXX display driver,
    which can be enabled with [`CONFIG_ILI9XXX_READ`](../kconfig.md#CONFIG_ILI9XXX_READ "CONFIG_ILI9XXX_READ")
  - Added support for [`display_set_orientation()`](../hardware/peripherals/display/index.md#c.display_set_orientation "display_set_orientation") API to SSD16XXX
    display driver
  ...
  - Added support for [`display_set_pixel_format()`](../hardware/peripherals/display/index.md#c.display_set_pixel_format "display_set_pixel_format") API to NXP eLCDIF
  ...
  - Added support for inverting color at runtime to the SSD1306 driver, via
    the [`display_set_pixel_format()`](../hardware/peripherals/display/index.md#c.display_set_pixel_format "display_set_pixel_format") API.
...
- Flash
  ...
  - Added preliminary support for non-erase devices with introduction of
    device capabilities to c:struct:flash\_parameters and the utility function
    c:func:flash\_params\_get\_erase\_cap that allows to obtain the erase type
    provided by a device; added c:macro:FLASH\_ERASE\_C\_EXPLICIT, which is
    currently the only supported erase type and is set by all flash devices.
  - Added the c:func:flash\_flatten function that can be used on devices,
    ...
    that device.
  - Added the c:func:flash\_fill utility function which allows to write
...
- GNSS
  ...
  - Added device driver for the u-blox M10 GNSS modem ([`u-blox,m10`](../build/dts/api/bindings/gnss/u-blox%2Cm10.md#std-dtcompatible-u-blox-m10)).
...
- GPIO
  ...
  - Added c:macro:STM32\_GPIO\_WKUP flag which allows to configure specific pins as wakeup source
...
- I2C
  ...
  - In STM32 V2 driver, added support for a new [`CONFIG_I2C_STM32_V2_TIMING`](../kconfig.md#CONFIG_I2C_STM32_V2_TIMING "CONFIG_I2C_STM32_V2_TIMING")
    ...
    in a production application, a dedicated sample [STM32 I2C V2 timings](../samples/boards/stm32/i2c_timing/README.md#stm32_i2c_v2_timings) is provided
...
- LED Strip
  ...
  - A length function has been added which returns the length of the LED strip
    ([`led_strip_length()`](../hardware/peripherals/led.md#c.led_strip_length "led_strip_length")).
...
- PWM
  ...
  - Fix zephyr:code-sample:pwm-blinky code sample to demonstrate PWM support for
    [BeagleConnect Freedom](../boards/beagle/beagleconnect_freedom/doc/index.md#beagleconnect-freedom).
  - Added driver for ENE KB1200.
...
- Sensors
  ...
  - General
    ...
    - Added a blocking sensor read call [`sensor_read()`](../hardware/peripherals/sensor/index.md#c.sensor_read "sensor_read").
...
- Wi-Fi
  ...
  - Implement [`bind()`](../connectivity/networking/api/sockets.md#c.bind "bind") and [`recvfrom()`](../connectivity/networking/api/sockets.md#c.recvfrom "recvfrom") for UDP sockets for esp-at.
...
- CoAP:
  ...
  - Added new CoAP client [`coap_client_cancel_requests()`](../connectivity/networking/api/coap_client.md#c.coap_client_cancel_requests "coap_client_cancel_requests") API which allows
...
- Connection manager:
  ...
  - Added support for new net\_mgmt events, which allow to track IPv4 and IPv6
    ...
    - [`NET_EVENT_L4_IPV4_CONNECTED`](../connectivity/networking/api/net_mgmt.md#c.NET_EVENT_L4_IPV4_CONNECTED "NET_EVENT_L4_IPV4_CONNECTED")
    - [`NET_EVENT_L4_IPV4_DISCONNECTED`](../connectivity/networking/api/net_mgmt.md#c.NET_EVENT_L4_IPV4_DISCONNECTED "NET_EVENT_L4_IPV4_DISCONNECTED")
    - [`NET_EVENT_L4_IPV6_CONNECTED`](../connectivity/networking/api/net_mgmt.md#c.NET_EVENT_L4_IPV6_CONNECTED "NET_EVENT_L4_IPV6_CONNECTED")
    - [`NET_EVENT_L4_IPV6_DISCONNECTED`](../connectivity/networking/api/net_mgmt.md#c.NET_EVENT_L4_IPV6_DISCONNECTED "NET_EVENT_L4_IPV6_DISCONNECTED")
- DHCPv4:
  ...
  - Added support for encapsulated vendor specific options. By enabling
    ...
    registered with [`net_dhcpv4_add_option_vendor_callback()`](../connectivity/networking/api/dhcpv4.md#c.net_dhcpv4_add_option_vendor_callback "net_dhcpv4_add_option_vendor_callback") to handle these options after
    being initialised with [`net_dhcpv4_init_option_vendor_callback()`](../connectivity/networking/api/dhcpv4.md#c.net_dhcpv4_init_option_vendor_callback "net_dhcpv4_init_option_vendor_callback").
...
- IPv4:
  ...
  - Added [`net_ipv4_is_private_addr()`](../connectivity/networking/api/ip_4_6.md#c.net_ipv4_is_private_addr "net_ipv4_is_private_addr") API function.
...
- IPv6:
  ...
  - Added [`net_ipv6_is_private_addr()`](../connectivity/networking/api/ip_4_6.md#c.net_ipv6_is_private_addr "net_ipv6_is_private_addr") API function.
  - Implemented reachability hint for IPv6. Upper layers can use
    c:func:net\_if\_nbr\_reachability\_hint to report Neighbor reachability and
...
- LwM2M:
  ...
  - Added new API functions:
    ...
    - [`lwm2m_set_bulk()`](../connectivity/networking/api/lwm2m.md#c.lwm2m_set_bulk "lwm2m_set_bulk")
    - `lwm2m_rd_client_set_ctx()`
  - Added new `offset` parameter to [`lwm2m_engine_set_data_cb_t`](../connectivity/networking/api/lwm2m.md#c.lwm2m_engine_set_data_cb_t "lwm2m_engine_set_data_cb_t") callback type.
...
- Misc:
  ...
  - Added SNTP [`sntp_simple_addr()`](../connectivity/networking/api/sntp.md#c.sntp_simple_addr "sntp_simple_addr") API function to perform SNTP query
  ...
  - Removed obsolete and unused `tcp_first_msg` [`net_pkt`](../connectivity/networking/api/net_pkt.md#c.net_pkt "net_pkt") flag.
...
- MQTT:
  ...
  - Added user data field in [`mqtt_client`](../connectivity/networking/api/mqtt.md#c.mqtt_client "mqtt_client") context structure.
  - Fixed a potential socket leak in MQTT Websockets transport.
- Network Interface:

  - Added new API functions:

    - [`net_if_ipv4_maddr_foreach()`](../connectivity/networking/api/net_if.md#c.net_if_ipv4_maddr_foreach "net_if_ipv4_maddr_foreach")
    - [`net_if_ipv6_maddr_foreach()`](../connectivity/networking/api/net_if.md#c.net_if_ipv6_maddr_foreach "net_if_ipv6_maddr_foreach")
  - Improved debug logging in the network interface code.
  - Added reference counter to the [`net_if_addr`](../connectivity/networking/api/net_if.md#c.net_if_addr "net_if_addr") structure.
...
- Sockets:
  ...
  - Fixed [`getsockname()`](../connectivity/networking/api/sockets.md#c.getsockname "getsockname") for TCP.
  - Improve [`sendmsg()`](../connectivity/networking/api/sockets.md#c.sendmsg "sendmsg") support when using DTLS sockets.
  - Fixed `net_socket_service_register()` function stall in case socket
  ...
  - Fixed potential busy looping when using [`zsock_accept()`](../connectivity/networking/api/sockets.md#c.zsock_accept "zsock_accept") in case of
...
- Syslog:
  ...
  - Added new API functions:
    ...
    - `log_backend_net_set_ip()` to initialize syslog net backend with IP
      address directly.
    - `log_backend_net_start()` to facilitate syslog net backend activation.
...
- TCP:
  ...
  - Deprecated [`CONFIG_NET_TCP_ACK_TIMEOUT`](../kconfig.md#CONFIG_NET_TCP_ACK_TIMEOUT "CONFIG_NET_TCP_ACK_TIMEOUT") as it was redundant with other configs.
...
- Websocket:
  ...
  - Added new Websocket APIs:
    ...
    - [`websocket_register()`](../connectivity/networking/api/websocket.md#c.websocket_register "websocket_register")
    - [`websocket_unregister()`](../connectivity/networking/api/websocket.md#c.websocket_unregister "websocket_unregister")
...
- Added [`DT_INST_NODE_HAS_COMPAT`](../build/dts/api/api.md#c.DT_INST_NODE_HAS_COMPAT "DT_INST_NODE_HAS_COMPAT") to check if a node has a compatible.
  This is useful for nodes that have multiple compatibles.
- Added [`DT_CHILD_NUM`](../build/dts/api/api.md#c.DT_CHILD_NUM "DT_CHILD_NUM") and variants to count the number of children of a node.
- Added [`DT_FOREACH_NODELABEL`](../build/dts/api/api.md#c.DT_FOREACH_NODELABEL "DT_FOREACH_NODELABEL") and variants, which can be used to iterate over the
  node labels of a devicetree node.
- Added [`DT_NODELABEL_STRING_ARRAY`](../build/dts/api/api.md#c.DT_NODELABEL_STRING_ARRAY "DT_NODELABEL_STRING_ARRAY") and [`DT_NUM_NODELABELS`](../build/dts/api/api.md#c.DT_NUM_NODELABELS "DT_NUM_NODELABELS") and their variants.
- Added [`DT_REG_HAS_NAME`](../build/dts/api/api.md#c.DT_REG_HAS_NAME "DT_REG_HAS_NAME") and variants.
- Reworked [`DT_ANY_INST_HAS_PROP_STATUS_OKAY`](../build/dts/api/api.md#c.DT_ANY_INST_HAS_PROP_STATUS_OKAY "DT_ANY_INST_HAS_PROP_STATUS_OKAY") so that the result can
  be used with macros like [`IS_ENABLED`](../kernel/util/index.md#c.IS_ENABLED "IS_ENABLED"), IF\_ENABLED, or COND\_CODE\_x.
- Reworked [`DT_NODE_HAS_COMPAT_STATUS`](../build/dts/api/api.md#c.DT_NODE_HAS_COMPAT_STATUS "DT_NODE_HAS_COMPAT_STATUS") so that it can be evaluated at preprocessor time.
...
- Management
  ...
  - hawkBit
    ...
    - By enabling [`CONFIG_HAWKBIT_SET_SETTINGS_RUNTIME`](../kconfig.md#CONFIG_HAWKBIT_SET_SETTINGS_RUNTIME "CONFIG_HAWKBIT_SET_SETTINGS_RUNTIME"), the hawkBit settings can
      be configured at runtime. Use the `hawkbit_set_config()` function to set the hawkBit
    ...
    - By enabling [`CONFIG_HAWKBIT_CUSTOM_DEVICE_ID`](../kconfig.md#CONFIG_HAWKBIT_CUSTOM_DEVICE_ID "CONFIG_HAWKBIT_CUSTOM_DEVICE_ID"), a callback function can be
      registered to set the device ID. Use the `hawkbit_set_device_identity_cb()` function to
    ...
    - By enabling [`CONFIG_HAWKBIT_CUSTOM_ATTRIBUTES`](../kconfig.md#CONFIG_HAWKBIT_CUSTOM_ATTRIBUTES "CONFIG_HAWKBIT_CUSTOM_ATTRIBUTES"), a callback function can be
      ...
      `hawkbit_set_custom_data_cb()` function to register the callback.
  - MCUmgr
...
- Logging
  ...
  - Add [`LOG_WRN_ONCE`](../services/logging/index.md#c.LOG_WRN_ONCE "LOG_WRN_ONCE") for logging warning message where only the first occurrence is
    logged.
  - Add [`log_thread_trigger()`](../services/logging/index.md#c.log_thread_trigger "log_thread_trigger") for triggering processing of the log messages.
...
- Power management
  ...
  - Devices can now declare which system power states cause power loss.
    ...
    [`pm_policy_device_power_lock_get()`](../services/pm/api/index.md#c.pm_policy_device_power_lock_get "pm_policy_device_power_lock_get") and [`pm_policy_device_power_lock_put()`](../services/pm/api/index.md#c.pm_policy_device_power_lock_put "pm_policy_device_power_lock_put")
...
- Random
  ...
  - Besides the existing [`sys_rand32_get()`](../services/crypto/random/index.md#c.sys_rand32_get "sys_rand32_get") function, [`sys_rand8_get()`](../services/crypto/random/index.md#c.sys_rand8_get "sys_rand8_get"),
    [`sys_rand16_get()`](../services/crypto/random/index.md#c.sys_rand16_get "sys_rand16_get") and [`sys_rand64_get()`](../services/crypto/random/index.md#c.sys_rand64_get "sys_rand64_get") are now also available.
    These functions are all implemented on top of [`sys_rand_get()`](../services/crypto/random/index.md#c.sys_rand_get "sys_rand_get").
- SD
...
- State Machine Framework
  ...
  - The [`SMF_CREATE_STATE`](../services/smf/index.md#c.SMF_CREATE_STATE "SMF_CREATE_STATE") macro now always takes 5 arguments.
  ...
  - Passing `NULL` to [`smf_set_state()`](../services/smf/index.md#c.smf_set_state "smf_set_state") is now not allowed.
- Storage
  ...
  - FS: It is now possible to truncate a file while opening using [`fs_open()`](../services/file_system/index.md#c.fs_open "fs_open")
    and by passing `FS_O_TRUNC` flag.
  - Flash Map: TinyCrypt has been replaced with PSA Crypto in Flash Area integrity check.
  - Flash Map: [`flash_area_flatten()`](../services/storage/flash_map/flash_map.md#c.flash_area_flatten "flash_area_flatten") has been added to be used where an erase
    operation has been previously used for removing/scrambling data rather than
    to prepare a device for a random data write.
  - Flash Map: [`FIXED_PARTITION_NODE_OFFSET`](../services/storage/flash_map/flash_map.md#c.FIXED_PARTITION_NODE_OFFSET "FIXED_PARTITION_NODE_OFFSET"), [`FIXED_PARTITION_NODE_SIZE`](../services/storage/flash_map/flash_map.md#c.FIXED_PARTITION_NODE_SIZE "FIXED_PARTITION_NODE_SIZE")
    and [`FIXED_PARTITION_NODE_DEVICE`](../services/storage/flash_map/flash_map.md#c.FIXED_PARTITION_NODE_DEVICE "FIXED_PARTITION_NODE_DEVICE") have been added to allow obtaining
  ...
  - Fixed NVS issue where [`nvs_calc_free_space()`](../services/storage/nvs/nvs.md#c.nvs_calc_free_space "nvs_calc_free_space") would return larger
...
- ZBus
  ...
  - Added a way of isolating a channel message subscribers pool. Some channels can now share an
    ...
    function [`zbus_chan_set_msg_sub_pool()`](../services/zbus/index.md#c.zbus_chan_set_msg_sub_pool "zbus_chan_set_msg_sub_pool") to change the msg pool used by the channel.
