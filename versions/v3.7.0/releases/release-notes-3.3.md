---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/release-notes-3.3.html
...
- SPI DT `spi_is_ready()` function has been deprecated in favor of [`spi_is_ready_dt()`](../hardware/peripherals/spi.md#c.spi_is_ready_dt "spi_is_ready_dt").
...
- Sensor
  ...
  - Refactored all drivers to use [`SENSOR_DEVICE_DT_INST_DEFINE`](../hardware/peripherals/sensor/index.md#c.SENSOR_DEVICE_DT_INST_DEFINE "SENSOR_DEVICE_DT_INST_DEFINE") to
