---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/migration-guide-3.6.html
...
> - The ts parameter of [`bt_bap_stream_send()`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_stream_send "bt_bap_stream_send") has been removed.
>   [`bt_bap_stream_send()`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_stream_send "bt_bap_stream_send") now always sends without timestamp.
>   To send with a timestamp, [`bt_bap_stream_send_ts()`](../connectivity/bluetooth/api/audio/bap.md#c.bt_bap_stream_send_ts "bt_bap_stream_send_ts") can be used.
> - The ts parameter of [`bt_cap_stream_send()`](../connectivity/bluetooth/api/audio/cap.md#c.bt_cap_stream_send "bt_cap_stream_send") has been removed.
>   [`bt_cap_stream_send()`](../connectivity/bluetooth/api/audio/cap.md#c.bt_cap_stream_send "bt_cap_stream_send") now always sends without timestamp.
>   To send with a timestamp, [`bt_cap_stream_send_ts()`](../connectivity/bluetooth/api/audio/cap.md#c.bt_cap_stream_send_ts "bt_cap_stream_send_ts") can be used.
