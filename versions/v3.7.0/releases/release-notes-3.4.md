---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/release-notes-3.4.html
...
- Including updatehub in an application now requires additional Kconfig options
  ...
  > | [`CONFIG_JSON_LIBRARY`](../kconfig.md#CONFIG_JSON_LIBRARY "CONFIG_JSON_LIBRARY") |
  > | [`CONFIG_HWINFO`](../kconfig.md#CONFIG_HWINFO "CONFIG_HWINFO") |
- The sensor driver API clarified [`sensor_trigger_set()`](../hardware/peripherals/sensor/index.md#c.sensor_trigger_set "sensor_trigger_set") to state that
...
- MCUmgr fs\_mgmt group’s file access hook is now called for all fs\_mgmt group
  ...
  `fs_mgmt_file_access` for the new structure definition.
