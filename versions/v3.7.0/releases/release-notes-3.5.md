---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/releases/release-notes-3.5.html
...
- Sockets:
  ...
  - Added support for `FIONREAD` and `FIONBIO` `ioctl()` commands.
...
- Maxim Integrated Products (maxim):
  ...
  - New bindings:
    ...
    - [`maxim,max31790`](../build/dts/api/bindings/mfd/maxim,max31790.md#std-dtcompatible-maxim-max31790)
