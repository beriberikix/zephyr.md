---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/subsys/mgmt/hawkbit/README.html
...
- The Zephyr port of hawkBit is configured to run on a
  [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) MCU by default. The application should
...
hawkBit can be built for the [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) as follows:
...
`hawkBit https` can be built for the [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) as follows:
