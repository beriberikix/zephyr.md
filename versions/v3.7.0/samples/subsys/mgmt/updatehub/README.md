---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/subsys/mgmt/updatehub/README.html
...
- The Zephyr port of `UpdateHub` was initially developed to run on a
  [Freedom-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) kit using the ethernet connectivity. The
...
```shell
west build -b [ frdm_k64f | nrf52840dk/nrf52840 | nucleo_f767zi ] --shield esp_8266_arduino -d build/app zephyr/samples/subsys/mgmt/updatehub -- -DEXTRA_CONF_FILE="overlay-wifi.conf;overlay-prj.conf"
```
...
```shell
west build -b nrf52840dk/nrf52840 -d build/app zephyr/samples/subsys/mgmt/updatehub -- -DEXTRA_CONF_FILE="overlay-802154.conf;overlay-prj.conf"
```

```shell
west build -b [ frdm_k64f | nucleo_f767zi ] --shield atmel_rf2xx_arduino -d build/app zephyr/samples/subsys/mgmt/updatehub -- -DEXTRA_CONF_FILE="overlay-802154.conf;overlay-prj.conf"
```
...
```shell
west build -b nrf52840dk/nrf52840 -d build/app zephyr/samples/subsys/mgmt/updatehub -- -DEXTRA_CONF_FILE="overlay-ot.conf;overlay-prj.conf"
```
...
| --- | --- |
| [NXP FRDM-K64F](../../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) | 1, 2, 3, 4 |
| [nRF52840 DK](../../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk-nrf52840) | 2, 3, 4, 5, 6 |
| [ST Nucleo F767ZI](../../../../boards/st/nucleo_f767zi/doc/index.md#nucleo-f767zi-board) | 1, 2, 3, 4 |
