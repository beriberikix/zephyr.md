...
[![ZBus priority boost scenario example.](https://docs.zephyrproject.org/3.7.0/_images/zbus_publishing_process_example_scenario.svg)](https://docs.zephyrproject.org/3.7.0/_images/zbus_publishing_process_example_scenario.svg)
...
[![ZBus example scenario for priority boost disabled.](https://docs.zephyrproject.org/3.7.0/_images/without_hlp_priority_boost_feature.svg)](https://docs.zephyrproject.org/3.7.0/_images/without_hlp_priority_boost_feature.svg)
...
[![ZBus example scenario for priority boost enabled.](https://docs.zephyrproject.org/3.7.0/_images/with_hlp_priority_boost_feature.svg)](https://docs.zephyrproject.org/3.7.0/_images/with_hlp_priority_boost_feature.svg)
