---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/sensor/tmp112/README.html
...
To build and flash the sample for the [NXP FRDM-K64F](../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f):
