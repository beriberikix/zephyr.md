---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/basic/servo_motor/README.html
...
The sample has a devicetree overlay for the [BBC MicroBit](../../../boards/bbc/microbit/doc/index.md#bbc-microbit).
