---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/bluetooth/bap_unicast_client/README.html
...
west build -b nrf52840dk/nrf52840 samples/bluetooth/bap_unicast_client/ -- -DOVERLAY_CONFIG=overlay-bt_ll_sw_split.conf
```
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/bap_unicast_client/ -- -DOVERLAY_CONFIG=overlay-bt_ll_sw_split.conf
```
