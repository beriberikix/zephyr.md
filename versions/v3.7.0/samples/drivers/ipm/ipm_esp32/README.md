---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/drivers/ipm/ipm_esp32/README.html
...
```shell
west build -b esp32_devkitc_wroom/esp32/procpu samples/drivers/ipm/ipm_esp32
```
