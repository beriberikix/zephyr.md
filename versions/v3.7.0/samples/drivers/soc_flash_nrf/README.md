---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/drivers/soc_flash_nrf/README.html
...
The sample uses [Flash map API](../../../services/storage/flash_map/flash_map.md#flash-map-api) to obtain a device that has
partition defined with label storage\_partition, then uses [Flash API](../../../hardware/peripherals/flash.md#flash-api)
...
fixed-partition, over that internal storage, labeled storage\_partition.
