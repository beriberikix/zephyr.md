---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/net/wpanusb/README.html
...
- a Zephyr board with supported 802.15.4 radio and supported USB driver
  (such as the [nRF52840 DK](../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk-nrf52840) or [SAM R21 Xplained Pro Evaluation Kit](../../../boards/atmel/sam0/samr21_xpro/doc/index.md#samr21-xpro))
...
```shell
west build -b nrf52840dk/nrf52840 samples/net/wpanusb
```
