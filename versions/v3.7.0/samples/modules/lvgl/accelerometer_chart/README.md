---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/modules/lvgl/accelerometer_chart/README.html
...
- A sensor that provides acceleration data ([`SENSOR_CHAN_ACCEL_XYZ`](../../../../hardware/peripherals/sensor/index.md#c.sensor_channel.SENSOR_CHAN_ACCEL_XYZ "SENSOR_CHAN_ACCEL_XYZ")) and available
