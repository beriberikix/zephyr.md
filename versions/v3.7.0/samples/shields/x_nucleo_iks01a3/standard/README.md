---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/shields/x_nucleo_iks01a3/standard/README.html
original_path: samples/shields/x_nucleo_iks01a3/standard/README.html
---
...
and devicetree). See for example the [ST Nucleo F401RE](../../../../boards/st/nucleo_f401re/doc/index.md#nucleo-f401re-board) board
source code:
...
```shell
west build -b nucleo_f401re samples/shields/x_nucleo_iks01a3/standard/
```
