---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/esp32/light_sleep/README.html
...
```shell
west build -b esp32_devkitc_wroom/esp32/procpu samples/boards/esp32/light_sleep
west flash
```
