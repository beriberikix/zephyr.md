---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/esp32/deep_sleep/README.html
...
[ESP32-DEVKITC-WROOM](../../../../boards/espressif/esp32_devkitc_wroom/doc/index.md#esp32-devkitc-wroom) development board without any extra hardware if
...
```shell
west build -b esp32_devkitc_wroom/esp32/procpu samples/boards/esp32/deep_sleep
west flash
```
