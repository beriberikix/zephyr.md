---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/nrf/clock_skew/README.html
original_path: samples/boards/nrf/clock_skew/README.html
---
...
```shell
west build -b nrf52dk/nrf52832 samples/boards/nrf/clock_skew
west flash
```
