---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/nrf/mesh/onoff_level_lighting_vnd_app/README.html
...
```shell
west build -b nrf52840dk/nrf52840 samples/boards/nrf/mesh/onoff_level_lighting_vnd_app
west flash
```
