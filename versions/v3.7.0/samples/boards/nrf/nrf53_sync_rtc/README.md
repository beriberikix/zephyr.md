---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/nrf/nrf53_sync_rtc/README.html
...
west build -b nrf5340dk/nrf5340/cpuapp --sysbuild samples/boards/nrf/nrf53_sync_rtc
...
```shell
# From the root of the zephyr repository
west build -b nrf5340bsim/nrf5340/cpuapp --sysbuild samples/boards/nrf/nrf53_sync_rtc
```
