---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/nxp_s32/netc/README.html
...
west build -b s32z2xxdc2/s32z270/rtu0 samples/boards/nxp_s32/netc
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b s32z2xxdc2/s32z270/rtu0 samples/boards/nxp_s32/netc -- -DDTC_OVERLAY_FILE="./vsi-and-psi.overlay"
west flash
```
