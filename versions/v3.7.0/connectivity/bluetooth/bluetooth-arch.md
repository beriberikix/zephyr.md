---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/bluetooth-arch.html
...
`samples/bluetooth/`
:   [Sample Bluetooth code](../../samples/bluetooth/bluetooth.md#bluetooth-samples). This is a good reference to
