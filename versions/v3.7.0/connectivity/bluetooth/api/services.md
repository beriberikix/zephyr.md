---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/services.html
...
*group* Immediate Alert Service (IAS)
...
*group* Object Transfer Service (OTS)
