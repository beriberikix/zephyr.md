---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/att.html
...
:   Attribute Protocol (ATT).
    ...
    static inline const char \*bt\_att\_err\_to\_str(uint8\_t att\_err)
    :   Converts a ATT error to string.
        ...
        Returns:
        :   The string representation of the ATT error code. If  [`CONFIG_BT_ATT_ERR_TO_STR`](../../../kconfig.md#CONFIG_BT_ATT_ERR_TO_STR "CONFIG_BT_ATT_ERR_TO_STR") is not enabled, this just returns the empty string
