---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/gap.html
...
*group* Generic Access Profile (GAP)
:   Generic Access Profile (GAP).
    ...
    **Version**
    ...
    BT\_LE\_SCAN\_ACTIVE\_CONTINUOUS
    ...
    BT\_LE\_SCAN\_PASSIVE\_CONTINUOUS
    ...
    :   Disable Bluetooth.
        ...
        This API will clear all configured identities and keys that are not persistently stored with  [`CONFIG_BT_SETTINGS`](../../../kconfig.md#CONFIG_BT_SETTINGS "CONFIG_BT_SETTINGS") . These can be restored with [settings\_load()](../../../services/settings/index.md#group__settings_1ga89c6d618df81f197cc5c1a2018b00648) before reenabling the stack.

        This API does *not* clear previously registered callbacks like [bt\_le\_scan\_cb\_register](#group__bt__gap_1ga80e870fa1de40c404c64624bef439067) and [bt\_conn\_cb\_register](connection_mgmt.md#group__bt__conn_1gaa9b79cd44734c1e560d6f30509be4d0b). That is, the application shall not re-register them when the Bluetooth subsystem is re-enabled later.
    ...
    int bt\_le\_ext\_adv\_start(struct bt\_le\_ext\_adv \*adv, const struct [bt\_le\_ext\_adv\_start\_param](#c.bt_le_ext_adv_start_param) \*param)
    ...
    int bt\_le\_per\_adv\_sync\_cb\_register(struct [bt\_le\_per\_adv\_sync\_cb](#c.bt_le_per_adv_sync_cb) \*cb)
    ...
    :   Start (LE) scanning.
        ...
        Setting the `param.timeout` parameter is not supported when  [`CONFIG_BT_PRIVACY`](../../../kconfig.md#CONFIG_BT_PRIVACY "CONFIG_BT_PRIVACY") is enabled, when the param.type is [BT\_LE\_SCAN\_TYPE\_ACTIVE](#group__bt__gap_1gga2383d7ea529bcaadb727dd11ecbe5f9aaf202213813092ba298cd046aed687f22). Supplying a non-zero timeout will result in an -EINVAL error code.

        Parameters:
        :   - **param** – Scan parameters.
            - **cb** – Callback to notify scan results. May be NULL if callback registration through [bt\_le\_scan\_cb\_register](#group__bt__gap_1ga80e870fa1de40c404c64624bef439067) is preferred.
    ...
    int bt\_le\_scan\_cb\_register(struct [bt\_le\_scan\_cb](#c.bt_le_scan_cb) \*cb)
...
*group* Defines and Assigned Numbers
:   Bluetooth Generic Access Profile defines and Assigned Numbers.
    ...
    BT\_GAP\_SCAN\_FAST\_INTERVAL\_MIN
