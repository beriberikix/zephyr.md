---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/mesh/access.html
...
:   Access layer.
    ...
    :   Composition data SIG model entry with callback functions and metadata.
        ...
        :   - **\_id** – Model ID.
            ...
            - **\_user\_data** – User data for the model.
            - **\_cb** – Callback structure, or NULL to keep no callbacks.
            - **\_metadata** – Metadata structure. Used if  [`CONFIG_BT_MESH_LARGE_COMP_DATA_SRV`](../../../../kconfig.md#CONFIG_BT_MESH_LARGE_COMP_DATA_SRV "CONFIG_BT_MESH_LARGE_COMP_DATA_SRV") is enabled.
