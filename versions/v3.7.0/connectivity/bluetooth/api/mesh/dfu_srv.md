---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/mesh/dfu_srv.html
...
![Bluetooth Mesh Firmware Update Server transfer](https://docs.zephyrproject.org/3.7.0/_images/dfu_srv.svg)
...
*group* Firmware Update Server model
