---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/mesh/dfu.html
...
![Graphic overview of the DFU roles mesh nodes can have during the process of image distribution](https://docs.zephyrproject.org/3.7.0/_images/dfu_roles_mesh.svg)
...
![Overview of DFU stages and procedures](https://docs.zephyrproject.org/3.7.0/_images/dfu_stages_procedures_mesh.svg)
...
*group* Firmware Distribution models
:   Enums
...
*group* Bluetooth Mesh Device Firmware Update
:   Defines
...
*group* Bluetooth Mesh Device Firmware Update (DFU) metadata
