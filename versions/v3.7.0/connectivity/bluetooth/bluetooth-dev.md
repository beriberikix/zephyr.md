---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/bluetooth-dev.html
...
More [sample Bluetooth applications](../../samples/bluetooth/bluetooth.md#bluetooth-samples) are available in
`samples/bluetooth/`.
