---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/usb/api/hid.html
...
*group* USB HID common definitions
:   hid.h API
...
*group* Mouse and keyboard report descriptors
:   Defines
