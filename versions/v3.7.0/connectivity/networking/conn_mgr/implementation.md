---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/conn_mgr/implementation.html
...
![A detailed view of how Connection Manager integrates with Zephyr and the application.](https://docs.zephyrproject.org/3.7.0/_images/integration_diagram_detailed.svg)
...
*group* Connection Manager Connectivity Implementation API
