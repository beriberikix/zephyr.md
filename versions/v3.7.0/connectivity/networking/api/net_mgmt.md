---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/net_mgmt.html
...
:   Network Management.
    ...
    :   Signature which all Net MGMT request handler need to follow.
        ...
        Param iface:
        :   A valid pointer on struct [net\_if](net_if.md#structnet__if) if the request is meant to be tied to a network interface. NULL otherwise.
    ...
    :   *#include <net\_event.h>*
        ...
        struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") addr
    ...
    :   *#include <net\_event.h>*
        ...
        struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") nexthop
    ...
    struct net\_event\_ipv6\_pe\_filter
    :   *#include <net\_event.h>*
