---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/mqtt.html
...
:   **Since**
    ...
    **Version**
    ...
    :   *#include <mqtt.h>*
        ...
        struct [mqtt\_transport](#c.mqtt_transport).[anonymous].[anonymous] tcp
        :   TCP socket transport for MQTT.

        union [mqtt\_transport](#c.mqtt_transport).[anonymous] [anonymous]
