---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/ip_4_6.html
...
*group* IPv4/IPv6 primitives and helpers
:   IPv4/IPv6 primitives and helpers.
    ...
    static inline bool net\_ipv4\_is\_private\_addr(const struct [in\_addr](#c.in_addr) \*addr)
    ...
    static inline bool net\_ipv6\_is\_private\_addr(const struct [in6\_addr](#c.in6_addr) \*addr)
    ...
    static inline struct sockaddr\_in6\_ptr \*net\_sin6\_ptr(const struct sockaddr\_ptr \*addr)
    ...
    static inline struct sockaddr\_in\_ptr \*net\_sin\_ptr(const struct sockaddr\_ptr \*addr)
    ...
    static inline struct sockaddr\_ll\_ptr \*net\_sll\_ptr(const struct sockaddr\_ptr \*addr)
    ...
    static inline struct sockaddr\_can\_ptr \*net\_can\_ptr(const struct sockaddr\_ptr \*addr)
    ...
    int net\_port\_set\_default(struct [sockaddr](#c.sockaddr) \*addr, uint16\_t default\_port)
    ...
    static inline int net\_ipv6\_pe\_add\_filter(struct [in6\_addr](#c.in6_addr) \*addr, bool is\_denylist)
    ...
    static inline int net\_ipv6\_pe\_del\_filter(struct [in6\_addr](#c.in6_addr) \*addr)
    ...
    :   *#include <net\_ip.h>*
        ...
        [sa\_family\_t](#c.sa_family_t) sin6\_family
        :   AF\_INET6.

        uint16\_t sin6\_port
        :   Port number.

        struct [in6\_addr](#c.in6_addr) sin6\_addr
        :   IPv6 address.
    ...
    :   *#include <net\_ip.h>*
        ...
        [sa\_family\_t](#c.sa_family_t) sin\_family
        :   AF\_INET.

        uint16\_t sin\_port
        :   Port number.

        struct [in\_addr](#c.in_addr) sin\_addr
        :   IPv4 address.
    ...
    :   *#include <net\_ip.h>*
        ...
        [sa\_family\_t](#c.sa_family_t) sll\_family
        :   Always AF\_PACKET.
    ...
    :   *#include <net\_ip.h>*
        ...
        [socklen\_t](#c.socklen_t) msg\_namelen
        :   Size of socket address.

        struct [iovec](#c.iovec) \*msg\_iov
    ...
    :   *#include <net\_ip.h>*
        ...
        [socklen\_t](#c.socklen_t) cmsg\_len
    ...
    :   *#include <net\_ip.h>*
        ...
        [sa\_family\_t](#c.sa_family_t) sa\_family
        :   Address family.
