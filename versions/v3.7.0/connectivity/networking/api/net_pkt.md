---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/net_pkt.html
...
`NET_PKT_DATA_ACCESS_DEFINE` when it is not possible to
tell if the data will be in a contiguous area, and
`NET_PKT_DATA_ACCESS_CONTIGUOUS_DEFINE` when
...
:   Network packet management library.
    ...
    struct [net\_buf](net_buf.md#c.net_buf "net_buf") \*net\_pkt\_get\_reserve\_data(struct [net\_buf\_pool](net_buf.md#c.net_buf_pool "net_buf_pool") \*pool, size\_t min\_len, [k\_timeout\_t](../../../kernel/services/timing/clocks.md#c.k_timeout_t "k_timeout_t") timeout)
    :   Get a data buffer from a given pool.
        ...
        Parameters:
        :   - **pool** – The [net\_buf](net_buf.md#structnet__buf) pool to use.
    ...
    static inline void net\_pkt\_cursor\_backup(struct [net\_pkt](#c.net_pkt) \*pkt, struct net\_pkt\_cursor \*backup)
    ...
    static inline void net\_pkt\_cursor\_restore(struct [net\_pkt](#c.net_pkt) \*pkt, struct net\_pkt\_cursor \*backup)
    ...
    :   Read a byte (uint8\_t) from a [net\_pkt](#structnet__pkt).

        [net\_pkt](#structnet__pkt)’s cursor should be properly initialized and, if needed, positioned using net\_pkt\_skip. Cursor position will be updated after the operation.

        Parameters:
        :   - **pkt** – The network packet from where to read
            - **data** – The destination uint8\_t where to copy the data
    ...
    :   Write a byte (uint8\_t) data to a [net\_pkt](#structnet__pkt).

        [net\_pkt](#structnet__pkt)’s cursor should be properly initialized and, if needed, positioned using net\_pkt\_skip. Cursor position will be updated after the operation.

        Parameters:
        :   - **pkt** – The network packet from where to read
            - **data** – The uint8\_t value to write

        Returns:
        :   0 on success, negative errno code otherwise.

    static inline int net\_pkt\_write\_be16(struct [net\_pkt](#c.net_pkt) \*pkt, uint16\_t data)
    :   Write a uint16\_t big endian data to a [net\_pkt](#structnet__pkt).

        [net\_pkt](#structnet__pkt)’s cursor should be properly initialized and, if needed, positioned using net\_pkt\_skip. Cursor position will be updated after the operation.

        Parameters:
        :   - **pkt** – The network packet from where to read
            - **data** – The uint16\_t value in host byte order to write

        Returns:
        :   0 on success, negative errno code otherwise.

    static inline int net\_pkt\_write\_be32(struct [net\_pkt](#c.net_pkt) \*pkt, uint32\_t data)
    :   Write a uint32\_t big endian data to a [net\_pkt](#structnet__pkt).

        [net\_pkt](#structnet__pkt)’s cursor should be properly initialized and, if needed, positioned using net\_pkt\_skip. Cursor position will be updated after the operation.

        Parameters:
        :   - **pkt** – The network packet from where to read
            - **data** – The uint32\_t value in host byte order to write

        Returns:
        :   0 on success, negative errno code otherwise.

    static inline int net\_pkt\_write\_le32(struct [net\_pkt](#c.net_pkt) \*pkt, uint32\_t data)
    :   Write a uint32\_t little endian data to a [net\_pkt](#structnet__pkt).
    ...
    :   Write a uint16\_t little endian data to a [net\_pkt](#structnet__pkt).
    ...
    void \*net\_pkt\_get\_data(struct [net\_pkt](#c.net_pkt) \*pkt, struct net\_pkt\_data\_access \*access)
    ...
    int net\_pkt\_set\_data(struct [net\_pkt](#c.net_pkt) \*pkt, struct net\_pkt\_data\_access \*access)
    ...
    static inline int net\_pkt\_acknowledge\_data(struct [net\_pkt](#c.net_pkt) \*pkt, struct net\_pkt\_data\_access \*access)
    ...
    :   *#include <net\_pkt.h>*
        ...
        struct [net\_buf](net_buf.md#c.net_buf "net_buf") \*frags
        :   buffer fragment

        struct [net\_buf](net_buf.md#c.net_buf "net_buf") \*buffer
