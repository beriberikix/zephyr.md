---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/net_if.html
...
*group* Network Interface abstraction layer
:   Network Interface abstraction layer.
    ...
    typedef void (\*net\_if\_ip\_maddr\_cb\_t)(struct [net\_if](#c.net_if) \*iface, struct [net\_if\_mcast\_addr](#c.net_if_mcast_addr) \*maddr, void \*user\_data)
    ...
    :   Define callback that is called after a network packet has been sent.
        ...
        Param iface:
        :   A pointer to a struct [net\_if](#structnet__if) to which the [net\_pkt](net_pkt.md#structnet__pkt) was sent to.
    ...
    enum net\_if\_checksum\_type
    :   Type of checksum for which support in the interface will be queried.

        *Values:*

        enumerator NET\_IF\_CHECKSUM\_IPV4\_HEADER = NET\_IF\_CHECKSUM\_IPV4\_HEADER\_BIT
        :   Interface supports IP version 4 header checksum calculation.

        enumerator NET\_IF\_CHECKSUM\_IPV4\_TCP = NET\_IF\_CHECKSUM\_IPV4\_HEADER\_BIT | NET\_IF\_CHECKSUM\_TCP\_BIT
        :   Interface supports checksum calculation for TCP payload in IPv4.

        enumerator NET\_IF\_CHECKSUM\_IPV4\_UDP = NET\_IF\_CHECKSUM\_IPV4\_HEADER\_BIT | NET\_IF\_CHECKSUM\_UDP\_BIT
        :   Interface supports checksum calculation for UDP payload in IPv4.

        enumerator NET\_IF\_CHECKSUM\_IPV4\_ICMP = NET\_IF\_CHECKSUM\_IPV4\_ICMP\_BIT
        :   Interface supports checksum calculation for ICMP4 payload in IPv4.

        enumerator NET\_IF\_CHECKSUM\_IPV6\_HEADER = NET\_IF\_CHECKSUM\_IPV6\_HEADER\_BIT
        :   Interface supports IP version 6 header checksum calculation.

        enumerator NET\_IF\_CHECKSUM\_IPV6\_TCP = NET\_IF\_CHECKSUM\_IPV6\_HEADER\_BIT | NET\_IF\_CHECKSUM\_TCP\_BIT
        :   Interface supports checksum calculation for TCP payload in IPv6.

        enumerator NET\_IF\_CHECKSUM\_IPV6\_UDP = NET\_IF\_CHECKSUM\_IPV6\_HEADER\_BIT | NET\_IF\_CHECKSUM\_UDP\_BIT
        :   Interface supports checksum calculation for UDP payload in IPv6.

        enumerator NET\_IF\_CHECKSUM\_IPV6\_ICMP = NET\_IF\_CHECKSUM\_IPV6\_ICMP\_BIT
    ...
    static inline void net\_if\_nbr\_reachability\_hint(struct [net\_if](#c.net_if) \*iface, const struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") \*ipv6\_addr)
    ...
    void net\_if\_ipv6\_maddr\_foreach(struct [net\_if](#c.net_if) \*iface, [net\_if\_ip\_maddr\_cb\_t](#c.net_if_ip_maddr_cb_t) cb, void \*user\_data)
    ...
    struct [net\_if\_ipv6\_prefix](#c.net_if_ipv6_prefix) \*net\_if\_ipv6\_prefix\_get(struct [net\_if](#c.net_if) \*iface, const struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") \*addr)
    ...
    static inline const struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") \*net\_if\_ipv6\_select\_src\_addr\_hint(struct [net\_if](#c.net_if) \*iface, const struct [in6\_addr](ip_4_6.md#c.in6_addr "in6_addr") \*dst, int flags)
    :   Get a IPv6 source address that should be used when sending network data to destination.
    ...
    void net\_if\_ipv4\_maddr\_foreach(struct [net\_if](#c.net_if) \*iface, [net\_if\_ip\_maddr\_cb\_t](#c.net_if_ip_maddr_cb_t) cb, void \*user\_data)
    ...
    struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") net\_if\_ipv4\_get\_netmask\_by\_addr(struct [net\_if](#c.net_if) \*iface, const struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") \*addr)
    ...
    :   Get IPv4 netmask of an interface.
        ...
        *Deprecated:*
        :   Use [net\_if\_ipv4\_get\_netmask\_by\_addr()](#group__net__if_1gadfad7d9232bf58c5626266387a2eb761) instead.
    ...
    :   Set IPv4 netmask for an interface.
        ...
        *Deprecated:*
        :   Use [net\_if\_ipv4\_set\_netmask\_by\_addr()](#group__net__if_1ga7beda6ccba46fce3cf2da1ce6c0725ec) instead.
    ...
    bool net\_if\_ipv4\_set\_netmask\_by\_addr\_by\_index(int index, const struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") \*addr, const struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") \*netmask)
    ...
    bool net\_if\_ipv4\_set\_netmask\_by\_addr(struct [net\_if](#c.net_if) \*iface, const struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") \*addr, const struct [in\_addr](ip_4_6.md#c.in_addr "in_addr") \*netmask)
    :   Set IPv4 netmask for an interface index for a given address.
    ...
    bool net\_if\_need\_calc\_rx\_checksum(struct [net\_if](#c.net_if) \*iface, enum [net\_if\_checksum\_type](#c.net_if_checksum_type) chksum\_type)
    ...
    bool net\_if\_need\_calc\_tx\_checksum(struct [net\_if](#c.net_if) \*iface, enum [net\_if\_checksum\_type](#c.net_if_checksum_type) chksum\_type)
    ...
    struct [net\_if](#c.net_if) \*net\_if\_get\_wifi\_sta(void)
    :   Get Wi-Fi network station interface.

        Returns:
        :   Pointer to network interface, NULL if not found.

    struct [net\_if](#c.net_if) \*net\_if\_get\_wifi\_sap(void)
    ...
    :   *#include <net\_if.h>*
        ...
        struct [net\_if\_addr](#c.net_if_addr) ipv4
        :   IPv4 address.
    ...
    :   *#include <net\_if.h>*
        ...
        struct [net\_if\_addr\_ipv4](#c.net_if_addr_ipv4) unicast[NET\_IF\_MAX\_IPV4\_ADDR]
        :   Unicast IP addresses.
    ...
    :   *#include <net\_if.h>*
        ...
        atomic\_t flags[[ATOMIC\_BITMAP\_SIZE](../../../kernel/services/other/atomic.md#c.ATOMIC_BITMAP_SIZE "ATOMIC_BITMAP_SIZE")(NET\_IF\_NUM\_FLAGS)]
        :   For internal use.
    ...
    :   *#include <net\_if.h>*
        ...
        struct [k\_mutex](../../../kernel/services/synchronization/mutexes.md#c.k_mutex "k_mutex") tx\_lock
