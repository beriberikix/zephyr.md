---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/networking/api/lwm2m.html
...
![LwM2M engine state machine](https://docs.zephyrproject.org/3.7.0/_images/lwm2m_engine_state_machine.svg)
...
Sending of data in the table above refers to calling [`lwm2m_send_cb()`](#c.lwm2m_send_cb) or by writing into one of the observed resources where observation would trigger a notify message.
...
![LwM2M seconds to update early](https://docs.zephyrproject.org/3.7.0/_images/lwm2m_lifetime_seconds_early.png)
...
![LwM2M update time when both values are set](https://docs.zephyrproject.org/3.7.0/_images/lwm2m_lifetime_both.png)
...
:   **Since**
    ...
    **Version**
    ...
    As the battery status changes, an LwM2M client can set one of the following codes via: lwm2m\_set\_u8(“3/0/20”, [battery status])
    ...
    :   Asynchronous callback to get a resource buffer and length.
        ...
        The client or LwM2M objects can register a function of this type via: [lwm2m\_register\_read\_callback()](#group__lwm2m__api_1gaf33bd6a527b6d399f3d92b666ac77dfb) [lwm2m\_register\_pre\_write\_callback()](#group__lwm2m__api_1ga6f775837e07ba9b0032be8917a593e16)
    ...
    typedef int (\*lwm2m\_engine\_set\_data\_cb\_t)(uint16\_t obj\_inst\_id, uint16\_t res\_id, uint16\_t res\_inst\_id, uint8\_t \*data, uint16\_t data\_len, bool last\_block, size\_t total\_size, size\_t offset)
    :   Asynchronous callback when data has been set to a resource buffer.
        ...
        A function of this type can be registered via: [lwm2m\_register\_validate\_callback()](#group__lwm2m__api_1gad6e5fd4815f409ad59ad631b03199333) [lwm2m\_register\_post\_write\_callback()](#group__lwm2m__api_1ga3dd8b38e797173dae902404fb5b7a3f4)
    ...
    :   Asynchronous event notification callback.
        ...
        Register a function of this type via: [lwm2m\_register\_create\_callback()](#group__lwm2m__api_1ga346d547e02bd53ee83f83b2248449e98) [lwm2m\_register\_delete\_callback()](#group__lwm2m__api_1ga92d7e6d81ef674a6c311e1717c6bf373)
    ...
    :   Asynchronous execute notification callback.
        ...
        Register a function of this type via: [lwm2m\_register\_exec\_callback()](#group__lwm2m__api_1ga29cc5cdd697e94d7379b1fb178487916)
    ...
    int lwm2m\_set\_bulk(const struct [lwm2m\_res\_item](#c.lwm2m_res_item) res\_list[], size\_t res\_list\_size)
    :   Set multiple resource (instance) values.

        NOTE: Value type must match the target resource as this function does not do any type conversion. See struct [lwm2m\_res\_item](#structlwm2m__res__item) for list of resource types.

        Parameters:
        :   - **res\_list** – **[in]** LwM2M resource item list
            - **res\_list\_size** – **[in]** Length of resource list
    ...
    :   Set resource (instance) read callback.
        ...
        When separate buffer for data should be used, use [lwm2m\_set\_res\_buf()](#group__lwm2m__api_1ga56a2aecd38baedb5dc17258610c4780d) instead to set the storage.
    ...
    :   Update data size for a resource.
        ...
        Use this function to set the new size of data in the buffer if you write to a buffer received by [lwm2m\_get\_res\_buf()](#group__lwm2m__api_1gac0b6669d8a19b03eb8b08cbbcdb0c192).
    ...
    :   *#include <lwm2m.h>*
        ...
        union [lwm2m\_time\_series\_elem](#c.lwm2m_time_series_elem).[anonymous] [anonymous]
        :   Element value.
    ...
    :   *#include <lwm2m.h>*
        ...
        - TIME is time\_t
        - FLOAT is double
        - OBJLNK is struct [lwm2m\_objlnk](#structlwm2m__objlnk)
        ...
        struct [lwm2m\_obj\_path](#c.lwm2m_obj_path) \*path
