---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/sensor/read_and_decode.html
...
- [`sensor_read()`](index.md#c.sensor_read "sensor_read")
- [`sensor_read_async_mempool()`](index.md#c.sensor_read_async_mempool "sensor_read_async_mempool")
- [`sensor_get_decoder()`](index.md#c.sensor_get_decoder "sensor_get_decoder")
- [`sensor_decode()`](index.md#c.sensor_decode "sensor_decode")
...
[`sensor_read()`](index.md#c.sensor_read "sensor_read") and similar functions acquire sensor encoded data into
a buffer provided by the caller. Decode ([`sensor_decode()`](index.md#c.sensor_decode "sensor_decode")) then
decodes the sensor specific encoded data into fixed point [`q31_t`](../../../services/dsp/index.md#c.q31_t "q31_t") values
