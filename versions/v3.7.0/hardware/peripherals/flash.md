---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/flash.html
...
[JEDEC MSPI-NOR flash](../../samples/drivers/mspi/mspi_flash/README.md#mspi-flash "Use the flash API to interact with a MSPI NOR serial flash memory device.")
...
:   FLASH Interface.
    ...
    **Version**
    ...
    static inline int flash\_params\_get\_erase\_cap(const struct [flash\_parameters](#c.flash_parameters) \*p)
    ...
    :   Erase part or all of a flash memory.
        ...
        [flash\_flatten()](#group__flash__interface_1ga11eda0cdc7be12636a90d2e8c7264e4a)
    ...
    int flash\_fill(const struct [device](../../kernel/drivers/index.md#c.device "device") \*dev, uint8\_t val, off\_t offset, size\_t size)
    ...
    int flash\_flatten(const struct [device](../../kernel/drivers/index.md#c.device "device") \*dev, off\_t offset, size\_t size)
    :   Erase part or all of a flash memory or level it.
        ...
        [flash\_erase()](#group__flash__interface_1ga05f9c8b0c1ff7273f71797e7ff799c95)
...
*group* FLASH internal Interface
