---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/adc.html
...
[Analog-to-Digital Converter (ADC) sequence sample](../../samples/drivers/adc/adc_sequence/README.md#adc_sequence "Read analog inputs from ADC channels, using a sequence.")
:   Read analog inputs from ADC channels, using a sequence.

[Analog-to-Digital Converter (ADC) with devicetree](../../samples/drivers/adc/adc_dt/README.md#adc_dt "Read analog inputs from ADC channels.")
:   Read analog inputs from ADC channels.

*group* ADC driver APIs
:   ADC driver APIs.
    ...
    **Version**
    ...
    ADC\_DT\_SPEC\_GET\_BY\_NAME(node\_id, name)
    :   Get ADC io-channel information from devicetree by name.

        This returns a static initializer for an `[adc_dt_spec](#structadc__dt__spec)` structure given a devicetree node and a channel name. The node must have the “io-channels” property defined.
    ...
    ADC\_DT\_SPEC\_INST\_GET\_BY\_NAME(inst, name)
    :   Get ADC io-channel information from a DT\_DRV\_COMPAT devicetree instance by name.

        See also

        [ADC\_DT\_SPEC\_GET\_BY\_NAME()](#group__adc__interface_1ga058dbc619b7bbf624cd48518b429bb58)
