---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/video.html
...
:   Video Interface.
    ...
    **Version**
    ...
    struct [video\_buffer](#c.video_buffer) \*video\_buffer\_aligned\_alloc(size\_t size, size\_t align)
