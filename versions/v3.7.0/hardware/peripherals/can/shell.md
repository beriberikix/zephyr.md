---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/can/shell.html
...
For example, building the [Hello World](../../../samples/hello_world/README.md#hello-world) sample for the [NXP FRDM-K64F](../../../boards/nxp/frdm_k64f/doc/index.md#frdm-k64f) with the CAN shell and
