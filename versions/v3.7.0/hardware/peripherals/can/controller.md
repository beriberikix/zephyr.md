---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/can/controller.html
...
:   CAN Interface.
    ...
    **Version**
    ...
    :   Get the CAN core clock rate.
        ...
        Returns the CAN core clock rate. One minimum time quantum (mtq) is 1/(core clock rate). The CAN core clock can be further divided by the CAN clock prescaler (see the *[can\_timing](#structcan__timing)* struct), providing the time quantum (tq).
    ...
    uint32\_t can\_get\_bitrate\_min(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev)
    ...
    static inline int can\_get\_min\_bitrate(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev, uint32\_t \*min\_bitrate)
    :   Get minimum supported bitrate.

        Get the minimum supported bitrate for the CAN controller/transceiver combination.

        *Deprecated:*
        :   Use *[can\_get\_bitrate\_min()](#group__can__interface_1ga343456749eec6144a91bacae0d94b114)* instead.

        Parameters:
        :   - **dev** – Pointer to the device structure for the driver instance.
            - **min\_bitrate** – **[out]** Minimum supported bitrate in bits/s

        Return values:
        :   - **-EIO** – General input/output error.
            - **-ENOSYS** – If this function is not implemented by the driver.

    uint32\_t can\_get\_bitrate\_max(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev)
    ...
    static inline int can\_get\_max\_bitrate(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev, uint32\_t \*max\_bitrate)
    :   Get maximum supported bitrate.

        Get the maximum supported bitrate for the CAN controller/transceiver combination.

        *Deprecated:*
        :   Use *[can\_get\_bitrate\_max()](#group__can__interface_1ga1e6dc8026e4d922bce4d398d9f32a457)* instead.
    ...
    :   Start the CAN controller.
        ...
        Bring the CAN controller out of `[CAN_STATE_STOPPED](#group__can__interface_1ggac7ec472c26c564dd7067c49f67c8d2f7a644e7a441f2e607b93528d3128508cc8)`. This will reset the RX/TX error counters, enable the CAN controller to participate in CAN communication, and enable the CAN transceiver, if supported.
    ...
    int can\_add\_rx\_filter(const struct [device](../../../kernel/drivers/index.md#c.device "device") \*dev, [can\_rx\_callback\_t](#c.can_rx_callback_t) callback, void \*user\_data, const struct [can\_filter](#c.can_filter) \*filter)
    ...
    :   Simple wrapper function for adding a message queue for a given filter.
        ...
        Wrapper function for *[can\_add\_rx\_filter()](#group__can__interface_1gae9dd69a13b960f773ab07bb0bb13b5e9)* which puts received CAN frames matching the filter in a message queue instead of calling a callback.
        ...
        Message queue overruns are silently ignored and overrun frames discarded. Custom error handling can be implemented by using *[can\_add\_rx\_filter()](#group__can__interface_1gae9dd69a13b960f773ab07bb0bb13b5e9)* and *[k\_msgq\_put()](../../../kernel/services/data_passing/message_queues.md#group__msgq__apis_1ga54e96aaaea5462a1f963b7fd5ca82bfe)* directly.
    ...
    :   Remove a CAN RX filter.
        ...
        This routine removes a CAN RX filter based on the filter ID returned by *[can\_add\_rx\_filter()](#group__can__interface_1gae9dd69a13b960f773ab07bb0bb13b5e9)* or *[can\_add\_rx\_filter\_msgq()](#group__can__interface_1gaaac20a068b7f32d2f38d1601d588b35c)*.
    ...
    :   Recover from bus-off state.
        ...
        [`CONFIG_CAN_MANUAL_RECOVERY_MODE`](../../../kconfig.md#CONFIG_CAN_MANUAL_RECOVERY_MODE "CONFIG_CAN_MANUAL_RECOVERY_MODE") must be enabled for this function to be available.
    ...
    :   Maximum value for a standard (11-bit) CAN identifier.
        ...
        *Deprecated:*
        :   Use `[CAN_STD_ID_MASK](#group__can__interface_1ga4cd8ce34887b90baeeaa6a4aa048b398)` instead.
    ...
    :   Maximum value for an extended (29-bit) CAN identifier.
        ...
        *Deprecated:*
        :   Use `[CAN_EXT_ID_MASK](#group__can__interface_1ga15ee71e8abcf51008925585049125986)` instead.
