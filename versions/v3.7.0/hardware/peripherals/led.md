---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/hardware/peripherals/led.html
...
[IS31FL3194 RGB LED](../../samples/drivers/led_is31fl3194/README.md#is31fl3194 "Cycle colors on an RGB LED connected to the IS31FL3194 using the LED API.")
    ...
    **Version**
    ...
    :   Set LED color.
        ...
        :   - **dev** – LED device
            ...
            - **color** – Array of colors. It must be ordered following the color mapping of the LED controller. See the color\_mapping member in struct [led\_info](#structled__info).
...
[LED strip](../../samples/drivers/led_strip/README.md#led-strip "Control an LED strip example.")
:   Control an LED strip example.

*group* LED Strip Interface
:   LED Strip Interface.
    ...
    typedef size\_t (\*led\_api\_length)(const struct [device](../../kernel/drivers/index.md#c.device "device") \*dev)
    :   Callback API for getting length of an LED strip.

        See also

        [led\_strip\_length()](#group__led__strip__interface_1ga7f94eab0b357a81cccb5f0ea1575714a) for argument descriptions.
    ...
    static inline size\_t led\_strip\_length(const struct [device](../../kernel/drivers/index.md#c.device "device") \*dev)
