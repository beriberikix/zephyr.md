---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/kernel/memory_management/demand_paging.html
...
:   Eviction algorithm APIs.
    ...
    :   Remove a page frame from potential eviction candidates.
        ...
        This function will only be called with page frames that were submitted using [k\_mem\_paging\_eviction\_add()](#group__mem-demand-paging-eviction_1ga6bb19be3098cc839ae3f6e9528598867) beforehand.
    ...
    :   Select a page frame for eviction.
        ...
        The kernel will invoke this to choose a page frame to evict if there are no free page frames. It is not guaranteed that the returned page frame will actually be evicted. If it is then the kernel will call [k\_mem\_paging\_eviction\_remove()](#group__mem-demand-paging-eviction_1ga16a4df904cc7a9641d06741ed589949d) with it.
    ...
    :   Initialization function.
        ...
        Called at POST\_KERNEL to perform any necessary initialization tasks for the eviction algorithm. [k\_mem\_paging\_eviction\_select()](#group__mem-demand-paging-eviction_1gaadbb4eb56c239f800daf995e6673ae1d) is guaranteed to never be called until this has returned, and this will only be called once.

### Backing Store APIs

*group* Backing Store APIs
:   Backing store APIs.
    ...
    :   Update internal accounting after a page-in.
        ...
        This is invoked after [k\_mem\_paging\_backing\_store\_page\_in()](#group__mem-demand-paging-backing-store_1ga9becb4908cc7840ece93a2360692962d) and interrupts have been\* re-locked, making it safe to access the k\_mem\_page\_frame data. The location value will be the same passed to [k\_mem\_paging\_backing\_store\_page\_in()](#group__mem-demand-paging-backing-store_1ga9becb4908cc7840ece93a2360692962d).
