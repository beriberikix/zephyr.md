---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/kernel/data_structures/slist.html
...
![slist example](https://docs.zephyrproject.org/3.7.0/_images/slist.png)

An slist containing three elements.

![empty slist example](https://docs.zephyrproject.org/3.7.0/_images/slist-empty.png)
...
:   Single-linked list implementation.
    ...
    static inline bool sys\_slist\_find([sys\_slist\_t](#c.sys_slist_t) \*list, [sys\_snode\_t](#c.sys_snode_t) \*node, [sys\_snode\_t](#c.sys_snode_t) \*\*prev)
...
*group* Flagged Single-linked list
