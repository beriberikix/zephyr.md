---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/kernel/drivers/index.html
...
the device is initialized when the application calls [`device_init()`](#c.device_init).
...
:   Device Model.
    ...
    **Version**
    ...
    int device\_init(const struct [device](#c.device) \*dev)
    :   Initialize a device.
