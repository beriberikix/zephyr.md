---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/kernel/services/threads/workqueue.html
...
locks ([`k_spinlock`](../smp/smp.md#c.k_spinlock "k_spinlock")) or thread-aware locks (`k_sem`,
