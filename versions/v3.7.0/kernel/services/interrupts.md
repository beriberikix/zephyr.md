---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/kernel/services/interrupts.html
...
Similar like for [`IRQ_CONNECT`](#c.IRQ_CONNECT), the created variable or function is placed
...
*group* Interrupt Service Routine APIs
:   Defines
