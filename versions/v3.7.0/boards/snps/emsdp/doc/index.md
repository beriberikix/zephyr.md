---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/snps/emsdp/doc/index.html
original_path: boards/snps/emsdp/doc/index.html
---
...
![DesignWare(R) ARC(R) EM Software Development Platform (synopsys.com)](https://docs.zephyrproject.org/3.7.0/_images/emsdp.jpg)
...
west build -b emsdp/emsdp_em7d samples/hello_world
...
[Hello World](../../../../samples/hello_world/README.md#hello-world) for the em4.

```shell
# From the root of the zephyr repository
west build -b emsdp/emsdp_em4 samples/hello_world
```
...
```shell
west build -b emsdp/emsdp_em6 <my app>
west debug
```
