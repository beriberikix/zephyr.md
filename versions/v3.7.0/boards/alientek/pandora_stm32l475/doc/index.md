---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/alientek/pandora_stm32l475/doc/index.html
...
![STM32L475 Pandora](https://docs.zephyrproject.org/3.7.0/_images/pandora_stm32l475.jpg)
...
The Zephyr stm32l475ve\_pandora board configuration supports the following hardware features:
...
| GPIO | on-chip | gpio |
| I2C | on-chip | I2C-AHT10(Temperature and humidity sensor) I2C-ICM2068(light environment sensor) |
...
> [boards/alientek/pandora\_stm32l475/pandora\_stm32l475\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/alientek/pandora_stm32l475/pandora_stm32l475_defconfig)
