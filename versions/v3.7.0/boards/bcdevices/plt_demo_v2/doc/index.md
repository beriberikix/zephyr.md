---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/bcdevices/plt_demo_v2/doc/index.html
...
![Blue Clover PLT Demo V2 nRF52832](https://docs.zephyrproject.org/3.7.0/_images/blueclover_plt_demo_v2.jpg)
...
Build the Zephyr kernel and the [LED strip](../../../../samples/drivers/led_strip/README.md#led-strip "Control an LED strip example.") sample application.

> ```shell
> west build -b blueclover_plt_demo_v2/nrf52832 samples/drivers/led_apa102
> ```
