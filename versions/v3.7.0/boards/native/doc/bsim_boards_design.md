...
![Zephyr layering in native & bsim builds](https://docs.zephyrproject.org/3.7.0/_images/layering_natsim.svg)
...
![Communication between a Zephyr device and other simulated devices](https://docs.zephyrproject.org/3.7.0/_images/Zephyr_and_bsim.svg)
