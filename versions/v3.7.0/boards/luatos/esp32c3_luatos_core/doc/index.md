---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/luatos/esp32c3_luatos_core/doc/index.html
original_path: boards/luatos/esp32c3_luatos_core/doc/index.html
---
...
but it also facilitates a variety of use-cases based on dual connectivity. [[1]](#id3)
...
![esp32c3_luatos_core](https://docs.zephyrproject.org/3.7.0/_images/esp32c3_luatos_core.jpg)

2. USB-C connect to esp32 chip directly(esp32c3\_luatos\_core/esp32c3/usb)

![esp32c3_luatos_core/esp32c3/usb](https://docs.zephyrproject.org/3.7.0/_images/esp32c3_luatos_core_usb.jpg)

### Supported Features

Current Zephyr’s ESP32C3\_LUATOS\_CORE board supports the following features:
...
![esp32c3_luatos_core_pinfunc](https://docs.zephyrproject.org/3.7.0/_images/esp32c3_luatos_core_pinfunc.jpg)
