---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/weact/blackpill_f401cc/doc/index.html
...
development board featuring the STM32F401CC, see [STM32F401CC website](https://www.st.com/en/microcontrollers/stm32f401cc.html) [[5]](#id9).
...
![Black Pill V3.0+](https://docs.zephyrproject.org/3.7.0/_images/blackpill-v3.jpg)
...
![Black Pill V1.2 Pinout](https://docs.zephyrproject.org/3.7.0/_images/Blackpill_Pinout.jpg)
...
It is recommended to use at least v0.8 of [dfu-util](http://dfu-util.sourceforge.net/build.html) [[4]](#id7). The package available in
