---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/xen/xenvm/doc/index.html
original_path: boards/xen/xenvm/doc/index.html
---
...
- [boards/xen/xenvm/Kconfig.defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/xen/xenvm/Kconfig.defconfig)
- [boards/xen/xenvm/xenvm\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/xen/xenvm/xenvm_defconfig)
...
- Xen early console\_io interface (mainly for debug purposes - requires debug version of Xen)
...
guest, for example, with the [Basic Synchronization](../../../../samples/synchronization/README.md#synchronization "Manipulate basic kernel synchronization primitives.") sample:
...
[Xen ARM with Virtualization Extensions](https://wiki.xenproject.org/wiki/Xen_ARM_with_Virtualization_Extensions)

[xl.conf (guest configuration file) manual](https://xenbits.xen.org/docs/unstable/man/xl.cfg.5.html)
