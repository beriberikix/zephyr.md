---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/shields/waveshare_epaper/doc/index.html
...
at the [Universal e-Paper Raw Panel Driver Shield website](https://www.waveshare.com/e-paper-shield.htm) [[1]](#id1).
...
| Good Display GDEY0213B74 | FPC-A002 | SSD1680 / ssd16xx | waveshare\_epaper\_gdey0213b74 |
...
west build -b nrf52840dk/nrf52840 --shield waveshare_epaper_gdeh0213b1 samples/subsys/display/lvgl
```
