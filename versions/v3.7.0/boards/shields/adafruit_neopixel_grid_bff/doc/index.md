---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/shields/adafruit_neopixel_grid_bff/doc/index.html
...
![Adafruit 5x5 NeoPixel Grid BFF](https://docs.zephyrproject.org/3.7.0/_images/adafruit_neopixel_grid_bff.jpg)
...
west build -b adafruit_qt_py_rp2040 --shield adafruit_neopixel_grid_bff samples/drivers/led_strip
```
