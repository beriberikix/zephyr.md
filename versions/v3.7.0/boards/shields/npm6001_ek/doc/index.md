---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/shields/npm6001_ek/doc/index.html
...
![nPM6001 EK](https://docs.zephyrproject.org/3.7.0/_images/npm6001_ek.jpg)
...
when invoking `west build`. You can check [nPM6001 EK sample](../../../../samples/shields/npm6001_ek/doc/index.md#npm6001-ek-sample) for a
