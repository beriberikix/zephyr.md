---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/shields/frdm_cr20a/doc/index.html
...
[NXP FRDM-K64F](../../../nxp/frdm_k64f/doc/index.md#frdm-k64f).

![FRDM-CR20A](https://docs.zephyrproject.org/3.7.0/_images/frdm_cr20a.jpg)
...
west build -b frdm_k64f --shield frdm_cr20a samples/net/wpanusb
```
