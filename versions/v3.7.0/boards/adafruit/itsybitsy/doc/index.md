---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/adafruit/itsybitsy/doc/index.html
...
![Adafruit ItsyBitsy nRF52840 Express](https://docs.zephyrproject.org/3.7.0/_images/adafruit_itsybitsy_nrf52840.jpeg)
...
with the [LED strip](../../../../samples/drivers/led_strip/README.md#led-strip "Control an LED strip example.") sample application.
