---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/adafruit/grand_central_m4_express/doc/index.html
...
[![Adafruit Grand Central M4 Express](https://docs.zephyrproject.org/3.7.0/_images/adafruit_grand_central_m4_express.webp)](https://docs.zephyrproject.org/3.7.0/_images/adafruit_grand_central_m4_express.webp)
...
The adafruit\_grand\_central\_m4\_express board configuration supports the following
hardware features:
...
[boards/adafruit/grand\_central\_m4\_express/adafruit\_grand\_central\_m4\_express\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adafruit/grand_central_m4_express/adafruit_grand_central_m4_express_defconfig).

### Connections and IOs

The [Adafruit Learning System](https://learn.adafruit.com/adafruit-grand-central) [[1]](#id3) has detailed information about
the board including [pinouts](https://learn.adafruit.com/adafruit-grand-central/pinouts) [[2]](#id5) and the [schematics](https://learn.adafruit.com/adafruit-grand-central/downloads) [[3]](#id7).
