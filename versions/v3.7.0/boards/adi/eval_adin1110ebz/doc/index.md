---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/adi/eval_adin1110ebz/doc/index.html
...
![ADI EVAL-ADIN1110EBZ](https://docs.zephyrproject.org/3.7.0/_images/adi_eval_adin1110ebz.webp)
...
The ADI adi\_eval\_adin1110ebz board configuration supports the
...
> [boards/adi/eval\_adin1110ebz/adi\_eval\_adin1110ebz\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/adi/eval_adin1110ebz/adi_eval_adin1110ebz_defconfig)
...
Then, build and flash in the usual way. Here is an example for the [Hello World](../../../../samples/hello_world/README.md#hello-world) application.
...
You can debug an application in the usual way. Here is an example for the [Hello World](../../../../samples/hello_world/README.md#hello-world)
application.
