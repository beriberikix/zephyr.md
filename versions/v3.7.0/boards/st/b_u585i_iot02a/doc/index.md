---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/st/b_u585i_iot02a/doc/index.html
...
![B_U585I_IOT02A Discovery kit](https://docs.zephyrproject.org/3.7.0/_images/b-u585i-iot02a.jpg)
...
The Zephyr b\_u585i\_iot02a board configuration supports the following hardware features:
...
| PWM die-temp | on-chip on-chip | pwm die temperature sensor |
| AES | on-chip | crypto |
| RADIO | STM32WB5MMG | Bluetooth Low Energy (BLE) |
| RTC | on-chip | rtc |

The default configuration can be found in the defconfig file:
[boards/st/b\_u585i\_iot02a/b\_u585i\_iot02a\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/b_u585i_iot02a/b_u585i_iot02a_defconfig)
