---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/st/nucleo_h745zi_q/doc/index.html
...
![Nucleo H745ZI-Q](https://docs.zephyrproject.org/3.7.0/_images/nucleo_h745zi_q.jpg)
...
The Zephyr nucleo\_h745zi\_q board configuration supports the following hardware
features:
...
[boards/st/nucleo\_h745zi\_q/nucleo\_h745zi\_q\_stm32h745xx\_m7\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_h745zi_q/nucleo_h745zi_q_stm32h745xx_m7_defconfig) and
[boards/st/nucleo\_h745zi\_q/nucleo\_h745zi\_q\_stm32h745xx\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_h745zi_q/nucleo_h745zi_q_stm32h745xx_m4_defconfig)
...
Following links may be helpful: [OpenOCD installing Debug Version](https://github.com/zephyrproject-rtos/openocd)
and [OpenOCD installing with ST-LINK V3 support](https://mbd.kleier.net/integrating-st-link-v3.html)

Note

Check if your ST-LINK V3 has newest FW version. It can be done with [STM32CubeIDE](https://www.st.com/en/development-tools/stm32cubeide.html)
...
west build -b nucleo_h745zi_q_m7 samples/hello_world
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b nucleo_h745zi_q_m4 samples/basic/blinky
west flash
```
