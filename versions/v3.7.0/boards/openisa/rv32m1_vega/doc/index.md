---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/openisa/rv32m1_vega/doc/index.html
...
![RV32M1-VEGA](https://docs.zephyrproject.org/3.7.0/_images/rv32m1_vega.jpg)
...
1. Connect the J-Link debugger through the adapter board to the
   ...
   ![RV32M1-VEGA](https://docs.zephyrproject.org/3.7.0/_images/rv32m1_vega_jtag.jpg)
...
>
> ![Reset button is pressed](https://docs.zephyrproject.org/3.7.0/_images/ri5cy_boot.jpg)
>
