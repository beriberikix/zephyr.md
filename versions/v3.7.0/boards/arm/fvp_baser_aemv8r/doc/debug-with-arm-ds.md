---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/arm/fvp_baser_aemv8r/doc/debug-with-arm-ds.html
original_path: boards/arm/fvp_baser_aemv8r/doc/debug-with-arm-ds.html
---
...
![Arm DS Version](https://docs.zephyrproject.org/3.7.0/_images/version-info.jpg)
...
![Arm DS Perspective choose Other...](https://docs.zephyrproject.org/3.7.0/_images/perspective-choose-other.jpg)

In the opened window, choose `Development Studio (default)`:

![Arm DS Perspective choose DS](https://docs.zephyrproject.org/3.7.0/_images/perspective-choose-ds.jpg)
...
![Arm DS create new configuration database](https://docs.zephyrproject.org/3.7.0/_images/create-new-configuration-database.jpg)

Choose a name for the database. Here `Zephyr` is used:

![Arm DS create new configuration database: choose database name](https://docs.zephyrproject.org/3.7.0/_images/create-new-configuration-database_database-name.jpg)

Click `Finish` and the new configuration database can be seen in `Project Explorer`:

![Arm DS create new configuration database: shown in project explorer](https://docs.zephyrproject.org/3.7.0/_images/create-new-configuration-database_shown-in-project-explorer.jpg)

## Create a new model configuration

Right click `Zephyr` in `Project Explorer`, choose `New -> Model Configuration`:

![Arm DS create new model configuration](https://docs.zephyrproject.org/3.7.0/_images/create-new-model-configuration.jpg)
...
![Arm DS create new model configuration: set model path](https://docs.zephyrproject.org/3.7.0/_images/create-new-model-configuration_model-path.jpg)

Then in `FVP_BaseR_AEMv8R` tab, change `ARMAEMv8-R_` to `V8R64-Generic`,
click `Save` and then click `Import`:

![Arm DS create new model configuration: import](https://docs.zephyrproject.org/3.7.0/_images/create-new-model-configuration_model-use-V8R64-Generic.jpg)

## Create a new launch configuration

From `Project Explorer`, right click `FVP_BaseR_AEMv8R` and select `Debug as -> Debug configurations...`:

![Arm DS create new launch configuration: context menu](https://docs.zephyrproject.org/3.7.0/_images/create-new-launch-configuration_context-menu.jpg)
...
![Arm DS create new launch configuration: connection](https://docs.zephyrproject.org/3.7.0/_images/create-new-launch-configuration_connection.jpg)

2. In `Files` tab:

   In `Files` box, set `Load symbols from file` to full path of `zephyr.elf` that you built.

![Arm DS create new launch configuration: files](https://docs.zephyrproject.org/3.7.0/_images/create-new-launch-configuration_files.jpg)
...
![Arm DS create new launch configuration: debugger](https://docs.zephyrproject.org/3.7.0/_images/create-new-launch-configuration_debugger.jpg)
...
![Arm DS working](https://docs.zephyrproject.org/3.7.0/_images/DS-debug-working.jpg)
