---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/microchip/mec15xxevb_assy6853/doc/index.html
...
![MEC15XX EVB ASSY 6853](https://docs.zephyrproject.org/3.7.0/_images/mec15xxevb_assy6853.jpg)
...
[boards/microchip/mec15xxevb\_assy6853/mec15xxevb\_assy6853\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/microchip/mec15xxevb_assy6853/mec15xxevb_assy6853_defconfig) Kconfig file.
...
![JP9 header Assy6853](https://docs.zephyrproject.org/3.7.0/_images/mec15xxevb_assy6853_jp9_1.jpg)
...
1. Connect the SPI Dongle ASSY 6791 to `J44` in the EVB.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/3.7.0/_images/spidongle_assy6791_view1.jpg)
...
4. Apply power to the board via a micro-USB cable.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/3.7.0/_images/jp88_power_options.jpg)
5. Final wiring for the board should look like this:

   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/3.7.0/_images/mec_board_setup.jpg)
...
2. Flash your board using `west` from the second terminal window.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/3.7.0/_images/reset_button_1.jpg)
