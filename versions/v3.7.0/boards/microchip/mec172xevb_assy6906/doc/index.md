---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/microchip/mec172xevb_assy6906/doc/index.html
...
![MEC172X EVB ASSY 6906](https://docs.zephyrproject.org/3.7.0/_images/mec172xevb_assy6906.jpg)
...
For more information about the SOC’s please see [MEC172x Reference Manual](https://github.com/MicrochipTech/CPGZephyrDocs/blob/master/MEC172x/MEC172x-Data-Sheet.pdf) [[1]](#id1)

### Supported Features

The mec172xevb\_assy6906 board configuration supports the following hardware
features:
...
[boards/microchip/mec172xevb\_assy6906/mec172xevb\_assy6906\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/microchip/mec172xevb_assy6906/mec172xevb_assy6906_defconfig) Kconfig file.

### Connections and IOs

This evaluation board kit is comprised of the following HW blocks:

- MEC172x EVB ASSY 6906 Rev A [MEC172x EVB Schematic](https://github.com/MicrochipTech/CPGZephyrDocs/blob/master/MEC172x/MEC172X-EVB-Assy_6906-A1p0-SCH.pdf) [[2]](#id3)
- MEC172x 144WFBGA SOLDER DC ASSY 6914 with MEC172x silicon [MEC172x Daughter Card Schematic](https://github.com/MicrochipTech/CPGZephyrDocs/blob/master/MEC172x/MEC172X-144WFBGA-Socket-DC-Assy6914-Rev-A-SCH.pdf) [[3]](#id5)
- SPI DONGLE ASSY 6791 [SPI Dongle Schematic](https://github.com/MicrochipTech/CPGZephyrDocs/blob/master/MEC1501/SPI%20Dongles%20and%20Aardvark%20Interposer%20Assy%206791%20Rev%20A1p1%20-%20SCH.pdf) [[4]](#id7)
...
1. If you use Dediprog SF100 programmer, then setup it.
   ...
   Windows version can be found at the [SF100 Product page](https://www.dediprog.com/product/SF100) [[7]](#id13).

   Linux version source code can be found at [SF100 Linux GitHub](https://github.com/DediProgSW/SF100Linux) [[6]](#id11).
   Follow the [SF100 Linux manual](https://www.dediprog.com/download/save/727.pdf) [[8]](#id15) to complete setup of the SF100 programmer.
...
2. Clone the [MEC172x SPI Image Gen](https://github.com/MicrochipTech/CPGZephyrDocs/tree/master/MEC172x/SPI_image_gen) [[5]](#id9) repository or download the files within
   that directory.
...
1. Connect the SPI Dongle ASSY 6791 to `J34` in the EVB.
   ...
   ![SPI DONGLE ASSY 6791 Connected](https://docs.zephyrproject.org/3.7.0/_images/spidongle_assy67911.jpg)
2. Connect programmer to the header J6 on the Assy6791 board, it will flash the SPI NOR chip
   ...
   ![SF100 Connected](https://docs.zephyrproject.org/3.7.0/_images/dediprog_connector.jpg)
...
4. Apply power to the board via a micro-USB cable.
   ...
   ![Power Connection](https://docs.zephyrproject.org/3.7.0/_images/jp30_power_options.jpg)
...
2. Flash your board using `west` from the second terminal window.
   ...
   ![Reset Button](https://docs.zephyrproject.org/3.7.0/_images/Reset_Button.jpg)
