---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/boards/96boards/wistrio/doc/96b_wistrio.html
...
![96Boards WisTrio](https://docs.zephyrproject.org/3.7.0/_images/96b-wistrio.jpg)

96Boards WisTrio

This board is one of the [96Boards IoT Edition](https://linaro.co/ie-specification) platforms providing LoRa
connectivity.
...
checking the application note [AN2606](https://www.st.com/resource/en/application_note/cd00167594.pdf) .
...
Chapter 29 of Application note [AN2606](https://www.st.com/resource/en/application_note/cd00167594.pdf). The ROM bootloader supports flashing
via UART, and I2C protocols.

Here is an example for building and flashing the [Hello World](../../../../samples/hello_world/README.md#hello-world) application using [stm32flash](https://sourceforge.net/p/stm32flash/wiki/Home/) command line utility:
...
Use the [Black Magic Debug Probe](https://github.com/blacksphere/blackmagic/wiki) as an SWD programmer, which can
...
documented on its [Getting started page](https://github.com/blacksphere/blackmagic/wiki/Getting-Started).
