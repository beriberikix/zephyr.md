---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/project/project_roles.html
...
- Responsibility to follow the project’s code of conduct
  ([https://github.com/zephyrproject-rtos/zephyr/blob/main/CODE\_OF\_CONDUCT.md](https://github.com/zephyrproject-rtos/zephyr/blob/main/CODE_OF_CONDUCT.md))

Contributors are initially only given [Read](https://docs.github.com/en/organizations/managing-access-to-your-organizations-repositories/repository-permission-levels-for-an-organization)
...
the [Zephyr devel mailing list](https://lists.zephyrproject.org/g/devel) or on
the [Zephyr Discord Server](https://chat.zephyrproject.org).
...
permission level by creating a GitHub issue, using the [nomination
template](https://github.com/zephyrproject-rtos/zephyr/issues/new?assignees=&labels=Role+Nomination&template=006_nomination.md&title=).
...
name to one or more `collaborators` sections of the [MAINTAINERS File](#maintainers-file) in
...
not follow the [expectations](../contribute/contributor_expectations.md#reviewer-expectations) and the guidelines
...
- Right to make decisions in the relevant subsystems or areas of involvement,
  ...
  See [PR Technical Escalation](../contribute/contributor_expectations.md#pr-technical-escalation).
...
[MAINTAINERS File](#maintainers-file) in the Zephyr repository.
...
- Right to dismiss stale and unrelated reviews or reviews not following
  [expectations](../contribute/contributor_expectations.md#reviewer-expectations) from reviewers and seek reviews
...
- Responsibility to drive the [PR Technical Escalation](../contribute/contributor_expectations.md#pr-technical-escalation) process
...
- Right to manage and coordinate all code merges after the
  code freeze milestone (M3, see [program management overview](https://wiki.zephyrproject.org/Program-Management).)
...
Project Roles vs GitHub Permissions
...
- The [MAINTAINERS.yml](https://github.com/zephyrproject-rtos/zephyr/blob/main/MAINTAINERS.yml) file shall replace the
  [CODEOWNERS](https://github.com/zephyrproject-rtos/zephyr/blob/main/CODEOWNERS) file and will be used for both setting assignees and
  reviewers.
...
> [![Release Activity](https://docs.zephyrproject.org/3.7.0/_images/img_release_activity.png)](https://docs.zephyrproject.org/3.7.0/_images/img_release_activity.png)
...
- A minimum review period of 2 business days, 4 hours for trivial changes (see
  [Give reviewers time to review before code merge](dev_env_and_tools.md#review-time)).
