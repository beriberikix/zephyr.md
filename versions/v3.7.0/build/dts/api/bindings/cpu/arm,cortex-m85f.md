---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/cpu/arm,cortex-m85f.html
original_path: build/dts/api/bindings/cpu/arm,cortex-m85f.html
---
...
may apply to the “arm,cortex-m85f” compatible.
