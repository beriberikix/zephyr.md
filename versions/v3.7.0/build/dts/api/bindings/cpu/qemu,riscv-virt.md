---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/cpu/qemu,riscv-virt.html
original_path: build/dts/api/bindings/cpu/qemu,riscv-virt.html
---
...
```text
QEMU RISC-V virt machine CPU node
```
...
may apply to the “qemu,riscv-virt” compatible.
