---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/cpu/espressif,riscv.html
...
| `xtal-freq` | `int` | ```text Value of the external XTAL connected to ESP32. This is typically 40 MHz. ```  This property is **required**.  Legal values: `40000000`, `32000000` |
