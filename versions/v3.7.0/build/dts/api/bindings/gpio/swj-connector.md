---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/gpio/swj-connector.html
original_path: build/dts/api/bindings/gpio/swj-connector.html
---
...
may apply to the “swj-connector” compatible.
