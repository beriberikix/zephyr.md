---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/gpio/adafruit-feather-header.html
original_path: build/dts/api/bindings/gpio/adafruit-feather-header.html
---
...
may apply to the “adafruit-feather-header” compatible.
