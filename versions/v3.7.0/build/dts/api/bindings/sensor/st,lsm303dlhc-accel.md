---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/sensor/st,lsm303dlhc-accel.html
original_path: build/dts/api/bindings/sensor/st,lsm303dlhc-accel.html
---
...
```text
LSM303DLHC acceleration sensor
```
...
may apply to the “st,lsm303dlhc-accel” compatible.
