---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/bluetooth/zephyr,bt-hci-spi.html
original_path: build/dts/api/bindings/bluetooth/zephyr,bt-hci-spi.html
---
...
| `bt-hci-quirks` | `string-array` | ```text HCI device quirks ``` |
...
may apply to the “zephyr,bt-hci-spi” compatible.
