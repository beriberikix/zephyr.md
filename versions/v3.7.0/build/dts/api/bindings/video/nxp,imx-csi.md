---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/video/nxp,imx-csi.html
...
| `source` | `phandle` | ```text the connected source device, e.g., a mipi csi or a camera sensor ```  This property is **required**. |
