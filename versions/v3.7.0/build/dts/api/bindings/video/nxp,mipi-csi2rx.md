---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/video/nxp,mipi-csi2rx.html
...
| Name | Type | Details |
| --- | --- | --- |
| `sensor` | `phandle` | ```text the connected camera sensor ```  This property is **required**. |
