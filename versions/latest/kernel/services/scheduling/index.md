---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/services/scheduling/index.html
...
- transition of a thread from running state to a suspended or waiting
  state, for example by [`k_sem_take()`](../../../doxygen/html/group__semaphore__apis.md#gac71e2383c1920dddc45a561cacfef090) or [`k_sleep()`](../../../doxygen/html/group__thread__apis.md#ga48d4b041790454da4d68ac8711f29657).
- transition of a thread to the [ready state](../threads/index.md#thread-states), for
  example by [`k_sem_give()`](../../../doxygen/html/group__semaphore__apis.md#gab9be3cf1988af2cd6afdace52d497c84) or [`k_thread_start()`](../../../doxygen/html/group__thread__apis.md#gac539268e0b45c600315a6567ec27f965)
- return to thread context after processing an interrupt
- when a running thread invokes [`k_yield()`](../../../doxygen/html/group__thread__apis.md#ga08a3484c33444ecedc2d71d78495a295)
...
[`k_thread_deadline_set()`](../../../doxygen/html/group__thread__apis.md#gad887f16c1dd6f3247682a83beb22d1ce) is used to set a thread’s deadline.
...
- Simple linked-list ready queue ([`CONFIG_SCHED_SIMPLE`](../../../kconfig.md#CONFIG_SCHED_SIMPLE "CONFIG_SCHED_SIMPLE"))
...
- Scalable wait\_q implementation ([`CONFIG_WAITQ_SCALABLE`](../../../kconfig.md#CONFIG_WAITQ_SCALABLE "CONFIG_WAITQ_SCALABLE"))
  ...
  There is a ~2kb code size increase over [`CONFIG_WAITQ_SIMPLE`](../../../kconfig.md#CONFIG_WAITQ_SIMPLE "CONFIG_WAITQ_SIMPLE") (which may
  ...
  path).
- Simple linked-list wait\_q ([`CONFIG_WAITQ_SIMPLE`](../../../kconfig.md#CONFIG_WAITQ_SIMPLE "CONFIG_WAITQ_SIMPLE"))
...
> ![../../../_images/cooperative.svg](https://docs.zephyrproject.org/4.2.0/_images/cooperative.svg)
...
- Calling [`k_yield()`](../../../doxygen/html/group__thread__apis.md#ga08a3484c33444ecedc2d71d78495a295) puts the thread at the back of the scheduler’s
...
- Calling [`k_sleep()`](../../../doxygen/html/group__thread__apis.md#ga48d4b041790454da4d68ac8711f29657) makes the thread unready for a specified
...
> ![../../../_images/preemptive.svg](https://docs.zephyrproject.org/4.2.0/_images/preemptive.svg)
...
![../../../_images/timeslicing.svg](https://docs.zephyrproject.org/4.2.0/_images/timeslicing.svg)
...
thread is preemptible and, if so, implicitly invokes [`k_yield()`](../../../doxygen/html/group__thread__apis.md#ga08a3484c33444ecedc2d71d78495a295)
...
as a cooperative thread by calling [`k_sched_lock()`](../../../doxygen/html/group__thread__apis.md#ga4f0c5d0b9f279b12a4ad97db0c116a5f). This prevents
...
[`k_sched_unlock()`](../../../doxygen/html/group__thread__apis.md#ga7b26f64523cc4c36522cc828ccf85580) to restore its normal, preemptible status.

If a thread calls [`k_sched_lock()`](../../../doxygen/html/group__thread__apis.md#ga4f0c5d0b9f279b12a4ad97db0c116a5f) and subsequently performs an
...
A thread can call [`k_sleep()`](../../../doxygen/html/group__thread__apis.md#ga48d4b041790454da4d68ac8711f29657) to delay its processing
...
[`k_wakeup()`](../../../doxygen/html/group__thread__apis.md#ga9275a019c8ff3c7fe49a81f8c078157e). This technique can sometimes be used
...
A thread can call [`k_busy_wait()`](../../../doxygen/html/group__thread__apis.md#ga550b642e071480323e589866abb99c22) to perform a `busy wait`
