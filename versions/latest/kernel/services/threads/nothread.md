---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/services/threads/nothread.html
...
- The system clock including [`k_uptime_get()`](../timing/clocks.md#c.k_uptime_get "k_uptime_get")
- Timers, i.e. `k_timer()`
- Non-sleeping delays e.g. [`k_busy_wait()`](index.md#c.k_busy_wait "k_busy_wait").
- Sleeping [`k_cpu_idle()`](../scheduling/index.md#c.k_cpu_idle "k_cpu_idle").
