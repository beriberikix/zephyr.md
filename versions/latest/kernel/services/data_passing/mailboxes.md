---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/services/data_passing/mailboxes.html
original_path: kernel/services/data_passing/mailboxes.html
---
...
A *mailbox* is a kernel object that provides enhanced message queue
...
### [Defining a Mailbox](#id7)

A mailbox is defined using a variable of type [`k_mbox`](#c.k_mbox).
It must then be initialized by calling [`k_mbox_init()`](#c.k_mbox_init).
...
by calling [`K_MBOX_DEFINE`](#c.K_MBOX_DEFINE).
...
### [Message Descriptors](#id8)

A message descriptor is a structure of type [`k_mbox_msg`](#c.k_mbox_msg).
...
*tx\_target\_thread*
:   The address of the desired receiving thread. Set it to `K_ANY`
...
*rx\_source\_thread*
:   The address of the desired sending thread. Set it to `K_ANY`
...
- If the message descriptor size is non-zero and the receiving thread still
  wants to retrieve the data, the thread must call [`k_mbox_data_get()`](#c.k_mbox_data_get)
...
- If the message descriptor size is non-zero and the receiving thread does *not*
  want to retrieve the data, the thread must call [`k_mbox_data_get()`](#c.k_mbox_data_get).
...
## [Configuration Options](#id12)

Related configuration options:

- [`CONFIG_NUM_MBOX_ASYNC_MSGS`](../../../kconfig.md#CONFIG_NUM_MBOX_ASYNC_MSGS "CONFIG_NUM_MBOX_ASYNC_MSGS")
...
:   Defines
    ...
    void k\_mbox\_init(struct [k\_mbox](#c.k_mbox) \*mbox)
    ...
    int k\_mbox\_put(struct [k\_mbox](#c.k_mbox) \*mbox, struct [k\_mbox\_msg](#c.k_mbox_msg) \*tx\_msg, [k\_timeout\_t](../timing/clocks.md#c.k_timeout_t "k_timeout_t") timeout)
    ...
    void k\_mbox\_async\_put(struct [k\_mbox](#c.k_mbox) \*mbox, struct [k\_mbox\_msg](#c.k_mbox_msg) \*tx\_msg, struct k\_sem \*sem)
    ...
    int k\_mbox\_get(struct [k\_mbox](#c.k_mbox) \*mbox, struct [k\_mbox\_msg](#c.k_mbox_msg) \*rx\_msg, void \*buffer, [k\_timeout\_t](../timing/clocks.md#c.k_timeout_t "k_timeout_t") timeout)
    ...
    void k\_mbox\_data\_get(struct [k\_mbox\_msg](#c.k_mbox_msg) \*rx\_msg, void \*buffer)
