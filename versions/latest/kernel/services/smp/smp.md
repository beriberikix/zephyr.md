---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/kernel/services/smp/smp.html
...
layer using [`arch_start_cpu()`](../../../hardware/porting/arch.md#c.arch_start_cpu "arch_start_cpu") for each one. This function is
...
architecture provides a [`arch_sched_ipi()`](../../../hardware/porting/arch.md#c.arch_sched_ipi "arch_sched_ipi") call, which when invoked
