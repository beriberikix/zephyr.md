---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/kernel/services/smp/smp.html
...
[`irq_lock()`](../../../doxygen/html/group__isr__apis.md#ga19fdde73c3b02fcca6cf1d1e67631228)/[`irq_unlock()`](../../../doxygen/html/group__isr__apis.md#ga646045943b3b2a130738bcc48867bf57) primitives to implement fine grained
...
SMP systems provide a more constrained [`k_spin_lock()`](../../../doxygen/html/group__spinlock__apis.md#gaac60da4347f5b29ff8c4e5f24c99b3bf) primitive
that not only masks interrupts locally, as done by [`irq_lock()`](../../../doxygen/html/group__isr__apis.md#ga19fdde73c3b02fcca6cf1d1e67631228), but
...
implementation of [`k_spin_lock()`](../../../doxygen/html/group__spinlock__apis.md#gaac60da4347f5b29ff8c4e5f24c99b3bf) and [`k_spin_unlock()`](../../../doxygen/html/group__spinlock__apis.md#gaa54fc60d17d1033276aed4605671ed8e) is built
...
API, [`irq_lock()`](../../../doxygen/html/group__isr__apis.md#ga19fdde73c3b02fcca6cf1d1e67631228) and [`irq_unlock()`](../../../doxygen/html/group__isr__apis.md#ga646045943b3b2a130738bcc48867bf57) continue to work compatibly on
...
[`irq_lock()`](../../../doxygen/html/group__isr__apis.md#ga19fdde73c3b02fcca6cf1d1e67631228) are not simply invoking a very short (often ~1
...
[`k_thread_cpu_mask_disable()`](../../../doxygen/html/group__thread__apis.md#ga89e6c07ac112da75b2ef115d1a557d44) with a particular CPU ID will prevent
that thread from running on that CPU in the future. Likewise
[`k_thread_cpu_mask_enable()`](../../../doxygen/html/group__thread__apis.md#ga306587604a7496db8059bd395fd90fc0) will re-enable execution. There are also
[`k_thread_cpu_mask_clear()`](../../../doxygen/html/group__thread__apis.md#ga80b9c58df6600c7e79f16756c128f44c) and [`k_thread_cpu_mask_enable_all()`](../../../doxygen/html/group__thread__apis.md#gaedcfeb0964ae72611791241580b2119d) APIs
...
available only when [`CONFIG_SCHED_SIMPLE`](../../../kconfig.md#CONFIG_SCHED_SIMPLE "CONFIG_SCHED_SIMPLE") is the selected
...
layer using [`arch_cpu_start()`](../../../doxygen/html/group__arch-smp.md#ga32b7e543ce51498200c368c39c900bc8) for each one. This function is
...
![SMP Initialization](https://docs.zephyrproject.org/4.2.0/_images/smpinit.svg)
...
One example is the Zephyr [`k_thread_abort()`](../../../doxygen/html/group__thread__apis.md#ga1f44bb0307bea7a97227764ecd7bf963) API, which cannot return
...
architecture provides at least a [`arch_sched_broadcast_ipi()`](../../../doxygen/html/group__arch-smp.md#ga8fe90cec57c56993df14c0d545106ca3) call,
...
architecture also provides a [`arch_sched_directed_ipi()`](../../../doxygen/html/group__arch-smp.md#gadebac82c1ed0a8a08adb297738d2633e) call, which
...
Using this, [`k_thread_abort()`](../../../doxygen/html/group__thread__apis.md#ga1f44bb0307bea7a97227764ecd7bf963) becomes only slightly more
...
context. The expectation is that [`arch_curr_cpu()`](../../../doxygen/html/group__arch-smp.md#gad42138d41dff6a4aad8abf7d77fcd8b2) will be
...
[`arch_switch()`](../../../doxygen/html/group__arch-threads.md#gab411d82ce5b60f062171f5a19e33e025) is always called with interrupts masked, and takes
...
used by [`arch_switch()`](../../../doxygen/html/group__arch-threads.md#gab411d82ce5b60f062171f5a19e33e025), or NULL if that thread cannot be released
...
registers only when [`arch_switch()`](../../../doxygen/html/group__arch-threads.md#gab411d82ce5b60f062171f5a19e33e025) is called to minimize context
...
to schedule, and follow through with their own [`arch_switch()`](../../../doxygen/html/group__arch-threads.md#gab411d82ce5b60f062171f5a19e33e025) or
...
[`arch_switch()`](../../../doxygen/html/group__arch-threads.md#gab411d82ce5b60f062171f5a19e33e025).
