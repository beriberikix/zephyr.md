---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/tools/clion.html
...
CLion now features [native Zephyr West integration](https://jb.gg/cl_zephyr_doc) which provides an easier and more intuitive
