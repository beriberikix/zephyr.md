---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/develop/tools/stm32cubeide.html
...
3. Open your already existing project by going to
   ...
   ![Create new CMake project](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_new_cmake.webp)
...
8. Go to the C/C++ Build page and set the Generator
   ...
   ![Properties dialog for project](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_project_properties.webp)
...
9. Go to the C/C++ General ‣ Preprocessor Include page.
   ...
   ![Properties dialog for preprocessor options](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_preprocessor_include.webp)
   ...
   ![Add include file dialog](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_add_include.webp)

   Once the include file has been added, your properties page should look
   similar to the following:

   ![Properties page after adding autoconf.h file](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_autoconf_h.webp)
...
2. Run STM32CubeIDE and import your project by going to File ‣ Import…:
   ...
   ![Import project](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_menu_import.webp)
3. Select C/C++ ‣ STM32 Cortex-M Executable, then click Next:

   ![Import project selection](https://docs.zephyrproject.org/4.2.0/_images/stm32cube_import_project.webp)
