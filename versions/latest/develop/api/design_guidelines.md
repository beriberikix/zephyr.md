---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/develop/api/design_guidelines.html
original_path: develop/api/design_guidelines.html
---
...
[`gpio_callback`](../../hardware/peripherals/gpio.md#c.gpio_callback "gpio_callback"), normally defined within a data structure
...
[`CONTAINER_OF`](../../kernel/util/index.md#c.CONTAINER_OF "CONTAINER_OF").

### Examples

- The requirements of [`k_timer_expiry_t`](../../kernel/services/timing/timers.md#c.k_timer_expiry_t "k_timer_expiry_t") invoked when a system
  ...
  The assumption here, as with [`gpio_callback`](../../hardware/peripherals/gpio.md#c.gpio_callback "gpio_callback"), is that the
  timer is embedded in a structure reachable from
  [`CONTAINER_OF`](../../kernel/util/index.md#c.CONTAINER_OF "CONTAINER_OF") that can provide additional context to the
  callback.
- The requirements of [`counter_alarm_callback_t`](../../hardware/peripherals/counter.md#c.counter_alarm_callback_t "counter_alarm_callback_t") invoked when a
  ...
  [`counter_alarm_cfg`](../../hardware/peripherals/counter.md#c.counter_alarm_cfg "counter_alarm_cfg") used to register the callback, depending
  on user needs.
...
[`capturing a timestamp`](../../kconfig.md#CONFIG_CAN_RX_TIMESTAMP "CONFIG_CAN_RX_TIMESTAMP") or
[`providing an alternative interface`](../../kconfig.md#CONFIG_SPI_ASYNC "CONFIG_SPI_ASYNC"). The
...
`PREDEFINED` variable in `doc/zephyr.doxyfile.in` to ensure the
