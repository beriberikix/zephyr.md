---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/bluetooth/hci_uart_async/README.html
...
west build -b nrf52dk_nrf52832 samples/bluetooth/hci_uart_async
west flash
```
