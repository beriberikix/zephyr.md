---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/bluetooth/channel_sounding/README.html
original_path: samples/bluetooth/channel_sounding/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/bluetooth/channel_sounding/README.rst/..)
...
be found under [samples/bluetooth/channel\_sounding/cs\_test](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/channel_sounding/cs_test).

The connected CS sample shows how to set up regular channel sounding procedures on a connection
between two devices.
It can be found under [samples/bluetooth/channel\_sounding/connected\_cs](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/channel_sounding/connected_cs)
...
but the mathematical representation described in [[1]](#phase-and-amplitude) and [[2]](#rtt-packets) is used
...
connected devices are available in [[3]](#cs-setup-phase) and [[4]](#cs-start).

## Requirements

- Two boards with Bluetooth LE and Channel Sounding support (such as an [nRF54L15](../../../boards/nordic/nrf54l15dk/doc/index.md#nrf54l15dk-nrf54l15))
- A controller that supports the Channel Sounding feature

## Building and Running

These samples can be found under [samples/bluetooth/channel\_sounding](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/bluetooth/channel_sounding) in
the Zephyr tree.
...
[Bluetooth Core Specification v. 6.0: Vol. 1, Part A, 9.2](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-60/out/en/architecture,-change-history,-and-conventions/architecture.html#UUID-a8d03618-5fcf-3043-2198-559653272b1b)

[[2](#id2)]

[Bluetooth Core Specification v. 6.0: Vol. 1, Part A, 9.3](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-60/out/en/architecture,-change-history,-and-conventions/architecture.html#UUID-9d4969af-baa6-b7e4-03ca-70b340877adf)

[[3](#id3)]

[Bluetooth Core Specification v. 6.0: Vol. 6, Part D, 6.34](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-60/out/en/low-energy-controller/message-sequence-charts.html#UUID-73ba2c73-f3c8-3b1b-2bdb-b18174b88059)

[[4](#id4)]

[Bluetooth Core Specification v. 6.0: Vol. 6, Part D, 6.35](https://www.bluetooth.com/wp-content/uploads/Files/Specification/HTML/Core-60/out/en/low-energy-controller/message-sequence-charts.html#UUID-c75cd2f9-0dd8-bd38-9afc-c7becfa7f073)
