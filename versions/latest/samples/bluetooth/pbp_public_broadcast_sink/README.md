---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/bluetooth/pbp_public_broadcast_sink/README.html
...
```shell
# From the root of the zephyr repository
west build -b nrf52_bsim samples/bluetooth/pbp_public_broadcast_sink/ -- -DOVERLAY_CONFIG=overlay-bt_ll_sw_split.conf
```
