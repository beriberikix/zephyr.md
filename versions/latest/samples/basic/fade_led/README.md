---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/basic/fade_led/README.html
...
```shell
west build -b nrf52840dk_nrf52840 samples/basic/fade_led
west flash
```
