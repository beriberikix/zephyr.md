---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/kernel/condition_variables/simple/README.html
original_path: samples/kernel/condition_variables/simple/README.html
---
...
```shell
west build -b native_sim samples/kernel/condition_variables/simple
west build -t run
```
