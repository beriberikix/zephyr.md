---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/jesd216/README.html
...
```shell
west build -b efr32mg_sltb004a samples/drivers/jesd216
west flash
```
