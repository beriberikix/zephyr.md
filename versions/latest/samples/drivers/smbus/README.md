---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/smbus/README.html
...
```shell
west build -b qemu_x86_64 zephyr/samples/drivers/smbus
west build -t run
```
