---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/drivers/display/README.html
...
Below is an example on how to build for a [nRF52840 DK](../../../boards/nordic/nrf52840dk/doc/index.md#nrf52840dk) board with a
