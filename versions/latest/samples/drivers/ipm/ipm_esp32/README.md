---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/ipm/ipm_esp32/README.html
...
```shell
west build -b esp32_devkitc_wroom samples/drivers/ipm/ipm_esp32
```
