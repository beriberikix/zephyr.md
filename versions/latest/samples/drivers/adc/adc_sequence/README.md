---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/drivers/adc/adc_sequence/README.html
...
Notice how for the whole sequence reading, only one call to the [`adc_read()`](../../../../hardware/peripherals/adc.md#c.adc_read "adc_read") API is made.
