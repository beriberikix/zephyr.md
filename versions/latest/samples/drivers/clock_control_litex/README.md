---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/clock_control_litex/README.html
...
The driver is interfaced with the [Clock Control API](../../../hardware/peripherals/clock_control.md#clock-control-api) function `clock_control_on()` and a LiteX driver specific structure:

struct litex\_clk\_setup
...
- [LiteX VexRiscv](../../../boards/riscv/litex_vexriscv/doc/index.md#litex-vexriscv)
