---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/drivers/uart/async_api/README.html
original_path: samples/drivers/uart/async_api/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/drivers/uart/async_api/README.rst/..)
...
```shell
west build -b nrf52840dk/nrf52840 samples/drivers/uart/async_api
west flash
```
