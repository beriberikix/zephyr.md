---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/drivers/dac/README.html
...
The sample can be built and executed for the
[ST Nucleo L152RE](../../../boards/arm/nucleo_l152re/doc/index.md#nucleo-l152re-board) as follows:
...
The sample can be built and executed for the
[ST Nucleo F767ZI](../../../boards/arm/nucleo_f767zi/doc/index.md#nucleo-f767zi-board) as follows:
...
The sample can be built and executed for the
[ST STM32F3 Discovery](../../../boards/arm/stm32f3_disco/doc/index.md#stm32f3-disco-board) as follows:
...
The sample can be built and executed for the
[ST Nucleo F429ZI](../../../boards/arm/nucleo_f429zi/doc/index.md#nucleo-f429zi-board) as follows:
...
The sample can be built and executed for the
[ST STM32L562E-DK Discovery](../../../boards/arm/stm32l562e_dk/doc/index.md#stm32l562e-dk-board) as follows:
...
The sample can be built and executed for the
[ST Nucleo L552ZE Q](../../../boards/arm/nucleo_l552ze_q/doc/nucleol552ze_q.md#nucleo-l552ze-q-board) as follows:
...
The sample can be built and executed for the [NXP TWR-KE18F](../../../boards/arm/twr_ke18f/doc/index.md#twr-ke18f) as
follows:
...
The sample can be built and executed for the [NXP FRDM-K64F](../../../boards/arm/frdm_k64f/doc/index.md#frdm-k64f) as
follows:
...
executed for the [Laird Connectivity BL652 DVK](../../../boards/arm/bl652_dvk/doc/bl652_dvk.md#bl652-dvk) as follows:
...
DAC. Note this is not populated by default. The sample can be built and
executed for the [Laird Connectivity BL653 DVK](../../../boards/arm/bl653_dvk/doc/bl653_dvk.md#bl653-dvk) as follows:
...
DAC. Note this is not populated by default. The sample can be built and
executed for the [Laird Connectivity BL654 DVK](../../../boards/arm/bl654_dvk/doc/bl654_dvk.md#bl654-dvk) as follows:
...
built and executed for the [Laird Connectivity BL5340 DVK](../../../boards/arm/bl5340_dvk/doc/index.md#bl5340-dvk) as follows:
...
The sample can be built and executed for the
[GigaDevice GD32F450I-EVAL](../../../boards/arm/gd32f450i_eval/doc/index.md#gd32f450i-eval) as follows:
...
The sample can be built and executed for the
[Sipeed Longan Nano](../../../boards/riscv/longan_nano/doc/index.md#longan-nano) as follows:
...
The sample can be built and executed for the [NXP LPCXpresso55S36](../../../boards/arm/lpcxpresso55s36/doc/index.md#lpcxpresso55s36) as
follows:
