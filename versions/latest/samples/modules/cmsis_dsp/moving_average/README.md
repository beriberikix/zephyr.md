---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/modules/cmsis_dsp/moving_average/README.html
...
```shell
west build -b qemu_cortex_m0 samples/modules/cmsis-dsp/moving_average
west build -t run
```
