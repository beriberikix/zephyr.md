---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/modules/pmci/mctp/endpoint/README.html
original_path: samples/modules/pmci/mctp/endpoint/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/modules/pmci/mctp/endpoint/README.rst/..)
...
```shell
west build -b nrf52840_nrf52840dk samples/modules/pmci/mctp/endpoint
west build -t run
```
