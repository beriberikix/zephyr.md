---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/net/sockets/echo_client/README.html
...
```shell
west build -b [atsamr21_xpro | sam4s_xplained | sam_v71_xult] samples/net/sockets/echo_client -- -DEXTRA_CONF_FILE=overlay-802154.conf
west flash
```
