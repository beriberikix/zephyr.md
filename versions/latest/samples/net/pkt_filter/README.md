---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/net/pkt_filter/README.html
original_path: samples/net/pkt_filter/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/net/pkt_filter/README.rst/..)
...
[samples/net/pkt\_filter](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/pkt_filter).
...
A good way to run this sample application is with QEMU or native\_sim board
as described in [Networking with the host system](../../../connectivity/networking/networking_with_host.md#networking-with-host).
...
```shell
west build -b <board to use> samples/net/pkt_filter -- -DCONF_FILE="prj.conf overlay-vlan.conf"
```

In this example, we enable VLAN support with these settings:

The VLAN overlay configuration file [samples/net/pkt\_filter/overlay-vlan.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/net/pkt_filter/overlay-vlan.conf)
