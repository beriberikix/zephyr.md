---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/sensor/jc42/README.html
original_path: samples/sensor/jc42/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/jc42/README.rst/..)
...
The MCP9808 digital temperature sensor converts temperatures between -20°
C and +100° C to a digital word with ±0.5° C (max.)
...
Sensor](https://www.adafruit.com/product/1782) breakout board.
...
west build -b particle_xenon samples/sensor/jc42
west flash
```
