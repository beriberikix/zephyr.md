---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/fdc2x1x/README.html
...
In this example the [nRF9160 DK](../../../boards/arm/nrf9160dk_nrf9160/doc/index.md#nrf9160dk-nrf9160) board is used. The devicetree
overlay of this board provides example settings for evaluation, which
you can use as a reference for other platforms.

```shell
west build -b nrf9160dk_nrf9160 samples/sensor/fdc2x1x
west flash
```
