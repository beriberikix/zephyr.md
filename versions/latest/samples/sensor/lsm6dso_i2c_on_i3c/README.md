---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/lsm6dso_i2c_on_i3c/README.html
...
on [NXP MIMXRT685-EVK](../../../boards/arm/mimxrt685_evk/doc/index.md#mimxrt685-evk).
...
```shell
west build -b mimxrt685_evk_cm33 samples/sensor/lsm6dso_i2c_on_i3c
```
