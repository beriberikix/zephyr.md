---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/bme280/README.html
...
This sample shows how to use the Zephyr [Sensors](../../../hardware/peripherals/sensor.md#sensor-api) API driver for the
...
The default assignment of the built-in spi0 device on the [Raspberry Pi Pico](../../../boards/arm/rpi_pico/doc/index.md#rpi-pico) is
...
For example, to build for the [Adafruit Feather M0 Basic Proto](../../../boards/arm/adafruit_feather_m0_basic_proto/doc/index.md#adafruit-feather-m0-basic-proto) using the
