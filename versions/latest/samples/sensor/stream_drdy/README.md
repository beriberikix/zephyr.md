---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/sensor/stream_drdy/README.html
original_path: samples/sensor/stream_drdy/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/sensor/stream_drdy/README.rst/..)

## Overview

This sample application demonstrates how to stream accel data using the
[RTIO framework](../../../services/rtio/index.md#rtio) based [Read and Decode method](../../../hardware/peripherals/sensor/read_and_decode.md#sensor-read-and-decode).

The streaming is started using the sensor\_stream() API and it is self-sustained by the
SENSOR\_TRIG\_DATA\_READY trigger.
...
Example devicetree overlays and configurations are already available for sensortile\_box\_pro,
nucleo\_f401re and nucleo\_h503rb in the boards directory:

- [samples/sensor/stream\_drdy/boards/sensortile\_box\_pro.overlay](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/sensortile_box_pro.overlay)

  DT overlay file for the sensortile\_box\_pro board.
- [samples/sensor/stream\_drdy/boards/sensortile\_box\_pro.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/sensortile_box_pro.conf)

  Configuration file for the sensortile\_box\_pro board.
- [samples/sensor/stream\_drdy/boards/nucleo\_f401re.overlay](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/nucleo_f401re.overlay)

  DT overlay file for the nucleo\_f401re board.
- [samples/sensor/stream\_drdy/boards/nucleo\_f401re.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/nucleo_f401re.conf)

  Configuration file for the nucleo\_f401re board.
- [samples/sensor/stream\_drdy/boards/nucleo\_h503rb.overlay](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/nucleo_h503rb.overlay)

  DT overlay file for the nucleo\_h503rb board.
- [samples/sensor/stream\_drdy/boards/nucleo\_h503rb.conf](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/sensor/stream_drdy/boards/nucleo_h503rb.conf)

  Configuration file for the nucleo\_h503rb board.

For example, build and run sample for sensortile\_box\_pro with:
...
The board used is a sensortile\_box\_pro.
