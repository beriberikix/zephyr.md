---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/sensor/ms5837/README.html
...
```shell
west build -b nrf52840dk_nrf52840 samples/sensor/ms5837
```

See [nRF52840 DK](../../../boards/arm/nrf52840dk_nrf52840/doc/index.md#nrf52840dk-nrf52840) on how to flash the build.
