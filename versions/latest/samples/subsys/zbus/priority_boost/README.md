---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/subsys/zbus/priority_boost/README.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/zbus/priority_boost/README.rst/..)
...
[![ZBus priority boost scenario example.](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_scenario1.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_scenario1.svg)

Note

The developer must use the [`zbus_obs_attach_to_thread()`](../../../../doxygen/html/group__zbus__apis.md#gabecf160e4d468d0275ad79e22fd0fb5b) function to ensure a proper
...
[![ZBus example scenario for priority boost disabled.](https://docs.zephyrproject.org/4.2.0/_images/without_hlp_priority_boost_feature.svg)
](https://docs.zephyrproject.org/4.2.0/_images/without_hlp_priority_boost_feature.svg)
...
[![ZBus example scenario for priority boost enabled.](https://docs.zephyrproject.org/4.2.0/_images/with_hlp_priority_boost_feature.svg)
](https://docs.zephyrproject.org/4.2.0/_images/with_hlp_priority_boost_feature.svg)
