---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/edac/README.html
...
Zephyr tree.
The sample can be built as follows for the [Elkhart Lake CRB](../../../boards/x86/intel_ehl/doc/index.md#intel-ehl-crb) board:

```shell
west build -b intel_ehl_crb samples/subsys/edac
```

The Zephyr image that’s created can be run on the [Elkhart Lake CRB](../../../boards/x86/intel_ehl/doc/index.md#intel-ehl-crb) board
as per the instructions in the board documentation. Check out the
[Elkhart Lake CRB](../../../boards/x86/intel_ehl/doc/index.md#intel-ehl-crb) for details.
