---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/subsys/rtio/sensor_batch_processing/README.html
original_path: samples/subsys/rtio/sensor_batch_processing/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/rtio/sensor_batch_processing/README.rst/..)

## Overview

This sample application demonstrates the use of the [Real Time I/O (RTIO)](../../../../services/rtio/index.md#rtio) framework for
doing asynchronous operation chains.
Application uses [Real Time I/O (RTIO)](../../../../services/rtio/index.md#rtio) with mempool API to fetch data from virtual sensor
and displays it on the console.

## Requirements

- A board with flash support or native\_sim target

## Building and Running

This sample can be found under [samples/subsys/rtio](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/subsys/rtio) in the Zephyr tree.

The sample can be built for most platforms, the following commands build the
application for the native\_sim target.

```shell
west build -b native_sim samples/subsys/rtio
west build -t run
```
