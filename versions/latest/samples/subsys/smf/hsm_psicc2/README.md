---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/subsys/smf/hsm_psicc2/README.html
...
The sample can be built and executed for the [ST Disco L475 IOT01 (B-L475E-IOT01A)](../../../../boards/st/disco_l475_iot1/doc/index.md#disco-l475-iot1-board) as follows:

```shell
west build -b disco_l475_iot1 samples/subsys/smf/psicc2
west flash
```
