---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/llext/shell_loader/README.html
...
(list\_symbols), and the hello\_world function which the extension exports can be called and
run (call\_fn).
