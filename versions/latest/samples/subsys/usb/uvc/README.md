---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/samples/subsys/usb/uvc/README.html
original_path: samples/subsys/usb/uvc/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/subsys/usb/uvc/README.rst/..)
...
controller ported to the [USB device controller (UDC) driver API](../../../../connectivity/usb/device_next/api/udc.md#udc-api).

## Building and Running

If a board does not have a camera supported, the [Video Software Generator Snippet (video-sw-generator)](../../../../snippets/video-sw-generator/README.md#snippet-video-sw-generator) snippet can be
...
Refers to [Ideas on board FAQ](https://www.ideasonboard.org/uvc/faq/)
...
In addition, the [USB3CV](https://www.usb.org/document-library/usb3cv) tool
...
The [VLC](https://www.videolan.org/vlc/) client and the system Webcam Settings panel
allows adjustment of the supported video controls.

The [VLC](https://www.videolan.org/vlc/) client and [Pot Player](https://potplayer.tv/)
...
[USB Video Class (UVC) device API](../../../../doxygen/html/group__usbd__uvc.md)
