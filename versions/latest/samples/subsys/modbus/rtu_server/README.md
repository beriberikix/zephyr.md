---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/subsys/modbus/rtu_server/README.html
...
The description of this sample uses [PyModbus](https://github.com/riptideio/pymodbus) (Pymodbus REPL).
...
```shell
west build -b nrf52840dk_nrf52840 samples/subsys/modbus/rtu_server -- -DDTC_OVERLAY_FILE=cdc-acm.overlay -DEXTRA_CONF_FILE=overlay-cdc-acm.conf
west flash
```
