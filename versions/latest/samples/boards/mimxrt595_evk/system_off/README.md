---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/samples/boards/mimxrt595_evk/system_off/README.html
original_path: samples/boards/mimxrt595_evk/system_off/README.html
---
...
```shell
west build -b mimxrt595_evk/mimxrt595s/cm33 samples/boards/mimxrt595_evk/system_off
west flash
```
