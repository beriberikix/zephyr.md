---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/boards/st/sensortile_box/README.html
original_path: samples/boards/st/sensortile_box/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/st/sensortile_box/README.rst/..)
...
- [SensorTile.box](../../../../boards/st/sensortile_box/doc/index.md#sensortile_box)
...
west build -b sensortile_box samples/boards/st/sensortile_box
west flash
```

Please note that flashing the board requires a few preliminary steps described
in [SensorTile.box](../../../../boards/st/sensortile_box/doc/index.md#sensortile_box).
...
Replace `<tty_device>` with the port where the SensorTile.box board
