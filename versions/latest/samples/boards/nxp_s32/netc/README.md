---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/nxp_s32/netc/README.html
original_path: samples/boards/nxp_s32/netc/README.html
---
...
[samples/boards/nxp\_s32/netc](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nxp_s32/netc).
...
west build -b s32z270dc2_rtu0_r52 samples/boards/nxp_s32/netc
west flash
```
...
```shell
# From the root of the zephyr repository
west build -b s32z270dc2_rtu0_r52 samples/boards/nxp_s32/netc -- -DDTC_OVERLAY_FILE="./vsi-and-psi.overlay"
west flash
```
