---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/esp32/flash_encryption/README.html
original_path: samples/boards/esp32/flash_encryption/README.html
---
...
For more details, check [ESP32 Flash Encryption](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/security/flash-encryption.html) and [MCUBoot Readme](https://docs.mcuboot.com/readme-espressif).
...
feature. Follow the instructions provided at [MCUBoot Readme](https://docs.mcuboot.com/readme-espressif) prior to running this sample.
...
memory reading using proper spi\_flash call, which decrypts the content as expected.
