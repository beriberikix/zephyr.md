---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/boards/esp32/deep_sleep/README.html
original_path: samples/boards/esp32/deep_sleep/README.html
---
...
[ESP32-DEVKITC-WROOM](../../../../boards/xtensa/esp32_devkitc_wroom/doc/index.md#esp32-devkitc-wroom) development board without any extra hardware if
...
```shell
west build -b esp32_devkitc_wroom samples/boards/esp32/deep_sleep
west flash
```
