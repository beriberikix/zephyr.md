---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/boards/nordic/mesh/onoff-app/README.html
original_path: samples/boards/nordic/mesh/onoff-app/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nordic/mesh/onoff-app/README.rst/..)
...
the button\_pressed() interrupt handler. An interrupt within 250ms of the
...
This sample can be found under [samples/boards/nordic/mesh/onoff-app](https://github.com/zephyrproject-rtos/zephyr/blob/main/samples/boards/nordic/mesh/onoff-app) in the
Zephyr tree.

The following commands build the application.

```shell
west build -b nrf52840dk/nrf52840 samples/boards/nordic/mesh/onoff-app
west flash
```
