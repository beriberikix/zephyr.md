---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/samples/boards/nxp/mimxrt1060_evk/system_off/README.html
original_path: samples/boards/nxp/mimxrt1060_evk/system_off/README.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//samples/boards/nxp/mimxrt1060_evk/system_off/README.rst/..)
...
```shell
west build -b mimxrt1060_evk samples/boards/nxp/mimxrt1060_evk/system_off
west flash
```
