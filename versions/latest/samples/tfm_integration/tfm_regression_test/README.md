---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/samples/tfm_integration/tfm_regression_test/README.html
original_path: samples/tfm_integration/tfm_regression_test/README.html
---
...
The TF-M regression tests are implemented in the tf-m-tests repo: [https://git.trustedfirmware.org/TF-M/tf-m-tests.git/](https://git.trustedfirmware.org/TF-M/tf-m-tests.git/)

This sample is available for platforms that are supported in the trusted-firmware-m repo: [https://git.trustedfirmware.org/TF-M/trusted-firmware-m.git/](https://git.trustedfirmware.org/TF-M/trusted-firmware-m.git/)
See sample.yaml for a list of supported platforms.

## Building and Running

Tests for both the secure and non-secure domain are enabled by default, controlled via the CONFIG\_TFM\_REGRESSION\_S and CONFIG\_TFM\_REGRESSION\_NS configs.
