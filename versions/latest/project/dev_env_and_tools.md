---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/project/dev_env_and_tools.html
...
![Pull request classes](https://docs.zephyrproject.org/4.2.0/_images/pull_request_classes.png)
...
| dev-review | The issue is to be discussed in the following [dev-review](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Groups#zephyr-dev-meeting) if time permits. |
| TSC | TSC stands for Technical Steering Committee. The issue is to be discussed in the following [TSC meeting](https://github.com/zephyrproject-rtos/zephyr/wiki/Technical-Steering-Committee-(TSC)) if time permits. |
