---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/contribute/proposals_and_rfcs.html
original_path: contribute/proposals_and_rfcs.html
---
...
The process in itself consists in creating a GitHub issue with the [RFC
label](../project/dev_env_and_tools.md#gh-labels) that documents the proposal thoroughly. There is an [RFC
template](https://github.com/zephyrproject-rtos/zephyr/blob/main/.github/ISSUE_TEMPLATE/003_rfc-proposal.md) included in the main Zephyr GitHub repository that serves as a
guideline to write a new RFC.

As with Pull Requests, RFCs might require discussion in the context of one of
the [Zephyr meetings](https://github.com/zephyrproject-rtos/zephyr/wiki/Zephyr-Committee-and-Working-Group-Meetings) in order to move it forward in cases where there is
