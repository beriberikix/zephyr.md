---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/zbus/index.html
...
[![zbus usage overview](https://docs.zephyrproject.org/4.2.0/_images/zbus_overview.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_overview.svg)
...
[![ZBus anatomy](https://docs.zephyrproject.org/4.2.0/_images/zbus_anatomy.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_anatomy.svg)
...
[![ZBus observers type](https://docs.zephyrproject.org/4.2.0/_images/zbus_type_of_observers.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_type_of_observers.svg)
...
[![ZBus observation mask.](https://docs.zephyrproject.org/4.2.0/_images/zbus_observation_mask.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_observation_mask.svg)
...
[![ZBus sensor-based application](https://docs.zephyrproject.org/4.2.0/_images/zbus_operations.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_operations.svg)
...
[![ZBus example scenario](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_scenario.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_scenario.svg)
...
[![ZBus publish processing detail](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example.svg)
...
[![ZBus publish processing detail](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example2.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example2.svg)
...
[![ZBus publishing process details using priority boost.](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_HLP.svg)
](https://docs.zephyrproject.org/4.2.0/_images/zbus_publishing_process_example_HLP.svg)
...
[`CONFIG_ZBUS_RUNTIME_OBSERVERS`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS "CONFIG_ZBUS_RUNTIME_OBSERVERS") to enable the feature. This feature uses the heap to
allocate the nodes dynamically, a memory slab to allocate the nodes statically, or user-provided
nodes. It depends on the [`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC"), which can be
...
[`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC"), and
[`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE"). The dynamic is the default. When
[`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC") is enabled, you need to set the
number of runtime observers you are going to use by setting the
[`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE") configuration. The following example
...
The [`zbus_observer_node`](../../doxygen/html/structzbus__observer__node.md) can only be re-used in [`zbus_chan_add_obs_with_node()`](../../doxygen/html/group__zbus__apis.md#ga6f2b8db3a13546e3d0fd095ff9cd37ba) after removing
the channel observer it was first associated with through [`zbus_chan_rm_obs()`](../../doxygen/html/group__zbus__apis.md#gaee11d7472a3f87156b8ef1dcfbe897c4).
...
- [`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_DYNAMIC`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_DYNAMIC "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_DYNAMIC") allocate the runtime observers
  dynamically using the heap;
- [`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_STATIC") allocate the runtime observers
  statically using a memory slab;
- [`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_POOL_SIZE") the amount of enabled runtime
  observers to statically allocate.
- [`CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE`](../../kconfig.md#CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE "CONFIG_ZBUS_RUNTIME_OBSERVERS_NODE_ALLOC_NONE") use user-provided runtime
  observers nodes;
