---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/services/shell/index.html
...
![RTT PuTTY terminal configuration.](https://docs.zephyrproject.org/4.2.0/_images/putty_rtt.png)
...
- Open up a second Terminal window and enter:
  ...
  ```
- Now you should have a network connection to RTT that will let you enter input
  to the shell. However, contrary to [PuTTY](#shell-rtt-putty) some features like
...
![Command tree with static commands.](https://docs.zephyrproject.org/4.2.0/_images/static_cmd.PNG)
...
![Dictionary commands example.](https://docs.zephyrproject.org/4.2.0/_images/dict_cmd.png)
...
![Command tree with static and dynamic commands.](https://docs.zephyrproject.org/4.2.0/_images/dynamic_cmd.PNG)
...
![Command tree with static commands.](https://docs.zephyrproject.org/4.2.0/_images/execution.png)
...
![Tab Feature usage example](https://docs.zephyrproject.org/4.2.0/_images/tab_prompt.png)
...
![Wildcard usage example](https://docs.zephyrproject.org/4.2.0/_images/wildcard.png)
