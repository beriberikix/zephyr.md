---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/device_mgmt/ota.html
...
Zephyr [Management Samples](../../samples/subsys/mgmt/mgmt.md#mgmt-samples) section.
...
[Management Samples](../../samples/subsys/mgmt/mgmt.md#mgmt-samples) section.
...
There is an [SMP server](../../samples/subsys/mgmt/mcumgr/smp_svr/README.md#smp-svr "Implement a Simple Management Protocol (SMP) server.") sample included in the Zephyr [Management Samples](../../samples/subsys/mgmt/mgmt.md#mgmt-samples)
section.
