---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/services/device_mgmt/smp_groups/smp_group_2.html
...
`STATS_INIT_AND_REG` macro or `stats_init_and_reg()` function
