---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/hardware/porting/board_porting.html
...
[![Hardware support Hierarchy](https://docs.zephyrproject.org/4.2.0/_images/hierarchy.png)
](https://docs.zephyrproject.org/4.2.0/_images/hierarchy.png)
...
| --- | --- | --- | --- | --- | --- | --- |
| [nRF52 DK](../../boards/nordic/nrf52dk/doc/index.md#nrf52dk) | nrf52832 | nRF52832 | nRF52 | Nordic nRF | Arm Cortex-M4 | ARMv7-M |
...
| [nRF5340 DK](../../boards/nordic/nrf5340dk/doc/index.md#nrf5340dk) | nrf5340/cpuapp | nRF5340 | nRF53 | Nordic nRF | Arm Cortex-M33 | ARMv8-M |
...
[![Board terminology diagram](https://docs.zephyrproject.org/4.2.0/_images/board-terminology.svg)
](https://docs.zephyrproject.org/4.2.0/_images/board-terminology.svg)
...
like the [Thingy:52](../../boards/nordic/thingy52/doc/index.md#thingy52) contains a single SoC with no CPU clusters and
no variants.
...
- If available, configure and enable a serial output for the console
  ...
  For boards like [nRF52840 Dongle](../../boards/nordic/nrf52840dongle/doc/index.md#nrf52840dongle), that do not
