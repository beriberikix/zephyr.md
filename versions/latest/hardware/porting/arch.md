...
:   Typedefs
    ...
    void arch\_start\_cpu(int cpu\_num, k\_thread\_stack\_t \*stack, int sz, [arch\_cpustart\_t](#c.arch_cpustart_t) fn, void \*arg)
...
:   Defines
    ...
    :   Fetch location information about a page at a particular address.
        ...
        :   - **addr** – Virtual data page address that took the page fault
            - **location** – **[out]** In the case of ARCH\_PAGE\_FAULT\_PAGED\_OUT, the backing store location value used to retrieve the data page. In the case of ARCH\_PAGE\_FAULT\_PAGED\_IN, the physical address the page is mapped to.
