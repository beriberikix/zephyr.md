---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/arch/arm_cortex_m.html
...
The above MPU regions are defined in `soc/arm/common/cortex_m/arm_mpu_regions.c`.
...
- a no-cache region to allow for a none-cacheable SRAM area, when [`CONFIG_NOCACHE_MEMORY`](../../kconfig.md#CONFIG_NOCACHE_MEMORY "CONFIG_NOCACHE_MEMORY") is enabled
...
GCC linker script in `include/arch/arm/cortex-m/scripts/linked.ld`,
...
| --- | --- | --- | --- | --- | --- |
| Architecture variant | Arm v6-M | Arm v7-M | | Arm v8-M | Arm v8.1-M |
|  | **qemu\_cortex\_m0** | **qemu\_cortex\_m3** | **mps2\_an385** | **mps2\_an521** | **mps3\_an547** |
| **Emulated features** |  | | | | |
| NVIC | Y | Y | Y | Y | Y |
| BASEPRI | N | Y | Y | Y | Y |
| SysTick | N | Y | Y | Y | Y |
