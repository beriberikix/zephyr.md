---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/arch/x86.html
original_path: hardware/arch/x86.html
---
...
marked by kconfig [`CONFIG_SRAM_BASE_ADDRESS`](../../kconfig.md#CONFIG_SRAM_BASE_ADDRESS "CONFIG_SRAM_BASE_ADDRESS") and
[`CONFIG_SRAM_SIZE`](../../kconfig.md#CONFIG_SRAM_SIZE "CONFIG_SRAM_SIZE") while the virtual address space is marked by
[`CONFIG_KERNEL_VM_BASE`](../../kconfig.md#CONFIG_KERNEL_VM_BASE "CONFIG_KERNEL_VM_BASE") and [`CONFIG_KERNEL_VM_SIZE`](../../kconfig.md#CONFIG_KERNEL_VM_SIZE "CONFIG_KERNEL_VM_SIZE").
Note that [`CONFIG_SRAM_OFFSET`](../../kconfig.md#CONFIG_SRAM_OFFSET "CONFIG_SRAM_OFFSET") controls where the Zephyr kernel
is being placed in the memory, and its counterpart
[`CONFIG_KERNEL_VM_OFFSET`](../../kconfig.md#CONFIG_KERNEL_VM_OFFSET "CONFIG_KERNEL_VM_OFFSET").
...
space before `vm_enter` inside `arch/x86/core/ia32/crt0.S`.
...
(`arch/x86/gen_mmu.py`) identity maps the physical addresses
...
cleared in `z_x86_mmu_init()`, effectively removing
...
- Physical and virtual address spaces must be disjoint. This is
  ...
  - If [`CONFIG_X86_PAE`](../../kconfig.md#CONFIG_X86_PAE "CONFIG_X86_PAE") is enabled (`=y`), each address space
  ...
  - If [`CONFIG_X86_PAE`](../../kconfig.md#CONFIG_X86_PAE "CONFIG_X86_PAE") is disabled (`=n`), each address space
...
The page table generation script (`arch/x86/gen_mmu.py`) generates
...
tables). [`CONFIG_X86_EXTRA_PAGE_TABLE_PAGES`](../../kconfig.md#CONFIG_X86_EXTRA_PAGE_TABLE_PAGES "CONFIG_X86_EXTRA_PAGE_TABLE_PAGES") is needed to
