---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/hardware/peripherals/can/shell.html
...
- [`CONFIG_CAN_STATS`](../../../kconfig.md#CONFIG_CAN_STATS "CONFIG_CAN_STATS") enables printing of various statistics for the CAN controller
  ...
  well.
- [`CONFIG_CAN_AUTO_BUS_OFF_RECOVERY`](../../../kconfig.md#CONFIG_CAN_AUTO_BUS_OFF_RECOVERY "CONFIG_CAN_AUTO_BUS_OFF_RECOVERY") enables the `can recover` subcommand when
  disabled.

For example, building the [Hello World](../../../samples/hello_world/README.md#hello-world) sample for the [NXP FRDM-K64F](../../../boards/arm/frdm_k64f/doc/index.md#frdm-k64f) with the CAN shell and
...
[`CONFIG_CAN_AUTO_BUS_OFF_RECOVERY`](../../../kconfig.md#CONFIG_CAN_AUTO_BUS_OFF_RECOVERY "CONFIG_CAN_AUTO_BUS_OFF_RECOVERY") is disabled.
