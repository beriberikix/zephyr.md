---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arc/em_starterkit/doc/index.html
original_path: boards/arc/em_starterkit/doc/index.html
---
...
Documentation for this board can be found at [embARC website](https://www.embarc.org).

See also this URL for details about the board:
[Designware ARC EM Starter Kit website](https://www.synopsys.com/dw/ipdir.php?ds=arc_em_starter_kit) .
...
[boards/arc/em\_starterkit/em\_starterkit\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arc/em_starterkit/em_starterkit_defconfig).
...
is found in [soc/arc/snps\_emsk/Kconfig.defconfig.em9d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/arc/snps_emsk/Kconfig.defconfig.em9d).
...
is found in [soc/arc/snps\_emsk/Kconfig.defconfig.em7d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/arc/snps_emsk/Kconfig.defconfig.em7d) and EM11D is
found in [soc/arc/snps\_emsk/Kconfig.defconfig.em11d](https://github.com/zephyrproject-rtos/zephyr/blob/main/soc/arc/snps_emsk/Kconfig.defconfig.em11d).
...
[embARC website](https://www.embarc.org), which also includes some free sample software.
...
- For EM Starter Kit 2.2, EM7D, EM9D and EM11D core configurations are supported.
  ...
  - Use [`CONFIG_BOARD_EM_STARTERKIT_R22`](../../../../kconfig.md#CONFIG_BOARD_EM_STARTERKIT_R22 "CONFIG_BOARD_EM_STARTERKIT_R22") to select 2.2 version.
  - Use [`CONFIG_SOC_EMSK_EM7D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM7D "CONFIG_SOC_EMSK_EM7D"), [`CONFIG_SOC_EMSK_EM9D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM9D "CONFIG_SOC_EMSK_EM9D") or
    [`CONFIG_SOC_EMSK_EM11D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM11D "CONFIG_SOC_EMSK_EM11D") to select EM7D or EM9D or EM11D.
- For EM Starter Kit 2.3, EM7D, EM9D and EM11D core configurations are
  supported.

  - Use [`CONFIG_BOARD_EM_STARTERKIT_R23`](../../../../kconfig.md#CONFIG_BOARD_EM_STARTERKIT_R23 "CONFIG_BOARD_EM_STARTERKIT_R23") to select 2.3 version.
  - Use [`CONFIG_SOC_EMSK_EM7D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM7D "CONFIG_SOC_EMSK_EM7D"), [`CONFIG_SOC_EMSK_EM9D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM9D "CONFIG_SOC_EMSK_EM9D") or
    [`CONFIG_SOC_EMSK_EM11D`](../../../../kconfig.md#CONFIG_SOC_EMSK_EM11D "CONFIG_SOC_EMSK_EM11D") to select EM7D or EM9D or EM11D.
...
| --- | --- | --- | --- | --- |
| INT | on-chip | Y | Y | interrupt\_controller |
...
copy the initialized data section to the data memory if CONFIG\_XIP is used.
...
- If you want to know more about how to use this board, you can take a look
  at the [ARC EM Starter Kit User Guide](https://www.synopsys.com/dw/ipdir.php?ds=arc_em_starter_kit).
...
- EM7D: em\_starterkit\_em7d\_defconfig
- EM9D: em\_starterkit\_defconfig
- EM11D: em\_starterkit\_em11d\_defconfig

### Building Sample Applications

You can try many of the sample applications or tests, but let us discuss
the one called [Hello World](../../../../samples/hello_world/README.md#hello-world).
...
- Specify the tty driver name, for example, on Linux this may be `/dev/ttyUSB1`
...
[embARC website](https://www.embarc.org), which includes instructions for how to place an
