---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/shields/frdm_kw41z/doc/index.html
...
document covers usage as a shield; see [NXP FRDM-KW41Z](../../../arm/frdm_kw41z/doc/index.md#frdm-kw41z) for usage as a
standalone board.
...
1. Download the MCUXpresso SDK for FRDM-KW41Z from the [MCUXpresso SDK Builder
   Website](https://mcuxpresso.nxp.com) [[1]](#id1).
...
9. Attach the FRDM-KW41Z to the Arduino header on your selected main board,
   such as [NXP MIMXRT1050-EVK](../../../arm/mimxrt1050_evk/doc/index.md#mimxrt1050-evk) or [NXP FRDM-K64F](../../../arm/frdm_k64f/doc/index.md#frdm-k64f).
10. Set `-DSHIELD=frdm_kw41z` when you invoke `west build` in
