---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/shields/x_nucleo_idb05a1/doc/index.html
...
![X-NUCLEO-IDB05A1](https://docs.zephyrproject.org/4.2.0/_images/x-nucleo-idb05a1.jpg)
...
> ```shell
> west build -b your_board_name --shield x_nucleo_idb05a1 your_app
> ```
