---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/esp32s3_luatos_core/doc/index.html
original_path: boards/xtensa/esp32s3_luatos_core/doc/index.html
---
...
west build -b esp32s3_luatos_core samples/hello_world
```
...
```shell
# From the root of the zephyr repository
west build -b esp32s3_luatos_core_usb samples/hello_world
```
