---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/xtensa/intel_adsp_cavs25/doc/chromebooks_adsp.html
original_path: boards/xtensa/intel_adsp_cavs25/doc/chromebooks_adsp.html
---
...
/mnt/stateful\_partition/cros\_sign\_backups) so that it specifies
...
([https://github.com/dnschneid/crouton](https://github.com/dnschneid/crouton)), which is a community
...
intended to be read only), so the INSTALL\_MOD\_STRIP=1 is absolutely
...
comparing the “kernel\_guid” command line parameter (passed by the
...
You can verify this image if you like with “vbutil\_kernel –verify”.
...
[http://www.chromium.org/chromium-os/chromiumos-design-docs/disk-format](http://www.chromium.org/chromium-os/chromiumos-design-docs/disk-format)

This is great too, with an eye toward booting things other than ChromeOS:

[https://www.chromium.org/chromium-os/developer-information-for-chrome-os-devices/custom-firmware](https://www.chromium.org/chromium-os/developer-information-for-chrome-os-devices/custom-firmware)
