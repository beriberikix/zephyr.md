---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/tdk/robokit1/doc/index.html
...
[![../../../../_images/tdk_robokit1.jpg](https://docs.zephyrproject.org/4.2.0/_images/tdk_robokit1.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/tdk_robokit1.jpg)
...
| on-chip | Atmel SAM Timer Counter (TC) QDEC mode[4 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/samx7x.dtsi?plain=1#L85) | [`atmel,sam-tc-qdec`](../../../../build/dts/api/bindings/sensor/atmel,sam-tc-qdec.md#std-dtcompatible-atmel-sam-tc-qdec) |
...
The `robokit1` board supports the runners and associated west commands listed below.
