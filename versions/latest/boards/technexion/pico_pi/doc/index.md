---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/technexion/pico_pi/doc/index.html
original_path: boards/technexion/pico_pi/doc/index.html
---
...
[![../../../../_images/pico_pi.jpg](https://docs.zephyrproject.org/4.2.0/_images/pico_pi.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/pico_pi.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/technexion/pico_pi/doc/index.rst/../..)
...
[boards/technexion/pico\_pi/pico\_pi\_mcimx7d\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/technexion/pico_pi/pico_pi_mcimx7d_m4_defconfig)
...
| --- | --- | --- |
| UART\_TX232 | UART1\_TX | UART Console |
| UART\_RX232 | UART1\_RX | UART Console |
| RX\_E | UART6\_TX | UART (mikroBUS and Edison) |
| TX\_E | UART6\_RX | UART (mikroBUS and Edison) |
| I2CX\_SDA\_3V | I2C1\_SDA | I2C (mikroBUS and Edison) |
| I2CX\_SCL\_3V | I2C1\_SCL | I2C (mikroBUS and Edison) |
...
- [i.MX 7 Dual Reference Manual](https://www.nxp.com/webapp/Download?colCode=IMX7DRM) from page 182 (section 2.1.2 and 2.1.3)
...
configuration is done in the file [boards/technexion/pico\_pi/pico\_pi\_mcimx7d\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/technexion/pico_pi/pico_pi_mcimx7d_m4.dts) with
