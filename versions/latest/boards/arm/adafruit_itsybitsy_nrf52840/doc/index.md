---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/adafruit_itsybitsy_nrf52840/doc/index.html
original_path: boards/arm/adafruit_itsybitsy_nrf52840/doc/index.html
---
...
with the [APA102 LED strip](../../../../samples/drivers/led_apa102/README.md#led-apa102 "Control an LED strip using an APA102, Adafruit DotStar, or compatible driver chip.") sample application.

You can build and flash the examples to make sure Zephyr is running correctly on
your board. The button and LED definitions can be found in
[boards/arm/adafruit\_itsybitsy\_nrf52840/adafruit\_itsybitsy\_nrf52840.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/adafruit_itsybitsy_nrf52840/adafruit_itsybitsy_nrf52840.dts).
...
1. Build the Zephyr kernel and the [Blinky](../../../../samples/basic/blinky/README.md#blinky "Blink an LED forever using the GPIO API.")
   ...
   ```shell
   west build -b adafruit_itsybitsy_nrf52840 samples/basic/blinky
   ```
