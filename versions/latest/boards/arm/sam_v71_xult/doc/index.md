---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/arm/sam_v71_xult/doc/index.html
original_path: boards/arm/sam_v71_xult/doc/index.html
---
...
[boards/arm/sam\_v71\_xult/sam\_v71\_xult\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/arm/sam_v71_xult/sam_v71_xult_defconfig).
...
3. To use the SoC variation B IC, you need type “sam\_v71b\_xult”.

   ```shell
   # From the root of the zephyr repository
   west build -b sam_v71b_xult samples/hello_world
   west flash
   ```

   You should see “Hello World! sam\_v71b\_xult” in your terminal.
