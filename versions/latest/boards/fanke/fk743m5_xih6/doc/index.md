---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/fanke/fk743m5_xih6/doc/index.html
original_path: boards/fanke/fk743m5_xih6/doc/index.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/fanke/fk743m5_xih6/doc/index.rst/../..)
...
- [STM32H743XI on www.st.com](https://www.st.com/en/microcontrollers/stm32h743xi.html) [[1]](#id2)

### Supported Features

The `fk743m5_xih6` board supports the hardware features listed below.
...
#### `fk743m5_xih6/stm32h743xx` target
...
| on-board | STM32 QSPI Flash controller supporting the JEDEC CFI interface[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/fanke/fk743m5_xih6/fk743m5_xih6.dts?plain=1#L99) | [`st,stm32-qspi-nor`](../../../../build/dts/api/bindings/flash_controller/st%2Cstm32-qspi-nor.md#std-dtcompatible-st-stm32-qspi-nor) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/fanke/fk743m5_xih6/fk743m5_xih6.dts?plain=1#L22) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
...
| on-board | Fixed partitions of a flash (or other non-volatile storage) memory[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/fanke/fk743m5_xih6/fk743m5_xih6.dts?plain=1#L108) | [`fixed-partitions`](../../../../build/dts/api/bindings/mtd/fixed-partitions.md#std-dtcompatible-fixed-partitions) |
...
The `fk743m5_xih6` board supports the runners and associated west commands listed below.
...
west build -b fk743m5_xih6 samples/hello_world
west flash
```
...
details, please refer to the [Flashing](#flashing) section and run the `west debug` command
...
[https://www.st.com/en/microcontrollers/stm32h743xi.html](https://www.st.com/en/microcontrollers/stm32h743xi.html)
