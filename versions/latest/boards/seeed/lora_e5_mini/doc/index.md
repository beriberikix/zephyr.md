---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/seeed/lora_e5_mini/doc/index.html
...
[![../../../../_images/lora_e5_mini.jpg](https://docs.zephyrproject.org/4.2.0/_images/lora_e5_mini.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/lora_e5_mini.jpg)
...
| SPI | on-chip | STM32 SPI controller with embedded Rx and Tx FIFOs[2 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/st/wl/stm32wl.dtsi?plain=1#L312) | [`st,stm32-spi-fifo`](../../../../build/dts/api/bindings/spi/st,stm32-spi-fifo.md#std-dtcompatible-st-stm32-spi-fifo) |
...
![LoRa-E5 mini Pinout](https://docs.zephyrproject.org/4.2.0/_images/lora_e5_mini_pinout.jpg)
...
The `lora_e5_mini` board supports the runners and associated west commands listed below.
