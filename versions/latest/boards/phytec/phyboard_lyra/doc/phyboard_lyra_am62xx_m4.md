---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/phytec/phyboard_lyra/doc/phyboard_lyra_am62xx_m4.html
original_path: boards/phytec/phyboard_lyra/doc/phyboard_lyra_am62xx_m4.html
---
...
![phyBOARD-Lyra AM62x](https://docs.zephyrproject.org/4.2.0/_images/phyCORE-AM62x_Lyra_frontside.webp)
...
The phyboard\_lyra/am6234/m4 configuration supports the following hardware features:
...
Download PHYTEC’s official [WIC](https://download.phytec.de/Software/Linux/BSP-Yocto-AM62x/BSP-Yocto-Ampliphy-AM62x-PD23.2.1/images/ampliphy-xwayland/phyboard-lyra-am62xx-3/phytec-qt5demo-image-phyboard-lyra-am62xx-3.wic.xz) as well as [BMAP](https://download.phytec.de/Software/Linux/BSP-Yocto-AM62x/BSP-Yocto-Ampliphy-AM62x-PD23.2.1/images/ampliphy-xwayland/phyboard-lyra-am62xx-3/phytec-qt5demo-image-phyboard-lyra-am62xx-3.wic.bmap) and flash the WIC file with
...
[boards/phytec/phyboard\_lyra/phyboard\_lyra\_am6234\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/phytec/phyboard_lyra/phyboard_lyra_am6234_m4_defconfig)
...
To allow the board to boot using the SD card, set the boot pins to the SD Card boot mode. Refer to [phyBOARD SD Card Booting Essentials](https://docs.phytec.com/projects/yocto-phycore-am62x/en/bsp-yocto-ampliphy-am62x-pd23.2.1/bootingessentials/sdcard.html).
