---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/st/nucleo_h503rb/doc/index.html
...
[![../../../../_images/nucleo_h503rb.png](https://docs.zephyrproject.org/4.2.0/_images/nucleo_h503rb.png)
](https://docs.zephyrproject.org/4.2.0/_images/nucleo_h503rb.png)
...
![NUCLEO-H503RB](https://docs.zephyrproject.org/4.2.0/_images/nucleo_h503rb1.png)
...
| Input | on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/st/nucleo_h503rb/nucleo_h503rb.dts?plain=1#L38) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
The `nucleo_h503rb` board supports the runners and associated west commands listed below.
