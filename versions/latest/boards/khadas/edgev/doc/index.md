---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/khadas/edgev/doc/index.html
...
The `khadas_edgev` board supports the runners and associated west commands listed below.
