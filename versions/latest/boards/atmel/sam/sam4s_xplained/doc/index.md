...
| GPIO & Headers | on-chip | SAM GPIO Port[3 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/sam4s.dtsi?plain=1#L169) | [`atmel,sam-gpio`](../../../../../build/dts/api/bindings/gpio/atmel,sam-gpio.md#std-dtcompatible-atmel-sam-gpio) |
...
| Pin control | on-chip | Atmel SAM Pinctrl Container[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/atmel/sam4s.dtsi?plain=1#L162) | [`atmel,sam-pinctrl`](../../../../../build/dts/api/bindings/pinctrl/atmel,sam-pinctrl.md#std-dtcompatible-atmel-sam-pinctrl) |
