---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/boards/mediatek/index.html
original_path: boards/mediatek/index.html
---
...
with intel\_adsp). SRAM is used for interrupt vectors and stacks,
currently.
...
- [Dev-Install: Installing Developer and Test packages onto a Chrome OS device](https://www.chromium.org/chromium-os/developer-library/guides/device/install-software-on-base-images/)
...
with gdb\_stub, which has support on Xtensa and via the SDK debuggers,
