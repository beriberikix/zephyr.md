---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/96boards/aerocore2/doc/index.html
original_path: boards/96boards/aerocore2/doc/index.html
---
...
![96Boards Aerocore2](https://docs.zephyrproject.org/4.2.0/_images/96b_aerocore2.jpg)
...
:   - [STM32F427 on www.st.com](https://www.st.com/en/microcontrollers-microprocessors/stm32f427vi.html)

### Supported Features

The Zephyr 96b\_aerocore2 board configuration supports the following hardware
features:
...
More details about the board can be found at [96Boards website](https://www.96boards.org/product/aerocore2/).

The default configuration can be found in
[boards/96boards/aerocore2/96b\_aerocore2\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/96boards/aerocore2/96b_aerocore2_defconfig)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | PWM4\_CH1 | PD12 | 2 | 5.0v | 3 | GND |
| 4 | PWM4\_CH2 | PD13 | 5 | 5.0v | 6 | GND |
| 7 | PWM4\_CH3 | PD14 | 8 | 5.0v | 9 | GND |
| 10 | PWM4\_CH4 | PD15 | 11 | 5.0v | 12 | GND |
| 13 | PWM5\_CH1 | PA0 | 14 | 5.0v | 15 | GND |
| 16 | PWM5\_CH2 | PA1 | 17 | 5.0v | 18 | GND |
| 19 | PWM5\_CH3 | PA2 | 20 | 5.0v | 21 | GND |
| 22 | PWM5\_CH4 | PA3 | 23 | 5.0v | 24 | GND |
...
| --- | --- | --- | --- | --- | --- |
| 1 | AGND | AGND | 2 | ADC1\_13 | PC3 |
| 3 | ADC1\_12 | PC2 | 4 | ADC1\_11 | PC1 |
| 5 | I2C\_SDA | PB11 | 6 | GND | GND |
| 7 | I2C\_SCL | PB10 | 8 | VCC 3v3 | VCC 3v3 |
| 9 | NC | NC | 10 | NC | NC |
| 11 | NC | NC | 12 | NC | NC |
| 13 | UART\_TX 7 | PE8 | 14 | GND | GND |
| 15 | UART\_RX 7 | PE7 | 16 | GND | GND |
| 17 | UART\_TX 2 | PD5 | 18 | GND | GND |
| 19 | UART\_TX 2 | PD6 | 20 | GND | GND |
| 21 | NC | NC | 10 | NC | NC |
| 23 | NC | NC | 10 | NC | NC |
| 25 | SPI1\_NIRQ | PC5 | 26 | GND | GND |
| 27 | SPI1\_CLK | PA5 | 28 | SPI1\_MISO | PA6 |
| 29 | SPI1\_CS0 | PA4 | 30 | SPI1\_MOSI | PA7 |
| 31 | CAN\_TX | PD1 | 32 | CANH | NC |
| 33 | CAN\_RX | PD0 | 34 | CANL | NC |
...
Connect the micro-USB cable to the USB OTG/STM\_CONSOLE Aerocore2 port and to your computer.
...
Connect a USB-TTL dongle to the UART\_7 header port and to your computer.
...
Replace `<tty_device>` with the port where the board 96Boards Aerocore2
