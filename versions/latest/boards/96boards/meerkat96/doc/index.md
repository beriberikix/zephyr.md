---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/96boards/meerkat96/doc/index.html
original_path: boards/96boards/meerkat96/doc/index.html
---
...
![96Boards Meerkat96](https://docs.zephyrproject.org/4.2.0/_images/96b_meerkat96.jpg)

More information about the board can be found at the
[96Boards website](https://www.96boards.org/product/imx7-96/).
...
- Memory
  ...
  - Internal RAM -> M4: 3x32KB (TCML, TCMU, OCRAM\_S), 1x128KB (OCRAM) and 1x256MB (DDR)
- Display
...
The Zephyr 96b\_meerkat96 board configuration supports the following hardware
features:
...
> [boards/96boards/meerkat96/96b\_meerkat96\_mcimx7d\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/96boards/meerkat96/96b_meerkat96_mcimx7d_m4_defconfig)
...
| --- | --- | --- |
| UART\_1 RXD | UART1\_TXD | UART Console |
| UART\_1 TXD | UART1\_RXD | UART Console |
| LED\_R1 | GPIO1\_IO04 | LED0 |
| LED\_R2 | GPIO1\_IO05 | LED1 |
| LED\_R3 | GPIO1\_IO06 | LED2 |
| LED\_R4 | GPIO1\_IO07 | LED3 |
...
The iMX7D SoC has seven UARTs. UART\_1 is configured for the console and
...
[i.MX 7 Dual Reference Manual](https://www.nxp.com/webapp/Download?colCode=IMX7DRM) (section 2.1.2 and 2.1.3), and the
...
configuration is done in the file [boards/96boards/meerkat96/96b\_meerkat96\_mcimx7d\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/96boards/meerkat96/96b_meerkat96_mcimx7d_m4.dts)
...
[J-Link Tools](https://www.segger.com/downloads/jlink/#J-LinkSoftwareAndDocumentationPack) and [NXP iMX7D Connect CortexM4.JLinkScript](https://wiki.segger.com/images/8/86/NXP_iMX7D_Connect_CortexM4.JLinkScript).
