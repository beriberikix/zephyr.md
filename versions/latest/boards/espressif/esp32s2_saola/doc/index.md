---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/espressif/esp32s2_saola/doc/index.html
original_path: boards/espressif/esp32s2_saola/doc/index.html
---
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/espressif/esp32s2_saola/doc/index.rst/../..)
...
For more information, check [ESP32-S3-DevKitC](https://docs.espressif.com/projects/esp-idf/en/latest/esp32s2/hw-reference/esp32s2/user-guide-saola-1-v1.2.html) [[1]](#id2).
...
The `esp32s2_saola` board supports the hardware features listed below.
...
| on-board | Group of GPIO-bound input keys[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/espressif/esp32s2_saola/esp32s2_saola.dts?plain=1#L33) | [`gpio-keys`](../../../../build/dts/api/bindings/input/gpio-keys.md#std-dtcompatible-gpio-keys) |
...
The `esp32s2_saola` board supports the runners and associated west commands listed below.
