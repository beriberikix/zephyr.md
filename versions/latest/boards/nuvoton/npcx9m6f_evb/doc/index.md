...
| Cryptographic accelerator | on-chip | NPCX Crypto SHA accelerator[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L384) | [`nuvoton,npcx-sha`](../../../../build/dts/api/bindings/crypto/nuvoton%2Cnpcx-sha.md#std-dtcompatible-nuvoton-npcx-sha) |
...
| Reset controller | on-chip | NPCX Reset Controller[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L407) | [`nuvoton,npcx-rst`](../../../../build/dts/api/bindings/reset/nuvoton%2Cnpcx-rst.md#std-dtcompatible-nuvoton-npcx-rst) |
...
| SHI | on-chip | Nuvoton NPCX Serial Host Interface (SHI)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L391) | [`nuvoton,npcx-shi`](../../../../build/dts/api/bindings/shi/nuvoton%2Cnpcx-shi.md#std-dtcompatible-nuvoton-npcx-shi) |
...
| on-chip | Nuvoton NPCX Internal Timer (ITIM)[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/dts/arm/nuvoton/npcx/npcx9.dtsi?plain=1#L93) | [`nuvoton,npcx-itim-timer`](../../../../build/dts/api/bindings/timer/nuvoton%2Cnpcx-itim-timer.md#std-dtcompatible-nuvoton-npcx-itim-timer) |
