---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/boards/posix/native_posix/doc/index.html
original_path: boards/posix/native_posix/doc/index.html
---
...
If you are a new user, you are encouraged to use [native\_sim](../../native_sim/doc/index.md#native-sim) directly.

If you have been using native\_posix you are recommended to start using
[native\_sim](../../native_sim/doc/index.md#native-sim) instead.

If needed, [native\_sim](../../native_sim/doc/index.md#native-sim) includes a compatibility mode
[`CONFIG_NATIVE_SIM_NATIVE_POSIX_COMPAT`](../../../../kconfig.md#CONFIG_NATIVE_SIM_NATIVE_POSIX_COMPAT "CONFIG_NATIVE_SIM_NATIVE_POSIX_COMPAT"),
which will set its configuration to mimic a native\_posix’s like configuration.
