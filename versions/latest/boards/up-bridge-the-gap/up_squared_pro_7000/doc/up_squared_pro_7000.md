---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/up-bridge-the-gap/up_squared_pro_7000/doc/up_squared_pro_7000.html
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/up-bridge-the-gap/up_squared_pro_7000/doc/up_squared_pro_7000.rst/../..)
...
General information about the board can be found at the [UP Squared Pro 7000](https://up-board.org/up-squared-pro-7000/) [[1]](#id1) website.

### Connections and IOs

Refer to the [UP Squared Pro 7000](https://up-board.org/up-squared-pro-7000/) [[1]](#id1) website for more information.

## Programming and Debugging

The `up_squared_pro_7000` board supports the runners and associated west commands listed below.
...
connector `CN14 USB 2.0/UART 1x10P Wafer`. Refer to [User Manual](https://downloads.up-community.org/download/up-squared-pro-7000-user-manual/) [[2]](#id4) for
description of the connector and location on the board.

Refer to [UP Serial Console](https://github.com/up-board/up-community/wiki/Serial-Console) [[3]](#id6) for additional information about serial
connection setup.
