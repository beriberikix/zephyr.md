---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/toradex/colibri_imx7d/doc/index.html
original_path: boards/toradex/colibri_imx7d/doc/index.html
---
...
[![../../../../_images/colibri_imx7d.jpg](https://docs.zephyrproject.org/4.2.0/_images/colibri_imx7d.jpg)
](https://docs.zephyrproject.org/4.2.0/_images/colibri_imx7d.jpg)
...
](https://github.com/zephyrproject-rtos/zephyr/blob/main//boards/toradex/colibri_imx7d/doc/index.rst/../..)
...
- [i.MX 7 Dual Datasheet](https://www.nxp.com/docs/en/data-sheet/IMX7DCEC.pdf)
- [i.MX 7 Dual Reference Manual](https://www.nxp.com/webapp/Download?colCode=IMX7DRM)
- [Colibri iMX7 Website](https://www.toradex.com/computer-on-modules/colibri-arm-family/nxp-freescale-imx7)
- [Colibri iMX7 User Guide](https://developer.toradex.com/products/colibri-imx7)
- [Colibri iMX7 Datasheet](https://docs.toradex.com/103125-colibri-arm-som-imx7-datasheet.pdf)
- [Colibri Evaluation Board Website](https://www.toradex.com/products/carrier-board/colibri-evaluation-carrier-board)
- [Colibri Evaluation Board Datasheet](https://docs.toradex.com/102284-colibri-evaluation-board-datasheet.pdf)
...
> [boards/toradex/colibri\_imx7d/colibri\_imx7d\_mcimx7d\_m4\_defconfig](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/colibri_imx7d/colibri_imx7d_mcimx7d_m4_defconfig)
...
| --- | --- | --- |
| UART\_B RXD | UART2\_TXD | UART Console |
| UART\_B TXD | UART2\_RXD | UART Console |
| SODIMM\_135 | GPIO1\_IO02 | LED0 |
| SODIMM\_133 | GPIO2\_IO26 | SW0 |
| SODIMM\_194 | I2C4\_SDA | I2C\_SDA |
| SODIMM\_196 | I2C4\_SCL | I2C\_SCL |
| SODIMM\_59 | PWM1/GPIO1\_IO08 | PWM |
...
The `colibri_imx7d` board supports the runners and associated west commands listed below.
...
- [i.MX 7 Dual Reference Manual](https://www.nxp.com/webapp/Download?colCode=IMX7DRM) from page 190 (section 2.1.2 and 2.1.3)
...
done in the file [boards/toradex/colibri\_imx7d/colibri\_imx7d\_mcimx7d\_m4.dts](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/toradex/colibri_imx7d/colibri_imx7d_mcimx7d_m4.dts)
with “zephyr,flash” (when CONFIG\_XIP=y) and “zephyr,sram”
...
The IMX7D soc supports the subsys/ipc/openamp\_rsc\_table sample to demonstrate the
usage of rpmsg\_tty as an inter processor communication.

The board configuration is provided for the colibri\_imx7d board.
...
- imx\_rproc
- virtio\_rpmsg\_bus
- rpmsg\_tty (requiring rpmsg\_core)
