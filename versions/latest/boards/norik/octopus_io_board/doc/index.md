---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/boards/norik/octopus_io_board/doc/index.html
...
| Charger | on-board | BQ25180 I2C Controlled, 1-Cell, 1-A Linear Battery Charger with Power Path and Ship Mode[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/norik/octopus_io_board/octopus_io_board_common.dtsi?plain=1#L31) | [`ti,bq25180`](../../../../build/dts/api/bindings/charger/ti,bq25180.md#std-dtcompatible-ti-bq25180) |
...
| LED | on-board | Group of GPIO-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/norik/octopus_io_board/../octopus_som/octopus_som_common.dtsi?plain=1#L17) | [`gpio-leds`](../../../../build/dts/api/bindings/led/gpio-leds.md#std-dtcompatible-gpio-leds) |
| on-board | Group of PWM-controlled LEDs[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/norik/octopus_io_board/../octopus_som/octopus_som_common.dtsi?plain=1#L27) | [`pwm-leds`](../../../../build/dts/api/bindings/led/pwm-leds.md#std-dtcompatible-pwm-leds) |
...
| on-board | The Octopus SoM provides the user 2 options for connecting a SIM card to the nRF9160[1 ](https://github.com/zephyrproject-rtos/zephyr/blob/main/boards/norik/octopus_io_board/../octopus_som/octopus_som_common.dtsi?plain=1#L35) | `norik,sim_select` |
...
The `octopus_io_board` board supports the runners and associated west commands listed below.
