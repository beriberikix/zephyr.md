---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/flashing/configuration.html
original_path: build/flashing/configuration.html
---
...
[west flash](../../develop/west/build-flash-debug.md#west-flashing)) which allows for customising how commands are used when
programming boards. This configuration is used for [Sysbuild (System build)](../sysbuild/index.md#sysbuild) projects and allows for
...
For example, building the [SMP server](../../samples/subsys/mgmt/mcumgr/smp_svr/README.md#smp-svr "Implement a Simple Management Protocol (SMP) server.") sample for the nrf5340dk which will
