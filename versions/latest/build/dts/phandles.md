---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/phandles.html
...
- [`DT_PHA_BY_IDX`](api/api.md#c.DT_PHA_BY_IDX "DT_PHA_BY_IDX")
- [`DT_PHA_BY_NAME`](api/api.md#c.DT_PHA_BY_NAME "DT_PHA_BY_NAME")

This feature and these macros are used internally by numerous hardware-specific
APIs. Here are a few examples:

- [`DT_GPIO_PIN_BY_IDX`](api/api.md#c.DT_GPIO_PIN_BY_IDX "DT_GPIO_PIN_BY_IDX")
- [`DT_PWMS_CHANNEL_BY_IDX`](api/api.md#c.DT_PWMS_CHANNEL_BY_IDX "DT_PWMS_CHANNEL_BY_IDX")
- [`DT_DMAS_CELL_BY_NAME`](api/api.md#c.DT_DMAS_CELL_BY_NAME "DT_DMAS_CELL_BY_NAME")
- [`DT_IO_CHANNELS_INPUT_BY_IDX`](api/api.md#c.DT_IO_CHANNELS_INPUT_BY_IDX "DT_IO_CHANNELS_INPUT_BY_IDX")
- [`DT_CLOCKS_CELL_BY_NAME`](api/api.md#c.DT_CLOCKS_CELL_BY_NAME "DT_CLOCKS_CELL_BY_NAME")
