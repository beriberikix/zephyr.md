---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/zephyr-user-node.html
original_path: build/dts/zephyr-user-node.html
---
...
You can store [phandles](phandles.md#dt-phandles) in `/zephyr,user` if you want to
...
(See [`gpio_dt_spec`](../../hardware/peripherals/gpio.md#c.gpio_dt_spec "gpio_dt_spec"), [`GPIO_DT_SPEC_GET`](../../hardware/peripherals/gpio.md#c.GPIO_DT_SPEC_GET "GPIO_DT_SPEC_GET"), and
[`gpio_pin_configure_dt()`](../../hardware/peripherals/gpio.md#c.gpio_pin_configure_dt "gpio_pin_configure_dt") for details on these APIs.)
