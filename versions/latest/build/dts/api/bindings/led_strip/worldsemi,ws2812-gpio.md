---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/led_strip/worldsemi,ws2812-gpio.html
...
| Name | Type | Details |
| --- | --- | --- |
| `in-gpios` | `phandle-array` | ```text GPIO phandle and specifier for the pin connected to the daisy chain's input pin. Exactly one pin should be given. ```  This property is **required**. |
