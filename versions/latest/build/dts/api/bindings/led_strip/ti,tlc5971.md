---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/led_strip/ti,tlc5971.html
original_path: build/dts/api/bindings/led_strip/ti,tlc5971.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `chain-length` | `int` | ```text The number of RGB LEDs in the daisy-chain. Must be multiple of 4. A single TLC5971 device supports 4 RGB LEDs. ```  This property is **required**. |
| `color-mapping` | `array` | ```text Channel to color mapping (or pixel order). For example a BGR channel to color mapping would be     color-mapping = <LED_COLOR_ID_BLUE                     LED_COLOR_ID_GREEN                     LED_COLOR_ID_RED>; ```  This property is **required**. |
...
may apply to the “ti,tlc5971” compatible.
