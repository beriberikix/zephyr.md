---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/led_strip/worldsemi,ws2812-rpi_pico-pio.html
...
| Name | Type | Details |
| --- | --- | --- |
| `output-pin` | `int` | ```text Select the output pin.  Note: This driver does not configure the output pin. You need to configure the pin with pinctrl that is in the parent node configuration for use by PIO. ```  This property is **required**. |
