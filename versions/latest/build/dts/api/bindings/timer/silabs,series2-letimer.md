---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/silabs,series2-letimer.html
original_path: build/dts/api/bindings/timer/silabs,series2-letimer.html
---
...
```text
Silicon Labs LETIMER (Low Energy Timer)
...
| `clock-div` | `int` | ```text Clock divider for timer ```  Default value: `1`  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128`, `256` |
...
may apply to the “silabs,series2-letimer” compatible.
