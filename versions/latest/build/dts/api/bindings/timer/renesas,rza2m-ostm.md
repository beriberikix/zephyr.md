---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/renesas,rza2m-ostm.html
original_path: build/dts/api/bindings/timer/renesas,rza2m-ostm.html
---
...
[drivers/timer/renesas\_rza2m\_os\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/timer/renesas_rza2m_os_timer.c).

## Description

```text
Renesas RZ/A2M OS timer
```
...
may apply to the “renesas,rza2m-ostm” compatible.
