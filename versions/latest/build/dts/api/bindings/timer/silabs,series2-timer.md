---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/timer/silabs,series2-timer.html
original_path: build/dts/api/bindings/timer/silabs,series2-timer.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `run-in-debug` | `boolean` | ```text Enable to keep timer running in debug mode. ``` |
| `clock-div` | `int` | ```text Clock divider for timer ```  Default value: `1`  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128`, `256`, `512`, `1024` |
| `channels` | `int` | ```text Number of compare/capture channels available ```  This property is **required**. |
| `counter-size` | `int` | ```text Width of the counter in bits ```  This property is **required**.  Legal values: `16`, `32` |
...
may apply to the “silabs,series2-timer” compatible.
