---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/timer/nordic,nrf-grtc.html
original_path: build/dts/api/bindings/timer/nordic,nrf-grtc.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `cc-num` | `int` | ```text Number of capture/compare channels ```  This property is **required**. |
...
may apply to the “nordic,nrf-grtc” compatible.
