---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/debug/arm,armv7m-itm.html
original_path: build/dts/api/bindings/debug/arm,armv7m-itm.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `swo-ref-frequency` | `int` | ```text Reference clock frequency for SWO if different than CPU clock. ``` |
...
may apply to the “arm,armv7m-itm” compatible.
