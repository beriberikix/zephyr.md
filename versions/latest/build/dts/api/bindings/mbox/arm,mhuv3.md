---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mbox/arm,mhuv3.html
original_path: build/dts/api/bindings/mbox/arm,mhuv3.html
---
...
[drivers/mbox/mbox\_mhuv3.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mbox/mbox_mhuv3.c).

## Description

```text
ARM MHUv3 (Message Handling Unit v3)
```
...
may apply to the “arm,mhuv3” compatible.
