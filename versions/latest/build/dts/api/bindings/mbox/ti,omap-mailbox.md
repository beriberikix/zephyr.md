---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mbox/ti,omap-mailbox.html
original_path: build/dts/api/bindings/mbox/ti,omap-mailbox.html
---
...
[drivers/mbox/mbox\_ti\_omap.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mbox/mbox_ti_omap.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `usr-id` | `int` | ```text User ID for processor ```  This property is **required**. |
...
may apply to the “ti,omap-mailbox” compatible.
