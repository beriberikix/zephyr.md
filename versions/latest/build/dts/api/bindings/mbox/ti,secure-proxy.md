---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mbox/ti,secure-proxy.html
original_path: build/dts/api/bindings/mbox/ti,secure-proxy.html
---
...
[drivers/mbox/mbox\_ti\_secproxy.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mbox/mbox_ti_secproxy.c).

## Description

```text
TI Secure Proxy MAILBOX
```
...
may apply to the “ti,secure-proxy” compatible.
