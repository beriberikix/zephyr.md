---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/display/ilitek,ili9488.html
original_path: build/dts/api/bindings/display/ilitek,ili9488.html
---
...
# ilitek,ili9488 (on mipi-dbi bus)
...
| Name | Type | Details |
| --- | --- | --- |
| `frmctr1` | `uint8-array` | ```text Frame rate control (in normal mode / full colors) (FRMCTR1) register value. ```  Default value: `[176, 17]` |
| `disctrl` | `uint8-array` | ```text Display function control (DISCTRL) register value. Note that changing default SS bit value (0) may interfere with display rotation. ```  Default value: `[2, 2, 59]` |
| `pwctrl1` | `uint8-array` | ```text Power control 1 (PWCTRL1) register values. ```  Default value: `[14, 14]` |
| `pwctrl2` | `uint8-array` | ```text Power control 2 (PWCTRL2) register values. ```  Default value: `[67]` |
| `vmctrl` | `uint8-array` | ```text VCOM control (VMCTRL) register values. ```  Default value: `[0, 64, 0, 64]` |
| `pgamctrl` | `uint8-array` | ```text Positive gamma correction (PGAMCTRL) register values. ```  Default value: `[15, 31, 28, 11, 14, 9, 72, 153, 56, 10, 20, 6, 17, 9, 0]` |
| `ngamctrl` | `uint8-array` | ```text Negative gamma correction (NGAMCTRL) register values. ```  Default value: `[15, 54, 46, 9, 10, 4, 70, 102, 55, 6, 16, 4, 36, 32, 0]` |
...
may apply to the “ilitek,ili9488” compatible.
