---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/display/ilitek,ili9806e.html
original_path: build/dts/api/bindings/display/ilitek,ili9806e.html
---

# ilitek,ili9806e-dsi (on mipi-dsi bus)
...
[drivers/display/display\_ili9806e\_dsi.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/display/display_ili9806e_dsi.c).

## Description

```text
ILITEK ILI9806E display controller
```
...
may apply to the “ilitek,ili9806e-dsi” compatible.
