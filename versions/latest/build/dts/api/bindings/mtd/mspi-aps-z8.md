---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mtd/mspi-aps-z8.html
original_path: build/dts/api/bindings/mtd/mspi-aps-z8.html
---

# mspi-aps-z8 (on mspi bus)
...
[drivers/memc/memc\_mspi\_aps\_z8.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/memc/memc_mspi_aps_z8.c).

## Description

```text
AP Memory pSRAM Version Z8 on MSPI bus
```
...
may apply to the “mspi-aps-z8” compatible.
