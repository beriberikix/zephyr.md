---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mtd/jedec,mspi-nor.html
original_path: build/dts/api/bindings/mtd/jedec,mspi-nor.html
---
...
[drivers/flash/flash\_mspi\_nor.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/flash/flash_mspi_nor.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text RESET line. If specified, the flash chip will be reset at initialization. ``` |
| `t-reset-pulse` | `int` | ```text Minimum duration, in nanoseconds, of an active pulse on the RESET line. ``` |
| `t-reset-recovery` | `int` | ```text Minimum time, in nanoseconds, the flash chip needs to recover after reset. ``` |
...
may apply to the “jedec,mspi-nor” compatible.
