---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mtd/renesas,rx-nv-flash.html
original_path: build/dts/api/bindings/mtd/renesas,rx-nv-flash.html
---
...
```text
Flash memory binding of Renesas RX family
```
...
may apply to the “renesas,rx-nv-flash” compatible.
