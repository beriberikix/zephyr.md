---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/firmware/ti,k2g-sci.html
original_path: build/dts/api/bindings/firmware/ti,k2g-sci.html
---
...
[drivers/firmware/tisci/tisci.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/firmware/tisci/tisci.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `ti,host-id` | `int` | ```text Host ID for processor ```  This property is **required**. |
...
may apply to the “ti,k2g-sci” compatible.
