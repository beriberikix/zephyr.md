---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/misc/renesas,ra-elc.html
original_path: build/dts/api/bindings/misc/renesas,ra-elc.html
---
...
[drivers/misc/interconn/renesas\_elc/renesas\_ra\_elc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/misc/interconn/renesas_elc/renesas_ra_elc.c).

## Description

```text
Renesas RA Event Link Controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `#renesas-elc-cells` | `int` | Constant value: `2` |
...
may apply to the “renesas,ra-elc” compatible.
...
- renesas-elc cells: peripheral, event
