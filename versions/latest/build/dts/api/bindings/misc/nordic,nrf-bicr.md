---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/misc/nordic,nrf-bicr.html
original_path: build/dts/api/bindings/misc/nordic,nrf-bicr.html
---
...
```text
Nordic BICR (Board Information Configuration Registers)
```
...
may apply to the “nordic,nrf-bicr” compatible.
