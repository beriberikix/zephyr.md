---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/silabs,timer-pwm.html
original_path: build/dts/api/bindings/pwm/silabs,timer-pwm.html
---
...
[drivers/pwm/pwm\_silabs\_timer.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_silabs_timer.c).

## Description

```text
Silicon Labs TIMER PWM (Pulse Width Modulation)
...
may apply to the “silabs,timer-pwm” compatible.
