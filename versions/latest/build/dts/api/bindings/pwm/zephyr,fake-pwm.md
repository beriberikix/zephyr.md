---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pwm/zephyr,fake-pwm.html
original_path: build/dts/api/bindings/pwm/zephyr,fake-pwm.html
---
...
[drivers/pwm/pwm\_fake.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_fake.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `#pwm-cells` | `int` | ```text Number of items to expect in a PWM - channel of the timer used for PWM - period to set in ns ```  This property is **required**.  Constant value: `2` |
| `frequency` | `int` | ```text Frequency for the underlying timer (in Hz) ``` |
...
may apply to the “zephyr,fake-pwm” compatible.
