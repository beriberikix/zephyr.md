---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/pwm/nxp,ftm-pwm.html
original_path: build/dts/api/bindings/pwm/nxp,ftm-pwm.html
---
...
```text
NXP FlexTimer Module (FTM) PWM controller
```
...
may apply to the “nxp,ftm-pwm” compatible.
