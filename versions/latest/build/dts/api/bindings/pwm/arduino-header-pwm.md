---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/arduino-header-pwm.html
original_path: build/dts/api/bindings/pwm/arduino-header-pwm.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `pwm-map` | `compound` | This property is **required**. |
| `pwm-map-mask` | `array` |  |
| `pwm-map-pass-thru` | `array` |  |
...
may apply to the “arduino-header-pwm” compatible.
