---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pwm/silabs,siwx91x-pwm.html
original_path: build/dts/api/bindings/pwm/silabs,siwx91x-pwm.html
---
...
[drivers/pwm/pwm\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pwm/pwm_silabs_siwx91x.c).
...
| `silabs,ch-prescaler` | `array` | ```text Contains the prescaler values for all the 4 channels ```  This property is **required**.  Legal values: `1`, `2`, `4`, `8`, `16`, `32`, `64` |
| `silabs,pwm-polarity` | `int` | ```text Common PWM polarity for all the channels 0 - Normal polarity 1 - Inverted polarity ```  This property is **required**. |
...
may apply to the “silabs,siwx91x-pwm” compatible.
