---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/renesas,ra-adc.html
original_path: build/dts/api/bindings/adc/renesas,ra-adc.html
---
...
[drivers/adc/adc\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_renesas_ra.c).
...
These property descriptions apply to “renesas,ra-adc”
...
| Name | Type | Details |
| --- | --- | --- |
| `vref-mv` | `int` | ```text ADC reference voltage (Unit:mV) ```  This property is **required**. |
| `channel-count` | `int` | ```text The number of ADC channels ```  This property is **required**. |
| `#io-channel-cells` | `int` | This property is **required**.  Constant value: `1` |
| `channel-available-mask` | `int` | ```text Mask for ADC channels existed in each board ```  This property is **required**. |
| `average-count` | `int` | ```text The conversion count of the average mode The ADC module will take multiple samples of an analog signal and averages them to reduce noise and enhance accuracy ```  Default value: `1`  Legal values: `1`, `2`, `4`, `8`, `16` |
...
may apply to the “renesas,ra-adc” compatible.
