---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,ads124s06.html
original_path: build/dts/api/bindings/adc/ti,ads124s06.html
---

# ti,ads124s06 (on spi bus)
...
```text
Texas Instrument 6 channels 24 bit SPI ADC
```
...
These property descriptions apply to “ti,ads124s06”
...
may apply to the “ti,ads124s06” compatible.
