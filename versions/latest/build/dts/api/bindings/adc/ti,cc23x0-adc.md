---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/ti,cc23x0-adc.html
original_path: build/dts/api/bindings/adc/ti,cc23x0-adc.html
---
...
[drivers/adc/adc\_cc23x0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_cc23x0.c).

## Description

```text
TI CC23X0 16-channel ADC
```
...
These property descriptions apply to “ti,cc23x0-adc”
...
may apply to the “ti,cc23x0-adc” compatible.
...
| `dmas` | `phandle-array` | ```text Optional DMA specifier. The specifier will have a phandle reference to the DMA controller, the channel number, and the peripheral trigger source.  Example for channel 3 with adc0trg trigger source:   dmas = <&dma 3 5>; ``` |
| `dma-names` | `string-array` | ```text Required if the dmas property exists. This should be "dma".  Example:   dma-names = "dma"; ``` |
