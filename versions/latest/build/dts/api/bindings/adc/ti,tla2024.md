---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,tla2024.html
original_path: build/dts/api/bindings/adc/ti,tla2024.html
---

# ti,tla2024 (on i2c bus)
...
[drivers/adc/adc\_tla202x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_tla202x.c).

## Description

```text
Texas Instruments TLA2024 Low-Power 4 CH ADC with PGA
```
...
These property descriptions apply to “ti,tla2024”
...
may apply to the “ti,tla2024” compatible.
