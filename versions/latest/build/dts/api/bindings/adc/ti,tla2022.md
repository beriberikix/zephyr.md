---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/adc/ti,tla2022.html
original_path: build/dts/api/bindings/adc/ti,tla2022.html
---

# ti,tla2022 (on i2c bus)
...
```text
Texas Instruments TLA2022 Low-Power ADC with PGA
```
...
These property descriptions apply to “ti,tla2022”
...
may apply to the “ti,tla2022” compatible.
