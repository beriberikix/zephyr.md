---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/adc/ene,kb106x-adc.html
original_path: build/dts/api/bindings/adc/ene,kb106x-adc.html
---
...
[drivers/adc/adc\_ene\_kb106x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/adc/adc_ene_kb106x.c).

## Description

```text
ENE KB106X ADC controller
```
...
These property descriptions apply to “ene,kb106x-adc”
...
may apply to the “ene,kb106x-adc” compatible.
