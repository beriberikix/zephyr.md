---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/mfd/microchip,sam-flexcom.html
original_path: build/dts/api/bindings/mfd/microchip,sam-flexcom.html
---
...
[drivers/mfd/mfd\_mchp\_sam\_flexcom.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mfd/mfd_mchp_sam_flexcom.c).

## Description

```text
Microchip Flexcom (Flexible Serial Communication Unit)
```
...
| Name | Type | Details |
| --- | --- | --- |
| `mchp,flexcom-mode` | `int` | ```text Initial operating mode for FLEXCOM ``` |
...
may apply to the “microchip,sam-flexcom” compatible.
