---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/spi/cdns,spi.html
original_path: build/dts/api/bindings/spi/cdns,spi.html
---
...
[drivers/spi/spi\_cdns.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_cdns.c).
...
| `clock-frequency-ext` | `int` |  |
| `fifo-width` | `int` | ```text The total fifo width in bits ```  This property is **required**.  Legal values: `8`, `16`, `24`, `32` |
| `rx-fifo-depth` | `int` | ```text The depth of the rx fifo ```  This property is **required**.  Legal values: `8`, `16`, `32`, `64`, `128`, `256` |
| `tx-fifo-depth` | `int` | ```text The depth of the tx fifo ```  This property is **required**.  Legal values: `8`, `16`, `32`, `64`, `128`, `256` |
...
may apply to the “cdns,spi” compatible.
