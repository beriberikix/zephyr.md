---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/spi/renesas,rx-rspi.html
original_path: build/dts/api/bindings/spi/renesas,rx-rspi.html
---
...
[drivers/spi/spi\_renesas\_rx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_renesas_rx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `channel` | `int` | ```text The index of SPI channel ```  This property is **required**. |
| `ssl-assert` | `int` | ```text Slave select to be asserted during transfer operation ```  Legal values: `0`, `1`, `2`, `3` |
...
may apply to the “renesas,rx-rspi” compatible.
