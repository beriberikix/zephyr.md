---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/spi/st,stm32-spi-subghz.html
original_path: build/dts/api/bindings/spi/st,stm32-spi-subghz.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `use-subghzspi-nss` | `boolean` | ```text Control the SUBGHZPI NSS line using the PWR HAL functions. This is for the special purpose SUBGHZSPI interface found in the STM32WL series. ```  This property is **required**. |
...
may apply to the “st,stm32-spi-subghz” compatible.
