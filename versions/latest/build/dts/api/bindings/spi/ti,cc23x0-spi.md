---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/spi/ti,cc23x0-spi.html
original_path: build/dts/api/bindings/spi/ti,cc23x0-spi.html
---
...
[drivers/spi/spi\_cc23x0.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/spi/spi_cc23x0.c).
...
```text
TI SimpleLink CC23x0 SPI controller
```
...
may apply to the “ti,cc23x0-spi” compatible.
...
| `dmas` | `phandle-array` | ```text Optional TX & RX DMA specifiers. Each specifier will have a phandle reference to the DMA controller, the channel number, and the peripheral trigger source.  Example for channels 0/1 with spi0txtrg/spi0rxtrg trigger sources:   dmas = <&dma 0 0>, <&dma 1 1>; ``` |
