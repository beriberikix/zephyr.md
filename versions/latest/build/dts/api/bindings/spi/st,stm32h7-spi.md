---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/spi/st,stm32h7-spi.html
original_path: build/dts/api/bindings/spi/st,stm32h7-spi.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `midi-clock` | `int` | ```text (Master Inter-Data Idleness) minimum clock inserted between two consecutive data frames. ``` |
| `mssi-clock` | `int` | ```text (Master SS Idleness) minimum clock inserted between start and first data transaction. ``` |
| `fifo-enable` | `boolean` | ```text Enable the SPI FIFO usage for performance improvement. ``` |
...
may apply to the “st,stm32h7-spi” compatible.
