---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/nuvoton,numaker-ethernet.html
original_path: build/dts/api/bindings/ethernet/nuvoton,numaker-ethernet.html
---
...
```text
Nuvoton, NuMaker Ethernet controller
```
...
These property descriptions apply to “nuvoton,numaker-ethernet”
...
may apply to the “nuvoton,numaker-ethernet” compatible.
