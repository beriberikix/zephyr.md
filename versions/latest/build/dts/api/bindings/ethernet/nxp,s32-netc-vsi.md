---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/nxp,s32-netc-vsi.html
original_path: build/dts/api/bindings/ethernet/nxp,s32-netc-vsi.html
---
...
```text
NXP S32 NETC Virtual Station Interface (VSI)
```
...
may apply to the “nxp,s32-netc-vsi” compatible.
