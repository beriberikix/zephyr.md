---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/zephyr,cdc-ecm-ethernet.html
original_path: build/dts/api/bindings/ethernet/zephyr,cdc-ecm-ethernet.html
---
...
```text
USB CDC ECM virtual Ethernet controller
```
...
| Name | Type | Details |
| --- | --- | --- |
| `remote-mac-address` | `string` | ```text Remote MAC address of the virtual Ethernet connection. Should not be the same as local-mac-address property. ```  This property is **required**. |
...
may apply to the “zephyr,cdc-ecm-ethernet” compatible.
