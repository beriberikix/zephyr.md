---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/smsc,lan91c111.html
original_path: build/dts/api/bindings/ethernet/smsc,lan91c111.html
---
...
```text
SMSC (now Microchip) LAN91C111 Ethernet controller
```
...
may apply to the “smsc,lan91c111” compatible.
