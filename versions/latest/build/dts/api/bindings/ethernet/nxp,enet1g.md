---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/ethernet/nxp,enet1g.html
...
| Name | Type | Details |
| --- | --- | --- |
| `rdc` | `int` | ```text Set the RDC(Resource Domain Controller) domain permission for this peripheral ``` |
