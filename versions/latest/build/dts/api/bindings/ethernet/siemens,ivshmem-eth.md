---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/ethernet/siemens,ivshmem-eth.html
original_path: build/dts/api/bindings/ethernet/siemens,ivshmem-eth.html
---
...
Vendor: [Siemens AG](../../bindings.md#dt-vendor-siemens)
...
| Name | Type | Details |
| --- | --- | --- |
| `ivshmem-v2` | `phandle` | ```text ivshmem-v2 driver node ```  This property is **required**. |
...
may apply to the “siemens,ivshmem-eth” compatible.
