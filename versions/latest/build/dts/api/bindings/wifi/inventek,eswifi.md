---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/wifi/inventek,eswifi.html
original_path: build/dts/api/bindings/wifi/inventek,eswifi.html
---
...
# inventek,eswifi (on spi bus)

Vendor: [Inventek Systems](../../bindings.md#dt-vendor-inventek)
...
| Name | Type | Details |
| --- | --- | --- |
| `resetn-gpios` | `phandle-array` | This property is **required**. |
| `data-gpios` | `phandle-array` | This property is **required**. |
| `wakeup-gpios` | `phandle-array` |  |
| `boot0-gpios` | `phandle-array` |  |
...
may apply to the “inventek,eswifi” compatible.
