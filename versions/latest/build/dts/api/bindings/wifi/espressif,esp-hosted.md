---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/wifi/espressif,esp-hosted.html
original_path: build/dts/api/bindings/wifi/espressif,esp-hosted.html
---

# espressif,esp-hosted (on spi bus)
...
[drivers/wifi/esp\_hosted](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/wifi/esp_hosted).

## Description

```text
Espressif ESP-Hosted WiFi
```
...
| `dataready-gpios` | `phandle-array` | This property is **required**. |
| `handshake-gpios` | `phandle-array` | This property is **required**. |
...
may apply to the “espressif,esp-hosted” compatible.
