---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/rtc/motorola,mc146818.html
original_path: build/dts/api/bindings/rtc/motorola,mc146818.html
---
...
Vendor: [Motorola, Inc.](../../bindings.md#dt-vendor-motorola)

## Description

```text
Motorola MC146818 compatible Real Timer Clock
```
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Frequency of the input-clock in Hertz (Hz) ```  Default value: `32768`  Legal values: `4194304`, `1048576`, `32768` |
...
may apply to the “motorola,mc146818” compatible.
