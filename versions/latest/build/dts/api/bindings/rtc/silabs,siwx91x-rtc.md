---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/rtc/silabs,siwx91x-rtc.html
original_path: build/dts/api/bindings/rtc/silabs,siwx91x-rtc.html
---
...
[drivers/rtc/rtc\_silabs\_siwx91x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/rtc/rtc_silabs_siwx91x.c).

## Description

```text
Silabs Siwx91x RTC (Real-Time Counter)
```
...
may apply to the “silabs,siwx91x-rtc” compatible.
