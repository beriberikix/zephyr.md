---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/renesas,ra-i2c-sci-b.html
original_path: build/dts/api/bindings/i2c/renesas,ra-i2c-sci-b.html
---
...
[drivers/i2c/i2c\_renesas\_ra\_sci\_b.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_renesas_ra_sci_b.c).
...
```text
Renesas RA SCI-B I2C controller
```
...
| `sda-output-delay` | `int` | ```text SDA Output Delay in nano seconds. ```  Default value: `300` |
| `noise-filter-clock-select` | `int` | ```text Select the on-chip baud rate generator source clock division setting for the digital noise filter. ```  Default value: `1`  Legal values: `1`, `2`, `3`, `4` |
| `bit-rate-modulation` | `boolean` | ```text Enabling bitrate modulation reduces the percent error of the actual bitrate with respect to the requested baud rate. ``` |
...
may apply to the “renesas,ra-i2c-sci-b” compatible.
