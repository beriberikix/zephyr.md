---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/renesas,rz-riic.html
original_path: build/dts/api/bindings/i2c/renesas,rz-riic.html
---
...
[drivers/i2c/i2c\_renesas\_rz\_riic.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_renesas_rz_riic.c).
...
| `rise-time-ns` | `int` | ```text Number of nanoseconds the SCL signal takes to rise; t(r) in the I2C specification. ```  Default value: `120` |
| `fall-time-ns` | `int` | ```text Number of nanoseconds the SCL signal takes to fall; t(f) in the I2C specification. ```  Default value: `120` |
| `duty-cycle-percent` | `int` | Default value: `50` |
| `noise-filter-stages` | `int` | Default value: `1`  Legal values: `1`, `2`, `3`, `4` |
...
may apply to the “renesas,rz-riic” compatible.
