---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/i2c/nordic,nrf-twis.html
original_path: build/dts/api/bindings/i2c/nordic,nrf-twis.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `address-0` | `int` | ```text TWI slave address 0 ``` |
| `address-1` | `int` | ```text TWI slave address 1 ``` |
