---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/i2c/cdns,i2c.html
original_path: build/dts/api/bindings/i2c/cdns,i2c.html
---
...
[drivers/i2c/i2c\_cdns.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/i2c/i2c_cdns.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-frequency` | `int` | ```text Desired I2C bus clock frequency in Hz. ```  This property is **required**. |
| `fifo-depth` | `int` | ```text Size of the data FIFO in bytes. ```  This property is **required**. |
...
may apply to the “cdns,i2c” compatible.
...
| `clocks` | `phandle-array` | ```text Reference Input clock for I2C core. ```  This property is **required**. |
