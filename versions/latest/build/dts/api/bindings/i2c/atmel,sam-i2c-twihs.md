---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/i2c/atmel,sam-i2c-twihs.html
original_path: build/dts/api/bindings/i2c/atmel,sam-i2c-twihs.html
---
...
```text
Atmel SAM Family I2C (TWIHS) node
```
...
may apply to the “atmel,sam-i2c-twihs” compatible.
