---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/wch,20x_30x-afio.html
original_path: build/dts/api/bindings/pinctrl/wch,20x_30x-afio.html
---
...
[drivers/pinctrl/pinctrl\_wch\_20x\_30x\_afio.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_wch_20x_30x_afio.c).

## Description

```text
WCH CH32V20x/30x AFIO
```
...
These property descriptions apply to “wch,20x\_30x-afio”
...
may apply to the “wch,20x\_30x-afio” compatible.
...
| Name | Type | Details |
| --- | --- | --- |
| `slew-rate` | `string` | Default value: `max-speed-2mhz`  Legal values: `'max-speed-10mhz'`, `'max-speed-2mhz'`, `'max-speed-50mhz'` |
| `pinmux` | `array` | ```text An array of pins sharing the same group properties. The pins should be defined using pre-defined macros. ```  This property is **required**. |
