---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/pinctrl/ene,kb106x-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/ene,kb106x-pinctrl.html
---
...
[drivers/pinctrl/pinctrl\_ene\_kb106x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/pinctrl/pinctrl_ene_kb106x.c).
...
These property descriptions apply to “ene,kb106x-pinctrl”
...
may apply to the “ene,kb106x-pinctrl” compatible.
...
| `drive-strength` | `int` | ```text The drive strength controls the maximum driving capabilities.   4 : 4 mA (SoC default)   16: 16 mA ```  Default value: `4`  Legal values: `4`, `16` |
