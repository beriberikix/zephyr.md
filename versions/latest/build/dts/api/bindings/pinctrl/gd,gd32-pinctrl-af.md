---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pinctrl/gd,gd32-pinctrl-af.html
original_path: build/dts/api/bindings/pinctrl/gd,gd32-pinctrl-af.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `slew-rate` | `string` | ```text Set the maximum speed of a pin. This setting effectively limits the slew rate of the output signal. Defaults to "max-speed-2mhz", the SoC default. ```  Default value: `max-speed-2mhz`  Legal values: `'max-speed-2mhz'`, `'max-speed-25mhz'`, `'max-speed-50mhz'`, `'max-speed-200mhz'` |
