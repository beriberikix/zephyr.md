---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/pinctrl/nxp,imx8mp-pinctrl.html
original_path: build/dts/api/bindings/pinctrl/nxp,imx8mp-pinctrl.html
---
...
These property descriptions apply to “nxp,imx8mp-pinctrl”
...
may apply to the “nxp,imx8mp-pinctrl” compatible.
...
| `drive-strength` | `string` | ```text Pin output drive strength. Sets the DSE field in the IOMUXC peripheral. 00 X1- low drive strength 01 X4- high drive strength 10 X2- medium drive strength 11 X6- max drive strength ```  This property is **required**.  Legal values: `'x1'`, `'x4'`, `'x2'`, `'x6'` |
| `slew-rate` | `string` | ```text Select slew rate for pin. Corresponds to SRE field in IOMUXC peripheral 0 SLOW — Slow Frequency Slew Rate 1 FAST — Fast Frequency Slew Rate ```  This property is **required**.  Legal values: `'slow'`, `'fast'` |
