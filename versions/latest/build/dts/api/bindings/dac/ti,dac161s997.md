---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/dac/ti,dac161s997.html
original_path: build/dts/api/bindings/dac/ti,dac161s997.html
---

# ti,dac161s997 (on spi bus)
...
[drivers/dac/dac\_dac161s997.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_dac161s997.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `errb-gpios` | `phandle-array` | ```text DAC error signal output. If set a callback can be set to read what caused the error. ``` |
...
may apply to the “ti,dac161s997” compatible.
