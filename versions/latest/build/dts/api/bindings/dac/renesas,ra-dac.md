---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/dac/renesas,ra-dac.html
original_path: build/dts/api/bindings/dac/renesas,ra-dac.html
---
...
[drivers/dac/dac\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/dac/dac_renesas_ra.c).

## Description

```text
Renesas RA DAC Controller
```
...
may apply to the “renesas,ra-dac” compatible.
