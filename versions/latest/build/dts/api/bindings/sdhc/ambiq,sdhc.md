---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sdhc/ambiq,sdhc.html
original_path: build/dts/api/bindings/sdhc/ambiq,sdhc.html
---
...
[drivers/sdhc/sdhc\_ambiq.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sdhc/sdhc_ambiq.c).
...
| `txdelay` | `int` | ```text SDIO TX delay tap setting. Range 0 - 15. ```  This property is **required**. |
| `rxdelay` | `int` | ```text SDIO RX delay tap setting. Range 0 - 31. ```  This property is **required**. |
...
may apply to the “ambiq,sdio” compatible.
