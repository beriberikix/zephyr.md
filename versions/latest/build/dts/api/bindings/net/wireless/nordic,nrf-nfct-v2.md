---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/net/wireless/nordic,nrf-nfct-v2.html
original_path: build/dts/api/bindings/net/wireless/nordic,nrf-nfct-v2.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `nfct-pins-as-gpios` | `boolean` | ```text When enabled this property will configure pins dedicated to NFCT peripheral as regular GPIOs. If this property is applied in cpuapp then node can be disabled or reserved (because NFCT is by default assigned to cpuapp). If property is applied in cpurad CPU then node must be reserved.  NFC pins in nRF54H series: P2.10 and P2.11 ``` |
...
may apply to the “nordic,nrf-nfct-v2” compatible.
