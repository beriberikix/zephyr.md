---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/adi,max14915-gpio.html
original_path: build/dts/api/bindings/gpio/adi,max14915-gpio.html
---

# adi,max14915-gpio (on spi bus)
...
These property descriptions apply to “adi,max14915-gpio”
...
| Name | Type | Details |
| --- | --- | --- |
| `wd-to` | `int` | ```text Default value according to documentation. Set SPI and SYNCH Watchdog Timeout 0: Disable SPI Watchdog and set SYNCH Watchdog Timeout to 600ms (typ) 1: Set SPI and SYNCH Watchdog Timeout to 200ms (typ) 2: Set SPI and SYNCH Watchdog Timeout to 600ms (typ) 3: Set SPI and SYNCH Watchdog Timeout to 1.2s (typ) ```  Legal values: `0`, `1`, `2`, `3` |
...
may apply to the “adi,max14915-gpio” compatible.
