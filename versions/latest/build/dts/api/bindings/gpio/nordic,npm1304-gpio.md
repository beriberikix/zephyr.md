---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/nordic,npm1304-gpio.html
original_path: build/dts/api/bindings/gpio/nordic,npm1304-gpio.html
---
...
[drivers/gpio/gpio\_npm13xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_npm13xx.c).

## Description

```text
nPM1304 GPIO Controller
```
...
These property descriptions apply to “nordic,npm1304-gpio”
...
may apply to the “nordic,npm1304-gpio” compatible.
