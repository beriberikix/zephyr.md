---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/nxp,pcal6534.html
original_path: build/dts/api/bindings/gpio/nxp,pcal6534.html
---

# nxp,pcal6534 (on i2c bus)
...
```text
NXP PCAL6534 I2C GPIO expander node
```
...
These property descriptions apply to “nxp,pcal6534”
...
may apply to the “nxp,pcal6534” compatible.
