---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/sensry,sy1xx-gpio.html
original_path: build/dts/api/bindings/gpio/sensry,sy1xx-gpio.html
---
...
[drivers/gpio/gpio\_sy1xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_sy1xx.c).

## Description

```text
Sensry SY1XX GPIO PORT node
```
...
These property descriptions apply to “sensry,sy1xx-gpio”
...
| `pad-cfg` | `int` | ```text Offset for gpio pad ctrl registers. ```  This property is **required**. |
...
may apply to the “sensry,sy1xx-gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text Base address for the gpio configuration. ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
