---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/ite,it51xxx-gpio.html
original_path: build/dts/api/bindings/gpio/ite,it51xxx-gpio.html
---
...
[drivers/gpio/gpio\_ite\_it51xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_ite_it51xxx.c).

## Description

```text
This binding gives a base representation of the it51xxx series gpio
```
...
These property descriptions apply to “ite,it51xxx-gpio”
...
may apply to the “ite,it51xxx-gpio” compatible.
