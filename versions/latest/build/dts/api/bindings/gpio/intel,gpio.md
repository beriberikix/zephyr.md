---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/intel,gpio.html
...
| `ngpios` | `int` | ```text Number of pins for this GPIO entry ```  This property is **required**.  Default value: `32` |
| `pin-offset` | `int` | ```text Pin offset of this GPIO entry ```  This property is **required**. |
