---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/renesas,rza2m-gpio.html
original_path: build/dts/api/bindings/gpio/renesas,rza2m-gpio.html
---
...
[drivers/gpio/gpio\_renesas\_rza2m.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_renesas_rza2m.c).

## Description

```text
Renesas RZ/A2M GPIO Controller
```
...
These property descriptions apply to “renesas,rza2m-gpio”
...
may apply to the “renesas,rza2m-gpio” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `reg` | `array` | ```text GPIO port number. RZ/A2M board has a number of ports that are used to calculate correct pin number. ```  This property is **required**.  See [Important properties](../../../intro-syntax-structure.md#dt-important-props) for more information. |
