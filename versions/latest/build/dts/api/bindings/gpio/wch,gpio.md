---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/wch,gpio.html
original_path: build/dts/api/bindings/gpio/wch,gpio.html
---
...
[drivers/gpio/wch\_gpio\_ch32v00x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/wch_gpio_ch32v00x.c).

## Description

```text
WCH CH32V00x General-Purpose Input/Output (GPIO)
```
...
These property descriptions apply to “wch,gpio”
...
may apply to the “wch,gpio” compatible.
