---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/arm,mps3-fpgaio-gpio.html
original_path: build/dts/api/bindings/gpio/arm,mps3-fpgaio-gpio.html
---
...
```text
GPIO controller on ARM MPS3 FPGA
```
...
These property descriptions apply to “arm,mps3-fpgaio-gpio”
...
may apply to the “arm,mps3-fpgaio-gpio” compatible.
