---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/nordic,nrf-gpiote.html
original_path: build/dts/api/bindings/gpio/nordic,nrf-gpiote.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `instance` | `int` | ```text The GPIOTE instance number. GPIOTE instance GPIOTE0 has:    instance = <0>;  And GPIOTE1 has:    instance = <1>; ```  This property is **required**. |
...
may apply to the “nordic,nrf-gpiote” compatible.
