---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/gpio/nxp,lpc-gpio.html
original_path: build/dts/api/bindings/gpio/nxp,lpc-gpio.html
---
...
These property descriptions apply to “nxp,lpc-gpio”
...
| `port` | `int` | ```text The GPIO port this node describes ```  This property is **required**.  Legal values: `0`, `1`, `2`, `3`, `4`, `5`, `6`, `7` |
...
may apply to the “nxp,lpc-gpio” compatible.
