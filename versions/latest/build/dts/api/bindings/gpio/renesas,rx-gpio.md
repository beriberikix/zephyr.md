---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/renesas,rx-gpio.html
original_path: build/dts/api/bindings/gpio/renesas,rx-gpio.html
---
...
[drivers/gpio/gpio\_renesas\_rx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_renesas_rx.c).

## Description

```text
Renesas RX series GPIO
```
...
These property descriptions apply to “renesas,rx-gpio”
...
| `pinmux` | `phandle` | ```text A phandle reference to the device tree node that contains the pinmux port associated with this GPIO controller. ```  This property is **required**. |
...
may apply to the “renesas,rx-gpio” compatible.
