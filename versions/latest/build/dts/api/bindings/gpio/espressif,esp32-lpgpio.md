---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/gpio/espressif,esp32-lpgpio.html
original_path: build/dts/api/bindings/gpio/espressif,esp32-lpgpio.html
---

# espressif,esp32-lpgpio
...
[drivers/gpio/gpio\_esp32\_lp.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/gpio/gpio_esp32_lp.c).

## Description

```text
ESP32 Low Power GPIO controller for LP Core
```
...
These property descriptions apply to “espressif,esp32-lpgpio”
...
may apply to the “espressif,esp32-lpgpio” compatible.
