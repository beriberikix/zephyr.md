---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/gpio/microchip,mcp23s18.html
original_path: build/dts/api/bindings/gpio/microchip,mcp23s18.html
---

# microchip,mcp23s18 (on spi bus)
...
```text
This is a representation of the Microchip MCP23S18 SPI GPIO Expander.
```
...
These property descriptions apply to “microchip,mcp23s18”
...
may apply to the “microchip,mcp23s18” compatible.
