---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/input/realtek,rts5912-kbd.html
original_path: build/dts/api/bindings/input/realtek,rts5912-kbd.html
---
...
[drivers/input/input\_realtek\_rts5912\_kbd.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_realtek_rts5912_kbd.c).

## Description

```text
Realtek RTS5912 keyboard matrix controller
```
...
may apply to the “realtek,rts5912-kbd” compatible.
