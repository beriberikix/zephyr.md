---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/input/ite,it51xxx-kbd.html
original_path: build/dts/api/bindings/input/ite,it51xxx-kbd.html
---
...
[drivers/input/input\_ite\_it51xxx\_kbd.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/input/input_ite_it51xxx_kbd.c).

## Description

```text
ITE it51xxx keyboard matrix controller
```
...
| `kso-ignore-mask` | `int` | ```text Bitmask of KSO signals to ignore, this can be used to instruct the driver to skip KSO signals between 0 and (col-size - 1) that are used as GPIOs. Default to 0 (no signals masked). ``` |
...
may apply to the “ite,it51xxx-kbd” compatible.
