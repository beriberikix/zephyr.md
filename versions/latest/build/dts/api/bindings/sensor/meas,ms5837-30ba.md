---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/meas,ms5837-30ba.html
original_path: build/dts/api/bindings/sensor/meas,ms5837-30ba.html
---

# meas,ms5837-30ba (on i2c bus)

Vendor: [Measurement Specialties](../../bindings.md#dt-vendor-meas)

Note

An implementation of a driver matching this compatible is available in
[drivers/sensor/meas/ms5837/ms5837.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/meas/ms5837/ms5837.c).

## Description

```text
TE Connectivity MS5837-30BA digital pressure sensor
```
...
may apply to the “meas,ms5837-30ba” compatible.
