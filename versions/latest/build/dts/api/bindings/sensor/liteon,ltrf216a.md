---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/liteon,ltrf216a.html
original_path: build/dts/api/bindings/sensor/liteon,ltrf216a.html
---

# liteon,ltrf216a (on i2c bus)
...
[drivers/sensor/liteon/ltrf216a/ltrf216a.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/liteon/ltrf216a/ltrf216a.c).

## Description

```text
LiteOn F216A ambient light sensor
```
...
may apply to the “liteon,ltrf216a” compatible.
