---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/sensor/ti,tmp11x.html
original_path: build/dts/api/bindings/sensor/ti,tmp11x.html
---

# ti,tmp11x (on i2c bus)
...
[drivers/sensor/ti/tmp11x/tmp11x.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/ti/tmp11x/tmp11x.c).

## Description

These nodes are “tmp11x” bus nodes.

```text
Texas Instruments TMP11X temperature sensor
```
...
| Name | Type | Details |
| --- | --- | --- |
| `odr` | `int` | ```text Specify the default temperature output data rate in milliseconds (ms). Default is power-up configuration.  - 0     # TMP11X_DT_ODR_15_5_MS - 0x80  # TMP11X_DT_ODR_125_MS - 0x100 # TMP11X_DT_ODR_250_MS - 0x180 # TMP11X_DT_ODR_500_MS - 0x200 # TMP11X_DT_ODR_1000_MS - 0x280 # TMP11X_DT_ODR_4000_MS - 0x300 # TMP11X_DT_ODR_8000_MS - 0x380 # TMP11X_DT_ODR_16000_MS ```  Default value: `512`  Legal values: `0`, `128`, `256`, `384`, `512`, `640`, `768`, `896` |
| `oversampling` | `int` | ```text Set number of sample to averaging in one readout. Default is power-up configuration (8 samples).  - 0    # TMP11X_DT_OVERSAMPLING_1 - 0x20 # TMP11X_DT_OVERSAMPLING_8 - 0x40 # TMP11X_DT_OVERSAMPLING_32 - 0x60 # TMP11X_DT_OVERSAMPLING_64 ```  Default value: `32`  Legal values: `0`, `32`, `64`, `96` |
...
may apply to the “ti,tmp11x” compatible.
