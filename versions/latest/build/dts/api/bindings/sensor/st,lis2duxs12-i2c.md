---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/sensor/st,lis2duxs12-i2c.html
...
| `power-mode` | `int` | ```text Specify the sensor power mode. Default is power-down mode  - 0 # LIS2DUX12_OPER_MODE_POWER_DOWN - 1 # LIS2DUX12_OPER_MODE_LOW_POWER - 2 # LIS2DUX12_OPER_MODE_HIGH_RESOLUTION - 3 # LIS2DUX12_OPER_MODE_HIGH_FREQUENCY ```  Legal values: `0`, `1`, `2`, `3` |
