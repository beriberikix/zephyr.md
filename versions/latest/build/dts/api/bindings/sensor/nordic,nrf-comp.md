---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/nordic,nrf-comp.html
original_path: build/dts/api/bindings/sensor/nordic,nrf-comp.html
---
...
```text
Nordic nRF family COMP (Comparator)
```
