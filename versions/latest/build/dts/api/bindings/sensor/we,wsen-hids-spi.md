---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/sensor/we,wsen-hids-spi.html
original_path: build/dts/api/bindings/sensor/we,wsen-hids-spi.html
---
...
| `odr` | `string` | ```text Sensor output data rate expressed in samples per second. Data rates supported by the chip are "1", "7" and "12.5". ```  This property is **required**.  Legal values: `'1'`, `'7'`, `'12.5'` |
...
may apply to the “we,wsen-hids” compatible.
