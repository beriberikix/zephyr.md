---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/watchdog/atmel,sam4l-watchdog.html
original_path: build/dts/api/bindings/watchdog/atmel,sam4l-watchdog.html
---
...
[drivers/watchdog/wdt\_sam4l.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/watchdog/wdt_sam4l.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `clk-source` | `string` | ```text Watchdog counter clock source:   - rcsys:  115kHz internal System RC oscillator   - osc32k: 32kHz clock source Defaults to "rcsys" (hardware reset value) and always enabled source ```  Default value: `rcsys`  Legal values: `'rcsys'`, `'osc32k'` |
| `lock-mode` | `boolean` | ```text Lock the watchdog when setup is executed. This provides a write protection to the control register. This mechanism can only be released when a hardware reset happens. ``` |
...
may apply to the “atmel,sam4l-watchdog” compatible.
