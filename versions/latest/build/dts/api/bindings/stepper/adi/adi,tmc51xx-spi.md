---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/stepper/adi/adi,tmc51xx-spi.html
original_path: build/dts/api/bindings/stepper/adi/adi,tmc51xx-spi.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `diag0-gpios` | `phandle-array` | ```text Diagnostics output DIAG0 pin. This pin enables interrupt-based rampstat handling, allowing the driver to respond to motor events like position reached or stall detection without polling. Should be configured as push-pull output (active high). ``` |
