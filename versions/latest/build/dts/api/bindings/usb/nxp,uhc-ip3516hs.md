---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/usb/nxp,uhc-ip3516hs.html
original_path: build/dts/api/bindings/usb/nxp,uhc-ip3516hs.html
---
...
[drivers/usb/uhc/uhc\_mcux\_ip3516hs.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/usb/uhc/uhc_mcux_ip3516hs.c).
...
```text
NXP IP3516HS USB host controller
```
...
may apply to the “nxp,uhc-ip3516hs” compatible.
