---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/usb/ite,it82xx2-usb.html
original_path: build/dts/api/bindings/usb/ite,it82xx2-usb.html
---
...
| `wucctrl` | `phandles` | ```text usbd node WUC interrupt. ``` |
...
may apply to the “ite,it82xx2-usb” compatible.
