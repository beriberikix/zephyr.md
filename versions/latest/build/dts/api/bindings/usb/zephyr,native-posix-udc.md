---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/usb/zephyr,native-posix-udc.html
original_path: build/dts/api/bindings/usb/zephyr,native-posix-udc.html
---
...
```text
Native POSIX USB device controller
```
...
may apply to the “zephyr,native-posix-udc” compatible.
