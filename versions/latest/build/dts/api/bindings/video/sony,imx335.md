---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/video/sony,imx335.html
original_path: build/dts/api/bindings/video/sony,imx335.html
---

# sony,imx335 (on i2c bus)

Vendor: [Sony Corporation](../../bindings.md#dt-vendor-sony)

Note

An implementation of a driver matching this compatible is available in
[drivers/video/imx335.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/video/imx335.c).

## Description

```text
IMX335 CMOS Solid-state Color Image Sensor
```
...
These property descriptions apply to “sony,imx335”
...
| Name | Type | Details |
| --- | --- | --- |
| `reset-gpios` | `phandle-array` | ```text The XCLR pin is asserted to cause a hard reset. The sensor receives this as an active-low signal. ``` |
...
may apply to the “sony,imx335” compatible.

| Name | Type | Details |
| --- | --- | --- |
| `clocks` | `phandle-array` | ```text Reference Input clock ```  This property is **required**. |
