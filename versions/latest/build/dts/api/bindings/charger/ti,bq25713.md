---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/charger/ti,bq25713.html
original_path: build/dts/api/bindings/charger/ti,bq25713.html
---

# ti,bq25713 (on i2c bus)
...
[drivers/charger/charger\_bq25713.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/charger/charger_bq25713.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `constant-charge-current-max-microamp` | `int` | ```text The charge current target for the constant current phase of the charge profile. This value will be set at initialization time. Range: 0 mA to 8.128 A. The value specified will be rounded down to the closest implemented value. ```  This property is **required**. |
| `constant-charge-voltage-max-microvolt` | `int` | ```text The voltage regulation target for the constant voltage phase of the battery charging profile. This value will be set at initialization time. Range: 4.2 V 1S to 16.8 V 4S. The value specified will be rounded down to the closest implemented value. ```  This property is **required**. |
| `system-voltage-min-threshold-microvolt` | `int` | ```text Minimum system voltage. Voltage that will be set above when the system voltage drops this level. This value will be set at initialization time. Range: 1.024 V to 16.128 V. The value specified will be rounded down to the closest implemented value. ```  This property is **required**. |
...
may apply to the “ti,bq25713” compatible.
