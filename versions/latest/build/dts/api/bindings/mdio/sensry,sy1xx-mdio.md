---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mdio/sensry,sy1xx-mdio.html
original_path: build/dts/api/bindings/mdio/sensry,sy1xx-mdio.html
---

# sensry,sy1xx-mdio

Vendor: [sensry.io](../../bindings.md#dt-vendor-sensry)

Note

An implementation of a driver matching this compatible is available in
[drivers/mdio/mdio\_sy1xx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_sy1xx.c).
...
may apply to the “sensry,sy1xx-mdio” compatible.
