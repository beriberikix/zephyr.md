---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/mdio/renesas,ra-mdio.html
original_path: build/dts/api/bindings/mdio/renesas,ra-mdio.html
---
...
[drivers/mdio/mdio\_renesas\_ra.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/mdio/mdio_renesas_ra.c).
...
```text
Renesas RA External MDIO controller
```
...
may apply to the “renesas,ra-mdio” compatible.
