---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/audio/ti,pcm1681xx-spi.html
original_path: build/dts/api/bindings/audio/ti,pcm1681xx-spi.html
---

# ti,pcm1681 (on spi bus)
...
[drivers/audio/pcm1681.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/audio/pcm1681.c).

## Description

```text
Texas Instruments PCM1681 and PCM1681-Q1 Audio DAC on SPI bus
```
...
may apply to the “ti,pcm1681” compatible.
