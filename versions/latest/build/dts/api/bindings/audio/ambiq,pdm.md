---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/audio/ambiq,pdm.html
original_path: build/dts/api/bindings/audio/ambiq,pdm.html
---
...
[drivers/audio/dmic\_ambiq\_pdm.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/audio/dmic_ambiq_pdm.c).
...
| `pdm-buffer-location` | `string` | ```text Define PDM DMA buffer location section ``` |
| `pdm-buffer-size` | `int` | ```text Define the PDM DMA buffer size in (4-byte) words ``` |
...
may apply to the “ambiq,pdm” compatible.
