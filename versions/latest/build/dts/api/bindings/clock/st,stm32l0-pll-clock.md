---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32l0-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32l0-pll-clock.html
---
...
| `div` | `int` | ```text PLL output division ```  This property is **required**.  Legal values: `2`, `3`, `4` |
| `mul` | `int` | ```text PLL multiplication factor for VCO The PLL VCO clock frequency must not exceed: - 96 MHz when the product is in Range 1 - 48 MHz when the product is in Range 2 - 24 MHz when the product is in Range 3 If the USB uses the PLL as clock source, the PLL VCO clock must be programmed to output a 96 MHz frequency (USBCLK = PLLVCO/2). ```  This property is **required**.  Legal values: `3`, `4`, `6`, `8`, `12`, `16`, `24`, `32`, `48` |
...
may apply to the “st,stm32l0-pll-clock” compatible.
