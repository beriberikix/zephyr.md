---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32f7-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32f7-pll-clock.html
---
...
| `mul-n` | `int` | ```text PLL multiplication factor for VCO Valid range: 50 - 432 ```  This property is **required**. |
