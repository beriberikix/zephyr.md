---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/st,stm32n6-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32n6-pll-clock.html
---
...
| `div-m` | `int` | ```text Prescaler for PLLx input clock Valid range: 1 - 63 ```  This property is **required**. |
| `mul-n` | `int` | ```text PLLx multiplication factor for VCO Valid range: 16 - 2500 ```  This property is **required**. |
| `div-p1` | `int` | ```text PLLx DIVP1 division factor Valid range: 1 - 7 ``` |
| `div-p2` | `int` | ```text PLLx DIVP2 division factor Valid range: 1 - 7 ``` |
...
may apply to the “st,stm32n6-pll-clock” compatible.
