---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/renesas,rz-cpg.html
original_path: build/dts/api/bindings/clock/renesas,rz-cpg.html
---
...
[drivers/clock\_control/clock\_control\_renesas\_rz\_cpg.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/clock_control/clock_control_renesas_rz_cpg.c).

## Description

```text
RZ Clock Pulse Generator
```
...
may apply to the “renesas,rz-cpg” compatible.
