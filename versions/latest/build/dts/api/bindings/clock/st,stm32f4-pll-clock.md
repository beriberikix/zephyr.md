---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32f4-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32f4-pll-clock.html
---
...
| `div-m` | `int` | ```text Division factor for the PLL input clock Valid range: 2 - 63 ```  This property is **required**. |
| `mul-n` | `int` | ```text Main PLL multiplication factor for VCO Valid range: 50 - 432 ```  This property is **required**. |
| `div-p` | `int` | ```text Main PLL division factor for PLLSAI2CLK ```  This property is **required**.  Legal values: `2`, `4`, `6`, `8` |
| `div-q` | `int` | ```text Main PLL (PLL) division factor for USB OTG FS, SDMMC and random number generator clocks. Valid range: 2 - 15 ``` |
| `div-r` | `int` | ```text Main PLL (PLL) division factor for I2S and DFSDM generator clocks. Valid range: 2 - 7 ``` |
