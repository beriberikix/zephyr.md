---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32l4-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32l4-pll-clock.html
---
...
| `div-m` | `int` | ```text Division factor for the main PLL and audio PLLs (PLLSAI1 and PLLSAI2) input clock Valid range: 1 - 8 ```  This property is **required**. |
| `mul-n` | `int` | ```text Main PLL multiplication factor for VCO Valid range: 8 - 86 ```  This property is **required**. |
| `div-p` | `int` | ```text Main PLL division factor for PLLSAI3CLK ```  Legal values: `7`, `17` |
