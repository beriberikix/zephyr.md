---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/st,stm32mp2-rcc.html
original_path: build/dts/api/bindings/clock/st,stm32mp2-rcc.html
---
...
may apply to the “st,stm32mp2-rcc” compatible.
