---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32wba-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32wba-pll-clock.html
---
...
| `div-m` | `int` | ```text Prescaler for PLLx input clock Valid range: 1 - 8 ```  This property is **required**. |
...
| `div-r` | `int` | ```text PLLx DIVR division factor Valid range: 1 - 128 ```  This property is **required**. |
...
may apply to the “st,stm32wba-pll-clock” compatible.
