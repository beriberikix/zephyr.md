---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/build/dts/api/bindings/clock/raspberrypi,pico-xosc.html
...
| Name | Type | Details |
| --- | --- | --- |
| `startup-delay-multiplier` | `int` | ```text Startup delay multiplier. The default value matches the Pico SDK. ```  Default value: `1` |
