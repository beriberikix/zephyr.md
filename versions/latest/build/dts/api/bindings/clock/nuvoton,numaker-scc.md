---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/nuvoton,numaker-scc.html
...
| `hirc48` | `string` | ```text Enable/disable 48 MHz high-speed internal RC oscillator (HIRC48) ```  Legal values: `'untouched'`, `'enable'`, `'disable'` |
