---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/clock/st,stm32g0-pll-clock.html
original_path: build/dts/api/bindings/clock/st,stm32g0-pll-clock.html
---
...
| `div-m` | `int` | ```text Division factor for PLL input clock Valid range: 1 - 8 ```  This property is **required**. |
| `mul-n` | `int` | ```text Main PLL multiplication factor for VCO Valid range: 8 - 86 ```  This property is **required**. |
| `div-p` | `int` | ```text PLL division factor for PLL P output Valid range: 2 - 32 ``` |
| `div-q` | `int` | ```text PLL division factor for PLL Q output Valid range: 2 - 8 ``` |
| `div-r` | `int` | ```text PLL division factor for PLLCLK (system clock) Valid range: 2 - 8 ```  This property is **required**. |
...
may apply to the “st,stm32g0-pll-clock” compatible.
