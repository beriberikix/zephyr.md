---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/clock/nordic,nrf54l-lfxo.html
original_path: build/dts/api/bindings/clock/nordic,nrf54l-lfxo.html
---
...
```text
Nordic nRF low-frequency crystal oscillator (nRF54L series)
```
...
may apply to the “nordic,nrf54l-lfxo” compatible.
