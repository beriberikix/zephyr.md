---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/nordic,vpr.html
original_path: build/dts/api/bindings/cpu/nordic,vpr.html
---
...
```text
Nordic Semiconductor RISC-V VPR CPU
```
...
| Name | Type | Details |
| --- | --- | --- |
| `nordic,bus-width` | `int` | ```text Bus width of the CPU. ```  This property is **required**.  Legal values: `32`, `64` |
...
may apply to the “nordic,vpr” compatible.
