---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/sifive,e24.html
original_path: build/dts/api/bindings/cpu/sifive,e24.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `hardware-exec-breakpoint-count` | `int` | ```text Number of hardware break points ``` |
...
may apply to the “sifive,e24” compatible.
