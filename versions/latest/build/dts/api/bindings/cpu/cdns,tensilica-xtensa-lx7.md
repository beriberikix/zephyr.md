---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/cdns,tensilica-xtensa-lx7.html
original_path: build/dts/api/bindings/cpu/cdns,tensilica-xtensa-lx7.html
---
...
```text
Cadence Tensilica Xtensa LX7 CPU
```
...
| Name | Type | Details |
| --- | --- | --- |
| `clock-source` | `int` | ```text cpu clock source ``` |
...
may apply to the “cdns,tensilica-xtensa-lx7” compatible.
