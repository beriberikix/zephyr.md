---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/zephyr,native-posix-cpu.html
original_path: build/dts/api/bindings/cpu/zephyr,native-posix-cpu.html
---
...
```text
A representation for native_posix CPU.
```
...
may apply to the “zephyr,native-posix-cpu” compatible.
