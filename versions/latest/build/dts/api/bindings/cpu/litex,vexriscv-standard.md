---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/litex,vexriscv-standard.html
original_path: build/dts/api/bindings/cpu/litex,vexriscv-standard.html
---
...
```text
VexRiscv core with the standard configuration as used by LiteX
```
...
may apply to the “litex,vexriscv-standard” compatible.
