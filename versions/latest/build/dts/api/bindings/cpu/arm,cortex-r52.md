---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/cpu/arm,cortex-r52.html
original_path: build/dts/api/bindings/cpu/arm,cortex-r52.html
---
...
```text
This is a representation of ARM Cortex-R52 CPU.
```
...
may apply to the “arm,cortex-r52” compatible.
