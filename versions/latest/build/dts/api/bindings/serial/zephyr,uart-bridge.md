---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/zephyr,uart-bridge.html
original_path: build/dts/api/bindings/serial/zephyr,uart-bridge.html
---
...
[drivers/serial/uart\_bridge.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_bridge.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `peers` | `phandles` | ```text Peer device nodes, must contain two phandles ``` |
...
may apply to the “zephyr,uart-bridge” compatible.
