---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/serial/silabs,gecko-usart.html
original_path: build/dts/api/bindings/serial/silabs,gecko-usart.html
---
...
| `location-rts` | `array` | ```text RTS pin configuration defined as <location port pin> ``` |
| `location-cts` | `array` | ```text CTS pin configuration defined as <location port pin> ``` |
...
may apply to the “silabs,gecko-usart” compatible.
