---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rx-uart-sci-qemu.html
original_path: build/dts/api/bindings/serial/renesas,rx-uart-sci-qemu.html
---
...
[drivers/serial/uart\_renesas\_rx\_sci\_qemu.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_rx_sci_qemu.c).
...
```text
Renesas RX SCI QEMU controller
```
...
may apply to the “renesas,rx-uart-sci-qemu” compatible.
