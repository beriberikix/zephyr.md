---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/aesc,uart.html
original_path: build/dts/api/bindings/serial/aesc,uart.html
---

# aesc,uart

Vendor: [Aesc Silicon](../../bindings.md#dt-vendor-aesc)

Note

An implementation of a driver matching this compatible is available in
[drivers/serial/uart\_aesc.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_aesc.c).
...
may apply to the “aesc,uart” compatible.
