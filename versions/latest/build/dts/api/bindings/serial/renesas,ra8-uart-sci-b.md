---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/build/dts/api/bindings/serial/renesas,ra8-uart-sci-b.html
...
| `tx-dtc` | `boolean` | ```text Enable dtc support for transmit ``` |
| `rx-dtc` | `boolean` | ```text Enable dtc support for receive ``` |
