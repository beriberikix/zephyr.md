---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/ite,it51xxx-uart.html
original_path: build/dts/api/bindings/serial/ite,it51xxx-uart.html
---
...
[drivers/serial/uart\_ite\_it51xxx.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_ite_it51xxx.c).
...
| Name | Type | Details |
| --- | --- | --- |
| `wucctrl` | `phandles` | ```text WUC groups internal and external inputs, and asserts wake-up signals to INTC that allows the CPU to exit a Doze/Deep Doze/Sleep mode. ``` |
...
may apply to the “ite,it51xxx-uart” compatible.
