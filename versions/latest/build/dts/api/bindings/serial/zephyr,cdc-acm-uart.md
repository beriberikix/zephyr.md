---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/serial/zephyr,cdc-acm-uart.html
original_path: build/dts/api/bindings/serial/zephyr,cdc-acm-uart.html
---
...
| Name | Type | Details |
| --- | --- | --- |
| `tx-fifo-size` | `int` | ```text Size of the virtual CDC ACM UART TX FIFO ```  Default value: `1024` |
| `rx-fifo-size` | `int` | ```text Size of the virtual CDC ACM UART RX FIFO ```  Default value: `1024` |
...
may apply to the “zephyr,cdc-acm-uart” compatible.
