---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/build/dts/api/bindings/serial/renesas,rza2m-scif-uart.html
original_path: build/dts/api/bindings/serial/renesas,rza2m-scif-uart.html
---
...
[drivers/serial/uart\_renesas\_rza2m\_scif.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/serial/uart_renesas_rza2m_scif.c).
...
may apply to the “renesas,rza2m-scif-uart” compatible.
...
| `clocks` | `phandle-array` | ```text Clock source for calculating BRR value ``` |
