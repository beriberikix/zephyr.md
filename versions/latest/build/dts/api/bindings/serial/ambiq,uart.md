---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/api/bindings/serial/ambiq,uart.html
original_path: build/dts/api/bindings/serial/ambiq,uart.html
---
...
```text
Ambiq UART controller (PL011 compatible)
```
...
may apply to the “ambiq,uart” compatible.
