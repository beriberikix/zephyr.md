---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/build/dts/troubleshooting.html
...
`<build>/zephyr/include/generated/devicetree_generated.h`. For example, if
...
[Hello World](../../samples/hello_world/README.md#hello-world) with west with this option set, use:
...
For example, to build [Hello World](../../samples/hello_world/README.md#hello-world) with west and this option disabled,
use:
...
If you’re using an API like [`DT_INST_PROP()`](api/api.md#c.DT_INST_PROP "DT_INST_PROP"), you must define
