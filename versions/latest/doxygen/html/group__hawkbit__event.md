---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__hawkbit__event.html
...
`#include <[zephyr/mgmt/hawkbit/event.h](event_8h.md)>`
...
| HAWKBIT\_EVENT\_CONFIRMED\_CURRENT\_IMAGE | Event triggered during initialisation when the current image is confirmed and the old image is erased. |
