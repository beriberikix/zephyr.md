---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/structnet__mgmt__event__callback.html
...
| union { |  |
| [net\_mgmt\_event\_handler\_t](group__net__mgmt.md#ga2e83a5a769ac52c846f255e23aea84d2)   [handler](#ada57aabc8acc3e9be93fb2726321f1b2) |  |
|  | Actual callback function being used to notify the owner. [More...](#ada57aabc8acc3e9be93fb2726321f1b2) |
| struct [k\_sem](structk__sem.md) \*   [sync\_call](#a7403d98fe528c492a4b1b449b43c10d3) |  |
|  | Semaphore meant to be used internally for the synchronous [net\_mgmt\_event\_wait()](group__net__mgmt.md#ga7137c77c55ee2609941c88db79e22d1a "Used to wait synchronously on an event mask.") function. [More...](#a7403d98fe528c492a4b1b449b43c10d3) |
| }; |  |
| union { |  |
| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1)   [event\_mask](#a99e3174c1052488877b3db6349de61e8) |  |
|  | A mask of network events on which the above handler should be called in case those events come. [More...](#a99e3174c1052488877b3db6349de61e8) |
| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1)   [raised\_event](#a555d868d6a0d6ecb04d09607fab06b79) |  |
|  | Internal place holder when a synchronous event wait is successfully unlocked on a event. [More...](#a555d868d6a0d6ecb04d09607fab06b79) |
| }; |  |
...
## [◆ ](#a99e3174c1052488877b3db6349de61e8)event\_mask

| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) net\_mgmt\_event\_callback::event\_mask |
| --- |
...
| [net\_mgmt\_event\_handler\_t](group__net__mgmt.md#ga2e83a5a769ac52c846f255e23aea84d2) net\_mgmt\_event\_callback::handler |
| --- |
...
## [◆ ](#a555d868d6a0d6ecb04d09607fab06b79)raised\_event

| [uint64\_t](stdint_8h.md#a2095b9bffea4b2656950c6c0419edbf1) net\_mgmt\_event\_callback::raised\_event |
| --- |
...
| struct [k\_sem](structk__sem.md)\* net\_mgmt\_event\_callback::sync\_call |
| --- |

Semaphore meant to be used internally for the synchronous [net\_mgmt\_event\_wait()](group__net__mgmt.md#ga7137c77c55ee2609941c88db79e22d1a "Used to wait synchronously on an event mask.") function.
