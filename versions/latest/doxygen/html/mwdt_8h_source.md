---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/mwdt_8h_source.html
...
121#ifdef CONFIG\_NATIVE\_BUILD
...
127#ifndef \_\_fallthrough

128#define \_\_fallthrough \_\_attribute\_\_((fallthrough))

129#endif

130

131#define TOOLCHAIN\_HAS\_C\_GENERIC 1

132#define TOOLCHAIN\_HAS\_C\_AUTO\_TYPE 1

133

134#include <[zephyr/toolchain/gcc.h](include_2zephyr_2toolchain_2gcc_8h.md)>

135

136#undef BUILD\_ASSERT

137#if defined(\_\_cplusplus) && (\_\_cplusplus >= 201103L)

138#define BUILD\_ASSERT(EXPR, MSG...) static\_assert(EXPR, "" MSG)

139#elif defined(\_\_cplusplus)

140/\* For cpp98 \*/

141#define BUILD\_ASSERT(EXPR, MSG...)

142#else

143#define BUILD\_ASSERT(EXPR, MSG...) \_Static\_assert((EXPR), "" MSG)

144#endif

145

146#define \_\_builtin\_arc\_nop() \_nop()
...
151#endif /\* ZEPHYR\_INCLUDE\_TOOLCHAIN\_MWDT\_H\_ \*/
