---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/clock__control_8h_source.html
...
131 if (api->[on](structclock__control__driver__api.md#a3b267856bdde2be0e679a9d1b16b3b4f) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {

132 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

133 }

134

135 return api->[on](structclock__control__driver__api.md#a3b267856bdde2be0e679a9d1b16b3b4f)(dev, sys);

136}

137

[ 148](group__clock__control__interface.md#gadbebc1c12937be561b761ef4a3b7d8a5)static inline int [clock\_control\_off](group__clock__control__interface.md#gadbebc1c12937be561b761ef4a3b7d8a5)(const struct [device](structdevice.md) \*dev,

149 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys)

150{

151 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

152 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

153

154 if (api->[off](structclock__control__driver__api.md#a92385c0e0c7bbf8fe955ad2281b7ccc3) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {

155 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

156 }

157

158 return api->[off](structclock__control__driver__api.md#a92385c0e0c7bbf8fe955ad2281b7ccc3)(dev, sys);

159}

160

[ 178](group__clock__control__interface.md#ga03cedb9723e001d01c495f0abb6acfdf)static inline int [clock\_control\_async\_on](group__clock__control__interface.md#ga03cedb9723e001d01c495f0abb6acfdf)(const struct [device](structdevice.md) \*dev,

179 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys,

180 [clock\_control\_cb\_t](group__clock__control__interface.md#ga17257fb3864dc5a33082c3422ad7c275) cb,

181 void \*user\_data)

182{

183 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

184 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

185

186 if (api->[async\_on](structclock__control__driver__api.md#a9a4a9a2ed1f0b80e48ee0f50469c72dc) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {
...
190 return api->[async\_on](structclock__control__driver__api.md#a9a4a9a2ed1f0b80e48ee0f50469c72dc)(dev, sys, cb, user\_data);

191}

192

[ 201](group__clock__control__interface.md#ga35be64d09222f44aa00cd1371a39613e)static inline enum [clock\_control\_status](group__clock__control__interface.md#gad12829335f0c954ab6d586549db45e09) [clock\_control\_get\_status](group__clock__control__interface.md#ga35be64d09222f44aa00cd1371a39613e)(const struct [device](structdevice.md) \*dev,

202 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys)

203{

204 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

205 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

206

207 if (!api->[get\_status](structclock__control__driver__api.md#a64461593304fad858b6d8f8292ef62f9)) {

208 return [CLOCK\_CONTROL\_STATUS\_UNKNOWN](group__clock__control__interface.md#ggad12829335f0c954ab6d586549db45e09a4c939e7c8c38b5f2c50fe339a60c75cc);

209 }

210

211 return api->[get\_status](structclock__control__driver__api.md#a64461593304fad858b6d8f8292ef62f9)(dev, sys);

212}

213

[ 226](group__clock__control__interface.md#ga00f6af6d2668c2dfff0640fe176e89ff)static inline int [clock\_control\_get\_rate](group__clock__control__interface.md#ga00f6af6d2668c2dfff0640fe176e89ff)(const struct [device](structdevice.md) \*dev,

227 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys,

228 [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*rate)

229{

230 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

231 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

232

233 if (api->[get\_rate](structclock__control__driver__api.md#ab19c4aa8f48dfa33e8bce3189ea3c332) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {

234 return -[ENOSYS](group__system__errno.md#ga43785b9969e0bd1af532dbde06c5540b);

235 }

236

237 return api->[get\_rate](structclock__control__driver__api.md#ab19c4aa8f48dfa33e8bce3189ea3c332)(dev, sys, rate);

238}

239

[ 256](group__clock__control__interface.md#ga3bd25314e8bfcc62f0728d89321bb614)static inline int [clock\_control\_set\_rate](group__clock__control__interface.md#ga3bd25314e8bfcc62f0728d89321bb614)(const struct [device](structdevice.md) \*dev,

257 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys,

258 [clock\_control\_subsys\_rate\_t](group__clock__control__interface.md#ga05d8b476ef0331e1502702921d2801f1) rate)

259{

260 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

261 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

262

263 if (api->[set\_rate](structclock__control__driver__api.md#a15e5eb98d0684a0afdb51f46d4e3fb5c) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {
...
267 return api->[set\_rate](structclock__control__driver__api.md#a15e5eb98d0684a0afdb51f46d4e3fb5c)(dev, sys, rate);

268}

269

[ 292](group__clock__control__interface.md#gaf5e4b13798955fcc891c080b9967ab06)static inline int [clock\_control\_configure](group__clock__control__interface.md#gaf5e4b13798955fcc891c080b9967ab06)(const struct [device](structdevice.md) \*dev,

293 [clock\_control\_subsys\_t](group__clock__control__interface.md#gaa7d3935eaaf18902801a7d94859483db) sys,

294 void \*data)

295{

296 const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*api =

297 (const struct [clock\_control\_driver\_api](structclock__control__driver__api.md) \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

298

299 if (api->[configure](structclock__control__driver__api.md#adfe1458a9b6fcca1c052ddfae1d311b3) == [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)) {
...
303 return api->[configure](structclock__control__driver__api.md#adfe1458a9b6fcca1c052ddfae1d311b3)(dev, sys, data);
...
314#endif /\* ZEPHYR\_INCLUDE\_DRIVERS\_CLOCK\_CONTROL\_H\_ \*/
...
**Definition** clock\_control.h:226
...
**Definition** clock\_control.h:178
...
**Definition** clock\_control.h:201
...
**Definition** clock\_control.h:256
...
**Definition** clock\_control.h:148
...
**Definition** clock\_control.h:292
