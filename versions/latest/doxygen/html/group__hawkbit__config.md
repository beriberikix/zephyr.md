---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__hawkbit__config.html
...
| static int | [hawkbit\_set\_server\_domain](#ga2c6aa606a003b34538b521fda77af903) (char \*domain\_str) |
...
| static char \* | [hawkbit\_get\_server\_domain](#gafd9f30b2acab65c34bcb5edaa3da8738) (void) |
...
`#include <[zephyr/mgmt/hawkbit/config.h](config_8h.md)>`
...
## [◆ ](#gafd9f30b2acab65c34bcb5edaa3da8738)hawkbit\_get\_server\_domain()

| | char \* hawkbit\_get\_server\_domain | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga2c6aa606a003b34538b521fda77af903)hawkbit\_set\_server\_domain()

| | int hawkbit\_set\_server\_domain | ( | char \* | *domain\_str* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Parameters
:   | domain\_str | Server hostname to set. |
    | --- | --- |

Return values
:   | 0 | on success. |
    | --- | --- |
    | -EINVAL | if string length mismatch for server\_domain |
    | -EAGAIN | if probe is currently running. |
