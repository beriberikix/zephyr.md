---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__net__context.html
...
|  | Note that we do not store the actual source IP address in the context because the address is already be set in the network interface struct. [More...](structnet__context.md#details) |
...
| #define | [NET\_CONTEXT\_STATE\_SHIFT](#gacd1592ed32c7de5ecdeb69f569cb701f)   1 |
| #define | [NET\_CONTEXT\_STATE\_MASK](#gac63c02e444e17b268c230ba15c7c4339)   0x03 |
...
| Enumerations | |
| --- | --- |
| enum | [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) {     [NET\_CONTEXT\_IDLE](#gga62753cf9e6218d37e65f8b461bf8c8dda1997d732e8a49fd42895917afe160de2) = 0 , [NET\_CONTEXT\_UNCONNECTED](#gga62753cf9e6218d37e65f8b461bf8c8dda8d946fd7f7895cce804bf617313a2c40) = 0 , [NET\_CONTEXT\_CONFIGURING](#gga62753cf9e6218d37e65f8b461bf8c8ddaaa50d60ab4b2aa7db248402c522fd3f6) = 1 , [NET\_CONTEXT\_CONNECTING](#gga62753cf9e6218d37e65f8b461bf8c8dda26bdeef9794c4051446339bb38a6999e) = 1 ,     [NET\_CONTEXT\_READY](#gga62753cf9e6218d37e65f8b461bf8c8dda69163a1ec7757a0307b326bdc3e2697b) = 2 , [NET\_CONTEXT\_CONNECTED](#gga62753cf9e6218d37e65f8b461bf8c8dda18b286eb1d9a61595b70f76eead211e7) = 2 , [NET\_CONTEXT\_LISTENING](#gga62753cf9e6218d37e65f8b461bf8c8ddab77dbc57d8c05b742bc28f01793179a9) = 3   } |
|  | State of the context (bits 1 & 2 in the flags). [More...](#ga62753cf9e6218d37e65f8b461bf8c8dd) |
...
| static enum [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) | [net\_context\_get\_state](#ga53bd5f35a142f1d43f90d3bde99778e0) (struct [net\_context](structnet__context.md) \*context) |
|  | Get state for this network context. |
| static void | [net\_context\_set\_state](#gaac934209341db606a4d563b3c48cce45) (struct [net\_context](structnet__context.md) \*context, enum [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) [state](parser__state_8h.md#adc6e5733fc3c22f0a7b2914188c49c90)) |
...
## [◆ ](#gac63c02e444e17b268c230ba15c7c4339)NET\_CONTEXT\_STATE\_MASK

| #define NET\_CONTEXT\_STATE\_MASK   0x03 |
| --- |

`#include <[net_context.h](net__context_8h.md)>`

## [◆ ](#gacd1592ed32c7de5ecdeb69f569cb701f)NET\_CONTEXT\_STATE\_SHIFT

| #define NET\_CONTEXT\_STATE\_SHIFT   1 |
| --- |
...
## [◆ ](#ga62753cf9e6218d37e65f8b461bf8c8dd)net\_context\_state

| enum [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) |
| --- |
...
| | enum [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) net\_context\_get\_state | ( | struct [net\_context](structnet__context.md) \* | *context* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | context | The network context to use. |
    | --- | --- |
    | [msghdr](structmsghdr.md) | The data to send |
...
| | void net\_context\_set\_state | ( | struct [net\_context](structnet__context.md) \* | *context*, | | --- | --- | --- | --- | |  |  | enum [net\_context\_state](#ga62753cf9e6218d37e65f8b461bf8c8dd) | *state* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
