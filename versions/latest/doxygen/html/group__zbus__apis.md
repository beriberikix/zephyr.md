---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__zbus__apis.html
...
| int | [zbus\_obs\_set\_enable](#ga6b44a887c82cbceff3136bbd9e0aa91c) (struct [zbus\_observer](structzbus__observer.md) \*obs, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enabled) |
|  | Change the observer state. |
| static int | [zbus\_obs\_is\_enabled](#ga9d1f5e1aecd8bd521d916944cece2b95) (struct [zbus\_observer](structzbus__observer.md) \*obs, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \*enable) |
...
STRUCT\_SECTION\_ITERABLE([zbus\_observer](structzbus__observer.md), \_name) = { \
...
sizeof(const struct [zbus\_channel](structzbus__channel.md) \*), \

\_queue\_size, sizeof(const struct [zbus\_channel](structzbus__channel.md) \*) \
...
## [◆ ](#ga9d1f5e1aecd8bd521d916944cece2b95)zbus\_obs\_is\_enabled()

| | int zbus\_obs\_is\_enabled | ( | struct [zbus\_observer](structzbus__observer.md) \* | *obs*, | | --- | --- | --- | --- | |  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \* | *enable* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga6b44a887c82cbceff3136bbd9e0aa91c)zbus\_obs\_set\_enable()

| int zbus\_obs\_set\_enable | ( | struct [zbus\_observer](structzbus__observer.md) \* | *obs*, |
| --- | --- | --- | --- |
