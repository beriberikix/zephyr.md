---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/log__core_8h_source.html
...
[ 19](log__core_8h.md#a43dece650f96e7cf2a4e535c9bd4804a)#define LOG\_LEVEL\_NONE 0U

[ 20](log__core_8h.md#ab3a03740685cbdaa375e2bde8247fdc6)#define LOG\_LEVEL\_ERR 1U

[ 21](log__core_8h.md#a54f5db1327d9fdbaecbb03a6969de97b)#define LOG\_LEVEL\_WRN 2U

[ 22](log__core_8h.md#a281bc2ce5315e6fae369796c0fdf5c1d)#define LOG\_LEVEL\_INF 3U

[ 23](log__core_8h.md#ad1f7d41b1af28ba81ea63d24c9b690cc)#define LOG\_LEVEL\_DBG 4U
...
[ 30](log__core_8h.md#ac618493585bc226f18f36b6a2ad7e8d5)#define CONFIG\_LOG\_DEFAULT\_LEVEL 0U

[ 31](log__core_8h.md#a97df309d4ec6704223193647b6faf819)#define CONFIG\_LOG\_MAX\_LEVEL 0U
...
[ 100](log__core_8h.md#a85c70bfd98bbc66a35806010a206237e)#define LOG\_CURRENT\_MODULE\_ID() (\_\_log\_level != 0 ? \
...
178 case [LOG\_LEVEL\_ERR](log__core_8h.md#ab3a03740685cbdaa375e2bde8247fdc6):

179 return 'E';

180 case [LOG\_LEVEL\_WRN](log__core_8h.md#a54f5db1327d9fdbaecbb03a6969de97b):

181 return 'W';

182 case [LOG\_LEVEL\_INF](log__core_8h.md#a281bc2ce5315e6fae369796c0fdf5c1d):

183 return 'I';

184 case [LOG\_LEVEL\_DBG](log__core_8h.md#ad1f7d41b1af28ba81ea63d24c9b690cc):
...
200#ifdef CONFIG\_LOG\_FMT\_STRING\_VALIDATE
...
[ 213](log__core_8h.md#a6d29de8e144ab8e57f42f096b0b47ca0)#define LOG\_POINTERS\_VALIDATE(string\_ok, ...) string\_ok = true

[ 214](log__core_8h.md#ad9fb171d1afec420ff46f6e0e4b0481d)#define LOG\_STRING\_WARNING(\_mode, \_src, ...)
...
254 if (IS\_ENABLED(CONFIG\_LOG\_RUNTIME\_FILTERING) && \
...
338 if (IS\_ENABLED(CONFIG\_LOG\_RUNTIME\_FILTERING) && \
...
[ 373](log__core_8h.md#a84474b9b8e31f5ee7040f7e22021c163)#define LOG\_LEVEL\_BITS 3U

374

[ 376](log__core_8h.md#a31c9e4a93ba2527b3bce4e5461dd65dd)#define LOG\_FILTER\_SLOT\_SIZE LOG\_LEVEL\_BITS

377

[ 379](log__core_8h.md#ad7a2f00a0b9d7961f6f246b828ec8c63)#define LOG\_FILTERS\_NUM\_OF\_SLOTS (32 / LOG\_FILTER\_SLOT\_SIZE)

380

[ 382](log__core_8h.md#a6258cbdcc73befb83fb5e5b5efd29d65)#define LOG\_FILTERS\_MAX\_BACKENDS \

383 (LOG\_FILTERS\_NUM\_OF\_SLOTS - (1 + IS\_ENABLED(CONFIG\_LOG\_FRONTEND)))

384

[ 386](log__core_8h.md#ad3865db594c20dff3d20e02b954d7a51)#define LOG\_FRONTEND\_SLOT\_ID (LOG\_FILTERS\_NUM\_OF\_SLOTS - 1)

387

[ 389](log__core_8h.md#a6d1b6a2b8ac28915ac085d430a952a15)#define LOG\_FILTER\_SLOT\_MASK (BIT(LOG\_FILTER\_SLOT\_SIZE) - 1U)

390

[ 395](log__core_8h.md#a5a21fea47b27e76f7382cf4cf687b4b3)#define LOG\_FILTER\_SLOT\_SHIFT(\_id) (LOG\_FILTER\_SLOT\_SIZE \* (\_id))

396

[ 397](log__core_8h.md#a91e38e2a6e541df4bb8dbb741e393e0e)#define LOG\_FILTER\_SLOT\_GET(\_filters, \_id) \

398 ((\*(\_filters) >> LOG\_FILTER\_SLOT\_SHIFT(\_id)) & LOG\_FILTER\_SLOT\_MASK)

399

[ 400](log__core_8h.md#aa95cdf72ca0084ef4deed1cf698192d6)#define LOG\_FILTER\_SLOT\_SET(\_filters, \_id, \_filter) \
...
[ 408](log__core_8h.md#a3a875fb65e4f17a0b2d5cbc493084e34)#define LOG\_FILTER\_AGGR\_SLOT\_IDX 0

409

[ 410](log__core_8h.md#a4f4120cb018e563dea7005b10d5a6dc8)#define LOG\_FILTER\_AGGR\_SLOT\_GET(\_filters) \

411 LOG\_FILTER\_SLOT\_GET(\_filters, LOG\_FILTER\_AGGR\_SLOT\_IDX)

412

[ 413](log__core_8h.md#ab0f4745bf6824181306e2f71b3c9612e)#define LOG\_FILTER\_FIRST\_BACKEND\_SLOT\_IDX 1
...
[ 425](log__core_8h.md#a8be8b78ac80e9dd6bc8b9d3639942d33)#define LOG\_LEVEL\_INTERNAL\_RAW\_STRING LOG\_LEVEL\_NONE

426

[ 427](log__core_8h.md#a8bddbf82fcd014a2b65b53d80312237d)[TYPE\_SECTION\_START\_EXTERN](group__iterable__section__apis.md#ga40c6ba05d5bcb848a530bdc17bbff5be)(struct [log\_source\_const\_data](structlog__source__const__data.md), log\_const);

[ 428](log__core_8h.md#a9c76801a0e4d03e64c025f7cd5695d77)[TYPE\_SECTION\_END\_EXTERN](group__iterable__section__apis.md#gaf009fe4b90f7b338c3bf85bb4cd682e5)(struct [log\_source\_const\_data](structlog__source__const__data.md), log\_const);
...
[ 464](log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_const\_source\_id](log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)(
...
[ 471](log__core_8h.md#aab9e9896eac3c3008df9f191e2dc46eb)[TYPE\_SECTION\_START\_EXTERN](group__iterable__section__apis.md#ga40c6ba05d5bcb848a530bdc17bbff5be)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md), log\_dynamic);

[ 472](log__core_8h.md#aa42f7911fae598d4b602b336cdf269b1)[TYPE\_SECTION\_END\_EXTERN](group__iterable__section__apis.md#gaf009fe4b90f7b338c3bf85bb4cd682e5)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md), log\_dynamic);

473

[ 478](log__core_8h.md#a86c2e55bace38c6e71b4d1d0736b1160)#define LOG\_ITEM\_DYNAMIC\_DATA(\_name) UTIL\_CAT(log\_dynamic\_, \_name)

479

[ 480](log__core_8h.md#a322351c9b30bf3328821c6358ddc6a0b)#define LOG\_INSTANCE\_DYNAMIC\_DATA(\_module\_name, \_inst) \

481 LOG\_ITEM\_DYNAMIC\_DATA(Z\_LOG\_INSTANCE\_FULL\_NAME(\_module\_name, \_inst))

482

[ 490](log__core_8h.md#ab2e628ee35c240d79a5e622fa1209008)static inline [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) [log\_dynamic\_source\_id](log__core_8h.md#ab2e628ee35c240d79a5e622fa1209008)(struct [log\_source\_dynamic\_data](structlog__source__dynamic__data.md) \*data)
...
[ 512](log__core_8h.md#ab81a1401935513819384b85948e3d09c)static inline void [log\_generic](log__core_8h.md#ab81a1401935513819384b85948e3d09c)([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level, const char \*fmt, va\_list ap)
