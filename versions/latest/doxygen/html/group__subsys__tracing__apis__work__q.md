---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__subsys__tracing__apis__work__q.html
...
| #define | [sys\_port\_trace\_k\_work\_queue\_stop\_enter](#ga97f548366e687d22af6db208c754e6f8)(queue, timeout) |
|  | Trace stop of a Work Queue call entry. |
| #define | [sys\_port\_trace\_k\_work\_queue\_stop\_blocking](#gaf6c1bf6d59104b7382d0938cc2247b54)(queue, timeout) |
|  | Trace stop of a Work Queue call blocking. |
| #define | [sys\_port\_trace\_k\_work\_queue\_stop\_exit](#ga3200afa981681bdd5b51c0aaecd04620)(queue, timeout, ret) |
...
## [◆ ](#gaf6c1bf6d59104b7382d0938cc2247b54)sys\_port\_trace\_k\_work\_queue\_stop\_blocking

| #define sys\_port\_trace\_k\_work\_queue\_stop\_blocking | ( |  | *queue*, |
| --- | --- | --- | --- |
|  |  |  | *timeout* ) |
...
## [◆ ](#ga97f548366e687d22af6db208c754e6f8)sys\_port\_trace\_k\_work\_queue\_stop\_enter

| #define sys\_port\_trace\_k\_work\_queue\_stop\_enter | ( |  | *queue*, |
| --- | --- | --- | --- |
|  |  |  | *timeout* ) |
...
## [◆ ](#ga3200afa981681bdd5b51c0aaecd04620)sys\_port\_trace\_k\_work\_queue\_stop\_exit

| #define sys\_port\_trace\_k\_work\_queue\_stop\_exit | ( |  | *queue*, |
| --- | --- | --- | --- |
|  |  |  | *timeout*, |
|  |  |  | *ret* ) |
