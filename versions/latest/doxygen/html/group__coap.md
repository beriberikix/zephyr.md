---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__coap.html
...
| Macros | |
| --- | --- |
| #define | [COAP\_REQUEST\_MASK](#gad61166d12586d72e44c6e53a1064032a)   0x07 |
| #define | [COAP\_VERSION\_1](#ga1c4e268d39446075243c2713bc68aa0c)   1U |
...
| #define | [COAP\_CODE\_EMPTY](#ga61fe5f43b386a3cd5ceb5b15280bfdca)   (0) |
| #define | [COAP\_TOKEN\_MAX\_LEN](#ga69fbb7a145ce60fc4f3765c590e4808c)   8UL |
| #define | [GET\_BLOCK\_NUM](#ga54bed49d5081d423d0600bb84dd44a75)(v) |
| #define | [GET\_BLOCK\_SIZE](#gaf8f67659f780c91f04eac97e8eb59fdd)(v) |
| #define | [GET\_MORE](#ga8bfd808b8828458887383f50833d80ed)(v) |
| #define | [COAP\_WELL\_KNOWN\_CORE\_PATH](#ga09d2c727fc6fc76aa9d908b759a3f40b)   ((const char \* const[]) { ".well-known", "core", NULL }) |
...
| int | [coap\_get\_block1\_option](#ga796c9fcf9f447ccf7def2da091e7e5f5) (const struct [coap\_packet](structcoap__packet.md) \*cpkt, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \*has\_more, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*block\_number) |
|  | Get the block size, more flag and block number from the CoAP block1 option. |
| int | [coap\_get\_block2\_option](#ga161875609f4a1ce5806625f97cd90a39) (const struct [coap\_packet](structcoap__packet.md) \*cpkt, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*block\_number) |
...
## [◆ ](#ga61fe5f43b386a3cd5ceb5b15280bfdca)COAP\_CODE\_EMPTY

| #define COAP\_CODE\_EMPTY   (0) |
| --- |
...
## [◆ ](#gad61166d12586d72e44c6e53a1064032a)COAP\_REQUEST\_MASK

| #define COAP\_REQUEST\_MASK   0x07 |
| --- |

`#include <[coap.h](coap_8h.md)>`

## [◆ ](#ga69fbb7a145ce60fc4f3765c590e4808c)COAP\_TOKEN\_MAX\_LEN

| #define COAP\_TOKEN\_MAX\_LEN   8UL |
| --- |

`#include <[coap.h](coap_8h.md)>`

## [◆ ](#ga1c4e268d39446075243c2713bc68aa0c)COAP\_VERSION\_1

| #define COAP\_VERSION\_1   1U |
| --- |
...
| #define COAP\_WELL\_KNOWN\_CORE\_PATH   ((const char \* const[]) { ".well-known", "core", NULL }) |
| --- |
...
## [◆ ](#ga54bed49d5081d423d0600bb84dd44a75)GET\_BLOCK\_NUM

| #define GET\_BLOCK\_NUM | ( |  | *v* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaf8f67659f780c91f04eac97e8eb59fdd)GET\_BLOCK\_SIZE

| #define GET\_BLOCK\_SIZE | ( |  | *v* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga8bfd808b8828458887383f50833d80ed)GET\_MORE
...
## [◆ ](#ga796c9fcf9f447ccf7def2da091e7e5f5)coap\_get\_block1\_option()
...
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \* | *block\_number* ) |
...
## [◆ ](#ga161875609f4a1ce5806625f97cd90a39)coap\_get\_block2\_option()
