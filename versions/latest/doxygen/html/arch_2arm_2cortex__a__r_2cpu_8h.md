---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/arch_2arm_2cortex__a__r_2cpu_8h.html
original_path: doxygen/html/arch_2arm_2cortex__a__r_2cpu_8h.html
---
...
[Go to the source code of this file.](arch_2arm_2cortex__a__r_2cpu_8h_source.md)
...
| #define | [E\_BIT](#a9368e9f279fd5b52f0ef708d907e0fa2)   (1 << 9) |
...
| #define | [IMP\_CSCTLR\_DFLW\_SHIFT](#a8b6221317453ee3cadc252a82f4ae1dd)   (0) |
| #define | [IMP\_CSCTLR\_IFLW\_SHIFT](#aaf30b48b6f17e6c2da1f0b6f48cec2e5)   (8) |
| #define | [IMP\_CSCTLR](#a17e136d37b4c2b724f634ef6516bc79a)(iway, dway) |
...
| #define | [MPIDR\_AFFLVL\_MASK](#a9bce40a5c0fceea5298a899b174c3e1c)   (0xffffff) |
...
## [◆ ](#a9368e9f279fd5b52f0ef708d907e0fa2)E\_BIT
...
## [◆ ](#a17e136d37b4c2b724f634ef6516bc79a)IMP\_CSCTLR

| #define IMP\_CSCTLR | ( |  | *iway*, |
| --- | --- | --- | --- |
|  |  |  | *dway* ) |

**Value:**

((iway << [IMP\_CSCTLR\_IFLW\_SHIFT](#aaf30b48b6f17e6c2da1f0b6f48cec2e5)) | \

((dway << [IMP\_CSCTLR\_DFLW\_SHIFT](#a8b6221317453ee3cadc252a82f4ae1dd))))

[IMP\_CSCTLR\_DFLW\_SHIFT](#a8b6221317453ee3cadc252a82f4ae1dd)

#define IMP\_CSCTLR\_DFLW\_SHIFT

**Definition** cpu.h:60

[IMP\_CSCTLR\_IFLW\_SHIFT](#aaf30b48b6f17e6c2da1f0b6f48cec2e5)

#define IMP\_CSCTLR\_IFLW\_SHIFT

**Definition** cpu.h:61

## [◆ ](#a8b6221317453ee3cadc252a82f4ae1dd)IMP\_CSCTLR\_DFLW\_SHIFT

| #define IMP\_CSCTLR\_DFLW\_SHIFT   (0) |
| --- |

## [◆ ](#aaf30b48b6f17e6c2da1f0b6f48cec2e5)IMP\_CSCTLR\_IFLW\_SHIFT

| #define IMP\_CSCTLR\_IFLW\_SHIFT   (8) |
| --- |
...
| #define MPIDR\_AFFLVL\_MASK   (0xffffff) |
| --- |
