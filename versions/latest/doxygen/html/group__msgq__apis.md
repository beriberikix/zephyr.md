---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__msgq__apis.html
...
| | int k\_msgq\_get | ( | struct [k\_msgq](structk__msgq.md) \* | *msgq*, | | --- | --- | --- | --- | |  |  | void \* | *data*, | |  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_msgq\_peek | ( | struct [k\_msgq](structk__msgq.md) \* | *msgq*, | | --- | --- | --- | --- | |  |  | void \* | *data* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_msgq\_peek\_at | ( | struct [k\_msgq](structk__msgq.md) \* | *msgq*, | | --- | --- | --- | --- | |  |  | void \* | *data*, | |  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *idx* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_msgq\_put | ( | struct [k\_msgq](structk__msgq.md) \* | *msgq*, | | --- | --- | --- | --- | |  |  | const void \* | *data*, | |  |  | [k\_timeout\_t](structk__timeout__t.md) | *timeout* ) | | isr-ok |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
:   | msgq | Address of the message queue. |
    ...
    | timeout | Waiting period to add the message, or one of the special values K\_NO\_WAIT and K\_FOREVER. |
