---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__bap__unicast__client.html
...
| int | [bt\_bap\_unicast\_client\_register\_cb](#gae598c65d7c5d419ee941d7cf33601a64) (const struct [bt\_bap\_unicast\_client\_cb](structbt__bap__unicast__client__cb.md) \*cb) |
...
## [◆ ](#gae598c65d7c5d419ee941d7cf33601a64)bt\_bap\_unicast\_client\_register\_cb()

| int bt\_bap\_unicast\_client\_register\_cb | ( | const struct [bt\_bap\_unicast\_client\_cb](structbt__bap__unicast__client__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Create a new audio unicast group with one or more audio streams as a unicast client. Streams in a unicast group shall share the same interval, framing and latency (see [bt\_audio\_codec\_qos](structbt__audio__codec__qos.md "bt_audio_codec_qos")).
