---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/pinctrl-rzg2-common_8h.html
original_path: doxygen/html/pinctrl-rzg2-common_8h.html
---
...
pinctrl-rzg2-common.h File Reference

[Go to the source code of this file.](pinctrl-rzg2-common_8h_source.md)
...
| #define | [PORT\_19](#a0c1b97684b0bbb0326a187117bcf78ae)   0x1300 /\* IO port 19 \*/ |
| #define | [PORT\_20](#a87d7fd3777b47baab0317a96ee874842)   0x1400 /\* IO port 20 \*/ |
| #define | [PORT\_21](#acc227be3abe2efbeed63891d0e4ad3db)   0x1500 /\* IO port 21 \*/ |
| #define | [PORT\_22](#aefb67b06965dd6320a246fc0529917ad)   0x1600 /\* IO port 22 \*/ |
| #define | [PORT\_23](#a1d7f17a633496267b4d19fc8fa89dbb5)   0x1700 /\* IO port 23 \*/ |
| #define | [PORT\_24](#affbf09e2b0a16edd6b6201909ee99394)   0x1800 /\* IO port 24 \*/ |
| #define | [PORT\_25](#a8294aaccee0f492317c516e0650aa3ae)   0x1900 /\* IO port 25 \*/ |
| #define | [PORT\_26](#ae05ca0fe949f27b5a7fb9ab591236eb5)   0x1A00 /\* IO port 26 \*/ |
| #define | [PORT\_27](#a75bd2e1d9ec1ca727e1bff3089817a0f)   0x1B00 /\* IO port 27 \*/ |
| #define | [PORT\_28](#aa57eff6bf891ecc8486ebcd1213291a7)   0x1C00 /\* IO port 28 \*/ |
| #define | [PORT\_29](#a657ec3a12bd94f98baf3b7f7636e335b)   0x1D00 /\* IO port 29 \*/ |
| #define | [PORT\_30](#a5d994c54f5e3a93a713eb1af0c775dda)   0x1E00 /\* IO port 30 \*/ |
| #define | [PORT\_31](#a634e9ea57181bc83b3be1c2473e8df13)   0x1F00 /\* IO port 31 \*/ |
| #define | [PORT\_32](#af0e97abbfe0607d2bbd6b0bf9ddbc0ef)   0x2000 /\* IO port 32 \*/ |
| #define | [PORT\_33](#a424a163455e7b6cc0faca5d3ca7f00f4)   0x2100 /\* IO port 33 \*/ |
| #define | [PORT\_34](#ac1b44b6dee31ebd6b8ac5bad56446a02)   0x2200 /\* IO port 34 \*/ |
| #define | [PORT\_35](#a78c202a4d3882450b41d1c60df530658)   0x2300 /\* IO port 35 \*/ |
| #define | [PORT\_36](#a47eb175dba955fec4cbf79a9b0efa973)   0x2400 /\* IO port 36 \*/ |
| #define | [PORT\_37](#a5a3debc2962b08963f39c38d2be12ae6)   0x2500 /\* IO port 37 \*/ |
| #define | [PORT\_38](#ac6c0f7e21c278e0c099d59998a2bdcb8)   0x2600 /\* IO port 38 \*/ |
| #define | [PORT\_39](#a9ff2297ec7bd05f237457c42e48f7004)   0x2700 /\* IO port 39 \*/ |
| #define | [PORT\_40](#a8186d359fb55d84806c1b85a2fad74c1)   0x2800 /\* IO port 40 \*/ |
| #define | [PORT\_41](#a4cc4764d4ec08a7307b6c2cd9e3d3349)   0x2900 /\* IO port 41 \*/ |
| #define | [PORT\_42](#ad653c357ac0b8df98e078c404be7c9b0)   0x2A00 /\* IO port 42 \*/ |
| #define | [PORT\_43](#aa4e56f114bdcde46fe218174e28d2fe6)   0x2B00 /\* IO port 43 \*/ |
| #define | [PORT\_44](#a743edbe771261c90cec0bf967df1cf7a)   0x2C00 /\* IO port 44 \*/ |
| #define | [PORT\_45](#a8fbd69bd13ac505784fc35dcd30e5ed0)   0x2D00 /\* IO port 45 \*/ |
| #define | [PORT\_46](#a556d96f490fe864f3c01b0518299561f)   0x2E00 /\* IO port 46 \*/ |
| #define | [PORT\_47](#aba995dc5260ba8341ac90de822901f99)   0x2F00 /\* IO port 47 \*/ |
| #define | [PORT\_48](#ac81eae40ea61b31e1bfcdac2bcede298)   0x3000 /\* IO port 48 \*/ |
...
| #define | [BSP\_IO\_SD0\_CLK](#a99cac86447ae6b18e3e1601085623a60)   0xFFFF0600 /\* SD0\_CLK \*/ |
| #define | [BSP\_IO\_SD0\_CMD](#a2b904f716e2bf524351430155b8c7ddc)   0xFFFF0601 /\* SD0\_CMD \*/ |
| #define | [BSP\_IO\_SD0\_RST\_N](#ad61d120b88812e3c41a600414f553325)   0xFFFF0602 /\* SD0\_RST\_N \*/ |
...
| #define | [BSP\_IO\_QSPI1\_SPCLK](#ab79be1e7eed598b1d9f09ce0bed7c625)   0xFFFF0B00 /\* QSPI1\_SPCLK \*/ |
| #define | [BSP\_IO\_QSPI1\_IO0](#a225d50a8d0e6a40f10bc8fd28abc10db)   0xFFFF0B01 /\* QSPI1\_IO0 \*/ |
| #define | [BSP\_IO\_QSPI1\_IO1](#ae926d4d471542c3b0593545acb9f2d1f)   0xFFFF0B02 /\* QSPI1\_IO1 \*/ |
| #define | [BSP\_IO\_QSPI1\_IO2](#a4c6591684fc2d2b6f99cc229f5eea5f8)   0xFFFF0B03 /\* QSPI1\_IO2 \*/ |
| #define | [BSP\_IO\_QSPI1\_IO3](#af3f0e39940012676f28d55d0c4959b63)   0xFFFF0B04 /\* QSPI1\_IO3 \*/ |
| #define | [BSP\_IO\_QSPI1\_SSL](#a8ee3034ed36e82ee6968a037efed0b61)   0xFFFF0B05 /\* QSPI1\_SSL \*/ |
...
| #define | [BSP\_IO\_QSPI\_INT\_N](#aff4a128a9accbf9da0becf0afbca47cc)   0xFFFF0C02 /\* QSPI\_INT\_N \*/ |
...
## [◆ ](#a225d50a8d0e6a40f10bc8fd28abc10db)BSP\_IO\_QSPI1\_IO0

| #define BSP\_IO\_QSPI1\_IO0   0xFFFF0B01 /\* QSPI1\_IO0 \*/ |
| --- |

## [◆ ](#ae926d4d471542c3b0593545acb9f2d1f)BSP\_IO\_QSPI1\_IO1

| #define BSP\_IO\_QSPI1\_IO1   0xFFFF0B02 /\* QSPI1\_IO1 \*/ |
| --- |

## [◆ ](#a4c6591684fc2d2b6f99cc229f5eea5f8)BSP\_IO\_QSPI1\_IO2

| #define BSP\_IO\_QSPI1\_IO2   0xFFFF0B03 /\* QSPI1\_IO2 \*/ |
| --- |

## [◆ ](#af3f0e39940012676f28d55d0c4959b63)BSP\_IO\_QSPI1\_IO3

| #define BSP\_IO\_QSPI1\_IO3   0xFFFF0B04 /\* QSPI1\_IO3 \*/ |
| --- |

## [◆ ](#ab79be1e7eed598b1d9f09ce0bed7c625)BSP\_IO\_QSPI1\_SPCLK

| #define BSP\_IO\_QSPI1\_SPCLK   0xFFFF0B00 /\* QSPI1\_SPCLK \*/ |
| --- |

## [◆ ](#a8ee3034ed36e82ee6968a037efed0b61)BSP\_IO\_QSPI1\_SSL

| #define BSP\_IO\_QSPI1\_SSL   0xFFFF0B05 /\* QSPI1\_SSL \*/ |
| --- |

## [◆ ](#aff4a128a9accbf9da0becf0afbca47cc)BSP\_IO\_QSPI\_INT\_N

| #define BSP\_IO\_QSPI\_INT\_N   0xFFFF0C02 /\* QSPI\_INT\_N \*/ |
| --- |
...
| #define BSP\_IO\_SD0\_CLK   0xFFFF0600 /\* SD0\_CLK \*/ |
| --- |

## [◆ ](#a2b904f716e2bf524351430155b8c7ddc)BSP\_IO\_SD0\_CMD

| #define BSP\_IO\_SD0\_CMD   0xFFFF0601 /\* SD0\_CMD \*/ |
| --- |
...
| #define BSP\_IO\_SD0\_RST\_N   0xFFFF0602 /\* SD0\_RST\_N \*/ |
| --- |
...
## [◆ ](#a0c1b97684b0bbb0326a187117bcf78ae)PORT\_19

| #define PORT\_19   0x1300 /\* IO port 19 \*/ |
| --- |

## [◆ ](#a87d7fd3777b47baab0317a96ee874842)PORT\_20

| #define PORT\_20   0x1400 /\* IO port 20 \*/ |
| --- |

## [◆ ](#acc227be3abe2efbeed63891d0e4ad3db)PORT\_21

| #define PORT\_21   0x1500 /\* IO port 21 \*/ |
| --- |

## [◆ ](#aefb67b06965dd6320a246fc0529917ad)PORT\_22

| #define PORT\_22   0x1600 /\* IO port 22 \*/ |
| --- |

## [◆ ](#a1d7f17a633496267b4d19fc8fa89dbb5)PORT\_23

| #define PORT\_23   0x1700 /\* IO port 23 \*/ |
| --- |

## [◆ ](#affbf09e2b0a16edd6b6201909ee99394)PORT\_24

| #define PORT\_24   0x1800 /\* IO port 24 \*/ |
| --- |

## [◆ ](#a8294aaccee0f492317c516e0650aa3ae)PORT\_25

| #define PORT\_25   0x1900 /\* IO port 25 \*/ |
| --- |

## [◆ ](#ae05ca0fe949f27b5a7fb9ab591236eb5)PORT\_26

| #define PORT\_26   0x1A00 /\* IO port 26 \*/ |
| --- |

## [◆ ](#a75bd2e1d9ec1ca727e1bff3089817a0f)PORT\_27

| #define PORT\_27   0x1B00 /\* IO port 27 \*/ |
| --- |

## [◆ ](#aa57eff6bf891ecc8486ebcd1213291a7)PORT\_28

| #define PORT\_28   0x1C00 /\* IO port 28 \*/ |
| --- |

## [◆ ](#a657ec3a12bd94f98baf3b7f7636e335b)PORT\_29

| #define PORT\_29   0x1D00 /\* IO port 29 \*/ |
| --- |

## [◆ ](#a5d994c54f5e3a93a713eb1af0c775dda)PORT\_30

| #define PORT\_30   0x1E00 /\* IO port 30 \*/ |
| --- |

## [◆ ](#a634e9ea57181bc83b3be1c2473e8df13)PORT\_31

| #define PORT\_31   0x1F00 /\* IO port 31 \*/ |
| --- |

## [◆ ](#af0e97abbfe0607d2bbd6b0bf9ddbc0ef)PORT\_32

| #define PORT\_32   0x2000 /\* IO port 32 \*/ |
| --- |

## [◆ ](#a424a163455e7b6cc0faca5d3ca7f00f4)PORT\_33

| #define PORT\_33   0x2100 /\* IO port 33 \*/ |
| --- |

## [◆ ](#ac1b44b6dee31ebd6b8ac5bad56446a02)PORT\_34

| #define PORT\_34   0x2200 /\* IO port 34 \*/ |
| --- |

## [◆ ](#a78c202a4d3882450b41d1c60df530658)PORT\_35

| #define PORT\_35   0x2300 /\* IO port 35 \*/ |
| --- |

## [◆ ](#a47eb175dba955fec4cbf79a9b0efa973)PORT\_36

| #define PORT\_36   0x2400 /\* IO port 36 \*/ |
| --- |

## [◆ ](#a5a3debc2962b08963f39c38d2be12ae6)PORT\_37

| #define PORT\_37   0x2500 /\* IO port 37 \*/ |
| --- |

## [◆ ](#ac6c0f7e21c278e0c099d59998a2bdcb8)PORT\_38

| #define PORT\_38   0x2600 /\* IO port 38 \*/ |
| --- |

## [◆ ](#a9ff2297ec7bd05f237457c42e48f7004)PORT\_39

| #define PORT\_39   0x2700 /\* IO port 39 \*/ |
| --- |

## [◆ ](#a8186d359fb55d84806c1b85a2fad74c1)PORT\_40

| #define PORT\_40   0x2800 /\* IO port 40 \*/ |
| --- |

## [◆ ](#a4cc4764d4ec08a7307b6c2cd9e3d3349)PORT\_41

| #define PORT\_41   0x2900 /\* IO port 41 \*/ |
| --- |

## [◆ ](#ad653c357ac0b8df98e078c404be7c9b0)PORT\_42

| #define PORT\_42   0x2A00 /\* IO port 42 \*/ |
| --- |

## [◆ ](#aa4e56f114bdcde46fe218174e28d2fe6)PORT\_43

| #define PORT\_43   0x2B00 /\* IO port 43 \*/ |
| --- |

## [◆ ](#a743edbe771261c90cec0bf967df1cf7a)PORT\_44

| #define PORT\_44   0x2C00 /\* IO port 44 \*/ |
| --- |

## [◆ ](#a8fbd69bd13ac505784fc35dcd30e5ed0)PORT\_45

| #define PORT\_45   0x2D00 /\* IO port 45 \*/ |
| --- |

## [◆ ](#a556d96f490fe864f3c01b0518299561f)PORT\_46

| #define PORT\_46   0x2E00 /\* IO port 46 \*/ |
| --- |

## [◆ ](#aba995dc5260ba8341ac90de822901f99)PORT\_47

| #define PORT\_47   0x2F00 /\* IO port 47 \*/ |
| --- |

## [◆ ](#ac81eae40ea61b31e1bfcdac2bcede298)PORT\_48

| #define PORT\_48   0x3000 /\* IO port 48 \*/ |
| --- |
