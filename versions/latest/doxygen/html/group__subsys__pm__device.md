---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__subsys__pm__device.html
...
| void | [pm\_device\_state\_lock](#gaab27e932950e1063b2f1f4c4e19dbf01) (const struct [device](structdevice.md) \*dev) |
|  | Lock current device state. |
| void | [pm\_device\_state\_unlock](#gaa5d2387a01a4ca4d765b1ea2361155bb) (const struct [device](structdevice.md) \*dev) |
|  | Unlock the current device state. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [pm\_device\_state\_is\_locked](#gaf577cada579b6f871bc55e4a282ef8a6) (const struct [device](structdevice.md) \*dev) |
...
This helper function is intended to be called at the end of a driver init function to automatically setup the device into the lowest power mode. It assumes that the device has been configured as if it is in [PM\_DEVICE\_STATE\_OFF](#gga561c0789071e3c3963f21f4c4a1bb2c6a2456389354b744d4e96847e38f8b61c2).
...
## [◆ ](#gaf577cada579b6f871bc55e4a282ef8a6)pm\_device\_state\_is\_locked()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) pm\_device\_state\_is\_locked | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | If device is locked. |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | If device is not locked. |

## [◆ ](#gaab27e932950e1063b2f1f4c4e19dbf01)pm\_device\_state\_lock()

| void pm\_device\_state\_lock | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
See also
:   [pm\_device\_state\_unlock](#gaa5d2387a01a4ca4d765b1ea2361155bb)
...
## [◆ ](#gaa5d2387a01a4ca4d765b1ea2361155bb)pm\_device\_state\_unlock()

| void pm\_device\_state\_unlock | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
See also
:   [pm\_device\_state\_lock](#gaab27e932950e1063b2f1f4c4e19dbf01)
