---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__clock__apis.html
...
| #define | [SYS\_CLOCK\_REALTIME](#gac88ce6c820c962691fdc6e0b344bd887)   1 |
|  | The real-time clock (i.e. |
| #define | [SYS\_CLOCK\_MONOTONIC](#gab8a1a7e619c67e9a86e773097ce3a8e5)   4 |
|  | The monotonic clock. |
| #define | [SYS\_TIMER\_ABSTIME](#ga647bea5f74dcf7f6f6fed2c1b78b540f)   4 |
...
| void | [sys\_clock\_getrtoffset](#gab40851eb5eebbdfdba211eea6967f1ce) (struct [timespec](structtimespec.md) \*tp) |
|  | INTERNAL\_HIDDEN. |
| int | [sys\_clock\_gettime](#ga92bad374219a4cd32299569c94907877) (int clock\_id, struct [timespec](structtimespec.md) \*tp) |
|  | Get the current time from the specified clock. |
| int | [sys\_clock\_settime](#ga297e885a8a95c762ae882e61f7d381b4) (int clock\_id, const struct [timespec](structtimespec.md) \*tp) |
|  | Set the current time for the specified clock. |
| int | [sys\_clock\_nanosleep](#ga01ca6f2ad006ed530ffec06c262ae380) (int clock\_id, int [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9), const struct [timespec](structtimespec.md) \*rqtp, struct [timespec](structtimespec.md) \*rmtp) |
...
`#include <[zephyr/sys/clock.h](clock_8h.md)>`
...
`#include <[zephyr/kernel.h](kernel_8h.md)>`
...
## [◆ ](#gab8a1a7e619c67e9a86e773097ce3a8e5)SYS\_CLOCK\_MONOTONIC

| #define SYS\_CLOCK\_MONOTONIC   4 |
| --- |
...
## [◆ ](#gac88ce6c820c962691fdc6e0b344bd887)SYS\_CLOCK\_REALTIME

| #define SYS\_CLOCK\_REALTIME   1 |
| --- |
...
## [◆ ](#ga647bea5f74dcf7f6f6fed2c1b78b540f)SYS\_TIMER\_ABSTIME

| #define SYS\_TIMER\_ABSTIME   4 |
| --- |
...
This flag may be passed to [sys\_clock\_nanosleep](#ga01ca6f2ad006ed530ffec06c262ae380) to indicate the requested timeout is an absolute time with respect to the specified clock.
...
`#include <[zephyr/drivers/timer/system_timer.h](system__timer_8h.md)>`
...
## [◆ ](#gab40851eb5eebbdfdba211eea6967f1ce)sys\_clock\_getrtoffset()

| void sys\_clock\_getrtoffset | ( | struct [timespec](structtimespec.md) \* | *tp* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Get the offset [SYS\_CLOCK\_REALTIME](#gac88ce6c820c962691fdc6e0b344bd887) with respect to [SYS\_CLOCK\_MONOTONIC](#gab8a1a7e619c67e9a86e773097ce3a8e5)

The "wall clock" (i.e. [SYS\_CLOCK\_REALTIME](#gac88ce6c820c962691fdc6e0b344bd887)) depends on a base time that is set by the system. The base time may be updated for a number of reasons, such as initialization of a hardware real-time-clock (RTC), network time protocol (NTP) synchronization, or manual adjustment by the application.

This function retrieves the current time offset, as a [timespec](structtimespec.md) object, for [SYS\_CLOCK\_REALTIME](#gac88ce6c820c962691fdc6e0b344bd887), with respect to [SYS\_CLOCK\_MONOTONIC](#gab8a1a7e619c67e9a86e773097ce3a8e5), and writes it to the provided memory location pointed-to by *tp*.

Note
:   This function may assert if *tp* is NULL.

Parameters
:   | tp | Pointer to memory where time will be written. |
    | --- | --- |

## [◆ ](#ga92bad374219a4cd32299569c94907877)sys\_clock\_gettime()

| int sys\_clock\_gettime | ( | int | *clock\_id*, |
| --- | --- | --- | --- |
|  |  | struct [timespec](structtimespec.md) \* | *tp* ) |
...
Parameters
:   | clock\_id | The clock from which to query time. |
    | --- | --- |
    | tp | Pointer to memory where time will be written. |
...
:   | 0 | on success. |
    | --- | --- |
    | -EINVAL | when an invalid *clock\_id* is specified. |
...
## [◆ ](#ga01ca6f2ad006ed530ffec06c262ae380)sys\_clock\_nanosleep()

| int sys\_clock\_nanosleep | ( | int | *clock\_id*, |
| --- | --- | --- | --- |
|  |  | int | *flags*, |
...
- until the absolute time specified by *rqtp* (if *flags* includes [SYS\_TIMER\_ABSTIME](#ga647bea5f74dcf7f6f6fed2c1b78b540f)), or
- until the relative time specified by *rqtp* (if *flags* does not include [SYS\_TIMER\_ABSTIME](#ga647bea5f74dcf7f6f6fed2c1b78b540f)).

The accepted values for *clock\_id* include

- [SYS\_CLOCK\_REALTIME](#gac88ce6c820c962691fdc6e0b344bd887)
- [SYS\_CLOCK\_MONOTONIC](#gab8a1a7e619c67e9a86e773097ce3a8e5)
...
Parameters
:   | clock\_id | The clock to by which to sleep. |
    | --- | --- |
    | [flags](parser_8h.md#ab6b306ef981f5e21bb41ea2c2dbe8cd9) | Flags to modify the behavior of the sleep operation. |
...
:   | 0 | on success. |
    | --- | --- |
    | -EINVAL | when an invalid *clock\_id*, when *rqtp* contains nanoseconds outside of the range [0, 999999999], or when *rqtp* contains a negative value. |
...
## [◆ ](#ga297e885a8a95c762ae882e61f7d381b4)sys\_clock\_settime()

| int sys\_clock\_settime | ( | int | *clock\_id*, |
| --- | --- | --- | --- |
|  |  | const struct [timespec](structtimespec.md) \* | *tp* ) |
...
Parameters
:   | clock\_id | The clock for which the time should be set. |
    | --- | --- |
...
:   | 0 | on success. |
    | --- | --- |
    | -EINVAL | when an invalid *clock\_id* is specified or when *tp* contains nanoseconds outside of the range [0, 999999999]. |
