---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__led__interface.html
...
| Macros | |
| --- | --- |
| #define | [LED\_BRIGHTNESS\_MAX](#ga7bb18ca9f746ebcfbfc397886643f16d)   100u |
...
## [◆ ](#ga7bb18ca9f746ebcfbfc397886643f16d)LED\_BRIGHTNESS\_MAX

| #define LED\_BRIGHTNESS\_MAX   100u |
| --- |

`#include <[zephyr/drivers/led.h](drivers_2led_8h.md)>`
...
LEDs which implements brightness control do not need to implement this, the set\_brightness API is used automatically.
...
LEDs which can only be turned on or off do not need to provide this function. These should simply turn the LED on if `value` is nonzero, and off if `value` is zero using the on/off APIs automatically.
