---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__devicetree-inst.html
...
|  | Invokes `fn` for each element of property `prop` for a DT\_DRV\_COMPAT instance with multiple arguments and a sepatator. |
...
([DT\_INST\_FOREACH\_STATUS\_OKAY\_VARGS](#ga1b9fd4b9c37a23e52e69ea23f7aedb38)(DT\_INST\_NODE\_HAS\_PROP\_AND\_OR, prop) 0)
...
Like DT\_ENUM\_IDX(), but with a fallback to a default enum index.

**Definition** devicetree.h:837
...
Get the node's Zephyr interrupt number at index If <code>CONFIG\_MULTI\_LEVEL\_INTERRUPTS</code> <ver...

**Definition** devicetree.h:2580
...
DT\_U64\_C([DT\_INST\_REG\_ADDR\_BY\_NAME](#ga722d6f7b97136aa9229242e4ba7dd25c)(inst, name))

[DT\_INST\_REG\_ADDR\_BY\_NAME](#ga722d6f7b97136aa9229242e4ba7dd25c)

#define DT\_INST\_REG\_ADDR\_BY\_NAME(inst, name)

Get a DT\_DRV\_COMPAT's register block address by name.

**Definition** devicetree.h:3896
...
DT\_U64\_C([DT\_INST\_REG\_ADDR](#gafde8fa67b94ac959ba2e24b44b3386a7)(inst))

[DT\_INST\_REG\_ADDR](#gafde8fa67b94ac959ba2e24b44b3386a7)

#define DT\_INST\_REG\_ADDR(inst)

Get a DT\_DRV\_COMPAT's (only) register block address.

**Definition** devicetree.h:3928
