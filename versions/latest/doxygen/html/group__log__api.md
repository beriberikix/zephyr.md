---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__log__api.html
...
`#include <[zephyr/logging/log.h](log_8h.md)>`
...
Z\_LOG\_MODULE\_PARTITION([K\_APP\_DMEM](group__mem__domain__apis__app.md#gace571a7f6ee313a732976cc863b5d0e6)) \
...
Z\_LOG\_MODULE\_PARTITION([K\_APP\_BMEM](group__mem__domain__apis__app.md#ga8fd691f9c9007ec80432c19f7ce84881)) \

static const [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \_\_log\_level \_\_unused = \

\_LOG\_LEVEL\_RESOLVE(\_\_VA\_ARGS\_\_)

[K\_APP\_BMEM](group__mem__domain__apis__app.md#ga8fd691f9c9007ec80432c19f7ce84881)

#define K\_APP\_BMEM(id)

Place data in a partition's bss section.

**Definition** app\_memdomain.h:61

[K\_APP\_DMEM](group__mem__domain__apis__app.md#gace571a7f6ee313a732976cc863b5d0e6)

#define K\_APP\_DMEM(id)

Place data in a partition's data section.

**Definition** app\_memdomain.h:51
