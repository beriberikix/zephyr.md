---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__coap__client.html
...
|  | Send CoAP request. |
| void | [coap\_client\_cancel\_requests](#ga3f511d4df22bece05c1ac97ff4d09a80) (struct coap\_client \*client) |
|  | Cancel all current requests. |
| void | [coap\_client\_cancel\_request](#ga71abc48834df15e7550f7f9c75918117) (struct coap\_client \*client, struct [coap\_client\_request](structcoap__client__request.md) \*req) |
|  | Cancel matching requests. |
| struct [coap\_client\_option](structcoap__client__option.md) | [coap\_client\_option\_initial\_block2](#ga437ead308ea92f314fd9ebb82a6300b7) (void) |
|  | Initialise a Block2 option to be added to a request. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [coap\_client\_has\_ongoing\_exchange](#ga9460711a90567fccb810fb4d93dbe841) (struct coap\_client \*client) |
...
`#include <[zephyr/net/coap_client.h](coap__client_8h.md)>`
...
## [◆ ](#ga71abc48834df15e7550f7f9c75918117)coap\_client\_cancel\_request()

| void coap\_client\_cancel\_request | ( | struct coap\_client \* | *client*, |
| --- | --- | --- | --- |
...
This function cancels all CoAP client request that matches the given request. The request is matched based on the method, path, callback and user\_data, if provided. Any field set to NULL is considered a wildcard.

(struct [coap\_client\_request](structcoap__client__request.md "Representation of a CoAP client request.")){0} cancels all requests. (struct [coap\_client\_request](structcoap__client__request.md "Representation of a CoAP client request.")){.method = COAP\_METHOD\_GET} cancels all GET requests.
...
## [◆ ](#ga3f511d4df22bece05c1ac97ff4d09a80)coap\_client\_cancel\_requests()
...
## [◆ ](#ga9460711a90567fccb810fb4d93dbe841)coap\_client\_has\_ongoing\_exchange()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) coap\_client\_has\_ongoing\_exchange | ( | struct coap\_client \* | *client* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
:   For socket handling. Function does no consider a socket POLL that has started before this call, therefore it is recommended to wait out POLL timeout before closing socket (e.g. call [coap\_client\_cancel\_requests()](#ga3f511d4df22bece05c1ac97ff4d09a80) which applies delay for timeout).
...
## [◆ ](#ga437ead308ea92f314fd9ebb82a6300b7)coap\_client\_option\_initial\_block2()

| struct [coap\_client\_option](structcoap__client__option.md) coap\_client\_option\_initial\_block2 | ( | void |  | ) |  |
| --- | --- | --- | --- | --- | --- |
