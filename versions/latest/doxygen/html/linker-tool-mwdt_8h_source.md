---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/linker-tool-mwdt_8h_source.html
...
[ 82](linker-tool-mwdt_8h.md#a784c696b95848c5f070e257a50fbe23a)#define SECTION\_PROLOGUE(name, options, align) name options align :

83

84/\*

85 \* As for SECTION\_PROLOGUE(), except that this one must (!) be used
...
89 \* GROUP\_LINK\_IN\_LMA to specify the correct output load address.

90 \*/

91#ifdef CONFIG\_XIP

92#define SECTION\_DATA\_PROLOGUE(name, options, align) \

93 name options ALIGN(8) align :

94#else

[ 95](linker-tool-mwdt_8h.md#a0d8981d3817b2563846735c90d50240c)#define SECTION\_DATA\_PROLOGUE(name, options, align) name options align :
