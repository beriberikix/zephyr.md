---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__workqueue__apis.html
...
| void | [k\_work\_queue\_run](#gac7fc60238574769e4eae6a2cc38da87b) (struct [k\_work\_q](structk__work__q.md) \*queue, const struct [k\_work\_queue\_config](structk__work__queue__config.md) \*cfg) |
...
## [◆ ](#gac7fc60238574769e4eae6a2cc38da87b)k\_work\_queue\_run()

| void k\_work\_queue\_run | ( | struct [k\_work\_q](structk__work__q.md) \* | *queue*, |
| --- | --- | --- | --- |
...
This will run the work queue forever unless stopped by [k\_work\_queue\_stop](#ga1fd2fce94eb731ccb0838ec763e62f5c).

Parameters
:   | queue | the queue to run |
    | --- | --- |
