---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__http__client.html
...
| typedef int(\* | [http\_response\_cb\_t](#ga6141c94f7da92b71713079063f3426be)) (struct [http\_response](structhttp__response.md) \*rsp, enum [http\_final\_call](#ga04fc31de51404e35b3dfab6261bb8e6d) final\_data, void \*user\_data) |
...
`#include <[zephyr/net/http/client.h](client_8h.md)>`
...
## [◆ ](#ga6141c94f7da92b71713079063f3426be)http\_response\_cb\_t

| typedef int(\* http\_response\_cb\_t) (struct [http\_response](structhttp__response.md) \*rsp, enum [http\_final\_call](#ga04fc31de51404e35b3dfab6261bb8e6d) final\_data, void \*user\_data) |
| --- |
...
Returns
:   0 if [http\_client\_req()](#gaa38b6efb03f88d6959273a41b6acac81) should proceed with the download, <0 if [http\_client\_req()](#gaa38b6efb03f88d6959273a41b6acac81) should abort the download.
...
The callback is called when data is received from the HTTP server. The caller must have created a connection to the server before calling this function so [connect()](posix_2sys_2socket_8h.md#a90f0aa598d0f4ab4ea99ecf289a6a7fb) call must have be done successfully for the socket.
