---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__mem-demand-paging-backing-store.html
...
| Functions | |
| --- | --- |
| int | [k\_mem\_paging\_backing\_store\_location\_get](#gaadedcda81ca04a2044332a8f6787967a) (struct z\_page\_frame \*pf, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) \*location, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) page\_fault) |
...
| void | [k\_mem\_paging\_backing\_store\_page\_finalize](#ga0902bc03fecfe8c7b51eb1f3efe587b7) (struct z\_page\_frame \*pf, [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) location) |
...
## [◆ ](#gaadedcda81ca04a2044332a8f6787967a)k\_mem\_paging\_backing\_store\_location\_get()

| int k\_mem\_paging\_backing\_store\_location\_get | ( | struct z\_page\_frame \* | *pf*, |
| --- | --- | --- | --- |
...
## [◆ ](#ga0902bc03fecfe8c7b51eb1f3efe587b7)k\_mem\_paging\_backing\_store\_page\_finalize()

| void k\_mem\_paging\_backing\_store\_page\_finalize | ( | struct z\_page\_frame \* | *pf*, |
| --- | --- | --- | --- |
|  |  | [uintptr\_t](stdint_8h.md#a4788399d1d0b37ccf098a7da82254808) | *location* ) |
...
This is invoked after [k\_mem\_paging\_backing\_store\_page\_in()](#ga9becb4908cc7840ece93a2360692962d) and interrupts have been\* re-locked, making it safe to access the z\_page\_frame data. The location value will be the same passed to [k\_mem\_paging\_backing\_store\_page\_in()](#ga9becb4908cc7840ece93a2360692962d).
