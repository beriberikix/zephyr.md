---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/stm32n6__clock_8h.html
...
| #define | [STM32\_SRC\_HSI\_DIV](#ad3a6174149cc423359e1b7e745e0f80b)   ([STM32\_SRC\_IC20](#a9aedd874a88b96145f31a76585806ff3) + 1) |
| #define | [STM32\_SRC\_TIMG](#aad7666755ccf0ec028e17610d3347edd)   ([STM32\_SRC\_HSI\_DIV](#ad3a6174149cc423359e1b7e745e0f80b) + 1) |
| #define | [STM32\_SRC\_HCLK1](#af4cce65567b57af5b512a97d3aadbbc9)   ([STM32\_SRC\_TIMG](#aad7666755ccf0ec028e17610d3347edd) + 1) |
| #define | [STM32\_SRC\_HCLK2](#ad4b4a2d0deaf49275f1d6502354c9cf6)   ([STM32\_SRC\_HCLK1](#af4cce65567b57af5b512a97d3aadbbc9) + 1) |
| #define | [STM32\_SRC\_HCLK3](#af15978643f6f5a5f9fa427cb59fa17c7)   ([STM32\_SRC\_HCLK2](#ad4b4a2d0deaf49275f1d6502354c9cf6) + 1) |
| #define | [STM32\_SRC\_HCLK4](#a796350ee1298d5c41abcf1d7a65c4654)   ([STM32\_SRC\_HCLK3](#af15978643f6f5a5f9fa427cb59fa17c7) + 1) |
| #define | [STM32\_SRC\_HCLK5](#a9a565ff797b5d040c194e11a969e2a4f)   ([STM32\_SRC\_HCLK4](#a796350ee1298d5c41abcf1d7a65c4654) + 1) |
...
| #define | [STM32\_SRC\_PCLK4](#a4c6b45a1c2d1e1eeccdd946eb52ef85e)   ([STM32\_SRC\_PCLK2](#a68f7335900538f3beb2c2d09e33376b3) + 1) |
| #define | [STM32\_SRC\_PCLK5](#a6f2aefaae2b34f76d3fc8011447be932)   ([STM32\_SRC\_PCLK4](#a4c6b45a1c2d1e1eeccdd946eb52ef85e) + 1) |
| #define | [STM32\_CLOCK\_BUS\_MEM](#a5572bcd39f02438edc00019e9f9e0d03)   0x24C |
...
| #define | [STM32\_PERIPH\_BUS\_MIN](#acc0577552371fcda95685f6424ecb4b2)   [STM32\_CLOCK\_BUS\_MEM](#a5572bcd39f02438edc00019e9f9e0d03) |
...
|  | RCC\_CCIPRx register offset (RM0486.pdf). |
...
|  | RCC\_ICxCFGR register offset (RM0486.pdf). |
...
|  | RCC\_CFGR1 register offset (RM0486.pdf). |
...
[STM32\_DT\_CLOCK\_SELECT](stm32__common__clocks_8h.md#af00e387856ff4e47b7b7d47ab2f61c8d)((val), 7, 16, [CCIPR2\_REG](stm32c0__clock_8h.md#a60349691a29a48b727f302acb8025b89))
...
[STM32\_DT\_CLOCK\_SELECT](stm32__common__clocks_8h.md#af00e387856ff4e47b7b7d47ab2f61c8d)((val), 1, 24, [CCIPR2\_REG](stm32c0__clock_8h.md#a60349691a29a48b727f302acb8025b89))
...
**Definition** stm32n6\_clock.h:169
...
**Definition** stm32n6\_clock.h:93
...
**Definition** stm32n6\_clock.h:95
...
**Definition** stm32n6\_clock.h:89
...
**Definition** stm32n6\_clock.h:90
...
**Definition** stm32n6\_clock.h:91
...
**Definition** stm32n6\_clock.h:92
...
## [◆ ](#a5572bcd39f02438edc00019e9f9e0d03)STM32\_CLOCK\_BUS\_MEM

| #define STM32\_CLOCK\_BUS\_MEM   0x24C |
| --- |
...
| #define STM32\_PERIPH\_BUS\_MIN   [STM32\_CLOCK\_BUS\_MEM](#a5572bcd39f02438edc00019e9f9e0d03) |
| --- |
...
| #define STM32\_SRC\_HCLK1   ([STM32\_SRC\_TIMG](#aad7666755ccf0ec028e17610d3347edd) + 1) |
| --- |

## [◆ ](#ad4b4a2d0deaf49275f1d6502354c9cf6)STM32\_SRC\_HCLK2

| #define STM32\_SRC\_HCLK2   ([STM32\_SRC\_HCLK1](#af4cce65567b57af5b512a97d3aadbbc9) + 1) |
| --- |

## [◆ ](#af15978643f6f5a5f9fa427cb59fa17c7)STM32\_SRC\_HCLK3

| #define STM32\_SRC\_HCLK3   ([STM32\_SRC\_HCLK2](#ad4b4a2d0deaf49275f1d6502354c9cf6) + 1) |
| --- |

## [◆ ](#a796350ee1298d5c41abcf1d7a65c4654)STM32\_SRC\_HCLK4

| #define STM32\_SRC\_HCLK4   ([STM32\_SRC\_HCLK3](#af15978643f6f5a5f9fa427cb59fa17c7) + 1) |
| --- |

## [◆ ](#a9a565ff797b5d040c194e11a969e2a4f)STM32\_SRC\_HCLK5

| #define STM32\_SRC\_HCLK5   ([STM32\_SRC\_HCLK4](#a796350ee1298d5c41abcf1d7a65c4654) + 1) |
| --- |
...
## [◆ ](#ad3a6174149cc423359e1b7e745e0f80b)STM32\_SRC\_HSI\_DIV

| #define STM32\_SRC\_HSI\_DIV   ([STM32\_SRC\_IC20](#a9aedd874a88b96145f31a76585806ff3) + 1) |
| --- |
...
| #define STM32\_SRC\_PCLK4   ([STM32\_SRC\_PCLK2](#a68f7335900538f3beb2c2d09e33376b3) + 1) |
| --- |

## [◆ ](#a6f2aefaae2b34f76d3fc8011447be932)STM32\_SRC\_PCLK5

| #define STM32\_SRC\_PCLK5   ([STM32\_SRC\_PCLK4](#a4c6b45a1c2d1e1eeccdd946eb52ef85e) + 1) |
| --- |
...
## [◆ ](#aad7666755ccf0ec028e17610d3347edd)STM32\_SRC\_TIMG

| #define STM32\_SRC\_TIMG   ([STM32\_SRC\_HSI\_DIV](#ad3a6174149cc423359e1b7e745e0f80b) + 1) |
| --- |
...
**Definition** stm32n6\_clock.h:94
