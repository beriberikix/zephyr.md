---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__monochrome__character__framebuffer.html
...
|  | Draw a rectangle. |
| int | [cfb\_draw\_circle](#ga2a87d5fd58bb7a56081668313f7038f6) (const struct [device](structdevice.md) \*dev, const struct [cfb\_position](structcfb__position.md) \*start, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) radius) |
|  | Draw a circle. |
...
| void | [cfb\_framebuffer\_deinit](#ga981f062bb314c107230e068f575f81ef) (const struct [device](structdevice.md) \*dev) |
...
`#include <[zephyr/display/cfb.h](cfb_8h.md)>`
...
## [◆ ](#ga2a87d5fd58bb7a56081668313f7038f6)cfb\_draw\_circle()

| int cfb\_draw\_circle | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | const struct [cfb\_position](structcfb__position.md) \* | *start*, |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *radius* ) |
...
:   | dev | Pointer to device structure for driver instance |
    | --- | --- |
    | start | Center position of the circle |
...
## [◆ ](#ga981f062bb314c107230e068f575f81ef)cfb\_framebuffer\_deinit()

| void cfb\_framebuffer\_deinit | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
