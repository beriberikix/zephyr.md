---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__csip.html
...
| struct | [bt\_csip\_set\_member\_set\_info](structbt__csip__set__member__set__info.md) |
|  | Struct to hold information about a service instance. [More...](structbt__csip__set__member__set__info.md#details) |
...
| typedef void(\* | [bt\_csip\_set\_coordinator\_size\_changed\_cb](#gaee24f364c90cdcd0b6f49c8b297a34a7)) (struct bt\_conn \*conn, const struct [bt\_csip\_set\_coordinator\_csis\_inst](structbt__csip__set__coordinator__csis__inst.md) \*inst) |
...
| int | [bt\_csip\_set\_member\_set\_size\_and\_rank](#gaef51ab05dbe9d8a69674f7020e8f837f) (struct bt\_csip\_set\_member\_svc\_inst \*svc\_inst, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) size, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) rank) |
|  | Set a new size and rank for a service instance. |
| int | [bt\_csip\_set\_member\_get\_info](#gad80917089bc7e629cc3cb9d7fbf6cf45) (const struct bt\_csip\_set\_member\_svc\_inst \*svc\_inst, struct [bt\_csip\_set\_member\_set\_info](structbt__csip__set__member__set__info.md) \*info) |
...
`#include <[zephyr/bluetooth/audio/csip.h](csip_8h.md)>`
...
## [◆ ](#gaee24f364c90cdcd0b6f49c8b297a34a7)bt\_csip\_set\_coordinator\_size\_changed\_cb

| typedef void(\* bt\_csip\_set\_coordinator\_size\_changed\_cb) (struct bt\_conn \*conn, const struct [bt\_csip\_set\_coordinator\_csis\_inst](structbt__csip__set__coordinator__csis__inst.md) \*inst) |
| --- |
...
Since all devices in a set shall have the same set size value. Each connected device may send the same new size set in a notification, assuming that the remote device supports notifications of the set size.

The rank of each device in the set may also change as part of this, so it is advisable to call [bt\_csip\_set\_coordinator\_discover()](#ga7e7ea4a92bb76aded86807571a2cbb73) to rediscover and read the characteristic values of the sets on each device.

Parameters
:   | inst | The Coordinated Set Identification Service instance that was changed. The new size is stored in the `inst->info.size`. |
    | --- | --- |
...
## [◆ ](#gad80917089bc7e629cc3cb9d7fbf6cf45)bt\_csip\_set\_member\_get\_info()

| int bt\_csip\_set\_member\_get\_info | ( | const struct bt\_csip\_set\_member\_svc\_inst \* | *svc\_inst*, |
| --- | --- | --- | --- |
|  |  | struct [bt\_csip\_set\_member\_set\_info](structbt__csip__set__member__set__info.md) \* | *info* ) |
...
Parameters
:   | svc\_inst | The service instance. |
    | --- | --- |
    | info | Pointer to a struct to store the information in. |

Return values
:   | -EINVAL | `svc_inst` or `info` is NULL. |
    | --- | --- |
    | 0 | Success. |
...
## [◆ ](#gaef51ab05dbe9d8a69674f7020e8f837f)bt\_csip\_set\_member\_set\_size\_and\_rank()

| int bt\_csip\_set\_member\_set\_size\_and\_rank | ( | struct bt\_csip\_set\_member\_svc\_inst \* | *svc\_inst*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *size*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *rank* ) |
...
:   | svc\_inst | The service instance. |
    ...
    | rank | The new rank. Ignored if the `svc_inst` is not lockable. |

Return values
:   | -EINVAL | `svc_inst` is NULL, `size` is less than 1, `rank` is less than 1 or higher than `size` for a lockable `svc_inst`. |
    | --- | --- |
    | -EALREADY | `size` and `rank` are already the provided values. |
    | 0 | Success. |
