---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__elf.html
original_path: doxygen/html/group__elf.html
---
...
|  | Relocation type from r\_info. |
| #define | [R\_386\_NONE](#ga9e2fc1d7696704e230b4d767c173e3b0)   0 |
| #define | [R\_386\_32](#gaf363b787459afd7e272677d7858572c0)   1 |
| #define | [R\_386\_PC32](#gad55eb4ccb6e52c4c03f99b34cc8c690b)   2 |
| #define | [R\_386\_GOT32](#ga42f8dd027e6f2384dba2cfa060240c63)   3 |
| #define | [R\_386\_PLT32](#ga6ee43218883fb9f2836f425615c2da40)   4 |
| #define | [R\_386\_COPY](#gac08872c616d1b9649dc13780f71833b1)   5 |
| #define | [R\_386\_GLOB\_DAT](#ga6ab6b058a8dd4e90c49e74415809f867)   6 |
| #define | [R\_386\_JMP\_SLOT](#ga4d36bf95ffa6b0f7a369b23938db5aaf)   7 |
| #define | [R\_386\_RELATIVE](#gaee5190154984e6176e1c6804ac13217d)   8 |
| #define | [R\_386\_GOTOFF](#gac2ed0eac08066a8dd368873fcd54ae3c)   9 |
| #define | [R\_ARM\_NONE](#gaba173f6bfc4939c6c675c7c9aac58f6b)   0 |
| #define | [R\_ARM\_PC24](#ga8aa3aa7e46a9d204f5216b89ec49bdd3)   1 |
| #define | [R\_ARM\_ABS32](#ga543397b9b693fc965fa85c53ae292533)   2 |
| #define | [R\_ARM\_REL32](#gae357ce092d48739867c418106f14dffa)   3 |
| #define | [R\_ARM\_COPY](#gaecd1d4456eb5714a88481f3fba1a0799)   4 |
| #define | [R\_ARM\_CALL](#gae59692354033b4884a8ef7d42c1dbfbd)   28 |
| #define | [R\_ARM\_V4BX](#ga62af6fef95eaf5591a8f56efb01b1012)   40 |
| #define | [R\_XTENSA\_NONE](#gae1eae33fa3ddf4d26549469eab3f6470)   0 |
| #define | [R\_XTENSA\_32](#ga422a8a958e91c992cc6d312f681ba120)   1 |
| #define | [R\_XTENSA\_SLOT0\_OP](#ga6c5725b952acb67e39199c63569a1ee6)   20 |
| #define | [PT\_LOAD](#ga84d7768fd6c6ece599d297090900cf92)   1 |
...
| typedef struct [elf64\_phdr](structelf64__phdr.md) | [elf\_phdr\_t](#gad5c63f362ef6b26db73c37980d731c93) |
...
## [◆ ](#ga84d7768fd6c6ece599d297090900cf92)PT\_LOAD
...
## [◆ ](#gaf363b787459afd7e272677d7858572c0)R\_386\_32
...
## [◆ ](#gac08872c616d1b9649dc13780f71833b1)R\_386\_COPY
...
## [◆ ](#ga6ab6b058a8dd4e90c49e74415809f867)R\_386\_GLOB\_DAT
...
## [◆ ](#ga42f8dd027e6f2384dba2cfa060240c63)R\_386\_GOT32
...
## [◆ ](#gac2ed0eac08066a8dd368873fcd54ae3c)R\_386\_GOTOFF
...
## [◆ ](#ga4d36bf95ffa6b0f7a369b23938db5aaf)R\_386\_JMP\_SLOT
...
## [◆ ](#ga9e2fc1d7696704e230b4d767c173e3b0)R\_386\_NONE
...
## [◆ ](#gad55eb4ccb6e52c4c03f99b34cc8c690b)R\_386\_PC32
...
## [◆ ](#ga6ee43218883fb9f2836f425615c2da40)R\_386\_PLT32
...
## [◆ ](#gaee5190154984e6176e1c6804ac13217d)R\_386\_RELATIVE
...
## [◆ ](#ga543397b9b693fc965fa85c53ae292533)R\_ARM\_ABS32

| #define R\_ARM\_ABS32   2 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#gae59692354033b4884a8ef7d42c1dbfbd)R\_ARM\_CALL

| #define R\_ARM\_CALL   28 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#gaecd1d4456eb5714a88481f3fba1a0799)R\_ARM\_COPY

| #define R\_ARM\_COPY   4 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#gaba173f6bfc4939c6c675c7c9aac58f6b)R\_ARM\_NONE

| #define R\_ARM\_NONE   0 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#ga8aa3aa7e46a9d204f5216b89ec49bdd3)R\_ARM\_PC24

| #define R\_ARM\_PC24   1 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#gae357ce092d48739867c418106f14dffa)R\_ARM\_REL32

| #define R\_ARM\_REL32   3 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#ga62af6fef95eaf5591a8f56efb01b1012)R\_ARM\_V4BX

| #define R\_ARM\_V4BX   40 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#ga422a8a958e91c992cc6d312f681ba120)R\_XTENSA\_32

| #define R\_XTENSA\_32   1 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#gae1eae33fa3ddf4d26549469eab3f6470)R\_XTENSA\_NONE

| #define R\_XTENSA\_NONE   0 |
| --- |

`#include <[elf.h](elf_8h.md)>`

## [◆ ](#ga6c5725b952acb67e39199c63569a1ee6)R\_XTENSA\_SLOT0\_OP

| #define R\_XTENSA\_SLOT0\_OP   20 |
| --- |
