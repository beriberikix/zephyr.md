---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__usb__hid__items.html
...
| #define | [HID\_USAGE16](#gaf2e338747f22f75256e57de1cf055200)(idx) |
...
| #define | [HID\_UNIT\_EXPONENT](#ga2147820c08a9b4a18d3aa162460f3967)(exp) |
...
## [◆ ](#ga2147820c08a9b4a18d3aa162460f3967)HID\_UNIT\_EXPONENT

| #define HID\_UNIT\_EXPONENT | ( |  | *exp* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[HID\_ITEM](#ga4e9dc6652402e0b87e1313c143737ed4)([HID\_ITEM\_TAG\_UNIT\_EXPONENT](group__usb__hid__definitions.md#ga7c6d81ee211814ec9b5d17f95e57639b), [HID\_ITEM\_TYPE\_GLOBAL](group__usb__hid__definitions.md#ga8e56e8090f1af7aae473e8a8b6832fb8), 1), exp

[HID\_ITEM\_TAG\_UNIT\_EXPONENT](group__usb__hid__definitions.md#ga7c6d81ee211814ec9b5d17f95e57639b)

#define HID\_ITEM\_TAG\_UNIT\_EXPONENT
...
Parameters
:   | exp | Unit exponent, refer to the HID Unit Exponent table in the specification for usage |
    | --- | --- |

Returns
:   HID Unit Exponent item
...
Parameters
:   | idx | HID Usage ID per the HID Usage Table |
    | --- | --- |

Returns
:   HID Usage Index item

## [◆ ](#gaf2e338747f22f75256e57de1cf055200)HID\_USAGE16

| #define HID\_USAGE16 | ( |  | *idx* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[HID\_ITEM](#ga4e9dc6652402e0b87e1313c143737ed4)([HID\_ITEM\_TAG\_USAGE](group__usb__hid__definitions.md#gaefd616ecaa8fc8762e65ec9d7b01f0cd), [HID\_ITEM\_TYPE\_LOCAL](group__usb__hid__definitions.md#ga0bfb0e326d9a01072c029cba788d6456), 2), ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d))idx, (idx >> 8)
