---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__input__kbd__matrix.html
...
| #define | [PRIkbdrow](#ga1343b97a8b072f8ed362e8a4f242bdd1)   "%02x" |
| #define | [INPUT\_KBD\_ACTUAL\_KEY\_MASK\_CONST](#gaec0209680e18da8584bdf41e5229aaae) |
| #define | [INPUT\_KBD\_MATRIX\_ROW\_BITS](#gae395cd03c295673dc9563c252ba7e022)   [NUM\_BITS](util_8h.md#afa27c06d0ad6b949289431ad75f104ab)([kbd\_row\_t](#gac7d5c811da0c9ab2660be3c3f2fcfe86)) |
...
**Definition** input\_kbd\_matrix.h:187
...
**Definition** input\_kbd\_matrix.h:137
...
**Definition** input\_kbd\_matrix.h:68
...
**Definition** input\_kbd\_matrix.h:215
...
**Definition** input\_kbd\_matrix.h:156
...
| #define INPUT\_KBD\_MATRIX\_ROW\_BITS   [NUM\_BITS](util_8h.md#afa27c06d0ad6b949289431ad75f104ab)([kbd\_row\_t](#gac7d5c811da0c9ab2660be3c3f2fcfe86)) |
| --- |
...
This allows enabling or disabling spcific row, column combination in the actual key mask in runtime. It can be useful if some of the keys are not present in some configuration, and the specific configuration is determined in runtime. Requires `CONFIG_INPUT_KBD_ACTUAL_KEY_MASK_DYNAMIC` to be enabled.
...
This can be implemented by the application to handle column selection quirks. Called after the driver specific drive\_column function. Requires `CONFIG_INPUT_KBD_DRIVE_COLUMN_HOOK` to be enabled.
