---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__ring__buffer__apis.html
...
| static [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [ring\_buf\_is\_empty](#gac1a8c9e4cc9c3485573082371a4d9574) (const struct [ring\_buf](structring__buf.md) \*buf) |
...
| static [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [ring\_buf\_space\_get](#ga5eee438bd5bf08eb3a2da4cf2289903c) (const struct [ring\_buf](structring__buf.md) \*buf) |
|  | Determine free space in a ring buffer. |
| static [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [ring\_buf\_item\_space\_get](#ga39c203f8e599098ce0d308e88d07d084) (const struct [ring\_buf](structring__buf.md) \*buf) |
|  | Determine free space in an "item based" ring buffer. |
| static [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [ring\_buf\_capacity\_get](#ga9589ff6b763eeafacb65a3af283db3cd) (const struct [ring\_buf](structring__buf.md) \*buf) |
|  | Return ring buffer capacity. |
| static [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | [ring\_buf\_size\_get](#ga5f0017eb22d84b9cb177adfe090e6a92) (const struct [ring\_buf](structring__buf.md) \*buf) |
...
`#include <[zephyr/sys/ring_buffer.h](ring__buffer_8h.md)>`
...
## [◆ ](#ga9589ff6b763eeafacb65a3af283db3cd)ring\_buf\_capacity\_get()

| | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) ring\_buf\_capacity\_get | ( | const struct [ring\_buf](structring__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gac1a8c9e4cc9c3485573082371a4d9574)ring\_buf\_is\_empty()

| | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) ring\_buf\_is\_empty | ( | const struct [ring\_buf](structring__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga39c203f8e599098ce0d308e88d07d084)ring\_buf\_item\_space\_get()

| | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) ring\_buf\_item\_space\_get | ( | const struct [ring\_buf](structring__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga5f0017eb22d84b9cb177adfe090e6a92)ring\_buf\_size\_get()

| | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) ring\_buf\_size\_get | ( | const struct [ring\_buf](structring__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga5eee438bd5bf08eb3a2da4cf2289903c)ring\_buf\_space\_get()

| | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) ring\_buf\_space\_get | ( | const struct [ring\_buf](structring__buf.md) \* | *buf* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
