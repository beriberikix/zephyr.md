---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bitarray__apis.html
...
| int | [sys\_bitarray\_xor](#ga195f100be66d9392c8a5e917ad9f8cea) ([sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \*dst, [sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \*other, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_bits, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) offset) |
|  | Calculates the bit-wise XOR of two bitarrays in a region. |
| int | [sys\_bitarray\_find\_nth\_set](#ga134b8b9cb37c69fc174ef0acc61075ec) ([sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \*bitarray, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) n, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_bits, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) offset, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) \*found\_at) |
|  | Find nth bit set in region. |
| int | [sys\_bitarray\_popcount\_region](#ga8dd6d35a082922b17c0efb7808f5e4be) ([sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \*bitarray, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) num\_bits, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) offset, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) \*count) |
...
`#include <[zephyr/sys/bitarray.h](bitarray_8h.md)>`
...
## [◆ ](#ga134b8b9cb37c69fc174ef0acc61075ec)sys\_bitarray\_find\_nth\_set()

| int sys\_bitarray\_find\_nth\_set | ( | [sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \* | *bitarray*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *n*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *num\_bits*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *offset*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) \* | *found\_at* ) |

`#include <[zephyr/sys/bitarray.h](bitarray_8h.md)>`

Find nth bit set in region.

This counts the number of bits set (`count`) in a region (`offset`, `num_bits`) and returns the index (`found_at`) of the nth set bit, if it exists, as long with a zero return value.

If it does not exist, `found_at` is not updated and the method returns

Parameters
:   | [in] | bitarray | Bitarray struct |
    | --- | --- | --- |
    | [in] | n | Nth bit set to look for |
    | [in] | num\_bits | Number of bits to check, must be larger than 0 |
    | [in] | offset | Starting bit position |
    | [out] | found\_at | Index of the nth bit set, if found |
...
## [◆ ](#ga8dd6d35a082922b17c0efb7808f5e4be)sys\_bitarray\_popcount\_region()

| int sys\_bitarray\_popcount\_region | ( | [sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \* | *bitarray*, |
| --- | --- | --- | --- |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *num\_bits*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *offset*, |
...
This counts the number of bits set (`count`) in a region (`offset`, `num_bits`).
...
## [◆ ](#ga195f100be66d9392c8a5e917ad9f8cea)sys\_bitarray\_xor()

| int sys\_bitarray\_xor | ( | [sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \* | *dst*, |
| --- | --- | --- | --- |
|  |  | [sys\_bitarray\_t](#ga168a1da9ac2bee523bdc9778e94fd841) \* | *other*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *num\_bits*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *offset* ) |
...
The result is stored in the first bitarray passed in (`dst`). Both bitarrays must be of the same size.

Parameters
:   | dst | Bitarray struct |
    | --- | --- |
    | other | Bitarray struct |
    | num\_bits | Number of bits in the region, must be larger than 0 |
