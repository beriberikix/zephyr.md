---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__mcumgr__mgmt__api.html
...
| typedef [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b)(\* | [mgmt\_groups\_cb\_t](#ga9f63f42cd468ce85d0f800dc1472a5c8)) (const struct [mgmt\_group](structmgmt__group.md) \*[group](structgroup.md), void \*user\_data) |
...
| Functions | |
| --- | --- |
| void | [mgmt\_register\_group](#ga70379f21faacddb5cc4a66f37a576ea0) (struct [mgmt\_group](structmgmt__group.md) \*[group](structgroup.md)) |
|  | Registers a full command group. |
| void | [mgmt\_unregister\_group](#ga87e98bdf47d1c7798098444f69ccf8b8) (struct [mgmt\_group](structmgmt__group.md) \*[group](structgroup.md)) |
|  | Unregisters a full command group. |
| void | [mgmt\_groups\_foreach](#ga125e3a6d076cade80f2080915a06ac67) ([mgmt\_groups\_cb\_t](#ga9f63f42cd468ce85d0f800dc1472a5c8) user\_cb, void \*user\_data) |
|  | Iterate over groups. |
...
| const struct [mgmt\_handler](structmgmt__handler.md) \* | [mgmt\_get\_handler](#gaec6ccbcaf28404b4b3662d5059f0a32b) (const struct [mgmt\_group](structmgmt__group.md) \*[group](structgroup.md), [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) command\_id) |
|  | Finds a registered command handler. |
...
`#include <[zephyr/mgmt/mcumgr/mgmt/mgmt.h](mgmt_8h.md)>`
...
`#include <[zephyr/mgmt/mcumgr/mgmt/mgmt_defines.h](mgmt__defines_8h.md)>`
...
## [◆ ](#ga9f63f42cd468ce85d0f800dc1472a5c8)mgmt\_groups\_cb\_t

| typedef [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b)(\* mgmt\_groups\_cb\_t) (const struct [mgmt\_group](structmgmt__group.md) \*[group](structgroup.md), void \*user\_data) |
| --- |
...
Parameters
:   | [group](structgroup.md "Group structure.") | Group |
    | --- | --- |
...
| MGMT\_GROUP\_ID\_ENUM | Enumeration management group, used for listing supported command groups. |
...
Parameters
:   | [group](structgroup.md "Group structure.") | The group of the command to find. |
    | --- | --- |
    | command\_id | The ID of the command to find. |
...
## [◆ ](#ga125e3a6d076cade80f2080915a06ac67)mgmt\_groups\_foreach()

| void mgmt\_groups\_foreach | ( | [mgmt\_groups\_cb\_t](#ga9f63f42cd468ce85d0f800dc1472a5c8) | *user\_cb*, |
| --- | --- | --- | --- |
|  |  | void \* | *user\_data* ) |
