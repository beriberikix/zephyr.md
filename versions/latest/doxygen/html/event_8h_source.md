---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/event_8h_source.html
...
[ 64](group__hawkbit__event.md#gga794d232d73d105bd170b222ab17ce2afa55dd61e8016fe6b69339e136d5ff279e) [HAWKBIT\_EVENT\_CONFIRMED\_CURRENT\_IMAGE](group__hawkbit__event.md#gga794d232d73d105bd170b222ab17ce2afa55dd61e8016fe6b69339e136d5ff279e),

65};

66

67struct hawkbit\_event\_callback;

68

[ 80](group__hawkbit__event.md#ga49064aef93c5383f24ea41819b78c458)typedef void (\*[hawkbit\_event\_callback\_handler\_t](group__hawkbit__event.md#ga49064aef93c5383f24ea41819b78c458))(struct hawkbit\_event\_callback \*cb,

81 enum [hawkbit\_event\_type](group__hawkbit__event.md#ga794d232d73d105bd170b222ab17ce2af) event);

82

84

95struct hawkbit\_event\_callback {

97 [sys\_snode\_t](group__single-linked-list__apis.md#ga69bf43aad81e3ee2d55250c59b857493) node;

98

100 [hawkbit\_event\_callback\_handler\_t](group__hawkbit__event.md#ga49064aef93c5383f24ea41819b78c458) handler;

101

103 enum [hawkbit\_event\_type](group__hawkbit__event.md#ga794d232d73d105bd170b222ab17ce2af) event;
...
[ 118](group__hawkbit__event.md#ga05eec89437dfd13a022ba2eac6b1e0d9)#define HAWKBIT\_EVENT\_CREATE\_CALLBACK(\_callback, \_handler, \_event) \

119 struct hawkbit\_event\_callback \_callback = { \
...
[ 131](group__hawkbit__event.md#ga0ec141ff3e11c0e1d0e3f8757ace5010)static inline void [hawkbit\_event\_init\_callback](group__hawkbit__event.md#ga0ec141ff3e11c0e1d0e3f8757ace5010)(struct hawkbit\_event\_callback \*callback,

132 [hawkbit\_event\_callback\_handler\_t](group__hawkbit__event.md#ga49064aef93c5383f24ea41819b78c458) handler,

133 enum [hawkbit\_event\_type](group__hawkbit__event.md#ga794d232d73d105bd170b222ab17ce2af) event)

134{

135 \_\_ASSERT(callback, "Callback pointer should not be NULL");

136 \_\_ASSERT(handler, "Callback handler pointer should not be NULL");
...
[ 149](group__hawkbit__event.md#ga646c72464b0761009f42393fa313c880)int [hawkbit\_event\_add\_callback](group__hawkbit__event.md#ga646c72464b0761009f42393fa313c880)(struct hawkbit\_event\_callback \*cb);

150

[ 158](group__hawkbit__event.md#gaa19bb74cb46e9aff7742907a86c96359)int [hawkbit\_event\_remove\_callback](group__hawkbit__event.md#gaa19bb74cb46e9aff7742907a86c96359)(struct hawkbit\_event\_callback \*cb);

159

163

164#endif /\* ZEPHYR\_INCLUDE\_MGMT\_HAWKBIT\_EVENT\_H\_ \*/
...
[HAWKBIT\_EVENT\_CONFIRMED\_CURRENT\_IMAGE](group__hawkbit__event.md#gga794d232d73d105bd170b222ab17ce2afa55dd61e8016fe6b69339e136d5ff279e)

@ HAWKBIT\_EVENT\_CONFIRMED\_CURRENT\_IMAGE
