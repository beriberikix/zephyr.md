---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__jwt.html
...
`#include <[zephyr/data/jwt.h](jwt_8h.md)>`
...
:   | builder | A previously initialized builder with payload. |
    | --- | --- |
    | der\_key | Private key to use in DER format. |
    | der\_key\_len | Size of the private key in bytes. |
