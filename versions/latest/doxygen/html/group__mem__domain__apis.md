---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__mem__domain__apis.html
...
| | int k\_mem\_domain\_add\_partition | ( | struct [k\_mem\_domain](structk__mem__domain.md) \* | *domain*, | | --- | --- | --- | --- | |  |  | struct [k\_mem\_partition](structk__mem__partition.md) \* | *part* ) | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_mem\_domain\_add\_thread | ( | struct [k\_mem\_domain](structk__mem__domain.md) \* | *domain*, | | --- | --- | --- | --- | |  |  | [k\_tid\_t](kernel_2thread_8h.md#a6379f5a1f19ffbc262a6877c4f6e3647) | *thread* ) | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_mem\_domain\_init | ( | struct [k\_mem\_domain](structk__mem__domain.md) \* | *domain*, | | --- | --- | --- | --- | |  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *num\_parts*, | |  |  | struct [k\_mem\_partition](structk__mem__partition.md) \* | *parts*[] ) | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| | int k\_mem\_domain\_remove\_partition | ( | struct [k\_mem\_domain](structk__mem__domain.md) \* | *domain*, | | --- | --- | --- | --- | |  |  | struct [k\_mem\_partition](structk__mem__partition.md) \* | *part* ) | | extern |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
