---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/arch__inlines_8h_source.html
...
28#include <[zephyr/arch/mips/arch\_inlines.h](mips_2arch__inlines_8h.md)>

29#elif defined(CONFIG\_ARCH\_POSIX)

30#include <[zephyr/arch/posix/arch\_inlines.h](posix_2arch__inlines_8h.md)>

31#elif defined(CONFIG\_SPARC)

32#include <[zephyr/arch/sparc/arch\_inlines.h](sparc_2arch__inlines_8h.md)>

33#elif defined(CONFIG\_RX)

34#include <[zephyr/arch/rx/arch\_inlines.h](rx_2arch__inlines_8h.md)>

35#endif

36

37#endif /\* ZEPHYR\_INCLUDE\_ARCH\_INLINES\_H\_ \*/
