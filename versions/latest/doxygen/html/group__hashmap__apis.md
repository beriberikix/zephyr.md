---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__hashmap__apis.html
...
`#include <[zephyr/sys/hash_map_api.h](hash__map__api_8h.md)>`
...
`#include <[zephyr/sys/hash_map.h](hash__map_8h.md)>`
