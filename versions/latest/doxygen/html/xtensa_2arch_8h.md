---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/xtensa_2arch_8h.html
...
| Typedefs | |
| --- | --- |
| typedef struct [arch\_mem\_domain](structarch__mem__domain.md) | [arch\_mem\_domain\_t](#abdb10445d0c4910929b4b7d305fe7e5a) |
...
|  | Implementation of [arch\_k\_cycle\_get\_32](arc_2v2_2misc_8h.md#a9ee9f897ec750957de45bf8d43349d5e "arch_k_cycle_get_32"). |
...
|  | Implementation of [arch\_k\_cycle\_get\_64](arc_2v2_2misc_8h.md#acc1ed8d949f694a1d39e389334caf971 "arch_k_cycle_get_64"). |
...
| static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) void | [xtensa\_vecbase\_lock](#ac14ee42f2f373cf48fa30a60f3aafc39) (void) |
...
This header contains the Xtensa specific kernel interface. It is included by the kernel interface architecture-abstraction header (include/zephyr/arch/cpu.h).
...
## [◆ ](#abdb10445d0c4910929b4b7d305fe7e5a)arch\_mem\_domain\_t
...
| void arch\_xtensa\_mmu\_post\_init | ( | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *is\_core0* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| void xtensa\_arch\_kernel\_oops | ( | int | *reason\_p*, |
| --- | --- | --- | --- |
|  |  | void \* | *ssf* ) |
...
| | [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) void xtensa\_vecbase\_lock | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | static |
| --- | --- | --- | --- | --- | --- | --- | --- |
