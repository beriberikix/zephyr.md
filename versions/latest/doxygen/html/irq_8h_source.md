---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/irq_8h_source.html
...
15#include <[zephyr/arch/cpu.h](arch_2cpu_8h.md)>
...
[ 140](group__isr__apis.md#gac6c8746ac28da6ce02b24714f4144ff3)#define IRQ\_DIRECT\_CONNECT(irq\_p, priority\_p, isr\_p, flags\_p) \

141 ARCH\_IRQ\_DIRECT\_CONNECT(irq\_p, priority\_p, isr\_p, flags\_p)

142

[ 150](group__isr__apis.md#ga1ab99dbeb50b228001e1fca808cbaeea)#define ISR\_DIRECT\_HEADER() ARCH\_ISR\_DIRECT\_HEADER()

151

[ 167](group__isr__apis.md#ga31581157c9dbacf935f0e6a8dd456335)#define ISR\_DIRECT\_FOOTER(check\_reschedule) \

168 ARCH\_ISR\_DIRECT\_FOOTER(check\_reschedule)

169

[ 182](group__isr__apis.md#ga3c1327551dfca7818975e3fbf1470227)#define ISR\_DIRECT\_PM() ARCH\_ISR\_DIRECT\_PM()

183

[ 217](group__isr__apis.md#gaf86866cd07fd37f381d98866f8874ebf)#define ISR\_DIRECT\_DECLARE(name) ARCH\_ISR\_DIRECT\_DECLARE(name)

218

260#ifdef CONFIG\_SMP

261unsigned int z\_smp\_global\_lock(void);

[ 262](group__isr__apis.md#ga19fdde73c3b02fcca6cf1d1e67631228)#define irq\_lock() z\_smp\_global\_lock()

263#else

264#define irq\_lock() arch\_irq\_lock()

265#endif

266

288#ifdef CONFIG\_SMP

289void z\_smp\_global\_unlock(unsigned int key);

[ 290](group__isr__apis.md#ga646045943b3b2a130738bcc48867bf57)#define irq\_unlock(key) z\_smp\_global\_unlock(key)

291#else

292#define irq\_unlock(key) arch\_irq\_unlock(key)

293#endif

294

[ 302](group__isr__apis.md#ga7ea700ee31e4ff036c997a554dbedfeb)#define irq\_enable(irq) arch\_irq\_enable(irq)

303

[ 311](group__isr__apis.md#ga82c3a15d812f58e0f6525f358d031e6d)#define irq\_disable(irq) arch\_irq\_disable(irq)

312

[ 322](group__isr__apis.md#ga71fef3867ba9818cf0a5baf8410a6354)#define irq\_is\_enabled(irq) arch\_irq\_is\_enabled(irq)

323

327

328#ifdef \_\_cplusplus
...
332#endif /\* ASMLANGUAGE \*/

333#endif /\* ZEPHYR\_INCLUDE\_IRQ\_H\_ \*/
