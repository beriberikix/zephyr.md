---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/clk_8h.html
...
| struct | [scmi\_clock\_rate\_config](structscmi__clock__rate__config.md) |
|  | Describes the parameters for the CLOCK\_RATE\_SET command. [More...](structscmi__clock__rate__config.md#details) |
...
| #define | [SCMI\_CLK\_RATE\_SET\_FLAGS\_ASYNC](#aab3ca60f158a5dd0b33f1b57e9d9b56f)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| #define | [SCMI\_CLK\_RATE\_SET\_FLAGS\_IGNORE\_DELEAYED\_RESP](#a7fa05d27f6a5a31298b2d075ebd83403)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
| #define | [SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_UP\_DOWN](#a649ba03b0e0f32db9aa83b568965301a)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(2) |
| #define | [SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_AUTO](#a605adf399c70721a68c9c4971d695d3e)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(3) |
...
| int | [scmi\_clock\_rate\_set](#aa0f54c7fba01045a89ef0fd3a0ff16fc) (struct [scmi\_protocol](structscmi__protocol.md) \*proto, struct [scmi\_clock\_rate\_config](structscmi__clock__rate__config.md) \*cfg) |
|  | Send the CLOCK\_RATE\_SET command and get its reply. |
| int | [scmi\_clock\_parent\_get](#a456618c04934490afffdcd8be71729b3) (struct [scmi\_protocol](structscmi__protocol.md) \*proto, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) clk\_id, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*parent\_id) |
|  | Query the parent of a clock. |
| int | [scmi\_clock\_parent\_set](#a57942effe001fdb62a435a51441108e6) (struct [scmi\_protocol](structscmi__protocol.md) \*proto, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) clk\_id, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) parent\_id) |
...
## [◆ ](#aab3ca60f158a5dd0b33f1b57e9d9b56f)SCMI\_CLK\_RATE\_SET\_FLAGS\_ASYNC

| #define SCMI\_CLK\_RATE\_SET\_FLAGS\_ASYNC   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
| --- |

## [◆ ](#a7fa05d27f6a5a31298b2d075ebd83403)SCMI\_CLK\_RATE\_SET\_FLAGS\_IGNORE\_DELEAYED\_RESP

| #define SCMI\_CLK\_RATE\_SET\_FLAGS\_IGNORE\_DELEAYED\_RESP   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(1) |
| --- |

## [◆ ](#a605adf399c70721a68c9c4971d695d3e)SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_AUTO

| #define SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_AUTO   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(3) |
| --- |

## [◆ ](#a649ba03b0e0f32db9aa83b568965301a)SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_UP\_DOWN

| #define SCMI\_CLK\_RATE\_SET\_FLAGS\_ROUNDS\_UP\_DOWN   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(2) |
| --- |
...
## [◆ ](#a456618c04934490afffdcd8be71729b3)scmi\_clock\_parent\_get()

| int scmi\_clock\_parent\_get | ( | struct [scmi\_protocol](structscmi__protocol.md) \* | *proto*, |
| --- | --- | --- | --- |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *clk\_id*, |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *parent\_id* ) |
...
:   | proto | pointer to SCMI clock protocol data |
    ...
    | parent\_id | pointer to be set via this command |
...
## [◆ ](#a57942effe001fdb62a435a51441108e6)scmi\_clock\_parent\_set()

| int scmi\_clock\_parent\_set | ( | struct [scmi\_protocol](structscmi__protocol.md) \* | *proto*, |
| --- | --- | --- | --- |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *clk\_id*, |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) | *parent\_id* ) |
...
:   | proto | pointer to SCMI clock protocol data |
    | --- | --- |
    | clk\_id | ID of the clock for which the query is done |
    | parent\_id | to be set via this command to be set |
...
## [◆ ](#aa0f54c7fba01045a89ef0fd3a0ff16fc)scmi\_clock\_rate\_set()

| int scmi\_clock\_rate\_set | ( | struct [scmi\_protocol](structscmi__protocol.md) \* | *proto*, |
| --- | --- | --- | --- |
|  |  | struct [scmi\_clock\_rate\_config](structscmi__clock__rate__config.md) \* | *cfg* ) |
