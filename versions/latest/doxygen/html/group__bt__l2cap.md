---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__l2cap.html
...
| struct | [bt\_l2cap\_br\_window](structbt__l2cap__br__window.md) |
|  | I-Frame transmission window for none BASIC mode L2cap connected channel. [More...](structbt__l2cap__br__window.md#details) |
...
| Macros | |
| --- | --- |
| #define | [BT\_L2CAP\_BR\_ECHO\_REQ\_RESERVE](#ga12c146741591a55dc50d7d07f0755daa)   [BT\_L2CAP\_BUF\_SIZE](#gab95b119de4757588074e367a90a7136a)(4) |
|  | Headroom needed for outgoing L2CAP ECHO REQ PDUs. |
| #define | [BT\_L2CAP\_BR\_ECHO\_RSP\_RESERVE](#ga2961971c1f80aa6168f6cd47b991bf4d)   [BT\_L2CAP\_BUF\_SIZE](#gab95b119de4757588074e367a90a7136a)(4) |
...
| #define | [BT\_L2CAP\_BR\_LINK\_MODE\_BASIC](#gae8b0ef3d8fbadc2e50759f3409196478)   0x00 |
|  | L2CAP Endpoint Link Mode. |
| #define | [BT\_L2CAP\_BR\_LINK\_MODE\_RET](#ga9e524a5a8037eb8d7b6fbdd841635baa)   0x01 |
|  | L2CAP Endpoint Link Mode. |
| #define | [BT\_L2CAP\_BR\_LINK\_MODE\_FC](#ga1c203f6b730bbb5f045d72a2875e9b75)   0x02 |
|  | L2CAP Endpoint Link Mode. |
| #define | [BT\_L2CAP\_BR\_LINK\_MODE\_ERET](#gacd3f015557ae273dba9255377350b55a)   0x03 |
|  | L2CAP Endpoint Link Mode. |
| #define | [BT\_L2CAP\_BR\_LINK\_MODE\_STREAM](#gaee76903b4b152d0c91fceee162abe8b4)   0x04 |
|  | L2CAP Endpoint Link Mode. |
| #define | [BT\_L2CAP\_BR\_FCS\_NO](#ga180d1d5cc2cab3d04836fcb556c06463)   0x00 |
|  | Frame Check Sequence type. |
| #define | [BT\_L2CAP\_BR\_FCS\_16BIT](#ga6e9cfa54d0a08ab33ba420e8ff099dba)   0x01 |
|  | Frame Check Sequence type. |
...
| Functions | |
| --- | --- |
| int | [bt\_l2cap\_br\_echo\_cb\_register](#ga62c0115185f5026c1a842848dc5336ce) (struct [bt\_l2cap\_br\_echo\_cb](structbt__l2cap__br__echo__cb.md) \*cb) |
|  | Register ECHO callbacks. |
| int | [bt\_l2cap\_br\_echo\_cb\_unregister](#ga00ef7d0a42d8e544b195172af44b88b2) (struct [bt\_l2cap\_br\_echo\_cb](structbt__l2cap__br__echo__cb.md) \*cb) |
|  | Unregister ECHO callbacks. |
| int | [bt\_l2cap\_br\_echo\_req](#ga3c6ad17ba18f5c00e39a379ed735de21) (struct bt\_conn \*conn, struct [net\_buf](structnet__buf.md) \*buf) |
|  | Send ECHO data through ECHO request. |
| int | [bt\_l2cap\_br\_echo\_rsp](#ga8ebf537cc7e4c0a68a320f9c65c94b05) (struct bt\_conn \*conn, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) identifier, struct [net\_buf](structnet__buf.md) \*buf) |
...
## [◆ ](#ga12c146741591a55dc50d7d07f0755daa)BT\_L2CAP\_BR\_ECHO\_REQ\_RESERVE

| #define BT\_L2CAP\_BR\_ECHO\_REQ\_RESERVE   [BT\_L2CAP\_BUF\_SIZE](#gab95b119de4757588074e367a90a7136a)(4) |
| --- |

`#include <[zephyr/bluetooth/classic/l2cap_br.h](l2cap__br_8h.md)>`

Headroom needed for outgoing L2CAP ECHO REQ PDUs.

## [◆ ](#ga2961971c1f80aa6168f6cd47b991bf4d)BT\_L2CAP\_BR\_ECHO\_RSP\_RESERVE

| #define BT\_L2CAP\_BR\_ECHO\_RSP\_RESERVE   [BT\_L2CAP\_BUF\_SIZE](#gab95b119de4757588074e367a90a7136a)(4) |
| --- |
...
## [◆ ](#ga6e9cfa54d0a08ab33ba420e8ff099dba)BT\_L2CAP\_BR\_FCS\_16BIT

| #define BT\_L2CAP\_BR\_FCS\_16BIT   0x01 |
| --- |

`#include <[zephyr/bluetooth/l2cap.h](l2cap_8h.md)>`

Frame Check Sequence type.

16-bit FCS.

## [◆ ](#ga180d1d5cc2cab3d04836fcb556c06463)BT\_L2CAP\_BR\_FCS\_NO

| #define BT\_L2CAP\_BR\_FCS\_NO   0x00 |
| --- |
...
## [◆ ](#gae8b0ef3d8fbadc2e50759f3409196478)BT\_L2CAP\_BR\_LINK\_MODE\_BASIC

| #define BT\_L2CAP\_BR\_LINK\_MODE\_BASIC   0x00 |
| --- |
...
## [◆ ](#gacd3f015557ae273dba9255377350b55a)BT\_L2CAP\_BR\_LINK\_MODE\_ERET

| #define BT\_L2CAP\_BR\_LINK\_MODE\_ERET   0x03 |
| --- |
...
Enhance retransmission mode.

## [◆ ](#ga1c203f6b730bbb5f045d72a2875e9b75)BT\_L2CAP\_BR\_LINK\_MODE\_FC

| #define BT\_L2CAP\_BR\_LINK\_MODE\_FC   0x02 |
| --- |
...
## [◆ ](#ga9e524a5a8037eb8d7b6fbdd841635baa)BT\_L2CAP\_BR\_LINK\_MODE\_RET

| #define BT\_L2CAP\_BR\_LINK\_MODE\_RET   0x01 |
| --- |
...
## [◆ ](#gaee76903b4b152d0c91fceee162abe8b4)BT\_L2CAP\_BR\_LINK\_MODE\_STREAM

| #define BT\_L2CAP\_BR\_LINK\_MODE\_STREAM   0x04 |
| --- |
...
## [◆ ](#ga62c0115185f5026c1a842848dc5336ce)bt\_l2cap\_br\_echo\_cb\_register()

| int bt\_l2cap\_br\_echo\_cb\_register | ( | struct [bt\_l2cap\_br\_echo\_cb](structbt__l2cap__br__echo__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga00ef7d0a42d8e544b195172af44b88b2)bt\_l2cap\_br\_echo\_cb\_unregister()

| int bt\_l2cap\_br\_echo\_cb\_unregister | ( | struct [bt\_l2cap\_br\_echo\_cb](structbt__l2cap__br__echo__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga3c6ad17ba18f5c00e39a379ed735de21)bt\_l2cap\_br\_echo\_req()

| int bt\_l2cap\_br\_echo\_req | ( | struct bt\_conn \* | *conn*, |
| --- | --- | --- | --- |
...
Send ECHO data through ECHO request. The application is required to have reserved [BT\_L2CAP\_BR\_ECHO\_REQ\_RESERVE](#ga12c146741591a55dc50d7d07f0755daa) bytes in the buffer before sending.
...
## [◆ ](#ga8ebf537cc7e4c0a68a320f9c65c94b05)bt\_l2cap\_br\_echo\_rsp()

| int bt\_l2cap\_br\_echo\_rsp | ( | struct bt\_conn \* | *conn*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *identifier*, |
|  |  | struct [net\_buf](structnet__buf.md) \* | *buf* ) |
...
Send ECHO data through ECHO response. The application is required to have reserved [BT\_L2CAP\_BR\_ECHO\_RSP\_RESERVE](#ga2961971c1f80aa6168f6cd47b991bf4d) bytes in the buffer before sending.
