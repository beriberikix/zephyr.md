---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/hash__map__sc_8h.html
original_path: doxygen/html/hash__map__sc_8h.html
---
...
hash\_map\_sc.h File Reference
...
[Go to the source code of this file.](hash__map__sc_8h_source.md)

| Macros | |
| --- | --- |
| #define | [SYS\_HASHMAP\_SC\_DEFINE\_ADVANCED](#a8360409c9a02327046d6dd1858c82042)(\_name, \_hash\_func, \_alloc\_func, ...) |
|  | Declare a Separate Chaining Hashmap (advanced). |
| #define | [SYS\_HASHMAP\_SC\_DEFINE\_STATIC\_ADVANCED](#aec907531a89db3d4c108a00e06104c5f)(\_name, \_hash\_func, \_alloc\_func, ...) |
|  | Declare a Separate Chaining Hashmap (advanced). |
| #define | [SYS\_HASHMAP\_SC\_DEFINE\_STATIC](#a47cb289884e08dc88027cf525b90315b)(\_name) |
|  | Declare a Separate Chaining Hashmap statically. |
| #define | [SYS\_HASHMAP\_SC\_DEFINE](#abb8b551888eb8936785f27ce6ffbcde2)(\_name) |
|  | Declare a Separate Chaining Hashmap. |

| Variables | |
| --- | --- |
| const struct [sys\_hashmap\_api](structsys__hashmap__api.md) | [sys\_hashmap\_sc\_api](#a4216aeb7b4b499bdba830ae378368588) |
...
Note
:   Enable with `CONFIG_SYS_HASH_MAP_SC`

## Macro Definition Documentation

## [◆ ](#abb8b551888eb8936785f27ce6ffbcde2)SYS\_HASHMAP\_SC\_DEFINE

| #define SYS\_HASHMAP\_SC\_DEFINE | ( |  | *\_name* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

[SYS\_HASHMAP\_SC\_DEFINE\_ADVANCED](#a8360409c9a02327046d6dd1858c82042)( \
...
#define SYS\_HASHMAP\_SC\_DEFINE\_ADVANCED(\_name, \_hash\_func, \_alloc\_func,...)

Declare a Separate Chaining Hashmap (advanced).

**Definition** hash\_map\_sc.h:43
...
## [◆ ](#a8360409c9a02327046d6dd1858c82042)SYS\_HASHMAP\_SC\_DEFINE\_ADVANCED

| #define SYS\_HASHMAP\_SC\_DEFINE\_ADVANCED | ( |  | *\_name*, |
| --- | --- | --- | --- |
|  |  |  | *\_hash\_func*, |
|  |  |  | *\_alloc\_func*, |
|  |  |  | ... ) |
...
[SYS\_HASHMAP\_DEFINE\_ADVANCED](group__hashmap__apis.md#gab21c79f226ca02c0225014c77f5b53d6)(\_name, &[sys\_hashmap\_sc\_api](#a4216aeb7b4b499bdba830ae378368588), [sys\_hashmap\_config](structsys__hashmap__config.md), \
...
[sys\_hashmap\_sc\_api](#a4216aeb7b4b499bdba830ae378368588)
...
Note
:   The allocator `_alloc_func` is used for allocating internal Hashmap entries and does not interact with any user-provided keys or values.
...
## [◆ ](#a47cb289884e08dc88027cf525b90315b)SYS\_HASHMAP\_SC\_DEFINE\_STATIC

| #define SYS\_HASHMAP\_SC\_DEFINE\_STATIC | ( |  | *\_name* | ) |  |
| --- | --- | --- | --- | --- | --- |

**Value:**

[SYS\_HASHMAP\_SC\_DEFINE\_STATIC\_ADVANCED](#aec907531a89db3d4c108a00e06104c5f)( \
...
#define SYS\_HASHMAP\_SC\_DEFINE\_STATIC\_ADVANCED(\_name, \_hash\_func, \_alloc\_func,...)

Declare a Separate Chaining Hashmap (advanced).

**Definition** hash\_map\_sc.h:60
...
## [◆ ](#aec907531a89db3d4c108a00e06104c5f)SYS\_HASHMAP\_SC\_DEFINE\_STATIC\_ADVANCED

| #define SYS\_HASHMAP\_SC\_DEFINE\_STATIC\_ADVANCED | ( |  | *\_name*, |
| --- | --- | --- | --- |
|  |  |  | *\_hash\_func*, |
|  |  |  | *\_alloc\_func*, |
|  |  |  | ... ) |
...
[SYS\_HASHMAP\_DEFINE\_STATIC\_ADVANCED](group__hashmap__apis.md#gacd16dd5377fe160a2154053ba20fcbd7)(\_name, &[sys\_hashmap\_sc\_api](#a4216aeb7b4b499bdba830ae378368588), [sys\_hashmap\_config](structsys__hashmap__config.md), \
...
## [◆ ](#a4216aeb7b4b499bdba830ae378368588)sys\_hashmap\_sc\_api

| | const struct [sys\_hashmap\_api](structsys__hashmap__api.md) sys\_hashmap\_sc\_api | | --- | | extern |
| --- | --- | --- |
