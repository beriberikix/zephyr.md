---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__gap.html
...
| int | [bt\_le\_ext\_adv\_start](#gaddc6da5166cd8415d2b367380447eac1) (struct bt\_le\_ext\_adv \*adv, struct [bt\_le\_ext\_adv\_start\_param](structbt__le__ext__adv__start__param.md) \*param) |
...
| void | [bt\_le\_per\_adv\_sync\_cb\_register](#ga0df428314deaa84c7f5680a90c38729a) (struct [bt\_le\_per\_adv\_sync\_cb](structbt__le__per__adv__sync__cb.md) \*cb) |
...
|  | Stop (LE) scanning. |
| void | [bt\_le\_scan\_cb\_register](#gad7c2f18de7f67b73ccc0e7813f48f096) (struct [bt\_le\_scan\_cb](structbt__le__scan__cb.md) \*cb) |
...
| static int | [bt\_le\_whitelist\_add](#ga1423cb91b0e9e7633bf9a3e7aa73d730) (const [bt\_addr\_le\_t](structbt__addr__le__t.md) \*addr) |
...
| static int | [bt\_le\_whitelist\_rem](#ga0f3bbbfca7dc10003258d9b0a051e653) (const [bt\_addr\_le\_t](structbt__addr__le__t.md) \*addr) |
| int | [bt\_le\_filter\_accept\_list\_clear](#gac87df899d1e363c63162988157ee6d00) (void) |
|  | Clear filter accept list. |
| static int | [bt\_le\_whitelist\_clear](#ga1e80196fbf29a539cdf5c21fbc96cfef) (void) |
...
|  | Get local LE Out of Band (OOB) information. |
| int | [bt\_br\_discovery\_start](#gaf7efa6302cde58a10efaf0b68f5cb3c6) (const struct [bt\_br\_discovery\_param](structbt__br__discovery__param.md) \*param, struct [bt\_br\_discovery\_result](structbt__br__discovery__result.md) \*results, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) count, [bt\_br\_discovery\_cb\_t](#ga4606f9a083b5c333d8c1dc92b759333a) cb) |
...
`#include <[bluetooth.h](bluetooth_8h.md)>`
...
[BT\_LE\_ADV\_OPT\_ONE\_TIME](#gga654b0098c5f04a9c85a65f86b8f95deea7d12782a02afefcf4b5c04442a99f8a2), 0, 0,\

\_peer)

[BT\_LE\_ADV\_OPT\_ONE\_TIME](#gga654b0098c5f04a9c85a65f86b8f95deea7d12782a02afefcf4b5c04442a99f8a2)
...
[BT\_LE\_ADV\_PARAM](#ga9557269dd36b624b49e76c511c3a0cc1)([BT\_LE\_ADV\_OPT\_CONNECTABLE](#gga654b0098c5f04a9c85a65f86b8f95deea2a90f8d144a194f74c5432079c5d42a3) | [BT\_LE\_ADV\_OPT\_ONE\_TIME](#gga654b0098c5f04a9c85a65f86b8f95deea7d12782a02afefcf4b5c04442a99f8a2) | \

[BT\_LE\_ADV\_OPT\_DIR\_MODE\_LOW\_DUTY](#gga654b0098c5f04a9c85a65f86b8f95deeafd164ec5476f5e2d9aedf50032946872), \

[BT\_GAP\_ADV\_FAST\_INT\_MIN\_2](group__bt__gap__defines.md#ga9573e6bcdae3aae9d51c0becbbd7ac60), [BT\_GAP\_ADV\_FAST\_INT\_MAX\_2](group__bt__gap__defines.md#gaebc3ce60836522d883f664227a3ffcfb), \
...
## [◆ ](#ga4606f9a083b5c333d8c1dc92b759333a)bt\_br\_discovery\_cb\_t

| typedef void bt\_br\_discovery\_cb\_t(struct [bt\_br\_discovery\_result](structbt__br__discovery__result.md) \*results, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) count) |
| --- |
...
A callback of this type is given to the [bt\_br\_discovery\_start()](#gaf7efa6302cde58a10efaf0b68f5cb3c6) function and will be called at the end of the discovery with information about found devices populated in the results array.
...
| BT\_LE\_ADV\_OPT\_SCANNABLE | Support scan response data.  When used together with [BT\_LE\_ADV\_OPT\_EXT\_ADV](#gga654b0098c5f04a9c85a65f86b8f95deeae33ae9d8e43cce82e47fa73999d415ab) then this option cannot be used together with the [BT\_LE\_ADV\_OPT\_CONNECTABLE](#gga654b0098c5f04a9c85a65f86b8f95deea2a90f8d144a194f74c5432079c5d42a3) option. When used together with [BT\_LE\_ADV\_OPT\_EXT\_ADV](#gga654b0098c5f04a9c85a65f86b8f95deeae33ae9d8e43cce82e47fa73999d415ab) then scan response data must be set. |
...
| BT\_LE\_ADV\_OPT\_FORCE\_NAME\_IN\_AD | Put GAP device name into advert data.  Will place the GAP device name into the advertising data rather than the scan response data.  Note  Requires [BT\_LE\_ADV\_OPT\_USE\_NAME](#gga654b0098c5f04a9c85a65f86b8f95deea2dbc9ec77d6de134d96a7bd3d9256398) |
...
## [◆ ](#gaf7efa6302cde58a10efaf0b68f5cb3c6)bt\_br\_discovery\_start()
...
|  |  | [bt\_br\_discovery\_cb\_t](#ga4606f9a083b5c333d8c1dc92b759333a) | *cb* ) |

`#include <[bluetooth.h](bluetooth_8h.md)>`

Start BR/EDR discovery.

Start BR/EDR discovery (inquiry) and provide results through the specified callback. When [bt\_br\_discovery\_cb\_t](#ga4606f9a083b5c333d8c1dc92b759333a) is called it indicates that discovery has completed. If more inquiry results were received during session than fits in provided result storage, only ones with highest RSSI will be reported.
...
If supported by the HCI driver (indicated by setting `CONFIG_BT_HCI_SET_PUBLIC_ADDR` ), the first call to this function can be used to set the controller's public identity address. This call must happen before calling [bt\_enable()](#gac45d16bfe21c3c38e834c293e5ebc42b). Subsequent calls always add/generate random static addresses.
...
## [◆ ](#gaddc6da5166cd8415d2b367380447eac1)bt\_le\_ext\_adv\_start()

| int bt\_le\_ext\_adv\_start | ( | struct bt\_le\_ext\_adv \* | *adv*, |
| --- | --- | --- | --- |
|  |  | struct [bt\_le\_ext\_adv\_start\_param](structbt__le__ext__adv__start__param.md) \* | *param* ) |
...
## [◆ ](#ga0df428314deaa84c7f5680a90c38729a)bt\_le\_per\_adv\_sync\_cb\_register()

| void bt\_le\_per\_adv\_sync\_cb\_register | ( | struct [bt\_le\_per\_adv\_sync\_cb](structbt__le__per__adv__sync__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gad7c2f18de7f67b73ccc0e7813f48f096)bt\_le\_scan\_cb\_register()

| void bt\_le\_scan\_cb\_register | ( | struct [bt\_le\_scan\_cb](structbt__le__scan__cb.md) \* | *cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
:   | param | Scan parameters. |
    | --- | --- |
    | cb | Callback to notify scan results. May be NULL if callback registration through [bt\_le\_scan\_cb\_register](#gad7c2f18de7f67b73ccc0e7813f48f096) is preferred. |
...
## [◆ ](#ga1423cb91b0e9e7633bf9a3e7aa73d730)bt\_le\_whitelist\_add()

| | int bt\_le\_whitelist\_add | ( | const [bt\_addr\_le\_t](structbt__addr__le__t.md) \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |

`#include <[bluetooth.h](bluetooth_8h.md)>`

## [◆ ](#ga1e80196fbf29a539cdf5c21fbc96cfef)bt\_le\_whitelist\_clear()

| | int bt\_le\_whitelist\_clear | ( | void |  | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |

`#include <[bluetooth.h](bluetooth_8h.md)>`

## [◆ ](#ga0f3bbbfca7dc10003258d9b0a051e653)bt\_le\_whitelist\_rem()

| | int bt\_le\_whitelist\_rem | ( | const [bt\_addr\_le\_t](structbt__addr__le__t.md) \* | *addr* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
