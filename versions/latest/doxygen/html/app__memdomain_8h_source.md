---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/app__memdomain_8h_source.html
...
131 .start = (uintptr\_t) &Z\_APP\_START(name), \

132 .size = (size\_t) &Z\_APP\_SIZE(name), \
...
139 .bss\_start = &Z\_APP\_BSS\_START(name), \

140 .bss\_size = (size\_t) &Z\_APP\_BSS\_SIZE(name) \
