---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__flash__area__api.html
...
| #define | [FIXED\_PARTITION\_NODE\_OFFSET](#gaf26b80f089d25283c01ed54b5a27988c)(node) |
...
| #define | [FIXED\_PARTITION\_NODE\_SIZE](#ga526459438c6de09abb727585d22b7004)(node) |
...
|  | Get device pointer for device the area/partition resides on. |
| #define | [FIXED\_PARTITION\_NODE\_DEVICE](#gad64fb220f82870acce62661bfa94991a)(node) |
|  | Get device pointer for device the area/partition resides on. |
| #define | [FIXED\_PARTITION](#ga5682b688b50fd2cac3c6c8045e64107e)(label) |
|  | Get pointer to [flash\_area](structflash__area.md "Flash partition.") object by partition label. |
| #define | [FIXED\_PARTITION\_BY\_NODE](#gab51fb05a2cd0666b892d90ccbc9de342)(node) |
|  | Get pointer to [flash\_area](structflash__area.md "Flash partition.") object by partition node in DTS. |
...
| static [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [flash\_area\_device\_is\_ready](#ga7adf79769378ed468df6d3ffef5e02a9) (const struct [flash\_area](structflash__area.md) \*fa) |
...
| int | [flash\_area\_copy](#gaa50bb1b455a9004f9c24e4af9fd74cd7) (const struct [flash\_area](structflash__area.md) \*src\_fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) src\_off, const struct [flash\_area](structflash__area.md) \*dst\_fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) dst\_off, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) len, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*buf, [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) buf\_size) |
...
|  | Erase flash area. |
| int | [flash\_area\_flatten](#gafd097d05f5bfe91695bc7793e82cabcd) (const struct [flash\_area](structflash__area.md) \*fa, [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) [off](asm-macro-32-bit-gnu_8h.md#adbc19a384ffe3a93866980a920b08394), [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) len) |
...
| int | [flash\_area\_sectors](#ga12064d388369a504b571e9776201f688) (const struct [flash\_area](structflash__area.md) \*fa, [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \*count, struct [flash\_sector](structflash__sector.md) \*sectors) |
|  | Retrieve info about sectors within the area. |
...
## [◆ ](#ga5682b688b50fd2cac3c6c8045e64107e)FIXED\_PARTITION

| #define FIXED\_PARTITION | ( |  | *label* | ) |  |
| --- | --- | --- | --- | --- | --- |

`#include <[zephyr/storage/flash_map.h](flash__map_8h.md)>`

**Value:**

FIXED\_PARTITION\_1([DT\_NODELABEL](group__devicetree-generic-id.md#gab7d23294a6bf7fd44a98b48ec47d8a79)(label))
...
Returns
:   Pointer to [flash\_area](structflash__area.md "Flash partition.") type object representing partition

## [◆ ](#gab51fb05a2cd0666b892d90ccbc9de342)FIXED\_PARTITION\_BY\_NODE

| #define FIXED\_PARTITION\_BY\_NODE | ( |  | *node* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gad64fb220f82870acce62661bfa94991a)FIXED\_PARTITION\_NODE\_DEVICE

| #define FIXED\_PARTITION\_NODE\_DEVICE | ( |  | *node* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[DEVICE\_DT\_GET](group__device__model.md#ga9a65996ce21f43acb7db061e23b48ec7)([DT\_MTD\_FROM\_FIXED\_PARTITION](group__devicetree-fixed-partition.md#ga3484bb9a0cd8c2a4d971989dc58c194e)(node))
...
## [◆ ](#gaf26b80f089d25283c01ed54b5a27988c)FIXED\_PARTITION\_NODE\_OFFSET

| #define FIXED\_PARTITION\_NODE\_OFFSET | ( |  | *node* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[DT\_REG\_ADDR](group__devicetree-reg-prop.md#gac6d8279c32351ced4c0ac7f32270974e)(node)
...
## [◆ ](#ga526459438c6de09abb727585d22b7004)FIXED\_PARTITION\_NODE\_SIZE

| #define FIXED\_PARTITION\_NODE\_SIZE | ( |  | *node* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
[DT\_REG\_SIZE](group__devicetree-reg-prop.md#gad223efc6c77d008e55c3588953e85bfb)(node)
...
## [◆ ](#gaa50bb1b455a9004f9c24e4af9fd74cd7)flash\_area\_copy()

| int flash\_area\_copy | ( | const struct [flash\_area](structflash__area.md) \* | *src\_fa*, |
| --- | --- | --- | --- |
|  |  | [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) | *src\_off*, |
|  |  | const struct [flash\_area](structflash__area.md) \* | *dst\_fa*, |
|  |  | [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) | *dst\_off*, |
|  |  | [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) | *len*, |
...
For more information, see [flash\_copy()](group__flash__interface.md#ga847407358a20d3d5918d8ef11657ce2b "Copy flash memory from one device to another.").

Parameters
:   | [in] | src\_fa | Source Flash area |
    | --- | --- | --- |
    | [in] | src\_off | Offset relative from beginning of source flash area. |
    | [in] | dst\_fa | Destination Flash area |
    | [in] | dst\_off | Offset relative from beginning of destination flash area. |
    | [in] | len | Number of bytes to copy, in bytes. |
    | [out] | buf | Pointer to a buffer of size *buf\_size*. |
    | [in] | buf\_size | Size of the buffer pointed to by *buf*. |

Returns
:   0 on success, negative errno code on fail.

## [◆ ](#ga7adf79769378ed468df6d3ffef5e02a9)flash\_area\_device\_is\_ready()

| | [ALWAYS\_INLINE](include_2zephyr_2toolchain_2common_8h.md#aa1dec568e79152c892dcf63f445cbd7a) [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) flash\_area\_device\_is\_ready | ( | const struct [flash\_area](structflash__area.md) \* | *fa* | ) |  | | --- | --- | --- | --- | --- | --- | | static |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
This can be used with struct [flash\_area](structflash__area.md "Flash partition.") pointers captured from [FIXED\_PARTITION()](#ga5682b688b50fd2cac3c6c8045e64107e). At minimum this means that the device has been successfully initialized.

Parameters
:   | fa | pointer to [flash\_area](structflash__area.md "Flash partition.") object to check. |
    | --- | --- |

Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | If the device is ready for use. |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | If the device is not ready for use or if a NULL pointer is passed as flash area pointer or device pointer within flash area object is NULL. |
...
## [◆ ](#gafd097d05f5bfe91695bc7793e82cabcd)flash\_area\_flatten()

| int flash\_area\_flatten | ( | const struct [flash\_area](structflash__area.md) \* | *fa*, |
| --- | --- | --- | --- |
|  |  | [off\_t](lib_2libc_2minimal_2include_2sys_2types_8h.md#a98a5cc5f4a350bf5652565021a2f239f) | *off*, |
|  |  | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | *len* ) |
...
See also
:   [flash\_area\_erase()](#gacc5cbff19d23773115f3334f862814d2)
:   [flash\_flatten()](group__flash__interface.md#ga11eda0cdc7be12636a90d2e8c7264e4a "Erase part or all of a flash memory or level it.")
...
## [◆ ](#ga12064d388369a504b571e9776201f688)flash\_area\_sectors()

| int flash\_area\_sectors | ( | const struct [flash\_area](structflash__area.md) \* | *fa*, |
| --- | --- | --- | --- |
|  |  | [uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f) \* | *count*, |
|  |  | struct [flash\_sector](structflash__sector.md) \* | *sectors* ) |
