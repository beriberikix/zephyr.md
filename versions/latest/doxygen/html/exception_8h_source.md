---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/exception_8h_source.html
...
21#elif defined(CONFIG\_RISCV)

22#include <[zephyr/arch/riscv/exception.h](riscv_2exception_8h.md)>

23#elif defined(CONFIG\_XTENSA)

24#include <[zephyr/arch/xtensa/exception.h](xtensa_2exception_8h.md)>

25#elif defined(CONFIG\_MIPS)

26#include <[zephyr/arch/mips/exception.h](mips_2exception_8h.md)>

27#elif defined(CONFIG\_ARCH\_POSIX)

28#include <[zephyr/arch/posix/exception.h](posix_2exception_8h.md)>

29#elif defined(CONFIG\_SPARC)

30#include <[zephyr/arch/sparc/exception.h](sparc_2exception_8h.md)>

31#elif defined(CONFIG\_RX)

32#include <[zephyr/arch/rx/exception.h](rx_2exception_8h.md)>
