---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__dns__sd.html
...
| Data Structures | |
| --- | --- |
| struct | [dns\_sd\_rec](structdns__sd__rec.md) |
|  | DNS Service Discovery record. [More...](structdns__sd__rec.md#details) |
...
| Functions | |
| --- | --- |
| static [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [dns\_sd\_txt\_size](#ga6d68e785607089df42d534c2f876c6d5) (const struct [dns\_sd\_rec](structdns__sd__rec.md) \*rec) |
|  | Obtain the size of DNS-SD TXT data. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [dns\_sd\_is\_service\_type\_enumeration](#gaeba098fa6d159067c70588cb60056277) (const struct [dns\_sd\_rec](structdns__sd__rec.md) \*rec) |
|  | Check if *rec* is a DNS-SD Service Type Enumeration. |
| void | [dns\_sd\_create\_wildcard\_filter](#ga328d71e26411460b1b329db8f1ebd37b) (struct [dns\_sd\_rec](structdns__sd__rec.md) \*filter) |
...
`#include <[zephyr/net/dns_sd.h](dns__sd_8h.md)>`
...
static const [STRUCT\_SECTION\_ITERABLE](group__iterable__section__apis.md#ga9104f42cbe4a67a931bed7f7cc8f600f)([dns\_sd\_rec](structdns__sd__rec.md), \_id) = { \
...
"\_foo", "local", [DNS\_SD\_EMPTY\_TXT](#ga221216c5ffd142aa4c6cade4064d580f), 4242);
...
| void dns\_sd\_create\_wildcard\_filter | ( | struct [dns\_sd\_rec](structdns__sd__rec.md) \* | *filter* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) dns\_sd\_is\_service\_type\_enumeration | ( | const struct [dns\_sd\_rec](structdns__sd__rec.md) \* | *rec* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| | [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) dns\_sd\_txt\_size | ( | const struct [dns\_sd\_rec](structdns__sd__rec.md) \* | *rec* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
