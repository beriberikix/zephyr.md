---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__lora__api.html
...
| static int | [lora\_recv\_async](#gafeae6fa9d81508023665705bf16b6435) (const struct [device](structdevice.md) \*dev, lora\_recv\_cb cb, void \*user\_data) |
...
`#include <[zephyr/drivers/lora.h](lora_8h.md)>`
...
## [◆ ](#gafeae6fa9d81508023665705bf16b6435)lora\_recv\_async()

| | int lora\_recv\_async | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | lora\_recv\_cb | *cb*, | |  |  | void \* | *user\_data* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
