---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/doxygen/html/shell__websocket_8h.html
...
| Functions | |
| --- | --- |
| int | [shell\_websocket\_setup](#a3b510cbaf4d17fc6aa4202a692c89627) (int ws\_socket, struct [http\_request\_ctx](structhttp__request__ctx.md) \*request\_ctx, void \*user\_data) |
...
.cb = [shell\_websocket\_setup](#a3b510cbaf4d17fc6aa4202a692c89627), \
...
[shell\_websocket\_setup](#a3b510cbaf4d17fc6aa4202a692c89627)
...
| int shell\_websocket\_enable | ( | const struct [shell](structshell.md) \* | *sh* | ) |  |
| --- | --- | --- | --- | --- | --- |

## [◆ ](#a3b510cbaf4d17fc6aa4202a692c89627)shell\_websocket\_setup()

| int shell\_websocket\_setup | ( | int | *ws\_socket*, |
| --- | --- | --- | --- |
|  |  | struct [http\_request\_ctx](structhttp__request__ctx.md) \* | *request\_ctx*, |
|  |  | void \* | *user\_data* ) |
