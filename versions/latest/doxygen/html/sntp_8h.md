---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/sntp_8h.html
...
`#include <[zephyr/net/socket_service.h](socket__service_8h_source.md)>`
...
| int | [sntp\_init\_async](group__sntp.md#ga3a45c2b5af5e30b5cbd153368fc7ec3d) (struct [sntp\_ctx](structsntp__ctx.md) \*ctx, struct [sockaddr](structsockaddr.md) \*addr, [socklen\_t](group__ip__4__6.md#gacf0ed818b0a3c85ff6a9206679d6d91a) addr\_len, const struct [net\_socket\_service\_desc](structnet__socket__service__desc.md) \*service) |
|  | Initialise SNTP context for async operation. |
| int | [sntp\_send\_async](group__sntp.md#gab6adcd7259bdfa841b57e535c380508d) (struct [sntp\_ctx](structsntp__ctx.md) \*ctx) |
|  | Send the SNTP query. |
| int | [sntp\_read\_async](group__sntp.md#gac73db957041a6814abb286fd9143ddb5) (struct [net\_socket\_service\_event](structnet__socket__service__event.md) \*event, struct [sntp\_time](structsntp__time.md) \*ts) |
|  | Read the result of the SNTP query. |
| void | [sntp\_close\_async](group__sntp.md#gaeb595e89c56fbb619010e3c8d7b2b5b1) (const struct [net\_socket\_service\_desc](structnet__socket__service__desc.md) \*service) |
|  | Release SNTP context. |
