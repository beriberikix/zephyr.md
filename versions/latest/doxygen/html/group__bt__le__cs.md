---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__bt__le__cs.html
...
| enum | [bt\_le\_cs\_snr\_control](#gaf34c59887e8a6da0560b6428733fe8d0) {     [BT\_LE\_CS\_SNR\_CONTROL\_18dB](#ggaf34c59887e8a6da0560b6428733fe8d0a78af4f3bbf5adfc8ee6f9d459bb96e7d) = BT\_HCI\_OP\_LE\_CS\_SNR\_18 , [BT\_LE\_CS\_SNR\_CONTROL\_21dB](#ggaf34c59887e8a6da0560b6428733fe8d0a685a458547bda6af6c88626ee08c4110) = BT\_HCI\_OP\_LE\_CS\_SNR\_21 , [BT\_LE\_CS\_SNR\_CONTROL\_24dB](#ggaf34c59887e8a6da0560b6428733fe8d0a02394d7394f79a6e91a8f81070fdf82e) = BT\_HCI\_OP\_LE\_CS\_SNR\_24 , [BT\_LE\_CS\_SNR\_CONTROL\_27dB](#ggaf34c59887e8a6da0560b6428733fe8d0a43a7b210424a2aa2830a07676d3499b8) = BT\_HCI\_OP\_LE\_CS\_SNR\_27 ,     [BT\_LE\_CS\_SNR\_CONTROL\_30dB](#ggaf34c59887e8a6da0560b6428733fe8d0a18bb25e63782e9993a3853d929d58ee1) = BT\_HCI\_OP\_LE\_CS\_SNR\_30 , [BT\_LE\_CS\_SNR\_CONTROL\_NOT\_USED](#ggaf34c59887e8a6da0560b6428733fe8d0a1a5c531f590f14773b7ddc9b0ec8cae9) = BT\_HCI\_OP\_LE\_CS\_SNR\_NOT\_USED   } |
|  | CS SNR control options. [More...](#gaf34c59887e8a6da0560b6428733fe8d0) |
...
| enum | [bt\_le\_cs\_procedure\_phy](#ga9e008daa9c0c1702aa3b4479e7a37ca4) { [BT\_LE\_CS\_PROCEDURE\_PHY\_1M](#gga9e008daa9c0c1702aa3b4479e7a37ca4aa1dcc1e15aac59898c0a6c229593a76b) = BT\_HCI\_OP\_LE\_CS\_PROCEDURE\_PHY\_1M , [BT\_LE\_CS\_PROCEDURE\_PHY\_2M](#gga9e008daa9c0c1702aa3b4479e7a37ca4a072649a66bf1260ce37bd16fc7a9185d) = BT\_HCI\_OP\_LE\_CS\_PROCEDURE\_PHY\_2M , [BT\_LE\_CS\_PROCEDURE\_PHY\_CODED\_S8](#gga9e008daa9c0c1702aa3b4479e7a37ca4a1ceb33afa661774e1077caced63bf263) = BT\_HCI\_OP\_LE\_CS\_PROCEDURE\_PHY\_CODED\_S8 , [BT\_LE\_CS\_PROCEDURE\_PHY\_CODED\_S2](#gga9e008daa9c0c1702aa3b4479e7a37ca4a5370237bdbceb37a631425f472ddc322) = BT\_HCI\_OP\_LE\_CS\_PROCEDURE\_PHY\_CODED\_S2 } |
...
| int | [bt\_le\_cs\_write\_cached\_remote\_fae\_table](#ga63aa61d2bd3cf9ecb3ea9f1d02bb5b8c) (struct bt\_conn \*conn, [int8\_t](stdint_8h.md#accbd6432732c88ad6adc5365800433b6) remote\_fae\_table[72]) |
|  | CS Write Cached Remote FAE Table. |
| int | [bt\_le\_cs\_get\_antenna\_path](#gaa9126eca834eee8e088d01295d4cf94f) ([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) n\_ap, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) antenna\_path\_permutation\_index, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) tone\_index) |
...
`#include <[zephyr/bluetooth/cs.h](cs_8h.md)>`
...
## [◆ ](#gaf34c59887e8a6da0560b6428733fe8d0)bt\_le\_cs\_snr\_control
...
| BT\_LE\_CS\_TEST\_OVERRIDE\_4\_ANTENNA\_PERMUTATION\_INDEX\_LOOP | Loop through all valid Antenna Permutation Indices starting from the lowest index. |
...
## [◆ ](#gaa9126eca834eee8e088d01295d4cf94f)bt\_le\_cs\_get\_antenna\_path()

| int bt\_le\_cs\_get\_antenna\_path | ( | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *n\_ap*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *antenna\_path\_permutation\_index*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *tone\_index* ) |

`#include <[zephyr/bluetooth/cs.h](cs_8h.md)>`

Get antenna path used for the CS tone exchange when using multiple antenna paths for mode-2 or mode-3 CS procedure.

The function implements antenna path permutation defined in Bluetooth Core Specification 6.0, Vol. 6, Part H, Section 4.7.5.

Note
:   To use this API `CONFIG_BT_CHANNEL_SOUNDING` must be set.

Parameters
:   | n\_ap | The number of antenna paths, range: [1, 4]. |
    | --- | --- |
    | antenna\_path\_permutation\_index | Antenna Path Permutation Index. |
    | tone\_index | Index of the tone in the CS step, range [0, n\_ap]. tone\_index = n\_ap corresponds to extension slot. |

Returns
:   Antenna path used to exchange CS tones, range: [0, 3].
...
If the remote controller supports a Frequency Actuation Error of zero relative to its mode-0 transmissions in the reflector role (see [bt\_conn\_le\_cs\_capabilities::cs\_without\_fae\_supported](structbt__conn__le__cs__capabilities.md#a22604c052da2f8ccf77c81a0a5c628b7 "bt_conn_le_cs_capabilities::cs_without_fae_supported")), calling this function is not needed and the read remote FAE table complete event will be generated with an error code.
...
Note
:   To use this API `CONFIG_BT_CHANNEL_SOUNDING_TEST` must be set.
...
## [◆ ](#ga63aa61d2bd3cf9ecb3ea9f1d02bb5b8c)bt\_le\_cs\_write\_cached\_remote\_fae\_table()

| int bt\_le\_cs\_write\_cached\_remote\_fae\_table | ( | struct bt\_conn \* | *conn*, |
| --- | --- | --- | --- |
|  |  | [int8\_t](stdint_8h.md#accbd6432732c88ad6adc5365800433b6) | *remote\_fae\_table*[72] ) |
...
If the remote controller supports a Frequency Actuation Error of zero relative to its mode-0 transmissions in the reflector role (see [bt\_conn\_le\_cs\_capabilities::cs\_without\_fae\_supported](structbt__conn__le__cs__capabilities.md#a22604c052da2f8ccf77c81a0a5c628b7 "bt_conn_le_cs_capabilities::cs_without_fae_supported")), calling this function is not needed. An error code will be returned.
