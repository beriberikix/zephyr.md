---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__timeutil__unit__apis.html
...
| #define | [SYS\_TIMEOUT\_MS\_INIT](#gaca39a49322d7498accbdfa872b274a34)(ms) |
|  | System-wide macro to initialize [k\_timeout\_t](structk__timeout__t.md "Kernel timeout type.") with a number of ticks converted from milliseconds. |
...
`#include <[zephyr/sys/time_units.h](time__units_8h.md)>`
...
([uint32\_t](stdint_8h.md#a0a8582351ac627ee8bde2973c825e47f))CONFIG\_SYS\_CLOCK\_HW\_CYCLES\_PER\_SEC
...
(([k\_timeout\_t](structk__timeout__t.md)) [SYS\_TIMEOUT\_MS\_INIT](#gaca39a49322d7498accbdfa872b274a34)(ms))

[SYS\_TIMEOUT\_MS\_INIT](#gaca39a49322d7498accbdfa872b274a34)

#define SYS\_TIMEOUT\_MS\_INIT(ms)

System-wide macro to initialize k\_timeout\_t with a number of ticks converted from milliseconds.

**Definition** time\_units.h:44
...
## [◆ ](#gaca39a49322d7498accbdfa872b274a34)SYS\_TIMEOUT\_MS\_INIT
...
Z\_TIMEOUT\_TICKS\_INIT((ms) == [SYS\_FOREVER\_MS](#ga9f9c4c41f62c7578a30209475201efed) ? \
