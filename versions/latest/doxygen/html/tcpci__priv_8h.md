---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/tcpci__priv_8h.html
...
| #define | [PD\_INT\_REV10](#afdb5a5ec3c04cba9b8ec1eec1195156c)   0x10 /\* Revision 1.0 \*/ |
|  | Type-C Port Controller Interface Specification Revision. |
| #define | [PD\_INT\_REV20](#afe46df9f6080d8f5070f0bc81b68a6b6)   0x20 /\* Revision 2.0 \*/ |
...
| int | [tcpci\_tcpm\_set\_drp\_toggle](#a3da565a529db5a6d337cf7f8642be8ab) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) pd\_int\_rev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
...
| int | [tcpci\_tcpm\_get\_snk\_ctrl](#a338bd0bfb0df0fa3e4004dce85a7336b) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \*sinking) |
|  | Queries the current sinking state of the TCPCI. |
| int | [tcpci\_tcpm\_get\_src\_ctrl](#a9be63be44b19198cd8d49f95e971ee6d) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \*sourcing) |
|  | Queries the current sourcing state of the TCPCI. |
| int | [tcpci\_tcpm\_set\_snk\_ctrl](#ac6848fa7e70af270d4471309589100f4) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
|  | Function to enable or disable sinking power over VBUS. |
| int | [tcpci\_tcpm\_set\_src\_ctrl](#aadac3408a1aea5e56c2578f3843c032a) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
|  | Function to enable or disable sourcing power over VBUS. |
| int | [tcpci\_tcpm\_set\_debug\_accessory](#a269a35fb98ec53dba41fa53c78683ae2) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
|  | Function to enable or disable the debug accessory mode. |
| int | [tcpci\_tcpm\_set\_low\_power\_mode](#aa86dd25de3d91ac61abc06f0c734046f) (const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \*bus, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) enable) |
...
## [◆ ](#afdb5a5ec3c04cba9b8ec1eec1195156c)PD\_INT\_REV10

| #define PD\_INT\_REV10   0x10 /\* Revision 1.0 \*/ |
| --- |

Type-C Port Controller Interface Specification Revision.

## [◆ ](#afe46df9f6080d8f5070f0bc81b68a6b6)PD\_INT\_REV20

| #define PD\_INT\_REV20   0x20 /\* Revision 2.0 \*/ |
| --- |
...
## [◆ ](#a338bd0bfb0df0fa3e4004dce85a7336b)tcpci\_tcpm\_get\_snk\_ctrl()

| int tcpci\_tcpm\_get\_snk\_ctrl | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \* | *sinking* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | sinking | Pointer to variable where sinking state will be stored |

Returns
:   int Status of I2C operation, 0 in case of success

## [◆ ](#a9be63be44b19198cd8d49f95e971ee6d)tcpci\_tcpm\_get\_src\_ctrl()

| int tcpci\_tcpm\_get\_src\_ctrl | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) \* | *sourcing* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | sourcing | Pointer to variable where sourcing state will be stored |
...
## [◆ ](#a269a35fb98ec53dba41fa53c78683ae2)tcpci\_tcpm\_set\_debug\_accessory()

| int tcpci\_tcpm\_set\_debug\_accessory | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *enable* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | enable | Boolean flag to enable (true) or disable (false) debug accessory mode |

Returns
:   int Status of I2C operation, 0 in case of success

## [◆ ](#a3da565a529db5a6d337cf7f8642be8ab)tcpci\_tcpm\_set\_drp\_toggle()

| int tcpci\_tcpm\_set\_drp\_toggle | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *pd\_int\_rev*, |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *enable* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | pd\_int\_rev | Value of the TCPC\_REG\_PD\_INT\_REV bits [15..8] |
    | enable | Boolean flag to enable (true) or disable (false) DRP toggle mode |

Returns
:   int Status of I2C operation, 0 in case of success

## [◆ ](#aa86dd25de3d91ac61abc06f0c734046f)tcpci\_tcpm\_set\_low\_power\_mode()

| int tcpci\_tcpm\_set\_low\_power\_mode | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *enable* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | enable | Boolean flag to enable (true) or disable (false) low power mode |
...
## [◆ ](#ac6848fa7e70af270d4471309589100f4)tcpci\_tcpm\_set\_snk\_ctrl()

| int tcpci\_tcpm\_set\_snk\_ctrl | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *enable* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | enable | Boolean flag to enable (true) or disable (false) sinking power |

Returns
:   int Status of I2C operation, 0 in case of success

## [◆ ](#aadac3408a1aea5e56c2578f3843c032a)tcpci\_tcpm\_set\_src\_ctrl()

| int tcpci\_tcpm\_set\_src\_ctrl | ( | const struct [i2c\_dt\_spec](structi2c__dt__spec.md) \* | *bus*, |
| --- | --- | --- | --- |
|  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *enable* ) |
...
:   | bus | I2C bus |
    | --- | --- |
    | enable | Boolean flag to enable (true) or disable (false) sourcing power |
