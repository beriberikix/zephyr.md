---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i3c__transfer__api.html
...
The array of message `msgs` must not be [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4). The number of message `num_msgs` may be zero, in which case no transfer occurs.
