---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i3c__interface.html
...
| static int | [i3c\_configure\_controller](#gaeca24930774ecc2dcbf2240d48ae19c5) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_controller](structi3c__config__controller.md) \*config) |
|  | Get the controller device configuration for an I3C device. |
| static int | [i3c\_configure\_target](#ga7dfa33c7bdbe7e6607af61fe04bcb985) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_target](structi3c__config__target.md) \*config) |
...
| static int | [i3c\_config\_get\_controller](#ga96cd903b4a676c5943c43cc7b27af867) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_controller](structi3c__config__controller.md) \*config) |
|  | Get the controller device configuration for an I3C device. |
| static int | [i3c\_config\_get\_target](#ga8ef11af673e94646806e093504cfb01f) (const struct [device](structdevice.md) \*dev, struct [i3c\_config\_target](structi3c__config__target.md) \*config) |
|  | Get the target device configuration for an I3C device. |
...
| int | [i3c\_bus\_rstdaa\_all](#ga14ec397e1c82b79302f7eff6022660ae) (const struct [device](structdevice.md) \*dev) |
|  | Reset all devices on the bus and clear their dynamic addresses. |
| int | [i3c\_bus\_setdasa](#ga2ae8b79140ddceebd071e0891a0ac824) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dynamic\_addr) |
|  | Assign a dynamic address to a device using its static address. |
| int | [i3c\_bus\_setnewda](#ga55ba4babddb31ed83ad3fab5adce2f18) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) dynamic\_addr) |
|  | Assign a new dynamic address to a device. |
| int | [i3c\_bus\_setaasa](#gab6735824952836a1ac06745b21e2b534) (const struct [device](structdevice.md) \*dev) |
|  | Assign static addresses as dynamic addresses for all devices on the bus. |
| int | [i3c\_bus\_getbcr](#gac8c0ec6eb11030183be10fb541e1e561) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Bus Characteristics Register (BCR) of a device. |
| int | [i3c\_bus\_getdcr](#gaab2801ccc00e9891269709ecc34f4f7c) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Device Characteristics Register (DCR) of a device. |
| int | [i3c\_bus\_getpid](#ga129bab2c352fd08b62c352d916c7307c) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Provisional ID (PID) of a device. |
| int | [i3c\_bus\_getmrl](#ga5483ce25f70cae032ed5935483102c0f) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Maximum Read Length (MRL) of a device. |
| int | [i3c\_bus\_getmwl](#ga8d4da712075ee05896bcd7dde49cd827) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Retrieve the Maximum Write Length (MWL) of a device. |
| int | [i3c\_bus\_setmrl](#ga6fbb9bec228b7dc310c5724c3530bebd) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mrl, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) ibi\_len) |
|  | Set the Maximum Read Length (MRL) for a device. |
| int | [i3c\_bus\_setmwl](#ga8002de8239c4a0d1178fba27092a1254) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mwl) |
|  | Set the Maximum Write Length (MWL) for a device. |
| int | [i3c\_bus\_setmrl\_all](#ga28278e90417b01d7cb18a301f906f6ae) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mrl, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) ibi\_len, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) has\_ibi\_size) |
|  | Set the Maximum Read Length (MRL) for all devices on the bus. |
| int | [i3c\_bus\_setmwl\_all](#gad3a4bf3cfc1b150c19ff1186cc8e3e2a) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) mwl) |
|  | Set the Maximum Write Length (MWL) for all devices on the bus. |
| int | [i3c\_bus\_getacccr](#ga8d4356b56d8414e62b5a9931ffc7ab8b) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
...
| int | [i3c\_device\_controller\_handoff](#gaedf58fdd96f38f103f8defe221427b6f) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) requested) |
|  | Perform Controller Handoff. |
| void | [i3c\_sec\_handoffed](#ga221ab7abe735ddee881c002b934ee138) (struct [k\_work](structk__work.md) \*work) |
|  | Call back for when Controllership is Handoffed to itself. |
| struct [i3c\_device\_desc](structi3c__device__desc.md) \* | [i3c\_device\_desc\_alloc](#gab8e12d10528686040707f4aae502df98) (void) |
|  | Allocate memory for a i3c device descriptor. |
| void | [i3c\_device\_desc\_free](#ga25bfef54bb7bdc387ce0997ed0120739) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Free memory from a i3c device descriptor. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i3c\_device\_desc\_in\_pool](#gaf2c8afec987322be8dfd4fb053fac61b) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*desc) |
|  | Report if the i3c device descriptor was from a mem slab. |
| struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* | [i3c\_i2c\_device\_desc\_alloc](#ga16b9ba6480ac807ff8b9268d6cffa577) (void) |
|  | Allocate memory for a i3c i2c device descriptor. |
| void | [i3c\_i2c\_device\_desc\_free](#ga61ead89539fe3556f5e6e30eae5e71a3) (struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \*desc) |
|  | Free memory from a i3c i2c device descriptor. |
| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | [i3c\_i2c\_device\_desc\_in\_pool](#gabfebceaa3e6f6f255352b8dcc3e7f9b1) (struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \*desc) |
...
`#include <[zephyr/drivers/i3c.h](i3c_8h.md)>`
...
## [◆ ](#ga8d4356b56d8414e62b5a9931ffc7ab8b)i3c\_bus\_getacccr()

| int i3c\_bus\_getacccr | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | desc | Pointer to the target device descriptor. |
    | --- | --- |
...
## [◆ ](#gac8c0ec6eb11030183be10fb541e1e561)i3c\_bus\_getbcr()

| int i3c\_bus\_getbcr | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gaab2801ccc00e9891269709ecc34f4f7c)i3c\_bus\_getdcr()

| int i3c\_bus\_getdcr | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga5483ce25f70cae032ed5935483102c0f)i3c\_bus\_getmrl()

| int i3c\_bus\_getmrl | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga8d4da712075ee05896bcd7dde49cd827)i3c\_bus\_getmwl()

| int i3c\_bus\_getmwl | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga129bab2c352fd08b62c352d916c7307c)i3c\_bus\_getpid()

| int i3c\_bus\_getpid | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga14ec397e1c82b79302f7eff6022660ae)i3c\_bus\_rstdaa\_all()

| int i3c\_bus\_rstdaa\_all | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
Parameters
:   | dev | Pointer to the controller device driver instance. |
    | --- | --- |
...
## [◆ ](#gab6735824952836a1ac06745b21e2b534)i3c\_bus\_setaasa()

| int i3c\_bus\_setaasa | ( | const struct [device](structdevice.md) \* | *dev* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga2ae8b79140ddceebd071e0891a0ac824)i3c\_bus\_setdasa()

| int i3c\_bus\_setdasa | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dynamic\_addr* ) |
...
:   | desc | Pointer to the target device descriptor. |
    | --- | --- |
    | dynamic\_addr | The dynamic address to assign to the device. |

Return values
:   | 0 | If successful. |
    | --- | --- |
    | -EADDRNOTAVAIL | If the address is not available. |
    | -EIO | General Input/Output error. |

## [◆ ](#ga6fbb9bec228b7dc310c5724c3530bebd)i3c\_bus\_setmrl()

| int i3c\_bus\_setmrl | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc*, |
| --- | --- | --- | --- |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *mrl*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *ibi\_len* ) |
...
:   | desc | Pointer to the target device descriptor. |
    | --- | --- |
    | mrl | Maximum read length to set. |
    | ibi\_len | Maximum IBI length to set. |
...
## [◆ ](#ga28278e90417b01d7cb18a301f906f6ae)i3c\_bus\_setmrl\_all()

| int i3c\_bus\_setmrl\_all | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *mrl*, |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *ibi\_len*, |
...
:   | dev | Pointer to the controller device driver instance. |
    ...
    | mrl | Maximum read length to set. |
    | ibi\_len | Maximum IBI length to set. |
    | has\_ibi\_size | True if to transmit max ibi len |
...
## [◆ ](#ga8002de8239c4a0d1178fba27092a1254)i3c\_bus\_setmwl()

| int i3c\_bus\_setmwl | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc*, |
| --- | --- | --- | --- |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *mwl* ) |
...
:   | desc | Pointer to the target device descriptor. |
    | --- | --- |
    | mwl | Maximum write length to set. |
...
## [◆ ](#gad3a4bf3cfc1b150c19ff1186cc8e3e2a)i3c\_bus\_setmwl\_all()

| int i3c\_bus\_setmwl\_all | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
|  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *mwl* ) |
...
## [◆ ](#ga55ba4babddb31ed83ad3fab5adce2f18)i3c\_bus\_setnewda()

| int i3c\_bus\_setnewda | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc*, |
| --- | --- | --- | --- |
|  |  | [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | *dynamic\_addr* ) |
...
:   | desc | Pointer to the target device descriptor. |
    | --- | --- |
    | dynamic\_addr | The new dynamic address to assign to the device. |
...
## [◆ ](#ga96cd903b4a676c5943c43cc7b27af867)i3c\_config\_get\_controller()

| | int i3c\_config\_get\_controller | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | struct [i3c\_config\_controller](structi3c__config__controller.md) \* | *config* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This function sets the configuration parameters specific to an I3C controller device. It is a type-safe wrapper around [i3c\_config\_get](#ga807877923755aeb5a065e054fb42946d) that ensures the correct structure type is passed.

Parameters
:   | [in] | dev | Pointer to the I3C controller device instance. |
    | --- | --- | --- |
    | [out] | config | Pointer to a [i3c\_config\_controller](structi3c__config__controller.md "i3c_config_controller") structure where the configuration will be used. |
...
## [◆ ](#ga8ef11af673e94646806e093504cfb01f)i3c\_config\_get\_target()

| | int i3c\_config\_get\_target | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | struct [i3c\_config\_target](structi3c__config__target.md) \* | *config* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This function sets the configuration parameters specific to an I3C target device. It is a type-safe wrapper around [i3c\_config\_get](#ga807877923755aeb5a065e054fb42946d) that ensures the correct structure type is passed.

Parameters
:   | [in] | dev | Pointer to the I3C controller device instance. |
    | --- | --- | --- |
    | [out] | config | Pointer to a [i3c\_config\_target](structi3c__config__target.md "i3c_config_target") structure where the configuration will be used. |
...
## [◆ ](#gaeca24930774ecc2dcbf2240d48ae19c5)i3c\_configure\_controller()

| | int i3c\_configure\_controller | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | struct [i3c\_config\_controller](structi3c__config__controller.md) \* | *config* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This function retrieves the configuration parameters specific to an I3C controller device. It is a type-safe wrapper around [i3c\_config\_get](#ga807877923755aeb5a065e054fb42946d) that ensures the correct structure type is passed.

Parameters
:   | dev | Pointer to the I3C controller device instance. |
    | --- | --- |
    | config | Pointer to a [i3c\_config\_controller](structi3c__config__controller.md "i3c_config_controller") structure where the configuration will be stored. |
...
## [◆ ](#ga7dfa33c7bdbe7e6607af61fe04bcb985)i3c\_configure\_target()

| | int i3c\_configure\_target | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | struct [i3c\_config\_target](structi3c__config__target.md) \* | *config* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This function retrieves the configuration parameters specific to an I3C target device. It is a type-safe wrapper around [i3c\_config\_get](#ga807877923755aeb5a065e054fb42946d) that ensures the correct structure type is passed.

Parameters
:   | dev | Pointer to the I3C controller device instance. |
    | --- | --- |
    | config | Pointer to a [i3c\_config\_target](structi3c__config__target.md "i3c_config_target") structure where the configuration will be stored. |
...
## [◆ ](#gaedf58fdd96f38f103f8defe221427b6f)i3c\_device\_controller\_handoff()

| int i3c\_device\_controller\_handoff | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *target*, |
| --- | --- | --- | --- |
...
## [◆ ](#gab8e12d10528686040707f4aae502df98)i3c\_device\_desc\_alloc()

| struct [i3c\_device\_desc](structi3c__device__desc.md) \* i3c\_device\_desc\_alloc | ( | void |  | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This allocates memory from a mem slab for a [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.")

Return values
:   | Pointer | to allocated [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.") |
    | --- | --- |
    | [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4) | if no mem slabs available |

## [◆ ](#ga25bfef54bb7bdc387ce0997ed0120739)i3c\_device\_desc\_free()

| void i3c\_device\_desc\_free | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This frees memory from a mem slab of a [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.")

Parameters
:   | desc | Pointer to allocated [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.") |
    | --- | --- |

## [◆ ](#gaf2c8afec987322be8dfd4fb053fac61b)i3c\_device\_desc\_in\_pool()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) i3c\_device\_desc\_in\_pool | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This reports if the [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.") was from a memory slab

Parameters
:   | desc | Pointer to a [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device.") |
    | --- | --- |

Returns
:   True if from a memory slab, False if not
...
## [◆ ](#ga16b9ba6480ac807ff8b9268d6cffa577)i3c\_i2c\_device\_desc\_alloc()

| struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* i3c\_i2c\_device\_desc\_alloc | ( | void |  | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This allocates memory from a mem slab for a [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.")

Returns
:   Pointer to allocated [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus."), NULL if none available

## [◆ ](#ga61ead89539fe3556f5e6e30eae5e71a3)i3c\_i2c\_device\_desc\_free()

| void i3c\_i2c\_device\_desc\_free | ( | struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This frees memory from a mem slab of a [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.")

Parameters
:   | desc | Pointer to allocated [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.") |
    | --- | --- |

## [◆ ](#gabfebceaa3e6f6f255352b8dcc3e7f9b1)i3c\_i2c\_device\_desc\_in\_pool()

| [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) i3c\_i2c\_device\_desc\_in\_pool | ( | struct [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md) \* | *desc* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This reports if the [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.") was from a memory slab

Parameters
:   | desc | Pointer to a [i3c\_i2c\_device\_desc](structi3c__i2c__device__desc.md "Structure describing a I2C device on I3C bus.") |
    | --- | --- |
...
## [◆ ](#ga221ab7abe735ddee881c002b934ee138)i3c\_sec\_handoffed()

| void i3c\_sec\_handoffed | ( | struct [k\_work](structk__work.md) \* | *work* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This reads the DEFTGTS it received earlier and processes it by reading the PIDs of all the devices with GETPID and then matching it with known PIDS. If it does not match, then it will attempt to grab a mem slab for [i3c\_device\_desc](structi3c__device__desc.md "Structure describing a I3C target device."). It will then obtain the standard I3C information from the device.
