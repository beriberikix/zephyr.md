---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/doxygen/html/group__uac2__device.html
original_path: doxygen/html/group__uac2__device.html
---
...
| Macros | |
| --- | --- |
| #define | [UAC2\_ENTITY\_ID](#gaa35265e83d894896806fcca28feb84a3)(node) |
|  | Get entity ID. |

| Functions | |
| --- | --- |
| void | [usbd\_uac2\_set\_ops](#ga802a727c1a201c26a3bd74f0e7f0900c) (const struct [device](structdevice.md) \*dev, const struct [uac2\_ops](structuac2__ops.md) \*ops, void \*user\_data) |
|  | Register USB Audio 2 application callbacks. |
| int | [usbd\_uac2\_send](#gae899d75d786f5b1df86db48de88d1254) (const struct [device](structdevice.md) \*dev, [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) terminal, void \*data, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) size) |
...
## [◆ ](#gaa35265e83d894896806fcca28feb84a3)UAC2\_ENTITY\_ID

| #define UAC2\_ENTITY\_ID | ( |  | *node* | ) |  |
| --- | --- | --- | --- | --- | --- |

`#include <[usbd_uac2.h](usbd__uac2_8h.md)>`
...
## [◆ ](#gae899d75d786f5b1df86db48de88d1254)usbd\_uac2\_send()
...
## [◆ ](#ga802a727c1a201c26a3bd74f0e7f0900c)usbd\_uac2\_set\_ops()
