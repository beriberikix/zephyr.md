---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__sys__init.html
...
`#include <[zephyr/init.h](init_8h.md)>`
...
Z\_INIT\_ENTRY\_NAME(name) = {.init\_fn = (init\_fn\_), .dev = [NULL](iar__missing__defs_8h.md#a070d2ce7b6bb7e5c05602aa8c308d0c4)} \
