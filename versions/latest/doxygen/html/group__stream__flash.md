---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__stream__flash.html
...
| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) | [stream\_flash\_bytes\_written](#gadcff5388f54e0e784619c706795fe7a8) (struct [stream\_flash\_ctx](structstream__flash__ctx.md) \*ctx) |
...
| int | [stream\_flash\_progress\_save](#ga6965ef8973f281fd0507e208d1645483) (struct [stream\_flash\_ctx](structstream__flash__ctx.md) \*ctx, const char \*settings\_key) |
|  | Save persistent stream write progress using key `settings_key` . |
| int | [stream\_flash\_progress\_clear](#gafd736d9014a3c5060d5c43383d07ac59) (struct [stream\_flash\_ctx](structstream__flash__ctx.md) \*ctx, const char \*settings\_key) |
...
## [◆ ](#gadcff5388f54e0e784619c706795fe7a8)stream\_flash\_bytes\_written()

| [size\_t](retained__mem_8h.md#a36713c339c3c5ec6d6bd481480bdb6f9) stream\_flash\_bytes\_written | ( | struct [stream\_flash\_ctx](structstream__flash__ctx.md) \* | *ctx* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
## [◆ ](#gafd736d9014a3c5060d5c43383d07ac59)stream\_flash\_progress\_clear()

| int stream\_flash\_progress\_clear | ( | struct [stream\_flash\_ctx](structstream__flash__ctx.md) \* | *ctx*, |
| --- | --- | --- | --- |
...
## [◆ ](#ga6965ef8973f281fd0507e208d1645483)stream\_flash\_progress\_save()

| int stream\_flash\_progress\_save | ( | struct [stream\_flash\_ctx](structstream__flash__ctx.md) \* | *ctx*, |
| --- | --- | --- | --- |
|  |  | const char \* | *settings\_key* ) |
