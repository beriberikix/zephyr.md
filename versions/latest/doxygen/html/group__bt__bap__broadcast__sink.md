---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__bap__broadcast__sink.html
...
:   | sink | Pointer to the sink object from the base\_recv callback. |
    ...
    | broadcast\_code | The 16-octet broadcast code. Shall be supplied if the broadcast is encrypted (see [bt\_bap\_broadcast\_sink\_cb::syncable](structbt__bap__broadcast__sink__cb.md#ac2c8389a8e68e5b4afe735f623dc36ec "bt_bap_broadcast_sink_cb::syncable")). If the value is a string or a the value is less than 16 octets, the remaining octets shall be 0. |
