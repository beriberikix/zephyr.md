---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/group__bt__buf.html
...
| Macros | |
| --- | --- |
| #define | [BT\_BUF\_RESERVE](#ga41f80f3995e79982f704f832394a6bef)   CONFIG\_BT\_HCI\_RESERVE |
...
[BT\_HCI\_ISO\_TS\_DATA\_HDR\_SIZE](hci__types_8h.md#a0ad84468158c3df92d4dd2fb10771f6e) + \

(size))

[BT\_HCI\_ISO\_TS\_DATA\_HDR\_SIZE](hci__types_8h.md#a0ad84468158c3df92d4dd2fb10771f6e)

#define BT\_HCI\_ISO\_TS\_DATA\_HDR\_SIZE

**Definition** hci\_types.h:110
...
| #define BT\_BUF\_RESERVE   CONFIG\_BT\_HCI\_RESERVE |
| --- |
...
This will set the buffer type so [bt\_buf\_set\_type()](#gaec645aec3d6fb845f214c07f2a864fec) does not need to be explicitly called before [bt\_recv\_prio()](group__bt__hci__driver.md#ga19c61df1660d6049ae6b03afe3554fee "Receive high priority data from the controller/HCI driver.") or [bt\_recv()](group__bt__hci__driver.md#gaca80bc9dacc4fa44416bd545bd185ef7 "Receive data from the controller/HCI driver.").
...
This will set the buffer type so [bt\_buf\_set\_type()](#gaec645aec3d6fb845f214c07f2a864fec) does not need to be explicitly called before [bt\_recv\_prio()](group__bt__hci__driver.md#ga19c61df1660d6049ae6b03afe3554fee "Receive high priority data from the controller/HCI driver.").
...
This will set the buffer type so [bt\_buf\_set\_type()](#gaec645aec3d6fb845f214c07f2a864fec) does not need to be explicitly called before [bt\_send()](group__hci__raw.md#ga8de934e01eb9a16a3c9d096151e58313 "Send packet to the Bluetooth controller.").
