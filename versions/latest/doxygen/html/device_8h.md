---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/device_8h.html
...
| #define | [DEVICE\_DEINIT\_DEFINE](group__device__model.md#ga61d851f960a701c9d47d6167b35ac99c)(dev\_id, name, init\_fn, deinit\_fn, pm, data, config, level, prio, api) |
...
| #define | [DEVICE\_DT\_DEINIT\_DEFINE](group__device__model.md#gaa53f7267950569df898b0e5362e6f583)(node\_id, init\_fn, deinit\_fn, pm, data, config, level, prio, api, ...) |
...
|  | Create a device object from a devicetree node identifier and set it up for boot time initialization. |
| #define | [DEVICE\_DT\_INST\_DEINIT\_DEFINE](group__device__model.md#ga85eecc663e60efa947a59844bcb0bb54)(inst, ...) |
|  | Like [DEVICE\_DT\_DEINIT\_DEFINE()](group__device__model.md#gaa53f7267950569df898b0e5362e6f583 "Create a device object from a devicetree node identifier and set it up for boot time initialization."), but uses an instance of a DT\_DRV\_COMPAT compatible instead of a node identifier. |
...
| #define | [DEVICE\_DT\_GET\_BY\_IDX](group__device__model.md#ga7abe347d0aa972e15d1f35af02265a6b)(node\_id, prop, idx) |
...
| #define | [DEVICE\_API](#aa0cdc799fc0b9c80eb29f989eec86707)(\_class, \_name) |
|  | Wrapper macro for declaring device API structs inside iterable sections. |
| #define | [DEVICE\_API\_GET](#a9907e8ee5e7be8c3b5d52b13bd33970a)(\_class, \_dev) |
|  | Expands to the pointer of a device's API for a given class. |
| #define | [DEVICE\_API\_IS](#a48c6030c2e7d1d05ace7c708dda11949)(\_class, \_dev) |
|  | Macro that evaluates to a boolean that can be used to check if a device is of a particular class. |
| Device flags | |
| #define | [DEVICE\_FLAG\_INIT\_DEFERRED](group__device__model.md#ga9541cb57fcd27619621668e4034d034d)   [BIT](group__sys-util.md#ga3a8ea58898cb58fc96013383d39f482c)(0) |
...
| typedef [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) | [device\_flags\_t](group__device__model.md#gae3daac2d0f7f881d15e47fa15009f15b) |
|  | Device flags. |
...
| int | [device\_init](group__device__model.md#gaeea4f9c9f14ab12d224378ab90231c09) (const struct [device](structdevice.md) \*dev) |
|  | Initialize a device. |
| int | [device\_deinit](group__device__model.md#ga73c949c90a7434a7ad31dc9047166417) (const struct [device](structdevice.md) \*dev) |
|  | De-initialize a device. |

## Macro Definition Documentation

## [◆ ](#aa0cdc799fc0b9c80eb29f989eec86707)DEVICE\_API

| #define DEVICE\_API | ( |  | *\_class*, |
| --- | --- | --- | --- |
|  |  |  | *\_name* ) |

**Value:**

const [STRUCT\_SECTION\_ITERABLE](group__iterable__section__apis.md#ga9104f42cbe4a67a931bed7f7cc8f600f)(Z\_DEVICE\_API\_TYPE(\_class), \_name)
...
Parameters
:   | \_class | The device API class. |
    | --- | --- |
    | \_name | The API instance name. |

## [◆ ](#a9907e8ee5e7be8c3b5d52b13bd33970a)DEVICE\_API\_GET

| #define DEVICE\_API\_GET | ( |  | *\_class*, |
| --- | --- | --- | --- |
|  |  |  | *\_dev* ) |

**Value:**

((const struct Z\_DEVICE\_API\_TYPE(\_class) \*)\_dev->api)
...
:   | \_class | The device API class. |
    | --- | --- |
    | \_dev | The device instance pointer. |

Returns
:   the pointer to the device API.

## [◆ ](#a48c6030c2e7d1d05ace7c708dda11949)DEVICE\_API\_IS

| #define DEVICE\_API\_IS | ( |  | *\_class*, |
| --- | --- | --- | --- |
|  |  |  | *\_dev* ) |
...
STRUCT\_SECTION\_START\_EXTERN(Z\_DEVICE\_API\_TYPE(\_class)); \

STRUCT\_SECTION\_END\_EXTERN(Z\_DEVICE\_API\_TYPE(\_class)); \

([DEVICE\_API\_GET](#a9907e8ee5e7be8c3b5d52b13bd33970a)(\_class, \_dev) < [STRUCT\_SECTION\_END](group__iterable__section__apis.md#ga3170a115129c683811181615661bc298)(Z\_DEVICE\_API\_TYPE(\_class)) && \

DEVICE\_API\_GET(\_class, \_dev) >= [STRUCT\_SECTION\_START](group__iterable__section__apis.md#ga53b4dd9b989b54d62254b425a23620f0)(Z\_DEVICE\_API\_TYPE(\_class))); \

})

[DEVICE\_API\_GET](#a9907e8ee5e7be8c3b5d52b13bd33970a)
...
[STRUCT\_SECTION\_END](group__iterable__section__apis.md#ga3170a115129c683811181615661bc298)

#define STRUCT\_SECTION\_END(struct\_type)

iterable section end symbol for a struct type

**Definition** iterable\_sections.h:167
...
Return values
:   | [true](stdbool_8h.md#a41f9c5fb8b08eb5dc3edce4dcb37fee7) | If the device is of the given class |
    | --- | --- |
    | [false](stdbool_8h.md#a65e9886d74aaee76545e83dd09011727) | If the device is not of the given class |
