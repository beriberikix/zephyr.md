---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__lwm2m__api.html
...
| typedef int(\* | [lwm2m\_set\_sockopt\_cb\_t](#ga92d2227f37e7d382bc4f1a7bae21b872)) (struct [lwm2m\_ctx](structlwm2m__ctx.md) \*client\_ctx) |
...
| void | [lwm2m\_pull\_context\_set\_sockopt\_callback](#ga647018abc15cd65c894d9acb6c866486) ([lwm2m\_set\_sockopt\_cb\_t](#ga92d2227f37e7d382bc4f1a7bae21b872) set\_sockopt\_cb) |
...
`#include <[zephyr/net/lwm2m.h](lwm2m_8h.md)>`
...
## [◆ ](#ga92d2227f37e7d382bc4f1a7bae21b872)lwm2m\_set\_sockopt\_cb\_t

| typedef int(\* lwm2m\_set\_sockopt\_cb\_t) (struct [lwm2m\_ctx](structlwm2m__ctx.md) \*client\_ctx) |
| --- |
...
## [◆ ](#ga647018abc15cd65c894d9acb6c866486)lwm2m\_pull\_context\_set\_sockopt\_callback()

| void lwm2m\_pull\_context\_set\_sockopt\_callback | ( | [lwm2m\_set\_sockopt\_cb\_t](#ga92d2227f37e7d382bc4f1a7bae21b872) | *set\_sockopt\_cb* | ) |  |
| --- | --- | --- | --- | --- | --- |
...
This allows setting specific socket options on the socket that is used to pull firmware updates. The callback will be called after the pull context socket has been created and before it will connect.

Parameters
:   | [in] | set\_sockopt\_cb | A callback function to set sockopts for the pull context client. |
    | --- | --- | --- |
...
The engine calls this when [lwm2m\_ctx::set\_socketoptions](structlwm2m__ctx.md#a8714a3ee6870515631fd75e74644d39c "lwm2m_ctx::set_socketoptions") is not overwritten. You can call this from the overwritten callback to set extra options after or before defaults.
