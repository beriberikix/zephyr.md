---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/can__mcan_8h.html
...
| int | [can\_mcan\_recover](#a8444e4415e377c6ab0756c80943e5b4b) (const struct [device](structdevice.md) \*dev, [k\_timeout\_t](structk__timeout__t.md) timeout) |
|  | Bosch M\_CAN driver callback API upon recovering the CAN bus See *[can\_recover()](group__can__interface.md#gac474e56a50685736a1c25dca277aab5e "Recover from bus-off state.")* for argument description. |
...
.common = CAN\_DT\_DRIVER\_CONFIG\_GET(node\_id, 8000000), \
...
.prop\_ts1 = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, prop\_seg, 0) + [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, phase\_seg1, 0), \

.ts2 = [DT\_PROP\_OR](group__devicetree-generic-prop.md#ga5e5bfc9b1a6627b3f73014329e96340f)(node\_id, phase\_seg2, 0), \
...
## [◆ ](#a8444e4415e377c6ab0756c80943e5b4b)can\_mcan\_recover()

| int can\_mcan\_recover | ( | const struct [device](structdevice.md) \* | *dev*, |
| --- | --- | --- | --- |
