---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/espi_8h_source.html
...
[ 734](group__espi__interface.md#gacab2b3bff7d940e71ee1c2a9fdedf782)\_\_syscall int [espi\_send\_vwire](group__espi__interface.md#gacab2b3bff7d940e71ee1c2a9fdedf782)(const struct [device](structdevice.md) \*dev,

735 enum [espi\_vwire\_signal](group__espi__interface.md#gab65a0951a8912d9de398cfec0aef7d35) [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69),

736 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level);

737

738static inline int z\_impl\_espi\_send\_vwire(const struct [device](structdevice.md) \*dev,

739 enum [espi\_vwire\_signal](group__espi__interface.md#gab65a0951a8912d9de398cfec0aef7d35) [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69),

740 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) level)

741{

742 const struct espi\_driver\_api \*api =

743 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

744

745 return api->send\_vwire(dev, [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69), level);

746}

747

[ 760](group__espi__interface.md#gaa8bb48b5592c4b49d27c9b8a42432410)\_\_syscall int [espi\_receive\_vwire](group__espi__interface.md#gaa8bb48b5592c4b49d27c9b8a42432410)(const struct [device](structdevice.md) \*dev,

761 enum [espi\_vwire\_signal](group__espi__interface.md#gab65a0951a8912d9de398cfec0aef7d35) [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69),

762 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*level);

763

764static inline int z\_impl\_espi\_receive\_vwire(const struct [device](structdevice.md) \*dev,

765 enum [espi\_vwire\_signal](group__espi__interface.md#gab65a0951a8912d9de398cfec0aef7d35) [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69),

766 [uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) \*level)

767{

768 const struct espi\_driver\_api \*api =

769 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

770

771 return api->receive\_vwire(dev, [signal](include_2zephyr_2posix_2signal_8h.md#ad9d7c8d68836c635e8ec915507f49b69), level);

772}

773

[ 785](group__espi__interface.md#ga2557cfc7a38f669d14e9826e3fb0fdee)\_\_syscall int [espi\_send\_oob](group__espi__interface.md#ga2557cfc7a38f669d14e9826e3fb0fdee)(const struct [device](structdevice.md) \*dev,

786 struct [espi\_oob\_packet](structespi__oob__packet.md) \*pckt);

787

788static inline int z\_impl\_espi\_send\_oob(const struct [device](structdevice.md) \*dev,

789 struct [espi\_oob\_packet](structespi__oob__packet.md) \*pckt)

790{

791 const struct espi\_driver\_api \*api =

792 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

793

794 if (!api->send\_oob) {
...
798 return api->send\_oob(dev, pckt);

799}

800

[ 812](group__espi__interface.md#ga4b8f4fbf66a2b2ae394e00b16500f70d)\_\_syscall int [espi\_receive\_oob](group__espi__interface.md#ga4b8f4fbf66a2b2ae394e00b16500f70d)(const struct [device](structdevice.md) \*dev,

813 struct [espi\_oob\_packet](structespi__oob__packet.md) \*pckt);

814

815static inline int z\_impl\_espi\_receive\_oob(const struct [device](structdevice.md) \*dev,

816 struct [espi\_oob\_packet](structespi__oob__packet.md) \*pckt)

817{

818 const struct espi\_driver\_api \*api =

819 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

820

821 if (!api->receive\_oob) {

822 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

823 }

824

825 return api->receive\_oob(dev, pckt);

826}

827

[ 841](group__espi__interface.md#ga0a97d11167367342283bfe6b6d66726e)\_\_syscall int [espi\_read\_flash](group__espi__interface.md#ga0a97d11167367342283bfe6b6d66726e)(const struct [device](structdevice.md) \*dev,

842 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt);

843

844static inline int z\_impl\_espi\_read\_flash(const struct [device](structdevice.md) \*dev,

845 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt)

846{

847 const struct espi\_driver\_api \*api =

848 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

849

850 if (!api->flash\_read) {

851 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

852 }

853

854 return api->flash\_read(dev, pckt);

855}

856

[ 870](group__espi__interface.md#gab02d46fd690e33875cc1b2433c976891)\_\_syscall int [espi\_write\_flash](group__espi__interface.md#gab02d46fd690e33875cc1b2433c976891)(const struct [device](structdevice.md) \*dev,

871 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt);

872

873static inline int z\_impl\_espi\_write\_flash(const struct [device](structdevice.md) \*dev,

874 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt)

875{

876 const struct espi\_driver\_api \*api =

877 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

878

879 if (!api->flash\_write) {

880 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

881 }

882

883 return api->flash\_write(dev, pckt);

884}

885

[ 899](group__espi__interface.md#gab42be7c76c4523cea96365aa77fd18be)\_\_syscall int [espi\_flash\_erase](group__espi__interface.md#gab42be7c76c4523cea96365aa77fd18be)(const struct [device](structdevice.md) \*dev,

900 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt);

901

902static inline int z\_impl\_espi\_flash\_erase(const struct [device](structdevice.md) \*dev,

903 struct [espi\_flash\_packet](structespi__flash__packet.md) \*pckt)

904{

905 const struct espi\_driver\_api \*api =

906 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

907

908 if (!api->flash\_erase) {

909 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

910 }

911

912 return api->flash\_erase(dev, pckt);
...
[ 984](group__espi__interface.md#ga8d88e4e3893d610713195e5352ec2565)static inline void [espi\_init\_callback](group__espi__interface.md#ga8d88e4e3893d610713195e5352ec2565)(struct espi\_callback \*callback,

985 [espi\_callback\_handler\_t](group__espi__interface.md#ga9d848c7e367cf277230f365f73c15c46) handler,

986 enum [espi\_bus\_event](group__espi__interface.md#ga36ac3fbf9813f78bad90f047e1eb1128) evt\_type)

987{

988 \_\_ASSERT(callback, "Callback pointer should not be NULL");

989 \_\_ASSERT(handler, "Callback handler pointer should not be NULL");

990

991 callback->handler = handler;

992 callback->evt\_type = evt\_type;

993}

994

[ 1007](group__espi__interface.md#gabf5f0ea01ec8ed5345b2e119181c2313)static inline int [espi\_add\_callback](group__espi__interface.md#gabf5f0ea01ec8ed5345b2e119181c2313)(const struct [device](structdevice.md) \*dev,

1008 struct espi\_callback \*callback)

1009{

1010 const struct espi\_driver\_api \*api =

1011 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

1012

1013 if (!api->manage\_callback) {
...
1017 return api->manage\_callback(dev, callback, true);

1018}

1019

[ 1036](group__espi__interface.md#ga7f04f98ea6a4671b821cf6ddf6bbf2a6)static inline int [espi\_remove\_callback](group__espi__interface.md#ga7f04f98ea6a4671b821cf6ddf6bbf2a6)(const struct [device](structdevice.md) \*dev,

1037 struct espi\_callback \*callback)

1038{

1039 const struct espi\_driver\_api \*api =

1040 (const struct espi\_driver\_api \*)dev->[api](structdevice.md#a4a2e6a2cfeb6efed7d5383c33458f46d);

1041

1042 if (!api->manage\_callback) {

1043 return -[ENOTSUP](group__system__errno.md#ga91457bbf35f0f1085619a99423bb1f33);

1044 }

1045

1046 return api->manage\_callback(dev, callback, false);

1047}

1048

1049#ifdef \_\_cplusplus
...
1056#include <zephyr/syscalls/espi.h>

1057#endif /\* ZEPHYR\_INCLUDE\_ESPI\_H\_ \*/
