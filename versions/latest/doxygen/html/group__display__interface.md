---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__display__interface.html
...
| typedef int(\* | [display\_clear\_api](#gaf42820ae69452788bf51f37512ca8586)) (const struct [device](structdevice.md) \*dev) |
...
| static int | [display\_clear](#ga62a6cd9e338aa07f789de60e64d3b3c4) (const struct [device](structdevice.md) \*dev) |
...
`#include <[zephyr/drivers/display.h](drivers_2display_8h.md)>`
...
(((fmt & [PIXEL\_FORMAT\_L\_8](#ggac346bc56771052a8fe919c3ec23d7c9ca14f33dfec4a630f5be50622a535434df)) >> 6) \* 8U))

[PIXEL\_FORMAT\_L\_8](#ggac346bc56771052a8fe919c3ec23d7c9ca14f33dfec4a630f5be50622a535434df)
...
## [◆ ](#gaf42820ae69452788bf51f37512ca8586)display\_clear\_api

| typedef int(\* display\_clear\_api) (const struct [device](structdevice.md) \*dev) |
| --- |
...
| PIXEL\_FORMAT\_L\_8 | 8-bit Grayscale/Luminance, equivalent to  GRAY, GREY, GRAY8, Y8, R8, etc... |
...
## [◆ ](#ga62a6cd9e338aa07f789de60e64d3b3c4)display\_clear()

| | int display\_clear | ( | const struct [device](structdevice.md) \* | *dev* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
