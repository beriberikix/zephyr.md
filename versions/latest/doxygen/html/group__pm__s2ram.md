---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__pm__s2ram.html
...
`#include <[zephyr/arch/common/pm_s2ram.h](pm__s2ram_8h.md)>`
...
Default implementation is checking a magic word in RAM. CONFIG\_PM\_S2RAM\_CUSTOM\_MARKING allows custom implementation.
