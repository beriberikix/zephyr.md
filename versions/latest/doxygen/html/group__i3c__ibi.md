---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__i3c__ibi.html
...
| Functions | |
| --- | --- |
| static int | [i3c\_ibi\_hj\_response](#gac8c77e43fc7c06701437e799739507ee) (const struct [device](structdevice.md) \*dev, [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) ack) |
...
| static int | [i3c\_device\_is\_controller\_capable](#ga537c1e2dafe3df1a5758e535beb323ea) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target) |
...
| int | [i3c\_ibi\_work\_enqueue\_controller\_request](#gad643c7f0512e1e6dcddbe5821e70fc0d) (struct [i3c\_device\_desc](structi3c__device__desc.md) \*target) |
...
`#include <[zephyr/drivers/i3c/ibi.h](ibi_8h.md)>`
...
## [◆ ](#ga537c1e2dafe3df1a5758e535beb323ea)i3c\_device\_is\_controller\_capable()

| | int i3c\_device\_is\_controller\_capable | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *target* | ) |  | | --- | --- | --- | --- | --- | --- | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Note that BCR must have been obtained from device and [i3c\_device\_desc::bcr](structi3c__device__desc.md#ae1cff0a31d9cc5d7b18206556f8e0b21 "Bus Characteristic Register (BCR).") must be set.

Returns
:   True if target is controller capable, false otherwise.
...
## [◆ ](#gac8c77e43fc7c06701437e799739507ee)i3c\_ibi\_hj\_response()

| | int i3c\_ibi\_hj\_response | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [bool](stdbool_8h.md#abb452686968e48b67397da5f97445f5b) | *ack* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
This tells the controller to Acknowledge or Not Acknowledge In-Band Interrupt Hot-Join Requests.

Parameters
:   | dev | Pointer to controller device driver instance. |
    | --- | --- |
    | ack | True to ack, False to nack |
...
## [◆ ](#gad643c7f0512e1e6dcddbe5821e70fc0d)i3c\_ibi\_work\_enqueue\_controller\_request()

| int i3c\_ibi\_work\_enqueue\_controller\_request | ( | struct [i3c\_device\_desc](structi3c__device__desc.md) \* | *target* | ) |  |
| --- | --- | --- | --- | --- | --- |
