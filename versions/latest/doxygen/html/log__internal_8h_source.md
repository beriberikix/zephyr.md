---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/log__internal_8h_source.html
...
95 return [log\_const\_source\_id](include_2zephyr_2logging_2log__core_8h.md#add353f5f883b7edee6428adb7fb7e4d5)([TYPE\_SECTION\_END](group__iterable__section__apis.md#ga14d6bc375423775e5484183eeadd1fad)(log\_const));
...
120union [log\_msg\_generic](unionlog__msg__generic.md) \*z\_log\_msg\_claim([k\_timeout\_t](structk__timeout__t.md) \*backoff);

121

126void z\_log\_msg\_free(union [log\_msg\_generic](unionlog__msg__generic.md) \*msg);

127

133bool z\_log\_msg\_pending(void);

134

135static inline void z\_log\_notify\_drop(const struct [mpsc\_pbuf\_buffer](structmpsc__pbuf__buffer.md) \*buffer,

136 const union [mpsc\_pbuf\_generic](unionmpsc__pbuf__generic.md) \*item)

137{

138 ARG\_UNUSED(buffer);

139 ARG\_UNUSED(item);

140

141 z\_log\_dropped(true);

142}

143

148const char \*z\_log\_get\_tag(void);

149

156static inline bool z\_log\_is\_local\_domain([uint8\_t](stdint_8h.md#a3cb4a16b0e8d6af0af86d4fd6ba5fd9d) domain\_id)

157{

158 return ![IS\_ENABLED](group__sys-util.md#ga111fe4e9d63758262fc6810a782cb32a)(CONFIG\_LOG\_MULTIDOMAIN) ||

159 (domain\_id == Z\_LOG\_LOCAL\_DOMAIN\_ID);

160}

161

166[log\_timestamp\_t](include_2zephyr_2logging_2log__msg_8h.md#acbc134e9ee5f3768a534d95a4c8335e8) z\_log\_timestamp(void);
...
172#endif /\* ZEPHYR\_INCLUDE\_LOGGING\_LOG\_INTERNAL\_H\_ \*/
