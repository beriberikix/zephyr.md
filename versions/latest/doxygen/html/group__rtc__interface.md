---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/doxygen/html/group__rtc__interface.html
...
| static int | [rtc\_alarm\_set\_callback](#ga90d7f422ca15cf679aa7ba61fb5373f0) (const struct [device](structdevice.md) \*dev, [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) id, [rtc\_alarm\_callback](#ga8fc3b6037a95e97b686875beff9a581d) callback, void \*user\_data) |
|  | API for setting alarm callback. |

| RTC Interface Update | |
| --- | --- |
| static int | [rtc\_update\_set\_callback](#ga0b2b2b44077dcdb73feb007f87cc47b3) (const struct [device](structdevice.md) \*dev, [rtc\_update\_callback](#ga99e4869ee85507befc7e7cf129b45b07) callback, void \*user\_data) |
...
`#include <[zephyr/drivers/rtc.h](rtc_8h.md)>`
...
## [◆ ](#ga90d7f422ca15cf679aa7ba61fb5373f0)rtc\_alarm\_set\_callback()

| | int rtc\_alarm\_set\_callback | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [uint16\_t](stdint_8h.md#a5debae8b2a1ec20a6694c0c443ee399e) | *id*, | |  |  | [rtc\_alarm\_callback](#ga8fc3b6037a95e97b686875beff9a581d) | *callback*, | |  |  | void \* | *user\_data* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
## [◆ ](#ga0b2b2b44077dcdb73feb007f87cc47b3)rtc\_update\_set\_callback()

| | int rtc\_update\_set\_callback | ( | const struct [device](structdevice.md) \* | *dev*, | | --- | --- | --- | --- | |  |  | [rtc\_update\_callback](#ga99e4869ee85507befc7e7cf129b45b07) | *callback*, | |  |  | void \* | *user\_data* ) | | inlinestatic |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
