---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/doxygen/html/structvirtual__interface__api.html
...
| enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896)(\* | [input](#a285f8f872420209107f73b6b268af7b2) )(struct [net\_if](structnet__if.md) \*input\_iface, struct [net\_if](structnet__if.md) \*iface, struct net\_addr \*remote\_addr, struct [net\_pkt](structnet__pkt.md) \*pkt) |
...
## [◆ ](#a285f8f872420209107f73b6b268af7b2)input

| enum [net\_verdict](group__net__core.md#ga8e5393f3bdd85491f221324e637c3896)(\* virtual\_interface\_api::input) (struct [net\_if](structnet__if.md) \*input\_iface, struct [net\_if](structnet__if.md) \*iface, struct net\_addr \*remote\_addr, struct [net\_pkt](structnet__pkt.md) \*pkt) |
| --- |

Check if this received network packet is for this interface.

The callback returns NET\_CONTINUE if this interface will accept the packet and pass it upper layers, NET\_DROP if the packet is to be dropped and NET\_OK to pass it to next interface.
