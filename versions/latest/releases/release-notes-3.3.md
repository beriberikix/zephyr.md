---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-3.3.html
...
- POSIX API
  ...
  - Added [`CONFIG_TIMER_CREATE_WAIT`](../kconfig.md#CONFIG_TIMER_CREATE_WAIT "CONFIG_TIMER_CREATE_WAIT"), `CONFIG_MAX_PTHREAD_KEY_COUNT`,
