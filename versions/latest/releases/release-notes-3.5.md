---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/releases/release-notes-3.5.html
...
- Analog Devices, Inc. (adi):
  ...
  - New bindings:
    ...
    - [`adi,adin1110`](../build/dts/api/bindings/ethernet/phy/adi,adin1110.md#std-dtcompatible-adi-adin1110)
...
- ZBus
  ...
  - Changed the VDED delivery sequence. Check the [documentation](../services/zbus/index.md#zbus-delivery-sequence).
...
>   need a `zephyr,kscan-input` child node to emit input events.
