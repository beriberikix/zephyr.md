---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-1.14.html
...
- Added the all new [NRF52 simulated board](../boards/posix/nrf_bsim/doc/nrf52_bsim.md#nrf52-bsim):
...
- Added new drivers and backends for [native\_posix](../boards/posix/native_posix/doc/index.md#native-posix):
...
- Logging:
  ...
  - Added [`LOG_PANIC()`](../services/logging/index.md#c.LOG_PANIC "LOG_PANIC") call to the fault handlers to ensure that
  ...
  - Added log backends:
    ...
    - SWO
    - Xtensa Sim
  - Changed default timestamp source function to [`k_uptime_get_32()`](../kernel/services/timing/clocks.md#c.k_uptime_get_32 "k_uptime_get_32")
- Shell:
...
- [GitHub #10320](https://github.com/zephyrproject-rtos/zephyr/issues/10320) - arm: mpu: mpu\_config and and mpu\_regions to be declared/defined as const
