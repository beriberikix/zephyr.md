---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-3.1.html
...
- Bindings
  ...
  - New bindings for the following compatible properties were added:
    ...
    - [`nordic,nrf-ppi`](../build/dts/api/bindings/arm/nordic%2Cnrf-ppi.md#std-dtcompatible-nordic-nrf-ppi)
