---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-2.5.html
...
- Removed SETTINGS\_USE\_BASE64 support as its been deprecated for more than
  two releases.
- The [`lwm2m_rd_client_start()`](../connectivity/networking/api/lwm2m.md#c.lwm2m_rd_client_start "lwm2m_rd_client_start") function now accepts an additional
...
- LwM2M execute now supports arguments. The execute callback
  [`lwm2m_engine_execute_cb_t`](../connectivity/networking/api/lwm2m.md#c.lwm2m_engine_execute_cb_t "lwm2m_engine_execute_cb_t") is extended with an `args` parameter
...
- The [`clock_control_async_on()`](../hardware/peripherals/clock_control.md#c.clock_control_async_on "clock_control_async_on") function will now take `callback` and
  `user_data` as arguments instead of structure which contained list node,
  callback and user data.
- The [`mqtt_keepalive_time_left()`](../connectivity/networking/api/mqtt.md#c.mqtt_keepalive_time_left "mqtt_keepalive_time_left") function now returns -1 if keep alive
...
- The [`coap_pending_init()`](../connectivity/networking/api/coap.md#c.coap_pending_init "coap_pending_init") function now accepts an additional `retries`
...
- The [`coap_packet_append_payload()`](../connectivity/networking/api/coap.md#c.coap_packet_append_payload "coap_packet_append_payload") function will now take a pointer to a
  constant buffer as the `payload` argument instead of a pointer to a writable
  buffer.
- The [`coap_packet_init()`](../connectivity/networking/api/coap.md#c.coap_packet_init "coap_packet_init") function will now take a pointer to a constant
...
- `fs_tile_t` objects must now be initialized by calling
  [`fs_file_t_init()`](../services/file_system/index.md#c.fs_file_t_init "fs_file_t_init") before their first use.
- [`fs_dir_t`](../services/file_system/index.md#c.fs_dir_t "fs_dir_t") objects must now be initialized by calling
  [`fs_dir_t_init()`](../services/file_system/index.md#c.fs_dir_t_init "fs_dir_t_init") before their first use.
...
- Bluetooth
  ...
  - Deprecated the `bt_set_id_addr()` function, use [`bt_id_create()`](../connectivity/bluetooth/api/gap.md#c.bt_id_create "bt_id_create")
    before calling [`bt_enable()`](../connectivity/bluetooth/api/gap.md#c.bt_enable "bt_enable") instead. When `CONFIG_PRIVACY` is
...
- Memory Management
  ...
  - Added [`k_mem_map()`](../kernel/memory_management/virtual_memory.md#c.k_mem_map "k_mem_map") which allows applications to increase
    the data space available via anonymous memory mappings.
  - Added [`k_mem_free_get()`](../kernel/memory_management/virtual_memory.md#c.k_mem_free_get "k_mem_free_get") which returns the amount of
  ...
  - Paging structure must now be pre-allocated so that there is no need
    ...
    [`arch_mem_map()`](../hardware/porting/arch.md#c.arch_mem_map "arch_mem_map") may no longer fail.
- Demand Paging
...
- Devicetree
  ...
  - Enhanced support for enumerated property values via new macros:
    ...
    - [`DT_ENUM_IDX_OR`](../build/dts/api/api.md#c.DT_ENUM_IDX_OR "DT_ENUM_IDX_OR")
    - `DT_ENUM_TOKEN`
    - `DT_ENUM_UPPER_TOKEN`
  - New hardware specific macros:

    - [`DT_GPIO_CTLR_BY_IDX`](../build/dts/api/api.md#c.DT_GPIO_CTLR_BY_IDX "DT_GPIO_CTLR_BY_IDX")
    - [`DT_GPIO_CTLR`](../build/dts/api/api.md#c.DT_GPIO_CTLR "DT_GPIO_CTLR")
    - [`DT_MTD_FROM_FIXED_PARTITION`](../build/dts/api/api.md#c.DT_MTD_FROM_FIXED_PARTITION "DT_MTD_FROM_FIXED_PARTITION")
  - Miscellaneous new node-related macros:

    - [`DT_GPARENT`](../build/dts/api/api.md#c.DT_GPARENT "DT_GPARENT")
    - [`DT_INVALID_NODE`](../build/dts/api/api.md#c.DT_INVALID_NODE "DT_INVALID_NODE")
    - [`DT_NODE_PATH`](../build/dts/api/api.md#c.DT_NODE_PATH "DT_NODE_PATH")
    - [`DT_SAME_NODE`](../build/dts/api/api.md#c.DT_SAME_NODE "DT_SAME_NODE")
  - Property access macro changes:

    - [`DT_PROP_BY_PHANDLE_IDX_OR`](../build/dts/api/api.md#c.DT_PROP_BY_PHANDLE_IDX_OR "DT_PROP_BY_PHANDLE_IDX_OR"): new macro
    - [`DT_PROP_HAS_IDX`](../build/dts/api/api.md#c.DT_PROP_HAS_IDX "DT_PROP_HAS_IDX") now expands to a literal 0 or 1, not an
      expression that evaluates to 0 or 1
  - Dependencies between nodes are now exposed via new macros:

    - [`DT_DEP_ORD`](../build/dts/api/api.md#c.DT_DEP_ORD "DT_DEP_ORD"), [`DT_INST_DEP_ORD`](../build/dts/api/api.md#c.DT_INST_DEP_ORD "DT_INST_DEP_ORD")
    - [`DT_REQUIRES_DEP_ORDS`](../build/dts/api/api.md#c.DT_REQUIRES_DEP_ORDS "DT_REQUIRES_DEP_ORDS"), [`DT_INST_REQUIRES_DEP_ORDS`](../build/dts/api/api.md#c.DT_INST_REQUIRES_DEP_ORDS "DT_INST_REQUIRES_DEP_ORDS")
    - [`DT_SUPPORTS_DEP_ORDS`](../build/dts/api/api.md#c.DT_SUPPORTS_DEP_ORDS "DT_SUPPORTS_DEP_ORDS"), [`DT_INST_SUPPORTS_DEP_ORDS`](../build/dts/api/api.md#c.DT_INST_SUPPORTS_DEP_ORDS "DT_INST_SUPPORTS_DEP_ORDS")
- West
...
- File systems
  ...
  - API
    ...
    - Added [`fs_file_t_init()`](../services/file_system/index.md#c.fs_file_t_init "fs_file_t_init") function for initialization of
      [`fs_file_t`](../services/file_system/index.md#c.fs_file_t "fs_file_t") objects.
    - Added [`fs_dir_t_init()`](../services/file_system/index.md#c.fs_dir_t_init "fs_dir_t_init") function for initialization of
      [`fs_dir_t`](../services/file_system/index.md#c.fs_dir_t "fs_dir_t") objects.
...
- Power management
  ...
  - Overhaul power states. New states [`pm_state`](../services/pm/api/index.md#c.pm_state "pm_state") are more
  ...
  - New power state changes notification API [`pm_notifier`](../services/pm/api/index.md#c.pm_notifier "pm_notifier")
...
- [GitHub #29120](https://github.com/zephyrproject-rtos/zephyr/issues/29120) - STM32: Few issues on on pinctrl generation script
