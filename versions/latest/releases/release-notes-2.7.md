---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/releases/release-notes-2.7.html
...
- `DT_ENUM_TOKEN` and `DT_ENUM_UPPER_TOKEN`,
  ...
  [`DT_STRING_TOKEN`](../build/dts/api/api.md#c.DT_STRING_TOKEN "DT_STRING_TOKEN") and [`DT_STRING_UPPER_TOKEN`](../build/dts/api/api.md#c.DT_STRING_UPPER_TOKEN "DT_STRING_UPPER_TOKEN")
- [`BT_CONN_ROLE_MASTER`](../connectivity/bluetooth/api/connection_mgmt.md#c.BT_CONN_ROLE_MASTER "BT_CONN_ROLE_MASTER") and [`BT_CONN_ROLE_SLAVE`](../connectivity/bluetooth/api/connection_mgmt.md#c.BT_CONN_ROLE_SLAVE "BT_CONN_ROLE_SLAVE")
  have been deprecated in favor of
  [`BT_CONN_ROLE_CENTRAL`](../connectivity/bluetooth/api/connection_mgmt.md#c.@333353045061050344007255220036325335161311226155.BT_CONN_ROLE_CENTRAL "BT_CONN_ROLE_CENTRAL") and [`BT_CONN_ROLE_PERIPHERAL`](../connectivity/bluetooth/api/connection_mgmt.md#c.@333353045061050344007255220036325335161311226155.BT_CONN_ROLE_PERIPHERAL "BT_CONN_ROLE_PERIPHERAL")
- [`BT_LE_SCAN_OPT_FILTER_WHITELIST`](../connectivity/bluetooth/api/gap.md#c.BT_LE_SCAN_OPT_FILTER_WHITELIST "BT_LE_SCAN_OPT_FILTER_WHITELIST")
  has been deprecated in favor of
  [`BT_LE_SCAN_OPT_FILTER_ACCEPT_LIST`](../connectivity/bluetooth/api/gap.md#c.@241112352326353256041034326302235077223072240255.BT_LE_SCAN_OPT_FILTER_ACCEPT_LIST "BT_LE_SCAN_OPT_FILTER_ACCEPT_LIST")
- The following whitelist functions have been deprecated:
  [`bt_le_whitelist_add()`](../connectivity/bluetooth/api/gap.md#c.bt_le_whitelist_add "bt_le_whitelist_add")
  [`bt_le_whitelist_rem()`](../connectivity/bluetooth/api/gap.md#c.bt_le_whitelist_rem "bt_le_whitelist_rem")
  [`bt_le_whitelist_clear()`](../connectivity/bluetooth/api/gap.md#c.bt_le_whitelist_clear "bt_le_whitelist_clear")
  in favor of
  [`bt_le_filter_accept_list_add()`](../connectivity/bluetooth/api/gap.md#c.bt_le_filter_accept_list_add "bt_le_filter_accept_list_add")
  [`bt_le_filter_accept_list_remove()`](../connectivity/bluetooth/api/gap.md#c.bt_le_filter_accept_list_remove "bt_le_filter_accept_list_remove")
  [`bt_le_filter_accept_list_clear()`](../connectivity/bluetooth/api/gap.md#c.bt_le_filter_accept_list_clear "bt_le_filter_accept_list_clear")
...
- Bluetooth
  ...
  - Added `multiple` to the [`bt_gatt_read_params`](../connectivity/bluetooth/api/gatt.md#c.bt_gatt_read_params "bt_gatt_read_params") - this
    structure contains two members: `handles`, which was moved from
    [`bt_gatt_read_params`](../connectivity/bluetooth/api/gatt.md#c.bt_gatt_read_params "bt_gatt_read_params"), and `variable`.
- Networking
...
- CoAP:
  ...
  - Added `user_data` field to the [`coap_packet`](../connectivity/networking/api/coap.md#c.coap_packet "coap_packet") structure.
  - Fixed processing of out-of-order notifications.
  - Fixed [`coap_packet_get_payload()`](../connectivity/networking/api/coap.md#c.coap_packet_get_payload "coap_packet_get_payload") function.
  - Converted CoAP test suite to ztest API.
  - Improved [`coap_packet_get_payload()`](../connectivity/networking/api/coap.md#c.coap_packet_get_payload "coap_packet_get_payload") function to minimize number
    of RNG calls.
...
- Misc:
  ...
  - Introduced [`net_pkt_remove_tail()`](../connectivity/networking/api/net_pkt.md#c.net_pkt_remove_tail "net_pkt_remove_tail") function.
    Added IEEE 802.15.4 security-related flags to the [`net_pkt`](../connectivity/networking/api/net_pkt.md#c.net_pkt "net_pkt")
    structure.
...
- MQTT:
  ...
  - Fixed a bug in [`mqtt_abort()`](../connectivity/networking/api/mqtt.md#c.mqtt_abort "mqtt_abort"), where the function could return without
    releasing a lock.
- OpenThread:
...
- Socket:
  ...
  - Added microsecond accuracy in [`zsock_select()`](../connectivity/networking/api/sockets.md#c.zsock_select "zsock_select") function.
  - Reworked [`zsock_select()`](../connectivity/networking/api/sockets.md#c.zsock_select "zsock_select") into a syscall.
  - Fixed a bug, where [`poll()`](../connectivity/networking/api/sockets.md#c.poll "poll") events were not signalled correctly
    for socketpair sockets.
  - Fixed a bug, where socket mutex could be used after being initialized by a
    new owner after being deallocated in [`zsock_close()`](../connectivity/networking/api/sockets.md#c.zsock_close "zsock_close").
...
- TLS:
  ...
  - Reset mbed TLS session on timed out DTLS handshake, to allow a retry without
    closing a socket.
  - Fixed TLS/DTLS [`sendmsg()`](../connectivity/networking/api/sockets.md#c.sendmsg "sendmsg") implementation for larger payloads.
  - Fixed TLS/DTLS sockets `POLLHUP` notification.
- WebSocket:

  - Fixed [`poll()`](../connectivity/networking/api/sockets.md#c.poll "poll") implementation for WebSocket, which did not work
    correctly with offloaded sockets.
  - Fixed [`ioctl()`](../connectivity/networking/api/sockets.md#c.ioctl "ioctl") implementation for WebSocket, which did not work
    correctly with offloaded sockets.
...
- Devicetree API
  ...
  - New “for-each” macros which work like existing APIs, but take variable
    numbers of arguments: [`DT_FOREACH_CHILD_VARGS`](../build/dts/api/api.md#c.DT_FOREACH_CHILD_VARGS "DT_FOREACH_CHILD_VARGS"),
    [`DT_FOREACH_CHILD_STATUS_OKAY_VARGS`](../build/dts/api/api.md#c.DT_FOREACH_CHILD_STATUS_OKAY_VARGS "DT_FOREACH_CHILD_STATUS_OKAY_VARGS"),
    [`DT_FOREACH_PROP_ELEM_VARGS`](../build/dts/api/api.md#c.DT_FOREACH_PROP_ELEM_VARGS "DT_FOREACH_PROP_ELEM_VARGS"),
    [`DT_INST_FOREACH_CHILD_VARGS`](../build/dts/api/api.md#c.DT_INST_FOREACH_CHILD_VARGS "DT_INST_FOREACH_CHILD_VARGS"),
    [`DT_INST_FOREACH_STATUS_OKAY_VARGS`](../build/dts/api/api.md#c.DT_INST_FOREACH_STATUS_OKAY_VARGS "DT_INST_FOREACH_STATUS_OKAY_VARGS"),
    [`DT_INST_FOREACH_PROP_ELEM_VARGS`](../build/dts/api/api.md#c.DT_INST_FOREACH_PROP_ELEM_VARGS "DT_INST_FOREACH_PROP_ELEM_VARGS")
  - Other new “for-each” macros: [`DT_FOREACH_STATUS_OKAY`](../build/dts/api/api.md#c.DT_FOREACH_STATUS_OKAY "DT_FOREACH_STATUS_OKAY"),
    [`DT_FOREACH_STATUS_OKAY_VARGS`](../build/dts/api/api.md#c.DT_FOREACH_STATUS_OKAY_VARGS "DT_FOREACH_STATUS_OKAY_VARGS")
  - New macros for converting strings to C tokens: [`DT_STRING_TOKEN`](../build/dts/api/api.md#c.DT_STRING_TOKEN "DT_STRING_TOKEN"),
    [`DT_STRING_UPPER_TOKEN`](../build/dts/api/api.md#c.DT_STRING_UPPER_TOKEN "DT_STRING_UPPER_TOKEN")
...
- Devicetree bindings
  ...
  - Various bindings had incorrect vendor prefixes in their [compatible](../build/dts/intro-syntax-structure.md#dt-important-props) properties; the following changes were made to fix
    ...
    | `vexriscv,intc0` | [`vexriscv-intc0`](../build/dts/api/bindings/interrupt-controller/vexriscv-intc0.md#std-dtcompatible-vexriscv-intc0) |
  ...
  - Other new bindings in alphabetical order: [`andestech,atcgpio100`](../build/dts/api/bindings/gpio/andestech%2Catcgpio100.md#std-dtcompatible-andestech-atcgpio100),
    ...
    [`zephyr,cdc-acm-uart`](../build/dts/api/bindings/serial/zephyr%2Ccdc-acm-uart.md#std-dtcompatible-zephyr-cdc-acm-uart), [`zephyr,gsm-ppp`](../build/dts/api/bindings/modem/zephyr%2Cgsm-ppp.md#std-dtcompatible-zephyr-gsm-ppp),
