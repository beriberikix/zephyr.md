---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/security/standards/etsi-303645.html
original_path: security/standards/etsi-303645.html
---
...
Full version of the standard can be found [here](https://www.etsi.org/deliver/etsi_en/303600_303699/303645/02.01.01_60/en_303645v020101p.pdf).
...
| Provision 5.2-1 | The manufacture shall make a vulnerability disclosure policy publicly available. | M | Y | [Vulnerability Management](../reporting.md#reporting) |
| Provision 5.2-2 | Disclosed vulnerabilities should be acted on in a timely manner. | R | Y | [Vulnerability Timeline](../reporting.md#vulnerability-timeline) |
| Provision 5.2-3 | Manufacturers should continually monitor for, identify and rectify security vulnerabilities within products and services they sell, produce, have produced and services they operate during the defined support period. | R | Y | [Modules](https://github.com/zephyrproject-rtos/) are covered |
| Provision 5.3-1 | All software components in consumer IoT devices should be securely updatable. | R | Y | [Device firwmware upgrade](../../services/device_mgmt/dfu.md#dfu) |
| Provision 5.3-2 | When the device is not a constrained device, it shall have an update mechanism for the secure installation of updates. | M C | Y | [Device firwmware upgrade](../../services/device_mgmt/dfu.md#dfu) |
...
| Provision 5.3-7 | The device shall use best practice cryptography to facilitate secure update mechanisms. | M C | Y | [West Sign](../../develop/west/sign.md#west-sign) |
| Provision 5.3-8 | Security updates shall be timely. | M C | N/A |  |
| Provision 5.3-9 | The device should verify the authenticity and integrity of software updates. | R C | Y | Functionality provided by MCUboot <https://github.com/zephyrproject-rtos/mcuboot>. Also see [Device Firwmware Upgrade](../../services/device_mgmt/dfu.md#dfu) |
...
| Provision 5.3-13 | The manufacturer shall publish, in an accessible way that is clear and transparent to the user, the defined support period. | M | Y | [Release Life Cycle and Maintenance](../../releases/index.md#zephyr-release-cycle) |
...
| Provision 5.4-3 | Hard-coded critical security parameters in device software source code shall not be used. | M | Y | [Hardening Tool](../hardening-tool.md#hardening) |
...
| Provision 5.6-1 | All unused network and logical interfaces shall be disabled. | M | Y | [Kconfig](../../build/kconfig/index.md#kconfig) |
...
| Provision 5.6-3 | Device hardware should not unnecessarily expose physical interfaces to attack. | R | Y | [Kconfig](../../build/kconfig/index.md#kconfig) and [Hardening Tool](../hardening-tool.md#hardening) |
| Provision 5.6-4 | Where a debug interface is physically accessible, it shall be disabled in software. | M C | Y | [Hardening Tool](../hardening-tool.md#hardening) |
| Provision 5.6-5 | The manufacturer should only enable software services that are used or required for the intended use or operation of the device. | R | Y | [Kconfig](../../build/kconfig/index.md#kconfig) and [Hardening Tool](../hardening-tool.md#hardening) |
| Provision 5.6-6 | Code should be minimized to the functionality necessary for the service/device to operate. | R | Y | [Kconfig](../../build/kconfig/index.md#kconfig) |
| Provision 5.6-7 | Software should run with least necessary privileges, taking account of both security and functionality. | R | Y | [Security Overview](../security-overview.md#security-overview) |
| Provision 5.6-8 | The device should include a hardware-level access control mechanism for memory. | R | Y | [Memory protection](../../kernel/usermode/memory_domain.md#memory-domain) |
| Provision 5.6-9 | The manufacturer should follow secure development processes for software deployed on the device. | R | Y | [Security Overview](../security-overview.md#security-overview) and [Coding guidelines](../../contribute/coding_guidelines/index.md#coding-guidelines) |
| Provision 5.7-1 | The consumer IoT device should verify its software using secure boot mechanisms. | R | Y | Functionality provided by MCUboot <https://github.com/zephyrproject-rtos/mcuboot>. Also see [Security Overview](../../develop/west/sign.md#west-sign) |
...
| Provision 5.8-3 | All external sensing capabilities of the device shall be documented in an accessible way that is clear and transparent for the user. | M | Y | [Sensing Subsystem](../../services/sensing/index.md#sensing) |
...
| Provision 5.13-1 | The consumer IoT device software shall validate data input via user interfaces or transferred via Application Programming Interfaces (APIs) or between networks in services and devices. | M | Y | [Syscall verification](../../kernel/usermode/syscalls.md#syscall-verification) and [Coding guidelines](../../contribute/coding_guidelines/index.md#coding-guidelines) |
