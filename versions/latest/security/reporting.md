---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/security/reporting.html
original_path: security/reporting.html
---
...
[vulnerabilities@zephyrproject.org](mailto:vulnerabilities%40zephyrproject.org) mailing list. These reports will be
...
advisory [GitHub](https://github.com/zephyrproject-rtos/zephyr/security). The original submitter will be granted permission to
...
out the form at the [Vulnerability Registry](https://www.zephyrproject.org/vulnerability-registry/). These parties will be
...
[vulnerability fixes](#vulnerability-fix-recommendations) apply
