---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/security/hardening-tool.html
original_path: security/hardening-tool.html
---
...
1. Disabling features and compilation flags that might lead to security vulnerabilities (ex. making
...
2. Enabling optional features that can lead to improve security (ex. stack sentinel, hardware stack
