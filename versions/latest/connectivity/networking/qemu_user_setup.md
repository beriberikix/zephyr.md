---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/qemu_user_setup.html
original_path: connectivity/networking/qemu_user_setup.html
---
...
[https://wiki.qemu.org/Documentation/Networking#User\_Networking\_.28SLIRP.29](https://wiki.qemu.org/Documentation/Networking#User_Networking_.28SLIRP.29)

## [Using SLIRP with Zephyr](#id2)
...
- There is a bug in the SLIRP implementation which filters out all IPv6 packets
  from the guest. See [https://bugs.launchpad.net/qemu/+bug/1724590](https://bugs.launchpad.net/qemu/+bug/1724590) for details.
