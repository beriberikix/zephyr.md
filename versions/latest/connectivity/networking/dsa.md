---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/dsa.html
original_path: connectivity/networking/dsa.html
---
...
[Linux DSA documentation](https://www.kernel.org/doc/html/latest/networking/dsa/dsa.html).

## [DSA switch TX/RX process](#id1)
...
For device driver, all needed to prepare are [`dsa_api`](../../doxygen/html/structdsa__api.md), private data if has, and
[`dsa_port_config`](../../doxygen/html/structdsa__port__config.md). The macro functions could be utilized. And below is an example
of i.MX NETC.

- [`DSA_SWITCH_INST_INIT`](../../doxygen/html/group__dsa__core.md#gaa7665e4b96cbc40cbae6de621f773aa4)
- [`DSA_PORT_INST_INIT`](../../doxygen/html/group__dsa__core.md#ga012eeda4facb67b5c387b74878b53188)
...
## [Common pitfalls using DSA setups](#id7)
...
Once a conduit network device is configured to use DSA (dev->dsa\_ptr becomes non-NULL), and
