---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/net_config_guide.html
...
:   How many network buffers are allocated for receiving data.
    ...
    the size of the data pool size by setting [`CONFIG_NET_BUF_DATA_POOL_SIZE`](../../kconfig.md#CONFIG_NET_BUF_DATA_POOL_SIZE "CONFIG_NET_BUF_DATA_POOL_SIZE")
