---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/overview.html
...
- **IPv6** The support for IPv6 is enabled by default. Various IPv6 sub-options
  ...
  - IPv6 header compression (6lo) is available for IPv6 connectivity for
    Bluetooth IPSP ([RFC 7668](https://tools.ietf.org/html/rfc7668)) and
