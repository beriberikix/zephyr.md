---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/api/ptp_time.html
original_path: connectivity/networking/api/ptp_time.html
---
...
in [generic Precision Time Protocol (gPTP)](gptp.md#gptp-interface) implementation.
...
:   Precision Time Protocol time specification.
    ...
    static inline [net\_time\_t](net_time.md#c.net_time_t "net_time_t") net\_ptp\_time\_to\_ns(struct [net\_ptp\_time](#c.net_ptp_time) \*ts)
    ...
    static inline struct [net\_ptp\_time](#c.net_ptp_time) ns\_to\_net\_ptp\_time([net\_time\_t](net_time.md#c.net_time_t "net_time_t") nsec)
    ...
    :   *#include <ptp\_time.h>*
        ...
        union [net\_ptp\_time](#c.net_ptp_time).[anonymous] [anonymous]
        :   Seconds encoded on 48 bits.

        uint32\_t nanosecond
        :   Nanoseconds.

    struct net\_ptp\_extended\_time
    :   *#include <ptp\_time.h>*
        ...
        A precise definition of PTP timestamps and their uses in Zephyr is given in the description of [net\_ptp\_time](#structnet__ptp__time).

        Public Members

        union [net\_ptp\_extended\_time](#c.net_ptp_extended_time).[anonymous] [anonymous]
        :   Seconds encoded on 48 bits.
