---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/api/net_buf.html
...
:   Network buffer library.
    ...
    static inline uint8\_t \*net\_buf\_simple\_tail(struct [net\_buf\_simple](#c.net_buf_simple) \*buf)
    ...
    size\_t net\_buf\_simple\_headroom(struct [net\_buf\_simple](#c.net_buf_simple) \*buf)
    ...
    size\_t net\_buf\_simple\_tailroom(struct [net\_buf\_simple](#c.net_buf_simple) \*buf)
    ...
    uint16\_t net\_buf\_simple\_max\_len(struct [net\_buf\_simple](#c.net_buf_simple) \*buf)
    ...
    static inline void net\_buf\_simple\_save(struct [net\_buf\_simple](#c.net_buf_simple) \*buf, struct [net\_buf\_simple\_state](#c.net_buf_simple_state) \*state)
    ...
    :   Restore the parsing state of a buffer.
        ...
        Restores the parsing state of a buffer from a state previously stored by [net\_buf\_simple\_save()](#group__net__buf_1ga5b891f335480830a71a5ee2d71f1a3db).
    ...
    int net\_buf\_id(struct [net\_buf](#c.net_buf) \*buf)
    ...
    static inline size\_t net\_buf\_tailroom(struct [net\_buf](#c.net_buf) \*buf)
    :   Check buffer tailroom.
    ...
    static inline size\_t net\_buf\_headroom(struct [net\_buf](#c.net_buf) \*buf)
    :   Check buffer headroom.
    ...
    static inline uint16\_t net\_buf\_max\_len(struct [net\_buf](#c.net_buf) \*buf)
    ...
    static inline uint8\_t \*net\_buf\_tail(struct [net\_buf](#c.net_buf) \*buf)
    :   Get the tail pointer for a buffer.
    ...
    size\_t net\_buf\_linearize(void \*dst, size\_t dst\_len, struct [net\_buf](#c.net_buf) \*src, size\_t offset, size\_t len)
    ...
    static inline size\_t net\_buf\_frags\_len(struct [net\_buf](#c.net_buf) \*buf)
    ...
    :   *#include <buf.h>*
        ...
        :   Length of the data behind the data pointer.
            ...
            To determine the max length, use [net\_buf\_simple\_max\_len()](#group__net__buf_1ga7deeb4a89b90a3784e582abcb81d5126), not [size](#structnet__buf__simple_1ae6dc4aa029a67d3911293618eb30caa6)!
    ...
    struct net\_buf\_data\_cb
    :   *#include <buf.h>*

    struct net\_buf\_data\_alloc
    :   *#include <buf.h>*
    ...
    :   *#include <buf.h>*
        ...
        const struct [net\_buf\_data\_alloc](#c.net_buf_data_alloc) \*alloc
        :   Data allocation handlers.

    struct net\_buf\_pool\_fixed
    :   *#include <buf.h>*
