---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/networking/api/lwm2m.html
...
[`lwm2m_ctx`](../../../doxygen/html/structlwm2m__ctx.md) structure:
...
The second parameter of [`lwm2m_rd_client_start()`](../../../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79) is the client
...
LwM2M stack provides callbacks in the [`lwm2m_ctx`](../../../doxygen/html/structlwm2m__ctx.md) structure.
...
Before calling [`lwm2m_rd_client_start()`](../../../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79) assign the tls\_tag # where the
...
Application needs to allocate an array of [`lwm2m_time_series_elem`](../../../doxygen/html/structlwm2m__time__series__elem.md) structures and then
enable the cache by calling [`lwm2m_enable_cache()`](../../../doxygen/html/group__lwm2m__api.md#ga6975c5c4825afaccc52741eb54aca4cb) for a given resource. Each resource
...
[`CONFIG_LWM2M_RW_SENML_JSON_SUPPORT`](../../../kconfig.md#CONFIG_LWM2M_RW_SENML_JSON_SUPPORT "CONFIG_LWM2M_RW_SENML_JSON_SUPPORT") and needs [`CONFIG_POSIX_TIMERS`](../../../kconfig.md#CONFIG_POSIX_TIMERS "CONFIG_POSIX_TIMERS")
...
[`lwm2m_register_validate_callback()`](../../../doxygen/html/group__lwm2m__api.md#gad6e5fd4815f409ad59ad631b03199333).
...
![LwM2M engine state machine](https://docs.zephyrproject.org/4.2.0/_images/lwm2m_engine_state_machine.svg)
...
| 4 | REGISTRATION\_FAILURE | Registration to LwM2M server failed. Occurs if server rejects the registration attempt. |
...
| 6 | REG\_TIMEOUT | Registration status lost. Occurs if there is socket errors or message timeouts. Client have lost connection to the server. |
...
| 11 | ENGINE\_SUSPENDED | Indicate that client has now paused as a result of calling [`lwm2m_engine_pause()`](../../../doxygen/html/group__lwm2m__api.md#ga1a4dadb822a8241c5bdf339c21cc57a4). State machine is no longer running and the handler thread is suspended. All timers are stopped so notifications are not triggered. |
...
| BOOTSTRAP\_REG\_FAILURE | Try to recover network connection. Then restart the client by calling [`lwm2m_rd_client_start()`](../../../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79). This might also indicate configuration issue. |
| BOOTSTRAP\_REG\_COMPLETE | No actions needed |
| BOOTSTRAP\_TRANSFER\_COMPLETE | No actions needed |
| REGISTRATION\_FAILURE | No actions needed. Client proceeds re-registration automatically. Might need a bootstrap or configuration fix. Cannot send or receive data. |
...
| DISCONNECT | Engine have stopped as a result of calling [`lwm2m_rd_client_stop()`](../../../doxygen/html/group__lwm2m__api.md#gafd87e5d975c4d88973ac3e95e4d156ac). If connection is required, the application should restart the client by calling [`lwm2m_rd_client_start()`](../../../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79). |
...
| ENGINE\_SUSPENDED | Engine can be resumed by calling [`lwm2m_engine_resume()`](../../../doxygen/html/group__lwm2m__api.md#ga178fea0407a5e98c4f5d5ad69688853a). Cannot send or receive data. |
| SERVER\_DISABLED | No actions needed, client will re-register once the disable period is over. Cannot send or receive data. |
| NETWORK\_ERROR | Try to recover network connection. Then restart the client by calling [`lwm2m_rd_client_start()`](../../../doxygen/html/group__lwm2m__api.md#ga9dfd46b8a535b1f28e644dc18f57fd79). This might also indicate configuration issue. |

Sending of data in the table above refers to calling [`lwm2m_send_cb()`](../../../doxygen/html/group__lwm2m__api.md#ga026cc9288d2de17ec557e08b9b987ebc) or by writing into one of the observed resources where observation would trigger a notify message.
...
![LwM2M seconds to update early](https://docs.zephyrproject.org/4.2.0/_images/lwm2m_lifetime_seconds_early.png)
...
![LwM2M update time when both values are set](https://docs.zephyrproject.org/4.2.0/_images/lwm2m_lifetime_both.png)
...
[LwM2M high-level API](../../../doxygen/html/group__lwm2m__api.md)

Related code samples

- [LwM2M client](../../../samples/net/lwm2m_client/README.md#lwm2m-client "Implement a LwM2M client that connects to a LwM2M server.")Implement a LwM2M client that connects to a LwM2M server.
