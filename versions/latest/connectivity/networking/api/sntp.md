---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/networking/api/sntp.html
...
:   Simple Network Time Protocol API.
    ...
    int sntp\_simple(const char \*server, uint32\_t timeout, struct [sntp\_time](#c.sntp_time) \*time)
