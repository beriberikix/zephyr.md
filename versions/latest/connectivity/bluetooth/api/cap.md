---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/cap.html
original_path: connectivity/bluetooth/api/cap.html
---
...
:   Common Audio Profile (CAP).
    ...
    :   *#include <cap.h>*
        ...
        void (\*discovery\_complete)(struct bt\_conn \*conn, int err, const struct [bt\_csip\_set\_coordinator\_csis\_inst](coordinated_sets.md#c.bt_csip_set_coordinator_csis_inst "bt_csip_set_coordinator_csis_inst") \*csis\_inst)
    ...
    :   *#include <cap.h>*
        ...
        struct [bt\_bap\_bass\_subgroup](bap.md#c.bt_bap_bass_subgroup "bt_bap_bass_subgroup") \*subgroups
