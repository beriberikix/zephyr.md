---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/mesh/sar_cfg.html
...
required. Set the `send rel` flag (see [`bt_mesh_msg_ctx`](msg.md#c.bt_mesh_msg_ctx "bt_mesh_msg_ctx")) to use the reliable message
