---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/bluetooth/api/mesh/brg_cfg.html
original_path: connectivity/bluetooth/api/mesh/brg_cfg.html
---
...
- [Bridge Configuration Server](brg_cfg_srv.md#bluetooth-mesh-models-brg-cfg-srv)
- [Bridge Configuration Client](brg_cfg_cli.md#bluetooth-mesh-models-brg-cfg-cli)
...
[`CONFIG_BT_MESH_BRG_TABLE_ITEMS_MAX`](../../../../kconfig.md#CONFIG_BT_MESH_BRG_TABLE_ITEMS_MAX "CONFIG_BT_MESH_BRG_TABLE_ITEMS_MAX") option, which defaults to the minimum value of
...
Server model on the target node, using the [`bt_mesh_brg_cfg_cli_set()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#ga6643d4d043af4b0cb30470a5c9a46f38) function.
...
Server model on the target node, calling the [`bt_mesh_brg_cfg_cli_table_add()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#ga8f055e8ee384e8ea4887a56720959b26) or
[`bt_mesh_brg_cfg_cli_table_remove()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#gabdb919dcf177b8d5c8a28b057469bf18) functions.
...
- *Subnet Bridge*: This state indicates whether the Subnet Bridge feature is enabled or disabled on
  ...
  message to the Bridge Configuration Server using the [`bt_mesh_brg_cfg_cli_get()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#ga6a4507190e425013a9d21ea0a1be1b5c) function.
- *Bridging Table*: This state holds the bridging table. The Client can request a list of
  ...
  the [`bt_mesh_brg_cfg_cli_table_get()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#gacd3811be7b87d2d9187aed6c50945b85) function.
  ...
  **Bridged Subnets Get** message to the target Server by calling the
  [`bt_mesh_brg_cfg_cli_subnets_get()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#ga04bb227d14d4f478e4f32a8ca87d2c38) function.
- *Bridging Table Size*: This state reports the maximum number of entries the Bridging Table can
  ...
  using the [`bt_mesh_brg_cfg_cli_table_size_get()`](../../../../doxygen/html/group__bt__mesh__brg__cfg__cli.md#ga99951987bd6787e3e1348d8e51e64fe5) function.
...
[`CONFIG_BT_MESH_RELAY_BUF_COUNT`](../../../../kconfig.md#CONFIG_BT_MESH_RELAY_BUF_COUNT "CONFIG_BT_MESH_RELAY_BUF_COUNT") Kconfig option.

When [`CONFIG_BT_MESH_ADV_EXT`](../../../../kconfig.md#CONFIG_BT_MESH_ADV_EXT "CONFIG_BT_MESH_ADV_EXT") is enabled, messages will be transmitted using the
relay advertising sets. The number of advertising sets are configurable using the
[`CONFIG_BT_MESH_RELAY_ADV_SETS`](../../../../kconfig.md#CONFIG_BT_MESH_RELAY_ADV_SETS "CONFIG_BT_MESH_RELAY_ADV_SETS") Kconfig option.

Both the relay buffer pool and advertising sets can be used even if the relay feature
[`CONFIG_BT_MESH_RELAY`](../../../../kconfig.md#CONFIG_BT_MESH_RELAY "CONFIG_BT_MESH_RELAY") is disabled.
