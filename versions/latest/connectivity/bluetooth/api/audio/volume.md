---
version: v3.7.0
source_url: https://docs.zephyrproject.org/3.7.0/connectivity/bluetooth/api/audio/volume.html
...
*group* Volume Control Profile (VCP)
:   Volume Control Profile (VCP).
    ...
    **Version**
    ...
    :   *#include <vcp.h>*
        ...
        These can be registered for usage with [bt\_vcp\_vol\_rend\_register()](#group__bt__gatt__vcp_1ga752d8ff54a4b8c8c854a9c693617e64d).
    ...
    :   *#include <vcp.h>*
        ...
        These can be registered for usage with [bt\_vcp\_vol\_ctlr\_cb\_register()](#group__bt__gatt__vcp_1ga7861d0c3426870c015106e8e170004a3).
