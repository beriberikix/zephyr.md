---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/shell/csip.html
original_path: connectivity/bluetooth/api/shell/csip.html
---
...
It is necessary to enable `BT_DEBUG_CSIP_SET_COORDINATOR` to properly use the set
coordinator.
