---
version: v3.6.0
source_url: https://raw.githubusercontent.com/zephyrproject-rtos/zephyr/3.6.0/doc/connectivity/bluetooth/api/shell/ccp.html
original_path: connectivity/bluetooth/api/shell/ccp.html
---
...
It is necessary to have `BT_DEBUG_TBS_CLIENT` enabled for using the client
interactively.
...
It is necessary to have `BT_DEBUG_TBS` enabled for using the TBS server
interactively.
