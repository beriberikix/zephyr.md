---
version: v4.2.0
source_url: https://docs.zephyrproject.org/4.2.0/connectivity/bluetooth/bluetooth-le-host.html
...
![Bluetooth Host protocol & profile layers](https://docs.zephyrproject.org/4.2.0/_images/ble_host_layers.png)
...
[`bt_conn_le_create()`](../../doxygen/html/group__bt__conn.md#ga8d66f3e0262a51279e9fa8b3139252e6).
...
the [`bt_conn_set_security()`](../../doxygen/html/group__bt__conn.md#gae001f1268e1ff42c3c974c95dcb6735d) API on a connection object.
...
![ATT timeout](https://docs.zephyrproject.org/4.2.0/_images/att_timeout.svg)
