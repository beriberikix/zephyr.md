---
version: v4.1.0
source_url: https://docs.zephyrproject.org/4.1.0/connectivity/usb/host/usbip.html
original_path: connectivity/usb/host/usbip.html
---
...
USB/IP protocol is described in [USB/IP protocol documentation](https://www.kernel.org/doc/html/latest/usb/usbip_protocol.html).
...
## USB/IP with native\_sim

The preferred method to develop with USB/IP support enabled is to use
[native\_sim](../../../boards/native/native_sim/doc/index.md#native-sim). Use on real hardware is not really tested yet.
USB/IP requires a network connection, see [Networking with native\_sim board](../../networking/native_sim_setup.md#networking-with-native-sim)
